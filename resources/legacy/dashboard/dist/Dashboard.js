...
`;function _e(e,t,i,s){var n,r=arguments.length,o=r<3?t:null===s?s=Object.getOwnPropertyDescriptor(t,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)o=Reflect.decorate(e,t,i,s);else for(var a=e.length-1;a>=0;a--)(n=e[a])&&(o=(r<3?n(o):r>3?n(t,i,o):n(t,i))||o);return r>3&&o&&Object.defineProperty(t,i,o),o}const be={attribute:!0,type:String,converter:k,reflect:!1,hasChanged:x},ge=(e=be,t,i)=>{const{kind:s,metadata:n}=i;let r=globalThis.litPropertyMetadata.get(n);if(void 0===r&&globalThis.litPropertyMetadata.set(n,r=new Map),"setter"===s&&((e=Object.create(e)).wrapped=!0),r.set(i.name,e),"accessor"===s){const{name:s}=i;return{set(i){const n=t.get.call(this);t.set.call(this,i),this.requestUpdate(s,n,e)},init(t){return void 0!==t&&this.C(s,void 0,e,t),t}}}if("setter"===s){const{name:s}=i;return function(i){const n=this[s];t.call(this,i),this.requestUpdate(s,n,e)}}throw Error("Unsupported decorator location: "+s)};function ve(e){return(t,i)=>"object"==typeof i?ge(e,t,i):((e,t,i)=>{const s=t.hasOwnProperty(i);return t.constructor.createProperty(i,e),s?Object.getOwnPropertyDescriptor(t,i):void 0})(e,t,i)}function ye(e){return ve({...e,state:!0,attribute:!1})}const we=(e,t,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,i),i);function ke(e,t){return(i,s,n)=>{const r=t=>t.renderRoot?.querySelector(e)??null;if(t){const{get:e,set:t}="object"==typeof s?i:n??(()=>{const e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return we(i,s,{get(){let i=e.call(this);return void 0===i&&(i=r(this),(null!==i||this.hasUpdated)&&t.call(this,i)),i}})}return we(i,s,{get(){return r(this)}})}}function xe(e){return(t,i)=>{const{slot:s,selector:n}=e??{},r="slot"+(s?`[name=${s}]`:":not([name])");return we(t,i,{get(){const t=this.renderRoot?.querySelector(r),i=t?.assignedElements(e)??[];return void 0===n?i:i.filter(e=>e.matches(n))}})}}var Ce=class extends pe{constructor(){super(),this.alt=!1,this.shift=!1,this.os="Unknown",this.os=this.detectOS()}connectedCallback(){super.connectedCallback(),"Unknown"===this.os&&(this.os=this.detectOS())}detectOS(){let e=navigator.platform.toLowerCase();return e.includes("mac")||/iphone|ipad|ipod/.test(e)?"Mac":e.includes("win")?"Windows":e.includes("linux")?"Linux":"Unknown"}renderShortcutPrefix(){switch(this.os){case"Mac":return`${this.alt?"⌥":""}${this.shift?"⇧":""}⌘`;case"Linux":return`Super+${this.alt?"Alt+":""}${this.shift?"Shift+":""}`;default:return`Ctrl+${this.alt?"Alt+":""}${this.shift?"Shift+":""}`}}render(){return K`<span class="shortcut"
      >${this.renderShortcutPrefix()}<slot></slot
    ></span>`}};function Ee(e){if("string"!=typeof e)return e;try{return JSON.parse(e)}catch{return null}}async function Ne(e,t={}){switch(e.type){case"clipboard":await navigator.clipboard.writeText(e.value);break;case"http":{if(e.confirm&&!confirm(e.confirm))return;let t=await fetch(e.url,{method:e.method||"POST",headers:{"Content-Type":"application/json",Accept:"application/json"},body:e.body?JSON.stringify(e.body):void 0}),i=await t.json().catch(()=>({}));if(!t.ok)throw Error(i.message??"Request failed");"string"==typeof i.redirect&&i.redirect&&function(e){window.dispatchEvent(new CustomEvent("action:redirect",{cancelable:!0,detail:{url:e}}))&&window.location.assign(e)}(i.redirect);break}case"event":if(e.confirm&&!confirm(e.confirm))return;window.dispatchEvent(new CustomEvent(e.name,{detail:{...e.detail??{},...t.trigger?{trigger:t.trigger}:{},...t.sourceEvent?{sourceEvent:t.sourceEvent}:{}}}));break;case"download":{let t=document.createElement("a");t.href=e.url,t.download=e.filename??"",t.click();break}default:throw Error(`Unknown action type: ${e.type}`)}}Ce.styles=l`
    :host {
      display: inline-flex;
    }
  ...
  `,_e([ve({type:Boolean})],Ce.prototype,"alt",void 0),_e([ve({type:Boolean})],Ce.prototype,"shift",void 0),_e([ve()],Ce.prototype,"os",void 0),customElements.get("craft-shortcut")||customElements.define("craft-shortcut",Ce);const Ae={Neutral:"neutral",Success:"success",Warning:"warning",Danger:"danger",Info:"info"},Se=Object.values(Ae),$e=e=>(...t)=>({_$litDirective$:e,values:t});class Te{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Le=$e(class extends Te{constructor(e){if(super(e),1!==e.type||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const i=e.element.classList;for(const e of this.st)e in t||(i.remove(e),this.st.delete(e));for(const e in t){const s=!!t[e];s===this.st.has(e)||this.nt?.has(e)||(s?(i.add(e),this.st.add(e)):(i.remove(e),this.st.delete(e)))}return G}}),Oe="idle",Fe="loading",Me="success",Ie="error";var De=l`
  :host {
    display: contents;
  }
...
`,Ve=class extends pe{constructor(...e){super(...e),this.icon=null,this.iconColor=null,this.href=null,this.disabled=!1,this.variant=Ae.Neutral,this.checked=!1,this.active=!1,this.type="button",this.action=null,this.feedback=null,this.feedbackDuration=1e3,this.confirm=null,this.state=Oe,this.feedbackMessage=null,this.shortcut=null}renderShortcut(){return"string"==typeof this.shortcut?K`<craft-shortcut>${this.shortcut}</craft-shortcut>`:null===this.shortcut?Z:K`<craft-shortcut
        ?alt="${this.shortcut.alt??!1}"
        ?shift="${this.shortcut.shift??!1}"
        >${this.shortcut.key}</craft-shortcut
      >`}connectedCallback(){super.connectedCallback(),this.addEventListener("click",this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this)}setState(e,t={}){this.state=e,this.feedbackMessage=t.message??null,this.dispatchEvent(new CustomEvent("action:change-state",{bubbles:!0,composed:!0,detail:{state:e,actionType:Ee(this.action)?.type,...t}}))}async handleEvent(e){if(this.disabled)return void e.preventDefault();let t=Ee(this.action);if("click"===e.type&&t){"http"===t.type&&this.setState(Fe);try{await Ne(t,{trigger:this,sourceEvent:e}),this.setState(Me,this.feedback?.success)}catch(e){this.setState(Ie,{message:e.message,...this.feedback?.error||{}})}finally{setTimeout(()=>{this.setState(Oe)},this.feedbackDuration)}}}renderCheckbox(){return K`<span class="action-item__check">
      <slot name="checkmark">
        ${this.checked?K`<craft-icon name="check"></craft-icon>`:Z}
      </slot>
    </span>`}renderIcon(){switch(this.state){case Fe:return K`<craft-spinner style="--size: 0.8em"></craft-spinner>`;case Me:return K`<craft-icon
          name="check"
          style="color: var(--c-color-success-on-normal)"
        ></craft-icon>`;case Ie:return K`<craft-icon
          name="xmark"
        ...
        ></craft-icon>`;default:return K`
          <slot name="icon">
            ${this.icon?K`<craft-icon
                  name="${this.icon}"
                  style="${this.iconColor?`color: var(--c-color-${this.iconColor}-on-normal, currentColor)`:Z}"
                ></craft-icon>`:Z}
          </slot>
        `}}renderPrefix(){let e=!!this.querySelector('[slot="icon"]')||!!this.icon;return K`
      ${"checkbox"===this.type?this.renderCheckbox():Z}
      ${e?K`<div class="action-item__icon">${this.renderIcon()}</div>`:Z}
    `}renderBody(){return K`
      ${this.renderPrefix()}
      ...
      <span class="action-item__suffix">
        ...
        ${this.shortcut?this.renderShortcut():Z}
      </span>
    `}render(){return this.href?K`
          <a
            class="${Le({"action-item":!0,"action-item--checkbox":"checkbox"===this.type})}"
            href="${this.href}"
          >
            ${this.renderBody()}
          </a>
...
`,It=new WeakMap,Dt=new WeakSet,Vt=class extends(Lt(pe)){constructor(){super(),st(this,Dt),this.placement="bottom-start",this.distance=4,this.matchInvokerWidth=!1,this.withoutArrow=!1,nt(this,It,null),et(this)}_defineOverlayConfig(){return{placementMode:"local",inheritsReferenceWidth:"min",hidesOnOutsideClick:!0,hidesOnEsc:!0,popperConfig:{placement:"bottom-start",modifiers:[{name:"offset",enabled:!1}]},handlesAccessibility:!0,visibilityTriggerFunction:({controller:e})=>{function t(){e._hasDisabledInvoker()||e.toggle()}return{init:()=>{e.invokerNode?.addEventListener("click",t)},teardown:()=>{e.invokerNode?.removeEventListener("click",t)}}},inheritsReferenceWidth:this.matchInvokerWidth?"min":"none",popperConfig:{strategy:"fixed",placement:this.placement,modifiers:[{name:"offset",options:{offset:[0,this.distance]}},{name:"computeStyles",options:{gpuAcceleration:!1}},{name:"containingBlockCorrection",enabled:!0,phase:"afterWrite",fn:({state:e})=>{let t=e.elements.popper,i=parseFloat(t.style.left),s=parseFloat(t.style.top);if(Number.isNaN(i)||Number.isNaN(s))return;let n=t.getBoundingClientRect(),r=n.x-i,o=n.y-s;(0!==r||0!==o)&&(t.style.left=i-r+"px",t.style.top=s-o+"px")}}]}}}get _overlayContentNode(){return this.shadowRoot?.querySelector(".popover-pane")}get _overlayInvokerNode(){if(this.anchor)return this.anchor;if(this.for){let e=this.getRootNode();return"function"==typeof e.getElementById?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}render(){return K`
    ...
    `],zt._filterableItemsSelector="craft-action-item, li, button",_e([ve({attribute:!1})],zt.prototype,"actions",void 0),_e([ve()],zt.prototype,"label",void 0),_e([ve()],zt.prototype,"icon",void 0),_e([ve({type:Boolean,reflect:!0})],zt.prototype,"disabled",void 0),_e([ve({type:Boolean,reflect:!0})],zt.prototype,"searchable",void 0),_e([xe({slot:"invoker"})],zt.prototype,"invokerNodes",void 0),_e([xe({slot:"content"})],zt.prototype,"contentNodes",void 0),customElements.get("craft-action-menu")||customElements.define("craft-action-menu",zt);var Bt=l`
  :host {
    --color-start: red;
    --color-end: blue;
    --color-text: inherit;
...
`,Ut=class extends pe{constructor(...e){super(...e),this.label=null,this._gradientId=null}connectedCallback(){super.connectedCallback(),this._gradientId=`avatar-gradient-${Math.random().toString(36).slice(2,8)}`}text(){return this.label?this.label.split(" ").map(e=>e.charAt(0).toUpperCase()).join(""):"?"}render(){return K`
      <span class="avatar">
        <svg
          viewBox="0 0 100 100"
    ...
    `}};Ut.styles=[Bt],_e([ve()],Ut.prototype,"label",void 0),_e([ye()],Ut.prototype,"_gradientId",void 0),customElements.get("craft-avatar")||customElements.define("craft-avatar",Ut);const qt=["red","orange","amber","yellow","lime","green","emerald","teal","cyan","sky","blue","indigo","violet","purple","fuchsia","pink","rose","white","gray","black","slate"],Ht=e=>e.charAt(0).toUpperCase()+e.slice(1),Wt={...Object.fromEntries(qt.map(e=>[Ht(e),e])),...Object.fromEntries(Object.entries({neutral:"slate",accent:"blue",info:"sky",success:"emerald",warning:"yellow",danger:"red"}).map(([e,t])=>[Ht(e),t])),...Object.fromEntries(Object.entries({pending:"orange",off:"red",suspended:"red",expired:"red",disabled:"gray",inactive:"gray",on:"emerald"}).map(([e,t])=>[Ht(e),t]))},jt=[...qt],Kt={Solid:"solid",OutlineFill:"outline-fill",Fill:"fill",Outline:"outline",Plain:"plain"};Object.values(Kt);var Gt=class extends pe{constructor(...e){super(...e),this.size="md",this.fill="var(--c-color-fill-loud)",this.label=null,this.appearance=Kt.OutlineFill}getFill(){return jt.includes(this.fill)||Se.includes(this.fill)?`var(--c-color-${this.fill}-fill-loud)`:this.fill}getSize(){switch(this.size){case"md":return"0.6em";case"lg":return"1em";default:return this.size}}render(){return K`<span
      style="--fill: ${this.getFill()}; --size: ${this.getSize()}"
      aria-label="${this.label??Z}"
      role="${this.label?"img":Z}"
      class="${Le({indicator:!0,"indicator--outline":this.appearance===Kt.Outline})}"
    ></span>`}};Gt.styles=[fe,l`
      .indicator {
    ...
    `],_e([ve()],Gt.prototype,"size",void 0),_e([ve({reflect:!0})],Gt.prototype,"fill",void 0),_e([ve()],Gt.prototype,"label",void 0),_e([ve({reflect:!0})],Gt.prototype,"appearance",void 0),customElements.get("craft-indicator")||customElements.define("craft-indicator",Gt);var Zt=l`
  :host {
    display: inline-flex;
  }
...
`,Yt=class extends pe{constructor(...e){super(...e),this.fill=Wt.Gray}getFill(){return this.fill}willUpdate(e){e.has("fill")&&(this.dataset.color=this.getFill())}render(){return K`
      <span
        part="badge"
        class="${Le({badge:!0})}"
      >
    ...
    `}};Yt.styles=[Zt],_e([ve({reflect:!0})],Yt.prototype,"fill",void 0),customElements.get("craft-badge")||customElements.define("craft-badge",Yt);var Jt=class extends pe{constructor(...e){super(...e),this.rel="noreferrer noopener"}render(){return K`
  ...
  `,_e([ve({reflect:!0})],Jt.prototype,"href",void 0),_e([ve()],Jt.prototype,"target",void 0),_e([ve()],Jt.prototype,"rel",void 0),customElements.get("craft-breadcrumb-item")||customElements.define("craft-breadcrumb-item",Jt);class Xt{constructor(){this.__iconResolvers=new Map}addIconResolver(e,t){if(this.__iconResolvers.has(e))throw new Error(`An icon resolver has already been registered for namespace: ${e}`);this.__iconResolvers.set(e,t)}removeIconResolver(e){this.__iconResolvers.delete(e)}resolveIcon(e,t,i){const s=this.__iconResolvers.get(e);if(s)return s(t,i);throw new Error(`Could not find any icon resolver for namespace ${e}.`)}resolveIconForId(e){const t=e.split(":");if(3!==t.length)throw new Error(`Incorrect iconId: ${e}. Format: <namespace>:<iconset>:<icon>`);return this.resolveIcon(t[0],t[1],t[2])}}const Qt=ht(function(){if(!ut.has("@lion/ui::icons::0.x")){const e=new Xt;ut.set("@lion/ui::icons::0.x",e)}return ut.get("@lion/ui::icons::0.x")});class ei extends Te{constructor(e){if(super(e),this.it=Z,2!==e.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===Z||null==e)return this._t=void 0,this.it=e;if(e===G)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}ei.directiveName="unsafeHTML",ei.resultType=1,$e(ei);class ti extends ei{}ti.directiveName="unsafeSVG",ti.resultType=2;const ii=$e(ti),si="craft",ni=new Map,ri=(e,t,i)=>{let s=function(e,t="classic",i="regular",s="/vendor/craft/icons"){let n="solid",r=i,o=e.endsWith(".svg")?e.split(".svg")[0]:e;if(e.includes("/")){let[t,...i]=e.split("/");r=t??r,o=i.join("/")}return"thin"===r?n="thin":"light"===r?n="light":"regular"===r?n="regular":"solid"===r&&(n="solid"),"brands"===t&&(n="brands"),("custom-icons"===t||"custom-icons"===r)&&(n="custom-icons"),`${s}/${n}/${o}.svg`}(e,t,i);if(null===s)return Z;let n=ni.get(s);return n||(n=async function(e){try{let t=await fetch(e,{mode:"cors"});if(!t.ok)return Z;let i=document.createElement("div");i.innerHTML=await t.text();let s=i.firstElementChild;return"svg"===s?.tagName?.toLowerCase()?(s.setAttribute("fill","currentColor"),s.setAttribute("part","svg"),K`${ii(s.outerHTML)}`):Z}catch{return Z}}(s),ni.set(s,n)),n.then(e=>(e===Z&&ni.delete(s),e))};!function(e){Qt.removeIconResolver(si),Qt.addIconResolver(si,(t,i)=>{let{family:s,variant:n}=function(e){let[t="classic",i="regular"]=e.split("/");return{family:t,variant:i}}(t);return e(i,s,n)})}(ri);var oi=new WeakSet,ai=class extends pe{constructor(...e){super(...e),st(this,oi),this.appearance="plain",this._svg=Z,this._hasSlottedContent=!1}connectedCallback(){super.connectedCallback(),"badge"===this.appearance&&!this.getAttribute("data-color")&&this.setAttribute("data-color","warning"),this._hasSlottedContent=this.childElementCount>0}firstUpdated(){it(oi,this,ci).call(this)}updated(e){super.updated(e),(e.has("name")||e.has("family")||e.has("variant"))&&it(oi,this,di).call(this),e.has("label")&&this.hasUpdated&&it(oi,this,ci).call(this)}_handleSlotChange(e){let t=e.target;this._hasSlottedContent=t.assignedElements({flatten:!0}).length>0}render(){return K`
      <slot @slotchange=${this._handleSlotChange}></slot>
      ${this._hasSlottedContent?Z:this._svg}
...
`,ui=class extends pe{constructor(...e){super(...e),this.label=Qe("Breadcrumbs"),this.items=[],this.visibleItems=0,this.firstRender=!0}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll("[id]")].forEach(e=>e.removeAttribute("id")),e.setAttribute("data-default",""),e.slot="separator",e}calculateBreadcrumbItemsWidth(){this.items=this.breadcrumbsElements.map((e,t)=>{let i=e.offsetWidth;return e.hasAttribute("hidden")&&(e.removeAttribute("hidden"),i=e.offsetWidth,e.setAttribute("hidden","")),{label:e.innerText,href:e.href,value:t.toString(),offsetWidth:i,isVisible:!0}})}async handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>"craft-breadcrumb-item"===e.tagName.toLowerCase());if(e.forEach((t,i)=>{let s=t.querySelector('[slot="separator"]');null===s?t.append(this.getSeparator()):s.hasAttribute("data-default")&&s.replaceWith(this.getSeparator()),i===e.length-1?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current")}),0===this.breadcrumbsElements.length)return this.items=[],void(this.visibleItems=0);await Promise.all(this.breadcrumbsElements.map(e=>e.updateComplete)),this.calculateBreadcrumbItemsWidth(),this.visibleItems=0,this.adjustOverflow()}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.firstRender?this.firstRender=!1:this.adjustOverflow()}),this.resizeObserver.observe(this)}adjustOverflow(){let e=this.getBoundingClientRect().width;console.log({availableSpace:e})}disconnectedCallback(){this.resizeObserver?.unobserve(this),super.disconnectedCallback()}render(){return K`
    ...
    `}};ui.styles=[hi],_e([ke("slot")],ui.prototype,"defaultSlot",void 0),_e([ke('slot[name="separator"]')],ui.prototype,"separatorSlot",void 0),_e([xe({selector:"craft-breadcrumb-item"})],ui.prototype,"breadcrumbsElements",void 0),_e([ve()],ui.prototype,"label",void 0),_e([ye()],ui.prototype,"items",void 0),_e([ye()],ui.prototype,"visibleItems",void 0),customElements.get("craft-breadcrumbs")||customElements.define("craft-breadcrumbs",ui);var pi=l`
  :host {
...
`,mi=class extends pe{constructor(){super(),this._handleClick=e=>{let t=e.composedPath().find(e=>e instanceof Element&&e.hasAttribute("value")&&e!==this);if(!t)return;let i=t.getAttribute("value")??"";i!==this.value&&(this.value=i,this._syncChildren(),this.dispatchEvent(new CustomEvent("change",{bubbles:!0,composed:!0,detail:{value:i}})))},this._internals=this.attachInternals()}firstUpdated(e){super.firstUpdated(e),this.name&&this._setupRadioMode()}updated(e){e.has("name")&&(this.name?this._setupRadioMode():this._teardownRadioMode()),e.has("value")&&this.name&&this._syncChildren()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleClick)}_setupRadioMode(){this.setAttribute("role","radiogroup"),this.removeEventListener("click",this._handleClick),this.addEventListener("click",this._handleClick),this._syncChildren()}_teardownRadioMode(){this.removeAttribute("role"),this.removeEventListener("click",this._handleClick)}_syncChildren(){this.querySelectorAll("craft-button").forEach(e=>{"button"!==e.getAttribute("type")&&e.setAttribute("type","button");let t=e.getAttribute("value")===this.value;e.toggleAttribute("active",t),e.setAttribute("aria-pressed",String(t))}),this._internals.setFormValue(this.value??null)}render(){return K`<slot @slotchange=${this._onSlotChange}></slot>`}_onSlotChange(){this.name&&this._syncChildren()}};mi.styles=[pi],mi.formAssociated=!0,_e([ve({reflect:!0})],mi.prototype,"name",void 0),_e([ve({reflect:!0})],mi.prototype,"value",void 0),customElements.get("craft-button-group")||customElements.define("craft-button-group",mi);var fi=l`
...
`;class _i extends(Ot(Lt(pe))){static get properties(){return{invokerRelation:{type:String,attribute:"invoker-relation"}}}static get styles(){return[...super.styles,l`
        :host {
      ...
      `]}constructor(){super(),this.hasArrow=!1,this.invokerRelation="description"}static enabledWarnings=super.enabledWarnings?.filter(e=>"change-in-update"!==e)||[];_defineOverlayConfig(){const e=super._defineOverlayConfig(),t=(({invokerRelation:e="description",delayIn:t=300,delayOut:i=300}={})=>({placementMode:"local",elementToFocusAfterHide:void 0,hidesOnEsc:!0,handlesAccessibility:!0,isTooltip:!0,invokerRelation:e,popperConfig:{strategy:"absolute"},...Ft({delayIn:t,delayOut:i})}))({invokerRelation:this.invokerRelation});return{...e,...t,popperConfig:{...e.popperConfig||{},...t.popperConfig||{},modifiers:[...e.popperConfig?.modifiers||[],...t.popperConfig?.modifiers||[]]}}}}var bi=new WeakMap,gi=new WeakMap,vi=new WeakSet,yi=class extends _i{constructor(){super(),st(this,vi),this.placement="top",this.trigger="hover focus",nt(this,bi,null),nt(this,gi,()=>{this.opened=!this.opened}),et(this)}static get styles(){return[...super.styles,l`
        ::slotted([slot='content']) {
      ...
      `]}connectedCallback(){it(vi,this,wi).call(this),super.connectedCallback()}get _overlayInvokerNode(){if(this.for){let e=this.getRootNode();return"function"==typeof e.getElementById?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}_defineOverlayConfig(){let e={...super._defineOverlayConfig()};return(ki.call(it(vi,this))||xi.call(it(vi,this)))&&delete e.visibilityTriggerFunction,{...e,popperConfig:{...e.popperConfig,placement:this.placement}}}_setupOpenCloseListeners(){super._setupOpenCloseListeners(),ki.call(it(vi,this))&&this._overlayInvokerNode?.addEventListener("click",rt(gi,this))}_teardownOpenCloseListeners(){super._teardownOpenCloseListeners(),this._overlayInvokerNode?.removeEventListener("click",rt(gi,this))}updated(e){super.updated(e),e.has("for")&&void 0!==e.get("for")&&this._overlayCtrl&&this._overlayCtrl.updateConfig({invokerNode:this._overlayInvokerNode})}async show(){this.opened=!0,await this.updateComplete}async hide(){this.opened=!1,await this.updateComplete}};function wi(){if(rt(bi,this)?.isConnected)return;let e=document.createElement("div");e.slot="content",e.append(...Array.from(this.childNodes).filter(e=>!(e instanceof Element)||""===e.slot)),this.append(e),ot(bi,this,e)}function ki(){return this.trigger.split(" ").includes("click")}function xi(){return this.trigger.split(" ").includes("manual")}_e([ve({reflect:!0})],yi.prototype,"for",void 0),_e([ve({reflect:!0})],yi.prototype,"placement",void 0),_e([ve({reflect:!0})],yi.prototype,"trigger",void 0),customElements.get("craft-tooltip")||customElements.define("craft-tooltip",yi);const Ci=lt(e=>class extends e{static get properties(){return{disabled:{type:Boolean,reflect:!0}}}constructor(){super(),this._requestedToBeDisabled=!1,this.__isUserSettingDisabled=!0,this.__restoreDisabledTo=!1,this.disabled=!1}makeRequestToBeDisabled(){!1===this._requestedToBeDisabled&&(this._requestedToBeDisabled=!0,this.__restoreDisabledTo=this.disabled,this.__internalSetDisabled(!0))}retractRequestToBeDisabled(){!0===this._requestedToBeDisabled&&(this._requestedToBeDisabled=!1,this.__internalSetDisabled(this.__restoreDisabledTo))}__internalSetDisabled(e){this.__isUserSettingDisabled=!1,this.disabled=e,this.__isUserSettingDisabled=!0}requestUpdate(e,t,i){super.requestUpdate(e,t,i),"disabled"===e&&(this.__isUserSettingDisabled&&(this.__restoreDisabledTo=this.disabled),!1===this.disabled&&!0===this._requestedToBeDisabled&&this.__internalSetDisabled(!0))}click(){this.disabled||super.click()}}),Ei=lt(e=>class extends(Ci(e)){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:"tabindex"}}}constructor(){super(),this.__isUserSettingTabIndex=!0,this.__restoreTabIndexTo=0,this.__internalSetTabIndex(0)}makeRequestToBeDisabled(){super.makeRequestToBeDisabled(),!1===this._requestedToBeDisabled&&null!=this.tabIndex&&(this.__restoreTabIndexTo=this.tabIndex)}retractRequestToBeDisabled(){super.retractRequestToBeDisabled(),!0===this._requestedToBeDisabled&&this.__internalSetTabIndex(this.__restoreTabIndexTo)}static enabledWarnings=super.enabledWarnings?.filter(e=>"change-in-update"!==e)||[];__internalSetTabIndex(e){this.__isUserSettingTabIndex=!1,this.tabIndex=e,this.__isUserSettingTabIndex=!0}requestUpdate(e,t,i){super.requestUpdate(e,t,i),"disabled"===e&&(this.disabled?this.__internalSetTabIndex(-1):this.__internalSetTabIndex(this.__restoreTabIndexTo)),"tabIndex"===e&&(this.__isUserSettingTabIndex&&null!=this.tabIndex&&(this.__restoreTabIndexTo=this.tabIndex),-1!==this.tabIndex&&!0===this._requestedToBeDisabled&&this.__internalSetTabIndex(-1))}firstUpdated(e){super.firstUpdated(e),this.disabled&&this.__internalSetTabIndex(-1)}}),Ni=e=>" "===e.key||"Enter"===e.key,Ai=e=>" "===e.key;class Si extends(Ei(pe)){static get properties(){return{active:{type:Boolean,reflect:!0},type:{type:String,reflect:!0}}}render(){return K` <div class="button-content"><slot></slot></div> `}static get styles(){return[l`
        :host {
          position: relative;
          display: inline-flex;
          box-sizing: border-box;
...
`,Mi=new WeakMap,Ii=class extends pe{constructor(...e){super(...e),this.label=Qe("More Info"),this.icon="circle-info",this.disabled=!1,this.status="",nt(this,Mi,new AbortController)}connectedCallback(){super.connectedCallback(),rt(Mi,this).signal.aborted&&ot(Mi,this,new AbortController),this.id||(this.id=`info-icon-${Math.random().toString(36).slice(2,8)}`);let{signal:e}=rt(Mi,this);this.addEventListener("craft-show",()=>{Di._&&Di._!==this&&Di._.renderRoot.querySelector("craft-tooltip")?.hide(),Di._=this},{signal:e}),this.addEventListener("craft-after-show",()=>{this.status="",setTimeout(()=>{this.status="Some new status"},200)},{signal:e}),this.addEventListener("craft-after-hide",()=>{Di._===this&&(Di._=null),this.status=""},{signal:e})}disconnectedCallback(){Di._===this&&(Di._=null),rt(Mi,this).abort(),super.disconnectedCallback()}render(){return K`
  ...
  `;var Di={_:null};_e([ve()],Ii.prototype,"label",void 0),_e([ve()],Ii.prototype,"icon",void 0),_e([ve({type:Boolean,reflect:!0})],Ii.prototype,"disabled",void 0),_e([ve()],Ii.prototype,"id",void 0),_e([ye()],Ii.prototype,"status",void 0),_e([ke("craft-tooltip")],Ii.prototype,"tooltip",void 0),customElements.get("craft-info-icon")||customElements.define("craft-info-icon",Ii);var Vi=class extends pe{constructor(...e){super(...e),this.debug=!1}render(){return K`<slot></slot>`}};Vi.styles=l`
    :host(:not([debug])) {
      position: absolute;
      width: 1px;
      height: 1px;
  ...
  `,_e([ve({type:Boolean,reflect:!0})],Vi.prototype,"debug",void 0),customElements.get("craft-visually-hidden")||customElements.define("craft-visually-hidden",Vi);var Ri=class extends pe{constructor(...e){super(...e),this.visible=!0}show(){this.visible=!0,this.dispatchEvent(new CustomEvent("show"))}hide(){this.visible=!1,this.dispatchEvent(new CustomEvent("hide"))}focus(){this.wrapper?.focus()}render(){return K`
      <div
        tabindex="-1"
    ...
    `}};Ri.styles=[fi,Fi],_e([ve({reflect:!0,type:Boolean})],Ri.prototype,"visible",void 0),_e([ke(".wrapper")],Ri.prototype,"wrapper",void 0),customElements.get("craft-spinner")||customElements.define("craft-spinner",Ri);var Pi=Object.prototype.toString;function zi(e){return"function"==typeof e||"[object Function]"===Pi.call(e)}var Bi=2**53-1;function Ui(e,t){var i=Array,s=Object(e);if(null==e)throw TypeError("Array.from requires an array-like object - not null or undefined");if(void 0!==t&&!zi(t))throw TypeError("Array.from: when provided, the second argument must be a function");for(var n,r=function(e){var t=function(e){var t=Number(e);return isNaN(t)?0:0!==t&&isFinite(t)?(t>0?1:-1)*Math.floor(Math.abs(t)):t}(e);return Math.min(Math.max(t,0),Bi)}(s.length),o=zi(i)?Object(new i(r)):Array(r),a=0;a<r;)n=s[a],o[a]=t?t(n,a):n,a+=1;return o.length=r,o}function qi(e){return qi="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},qi(e)}function Hi(e,t){for(var i=0;i<t.length;i++){var s=t[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,Wi(s.key),s)}}function Wi(e){var t=function(e){if("object"!=qi(e)||!e)return e;var t=e[Symbol.toPrimitive];if(void 0!==t){var i=t.call(e,"string");if("object"!=qi(i))return i;throw TypeError("@@toPrimitive must return a primitive value.")}return String(e)}(e);return"symbol"==qi(t)?t:t+""}var ji=typeof Set>"u"?Set:function(e,t){return t&&Hi(e.prototype,t),Object.defineProperty(e,"prototype",{writable:!1}),e}(function e(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[];(function(e,t){if(!(e instanceof t))throw TypeError("Cannot call a class as a function")})(this,e),function(e,t,i){(t=Wi(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i}(this,"items",void 0),this.items=t},[{key:"add",value:function(e){return!1===this.has(e)&&this.items.push(e),this}},{key:"clear",value:function(){this.items=[]}},{key:"delete",value:function(e){var t=this.items.length;return this.items=this.items.filter(function(t){return t!==e}),t!==this.items.length}},{key:"forEach",value:function(e){var t=this;this.items.forEach(function(i){e(i,i,t)})}},{key:"has",value:function(e){return-1!==this.items.indexOf(e)}},{key:"size",get:function(){return this.items.length}}]);function Ki(e){return e.localName??e.tagName.toLowerCase()}var Gi={article:"article",aside:"complementary",button:"button",datalist:"listbox",dd:"definition",details:"group",dialog:"dialog",dt:"term",fieldset:"group",figure:"figure",form:"form",footer:"contentinfo",h1:"heading",h2:"heading",h3:"heading",h4:"heading",h5:"heading",h6:"heading",header:"banner",hr:"separator",html:"document",legend:"legend",li:"listitem",math:"math",main:"main",menu:"list",nav:"navigation",ol:"list",optgroup:"group",option:"option",output:"status",progress:"progressbar",section:"region",summary:"button",table:"table",tbody:"rowgroup",textarea:"textbox",tfoot:"rowgroup",td:"cell",th:"columnheader",thead:"rowgroup",tr:"row",ul:"list"},Zi={caption:new Set(["aria-label","aria-labelledby"]),code:new Set(["aria-label","aria-labelledby"]),deletion:new Set(["aria-label","aria-labelledby"]),emphasis:new Set(["aria-label","aria-labelledby"]),generic:new Set(["aria-label","aria-labelledby","aria-roledescription"]),insertion:new Set(["aria-label","aria-labelledby"]),none:new Set(["aria-label","aria-labelledby"]),paragraph:new Set(["aria-label","aria-labelledby"]),presentation:new Set(["aria-label","aria-labelledby"]),strong:new Set(["aria-label","aria-labelledby"]),subscript:new Set(["aria-label","aria-labelledby"]),superscript:new Set(["aria-label","aria-labelledby"])};function Yi(e,t){return function(e,t){return["aria-atomic","aria-busy","aria-controls","aria-current","aria-description","aria-describedby","aria-details","aria-dropeffect","aria-flowto","aria-grabbed","aria-hidden","aria-keyshortcuts","aria-label","aria-labelledby","aria-live","aria-owns","aria-relevant","aria-roledescription"].some(function(i){var s;return e.hasAttribute(i)&&!(null!=(s=Zi[t])&&s.has(i))})}(e,t)}var Ji=["presentation","none"];function Xi(e){return null!==e&&e.nodeType===e.ELEMENT_NODE}function Qi(e){return Xi(e)&&"caption"===Ki(e)}function es(e){return Xi(e)&&"input"===Ki(e)}function ts(e){return Xi(e)&&"legend"===Ki(e)}function is(e){return function(e){return Xi(e)&&void 0!==e.ownerSVGElement}(e)&&"title"===Ki(e)}function ss(e,t){if(Xi(e)&&e.hasAttribute(t)){var i=e.getAttribute(t).split(" "),s=e.getRootNode?e.getRootNode():e.ownerDocument;return i.map(function(e){return s.getElementById(e)}).filter(function(e){return null!==e})}return[]}function ns(e,t){return!!Xi(e)&&-1!==t.indexOf(function(e){var t=function(e){var t=e.getAttribute("role");if(null!==t){var i=t.trim().split(" ")[0];if(i.length>0)return i}return null}(e);if(null===t||-1!==Ji.indexOf(t)){var i=function(e){var t=Gi[Ki(e)];if(void 0!==t)return t;switch(Ki(e)){case"a":case"area":case"link":if(e.hasAttribute("href"))return"link";break;case"img":return""!==e.getAttribute("alt")||Yi(e,"img")?"img":"presentation";case"input":var i=e.type;switch(i){case"button":case"image":case"reset":case"submit":return"button";case"checkbox":case"radio":return i;case"range":return"slider";case"email":case"tel":case"text":case"url":return e.hasAttribute("list")?"combobox":"textbox";case"search":return e.hasAttribute("list")?"combobox":"searchbox";case"number":return"spinbutton";default:return null}case"select":return e.hasAttribute("multiple")||e.size>1?"listbox":"combobox"}return null}(e);if(-1===Ji.indexOf(t||"")||Yi(e,i||""))return i}return t}(e))}function rs(e,t){if(!Xi(e))return!1;if("range"===t)return ns(e,["meter","progressbar","scrollbar","slider","spinbutton"]);throw TypeError(`No knowledge about abstract role '${t}'. This is likely a bug :(`)}function os(e,t){var i=Ui(e.querySelectorAll(t));return ss(e,"aria-owns").forEach(function(e){i.push.apply(i,Ui(e.querySelectorAll(t)))}),i}function as(e){var t=e.getPropertyValue("content");return/^["'].*["']$/.test(t)?t.slice(1,-1):""}function ls(e){var t=Ki(e);return"button"===t||"input"===t&&"hidden"!==e.getAttribute("type")||"meter"===t||"output"===t||"progress"===t||"select"===t||"textarea"===t}function ds(e){if(ls(e))return e;var t=null;return e.childNodes.forEach(function(e){if(null===t&&Xi(e)){var i=ds(e);null!==i&&(t=i)}}),t}function cs(e){if(void 0!==e.control)return e.control;var t=e.getAttribute("for");return null===t?ds(e):e.ownerDocument.getElementById(t)}function hs(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},i=new ji,s=typeof Map>"u"?void 0:new Map,n=function(e){var t=(null===e.ownerDocument?e:e.ownerDocument).defaultView;if(null===t)throw TypeError("no window available");return t}(e),r=t.compute,o=void 0===r?"name":r,a=t.computedStyleSupportsPseudoElements,l=void 0===a?void 0!==t.getComputedStyle:a,d=t.getComputedStyle,c=void 0===d?n.getComputedStyle.bind(n):d,h=t.hidden,u=void 0!==h&&h,p=function(e,t){if(void 0!==t)throw Error("use uncachedGetComputedStyle directly for pseudo elements");if(void 0===s)return c(e);var i=s.get(e);if(i)return i;var n=c(e,t);return s.set(e,n),n};function m(e,t){var i="";if(Xi(e)&&l&&(i=`${as(c(e,"::before"))} ${i}`),(function(e){return Xi(e)&&"slot"===Ki(e)}(e)?function(e){var t=e.assignedNodes();return 0===t.length?Ui(e.childNodes):t}(e):Ui(e.childNodes).concat(ss(e,"aria-owns"))).forEach(function(e){var s=_(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0}),n="inline"===(Xi(e)?p(e).getPropertyValue("display"):"inline")?"":" ";i+=`${n}${s}${n}`}),Xi(e)&&l){var s=as(c(e,"::after"));i=`${i} ${s}`}return i.trim()}function f(e,t){var s=e.getAttributeNode(t);return null===s||i.has(s)||""===s.value.trim()?null:(i.add(s),s.value)}function _(e,t){if(i.has(e))return"";if(!u&&function(e,t){if(!Xi(e))return!1;if(e.hasAttribute("hidden")||"true"===e.getAttribute("aria-hidden"))return!0;var i=t(e);return"none"===i.getPropertyValue("display")||"hidden"===i.getPropertyValue("visibility")}(e,p)&&!t.isReferenced)return i.add(e),"";var s=Xi(e)?e.getAttributeNode("aria-labelledby"):null,n=null===s||i.has(s)?[]:ss(e,"aria-labelledby");if("name"===o&&!t.isReferenced&&n.length>0)return i.add(s),n.map(function(e){return _(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!0,recursion:!1})}).join(" ");var r=t.recursion&&function(e){return ns(e,["button","combobox","listbox","textbox"])||rs(e,"range")}(e)&&"name"===o;if(!r){var a=(Xi(e)&&e.getAttribute("aria-label")||"").trim();if(""!==a&&"name"===o)return i.add(e),a;if(!function(e){return ns(e,Ji)}(e)){var l=function(e){if(!Xi(e))return null;if(function(e){return Xi(e)&&"fieldset"===Ki(e)}(e)){i.add(e);for(var t=Ui(e.childNodes),s=0;s<t.length;s+=1){var n=t[s];if(ts(n))return _(n,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(function(e){return Xi(e)&&"table"===Ki(e)}(e)){i.add(e);for(var r=Ui(e.childNodes),o=0;o<r.length;o+=1){var a=r[o];if(Qi(a))return _(a,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else{if(function(e){return Xi(e)&&"svg"===Ki(e)}(e)){i.add(e);for(var l=Ui(e.childNodes),d=0;d<l.length;d+=1){var c=l[d];if(is(c))return c.textContent}return null}if("img"===Ki(e)||"area"===Ki(e)){var h=f(e,"alt");if(null!==h)return h}else if(function(e){return Xi(e)&&"optgroup"===Ki(e)}(e)){var u=f(e,"label");if(null!==u)return u}}if(es(e)&&("button"===e.type||"submit"===e.type||"reset"===e.type)){var p=f(e,"value");if(null!==p)return p;if("submit"===e.type)return"Submit";if("reset"===e.type)return"Reset"}var b=function(e){var t=e.labels;return null===t?t:void 0!==t?Ui(t):ls(e)?Ui(e.ownerDocument.querySelectorAll("label")).filter(function(t){return cs(t)===e}):null}(e);if(null!==b&&0!==b.length)return i.add(e),Ui(b).map(function(e){return _(e,{isEmbeddedInLabel:!0,isReferenced:!1,recursion:!0})}).filter(function(e){return e.length>0}).join(" ");if(es(e)&&"image"===e.type){var g=f(e,"alt");if(null!==g)return g;var v=f(e,"title");return null===v?"Submit Query":v}if(ns(e,["button"])){var y=m(e,{isEmbeddedInLabel:!1,isReferenced:!1});if(""!==y)return y}return null}(e);if(null!==l)return i.add(e),l}}if(ns(e,["menu"]))return i.add(e),"";if(r||t.isEmbeddedInLabel||t.isReferenced){if(ns(e,["combobox","listbox"])){i.add(e);var d=function(e){return function(e){return Xi(e)&&"select"===Ki(e)}(e)?e.selectedOptions||os(e,"[selected]"):os(e,'[aria-selected="true"]')}(e);return 0===d.length?es(e)?e.value:"":Ui(d).map(function(e){return _(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0})}).join(" ")}if(rs(e,"range"))return i.add(e),e.hasAttribute("aria-valuetext")?e.getAttribute("aria-valuetext"):e.hasAttribute("aria-valuenow")?e.getAttribute("aria-valuenow"):e.getAttribute("value")||"";if(ns(e,["textbox"]))return i.add(e),function(e){return es(e)||function(e){return Xi(e)&&"textarea"===Ki(e)}(e)?e.value:e.textContent||""}(e)}if(function(e){return ns(e,["button","cell","checkbox","columnheader","gridcell","heading","label","legend","link","menuitem","menuitemcheckbox","menuitemradio","option","radio","row","rowheader","switch","tab","tooltip","treeitem"])}(e)||Xi(e)&&t.isReferenced||function(e){return Qi(e)}(e)){var c=m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});if(""!==c)return i.add(e),c}if(e.nodeType===e.TEXT_NODE)return i.add(e),e.textContent||"";if(t.recursion)return i.add(e),m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});var h=function(e){return Xi(e)?f(e,"title"):null}(e);return null===h?(i.add(e),""):(i.add(e),h)}return function(e){return e.trim().replace(/\s\s+/g," ")}(_(e,{isEmbeddedInLabel:!1,isReferenced:"description"===o,recursion:!1}))}const us="fill";var ps=new WeakMap,ms=class extends Li{static get styles(){return[...super.styles,fi,Oi]}constructor(){super(),nt(this,ps,async e=>{let t=Ee(this.action);if(t&&!this.disabled){e.preventDefault(),"http"===t.type&&(this.loading=!0);try{await Ne(t,{trigger:this,sourceEvent:e})}finally{this.loading=!1}}}),this.variant=us,this.inherit=!1,this.size="medium",this.active=!1,this.loading=!1,this.align="center",this.icon=null,this.action=null,this.href=null,this.target=null,this.rel=null,this.download=null,this.iconPosition="prefix",this._hasAccessibilityError=!1,this.linkHostStateApplied=!1,this.originalType=null,this.announcementTimer=null,this.type="button"}connectedCallback(){this.href&&!this.disabled&&(this.originalType=this.type,this.type="button",this.setAttribute("role","presentation"),this.linkHostStateApplied=!0),super.connectedCallback(),this.syncLinkHostState(),this.addEventListener("click",rt(ps,this))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",rt(ps,this)),this.announcementTimer&&(clearTimeout(this.announcementTimer),this.announcementTimer=null)}updated(e){super.updated(e),(e.has("href")||e.has("disabled"))&&this.syncLinkHostState(),e.has("loading")&&this.loading&&this.announceLoading()}announceLoading(){this.liveRegion.textContent=Qe("Loading"),this.announcementTimer&&clearTimeout(this.announcementTimer),this.announcementTimer=setTimeout(()=>{this.liveRegion.textContent=""},5e3)}syncLinkHostState(){this.isLink?(this.linkHostStateApplied||(this.originalType=this.type),this.setAttribute("role","presentation"),this.tabIndex=-1,this.type="button",this.linkHostStateApplied=!0):this.linkHostStateApplied&&(this.setAttribute("role","button"),this.type=this.originalType??"button",this.disabled||(this.tabIndex=0),this.linkHostStateApplied=!1)}async firstUpdated(e){super.firstUpdated(e),await this.updateComplete;let t=this.querySelectorAll("craft-icon, craft-spinner");if(await Promise.all(Array.from(t).map(e=>e.updateComplete)),!this.accessibleName){let e=this.isLink?this.shadowRoot?.querySelector("a.link")??this:this;this.accessibleName=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return function(e){return ns(e,["caption","code","deletion","emphasis","generic","insertion","none","paragraph","presentation","strong","subscript","superscript"])}(e)?"":hs(e,t)}(e)}this._hasAccessibilityError=!this.accessibleName||""===this.accessibleName.trim()}get isLink(){return!!this.href&&!this.disabled}get computedRel(){if("_blank"===this.target){let e=new Set((this.rel??"").split(/\s+/).filter(Boolean));return e.add("noopener"),Array.from(e).join(" ")}return this.rel}render(){let e=K`
      <div
        class="${Le({"button-content":!0,"button-content--start":"start"===this.align,"button-content--end":"end"===this.align,"a11y-error":this._hasAccessibilityError})}"
        part="content"
      >
        <slot name="prefix" class="prefix" part="prefix">
          ${this.icon&&"prefix"===this.iconPosition?K`<craft-icon name="${this.icon}"></craft-icon>`:Z}
        </slot>
        <slot class="label" part="label"></slot>
        <slot name="suffix" class="suffix" part="suffix">
          ${this.icon&&"suffix"===this.iconPosition?K`<craft-icon name="${this.icon}"></craft-icon>`:Z}
        </slot>
      </div>
      ${this.loading?K`<craft-spinner part="spinner"></craft-spinner>`:Z}
    ...
    `;return this.isLink?K`
        <a
          ...
          href="${this.href}"
          target="${this.target??Z}"
          rel="${this.computedRel??Z}"
          download="${this.download??Z}"
          >${e}</a
        >
      `:e}};_e([ve({attribute:"accessible-name"})],ms.prototype,"accessibleName",void 0),_e([ve({reflect:!0})],ms.prototype,"variant",void 0),_e([ve({reflect:!0,type:Boolean})],ms.prototype,"inherit",void 0),_e([ve({reflect:!0})],ms.prototype,"size",void 0),_e([ve({reflect:!0})],ms.prototype,"value",void 0),_e([ve({reflect:!0,type:Boolean})],ms.prototype,"active",void 0),_e([ve({reflect:!0,type:Boolean})],ms.prototype,"loading",void 0),_e([ve()],ms.prototype,"align",void 0),_e([ve()],ms.prototype,"icon",void 0),_e([ve({type:Object})],ms.prototype,"action",void 0),_e([ve({reflect:!0})],ms.prototype,"href",void 0),_e([ve()],ms.prototype,"target",void 0),_e([ve()],ms.prototype,"rel",void 0),_e([ve()],ms.prototype,"download",void 0),_e([ve({attribute:"icon-position"})],ms.prototype,"iconPosition",void 0),_e([ke("[data-live-region]")],ms.prototype,"liveRegion",void 0),_e([ye()],ms.prototype,"_hasAccessibilityError",void 0),customElements.get("craft-button")||customElements.define("craft-button",ms);var fs=l`
  :host {
    --c-color-fill-loud: var(--c-color-neutral-fill-loud);
    --c-color-fill-normal: var(--c-color-neutral-fill-normal);
    --c-color-fill-quiet: var(--c-color-neutral-fill-quiet);
...
`,_s=class extends pe{constructor(...e){super(...e),this.variant=Ae.Neutral,this.appearance=Kt.OutlineFill,this.title="",this.icon=null,this.hideIcon=!1,this.rounded="all",this.inline=!1}getDefaultIcon(){switch(this.variant){case Ae.Info:return"lightbulb";case Ae.Success:return"circle-check";case Ae.Warning:return"circle-exclamation";case Ae.Danger:return"triangle-exclamation";default:return null}}render(){return K`
      ${this.hideIcon?Z:K`<slot name="icon" class="callout__icon">
            <craft-icon
    ...
    `}};_s.styles=[fe,fs],_e([ve({reflect:!0})],_s.prototype,"variant",void 0),_e([ve({reflect:!0})],_s.prototype,"appearance",void 0),_e([ve()],_s.prototype,"title",void 0),_e([ve()],_s.prototype,"icon",void 0),_e([ve({type:Boolean,attribute:"hide-icon"})],_s.prototype,"hideIcon",void 0),_e([ve({reflect:!0})],_s.prototype,"rounded",void 0),_e([ve({reflect:!0,type:Boolean})],_s.prototype,"inline",void 0),customElements.get("craft-callout")||customElements.define("craft-callout",_s);var bs=l`
  :host {
    display: block;
  }
...
`,gs=class extends pe{constructor(...e){super(...e),this.label="",this.active=!1,this.showThumb=!0,this.thumbAlignment="start",this._hasThumbnail=!1,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["slot"]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasSlottedHeader=!!this.querySelector('[slot="header"]')||!!this.querySelector('[slot="label"]')||!!this.querySelector('[slot="actions"]'),this._hasSlottedFooter=!!this.querySelector('[slot="footer"]'),this._hasThumbnail=!!this.querySelector('[slot="thumbnail"]')}_handleThumbnailSlotChange(e){let t=e.target;this._hasThumbnail=t.assignedElements({flatten:!0}).length>0}render(){let e=!!this.label||this._hasSlottedHeader,t=this._hasSlottedFooter,i=this.showThumb&&this._hasThumbnail;return K`
      ...
      >
        ...
        <div
          class="${Le({"card-body":!0,"card-body--thumb-start":i&&"start"===this.thumbAlignment,"card-body--thumb-end":i&&"end"===this.thumbAlignment})}"
        >
    ...
    `}};gs.styles=[bs],_e([ve()],gs.prototype,"label",void 0),_e([ve({type:Boolean,reflect:!0})],gs.prototype,"active",void 0),_e([ve({attribute:"show-thumb",type:Boolean})],gs.prototype,"showThumb",void 0),_e([ve({attribute:"thumb-alignment"})],gs.prototype,"thumbAlignment",void 0),_e([ye()],gs.prototype,"_hasThumbnail",void 0),_e([ye()],gs.prototype,"_hasSlottedHeader",void 0),_e([ye()],gs.prototype,"_hasSlottedFooter",void 0),customElements.get("craft-card")||customElements.define("craft-card",gs);const{I:vs}=de,ys=()=>document.createComment(""),ws=(e,t,i)=>{const s=e._$AA.parentNode,n=void 0===t?e._$AB:t._$AA;if(void 0===i){const t=s.insertBefore(ys(),n),r=s.insertBefore(ys(),n);i=new vs(t,r,e,e.options)}else{const t=i._$AB.nextSibling,r=i._$AM,o=r!==e;if(o){let t;i._$AQ?.(e),i._$AM=e,void 0!==i._$AP&&(t=e._$AU)!==r._$AU&&i._$AP(t)}if(t!==n||o){let e=i._$AA;for(;e!==t;){const t=e.nextSibling;s.insertBefore(e,n),e=t}}}return i},ks=(e,t,i=e)=>(e._$AI(t,i),e),xs={},Cs=e=>{e._$AR(),e._$AA.remove()};function Es(e,t){let i=!1;Array.from(e.childNodes).forEach(e=>{const s=e.hasAttribute&&e.hasAttribute("slot");e.nodeType===Node.COMMENT_NODE&&!i&&(i=e.textContent.includes("_start_slot_")),i?e.textContent.includes("_end_slot_")&&(i=!1):s||t.appendChild(e)})}function Ns(e){return e instanceof Node?"node":(e=>void 0!==e?._$litType$)(e)?"template-result":!Array.isArray(e)&&"object"==typeof e&&"template"in e?"slot-rerender-object":null}const As=lt(e=>class extends e{get slots(){return{}}constructor(){super(),this.__renderMetaPerSlot=new Map,this.__slotsThatNeedRerender=new Set,this.__slotsProvidedByUserOnFirstConnected=new Set,this.__privateSlots=new Set}connectedCallback(){super.connectedCallback(),this._connectSlotMixin()}__rerenderSlot(e){const t=this.slots[e]();this.__renderTemplateInScopedContext({renderAsDirectHostChild:t.renderAsDirectHostChild,template:t.template,slotName:e}),t.afterRender?.()}update(e){super.update(e);for(const e of this.__slotsThatNeedRerender)this.__rerenderSlot(e)}__renderTemplateInScopedContext({template:e,slotName:t,renderAsDirectHostChild:i}){if(!this.__renderMetaPerSlot.has(t)){const s=!!ShadowRoot.prototype.createElement;Boolean(this.shadowRoot)||console.error("[SlotMixin] No shadowRoot was found");const n=(s?this.shadowRoot:document).createElement("div"),r=document.createComment(`_start_slot_${t}_`),o=document.createComment(`_end_slot_${t}_`);n.appendChild(r),n.appendChild(o);const{creationScope:a,host:l}=this.renderOptions;if(he(e,n,{renderBefore:o,creationScope:a,host:l}),i){const e=Array.from(n.childNodes);this.__appendNodes({nodes:e,renderParent:this,slotName:t})}else n.slot=t,this.appendChild(n);return void this.__renderMetaPerSlot.set(t,{renderTargetThatRespectsShadowRootScoping:n,renderBefore:o})}const{renderBefore:s,renderTargetThatRespectsShadowRootScoping:n}=this.__renderMetaPerSlot.get(t),r=i?this:n,{creationScope:o,host:a}=this.renderOptions;he(e,r,{creationScope:o,host:a,renderBefore:s}),i&&s.previousElementSibling&&!s.previousElementSibling.slot&&(s.previousElementSibling.slot=t)}__appendNodes({nodes:e,renderParent:t=this,slotName:i}){for(const s of e)s instanceof Element&&i&&""!==i&&s.setAttribute("slot",i),t.appendChild(s)}__initSlots(e){for(const t of e){if(this.__slotsProvidedByUserOnFirstConnected.has(t))continue;const e=this.slots[t]();if(void 0!==e)switch(this.__isConnectedSlotMixin||this.__privateSlots.add(t),Ns(e)){case"template-result":this.__renderTemplateInScopedContext({template:e,renderAsDirectHostChild:!0,slotName:t});break;case"node":this.__appendNodes({nodes:[e],renderParent:this,slotName:t});break;case"slot-rerender-object":this.__slotsThatNeedRerender.add(t),e.firstRenderOnConnected&&this.__rerenderSlot(t);break;default:throw new Error(`Slot "${t}" configured inside "get slots()" (in prototype) of ${this.constructor.name} may return these types: TemplateResult | Node | {template:TemplateResult, afterRender?:function} | undefined.\n              You provided: ${e}`)}}}_connectSlotMixin(){if(this.__isConnectedSlotMixin)return;const e=Object.keys(this.slots);for(const t of e)(""===t?Array.from(this.children).find(e=>!e.hasAttribute("slot")):Array.from(this.children).find(e=>e.slot===t))&&this.__slotsProvidedByUserOnFirstConnected.add(t);this.__initSlots(e),this.__isConnectedSlotMixin=!0}_isPrivateSlot(e){return this.__privateSlots.has(e)}}),Ss=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function $s(e,{reverse:t}={}){const i=e.filter(e=>e);return i.sort((e,t)=>{const i=e.compareDocumentPosition(t);return Ss.includes(i)?1:-1}),t&&i.reverse(),i}class Ts{constructor(e){this.type="unparseable",this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}}const Ls=lt(e=>class extends e{constructor(){super(),this.name="",this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||""}set name(e){const t=this.name;this.__name=e.toString(),this.requestUpdate("name",t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:"allow-cross-root-registration"}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent("form-element-register",{detail:{element:this},bubbles:!0,composed:Boolean(this.allowCrossRootRegistration)}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),Os=lt(e=>class extends(Ls(Ci(As(e)))){static get properties(){return{readOnly:{type:Boolean,attribute:"readonly",reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:"label-sr-only",reflect:!0},helpText:{type:String,attribute:"help-text"},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||"")}set label(e){const t=this.label;this.__label=e,this.requestUpdate("label",t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||"")}set helpText(e){const t=this.helpText;this.__helpText=e,this.requestUpdate("helpText",t)}get fieldName(){return this.__fieldName||this.label||this.name||""}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{const e=document.createElement("label");return e.textContent=this.label,e},"help-text":()=>{const e=document.createElement("div");return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild("input")}get _labelNode(){return this.__getDirectSlotChild("label")}get _helpTextNode(){return this.__getDirectSlotChild("help-text")}get _feedbackNode(){return this.__getDirectSlotChild("feedback")}static enabledWarnings=super.enabledWarnings?.filter(e=>"change-in-update"!==e)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=Pt(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole="child",this._isRepropagationEndpoint=!1,this.addEventListener("model-value-changed",this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener("click",this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener("click",this._onLabelClick)}updated(e){super.updated(e),e.has("disabled")&&this._inputNode?.setAttribute("aria-disabled",`${Boolean(this.disabled)}`),e.has("_ariaLabelledNodes")&&this.__reflectAriaAttr("aria-labelledby",this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has("_ariaDescribedNodes")&&this.__reflectAriaAttr("aria-describedby",this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has("label")&&void 0!==this.__label&&this._labelNode&&(this._labelNode.textContent=this.label),e.has("helpText")&&void 0!==this.__helpText&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has("name")&&this.dispatchEvent(new CustomEvent("form-element-name-changed",{detail:{oldName:e.get("name"),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add("form-control")}_enhanceLightDomA11y(){const{_inputNode:e,_labelNode:t,_helpTextNode:i,_feedbackNode:s}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute("for",this._inputId),this.addToAriaLabelledBy(t,{idPrefix:"label"})),i&&this.addToAriaDescribedBy(i,{idPrefix:"help-text"}),s&&(this.addEventListener("focusin",()=>{s.setAttribute("aria-live","polite")}),this.addEventListener("focusout",()=>{s.setAttribute("aria-live","assertive")}),this.addToAriaDescribedBy(s,{idPrefix:"feedback"})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=["prefix","suffix","before","after"]){e.forEach(e=>{const t=this.__getDirectSlotChild(e);t&&(t.hasAttribute("data-label")&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute("data-description")&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,i){if(this._inputNode){if(i){const e=t.filter(e=>this.contains(e)),i=t.filter(e=>!this.contains(e)),s=[...$s(e.map(e=>e.assignedSlot||e))],n=[];s.forEach(t=>{e.forEach(e=>{t.name===e.slot&&n.push(e)})}),t=[...n,...i]}const s=t.map(e=>e.id).join(" ");this._inputNode.setAttribute(e,s)}}render(){return K`
      ...
      `}_inputGroupPrefixTemplate(){return Array.from(this.children).find(e=>"prefix"===e.slot)?K`
          ...
          `:Z}_inputGroupInputTemplate(){return K`
      ...
      `}_inputGroupSuffixTemplate(){return Array.from(this.children).find(e=>"suffix"===e.slot)?K`
          ...
          `:Z}_inputGroupAfterTemplate(){return K`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;if(this.modelValue instanceof Ts&&(t=this.modelValue.viewValue),"object"==typeof t&&null!==t&&!(t instanceof Date))return!Object.keys(t).length;const i="number"==typeof t&&(0===t||Number.isNaN(t));return!(t||i||"boolean"==typeof t&&!1===t)}static get styles(){return[l`
          /**********************
            {block} .form-field
           ********************/
        ...
        `]}_getAriaDescriptionElements(){return[this._helpTextNode,this._feedbackNode]}addToAriaLabelledBy(e,{idPrefix:t="",reorder:i=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaLabelledNodes.includes(e)||(this._ariaLabelledNodes=[...this._ariaLabelledNodes,e],this.__reorderAriaLabelledNodes=Boolean(i))}removeFromAriaLabelledBy(e){this._ariaLabelledNodes.includes(e)&&(this._ariaLabelledNodes.splice(this._ariaLabelledNodes.indexOf(e),1),this._ariaLabelledNodes=[...this._ariaLabelledNodes],this.__reorderAriaLabelledNodes=!1)}addToAriaDescribedBy(e,{idPrefix:t="",reorder:i=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaDescribedNodes.includes(e)||(this._ariaDescribedNodes=[...this._ariaDescribedNodes,e],this.__reorderAriaDescribedNodes=Boolean(i))}removeFromAriaDescribedBy(e){this._ariaDescribedNodes.includes(e)&&(this._ariaDescribedNodes.splice(this._ariaDescribedNodes.indexOf(e),1),this._ariaDescribedNodes=[...this._ariaDescribedNodes],this.__reorderAriaLabelledNodes=!1)}__getDirectSlotChild(e){return Array.from(this.children).find(t=>t.slot===e)}_dispatchInitialModelValueChangedEvent(){"child"!==this._repropagationRole&&(this.__repropagateChildrenInitialized=!0,this.dispatchEvent(new CustomEvent("model-value-changed",{bubbles:!0,detail:{formPath:[this],initialize:!0,isTriggeredByUser:!1}})))}_onBeforeRepropagateChildrenValues(e){}__repropagateChildrenValues(e){this._onBeforeRepropagateChildrenValues(e);const t=e.detail&&e.detail.element||e.target,i=this._isRepropagationEndpoint||"choice-group"===this._repropagationRole;if(t===this)return;e.stopImmediatePropagation();const s="child"!==this._repropagationRole&&!this.__repropagateChildrenInitialized,n=e.detail&&e.detail.initialize;if(s||n)return;if(!this._repropagationCondition(t))return;let r=[];i||(r=e.detail&&e.detail.formPath||[t]);const o=[...r,this];this.dispatchEvent(new CustomEvent("model-value-changed",{bubbles:!0,detail:{formPath:o,isTriggeredByUser:Boolean(e.detail?.isTriggeredByUser)}}))}_repropagationCondition(e){return Boolean(e)}_onLabelClick(){}}),Fs=lt(e=>class extends(Os(e)){static get properties(){return{touched:{type:Boolean,reflect:!0},dirty:{type:Boolean,reflect:!0},filled:{type:Boolean,reflect:!0},prefilled:{attribute:!1},submitted:{attribute:!1}}}requestUpdate(e,t,i){super.requestUpdate(e,t,i),"touched"===e&&this.touched!==t&&this._onTouchedChanged(),"modelValue"===e&&(this.filled=!this._isEmpty()),"dirty"===e&&this.dirty!==t&&this._onDirtyChanged()}constructor(){super(),this.touched=!1,this.dirty=!1,this.prefilled=!1,this.filled=!1,this._leaveEvent="blur",this._valueChangedEvent="model-value-changed",this._iStateOnLeave=this._iStateOnLeave.bind(this),this._iStateOnValueChange=this._iStateOnValueChange.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(this._leaveEvent,this._iStateOnLeave),this.addEventListener(this._valueChangedEvent,this._iStateOnValueChange),this.initInteractionState()}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(this._leaveEvent,this._iStateOnLeave),this.removeEventListener(this._valueChangedEvent,this._iStateOnValueChange)}initInteractionState(){this.dirty=!1,this.prefilled=!this._isEmpty()}_iStateOnLeave(){this.touched=!0,this.prefilled=!this._isEmpty()}_iStateOnValueChange(){this.dirty=!0}resetInteractionState(){this.touched=!1,this.submitted=!1,this.dirty=!1,this.prefilled=!this._isEmpty()}_onTouchedChanged(){this.dispatchEvent(new Event("touched-changed",{bubbles:!0,composed:!0}))}_onDirtyChanged(){this.dispatchEvent(new Event("dirty-changed",{bubbles:!0,composed:!0}))}_showFeedbackConditionFor(e,t){return t.touched&&t.dirty||t.prefilled||t.submitted}get _feedbackConditionMeta(){return{...super._feedbackConditionMeta,submitted:this.submitted,touched:this.touched,dirty:this.dirty,filled:this.filled,prefilled:this.prefilled}}});class Ms extends Array{_keys(){return Object.keys(this).filter(e=>Number.isNaN(Number(e)))}}const Is=lt(e=>class extends(Ls(e)){static get properties(){return{_isFormOrFieldset:{type:Boolean}}}constructor(){super(),this.formElements=new Ms,this._isFormOrFieldset=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this._onRequestToChangeFormElementName=this._onRequestToChangeFormElementName.bind(this),this.addEventListener("form-element-register",this._onRequestToAddFormElement),this.addEventListener("form-element-name-changed",this._onRequestToChangeFormElementName),this.initComplete=new Promise((e,t)=>{this.__resolveInitComplete=e,this.__rejectInitComplete=t}),this.registrationComplete=new Promise((e,t)=>{this.__resolveRegistrationComplete=e,this.__rejectRegistrationComplete=t}),this.registrationComplete.done=!1,this.registrationComplete.then(()=>{this.registrationComplete.done=!0,this.__resolveInitComplete(void 0)},()=>{throw this.registrationComplete.done=!0,this.__rejectInitComplete(void 0),new Error("Registration could not finish. Please use await el.registrationComplete;")})}connectedCallback(){super.connectedCallback(),this._completeRegistration()}_completeRegistration(){Promise.resolve().then(()=>this.__resolveRegistrationComplete(void 0))}disconnectedCallback(){super.disconnectedCallback(),!1===this.registrationComplete.done&&Promise.resolve().then(()=>{Promise.resolve().then(()=>{this.__rejectRegistrationComplete()})})}isRegisteredFormElement(e){return this.formElements.some(t=>t===e)}addFormElement(e,t){if(e._parentFormGroup=this,t>=0?this.formElements.splice(t,0,e):this.formElements.push(e),this._isFormOrFieldset){const{name:i}=e;if(i===this.name)throw console.info("Error Node:",e),new TypeError(`You can not have the same name "${i}" as your parent`);if("[]"===i.substr(-2))Array.isArray(this.formElements[i])||(this.formElements[i]=new Ms),t>0?this.formElements[i].splice(t,0,e):this.formElements[i].push(e);else{if(this.formElements[i])throw console.info("Error Node:",e),new TypeError(`Name "${i}" is already registered - if you want an array add [] to the end`);this.formElements[i]=e}}}removeFormElement(e){const t=this.formElements.indexOf(e);if(t>-1&&this.formElements.splice(t,1),this._isFormOrFieldset){const{name:t}=e;if("[]"===t.substr(-2)&&this.formElements[t]){const i=this.formElements[t].indexOf(e);i>-1&&this.formElements[t].splice(i,1)}else this.formElements[t]&&delete this.formElements[t]}}_onRequestToAddFormElement(e){const t=e.detail.element;if(t===this)return;if(this.isRegisteredFormElement(t))return;e.stopPropagation();let i=-1;if(this.formElements&&Array.isArray(this.formElements))for(const[e,s]of this.formElements.entries())if(!(s.compareDocumentPosition(t)&Node.DOCUMENT_POSITION_FOLLOWING)){i=e;break}this.addFormElement(t,i)}_onRequestToChangeFormElementName(e){const t=this.formElements[e.detail.oldName];t&&(this.formElements[e.detail.newName]=t,delete this.formElements[e.detail.oldName])}_onRequestToRemoveFormElement(e){const t=e.detail.element;t!==this&&this.isRegisteredFormElement(t)&&(e.stopPropagation(),this.removeFormElement(t))}});function Ds(e,t){return e(t={exports:{}},t.exports),t.exports}var Vs="long",Rs="short",Ps="narrow",zs="numeric",Bs="2-digit",Us={number:{decimal:{style:"decimal"},integer:{style:"decimal",maximumFractionDigits:0},currency:{style:"currency",currency:"USD"},percent:{style:"percent"},default:{style:"decimal"}},date:{short:{month:zs,day:zs,year:Bs},medium:{month:Rs,day:zs,year:zs},long:{month:Vs,day:zs,year:zs},full:{month:Vs,day:zs,year:zs,weekday:Vs},default:{month:Rs,day:zs,year:zs}},time:{short:{hour:zs,minute:zs},medium:{hour:zs,minute:zs,second:zs},long:{hour:zs,minute:zs,second:zs,timeZoneName:Rs},full:{hour:zs,minute:zs,second:zs,timeZoneName:Rs},default:{hour:zs,minute:zs,second:zs}},duration:{default:{hours:{minimumIntegerDigits:1,maximumFractionDigits:0},minutes:{minimumIntegerDigits:2,maximumFractionDigits:0},seconds:{minimumIntegerDigits:2,maximumFractionDigits:3}}},parseNumberPattern:function(e){if(e){var t={},i=e.match(/\b[A-Z]{3}\b/i),s=e.replace(/[^¤]/g,"").length;if(!s&&i&&(s=1),s?(t.style="currency",t.currencyDisplay=1===s?"symbol":2===s?"code":"name",t.currency=i?i[0].toUpperCase():"USD"):e.indexOf("%")>=0&&(t.style="percent"),!/[@#0]/.test(e))return t.style?t:void 0;if(t.useGrouping=e.indexOf(",")>=0,/E\+?[@#0]+/i.test(e)||e.indexOf("@")>=0){var n=e.replace(/E\+?[@#0]+|[^@#0]/gi,"");t.minimumSignificantDigits=Math.min(Math.max(n.replace(/[^@0]/g,"").length,1),21),t.maximumSignificantDigits=Math.min(Math.max(n.length,1),21)}else{for(var r=e.replace(/[^#0.]/g,"").split("."),o=r[0],a=o.length-1;"0"===o[a];)--a;t.minimumIntegerDigits=Math.min(Math.max(o.length-1-a,1),21);var l=r[1]||"";for(a=0;"0"===l[a];)++a;for(t.minimumFractionDigits=Math.min(Math.max(a,0),20);"#"===l[a];)++a;t.maximumFractionDigits=Math.min(Math.max(a,0),20)}return t}},parseDatePattern:function(e){if(e){for(var t={},i=0;i<e.length;){for(var s=e[i],n=1;e[++i]===s;)++n;switch(s){case"G":t.era=5===n?Ps:4===n?Vs:Rs;break;case"y":case"Y":t.year=2===n?Bs:zs;break;case"M":case"L":n=Math.min(Math.max(n-1,0),4),t.month=[zs,Bs,Rs,Vs,Ps][n];break;case"E":case"e":case"c":t.weekday=5===n?Ps:4===n?Vs:Rs;break;case"d":case"D":t.day=2===n?Bs:zs;break;case"h":case"K":t.hour12=!0,t.hour=2===n?Bs:zs;break;case"H":case"k":t.hour12=!1,t.hour=2===n?Bs:zs;break;case"m":t.minute=2===n?Bs:zs;break;case"s":case"S":t.second=2===n?Bs:zs;break;case"z":case"Z":case"v":case"V":t.timeZoneName=1===n?Rs:Vs}}return Object.keys(t).length?t:void 0}}},qs="zero",Hs="one",Ws="two",js="few",Ks="many",Gs="other",Zs=[function(e){return 1===+e?Hs:Gs},function(e){var t=+e;return 0<=t&&t<=1?Hs:Gs},function(e){return 0===Math.floor(Math.abs(+e))||1===+e?Hs:Gs},function(e){var t=+e;return 0===t?qs:1===t?Hs:2===t?Ws:3<=t%100&&t%100<=10?js:11<=t%100&&t%100<=99?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length;return 1===t&&0===i?Hs:Gs},function(e){var t=+e;return t%10==1&&t%100!=11?Hs:2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?js:t%10==0||5<=t%10&&t%10<=9||11<=t%100&&t%100<=14?Ks:Gs},function(e){var t=+e;return t%10==1&&t%100!=11&&t%100!=71&&t%100!=91?Hs:t%10==2&&t%100!=12&&t%100!=72&&t%100!=92?Ws:(3<=t%10&&t%10<=4||t%10==9)&&(t%100<10||19<t%100)&&(t%100<70||79<t%100)&&(t%100<90||99<t%100)?js:0!==t&&t%1e6==0?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length,s=+(e+".").split(".")[1];return 0===i&&t%10==1&&t%100!=11||s%10==1&&s%100!=11?Hs:0===i&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)||2<=s%10&&s%10<=4&&(s%100<12||14<s%100)?js:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length;return 1===t&&0===i?Hs:2<=t&&t<=4&&0===i?js:0!==i?Ks:Gs},function(e){var t=+e;return 0===t?qs:1===t?Hs:2===t?Ws:3===t?js:6===t?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=+(""+e).replace(/^[^.]*.?|0+$/g,"");return 1===+e||0!==i&&(0===t||1===t)?Hs:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length,s=+(e+".").split(".")[1];return 0===i&&t%100==1||s%100==1?Hs:0===i&&t%100==2||s%100==2?Ws:0===i&&3<=t%100&&t%100<=4||3<=s%100&&s%100<=4?js:Gs},function(e){var t=Math.floor(Math.abs(+e));return 0===t||1===t?Hs:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length,s=+(e+".").split(".")[1];return 0===i&&(1===t||2===t||3===t)||0===i&&t%10!=4&&t%10!=6&&t%10!=9||0!==i&&s%10!=4&&s%10!=6&&s%10!=9?Hs:Gs},function(e){var t=+e;return 1===t?Hs:2===t?Ws:3<=t&&t<=6?js:7<=t&&t<=10?Ks:Gs},function(e){var t=+e;return 1===t||11===t?Hs:2===t||12===t?Ws:3<=t&&t<=10||13<=t&&t<=19?js:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length;return 0===i&&t%10==1?Hs:0===i&&t%10==2?Ws:0!==i||t%100!=0&&t%100!=20&&t%100!=40&&t%100!=60&&t%100!=80?0!==i?Ks:Gs:js},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length,s=+e;return 1===t&&0===i?Hs:2===t&&0===i?Ws:0===i&&(s<0||10<s)&&s%10==0?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=+(""+e).replace(/^[^.]*.?|0+$/g,"");return 0===i&&t%10==1&&t%100!=11||0!==i?Hs:Gs},function(e){var t=+e;return 1===t?Hs:2===t?Ws:Gs},function(e){var t=+e;return 0===t?qs:1===t?Hs:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=+e;return 0===i?qs:0!==t&&1!==t||0===i?Gs:Hs},function(e){var t=+(e+".").split(".")[1],i=+e;return i%10==1&&(i%100<11||19<i%100)?Hs:2<=i%10&&i%10<=9&&(i%100<11||19<i%100)?js:0!==t?Ks:Gs},function(e){var t=(e+".").split(".")[1].length,i=+(e+".").split(".")[1],s=+e;return s%10==0||11<=s%100&&s%100<=19||2===t&&11<=i%100&&i%100<=19?qs:s%10==1&&s%100!=11||2===t&&i%10==1&&i%100!=11||2!==t&&i%10==1?Hs:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length,s=+(e+".").split(".")[1];return 0===i&&t%10==1&&t%100!=11||s%10==1&&s%100!=11?Hs:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length,s=+e;return 1===t&&0===i?Hs:0!==i||0===s||1!==s&&1<=s%100&&s%100<=19?js:Gs},function(e){var t=+e;return 1===t?Hs:0===t||2<=t%100&&t%100<=10?js:11<=t%100&&t%100<=19?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length;return 1===t&&0===i?Hs:0===i&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?js:0===i&&1!==t&&0<=t%10&&t%10<=1||0===i&&5<=t%10&&t%10<=9||0===i&&12<=t%100&&t%100<=14?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e));return 0<=t&&t<=1?Hs:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length;return 0===i&&t%10==1&&t%100!=11?Hs:0===i&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?js:0===i&&t%10==0||0===i&&5<=t%10&&t%10<=9||0===i&&11<=t%100&&t%100<=14?Ks:Gs},function(e){var t=+e;return 0===Math.floor(Math.abs(+e))||1===t?Hs:2<=t&&t<=10?js:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=+(e+".").split(".")[1],s=+e;return 0===s||1===s||0===t&&1===i?Hs:Gs},function(e){var t=Math.floor(Math.abs(+e)),i=(e+".").split(".")[1].length;return 0===i&&t%100==1?Hs:0===i&&t%100==2?Ws:0===i&&3<=t%100&&t%100<=4||0!==i?js:Gs},function(e){var t=+e;return 0<=t&&t<=1||11<=t&&t<=99?Hs:Gs},function(e){var t=+e;return 1===t||5===t||7===t||8===t||9===t||10===t?Hs:2===t||3===t?Ws:4===t?js:6===t?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e));return t%10==1||t%10==2||t%10==5||t%10==7||t%10==8||t%100==20||t%100==50||t%100==70||t%100==80?Hs:t%10==3||t%10==4||t%1e3==100||t%1e3==200||t%1e3==300||t%1e3==400||t%1e3==500||t%1e3==600||t%1e3==700||t%1e3==800||t%1e3==900?js:0===t||t%10==6||t%100==40||t%100==60||t%100==90?Ks:Gs},function(e){var t=+e;return t%10!=2&&t%10!=3||t%100==12||t%100==13?Gs:js},function(e){var t=+e;return 1===t||3===t?Hs:2===t?Ws:4===t?js:Gs},function(e){var t=+e;return 0===t||7===t||8===t||9===t?qs:1===t?Hs:2===t?Ws:3===t||4===t?js:5===t||6===t?Ks:Gs},function(e){var t=+e;return t%10==1&&t%100!=11?Hs:t%10==2&&t%100!=12?Ws:t%10==3&&t%100!=13?js:Gs},function(e){var t=+e;return 1===t||11===t?Hs:2===t||12===t?Ws:3===t||13===t?js:Gs},function(e){var t=+e;return 1===t?Hs:2===t||3===t?Ws:4===t?js:6===t?Ks:Gs},function(e){var t=+e;return 1===t||5===t?Hs:Gs},function(e){var t=+e;return 11===t||8===t||80===t||800===t?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e));return 1===t?Hs:0===t||2<=t%100&&t%100<=20||t%100==40||t%100==60||t%100==80?Ks:Gs},function(e){var t=+e;return t%10==6||t%10==9||t%10==0&&0!==t?Ks:Gs},function(e){var t=Math.floor(Math.abs(+e));return t%10==1&&t%100!=11?Hs:t%10==2&&t%100!=12?Ws:t%10!=7&&t%10!=8||t%100==17||t%100==18?Gs:Ks},function(e){var t=+e;return 1===t?Hs:2===t||3===t?Ws:4===t?js:Gs},function(e){var t=+e;return 1<=t&&t<=4?Hs:Gs},function(e){var t=+e;return 1===t||5===t||7<=t&&t<=9?Hs:2===t||3===t?Ws:4===t?js:6===t?Ks:Gs},function(e){var t=+e;return 1===t?Hs:t%10==4&&t%100!=14?Ks:Gs},function(e){var t=+e;return t%10!=1&&t%10!=2||t%100==11||t%100==12?Gs:Hs},function(e){var t=+e;return t%10==6||t%10==9||10===t?js:Gs},function(e){var t=+e;return t%10==3&&t%100!=13?js:Gs}],Ys={af:{cardinal:Zs[0]},ak:{cardinal:Zs[1]},am:{cardinal:Zs[2]},ar:{cardinal:Zs[3]},ars:{cardinal:Zs[3]},as:{cardinal:Zs[2],ordinal:Zs[34]},asa:{cardinal:Zs[0]},ast:{cardinal:Zs[4]},az:{cardinal:Zs[0],ordinal:Zs[35]},be:{cardinal:Zs[5],ordinal:Zs[36]},bem:{cardinal:Zs[0]},bez:{cardinal:Zs[0]},bg:{cardinal:Zs[0]},bh:{cardinal:Zs[1]},bn:{cardinal:Zs[2],ordinal:Zs[34]},br:{cardinal:Zs[6]},brx:{cardinal:Zs[0]},bs:{cardinal:Zs[7]},ca:{cardinal:Zs[4],ordinal:Zs[37]},ce:{cardinal:Zs[0]},cgg:{cardinal:Zs[0]},chr:{cardinal:Zs[0]},ckb:{cardinal:Zs[0]},cs:{cardinal:Zs[8]},cy:{cardinal:Zs[9],ordinal:Zs[38]},da:{cardinal:Zs[10]},de:{cardinal:Zs[4]},dsb:{cardinal:Zs[11]},dv:{cardinal:Zs[0]},ee:{cardinal:Zs[0]},el:{cardinal:Zs[0]},en:{cardinal:Zs[4],ordinal:Zs[39]},eo:{cardinal:Zs[0]},es:{cardinal:Zs[0]},et:{cardinal:Zs[4]},eu:{cardinal:Zs[0]},fa:{cardinal:Zs[2]},ff:{cardinal:Zs[12]},fi:{cardinal:Zs[4]},fil:{cardinal:Zs[13],ordinal:Zs[0]},fo:{cardinal:Zs[0]},fr:{cardinal:Zs[12],ordinal:Zs[0]},fur:{cardinal:Zs[0]},fy:{cardinal:Zs[4]},ga:{cardinal:Zs[14],ordinal:Zs[0]},gd:{cardinal:Zs[15],ordinal:Zs[40]},gl:{cardinal:Zs[4]},gsw:{cardinal:Zs[0]},gu:{cardinal:Zs[2],ordinal:Zs[41]},guw:{cardinal:Zs[1]},gv:{cardinal:Zs[16]},ha:{cardinal:Zs[0]},haw:{cardinal:Zs[0]},he:{cardinal:Zs[17]},hi:{cardinal:Zs[2],ordinal:Zs[41]},hr:{cardinal:Zs[7]},hsb:{cardinal:Zs[11]},hu:{cardinal:Zs[0],ordinal:Zs[42]},hy:{cardinal:Zs[12],ordinal:Zs[0]},ia:{cardinal:Zs[4]},io:{cardinal:Zs[4]},is:{cardinal:Zs[18]},it:{cardinal:Zs[4],ordinal:Zs[43]},iu:{cardinal:Zs[19]},iw:{cardinal:Zs[17]},jgo:{cardinal:Zs[0]},ji:{cardinal:Zs[4]},jmc:{cardinal:Zs[0]},ka:{cardinal:Zs[0],ordinal:Zs[44]},kab:{cardinal:Zs[12]},kaj:{cardinal:Zs[0]},kcg:{cardinal:Zs[0]},kk:{cardinal:Zs[0],ordinal:Zs[45]},kkj:{cardinal:Zs[0]},kl:{cardinal:Zs[0]},kn:{cardinal:Zs[2]},ks:{cardinal:Zs[0]},ksb:{cardinal:Zs[0]},ksh:{cardinal:Zs[20]},ku:{cardinal:Zs[0]},kw:{cardinal:Zs[19]},ky:{cardinal:Zs[0]},lag:{cardinal:Zs[21]},lb:{cardinal:Zs[0]},lg:{cardinal:Zs[0]},ln:{cardinal:Zs[1]},lt:{cardinal:Zs[22]},lv:{cardinal:Zs[23]},mas:{cardinal:Zs[0]},mg:{cardinal:Zs[1]},mgo:{cardinal:Zs[0]},mk:{cardinal:Zs[24],ordinal:Zs[46]},ml:{cardinal:Zs[0]},mn:{cardinal:Zs[0]},mo:{cardinal:Zs[25],ordinal:Zs[0]},mr:{cardinal:Zs[2],ordinal:Zs[47]},mt:{cardinal:Zs[26]},nah:{cardinal:Zs[0]},naq:{cardinal:Zs[19]},nb:{cardinal:Zs[0]},nd:{cardinal:Zs[0]},ne:{cardinal:Zs[0],ordinal:Zs[48]},nl:{cardinal:Zs[4]},nn:{cardinal:Zs[0]},nnh:{cardinal:Zs[0]},no:{cardinal:Zs[0]},nr:{cardinal:Zs[0]},nso:{cardinal:Zs[1]},ny:{cardinal:Zs[0]},nyn:{cardinal:Zs[0]},om:{cardinal:Zs[0]},or:{cardinal:Zs[0],ordinal:Zs[49]},os:{cardinal:Zs[0]},pa:{cardinal:Zs[1]},pap:{cardinal:Zs[0]},pl:{cardinal:Zs[27]},prg:{cardinal:Zs[23]},ps:{cardinal:Zs[0]},pt:{cardinal:Zs[28]},"pt-PT":{cardinal:Zs[4]},rm:{cardinal:Zs[0]},ro:{cardinal:Zs[25],ordinal:Zs[0]},rof:{cardinal:Zs[0]},ru:{cardinal:Zs[29]},rwk:{cardinal:Zs[0]},saq:{cardinal:Zs[0]},sc:{cardinal:Zs[4],ordinal:Zs[43]},scn:{cardinal:Zs[4],ordinal:Zs[43]},sd:{cardinal:Zs[0]},sdh:{cardinal:Zs[0]},se:{cardinal:Zs[19]},seh:{cardinal:Zs[0]},sh:{cardinal:Zs[7]},shi:{cardinal:Zs[30]},si:{cardinal:Zs[31]},sk:{cardinal:Zs[8]},sl:{cardinal:Zs[32]},sma:{cardinal:Zs[19]},smi:{cardinal:Zs[19]},smj:{cardinal:Zs[19]},smn:{cardinal:Zs[19]},sms:{cardinal:Zs[19]},sn:{cardinal:Zs[0]},so:{cardinal:Zs[0]},sq:{cardinal:Zs[0],ordinal:Zs[50]},sr:{cardinal:Zs[7]},ss:{cardinal:Zs[0]},ssy:{cardinal:Zs[0]},st:{cardinal:Zs[0]},sv:{cardinal:Zs[4],ordinal:Zs[51]},sw:{cardinal:Zs[4]},syr:{cardinal:Zs[0]},ta:{cardinal:Zs[0]},te:{cardinal:Zs[0]},teo:{cardinal:Zs[0]},ti:{cardinal:Zs[1]},tig:{cardinal:Zs[0]},tk:{cardinal:Zs[0],ordinal:Zs[52]},tl:{cardinal:Zs[13],ordinal:Zs[0]},tn:{cardinal:Zs[0]},tr:{cardinal:Zs[0]},ts:{cardinal:Zs[0]},tzm:{cardinal:Zs[33]},ug:{cardinal:Zs[0]},uk:{cardinal:Zs[29],ordinal:Zs[53]},ur:{cardinal:Zs[4]},uz:{cardinal:Zs[0]},ve:{cardinal:Zs[0]},vo:{cardinal:Zs[0]},vun:{cardinal:Zs[0]},wa:{cardinal:Zs[1]},wae:{cardinal:Zs[0]},xh:{cardinal:Zs[0]},xog:{cardinal:Zs[0]},yi:{cardinal:Zs[4]},zu:{cardinal:Zs[2]},lo:{ordinal:Zs[0]},ms:{ordinal:Zs[0]},vi:{ordinal:Zs[0]}},Js=Ds(function(e,t){function i(e,t,n,r,o){var a=e.map(function(e){return function(e,t,n,r,o){if("string"==typeof e){var a=e;return function(){return a}}var d,c=e[0],h=e[1];if(t&&"#"===e[0]){c=t[0];var u=t[2],p=(r.number||l.number)([c,"number"],n);return function(e){return p(s(c,e)-u,e)}}"plural"===h||"selectordinal"===h?(d={},Object.keys(e[3]).forEach(function(t){d[t]=i(e[3][t],e,n,r,o)}),e=[e[0],e[1],e[2],d]):e[2]&&"object"==typeof e[2]&&(d={},Object.keys(e[2]).forEach(function(t){d[t]=i(e[2][t],e,n,r,o)}),e=[e[0],e[1],d]);var m=h&&(r[h]||l[h]);if(m){var f=m(e,n);return function(e){return f(s(c,e),e)}}return o?function(e){return String(s(c,e))}:function(e){return s(c,e)}}(e,t,n,r,o)});return o?1===a.length?a[0]:function(e){for(var t="",i=0;i<a.length;++i)t+=a[i](e);return t}:function(e){return a.reduce(function(t,i){return t.concat(i(e))},[])}}function s(e,t){if(t&&e in t)return t[e];for(var i=e.split("."),s=t,n=0,r=i.length;s&&n<r;++n)s=s[i[n]];return s}function n(e,t){var i=e[2],s=Us.number[i]||Us.parseNumberPattern(i)||Us.number.default;return new Intl.NumberFormat(t,s).format}function r(e,t){var i=e[1],s=e[2],n=Us[i][s]||Us.parseDatePattern(s)||Us[i].default;return new Intl.DateTimeFormat(t,n).format}function o(e,t){var i,s="selectordinal"===e[1]?"ordinal":"cardinal",n=e[2],r=e[3];if(Intl.PluralRules&&Intl.PluralRules.supportedLocalesOf(t).length>0)i=new Intl.PluralRules(t,{type:s});else{var o=function(e,t){if("string"==typeof e&&t[e])return e;for(var i=[].concat(e||[]),s=0,n=i.length;s<n;++s)for(var r=i[s].split("-");r.length;){var o=r.join("-");if(t[o])return o;r.pop()}}(t,Ys),l=o&&Ys[o][s]||a;i={select:l}}return function(e,t){return(r["="+ +e]||r[i.select(e-n)]||r.other)(t)}}function a(){return"other"}(t=e.exports=function(e,t,s){return i(e,null,t||"en",s||{},!0)}).toParts=function(e,t,s){return i(e,null,t||"en",s||{},!1)};var l={number:n,ordinal:n,spellout:n,duration:function(e,t){var i=e[2],s=Us.duration[i]||Us.duration.default,n=new Intl.NumberFormat(t,s.seconds).format,r=new Intl.NumberFormat(t,s.minutes).format,o=new Intl.NumberFormat(t,s.hours).format,a=/^fi$|^fi-|^da/.test(String(t))?".":":";return function(e,t){if(e=+e,!isFinite(e))return n(e);var i=~~(e/60/60),s=~~(e/60%60),l=(i?o(Math.abs(i))+a:"")+r(Math.abs(s))+a+n(Math.abs(e%60));return e<0?o(-1).replace(o(1),l):l}},date:r,time:r,plural:o,selectordinal:o,select:function(e,t){var i=e[2];return function(e,t){return(i[e]||i.other)(t)}}};t.types=l}),Xs=(Js.toParts,Js.types,Ds(function(e,t){var i="{",s="}",n=",",r="#",o="<",a=">",l="</",d="'",c=["number","date","time","ordinal","duration","spellout"],h=["plural","select","selectordinal"];function u(e,t){var i=e.pattern,n=i.length,r=[],o=e.index,a=p(e,t);for(a&&r.push(a),a&&e.tokens&&e.tokens.push(["text",i.slice(o,e.index)]);e.index<n;){if(i[e.index]===s){if(!t)throw k(e);break}if(t&&e.tagsType&&i.slice(e.index,e.index+2)===l)break;r.push(_(e)),o=e.index,(a=p(e,t))&&r.push(a),a&&e.tokens&&e.tokens.push(["text",i.slice(o,e.index)])}return r}function p(e,t){for(var n=e.pattern,a=n.length,l="plural"===t||"selectordinal"===t,c=!!e.tagsType,h="{style}"===t,u="";e.index<a;){var p=n[e.index];if(p===i||p===s||l&&p===r||c&&p===o||h&&m(p.charCodeAt(0)))break;if(p===d)if((p=n[++e.index])===d)u+=p,++e.index;else if(p===i||p===s||l&&p===r||c&&p===o||h)for(u+=p;++e.index<a;)if((p=n[e.index])===d&&n[e.index+1]===d)u+=d,++e.index;else{if(p===d){++e.index;break}u+=p}else u+=d;else u+=p,++e.index}return u}function m(e){return e>=9&&e<=13||32===e||133===e||160===e||6158===e||e>=8192&&e<=8205||8232===e||8233===e||8239===e||8287===e||8288===e||12288===e||65279===e}function f(e){for(var t=e.pattern,i=t.length,s=e.index;e.index<i&&m(t.charCodeAt(e.index));)++e.index;s<e.index&&e.tokens&&e.tokens.push(["space",e.pattern.slice(s,e.index)])}function _(e){var t=e.pattern;if(t[e.index]===r)return e.tokens&&e.tokens.push(["syntax",r]),++e.index,[r];var d=function(e){var t=e.tagsType;if(t&&e.pattern[e.index]===o){if(e.pattern.slice(e.index,e.index+2)===l)throw k(e,null,"closing tag without matching opening tag");e.tokens&&e.tokens.push(["syntax",o]),++e.index;var i=b(e,!0);if(!i)throw k(e,"placeholder id");if(e.tokens&&e.tokens.push(["id",i]),f(e),"/>"===e.pattern.slice(e.index,e.index+2))return e.tokens&&e.tokens.push(["syntax","/>"]),e.index+=2,[i,t];if(e.pattern[e.index]!==a)throw k(e,a);e.tokens&&e.tokens.push(["syntax",a]),++e.index;var s=u(e,t),n=e.index;if(e.pattern.slice(e.index,e.index+2)!==l)throw k(e,l+i+a);e.tokens&&e.tokens.push(["syntax",l]),e.index+=2;var r=b(e,!0);if(r&&e.tokens&&e.tokens.push(["id",r]),i!==r)throw e.index=n,k(e,l+i+a,l+r+a);if(f(e),e.pattern[e.index]!==a)throw k(e,a);return e.tokens&&e.tokens.push(["syntax",a]),++e.index,[i,t,{children:s}]}}(e);if(d)return d;if(t[e.index]!==i)throw k(e,i);e.tokens&&e.tokens.push(["syntax",i]),++e.index,f(e);var h=b(e);if(!h)throw k(e,"placeholder id");e.tokens&&e.tokens.push(["id",h]),f(e);var p=t[e.index];if(p===s)return e.tokens&&e.tokens.push(["syntax",s]),++e.index,[h];if(p!==n)throw k(e,", or }");e.tokens&&e.tokens.push(["syntax",n]),++e.index,f(e);var m,_=b(e);if(!_)throw k(e,"placeholder type");if(e.tokens&&e.tokens.push(["type",_]),f(e),(p=t[e.index])===s){if(e.tokens&&e.tokens.push(["syntax",s]),"plural"===_||"selectordinal"===_||"select"===_)throw k(e,_+" sub-messages");return++e.index,[h,_]}if(p!==n)throw k(e,", or }");if(e.tokens&&e.tokens.push(["syntax",n]),++e.index,f(e),"plural"===_||"selectordinal"===_){var w=function(e){var t=e.pattern,i=t.length,s=0;if("offset:"===t.slice(e.index,e.index+7)){e.tokens&&e.tokens.push(["offset","offset"],["syntax",":"]),e.index+=7,f(e);for(var n=e.index;e.index<i&&v(t.charCodeAt(e.index));)++e.index;if(n===e.index)throw k(e,"offset number");e.tokens&&e.tokens.push(["number",t.slice(n,e.index)]),s=+t.slice(n,e.index)}return s}(e);f(e),m=[h,_,w,y(e,_)]}else if("select"===_)m=[h,_,y(e,_)];else if(c.indexOf(_)>=0)m=[h,_,g(e)];else{var x=e.index,C=g(e);f(e),t[e.index]===i&&(e.index=x,C=y(e,_)),m=[h,_,C]}if(f(e),t[e.index]!==s)throw k(e,s);return e.tokens&&e.tokens.push(["syntax",s]),++e.index,m}function b(e,t){for(var l=e.pattern,c=l.length,h="";e.index<c;){var u=l[e.index];if(u===i||u===s||u===n||u===r||u===d||m(u.charCodeAt(0))||t&&(u===o||u===a||"/"===u))break;h+=u,++e.index}return h}function g(e){var t=e.index,i=p(e,"{style}");if(!i)throw k(e,"placeholder style name");return e.tokens&&e.tokens.push(["style",e.pattern.slice(t,e.index)]),i}function v(e){return e>=48&&e<=57}function y(e,t){for(var i=e.pattern,n=i.length,r={};e.index<n&&i[e.index]!==s;){var o=b(e);if(!o)throw k(e,"sub-message selector");e.tokens&&e.tokens.push(["selector",o]),f(e),r[o]=w(e,t),f(e)}if(!r.other&&h.indexOf(t)>=0)throw k(e,null,null,'"other" sub-message must be specified in '+t);return r}function w(e,t){if(e.pattern[e.index]!==i)throw k(e,"{ to start sub-message");e.tokens&&e.tokens.push(["syntax",i]),++e.index;var n=u(e,t);if(e.pattern[e.index]!==s)throw k(e,"} to end sub-message");return e.tokens&&e.tokens.push(["syntax",s]),++e.index,n}function k(e,t,i,s){var n=e.pattern,r=n.slice(0,e.index).split(/\r?\n/),o=e.index,a=r.length,l=r.slice(-1)[0].length;return i=i||(e.index>=n.length?"end of message pattern":b(e)||n[e.index]),s||(s=function(e,t){return e?"Expected "+e+" but found "+t:"Unexpected "+t+" found"}(t,i)),new x(s+=" in "+n.replace(/\r?\n/g,"\n"),t,i,o,a,l)}function x(e,t,i,s,n,r){Error.call(this,e),this.name="SyntaxError",this.message=e,this.expected=t,this.found=i,this.offset=s,this.line=n,this.column=r}t=e.exports=function(e,t){return u({pattern:String(e),index:0,tagsType:t&&t.tagsType||null,tokens:t&&t.tokens||null},"")},x.prototype=Object.create(Error.prototype),t.SyntaxError=x})),Qs=(Xs.SyntaxError,new RegExp("^("+Object.keys(Ys).join("|")+")\\b")),en=new WeakMap;function tn(e,t,i){if(!(this instanceof tn)||en.has(this))throw new TypeError("calling MessageFormat constructor without new is invalid");var s=Xs(e);en.set(this,{ast:s,format:Js(s,t,i&&i.types),locale:tn.supportedLocalesOf(t)[0]||"en",locales:t,options:i})}var sn=tn;Object.defineProperties(tn.prototype,{format:{configurable:!0,get:function(){var e=en.get(this);if(!e)throw new TypeError("MessageFormat.prototype.format called on value that's not an object initialized as a MessageFormat");return e.format}},formatToParts:{configurable:!0,writable:!0,value:function(e){var t=en.get(this);if(!t)throw new TypeError("MessageFormat.prototype.formatToParts called on value that's not an object initialized as a MessageFormat");return(t.toParts||(t.toParts=Js.toParts(t.ast,t.locales,t.options&&t.options.types)))(e)}},resolvedOptions:{configurable:!0,writable:!0,value:function(){var e=en.get(this);if(!e)throw new TypeError("MessageFormat.prototype.resolvedOptions called on value that's not an object initialized as a MessageFormat");return{locale:e.locale}}}}),"undefined"!=typeof Symbol&&Object.defineProperty(tn.prototype,Symbol.toStringTag,{value:"Object"}),Object.defineProperties(tn,{supportedLocalesOf:{configurable:!0,writable:!0,value:function(e){return[].concat(Intl.NumberFormat.supportedLocalesOf(e),Intl.DateTimeFormat.supportedLocalesOf(e),Intl.PluralRules?Intl.PluralRules.supportedLocalesOf(e):[],[].concat(e||[]).filter(function(e){return Qs.test(e)})).filter(function(e,t,i){return i.indexOf(e)===t})}}});var nn=sn;const rn=globalThis.document?.documentElement;class on extends EventTarget{formatNumberOptions={returnIfNaN:"",postProcessors:new Map};formatDateOptions={postProcessors:new Map};#h=!1;#u="";#p=null;__storage={};__namespacePatternsMap=new Map;__namespaceLoadersCache={};__namespaceLoaderPromisesCache={};get locale(){return this.#h?this.#u||"":rn.lang||""}set locale(e){if(this.#m(e),!this.#h){const t=rn.lang;return this._setHtmlLangAttribute(e),void this._onLocaleChanged(e,t)}const t=this.#u;this.#u=e,null===this.#p&&this._setHtmlLangAttribute(e),this._onLocaleChanged(e,t)}get loadingComplete(){return"object"==typeof this.__namespaceLoaderPromisesCache[this.locale]?Promise.all(Object.values(this.__namespaceLoaderPromisesCache[this.locale])):Promise.resolve()}constructor({allowOverridesForExistingNamespaces:e=!1,autoLoadOnLocaleChange:t=!1,showKeyAsFallback:i=!1,fallbackLocale:s=""}={}){super(),this.__allowOverridesForExistingNamespaces=e,this._autoLoadOnLocaleChange=!!t,this._showKeyAsFallback=i,this._fallbackLocale=s;const n=rn.getAttribute("data-localize-lang");this.#h=Boolean(n),this.#h&&(this.locale=n,this._setupTranslationToolSupport()),rn.lang||(rn.lang=this.locale||"en-GB"),this._setupHtmlLangAttributeObserver()}addData(e,t,i){if(!this.__allowOverridesForExistingNamespaces&&this._isNamespaceInCache(e,t))throw new Error(`Namespace "${t}" has been already added for the locale "${e}".`);this.__storage[e]=this.__storage[e]||{},this.__allowOverridesForExistingNamespaces?this.__storage[e][t]={...this.__storage[e][t],...i}:this.__storage[e][t]=i}setupNamespaceLoader(e,t){this.__namespacePatternsMap.set(e,t)}loadNamespaces(e,{locale:t}={}){return Promise.all(e.map(e=>this.loadNamespace(e,{locale:t})))}loadNamespace(e,{locale:t=this.locale}={locale:this.locale}){const i="object"==typeof e,s=i?Object.keys(e)[0]:e;if(this._isNamespaceInCache(t,s))return Promise.resolve();return this._getCachedNamespaceLoaderPromise(t,s)||this._loadNamespaceData(t,e,i,s)}msg(e,t,i={}){const s=i.locale?i.locale:this.locale,n=this._getMessageForKeys(e,s);return n?new nn(n,s).format(t):""}teardown(){this._teardownHtmlLangAttributeObserver()}reset(){this.__storage={},this.__namespacePatternsMap=new Map,this.__namespaceLoadersCache={},this.__namespaceLoaderPromisesCache={}}setDatePostProcessorForLocale({locale:e,postProcessor:t}){this.formatDateOptions?.postProcessors.set(e,t)}setNumberPostProcessorForLocale({locale:e,postProcessor:t}){this.formatNumberOptions?.postProcessors.set(e,t)}_setupTranslationToolSupport(){this.#p=rn.lang||null}_setHtmlLangAttribute(e){this._teardownHtmlLangAttributeObserver(),rn.lang=e,this._setupHtmlLangAttributeObserver()}_setupHtmlLangAttributeObserver(){this._htmlLangAttributeObserver||(this._htmlLangAttributeObserver=new MutationObserver(e=>{e.forEach(e=>{this.#h?"auto"===rn.lang?(this.#p=null,this._setHtmlLangAttribute(this.locale)):this.#p=document.documentElement.lang:this._onLocaleChanged(document.documentElement.lang,e.oldValue||"")})})),this._htmlLangAttributeObserver.observe(document.documentElement,{attributes:!0,attributeFilter:["lang"],attributeOldValue:!0})}_teardownHtmlLangAttributeObserver(){this._htmlLangAttributeObserver&&this._htmlLangAttributeObserver.disconnect()}_isNamespaceInCache(e,t){return!(!this.__storage[e]||!this.__storage[e][t])}_getCachedNamespaceLoaderPromise(e,t){return this.__namespaceLoaderPromisesCache[e]?this.__namespaceLoaderPromisesCache[e][t]:null}_loadNamespaceData(e,t,i,s){const n=this._getNamespaceLoader(t,i,s),r=this._getNamespaceLoaderPromise(n,e,s);return this._cacheNamespaceLoaderPromise(e,s,r),r.then(t=>{if(this.__namespaceLoaderPromisesCache[e]&&this.__namespaceLoaderPromisesCache[e][s]===r){const i=function(e){return!(!e||!e.default||"object"!=typeof e.default||1!==Object.keys(e).length)}(t)?t.default:t;this.addData(e,s,i)}})}_getNamespaceLoader(e,t,i){let s=this.__namespaceLoadersCache[i];if(s||(t?(s=e[i],this.__namespaceLoadersCache[i]=s):(s=this._lookupNamespaceLoader(i),this.__namespaceLoadersCache[i]=s)),!s)throw new Error(`Namespace "${i}" was not properly setup.`);return this.__namespaceLoadersCache[i]=s,s}_getNamespaceLoaderPromise(e,t,i,s=this._fallbackLocale){return e(t,i).catch(()=>{const n=this._getLangFromLocale(t);return e(n,i).catch(()=>{if(s)return this._getNamespaceLoaderPromise(e,s,i,"").catch(()=>{const e=this._getLangFromLocale(s);throw new Error(`Data for namespace "${i}" and current locale "${t}" or fallback locale "${s}" could not be loaded. Make sure you have data either for locale "${t}" (and/or generic language "${n}") or for fallback "${s}" (and/or "${e}").`)});throw new Error(`Data for namespace "${i}" and locale "${t}" could not be loaded. Make sure you have data for locale "${t}" (and/or generic language "${n}").`)})})}_cacheNamespaceLoaderPromise(e,t,i){this.__namespaceLoaderPromisesCache[e]||(this.__namespaceLoaderPromisesCache[e]={}),this.__namespaceLoaderPromisesCache[e][t]=i}_lookupNamespaceLoader(e){for(const[t,i]of this.__namespacePatternsMap){const s="string"==typeof t&&t===e,n="object"==typeof t&&"RegExp"===t.constructor.name&&t.test(e);if(s||n)return i}return null}_getLangFromLocale(e){return e.substring(0,2)}_onLocaleChanged(e,t){this.dispatchEvent(new CustomEvent("__localeChanging")),e!==t&&(this._autoLoadOnLocaleChange?(this._loadAllMissing(e,t),this.loadingComplete.then(()=>{this.dispatchEvent(new CustomEvent("localeChanged",{detail:{newLocale:e,oldLocale:t}}))})):this.dispatchEvent(new CustomEvent("localeChanged",{detail:{newLocale:e,oldLocale:t}})))}_loadAllMissing(e,t){const i=this.__storage[t]||{},s=this.__storage[e]||{};Object.keys(i).forEach(t=>{s[t]||this.loadNamespace(t,{locale:e})})}_getMessageForKeys(e,t){if("string"==typeof e)return this._getMessageForKey(e,t);const i=Array.from(e).reverse();let s,n;for(;i.length;)if(s=i.pop(),n=this._getMessageForKey(s,t),n)return n}_getMessageForKey(e,t){if(!e||-1===e.indexOf(":"))throw new Error(`Namespace is missing in the key "${e}". The format for keys is "namespace:name".`);const[i,s]=e.split(":"),n=this.__storage[t],r=n?n[i]:{},o=s.split(".").reduce((e,t)=>"object"==typeof e?e[t]:e,r);return String(o||(this._showKeyAsFallback?e:""))}#m(e){if(!e.includes("-"))throw new Error(`\n      Locale was set to ${e}.\n      Language only locales are not allowed, please use the full language locale e.g. 'en-GB' instead of 'en'.\n      See https://github.com/ing-bank/lion/issues/187 for more information.\n    `)}get _supportExternalTranslationTools(){return this.#h}set _supportExternalTranslationTools(e){this.#h=e}get _langAttrSetByTranslationTool(){return this.#u}set _langAttrSetByTranslationTool(e){this.#u=e}}function an(){if(!ut.has("@lion/ui::localize::0.x")){const e=new on({autoLoadOnLocaleChange:!0,fallbackLocale:"en-GB"});ut.set("@lion/ui::localize::0.x",e)}return ut.get("@lion/ui::localize::0.x")}function ln(){return ht(an)}const dn="3.0.0",cn=window.scopedElementsVersions||(window.scopedElementsVersions=[]);cn.includes(dn)||cn.push(dn);const hn=lt(e=>class extends e{static scopedElements;static get scopedElementsVersion(){return dn}static __registry;get registry(){return this.constructor.__registry}set registry(e){this.constructor.__registry=e}attachShadow(e){const{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,"__registry")){this.registry=new CustomElementRegistry;for(const[e,i]of Object.entries(t??{}))this.registry.define(e,i)}return super.attachShadow({...e,customElements:this.registry,registry:this.registry})}}),un=lt(e=>class extends(hn(e)){createRenderRoot(){const{shadowRootOptions:e,elementStyles:t}=this.constructor,i=this.attachShadow(e);return this.renderOptions.creationScope=i,d(i,t),this.renderOptions.renderBefore??=i.firstChild,i}});function pn(){return Boolean(globalThis.ShadowRoot?.prototype.createElement&&globalThis.ShadowRoot?.prototype.importNode)}const mn=lt(e=>class extends(un(e)){constructor(){super()}createScopedElement(e){return(pn()?this.shadowRoot:document).createElement(e)}defineScopedElement(e,t){const i=this.registry.get(e),s=i&&i!==t;return!pn()&&s&&console.error([`You are trying to re-register the "${e}" custom element with a different class via ScopedElementsMixin.`,"This is only possible with a CustomElementRegistry.","Your browser does not support this feature so you will need to load a polyfill for it.",'Load "@webcomponents/scoped-custom-element-registry" before you register ANY web component to the global customElements registry.','e.g. add "<script src="/node_modules/@webcomponents/scoped-custom-element-registry/scoped-custom-element-registry.min.js"><\/script>" as your first script tag.',"For more details you can visit https://open-wc.org/docs/development/scoped-elements/"].join("\n")),i?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){const{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,"__registry")){this.registry=pn()?new CustomElementRegistry:customElements;for(const[e,i]of Object.entries(t??{}))this.defineScopedElement(e,i)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){const{shadowRootOptions:e,elementStyles:t}=this.constructor,i=this.attachShadow(e);return pn()&&(this.renderOptions.creationScope=i),i instanceof ShadowRoot&&(d(i,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||i.firstChild),i}});class fn{constructor(){this.__running=!1,this.__queue=[]}add(e){this.__queue.push(e),this.__running||(this.complete=new Promise(e=>{this.__callComplete=e}),this.__run())}async __run(){this.__running=!0,await this.__queue[0](),this.__queue.shift(),this.__queue.length>0?this.__run():(this.__running=!1,this.__callComplete&&this.__callComplete())}}const _n=lt(e=>class extends e{constructor(){super(),this.__SyncUpdatableNamespace={}}firstUpdated(e){super.firstUpdated(e),this.__syncUpdatableInitialize()}connectedCallback(){super.connectedCallback(),this.__SyncUpdatableNamespace.connected=!0}disconnectedCallback(){super.disconnectedCallback(),this.__SyncUpdatableNamespace.connected=!1}static enabledWarnings=super.enabledWarnings?.filter(e=>"change-in-update"!==e)||[];static __syncUpdatableHasChanged(e,t,i){const s=this.elementProperties;return s.get(e)&&s.get(e).hasChanged?s.get(e).hasChanged(t,i):t!==i}__syncUpdatableInitialize(){const e=this.__SyncUpdatableNamespace,t=this.constructor;e.initialized=!0,e.queue&&Array.from(e.queue).forEach(e=>{t.__syncUpdatableHasChanged(e,this[e],void 0)&&this.updateSync(e,void 0)})}requestUpdate(e,t,i){if(super.requestUpdate(e,t,i),void 0===e)return;this.__SyncUpdatableNamespace=this.__SyncUpdatableNamespace||{};const s=this.__SyncUpdatableNamespace,n=this.constructor;s.initialized?n.__syncUpdatableHasChanged(e,this[e],t)&&this.updateSync(e,t):(s.queue=s.queue||new Set,s.queue.add(e))}updateSync(e,t){}}),bn=(e,t)=>{const i=e._$AN;if(void 0===i)return!1;for(const e of i)e._$AO?.(t,!1),bn(e,t);return!0},gn=e=>{let t,i;do{if(void 0===(t=e._$AM))break;i=t._$AN,i.delete(e),e=t}while(0===i?.size)},vn=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),kn(t)}};function yn(e){void 0!==this._$AN?(gn(this),this._$AM=e,vn(this)):this._$AM=e}function wn(e,t=!1,i=0){const s=this._$AH,n=this._$AN;if(void 0!==n&&0!==n.size)if(t)if(Array.isArray(s))for(let e=i;e<s.length;e++)bn(s[e],!1),gn(s[e]);else null!=s&&(bn(s,!1),gn(s));else bn(this,e)}const kn=e=>{2==e.type&&(e._$AP??=wn,e._$AQ??=yn)};class xn extends Te{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),vn(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(bn(this,e),gn(this))}setValue(e){if((()=>void 0===this._$Ct.strings)())this._$Ct._$AI(e,this);else{const t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}}class Cn{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}}class En{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(e=>this.Z=e)}resume(){this.Z?.(),this.Y=this.Z=void 0}}const Nn=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,An=1073741823,Sn=$e(class extends xn{constructor(){super(...arguments),this._$Cwt=An,this._$Cbt=[],this._$CK=new Cn(this),this._$CX=new En}render(...e){return e.find(e=>!Nn(e))??G}update(e,t){const i=this._$Cbt;let s=i.length;this._$Cbt=t;const n=this._$CK,r=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){const o=t[e];if(!Nn(o))return this._$Cwt=e,o;e<s&&o===i[e]||(this._$Cwt=An,s=0,Promise.resolve(o).then(async e=>{for(;r.get();)await r.get();const t=n.deref();if(void 0!==t){const i=t._$Cbt.indexOf(o);i>-1&&i<t._$Cwt&&(t._$Cwt=i,t.setValue(e))}}))}return G}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),$n=lt(e=>class extends e{static get localizeNamespaces(){return[]}static get waitForLocalizeNamespaces(){return!0}constructor(){super(),this._localizeManager=ln(),this.__boundLocalizeOnLocaleChanged=(...e)=>{const t=Array.from(e)[0];this.__localizeOnLocaleChanged(t)},this.__boundLocalizeOnLocaleChanging=()=>{this.__localizeOnLocaleChanging()},this.__localizeStartLoadingNamespaces(),this.localizeNamespacesLoaded&&this.localizeNamespacesLoaded.then(()=>{this.__localizeMessageSync=!0})}async scheduleUpdate(){Object.getPrototypeOf(this).constructor.waitForLocalizeNamespaces&&await this.localizeNamespacesLoaded,super.scheduleUpdate()}connectedCallback(){super.connectedCallback(),this.localizeNamespacesLoaded&&this.localizeNamespacesLoaded.then(()=>this.onLocaleReady()),this._localizeManager.addEventListener("__localeChanging",this.__boundLocalizeOnLocaleChanging),this._localizeManager.addEventListener("localeChanged",this.__boundLocalizeOnLocaleChanged)}disconnectedCallback(){super.disconnectedCallback(),this._localizeManager.removeEventListener("__localeChanging",this.__boundLocalizeOnLocaleChanging),this._localizeManager.removeEventListener("localeChanged",this.__boundLocalizeOnLocaleChanged)}msgLit(e,t,i){return this.__localizeMessageSync?this._localizeManager.msg(e,t,i):this.localizeNamespacesLoaded?Sn(this.localizeNamespacesLoaded.then(()=>this._localizeManager.msg(e,t,i)),Z):""}__getUniqueNamespaces(){const e=[],t=new Set;return Object.getPrototypeOf(this).constructor.localizeNamespaces.forEach(t.add.bind(t)),t.forEach(t=>{e.push(t)}),e}__localizeStartLoadingNamespaces(){this.localizeNamespacesLoaded=this._localizeManager.loadNamespaces(this.__getUniqueNamespaces())}__localizeOnLocaleChanging(){this.__localizeStartLoadingNamespaces()}__localizeOnLocaleChanged(e){this.onLocaleChanged(e.detail.newLocale,e.detail.oldLocale)}onLocaleReady(){this.onLocaleUpdated()}onLocaleChanged(e,t){this.onLocaleUpdated(),this.requestUpdate()}onLocaleUpdated(){}}),Tn=e=>{switch(e){case"bg-BG":return i.e(6952).then(i.bind(i,6952));case"bg":return i.e(2038).then(i.bind(i,2038));case"cs-CZ":return i.e(1645).then(i.bind(i,1645));case"cs":return i.e(167).then(i.bind(i,167));case"de-DE":return i.e(7472).then(i.bind(i,7472));case"de":return i.e(3902).then(i.bind(i,3902));case"en-AU":return i.e(6617).then(i.bind(i,6617));case"en-GB":return i.e(2922).then(i.bind(i,2922));case"en-US":return i.e(3055).then(i.bind(i,3055));case"en-PH":case"en":default:return i.e(3474).then(i.bind(i,3474));case"es-ES":return i.e(8722).then(i.bind(i,8722));case"es":return i.e(2437).then(i.bind(i,2437));case"fr-FR":return i.e(7426).then(i.bind(i,7426));case"fr-BE":return i.e(4487).then(i.bind(i,4487));case"fr":return i.e(2637).then(i.bind(i,2637));case"hu-HU":return i.e(8160).then(i.bind(i,8160));case"hu":return i.e(9770).then(i.bind(i,9770));case"it-IT":return i.e(1144).then(i.bind(i,1144));case"it":return i.e(4332).then(i.bind(i,4332));case"nl-BE":return i.e(3585).then(i.bind(i,3585));case"nl-NL":return i.e(6102).then(i.bind(i,6102));case"nl":return i.e(6559).then(i.bind(i,6559));case"pl-PL":return i.e(5598).then(i.bind(i,5598));case"pl":return i.e(1593).then(i.bind(i,1593));case"ro-RO":return i.e(4504).then(i.bind(i,4504));case"ro":return i.e(3566).then(i.bind(i,3566));case"ru-RU":return i.e(9944).then(i.bind(i,9944));case"ru":return i.e(2028).then(i.bind(i,2028));case"sk-SK":return i.e(8742).then(i.bind(i,8742));case"sk":return i.e(1967).then(i.bind(i,1967));case"tr-TR":return i.e(2722).then(i.bind(i,2722));case"tr":return i.e(767).then(i.bind(i,767));case"uk-UA":return i.e(5600).then(i.bind(i,5600));case"uk":return i.e(7229).then(i.bind(i,7229));case"zh-CN":case"zh":return i.e(7831).then(i.bind(i,7831))}};class Ln extends($n(pe)){static get properties(){return{feedbackData:{attribute:!1}}}static localizeNamespaces=[{"lion-form-core":Tn},...super.localizeNamespaces];static get styles(){return[l`
    ...
    `}_onRequestToAddFormElement(e){e.target.hasAttribute("role")||e.target?.setAttribute("role","listitem"),this.__addToSubCheckboxes(e.detail.element),this._setOwnCheckedState()}_onRequestToRemoveFormElement(e){"listitem"===e.target.getAttribute("role")&&e.target?.removeAttribute("role"),this.__removeFromSubCheckboxes(e.detail.element)}__addToSubCheckboxes(e){e!==this&&this.contains(e)&&this.__subCheckboxes.push(e)}__removeFromSubCheckboxes(e){const t=this.__subCheckboxes.indexOf(e);-1!==t&&this.__subCheckboxes.splice(t,1)}constructor(){super(),this.indeterminate=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this.__onModelValueChanged=this.__onModelValueChanged.bind(this),this.__subCheckboxes=[],this._indeterminateSubStates=[],this.mixedState=!1}connectedCallback(){super.connectedCallback(),this.addEventListener("model-value-changed",this.__onModelValueChanged),this.addEventListener("form-element-register",this._onRequestToAddFormElement)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("model-value-changed",this.__onModelValueChanged),this.removeEventListener("form-element-register",this._onRequestToAddFormElement)}firstUpdated(e){super.firstUpdated(e),this._setOldState(),this.indeterminate&&this._storeIndeterminateState()}updated(e){super.updated(e),(e.has("indeterminate")||e.has("checked"))&&(this._inputNode.indeterminate=this.indeterminate)}}customElements.get("craft-checkbox-indeterminate")||customElements.define("craft-checkbox-indeterminate",class extends Zn{static get styles(){return[...Zn.styles,l`
      ...
      `]}});const Yn=e=>class extends e{constructor(...e){super(...e),this.__ssrStateAdopted=!1}set value(e){""===e&&!this.__ssrStateAdopted&&this.__slottedInput()?.hasAttribute("value")||(super.value=e)}get value(){return super.value}connectedCallback(){this.__adoptSlottedInputState(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedInputState(),super.willUpdate(e)}updated(e){super.updated(e);let{_inputNode:t}=this,i=this.choiceValue;"string"==typeof i&&""!==i&&t instanceof HTMLInputElement&&t.value!==i&&(t.value=i)}__slottedInput(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&"input"===e.slot)}__adoptSlottedInputState(){if(this.__ssrStateAdopted)return;let e=this.__slottedInput();if(!e)return;this.__ssrStateAdopted=!0,e.id&&(this._inputId=e.id),!this.name&&e.name&&(this.name=e.name);let t=e.getAttribute("value")??e.value;t&&(this.choiceValue=t,e.value=t),e.checked&&(this.checked=!0),e.disabled&&(this.disabled=!0)}};var Jn=class extends(Yn(Gn)){constructor(...e){super(...e),this.__inputPatched=!1,this.indeterminate=!1}connectedCallback(){super.connectedCallback(),this.__patchSlottedInputProps()}updated(e){super.updated(e),this.__patchSlottedInputProps();let t=this._inputNode;t&&(t.indeterminate=this.indeterminate)}__patchSlottedInputProps(){if(this.__inputPatched)return;let e=this.__slottedInputElement();if(!e)return;this.__inputPatched=!0;let t=this;for(let i of["checked","disabled"]){let s=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,i);if(!s?.get||!s.set)continue;let{get:n,set:r}=s;Object.defineProperty(e,i,{configurable:!0,enumerable:s.enumerable,get(){return n.call(this)},set(e){r.call(this,e),t[i]!==e&&(t[i]=e)}})}}__slottedInputElement(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&"input"===e.slot)}static get styles(){return[...Gn.styles,l`
      ...
      `]}};function Xn(e){return"function"==typeof e.checkVisibility?e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}):e.offsetWidth>0||e.offsetHeight>0}_e([ve({type:Boolean,reflect:!0})],Jn.prototype,"indeterminate",void 0),customElements.get("craft-checkbox")||customElements.define("craft-checkbox",Jn);var Qn=new WeakMap,er=class e{constructor(){this.queue=[],this.workers=[],nt(this,Qn,null),ot(Qn,this,new AbortController);for(let e=0;e<3;e++)this.workers.push(new nr(this))}load(t=document,i="[data-sizes]"){t.querySelectorAll(i).forEach(t=>{if(Xn(t))this.addToQueue(t);else{let i=`thumb${Math.floor(1e6*Math.random())}`;e.invisibleThumbs[i]=[this,t];let s=()=>{e.invisibleThumbs[i]&&Xn(t)&&(delete e.invisibleThumbs[i],this.addToQueue(t))};document.addEventListener("scroll",s,{signal:rt(Qn,this)?.signal}),window.addEventListener("resize",s,{signal:rt(Qn,this)?.signal})}})}addToQueue(e){this.queue.push(e),this.workers.forEach(e=>{e.active||e.loadNext()})}static retryAll(){for(let t in e.invisibleThumbs){let i=e.invisibleThumbs[t];if(!i)continue;let[s,n]=i;delete e.invisibleThumbs[t],s.load(n.parentElement??document)}}destroy(){this.workers.forEach(e=>e.deactivate()),rt(Qn,this)?.abort()}};er.invisibleThumbs={};var tr=new WeakMap,ir=new WeakMap,sr=new WeakMap,nr=class{constructor(e){this.active=!1,this.container=void 0,nt(this,tr,null),nt(this,ir,null),nt(this,sr,null),ot(tr,this,e)}activate(){this.active||(this.active=!0,this.clearInterval(),ot(ir,this,setInterval(()=>{this.loadNextIfRemoved()},500)))}deactivate(){this.active&&(this.active=!1,this.clearInterval(),this.clearTimeout())}clearInterval(){rt(ir,this)&&(clearInterval(rt(ir,this)),ot(ir,this,null))}clearTimeout(){rt(sr,this)&&(clearTimeout(rt(sr,this)),ot(sr,this,null))}loadNext(){if(this.clearTimeout(),this.container=rt(tr,this)?.queue.shift(),void 0===this.container)return void this.deactivate();if(this.loadNextIfRemoved())return;if(this.container.querySelectorAll("img").length>0)return void this.loadNext();this.activate(),ot(sr,this,setTimeout(()=>{this.loadNext()},3e4));let e=document.createElement("img");e.sizes=this.container.getAttribute("data-sizes")??"",e.srcset=this.container.getAttribute("data-srcset")??"",e.alt=this.container.getAttribute("data-alt")??"",e.setAttribute("data-animated",this.container.getAttribute("data-animated")??""),e.src=this.container.getAttribute("data-src")??"",e.onload=()=>this.loadNext(),e.onabort=()=>this.loadNext(),e.onerror=()=>this.loadNext(),this.container.appendChild(e)}loadNextIfRemoved(){return!(!this.container||document.body.contains(this.container)||(this.loadNext(),0))}},rr=l`
  :host {
    display: contents;
  }
...
`,or=new WeakMap,ar=class extends pe{constructor(...e){super(...e),this.size="",this.variant=Ae.Neutral,this.appearance=Kt.OutlineFill,this.icon=null,nt(this,or,new er)}renderPrefix(){let e=!!this.querySelector('[slot="thumbnail"]'),t=!!this.querySelector('[slot="indicator"]');return K` <div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
        ${e?K`<slot class="cp-chip__thumbnail" name="thumbnail"></slot>`:Z}
        ${t?K`<slot class="cp-chip__indicator" name="indicator"></slot>`:Z}
        <slot class="cp-chip__icon" name="icon">
          ${this.icon?K` <craft-icon name="${this.icon}"></craft-icon>`:Z}
        </slot>
      </slot>
    </div>`}firstUpdated(e){super.firstUpdated(e),rt(or,this).load(this)}render(){let e=!!this.querySelector('[slot="prefix"]')||!!this.querySelector('[slot="icon"]')||!!this.querySelector('[slot="thumbnail"]')||!!this.querySelector('[slot="indicator"]')||this.icon,t=!!this.querySelector('[slot="suffix"]');return K`
      <div
        part="chip"
        class="${Le({"cp-chip":!0,"cp-chip--small":"small"===this.size,"cp-chip--medium":"medium"===this.size,"cp-chip--large":"large"===this.size,"cp-chip--plain":this.appearance===Kt.Plain})}"
      >
        ${e?this.renderPrefix():Z}
    ...
    `}};ar.styles=[rr],_e([ve()],ar.prototype,"size",void 0),_e([ve({reflect:!0})],ar.prototype,"variant",void 0),_e([ve({reflect:!0})],ar.prototype,"appearance",void 0),_e([ve()],ar.prototype,"icon",void 0),customElements.get("craft-chip")||customElements.define("craft-chip",ar);const lr=l`
  --_border-width: var(
    --c-input-border-width,
    var(--c-form-control-border-width)
  );
...
`;class hr extends(Ci(Kn(Ls(As(pe))))){static get properties(){return{active:{type:Boolean,reflect:!0}}}static get styles(){return[l`
        :host {
          display: block;
          background-color: white;
          padding: 4px;
...
`,pr=new WeakMap,mr=new WeakSet,fr=class extends hr{constructor(...e){super(...e),st(this,mr),this.hint=null,nt(this,pr,void 0)}static get styles(){return[...hr.styles,ur]}connectedCallback(){super.connectedCallback(),br._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),br._.unobserve(this)}render(){return K`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?K`<span class="hint">${this.hint}</span>`:Z}
        <slot name="suffix"></slot>
      </div>
    `}};function _r(){return rt(pr,this)??ot(pr,this,parseInt(getComputedStyle(this).getPropertyValue("--c-option-wide-threshold")||"640",10)),rt(pr,this)}var br={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,i=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute("wide",i>=it(mr,e,_r).call(e))}})};_e([ve()],fr.prototype,"hint",void 0),customElements.get("craft-option")||customElements.define("craft-option",fr);const gr=lt(e=>class extends e{constructor(){super(),this.registrationTarget=void 0,this.__redispatchEventForFormRegistrarPortalMixin=this.__redispatchEventForFormRegistrarPortalMixin.bind(this),this.addEventListener("form-element-register",this.__redispatchEventForFormRegistrarPortalMixin)}__redispatchEventForFormRegistrarPortalMixin(e){if(e.stopPropagation(),!this.registrationTarget)throw new Error("A FormRegistrarPortal element requires a .registrationTarget");this.registrationTarget.dispatchEvent(new CustomEvent("form-element-register",{detail:{element:e.detail.element},bubbles:!0}))}});class vr extends(gr(pe)){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:"tabindex"}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","listbox")}createRenderRoot(){return this}}const yr=lt(e=>class extends(Os(mn(Mn(As(Is(e)))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:"selection-follows-focus"},rotateKeyboardNavigation:{type:Boolean,attribute:"rotate-keyboard-navigation"},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:"has-no-default-selected"},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],l`
          :host {
            display: block;
          }
...
`,Lr=new WeakMap,Or=new WeakMap,Fr=new WeakSet,Mr=new WeakMap,Ir=class extends $r{static get styles(){return[...super.styles,Tr]}constructor(){super(),st(this,Fr),this.options=[],this.limit=150,this.clearable=!1,nt(this,Lr,void 0),nt(this,Or,()=>{it(Fr,this,zr).call(this),it(Fr,this,Dr).call(this)}),nt(this,Mr,()=>{this.modelValue="",this._inputNode&&(this._inputNode.value=""),it(Fr,this,zr).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete="list"}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener("input",rt(Or,this)),this.addEventListener("model-value-changed",()=>{ot(Lr,this,this.modelValue)}),ot(Lr,this,this.modelValue),it(Fr,this,zr).call(this)}updated(e){super.updated(e),(e.has("options")||e.has("limit")||e.has("opened")||e.has("modelValue"))&&it(Fr,this,zr).call(this)}matchCondition(){return!0}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&("ArrowDown"===e.lastKey||"ArrowUp"===e.lastKey)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){return K`
      <div class="input-group__input">
        <slot name="input"></slot>
        ${this.clearable&&it(Fr,this,Ur).call(this)?K`<craft-button
              class="clear"
              type="button"
              appearance="plain"
              size="small"
    ...
    `}parser(e){if("string"==typeof e&&""!==e){let t=it(Fr,this,qr).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,i={}){return"overlay-close"===i.phase||super._syncToTextboxCondition(e,t,i)}_getTextboxValueFromOption(e){return e?e.textContent?.trim()||"":super._getTextboxValueFromOption(e)}};function Dr(){let e=this.parser(this._inputNode?.value??"");e!==this.modelValue&&(this.modelValue=e),this.modelValue!==rt(Lr,this)&&(ot(Lr,this,this.modelValue),this.dispatchEvent(new CustomEvent("model-value-changed",{bubbles:!0,detail:{formPath:[this],isTriggeredByUser:!0}})))}function Vr(e){let t=e.trim().toLowerCase(),i=[];for(let e of this.options)if(it(Fr,this,Rr).call(this,e))for(let s of e.options)(""===t||it(Fr,this,Pr).call(this,t,s))&&i.push({groupLabel:e.label,option:s});else(""===t||it(Fr,this,Pr).call(this,t,e))&&i.push({option:e});return i}function Rr(e){return"optgroup"===e.type}function Pr(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function zr(){let e=this._listboxNode;if(!e)return;let t,i=this._inputNode?.value??"",s=it(Fr,this,Vr).call(this,i),n=s.slice(0,this.limit);he(K`${n.map(e=>{let i=e.groupLabel&&e.groupLabel!==t?K`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:Z;return t=e.groupLabel,K`${i}${it(Fr,this,Br).call(this,e.option)}`})}${s.length>this.limit?K`<div class="combobox__footer" aria-hidden="true">
            ${Qe("Showing {shown} of {total} — keep typing to narrow results.",{shown:this.limit,total:s.length})}
          </div>`:Z}`,e)}function Br(e){let t=e.data??{},i=e.label,s=i.startsWith("$")||i.startsWith("@");return K`
      <craft-option
    ...
    `}function Ur(){return""!==this.modelValue&&null!=this.modelValue}function qr(e){let t=e.trim();for(let e of this.options)if(it(Fr,this,Rr).call(this,e)){let i=e.options.find(e=>e.label===t);if(i)return i}else if(e.label===t)return e}_e([ve({type:Array})],Ir.prototype,"options",void 0),_e([ve({type:Number})],Ir.prototype,"limit",void 0),_e([ve({type:Boolean,reflect:!0})],Ir.prototype,"clearable",void 0),customElements.get("craft-combobox")||customElements.define("craft-combobox",Ir);var Hr=l`
  :host {
    display: inline-block;
  }
...
`;const Wr={keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},jr={keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}};var Kr=class extends pe{constructor(...e){super(...e),this.isCopying=!1,this.status="rest",this.value="",this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if("copying"!==this.status&&!this.disabled){this.status="copying";try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent("craft-copy",{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent("craft-error",{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t="success"===e?this.successIconEl:this.errorIconEl;this.tooltipLabel="success"===e?"Copied":"Copy failed",await t.animate(jr.keyframes,jr.options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(Wr.keyframes,Wr.options),this.status=e,setTimeout(async()=>{await t.animate(jr.keyframes,jr.options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(Wr.keyframes,Wr.options),this.status="rest",this.tooltipLabel="Copy"},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute("tooltip-label")||Qe("Copy"),this.id||(this.id=`copy-${Math.floor(1e8*Math.random())}`),this.addEventListener("craft-copy",()=>{this.showStatus("success")}),this.addEventListener("craft-error",()=>{this.showStatus("error")})}render(){return K`
    ...
    `}};Kr.styles=[Hr],_e([ye()],Kr.prototype,"isCopying",void 0),_e([ye()],Kr.prototype,"status",void 0),_e([ke('slot[name="copy-icon"]')],Kr.prototype,"copyIconEl",void 0),_e([ke('slot[name="success-icon"]')],Kr.prototype,"successIconEl",void 0),_e([ke('slot[name="error-icon"]')],Kr.prototype,"errorIconEl",void 0),_e([ve({type:String})],Kr.prototype,"value",void 0),_e([ve({type:Boolean})],Kr.prototype,"disabled",void 0),_e([ve({attribute:"feedback-duration",type:Number})],Kr.prototype,"feedbackDuration",void 0),_e([ve({attribute:"tooltip-label"})],Kr.prototype,"tooltipLabel",void 0),customElements.get("craft-copy-button")||customElements.define("craft-copy-button",Kr);var Gr,Zr=l`
...
`,Jr=Object.defineProperty,Xr=Object.getOwnPropertyDescriptor,Qr=Object.getOwnPropertySymbols,eo=Object.prototype.hasOwnProperty,to=Object.prototype.propertyIsEnumerable,io=e=>{throw TypeError(e)},so=(e,t,i)=>t in e?Jr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:i}):e[t]=i,no=(e,t,i,s)=>{for(var n,r=s>1?void 0:s?Xr(t,i):t,o=e.length-1;o>=0;o--)(n=e[o])&&(r=(s?n(t,i,r):n(r))||r);return s&&r&&Jr(t,i,r),r},ro=(e,t,i)=>t.has(e)||io("Cannot "+i),oo=class extends pe{constructor(){super(),((e,t)=>{t.has(e)?io("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,!1)})(this,Gr),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let i=new CustomEvent(e,((e,t)=>{for(var i in t||(t={}))eo.call(t,i)&&so(e,i,t[i]);if(Qr)for(var i of Qr(t))to.call(t,i)&&so(e,i,t[i]);return e})({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(i),i}static define(e,t=this,i={}){let s=customElements.get(e);if(!s){try{customElements.define(e,t,i)}catch{customElements.define(e,class extends t{},i)}return}let n=" (unknown version)",r=n;"version"in t&&t.version&&(n=" v"+t.version),"version"in s&&s.version&&(r=" v"+s.version),(!n||!r||n!==r)&&console.warn(`Attempted to register <${e}>${n}, but <${e}>${r} has already been registered.`)}attributeChangedCallback(e,t,i){((e,t)=>(ro(e,t,"read from private field"),t.get(e)))(this,Gr)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])}),((e,t,i)=>{ro(e,t,"write to private field"),t.set(e,i)})(this,Gr,!0)),super.attributeChangedCallback(e,t,i)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,i)=>{e.has(i)&&null==this[i]&&(this[i]=t)})}};Gr=new WeakMap,oo.version="2.20.1",oo.dependencies={},no([ve()],oo.prototype,"dir",2),no([ve()],oo.prototype,"lang",2);var ao=class extends oo{render(){return K` <slot></slot> `}};ao.styles=[Yr,Zr],ao.define("sl-visually-hidden");var lo=l`
  :host {
    box-sizing: border-box;
  }
...
`,ho=class extends pe{constructor(...e){super(...e),this.value="",this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,"$1-$2").replace(/[\s_]+/g,"-").toLowerCase()}`}render(){return K`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};ho.styles=[lo,co],_e([ke("craft-copy-button")],ho.prototype,"copyButtonEl",void 0),_e([ve({type:String})],ho.prototype,"value",void 0),_e([ve({type:Boolean,reflect:!0})],ho.prototype,"disabled",void 0),customElements.get("craft-copy-attribute")||customElements.define("craft-copy-attribute",ho);class uo extends(Lt(pe)){static get properties(){return{isAlertDialog:{type:Boolean,attribute:"is-alert-dialog"}}}constructor(){super(),this.isAlertDialog=!1}_defineOverlayConfig(){return{placementMode:"global",viewportConfig:{placement:"center"},hasBackdrop:!0,preventsScroll:!0,trapsKeyboardFocus:!0,hidesOnEsc:!0,handlesAccessibility:!0,visibilityTriggerFunction:({controller:e})=>{function t(){e._hasDisabledInvoker()||e.toggle()}return{init:()=>{e.invokerNode?.addEventListener("click",t)},teardown:()=>{e.invokerNode?.removeEventListener("click",t)}}},isAlertDialog:this.isAlertDialog}}render(){return K`
      <slot name="invoker"></slot>
      <div id="overlay-content-node-wrapper">
        <slot name="content"></slot>
      </div>
    `}}const po=typeof CSSStyleSheet<"u"?new CSSStyleSheet:null;po?.replaceSync("\n  .craft-dialog {\n    background-color: var(--c-surface-raised);\n    border-radius: var(--c-radius-md);\n    box-shadow: var(--c-shadow-lg);\n    min-width: min(90vw, 24rem);\n    max-width: min(90vw, 40rem);\n  }\n\n  .craft-dialog__header {\n    display: flex;\n    align-items: flex-start;\n    justify-content: space-between;\n    gap: var(--c-spacing-md);\n    padding-inline: var(--c-spacing-lg);\n    padding-block-start: var(--c-spacing-lg);\n    padding-block-end: var(--c-spacing-md);\n  }\n\n  .craft-dialog__title {\n    font-size: 1.25em;\n    margin: 0;\n  }\n\n  .craft-dialog__close {\n    background: none;\n    border: none;\n    cursor: pointer;\n    color: inherit;\n    padding: var(--c-spacing-xs);\n    line-height: 1;\n  }\n\n  .craft-dialog__body {\n    padding-inline: var(--c-spacing-lg);\n    padding-block-end: var(--c-spacing-lg);\n  }\n\n  .craft-dialog__footer {\n    display: flex;\n    justify-content: flex-end;\n    gap: var(--c-spacing-sm);\n    padding-inline: var(--c-spacing-lg);\n    padding-block-end: var(--c-spacing-lg);\n  }\n");var mo=new WeakMap,fo=new WeakMap,_o=new WeakSet,bo=class extends uo{constructor(){super(),st(this,_o),this.openAttribute=!1,this.label="",nt(this,mo,null),nt(this,fo,null),et(this),this.addEventListener("opened-changed",()=>{let e=!!this.opened;this.openAttribute!==e&&(this.openAttribute=e)})}static get styles(){return[l`
        :host {
          display: contents;
        }
      ...
      `]}connectedCallback(){it(_o,this,go).call(this),it(_o,this,vo).call(this),super.connectedCallback()}updated(e){super.updated(e),e.has("openAttribute")&&this.openAttribute!==this.opened&&(this.opened=this.openAttribute),e.has("label")&&rt(fo,this)&&(rt(fo,this).textContent=this.label)}};function go(){let e=this.getRootNode();po&&(e instanceof Document||e instanceof ShadowRoot)&&!e.adoptedStyleSheets.includes(po)&&(e.adoptedStyleSheets=[...e.adoptedStyleSheets,po])}function vo(){if(rt(mo,this)?.isConnected)return;let e=document.createElement("div");e.slot="content",e.classList.add("craft-dialog");let t=document.createElement("div");t.classList.add("craft-dialog__body"),t.append(...Array.from(this.childNodes).filter(e=>!(e instanceof Element)||""===e.slot));let i=Array.from(this.children).filter(e=>"footer"===e.slot);if(e.append(it(_o,this,yo).call(this),t),i.length>0){let t=document.createElement("footer");t.classList.add("craft-dialog__footer"),t.append(...i),e.append(t)}e.addEventListener("click",e=>{e.target.closest?.('[data-dialog="close"]')&&(this.opened=!1)}),this.append(e),ot(mo,this,e)}function yo(){let e=document.createElement("header");e.classList.add("craft-dialog__header");let t=document.createElement("h2");t.classList.add("craft-dialog__title"),t.textContent=this.label,ot(fo,this,t);let i=document.createElement("button");i.type="button",i.classList.add("craft-dialog__close"),i.setAttribute("aria-label",Qe("Close")),i.setAttribute("data-dialog","close");let s=document.createElement("craft-icon");return s.setAttribute("name","xmark"),i.append(s),e.append(t,i),e}_e([ve({type:Boolean,attribute:"open",reflect:!0})],bo.prototype,"openAttribute",void 0),_e([ve()],bo.prototype,"label",void 0),customElements.get("craft-dialog")||customElements.define("craft-dialog",bo);class wo extends pe{static get styles(){return[l`
        :host {
          display: block;
        }
    ...
    `}constructor(){super(),this.opened=!1,this.toggle=this.toggle.bind(this)}connectedCallback(){super.connectedCallback();const e=Pt();this._invokerNode&&(this._invokerNode.addEventListener("click",this.toggle),this._invokerNode.setAttribute("aria-expanded",`${this.opened}`),this._invokerNode.setAttribute("aria-controls",`collapsible-content-${e}`)),this._contentNode&&this._contentNode.setAttribute("id",`collapsible-content-${e}`),this.__setDefaultState()}updated(e){super.updated(e),e.has("opened")&&this.__openedChanged()}disconnectedCallback(){super.disconnectedCallback(),this._invokerNode&&this._invokerNode.removeEventListener("click",this.toggle)}show(){this.opened||(this.opened=!0)}hide(){this.opened&&(this.opened=!1)}toggle(){this.opened=!this.opened,this.requestUpdate()}async _showAnimation(e){}async _hideAnimation(e){}get _invokerNode(){return Array.from(this.children).find(e=>"invoker"===e.slot)}get _contentNode(){return Array.from(this.children).find(e=>"content"===e.slot)}get _contentHeight(){return`${this._contentNode?.getBoundingClientRect().height||0}px`}__openedChanged(){this.__updateContentSize(),this._invokerNode&&this._invokerNode.setAttribute("aria-expanded",`${this.opened}`),this.dispatchEvent(new CustomEvent("opened-changed"))}async __updateContentSize(){this._contentNode&&(this.opened?(this._contentNode.style.setProperty("display",""),await this._showAnimation({contentNode:this._contentNode})):(await this._hideAnimation({contentNode:this._contentNode}),this._contentNode.style.setProperty("display","none")))}__setDefaultState(){!this.opened&&this._contentNode&&this._contentNode.style.setProperty("display","none")}}var ko=class extends wo{constructor(...e){super(...e),this.label="",this.state=null,this.cookieName=null,this.__defaultInvoker=null,this.__externalTrigger=null,this.__externalExpanded=!1,this.__toggleExternal=()=>{this.state=this.__externalExpanded?"collapsed":"expanded"}}static get styles(){return[...super.styles,l`
      ...
      <slot name="content"></slot>
      <slot></slot>
    `}connectedCallback(){this.__externalTrigger=this.querySelector(':scope > button[type="button"][aria-controls]:not([slot])'),this.__externalTrigger||this.__ensureDefaultInvoker(),super.connectedCallback(),this.__externalTrigger&&this.__setupExternalMode()}disconnectedCallback(){super.disconnectedCallback(),this.__externalTrigger&&(this.__handleExternalOpen(),this.__externalTrigger.removeEventListener("click",this.__toggleExternal))}updated(e){super.updated(e),e.has("label")&&this.__defaultInvoker&&(this.__defaultInvoker.textContent=this.label),e.has("state")&&this.__externalTrigger&&("expanded"===this.state?this.__handleExternalOpen():"collapsed"===this.state&&this.__handleExternalClose())}__ensureDefaultInvoker(){if(this._invokerNode)return;let e=document.createElement("craft-button");e.slot="invoker",e.setAttribute("type","button"),e.setAttribute("appearance","plain"),e.setAttribute("icon","chevron-down"),e.textContent=this.label,this.__defaultInvoker=e,this.prepend(e)}__setupExternalMode(){let e=this.__externalTrigger;this.__externalTarget?(e.addEventListener("click",this.__toggleExternal),"expanded"!==this.state&&"collapsed"!==this.state&&(this.state="expanded")):console.error(`No target with id ${e.getAttribute("aria-controls")} found for disclosure.`,e)}__handleExternalOpen(){this.__externalExpanded=!0,this.__externalTrigger?.setAttribute("aria-expanded","true"),this.dispatchEvent(new CustomEvent("open"));let e=this.__externalTarget;e&&(e.dataset.state="expanded"),this.__persistExternalState("expanded")}__handleExternalClose(){this.__externalExpanded=!1,this.__externalTrigger?.setAttribute("aria-expanded","false"),this.dispatchEvent(new CustomEvent("close"));let e=this.__externalTarget;e&&(e.dataset.state="collapsed"),this.__persistExternalState("collapsed")}__persistExternalState(e){this.cookieName&&window.Craft?.setCookie(this.cookieName,e)}};_e([ve()],ko.prototype,"label",void 0),_e([ve({reflect:!0})],ko.prototype,"state",void 0),_e([ve({attribute:"cookie-name"})],ko.prototype,"cookieName",void 0),customElements.get("craft-disclosure")||customElements.define("craft-disclosure",ko);var xo=class extends pe{constructor(...e){super(...e),this.label="",this.icon=""}render(){return K`
      <div class="cp-empty">
    ...
    `],_e([ve()],xo.prototype,"label",void 0),_e([ve()],xo.prototype,"icon",void 0),customElements.get("craft-empty")||customElements.define("craft-empty",xo);const Co=e=>e??Z;var Eo=l`
  :host {
    position: relative;
    display: block;
  }
...
`,No=class extends(Os(pe)){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=Qe("This field is translatable."),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition="before",this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[fi,dr,Eo]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth()}__syncHasMaxlength(){this.toggleAttribute("has-maxlength",this.querySelector(':scope > [slot="input"]')?.hasAttribute("maxlength")??!1)}__syncControlWidth(){if(void 0!==this.width)return;let e=this.querySelector(':scope > [slot="input"]')?.getAttribute("width");("full"===e||"auto"===e)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has("disabled")&&this._inputNode?.removeAttribute("aria-disabled"),e.has("fieldset")&&this.__syncFieldsetSemantics(),(e.has("label")||e.has("required")||e.has("translatable")||e.has("translationDescription"))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:"rtl"===(this.closest("[dir]")?.getAttribute("dir")??document.documentElement.getAttribute("dir"))?.toLowerCase()?"rtl":"ltr"}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy()}addToAriaLabelledBy(e,t={}){super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return K`
    ...
    `}_labelTemplate(){return K`
      <div class="heading form-field__label">
        ...
        <slot name="label"></slot>
        ${this.readOnly?K`<span class="read-only-badge">${Qe("Read Only")}</span>`:Z}
        ${this.__hasLightChild("label-extra")?K`<div class="flex-grow"></div>`:Z}
    ...
    `}_statusBadgeTemplate(){return this.status?K`
      <div
        ...
        title=${Co(this.statusLabel)}
        aria-hidden="true"
      >
        <span class="cp-visually-hidden">${this.statusLabel}</span>
      </div>
    `:Z}_noticeTemplate(e){if(!this.__hasLightChild(e))return Z;let t="tip"===e;return K`
      <craft-callout
        class="field-notice"
    ...
    `}__hasLightChild(e){return void 0!==this.__lightChild(e)}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of["help-text","feedback","tip","warning"]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__syncHasErrors(){let e=this.__lightChild("feedback");e&&(this.hasErrors=!(!e.childElementCount&&!e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode;this.fieldset?(this.setAttribute("role","group"),e&&(e.id||(e.id=`label-${this._inputId}`),this.setAttribute("aria-labelledby",e.id),e.removeAttribute("for"))):("group"===this.getAttribute("role")&&this.removeAttribute("role"),this.removeAttribute("aria-labelledby"),e&&this._inputNode&&e.setAttribute("for",this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll("[data-craft-field-decoration]"))t.remove();if(this.label){if(this.required){let t=document.createElement("span");t.className="visually-hidden",t.textContent=Qe("Required"),t.setAttribute("data-craft-field-decoration","");let i=document.createElement("span");i.className="required",i.setAttribute("aria-hidden","true"),i.setAttribute("data-craft-field-decoration",""),e.append(t,i)}if(this.translatable){let t=document.createElement("craft-tooltip");t.setAttribute("placement","bottom"),t.setAttribute("max-width","200px"),t.setAttribute("text",this.translationDescription),t.setAttribute("delay","1000"),t.setAttribute("data-craft-field-decoration","");let i=document.createElement("button");i.type="button",i.className="t9n-indicator prevent-autofocus",i.setAttribute("data-icon","language"),i.setAttribute("aria-label",this.translationDescription),t.append(i),e.append(t)}}}}};_e([ve({type:Boolean,reflect:!0})],No.prototype,"required",void 0),_e([ve({type:Boolean,reflect:!0})],No.prototype,"translatable",void 0),_e([ve({attribute:"translation-description"})],No.prototype,"translationDescription",void 0),_e([ve({type:Boolean,reflect:!0})],No.prototype,"fieldset",void 0),_e([ve({reflect:!0})],No.prototype,"status",void 0),_e([ve({attribute:"status-label"})],No.prototype,"statusLabel",void 0),_e([ve({reflect:!0})],No.prototype,"orientation",void 0),_e([ve({type:Boolean,reflect:!0,attribute:"has-errors"})],No.prototype,"hasErrors",void 0),_e([ve({attribute:"instructions-position"})],No.prototype,"instructionsPosition",void 0),_e([ve({type:String,reflect:!0})],No.prototype,"width",void 0),customElements.get("craft-field")||customElements.define("craft-field",No),customElements.get("craft-field-group")||customElements.define("craft-field-group",class extends pe{render(){return K`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}});var Ao=l`
  ${dr}
...
`;const So=/^[0-9a-f]{6}$/i,$o=/^[0-9a-f]{3}$/i,To={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function Lo(e){return String(e??"").trim().replace(/^#/,"")}function Oo(e){let t=Lo(e);return $o.test(t)?t.split("").map(e=>e+e).join(""):So.test(t)?t:null}var Fo=class e extends Wn{static get styles(){return[...super.styles,cr,Ao]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type="text"}static doesBrowserSupportColorInputs(){if(null===e._browserSupportsColorInputs){let t=document.createElement("input");t.setAttribute("type","color"),e._browserSupportsColorInputs="color"===t.type}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement("input"),t=this.getAttribute("value");return e.type="text",e.inputMode="text",e.spellcheck=!1,e.setAttribute("autocorrect","off"),e.setAttribute("autocapitalize","off"),t&&e.setAttribute("value",Lo(t)),e}}}parser(e){return Lo(e)}formatter(e){return Lo(e)}serializer(e){return Lo(e)}deserializer(e){return Lo(e)}preprocessor(e){let t=Lo(e);if(t!==e)return t}get _expandedHexValue(){return Oo(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:"#ffffff"}get _validPresets(){return this.presets.map(e=>Oo(e)).filter(e=>null!==e).map(e=>`#${e}`)}_handlePickerInput(e){let t=Lo(e.target.value),i=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=t,this.value=t,this._isHandlingUserInput=i}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return Z;let t=this._validPresets;return K`
      <input
        ...
        ?disabled="${this.disabled}"
        list=${t.length?this._pickerListId:Z}
    ...
    `}_removeButtonContentTemplate(){return K`✖️`}_selectedListItemTemplate(e){const t=Pt();return K`
          ...
          <span id="selected-list-item-label-${t}" class="selected__list__item__label__text">
            ...
            ${e.downloadUrl&&"LOADING"!==e.status?K`
                  <a
                    ...
                    rel="${Co(e.downloadUrl.startsWith("blob")?"noopener noreferrer":void 0)}"
                    >${e.systemFile?.name}</a
                  >
                `:e.systemFile?.name}
          </span>
    ...
    `}render(){return this.fileList?.length?K`
      ...
      `]}}var Ro=class extends Vo{static get styles(){return[...super.styles,l`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
    ...
    `}_removeButtonContentTemplate(){return K`<craft-icon name="x"></craft-icon>`}_listItemBeforeTemplate(e){return K`<img src="${e.downloadUrl}" alt="" class="preview-thumb" />`}};class Po extends In{static validatorName="IsAcceptedFile";static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf("."))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let i,s;const n=this.constructor,{allowedFileTypes:r,allowedFileExtensions:o,maxFileSize:a}=t;return r?.length?(i=e.some(e=>!n.isFileTypeAllowed(e.type,r)),i):o?.length?(s=e.some(e=>!n.isExtensionAllowed(n.getExtension(e.name),o)),s):e.findIndex(e=>!n.checkFileSize(e.size,a))>-1}static async getMessage(){return""}}class zo extends In{static validatorName="DuplicateFileNames";constructor(e,t){super(e,t),this.type="info"}execute(e,t=this.param){return t.show}static async getMessage(){return ln().msg("lion-input-file:uploadTextDuplicateFileName")}}const Bo="FILE_TYPE",Uo="FAIL";class qo{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),0===this.failedProp.length&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf("."))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){const e=this._getFileNameExtension(this.systemFile.name);Po.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Uo,this.failedProp.push(Bo))}else if(this._acceptCriteria.allowedFileTypes.length){const e=this.systemFile.type;Po.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Uo,this.failedProp.push(Bo))}Po.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Uo&&(this.status="SUCCESS"):(this.status=Uo,this.failedProp.push("FILE_SIZE"))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}}function Ho(e,t=2){if(!+e)return"0 Bytes";const i=t<0?0:t,s=Math.floor(Math.log(e)/Math.log(1024));return`${parseFloat((e/1024**s).toFixed(i))}${[" bytes","KB","MB","GB","TB","PB","EB","ZB","YB"][s]}`}class Wo extends(mn($n(Hn))){static get scopedElements(){return{...super.scopedElements,"lion-selected-file-list":Vo}}static get properties(){return{accept:{type:String},multiple:{type:Boolean,reflect:!0},buttonLabel:{type:String,attribute:"button-label"},maxFileSize:{type:Number,attribute:"max-file-size"},enableDropZone:{type:Boolean,attribute:"enable-drop-zone"},uploadOnSelect:{type:Boolean,attribute:"upload-on-select"},isDragging:{type:Boolean,attribute:"is-dragging",reflect:!0},uploadResponse:{type:Array,state:!1},_selectedFilesMetaData:{type:Array,state:!0}}}static localizeNamespaces=[{"lion-input-file":Do},...super.localizeNamespaces];static get validationTypes(){return["error","info"]}get slots(){return{...super.slots,input:()=>K`<input .value="${Co(this.getAttribute("value"))}" />`,"file-select-button":()=>K`<button
          type="button"
    ...
    `}static get styles(){return[super.styles,l`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}}var jo=l`
  /* Add any craft-specific styles for input-file here */
  ::slotted([slot='selected-file-list']) {
    margin-block-start: var(--c-spacing-lg);
  }
`;customElements.get("craft-input-file")||customElements.define("craft-input-file",class extends Wo{static get styles(){return[...super.styles,cr,jo]}get slots(){return{...super.slots,"file-select-button":()=>K`<craft-button
          type="button"
          id="select-button-${this._inputId}"
          @click="${this.__openDialogOnBtnClick}"
        >
          ${this.buttonLabel}
        </craft-button>`}}static get scopedElements(){return{...super.scopedElements,"lion-selected-file-list":Ro}}});var Ko=l`
...
`,Go=class extends Wn{constructor(...e){super(...e),this.size="medium",this.small=!1,this.center=!1,this.monospace=!1,this.hiddenInput=!1}static get styles(){return[...super.styles,cr,Ko]}connectedCallback(){super.connectedCallback(),this._inputNode&&this.maxlength&&this.maxlength>0&&(this._inputNode.maxLength=this.maxlength,"full"!==this.width&&(this._inputNode.size=this.maxlength))}};_e([ve({type:Number,reflect:!0})],Go.prototype,"maxlength",void 0),_e([ve({type:String,reflect:!0})],Go.prototype,"size",void 0),_e([ve({reflect:!0,type:Boolean})],Go.prototype,"small",void 0),_e([ve({type:String,reflect:!0})],Go.prototype,"width",void 0),_e([ve({reflect:!0,type:Boolean})],Go.prototype,"center",void 0),_e([ve({reflect:!0,type:Boolean})],Go.prototype,"monospace",void 0),_e([ve({reflect:!0,type:Boolean,attribute:"hidden-input"})],Go.prototype,"hiddenInput",void 0),customElements.get("craft-input")||customElements.define("craft-input",Go);var Zo=class extends Go{constructor(...e){super(...e),this.autocorrect=!1,this.autocapitalize="off"}static get styles(){return[...super.styles,l`
        .input-group__input {
          font-family: var(--c-font-mono);
          font-size: 0.9em;
        }
      `]}firstUpdated(e){super.firstUpdated(e),this._inputNode?.setAttribute("autocorrect",this.autocorrect?"on":"off"),this._inputNode?.setAttribute("autocapitalize",this.autocapitalize)}};_e([ve({reflect:!0})],Zo.prototype,"autocorrect",void 0),_e([ve({reflect:!0,type:String})],Zo.prototype,"autocapitalize",void 0),customElements.get("craft-input-handle")||customElements.define("craft-input-handle",Zo);var Yo=class extends Wn{static get styles(){return[...super.styles,cr,l`
        .input-group__container {
          position: relative;
        }
      ...
      >
        <span class="icon"
          >${this._visible?K`<craft-icon
                name="eye-slash"
                label="${Qe("Hide")}"
              ></craft-icon>`:K`<craft-icon name="eye" label="${Qe("Show")}"></craft-icon>`}
        </span>
      </craft-button>
    `,this.type="password"}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix()})}}};_e([ye()],Yo.prototype,"_visible",void 0),customElements.get("craft-input-password")||customElements.define("craft-input-password",Yo);var Jo=l`
  .badge-indicator {
...
`,Xo=class extends pe{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant="primary",this.id=this.id||`badge-${Math.floor(1e9*Math.random()).toString()}`}showCount(){return null!==this.badgeCount&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?"99+":this.badgeCount.toString()}getBadgeRole(){return this.altText?"img":Z}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return K`
      ${this.showCount()?K`
    ...
    `}render(){return K`
      <div
        part="badge"
        id=${this.id}
        class="${Le({"badge-indicator":!0,"badge-indicator--with-number":this.showCount(),"badge-indicator--secondary":"secondary"===this.variant,"badge-indicator--inverse":"inverse"===this.variant})}"
        role="${this.getBadgeRole()}"
        aria-labelledby="${this.altText?this.getLabelId():Z}"
      >
        ${this.renderBadgeContents()}
      </div>
    `}};Xo.styles=[Jo],_e([ve({attribute:"alt-text"})],Xo.prototype,"altText",void 0),_e([ve({attribute:"badge-count"})],Xo.prototype,"badgeCount",void 0),_e([ve({attribute:"badge-count-suffix"})],Xo.prototype,"badgeCountSuffix",void 0),_e([ve()],Xo.prototype,"variant",void 0),_e([ve()],Xo.prototype,"id",void 0),customElements.get("craft-badge-indicator")||customElements.define("craft-badge-indicator",Xo);const Qo="important",ea=" !"+Qo,ta=$e(class extends Te{constructor(e){if(super(e),1!==e.type||"style"!==e.name||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];return null==s?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`},"")}update(e,[t]){const{style:i}=e.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(t)),this.render(t);for(const e of this.ft)null==t[e]&&(this.ft.delete(e),e.includes("-")?i.removeProperty(e):i[e]=null);for(const e in t){const s=t[e];if(null!=s){this.ft.add(e);const t="string"==typeof s&&s.endsWith(ea);e.includes("-")||t?i.setProperty(e,t?s.slice(0,-11):s,t?Qo:""):i[e]=s}}return G}});var ia=l`
  :host {
...
`,sa=class extends pe{get hasLabel(){return Array.from(this.childNodes).some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE&&!e.hasAttribute("slot"))}constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.initialState="closed",this.togglePosition="suffix",this.subnavState="closed",this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active||"open"===this.initialState?"open":"closed"}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState="open"===this.subnavState?"closed":"open"}renderIconItem(e){let t=`item-${this.id}`;return K`
      <a
        class="${Le({"nav-item":!0,"nav-item--icon":!0,"nav-item--static":!this.href})}"
        id="${t}"
        href="${Co(this.href||void 0)}"
    ...
    `}renderSuffix(e=!1){return K`
      <div class="nav-item__suffix">
        <slot name="suffix">
          ${e&&"suffix"===this.togglePosition?this.renderSubnavToggle():Z}
        </slot>
      </div>
    `}renderItem(e,t=!1){return K`
      <a
        class="${Le({"nav-item":!0,"nav-item--prefixed":t,"nav-item--flush":this.flush,"nav-item--static":!this.href})}"
        href="${Co(this.href||void 0)}"
        aria-current="${!!this.active&&"page"}"
      >
        ${t?this.renderPrefix(e):Z}
        <slot
          id="${this.id}-label"
    ...
    `}render(){let e=!!this.querySelector('[slot="subnav"]'),t=e&&this.hasLabel,i=t&&"prefix"===this.togglePosition||!!this.icon||!!this.querySelector('[slot="prefix"]')||!!this.querySelector('[slot="icon"]'),s=!t||"open"===this.subnavState;return K`
      <li>
        ...
        ${e?K`
              <div
                class="subnav"
                id="${this.id}-subnav"
                style="${ta({display:s?"block":"none"})}"
              >
                <slot name="subnav"></slot>
              </div>
            `:Z}
      </li>
    `}};sa.styles=ia,_e([ve()],sa.prototype,"icon",void 0),_e([ve()],sa.prototype,"href",void 0),_e([ve({type:Boolean,reflect:!0})],sa.prototype,"active",void 0),_e([ve({type:Boolean})],sa.prototype,"external",void 0),_e([ve({type:Boolean})],sa.prototype,"indicator",void 0),_e([ve()],sa.prototype,"id",void 0),_e([ve({reflect:!0,type:Boolean,attribute:"icon-only"})],sa.prototype,"iconOnly",void 0),_e([ve()],sa.prototype,"flush",void 0),_e([ve({reflect:!0,attribute:"initial-state"})],sa.prototype,"initialState",void 0),_e([ve({attribute:"toggle-position"})],sa.prototype,"togglePosition",void 0),_e([ye()],sa.prototype,"subnavState",void 0),customElements.get("craft-nav-item")||customElements.define("craft-nav-item",sa);var na=class extends pe{render(){return K`
      <ul class="nav-list">
        <slot></slot>
      </ul>
    `}};na.styles=l`
  ...
  `,customElements.get("craft-nav-list")||customElements.define("craft-nav-list",na);var ra=class extends pe{constructor(...e){super(...e),this.appearance="raised",this.size="lg"}render(){return K`<div
      class="${Le({"cp-pane":!0,"cp-pane--raised":"raised"===this.appearance,"cp-pane--sunken":"sunken"===this.appearance,"cp-pane--lg":"lg"===this.size,"cp-pane--md":"md"===this.size,"cp-pane--sm":"sm"===this.size})}"
    >
      <slot></slot>
    </div>`}};ra.styles=[l`
      .cp-pane {
    ...
    `],_e([ve()],ra.prototype,"appearance",void 0),_e([ve()],ra.prototype,"size",void 0),customElements.get("craft-pane")||customElements.define("craft-pane",ra);var oa=l`
  :host {
...
`,aa=new WeakMap,la=class extends pe{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label="Progress",nt(this,aa,0)}updated(e){if((e.has("total")||e.has("processed"))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&rt(aa,this)<100&&this.dispatchEvent(new CustomEvent("complete",{bubbles:!0,composed:!0})),this.progress=e}e.has("progress")&&(this.progress>0&&this.pending&&(this.pending=!1),ot(aa,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,ot(aa,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?"100%":`${this.progressPercent}%`};return K`
      <div
        class=${Le({"progress-bar":!0,"progress-bar--pending":this.pending})}
        part="track"
        role="progressbar"
        aria-valuenow=${this.pending?Z:this.progressPercent}
        aria-valuemin="0"
        aria-valuemax="100"
    ...
    `}};la.styles=[oa],_e([ve({type:Number})],la.prototype,"progress",void 0),_e([ve({type:Number})],la.prototype,"total",void 0),_e([ve({type:Number})],la.prototype,"processed",void 0),_e([ve({type:Boolean,attribute:"show-status"})],la.prototype,"showStatus",void 0),_e([ve({type:Boolean,reflect:!0})],la.prototype,"pending",void 0),_e([ve({type:Boolean})],la.prototype,"smooth",void 0),_e([ve({type:String})],la.prototype,"label",void 0),customElements.get("craft-progress-bar")||customElements.define("craft-progress-bar",la);var da=new WeakMap,ca=new WeakMap,ha=new WeakMap,ua=new WeakMap,pa=new WeakMap,ma=new WeakMap,fa=new WeakMap,_a=new WeakMap,ba=new WeakMap,ga=new WeakMap,va=new WeakMap,ya=new WeakSet,wa=class extends pe{constructor(...e){super(...e),st(this,ya),this.progress=0,this.failed=!1,this.color="currentColor",this.bgColor="#a3afbb",this.failColor="#da5a47",this.label="Progress",this.autoComplete=!1,nt(this,da,null),nt(this,ca,0),nt(this,ha,0),nt(this,ua,0),nt(this,pa,0),nt(this,ma,0),nt(this,fa,null),nt(this,_a,0),nt(this,ba,null),nt(this,ga,0),nt(this,va,!1)}connectedCallback(){super.connectedCallback(),ot(va,this,window.matchMedia("(prefers-reduced-motion: reduce)").matches)}disconnectedCallback(){super.disconnectedCallback(),it(ya,this,Sa).call(this)}firstUpdated(){ot(da,this,this.renderRoot.querySelector("canvas")),it(ya,this,ka).call(this),it(ya,this,xa).call(this)}updated(e){e.has("progress")?it(ya,this,xa).call(this):(e.has("color")||e.has("bgColor")||e.has("failColor")||e.has("failed"))&&it(ya,this,Ea).call(this)}get canvas(){return rt(da,this)}get prefersReducedMotion(){return rt(va,this)}runCompleteAnimation(){return new Promise(e=>{if(rt(va,this))return ot(ma,this,1),rt(da,this)&&(rt(da,this).style.opacity="0"),it(ya,this,Ea).call(this),void e();it(ya,this,Aa).call(this,1,()=>{rt(da,this)&&(rt(da,this).style.transition="opacity 0.4s",rt(da,this).style.opacity="0"),setTimeout(e,400)})})}async complete(){await this.runCompleteAnimation(),this.dispatchEvent(new CustomEvent("complete",{bubbles:!0,composed:!0}))}render(){return K`
      <canvas
        part="canvas"
        role="progressbar"
    ...
    `}};function ka(){let e=getComputedStyle(this),t=parseFloat(e.getPropertyValue("--_size")),i=parseFloat(e.getPropertyValue("--_stroke-width")),s=window.devicePixelRatio>1?2:1;ot(ca,this,t*s),ot(ha,this,rt(ca,this)/2),ot(pa,this,i*s),ot(ua,this,(t/2-i/2)*s),rt(da,this)&&(rt(da,this).width=rt(ca,this),rt(da,this).height=rt(ca,this))}function xa(){if(this.progress>=0&&null!==rt(ba,this)&&(cancelAnimationFrame(rt(ba,this)),ot(ba,this,null),ot(_a,this,0)),this.progress<0)return void(null===rt(ba,this)&&it(ya,this,Ca).call(this));let e=this.progress/100;if(this.autoComplete&&this.progress>=100&&rt(ga,this)<100)return ot(ga,this,this.progress),void this.complete();rt(ga,this)>0&&this.progress>rt(ga,this)&&!rt(va,this)?it(ya,this,Aa).call(this,e):(ot(ma,this,e),it(ya,this,Ea).call(this)),ot(ga,this,this.progress)}function Ca(){if(rt(va,this))return ot(ma,this,.25),void it(ya,this,Ea).call(this);let e=()=>{ot(_a,this,rt(_a,this)+.05),ot(ma,this,.15+.1*Math.sin(3*rt(_a,this))),it(ya,this,Ea).call(this),ot(ba,this,requestAnimationFrame(e))};ot(ba,this,requestAnimationFrame(e))}function Ea(){let e=rt(da,this)?.getContext("2d");if(e){if(e.clearRect(0,0,rt(ca,this),rt(ca,this)),this.failed)return void it(ya,this,Na).call(this,e,this.failColor,1,0);if(it(ya,this,Na).call(this,e,this.bgColor,1,0),rt(ma,this)>0){let t=this.progress<0?rt(_a,this):-Math.PI/2;it(ya,this,Na).call(this,e,this.color,rt(ma,this),t)}}}function Na(e,t,i,s){e.strokeStyle=t,e.lineWidth=rt(pa,this),e.lineCap="round",e.beginPath(),e.arc(rt(ha,this),rt(ha,this),rt(ua,this),s,s+2*i*Math.PI),e.stroke()}function Aa(e,t){it(ya,this,Sa).call(this);let i=performance.now(),s=rt(ma,this),n=r=>{let o=r-i,a=Math.min(o/500,1);ot(ma,this,s+(e-s)*(1-(1-a)**3)),it(ya,this,Ea).call(this),a<1?ot(fa,this,requestAnimationFrame(n)):(ot(fa,this,null),t?.())};ot(fa,this,requestAnimationFrame(n))}function Sa(){null!==rt(fa,this)&&(cancelAnimationFrame(rt(fa,this)),ot(fa,this,null)),null!==rt(ba,this)&&(cancelAnimationFrame(rt(ba,this)),ot(ba,this,null))}wa.styles=l`
    :host {
  ...
  `,_e([ve({type:Number})],wa.prototype,"progress",void 0),_e([ve({type:Boolean})],wa.prototype,"failed",void 0),_e([ve({type:String})],wa.prototype,"color",void 0),_e([ve({type:String,attribute:"bg-color"})],wa.prototype,"bgColor",void 0),_e([ve({type:String,attribute:"fail-color"})],wa.prototype,"failColor",void 0),_e([ve({type:String})],wa.prototype,"label",void 0),_e([ve({type:Boolean,attribute:"auto-complete"})],wa.prototype,"autoComplete",void 0),customElements.get("craft-progress")||customElements.define("craft-progress",wa);class $a extends(Mn(Vn(pe))){connectedCallback(){super.connectedCallback(),this.setAttribute("role","radiogroup")}resetGroup(){let e;this.formElements.forEach(t=>{"function"==typeof t.resetGroup?t.resetGroup():"function"==typeof t.reset&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}}customElements.get("craft-radio-group")||customElements.define("craft-radio-group",class extends $a{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector('input[type="radio"][name]');e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,cr,l`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      `]}});class Ta extends(Kn(Wn)){connectedCallback(){super.connectedCallback(),this.type="radio"}}var La=class extends(Yn(Ta)){static get styles(){return[...super.styles,l`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get("craft-radio")||customElements.define("craft-radio",La);var Oa=l`
  craft-button {
    cursor: move;
  }
...
`,Fa=class extends pe{constructor(...e){super(...e),this.label=null,this.position="middle",this.orientation="vertical",this.variant="neutral",this.disabled=!1}updated(e){super.updated(e),e.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}_reorder(e){this.disabled||"up"===e&&"first"===this.position||"down"===e&&"last"===this.position||this.dispatchEvent(new CustomEvent("reorder",{detail:{direction:e}}))}_isRtl(){return"rtl"===(this.closest("[dir]")?.getAttribute("dir")??document.documentElement.getAttribute("dir"))?.toLowerCase()}render(){let e=this.label??Qe("Reorder"),t="horizontal"===this.orientation,i=t&&this._isRtl(),s=t?i?"arrow-right":"arrow-left":"arrow-up",n=t?i?"arrow-left":"arrow-right":"arrow-down",r=Qe(t?"Move forward":"Move up"),o=Qe(t?"Move backward":"Move down");return K`
    ...
    `}};Fa.styles=[Oa],_e([ve()],Fa.prototype,"label",void 0),_e([ve({reflect:!0})],Fa.prototype,"position",void 0),_e([ve({reflect:!0})],Fa.prototype,"orientation",void 0),_e([ve({reflect:!0})],Fa.prototype,"variant",void 0),_e([ve({reflect:!0,type:Boolean})],Fa.prototype,"disabled",void 0),customElements.get("craft-reorder-button")||customElements.define("craft-reorder-button",Fa);class Ma extends(As(Si)){static get styles(){return[...super.styles,l`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Da=class extends Ma{static get styles(){return[...super.styles,Ia]}_afterTemplate(){return K`${this.singleOption?"":K`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}};class Va extends(As(mn(Lt(wr)))){static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Ma}}static get properties(){return{navigateWithinInvoker:{type:Boolean,attribute:"navigate-within-invoker"},interactionMode:{type:String,attribute:"interaction-mode"},singleOption:{type:Boolean,reflect:!0,attribute:"single-option"}}}_inputGroupInputTemplate(){return K`
      <div class="input-group__input">
        <slot name="invoker"></slot>
        <div id="overlay-content-node-wrapper">
          <slot name="input"></slot>
...
`,Pa=class extends Va{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Ra]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Da}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,i=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display="",this._overlayCtrl.contentWrapperNode.style.minWidth="auto",this._overlayCtrl.contentWrapperNode.style.width="auto";let s=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;s>0&&(this._invokerNode.style.minWidth=`${s}px`,this._invokerNode.style.width=""),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=i}_inputGroupInputTemplate(){return K`
    ...
    `}};_e([ve({reflect:!0,type:Boolean})],Pa.prototype,"small",void 0),customElements.get("craft-select-rich")||customElements.define("craft-select-rich",Pa);var za=l`
  :host {
    display: block;
  }
`,Ba=class extends pe{constructor(...e){super(...e),this.label="",this.name="",this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return K`<span
    ...
    ></span>`}_optionTemplate(e,t){return K`<craft-option .choiceValue=${e}>
      ...
      >
        ...
        ${jt.map(e=>this._optionTemplate(e,Qe(function(e){return e.charAt(0).toUpperCase()+e.slice(1)}(e))))}
      </craft-select-rich>
    `}};Ba.styles=[za],_e([ve()],Ba.prototype,"label",void 0),_e([ve()],Ba.prototype,"name",void 0),_e([ve({attribute:"model-value"})],Ba.prototype,"modelValue",void 0),_e([ve({type:Boolean,reflect:!0,attribute:"allow-transparent"})],Ba.prototype,"allowTransparent",void 0),customElements.get("craft-select-color")||customElements.define("craft-select-color",Ba);class Ua extends Hn{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>"input"===e.slot)}}class qa extends Ua{get operationMode(){return"select"}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener("change",this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:"model"})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has("disabled")&&(this._inputNode.disabled=this.disabled,this.validate()),e.has("name")&&(this._inputNode.name=this.name),e.has("autocomplete")&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener("change",this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){const t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:""}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=void 0!==this.modelValue?this.modelValue:"")}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent("user-input-changed",{bubbles:!0,composed:!0}))}}var Ha=l`
  ${dr}
...
`,Wa=class extends qa{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Ha]}_inputGroupInputTemplate(){return K`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};_e([ve({reflect:!0,type:Boolean})],Wa.prototype,"small",void 0),customElements.get("craft-select")||customElements.define("craft-select",Wa);var ja=l`
  :host {
    display: inline-block;
  }
...
`,Ka=new WeakSet,Ga=class extends pe{constructor(...e){super(...e),st(this,Ka),this.min=0,this.max=100,this.step=10,this.value=0,this.label=Qe("Number of columns"),this.valueUnit="",this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has("min")||e.has("max")||e.has("step")||e.has("value")){let e=it(Ka,this,Ya).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=it(Ka,this,Za).call(this);return K`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${it(Ka,this,Xa).call(this,this.value)}
        aria-readonly=${this.readOnly?"true":"false"}
        aria-describedby=${Co(this.describedBy)}
        @keydown=${it(Ka,this,tl)}
      >
        ${e.map(e=>K`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>it(Ka,this,el).call(this,e)}
              title=${it(Ka,this,Xa).call(this,e)}
              >${Z}</span
            >
          `)}
      </div>
    `}};function Za(){let{min:e,max:t,step:i}=this;if(i<=0||t<e)throw Error("Invalid craft-slide-picker range configuration.");let s=(t-e)/i;if(!Number.isInteger(s))throw Error("Invalid craft-slide-picker step configuration for the provided range.");return Array.from({length:s+1},(t,s)=>e+s*i)}function Ya(e){it(Ka,this,Za).call(this);let{min:t,max:i,step:s}=this,n=t+Math.round((Math.min(Math.max(e,t),i)-t)/s)*s;return Math.min(Math.max(n,t),i)}function Ja(){return"rtl"===(this.closest("[dir]")?.getAttribute("dir")??document.documentElement.getAttribute("dir"))?.toLowerCase()}function Xa(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function Qa(e,t){let i=it(Ka,this,Ya).call(this,e);i!==this.value&&(this.value=i,t&&this.dispatchEvent(new CustomEvent("value-change",{detail:{value:i},bubbles:!0,composed:!0})))}function el(e){this.readOnly||it(Ka,this,Qa).call(this,e,!0)}function tl(e){if(this.readOnly)return;let t=it(Ka,this,Ja).call(this);switch(e.key){case"ArrowUp":it(Ka,this,Qa).call(this,this.value+this.step,!0),e.preventDefault();break;case"ArrowDown":it(Ka,this,Qa).call(this,this.value-this.step,!0),e.preventDefault();break;case"ArrowRight":it(Ka,this,Qa).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case"ArrowLeft":it(Ka,this,Qa).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case"Home":it(Ka,this,Qa).call(this,this.min,!0),e.preventDefault();break;case"End":it(Ka,this,Qa).call(this,this.max,!0),e.preventDefault()}}Ga.styles=[ja],_e([ve({type:Number})],Ga.prototype,"min",void 0),_e([ve({type:Number})],Ga.prototype,"max",void 0),_e([ve({type:Number})],Ga.prototype,"step",void 0),_e([ve({type:Number})],Ga.prototype,"value",void 0),_e([ve()],Ga.prototype,"label",void 0),_e([ve({attribute:"described-by"})],Ga.prototype,"describedBy",void 0),_e([ve({attribute:"value-unit"})],Ga.prototype,"valueUnit",void 0),_e([ve({attribute:!1})],Ga.prototype,"valueLabel",void 0),_e([ve({type:Boolean,reflect:!0,attribute:"read-only"})],Ga.prototype,"readOnly",void 0),customElements.get("craft-slide-picker")||customElements.define("craft-slide-picker",Ga);var il=l`
  :host {
    display: block;
  }
...
`,sl=new WeakMap,nl=new WeakMap,rl=new WeakMap,ol=new WeakMap,al=new WeakMap,ll=new WeakMap,dl=new WeakSet,cl=class extends pe{constructor(...e){super(...e),st(this,dl),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=Qe("Rotate"),nt(this,sl,!1),nt(this,nl,!1),nt(this,rl,0),nt(this,ol,0),nt(this,al,0),nt(this,ll,null)}connectedCallback(){super.connectedCallback(),ot(ll,this,new ResizeObserver(()=>it(dl,this,ul).call(this))),rt(ll,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),rt(ll,this)?.disconnect(),ot(ll,this,null)}firstUpdated(){ot(al,this,10*(it(dl,this,hl).call(this).length-1)),it(dl,this,ul).call(this)}updated(e){(e.has("value")||e.has("min")||e.has("max")||e.has("graduationMin")||e.has("graduationMax"))&&it(dl,this,ul).call(this)}render(){return K`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${it(dl,this,pl).call(this,this.value)}
        @keydown=${it(dl,this,kl)}
        @pointerdown=${it(dl,this,gl)}
        @pointermove=${it(dl,this,vl)}
        @pointerup=${it(dl,this,yl)}
      >
        <div class="overlay"></div>
        <div class="cursor"></div>
        <div class="graduations">
          <ul aria-hidden="true">
            ${it(dl,this,hl).call(this).map(e=>K`
                <li
                  class=${Le({graduation:!0,"main-graduation":e%5==0,selected:it(dl,this,xl).call(this,e)})}
                  data-graduation=${e}
                >
    ...
    `}};function hl(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function ul(){this._list&&(this._list.style.left=`${it(dl,this,fl).call(this,this.value)}px`)}function pl(e){return Qe("{num, number} {num, plural, =1{degree} other{degrees}}",{num:Math.round(e)})}function ml(e){let t=-1*this.graduationMin,i=-1*(this.graduationMin-this.graduationMax);return(this._graduations.offsetWidth/2+-1*e)/rt(al,this)*i-t}function fl(e){let t=-1*this.graduationMin,i=-1*(this.graduationMin-this.graduationMax);return-((e+t)*rt(al,this)/i-this._graduations.offsetWidth/2)}function _l(e,t=!0){let i=Math.min(Math.max(e,this.min),this.max);this.value=i,t&&it(dl,this,bl).call(this,"change")}function bl(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function gl(e){ot(nl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),rt(nl,this)&&(e.preventDefault(),ot(rl,this,e.clientX),ot(ol,this,this._list.offsetLeft),this._root.setPointerCapture(e.pointerId),it(dl,this,bl).call(this,"start"))}function vl(e){rt(nl,this)&&Math.abs(e.clientX-rt(rl,this))>3&&(ot(sl,this,!0),this._root.classList.add("dragging"),e.preventDefault(),it(dl,this,wl).call(this,e))}function yl(e){rt(nl,this)&&(rt(sl,this)?(e.preventDefault(),ot(sl,this,!1),this._root.classList.remove("dragging")):it(dl,this,wl).call(this,e),it(dl,this,bl).call(this,"end"),this._root.releasePointerCapture(e.pointerId),ot(rl,this,0),ot(nl,this,!1))}function wl(e){let t=rt(sl,this)?rt(rl,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,i=rt(sl,this)?t-e.clientX:e.clientX-t,s=rt(ol,this)-i;it(dl,this,_l).call(this,it(dl,this,ml).call(this,s))}function kl(e){let t=this.value;switch(e.key){case"ArrowUp":case"ArrowRight":it(dl,this,_l).call(this,t+1);break;case"ArrowDown":case"ArrowLeft":it(dl,this,_l).call(this,t-1);break;case"PageUp":it(dl,this,_l).call(this,t+10);break;case"PageDown":it(dl,this,_l).call(this,t-10);break;case"Home":it(dl,this,_l).call(this,this.min);break;case"End":it(dl,this,_l).call(this,this.max);break;default:return}e.preventDefault()}function xl(e){return e>=Math.min(0,this.value)&&e<=Math.max(0,this.value)}cl.styles=[il],_e([ve({type:Number})],cl.prototype,"min",void 0),_e([ve({type:Number})],cl.prototype,"max",void 0),_e([ve({type:Number})],cl.prototype,"value",void 0),_e([ve({type:Number,attribute:"graduation-min"})],cl.prototype,"graduationMin",void 0),_e([ve({type:Number,attribute:"graduation-max"})],cl.prototype,"graduationMax",void 0),_e([ve()],cl.prototype,"label",void 0),_e([ke(".slide-rule")],cl.prototype,"_root",void 0),_e([ke(".graduations")],cl.prototype,"_graduations",void 0),_e([ke(".graduations ul")],cl.prototype,"_list",void 0),_e([ke(".cursor")],cl.prototype,"_cursor",void 0),customElements.get("craft-slide-rule")||customElements.define("craft-slide-rule",cl);var Cl=l`
  :host {
    display: inline-flex;
...
`,El=class extends pe{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return K`
      <span
        class="${Le({status:!0,"status--live":"live"===this.status,"status--enabled":"enabled"===this.status,"status--pending":"pending"===this.status,"status--expired":"expired"===this.status,"status--disabled":"disabled"===this.status})}"
        role="img"
        aria-label="${this.getLabel()}"
      ></span>
    `}};El.styles=[Cl],_e([ve()],El.prototype,"label",void 0),_e([ve()],El.prototype,"status",void 0),customElements.get("craft-status")||customElements.define("craft-status",El);class Nl extends(Ei(pe)){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[l`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}constructor(){super(),this.value="",this.checked=!1,this.__initialized=!1,this._toggleChecked=this._toggleChecked.bind(this),this.__handleKeydown=this._handleKeydown.bind(this),this.__handleKeyup=this._handleKeyup.bind(this)}connectedCallback(){super.connectedCallback(),this.setAttribute("role","switch"),this.setAttribute("aria-checked",`${this.checked}`),this.addEventListener("click",this._toggleChecked),this.addEventListener("keydown",this.__handleKeydown),this.addEventListener("keyup",this.__handleKeyup)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._toggleChecked),this.removeEventListener("keydown",this.__handleKeydown),this.removeEventListener("keyup",this.__handleKeyup)}_toggleChecked(){this.disabled||(this.focus(),this.checked=!this.checked)}__checkedStateChange(){this.dispatchEvent(new Event("checked-changed",{bubbles:!0})),this.setAttribute("aria-checked",`${this.checked}`)}_handleKeydown(e){" "===e.key&&e.preventDefault()}_handleKeyup(e){[" ","Enter"].includes(e.key)&&this._toggleChecked()}updated(e){super.updated(e),e.has("disabled")&&this.setAttribute("aria-disabled",`${this.disabled}`)}requestUpdate(e,t,i){super.requestUpdate(e,t,i),this.__initialized&&this.isConnected&&"checked"===e&&this.checked!==t&&!this.disabled&&this.__checkedStateChange()}firstUpdated(e){super.firstUpdated(e),this.__initialized=!0}}var Al=class extends Nl{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has("indeterminate")||e.has("checked"))&&this.setAttribute("aria-checked",this.checked?"true":this.indeterminate?"mixed":"false")}static get styles(){return[...super.styles,l`
      ...
      `]}};_e([ve({type:Boolean,reflect:!0})],Al.prototype,"indeterminate",void 0),customElements.get("craft-switch-button")||customElements.define("craft-switch-button",Al);class Sl extends(mn(Kn(Hn))){static get styles(){return[...super.styles,l`
        :host([hidden]) {
          display: none;
        }
...
`;function Tl(e){return(e??"").split(/\s+/).filter(Boolean)}const Ll=Symbol.for("craft-switch-synthetic-change");var Ol=new WeakMap,Fl=new WeakSet,Ml=class extends Sl{constructor(...e){super(...e),st(this,Fl),this.size="medium",this.onLabel="",this.offLabel="",this.checkedValue="1",this.indeterminateValue="-",this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,nt(this,Ol,!1),this.__onKeydown=e=>{if("ArrowLeft"!==e.key&&"ArrowRight"!==e.key||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t="rtl"===getComputedStyle(this).direction;this._setCheckedState(e.key===(t?"ArrowLeft":"ArrowRight"))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,dr,$l]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement("craft-switch-button");return e.setAttribute("size",this.size),e.setAttribute("data-tag-name","craft-switch-button"),e},"state-description":()=>{let e=document.createElement("div");return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement("input");return e.type="hidden",e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Al}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener("checked-changed",this.__forwardNativeChange),this.addEventListener("keydown",this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("checked-changed",this.__forwardNativeChange),this.removeEventListener("keydown",this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&"hidden-input"===e.slot)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:""}get _stateDescriptionNode(){return Array.from(this.children).find(e=>"state-description"===e.slot)}get _stateDescriptionText(){return[this.onLabel?Qe("Check for {onLabel}.",{onLabel:this.onLabel}):"",this.offLabel?Qe("Uncheck for {offLabel}.",{offLabel:this.offLabel}):""].filter(Boolean).join(" ")}updated(e){super.updated(e),e.has("checked")&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has("onLabel")||e.has("offLabel"))&&this.__syncStateDescription(),["checked","indeterminate","checkedValue","indeterminateValue","disabled","size"].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has("checked")||e.has("indeterminate"))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute("data-target"),i=e.getAttribute("data-reverse-target");if(!t&&!i)return;let s=window.jQuery;s&&s(e).data?.("fieldtoggle")||(this.__toggleTargets(t,this.checked),this.__toggleTargets(i,!this.checked))}__toggleTargets(e,t){if(!e)return;let i=/^[#.]/.test(e)?e:`#${e}`,s=this.getRootNode(),n=!1;for(let e of s.querySelectorAll(i))e.classList.contains("hidden")===t&&(e.classList.toggle("hidden",!t),n=!0);n&&t&&window.dispatchEvent(new Event("resize"))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){it(Fl,this,Il).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){it(Fl,this,Il).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){it(Fl,this,Il).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(rt(Ol,this))return;let e=new Event("change",{bubbles:!0});e[Ll]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Ll in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let i of Tl(e.getAttribute("aria-labelledby"))){let e=t.getElementById(i);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let i of Tl(e.getAttribute("aria-describedby"))){let e=t.getElementById(i);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),i=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let s of t.querySelectorAll(`label[for="${function(e){return typeof CSS<"u"&&"function"==typeof CSS.escape?CSS.escape(e):e}(e.id)}"]`))i.add(s);for(let e of i)this.__clickableExternalLabels.has(e)||(e.addEventListener("click",this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener("click",this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute("size")!==this.size&&e.setAttribute("size",this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:"state-description",reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return K`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return K`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t="on"===e?this.onLabel:this.offLabel;return t?K`<span
    ...
    `}};function Il(e,t){if(!this.disabled){if(!t)return void e();ot(Ol,this,!0),e(),this.updateComplete.then(()=>{ot(Ol,this,!1)})}}function Dl(e){e.removeAttribute("selected")}function Vl(e){e.removeAttribute("selected"),e.setAttribute("aria-selected","false"),e.setAttribute("tabindex","-1")}function Rl(e){const t=e;switch(t.key){case"ArrowDown":case"ArrowRight":case"ArrowUp":case"ArrowLeft":case"Home":case"End":t.preventDefault()}}_e([ve({type:String,reflect:!0})],Ml.prototype,"size",void 0),_e([ve({type:String,attribute:"on-label"})],Ml.prototype,"onLabel",void 0),_e([ve({type:String,attribute:"off-label"})],Ml.prototype,"offLabel",void 0),_e([ve({attribute:"value"})],Ml.prototype,"checkedValue",void 0),_e([ve({attribute:"indeterminate-value"})],Ml.prototype,"indeterminateValue",void 0),_e([ve({type:Boolean,reflect:!0})],Ml.prototype,"indeterminate",void 0),customElements.get("craft-switch")||customElements.define("craft-switch",Ml);class Pl extends pe{static get properties(){return{selectedIndex:{type:Number,attribute:"selected-index",reflect:!0}}}static get styles(){return[l`
        .tabs__tab-group {
          display: flex;
        }
...
`;customElements.get("craft-tabs")||customElements.define("craft-tabs",class extends Pl{static get styles(){return[...super.styles,zl]}});var Bl=l`
  :host {
    display: inline-flex;
...
`,Jl=class extends Zl{constructor(...e){super(...e),this.monospace=!1}static get styles(){return[...super.styles,cr,Yl]}};_e([ve({type:Boolean,reflect:!0})],Jl.prototype,"monospace",void 0),customElements.get("craft-textarea")||customElements.define("craft-textarea",Jl);var Xl=l`
  :host {
...
`,Ql=class extends pe{constructor(...e){super(...e),this.src=null,this.srcset=null,this.sizes=null,this.alt="",this.width=null,this.height=null,this.loading="lazy",this.checkered=!0,this.rounded=!1}render(){return K`
      <div class="${Le({thumbnail:!0,"thumbnail--checkered":this.checkered,"thumbnail--rounded":this.rounded})}" part="thumbnail">
        ${this.src?K`<img
              class="thumbnail__image"
              part="image"
              src="${this.src}"
              srcset="${Co(this.srcset??void 0)}"
              sizes="${Co(this.sizes??void 0)}"
              width="${Co(this.width??void 0)}"
              height="${Co(this.height??void 0)}"
              alt="${this.alt}"

...
`;class Ai extends(jt(zt(pe))){static get properties(){return{invokerRelation:{type:String,attribute:"invoker-relation"}}}static get styles(){return[...super.styles,r`
      ...
      `]}constructor(){super(),this.hasArrow=!1,this.invokerRelation="description"}static enabledWarnings=super.enabledWarnings?.filter(e=>"change-in-update"!==e)||[];_defineOverlayConfig(){const e=super._defineOverlayConfig(),t=qt({invokerRelation:this.invokerRelation});return{...e,...t,popperConfig:{...e.popperConfig||{},...t.popperConfig||{},modifiers:[...e.popperConfig?.modifiers||[],...t.popperConfig?.modifiers||[]]}}}}var Ni=new WeakMap,Ti=new WeakMap,Oi=new WeakSet,Mi=class extends Ai{constructor(){super(),Ae(this,Oi),this.placement="top",this.trigger="hover focus",Ne(this,Ni,null),Ne(this,Ti,()=>{this.opened=!this.opened}),gt(this)}static get styles(){return[...super.styles,r`
        ::slotted([slot='content']) {
...
`,$o=new WeakMap,Io=new WeakSet,Fo=class extends Mo{constructor(...e){super(...e),Ae(this,Io),this.hint=null,Ne(this,$o,void 0)}static get styles(){return[...Mo.styles,Lo]}connectedCallback(){super.connectedCallback(),Do._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),Do._.unobserve(this)}render(){return H`
      <div class="choice-field__label">
        <slot></slot>
...
`,Or=class extends pe{constructor(...e){super(...e),this.value="",this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,"$1-$2").replace(/[\s_]+/g,"-").toLowerCase()}`}render(){return H`
    ...
    `}}const Lr=typeof CSSStyleSheet<"u"?new CSSStyleSheet:null;Lr?.replaceSync("\n  .craft-dialog {\n    background-color: var(--c-surface-raised);\n    border-radius: var(--c-radius-md);\n    box-shadow: var(--c-shadow-lg);\n    min-width: min(90vw, 24rem);\n    max-width: min(90vw, 40rem);\n  }\n\n  .craft-dialog__header {\n    display: flex;\n    align-items: flex-start;\n    justify-content: space-between;\n    gap: var(--c-spacing-md);\n    padding-inline: var(--c-spacing-lg);\n    padding-block-start: var(--c-spacing-lg);\n    padding-block-end: var(--c-spacing-md);\n  }\n\n  .craft-dialog__title {\n    font-size: 1.25em;\n    margin: 0;\n  }\n\n  .craft-dialog__close {\n    background: none;\n    border: none;\n    cursor: pointer;\n    color: inherit;\n    padding: var(--c-spacing-xs);\n    line-height: 1;\n  }\n\n  .craft-dialog__body {\n    padding-inline: var(--c-spacing-lg);\n    padding-block-end: var(--c-spacing-lg);\n  }\n\n  .craft-dialog__footer {\n    display: flex;\n    justify-content: flex-end;\n    gap: var(--c-spacing-sm);\n    padding-inline: var(--c-spacing-lg);\n    padding-block-end: var(--c-spacing-lg);\n  }\n");var $r=new WeakMap,Ir=new WeakMap,Fr=new WeakSet,Pr=class extends Mr{constructor(){super(),Ae(this,Fr),this.openAttribute=!1,this.label="",Ne(this,$r,null),Ne(this,Ir,null),gt(this),this.addEventListener("opened-changed",()=>{let e=!!this.opened;this.openAttribute!==e&&(this.openAttribute=e)})}static get styles(){return[r`
        :host {
          display: contents;
        }
...
`,Hr=class extends(Ws(pe)){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=ft("This field is translatable."),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition="before",this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[Si,Ms,qr]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth()}__syncHasMaxlength(){this.toggleAttribute("has-maxlength",this.querySelector(':scope > [slot="input"]')?.hasAttribute("maxlength")??!1)}__syncControlWidth(){if(void 0!==this.width)return;let e=this.querySelector(':scope > [slot="input"]')?.getAttribute("width");("full"===e||"auto"===e)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has("disabled")&&this._inputNode?.removeAttribute("aria-disabled"),e.has("fieldset")&&this.__syncFieldsetSemantics(),(e.has("label")||e.has("required")||e.has("translatable")||e.has("translationDescription"))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:"rtl"===(this.closest("[dir]")?.getAttribute("dir")??document.documentElement.getAttribute("dir"))?.toLowerCase()?"rtl":"ltr"}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let i=this.__formControlTarget();i?i.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??"label"}`}):!this.fieldset&&this.__hasNativeLabelTarget()?super.addToAriaLabelledBy(e,{...t,reorder:!1}):this.__addGroupAriaReference("aria-labelledby",e,"label")}addToAriaDescribedBy(e,t={}){let i=this.__formControlTarget();i?i.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??"description"}`}):!this.fieldset&&this.__hasNativeLabelTarget()?super.addToAriaDescribedBy(e,{...t,reorder:!1}):this.__addGroupAriaReference("aria-describedby",e,t.idPrefix??"description")}render(){return H`
    ...
    `}_labelTemplate(){return H`
      <div class="heading form-field__label">
        ...
        ${this.__hasLightChild("label-extra")?H`<div class="flex-grow"></div>`:Y}
...
`;customElements.get("craft-input-file")||customElements.define("craft-input-file",class extends La{static get styles(){return[...super.styles,Ls,$a]}get slots(){return{...super.slots,"file-select-button":()=>H`<craft-button
          type="button"
          id="select-button-${this._inputId}"
          @click="${this.__openDialogOnBtnClick}"
        >
...
`,Ol=new WeakMap,Ml=class extends pe{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label="Progress",Ne(this,Ol,0)}updated(e){if((e.has("total")||e.has("processed"))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&Te(Ol,this)<100&&this.dispatchEvent(new CustomEvent("complete",{bubbles:!0,composed:!0})),this.progress=e}e.has("progress")&&(this.progress>0&&this.pending&&(this.pending=!1),Oe(Ol,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,Oe(Ol,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?"100%":`${this.progressPercent}%`};return H`
  ...
  `,ge([_e({type:Number})],ql.prototype,"progress",void 0),ge([_e({type:Boolean})],ql.prototype,"failed",void 0),ge([_e({type:String})],ql.prototype,"color",void 0),ge([_e({type:String,attribute:"bg-color"})],ql.prototype,"bgColor",void 0),ge([_e({type:String,attribute:"fail-color"})],ql.prototype,"failColor",void 0),ge([_e({type:String})],ql.prototype,"label",void 0),ge([_e({type:Boolean,attribute:"auto-complete"})],ql.prototype,"autoComplete",void 0),customElements.get("craft-progress")||customElements.define("craft-progress",ql);class Ql extends(Kn(Jn(pe))){connectedCallback(){super.connectedCallback(),this.setAttribute("role","radiogroup")}resetGroup(){let e;this.formElements.forEach(t=>{"function"==typeof t.resetGroup?t.resetGroup():"function"==typeof t.reset&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}}customElements.get("craft-radio-group")||customElements.define("craft-radio-group",class extends Ql{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector('input[type="radio"][name]');e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,Ls,r`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
...
`,Sc=new WeakMap,Ac=new WeakMap,Nc=new WeakMap,Tc=new WeakMap,Oc=new WeakMap,Mc=new WeakMap,Lc=new WeakSet,$c=class extends pe{constructor(...e){super(...e),Ae(this,Lc),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=ft("Rotate"),Ne(this,Sc,!1),Ne(this,Ac,!1),Ne(this,Nc,0),Ne(this,Tc,0),Ne(this,Oc,0),Ne(this,Mc,null)}connectedCallback(){super.connectedCallback(),Oe(Mc,this,new ResizeObserver(()=>Se(Lc,this,Fc).call(this))),Te(Mc,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),Te(Mc,this)?.disconnect(),Oe(Mc,this,null)}firstUpdated(){Oe(Oc,this,10*(Se(Lc,this,Ic).call(this).length-1)),Se(Lc,this,Fc).call(this)}updated(e){(e.has("value")||e.has("min")||e.has("max")||e.has("graduationMin")||e.has("graduationMax"))&&Se(Lc,this,Fc).call(this)}render(){return H`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
      ...
      >
        ...
        <div class="graduations">
          <ul aria-hidden="true">
            ${Se(Lc,this,Ic).call(this).map(e=>H`
                <li
...
`;const sh=/^[\p{L}\p{N}_-]*$/u,nh=ft("Suggestions"),oh={"#":ft("Environment"),"@":ft("Users")},rh=["role","aria-autocomplete","aria-haspopup","aria-expanded","aria-controls","aria-activedescendant","aria-busy"],ah={handlesAccessibility:!1,visibilityTriggerFunction:void 0};let lh=0;var ch=new WeakMap,dh=new WeakMap,hh=new WeakMap,uh=new WeakMap,ph=new WeakMap,mh=new WeakMap,fh=new WeakMap,gh=new WeakMap,vh=new WeakMap,bh=new WeakMap,_h=new WeakMap,yh=new WeakMap,kh=new WeakMap,wh=new WeakMap,xh=new WeakSet,Eh=new WeakMap,Ch=new WeakMap,Sh=new WeakMap,Ah=new WeakMap,Nh=new WeakMap,Th=new WeakMap,Oh=new WeakMap,Mh=new WeakMap,Lh=new WeakMap,$h=new WeakMap,Ih=new WeakMap,Fh=class extends pe{constructor(...e){super(...e),Ae(this,xh),this.for="",this.triggers={},this.loading=!1,this.announcement="",Ne(this,ch,void 0),Ne(this,dh,null),Ne(this,hh,null),Ne(this,uh,new Map),Ne(this,ph,null),Ne(this,mh,[]),Ne(this,fh,0),Ne(this,gh,null),Ne(this,vh,null),Ne(this,bh,null),Ne(this,_h,!1),Ne(this,yh,null),Ne(this,kh,new DOMRect),Ne(this,wh,new MutationObserver(()=>{let e=Se(xh,this,Dh).call(this);(ru(e)&&e!==Te(dh,this)||Te(dh,this)&&!Te(dh,this).isConnected)&&Se(xh,this,Vh).call(this)})),Ne(this,Eh,()=>{Te(_h,this)||Se(xh,this,Hh).call(this)}),Ne(this,Ch,()=>{Oe(_h,this,!0),Se(xh,this,tu).call(this)}),Ne(this,Sh,()=>{Oe(_h,this,!1),Se(xh,this,Hh).call(this)}),Ne(this,Ah,()=>{queueMicrotask(()=>Se(xh,this,tu).call(this))}),Ne(this,Nh,()=>{let e=Te(dh,this);!e||!Te(ph,this)||!au(e)||queueMicrotask(()=>{Te(ph,this)&&(e.selectionStart!==Te(ph,this).end||e.selectionEnd!==Te(ph,this).end)&&Se(xh,this,Hh).call(this)})}),Ne(this,Th,()=>{Te(ph,this)&&Se(xh,this,eu).call(this)}),Ne(this,Oh,e=>{let t=e;Te(ph,this)&&Te(ch,this).querySelector('[aria-selected="true"]')&&["ArrowDown","ArrowUp","Enter"].includes(t.key)&&t.stopPropagation()}),Ne(this,Mh,e=>{e.target instanceof Element&&e.target.closest('[role="option"]')&&e.preventDefault()}),Ne(this,Lh,e=>{"touch"===e.pointerType&&e.target instanceof Element&&e.target.closest('[role="option"]')?.click()}),Ne(this,$h,e=>{Se(xh,this,Jh).call(this,Number(e.target.dataset.index))}),Ne(this,Ih,e=>{if(e.target!==this.popoverElement)return;let t=Te(ch,this).getAttribute("aria-label")??nh;Se(xh,this,nu).call(this),Oe(ph,this,null),Se(xh,this,su).call(this),Se(xh,this,ou).call(this,t===nh?ft("Suggestions collapsed"):ft("{name} suggestions collapsed",{name:t}))})}connectedCallback(){super.connectedCallback(),Se(xh,this,Ph).call(this),this.hasUpdated&&Se(xh,this,Vh).call(this)}disconnectedCallback(){Se(xh,this,Bh).call(this),Te(ch,this)?.remove(),null!==Te(bh,this)&&(clearTimeout(Te(bh,this)),Oe(bh,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),Se(xh,this,Vh).call(this)}updated(e){super.updated(e),e.has("for")&&Te(dh,this)!==Se(xh,this,Dh).call(this)&&Se(xh,this,Vh).call(this),e.has("triggers")&&e.get("triggers")&&Se(xh,this,tu).call(this)}render(){return H`
      <craft-popover
        exportparts="popup"
        .config=${ah}
        @craft-hide=${Te(Ih,this)}
      >
    ...
    `}};function Ph(){Oe(ch,this,document.createElement("div")),Te(ch,this).id="craft-text-expander-listbox-"+ ++lh,Te(ch,this).slot="listbox",Te(ch,this).setAttribute("part","listbox"),Te(ch,this).role="listbox",Te(ch,this).setAttribute("aria-label",nh),Te(ch,this).addEventListener("pointerdown",Te(Mh,this)),Te(ch,this).addEventListener("pointerup",Te(Lh,this)),Te(ch,this).addEventListener("combobox-commit",Te($h,this)),this.append(Te(ch,this))}function Dh(){return this.getRootNode().getElementById(this.for)}function Vh(){let e=Se(xh,this,Dh).call(this);Se(xh,this,Bh).call(this),ru(e)?(Oe(dh,this,e),Se(xh,this,zh).call(this,e),Oe(hh,this,new Wd(e,Te(ch,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:"selected",scrollIntoViewOptions:{block:"nearest"}})),Se(xh,this,jh).call(this,e),e.addEventListener("input",Te(Eh,this)),e.addEventListener("keydown",Te(Oh,this)),e.addEventListener("blur",Te(Ah,this)),e.addEventListener("compositionstart",Te(Ch,this)),e.addEventListener("compositionend",Te(Sh,this)),e.ownerDocument.addEventListener("selectionchange",Te(Nh,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>Te(kh,this)},Se(xh,this,Rh).call(this)):Se(xh,this,Rh).call(this)}function Rh(){Te(wh,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:["id"],childList:!0,subtree:!0})}function Bh(){Te(wh,this).disconnect(),Se(xh,this,tu).call(this);let e=Te(dh,this);e&&(e.removeEventListener("input",Te(Eh,this)),e.removeEventListener("keydown",Te(Oh,this)),e.removeEventListener("blur",Te(Ah,this)),e.removeEventListener("compositionstart",Te(Ch,this)),e.removeEventListener("compositionend",Te(Sh,this)),e.ownerDocument.removeEventListener("selectionchange",Te(Nh,this)),Te(yh,this)?.getStyleClone().disconnect(),Oe(yh,this,null),Te(hh,this)?.destroy(),Oe(hh,this,null),Se(xh,this,Uh).call(this,e),Oe(dh,this,null))}function zh(e){Te(uh,this).clear();for(let t of rh)Te(uh,this).set(t,e.getAttribute(t))}function jh(e){let t=[Te(uh,this).get("aria-controls"),Te(ch,this).id].filter(Boolean).join(" ");e.setAttribute("aria-autocomplete","list"),e.setAttribute("aria-controls",t),e.setAttribute("data-text-expander-input",""),"combobox"===e.getAttribute("role")&&e.removeAttribute("role"),e instanceof HTMLInputElement?e.setAttribute("aria-haspopup","listbox"):Se(xh,this,qh).call(this,e,"aria-haspopup"),Se(xh,this,qh).call(this,e,"aria-expanded")}function Uh(e){for(let t of rh)Se(xh,this,qh).call(this,e,t);Te(uh,this).clear()}function qh(e,t){let i=Te(uh,this).get(t);null==i?e.removeAttribute(t):e.setAttribute(t,i)}function Hh(){Se(xh,this,nu).call(this);let e=Se(xh,this,Gh).call(this);if(!e)return Oe(ph,this,null),void Se(xh,this,iu).call(this);Oe(ph,this,e);let t=e.trigger.limit??8;if(e.trigger.options){this.loading=!1;let i=e.query.toLowerCase(),s=e.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(i))).slice(0,t);return void Se(xh,this,Zh).call(this,s)}this.loading=!0,Se(xh,this,Zh).call(this,[]),Se(xh,this,ou).call(this,ft("Loading"));let i=Te(fh,this);Oe(vh,this,setTimeout(()=>{Se(xh,this,Wh).call(this,e,t,i)},150))}async function Wh(e,t,i){let s;Oe(gh,this,new AbortController);try{let i=await Re.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,limit:t},signal:Te(gh,this).signal});if(!Array.isArray(i.data))throw TypeError("Text expander sources must return an array.");s=i.data}catch(t){if(i!==Te(fh,this)||function(e){return e instanceof DOMException&&"AbortError"===e.name}(t))return;return Se(xh,this,tu).call(this),void this.dispatchEvent(new CustomEvent("craft-text-expander-error",{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}))}i===Te(fh,this)&&(this.loading=!1,Se(xh,this,Zh).call(this,s.slice(0,t)))}function Gh(){let e=Te(dh,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!au(e)||null===e.selectionStart||null===e.selectionEnd||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,i=e.value.slice(0,t),s=null;for(let[e,n]of Object.entries(this.triggers)){let o=i.lastIndexOf(e);if(-1===o||s&&o<=s.start)continue;let r=Array.from(i.slice(0,o)).at(-1),a=i.slice(o+e.length);(!r||/\s/u.test(r))&&sh.test(a)&&(s={character:e,query:a,start:o,end:t,trigger:n})}return s}function Kh(){return Te(ph,this)?.character??null}function Yh(){let e=(null===Kh.call(Se(xh,this))?void 0:oh[Kh.call(Se(xh,this))])??nh;Te(ch,this).setAttribute("aria-label",e)}function Zh(e){if(Se(xh,this,Xh).call(this),Oe(mh,this,e),Te(ch,this).replaceChildren(),Te(ch,this).hidden=this.loading,Se(xh,this,Yh).call(this),e.forEach((e,t)=>{let i=document.createElement("craft-option");i.id=`${Te(ch,this).id}-option-${t}`,i.setAttribute("part","option"),i.dataset.index=String(t),i.setAttribute("aria-label",e.label),i.append(Te(ph,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),Te(ch,this).append(i)}),!this.loading&&!e.length)return Oe(ph,this,null),Se(xh,this,iu).call(this),void Se(xh,this,ou).call(this,ft("No suggestions"));this.updateComplete.then(()=>{Te(ph,this)&&Se(xh,this,Qh).call(this)})}function Jh(e){let t=Te(dh,this),i=Te(mh,this)[e],s=Se(xh,this,Gh).call(this),n=Te(ph,this);if(!(t&&i&&n&&s&&s.start===n.start&&s.end===n.end&&s.character===n.character&&s.query===n.query))return void Se(xh,this,tu).call(this);!function(e,t,i,s){e.maxLength>=0&&(s=s.slice(0,Math.max(0,e.maxLength-(e.value.length-(i-t)))));let n=`${e.value.slice(0,t)}${s}${e.value.slice(i)}`,o=!1,r=()=>{o=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,i),e.addEventListener("input",r,{once:!0});try{e.ownerDocument.execCommand?.("insertText",!1,s)}catch{}e.removeEventListener("input",r),e.value!==n&&(e.setRangeText(s,t,i,"end"),o=!1),o||e.dispatchEvent(new InputEvent("input",{bubbles:!0,composed:!0,data:s,inputType:"insertReplacementText"}))}(t,n.start,n.end,i.value);let o={character:n.character,query:n.query,option:i};Se(xh,this,tu).call(this),this.dispatchEvent(new CustomEvent("craft-text-expander-select",{bubbles:!0,composed:!0,detail:o}))}async function Qh(){await this.popoverElement.updateComplete;let e=Te(dh,this);e&&Se(xh,this,eu).call(this)?(e.setAttribute("aria-busy",String(this.loading)),await this.popoverElement.show(),Te(ph,this)&&e===Te(dh,this)&&Te(mh,this).length&&(Te(hh,this)?.start(),Se(xh,this,qh).call(this,e,"aria-expanded"),e.removeEventListener("input",Te(Eh,this)),e.addEventListener("input",Te(Eh,this)))):Se(xh,this,tu).call(this)}function Xh(){Te(hh,this)?.stop(),Te(dh,this)&&Se(xh,this,qh).call(this,Te(dh,this),"aria-expanded")}function eu(){let e=Te(dh,this),t=e?.selectionStart;if(!e?.isConnected||null==t)return!1;if(!Te(yh,this)){Oe(yh,this,new th(e));let t=Te(yh,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener("update",Te(Th,this))}return Te(yh,this).setStartOffset(t),Te(yh,this).setEndOffset(t),Oe(kh,this,Te(yh,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function tu(){Se(xh,this,nu).call(this),Oe(ph,this,null),Se(xh,this,iu).call(this)}function iu(){Se(xh,this,su).call(this),this.popoverElement.hide()}function su(){this.loading=!1,Se(xh,this,Xh).call(this),Oe(mh,this,[]),Te(ch,this)?.replaceChildren(),Te(ch,this)&&(Te(ch,this).hidden=!1);let e=Te(dh,this);e&&(Se(xh,this,qh).call(this,e,"aria-activedescendant"),Se(xh,this,qh).call(this,e,"aria-busy"))}function nu(){var e;Oe(fh,this,(e=Te(fh,this),++e)),Te(vh,this)&&(clearTimeout(Te(vh,this)),Oe(vh,this,null)),Te(gh,this)?.abort(),Oe(gh,this,null)}function ou(e){null!==Te(bh,this)&&(clearTimeout(Te(bh,this)),Oe(bh,this,null)),this.announcement="",queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),Oe(bh,this,setTimeout(()=>{Oe(bh,this,null),this.announcement=""},5e3))}function ru(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&"text"===e.type}function au(e){return e.getRootNode().activeElement===e}Fh.styles=[Si,ih],ge([_e({reflect:!0})],Fh.prototype,"for",void 0),ge([_e({type:Object})],Fh.prototype,"triggers",void 0),ge([ye()],Fh.prototype,"loading",void 0),ge([ye()],Fh.prototype,"announcement",void 0),ge([we("craft-popover")],Fh.prototype,"popoverElement",void 0),customElements.get("craft-text-expander")||customElements.define("craft-text-expander",Fh);var lu=r`
  :host {
    display: inline-flex;
...
`,cu=new WeakMap,du=new WeakSet,hu=class extends pe{constructor(...e){super(...e),Ae(this,du),this.placement="top",this.disabled=!1,this.overflowing=!1,this.text="",Ne(this,cu,typeof ResizeObserver<"u"?new ResizeObserver(()=>Se(du,this,uu).call(this)):null)}connectedCallback(){super.connectedCallback(),Te(cu,this)?.observe(this)}disconnectedCallback(){Te(cu,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){Se(du,this,uu).call(this)}render(){let e=this.overflowing&&!this.disabled;return H`
      <span class="truncate" id="content">
        <slot @slotchange=${Se(du,this,pu)}></slot>
      </span>
      ${e?H`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:""}
    `}};function uu(){this.text=(this.textContent??"").replace(/\s+/g," ").trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function pu(){Se(du,this,uu).call(this)}hu.styles=lu,ge([_e({reflect:!0})],hu.prototype,"placement",void 0),ge([_e({type:Boolean,reflect:!0})],hu.prototype,"disabled",void 0),ge([ye()],hu.prototype,"overflowing",void 0),ge([ye()],hu.prototype,"text",void 0),ge([we(".truncate")],hu.prototype,"content",void 0),customElements.get("craft-truncate")||customElements.define("craft-truncate",hu);var mu=r`
  :host {
...
`,fu=class extends pe{constructor(...e){super(...e),this.src=null,this.srcset=null,this.sizes=null,this.alt="",this.width=null,this.height=null,this.loading="lazy",this.checkered=!0,this.rounded=!1}render(){return H`

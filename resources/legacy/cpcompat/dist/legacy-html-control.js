...
`,Jo=new WeakMap,Qo=new WeakMap,Xo=new WeakSet,er=new WeakMap,tr=class extends Yo{static get styles(){return[...super.styles,Zo]}constructor(){super(),Ne(this,Xo),this.options=[],this.limit=150,this.clearable=!1,this.placeholder="",Ae(this,Jo,void 0),Ae(this,Qo,()=>{Se(Xo,this,rr).call(this),Se(Xo,this,ir).call(this)}),Ae(this,er,()=>{this.modelValue="",this._inputNode&&(this._inputNode.value=""),Se(Xo,this,rr).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete="list"}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener("input",Te(Qo,this)),this.addEventListener("model-value-changed",()=>{Oe(Jo,this,this.modelValue)}),Oe(Jo,this,this.modelValue),Se(Xo,this,rr).call(this)}updated(e){super.updated(e),e.has("placeholder")&&(this._inputNode.placeholder=this.placeholder),(e.has("options")||e.has("limit")||e.has("opened")||e.has("modelValue"))&&Se(Xo,this,rr).call(this)}matchCondition(){return!0}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&("ArrowDown"===e.lastKey||"ArrowUp"===e.lastKey)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){return q`
      <div class="input-group__input">
        <slot name="input"></slot>

...
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=ci()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return ci()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(i(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),ui=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function di(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return ui.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var fi=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},pi=D(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),mi=D(e=>class extends pi(De(He(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=Ue(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...di(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return r`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof fi&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&(typeof t!=`boolean`||t!==!1)}static get styles(){return[a`
          /**********************
            {block} .form-field
           ********************/
    ...
    `}_onRequestToAddFormElement(e){e.target.hasAttribute(`role`)||e.target?.setAttribute(`role`,`listitem`),this.__addToSubCheckboxes(e.detail.element),this._setOwnCheckedState()}_onRequestToRemoveFormElement(e){e.target.getAttribute(`role`)===`listitem`&&e.target?.removeAttribute(`role`),this.__removeFromSubCheckboxes(e.detail.element)}__addToSubCheckboxes(e){e!==this&&this.contains(e)&&this.__subCheckboxes.push(e)}__removeFromSubCheckboxes(e){let t=this.__subCheckboxes.indexOf(e);t!==-1&&this.__subCheckboxes.splice(t,1)}constructor(){super(),this.indeterminate=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this.__onModelValueChanged=this.__onModelValueChanged.bind(this),this.__subCheckboxes=[],this._indeterminateSubStates=[],this.mixedState=!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,this.__onModelValueChanged),this.addEventListener(`form-element-register`,this._onRequestToAddFormElement)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`model-value-changed`,this.__onModelValueChanged),this.removeEventListener(`form-element-register`,this._onRequestToAddFormElement)}firstUpdated(e){super.firstUpdated(e),this._setOldState(),this.indeterminate&&this._storeIndeterminateState()}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&(this._inputNode.indeterminate=this.indeterminate)}},Vi=class extends Li{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="checkbox"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...Li.styles,a`
      ...
      `]}};customElements.get(`craft-checkbox-group`)||customElements.define(`craft-checkbox-group`,Vi);var Hi=class extends Bi{static get styles(){return[...Bi.styles,a`
        :host {
          display: flex;
          align-items: center;
      ...
      `]}};customElements.get(`craft-checkbox-indeterminate`)||customElements.define(`craft-checkbox-indeterminate`,Hi);var Ui=e=>{class t extends e{constructor(...e){super(...e),this.__ssrStateAdopted=!1}set value(e){e===``&&!this.__ssrStateAdopted&&this.__slottedInput()?.hasAttribute(`value`)||(super.value=e)}get value(){return super.value}connectedCallback(){this.__adoptSlottedInputState(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedInputState(),super.willUpdate(e)}updated(e){super.updated(e);let{_inputNode:t}=this,n=this.choiceValue;typeof n==`string`&&n!==``&&t instanceof HTMLInputElement&&t.value!==n&&(t.value=n)}__slottedInput(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}__adoptSlottedInputState(){if(this.__ssrStateAdopted)return;let e=this.__slottedInput();if(!e)return;this.__ssrStateAdopted=!0,e.id&&(this._inputId=e.id),!this.name&&e.name&&(this.name=e.name);let t=e.getAttribute(`value`)??e.value;t&&(this.choiceValue=t,e.value=t),e.checked&&(this.checked=!0),e.disabled&&(this.disabled=!0)}}return t},Wi=class extends Ui(zi){constructor(...e){super(...e),this.__inputPatched=!1,this.indeterminate=!1}connectedCallback(){super.connectedCallback(),this.__patchSlottedInputProps()}updated(e){super.updated(e),this.__patchSlottedInputProps();let t=this._inputNode;t&&(t.indeterminate=this.indeterminate)}__patchSlottedInputProps(){if(this.__inputPatched)return;let e=this.__slottedInputElement();if(!e)return;this.__inputPatched=!0;let t=this;for(let n of[`checked`,`disabled`]){let r=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,n);if(!r?.get||!r.set)continue;let{get:i,set:a}=r;Object.defineProperty(e,n,{configurable:!0,enumerable:r.enumerable,get(){return i.call(this)},set(e){a.call(this,e),t[n]!==e&&(t[n]=e)}})}}__slottedInputElement(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}static get styles(){return[...zi.styles,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Wi.prototype,`indeterminate`,void 0),customElements.get(`craft-checkbox`)||customElements.define(`craft-checkbox`,Wi);var Gi=new Map;async function Ki(e,t,n=!1){let r=[],i=[],a=()=>{for(let e of r)e.remove();i.forEach(e=>e())};if(!e)return a;let o=document.createElement(`template`);o.innerHTML=e.trim();try{for(let e of o.content.childNodes){let a=Ji(e);if(a){let e=Gi.get(a.key);if(e){e.references++,i.push(()=>Qi(a.key,e)),e.loaded&&await Zi(e.loaded,n);continue}if(Yi(a))continue}let o=qi(e),s=a&&o instanceof HTMLScriptElement?Xi(o,a.value):null;if(t.appendChild(o),a&&(o instanceof HTMLLinkElement||o instanceof HTMLScriptElement)){let e={node:o,loaded:s,references:1};Gi.set(a.key,e),i.push(()=>Qi(a.key,e))}else r.push(o);s&&await Zi(s,n)}return a}catch(e){throw a(),e}}function qi(e){if(!(e instanceof HTMLScriptElement))return e.cloneNode(!0);let t=document.createElement(`script`);for(let n of e.attributes)t.setAttribute(n.name,n.value);return t.textContent=e.textContent,t.async=!1,t}function Ji(e){return e instanceof HTMLLinkElement&&e.href?{key:`link:${e.href}`,selector:`link[href]`,value:e.href}:e instanceof HTMLScriptElement&&e.src?{key:`script:${e.src}`,selector:`script[src]`,value:e.src}:null}function Yi(e){return Array.from(document.querySelectorAll(e.selector)).some(t=>(t instanceof HTMLLinkElement?t.href:t.src)===e.value)}function Xi(e,t){return new Promise((n,r)=>{e.addEventListener(`load`,()=>n(),{once:!0}),e.addEventListener(`error`,()=>r(Error(`Failed to load asset [${t}].`)),{once:!0})})}async function Zi(e,t){try{await e}catch(e){if(t)throw e}}function Qi(e,t){t.references--,!(t.references>0)&&(t.node.remove(),Gi.delete(e))}async function $i(e){return Ki(e,document.head)}async function ea(e){return Ki(e,document.body)}function ta(e){return typeof e.checkVisibility==`function`?e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}):e.offsetWidth>0||e.offsetHeight>0}function na(e){return typeof e==`object`&&!!e&&`checked`in e&&typeof e.checked==`boolean`}function ra(e){return ia(e).toString()}function ia(e){let t=new URLSearchParams,n=e.querySelectorAll(`input[name], select[name], textarea[name]`);for(let e of n)if(!e.disabled&&!(e instanceof HTMLInputElement&&([`file`,`submit`,`button`,`reset`,`image`].includes(e.type)||(e.type===`checkbox`||e.type===`radio`)&&!e.checked))){if(e instanceof HTMLSelectElement&&e.multiple){for(let n of e.selectedOptions)t.append(e.name,n.value);continue}t.append(e.name,e.value)}for(let n of e.querySelectorAll(`*`)){if(!n.tagName.includes(`-`))continue;let e=n.name;if(typeof e!=`string`||e===``||n.disabled===!0||n.querySelector(`input[name], select[name], textarea[name]`))continue;if(na(n.modelValue)){n.modelValue.checked&&t.append(e,String(n.modelValue.value??``));continue}let r=n.serializedValue??n.value;if(r!=null)if(Array.isArray(r))for(let n of r)t.append(e,String(n));else t.append(e,String(r))}return t}var aa={Á:`A`,á:`a`,Ä:`A`,ä:`a`,À:`A`,à:`a`,Â:`A`,â:`a`,É:`E`,é:`e`,Ë:`E`,ë:`e`,È:`E`,è:`e`,Ê:`E`,ê:`e`,Í:`I`,í:`i`,Ï:`I`,ï:`i`,Ì:`I`,ì:`i`,Î:`I`,î:`i`,Ó:`O`,ó:`o`,Ö:`O`,ö:`o`,Ò:`O`,ò:`o`,Ô:`O`,ô:`o`,Ú:`U`,ú:`u`,Ü:`U`,ü:`u`,Ù:`U`,ù:`u`,Û:`U`,û:`u`,Ý:`Y`,ý:`y`,Ÿ:`Y`,А:`A`,Б:`B`,В:`V`,Г:`G`,Д:`D`,Ѓ:`Gj`,Е:`E`,Ж:`Z`,З:`Z`,Ѕ:`Dz`,И:`I`,Ј:`j`,К:`K`,Л:`L`,Љ:`Lj`,М:`M`,Н:`N`,Њ:`Nj`,О:`O`,П:`P`,Р:`R`,С:`S`,Т:`T`,Ќ:`Kj`,У:`U`,Ф:`F`,Х:`X`,Ц:`C`,Ч:`C`,Џ:`Dz`,Ш:`S`,а:`a`,б:`b`,в:`v`,г:`g`,д:`d`,ѓ:`gj`,е:`e`,ж:`z`,з:`z`,ѕ:`dz`,и:`i`,ј:`j`,к:`k`,л:`l`,љ:`lj`,м:`m`,н:`n`,њ:`nj`,о:`o`,п:`p`,р:`r`,с:`s`,т:`t`,ќ:`kj`,у:`u`,ф:`f`,х:`x`,ц:`c`,ч:`c`,џ:`dz`,ш:`s`,æ:`ae`,ǽ:`ae`,Ã:`A`,Å:`A`,Ǻ:`A`,Ă:`A`,Ǎ:`A`,Æ:`AE`,Ǽ:`AE`,ã:`a`,å:`a`,ǻ:`a`,ă:`a`,ǎ:`a`,ª:`a`,Ĉ:`C`,Ċ:`C`,Ç:`C`,ç:`c`,ĉ:`c`,ċ:`c`,Ð:`D`,Đ:`D`,ð:`d`,đ:`d`,Ĕ:`E`,Ė:`E`,ĕ:`e`,ė:`e`,ƒ:`f`,Ĝ:`G`,Ġ:`G`,ĝ:`g`,ġ:`g`,Ĥ:`H`,Ħ:`H`,ĥ:`h`,ħ:`h`,Ĩ:`I`,Ĭ:`I`,Ǐ:`I`,Į:`I`,Ĳ:`IJ`,ĩ:`i`,ĭ:`i`,ǐ:`i`,į:`i`,ĳ:`ij`,Ĵ:`J`,ĵ:`j`,Ĺ:`L`,Ľ:`L`,Ŀ:`L`,ĺ:`l`,ľ:`l`,ŀ:`l`,Ñ:`N`,ñ:`n`,ŉ:`n`,Õ:`O`,Ō:`O`,Ŏ:`O`,Ǒ:`O`,Ő:`O`,Ơ:`O`,Ø:`O`,Ǿ:`O`,Œ:`OE`,õ:`o`,ō:`o`,ŏ:`o`,ǒ:`o`,ő:`o`,ơ:`o`,ø:`o`,ǿ:`o`,º:`o`,œ:`oe`,Ŕ:`R`,Ŗ:`R`,ŕ:`r`,ŗ:`r`,Ŝ:`S`,Ș:`S`,ŝ:`s`,ș:`s`,ſ:`s`,Ţ:`T`,Ț:`T`,Ŧ:`T`,Þ:`TH`,ţ:`t`,ț:`t`,ŧ:`t`,þ:`th`,Ũ:`U`,Ŭ:`U`,Ű:`U`,Ų:`U`,Ư:`U`,Ǔ:`U`,Ǖ:`U`,Ǘ:`U`,Ǚ:`U`,Ǜ:`U`,ũ:`u`,ŭ:`u`,ű:`u`,ų:`u`,ư:`u`,ǔ:`u`,ǖ:`u`,ǘ:`u`,ǚ:`u`,ǜ:`u`,Ŵ:`W`,ŵ:`w`,Ŷ:`Y`,ÿ:`y`,ŷ:`y`,ΑΥ:`AU`,ΑΎ:`AU`,Αυ:`Au`,Αύ:`Au`,ΕΊ:`I`,ΕΙ:`I`,Ει:`Ei`,ΕΥ:`EF`,ΕΎ:`EU`,Εί:`I`,Ευ:`Ef`,Εύ:`Eu`,ΟΙ:`I`,ΟΊ:`I`,ΟΥ:`U`,ΟΎ:`OU`,Οι:`Oi`,Οί:`I`,Ου:`Oy`,Ού:`Ou`,ΥΙ:`I`,ΎΙ:`I`,Υι:`Yi`,Ύι:`I`,ΥΊ:`I`,Υί:`I`,αυ:`au`,αύ:`au`,εί:`i`,ει:`ei`,ευ:`ef`,εύ:`eu`,οι:`oi`,οί:`i`,ου:`oy`,ού:`ou`,υι:`yi`,ύι:`i`,υί:`i`,Α:`A`,Ά:`A`,Β:`B`,Δ:`D`,Ε:`E`,Έ:`E`,Φ:`F`,Γ:`G`,Η:`H`,Ή:`I`,Ι:`I`,Ί:`I`,Ϊ:`I`,Κ:`K`,Ξ:`Ks`,Λ:`L`,Μ:`M`,Ν:`N`,Π:`P`,Ο:`O`,Ό:`O`,Ψ:`Ps`,Ρ:`R`,Σ:`S`,Τ:`T`,Θ:`Th`,Ω:`O`,Ώ:`W`,Χ:`X`,ϒ:`Y`,Υ:`Y`,Ύ:`Y`,Ϋ:`Y`,Ζ:`Z`,α:`a`,ά:`a`,β:`v`,δ:`d`,ε:`e`,έ:`e`,φ:`f`,γ:`gh`,η:`i`,ή:`i`,ι:`i`,ί:`i`,ϊ:`i`,ΐ:`i`,κ:`k`,ξ:`ks`,λ:`l`,μ:`m`,ν:`n`,ο:`o`,ό:`o`,π:`p`,ψ:`ps`,ρ:`r`,σ:`s`,ς:`s`,τ:`t`,ϑ:`th`,θ:`th`,ϐ:`v`,ω:`o`,ώ:`w`,χ:`kh`,υ:`i`,ύ:`y`,ΰ:`y`,ϋ:`y`,ζ:`z`,अ:`a`,आ:`aa`,ए:`e`,ई:`ii`,ऍ:`ei`,ऎ:`ae`,ऐ:`ai`,इ:`i`,ओ:`o`,ऑ:`oi`,ऒ:`oii`,ऊ:`uu`,औ:`ou`,उ:`u`,ब:`B`,भ:`Bha`,च:`Ca`,छ:`Chha`,ड:`Da`,ढ:`Dha`,फ:`Fa`,फ़:`Fi`,ग:`Ga`,घ:`Gha`,ग़:`Ghi`,ह:`Ha`,ज:`Ja`,झ:`Jha`,क:`Ka`,ख:`Kha`,ख़:`Khi`,ल:`L`,ळ:`Li`,ऌ:`Li`,ऴ:`Lii`,ॡ:`Lii`,म:`Ma`,न:`Na`,ङ:`Na`,ञ:`Nia`,ण:`Nae`,ऩ:`Ni`,ॐ:`oms`,प:`Pa`,क़:`Qi`,र:`Ra`,ऋ:`Ri`,ॠ:`Ri`,ऱ:`Ri`,स:`Sa`,श:`Sha`,ष:`Shha`,ट:`Ta`,त:`Ta`,ठ:`Tha`,द:`Tha`,थ:`Tha`,ध:`Thha`,ड़:`ugDha`,ढ़:`ugDhha`,व:`Va`,य:`Ya`,य़:`Yi`,ज़:`Za`,Ա:`A`,Բ:`B`,Գ:`G`,Դ:`D`,Ե:`E`,Զ:`Z`,Է:`E`,Ը:`Y`,Թ:`Th`,Ժ:`Zh`,Ի:`I`,Լ:`L`,Խ:`Kh`,Ծ:`Ts`,Կ:`K`,Հ:`H`,Ձ:`Dz`,Ղ:`Gh`,Ճ:`Tch`,Մ:`M`,Յ:`Y`,Ն:`N`,Շ:`Sh`,Ո:`Vo`,Չ:`Ch`,Պ:`P`,Ջ:`J`,Ռ:`R`,Ս:`S`,Վ:`V`,Տ:`T`,Ր:`R`,Ց:`C`,Ւ:`u`,Փ:`Ph`,Ք:`Q`,և:`ev`,Օ:`O`,Ֆ:`F`,ա:`a`,բ:`b`,գ:`g`,դ:`d`,ե:`e`,զ:`z`,է:`e`,ը:`y`,թ:`th`,ժ:`zh`,ի:`i`,լ:`l`,խ:`kh`,ծ:`ts`,կ:`k`,հ:`h`,ձ:`dz`,ղ:`gh`,ճ:`tch`,մ:`m`,յ:`y`,ն:`n`,շ:`sh`,ո:`vo`,չ:`ch`,պ:`p`,ջ:`j`,ռ:`r`,ս:`s`,վ:`v`,տ:`t`,ր:`r`,ց:`c`,ւ:`u`,փ:`ph`,ք:`q`,օ:`o`,ֆ:`f`,Ž:`Z`,Ň:`N`,Ş:`S`,ž:`z`,ň:`n`,ş:`s`,ı:`i`,İ:`I`,ğ:`g`,Ğ:`G`,ьо:`yo`,Й:`i`,Щ:`Shh`,Ъ:`Ie`,Ь:``,Ю:`Iu`,Я:`Ia`,й:`i`,щ:`shh`,ъ:`ie`,ь:``,ю:`iu`,я:`ia`,Ē:`E`,ē:`e`,န်ုပ်:`nub`,"ောင်":`aung`,"ိုက်":`aik`,"ိုဒ်":`ok`,"ိုင်":`aing`,"ိုလ်":`ol`,"ေါင်":`aung`,သြော:`aw`,"ောက်":`auk`,"ိတ်":`eik`,"ုတ်":`ok`,"ုန်":`on`,"ေတ်":`it`,"ုဒ်":`ait`,"ာန်":`an`,"ိန်":`ein`,"ွတ်":`ut`,"ေါ်":`aw`,"ွန်":`un`,"ိပ်":`eik`,"ုပ်":`ok`,"ွပ်":`ut`,"ိမ်":`ein`,"ုမ်":`on`,"ော်":`aw`,"ွမ်":`un`,က်:`et`,"ေါ":`aw`,"ော":`aw`,"ျွ":`ywa`,"ြွ":`yw`,"ို":`o`,"ုံ":`on`,တ်:`at`,င်:`in`,ည်:`i`,ဒ်:`d`,န်:`an`,ပ်:`at`,မ်:`an`,စျ:`za`,ယ်:`e`,ဉ်:`in`,စ်:`it`,"ိံ":`ein`,"ဲ":`e`,"း":``,"ာ":`a`,"ါ":`a`,"ေ":`e`,"ံ":`an`,"ိ":`i`,"ီ":`i`,"ု":`u`,"ူ":`u`,"်":`at`,"္":``,"့":``,က:`k`,"၉":`9`,တ:`t`,ရ:`ya`,ယ:`y`,မ:`m`,ဘ:`ba`,ဗ:`b`,ဖ:`pa`,ပ:`p`,န:`n`,ဓ:`da`,ဒ:`d`,ထ:`ta`,ဏ:`na`,ဝ:`w`,ဎ:`da`,ဍ:`d`,ဌ:`ta`,ဋ:`t`,ည:`ny`,ဇ:`z`,ဆ:`sa`,စ:`s`,င:`ng`,ဃ:`ga`,ဂ:`g`,လ:`l`,သ:`th`,"၈":`8`,ဩ:`aw`,ခ:`kh`,"၆":`6`,"၅":`5`,"၄":`4`,"၃":`3`,"၂":`2`,"၁":`1`,"၀":`0`,"၌":`hnaik`,"၍":`ywae`,ဪ:`aw`,ဦ:`-u`,ဟ:`h`,ဉ:`u`,ဤ:`-i`,ဣ:`i`,"၏":`-e`,ဧ:`e`,"ှ":`h`,"ွ":`w`,"ျ":`ya`,"ြ":`y`,အ:`a`,ဠ:`la`,"၇":`7`,DŽ:`DZ`,Dž:`Dz`,dž:`dz`,Ǳ:`DZ`,ǲ:`Dz`,ǳ:`dz`,Ǉ:`LJ`,ǈ:`Lj`,ǉ:`lj`,Ǌ:`NJ`,ǋ:`Nj`,ǌ:`nj`,č:`c`,Č:`C`,ć:`c`,Ć:`C`,š:`s`,Š:`S`,ა:`a`,ბ:`b`,გ:`g`,დ:`d`,ე:`e`,ვ:`v`,ზ:`z`,თ:`t`,ი:`i`,კ:`k`,ლ:`l`,მ:`m`,ნ:`n`,ო:`o`,პ:`p`,ჟ:`zh`,რ:`r`,ს:`s`,ტ:`t`,უ:`u`,ფ:`f`,ქ:`q`,ღ:`gh`,ყ:`y`,შ:`sh`,ჩ:`ch`,ც:`ts`,ძ:`dz`,წ:`ts`,ჭ:`ch`,ხ:`kh`,ჯ:`j`,ჰ:`h`,Ё:`E`,ё:`e`,Ы:`Y`,ы:`y`,Э:`E`,э:`e`,І:`I`,і:`i`,Ѳ:`F`,ѳ:`f`,Ѣ:`E`,ѣ:`e`,Ѵ:`I`,ѵ:`i`,Є:`Je`,є:`je`,Ѥ:`Je`,ѥ:`je`,Ꙋ:`U`,ꙋ:`u`,Ѡ:`O`,ѡ:`o`,Ѿ:`Ot`,ѿ:`ot`,Ѫ:`U`,ѫ:`u`,Ѧ:`Ja`,ѧ:`ja`,Ѭ:`Ju`,ѭ:`ju`,Ѩ:`Ja`,ѩ:`Ja`,Ѯ:`Ks`,ѯ:`ks`,Ѱ:`Ps`,ѱ:`ps`,Ґ:`G`,ґ:`g`,Ї:`Yi`,ї:`yi`,Ә:`A`,Ғ:`G`,Қ:`Q`,Ң:`N`,Ө:`O`,Ұ:`U`,Ү:`U`,Һ:`H`,ә:`a`,ғ:`g`,қ:`q`,ң:`n`,ө:`o`,ұ:`u`,ү:`u`,һ:`h`,ď:`d`,Ď:`D`,ě:`e`,Ě:`E`,ř:`r`,Ř:`R`,ť:`t`,Ť:`T`,ů:`u`,Ů:`U`,ą:`a`,ę:`e`,ł:`l`,ń:`n`,ś:`s`,ź:`z`,ż:`z`,Ą:`A`,Ę:`E`,Ł:`L`,Ń:`N`,Ś:`S`,Ź:`Z`,Ż:`Z`,ā:`a`,ģ:`g`,ī:`i`,ķ:`k`,ļ:`l`,ņ:`n`,ū:`u`,Ā:`A`,Ģ:`G`,Ī:`I`,Ķ:`k`,Ļ:`L`,Ņ:`N`,Ū:`U`,Ả:`A`,Ạ:`A`,Ắ:`A`,Ằ:`A`,Ẳ:`A`,Ẵ:`A`,Ặ:`A`,Ấ:`A`,Ầ:`A`,Ẩ:`A`,Ẫ:`A`,Ậ:`A`,ả:`a`,ạ:`a`,ắ:`a`,ằ:`a`,ẳ:`a`,ẵ:`a`,ặ:`a`,ấ:`a`,ầ:`a`,ẩ:`a`,ẫ:`a`,ậ:`a`,Ẻ:`E`,Ẽ:`E`,Ẹ:`E`,Ế:`E`,Ề:`E`,Ể:`E`,Ễ:`E`,Ệ:`E`,ẻ:`e`,ẽ:`e`,ẹ:`e`,ế:`e`,ề:`e`,ể:`e`,ễ:`e`,ệ:`e`,Ỉ:`I`,Ị:`I`,ỉ:`i`,ị:`i`,Ỏ:`O`,Ọ:`O`,Ố:`O`,Ồ:`O`,Ổ:`O`,Ỗ:`O`,Ộ:`O`,Ớ:`O`,Ờ:`O`,Ở:`O`,Ỡ:`O`,Ợ:`O`,ỏ:`o`,ọ:`o`,ố:`o`,ồ:`o`,ổ:`o`,ỗ:`o`,ộ:`o`,ớ:`o`,ờ:`o`,ở:`o`,ỡ:`o`,ợ:`o`,Ủ:`U`,Ụ:`U`,Ứ:`U`,Ừ:`U`,Ử:`U`,Ữ:`U`,Ự:`U`,ủ:`u`,ụ:`u`,ứ:`u`,ừ:`u`,ử:`u`,ữ:`u`,ự:`u`,Ỳ:`Y`,Ỷ:`Y`,Ỹ:`Y`,Ỵ:`Y`,ỳ:`y`,ỷ:`y`,ỹ:`y`,ỵ:`y`,ا:`a`,ب:`b`,پ:`p`,ت:`t`,ث:`th`,ج:`g`,چ:`ch`,ح:`h`,خ:`kh`,د:`d`,ذ:`th`,ر:`r`,ز:`z`,س:`s`,ش:`sh`,ص:`s`,ض:`d`,ط:`t`,ظ:`th`,ع:`aa`,غ:`gh`,ف:`f`,ق:`k`,ک:`k`,گ:`g`,ل:`l`,ژ:`zh`,ك:`k`,م:`m`,ن:`n`,ه:`h`,و:`o`,ی:`y`,آ:`a`,"٠":`0`,"١":`1`,"٢":`2`,"٣":`3`,"٤":`4`,"٥":`5`,"٦":`6`,"٧":`7`,"٨":`8`,"٩":`9`,أ:`a`,ي:`y`,إ:`a`,ؤ:`o`,ئ:`y`,ء:`aa`,ђ:`dj`,ћ:`c`,Ђ:`Dj`,Ћ:`C`,ə:`e`,Ə:`E`,ß:`ss`,ẞ:`SS`,ভ্ল:`vl`,পশ:`psh`,ব্ধ:`bdh`,ব্জ:`bj`,ব্দ:`bd`,ব্ব:`bb`,ব্ল:`bl`,ভ:`v`,ব:`b`,চ্ঞ:`cNG`,চ্ছ:`cch`,চ্চ:`cc`,ছ:`ch`,চ:`c`,ধ্ন:`dhn`,ধ্ম:`dhm`,দ্ঘ:`dgh`,দ্ধ:`ddh`,দ্ভ:`dv`,দ্ম:`dm`,ড্ড:`DD`,ঢ:`Dh`,ধ:`dh`,দ্গ:`dg`,দ্দ:`dd`,ড:`D`,দ:`d`,"।":`.`,ঘ্ন:`Ghn`,গ্ধ:`Gdh`,গ্ণ:`GN`,গ্ন:`Gn`,গ্ম:`Gm`,গ্ল:`Gl`,জ্ঞ:`jNG`,ঘ:`Gh`,গ:`g`,হ্ণ:`hN`,হ্ন:`hn`,হ্ম:`hm`,হ্ল:`hl`,হ:`h`,জ্ঝ:`jjh`,ঝ:`jh`,জ্জ:`jj`,জ:`j`,ক্ষ্ণ:`kxN`,ক্ষ্ম:`kxm`,ক্ষ:`ksh`,কশ:`ksh`,ক্ক:`kk`,ক্ট:`kT`,ক্ত:`kt`,ক্ল:`kl`,ক্স:`ks`,খ:`kh`,ক:`k`,ল্ভ:`lv`,ল্ধ:`ldh`,লখ:`lkh`,লঘ:`lgh`,লফ:`lph`,ল্ক:`lk`,ল্গ:`lg`,ল্ট:`lT`,ল্ড:`lD`,ল্প:`lp`,ল্ম:`lm`,ল্ল:`ll`,ল্ব:`lb`,ল:`l`,ম্থ:`mth`,ম্ফ:`mf`,ম্ভ:`mv`,মপ্ল:`mpl`,ম্ন:`mn`,ম্প:`mp`,ম্ম:`mm`,ম্ল:`ml`,ম্ব:`mb`,ম:`m`,"০":`0`,"১":`1`,"২":`2`,"৩":`3`,"৪":`4`,"৫":`5`,"৬":`6`,"৭":`7`,"৮":`8`,"৯":`9`,ঙ্ক্ষ:`Ngkx`,ঞ্ছ:`nch`,ঙ্ঘ:`ngh`,ঙ্খ:`nkh`,ঞ্ঝ:`njh`,ঙ্গৌ:`ngOU`,ঙ্গৈ:`ngOI`,ঞ্চ:`nc`,ঙ্ক:`nk`,ঙ্ষ:`Ngx`,ঙ্গ:`ngo`,ঙ্ম:`Ngm`,ঞ্জ:`nj`,ন্ধ:`ndh`,ন্ঠ:`nTh`,ণ্ঠ:`NTh`,ন্থ:`nth`,ঙ্গা:`nga`,ঙ্গি:`ngi`,ঙ্গী:`ngI`,ঙ্গু:`ngu`,ঙ্গূ:`ngU`,ঙ্গে:`nge`,ঙ্গো:`ngO`,ণ্ঢ:`NDh`,নশ:`nsh`,ঙর:`Ngr`,ঞর:`NGr`,"ংর":`ngr`,ঙ:`Ng`,ঞ:`NG`,"ং":`ng`,ন্ন:`nn`,ণ্ণ:`NN`,ণ্ন:`Nn`,ন্ম:`nm`,ণ্ম:`Nm`,ন্দ:`nd`,ন্ট:`nT`,ণ্ট:`NT`,ন্ড:`nD`,ণ্ড:`ND`,ন্ত:`nt`,ন্স:`ns`,ন:`n`,ণ:`N`,"ৈ":`OI`,"ৌ":`OU`,"ো":`O`,ঐ:`OI`,ঔ:`OU`,অ:`o`,ও:`oo`,ফ্ল:`fl`,প্ট:`pT`,প্ত:`pt`,প্ন:`pn`,প্প:`pp`,প্ল:`pl`,প্স:`ps`,ফ:`f`,প:`p`,"ৃ":`rri`,ঋ:`rri`,রর‍্য:`rry`,"্র্য":`ry`,"্রর":`rr`,ড়্গ:`Rg`,ঢ়:`Rh`,ড়:`R`,র:`r`,"্র":`r`,শ্ছ:`Sch`,ষ্ঠ:`ShTh`,ষ্ফ:`Shf`,স্ক্ল:`skl`,স্খ:`skh`,স্থ:`sth`,স্ফ:`sf`,শ্চ:`Sc`,শ্ত:`St`,শ্ন:`Sn`,শ্ম:`Sm`,শ্ল:`Sl`,ষ্ক:`Shk`,ষ্ট:`ShT`,ষ্ণ:`ShN`,ষ্প:`Shp`,ষ্ম:`Shm`,স্প্ল:`spl`,স্ক:`sk`,স্ট:`sT`,স্ত:`st`,স্ন:`sn`,স্প:`sp`,স্ম:`sm`,স্ল:`sl`,শ:`S`,ষ:`Sh`,স:`s`,"ু":`u`,উ:`u`,অ্য:`oZ`,ত্থ:`tth`,ৎ:`tt`,ট্ট:`TT`,ট্ম:`Tm`,ঠ:`Th`,ত্ন:`tn`,ত্ম:`tm`,থ:`th`,ত্ত:`tt`,ট:`T`,ত:`t`,অ্যা:`AZ`,"া":`a`,আ:`a`,য়া:`ya`,য়:`y`,"ি":`i`,ই:`i`,"ী":`ee`,ঈ:`ee`,"ূ":`uu`,ঊ:`uu`,"ে":`e`,এ:`e`,য:`z`,"্য":`Z`,ইয়:`y`,ওয়:`w`,"্ব":`w`,এক্স:`x`,"ঃ":`:`,"ঁ":`nn`,"্‌":``,"˚":`0`,"¹":`1`,"²":`2`,"³":`3`,"⁴":`4`,"⁵":`5`,"⁶":`6`,"⁷":`7`,"⁸":`8`,"⁹":`9`,"₀":`0`,"₁":`1`,"₂":`2`,"₃":`3`,"₄":`4`,"₅":`5`,"₆":`6`,"₇":`7`,"₈":`8`,"₉":`9`,"௦":`0`,"௧":`1`,"௨":`2`,"௩":`3`,"௪":`4`,"௫":`5`,"௬":`6`,"௭":`7`,"௮":`8`,"௯":`9`,"௰":`10`,"௱":`100`,"௲":`1000`,Ꜳ:`AA`,ꜳ:`aa`,Ꜵ:`AO`,ꜵ:`ao`,Ꜷ:`AU`,ꜷ:`au`,Ꜹ:`AV`,ꜹ:`av`,Ꜻ:`av`,ꜻ:`av`,Ꜽ:`AY`,ꜽ:`ay`,ȸ:`db`,ʣ:`dz`,ʥ:`dz`,ʤ:`dezh`,"🙰":`et`,ﬀ:`ff`,ﬃ:`ffi`,ﬄ:`ffl`,ﬁ:`fi`,ﬂ:`fl`,ʩ:`feng`,ʪ:`ls`,ʫ:`lz`,ɮ:`lezh`,ȹ:`qp`,ʨ:`tc`,ʦ:`ts`,ʧ:`tesh`,Ꝏ:`OO`,ꝏ:`oo`,ﬆ:`st`,ﬅ:`st`,Ꜩ:`TZ`,ꜩ:`tz`,ᵫ:`ue`,Aι:`Ai`,αι:`ai`,ἀ:`a`,ἁ:`a`,ἂ:`a`,ἃ:`a`,ἄ:`a`,ἅ:`a`,ἆ:`a`,ἇ:`a`,Ἀ:`A`,Ἁ:`A`,Ἂ:`A`,Ἃ:`A`,Ἄ:`A`,Ἅ:`A`,Ἆ:`A`,Ἇ:`A`,ᾰ:`a`,ᾱ:`a`,ᾲ:`a`,ᾳ:`a`,ᾴ:`a`,ᾶ:`a`,ᾷ:`a`,Ᾰ:`A`,Ᾱ:`A`,Ὰ:`A`,Ά:`A`,ᾼ:`A`,A̧:`A`,a̧:`a`,Ⱥ:`A`,ⱥ:`a`,Ȧ:`A`,ȧ:`a`,Ɓ:`B`,C̈:`C`,c̈:`c`,C̨:`C`,c̨:`c`,Ȼ:`C`,ȼ:`c`,C̀:`C`,c̀:`c`,C̣:`C`,c̣:`c`,C̄:`C`,c̄:`c`,C̃:`C`,c̃:`c`,Ȩ:`E`,ȩ:`e`,Ɇ:`E`,ɇ:`e`,I̧:`I`,i̧:`i`,Ɨ:`I`,ɨ:`i`,i:`i`,J́́:`J`,j́:`j`,J̀̀:`J`,j̀:`j`,J̈:`J`,j̈:`j`,J̧:`J`,j̧:`j`,J̨:`J`,j̨:`j`,Ɉ:`J`,ɉ:`j`,J̌:`J`,ǰ:`j`,J̇:`J`,j:`j`,J̣:`J`,j̣:`j`,J̄:`J`,j̄:`j`,J̃:`J`,j̃:`j`,ĸ:`k`,L̀:`L`,l̀:`l`,L̂:`L`,l̂:`l`,L̈:`L`,l̈:`l`,L̨:`L`,l̨:`l`,Ƚ:`L`,ƚ:`l`,L̇:`L`,l̇:`l`,Ḷ:`L`,ḷ:`l`,L̄:`L`,l̄:`l`,L̃:`L`,l̃:`l`,Ŋ:`N`,ŋ:`n`,Ǹ:`N`,ǹ:`n`,N̂:`N`,n̂:`n`,N̈:`N`,n̈:`n`,N̨:`N`,n̨:`n`,Ꞥ:`N`,ꞥ:`n`,Ṅ:`N`,ṅ:`n`,Ṇ:`N`,ṇ:`n`,N̄:`N`,n̄:`n`,O̧:`O`,o̧:`o`,Ǫ:`O`,ǫ:`o`,Ɵ:`O`,ɵ:`o`,Ȯ:`O`,ȯ:`o`,S̀:`S`,s̀:`s`,Ŝ̀:`S`,S̈:`S`,s̈:`s`,S̨:`S`,s̨:`s`,Ꞩ:`S`,ꞩ:`s`,Ṡ:`S`,ṡ:`s`,Ṣ:`S`,ṣ:`s`,S̄:`S`,s̄:`s`,S̃:`S`,s̃:`s`,T́:`T`,t́:`t`,T̀:`T`,t̀:`t`,T̂:`T`,t̂:`t`,T̈:`T`,ẗ:`t`,T̨:`T`,t̨:`t`,Ⱦ:`T`,ⱦ:`t`,Ṫ:`T`,ṫ:`t`,Ṭ:`T`,ṭ:`t`,T̄:`T`,t̄:`t`,T̃:`T`,t̃:`t`,U̧:`U`,u̧:`u`,Ʉ:`U`,ʉ:`u`,U̇:`U`,u̇:`u`,Ʊ:`U`,ʊ:`u`,Ẁ:`W`,ẁ:`w`,Ẃ:`W`,ẃ:`w`,Ẅ:`W`,ẅ:`w`,Ꙗ:`Ja`,ꙗ:`ja`,Y̧:`Y`,y̧:`y`,Y̨:`Y`,y̨:`y`,Ɏ:`Y`,ɏ:`y`,Y̌:`Y`,y̌:`y`,Ẏ:`Y`,ẏ:`y`,Ȳ:`Y`,ȳ:`y`,Z̀:`Z`,z̀:`z`,Ẑ:`Z`,ẑ:`z`,Z̈:`Z`,z̈:`z`,Z̧:`Z`,z̧:`z`,Z̨:`Z`,z̨:`z`,Ƶ:`Z`,ƶ:`z`,Ẓ:`Z`,ẓ:`z`,Z̄:`Z`,z̄:`z`,Z̃:`Z`,z̃:`z`,"\xA0":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `,"\u2028":` `,"\u2029":` `,"​":` `," ":` `," ":` `,"　":` `,ﾠ:` `,"«":`<<`,"»":`>>`,"‘":`'`,"’":`'`,"‚":`'`,"‛":`'`,"“":`"`,"”":`"`,"„":`"`,"‟":`"`,"‹":`'`,"›":`'`,"–":`-`,"—":`-`,"…":`...`,"€":`EUR`,$:`$`,"₢":`Cr`,"₣":`Fr.`,"£":`PS`,"₤":`L.`,ℳ:`M`,"₥":`mil`,"₦":`N`,"₧":`Pts`,"₨":`Rs`,රු:`LKR`,ரூ:`LKR`,"௹":`Rs`,रू:`NPR`,"₹":`Rs`,"૱":`Rs`,"₩":`W`,"₪":`NS`,"₸":`KZT`,"₫":`D`,"֏":`AMD`,"₭":`K`,"₺":`TL`,"₼":`AZN`,"₮":`T`,"₯":`Dr`,"₲":`PYG`,"₾":`GEL`,"₳":`ARA`,"₴":`UAH`,"₽":`RUB`,"₵":`GHS`,"₡":`CL`,"¢":`c`,"¥":`YEN`,円:`JPY`,"৳":`BDT`,元:`CNY`,"﷼":`SAR`,"៛":`KR`,"₠":`ECU`,"¤":`$?`,"฿":`THB`,"؋":`AFN`};function oa(e,t=aa){e=e.normalize(`NFC`);let n=``,r;for(let i=0;i<e.length;i++)r=e.charAt(i),n+=typeof t[r]==`string`?t[r]:r;return n}function sa(e,t={}){let n={allowNonAlphaStart:!1,handleCasing:`camel`,...t};var r=e.replace(/<(.*?)>/g,``);r=r.replace(/['"‘’“”ʻ\[\]\(\)\{\}:]/g,``),r=r.toLowerCase(),r=oa(r),n.allowNonAlphaStart||(r=r.replace(/^[^a-z]+/,``));let i=r.split(/[^a-z0-9]+/).filter(Boolean);if(r=``,n.handleCasing===`snake`)return i.join(`_`);for(let e=0;e<i.length;e++)n.handleCasing!==`pascal`&&e===0?r+=i[e]:r+=i[e].charAt(0).toUpperCase()+i[e].substring(1);return r}function ca(e,t={}){let n={prefix:``,suffix:``,...t},r=sa(e,{handleCasing:`snake`}).toUpperCase();return r?`${n.prefix}${r}${n.suffix}`:``}function la(e){let t=e.replace(/<(.*?)>/g,``);return t=t.toLowerCase(),t=oa(t),t=t.replace(/^[^a-z]+/,``),t=t.replace(/[^a-z0-9]+$/,``),t.split(/[^a-z0-9]+/).filter(Boolean).join(`-`)}function ua(e){return e.charAt(0).toUpperCase()+e.slice(1)}function da(){return Math.floor(Math.random()*1e6)}var fa=new WeakMap,pa=class e{constructor(){this.queue=[],this.workers=[],f(this,fa,null),h(fa,this,new AbortController);for(let e=0;e<3;e++)this.workers.push(new _a(this))}load(t=document,n=`[data-sizes]`){t.querySelectorAll(n).forEach(t=>{if(ta(t))this.addToQueue(t);else{let n=`thumb${da()}`;e.invisibleThumbs[n]=[this,t];let r=()=>{e.invisibleThumbs[n]&&ta(t)&&(delete e.invisibleThumbs[n],this.addToQueue(t))};document.addEventListener(`scroll`,r,{signal:m(fa,this)?.signal}),window.addEventListener(`resize`,r,{signal:m(fa,this)?.signal})}})}addToQueue(e){this.queue.push(e),this.workers.forEach(e=>{e.active||e.loadNext()})}static retryAll(){for(let t in e.invisibleThumbs){let n=e.invisibleThumbs[t];if(!n)continue;let[r,i]=n;delete e.invisibleThumbs[t],r.load(i.parentElement??document)}}destroy(){this.workers.forEach(e=>e.deactivate()),m(fa,this)?.abort()}};pa.invisibleThumbs={};var ma=new WeakMap,ha=new WeakMap,ga=new WeakMap,_a=class{constructor(e){this.active=!1,this.container=void 0,f(this,ma,null),f(this,ha,null),f(this,ga,null),h(ma,this,e)}activate(){this.active||(this.active=!0,this.clearInterval(),h(ha,this,setInterval(()=>{this.loadNextIfRemoved()},500)))}deactivate(){this.active&&(this.active=!1,this.clearInterval(),this.clearTimeout())}clearInterval(){m(ha,this)&&(clearInterval(m(ha,this)),h(ha,this,null))}clearTimeout(){m(ga,this)&&(clearTimeout(m(ga,this)),h(ga,this,null))}loadNext(){if(this.clearTimeout(),this.container=m(ma,this)?.queue.shift(),this.container===void 0){this.deactivate();return}if(this.loadNextIfRemoved())return;if(this.container.querySelectorAll(`img`).length>0){this.loadNext();return}this.activate(),h(ga,this,setTimeout(()=>{this.loadNext()},3e4));let e=document.createElement(`img`);e.sizes=this.container.getAttribute(`data-sizes`)??``,e.srcset=this.container.getAttribute(`data-srcset`)??``,e.alt=this.container.getAttribute(`data-alt`)??``,e.setAttribute(`data-animated`,this.container.getAttribute(`data-animated`)??``),e.src=this.container.getAttribute(`data-src`)??``,e.onload=()=>this.loadNext(),e.onabort=()=>this.loadNext(),e.onerror=()=>this.loadNext(),this.container.appendChild(e)}loadNextIfRemoved(){return this.container&&!document.body.contains(this.container)?(this.loadNext(),!0):!1}},va=a`
  :host {
    display: contents;
  }
...
`,ya=new WeakMap,ba=new WeakMap,xa=class extends l{constructor(...e){super(...e),this.size=``,this.variant=Ce.Neutral,this.appearance=te.OutlineFill,this.icon=null,this.showIndicators=!1,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,f(this,ya,new pa),this.lightDom=0,f(this,ba,new MutationObserver(()=>this.lightDom++))}connectedCallback(){super.connectedCallback(),m(ba,this).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){m(ba,this).disconnect(),super.disconnectedCallback()}renderPrefix(){return r`<div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
    ...
    </div>`}firstUpdated(e){super.firstUpdated(e),m(ya,this).load(this)}render(){this.lightDom;let e=!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`)||!!this.querySelector(`[slot="thumbnail"]`)||!!this.querySelector(`[slot="indicator"]`)||this.icon,t=!!this.querySelector(`[slot="suffix"]`);return r`
      <div
        part="chip"
    ...
    `}};xa.styles=[va],p([g()],xa.prototype,`size`,void 0),p([g({reflect:!0})],xa.prototype,`variant`,void 0),p([g({reflect:!0})],xa.prototype,`appearance`,void 0),p([g()],xa.prototype,`icon`,void 0),p([g({attribute:`show-indicators`,type:Boolean})],xa.prototype,`showIndicators`,void 0),p([g({attribute:`show-status`,type:Boolean})],xa.prototype,`showStatus`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],xa.prototype,`showThumb`,void 0),p([g({type:Boolean})],xa.prototype,`selectable`,void 0),p([_()],xa.prototype,`lightDom`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,xa);var Sa=class extends Ai(l){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},Ca=D(e=>class extends mi(li(Mi(He(ki(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],a`
          :host {
            display: block;
          }
...
`,Da=new WeakMap,Oa=new WeakSet,ka=class extends Ta{constructor(...e){super(...e),d(this,Oa),this.hint=null,f(this,Da,void 0)}static get styles(){return[...Ta.styles,Ea]}connectedCallback(){super.connectedCallback(),ja._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),ja._.unobserve(this)}render(){return r`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?r`<span class="hint">${this.hint}</span>`:c}
        <slot name="suffix"></slot>
      </div>
    `}};function Aa(){return m(Da,this)??h(Da,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),m(Da,this)}var ja={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=u(Oa,e,Aa).call(e))}})};p([g()],ka.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,ka);var Ma=new WeakMap;function Na(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Ma.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else Na(n,t)})}function Pa(e){Ma.has(e)&&Ma.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Ma.has(e)&&Ma.get(e)():Pa(e)})}var Fa=class extends xi{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof fi}};function Ia(e){return Array.isArray(e)?e:[e]}var La=D(e=>class extends Mi(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Ia(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Ia(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Ia(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Ia(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Ra=new WeakMap,za=class extends ri(ce(La(wa))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,a`
        .input-group__input {
          display: flex;
          flex: 1;
        }
...
`,Va=new WeakMap,Ha=new WeakMap,Ua=new WeakMap,Wa=new WeakSet,Ga=new WeakMap,Ka=class extends za{static get styles(){return[...super.styles,Ba]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,Wa),this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,Va,void 0),f(this,Ha,!1),f(this,Ua,()=>{h(Ha,this,!0),u(Wa,this,Za).call(this),u(Wa,this,qa).call(this)}),f(this,Ga,()=>{this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(Wa,this,Za).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m(Ua,this)),this.addEventListener(`model-value-changed`,()=>{h(Va,this,this.modelValue)}),h(Va,this,this.modelValue),u(Wa,this,Za).call(this)}updated(e){super.updated(e),e.has(`opened`)&&!this.opened&&h(Ha,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`))&&u(Wa,this,Za).call(this)}addFormElement(e,t){super.addFormElement(e,t),e.updateComplete.then(()=>{String(e.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(e)))})}_notifyModelValueChanged(){this.modelValue!==m(Va,this)&&(h(Va,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],isTriggeredByUser:!0}})))}matchCondition(){return!0}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
        <slot name="input"></slot>
        ${this.clearable&&u(Wa,this,$a).call(this)?r`<craft-button
              class="clear"
              type="button"
              appearance="plain"
              size="small"
    ...
    `}parser(e){if(typeof e==`string`&&e!==``){let t=u(Wa,this,eo).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function qa(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function Ja(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(u(Wa,this,Ya).call(this,e))for(let r of e.options)(t===``||u(Wa,this,Xa).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||u(Wa,this,Xa).call(this,t,e))&&n.push({option:e});return n}function Ya(e){return e.type===`optgroup`}function Xa(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function Za(){let e=this._listboxNode;if(!e)return;let t=m(Ha,this)?this._inputNode?.value??``:``,n=u(Wa,this,Ja).call(this,t),i=n.slice(0,this.limit),a;s(r`${i.map(e=>{let t=e.groupLabel&&e.groupLabel!==a?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return a=e.groupLabel,r`${t}${u(Wa,this,Qa).call(this,e.option)}`})}${n.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${O(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:n.length})}
          </div>`:c}`,e)}function Qa(e){let t=e.data??{},n=e.label,i=n.startsWith(`$`)||n.startsWith(`@`);return r`
      <craft-option
    ...
    `}function $a(){return this.modelValue!==``&&this.modelValue!=null}function eo(e){let t=e.trim();for(let e of this.options)if(u(Wa,this,Ya).call(this,e)){let n=e.options.find(e=>u(Wa,this,to).call(this,e)===t);if(n)return n}else if(u(Wa,this,to).call(this,e)===t)return e}function to(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}p([g({type:Array})],Ka.prototype,`options`,void 0),p([g({type:Number})],Ka.prototype,`limit`,void 0),p([g({type:Boolean,reflect:!0})],Ka.prototype,`clearable`,void 0),p([g({type:String,reflect:!0})],Ka.prototype,`placeholder`,void 0),p([g({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],Ka.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,Ka);var no=a`
  :host {
    display: inline-block;
  }
...
`,ro={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},io=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(ro[`icon.out`].keyframes,ro[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(ro[`icon.in`].keyframes,ro[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(ro[`icon.out`].keyframes,ro[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(ro[`icon.in`].keyframes,ro[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||O(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};io.styles=[no],p([_()],io.prototype,`isCopying`,void 0),p([_()],io.prototype,`status`,void 0),p([y(`slot[name="copy-icon"]`)],io.prototype,`copyIconEl`,void 0),p([y(`slot[name="success-icon"]`)],io.prototype,`successIconEl`,void 0),p([y(`slot[name="error-icon"]`)],io.prototype,`errorIconEl`,void 0),p([y(`craft-tooltip`)],io.prototype,`tooltipEl`,void 0),p([g({type:String})],io.prototype,`value`,void 0),p([g({type:Boolean})],io.prototype,`disabled`,void 0),p([g({attribute:`feedback-duration`,type:Number})],io.prototype,`feedbackDuration`,void 0),p([g({attribute:`tooltip-label`})],io.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,io);var ao=a`
  :host {
    box-sizing: border-box;
  }
...
`,so=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return r`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};so.styles=[ao,oo],p([y(`craft-copy-button`)],so.prototype,`copyButtonEl`,void 0),p([g({type:String})],so.prototype,`value`,void 0),p([g({type:Boolean,reflect:!0})],so.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,so);var co=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function lo(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function uo(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(co))).filter(lo)}function fo(e){let t=t=>{if(t.key!==`Tab`)return;let n=uo(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var po=a`
  :host {
    display: contents;
...
`,mo=0,ho=0;function go(){ho++===0&&document.body.classList.add(`no-scroll`)}function _o(){ho>0&&--ho===0&&document.body.classList.remove(`no-scroll`)}var vo=new WeakMap,yo=new WeakMap,bo=new WeakMap,xo=new WeakMap,So=new WeakSet,Co=new WeakMap,wo=new WeakMap,To=new WeakMap,Eo=new WeakMap,Do=new WeakMap,Oo=new WeakMap,ko=class extends l{constructor(...e){super(...e),d(this,So),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++mo}`,f(this,vo,!1),f(this,yo,null),f(this,bo,!1),f(this,xo,null),f(this,Co,e=>{e.preventDefault(),this.requestClose()}),f(this,wo,()=>{this.opened=!1}),f(this,To,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),f(this,Eo,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),f(this,Do,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),f(this,Oo,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,m(Eo,this)),this.addEventListener(`keydown`,m(To,this)),h(xo,this,new MutationObserver(()=>this.requestUpdate())),m(xo,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(Eo,this)),this.removeEventListener(`keydown`,m(To,this)),m(xo,this)?.disconnect(),h(xo,this,null),m(yo,this)?.call(this),h(yo,this,null),u(So,this,Mo).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
    ...
    `}updated(e){super.updated(e),this.opened!==m(vo,this)&&(h(vo,this,this.opened),this.opened?u(So,this,Ao).call(this):u(So,this,jo).call(this),u(So,this,No).call(this,this.opened))}requestClose(){this.opened=!1}};function Ao(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(m(yo,this)?.call(this),h(yo,this,fo(this))),m(bo,this)||(h(bo,this,!0),go())}function jo(){let e=this.dialogElement;e?.open&&e.close(),m(yo,this)?.call(this),h(yo,this,null),u(So,this,Mo).call(this)}function Mo(){m(bo,this)&&(h(bo,this,!1),_o())}function No(e){u(So,this,Po).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&u(So,this,Po).call(this,e?`craft-after-show`:`craft-after-hide`)})}function Po(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}ko.styles=[ao,po],p([g({type:Boolean,attribute:`open`,reflect:!0})],ko.prototype,`opened`,void 0),p([g()],ko.prototype,`label`,void 0),p([g({type:Boolean,attribute:`non-modal`,reflect:!0})],ko.prototype,`nonModal`,void 0),p([g({type:Boolean,reflect:!0})],ko.prototype,`fullscreen`,void 0),p([g({type:Boolean,attribute:`close-on-outside-click`})],ko.prototype,`closeOnOutsideClick`,void 0),p([g({type:Boolean,attribute:`no-close`,reflect:!0})],ko.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,ko);var Fo=new WeakMap,Io=new WeakSet,Lo=class{constructor(e,t){this.host=e,this.source=t,d(this,Io),f(this,Fo,null),e.addController(this)}hostConnected(){u(Io,this,Ro).call(this)}hostDisconnected(){u(Io,this,zo).call(this)}resubscribe(){u(Io,this,zo).call(this),u(Io,this,Ro).call(this)}get state(){return this.source()?.state??null}};function Ro(){h(Fo,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function zo(){m(Fo,this)?.call(this),h(Fo,this,null)}var Bo=a`
  :host {
    /*
...
`,Vo=new WeakMap,Ho=new WeakMap,Uo=new WeakMap,Wo=new WeakMap,Go=new WeakMap,Ko=class extends ko{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,f(this,Vo,new Lo(this,()=>this.controller)),f(this,Ho,null),f(this,Uo,()=>{this.submit()}),f(this,Wo,()=>{this.busy||this.requestClose()}),f(this,Go,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&h(Ho,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),m(Ho,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&m(Vo,this).resubscribe();let t=m(Vo,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&m(Ho,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
    ...
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};Ko.styles=[...ko.styles,Bo],p([g({attribute:!1})],Ko.prototype,`controller`,void 0),p([g({type:Boolean,attribute:`show-title`,reflect:!0})],Ko.prototype,`showTitle`,void 0),p([g({attribute:`select-label`})],Ko.prototype,`selectLabel`,void 0),p([g({attribute:`cancel-label`})],Ko.prototype,`cancelLabel`,void 0),p([g({type:Boolean,reflect:!0})],Ko.prototype,`busy`,void 0),p([g({type:Boolean,reflect:!0})],Ko.prototype,`loading`,void 0),p([g({type:Boolean,attribute:`can-submit`,reflect:!0})],Ko.prototype,`canSubmit`,void 0),p([g({type:Boolean,reflect:!0})],Ko.prototype,`narrow`,void 0),p([_()],Ko.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,Ko);var qo=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
    ...
    `],p([g()],Yo.prototype,`label`,void 0),p([g()],Yo.prototype,`icon`,void 0),customElements.get(`craft-empty`)||customElements.define(`craft-empty`,Yo);var Xo=a`
  :host {
    position: relative;
    display: block;
  }
...
`,Zo=class extends mi(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=O(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[Mt,yr,Xo]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth()}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
    ...
    `}__hasLightChild(e){return this.__lightChild(e)!==void 0}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`span`);t.className=`visually-hidden`,t.textContent=O(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};p([g({type:Boolean,reflect:!0})],Zo.prototype,`required`,void 0),p([g({type:Boolean,reflect:!0})],Zo.prototype,`translatable`,void 0),p([g({attribute:`translation-description`})],Zo.prototype,`translationDescription`,void 0),p([g({type:Boolean,reflect:!0})],Zo.prototype,`fieldset`,void 0),p([g({reflect:!0})],Zo.prototype,`status`,void 0),p([g({attribute:`status-label`})],Zo.prototype,`statusLabel`,void 0),p([g({reflect:!0})],Zo.prototype,`orientation`,void 0),p([g({type:Boolean,reflect:!0,attribute:`has-errors`})],Zo.prototype,`hasErrors`,void 0),p([g({attribute:`instructions-position`})],Zo.prototype,`instructionsPosition`,void 0),p([g({type:String,reflect:!0})],Zo.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,Zo);var Qo=class extends l{render(){return r`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,Qo);var $o=a`
  ${yr}
...
`,es=/^[0-9a-f]{6}$/i,ts=/^[0-9a-f]{3}$/i,ns={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function rs(e){return String(e??``).trim().replace(/^#/,``)}function is(e){let t=rs(e);return ts.test(t)?t.split(``).map(e=>e+e).join(``):es.test(t)?t:null}var as=class e extends Ri{static get styles(){return[...super.styles,br,$o]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,rs(t)),e}}}parser(e){return rs(e)}formatter(e){return rs(e)}serializer(e){return rs(e)}deserializer(e){return rs(e)}preprocessor(e){let t=rs(e);if(t!==e)return t}get _expandedHexValue(){return is(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>is(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=rs(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
      <input
    ...
    `}};as._browserSupportsColorInputs=null,p([g({converter:ns})],as.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,as);var os=a`
  ::slotted(.form-control) {
    ${gr}
  }
...
`,cs=class extends B{static get styles(){return[...super.styles,ss]}_renderSuffix(){return r`<craft-copy-button
      tooltip-label="${O(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};p([g({type:String,attribute:`copy-value`})],cs.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,cs);var ls=class extends B{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,ls);var us=new WeakSet,ds=class extends B{constructor(){super(),d(this,us),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,u(us,this,fs))}disconnectedCallback(){this.removeEventListener(`change`,u(us,this,fs)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),u(us,this,ps).call(this)}};function fs(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=u(us,this,ms).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}u(us,this,ps).call(this)}}function ps(){let e=this._inputNode;if(!e)return;let t=u(us,this,hs).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=u(us,this,hs).call(this,e),i=u(us,this,hs).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function ms(e){let t=u(us,this,hs).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function hs(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}p([g({type:Number,attribute:`minute-increment`})],ds.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],ds.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],ds.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,ds);var gs={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},_s=new WeakSet,vs=new WeakMap,V=class extends l{constructor(...e){super(...e),d(this,_s),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,f(this,vs,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof B))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,m(vs,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,m(vs,this)),super.disconnectedCallback()}updated(e){super.updated(e),u(_s,this,ys).call(this),u(_s,this,bs).call(this),u(_s,this,xs).call(this),u(_s,this,Es).call(this,`locale`,this.locale,!0),u(_s,this,Es).call(this,`timezone`,this.timezone,!this.showTimezone)}};function ys(){let e=u(_s,this,Ss).call(this,`craft-input-date`,`date`,this.showDate);e instanceof ls&&(u(_s,this,Ts).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,u(_s,this,Cs).call(this,e))}function bs(){let e=u(_s,this,Ss).call(this,`craft-input-time`,`time`,this.showTime);e instanceof ds&&(u(_s,this,Ts).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,u(_s,this,Cs).call(this,e))}function xs(){let e=u(_s,this,Ss).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(u(_s,this,Ts).call(this,e,`timezone`,this.timezone??``,!1),u(_s,this,Cs).call(this,e))}function Ss(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof B);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Cs(e){e.parentElement!==this&&this.insertBefore(e,u(_s,this,ws).call(this))}function ws(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function Ts(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function Es(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}V.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,p([g()],V.prototype,`name`,void 0),p([g({attribute:`date-value`})],V.prototype,`dateValue`,void 0),p([g({attribute:`time-value`})],V.prototype,`timeValue`,void 0),p([g()],V.prototype,`locale`,void 0),p([g()],V.prototype,`timezone`,void 0),p([g({attribute:`show-date`,converter:gs})],V.prototype,`showDate`,void 0),p([g({attribute:`show-time`,converter:gs})],V.prototype,`showTime`,void 0),p([g({type:Boolean,attribute:`show-timezone`})],V.prototype,`showTimezone`,void 0),p([g()],V.prototype,`min`,void 0),p([g()],V.prototype,`max`,void 0),p([g({attribute:`min-time`})],V.prototype,`minTime`,void 0),p([g({attribute:`max-time`})],V.prototype,`maxTime`,void 0),p([g({type:Number,attribute:`minute-increment`})],V.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],V.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],V.prototype,`forceRoundTime`,void 0),p([g({type:Boolean})],V.prototype,`disabled`,void 0),p([g({type:Boolean})],V.prototype,`readonly`,void 0),p([g({type:Boolean})],V.prototype,`required`,void 0),p([g({attribute:`described-by`})],V.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,V);var Ds=class extends xi{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Os=class extends xi{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Wr().msg(`lion-input-file:uploadTextDuplicateFileName`)}},ks=524288e3,As={type:`FILE_TYPE`,size:`FILE_SIZE`},js={fail:`FAIL`,pass:`SUCCESS`},Ms=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);Ds.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=js.fail,this.failedProp.push(As.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;Ds.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=js.fail,this.failedProp.push(As.type))}Ds.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==js.fail&&(this.status=js.pass):(this.status=js.fail,this.failedProp.push(As.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Ns=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},Ps=T(class extends de{constructor(e){if(super(e),e.type!==S.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){let i=Re(e),{values:a,keys:s}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=s,a;let c=this.ut??=[],l=[],u,d,f=0,p=i.length-1,m=0,h=a.length-1;for(;f<=p&&m<=h;)if(i[f]===null)f++;else if(i[p]===null)p--;else if(c[f]===s[m])l[m]=Fe(i[f],a[m]),f++,m++;else if(c[p]===s[h])l[h]=Fe(i[p],a[h]),p--,h--;else if(c[f]===s[h])l[h]=Fe(i[f],a[h]),Pe(e,l[h+1],i[f]),f++,h--;else if(c[p]===s[m])l[m]=Fe(i[p],a[m]),Pe(e,i[f],i[p]),p--,m++;else if(u===void 0&&(u=Ns(s,m,h),d=Ns(c,f,p)),u.has(c[f]))if(u.has(c[p])){let t=d.get(s[m]),n=t===void 0?null:i[t];if(n===null){let t=Pe(e,i[f]);Fe(t,a[m]),l[m]=t}else l[m]=Fe(n,a[m]),Pe(e,i[f],n),i[t]=null;m++}else ze(i[p]),p--;else ze(i[f]),f++;for(;m<=h;){let t=Pe(e,l[h+1]);Fe(t,a[m]),l[m++]=t}for(;f<=p;){let e=i[f++];e!==null&&ze(e)}return this.ut=s,Le(e,l),o}}),Fs=e=>{switch(e){case`bg-BG`:return E(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return E(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return E(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return E(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return E(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return E(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return E(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return E(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return E(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return E(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return E(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return E(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return E(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return E(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return E(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return E(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return E(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return E(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return E(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return E(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return E(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return E(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return E(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return E(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return E(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return E(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return E(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return E(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return E(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return E(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return E(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return E(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return E(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return E(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Is=class extends ri(li(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":bi}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Fs},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},zs=class extends Is{static get styles(){return[...super.styles,a`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
...
`,Vs=class extends Rs{static get styles(){return[...super.styles,br,Bs]}get slots(){return{...super.slots,"file-select-button":()=>r`<craft-button
      ...
      `]}constructor(){super(),d(this,Ks),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,f(this,qs,()=>{this.modelValue=``,this.value=``,u(Ks,this,Ys).call(this)?.inputmask?.setValue(``),u(Ks,this,Ys).call(this)?.focus()}),this.type=`text`,this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&u(Ks,this,Zs).call(this),u(Ks,this,Ys).call(this)?.classList.toggle(`money-placeholder`,!u(Ks,this,Qs).call(this))}disconnectedCallback(){u(Ks,this,Ys).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?r`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${u(Ks,this,Xs).call(this).currency}`}</span
      >
      ...
      <craft-button
        ...
        icon
        aria-label=${O(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!u(Ks,this,Qs).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${m(qs,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function Ys(){return this._inputNode}function Xs(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function Zs(){let e=u(Ks,this,Ys).call(this);if(!e)return;let t=String(this.modelValue??``),n=u(Ks,this,Xs).call(this);e.inputmask?.remove(),e.value=t,new Ws({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function Qs(){return this.modelValue!==``&&this.modelValue!=null}p([g()],Js.prototype,`currency`,void 0),p([g()],Js.prototype,`locale`,void 0),p([g({type:Number})],Js.prototype,`decimals`,void 0),p([g({attribute:`decimal-separator`})],Js.prototype,`decimalSeparator`,void 0),p([g({attribute:`group-separator`})],Js.prototype,`groupSeparator`,void 0),p([g({converter:Gs,attribute:`show-currency`})],Js.prototype,`showCurrency`,void 0),p([g({converter:Gs})],Js.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,Js);var $s=new WeakSet,ec=class extends Ri{static get styles(){return[...super.styles,br,a`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),d(this,$s),this.passwordRules=``,this._visible=!1,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>r`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),u($s,this,tc).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&u($s,this,tc).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function tc(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}p([g({attribute:`passwordrules`})],ec.prototype,`passwordRules`,void 0),p([_()],ec.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,ec);var nc=class extends l{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return r`
  ...
  `,p([g()],nc.prototype,`error`,void 0),p([g({attribute:`plugin-name`})],nc.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,nc);var rc=a`
  :host {
    display: block;
    /*
...
`,ic={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(ic);var ac={Plain:`plain`,Error:`error`,Code:`code`};Object.values(ac);var oc=new Set([`clip`,`hidden`]),sc=class extends dr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=ic.Raised,this.variant=ac.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!oc.has(n)&&e.scrollHeight-e.clientHeight>1||!oc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};sc.styles=[ao,rc],p([g({reflect:!0})],sc.prototype,`appearance`,void 0),p([g({reflect:!0})],sc.prototype,`variant`,void 0),p([g()],sc.prototype,`label`,void 0),p([_()],sc.prototype,`_hasSlottedHeader`,void 0),p([_()],sc.prototype,`_hasSlottedFooter`,void 0),p([_()],sc.prototype,`_scrollable`,void 0),p([_()],sc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,sc);var cc=0,lc=new WeakMap,H=new WeakSet,uc=class extends l{constructor(...e){super(...e),d(this,H),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,lc,++cc)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(H,this,xc).call(this)}render(){let e=u(H,this,pc).call(this);return Ps(this.groups,e=>e.handle,(t,n)=>u(H,this,dc).call(this,t,n,e))}};function dc(e,t,n){let i=`permission-tree-heading-${m(lc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>u(H,this,_c).call(this,e.keys,n)}
                >
                  ${u(H,this,gc).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${u(H,this,fc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function fc(e,t,n,i){return Ps(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(H,this,hc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||u(H,this,mc).call(this,o,i)}
                @model-value-changed=${e=>u(H,this,vc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?u(H,this,fc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function pc(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function mc(e,t){return t.has(e.toLowerCase())}function hc(e,t){return this.modelValue.includes(e)||u(H,this,mc).call(this,e,t)}function gc(e,t){let n=e.filter(e=>!u(H,this,mc).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function _c(e,t){let n=e.filter(e=>!u(H,this,mc).call(this,e,t));if(u(H,this,gc).call(this,e,t)){let e=new Set(n);u(H,this,bc).call(this,this.modelValue.filter(t=>!e.has(t)));return}u(H,this,bc).call(this,[...new Set([...this.modelValue,...n])])}function vc(e,t,n,r){if(e.stopPropagation(),this.disabled||u(H,this,mc).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){u(H,this,bc).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...u(H,this,yc).call(this,n)]);u(H,this,bc).call(this,this.modelValue.filter(e=>!o.has(e)))}function yc(e){return Object.values(e).flatMap(e=>[e.key,...u(H,this,yc).call(this,e.nested??{})])}function bc(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function xc(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;u(H,this,Sc).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&u(H,this,Sc).call(this,`${this.name}[]`,t)}function Sc(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}uc.styles=a`
    :host {
      display: block;
    }
  ...
  `,p([g({type:Array})],uc.prototype,`groups`,void 0),p([g({type:Array,attribute:`model-value`})],uc.prototype,`modelValue`,void 0),p([g({type:Array,attribute:`locked-permissions`})],uc.prototype,`lockedPermissions`,void 0),p([g()],uc.prototype,`name`,void 0),p([g({type:Boolean,reflect:!0})],uc.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,uc);var Cc=a`
  :host {
...
`,wc=new WeakMap,Tc=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,f(this,wc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&m(wc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),h(wc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,h(wc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
      <div
    ...
    `}};Tc.styles=[Cc],p([g({type:Number})],Tc.prototype,`progress`,void 0),p([g({type:Number})],Tc.prototype,`total`,void 0),p([g({type:Number})],Tc.prototype,`processed`,void 0),p([g({type:Boolean,attribute:`show-status`})],Tc.prototype,`showStatus`,void 0),p([g({type:Boolean,reflect:!0})],Tc.prototype,`pending`,void 0),p([g({type:Boolean})],Tc.prototype,`smooth`,void 0),p([g({type:String})],Tc.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Tc);var Ec=class extends Mi(Ii(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Dc=class extends Pi(Ri){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Oc=class extends Ec{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,br,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      `]}};customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Oc);var kc=class extends Ui(Dc){static get styles(){return[...super.styles,a`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,kc);var Ac=a`
  craft-button {
    cursor: move;
  }
...
`,jc=class extends l{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??O(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),i=t?n?`arrow-right`:`arrow-left`:`arrow-up`,a=t?n?`arrow-left`:`arrow-right`:`arrow-down`,o=O(t?`Move forward`:`Move up`),s=O(t?`Move backward`:`Move down`);return r`
    ...
    `}};jc.styles=[Ac],p([g()],jc.prototype,`label`,void 0),p([g({reflect:!0})],jc.prototype,`position`,void 0),p([g({reflect:!0})],jc.prototype,`orientation`,void 0),p([g({reflect:!0})],jc.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],jc.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,jc);var Mc=class extends He(Ut){static get styles(){return[...super.styles,a`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Ic=class extends Mc{static get styles(){return[...super.styles,Fc]}_afterTemplate(){return r`${this.singleOption?``:r`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},Lc=a`
  ${yr}
...
`,Rc=class extends Pc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Lc]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Ic}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return r`
    ...
    `}};p([g({reflect:!0,type:Boolean})],Rc.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,Rc);var zc=a`
  :host {
    display: block;
  }
`;function Bc(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Vc=class extends l{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return r`<span
    ...
    ></span>`}_optionTemplate(e,t){return r`<craft-option .choiceValue=${e}>
      ...
      >
        ...
        ${tt.map(e=>this._optionTemplate(e,O(Bc(e))))}
      </craft-select-rich>
    `}};Vc.styles=[zc],p([g()],Vc.prototype,`label`,void 0),p([g()],Vc.prototype,`name`,void 0),p([g({attribute:`model-value`})],Vc.prototype,`modelValue`,void 0),p([g({type:Boolean,reflect:!0,attribute:`allow-transparent`})],Vc.prototype,`allowTransparent`,void 0),customElements.get(`craft-select-color`)||customElements.define(`craft-select-color`,Vc);var Hc=class extends Di{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>e.slot===`input`)}},Uc=class extends Hc{get operationMode(){return`select`}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener(`change`,this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:`model`})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has(`disabled`)&&(this._inputNode.disabled=this.disabled,this.validate()),e.has(`name`)&&(this._inputNode.name=this.name),e.has(`autocomplete`)&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener(`change`,this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){let t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:``}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=this.modelValue===void 0?``:this.modelValue)}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent(`user-input-changed`,{bubbles:!0,composed:!0}))}},Wc=a`
  ${yr}
...
`,Gc=class extends Uc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Wc]}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};p([g({reflect:!0,type:Boolean})],Gc.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,Gc);var Kc=a`
  :host {
    display: inline-block;
  }
...
`,U=new WeakSet,qc=class extends l{constructor(...e){super(...e),d(this,U),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(U,this,Yc).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(U,this,Jc).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${u(U,this,Zc).call(this,this.value)}
      ...
      >
        ${e.map(e=>r`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(U,this,$c).call(this,e)}
              title=${u(U,this,Zc).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function Jc(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function Yc(e){u(U,this,Jc).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function Xc(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function Zc(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function Qc(e,t){let n=u(U,this,Yc).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function $c(e){this.readOnly||u(U,this,Qc).call(this,e,!0)}function el(e){if(this.readOnly)return;let t=u(U,this,Xc).call(this);switch(e.key){case`ArrowUp`:u(U,this,Qc).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(U,this,Qc).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(U,this,Qc).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(U,this,Qc).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(U,this,Qc).call(this,this.min,!0),e.preventDefault();break;case`End`:u(U,this,Qc).call(this,this.max,!0),e.preventDefault();break}}qc.styles=[Kc],p([g({type:Number})],qc.prototype,`min`,void 0),p([g({type:Number})],qc.prototype,`max`,void 0),p([g({type:Number})],qc.prototype,`step`,void 0),p([g({type:Number})],qc.prototype,`value`,void 0),p([g()],qc.prototype,`label`,void 0),p([g({attribute:`described-by`})],qc.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],qc.prototype,`valueUnit`,void 0),p([g({attribute:!1})],qc.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],qc.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,qc);var tl=a`
  :host {
    display: block;
  }
...
`,nl=new WeakMap,rl=new WeakMap,il=new WeakMap,al=new WeakMap,ol=new WeakMap,sl=new WeakMap,W=new WeakSet,cl=class extends l{constructor(...e){super(...e),d(this,W),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,nl,!1),f(this,rl,!1),f(this,il,0),f(this,al,0),f(this,ol,0),f(this,sl,null)}connectedCallback(){super.connectedCallback(),h(sl,this,new ResizeObserver(()=>u(W,this,ul).call(this))),m(sl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(sl,this)?.disconnect(),h(sl,this,null)}firstUpdated(){h(ol,this,(u(W,this,ll).call(this).length-1)*10),u(W,this,ul).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(W,this,ul).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(W,this,dl).call(this,this.value)}
        @keydown=${u(W,this,bl)}
        @pointerdown=${u(W,this,gl)}
        @pointermove=${u(W,this,_l)}
        @pointerup=${u(W,this,vl)}
      >
        <div class="overlay"></div>
        <div class="cursor"></div>
        <div class="graduations">
          <ul aria-hidden="true">
            ${u(W,this,ll).call(this).map(e=>r`
                <li
                  class=${k({graduation:!0,"main-graduation":e%5==0,selected:u(W,this,xl).call(this,e)})}
                  data-graduation=${e}
                >
    ...
    `}};function ll(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function ul(){this._list&&(this._list.style.left=`${u(W,this,pl).call(this,this.value)}px`)}function dl(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function fl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(ol,this)*n-t}function pl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(ol,this)/n-this._graduations.offsetWidth/2)}function ml(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);this.value=n,t&&u(W,this,hl).call(this,`change`)}function hl(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function gl(e){h(rl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(rl,this)&&(e.preventDefault(),h(il,this,e.clientX),h(al,this,this._list.offsetLeft),this._root.setPointerCapture(e.pointerId),u(W,this,hl).call(this,`start`))}function _l(e){m(rl,this)&&Math.abs(e.clientX-m(il,this))>3&&(h(nl,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(W,this,yl).call(this,e))}function vl(e){m(rl,this)&&(m(nl,this)?(e.preventDefault(),h(nl,this,!1),this._root.classList.remove(`dragging`)):u(W,this,yl).call(this,e),u(W,this,hl).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(il,this,0),h(rl,this,!1))}function yl(e){let t=m(nl,this)?m(il,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(nl,this)?t-e.clientX:e.clientX-t,r=m(al,this)-n;u(W,this,ml).call(this,u(W,this,fl).call(this,r))}function bl(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(W,this,ml).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(W,this,ml).call(this,t-1);break;case`PageUp`:u(W,this,ml).call(this,t+10);break;case`PageDown`:u(W,this,ml).call(this,t-10);break;case`Home`:u(W,this,ml).call(this,this.min);break;case`End`:u(W,this,ml).call(this,this.max);break;default:return}e.preventDefault()}function xl(e){return e>=Math.min(0,this.value)&&e<=Math.max(0,this.value)}cl.styles=[tl],p([g({type:Number})],cl.prototype,`min`,void 0),p([g({type:Number})],cl.prototype,`max`,void 0),p([g({type:Number})],cl.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],cl.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],cl.prototype,`graduationMax`,void 0),p([g()],cl.prototype,`label`,void 0),p([y(`.slide-rule`)],cl.prototype,`_root`,void 0),p([y(`.graduations`)],cl.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],cl.prototype,`_list`,void 0),p([y(`.cursor`)],cl.prototype,`_cursor`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,cl);var Sl=a`
  :host {
    display: inline-flex;
...
`,Cl=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      <span
      ...
      ></span>
    `}};Cl.styles=[Sl],p([g()],Cl.prototype,`label`,void 0),p([g()],Cl.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Cl);var wl=class extends Oe(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},El=class extends wl{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],El.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,El);var Dl=a`
  :host {
    display: grid;
  }
...
`;function Ol(e){return(e??``).split(/\s+/).filter(Boolean)}function kl(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Al=Symbol.for(`craft-switch-synthetic-change`),jl=new WeakMap,Ml=new WeakSet,Nl=class extends Tl{constructor(...e){super(...e),d(this,Ml),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,f(this,jl,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,yr,Dl]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":El}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?O(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?O(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){u(Ml,this,Pl).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){u(Ml,this,Pl).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){u(Ml,this,Pl).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(m(jl,this))return;let e=new Event(`change`,{bubbles:!0});e[Al]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Al in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of Ol(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of Ol(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${kl(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
    ...
    `}};function Pl(e,t){if(!this.disabled){if(!t){e();return}h(jl,this,!0),e(),this.updateComplete.then(()=>{h(jl,this,!1)})}}p([g({type:String,reflect:!0})],Nl.prototype,`size`,void 0),p([g({type:String,attribute:`on-label`})],Nl.prototype,`onLabel`,void 0),p([g({type:String,attribute:`off-label`})],Nl.prototype,`offLabel`,void 0),p([g({attribute:`value`})],Nl.prototype,`checkedValue`,void 0),p([g({attribute:`indeterminate-value`})],Nl.prototype,`indeterminateValue`,void 0),p([g({type:Boolean,reflect:!0})],Nl.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,Nl);function Fl({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function Il(e){e.setAttribute(`selected`,`true`)}function Ll(e){e.removeAttribute(`selected`)}function Rl({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function zl({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function Bl(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function Vl(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function Hl(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var Ul=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,Gl={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(Gl);var Kl={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(Kl);var ql=[Gl.InlineStart,Gl.InlineEnd],Jl=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),G=new WeakSet,Yl=new WeakMap,Xl=new WeakMap,Zl=new WeakMap,Ql=new WeakMap,$l=new WeakMap,eu=new WeakMap,tu=new WeakMap,nu=new WeakMap,ru=new WeakMap,iu=new WeakMap,au=new WeakMap,ou=class extends Ul{constructor(...e){super(...e),d(this,G),this.placement=Gl.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,Yl,[]),f(this,Xl,!1),f(this,Zl,[]),f(this,Ql,0),f(this,$l,void 0),f(this,eu,!1),f(this,tu,e=>{if(!this.collapsible||cu.call(u(G,this)))return;let t=u(G,this,fu).call(this,e.target);!t||t.disabled||lu.call(u(G,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(G,this,pu).call(this,!0))}),f(this,nu,e=>{e.key!==`Escape`||!this.collapsible||cu.call(u(G,this))||u(G,this,fu).call(this,e.target)&&(e.stopPropagation(),u(G,this,pu).call(this,!0))}),f(this,ru,()=>{cu.call(u(G,this))&&(lu.call(u(G,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(G,this,mu).call(this)}),f(this,iu,()=>{if(u(G,this,hu).call(this),lu.call(u(G,this)).forEach((e,t)=>{let n=()=>u(G,this,Cu).call(this,t,!0),r=e=>{Jl.has(e.key)&&e.preventDefault()},i=e=>u(G,this,wu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(Yl,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),lu.call(u(G,this))[this.selectedIndex]?.disabled){let e=lu.call(u(G,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(G,this,gu).call(this)}),f(this,au,()=>{m(eu,this)||(h(eu,this,!0),requestAnimationFrame(()=>{h(eu,this,!1),u(G,this,vu).call(this)}))})}static get styles(){return[...super.styles,ao,Wl]}get layout(){return su.call(u(G,this))?Kl.Vertical:Kl.Horizontal}set layout(e){this.placement=e===Kl.Vertical?Gl.InlineStart:Gl.BlockStart}refresh(){m(Xl,this)&&u(G,this,gu).call(this),u(G,this,vu).call(this)}firstUpdated(e){h(Xl,this,lu.call(u(G,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(Xl,this))t?.addEventListener(`slotchange`,m(iu,this)),m(iu,this).call(this);else{let n=cu.call(u(G,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(ru,this))}this.addEventListener(`click`,m(tu,this),!0),this.addEventListener(`keydown`,m(nu,this)),t?.addEventListener(`slotchange`,m(au,this)),h($l,this,new ResizeObserver(m(au,this))),m($l,this).observe(this),u(G,this,vu).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(G,this,hu).call(this),m($l,this)?.disconnect(),h($l,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,cu.call(u(G,this))),e.has(`selectedIndex`)&&(m(Xl,this)?u(G,this,gu).call(this):m(ru,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(G,this,vu).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${su.call(u(G,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${cu.call(u(G,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function su(){return ql.includes(this.placement)}function cu(){return this.selectedIndex<0}function lu(){return this.tabs}function uu(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function du(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function fu(e){return e instanceof Node?lu.call(u(G,this)).find(t=>t===e||t.contains(e))??null:null}function pu(e){let t=lu.call(u(G,this))[this.selectedIndex];h(Ql,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function mu(){let e=lu.call(u(G,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(Ql,this))?m(Ql,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function hu(){for(;m(Yl,this).length;)m(Yl,this).pop()?.()}function gu(){let e=lu.call(u(G,this)).map(e=>u(G,this,_u).call(this,e)),t=e.some(Boolean);lu.call(u(G,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Ue()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(G,this,mu).call(this)}function _u(e){return e.controls?document.getElementById(e.controls):null}function vu(){let e=uu.call(u(G,this)),t=du.call(u(G,this)),n=lu.call(u(G,this));if(!e||!t)return;if(su.call(u(G,this))||n.length===0){u(G,this,bu).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(G,this,yu).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(G,this,bu).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(G,this,bu).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function yu(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function bu(e){let t=du.call(u(G,this)),n=new Set(e);lu.call(u(G,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(Zl,this,e),t&&(t.hidden=e.length===0,t.actions=u(G,this,xu).call(this))}function xu(){return m(Zl,this).map(e=>{let t=lu.call(u(G,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(G,this,Su).call(this,e)}})}function Su(e){let t=lu.call(u(G,this))[e];if(!t||t.disabled)return;let n=du.call(u(G,this));n&&(n.opened=!1),this.selectedIndex=e,u(G,this,vu).call(this),t.focus()}function Cu(e,t){let n=lu.call(u(G,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function wu(e){if(!Jl.has(e.key))return;let t=u(G,this,Tu).call(this,e.key);t!==-1&&u(G,this,Cu).call(this,t,!0)}function Tu(e){let t=lu.call(u(G,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(cu.call(u(G,this)))return u(G,this,Tu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],ou.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],ou.prototype,`collapsible`,void 0),p([g({reflect:!0})],ou.prototype,`layout`,null),p([g({reflect:!0})],ou.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,ou);var Eu=a`
  :host {
    display: inline-flex;
...
`,Iu=C(ue(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?t.exports=r():typeof define==`function`&&define.amd?define(r):(n||=self,n.autosize=r())})(e,(function(){var e=new Map;function t(t){if(!t||!t.nodeName||t.nodeName!==`TEXTAREA`||e.has(t))return;var n=null;function r(e){for(var t=[];e&&e.parentNode&&e.parentNode instanceof Element;)e.parentNode.scrollTop&&t.push([e.parentNode,e.parentNode.scrollTop]),e=e.parentNode;return function(){return t.forEach(function(e){var t=e[0],n=e[1];t.style.scrollBehavior=`auto`,t.scrollTop=n,t.style.scrollBehavior=null})}}var i=window.getComputedStyle(t);function a(e){var o=e.restoreTextAlign,s=o===void 0?null:o,c=e.testForHeightReduction,l=c===void 0||c,u=i.overflowY;if(t.scrollHeight!==0){i.resize===`vertical`?t.style.resize=`none`:i.resize===`both`&&(t.style.resize=`horizontal`);var d;l&&(d=r(t),t.style.height=``);var f=i.boxSizing===`content-box`?t.scrollHeight-(parseFloat(i.paddingTop)+parseFloat(i.paddingBottom)):t.scrollHeight+parseFloat(i.borderTopWidth)+parseFloat(i.borderBottomWidth);if(i.maxHeight!==`none`&&f>parseFloat(i.maxHeight)?(i.overflowY===`hidden`&&(t.style.overflow=`scroll`),f=parseFloat(i.maxHeight)):i.overflowY!==`hidden`&&(t.style.overflow=`hidden`),t.style.height=f+`px`,s&&(t.style.textAlign=s),d&&d(),n!==f&&(t.dispatchEvent(new Event(`autosize:resized`,{bubbles:!0})),n=f),u!==i.overflow&&!s){var p=i.textAlign;i.overflow===`hidden`&&(t.style.textAlign=p===`start`?`end`:`start`),a({restoreTextAlign:p,testForHeightReduction:!0})}}}function o(){a({testForHeightReduction:!0,restoreTextAlign:null})}var s=function(){var e=t.value;return function(){a({testForHeightReduction:e===``||!t.value.startsWith(e),restoreTextAlign:null}),e=t.value}}(),c=function(n){t.removeEventListener(`autosize:destroy`,c),t.removeEventListener(`autosize:update`,o),t.removeEventListener(`input`,s),window.removeEventListener(`resize`,o),Object.keys(n).forEach(function(e){return t.style[e]=n[e]}),e.delete(t)}.bind(t,{height:t.style.height,resize:t.style.resize,textAlign:t.style.textAlign,overflowY:t.style.overflowY,overflowX:t.style.overflowX,wordWrap:t.style.wordWrap});t.addEventListener(`autosize:destroy`,c),t.addEventListener(`autosize:update`,o),t.addEventListener(`input`,s),window.addEventListener(`resize`,o),t.style.overflowX=`hidden`,t.style.wordWrap=`break-word`,e.set(t,{destroy:c,update:o}),o()}function n(t){var n=e.get(t);n&&n.destroy()}function r(t){var n=e.get(t);n&&n.update()}var i=null;return typeof window>`u`?(i=function(e){return e},i.destroy=function(e){return e},i.update=function(e){return e}):(i=function(e,n){return e&&Array.prototype.forEach.call(e.length?e:[e],function(e){return t(e)}),e},i.destroy=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],n),e},i.update=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],r),e}),i}))}))(),1),Lu=new WeakMap,Ru=new WeakMap,zu=new WeakMap,Bu=new WeakSet,Vu=class extends Pu{constructor(...e){super(...e),d(this,Bu),this.monospace=!1,f(this,Lu,void 0),f(this,Ru,void 0),f(this,zu,null)}static get styles(){return[...super.styles,br,Fu]}connectedCallback(){super.connectedCallback(),u(Bu,this,Hu).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(Lu,this)?.disconnect(),h(Lu,this,void 0),m(Ru,this)?.disconnect(),h(Ru,this,void 0)}};function Hu(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(zu,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(zu,this,e.style.height)}),h(Ru,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(Ru,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(Lu,this,new ResizeObserver(()=>{if(e.style.height===m(zu,this))return;let t=e.style.height;Iu.default.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(Ru,this)?.disconnect(),h(Ru,this,void 0),m(Lu,this)?.disconnect(),h(Lu,this,void 0)})),m(Lu,this).observe(e))}p([g({type:Boolean,reflect:!0})],Vu.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Vu);var Uu=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>Wu(e,this),this.compositionEventHandler=e=>Xu(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,Gu),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,Gu)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(Yu)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(Yu)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(Yu),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),Ju(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function Wu(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:Ku(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&Ku(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function Gu(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&qu(t,{event:e})}function Ku(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function qu(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function Ju(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function Yu(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function Xu(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var Zu=class extends Event{constructor(){super(`update`)}},Qu=new WeakMap,$u=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=Qu.get(t);return n||(n=new e(t),Qu.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),Qu.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new Zu)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of ed)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},ed=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),td=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return $u.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},nd=a`
  :host {
    display: contents;
  }
...
`,rd=/^[\p{L}\p{N}_.-]*$/u,id=O(`Suggestions`),ad=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],od={handlesAccessibility:!1,visibilityTriggerFunction:void 0},sd=0,K=new WeakMap,cd=new WeakMap,ld=new WeakMap,ud=new WeakMap,q=new WeakMap,dd=new WeakMap,fd=new WeakMap,pd=new WeakMap,md=new WeakMap,hd=new WeakMap,gd=new WeakMap,_d=new WeakMap,vd=new WeakMap,yd=new WeakMap,J=new WeakSet,bd=new WeakMap,xd=new WeakMap,Sd=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=class extends l{constructor(...e){super(...e),d(this,J),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,K,void 0),f(this,cd,null),f(this,ld,null),f(this,ud,new Map),f(this,q,null),f(this,dd,[]),f(this,fd,0),f(this,pd,null),f(this,md,null),f(this,hd,null),f(this,gd,!1),f(this,_d,null),f(this,vd,new DOMRect),f(this,yd,new MutationObserver(()=>{let e=u(J,this,Nd).call(this);(tf(e)&&e!==m(cd,this)||m(cd,this)&&!m(cd,this).isConnected)&&u(J,this,Pd).call(this)})),f(this,bd,()=>{m(gd,this)||u(J,this,Vd).call(this)}),f(this,xd,()=>{h(gd,this,!0),u(J,this,Yd).call(this)}),f(this,Sd,()=>{h(gd,this,!1),u(J,this,Vd).call(this)}),f(this,Cd,()=>{queueMicrotask(()=>u(J,this,Yd).call(this))}),f(this,wd,()=>{let e=m(cd,this);!e||!m(q,this)||!nf(e)||queueMicrotask(()=>{m(q,this)&&(e.selectionStart!==m(q,this).end||e.selectionEnd!==m(q,this).end)&&u(J,this,Vd).call(this)})}),f(this,Td,()=>{m(q,this)&&u(J,this,Jd).call(this)}),f(this,Ed,e=>{let t=e;m(q,this)&&m(K,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,Dd,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,Od,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,kd,e=>{u(J,this,Gd).call(this,Number(e.target.dataset.index))}),f(this,Ad,e=>{if(e.target!==this.popoverElement)return;let t=m(K,this).getAttribute(`aria-label`)??id;u(J,this,Qd).call(this),h(q,this,null),u(J,this,Zd).call(this),u(J,this,$d).call(this,t===id?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(J,this,Md).call(this),this.hasUpdated&&u(J,this,Pd).call(this)}disconnectedCallback(){u(J,this,Id).call(this),m(K,this)?.remove(),m(hd,this)!==null&&(clearTimeout(m(hd,this)),h(hd,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(J,this,Pd).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(cd,this)!==u(J,this,Nd).call(this)&&u(J,this,Pd).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(q,this)){let e=m(K,this).querySelector(`[aria-selected="true"]`),t=e?m(dd,this)[Number(e.dataset.index)]:void 0;u(J,this,Vd).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${od}
        @craft-hide=${m(Ad,this)}
      >
    ...
    `}};function Md(){h(K,this,document.createElement(`div`)),m(K,this).id=`craft-text-expander-listbox-${++sd}`,m(K,this).slot=`listbox`,m(K,this).setAttribute(`part`,`listbox`),m(K,this).role=`listbox`,m(K,this).setAttribute(`aria-label`,id),m(K,this).addEventListener(`pointerdown`,m(Dd,this)),m(K,this).addEventListener(`pointerup`,m(Od,this)),m(K,this).addEventListener(`combobox-commit`,m(kd,this)),this.append(m(K,this))}function Nd(){return this.getRootNode().getElementById(this.for)}function Pd(){let e=u(J,this,Nd).call(this);if(u(J,this,Id).call(this),!tf(e)){u(J,this,Fd).call(this);return}h(cd,this,e),u(J,this,Ld).call(this,e),h(ld,this,new Uu(e,m(K,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(J,this,Rd).call(this,e),e.addEventListener(`input`,m(bd,this)),e.addEventListener(`keydown`,m(Ed,this)),e.addEventListener(`blur`,m(Cd,this)),e.addEventListener(`compositionstart`,m(xd,this)),e.addEventListener(`compositionend`,m(Sd,this)),e.ownerDocument.addEventListener(`selectionchange`,m(wd,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(vd,this)},u(J,this,Fd).call(this)}function Fd(){m(yd,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function Id(){m(yd,this).disconnect(),u(J,this,Yd).call(this);let e=m(cd,this);e&&(e.removeEventListener(`input`,m(bd,this)),e.removeEventListener(`keydown`,m(Ed,this)),e.removeEventListener(`blur`,m(Cd,this)),e.removeEventListener(`compositionstart`,m(xd,this)),e.removeEventListener(`compositionend`,m(Sd,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(wd,this)),m(_d,this)?.getStyleClone().disconnect(),h(_d,this,null),m(ld,this)?.destroy(),h(ld,this,null),u(J,this,zd).call(this,e),h(cd,this,null))}function Ld(e){m(ud,this).clear();for(let t of ad)m(ud,this).set(t,e.getAttribute(t))}function Rd(e){let t=[m(ud,this).get(`aria-controls`),m(K,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(J,this,Bd).call(this,e,`aria-haspopup`),u(J,this,Bd).call(this,e,`aria-expanded`)}function zd(e){for(let t of ad)u(J,this,Bd).call(this,e,t);m(ud,this).clear()}function Bd(e,t){let n=m(ud,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function Vd(e){u(J,this,Qd).call(this);let t=u(J,this,Ud).call(this);if(!t){h(q,this,null),u(J,this,Xd).call(this);return}h(q,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(J,this,Wd).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(J,this,Wd).call(this,[]),u(J,this,$d).call(this,O(`Loading`));let r=m(fd,this);h(md,this,setTimeout(()=>{u(J,this,Hd).call(this,t,n,r,e)},150))}async function Hd(e,t,n,r){h(pd,this,new AbortController);let i;try{let n=await ve.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(pd,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(fd,this)||rf(t))return;u(J,this,Yd).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(fd,this)&&(this.loading=!1,u(J,this,Wd).call(this,t===void 0?i:i.slice(0,t),r))}function Ud(){let e=m(cd,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!nf(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&rd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function Wd(e,t){if(u(J,this,qd).call(this),h(dd,this,e),m(K,this).replaceChildren(),m(K,this).hidden=this.loading,m(K,this).setAttribute(`aria-label`,m(q,this)?.trigger.label??id),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=ef(e);n.id=`${m(K,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(q,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(K,this).append(n)}),!this.loading&&!e.length){h(q,this,null),u(J,this,Xd).call(this),u(J,this,$d).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(q,this)&&u(J,this,Kd).call(this,t)})}function Gd(e){let t=m(cd,this),n=m(dd,this)[e],r=u(J,this,Ud).call(this),i=m(q,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(J,this,Yd).call(this);return}af(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(J,this,Yd).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function Kd(e){await this.popoverElement.updateComplete;let t=m(cd,this);if(!t||!u(J,this,Jd).call(this)){u(J,this,Yd).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(q,this)||t!==m(cd,this))&&m(dd,this).length&&(m(ld,this)?.start(),u(J,this,Bd).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(bd,this)),t.addEventListener(`input`,m(bd,this)),e)){let t=m(dd,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(ld,this)?.navigate(1)}}function qd(){m(ld,this)?.stop(),m(cd,this)&&u(J,this,Bd).call(this,m(cd,this),`aria-expanded`)}function Jd(){let e=m(cd,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(_d,this)){h(_d,this,new td(e));let t=m(_d,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(Td,this))}return m(_d,this).setStartOffset(t),m(_d,this).setEndOffset(t),h(vd,this,m(_d,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function Yd(){u(J,this,Qd).call(this),h(q,this,null),u(J,this,Xd).call(this)}function Xd(){u(J,this,Zd).call(this),this.popoverElement.hide()}function Zd(){this.loading=!1,u(J,this,qd).call(this),h(dd,this,[]),m(K,this)?.replaceChildren(),m(K,this)&&(m(K,this).hidden=!1);let e=m(cd,this);e&&(u(J,this,Bd).call(this,e,`aria-activedescendant`),u(J,this,Bd).call(this,e,`aria-busy`))}function Qd(){var e;h(fd,this,(e=m(fd,this),e++,e)),m(md,this)&&(clearTimeout(m(md,this)),h(md,this,null)),m(pd,this)?.abort(),h(pd,this,null)}function $d(e){m(hd,this)!==null&&(clearTimeout(m(hd,this)),h(hd,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(hd,this,setTimeout(()=>{h(hd,this,null),this.announcement=``},5e3))}jd.styles=[Mt,nd],p([g({reflect:!0})],jd.prototype,`for`,void 0),p([g({type:Array})],jd.prototype,`triggers`,void 0),p([_()],jd.prototype,`loading`,void 0),p([_()],jd.prototype,`announcement`,void 0),p([y(`craft-popover`)],jd.prototype,`popoverElement`,void 0);function ef(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function tf(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function nf(e){return e.getRootNode().activeElement===e}function rf(e){return e instanceof DOMException&&e.name===`AbortError`}function af(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,jd);var of=a`
  :host {
    display: inline-flex;
...
`,sf=new WeakMap,cf=new WeakSet,lf=class extends l{constructor(...e){super(...e),d(this,cf),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,f(this,sf,typeof ResizeObserver<`u`?new ResizeObserver(()=>u(cf,this,uf).call(this)):null)}connectedCallback(){super.connectedCallback(),m(sf,this)?.observe(this)}disconnectedCallback(){m(sf,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){u(cf,this,uf).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${u(cf,this,df)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function uf(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function df(){u(cf,this,uf).call(this)}lf.styles=of,p([g({reflect:!0})],lf.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],lf.prototype,`disabled`,void 0),p([_()],lf.prototype,`overflowing`,void 0),p([_()],lf.prototype,`text`,void 0),p([y(`.truncate`)],lf.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,lf);var ff=a`
  :host {
...
`,pf={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},mf=class extends l{constructor(...e){super(...e),this.src=null,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}render(){return r`
    ...
    `}};mf.styles=[ff],p([g()],mf.prototype,`src`,void 0),p([g()],mf.prototype,`srcset`,void 0),p([g()],mf.prototype,`sizes`,void 0),p([g()],mf.prototype,`alt`,void 0),p([g({type:Number})],mf.prototype,`width`,void 0),p([g({type:Number})],mf.prototype,`height`,void 0),p([g()],mf.prototype,`loading`,void 0),p([g({reflect:!0,converter:pf})],mf.prototype,`checkered`,void 0),p([g({type:Boolean,reflect:!0})],mf.prototype,`rounded`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,mf);var hf=new WeakMap,gf=new WeakSet,_f=class extends HTMLElement{constructor(...e){super(...e),d(this,gf),f(this,hf,null)}connectedCallback(){u(gf,this,vf).call(this)}disconnectedCallback(){m(hf,this)?.destroy(),h(hf,this,null)}};function vf(){if(!(m(hf,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>u(gf,this,vf).call(this));return}h(hf,this,new pa),m(hf,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,_f);var yf=!1,bf=null;async function xf(e){if(!yf){if(bf)return bf;yf=!0;try{return(await ve.post(`app/api-headers`,void 0,{cancelToken:e})).data}catch{}finally{yf=!1}}}var Sf=x.create({baseURL:`https://api.craftcms.com/v1/`});async function Cf(e){return bf?Object.entries(bf).forEach(([t,n])=>{e.headers.set(t,n)}):(e.params=e.params||{},e.params.processCraftHeaders=1),e}async function wf(e,t){if(bf)return;let{data:n}=await ve.post(`app/process-api-response-headers`,{headers:e},{cancelToken:t});return bf=n,yf=!1,bf}async function Tf(e){return await wf(e.headers,e.config.cancelToken),e}Sf.interceptors.request.use(async e=>{let{cancelToken:t}=e,n=await xf(t);n&&Object.entries(n).forEach(([t,n])=>{e.headers.set(t,n)});let r={...e,params:{...Cp.apiParams||{},...e.params,v:new Date().getTime()}};return n||(r.params.processCraftHeaders=1),Cp.httpProxy&&(r.proxy=Cp.httpProxy),r}),Sf.interceptors.request.use(Cf),Sf.interceptors.response.use(Tf);function Ef(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function Df(e={}){let t=Ef({...e,type:`submit`,label:e.label||O(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function Of(e={}){let t=Ef({...e,icon:`duplicate`,label:e.label||ua(O(`Paste {type}`,{type:O(`elements`)}))});return t.classList.add(`paste-btn`),t}var kf=async(e,t)=>{let{data:n}=await ve.post(e,t);return n},Af=new WeakMap,jf=new WeakMap,Mf=new WeakMap,Nf=new WeakMap,Pf=new WeakMap,Ff=new WeakMap,If=new WeakMap,Lf=new WeakMap,Rf=new WeakMap,zf=new WeakMap,Y=new WeakSet,Bf=class e{constructor(t){d(this,Y),f(this,Af,null),f(this,jf,[]),f(this,Mf,[]),f(this,Nf,null),f(this,Pf,!1),f(this,Ff,!1),f(this,If,!1),f(this,Lf,null),f(this,Rf,void 0),f(this,zf,new Map),this.options={...e.defaults,modalTitle:O(`Select element`),selectBtnLabel:O(`Select`),...Gf(t)},h(Mf,this,[...this.options.disabledElementIds??[]]),h(Rf,this,u(Y,this,Vf).call(this))}get elementType(){return this.options.elementType}get state(){return m(Rf,this)}get index(){return m(Af,this)}get hasSelection(){return m(jf,this).length>0}on(e,t){let n=m(zf,this).get(e);return n||(n=new Set,m(zf,this).set(e,n)),n.add(t),()=>{m(zf,this).get(e)?.delete(t)}}async open(){h(jf,this,[]),m(Af,this)?.clearSelection(),m(Pf,this)||(h(Pf,this,!0),u(Y,this,Wf).call(this,`open`,void 0)),u(Y,this,Hf).call(this),m(Nf,this)||await this.reload()}close(){m(Pf,this)&&(h(Pf,this,!1),u(Y,this,Wf).call(this,`close`,void 0),this.options.onClose?.(),u(Y,this,Hf).call(this))}destroy(){m(Af,this)?.destroy?.(),h(Af,this,null),h(jf,this,[]),h(Nf,this,null),h(Pf,this,!1),h(If,this,!1),h(Ff,this,!1),h(Lf,this,null),u(Y,this,Hf).call(this),m(zf,this).clear()}async reload(){let e=this.options.loadIndexBody??kf;h(Ff,this,!0),h(Lf,this,null),u(Y,this,Hf).call(this);try{h(Nf,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){u(Y,this,Uf).call(this,e)}finally{h(Ff,this,!1),u(Y,this,Hf).call(this)}}async submit(){if(!m(Rf,this).canSubmit)return;let e=this.buildElementInfo(m(jf,this)),t=this.selectMeta();h(If,this,!0),u(Y,this,Hf).call(this);try{u(Y,this,Wf).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){u(Y,this,Uf).call(this,e);return}finally{h(If,this,!1),u(Y,this,Hf).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...m(Mf,this),...e.map(e=>Number(e.id))]),m(Af,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){m(Rf,this).canCancel&&(u(Y,this,Wf).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){h(Af,this,e),u(Y,this,Hf).call(this)}detachIndex(){h(Af,this,null),u(Y,this,Hf).call(this)}setSelection(e){h(jf,this,[...e]),u(Y,this,Hf).call(this)}setDisabledElementIds(e){h(Mf,this,[...new Set(e.map(Number))]),u(Y,this,Hf).call(this)}setBusy(e){h(If,this,e),u(Y,this,Hf).call(this)}indexParams(){let{options:e}=this,t={context:`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),t}indexSettings(){let{options:e}=this;return{context:`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...m(Mf,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return m(jf,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){u(Y,this,Hf).call(this)}get selection(){return m(jf,this)}get disabledElementIds(){return m(Mf,this)}};function Vf(){let e=m(If,this),t=m(Ff,this);return Object.freeze({open:m(Pf,this),loading:t,busy:e,selection:Object.freeze([...m(jf,this)]),disabledElementIds:Object.freeze([...m(Mf,this)]),indexBody:m(Nf,this),error:m(Lf,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function Hf(){h(Rf,this,u(Y,this,Vf).call(this)),u(Y,this,Wf).call(this,`change`,m(Rf,this))}function Uf(e){h(Lf,this,e instanceof Error?e:Error(String(e??`Unknown`))),u(Y,this,Wf).call(this,`error`,m(Lf,this))}function Wf(e,t){let n=m(zf,this).get(e);n&&[...n].forEach(e=>e(t))}Bf.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function Gf(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var Kf=async(e,t)=>{let{data:n}=await ve.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},qf=new WeakMap,Jf=class e extends Bf{constructor(e){super(e),f(this,qf,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??Kf;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}h(qf,this,t);try{await this.submit()}finally{h(qf,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!m(qf,this))return n;let r=e.transformUrls[m(qf,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:m(qf,this)}}};Jf.transformUrls={};var Yf=`CraftCms\\Cms\\Asset\\Elements\\Asset`,Xf=new WeakSet,Zf=class extends Bf{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:Yf,showSiteMenu:!1}),d(this,Xf),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:u(Xf,this,Qf).call(this),status:null,url:null,hasThumb:!1}]}};function Qf(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var $f=new Map;function ep(e,t){if($f.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);$f.set(e,t)}function tp(e){return $f.has(e)}function np(e){return $f.get(e)??Bf}function rp(e){return new(np(e.elementType))(e)}function ip(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))$f.has(t)||$f.set(t,n)}var ap={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},op=new WeakMap,X=new WeakMap,sp=new WeakMap,cp=new WeakMap,lp=new WeakMap,up=new WeakMap,dp=new WeakMap,Z=new WeakSet,fp=class{constructor(e={}){d(this,Z),f(this,op,new Map),f(this,X,null),f(this,sp,0),f(this,cp,[]),f(this,lp,[]),f(this,up,new Set),f(this,dp,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)m(op,this).set(e.id,e);r&&(u(Z,this,gp).call(this),m(X,this)!==null&&u(Z,this,_p).call(this))}getSessions(){return Array.from(m(op,this).values())}getCurrentSessionId(){return m(X,this)}isProcessing(){return m(sp,this)>0}on(e,t){return m(dp,this).has(e)||m(dp,this).set(e,new Set),m(dp,this).get(e).add(t),()=>{m(dp,this).get(e)?.delete(t)}}async startIndexing(e){let t=await ve.post(ap.START,e),{data:n}=t;return n.session&&(m(op,this).set(n.session.id,n.session),h(X,this,n.session.id),u(Z,this,mp).call(this),n.stop||u(Z,this,_p).call(this)),n.stop&&u(Z,this,hp).call(this,n.stop),t}stopSession(e){u(Z,this,vp).call(this,e),u(Z,this,yp).call(this,{sessionId:e,action:ap.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){u(Z,this,yp).call(this,{sessionId:e,action:ap.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){u(Z,this,yp).call(this,{sessionId:e.sessionId,action:ap.FINISH,params:e,priority:!0})}destroy(){m(op,this).clear(),h(cp,this,[]),h(lp,this,[]),m(dp,this).clear(),h(X,this,null),h(sp,this,0)}};function pp(e,t){m(dp,this).get(e)?.forEach(e=>e(t))}function mp(e){u(Z,this,pp).call(this,`change`,{sessions:this.getSessions(),currentSessionId:m(X,this),reviewSessionId:e})}function hp(e){m(op,this).delete(e),m(X,this)===e&&h(X,this,null),u(Z,this,mp).call(this)}function gp(){for(let[e,t]of m(op,this))if(!t.actionRequired&&!m(up,this).has(e)){h(X,this,e);return}h(X,this,null)}function _p(){if(m(X,this)||u(Z,this,gp).call(this),!m(X,this))return;let e=m(op,this).get(m(X,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-m(sp,this),r=Math.min(n,t);for(let t=0;t<r;t++)u(Z,this,yp).call(this,{sessionId:e.id,action:ap.PROCESS,params:{sessionId:m(X,this)},priority:!1});e.processIfRootEmpty&&u(Z,this,yp).call(this,{sessionId:e.id,action:ap.PROCESS,params:{sessionId:m(X,this)},priority:!1})}function vp(e){m(up,this).add(e),h(cp,this,m(cp,this).filter(t=>t.sessionId!==e))}function yp(e){e.priority?m(lp,this).push(e):m(cp,this).push(e),u(Z,this,bp).call(this)}function bp(){if(!(m(cp,this).length+m(lp,this).length===0||m(sp,this)>=this.maxConcurrentConnections))for(;m(cp,this).length+m(lp,this).length>0&&m(sp,this)<this.maxConcurrentConnections;){var e;h(sp,this,(e=m(sp,this),e++,e));let t=m(lp,this).length>0?m(lp,this).shift():m(cp,this).shift();u(Z,this,xp).call(this,t)}}async function xp(e){try{let t=await ve.post(e.action,e.params);u(Z,this,Sp).call(this,t.data)}catch(t){u(Z,this,wp).call(this,t,e)}finally{var t;h(sp,this,(t=m(sp,this),t--,t)),u(Z,this,bp).call(this)}}function Sp(e){let t;e.session&&(m(op,this).set(e.session.id,e.session),u(Z,this,gp).call(this),e.session.actionRequired&&!e.skipDialog?m(up,this).has(e.session.id)||(t=e.session.id):m(up,this).has(e.session.id)||u(Z,this,_p).call(this)),u(Z,this,gp).call(this),e.stop&&(m(op,this).delete(e.stop),m(X,this)===e.stop&&h(X,this,null)),u(Z,this,mp).call(this,t),m(op,this).size===0&&u(Z,this,pp).call(this,`complete`,{})}function wp(e,t){u(Z,this,gp).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;u(Z,this,pp).call(this,`error`,{message:n,sessionId:t.sessionId}),u(Z,this,bp).call(this)}var Tp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},Ep=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Dp,Op=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},kp=typeof Intl<`u`&&Intl.ListFormat||Op,Ap=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],jp={minimumIntegerDigits:2},Mp=class{constructor(e,t={}){Dp.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Tp(this,Dp,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return Ep(this,Dp,`f`)}formatToParts(e){let t=[],n=Ep(this,Dp,`f`),r=n.style,i=n.locale;for(let[a,o]of Ap){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?jp:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new kp(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Dp=new WeakMap;var Np=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,Pp=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],Fp=e=>Np.test(e),Ip=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(Np)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(Lp(r,e.from(t)).getTime()-r),a=Math.abs(Lp(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Mp(e,t).format(this)}};function Lp(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function Rp(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new Ip;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=Pp.indexOf(t)||Pp.length;return new Ip(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function zp(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new Ip(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function Bp(e,t){let n=zp(e,t);if(n.blank)return[0,`second`];for(let e of Pp){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Vp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,Hp,Up,Wp,Gp,Kp,qp,Jp,Yp,Xp,Zp,Qp,$p,em,tm,nm,rm=globalThis.HTMLElement||null,im=new Ip,am=new Ip(0,0,0,0,0,1),om=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function sm(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var cm=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=sm(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,sm(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},lm=class extends rm{constructor(){super(...arguments),$.add(this),Hp.set(this,!1),Up.set(this,!1),Gp.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),nm.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,nm,`f`)}set onRelativeTimeUpdated(e){Q(this,nm,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,nm,`f`)),Vp(this,nm,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&Fp(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return Pp.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){cm.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&Vp(this,Hp,n!==null&&(this.date&&Q(this,$,`m`,Kp).call(this,this.date))!==n,`f`),!Q(this,Up,`f`)&&!(e===`title`&&Q(this,Hp,`f`))&&Vp(this,Up,(async()=>{await Promise.resolve(),this.update(),Vp(this,Up,!1,`f`)})(),`f`))}update(){let e=Q(this,Gp,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,Gp,`f`).textContent=e;return}let i=Date.now();Q(this,Hp,`f`)||(n=Q(this,$,`m`,Kp).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=Rp(r,this.precision,i),o=Q(this,$,`m`,qp).call(this,a),s=e,c=Q(this,$,`m`,tm).call(this,o);s=c?Q(this,$,`m`,$p).call(this,r):o===`duration`?Q(this,$,`m`,Jp).call(this,a):o===`relative`?Q(this,$,`m`,Yp).call(this,a):Q(this,$,`m`,Xp).call(this,r),s?Q(this,$,`m`,em).call(this,s):this.shadowRoot===Q(this,Gp,`f`)&&this.textContent&&Q(this,$,`m`,em).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new om(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,Zp).call(this,r)||Q(this,$,`m`,Qp).call(this,r))?cm.observe(this):cm.unobserve(this)}};Hp=new WeakMap,Up=new WeakMap,Gp=new WeakMap,nm=new WeakMap,$=new WeakSet,Wp=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},Kp=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,Wp),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},qp=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||Ip.compare(e,this.threshold)===1)return`relative`}return`datetime`},Jp=function(e){let t=Q(this,$,`a`,Wp),n=this.format,r=this.formatStyle,i=this.tense,a=im;n===`micro`?(e=zp(e),a=am,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=am)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},Yp=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,Wp),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=im),n===`past`&&e.sign!==-1&&(e=im);let[r,i]=Bp(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},Xp=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,Wp),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},Zp=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Wp),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},Qp=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Wp),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},$p=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,Zp).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,Wp),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,Wp))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,Wp),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,Qp).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,Wp),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,Wp),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},em=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,Gp,`f`).replaceChildren(t)}else Q(this,Gp,`f`).textContent=e},tm=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var um=typeof globalThis<`u`?globalThis:window;try{um.RelativeTimeElement=lm.define()}catch(e){if(!(um.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{Ki as A,la as C,$i as D,oa as E,vt as F,yt as I,ut as L,or as M,Mt as N,ra as O,xt as P,ve as R,ua as S,ca as T,Hs as _,tp as a,Ka as b,Bf as c,Df as d,Sf as f,Js as g,Gc as h,ip as i,xi as j,ea as k,Of as l,Nl as m,rp as n,Zf as o,Vu as p,ep as r,Jf as s,fp as t,Ef as u,B as v,sa as w,pa as x,as as y,ge as z};
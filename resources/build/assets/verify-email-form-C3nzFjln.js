import{c as e,r as t,t as n}from"./lit-DNaDb1T7.js";import{_ as r}from"./nav-item-gOH_bIIx-CFFCEHYs.js";import"./cp-CzgRJh7V.js";import{n as i,t as a}from"./decorators-D0-gbKXH.js";import{t as o}from"./login-form.styles-CWUEj_6V.js";import{t as s}from"./decorate-B3KLIx2E.js";var c=class extends n{constructor(...e){super(...e),this.action=``,this.uid=``,this.code=``,this.initialError=``,this._busy=!1}static{this.styles=[o]}#e(){this._busy=!0}render(){return e`
      <craft-pane>
        <form
          class="auth-form"
          method="post"
        ...
        >
          ...
          <h2 class="auth-form__heading">${r(`Verify your email address`)}</h2>

...
`,it=class extends l{constructor(...e){super(...e),this.fill=et.Gray}getFill(){return this.fill}willUpdate(e){e.has(`fill`)&&(this.dataset.color=this.getFill())}render(){return r`
      <span
        part="badge"
        class="${k({badge:!0})}"
      >
    ...
    `}};it.styles=[rt],p([g({reflect:!0})],it.prototype,`fill`,void 0),customElements.get(`craft-badge`)||customElements.define(`craft-badge`,it);var at=class extends l{constructor(...e){super(...e),this.rel=`noreferrer noopener`}render(){return r`
...
`,Nt=class extends We(ce(l)){static get properties(){return{invokerRelation:{type:String,attribute:`invoker-relation`}}}static get styles(){return[...super.styles,a`
        :host {
      ...
      `]}constructor(){super(),this.hasArrow=!1,this.invokerRelation=`description`}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];_defineOverlayConfig(){let e=super._defineOverlayConfig(),t=Ke({invokerRelation:this.invokerRelation});return{...e,...t,popperConfig:{...e.popperConfig||{},...t.popperConfig||{},modifiers:[...e.popperConfig?.modifiers||[],...t.popperConfig?.modifiers||[]]}}}},Pt=new WeakMap,Ft=new WeakMap,It=new WeakSet,Lt=class extends Nt{constructor(){super(),d(this,It),this.placement=`top`,this.trigger=`hover focus`,f(this,Pt,null),f(this,Ft,()=>{this.opened=!this.opened}),re(this)}static get styles(){return[...super.styles,a`
        :host {
          display: contents;
        }
...
`,pr=class extends dr(l,{customProperty:[`--_callout-padding-block`,`--_callout-padding-inline`]}){constructor(...e){super(...e),this.variant=Ce.Neutral,this.appearance=te.OutlineFill,this.title=``,this.icon=null,this.hideIcon=!1,this.rounded=`all`,this.inline=!1,this.size=`auto`,this.resolvedIcon=null}willUpdate(){this.resolvedIcon=this.icon??this.getDefaultIcon()}getDefaultIcon(){switch(this.variant){case Ce.Info:return`lightbulb`;case Ce.Success:return`circle-check`;case Ce.Warning:return`circle-exclamation`;case Ce.Danger:return`triangle-exclamation`;default:return null}}render(){let e=this.title||!!this.querySelector(`[slot="title"]`),t=!this.hideIcon&&(!!this.resolvedIcon||!!this.querySelector(`[slot="icon"]`));return r`
    ...
    `}};pr.styles=[fe,fr],p([g({reflect:!0})],pr.prototype,`variant`,void 0),p([g({reflect:!0})],pr.prototype,`appearance`,void 0),p([g()],pr.prototype,`title`,void 0),p([g()],pr.prototype,`icon`,void 0),p([g({type:Boolean,attribute:`hide-icon`})],pr.prototype,`hideIcon`,void 0),p([g({reflect:!0})],pr.prototype,`rounded`,void 0),p([g({reflect:!0,type:Boolean})],pr.prototype,`inline`,void 0),p([g()],pr.prototype,`size`,void 0),p([_()],pr.prototype,`resolvedIcon`,void 0),customElements.get(`craft-callout`)||customElements.define(`craft-callout`,pr);var mr=a`
  :host {
    display: block;
  }
...
`,Sa=new WeakMap,Ca=new WeakMap,wa=class extends l{constructor(...e){super(...e),this.size=``,this.variant=Ce.Neutral,this.appearance=te.OutlineFill,this.icon=null,this.showIndicators=!1,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,f(this,Sa,new ga),this.lightDom=0,f(this,Ca,new MutationObserver(()=>this.lightDom++))}connectedCallback(){super.connectedCallback(),m(Ca,this).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){m(Ca,this).disconnect(),super.disconnectedCallback()}renderPrefix(){return r`<div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
    ...
    </div>`}firstUpdated(e){super.firstUpdated(e),m(Sa,this).load(this)}render(){this.lightDom;let e=!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`)||!!this.querySelector(`[slot="thumbnail"]`)||!!this.querySelector(`[slot="indicator"]`)||this.icon,t=!!this.querySelector(`[slot="suffix"]`);return r`
      <div
        part="chip"
      ...
      >
        ${this.selectable?r` <input type="checkbox" />`:c}
    ...
    `}};wa.styles=[xa],p([g()],wa.prototype,`size`,void 0),p([g({reflect:!0})],wa.prototype,`variant`,void 0),p([g({reflect:!0})],wa.prototype,`appearance`,void 0),p([g()],wa.prototype,`icon`,void 0),p([g({attribute:`show-indicators`,type:Boolean})],wa.prototype,`showIndicators`,void 0),p([g({attribute:`show-status`,type:Boolean})],wa.prototype,`showStatus`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],wa.prototype,`showThumb`,void 0),p([g({type:Boolean})],wa.prototype,`selectable`,void 0),p([_()],wa.prototype,`lightDom`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,wa);var Ta=class extends ji(l){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},Ea=D(e=>class extends hi(ui(Ni(He(Ai(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],a`
          :host {
            display: block;
          }
...
`,Aa=new WeakMap,ja=new WeakSet,Ma=class extends Oa{constructor(...e){super(...e),d(this,ja),this.hint=null,f(this,Aa,void 0)}static get styles(){return[...Oa.styles,ka]}connectedCallback(){super.connectedCallback(),Pa._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),Pa._.unobserve(this)}render(){return r`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?r`<span class="hint">${this.hint}</span>`:c}
        <slot name="suffix"></slot>
      </div>
    `}};function Na(){return m(Aa,this)??h(Aa,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),m(Aa,this)}var Pa={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=u(ja,e,Na).call(e))}})};p([g()],Ma.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,Ma);var Fa=new WeakMap;function Ia(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Fa.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else Ia(n,t)})}function La(e){Fa.has(e)&&Fa.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Fa.has(e)&&Fa.get(e)():La(e)})}var Ra=class extends Si{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof pi}};function za(e){return Array.isArray(e)?e:[e]}var Ba=D(e=>class extends Ni(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(za(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(za(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(za(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...za(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Va=new WeakMap,Ha=class extends ii(ce(Ba(Da))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,a`
        .input-group__input {
          display: flex;
          flex: 1;
        }
...
`,Wa=new WeakMap,Ga=new WeakMap,Ka=new WeakMap,B=new WeakSet,qa=new WeakMap,Ja=class extends Ha{static get styles(){return[...super.styles,Ua]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,B),this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,Wa,void 0),f(this,Ga,!1),f(this,Ka,()=>{h(Ga,this,!0),u(B,this,$a).call(this),u(B,this,Ya).call(this)}),f(this,qa,()=>{this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(B,this,$a).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m(Ka,this)),this.addEventListener(`model-value-changed`,()=>{h(Wa,this,this.modelValue)}),h(Wa,this,this.modelValue),u(B,this,$a).call(this)}updated(e){super.updated(e),e.has(`opened`)&&!this.opened&&h(Ga,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`))&&u(B,this,$a).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,u(B,this,ro).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t),e.updateComplete.then(()=>{String(e.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(e)))})}_notifyModelValueChanged(){this.modelValue!==m(Wa,this)&&(h(Wa,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],isTriggeredByUser:!0}})))}matchCondition(){return!0}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=u(B,this,ro).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ${e?r`<craft-icon class="prefix" name=${e}></craft-icon>`:c}
        <slot name="input"></slot>
        ${this.clearable&&u(B,this,to).call(this)?r`<craft-button
              class="clear"
              type="button"
              appearance="plain"
              size="small"
    ...
    `}parser(e){if(typeof e==`string`&&e!==``){let t=u(B,this,no).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function Ya(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function Xa(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(u(B,this,Za).call(this,e))for(let r of e.options)(t===``||u(B,this,Qa).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||u(B,this,Qa).call(this,t,e))&&n.push({option:e});return n}function Za(e){return e.type===`optgroup`}function Qa(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function $a(){let e=this._listboxNode;if(!e)return;let t=m(Ga,this)?this._inputNode?.value??``:``,n=u(B,this,Xa).call(this,t),i=n.slice(0,this.limit),a;s(r`${i.map(e=>{let t=e.groupLabel&&e.groupLabel!==a?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return a=e.groupLabel,r`${t}${u(B,this,eo).call(this,e.option)}`})}${n.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${O(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:n.length})}
          </div>`:c}`,e)}function eo(e){let t=e.data??{},n=e.label,i=n.startsWith(`$`)||n.startsWith(`@`);return r`
      <craft-option
    ...
    `}function to(){return this.modelValue!==``&&this.modelValue!=null}function no(e){let t=e.trim();for(let e of u(B,this,io).call(this))if(u(B,this,ao).call(this,e)===t)return e}function ro(){if(!u(B,this,to).call(this))return;let e=String(this.modelValue);for(let t of u(B,this,io).call(this))if(String(t.value)===e)return t}function*io(){for(let e of this.options)u(B,this,Za).call(this,e)?yield*e.options:yield e}function ao(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}p([g({type:Array})],Ja.prototype,`options`,void 0),p([g({type:Number})],Ja.prototype,`limit`,void 0),p([g({type:Boolean,reflect:!0})],Ja.prototype,`clearable`,void 0),p([g({type:String,reflect:!0})],Ja.prototype,`placeholder`,void 0),p([g({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],Ja.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,Ja);var oo=a`
  :host {
    display: inline-block;
  }
...
`,so={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},co=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(so[`icon.out`].keyframes,so[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(so[`icon.in`].keyframes,so[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(so[`icon.out`].keyframes,so[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(so[`icon.in`].keyframes,so[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||O(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};co.styles=[oo],p([_()],co.prototype,`isCopying`,void 0),p([_()],co.prototype,`status`,void 0),p([y(`slot[name="copy-icon"]`)],co.prototype,`copyIconEl`,void 0),p([y(`slot[name="success-icon"]`)],co.prototype,`successIconEl`,void 0),p([y(`slot[name="error-icon"]`)],co.prototype,`errorIconEl`,void 0),p([y(`craft-tooltip`)],co.prototype,`tooltipEl`,void 0),p([g({type:String})],co.prototype,`value`,void 0),p([g({type:Boolean})],co.prototype,`disabled`,void 0),p([g({attribute:`feedback-duration`,type:Number})],co.prototype,`feedbackDuration`,void 0),p([g({attribute:`tooltip-label`})],co.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,co);var lo=a`
  :host {
    box-sizing: border-box;
  }
...
`,fo=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return r`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};fo.styles=[lo,uo],p([y(`craft-copy-button`)],fo.prototype,`copyButtonEl`,void 0),p([g({type:String})],fo.prototype,`value`,void 0),p([g({type:Boolean,reflect:!0})],fo.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,fo);var po=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function mo(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function ho(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(po))).filter(mo)}function go(e){let t=t=>{if(t.key!==`Tab`)return;let n=ho(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var _o=a`
  :host {
    display: contents;
...
`,vo=0,yo=0;function bo(){yo++===0&&document.body.classList.add(`no-scroll`)}function xo(){yo>0&&--yo===0&&document.body.classList.remove(`no-scroll`)}var So=new WeakMap,Co=new WeakMap,wo=new WeakMap,To=new WeakMap,Eo=new WeakSet,Do=new WeakMap,Oo=new WeakMap,ko=new WeakMap,Ao=new WeakMap,jo=new WeakMap,Mo=new WeakMap,No=class extends l{constructor(...e){super(...e),d(this,Eo),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++vo}`,f(this,So,!1),f(this,Co,null),f(this,wo,!1),f(this,To,null),f(this,Do,e=>{e.preventDefault(),this.requestClose()}),f(this,Oo,()=>{this.opened=!1}),f(this,ko,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),f(this,Ao,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),f(this,jo,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),f(this,Mo,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,m(Ao,this)),this.addEventListener(`keydown`,m(ko,this)),h(To,this,new MutationObserver(()=>this.requestUpdate())),m(To,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(Ao,this)),this.removeEventListener(`keydown`,m(ko,this)),m(To,this)?.disconnect(),h(To,this,null),m(Co,this)?.call(this),h(Co,this,null),u(Eo,this,Io).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
    ...
    `}updated(e){super.updated(e),this.opened!==m(So,this)&&(h(So,this,this.opened),this.opened?u(Eo,this,Po).call(this):u(Eo,this,Fo).call(this),u(Eo,this,Lo).call(this,this.opened))}requestClose(){this.opened=!1}};function Po(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(m(Co,this)?.call(this),h(Co,this,go(this))),m(wo,this)||(h(wo,this,!0),bo())}function Fo(){let e=this.dialogElement;e?.open&&e.close(),m(Co,this)?.call(this),h(Co,this,null),u(Eo,this,Io).call(this)}function Io(){m(wo,this)&&(h(wo,this,!1),xo())}function Lo(e){u(Eo,this,Ro).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&u(Eo,this,Ro).call(this,e?`craft-after-show`:`craft-after-hide`)})}function Ro(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}No.styles=[lo,_o],p([g({type:Boolean,attribute:`open`,reflect:!0})],No.prototype,`opened`,void 0),p([g()],No.prototype,`label`,void 0),p([g({type:Boolean,attribute:`non-modal`,reflect:!0})],No.prototype,`nonModal`,void 0),p([g({type:Boolean,reflect:!0})],No.prototype,`fullscreen`,void 0),p([g({type:Boolean,attribute:`close-on-outside-click`})],No.prototype,`closeOnOutsideClick`,void 0),p([g({type:Boolean,attribute:`no-close`,reflect:!0})],No.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,No);var zo=new WeakMap,Bo=new WeakSet,Vo=class{constructor(e,t){this.host=e,this.source=t,d(this,Bo),f(this,zo,null),e.addController(this)}hostConnected(){u(Bo,this,Ho).call(this)}hostDisconnected(){u(Bo,this,Uo).call(this)}resubscribe(){u(Bo,this,Uo).call(this),u(Bo,this,Ho).call(this)}get state(){return this.source()?.state??null}};function Ho(){h(zo,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function Uo(){m(zo,this)?.call(this),h(zo,this,null)}var Wo=a`
  :host {
    /*
...
`,Go=new WeakMap,Ko=new WeakMap,qo=new WeakMap,Jo=new WeakMap,Yo=new WeakMap,Xo=class extends No{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,f(this,Go,new Vo(this,()=>this.controller)),f(this,Ko,null),f(this,qo,()=>{this.submit()}),f(this,Jo,()=>{this.busy||this.requestClose()}),f(this,Yo,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&h(Ko,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),m(Ko,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&m(Go,this).resubscribe();let t=m(Go,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&m(Ko,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
    ...
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};Xo.styles=[...No.styles,Wo],p([g({attribute:!1})],Xo.prototype,`controller`,void 0),p([g({type:Boolean,attribute:`show-title`,reflect:!0})],Xo.prototype,`showTitle`,void 0),p([g({attribute:`select-label`})],Xo.prototype,`selectLabel`,void 0),p([g({attribute:`cancel-label`})],Xo.prototype,`cancelLabel`,void 0),p([g({type:Boolean,reflect:!0})],Xo.prototype,`busy`,void 0),p([g({type:Boolean,reflect:!0})],Xo.prototype,`loading`,void 0),p([g({type:Boolean,attribute:`can-submit`,reflect:!0})],Xo.prototype,`canSubmit`,void 0),p([g({type:Boolean,reflect:!0})],Xo.prototype,`narrow`,void 0),p([_()],Xo.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,Xo);var Zo=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
    ...
    `],p([g()],$o.prototype,`label`,void 0),p([g()],$o.prototype,`icon`,void 0),customElements.get(`craft-empty`)||customElements.define(`craft-empty`,$o);var es=a`
  :host {
    position: relative;
    display: block;
  }
...
`,ts=class extends hi(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=O(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[Mt,yr,es]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth()}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
    ...
    `}__hasLightChild(e){return this.__lightChild(e)!==void 0}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`span`);t.className=`visually-hidden`,t.textContent=O(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};p([g({type:Boolean,reflect:!0})],ts.prototype,`required`,void 0),p([g({type:Boolean,reflect:!0})],ts.prototype,`translatable`,void 0),p([g({attribute:`translation-description`})],ts.prototype,`translationDescription`,void 0),p([g({type:Boolean,reflect:!0})],ts.prototype,`fieldset`,void 0),p([g({reflect:!0})],ts.prototype,`status`,void 0),p([g({attribute:`status-label`})],ts.prototype,`statusLabel`,void 0),p([g({reflect:!0})],ts.prototype,`orientation`,void 0),p([g({type:Boolean,reflect:!0,attribute:`has-errors`})],ts.prototype,`hasErrors`,void 0),p([g({attribute:`instructions-position`})],ts.prototype,`instructionsPosition`,void 0),p([g({type:String,reflect:!0})],ts.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,ts);var ns=class extends l{render(){return r`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,ns);var rs=a`
  ${yr}
...
`,is=/^[0-9a-f]{6}$/i,as=/^[0-9a-f]{3}$/i,os={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function ss(e){return String(e??``).trim().replace(/^#/,``)}function cs(e){let t=ss(e);return as.test(t)?t.split(``).map(e=>e+e).join(``):is.test(t)?t:null}var ls=class e extends zi{static get styles(){return[...super.styles,br,rs]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,ss(t)),e}}}parser(e){return ss(e)}formatter(e){return ss(e)}serializer(e){return ss(e)}deserializer(e){return ss(e)}preprocessor(e){let t=ss(e);if(t!==e)return t}get _expandedHexValue(){return cs(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>cs(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=ss(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
      <input
    ...
    `}};ls._browserSupportsColorInputs=null,p([g({converter:os})],ls.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,ls);var us=a`
  ::slotted(.form-control) {
    ${gr}
  }
...
`,fs=class extends V{static get styles(){return[...super.styles,ds]}_renderSuffix(){return r`<craft-copy-button
      tooltip-label="${O(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};p([g({type:String,attribute:`copy-value`})],fs.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,fs);var ps=class extends V{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,ps);var ms=new WeakSet,hs=class extends V{constructor(){super(),d(this,ms),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,u(ms,this,gs))}disconnectedCallback(){this.removeEventListener(`change`,u(ms,this,gs)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),u(ms,this,_s).call(this)}};function gs(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=u(ms,this,vs).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}u(ms,this,_s).call(this)}}function _s(){let e=this._inputNode;if(!e)return;let t=u(ms,this,ys).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=u(ms,this,ys).call(this,e),i=u(ms,this,ys).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function vs(e){let t=u(ms,this,ys).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function ys(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}p([g({type:Number,attribute:`minute-increment`})],hs.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],hs.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],hs.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,hs);var bs={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},xs=new WeakSet,Ss=new WeakMap,H=class extends l{constructor(...e){super(...e),d(this,xs),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,f(this,Ss,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof V))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,m(Ss,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,m(Ss,this)),super.disconnectedCallback()}updated(e){super.updated(e),u(xs,this,Cs).call(this),u(xs,this,ws).call(this),u(xs,this,Ts).call(this),u(xs,this,As).call(this,`locale`,this.locale,!0),u(xs,this,As).call(this,`timezone`,this.timezone,!this.showTimezone)}};function Cs(){let e=u(xs,this,Es).call(this,`craft-input-date`,`date`,this.showDate);e instanceof ps&&(u(xs,this,ks).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,u(xs,this,Ds).call(this,e))}function ws(){let e=u(xs,this,Es).call(this,`craft-input-time`,`time`,this.showTime);e instanceof hs&&(u(xs,this,ks).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,u(xs,this,Ds).call(this,e))}function Ts(){let e=u(xs,this,Es).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(u(xs,this,ks).call(this,e,`timezone`,this.timezone??``,!1),u(xs,this,Ds).call(this,e))}function Es(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof V);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Ds(e){e.parentElement!==this&&this.insertBefore(e,u(xs,this,Os).call(this))}function Os(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function ks(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function As(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}H.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,p([g()],H.prototype,`name`,void 0),p([g({attribute:`date-value`})],H.prototype,`dateValue`,void 0),p([g({attribute:`time-value`})],H.prototype,`timeValue`,void 0),p([g()],H.prototype,`locale`,void 0),p([g()],H.prototype,`timezone`,void 0),p([g({attribute:`show-date`,converter:bs})],H.prototype,`showDate`,void 0),p([g({attribute:`show-time`,converter:bs})],H.prototype,`showTime`,void 0),p([g({type:Boolean,attribute:`show-timezone`})],H.prototype,`showTimezone`,void 0),p([g()],H.prototype,`min`,void 0),p([g()],H.prototype,`max`,void 0),p([g({attribute:`min-time`})],H.prototype,`minTime`,void 0),p([g({attribute:`max-time`})],H.prototype,`maxTime`,void 0),p([g({type:Number,attribute:`minute-increment`})],H.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],H.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],H.prototype,`forceRoundTime`,void 0),p([g({type:Boolean})],H.prototype,`disabled`,void 0),p([g({type:Boolean})],H.prototype,`readonly`,void 0),p([g({type:Boolean})],H.prototype,`required`,void 0),p([g({attribute:`described-by`})],H.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,H);var js=class extends Si{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Ms=class extends Si{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Gr().msg(`lion-input-file:uploadTextDuplicateFileName`)}},Ns=524288e3,Ps={type:`FILE_TYPE`,size:`FILE_SIZE`},Fs={fail:`FAIL`,pass:`SUCCESS`},Is=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);js.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Fs.fail,this.failedProp.push(Ps.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;js.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Fs.fail,this.failedProp.push(Ps.type))}js.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Fs.fail&&(this.status=Fs.pass):(this.status=Fs.fail,this.failedProp.push(Ps.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Ls=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},Rs=T(class extends de{constructor(e){if(super(e),e.type!==S.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){let i=Re(e),{values:a,keys:s}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=s,a;let c=this.ut??=[],l=[],u,d,f=0,p=i.length-1,m=0,h=a.length-1;for(;f<=p&&m<=h;)if(i[f]===null)f++;else if(i[p]===null)p--;else if(c[f]===s[m])l[m]=Fe(i[f],a[m]),f++,m++;else if(c[p]===s[h])l[h]=Fe(i[p],a[h]),p--,h--;else if(c[f]===s[h])l[h]=Fe(i[f],a[h]),Pe(e,l[h+1],i[f]),f++,h--;else if(c[p]===s[m])l[m]=Fe(i[p],a[m]),Pe(e,i[f],i[p]),p--,m++;else if(u===void 0&&(u=Ls(s,m,h),d=Ls(c,f,p)),u.has(c[f]))if(u.has(c[p])){let t=d.get(s[m]),n=t===void 0?null:i[t];if(n===null){let t=Pe(e,i[f]);Fe(t,a[m]),l[m]=t}else l[m]=Fe(n,a[m]),Pe(e,i[f],n),i[t]=null;m++}else ze(i[p]),p--;else ze(i[f]),f++;for(;m<=h;){let t=Pe(e,l[h+1]);Fe(t,a[m]),l[m++]=t}for(;f<=p;){let e=i[f++];e!==null&&ze(e)}return this.ut=s,Le(e,l),o}}),zs=e=>{switch(e){case`bg-BG`:return E(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return E(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return E(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return E(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return E(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return E(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return E(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return E(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return E(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return E(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return E(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return E(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return E(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return E(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return E(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return E(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return E(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return E(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return E(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return E(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return E(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return E(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return E(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return E(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return E(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return E(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return E(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return E(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return E(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return E(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return E(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return E(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return E(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return E(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Bs=class extends ii(ui(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":xi}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":zs},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},Us=class extends Bs{static get styles(){return[...super.styles,a`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
...
`,Gs=class extends Hs{static get styles(){return[...super.styles,br,Ws]}get slots(){return{...super.slots,"file-select-button":()=>r`<craft-button
      ...
      `]}constructor(){super(),d(this,Xs),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,f(this,Zs,()=>{this.modelValue=``,this.value=``,u(Xs,this,$s).call(this)?.inputmask?.setValue(``),u(Xs,this,$s).call(this)?.focus()}),this.type=`text`,this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&u(Xs,this,tc).call(this),u(Xs,this,$s).call(this)?.classList.toggle(`money-placeholder`,!u(Xs,this,nc).call(this))}disconnectedCallback(){u(Xs,this,$s).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?r`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${u(Xs,this,ec).call(this).currency}`}</span
      >
      ...
      <craft-button
        ...
        icon
        aria-label=${O(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!u(Xs,this,nc).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${m(Zs,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function $s(){return this._inputNode}function ec(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function tc(){let e=u(Xs,this,$s).call(this);if(!e)return;let t=String(this.modelValue??``),n=u(Xs,this,ec).call(this);e.inputmask?.remove(),e.value=t,new Js({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function nc(){return this.modelValue!==``&&this.modelValue!=null}p([g()],Qs.prototype,`currency`,void 0),p([g()],Qs.prototype,`locale`,void 0),p([g({type:Number})],Qs.prototype,`decimals`,void 0),p([g({attribute:`decimal-separator`})],Qs.prototype,`decimalSeparator`,void 0),p([g({attribute:`group-separator`})],Qs.prototype,`groupSeparator`,void 0),p([g({converter:Ys,attribute:`show-currency`})],Qs.prototype,`showCurrency`,void 0),p([g({converter:Ys})],Qs.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,Qs);var rc=new WeakSet,ic=class extends zi{static get styles(){return[...super.styles,br,a`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),d(this,rc),this.passwordRules=``,this._visible=!1,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>r`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),u(rc,this,ac).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&u(rc,this,ac).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function ac(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}p([g({attribute:`passwordrules`})],ic.prototype,`passwordRules`,void 0),p([_()],ic.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,ic);var oc=class extends l{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return r`
  ...
  `,p([g()],oc.prototype,`error`,void 0),p([g({attribute:`plugin-name`})],oc.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,oc);var sc=a`
  :host {
    display: block;
    /*
...
`,cc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(cc);var lc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(lc);var uc=new Set([`clip`,`hidden`]),dc=class extends dr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=cc.Raised,this.variant=lc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!uc.has(n)&&e.scrollHeight-e.clientHeight>1||!uc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};dc.styles=[lo,sc],p([g({reflect:!0})],dc.prototype,`appearance`,void 0),p([g({reflect:!0})],dc.prototype,`variant`,void 0),p([g()],dc.prototype,`label`,void 0),p([_()],dc.prototype,`_hasSlottedHeader`,void 0),p([_()],dc.prototype,`_hasSlottedFooter`,void 0),p([_()],dc.prototype,`_scrollable`,void 0),p([_()],dc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,dc);var fc=0,pc=new WeakMap,U=new WeakSet,mc=class extends l{constructor(...e){super(...e),d(this,U),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,pc,++fc)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(U,this,Tc).call(this)}render(){let e=u(U,this,_c).call(this);return Rs(this.groups,e=>e.handle,(t,n)=>u(U,this,hc).call(this,t,n,e))}};function hc(e,t,n){let i=`permission-tree-heading-${m(pc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>u(U,this,xc).call(this,e.keys,n)}
                >
                  ${u(U,this,bc).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${u(U,this,gc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function gc(e,t,n,i){return Rs(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(U,this,yc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||u(U,this,vc).call(this,o,i)}
                @model-value-changed=${e=>u(U,this,Sc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?u(U,this,gc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function _c(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function vc(e,t){return t.has(e.toLowerCase())}function yc(e,t){return this.modelValue.includes(e)||u(U,this,vc).call(this,e,t)}function bc(e,t){let n=e.filter(e=>!u(U,this,vc).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function xc(e,t){let n=e.filter(e=>!u(U,this,vc).call(this,e,t));if(u(U,this,bc).call(this,e,t)){let e=new Set(n);u(U,this,wc).call(this,this.modelValue.filter(t=>!e.has(t)));return}u(U,this,wc).call(this,[...new Set([...this.modelValue,...n])])}function Sc(e,t,n,r){if(e.stopPropagation(),this.disabled||u(U,this,vc).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){u(U,this,wc).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...u(U,this,Cc).call(this,n)]);u(U,this,wc).call(this,this.modelValue.filter(e=>!o.has(e)))}function Cc(e){return Object.values(e).flatMap(e=>[e.key,...u(U,this,Cc).call(this,e.nested??{})])}function wc(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function Tc(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;u(U,this,Ec).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&u(U,this,Ec).call(this,`${this.name}[]`,t)}function Ec(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}mc.styles=a`
    :host {
      display: block;
    }
  ...
  `,p([g({type:Array})],mc.prototype,`groups`,void 0),p([g({type:Array,attribute:`model-value`})],mc.prototype,`modelValue`,void 0),p([g({type:Array,attribute:`locked-permissions`})],mc.prototype,`lockedPermissions`,void 0),p([g()],mc.prototype,`name`,void 0),p([g({type:Boolean,reflect:!0})],mc.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,mc);var Dc=a`
  :host {
...
`,Oc=new WeakMap,kc=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,f(this,Oc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&m(Oc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),h(Oc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,h(Oc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
      <div
    ...
    `}};kc.styles=[Dc],p([g({type:Number})],kc.prototype,`progress`,void 0),p([g({type:Number})],kc.prototype,`total`,void 0),p([g({type:Number})],kc.prototype,`processed`,void 0),p([g({type:Boolean,attribute:`show-status`})],kc.prototype,`showStatus`,void 0),p([g({type:Boolean,reflect:!0})],kc.prototype,`pending`,void 0),p([g({type:Boolean})],kc.prototype,`smooth`,void 0),p([g({type:String})],kc.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,kc);var Ac=class extends Ni(Li(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},jc=class extends Fi(zi){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Mc=class extends Ac{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,br,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Mc.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Mc);var Nc=class extends Ui(jc){static get styles(){return[...super.styles,a`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,Nc);var Pc=a`
  craft-button {
    cursor: move;
  }
...
`,Fc=class extends l{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??O(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),i=t?n?`arrow-right`:`arrow-left`:`arrow-up`,a=t?n?`arrow-left`:`arrow-right`:`arrow-down`,o=O(t?`Move forward`:`Move up`),s=O(t?`Move backward`:`Move down`);return r`
    ...
    `}};Fc.styles=[Pc],p([g()],Fc.prototype,`label`,void 0),p([g({reflect:!0})],Fc.prototype,`position`,void 0),p([g({reflect:!0})],Fc.prototype,`orientation`,void 0),p([g({reflect:!0})],Fc.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],Fc.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,Fc);var Ic=class extends He(Ut){static get styles(){return[...super.styles,a`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Bc=class extends Ic{static get styles(){return[...super.styles,zc]}_afterTemplate(){return r`${this.singleOption?``:r`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},Vc=a`
  ${yr}
...
`,Hc=class extends Rc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Vc]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Bc}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return r`
    ...
    `}};p([g({reflect:!0,type:Boolean})],Hc.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,Hc);var Uc=a`
  :host {
    display: block;
  }
`;function Wc(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Gc=class extends l{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return r`<span
    ...
    ></span>`}_optionTemplate(e,t){return r`<craft-option .choiceValue=${e}>
      ...
      >
        ...
        ${tt.map(e=>this._optionTemplate(e,O(Wc(e))))}
      </craft-select-rich>
    `}};Gc.styles=[Uc],p([g()],Gc.prototype,`label`,void 0),p([g()],Gc.prototype,`name`,void 0),p([g({attribute:`model-value`})],Gc.prototype,`modelValue`,void 0),p([g({type:Boolean,reflect:!0,attribute:`allow-transparent`})],Gc.prototype,`allowTransparent`,void 0),customElements.get(`craft-select-color`)||customElements.define(`craft-select-color`,Gc);var Kc=class extends Oi{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>e.slot===`input`)}},qc=class extends Kc{get operationMode(){return`select`}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener(`change`,this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:`model`})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has(`disabled`)&&(this._inputNode.disabled=this.disabled,this.validate()),e.has(`name`)&&(this._inputNode.name=this.name),e.has(`autocomplete`)&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener(`change`,this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){let t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:``}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=this.modelValue===void 0?``:this.modelValue)}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent(`user-input-changed`,{bubbles:!0,composed:!0}))}},Jc=a`
  ${yr}
...
`,Yc=class extends qc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Jc]}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};p([g({reflect:!0,type:Boolean})],Yc.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,Yc);var Xc=a`
  :host {
    display: inline-block;
  }
...
`,W=new WeakSet,Zc=class extends l{constructor(...e){super(...e),d(this,W),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(W,this,$c).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(W,this,Qc).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${u(W,this,tl).call(this,this.value)}
      ...
      >
        ${e.map(e=>r`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(W,this,rl).call(this,e)}
              title=${u(W,this,tl).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function Qc(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function $c(e){u(W,this,Qc).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function el(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function tl(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function nl(e,t){let n=u(W,this,$c).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function rl(e){this.readOnly||u(W,this,nl).call(this,e,!0)}function il(e){if(this.readOnly)return;let t=u(W,this,el).call(this);switch(e.key){case`ArrowUp`:u(W,this,nl).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(W,this,nl).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(W,this,nl).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(W,this,nl).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(W,this,nl).call(this,this.min,!0),e.preventDefault();break;case`End`:u(W,this,nl).call(this,this.max,!0),e.preventDefault();break}}Zc.styles=[Xc],p([g({type:Number})],Zc.prototype,`min`,void 0),p([g({type:Number})],Zc.prototype,`max`,void 0),p([g({type:Number})],Zc.prototype,`step`,void 0),p([g({type:Number})],Zc.prototype,`value`,void 0),p([g()],Zc.prototype,`label`,void 0),p([g({attribute:`described-by`})],Zc.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],Zc.prototype,`valueUnit`,void 0),p([g({attribute:!1})],Zc.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],Zc.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,Zc);var al=a`
  :host {
    display: block;
  }
...
`,ol=new WeakMap,sl=new WeakMap,cl=new WeakMap,ll=new WeakMap,ul=new WeakMap,dl=new WeakMap,G=new WeakSet,fl=class extends l{constructor(...e){super(...e),d(this,G),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,ol,!1),f(this,sl,!1),f(this,cl,0),f(this,ll,0),f(this,ul,0),f(this,dl,null)}connectedCallback(){super.connectedCallback(),h(dl,this,new ResizeObserver(()=>u(G,this,ml).call(this))),m(dl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(dl,this)?.disconnect(),h(dl,this,null)}firstUpdated(){h(ul,this,(u(G,this,pl).call(this).length-1)*10),u(G,this,ml).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(G,this,ml).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(G,this,hl).call(this,this.value)}
        @keydown=${u(G,this,wl)}
        @pointerdown=${u(G,this,bl)}
        @pointermove=${u(G,this,xl)}
        @pointerup=${u(G,this,Sl)}
      >
        <div class="overlay"></div>
        <div class="cursor"></div>
        <div class="graduations">
          <ul aria-hidden="true">
            ${u(G,this,pl).call(this).map(e=>r`
                <li
                  class=${k({graduation:!0,"main-graduation":e%5==0,selected:u(G,this,Tl).call(this,e)})}
                  data-graduation=${e}
                >
    ...
    `}};function pl(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function ml(){this._list&&(this._list.style.left=`${u(G,this,_l).call(this,this.value)}px`)}function hl(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function gl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(ul,this)*n-t}function _l(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(ul,this)/n-this._graduations.offsetWidth/2)}function vl(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);this.value=n,t&&u(G,this,yl).call(this,`change`)}function yl(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function bl(e){h(sl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(sl,this)&&(e.preventDefault(),h(cl,this,e.clientX),h(ll,this,this._list.offsetLeft),this._root.setPointerCapture(e.pointerId),u(G,this,yl).call(this,`start`))}function xl(e){m(sl,this)&&Math.abs(e.clientX-m(cl,this))>3&&(h(ol,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(G,this,Cl).call(this,e))}function Sl(e){m(sl,this)&&(m(ol,this)?(e.preventDefault(),h(ol,this,!1),this._root.classList.remove(`dragging`)):u(G,this,Cl).call(this,e),u(G,this,yl).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(cl,this,0),h(sl,this,!1))}function Cl(e){let t=m(ol,this)?m(cl,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(ol,this)?t-e.clientX:e.clientX-t,r=m(ll,this)-n;u(G,this,vl).call(this,u(G,this,gl).call(this,r))}function wl(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(G,this,vl).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(G,this,vl).call(this,t-1);break;case`PageUp`:u(G,this,vl).call(this,t+10);break;case`PageDown`:u(G,this,vl).call(this,t-10);break;case`Home`:u(G,this,vl).call(this,this.min);break;case`End`:u(G,this,vl).call(this,this.max);break;default:return}e.preventDefault()}function Tl(e){return e>=Math.min(0,this.value)&&e<=Math.max(0,this.value)}fl.styles=[al],p([g({type:Number})],fl.prototype,`min`,void 0),p([g({type:Number})],fl.prototype,`max`,void 0),p([g({type:Number})],fl.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],fl.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],fl.prototype,`graduationMax`,void 0),p([g()],fl.prototype,`label`,void 0),p([y(`.slide-rule`)],fl.prototype,`_root`,void 0),p([y(`.graduations`)],fl.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],fl.prototype,`_list`,void 0),p([y(`.cursor`)],fl.prototype,`_cursor`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,fl);var El=a`
  :host {
    display: inline-flex;
...
`,Dl=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      <span
      ...
      ></span>
    `}};Dl.styles=[El],p([g()],Dl.prototype,`label`,void 0),p([g()],Dl.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Dl);var Ol=class extends Oe(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},Al=class extends Ol{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Al.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,Al);var jl=a`
  :host {
    display: grid;
  }
...
`;function Ml(e){return(e??``).split(/\s+/).filter(Boolean)}function Nl(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Pl=Symbol.for(`craft-switch-synthetic-change`),Fl=new WeakMap,Il=new WeakSet,Ll=class extends kl{constructor(...e){super(...e),d(this,Il),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,f(this,Fl,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,yr,jl]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Al}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?O(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?O(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){u(Il,this,Rl).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){u(Il,this,Rl).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){u(Il,this,Rl).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(m(Fl,this))return;let e=new Event(`change`,{bubbles:!0});e[Pl]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Pl in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of Ml(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of Ml(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Nl(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
    ...
    `}};function Rl(e,t){if(!this.disabled){if(!t){e();return}h(Fl,this,!0),e(),this.updateComplete.then(()=>{h(Fl,this,!1)})}}p([g({type:String,reflect:!0})],Ll.prototype,`size`,void 0),p([g({type:String,attribute:`on-label`})],Ll.prototype,`onLabel`,void 0),p([g({type:String,attribute:`off-label`})],Ll.prototype,`offLabel`,void 0),p([g({attribute:`value`})],Ll.prototype,`checkedValue`,void 0),p([g({attribute:`indeterminate-value`})],Ll.prototype,`indeterminateValue`,void 0),p([g({type:Boolean,reflect:!0})],Ll.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,Ll);function zl({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function Bl(e){e.setAttribute(`selected`,`true`)}function Vl(e){e.removeAttribute(`selected`)}function Hl({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function Ul({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function Wl(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function Gl(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function Kl(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var ql=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,Yl={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(Yl);var Xl={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(Xl);var Zl=[Yl.InlineStart,Yl.InlineEnd],Ql=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),K=new WeakSet,$l=new WeakMap,eu=new WeakMap,tu=new WeakMap,nu=new WeakMap,ru=new WeakMap,iu=new WeakMap,au=new WeakMap,ou=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=class extends ql{constructor(...e){super(...e),d(this,K),this.placement=Yl.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,$l,[]),f(this,eu,!1),f(this,tu,[]),f(this,nu,0),f(this,ru,void 0),f(this,iu,!1),f(this,au,e=>{if(!this.collapsible||fu.call(u(K,this)))return;let t=u(K,this,gu).call(this,e.target);!t||t.disabled||pu.call(u(K,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(K,this,_u).call(this,!0))}),f(this,ou,e=>{e.key!==`Escape`||!this.collapsible||fu.call(u(K,this))||u(K,this,gu).call(this,e.target)&&(e.stopPropagation(),u(K,this,_u).call(this,!0))}),f(this,su,()=>{fu.call(u(K,this))&&(pu.call(u(K,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(K,this,vu).call(this)}),f(this,cu,()=>{if(u(K,this,yu).call(this),pu.call(u(K,this)).forEach((e,t)=>{let n=()=>u(K,this,Du).call(this,t,!0),r=e=>{Ql.has(e.key)&&e.preventDefault()},i=e=>u(K,this,Ou).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m($l,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),pu.call(u(K,this))[this.selectedIndex]?.disabled){let e=pu.call(u(K,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(K,this,bu).call(this)}),f(this,lu,()=>{m(iu,this)||(h(iu,this,!0),requestAnimationFrame(()=>{h(iu,this,!1),u(K,this,Su).call(this)}))})}static get styles(){return[...super.styles,lo,Jl]}get layout(){return du.call(u(K,this))?Xl.Vertical:Xl.Horizontal}set layout(e){this.placement=e===Xl.Vertical?Yl.InlineStart:Yl.BlockStart}refresh(){m(eu,this)&&u(K,this,bu).call(this),u(K,this,Su).call(this)}firstUpdated(e){h(eu,this,pu.call(u(K,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(eu,this))t?.addEventListener(`slotchange`,m(cu,this)),m(cu,this).call(this);else{let n=fu.call(u(K,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(su,this))}this.addEventListener(`click`,m(au,this),!0),this.addEventListener(`keydown`,m(ou,this)),t?.addEventListener(`slotchange`,m(lu,this)),h(ru,this,new ResizeObserver(m(lu,this))),m(ru,this).observe(this),u(K,this,Su).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(K,this,yu).call(this),m(ru,this)?.disconnect(),h(ru,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,fu.call(u(K,this))),e.has(`selectedIndex`)&&(m(eu,this)?u(K,this,bu).call(this):m(su,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(K,this,Su).call(this)}render(){return r`
      <div class="tabs" part="base">
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${fu.call(u(K,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function du(){return Zl.includes(this.placement)}function fu(){return this.selectedIndex<0}function pu(){return this.tabs}function mu(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function hu(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function gu(e){return e instanceof Node?pu.call(u(K,this)).find(t=>t===e||t.contains(e))??null:null}function _u(e){let t=pu.call(u(K,this))[this.selectedIndex];h(nu,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function vu(){let e=pu.call(u(K,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(nu,this))?m(nu,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function yu(){for(;m($l,this).length;)m($l,this).pop()?.()}function bu(){let e=pu.call(u(K,this)).map(e=>u(K,this,xu).call(this,e)),t=e.some(Boolean);pu.call(u(K,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Ue()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(K,this,vu).call(this)}function xu(e){return e.controls?document.getElementById(e.controls):null}function Su(){let e=mu.call(u(K,this)),t=hu.call(u(K,this)),n=pu.call(u(K,this));if(!e||!t)return;if(du.call(u(K,this))||n.length===0){u(K,this,wu).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(K,this,Cu).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(K,this,wu).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(K,this,wu).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Cu(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function wu(e){let t=hu.call(u(K,this)),n=new Set(e);pu.call(u(K,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(tu,this,e),t&&(t.hidden=e.length===0,t.actions=u(K,this,Tu).call(this))}function Tu(){return m(tu,this).map(e=>{let t=pu.call(u(K,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(K,this,Eu).call(this,e)}})}function Eu(e){let t=pu.call(u(K,this))[e];if(!t||t.disabled)return;let n=hu.call(u(K,this));n&&(n.opened=!1),this.selectedIndex=e,u(K,this,Su).call(this),t.focus()}function Du(e,t){let n=pu.call(u(K,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Ou(e){if(!Ql.has(e.key))return;let t=u(K,this,ku).call(this,e.key);t!==-1&&u(K,this,Du).call(this,t,!0)}function ku(e){let t=pu.call(u(K,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(fu.call(u(K,this)))return u(K,this,ku).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],uu.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],uu.prototype,`collapsible`,void 0),p([g({reflect:!0})],uu.prototype,`layout`,null),p([g({reflect:!0})],uu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,uu);var Au=a`
  :host {
    display: inline-flex;
...
`,Bu=C(ue(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?t.exports=r():typeof define==`function`&&define.amd?define(r):(n||=self,n.autosize=r())})(e,(function(){var e=new Map;function t(t){if(!t||!t.nodeName||t.nodeName!==`TEXTAREA`||e.has(t))return;var n=null;function r(e){for(var t=[];e&&e.parentNode&&e.parentNode instanceof Element;)e.parentNode.scrollTop&&t.push([e.parentNode,e.parentNode.scrollTop]),e=e.parentNode;return function(){return t.forEach(function(e){var t=e[0],n=e[1];t.style.scrollBehavior=`auto`,t.scrollTop=n,t.style.scrollBehavior=null})}}var i=window.getComputedStyle(t);function a(e){var o=e.restoreTextAlign,s=o===void 0?null:o,c=e.testForHeightReduction,l=c===void 0||c,u=i.overflowY;if(t.scrollHeight!==0){i.resize===`vertical`?t.style.resize=`none`:i.resize===`both`&&(t.style.resize=`horizontal`);var d;l&&(d=r(t),t.style.height=``);var f=i.boxSizing===`content-box`?t.scrollHeight-(parseFloat(i.paddingTop)+parseFloat(i.paddingBottom)):t.scrollHeight+parseFloat(i.borderTopWidth)+parseFloat(i.borderBottomWidth);if(i.maxHeight!==`none`&&f>parseFloat(i.maxHeight)?(i.overflowY===`hidden`&&(t.style.overflow=`scroll`),f=parseFloat(i.maxHeight)):i.overflowY!==`hidden`&&(t.style.overflow=`hidden`),t.style.height=f+`px`,s&&(t.style.textAlign=s),d&&d(),n!==f&&(t.dispatchEvent(new Event(`autosize:resized`,{bubbles:!0})),n=f),u!==i.overflow&&!s){var p=i.textAlign;i.overflow===`hidden`&&(t.style.textAlign=p===`start`?`end`:`start`),a({restoreTextAlign:p,testForHeightReduction:!0})}}}function o(){a({testForHeightReduction:!0,restoreTextAlign:null})}var s=function(){var e=t.value;return function(){a({testForHeightReduction:e===``||!t.value.startsWith(e),restoreTextAlign:null}),e=t.value}}(),c=function(n){t.removeEventListener(`autosize:destroy`,c),t.removeEventListener(`autosize:update`,o),t.removeEventListener(`input`,s),window.removeEventListener(`resize`,o),Object.keys(n).forEach(function(e){return t.style[e]=n[e]}),e.delete(t)}.bind(t,{height:t.style.height,resize:t.style.resize,textAlign:t.style.textAlign,overflowY:t.style.overflowY,overflowX:t.style.overflowX,wordWrap:t.style.wordWrap});t.addEventListener(`autosize:destroy`,c),t.addEventListener(`autosize:update`,o),t.addEventListener(`input`,s),window.addEventListener(`resize`,o),t.style.overflowX=`hidden`,t.style.wordWrap=`break-word`,e.set(t,{destroy:c,update:o}),o()}function n(t){var n=e.get(t);n&&n.destroy()}function r(t){var n=e.get(t);n&&n.update()}var i=null;return typeof window>`u`?(i=function(e){return e},i.destroy=function(e){return e},i.update=function(e){return e}):(i=function(e,n){return e&&Array.prototype.forEach.call(e.length?e:[e],function(e){return t(e)}),e},i.destroy=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],n),e},i.update=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],r),e}),i}))}))(),1),Vu=new WeakMap,Hu=new WeakMap,Uu=new WeakMap,Wu=new WeakSet,Gu=class extends Ru{constructor(...e){super(...e),d(this,Wu),this.monospace=!1,f(this,Vu,void 0),f(this,Hu,void 0),f(this,Uu,null)}static get styles(){return[...super.styles,br,zu]}connectedCallback(){super.connectedCallback(),u(Wu,this,Ku).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(Vu,this)?.disconnect(),h(Vu,this,void 0),m(Hu,this)?.disconnect(),h(Hu,this,void 0)}};function Ku(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(Uu,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(Uu,this,e.style.height)}),h(Hu,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(Hu,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(Vu,this,new ResizeObserver(()=>{if(e.style.height===m(Uu,this))return;let t=e.style.height;Bu.default.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(Hu,this)?.disconnect(),h(Hu,this,void 0),m(Vu,this)?.disconnect(),h(Vu,this,void 0)})),m(Vu,this).observe(e))}p([g({type:Boolean,reflect:!0})],Gu.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Gu);var qu=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>Ju(e,this),this.compositionEventHandler=e=>ed(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,Yu),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,Yu)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter($u)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter($u)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter($u),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),Qu(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function Ju(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:Xu(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&Xu(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function Yu(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&Zu(t,{event:e})}function Xu(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function Zu(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function Qu(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function $u(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function ed(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var td=class extends Event{constructor(){super(`update`)}},nd=new WeakMap,rd=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=nd.get(t);return n||(n=new e(t),nd.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),nd.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new td)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of id)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},id=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),ad=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return rd.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},od=a`
  :host {
    display: contents;
  }
...
`,sd=/^[\p{L}\p{N}_.-]*$/u,cd=O(`Suggestions`),ld=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],ud={handlesAccessibility:!1,visibilityTriggerFunction:void 0},dd=0,q=new WeakMap,fd=new WeakMap,pd=new WeakMap,md=new WeakMap,J=new WeakMap,hd=new WeakMap,gd=new WeakMap,_d=new WeakMap,vd=new WeakMap,yd=new WeakMap,bd=new WeakMap,xd=new WeakMap,Sd=new WeakMap,Cd=new WeakMap,Y=new WeakSet,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=class extends l{constructor(...e){super(...e),d(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,q,void 0),f(this,fd,null),f(this,pd,null),f(this,md,new Map),f(this,J,null),f(this,hd,[]),f(this,gd,0),f(this,_d,null),f(this,vd,null),f(this,yd,null),f(this,bd,!1),f(this,xd,null),f(this,Sd,new DOMRect),f(this,Cd,new MutationObserver(()=>{let e=u(Y,this,Ld).call(this);(of(e)&&e!==m(fd,this)||m(fd,this)&&!m(fd,this).isConnected)&&u(Y,this,Rd).call(this)})),f(this,wd,()=>{m(bd,this)||u(Y,this,Gd).call(this)}),f(this,Td,()=>{h(bd,this,!0),u(Y,this,$d).call(this)}),f(this,Ed,()=>{h(bd,this,!1),u(Y,this,Gd).call(this)}),f(this,Dd,()=>{queueMicrotask(()=>u(Y,this,$d).call(this))}),f(this,Od,()=>{let e=m(fd,this);!e||!m(J,this)||!sf(e)||queueMicrotask(()=>{m(J,this)&&(e.selectionStart!==m(J,this).end||e.selectionEnd!==m(J,this).end)&&u(Y,this,Gd).call(this)})}),f(this,kd,()=>{m(J,this)&&u(Y,this,Qd).call(this)}),f(this,Ad,e=>{let t=e;m(J,this)&&m(q,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,jd,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,Md,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,Nd,e=>{u(Y,this,Yd).call(this,Number(e.target.dataset.index))}),f(this,Pd,e=>{if(e.target!==this.popoverElement)return;let t=m(q,this).getAttribute(`aria-label`)??cd;u(Y,this,nf).call(this),h(J,this,null),u(Y,this,tf).call(this),u(Y,this,rf).call(this,t===cd?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(Y,this,Id).call(this),this.hasUpdated&&u(Y,this,Rd).call(this)}disconnectedCallback(){u(Y,this,Bd).call(this),m(q,this)?.remove(),m(yd,this)!==null&&(clearTimeout(m(yd,this)),h(yd,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(Y,this,Rd).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(fd,this)!==u(Y,this,Ld).call(this)&&u(Y,this,Rd).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(J,this)){let e=m(q,this).querySelector(`[aria-selected="true"]`),t=e?m(hd,this)[Number(e.dataset.index)]:void 0;u(Y,this,Gd).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${ud}
        @craft-hide=${m(Pd,this)}
      >
    ...
    `}};function Id(){h(q,this,document.createElement(`div`)),m(q,this).id=`craft-text-expander-listbox-${++dd}`,m(q,this).slot=`listbox`,m(q,this).setAttribute(`part`,`listbox`),m(q,this).role=`listbox`,m(q,this).setAttribute(`aria-label`,cd),m(q,this).addEventListener(`pointerdown`,m(jd,this)),m(q,this).addEventListener(`pointerup`,m(Md,this)),m(q,this).addEventListener(`combobox-commit`,m(Nd,this)),this.append(m(q,this))}function Ld(){return this.getRootNode().getElementById(this.for)}function Rd(){let e=u(Y,this,Ld).call(this);if(u(Y,this,Bd).call(this),!of(e)){u(Y,this,zd).call(this);return}h(fd,this,e),u(Y,this,Vd).call(this,e),h(pd,this,new qu(e,m(q,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(Y,this,Hd).call(this,e),e.addEventListener(`input`,m(wd,this)),e.addEventListener(`keydown`,m(Ad,this)),e.addEventListener(`blur`,m(Dd,this)),e.addEventListener(`compositionstart`,m(Td,this)),e.addEventListener(`compositionend`,m(Ed,this)),e.ownerDocument.addEventListener(`selectionchange`,m(Od,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(Sd,this)},u(Y,this,zd).call(this)}function zd(){m(Cd,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function Bd(){m(Cd,this).disconnect(),u(Y,this,$d).call(this);let e=m(fd,this);e&&(e.removeEventListener(`input`,m(wd,this)),e.removeEventListener(`keydown`,m(Ad,this)),e.removeEventListener(`blur`,m(Dd,this)),e.removeEventListener(`compositionstart`,m(Td,this)),e.removeEventListener(`compositionend`,m(Ed,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(Od,this)),m(xd,this)?.getStyleClone().disconnect(),h(xd,this,null),m(pd,this)?.destroy(),h(pd,this,null),u(Y,this,Ud).call(this,e),h(fd,this,null))}function Vd(e){m(md,this).clear();for(let t of ld)m(md,this).set(t,e.getAttribute(t))}function Hd(e){let t=[m(md,this).get(`aria-controls`),m(q,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(Y,this,Wd).call(this,e,`aria-haspopup`),u(Y,this,Wd).call(this,e,`aria-expanded`)}function Ud(e){for(let t of ld)u(Y,this,Wd).call(this,e,t);m(md,this).clear()}function Wd(e,t){let n=m(md,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function Gd(e){u(Y,this,nf).call(this);let t=u(Y,this,qd).call(this);if(!t){h(J,this,null),u(Y,this,ef).call(this);return}h(J,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(Y,this,Jd).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(Y,this,Jd).call(this,[]),u(Y,this,rf).call(this,O(`Loading`));let r=m(gd,this);h(vd,this,setTimeout(()=>{u(Y,this,Kd).call(this,t,n,r,e)},150))}async function Kd(e,t,n,r){h(_d,this,new AbortController);let i;try{let n=await ve.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(_d,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(gd,this)||cf(t))return;u(Y,this,$d).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(gd,this)&&(this.loading=!1,u(Y,this,Jd).call(this,t===void 0?i:i.slice(0,t),r))}function qd(){let e=m(fd,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!sf(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&sd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function Jd(e,t){if(u(Y,this,Zd).call(this),h(hd,this,e),m(q,this).replaceChildren(),m(q,this).hidden=this.loading,m(q,this).setAttribute(`aria-label`,m(J,this)?.trigger.label??cd),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=af(e);n.id=`${m(q,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(J,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(q,this).append(n)}),!this.loading&&!e.length){h(J,this,null),u(Y,this,ef).call(this),u(Y,this,rf).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(J,this)&&u(Y,this,Xd).call(this,t)})}function Yd(e){let t=m(fd,this),n=m(hd,this)[e],r=u(Y,this,qd).call(this),i=m(J,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(Y,this,$d).call(this);return}lf(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(Y,this,$d).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function Xd(e){await this.popoverElement.updateComplete;let t=m(fd,this);if(!t||!u(Y,this,Qd).call(this)){u(Y,this,$d).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(J,this)||t!==m(fd,this))&&m(hd,this).length&&(m(pd,this)?.start(),u(Y,this,Wd).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(wd,this)),t.addEventListener(`input`,m(wd,this)),e)){let t=m(hd,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(pd,this)?.navigate(1)}}function Zd(){m(pd,this)?.stop(),m(fd,this)&&u(Y,this,Wd).call(this,m(fd,this),`aria-expanded`)}function Qd(){let e=m(fd,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(xd,this)){h(xd,this,new ad(e));let t=m(xd,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(kd,this))}return m(xd,this).setStartOffset(t),m(xd,this).setEndOffset(t),h(Sd,this,m(xd,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function $d(){u(Y,this,nf).call(this),h(J,this,null),u(Y,this,ef).call(this)}function ef(){u(Y,this,tf).call(this),this.popoverElement.hide()}function tf(){this.loading=!1,u(Y,this,Zd).call(this),h(hd,this,[]),m(q,this)?.replaceChildren(),m(q,this)&&(m(q,this).hidden=!1);let e=m(fd,this);e&&(u(Y,this,Wd).call(this,e,`aria-activedescendant`),u(Y,this,Wd).call(this,e,`aria-busy`))}function nf(){var e;h(gd,this,(e=m(gd,this),e++,e)),m(vd,this)&&(clearTimeout(m(vd,this)),h(vd,this,null)),m(_d,this)?.abort(),h(_d,this,null)}function rf(e){m(yd,this)!==null&&(clearTimeout(m(yd,this)),h(yd,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(yd,this,setTimeout(()=>{h(yd,this,null),this.announcement=``},5e3))}Fd.styles=[Mt,od],p([g({reflect:!0})],Fd.prototype,`for`,void 0),p([g({type:Array})],Fd.prototype,`triggers`,void 0),p([_()],Fd.prototype,`loading`,void 0),p([_()],Fd.prototype,`announcement`,void 0),p([y(`craft-popover`)],Fd.prototype,`popoverElement`,void 0);function af(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function of(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function sf(e){return e.getRootNode().activeElement===e}function cf(e){return e instanceof DOMException&&e.name===`AbortError`}function lf(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Fd);var uf=a`
  :host {
    display: inline-flex;
...
`,df=new WeakMap,ff=new WeakSet,pf=class extends l{constructor(...e){super(...e),d(this,ff),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,f(this,df,typeof ResizeObserver<`u`?new ResizeObserver(()=>u(ff,this,mf).call(this)):null)}connectedCallback(){super.connectedCallback(),m(df,this)?.observe(this)}disconnectedCallback(){m(df,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){u(ff,this,mf).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${u(ff,this,hf)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function mf(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function hf(){u(ff,this,mf).call(this)}pf.styles=uf,p([g({reflect:!0})],pf.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],pf.prototype,`disabled`,void 0),p([_()],pf.prototype,`overflowing`,void 0),p([_()],pf.prototype,`text`,void 0),p([y(`.truncate`)],pf.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,pf);var gf=a`
  :host {
...
`,_f={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},vf=class extends l{constructor(...e){super(...e),this.src=null,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}render(){return r`
    ...
    `}};vf.styles=[gf],p([g()],vf.prototype,`src`,void 0),p([g()],vf.prototype,`srcset`,void 0),p([g()],vf.prototype,`sizes`,void 0),p([g()],vf.prototype,`alt`,void 0),p([g({type:Number})],vf.prototype,`width`,void 0),p([g({type:Number})],vf.prototype,`height`,void 0),p([g()],vf.prototype,`loading`,void 0),p([g({reflect:!0,converter:_f})],vf.prototype,`checkered`,void 0),p([g({type:Boolean,reflect:!0})],vf.prototype,`rounded`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,vf);var yf=new WeakMap,bf=new WeakSet,xf=class extends HTMLElement{constructor(...e){super(...e),d(this,bf),f(this,yf,null)}connectedCallback(){u(bf,this,Sf).call(this)}disconnectedCallback(){m(yf,this)?.destroy(),h(yf,this,null)}};function Sf(){if(!(m(yf,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>u(bf,this,Sf).call(this));return}h(yf,this,new ga),m(yf,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,xf);var Cf=!1,wf=null;async function Tf(e){if(!Cf){if(wf)return wf;Cf=!0;try{return(await ve.post(`app/api-headers`,void 0,{cancelToken:e})).data}catch{}finally{Cf=!1}}}var Ef=x.create({baseURL:`https://api.craftcms.com/v1/`});async function Df(e){return wf?Object.entries(wf).forEach(([t,n])=>{e.headers.set(t,n)}):(e.params=e.params||{},e.params.processCraftHeaders=1),e}async function Of(e,t){if(wf)return;let{data:n}=await ve.post(`app/process-api-response-headers`,{headers:e},{cancelToken:t});return wf=n,Cf=!1,wf}async function kf(e){return await Of(e.headers,e.config.cancelToken),e}Ef.interceptors.request.use(async e=>{let{cancelToken:t}=e,n=await Tf(t);n&&Object.entries(n).forEach(([t,n])=>{e.headers.set(t,n)});let r={...e,params:{...Cp.apiParams||{},...e.params,v:new Date().getTime()}};return n||(r.params.processCraftHeaders=1),Cp.httpProxy&&(r.proxy=Cp.httpProxy),r}),Ef.interceptors.request.use(Df),Ef.interceptors.response.use(kf);function Af(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function jf(e={}){let t=Af({...e,type:`submit`,label:e.label||O(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function Mf(e={}){let t=Af({...e,icon:`duplicate`,label:e.label||pa(O(`Paste {type}`,{type:O(`elements`)}))});return t.classList.add(`paste-btn`),t}var Nf=async(e,t)=>{let{data:n}=await ve.post(e,t);return n},Pf=new WeakMap,Ff=new WeakMap,If=new WeakMap,Lf=new WeakMap,Rf=new WeakMap,zf=new WeakMap,Bf=new WeakMap,Vf=new WeakMap,Hf=new WeakMap,Uf=new WeakMap,X=new WeakSet,Wf=class e{constructor(t){d(this,X),f(this,Pf,null),f(this,Ff,[]),f(this,If,[]),f(this,Lf,null),f(this,Rf,!1),f(this,zf,!1),f(this,Bf,!1),f(this,Vf,null),f(this,Hf,void 0),f(this,Uf,new Map),this.options={...e.defaults,modalTitle:O(`Select element`),selectBtnLabel:O(`Select`),...Yf(t)},h(If,this,[...this.options.disabledElementIds??[]]),h(Hf,this,u(X,this,Gf).call(this))}get elementType(){return this.options.elementType}get state(){return m(Hf,this)}get index(){return m(Pf,this)}get hasSelection(){return m(Ff,this).length>0}on(e,t){let n=m(Uf,this).get(e);return n||(n=new Set,m(Uf,this).set(e,n)),n.add(t),()=>{m(Uf,this).get(e)?.delete(t)}}async open(){h(Ff,this,[]),m(Pf,this)?.clearSelection(),m(Rf,this)||(h(Rf,this,!0),u(X,this,Jf).call(this,`open`,void 0)),u(X,this,Kf).call(this),m(Lf,this)||await this.reload()}close(){m(Rf,this)&&(h(Rf,this,!1),u(X,this,Jf).call(this,`close`,void 0),this.options.onClose?.(),u(X,this,Kf).call(this))}destroy(){m(Pf,this)?.destroy?.(),h(Pf,this,null),h(Ff,this,[]),h(Lf,this,null),h(Rf,this,!1),h(Bf,this,!1),h(zf,this,!1),h(Vf,this,null),u(X,this,Kf).call(this),m(Uf,this).clear()}async reload(){let e=this.options.loadIndexBody??Nf;h(zf,this,!0),h(Vf,this,null),u(X,this,Kf).call(this);try{h(Lf,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){u(X,this,qf).call(this,e)}finally{h(zf,this,!1),u(X,this,Kf).call(this)}}async submit(){if(!m(Hf,this).canSubmit)return;let e=this.buildElementInfo(m(Ff,this)),t=this.selectMeta();h(Bf,this,!0),u(X,this,Kf).call(this);try{u(X,this,Jf).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){u(X,this,qf).call(this,e);return}finally{h(Bf,this,!1),u(X,this,Kf).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...m(If,this),...e.map(e=>Number(e.id))]),m(Pf,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){m(Hf,this).canCancel&&(u(X,this,Jf).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){h(Pf,this,e),u(X,this,Kf).call(this)}detachIndex(){h(Pf,this,null),u(X,this,Kf).call(this)}setSelection(e){h(Ff,this,[...e]),u(X,this,Kf).call(this)}setDisabledElementIds(e){h(If,this,[...new Set(e.map(Number))]),u(X,this,Kf).call(this)}setBusy(e){h(Bf,this,e),u(X,this,Kf).call(this)}indexParams(){let{options:e}=this,t={context:`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),t}indexSettings(){let{options:e}=this;return{context:`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...m(If,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return m(Ff,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){u(X,this,Kf).call(this)}get selection(){return m(Ff,this)}get disabledElementIds(){return m(If,this)}};function Gf(){let e=m(Bf,this),t=m(zf,this);return Object.freeze({open:m(Rf,this),loading:t,busy:e,selection:Object.freeze([...m(Ff,this)]),disabledElementIds:Object.freeze([...m(If,this)]),indexBody:m(Lf,this),error:m(Vf,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function Kf(){h(Hf,this,u(X,this,Gf).call(this)),u(X,this,Jf).call(this,`change`,m(Hf,this))}function qf(e){h(Vf,this,e instanceof Error?e:Error(String(e??`Unknown`))),u(X,this,Jf).call(this,`error`,m(Vf,this))}function Jf(e,t){let n=m(Uf,this).get(e);n&&[...n].forEach(e=>e(t))}Wf.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function Yf(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var Xf=async(e,t)=>{let{data:n}=await ve.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},Zf=new WeakMap,Qf=class e extends Wf{constructor(e){super(e),f(this,Zf,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??Xf;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}h(Zf,this,t);try{await this.submit()}finally{h(Zf,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!m(Zf,this))return n;let r=e.transformUrls[m(Zf,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:m(Zf,this)}}};Qf.transformUrls={};var $f=`CraftCms\\Cms\\Asset\\Elements\\Asset`,ep=new WeakSet,tp=class extends Wf{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:$f,showSiteMenu:!1}),d(this,ep),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:u(ep,this,np).call(this),status:null,url:null,hasThumb:!1}]}};function np(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var rp=new Map;function ip(e,t){if(rp.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);rp.set(e,t)}function ap(e){return rp.has(e)}function op(e){return rp.get(e)??Wf}function sp(e){return new(op(e.elementType))(e)}function cp(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))rp.has(t)||rp.set(t,n)}var lp={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},up=new WeakMap,dp=new WeakMap,fp=new WeakMap,pp=new WeakMap,mp=new WeakMap,hp=new WeakMap,gp=new WeakMap,Z=new WeakSet,_p=class{constructor(e={}){d(this,Z),f(this,up,new Map),f(this,dp,null),f(this,fp,0),f(this,pp,[]),f(this,mp,[]),f(this,hp,new Set),f(this,gp,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)m(up,this).set(e.id,e);r&&(u(Z,this,xp).call(this),m(dp,this)!==null&&u(Z,this,Sp).call(this))}getSessions(){return Array.from(m(up,this).values())}getCurrentSessionId(){return m(dp,this)}isProcessing(){return m(fp,this)>0}on(e,t){return m(gp,this).has(e)||m(gp,this).set(e,new Set),m(gp,this).get(e).add(t),()=>{m(gp,this).get(e)?.delete(t)}}async startIndexing(e){let t=await ve.post(lp.START,e),{data:n}=t;return n.session&&(m(up,this).set(n.session.id,n.session),h(dp,this,n.session.id),u(Z,this,yp).call(this),n.stop||u(Z,this,Sp).call(this)),n.stop&&u(Z,this,bp).call(this,n.stop),t}stopSession(e){u(Z,this,wp).call(this,e),u(Z,this,Tp).call(this,{sessionId:e,action:lp.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){u(Z,this,Tp).call(this,{sessionId:e,action:lp.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){u(Z,this,Tp).call(this,{sessionId:e.sessionId,action:lp.FINISH,params:e,priority:!0})}destroy(){m(up,this).clear(),h(pp,this,[]),h(mp,this,[]),m(gp,this).clear(),h(dp,this,null),h(fp,this,0)}};function vp(e,t){m(gp,this).get(e)?.forEach(e=>e(t))}function yp(e){u(Z,this,vp).call(this,`change`,{sessions:this.getSessions(),currentSessionId:m(dp,this),reviewSessionId:e})}function bp(e){m(up,this).delete(e),m(dp,this)===e&&h(dp,this,null),u(Z,this,yp).call(this)}function xp(){for(let[e,t]of m(up,this))if(!t.actionRequired&&!m(hp,this).has(e)){h(dp,this,e);return}h(dp,this,null)}function Sp(){if(m(dp,this)||u(Z,this,xp).call(this),!m(dp,this))return;let e=m(up,this).get(m(dp,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-m(fp,this),r=Math.min(n,t);for(let t=0;t<r;t++)u(Z,this,Tp).call(this,{sessionId:e.id,action:lp.PROCESS,params:{sessionId:m(dp,this)},priority:!1});e.processIfRootEmpty&&u(Z,this,Tp).call(this,{sessionId:e.id,action:lp.PROCESS,params:{sessionId:m(dp,this)},priority:!1})}function wp(e){m(hp,this).add(e),h(pp,this,m(pp,this).filter(t=>t.sessionId!==e))}function Tp(e){e.priority?m(mp,this).push(e):m(pp,this).push(e),u(Z,this,Ep).call(this)}function Ep(){if(!(m(pp,this).length+m(mp,this).length===0||m(fp,this)>=this.maxConcurrentConnections))for(;m(pp,this).length+m(mp,this).length>0&&m(fp,this)<this.maxConcurrentConnections;){var e;h(fp,this,(e=m(fp,this),e++,e));let t=m(mp,this).length>0?m(mp,this).shift():m(pp,this).shift();u(Z,this,Dp).call(this,t)}}async function Dp(e){try{let t=await ve.post(e.action,e.params);u(Z,this,Op).call(this,t.data)}catch(t){u(Z,this,kp).call(this,t,e)}finally{var t;h(fp,this,(t=m(fp,this),t--,t)),u(Z,this,Ep).call(this)}}function Op(e){let t;e.session&&(m(up,this).set(e.session.id,e.session),u(Z,this,xp).call(this),e.session.actionRequired&&!e.skipDialog?m(hp,this).has(e.session.id)||(t=e.session.id):m(hp,this).has(e.session.id)||u(Z,this,Sp).call(this)),u(Z,this,xp).call(this),e.stop&&(m(up,this).delete(e.stop),m(dp,this)===e.stop&&h(dp,this,null)),u(Z,this,yp).call(this,t),m(up,this).size===0&&u(Z,this,vp).call(this,`complete`,{})}function kp(e,t){u(Z,this,xp).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;u(Z,this,vp).call(this,`error`,{message:n,sessionId:t.sessionId}),u(Z,this,Ep).call(this)}var Ap=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},jp=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Mp,Np=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Pp=typeof Intl<`u`&&Intl.ListFormat||Np,Fp=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],Ip={minimumIntegerDigits:2},Lp=class{constructor(e,t={}){Mp.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Ap(this,Mp,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return jp(this,Mp,`f`)}formatToParts(e){let t=[],n=jp(this,Mp,`f`),r=n.style,i=n.locale;for(let[a,o]of Fp){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?Ip:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Pp(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Mp=new WeakMap;var Rp=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,zp=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],Bp=e=>Rp.test(e),Vp=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(Rp)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(Hp(r,e.from(t)).getTime()-r),a=Math.abs(Hp(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Lp(e,t).format(this)}};function Hp(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function Up(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new Vp;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=zp.indexOf(t)||zp.length;return new Vp(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function Wp(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new Vp(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function Gp(e,t){let n=Wp(e,t);if(n.blank)return[0,`second`];for(let e of zp){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Kp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,qp,Jp,Yp,Xp,Zp,Qp,$p,em,tm,nm,rm,im,am,om,sm,cm=globalThis.HTMLElement||null,lm=new Vp,um=new Vp(0,0,0,0,0,1),dm=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function fm(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var pm=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=fm(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,fm(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},mm=class extends cm{constructor(){super(...arguments),$.add(this),qp.set(this,!1),Jp.set(this,!1),Xp.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),sm.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,sm,`f`)}set onRelativeTimeUpdated(e){Q(this,sm,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,sm,`f`)),Kp(this,sm,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&Bp(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return zp.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){pm.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&Kp(this,qp,n!==null&&(this.date&&Q(this,$,`m`,Zp).call(this,this.date))!==n,`f`),!Q(this,Jp,`f`)&&!(e===`title`&&Q(this,qp,`f`))&&Kp(this,Jp,(async()=>{await Promise.resolve(),this.update(),Kp(this,Jp,!1,`f`)})(),`f`))}update(){let e=Q(this,Xp,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,Xp,`f`).textContent=e;return}let i=Date.now();Q(this,qp,`f`)||(n=Q(this,$,`m`,Zp).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=Up(r,this.precision,i),o=Q(this,$,`m`,Qp).call(this,a),s=e,c=Q(this,$,`m`,om).call(this,o);s=c?Q(this,$,`m`,im).call(this,r):o===`duration`?Q(this,$,`m`,$p).call(this,a):o===`relative`?Q(this,$,`m`,em).call(this,a):Q(this,$,`m`,tm).call(this,r),s?Q(this,$,`m`,am).call(this,s):this.shadowRoot===Q(this,Xp,`f`)&&this.textContent&&Q(this,$,`m`,am).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new dm(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,nm).call(this,r)||Q(this,$,`m`,rm).call(this,r))?pm.observe(this):pm.unobserve(this)}};qp=new WeakMap,Jp=new WeakMap,Xp=new WeakMap,sm=new WeakMap,$=new WeakSet,Yp=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},Zp=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,Yp),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},Qp=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||Vp.compare(e,this.threshold)===1)return`relative`}return`datetime`},$p=function(e){let t=Q(this,$,`a`,Yp),n=this.format,r=this.formatStyle,i=this.tense,a=lm;n===`micro`?(e=Wp(e),a=um,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=um)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},em=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,Yp),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=lm),n===`past`&&e.sign!==-1&&(e=lm);let[r,i]=Gp(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},tm=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,Yp),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},nm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Yp),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},rm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Yp),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},im=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,nm).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,Yp),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,Yp))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,Yp),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,rm).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,Yp),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,Yp),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},am=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,Xp,`f`).replaceChildren(t)}else Q(this,Xp,`f`).textContent=e},om=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var hm=typeof globalThis<`u`?globalThis:window;try{hm.RelativeTimeElement=mm.define()}catch(e){if(!(hm.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{Yi as A,fa as C,na as D,la as E,vt as F,yt as I,ut as L,or as M,Mt as N,oa as O,xt as P,ve as R,pa as S,da as T,Ks as _,ap as a,Ja as b,Wf as c,jf as d,Ef as f,Qs as g,Yc as h,cp as i,Si as j,ra as k,Mf as l,Ll as m,sp as n,tp as o,Gu as p,ip as r,Qf as s,_p as t,Af as u,V as v,ua as w,ga as x,ls as y,ge as z};
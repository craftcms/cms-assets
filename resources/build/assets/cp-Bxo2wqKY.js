...
`,pr=class extends dr(l,{customProperty:[`--_callout-padding-block`,`--_callout-padding-inline`]}){constructor(...e){super(...e),this.variant=Se.Neutral,this.appearance=ee.OutlineFill,this.title=``,this.icon=null,this.hideIcon=!1,this.rounded=`all`,this.inline=!1,this.size=`auto`,this.resolvedIcon=null}willUpdate(){this.resolvedIcon=this.icon??this.getDefaultIcon()}getDefaultIcon(){switch(this.variant){case Se.Info:return`lightbulb`;case Se.Success:return`circle-check`;case Se.Warning:return`circle-exclamation`;case Se.Danger:return`triangle-exclamation`;default:return null}}render(){let e=this.title||!!this.querySelector(`[slot="title"]`),t=!this.hideIcon&&(!!this.resolvedIcon||!!this.querySelector(`[slot="icon"]`));return r`
    ...
    `}};pr.styles=[de,fr],p([g({reflect:!0})],pr.prototype,`variant`,void 0),p([g({reflect:!0})],pr.prototype,`appearance`,void 0),p([g()],pr.prototype,`title`,void 0),p([g()],pr.prototype,`icon`,void 0),p([g({type:Boolean,attribute:`hide-icon`})],pr.prototype,`hideIcon`,void 0),p([g({reflect:!0})],pr.prototype,`rounded`,void 0),p([g({reflect:!0,type:Boolean})],pr.prototype,`inline`,void 0),p([g()],pr.prototype,`size`,void 0),p([_()],pr.prototype,`resolvedIcon`,void 0),customElements.get(`craft-callout`)||customElements.define(`craft-callout`,pr);var mr=a`
  :host {
    display: block;
  }
...
`,hr=class extends l{constructor(...e){super(...e),this.label=``,this.active=!1,this.showThumb=!0,this.thumbAlignment=`start`,this._hasThumbnail=!1,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasSlottedHeader=!!this.querySelector(`:scope > [slot="header"]`)||!!this.querySelector(`:scope > [slot="label"]`)||!!this.querySelector(`:scope > [slot="actions"]`),this._hasSlottedFooter=!!this.querySelector(`:scope > [slot="footer"]`),this._hasThumbnail=!!this.querySelector(`:scope > [slot="thumbnail"]`)}_handleThumbnailSlotChange(e){let t=e.target;this._hasThumbnail=t.assignedElements({flatten:!0}).length>0}render(){let e=!!this.label||this._hasSlottedHeader,t=this._hasSlottedFooter,n=this.showThumb&&this._hasThumbnail;return r`
    ...
    `}};hr.styles=[mr],p([g()],hr.prototype,`label`,void 0),p([g({type:Boolean,reflect:!0})],hr.prototype,`active`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],hr.prototype,`showThumb`,void 0),p([g({attribute:`thumb-alignment`})],hr.prototype,`thumbAlignment`,void 0),p([_()],hr.prototype,`_hasThumbnail`,void 0),p([_()],hr.prototype,`_hasSlottedHeader`,void 0),p([_()],hr.prototype,`_hasSlottedFooter`,void 0),customElements.get(`craft-card`)||customElements.define(`craft-card`,hr);var gr=a`
...
`,Sa=new WeakMap,Ca=new WeakMap,wa=new WeakMap,Ta=new WeakSet,Ea=class extends l{constructor(...e){super(...e),d(this,Ta),this.size=``,this.variant=Se.Neutral,this.appearance=ee.OutlineFill,this.icon=null,this.showIndicators=!1,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,this.selected=!1,this.selectLabel=null,f(this,Sa,!1),f(this,Ca,new ga),this.lightDom=0,f(this,wa,new MutationObserver(()=>this.lightDom++))}connectedCallback(){super.connectedCallback(),m(wa,this).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){m(wa,this).disconnect(),super.disconnectedCallback()}renderSelect(){return r`<input
      type="checkbox"
    ...
    </div>`}firstUpdated(e){super.firstUpdated(e),m(Ca,this).load(this)}render(){this.lightDom;let e=!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`)||!!this.querySelector(`[slot="thumbnail"]`)||!!this.querySelector(`[slot="indicator"]`)||!!this.querySelector(`[slot="status"]`)||this.icon,t=!!this.querySelector(`[slot="suffix"]`);return r`
      <div
        part="chip"
    ...
    `}};function Da(e){h(Sa,this,e.shiftKey),e.stopPropagation()}function Oa(e){let{checked:t}=e.target;this.selected=t,this.dispatchEvent(new CustomEvent(`selected-change`,{detail:{selected:t,shiftKey:m(Sa,this)},bubbles:!0,composed:!0}))}Ea.styles=[xa],p([g()],Ea.prototype,`size`,void 0),p([g({reflect:!0})],Ea.prototype,`variant`,void 0),p([g({reflect:!0})],Ea.prototype,`appearance`,void 0),p([g()],Ea.prototype,`icon`,void 0),p([g({attribute:`show-indicators`,type:Boolean})],Ea.prototype,`showIndicators`,void 0),p([g({attribute:`show-status`,type:Boolean})],Ea.prototype,`showStatus`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],Ea.prototype,`showThumb`,void 0),p([g({type:Boolean})],Ea.prototype,`selectable`,void 0),p([g({type:Boolean,reflect:!0})],Ea.prototype,`selected`,void 0),p([g({attribute:`select-label`})],Ea.prototype,`selectLabel`,void 0),p([_()],Ea.prototype,`lightDom`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,Ea);var ka=class extends ji(l){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},Aa=D(e=>class extends hi(ui(Ni(Ve(Ai(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],a`
          :host {
            display: block;
          }
...
`,Pa=new WeakMap,Fa=new WeakSet,Ia=class extends Ma{constructor(...e){super(...e),d(this,Fa),this.hint=null,f(this,Pa,void 0)}static get styles(){return[...Ma.styles,Na]}connectedCallback(){super.connectedCallback(),Ra._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),Ra._.unobserve(this)}render(){return r`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?r`<span class="hint">${this.hint}</span>`:c}
        <slot name="suffix"></slot>
      </div>
    `}};function La(){return m(Pa,this)??h(Pa,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),m(Pa,this)}var Ra={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=u(Fa,e,La).call(e))}})};p([g()],Ia.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,Ia);var za=new WeakMap;function Ba(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),za.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else Ba(n,t)})}function Va(e){za.has(e)&&za.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?za.has(e)&&za.get(e)():Va(e)})}var Ha=class extends Si{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof pi}};function Ua(e){return Array.isArray(e)?e:[e]}var Wa=D(e=>class extends Ni(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Ua(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Ua(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Ua(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Ua(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Ga=new WeakMap,Ka=class extends ii(se(Wa(ja))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,a`
        .input-group__input {
          display: flex;
          flex: 1;
        }
...
`,Xa=new WeakMap,Za=new WeakMap,Qa=new WeakMap,z=new WeakSet,$a=new WeakMap,eo=class extends Ka{static get properties(){return{modelValue:{attribute:`model-value`}}}attributeChangedCallback(e,t,n){if(e===`model-value`){this.modelValue=this.hasAttribute(`multiple-choice`)?JSON.parse(n??`[]`):n??``;return}super.attributeChangedCallback(e,t,n)}static get styles(){return[...super.styles,Ya]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,z),this.multipleChoice=!1,this.required=!1,this.initialValues=[],this.fieldsetDisabled=!1,this.changingValues=!1,this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,Xa,void 0),f(this,Za,!1),f(this,Qa,()=>{h(Za,this,!0),u(z,this,ao).call(this),!this.multipleChoice&&!this.requireOptionMatch&&u(z,this,to).call(this)}),f(this,$a,()=>{if(this.multipleChoice){this.changeValues([]);return}this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(z,this,ao).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.selectionFollowsFocus=!1,this.addEventListener(`model-value-changed`,e=>{if(this.changingValues){e.stopImmediatePropagation();return}if(e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&JSON.stringify(this.modelValue)!==JSON.stringify(this.pendingModelValue)){e.stopImmediatePropagation();return}e.target===this&&e.detail?.isTriggeredByUser&&(this.pendingModelValue=this.multipleChoice?[...this.selectedValues]:this.modelValue,this.multipleChoice&&(this.syncInputs(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))))}),this.addEventListener(`focusout`,e=>{this.multipleChoice&&!this.requireOptionMatch&&!(e.relatedTarget instanceof Node&&this.contains(e.relatedTarget))&&this.commitQuery()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m(Qa,this)),this.addEventListener(`model-value-changed`,()=>{h(Xa,this,this.modelValue)}),h(Xa,this,this.modelValue),u(z,this,ao).call(this),this.multipleChoice&&(this.initialValues=[...Array.isArray(this.pendingModelValue)?this.pendingModelValue:[]])}updated(e){if(super.updated(e),this.multipleChoice){this.syncInputs(),this._inputNode.removeAttribute(`name`),this._comboboxNode.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this._inputNode.disabled=this.disabled||this.fieldsetDisabled;let e=this.required&&!this.inactive&&this.selectedValues.length===0;this.internals??=this.attachInternals(),this.internals.setValidity(e?{valueMissing:!0}:{},e?O(`This field is required.`):``,this._inputNode)}e.has(`opened`)&&!this.opened&&h(Za,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`)||e.has(`multipleChoice`))&&u(z,this,ao).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,u(z,this,lo).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t);let n=e;n.updateComplete.then(()=>{if(this.multipleChoice){n.checked=Array.isArray(this.pendingModelValue)&&this.pendingModelValue.includes(String(n.choiceValue));return}String(n.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(n)))})}_notifyModelValueChanged(){JSON.stringify(this.modelValue)!==JSON.stringify(m(Xa,this))&&(h(Xa,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:this.multipleChoice?`selection`:`input`}})))}matchCondition(e){return!this.multipleChoice||!e.hidden}_autoSelectCondition(){return!this.multipleChoice}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=u(z,this,lo).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ${this.multipleChoice?Ja(this.selectedValues,e=>e,e=>r`
                <span class="token">
                  ${this.valueLabel(e)}
        ...
        <div class="combobox__textbox">
          ...
          <slot name="input"></slot>
          ${this.clearable&&u(z,this,so).call(this)&&!this.inactive?r`<craft-button
                class="clear"
                type="button"
                appearance="plain"
                size="small"
    ...
    `}get selectedValues(){return Array.isArray(this.modelValue)?this.modelValue:[]}get inactive(){return this.disabled||this.readOnly||this.fieldsetDisabled}valueLabel(e){return[...u(z,this,uo).call(this)].find(t=>t.value===e)?.label??e}syncInputs(){this.inputs||(this.inputs=document.createElement(`span`),this.inputs.hidden=!0,this.inputs.slot=`native-inputs`,this.inputs.setAttribute(`data-combobox-inputs`,``),this.append(this.inputs)),s(!this.name||this.disabled||this.fieldsetDisabled?c:r`
            ...
            ${this.selectedValues.map(e=>r`<input
                  ...
                  .value=${e}
                />`)}
          `,this.inputs)}formResetCallback(){this.multipleChoice&&(this.modelValue=[...this.initialValues],this.value=``,this.syncInputs())}formDisabledCallback(e){this.fieldsetDisabled=e,this.requestUpdate(),this.multipleChoice&&this.syncInputs()}changeValues(e){if(!this.inactive){this.changingValues=!0;try{this.modelValue=e}finally{this.changingValues=!1}this.value=``,this.opened=!1,u(z,this,ao).call(this),this.syncInputs(),this._notifyModelValueChanged(),this._inputNode.focus()}}commitQuery(){let e=this.value;if(this.inactive||e===``)return;let t=[...u(z,this,uo).call(this)].find(t=>t.value===e);t?.disabled||this.requireOptionMatch&&!t||this.changeValues([...new Set([...this.selectedValues,e])])}_listboxOnKeyDown(e){if(!this.multipleChoice){super._listboxOnKeyDown(e);return}if(this.inactive||e.isComposing)return;if(e.key===`Backspace`&&this.value===``){e.preventDefault(),this.changeValues(this.selectedValues.slice(0,-1));return}let t=this.formElements[this.activeIndex];if(e.key===`Enter`&&(!this.opened||!t||t.hidden||t.hasAttribute(`aria-hidden`))){e.preventDefault(),this.commitQuery();return}super._listboxOnKeyDown(e)}_syncToTextboxMultiple(){}_resetListboxOptions(){super._resetListboxOptions(),this.hideSelectedOptions()}_handleAutocompletion(){super._handleAutocompletion(),this.hideSelectedOptions()}hideSelectedOptions(){if(!this.multipleChoice)return;for(let e of this.formElements)e.hidden&&(e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`aria-posinset`),e.removeAttribute(`aria-setsize`));let e=this.formElements.filter(e=>!e.hasAttribute(`aria-hidden`));e.forEach((t,n)=>{t.setAttribute(`aria-posinset`,String(n+1)),t.setAttribute(`aria-setsize`,String(e.length))})}parser(e){if(typeof e==`string`&&e!==``){let t=u(z,this,co).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function to(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function no(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(u(z,this,ro).call(this,e))for(let r of e.options)(t===``||u(z,this,io).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||u(z,this,io).call(this,t,e))&&n.push({option:e});return n}function ro(e){return e.type===`optgroup`}function io(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function ao(){let e=this._listboxNode;if(!e)return;let t=m(Za,this)?this._inputNode?.value??``:``,n=this.multipleChoice?Array.isArray(this.pendingModelValue)?this.pendingModelValue:this.selectedValues:[],i=u(z,this,no).call(this,t).filter(e=>!n.includes(e.option.value)),a=i.slice(0,this.limit),o=[...u(z,this,uo).call(this)],l=[...n.map(e=>({option:o.find(t=>t.value===e)??{value:e,label:e}})),...a],d,f=l.map(e=>{let t=e.groupLabel&&e.groupLabel!==d?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return d=e.groupLabel,{value:e.option.value,template:r`${t}${u(z,this,oo).call(this,e.option,n.includes(e.option.value))}`}}),p=i.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${O(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:i.length})}
          </div>`:c;s(r`${Ja(f,e=>e.value,e=>e.template)}${p}`,e)}function oo(e,t=!1){let n=e.data??{},i=e.label,a=i.startsWith(`$`)||i.startsWith(`@`);return r`
      <craft-option
        ?hidden=${t}
    ...
    `}function so(){return this.multipleChoice?this.selectedValues.length>0:this.modelValue!==``&&this.modelValue!=null}function co(e){let t=e.trim();for(let e of u(z,this,uo).call(this))if(u(z,this,fo).call(this,e)===t)return e}function lo(){if(this.multipleChoice||!u(z,this,so).call(this))return;let e=String(this.modelValue);for(let t of u(z,this,uo).call(this))if(String(t.value)===e)return t}function*uo(){for(let e of this.options)u(z,this,ro).call(this,e)?yield*e.options:yield e}function fo(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}eo.formAssociated=!0,p([g({type:Boolean,attribute:`multiple-choice`,reflect:!0})],eo.prototype,`multipleChoice`,void 0),p([g({type:Boolean})],eo.prototype,`required`,void 0),p([g({type:Array})],eo.prototype,`options`,void 0),p([g({type:Number})],eo.prototype,`limit`,void 0),p([g({type:Boolean,reflect:!0})],eo.prototype,`clearable`,void 0),p([g({type:String,reflect:!0})],eo.prototype,`placeholder`,void 0),p([g({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],eo.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,eo);var po=a`
  :host {
    display: inline-block;
  }
...
`,mo={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},ho=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(mo[`icon.out`].keyframes,mo[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(mo[`icon.in`].keyframes,mo[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(mo[`icon.out`].keyframes,mo[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(mo[`icon.in`].keyframes,mo[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||O(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};ho.styles=[po],p([_()],ho.prototype,`isCopying`,void 0),p([_()],ho.prototype,`status`,void 0),p([y(`slot[name="copy-icon"]`)],ho.prototype,`copyIconEl`,void 0),p([y(`slot[name="success-icon"]`)],ho.prototype,`successIconEl`,void 0),p([y(`slot[name="error-icon"]`)],ho.prototype,`errorIconEl`,void 0),p([y(`craft-tooltip`)],ho.prototype,`tooltipEl`,void 0),p([g({type:String})],ho.prototype,`value`,void 0),p([g({type:Boolean})],ho.prototype,`disabled`,void 0),p([g({attribute:`feedback-duration`,type:Number})],ho.prototype,`feedbackDuration`,void 0),p([g({attribute:`tooltip-label`})],ho.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,ho);var go=a`
  :host {
    box-sizing: border-box;
  }
...
`,vo=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return r`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};vo.styles=[go,_o],p([y(`craft-copy-button`)],vo.prototype,`copyButtonEl`,void 0),p([g({type:String})],vo.prototype,`value`,void 0),p([g({type:Boolean,reflect:!0})],vo.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,vo);var yo=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function bo(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function xo(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(yo))).filter(bo)}function So(e){let t=t=>{if(t.key!==`Tab`)return;let n=xo(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var Co=a`
  :host {
    display: contents;
...
`,wo=0,To=0;function Eo(){To++===0&&document.body.classList.add(`no-scroll`)}function Do(){To>0&&--To===0&&document.body.classList.remove(`no-scroll`)}var Oo=new WeakMap,ko=new WeakMap,Ao=new WeakMap,jo=new WeakMap,Mo=new WeakSet,No=new WeakMap,Po=new WeakMap,Fo=new WeakMap,Io=new WeakMap,Lo=new WeakMap,Ro=new WeakMap,zo=class extends l{constructor(...e){super(...e),d(this,Mo),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++wo}`,f(this,Oo,!1),f(this,ko,null),f(this,Ao,!1),f(this,jo,null),f(this,No,e=>{e.preventDefault(),this.requestClose()}),f(this,Po,()=>{this.opened=!1}),f(this,Fo,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),f(this,Io,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),f(this,Lo,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),f(this,Ro,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,m(Io,this)),this.addEventListener(`keydown`,m(Fo,this)),h(jo,this,new MutationObserver(()=>this.requestUpdate())),m(jo,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(Io,this)),this.removeEventListener(`keydown`,m(Fo,this)),m(jo,this)?.disconnect(),h(jo,this,null),m(ko,this)?.call(this),h(ko,this,null),u(Mo,this,Ho).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
    ...
    `}updated(e){super.updated(e),this.opened!==m(Oo,this)&&(h(Oo,this,this.opened),this.opened?u(Mo,this,Bo).call(this):u(Mo,this,Vo).call(this),u(Mo,this,Uo).call(this,this.opened))}requestClose(){this.opened=!1}};function Bo(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(m(ko,this)?.call(this),h(ko,this,So(this))),m(Ao,this)||(h(Ao,this,!0),Eo())}function Vo(){let e=this.dialogElement;e?.open&&e.close(),m(ko,this)?.call(this),h(ko,this,null),u(Mo,this,Ho).call(this)}function Ho(){m(Ao,this)&&(h(Ao,this,!1),Do())}function Uo(e){u(Mo,this,Wo).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&u(Mo,this,Wo).call(this,e?`craft-after-show`:`craft-after-hide`)})}function Wo(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}zo.styles=[go,Co],p([g({type:Boolean,attribute:`open`,reflect:!0})],zo.prototype,`opened`,void 0),p([g()],zo.prototype,`label`,void 0),p([g({type:Boolean,attribute:`non-modal`,reflect:!0})],zo.prototype,`nonModal`,void 0),p([g({type:Boolean,reflect:!0})],zo.prototype,`fullscreen`,void 0),p([g({type:Boolean,attribute:`close-on-outside-click`})],zo.prototype,`closeOnOutsideClick`,void 0),p([g({type:Boolean,attribute:`no-close`,reflect:!0})],zo.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,zo);var Go=new WeakMap,Ko=new WeakSet,qo=class{constructor(e,t){this.host=e,this.source=t,d(this,Ko),f(this,Go,null),e.addController(this)}hostConnected(){u(Ko,this,Jo).call(this)}hostDisconnected(){u(Ko,this,Yo).call(this)}resubscribe(){u(Ko,this,Yo).call(this),u(Ko,this,Jo).call(this)}get state(){return this.source()?.state??null}};function Jo(){h(Go,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function Yo(){m(Go,this)?.call(this),h(Go,this,null)}var Xo=a`
  :host {
    /*
...
`,Zo=new WeakMap,Qo=new WeakMap,$o=new WeakMap,es=new WeakMap,ts=new WeakMap,ns=class extends zo{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,f(this,Zo,new qo(this,()=>this.controller)),f(this,Qo,null),f(this,$o,()=>{this.submit()}),f(this,es,()=>{this.busy||this.requestClose()}),f(this,ts,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&h(Qo,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),m(Qo,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&m(Zo,this).resubscribe();let t=m(Zo,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&m(Qo,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
    ...
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};ns.styles=[...zo.styles,Xo],p([g({attribute:!1})],ns.prototype,`controller`,void 0),p([g({type:Boolean,attribute:`show-title`,reflect:!0})],ns.prototype,`showTitle`,void 0),p([g({attribute:`select-label`})],ns.prototype,`selectLabel`,void 0),p([g({attribute:`cancel-label`})],ns.prototype,`cancelLabel`,void 0),p([g({type:Boolean,reflect:!0})],ns.prototype,`busy`,void 0),p([g({type:Boolean,reflect:!0})],ns.prototype,`loading`,void 0),p([g({type:Boolean,attribute:`can-submit`,reflect:!0})],ns.prototype,`canSubmit`,void 0),p([g({type:Boolean,reflect:!0})],ns.prototype,`narrow`,void 0),p([_()],ns.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,ns);var rs=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
...
`,pc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(pc);var mc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(mc);var hc=new Set([`clip`,`hidden`]),gc=class extends dr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=pc.Raised,this.variant=mc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!hc.has(n)&&e.scrollHeight-e.clientHeight>1||!hc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};gc.styles=[go,fc],p([g({reflect:!0})],gc.prototype,`appearance`,void 0),p([g({reflect:!0})],gc.prototype,`variant`,void 0),p([g()],gc.prototype,`label`,void 0),p([_()],gc.prototype,`_hasSlottedHeader`,void 0),p([_()],gc.prototype,`_hasSlottedFooter`,void 0),p([_()],gc.prototype,`_scrollable`,void 0),p([_()],gc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,gc);var _c=0,vc=new WeakMap,H=new WeakSet,yc=class extends l{constructor(...e){super(...e),d(this,H),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,vc,++_c)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(H,this,Ac).call(this)}render(){let e=u(H,this,Sc).call(this);return Ja(this.groups,e=>e.handle,(t,n)=>u(H,this,bc).call(this,t,n,e))}};function bc(e,t,n){let i=`permission-tree-heading-${m(vc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>u(H,this,Ec).call(this,e.keys,n)}
                >
                  ${u(H,this,Tc).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${u(H,this,xc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function xc(e,t,n,i){return Ja(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(H,this,wc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||u(H,this,Cc).call(this,o,i)}
                @model-value-changed=${e=>u(H,this,Dc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?u(H,this,xc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function Sc(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function Cc(e,t){return t.has(e.toLowerCase())}function wc(e,t){return this.modelValue.includes(e)||u(H,this,Cc).call(this,e,t)}function Tc(e,t){let n=e.filter(e=>!u(H,this,Cc).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function Ec(e,t){let n=e.filter(e=>!u(H,this,Cc).call(this,e,t));if(u(H,this,Tc).call(this,e,t)){let e=new Set(n);u(H,this,kc).call(this,this.modelValue.filter(t=>!e.has(t)));return}u(H,this,kc).call(this,[...new Set([...this.modelValue,...n])])}function Dc(e,t,n,r){if(e.stopPropagation(),this.disabled||u(H,this,Cc).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){u(H,this,kc).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...u(H,this,Oc).call(this,n)]);u(H,this,kc).call(this,this.modelValue.filter(e=>!o.has(e)))}function Oc(e){return Object.values(e).flatMap(e=>[e.key,...u(H,this,Oc).call(this,e.nested??{})])}function kc(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function Ac(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;u(H,this,jc).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&u(H,this,jc).call(this,`${this.name}[]`,t)}function jc(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}yc.styles=a`
    :host {
      display: block;
    }
...
`,Nc=new WeakMap,Pc=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,f(this,Nc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&m(Nc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),h(Nc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,h(Nc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
    ...
    `}};Pc.styles=[Mc],p([g({type:Number})],Pc.prototype,`progress`,void 0),p([g({type:Number})],Pc.prototype,`total`,void 0),p([g({type:Number})],Pc.prototype,`processed`,void 0),p([g({type:Boolean,attribute:`show-status`})],Pc.prototype,`showStatus`,void 0),p([g({type:Boolean,reflect:!0})],Pc.prototype,`pending`,void 0),p([g({type:Boolean})],Pc.prototype,`smooth`,void 0),p([g({type:String})],Pc.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Pc);var Fc=class extends Ni(Li(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Ic=class extends Fi(zi){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Lc=class extends Fc{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,br,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Lc.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Lc);var Rc=class extends Ui(Ic){static get styles(){return[...super.styles,a`
...
`,U=new WeakSet,nl=class extends l{constructor(...e){super(...e),d(this,U),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(U,this,il).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(U,this,rl).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${u(U,this,ol).call(this,this.value)}
      ...
      >
        ${e.map(e=>r`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(U,this,cl).call(this,e)}
              title=${u(U,this,ol).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function rl(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function il(e){u(U,this,rl).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function al(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function ol(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function sl(e,t){let n=u(U,this,il).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function cl(e){this.readOnly||u(U,this,sl).call(this,e,!0)}function ll(e){if(this.readOnly)return;let t=u(U,this,al).call(this);switch(e.key){case`ArrowUp`:u(U,this,sl).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(U,this,sl).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(U,this,sl).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(U,this,sl).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(U,this,sl).call(this,this.min,!0),e.preventDefault();break;case`End`:u(U,this,sl).call(this,this.max,!0),e.preventDefault();break}}nl.styles=[tl],p([g({type:Number})],nl.prototype,`min`,void 0),p([g({type:Number})],nl.prototype,`max`,void 0),p([g({type:Number})],nl.prototype,`step`,void 0),p([g({type:Number})],nl.prototype,`value`,void 0),p([g()],nl.prototype,`label`,void 0),p([g({attribute:`described-by`})],nl.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],nl.prototype,`valueUnit`,void 0),p([g({attribute:!1})],nl.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],nl.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,nl);var ul=a`
  :host {
    display: block;
  }
...
`,dl=new WeakMap,fl=new WeakMap,pl=new WeakMap,ml=new WeakMap,hl=new WeakMap,gl=new WeakMap,W=new WeakSet,_l=class extends l{constructor(...e){super(...e),d(this,W),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,dl,!1),f(this,fl,!1),f(this,pl,0),f(this,ml,0),f(this,hl,0),f(this,gl,null)}connectedCallback(){super.connectedCallback(),h(gl,this,new ResizeObserver(()=>u(W,this,yl).call(this))),m(gl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(gl,this)?.disconnect(),h(gl,this,null)}firstUpdated(){h(hl,this,(u(W,this,vl).call(this).length-1)*10),u(W,this,yl).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(W,this,yl).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(W,this,bl).call(this,this.value)}
        @keydown=${u(W,this,kl)}
        @pointerdown=${u(W,this,Tl)}
        @pointermove=${u(W,this,El)}
        @pointerup=${u(W,this,Dl)}
      >
        <div class="overlay"></div>
        <div class="cursor"></div>
        <div class="graduations">
          <ul aria-hidden="true">
            ${u(W,this,vl).call(this).map(e=>r`
                <li
                  class=${S({graduation:!0,"main-graduation":e%5==0,selected:u(W,this,Al).call(this,e)})}
                  data-graduation=${e}
                >
    ...
    `}};function vl(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function yl(){this._list&&(this._list.style.left=`${u(W,this,Sl).call(this,this.value)}px`)}function bl(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function xl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(hl,this)*n-t}function Sl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(hl,this)/n-this._graduations.offsetWidth/2)}function Cl(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);this.value=n,t&&u(W,this,wl).call(this,`change`)}function wl(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function Tl(e){h(fl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(fl,this)&&(e.preventDefault(),h(pl,this,e.clientX),h(ml,this,this._list.offsetLeft),this._root.setPointerCapture(e.pointerId),u(W,this,wl).call(this,`start`))}function El(e){m(fl,this)&&Math.abs(e.clientX-m(pl,this))>3&&(h(dl,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(W,this,Ol).call(this,e))}function Dl(e){m(fl,this)&&(m(dl,this)?(e.preventDefault(),h(dl,this,!1),this._root.classList.remove(`dragging`)):u(W,this,Ol).call(this,e),u(W,this,wl).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(pl,this,0),h(fl,this,!1))}function Ol(e){let t=m(dl,this)?m(pl,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(dl,this)?t-e.clientX:e.clientX-t,r=m(ml,this)-n;u(W,this,Cl).call(this,u(W,this,xl).call(this,r))}function kl(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(W,this,Cl).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(W,this,Cl).call(this,t-1);break;case`PageUp`:u(W,this,Cl).call(this,t+10);break;case`PageDown`:u(W,this,Cl).call(this,t-10);break;case`Home`:u(W,this,Cl).call(this,this.min);break;case`End`:u(W,this,Cl).call(this,this.max);break;default:return}e.preventDefault()}function Al(e){return e>=Math.min(0,this.value)&&e<=Math.max(0,this.value)}_l.styles=[ul],p([g({type:Number})],_l.prototype,`min`,void 0),p([g({type:Number})],_l.prototype,`max`,void 0),p([g({type:Number})],_l.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],_l.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],_l.prototype,`graduationMax`,void 0),p([g()],_l.prototype,`label`,void 0),p([y(`.slide-rule`)],_l.prototype,`_root`,void 0),p([y(`.graduations`)],_l.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],_l.prototype,`_list`,void 0),p([y(`.cursor`)],_l.prototype,`_cursor`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,_l);var jl=a`
  :host {
    display: inline-flex;
...
`,Ml=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      ...
      ></span>
    `}};Ml.styles=[jl],p([g()],Ml.prototype,`label`,void 0),p([g()],Ml.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Ml);var Nl=class extends De(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
...
`,eu={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(eu);var tu={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(tu);var nu=[eu.InlineStart,eu.InlineEnd],ru=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),G=new WeakSet,iu=new WeakMap,au=new WeakMap,ou=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakMap,du=new WeakMap,fu=new WeakMap,pu=new WeakMap,mu=new WeakMap,hu=class extends Ql{constructor(...e){super(...e),d(this,G),this.placement=eu.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,iu,[]),f(this,au,!1),f(this,ou,[]),f(this,su,0),f(this,cu,void 0),f(this,lu,!1),f(this,uu,e=>{if(!this.collapsible||_u.call(u(G,this)))return;let t=u(G,this,bu).call(this,e.target);!t||t.disabled||K.call(u(G,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(G,this,xu).call(this,!0))}),f(this,du,e=>{e.key!==`Escape`||!this.collapsible||_u.call(u(G,this))||u(G,this,bu).call(this,e.target)&&(e.stopPropagation(),u(G,this,xu).call(this,!0))}),f(this,fu,()=>{_u.call(u(G,this))&&(K.call(u(G,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(G,this,Su).call(this)}),f(this,pu,()=>{if(u(G,this,Cu).call(this),K.call(u(G,this)).forEach((e,t)=>{let n=()=>u(G,this,ju).call(this,t,!0),r=e=>{ru.has(e.key)&&e.preventDefault()},i=e=>u(G,this,Mu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(iu,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),K.call(u(G,this))[this.selectedIndex]?.disabled){let e=K.call(u(G,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(G,this,wu).call(this)}),f(this,mu,()=>{m(lu,this)||(h(lu,this,!0),requestAnimationFrame(()=>{h(lu,this,!1),u(G,this,Eu).call(this)}))})}static get styles(){return[...super.styles,go,$l]}get layout(){return gu.call(u(G,this))?tu.Vertical:tu.Horizontal}set layout(e){this.placement=e===tu.Vertical?eu.InlineStart:eu.BlockStart}refresh(){m(au,this)&&u(G,this,wu).call(this),u(G,this,Eu).call(this)}firstUpdated(e){h(au,this,K.call(u(G,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(au,this))t?.addEventListener(`slotchange`,m(pu,this)),m(pu,this).call(this);else{let n=_u.call(u(G,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(fu,this))}this.addEventListener(`click`,m(uu,this),!0),this.addEventListener(`keydown`,m(du,this)),t?.addEventListener(`slotchange`,m(mu,this)),h(cu,this,new ResizeObserver(m(mu,this))),m(cu,this).observe(this),u(G,this,Eu).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(G,this,Cu).call(this),m(cu,this)?.disconnect(),h(cu,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,_u.call(u(G,this))),e.has(`selectedIndex`)&&(m(au,this)?u(G,this,wu).call(this):m(fu,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(G,this,Eu).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${gu.call(u(G,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${_u.call(u(G,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function gu(){return nu.includes(this.placement)}function _u(){return this.selectedIndex<0}function K(){return this.tabs}function vu(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function yu(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function bu(e){return e instanceof Node?K.call(u(G,this)).find(t=>t===e||t.contains(e))??null:null}function xu(e){let t=K.call(u(G,this))[this.selectedIndex];h(su,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Su(){let e=K.call(u(G,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(su,this))?m(su,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function Cu(){for(;m(iu,this).length;)m(iu,this).pop()?.()}function wu(){let e=K.call(u(G,this)).map(e=>u(G,this,Tu).call(this,e)),t=e.some(Boolean);K.call(u(G,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${He()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(G,this,Su).call(this)}function Tu(e){return e.controls?document.getElementById(e.controls):null}function Eu(){let e=vu.call(u(G,this)),t=yu.call(u(G,this)),n=K.call(u(G,this));if(!e||!t)return;if(gu.call(u(G,this))||n.length===0){u(G,this,Ou).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(G,this,Du).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(G,this,Ou).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(G,this,Ou).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Du(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function Ou(e){let t=yu.call(u(G,this)),n=new Set(e);K.call(u(G,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(ou,this,e),t&&(t.hidden=e.length===0,t.actions=u(G,this,ku).call(this))}function ku(){return m(ou,this).map(e=>{let t=K.call(u(G,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(G,this,Au).call(this,e)}})}function Au(e){let t=K.call(u(G,this))[e];if(!t||t.disabled)return;let n=yu.call(u(G,this));n&&(n.opened=!1),this.selectedIndex=e,u(G,this,Eu).call(this),t.focus()}function ju(e,t){let n=K.call(u(G,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Mu(e){if(!ru.has(e.key))return;let t=u(G,this,Nu).call(this,e.key);t!==-1&&u(G,this,ju).call(this,t,!0)}function Nu(e){let t=K.call(u(G,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(_u.call(u(G,this)))return u(G,this,Nu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],hu.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],hu.prototype,`collapsible`,void 0),p([g({reflect:!0})],hu.prototype,`layout`,null),p([g({reflect:!0})],hu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,hu);var Pu=a`
  :host {
    display: inline-flex;
...
`,Wu=new WeakMap,Gu=new WeakMap,Ku=new WeakMap,qu=new WeakSet,Ju=class extends Hu{constructor(...e){super(...e),d(this,qu),this.monospace=!1,f(this,Wu,void 0),f(this,Gu,void 0),f(this,Ku,null)}static get styles(){return[...super.styles,br,Uu]}connectedCallback(){super.connectedCallback(),u(qu,this,Yu).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(Wu,this)?.disconnect(),h(Wu,this,void 0),m(Gu,this)?.disconnect(),h(Gu,this,void 0)}};function Yu(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(Ku,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(Ku,this,e.style.height)}),h(Gu,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(Gu,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(Wu,this,new ResizeObserver(()=>{if(e.style.height===m(Ku,this))return;let t=e.style.height;Bu.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(Gu,this)?.disconnect(),h(Gu,this,void 0),m(Wu,this)?.disconnect(),h(Wu,this,void 0)})),m(Wu,this).observe(e))}p([g({type:Boolean,reflect:!0})],Ju.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Ju);var Xu=a`
  :host {
    display: block;
    min-width: 0;
  }

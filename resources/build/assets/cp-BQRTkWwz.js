...
import{a as e,t}from"./rolldown-runtime-CNC7AqOf.js";import{a as n,c as r,d as i,f as a,i as o,n as s,r as c,t as l}from"./lit-DNaDb1T7.js";import{A as u,D as d,M as f,N as p,O as m,P as h,S as g,_,b as v,c as y,d as b,f as x,h as S,i as C,j as w,k as ee,l as T,m as te,n as ne,o as re,p as ie,r as ae,s as oe,u as se,v as ce,x as E,y as le}from"./nav-item-dDjxs2dE-9idAgG5g.js";import{t as D}from"./decorate-B3KLIx2E-B3KLIx2E.js";import{n as O,t as k}from"./decorators-D0-gbKXH.js";import{n as ue,t as de}from"./query-Df4-SAIv.js";import{a as A,i as j,o as M,r as N,s as P}from"./axios-Mm3N8iqg.js";import{t as fe}from"./actionClient-NFMyfrDL-DsDU7tG9.js";import"./nav-list.ts-DPwcLr0r.js";import"./progress.ts-uVZQ_tSZ.js";import"./apiClient.ts-Ch6pjDG0.js";a`
  :host([data-color='red']),
  [data-color='red'] {
...
`,me={Neutral:`neutral`,Success:`success`,Warning:`warning`,Danger:`danger`,Info:`info`},he=Object.values(me),ge=class{constructor(e,t={}){this.host=e,this.options=t,this.observer=new MutationObserver(()=>{this.options.onChange?.(),this.host.requestUpdate()}),e.addController(this)}hostConnected(){this.options.onChange?.(),this.observer.observe(this.host,{childList:!0,subtree:!0,characterData:this.options.characterData??!1,attributes:!0,attributeFilter:[`slot`,...this.options.attributeFilter??[]]})}hostDisconnected(){this.observer.disconnect()}};function _e(e,...t){return Array.from(e.children).some(e=>t.includes(e.slot))}function ve(e){return(t,n)=>{let{slot:r,selector:i}=e??{},a=`slot`+(r?`[name=${r}]`:`:not([name])`);return ue(t,n,{get(){let t=(this.renderRoot?.querySelector(a))?.assignedElements(e)??[];return i===void 0?t:t.filter((e=>e.matches(i)))}})}}var ye=class extends l{constructor(){super(),this.alt=!1,this.shift=!1,this.os=`Unknown`,this.os=this.detectOS()}connectedCallback(){super.connectedCallback(),this.os===`Unknown`&&(this.os=this.detectOS())}detectOS(){let e=navigator.platform.toLowerCase();return e.includes(`mac`)||/iphone|ipad|ipod/.test(e)?`Mac`:e.includes(`win`)?`Windows`:e.includes(`linux`)?`Linux`:`Unknown`}renderShortcutPrefix(){switch(this.os){case`Mac`:return`${this.alt?`⌥`:``}${this.shift?`⇧`:``}⌘`;case`Linux`:return`Super+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`;default:return`Ctrl+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`}}render(){return r`<span class="shortcut"
  ...
  `,D([O({type:Boolean})],ye.prototype,`alt`,void 0),D([O({type:Boolean})],ye.prototype,`shift`,void 0),D([O()],ye.prototype,`os`,void 0),customElements.get(`craft-shortcut`)||customElements.define(`craft-shortcut`,ye);var{I:be}=n,xe=e=>e===null||typeof e!=`object`&&typeof e!=`function`,Se=(e,t)=>t===void 0?e?._$litType$!==void 0:e?._$litType$===t,Ce=e=>e.strings===void 0,we=()=>document.createComment(``),Te=(e,t,n)=>{let r=e._$AA.parentNode,i=t===void 0?e._$AB:t._$AA;if(n===void 0)n=new be(r.insertBefore(we(),i),r.insertBefore(we(),i),e,e.options);else{let t=n._$AB.nextSibling,a=n._$AM,o=a!==e;if(o){let t;n._$AQ?.(e),n._$AM=e,n._$AP!==void 0&&(t=e._$AU)!==a._$AU&&n._$AP(t)}if(t!==i||o){let e=n._$AA;for(;e!==t;){let t=e.nextSibling;r.insertBefore(e,i),e=t}}}return n},Ee=(e,t,n=e)=>(e._$AI(t,n),e),De={},Oe=(e,t=De)=>e._$AH=t,ke=e=>e._$AH,Ae=e=>{e._$AR(),e._$AA.remove()},je=a`
  :host {
    display: contents;
  }
...
`,Me=[`a[href]`,`button`,`input`,`select`,`textarea`,`[tabindex]:not([tabindex="-1"])`,`craft-button`,`craft-action-item`,`craft-checkbox`,`craft-switch`].join(`, `),F=class extends l{constructor(...e){super(...e),this.icon=null,this.iconColor=null,this.href=null,this.target=null,this.rel=null,this.disabled=!1,this.variant=me.Neutral,this.checked=!1,this.active=!1,this.current=!1,this.type=`button`,this.action=null,this.feedback=null,this.feedbackDuration=1e3,this.state=h.Idle,this.feedbackMessage=null,this.shortcut=null,this._hasNestedControl=!1,this._lightDom=new ge(this,{onChange:()=>this._checkSuffixForControls()})}renderShortcut(){return typeof this.shortcut==`string`?r`<craft-shortcut>${this.shortcut}</craft-shortcut>`:this.shortcut===null?c:r`<craft-shortcut
        ?alt="${this.shortcut.alt??!1}"
        ?shift="${this.shortcut.shift??!1}"
        >${this.shortcut.key}</craft-shortcut
      >`}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this)}setState(e,t={}){this.state=e,this.feedbackMessage=t.message??null,this.dispatchEvent(new CustomEvent(`craft-state-change`,{bubbles:!0,composed:!0,detail:{state:e,actionType:v(this.action)?.type,...t}}))}async handleEvent(e){if(this.disabled){e.preventDefault();return}let t=v(this.action);if(e.type===`click`&&t){t.type===`http`&&this.setState(h.Loading);try{await le(t,{trigger:this,sourceEvent:e}),this.setState(h.Success,this.feedback?.success)}catch(e){this.setState(h.Error,{message:e.message,...this.feedback?.error||{}})}finally{setTimeout(()=>{this.setState(h.Idle)},this.feedbackDuration)}}}renderCheckbox(){return r`<span class="action-item__check">
      <slot name="checkmark">
        ${this.checked?r`<craft-icon name="check"></craft-icon>`:c}
      </slot>
    </span>`}renderIcon(){switch(this.state){case h.Loading:return r`<craft-spinner style="--size: 0.8em"></craft-spinner>`;case h.Success:return r`<craft-icon
          name="check"
          style="color: var(--c-color-success-on-normal)"
        ></craft-icon>`;case h.Error:return r`<craft-icon
          name="xmark"
    ...
    `}_checkSuffixForControls(){this._hasNestedControl=Array.from(this.children).some(e=>e.slot===`suffix`&&e.matches(Me))}renderBody(){return r`
      ${this.renderPrefix()}
      ...
      <span
        class="${E({"action-item__suffix":!0,"a11y-error":this._hasNestedControl})}"
      >
    ...
    `}render(){return this.href?r`
          <a
            class="${E({"action-item":!0,"action-item--checkbox":this.type===`checkbox`})}"
            href="${this.href}"
            aria-current="${this.current?`true`:c}"
            target="${ce(this.target??void 0)}"
            rel="${ce(this.rel??(this.target===`_blank`?`noopener`:null)??void 0)}"
          >
            ${this.renderBody()}
          </a>
        `:r`
    ...
    `],Le._filterableItemsSelector=`craft-action-item, li, button`,D([O({attribute:!1})],Le.prototype,`actions`,void 0),D([O()],Le.prototype,`label`,void 0),D([O()],Le.prototype,`icon`,void 0),D([O({type:Boolean,reflect:!0})],Le.prototype,`disabled`,void 0),D([O({type:Boolean,reflect:!0})],Le.prototype,`searchable`,void 0),D([ve({slot:`invoker`})],Le.prototype,`invokerNodes`,void 0),D([ve({slot:`content`})],Le.prototype,`contentNodes`,void 0),customElements.get(`craft-action-menu`)||customElements.define(`craft-action-menu`,Le);var Re=a`
  :host {
...
`,ze=class extends l{constructor(...e){super(...e),this.label=null,this._gradientId=null}connectedCallback(){super.connectedCallback(),this._gradientId=`avatar-gradient-${Math.random().toString(36).slice(2,8)}`}text(){return this.label?this.label.split(` `).map(e=>e.charAt(0).toUpperCase()).join(``):`?`}render(){return r`
      <span class="avatar">
        <svg
          viewBox="0 0 100 100"
        ...
        >
          ${this.label?r`<title>${this.label}</title>`:c}
          <defs>
            <linearGradient
              id="${this._gradientId}"
              x1="0"
    ...
    `}};ze.styles=[Re],D([O()],ze.prototype,`label`,void 0),D([k()],ze.prototype,`_gradientId`,void 0),customElements.get(`craft-avatar`)||customElements.define(`craft-avatar`,ze);var Be=[`red`,`orange`,`amber`,`yellow`,`lime`,`green`,`emerald`,`teal`,`cyan`,`sky`,`blue`,`indigo`,`violet`,`purple`,`fuchsia`,`pink`,`rose`,`white`,`gray`,`black`,`slate`],Ve={neutral:`slate`,accent:`blue`,info:`sky`,success:`emerald`,warning:`yellow`,danger:`red`},He={pending:`orange`,off:`red`,suspended:`red`,expired:`red`,disabled:`gray`,inactive:`gray`,on:`emerald`},Ue=e=>e.charAt(0).toUpperCase()+e.slice(1),We={...Object.fromEntries(Be.map(e=>[Ue(e),e])),...Object.fromEntries(Object.entries(Ve).map(([e,t])=>[Ue(e),t])),...Object.fromEntries(Object.entries(He).map(([e,t])=>[Ue(e),t]))},Ge=[...Be],Ke=class extends l{constructor(...e){super(...e),this.size=`md`,this.fill=`var(--c-color-fill-loud)`,this.label=null,this.appearance=oe.OutlineFill}getFill(){return Ge.includes(this.fill)||he.includes(this.fill)?`var(--c-color-${this.fill}-fill-loud)`:this.fill}getSize(){switch(this.size){case`md`:return`0.6em`;case`lg`:return`1em`;default:return this.size}}render(){return r`<span
      style="--fill: ${this.getFill()}; --size: ${this.getSize()}"
      aria-label="${this.label??c}"
      role="${this.label?`img`:c}"
      class="${E({indicator:!0,"indicator--outline":this.appearance===oe.Outline})}"
    ></span>`}};Ke.styles=[pe,a`
      :host {
        display: contents;
      }
    ...
    `],D([O()],Ke.prototype,`size`,void 0),D([O({reflect:!0})],Ke.prototype,`fill`,void 0),D([O()],Ke.prototype,`label`,void 0),D([O({reflect:!0})],Ke.prototype,`appearance`,void 0),customElements.get(`craft-indicator`)||customElements.define(`craft-indicator`,Ke);var qe=a`
  :host {
    display: inline-flex;
  }
...
`,Je={Small:`small`,Medium:`medium`,Large:`large`};Object.values(Je);var Ye=class extends l{constructor(...e){super(...e),this.fill=We.Gray,this.noPrefix=!1,this.size=Je.Medium}getFill(){return this.fill}willUpdate(e){e.has(`fill`)&&(this.dataset.color=this.getFill())}render(){return r`
      <span
        part="badge"
        class="${E({badge:!0,"badge--small":this.size===Je.Small,"badge--large":this.size===Je.Large})}"
      >
    ...
    `}};Ye.styles=[qe],D([O({reflect:!0})],Ye.prototype,`fill`,void 0),D([O({attribute:`no-prefix`,type:Boolean})],Ye.prototype,`noPrefix`,void 0),D([O()],Ye.prototype,`size`,void 0),customElements.get(`craft-badge`)||customElements.define(`craft-badge`,Ye);var Xe=class extends l{constructor(...e){super(...e),this.rel=`noreferrer noopener`}render(){return r`
...
`,Qe=class extends l{constructor(...e){super(...e),this.label=_(`Breadcrumbs`),this.items=[],this.visibleItems=0,this.firstRender=!0}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}calculateBreadcrumbItemsWidth(){this.items=this.breadcrumbsElements.map((e,t)=>{let n=e.offsetWidth;return e.hasAttribute(`hidden`)&&(e.removeAttribute(`hidden`),n=e.offsetWidth,e.setAttribute(`hidden`,``)),{label:e.innerText,href:e.href,value:t.toString(),offsetWidth:n,isVisible:!0}})}async handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`craft-breadcrumb-item`);if(e.forEach((t,n)=>{let r=n===e.length-1,i=t.querySelector(`[slot="separator"]`);r?i?.hasAttribute(`data-default`)&&i.remove():i===null?t.append(this.getSeparator()):i.hasAttribute(`data-default`)&&i.replaceWith(this.getSeparator()),r?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)}),this.breadcrumbsElements.length===0){this.items=[],this.visibleItems=0;return}await Promise.all(this.breadcrumbsElements.map(e=>e.updateComplete)),this.calculateBreadcrumbItemsWidth(),this.visibleItems=0,this.adjustOverflow()}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{if(this.firstRender){this.firstRender=!1;return}this.adjustOverflow()}),this.resizeObserver.observe(this)}adjustOverflow(){}disconnectedCallback(){this.resizeObserver?.unobserve(this),super.disconnectedCallback()}render(){return r`
    ...
    `}};Qe.styles=[Ze],D([de(`slot`)],Qe.prototype,`defaultSlot`,void 0),D([de(`slot[name="separator"]`)],Qe.prototype,`separatorSlot`,void 0),D([ve({selector:`craft-breadcrumb-item`})],Qe.prototype,`breadcrumbsElements`,void 0),D([O()],Qe.prototype,`label`,void 0),D([k()],Qe.prototype,`items`,void 0),D([k()],Qe.prototype,`visibleItems`,void 0),customElements.get(`craft-breadcrumbs`)||customElements.define(`craft-breadcrumbs`,Qe);var $e=a`
  :host {
...
`,at=class extends rt(l,{customProperty:[`--_callout-padding-block`,`--_callout-padding-inline`]}){constructor(...e){super(...e),this.variant=me.Neutral,this.appearance=oe.OutlineFill,this.title=``,this.icon=null,this.hideIcon=!1,this.rounded=`all`,this.inline=!1,this.size=`auto`,this.resolvedIcon=null}willUpdate(){this.resolvedIcon=this.icon??this.getDefaultIcon()}getDefaultIcon(){switch(this.variant){case me.Info:return`lightbulb`;case me.Success:return`circle-check`;case me.Warning:return`circle-exclamation`;case me.Danger:return`triangle-exclamation`;default:return null}}render(){let e=this.title||!!this.querySelector(`[slot="title"]`),t=!this.hideIcon&&(!!this.resolvedIcon||!!this.querySelector(`[slot="icon"]`));return r`
      <div
        data-variant="${this.variant}"
        style="${C(this.paddingStyles)}"
        class="${E({callout:!0,"callout--hide-icon":!t,"callout--title":e,"callout--small":this.size===`small`})}"
      >
    ...
    `}};at.styles=[pe,it],D([O({reflect:!0})],at.prototype,`variant`,void 0),D([O({reflect:!0})],at.prototype,`appearance`,void 0),D([O()],at.prototype,`title`,void 0),D([O()],at.prototype,`icon`,void 0),D([O({type:Boolean,attribute:`hide-icon`})],at.prototype,`hideIcon`,void 0),D([O({reflect:!0})],at.prototype,`rounded`,void 0),D([O({reflect:!0,type:Boolean})],at.prototype,`inline`,void 0),D([O()],at.prototype,`size`,void 0),D([k()],at.prototype,`resolvedIcon`,void 0),customElements.get(`craft-callout`)||customElements.define(`craft-callout`,at);var ot=a`
  :host {
    display: block;
  }
...
`,st=class extends rt(l,{customProperty:[`--c-card-padding-block`,`--c-card-padding-inline`]}){constructor(...e){super(...e),this.label=``,this.active=!1,this.collapsed=!1,this.showThumb=!0,this.thumbAlignment=`start`,this._lightDom=new ge(this)}render(){let e=!!this.label||_e(this,`header`,`label`,`actions`),t=_e(this,`footer`),n=this.showThumb&&_e(this,`thumbnail`);return r`
      <div
        part="base"
        class="${E({card:!0,"card--has-thumbnail":n})}"
        style="${C(this.paddingStyles)}"
      >
        ${e?r`<div class="card__header" part="header">
              <slot name="header">
        ...
        <div
          part="body"
          class="${E({"card-body":!0,"card-body--thumb-start":n&&this.thumbAlignment===`start`,"card-body--thumb-end":n&&this.thumbAlignment===`end`})}"
        >
          <div
        ...
        ${t?r`<div class="card__footer" part="footer">
              <slot name="footer"></slot>
            </div>`:c}
      </div>
    `}};st.styles=[ot],D([O()],st.prototype,`label`,void 0),D([O({type:Boolean,reflect:!0})],st.prototype,`active`,void 0),D([O({type:Boolean,reflect:!0})],st.prototype,`collapsed`,void 0),D([O({attribute:`show-thumb`,type:Boolean})],st.prototype,`showThumb`,void 0),D([O({attribute:`thumb-alignment`})],st.prototype,`thumbAlignment`,void 0),customElements.get(`craft-card`)||customElements.define(`craft-card`,st);var ct=a`
...
`,mt=(e,t)=>{class n extends e{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="${t}"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}}return n},ht=window,gt=new WeakMap;function _t(e){ht.applyFocusVisiblePolyfill&&!gt.has(e)&&(ht.applyFocusVisiblePolyfill(e),gt.set(e,void 0))}var vt=S(e=>class extends e{static get properties(){return{focused:{type:Boolean,reflect:!0},focusedVisible:{type:Boolean,reflect:!0,attribute:`focused-visible`},autofocus:{type:Boolean,reflect:!0}}}constructor(){super(),this.focused=!1,this.focusedVisible=!1,this.autofocus=!1}firstUpdated(e){super.firstUpdated(e),this.__registerEventsForFocusMixin(),this.__syncAutofocusToFocusableElement()}disconnectedCallback(){super.disconnectedCallback(),this.__teardownEventsForFocusMixin()}updated(e){super.updated(e),e.has(`autofocus`)&&this.__syncAutofocusToFocusableElement()}__syncAutofocusToFocusableElement(){this._focusableNode&&(this.hasAttribute(`autofocus`)?this._focusableNode.setAttribute(`autofocus`,``):this._focusableNode.removeAttribute(`autofocus`))}focus(){this._focusableNode?.focus()}blur(){this._focusableNode?.blur()}get _focusableNode(){return this._inputNode||document.createElement(`input`)}__onFocus(){if(this.focused=!0,typeof ht.applyFocusVisiblePolyfill==`function`)this.focusedVisible=this._focusableNode.hasAttribute(`data-focus-visible-added`);else try{this.focusedVisible=this._focusableNode.matches(`:focus-visible`)}catch{this.focusedVisible=!1}}__onBlur(){this.focused=!1,this.focusedVisible=!1}__registerEventsForFocusMixin(){_t(this.getRootNode()),this.__redispatchFocus=e=>{e.stopPropagation(),this.dispatchEvent(new Event(`focus`))},this._focusableNode.addEventListener(`focus`,this.__redispatchFocus),this.__redispatchBlur=e=>{e.stopPropagation(),this.dispatchEvent(new Event(`blur`))},this._focusableNode.addEventListener(`blur`,this.__redispatchBlur),this.__redispatchFocusin=e=>{e.stopPropagation(),this.__onFocus(),this.dispatchEvent(new Event(`focusin`,{bubbles:!0,composed:!0}))},this._focusableNode.addEventListener(`focusin`,this.__redispatchFocusin),this.__redispatchFocusout=e=>{e.stopPropagation(),this.__onBlur(),this.dispatchEvent(new Event(`focusout`,{bubbles:!0,composed:!0}))},this._focusableNode.addEventListener(`focusout`,this.__redispatchFocusout)}__teardownEventsForFocusMixin(){this._focusableNode&&(this._focusableNode?.removeEventListener(`focus`,this.__redispatchFocus),this._focusableNode?.removeEventListener(`blur`,this.__redispatchBlur),this._focusableNode?.removeEventListener(`focusin`,this.__redispatchFocusin),this._focusableNode?.removeEventListener(`focusout`,this.__redispatchFocusout))}});function yt(e,t){return t={exports:{}},e(t,t.exports),t.exports}var bt=`long`,xt=`short`,St=`narrow`,I=`numeric`,Ct=`2-digit`,wt={number:{decimal:{style:`decimal`},integer:{style:`decimal`,maximumFractionDigits:0},currency:{style:`currency`,currency:`USD`},percent:{style:`percent`},default:{style:`decimal`}},date:{short:{month:I,day:I,year:Ct},medium:{month:xt,day:I,year:I},long:{month:bt,day:I,year:I},full:{month:bt,day:I,year:I,weekday:bt},default:{month:xt,day:I,year:I}},time:{short:{hour:I,minute:I},medium:{hour:I,minute:I,second:I},long:{hour:I,minute:I,second:I,timeZoneName:xt},full:{hour:I,minute:I,second:I,timeZoneName:xt},default:{hour:I,minute:I,second:I}},duration:{default:{hours:{minimumIntegerDigits:1,maximumFractionDigits:0},minutes:{minimumIntegerDigits:2,maximumFractionDigits:0},seconds:{minimumIntegerDigits:2,maximumFractionDigits:3}}},parseNumberPattern:function(e){if(e){var t={},n=e.match(/\b[A-Z]{3}\b/i),r=e.replace(/[^¤]/g,``).length;if(!r&&n&&(r=1),r?(t.style=`currency`,t.currencyDisplay=r===1?`symbol`:r===2?`code`:`name`,t.currency=n?n[0].toUpperCase():`USD`):e.indexOf(`%`)>=0&&(t.style=`percent`),!/[@#0]/.test(e))return t.style?t:void 0;if(t.useGrouping=e.indexOf(`,`)>=0,/E\+?[@#0]+/i.test(e)||e.indexOf(`@`)>=0){var i=e.replace(/E\+?[@#0]+|[^@#0]/gi,``);t.minimumSignificantDigits=Math.min(Math.max(i.replace(/[^@0]/g,``).length,1),21),t.maximumSignificantDigits=Math.min(Math.max(i.length,1),21)}else{for(var a=e.replace(/[^#0.]/g,``).split(`.`),o=a[0],s=o.length-1;o[s]===`0`;)--s;t.minimumIntegerDigits=Math.min(Math.max(o.length-1-s,1),21);var c=a[1]||``;for(s=0;c[s]===`0`;)++s;for(t.minimumFractionDigits=Math.min(Math.max(s,0),20);c[s]===`#`;)++s;t.maximumFractionDigits=Math.min(Math.max(s,0),20)}return t}},parseDatePattern:function(e){if(e){for(var t={},n=0;n<e.length;){for(var r=e[n],i=1;e[++n]===r;)++i;switch(r){case`G`:t.era=i===5?St:i===4?bt:xt;break;case`y`:case`Y`:t.year=i===2?Ct:I;break;case`M`:case`L`:i=Math.min(Math.max(i-1,0),4),t.month=[I,Ct,xt,bt,St][i];break;case`E`:case`e`:case`c`:t.weekday=i===5?St:i===4?bt:xt;break;case`d`:case`D`:t.day=i===2?Ct:I;break;case`h`:case`K`:t.hour12=!0,t.hour=i===2?Ct:I;break;case`H`:case`k`:t.hour12=!1,t.hour=i===2?Ct:I;break;case`m`:t.minute=i===2?Ct:I;break;case`s`:case`S`:t.second=i===2?Ct:I;break;case`z`:case`Z`:case`v`:case`V`:t.timeZoneName=i===1?xt:bt;break}}return Object.keys(t).length?t:void 0}}},Tt=function(e,t){if(typeof e==`string`&&t[e])return e;for(var n=[].concat(e||[]),r=0,i=n.length;r<i;++r)for(var a=n[r].split(`-`);a.length;){var o=a.join(`-`);if(t[o])return o;a.pop()}},Et=`zero`,L=`one`,Dt=`two`,R=`few`,z=`many`,B=`other`,V=[function(e){return+e==1?L:B},function(e){var t=+e;return 0<=t&&t<=1?L:B},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return t===0||n===1?L:B},function(e){var t=+e;return t===0?Et:t===1?L:t===2?Dt:3<=t%100&&t%100<=10?R:11<=t%100&&t%100<=99?z:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?L:B},function(e){var t=+e;return t%10==1&&t%100!=11?L:2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?R:t%10==0||5<=t%10&&t%10<=9||11<=t%100&&t%100<=14?z:B},function(e){var t=+e;return t%10==1&&t%100!=11&&t%100!=71&&t%100!=91?L:t%10==2&&t%100!=12&&t%100!=72&&t%100!=92?Dt:(3<=t%10&&t%10<=4||t%10==9)&&(t%100<10||19<t%100)&&(t%100<70||79<t%100)&&(t%100<90||99<t%100)?R:t!==0&&t%1e6==0?z:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%10==1&&t%100!=11||r%10==1&&r%100!=11?L:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)||2<=r%10&&r%10<=4&&(r%100<12||14<r%100)?R:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?L:2<=t&&t<=4&&n===0?R:n===0?B:z},function(e){var t=+e;return t===0?Et:t===1?L:t===2?Dt:t===3?R:t===6?z:B},function(e){var t=Math.floor(Math.abs(+e)),n=+(``+e).replace(/^[^.]*.?|0+$/g,``);return+e==1||n!==0&&(t===0||t===1)?L:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%100==1||r%100==1?L:n===0&&t%100==2||r%100==2?Dt:n===0&&3<=t%100&&t%100<=4||3<=r%100&&r%100<=4?R:B},function(e){var t=Math.floor(Math.abs(+e));return t===0||t===1?L:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&(t===1||t===2||t===3)||n===0&&t%10!=4&&t%10!=6&&t%10!=9||n!==0&&r%10!=4&&r%10!=6&&r%10!=9?L:B},function(e){var t=+e;return t===1?L:t===2?Dt:3<=t&&t<=6?R:7<=t&&t<=10?z:B},function(e){var t=+e;return t===1||t===11?L:t===2||t===12?Dt:3<=t&&t<=10||13<=t&&t<=19?R:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%10==1?L:n===0&&t%10==2?Dt:n===0&&(t%100==0||t%100==20||t%100==40||t%100==60||t%100==80)?R:n===0?B:z},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+e;return t===1&&n===0?L:t===2&&n===0?Dt:n===0&&(r<0||10<r)&&r%10==0?z:B},function(e){var t=Math.floor(Math.abs(+e)),n=+(``+e).replace(/^[^.]*.?|0+$/g,``);return n===0&&t%10==1&&t%100!=11||n!==0?L:B},function(e){var t=+e;return t===1?L:t===2?Dt:B},function(e){var t=+e;return t===0?Et:t===1?L:B},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return n===0?Et:(t===0||t===1)&&n!==0?L:B},function(e){var t=+(e+`.`).split(`.`)[1],n=+e;return n%10==1&&(n%100<11||19<n%100)?L:2<=n%10&&n%10<=9&&(n%100<11||19<n%100)?R:t===0?B:z},function(e){var t=(e+`.`).split(`.`)[1].length,n=+(e+`.`).split(`.`)[1],r=+e;return r%10==0||11<=r%100&&r%100<=19||t===2&&11<=n%100&&n%100<=19?Et:r%10==1&&r%100!=11||t===2&&n%10==1&&n%100!=11||t!==2&&n%10==1?L:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%10==1&&t%100!=11||r%10==1&&r%100!=11?L:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+e;return t===1&&n===0?L:n!==0||r===0||r!==1&&1<=r%100&&r%100<=19?R:B},function(e){var t=+e;return t===1?L:t===0||2<=t%100&&t%100<=10?R:11<=t%100&&t%100<=19?z:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?L:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?R:n===0&&t!==1&&0<=t%10&&t%10<=1||n===0&&5<=t%10&&t%10<=9||n===0&&12<=t%100&&t%100<=14?z:B},function(e){var t=Math.floor(Math.abs(+e));return 0<=t&&t<=1?L:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%10==1&&t%100!=11?L:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?R:n===0&&t%10==0||n===0&&5<=t%10&&t%10<=9||n===0&&11<=t%100&&t%100<=14?z:B},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return t===0||n===1?L:2<=n&&n<=10?R:B},function(e){var t=Math.floor(Math.abs(+e)),n=+(e+`.`).split(`.`)[1],r=+e;return r===0||r===1||t===0&&n===1?L:B},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%100==1?L:n===0&&t%100==2?Dt:n===0&&3<=t%100&&t%100<=4||n!==0?R:B},function(e){var t=+e;return 0<=t&&t<=1||11<=t&&t<=99?L:B},function(e){var t=+e;return t===1||t===5||t===7||t===8||t===9||t===10?L:t===2||t===3?Dt:t===4?R:t===6?z:B},function(e){var t=Math.floor(Math.abs(+e));return t%10==1||t%10==2||t%10==5||t%10==7||t%10==8||t%100==20||t%100==50||t%100==70||t%100==80?L:t%10==3||t%10==4||t%1e3==100||t%1e3==200||t%1e3==300||t%1e3==400||t%1e3==500||t%1e3==600||t%1e3==700||t%1e3==800||t%1e3==900?R:t===0||t%10==6||t%100==40||t%100==60||t%100==90?z:B},function(e){var t=+e;return(t%10==2||t%10==3)&&t%100!=12&&t%100!=13?R:B},function(e){var t=+e;return t===1||t===3?L:t===2?Dt:t===4?R:B},function(e){var t=+e;return t===0||t===7||t===8||t===9?Et:t===1?L:t===2?Dt:t===3||t===4?R:t===5||t===6?z:B},function(e){var t=+e;return t%10==1&&t%100!=11?L:t%10==2&&t%100!=12?Dt:t%10==3&&t%100!=13?R:B},function(e){var t=+e;return t===1||t===11?L:t===2||t===12?Dt:t===3||t===13?R:B},function(e){var t=+e;return t===1?L:t===2||t===3?Dt:t===4?R:t===6?z:B},function(e){var t=+e;return t===1||t===5?L:B},function(e){var t=+e;return t===11||t===8||t===80||t===800?z:B},function(e){var t=Math.floor(Math.abs(+e));return t===1?L:t===0||2<=t%100&&t%100<=20||t%100==40||t%100==60||t%100==80?z:B},function(e){var t=+e;return t%10==6||t%10==9||t%10==0&&t!==0?z:B},function(e){var t=Math.floor(Math.abs(+e));return t%10==1&&t%100!=11?L:t%10==2&&t%100!=12?Dt:(t%10==7||t%10==8)&&t%100!=17&&t%100!=18?z:B},function(e){var t=+e;return t===1?L:t===2||t===3?Dt:t===4?R:B},function(e){var t=+e;return 1<=t&&t<=4?L:B},function(e){var t=+e;return t===1||t===5||7<=t&&t<=9?L:t===2||t===3?Dt:t===4?R:t===6?z:B},function(e){var t=+e;return t===1?L:t%10==4&&t%100!=14?z:B},function(e){var t=+e;return(t%10==1||t%10==2)&&t%100!=11&&t%100!=12?L:B},function(e){var t=+e;return t%10==6||t%10==9||t===10?R:B},function(e){var t=+e;return t%10==3&&t%100!=13?R:B}],Ot={af:{cardinal:V[0]},ak:{cardinal:V[1]},am:{cardinal:V[2]},ar:{cardinal:V[3]},ars:{cardinal:V[3]},as:{cardinal:V[2],ordinal:V[34]},asa:{cardinal:V[0]},ast:{cardinal:V[4]},az:{cardinal:V[0],ordinal:V[35]},be:{cardinal:V[5],ordinal:V[36]},bem:{cardinal:V[0]},bez:{cardinal:V[0]},bg:{cardinal:V[0]},bh:{cardinal:V[1]},bn:{cardinal:V[2],ordinal:V[34]},br:{cardinal:V[6]},brx:{cardinal:V[0]},bs:{cardinal:V[7]},ca:{cardinal:V[4],ordinal:V[37]},ce:{cardinal:V[0]},cgg:{cardinal:V[0]},chr:{cardinal:V[0]},ckb:{cardinal:V[0]},cs:{cardinal:V[8]},cy:{cardinal:V[9],ordinal:V[38]},da:{cardinal:V[10]},de:{cardinal:V[4]},dsb:{cardinal:V[11]},dv:{cardinal:V[0]},ee:{cardinal:V[0]},el:{cardinal:V[0]},en:{cardinal:V[4],ordinal:V[39]},eo:{cardinal:V[0]},es:{cardinal:V[0]},et:{cardinal:V[4]},eu:{cardinal:V[0]},fa:{cardinal:V[2]},ff:{cardinal:V[12]},fi:{cardinal:V[4]},fil:{cardinal:V[13],ordinal:V[0]},fo:{cardinal:V[0]},fr:{cardinal:V[12],ordinal:V[0]},fur:{cardinal:V[0]},fy:{cardinal:V[4]},ga:{cardinal:V[14],ordinal:V[0]},gd:{cardinal:V[15],ordinal:V[40]},gl:{cardinal:V[4]},gsw:{cardinal:V[0]},gu:{cardinal:V[2],ordinal:V[41]},guw:{cardinal:V[1]},gv:{cardinal:V[16]},ha:{cardinal:V[0]},haw:{cardinal:V[0]},he:{cardinal:V[17]},hi:{cardinal:V[2],ordinal:V[41]},hr:{cardinal:V[7]},hsb:{cardinal:V[11]},hu:{cardinal:V[0],ordinal:V[42]},hy:{cardinal:V[12],ordinal:V[0]},ia:{cardinal:V[4]},io:{cardinal:V[4]},is:{cardinal:V[18]},it:{cardinal:V[4],ordinal:V[43]},iu:{cardinal:V[19]},iw:{cardinal:V[17]},jgo:{cardinal:V[0]},ji:{cardinal:V[4]},jmc:{cardinal:V[0]},ka:{cardinal:V[0],ordinal:V[44]},kab:{cardinal:V[12]},kaj:{cardinal:V[0]},kcg:{cardinal:V[0]},kk:{cardinal:V[0],ordinal:V[45]},kkj:{cardinal:V[0]},kl:{cardinal:V[0]},kn:{cardinal:V[2]},ks:{cardinal:V[0]},ksb:{cardinal:V[0]},ksh:{cardinal:V[20]},ku:{cardinal:V[0]},kw:{cardinal:V[19]},ky:{cardinal:V[0]},lag:{cardinal:V[21]},lb:{cardinal:V[0]},lg:{cardinal:V[0]},ln:{cardinal:V[1]},lt:{cardinal:V[22]},lv:{cardinal:V[23]},mas:{cardinal:V[0]},mg:{cardinal:V[1]},mgo:{cardinal:V[0]},mk:{cardinal:V[24],ordinal:V[46]},ml:{cardinal:V[0]},mn:{cardinal:V[0]},mo:{cardinal:V[25],ordinal:V[0]},mr:{cardinal:V[2],ordinal:V[47]},mt:{cardinal:V[26]},nah:{cardinal:V[0]},naq:{cardinal:V[19]},nb:{cardinal:V[0]},nd:{cardinal:V[0]},ne:{cardinal:V[0],ordinal:V[48]},nl:{cardinal:V[4]},nn:{cardinal:V[0]},nnh:{cardinal:V[0]},no:{cardinal:V[0]},nr:{cardinal:V[0]},nso:{cardinal:V[1]},ny:{cardinal:V[0]},nyn:{cardinal:V[0]},om:{cardinal:V[0]},or:{cardinal:V[0],ordinal:V[49]},os:{cardinal:V[0]},pa:{cardinal:V[1]},pap:{cardinal:V[0]},pl:{cardinal:V[27]},prg:{cardinal:V[23]},ps:{cardinal:V[0]},pt:{cardinal:V[28]},"pt-PT":{cardinal:V[4]},rm:{cardinal:V[0]},ro:{cardinal:V[25],ordinal:V[0]},rof:{cardinal:V[0]},ru:{cardinal:V[29]},rwk:{cardinal:V[0]},saq:{cardinal:V[0]},sc:{cardinal:V[4],ordinal:V[43]},scn:{cardinal:V[4],ordinal:V[43]},sd:{cardinal:V[0]},sdh:{cardinal:V[0]},se:{cardinal:V[19]},seh:{cardinal:V[0]},sh:{cardinal:V[7]},shi:{cardinal:V[30]},si:{cardinal:V[31]},sk:{cardinal:V[8]},sl:{cardinal:V[32]},sma:{cardinal:V[19]},smi:{cardinal:V[19]},smj:{cardinal:V[19]},smn:{cardinal:V[19]},sms:{cardinal:V[19]},sn:{cardinal:V[0]},so:{cardinal:V[0]},sq:{cardinal:V[0],ordinal:V[50]},sr:{cardinal:V[7]},ss:{cardinal:V[0]},ssy:{cardinal:V[0]},st:{cardinal:V[0]},sv:{cardinal:V[4],ordinal:V[51]},sw:{cardinal:V[4]},syr:{cardinal:V[0]},ta:{cardinal:V[0]},te:{cardinal:V[0]},teo:{cardinal:V[0]},ti:{cardinal:V[1]},tig:{cardinal:V[0]},tk:{cardinal:V[0],ordinal:V[52]},tl:{cardinal:V[13],ordinal:V[0]},tn:{cardinal:V[0]},tr:{cardinal:V[0]},ts:{cardinal:V[0]},tzm:{cardinal:V[33]},ug:{cardinal:V[0]},uk:{cardinal:V[29],ordinal:V[53]},ur:{cardinal:V[4]},uz:{cardinal:V[0]},ve:{cardinal:V[0]},vo:{cardinal:V[0]},vun:{cardinal:V[0]},wa:{cardinal:V[1]},wae:{cardinal:V[0]},xh:{cardinal:V[0]},xog:{cardinal:V[0]},yi:{cardinal:V[4]},zu:{cardinal:V[2]},lo:{ordinal:V[0]},ms:{ordinal:V[0]},vi:{ordinal:V[0]}},kt=yt(function(e,t){t=e.exports=function(e,t,r){return n(e,null,t||`en`,r||{},!0)},t.toParts=function(e,t,r){return n(e,null,t||`en`,r||{},!1)};function n(e,t,n,i,a){var o=e.map(function(e){return r(e,t,n,i,a)});return a?o.length===1?o[0]:function(e){for(var t=``,n=0;n<o.length;++n)t+=o[n](e);return t}:function(e){return o.reduce(function(t,n){return t.concat(n(e))},[])}}function r(e,t,r,a,o){if(typeof e==`string`){var s=e;return function(){return s}}var c=e[0],l=e[1];if(t&&e[0]===`#`){c=t[0];var u=t[2],f=(a.number||d.number)([c,`number`],r);return function(e){return f(i(c,e)-u,e)}}var p;l===`plural`||l===`selectordinal`?(p={},Object.keys(e[3]).forEach(function(t){p[t]=n(e[3][t],e,r,a,o)}),e=[e[0],e[1],e[2],p]):e[2]&&typeof e[2]==`object`&&(p={},Object.keys(e[2]).forEach(function(t){p[t]=n(e[2][t],e,r,a,o)}),e=[e[0],e[1],p]);var m=l&&(a[l]||d[l]);if(m){var h=m(e,r);return function(e){return h(i(c,e),e)}}return o?function(e){return String(i(c,e))}:function(e){return i(c,e)}}function i(e,t){if(t&&e in t)return t[e];for(var n=e.split(`.`),r=t,i=0,a=n.length;r&&i<a;++i)r=r[n[i]];return r}function a(e,t){var n=e[2],r=wt.number[n]||wt.parseNumberPattern(n)||wt.number.default;return new Intl.NumberFormat(t,r).format}function o(e,t){var n=e[2],r=wt.duration[n]||wt.duration.default,i=new Intl.NumberFormat(t,r.seconds).format,a=new Intl.NumberFormat(t,r.minutes).format,o=new Intl.NumberFormat(t,r.hours).format,s=/^fi$|^fi-|^da/.test(String(t))?`.`:`:`;return function(e,t){if(e=+e,!isFinite(e))return i(e);var n=~~(e/60/60),r=~~(e/60%60),c=(n?o(Math.abs(n))+s:``)+a(Math.abs(r))+s+i(Math.abs(e%60));return e<0?o(-1).replace(o(1),c):c}}function s(e,t){var n=e[1],r=e[2],i=wt[n][r]||wt.parseDatePattern(r)||wt[n].default;return new Intl.DateTimeFormat(t,i).format}function c(e,t){var n=e[1]===`selectordinal`?`ordinal`:`cardinal`,r=e[2],i=e[3],a;if(Intl.PluralRules&&Intl.PluralRules.supportedLocalesOf(t).length>0)a=new Intl.PluralRules(t,{type:n});else{var o=Tt(t,Ot);a={select:o&&Ot[o][n]||l}}return function(e,t){return(i[`=`+ +e]||i[a.select(e-r)]||i.other)(t)}}function l(){return`other`}function u(e,t){var n=e[2];return function(e,t){return(n[e]||n.other)(t)}}var d={number:a,ordinal:a,spellout:a,duration:o,date:s,time:s,plural:c,selectordinal:c,select:u};t.types=d});kt.toParts,kt.types;var At=yt(function(e,t){var n=[`number`,`date`,`time`,`ordinal`,`duration`,`spellout`],r=[`plural`,`select`,`selectordinal`];t=e.exports=function(e,t){return i({pattern:String(e),index:0,tagsType:t&&t.tagsType||null,tokens:t&&t.tokens||null},``)};function i(e,t){var n=e.pattern,r=n.length,i=[],o=e.index,s=a(e,t);for(s&&i.push(s),s&&e.tokens&&e.tokens.push([`text`,n.slice(o,e.index)]);e.index<r;){if(n[e.index]===`}`){if(!t)throw g(e);break}if(t&&e.tagsType&&n.slice(e.index,e.index+2)===`</`)break;i.push(c(e)),o=e.index,s=a(e,t),s&&i.push(s),s&&e.tokens&&e.tokens.push([`text`,n.slice(o,e.index)])}return i}function a(e,t){for(var n=e.pattern,r=n.length,i=t===`plural`||t===`selectordinal`,a=!!e.tagsType,s=t===`{style}`,c=``;e.index<r;){var l=n[e.index];if(l===`{`||l===`}`||i&&l===`#`||a&&l===`<`||s&&o(l.charCodeAt(0)))break;if(l===`'`)if(l=n[++e.index],l===`'`)c+=l,++e.index;else if(l===`{`||l===`}`||i&&l===`#`||a&&l===`<`||s)for(c+=l;++e.index<r;)if(l=n[e.index],l===`'`&&n[e.index+1]===`'`)c+=`'`,++e.index;else if(l===`'`){++e.index;break}else c+=l;else c+=`'`;else c+=l,++e.index}return c}function o(e){return e>=9&&e<=13||e===32||e===133||e===160||e===6158||e>=8192&&e<=8205||e===8232||e===8233||e===8239||e===8287||e===8288||e===12288||e===65279}function s(e){for(var t=e.pattern,n=t.length,r=e.index;e.index<n&&o(t.charCodeAt(e.index));)++e.index;r<e.index&&e.tokens&&e.tokens.push([`space`,e.pattern.slice(r,e.index)])}function c(e){var t=e.pattern;if(t[e.index]===`#`)return e.tokens&&e.tokens.push([`syntax`,`#`]),++e.index,[`#`];var r=l(e);if(r)return r;if(t[e.index]!==`{`)throw g(e,`{`);e.tokens&&e.tokens.push([`syntax`,`{`]),++e.index,s(e);var i=u(e);if(!i)throw g(e,`placeholder id`);e.tokens&&e.tokens.push([`id`,i]),s(e);var a=t[e.index];if(a===`}`)return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,[i];if(a!==`,`)throw g(e,`, or }`);e.tokens&&e.tokens.push([`syntax`,`,`]),++e.index,s(e);var o=u(e);if(!o)throw g(e,`placeholder type`);if(e.tokens&&e.tokens.push([`type`,o]),s(e),a=t[e.index],a===`}`){if(e.tokens&&e.tokens.push([`syntax`,`}`]),o===`plural`||o===`selectordinal`||o===`select`)throw g(e,o+` sub-messages`);return++e.index,[i,o]}if(a!==`,`)throw g(e,`, or }`);e.tokens&&e.tokens.push([`syntax`,`,`]),++e.index,s(e);var c;if(o===`plural`||o===`selectordinal`){var p=f(e);s(e),c=[i,o,p,m(e,o)]}else if(o===`select`)c=[i,o,m(e,o)];else if(n.indexOf(o)>=0)c=[i,o,d(e)];else{var h=e.index,_=d(e);s(e),t[e.index]===`{`&&(e.index=h,_=m(e,o)),c=[i,o,_]}if(s(e),t[e.index]!==`}`)throw g(e,`}`);return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,c}function l(e){var t=e.tagsType;if(!(!t||e.pattern[e.index]!==`<`)){if(e.pattern.slice(e.index,e.index+2)===`</`)throw g(e,null,`closing tag without matching opening tag`);e.tokens&&e.tokens.push([`syntax`,`<`]),++e.index;var n=u(e,!0);if(!n)throw g(e,`placeholder id`);if(e.tokens&&e.tokens.push([`id`,n]),s(e),e.pattern.slice(e.index,e.index+2)===`/>`)return e.tokens&&e.tokens.push([`syntax`,`/>`]),e.index+=2,[n,t];if(e.pattern[e.index]!==`>`)throw g(e,`>`);e.tokens&&e.tokens.push([`syntax`,`>`]),++e.index;var r=i(e,t),a=e.index;if(e.pattern.slice(e.index,e.index+2)!==`</`)throw g(e,`</`+n+`>`);e.tokens&&e.tokens.push([`syntax`,`</`]),e.index+=2;var o=u(e,!0);if(o&&e.tokens&&e.tokens.push([`id`,o]),n!==o)throw e.index=a,g(e,`</`+n+`>`,`</`+o+`>`);if(s(e),e.pattern[e.index]!==`>`)throw g(e,`>`);return e.tokens&&e.tokens.push([`syntax`,`>`]),++e.index,[n,t,{children:r}]}}function u(e,t){for(var n=e.pattern,r=n.length,i=``;e.index<r;){var a=n[e.index];if(a===`{`||a===`}`||a===`,`||a===`#`||a===`'`||o(a.charCodeAt(0))||t&&(a===`<`||a===`>`||a===`/`))break;i+=a,++e.index}return i}function d(e){var t=e.index,n=a(e,`{style}`);if(!n)throw g(e,`placeholder style name`);return e.tokens&&e.tokens.push([`style`,e.pattern.slice(t,e.index)]),n}function f(e){var t=e.pattern,n=t.length,r=0;if(t.slice(e.index,e.index+7)===`offset:`){e.tokens&&e.tokens.push([`offset`,`offset`],[`syntax`,`:`]),e.index+=7,s(e);for(var i=e.index;e.index<n&&p(t.charCodeAt(e.index));)++e.index;if(i===e.index)throw g(e,`offset number`);e.tokens&&e.tokens.push([`number`,t.slice(i,e.index)]),r=+t.slice(i,e.index)}return r}function p(e){return e>=48&&e<=57}function m(e,t){for(var n=e.pattern,i=n.length,a={};e.index<i&&n[e.index]!==`}`;){var o=u(e);if(!o)throw g(e,`sub-message selector`);e.tokens&&e.tokens.push([`selector`,o]),s(e),a[o]=h(e,t),s(e)}if(!a.other&&r.indexOf(t)>=0)throw g(e,null,null,`"other" sub-message must be specified in `+t);return a}function h(e,t){if(e.pattern[e.index]!==`{`)throw g(e,`{ to start sub-message`);e.tokens&&e.tokens.push([`syntax`,`{`]),++e.index;var n=i(e,t);if(e.pattern[e.index]!==`}`)throw g(e,`} to end sub-message`);return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,n}function g(e,t,n,r){var i=e.pattern,a=i.slice(0,e.index).split(/\r?\n/),o=e.index,s=a.length,c=a.slice(-1)[0].length;return n||=e.index>=i.length?`end of message pattern`:u(e)||i[e.index],r||=_(t,n),r+=` in `+i.replace(/\r?\n/g,`
`),new v(r,t,n,o,s,c)}function _(e,t){return e?`Expected `+e+` but found `+t:`Unexpected `+t+` found`}function v(e,t,n,r,i,a){Error.call(this,e),this.name=`SyntaxError`,this.message=e,this.expected=t,this.found=n,this.offset=r,this.line=i,this.column=a}v.prototype=Object.create(Error.prototype),t.SyntaxError=v});At.SyntaxError;var jt=RegExp(`^(`+Object.keys(Ot).join(`|`)+`)\\b`),Mt=new WeakMap;function Nt(e,t,n){if(!(this instanceof Nt)||Mt.has(this))throw TypeError(`calling MessageFormat constructor without new is invalid`);var r=At(e);Mt.set(this,{ast:r,format:kt(r,t,n&&n.types),locale:Nt.supportedLocalesOf(t)[0]||`en`,locales:t,options:n})}var Pt=Nt;Object.defineProperties(Nt.prototype,{format:{configurable:!0,get:function(){var e=Mt.get(this);if(!e)throw TypeError(`MessageFormat.prototype.format called on value that's not an object initialized as a MessageFormat`);return e.format}},formatToParts:{configurable:!0,writable:!0,value:function(e){var t=Mt.get(this);if(!t)throw TypeError(`MessageFormat.prototype.formatToParts called on value that's not an object initialized as a MessageFormat`);return(t.toParts||=kt.toParts(t.ast,t.locales,t.options&&t.options.types))(e)}},resolvedOptions:{configurable:!0,writable:!0,value:function(){var e=Mt.get(this);if(!e)throw TypeError(`MessageFormat.prototype.resolvedOptions called on value that's not an object initialized as a MessageFormat`);return{locale:e.locale}}}}),typeof Symbol<`u`&&Object.defineProperty(Nt.prototype,Symbol.toStringTag,{value:`Object`}),Object.defineProperties(Nt,{supportedLocalesOf:{configurable:!0,writable:!0,value:function(e){return[].concat(Intl.NumberFormat.supportedLocalesOf(e),Intl.DateTimeFormat.supportedLocalesOf(e),Intl.PluralRules?Intl.PluralRules.supportedLocalesOf(e):[],[].concat(e||[]).filter(function(e){return jt.test(e)})).filter(function(e,t,n){return n.indexOf(e)===t})}}});function Ft(e){return!!(e&&e.default&&typeof e.default==`object`&&Object.keys(e).length===1)}var It=globalThis.document?.documentElement,Lt=class extends EventTarget{formatNumberOptions={returnIfNaN:``,postProcessors:new Map};formatDateOptions={postProcessors:new Map};#e=!1;#t=``;#n=null;__storage={};__namespacePatternsMap=new Map;__namespaceLoadersCache={};__namespaceLoaderPromisesCache={};get locale(){return this.#e?this.#t||``:It.lang||``}set locale(e){if(this.#r(e),!this.#e){let t=It.lang;this._setHtmlLangAttribute(e),this._onLocaleChanged(e,t);return}let t=this.#t;this.#t=e,this.#n===null&&this._setHtmlLangAttribute(e),this._onLocaleChanged(e,t)}get loadingComplete(){return typeof this.__namespaceLoaderPromisesCache[this.locale]==`object`?Promise.all(Object.values(this.__namespaceLoaderPromisesCache[this.locale])):Promise.resolve()}constructor({allowOverridesForExistingNamespaces:e=!1,autoLoadOnLocaleChange:t=!1,showKeyAsFallback:n=!1,fallbackLocale:r=``}={}){super(),this.__allowOverridesForExistingNamespaces=e,this._autoLoadOnLocaleChange=!!t,this._showKeyAsFallback=n,this._fallbackLocale=r;let i=It.getAttribute(`data-localize-lang`);this.#e=!!i,this.#e&&(this.locale=i,this._setupTranslationToolSupport()),It.lang||=this.locale||`en-GB`,this._setupHtmlLangAttributeObserver()}addData(e,t,n){if(!this.__allowOverridesForExistingNamespaces&&this._isNamespaceInCache(e,t))throw Error(`Namespace "${t}" has been already added for the locale "${e}".`);this.__storage[e]=this.__storage[e]||{},this.__allowOverridesForExistingNamespaces?this.__storage[e][t]={...this.__storage[e][t],...n}:this.__storage[e][t]=n}setupNamespaceLoader(e,t){this.__namespacePatternsMap.set(e,t)}loadNamespaces(e,{locale:t}={}){return Promise.all(e.map(e=>this.loadNamespace(e,{locale:t})))}loadNamespace(e,{locale:t=this.locale}={locale:this.locale}){let n=typeof e==`object`,r=n?Object.keys(e)[0]:e;return this._isNamespaceInCache(t,r)?Promise.resolve():this._getCachedNamespaceLoaderPromise(t,r)||this._loadNamespaceData(t,e,n,r)}msg(e,t,n={}){let r=n.locale?n.locale:this.locale,i=this._getMessageForKeys(e,r);return i?new Pt(i,r).format(t):``}teardown(){this._teardownHtmlLangAttributeObserver()}reset(){this.__storage={},this.__namespacePatternsMap=new Map,this.__namespaceLoadersCache={},this.__namespaceLoaderPromisesCache={}}setDatePostProcessorForLocale({locale:e,postProcessor:t}){this.formatDateOptions?.postProcessors.set(e,t)}setNumberPostProcessorForLocale({locale:e,postProcessor:t}){this.formatNumberOptions?.postProcessors.set(e,t)}_setupTranslationToolSupport(){this.#n=It.lang||null}_setHtmlLangAttribute(e){this._teardownHtmlLangAttributeObserver(),It.lang=e,this._setupHtmlLangAttributeObserver()}_setupHtmlLangAttributeObserver(){this._htmlLangAttributeObserver||=new MutationObserver(e=>{e.forEach(e=>{this.#e?It.lang===`auto`?(this.#n=null,this._setHtmlLangAttribute(this.locale)):this.#n=document.documentElement.lang:this._onLocaleChanged(document.documentElement.lang,e.oldValue||``)})}),this._htmlLangAttributeObserver.observe(document.documentElement,{attributes:!0,attributeFilter:[`lang`],attributeOldValue:!0})}_teardownHtmlLangAttributeObserver(){this._htmlLangAttributeObserver&&this._htmlLangAttributeObserver.disconnect()}_isNamespaceInCache(e,t){return!!(this.__storage[e]&&this.__storage[e][t])}_getCachedNamespaceLoaderPromise(e,t){return this.__namespaceLoaderPromisesCache[e]?this.__namespaceLoaderPromisesCache[e][t]:null}_loadNamespaceData(e,t,n,r){let i=this._getNamespaceLoader(t,n,r),a=this._getNamespaceLoaderPromise(i,e,r);return this._cacheNamespaceLoaderPromise(e,r,a),a.then(t=>{if(this.__namespaceLoaderPromisesCache[e]&&this.__namespaceLoaderPromisesCache[e][r]===a){let n=Ft(t)?t.default:t;this.addData(e,r,n)}})}_getNamespaceLoader(e,t,n){let r=this.__namespaceLoadersCache[n];if(r||(t?(r=e[n],this.__namespaceLoadersCache[n]=r):(r=this._lookupNamespaceLoader(n),this.__namespaceLoadersCache[n]=r)),!r)throw Error(`Namespace "${n}" was not properly setup.`);return this.__namespaceLoadersCache[n]=r,r}_getNamespaceLoaderPromise(e,t,n,r=this._fallbackLocale){return e(t,n).catch(()=>{let i=this._getLangFromLocale(t);return e(i,n).catch(()=>{if(r)return this._getNamespaceLoaderPromise(e,r,n,``).catch(()=>{let e=this._getLangFromLocale(r);throw Error(`Data for namespace "${n}" and current locale "${t}" or fallback locale "${r}" could not be loaded. Make sure you have data either for locale "${t}" (and/or generic language "${i}") or for fallback "${r}" (and/or "${e}").`)});throw Error(`Data for namespace "${n}" and locale "${t}" could not be loaded. Make sure you have data for locale "${t}" (and/or generic language "${i}").`)})})}_cacheNamespaceLoaderPromise(e,t,n){this.__namespaceLoaderPromisesCache[e]||(this.__namespaceLoaderPromisesCache[e]={}),this.__namespaceLoaderPromisesCache[e][t]=n}_lookupNamespaceLoader(e){for(let[t,n]of this.__namespacePatternsMap){let r=typeof t==`string`&&t===e,i=typeof t==`object`&&t.constructor.name===`RegExp`&&t.test(e);if(r||i)return n}return null}_getLangFromLocale(e){return e.substring(0,2)}_onLocaleChanged(e,t){this.dispatchEvent(new CustomEvent(`__localeChanging`)),e!==t&&(this._autoLoadOnLocaleChange?(this._loadAllMissing(e,t),this.loadingComplete.then(()=>{this.dispatchEvent(new CustomEvent(`localeChanged`,{detail:{newLocale:e,oldLocale:t}}))})):this.dispatchEvent(new CustomEvent(`localeChanged`,{detail:{newLocale:e,oldLocale:t}})))}_loadAllMissing(e,t){let n=this.__storage[t]||{},r=this.__storage[e]||{};Object.keys(n).forEach(t=>{r[t]||this.loadNamespace(t,{locale:e})})}_getMessageForKeys(e,t){if(typeof e==`string`)return this._getMessageForKey(e,t);let n=Array.from(e).reverse(),r,i;for(;n.length;)if(r=n.pop(),i=this._getMessageForKey(r,t),i)return i}_getMessageForKey(e,t){if(!e||e.indexOf(`:`)===-1)throw Error(`Namespace is missing in the key "${e}". The format for keys is "namespace:name".`);let[n,r]=e.split(`:`),i=this.__storage[t],a=i?i[n]:{},o=r.split(`.`).reduce((e,t)=>typeof e==`object`?e[t]:e,a);return String(o||(this._showKeyAsFallback?e:``))}#r(e){if(!e.includes(`-`))throw Error(`
      Locale was set to ${e}.
      Language only locales are not allowed, please use the full language locale e.g. 'en-GB' instead of 'en'.
      See https://github.com/ing-bank/lion/issues/187 for more information.
    `)}get _supportExternalTranslationTools(){return this.#e}set _supportExternalTranslationTools(e){this.#e=e}get _langAttrSetByTranslationTool(){return this.#t}set _langAttrSetByTranslationTool(e){this.#t=e}};function Rt(){if(!u.has(`@lion/ui::localize::0.x`)){let e=new Lt({autoLoadOnLocaleChange:!0,fallbackLocale:`en-GB`});u.set(`@lion/ui::localize::0.x`,e)}return u.get(`@lion/ui::localize::0.x`)}function zt(){return w(Rt)}var Bt=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),Bt(e,t);return!0},Vt=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},Ht=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Gt(t)}};function Ut(e){this._$AN===void 0?this._$AM=e:(Vt(this),this._$AM=e,Ht(this))}function Wt(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(r))for(let e=n;e<r.length;e++)Bt(r[e],!1),Vt(r[e]);else r!=null&&(Bt(r,!1),Vt(r));else Bt(this,e)}var Gt=e=>{e.type==ee.CHILD&&(e._$AP??=Wt,e._$AQ??=Ut)},Kt=class extends m{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),Ht(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Bt(this,e),Vt(this))}setValue(e){if(Ce(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},qt=class{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}},Jt=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((e=>this.Z=e))}resume(){this.Z?.(),this.Y=this.Z=void 0}},Yt=e=>!xe(e)&&typeof e.then==`function`,Xt=1073741823,Zt=d(class extends Kt{constructor(){super(...arguments),this._$Cwt=Xt,this._$Cbt=[],this._$CK=new qt(this),this._$CX=new Jt}render(...e){return e.find((e=>!Yt(e)))??o}update(e,t){let n=this._$Cbt,r=n.length;this._$Cbt=t;let i=this._$CK,a=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){let o=t[e];if(!Yt(o))return this._$Cwt=e,o;e<r&&o===n[e]||(this._$Cwt=Xt,r=0,Promise.resolve(o).then((async e=>{for(;a.get();)await a.get();let t=i.deref();if(t!==void 0){let n=t._$Cbt.indexOf(o);n>-1&&n<t._$Cwt&&(t._$Cwt=n,t.setValue(e))}})))}return o}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),Qt=S(e=>class extends e{static get localizeNamespaces(){return[]}static get waitForLocalizeNamespaces(){return!0}constructor(){super(),this._localizeManager=zt(),this.__boundLocalizeOnLocaleChanged=(...e)=>{let t=Array.from(e)[0];this.__localizeOnLocaleChanged(t)},this.__boundLocalizeOnLocaleChanging=()=>{this.__localizeOnLocaleChanging()},this.__localizeStartLoadingNamespaces(),this.localizeNamespacesLoaded&&this.localizeNamespacesLoaded.then(()=>{this.__localizeMessageSync=!0})}async scheduleUpdate(){Object.getPrototypeOf(this).constructor.waitForLocalizeNamespaces&&await this.localizeNamespacesLoaded,super.scheduleUpdate()}connectedCallback(){super.connectedCallback(),this.localizeNamespacesLoaded&&this.localizeNamespacesLoaded.then(()=>this.onLocaleReady()),this._localizeManager.addEventListener(`__localeChanging`,this.__boundLocalizeOnLocaleChanging),this._localizeManager.addEventListener(`localeChanged`,this.__boundLocalizeOnLocaleChanged)}disconnectedCallback(){super.disconnectedCallback(),this._localizeManager.removeEventListener(`__localeChanging`,this.__boundLocalizeOnLocaleChanging),this._localizeManager.removeEventListener(`localeChanged`,this.__boundLocalizeOnLocaleChanged)}msgLit(e,t,n){return this.__localizeMessageSync?this._localizeManager.msg(e,t,n):this.localizeNamespacesLoaded?Zt(this.localizeNamespacesLoaded.then(()=>this._localizeManager.msg(e,t,n)),c):``}__getUniqueNamespaces(){let e=[],t=new Set;return Object.getPrototypeOf(this).constructor.localizeNamespaces.forEach(t.add.bind(t)),t.forEach(t=>{e.push(t)}),e}__localizeStartLoadingNamespaces(){this.localizeNamespacesLoaded=this._localizeManager.loadNamespaces(this.__getUniqueNamespaces())}__localizeOnLocaleChanging(){this.__localizeStartLoadingNamespaces()}__localizeOnLocaleChanged(e){this.onLocaleChanged(e.detail.newLocale,e.detail.oldLocale)}onLocaleReady(){this.onLocaleUpdated()}onLocaleChanged(e,t){this.onLocaleUpdated(),this.requestUpdate()}onLocaleUpdated(){}}),$t=`3.0.0`,en=window.scopedElementsVersions||(window.scopedElementsVersions=[]);en.includes($t)||en.push($t);var tn=S(e=>class extends e{static scopedElements;static get scopedElementsVersion(){return $t}static __registry;get registry(){return this.constructor.__registry}set registry(e){this.constructor.__registry=e}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=new CustomElementRegistry;for(let[e,n]of Object.entries(t??{}))this.registry.define(e,n)}return super.attachShadow({...e,customElements:this.registry,registry:this.registry})}}),nn=S(e=>class extends tn(e){createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return this.renderOptions.creationScope=n,i(n,t),this.renderOptions.renderBefore??=n.firstChild,n}});function rn(){return!!(globalThis.ShadowRoot?.prototype.createElement&&globalThis.ShadowRoot?.prototype.importNode)}var an=S(e=>class extends nn(e){constructor(){super()}createScopedElement(e){return(rn()?this.shadowRoot:document).createElement(e)}defineScopedElement(e,t){let n=this.registry.get(e),r=n&&n!==t;return!rn()&&r&&console.error([`You are trying to re-register the "${e}" custom element with a different class via ScopedElementsMixin.`,`This is only possible with a CustomElementRegistry.`,`Your browser does not support this feature so you will need to load a polyfill for it.`,`Load "@webcomponents/scoped-custom-element-registry" before you register ANY web component to the global customElements registry.`,`e.g. add "<script src="/node_modules/@webcomponents/scoped-custom-element-registry/scoped-custom-element-registry.min.js"><\/script>" as your first script tag.`,`For more details you can visit https://open-wc.org/docs/development/scoped-elements/`].join(`
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=rn()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return rn()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(i(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),on=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function sn(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return on.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var cn=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},ln=S(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),un=S(e=>class extends ln(te(Fe(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=Ie(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...sn(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return r`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof cn&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&(typeof t!=`boolean`||t!==!1)}static get styles(){return[a`
          /**********************
            {block} .form-field
           ********************/
        ...
        `]}_getAriaDescriptionElements(){return[this._helpTextNode,this._feedbackNode]}addToAriaLabelledBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaLabelledNodes.includes(e)||(this._ariaLabelledNodes=[...this._ariaLabelledNodes,e],this.__reorderAriaLabelledNodes=!!n)}removeFromAriaLabelledBy(e){this._ariaLabelledNodes.includes(e)&&(this._ariaLabelledNodes.splice(this._ariaLabelledNodes.indexOf(e),1),this._ariaLabelledNodes=[...this._ariaLabelledNodes],this.__reorderAriaLabelledNodes=!1)}addToAriaDescribedBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaDescribedNodes.includes(e)||(this._ariaDescribedNodes=[...this._ariaDescribedNodes,e],this.__reorderAriaDescribedNodes=!!n)}removeFromAriaDescribedBy(e){this._ariaDescribedNodes.includes(e)&&(this._ariaDescribedNodes.splice(this._ariaDescribedNodes.indexOf(e),1),this._ariaDescribedNodes=[...this._ariaDescribedNodes],this.__reorderAriaLabelledNodes=!1)}__getDirectSlotChild(e){return Array.from(this.children).find(t=>t.slot===e)}_dispatchInitialModelValueChangedEvent(){this._repropagationRole!==`child`&&(this.__repropagateChildrenInitialized=!0,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],initialize:!0,isTriggeredByUser:!1}})))}_onBeforeRepropagateChildrenValues(e){}__repropagateChildrenValues(e){this._onBeforeRepropagateChildrenValues(e);let t=e.detail&&e.detail.element||e.target,n=this._isRepropagationEndpoint||this._repropagationRole===`choice-group`;if(t===this)return;e.stopImmediatePropagation();let r=this._repropagationRole!==`child`&&!this.__repropagateChildrenInitialized,i=e.detail&&e.detail.initialize;if(r||i||!this._repropagationCondition(t))return;let a=[];n||(a=e.detail&&e.detail.formPath||[t]);let o=[...a,this];this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:o,isTriggeredByUser:!!e.detail?.isTriggeredByUser}}))}_repropagationCondition(e){return!!e}_onLabelClick(){}}),dn=class{constructor(){this.__running=!1,this.__queue=[]}add(e){this.__queue.push(e),this.__running||(this.complete=new Promise(e=>{this.__callComplete=e}),this.__run())}async __run(){this.__running=!0,await this.__queue[0](),this.__queue.shift(),this.__queue.length>0?this.__run():(this.__running=!1,this.__callComplete&&this.__callComplete())}};function fn(e){return e.charAt(0).toUpperCase()+e.slice(1)}var pn=S(e=>class extends e{constructor(){super(),this.__SyncUpdatableNamespace={}}firstUpdated(e){super.firstUpdated(e),this.__syncUpdatableInitialize()}connectedCallback(){super.connectedCallback(),this.__SyncUpdatableNamespace.connected=!0}disconnectedCallback(){super.disconnectedCallback(),this.__SyncUpdatableNamespace.connected=!1}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];static __syncUpdatableHasChanged(e,t,n){let r=this.elementProperties;return r.get(e)&&r.get(e).hasChanged?r.get(e).hasChanged(t,n):t!==n}__syncUpdatableInitialize(){let e=this.__SyncUpdatableNamespace,t=this.constructor;e.initialized=!0,e.queue&&Array.from(e.queue).forEach(e=>{t.__syncUpdatableHasChanged(e,this[e],void 0)&&this.updateSync(e,void 0)})}requestUpdate(e,t,n){if(super.requestUpdate(e,t,n),e===void 0)return;this.__SyncUpdatableNamespace=this.__SyncUpdatableNamespace||{};let r=this.__SyncUpdatableNamespace,i=this.constructor;r.initialized?i.__syncUpdatableHasChanged(e,this[e],t)&&this.updateSync(e,t):(r.queue=r.queue||new Set,r.queue.add(e))}updateSync(e,t){}}),mn=e=>{switch(e){case`bg-BG`:return b(()=>import(`./bg-BG-BSOJu8wp.js`),__vite__mapDeps([0,1]),import.meta.url);case`bg`:return b(()=>import(`./bg-tT2-9j0y.js`),__vite__mapDeps([2,1]),import.meta.url);case`cs-CZ`:return b(()=>import(`./cs-CZ-BXYisR25.js`),__vite__mapDeps([3,4]),import.meta.url);case`cs`:return b(()=>import(`./cs-BWWtw9FR.js`),__vite__mapDeps([5,4]),import.meta.url);case`de-DE`:return b(()=>import(`./de-DE-CqA9yOdY.js`),__vite__mapDeps([6,7]),import.meta.url);case`de`:return b(()=>import(`./de-D2KzmuNN.js`),__vite__mapDeps([8,7]),import.meta.url);case`en-AU`:return b(()=>import(`./en-AU-ClGzkm9N.js`),__vite__mapDeps([9,10]),import.meta.url);case`en-GB`:return b(()=>import(`./en-GB-ClGzkm9N.js`),__vite__mapDeps([11,10]),import.meta.url);case`en-US`:return b(()=>import(`./en-US-ClGzkm9N.js`),__vite__mapDeps([12,10]),import.meta.url);case`en-PH`:case`en`:return b(()=>import(`./en-Bn2liEJW.js`),__vite__mapDeps([13,10]),import.meta.url);case`es-ES`:return b(()=>import(`./es-ES-lc8truAL.js`),__vite__mapDeps([14,15]),import.meta.url);case`es`:return b(()=>import(`./es-BHRFfW-v.js`),__vite__mapDeps([16,15]),import.meta.url);case`fr-FR`:return b(()=>import(`./fr-FR-BFPCNFnr.js`),__vite__mapDeps([17,18]),import.meta.url);case`fr-BE`:return b(()=>import(`./fr-BE-BFPCNFnr.js`),__vite__mapDeps([19,18]),import.meta.url);case`fr`:return b(()=>import(`./fr-BatdFrY1.js`),__vite__mapDeps([20,18]),import.meta.url);case`hu-HU`:return b(()=>import(`./hu-HU-CgHBHfiG.js`),__vite__mapDeps([21,22]),import.meta.url);case`hu`:return b(()=>import(`./hu-BGJUkRn0.js`),__vite__mapDeps([23,22]),import.meta.url);case`it-IT`:return b(()=>import(`./it-IT-DXWt8Y3M.js`),__vite__mapDeps([24,25]),import.meta.url);case`it`:return b(()=>import(`./it-BbZB0zCO.js`),__vite__mapDeps([26,25]),import.meta.url);case`nl-BE`:return b(()=>import(`./nl-BE-CN9u7Cp2.js`),__vite__mapDeps([27,28]),import.meta.url);case`nl-NL`:return b(()=>import(`./nl-NL-CN9u7Cp2.js`),__vite__mapDeps([29,28]),import.meta.url);case`nl`:return b(()=>import(`./nl-CubSULoy.js`),__vite__mapDeps([30,28]),import.meta.url);case`pl-PL`:return b(()=>import(`./pl-PL-D0K_dWml.js`),__vite__mapDeps([31,32]),import.meta.url);case`pl`:return b(()=>import(`./pl-BhJlmndU.js`),__vite__mapDeps([33,32]),import.meta.url);case`ro-RO`:return b(()=>import(`./ro-RO-BXVNXH1J.js`),__vite__mapDeps([34,35]),import.meta.url);case`ro`:return b(()=>import(`./ro-75jeTe0N.js`),__vite__mapDeps([36,35]),import.meta.url);case`ru-RU`:return b(()=>import(`./ru-RU-BpGy32BK.js`),__vite__mapDeps([37,38]),import.meta.url);case`ru`:return b(()=>import(`./ru-DU7uFj2i.js`),__vite__mapDeps([39,38]),import.meta.url);case`sk-SK`:return b(()=>import(`./sk-SK-wewEOZGv.js`),__vite__mapDeps([40,41]),import.meta.url);case`sk`:return b(()=>import(`./sk-cN9_UHno.js`),__vite__mapDeps([42,41]),import.meta.url);case`tr-TR`:return b(()=>import(`./tr-TR-D1nJ_iYG.js`),__vite__mapDeps([43,44]),import.meta.url);case`tr`:return b(()=>import(`./tr-DuiqIpvR.js`),__vite__mapDeps([45,44]),import.meta.url);case`uk-UA`:return b(()=>import(`./uk-UA-DHqiIGvL.js`),__vite__mapDeps([46,47]),import.meta.url);case`uk`:return b(()=>import(`./uk-Cm-Wcqws.js`),__vite__mapDeps([48,47]),import.meta.url);case`zh-CN`:case`zh`:return b(()=>import(`./zh-DMe6SF13.js`),[],import.meta.url);default:return b(()=>import(`./en-Bn2liEJW.js`),__vite__mapDeps([13,10]),import.meta.url)}},hn=e=>`${e[0].toUpperCase()}${e.slice(1)}`,gn=class extends Qt(l){static get properties(){return{feedbackData:{attribute:!1}}}static localizeNamespaces=[{"lion-form-core":mn},...super.localizeNamespaces];static get styles(){return[a`
    ...
    `}_onRequestToAddFormElement(e){e.target.hasAttribute(`role`)||e.target?.setAttribute(`role`,`listitem`),this.__addToSubCheckboxes(e.detail.element),this._setOwnCheckedState()}_onRequestToRemoveFormElement(e){e.target.getAttribute(`role`)===`listitem`&&e.target?.removeAttribute(`role`),this.__removeFromSubCheckboxes(e.detail.element)}__addToSubCheckboxes(e){e!==this&&this.contains(e)&&this.__subCheckboxes.push(e)}__removeFromSubCheckboxes(e){let t=this.__subCheckboxes.indexOf(e);t!==-1&&this.__subCheckboxes.splice(t,1)}constructor(){super(),this.indeterminate=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this.__onModelValueChanged=this.__onModelValueChanged.bind(this),this.__subCheckboxes=[],this._indeterminateSubStates=[],this.mixedState=!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,this.__onModelValueChanged),this.addEventListener(`form-element-register`,this._onRequestToAddFormElement)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`model-value-changed`,this.__onModelValueChanged),this.removeEventListener(`form-element-register`,this._onRequestToAddFormElement)}firstUpdated(e){super.firstUpdated(e),this._setOldState(),this.indeterminate&&this._storeIndeterminateState()}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&(this._inputNode.indeterminate=this.indeterminate)}},Ln=class extends mt(Nn,`checkbox`){static get styles(){return[...Nn.styles,a`
      ...
      `]}};function Vn(){let e=this.allMode===`single-value`&&this.checked;for(let t of this._subCheckboxes??[]){let n=t.querySelector(`:scope > input[slot="input"]`);n&&(e?n.name&&(n.dataset.governedName=n.name,n.removeAttribute(`name`)):n.dataset.governedName&&(n.name=n.dataset.governedName,delete n.dataset.governedName))}}D([O({reflect:!0,attribute:`all-mode`})],Bn.prototype,`allMode`,void 0),customElements.get(`craft-checkbox-indeterminate`)||customElements.define(`craft-checkbox-indeterminate`,Bn);var Hn=class extends Rn(Fn){constructor(...e){super(...e),this.__inputPatched=!1,this.indeterminate=!1}connectedCallback(){super.connectedCallback(),this.__patchSlottedInputProps()}updated(e){super.updated(e),this.__patchSlottedInputProps();let t=this._inputNode;t&&(t.indeterminate=this.indeterminate)}__patchSlottedInputProps(){if(this.__inputPatched)return;let e=this.__slottedInputElement();if(!e)return;this.__inputPatched=!0;let t=this;for(let n of[`checked`,`disabled`]){let r=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,n);if(!r?.get||!r.set)continue;let{get:i,set:a}=r;Object.defineProperty(e,n,{configurable:!0,enumerable:r.enumerable,get(){return i.call(this)},set(e){a.call(this,e),t[n]!==e&&(t[n]=e)}})}}__slottedInputElement(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}static get styles(){return[...Fn.styles,pt,a`
      ...
      `]}};D([O({type:Boolean,reflect:!0})],Hn.prototype,`indeterminate`,void 0),customElements.get(`craft-checkbox`)||customElements.define(`craft-checkbox`,Hn);var Un=new Map;async function Wn(e,t,n=!1){let r=[],i=[],a=()=>{for(let e of r)e.remove();i.forEach(e=>e())};if(!e)return a;let o=document.createElement(`template`);o.innerHTML=e.trim();try{for(let e of o.content.childNodes){let a=Kn(e);if(a){let e=Un.get(a.key);if(e){e.references++,i.push(()=>Xn(a.key,e)),e.loaded&&await Yn(e.loaded,n);continue}if(qn(a))continue}let o=Gn(e),s=a&&o instanceof HTMLScriptElement?Jn(o,a.value):null;if(t.appendChild(o),a&&(o instanceof HTMLLinkElement||o instanceof HTMLScriptElement)){let e={node:o,loaded:s,references:1};Un.set(a.key,e),i.push(()=>Xn(a.key,e))}else r.push(o);s&&await Yn(s,n)}return a}catch(e){throw a(),e}}function Gn(e){if(!(e instanceof HTMLScriptElement))return e.cloneNode(!0);let t=document.createElement(`script`);for(let n of e.attributes)t.setAttribute(n.name,n.value);return t.textContent=e.textContent,t.async=!1,t}function Kn(e){return e instanceof HTMLLinkElement&&e.href?{key:`link:${e.href}`,selector:`link[href]`,value:e.href}:e instanceof HTMLScriptElement&&e.src?{key:`script:${e.src}`,selector:`script[src]`,value:e.src}:null}function qn(e){return Array.from(document.querySelectorAll(e.selector)).some(t=>(t instanceof HTMLLinkElement?t.href:t.src)===e.value)}function Jn(e,t){return new Promise((n,r)=>{e.addEventListener(`load`,()=>n(),{once:!0}),e.addEventListener(`error`,()=>r(Error(`Failed to load asset [${t}].`)),{once:!0})})}async function Yn(e,t){try{await e}catch(e){if(t)throw e}}function Xn(e,t){t.references--,!(t.references>0)&&(t.node.remove(),Un.delete(e))}async function Zn(e){return Wn(e,document.head)}async function Qn(e){return Wn(e,document.body)}function $n(e){return typeof e.checkVisibility==`function`?e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}):e.offsetWidth>0||e.offsetHeight>0}function er(e){return typeof e==`object`&&!!e&&`checked`in e&&typeof e.checked==`boolean`}function tr(e){return nr(e).toString()}function nr(e){let t=new URLSearchParams,n=e.querySelectorAll(`input[name], select[name], textarea[name]`);for(let e of n)if(!e.disabled&&!(e instanceof HTMLInputElement&&([`file`,`submit`,`button`,`reset`,`image`].includes(e.type)||(e.type===`checkbox`||e.type===`radio`)&&!e.checked))){if(e instanceof HTMLSelectElement&&e.multiple){for(let n of e.selectedOptions)t.append(e.name,n.value);continue}t.append(e.name,e.value)}for(let n of e.querySelectorAll(`*`)){if(!n.tagName.includes(`-`))continue;let e=n.name;if(typeof e!=`string`||e===``||n.disabled===!0||n.querySelector(`input[name], select[name], textarea[name]`))continue;if(er(n.modelValue)){n.modelValue.checked&&t.append(e,String(n.modelValue.value??``));continue}let r=n.serializedValue??n.value;if(r!=null)if(Array.isArray(r))for(let n of r)t.append(e,String(n));else t.append(e,String(r))}return t}var rr={Á:`A`,á:`a`,Ä:`A`,ä:`a`,À:`A`,à:`a`,Â:`A`,â:`a`,É:`E`,é:`e`,Ë:`E`,ë:`e`,È:`E`,è:`e`,Ê:`E`,ê:`e`,Í:`I`,í:`i`,Ï:`I`,ï:`i`,Ì:`I`,ì:`i`,Î:`I`,î:`i`,Ó:`O`,ó:`o`,Ö:`O`,ö:`o`,Ò:`O`,ò:`o`,Ô:`O`,ô:`o`,Ú:`U`,ú:`u`,Ü:`U`,ü:`u`,Ù:`U`,ù:`u`,Û:`U`,û:`u`,Ý:`Y`,ý:`y`,Ÿ:`Y`,А:`A`,Б:`B`,В:`V`,Г:`G`,Д:`D`,Ѓ:`Gj`,Е:`E`,Ж:`Z`,З:`Z`,Ѕ:`Dz`,И:`I`,Ј:`j`,К:`K`,Л:`L`,Љ:`Lj`,М:`M`,Н:`N`,Њ:`Nj`,О:`O`,П:`P`,Р:`R`,С:`S`,Т:`T`,Ќ:`Kj`,У:`U`,Ф:`F`,Х:`X`,Ц:`C`,Ч:`C`,Џ:`Dz`,Ш:`S`,а:`a`,б:`b`,в:`v`,г:`g`,д:`d`,ѓ:`gj`,е:`e`,ж:`z`,з:`z`,ѕ:`dz`,и:`i`,ј:`j`,к:`k`,л:`l`,љ:`lj`,м:`m`,н:`n`,њ:`nj`,о:`o`,п:`p`,р:`r`,с:`s`,т:`t`,ќ:`kj`,у:`u`,ф:`f`,х:`x`,ц:`c`,ч:`c`,џ:`dz`,ш:`s`,æ:`ae`,ǽ:`ae`,Ã:`A`,Å:`A`,Ǻ:`A`,Ă:`A`,Ǎ:`A`,Æ:`AE`,Ǽ:`AE`,ã:`a`,å:`a`,ǻ:`a`,ă:`a`,ǎ:`a`,ª:`a`,Ĉ:`C`,Ċ:`C`,Ç:`C`,ç:`c`,ĉ:`c`,ċ:`c`,Ð:`D`,Đ:`D`,ð:`d`,đ:`d`,Ĕ:`E`,Ė:`E`,ĕ:`e`,ė:`e`,ƒ:`f`,Ĝ:`G`,Ġ:`G`,ĝ:`g`,ġ:`g`,Ĥ:`H`,Ħ:`H`,ĥ:`h`,ħ:`h`,Ĩ:`I`,Ĭ:`I`,Ǐ:`I`,Į:`I`,Ĳ:`IJ`,ĩ:`i`,ĭ:`i`,ǐ:`i`,į:`i`,ĳ:`ij`,Ĵ:`J`,ĵ:`j`,Ĺ:`L`,Ľ:`L`,Ŀ:`L`,ĺ:`l`,ľ:`l`,ŀ:`l`,Ñ:`N`,ñ:`n`,ŉ:`n`,Õ:`O`,Ō:`O`,Ŏ:`O`,Ǒ:`O`,Ő:`O`,Ơ:`O`,Ø:`O`,Ǿ:`O`,Œ:`OE`,õ:`o`,ō:`o`,ŏ:`o`,ǒ:`o`,ő:`o`,ơ:`o`,ø:`o`,ǿ:`o`,º:`o`,œ:`oe`,Ŕ:`R`,Ŗ:`R`,ŕ:`r`,ŗ:`r`,Ŝ:`S`,Ș:`S`,ŝ:`s`,ș:`s`,ſ:`s`,Ţ:`T`,Ț:`T`,Ŧ:`T`,Þ:`TH`,ţ:`t`,ț:`t`,ŧ:`t`,þ:`th`,Ũ:`U`,Ŭ:`U`,Ű:`U`,Ų:`U`,Ư:`U`,Ǔ:`U`,Ǖ:`U`,Ǘ:`U`,Ǚ:`U`,Ǜ:`U`,ũ:`u`,ŭ:`u`,ű:`u`,ų:`u`,ư:`u`,ǔ:`u`,ǖ:`u`,ǘ:`u`,ǚ:`u`,ǜ:`u`,Ŵ:`W`,ŵ:`w`,Ŷ:`Y`,ÿ:`y`,ŷ:`y`,ΑΥ:`AU`,ΑΎ:`AU`,Αυ:`Au`,Αύ:`Au`,ΕΊ:`I`,ΕΙ:`I`,Ει:`Ei`,ΕΥ:`EF`,ΕΎ:`EU`,Εί:`I`,Ευ:`Ef`,Εύ:`Eu`,ΟΙ:`I`,ΟΊ:`I`,ΟΥ:`U`,ΟΎ:`OU`,Οι:`Oi`,Οί:`I`,Ου:`Oy`,Ού:`Ou`,ΥΙ:`I`,ΎΙ:`I`,Υι:`Yi`,Ύι:`I`,ΥΊ:`I`,Υί:`I`,αυ:`au`,αύ:`au`,εί:`i`,ει:`ei`,ευ:`ef`,εύ:`eu`,οι:`oi`,οί:`i`,ου:`oy`,ού:`ou`,υι:`yi`,ύι:`i`,υί:`i`,Α:`A`,Ά:`A`,Β:`B`,Δ:`D`,Ε:`E`,Έ:`E`,Φ:`F`,Γ:`G`,Η:`H`,Ή:`I`,Ι:`I`,Ί:`I`,Ϊ:`I`,Κ:`K`,Ξ:`Ks`,Λ:`L`,Μ:`M`,Ν:`N`,Π:`P`,Ο:`O`,Ό:`O`,Ψ:`Ps`,Ρ:`R`,Σ:`S`,Τ:`T`,Θ:`Th`,Ω:`O`,Ώ:`W`,Χ:`X`,ϒ:`Y`,Υ:`Y`,Ύ:`Y`,Ϋ:`Y`,Ζ:`Z`,α:`a`,ά:`a`,β:`v`,δ:`d`,ε:`e`,έ:`e`,φ:`f`,γ:`gh`,η:`i`,ή:`i`,ι:`i`,ί:`i`,ϊ:`i`,ΐ:`i`,κ:`k`,ξ:`ks`,λ:`l`,μ:`m`,ν:`n`,ο:`o`,ό:`o`,π:`p`,ψ:`ps`,ρ:`r`,σ:`s`,ς:`s`,τ:`t`,ϑ:`th`,θ:`th`,ϐ:`v`,ω:`o`,ώ:`w`,χ:`kh`,υ:`i`,ύ:`y`,ΰ:`y`,ϋ:`y`,ζ:`z`,अ:`a`,आ:`aa`,ए:`e`,ई:`ii`,ऍ:`ei`,ऎ:`ae`,ऐ:`ai`,इ:`i`,ओ:`o`,ऑ:`oi`,ऒ:`oii`,ऊ:`uu`,औ:`ou`,उ:`u`,ब:`B`,भ:`Bha`,च:`Ca`,छ:`Chha`,ड:`Da`,ढ:`Dha`,फ:`Fa`,फ़:`Fi`,ग:`Ga`,घ:`Gha`,ग़:`Ghi`,ह:`Ha`,ज:`Ja`,झ:`Jha`,क:`Ka`,ख:`Kha`,ख़:`Khi`,ल:`L`,ळ:`Li`,ऌ:`Li`,ऴ:`Lii`,ॡ:`Lii`,म:`Ma`,न:`Na`,ङ:`Na`,ञ:`Nia`,ण:`Nae`,ऩ:`Ni`,ॐ:`oms`,प:`Pa`,क़:`Qi`,र:`Ra`,ऋ:`Ri`,ॠ:`Ri`,ऱ:`Ri`,स:`Sa`,श:`Sha`,ष:`Shha`,ट:`Ta`,त:`Ta`,ठ:`Tha`,द:`Tha`,थ:`Tha`,ध:`Thha`,ड़:`ugDha`,ढ़:`ugDhha`,व:`Va`,य:`Ya`,य़:`Yi`,ज़:`Za`,Ա:`A`,Բ:`B`,Գ:`G`,Դ:`D`,Ե:`E`,Զ:`Z`,Է:`E`,Ը:`Y`,Թ:`Th`,Ժ:`Zh`,Ի:`I`,Լ:`L`,Խ:`Kh`,Ծ:`Ts`,Կ:`K`,Հ:`H`,Ձ:`Dz`,Ղ:`Gh`,Ճ:`Tch`,Մ:`M`,Յ:`Y`,Ն:`N`,Շ:`Sh`,Ո:`Vo`,Չ:`Ch`,Պ:`P`,Ջ:`J`,Ռ:`R`,Ս:`S`,Վ:`V`,Տ:`T`,Ր:`R`,Ց:`C`,Ւ:`u`,Փ:`Ph`,Ք:`Q`,և:`ev`,Օ:`O`,Ֆ:`F`,ա:`a`,բ:`b`,գ:`g`,դ:`d`,ե:`e`,զ:`z`,է:`e`,ը:`y`,թ:`th`,ժ:`zh`,ի:`i`,լ:`l`,խ:`kh`,ծ:`ts`,կ:`k`,հ:`h`,ձ:`dz`,ղ:`gh`,ճ:`tch`,մ:`m`,յ:`y`,ն:`n`,շ:`sh`,ո:`vo`,չ:`ch`,պ:`p`,ջ:`j`,ռ:`r`,ս:`s`,վ:`v`,տ:`t`,ր:`r`,ց:`c`,ւ:`u`,փ:`ph`,ք:`q`,օ:`o`,ֆ:`f`,Ž:`Z`,Ň:`N`,Ş:`S`,ž:`z`,ň:`n`,ş:`s`,ı:`i`,İ:`I`,ğ:`g`,Ğ:`G`,ьо:`yo`,Й:`i`,Щ:`Shh`,Ъ:`Ie`,Ь:``,Ю:`Iu`,Я:`Ia`,й:`i`,щ:`shh`,ъ:`ie`,ь:``,ю:`iu`,я:`ia`,Ē:`E`,ē:`e`,န်ုပ်:`nub`,"ောင်":`aung`,"ိုက်":`aik`,"ိုဒ်":`ok`,"ိုင်":`aing`,"ိုလ်":`ol`,"ေါင်":`aung`,သြော:`aw`,"ောက်":`auk`,"ိတ်":`eik`,"ုတ်":`ok`,"ုန်":`on`,"ေတ်":`it`,"ုဒ်":`ait`,"ာန်":`an`,"ိန်":`ein`,"ွတ်":`ut`,"ေါ်":`aw`,"ွန်":`un`,"ိပ်":`eik`,"ုပ်":`ok`,"ွပ်":`ut`,"ိမ်":`ein`,"ုမ်":`on`,"ော်":`aw`,"ွမ်":`un`,က်:`et`,"ေါ":`aw`,"ော":`aw`,"ျွ":`ywa`,"ြွ":`yw`,"ို":`o`,"ုံ":`on`,တ်:`at`,င်:`in`,ည်:`i`,ဒ်:`d`,န်:`an`,ပ်:`at`,မ်:`an`,စျ:`za`,ယ်:`e`,ဉ်:`in`,စ်:`it`,"ိံ":`ein`,"ဲ":`e`,"း":``,"ာ":`a`,"ါ":`a`,"ေ":`e`,"ံ":`an`,"ိ":`i`,"ီ":`i`,"ု":`u`,"ူ":`u`,"်":`at`,"္":``,"့":``,က:`k`,"၉":`9`,တ:`t`,ရ:`ya`,ယ:`y`,မ:`m`,ဘ:`ba`,ဗ:`b`,ဖ:`pa`,ပ:`p`,န:`n`,ဓ:`da`,ဒ:`d`,ထ:`ta`,ဏ:`na`,ဝ:`w`,ဎ:`da`,ဍ:`d`,ဌ:`ta`,ဋ:`t`,ည:`ny`,ဇ:`z`,ဆ:`sa`,စ:`s`,င:`ng`,ဃ:`ga`,ဂ:`g`,လ:`l`,သ:`th`,"၈":`8`,ဩ:`aw`,ခ:`kh`,"၆":`6`,"၅":`5`,"၄":`4`,"၃":`3`,"၂":`2`,"၁":`1`,"၀":`0`,"၌":`hnaik`,"၍":`ywae`,ဪ:`aw`,ဦ:`-u`,ဟ:`h`,ဉ:`u`,ဤ:`-i`,ဣ:`i`,"၏":`-e`,ဧ:`e`,"ှ":`h`,"ွ":`w`,"ျ":`ya`,"ြ":`y`,အ:`a`,ဠ:`la`,"၇":`7`,DŽ:`DZ`,Dž:`Dz`,dž:`dz`,Ǳ:`DZ`,ǲ:`Dz`,ǳ:`dz`,Ǉ:`LJ`,ǈ:`Lj`,ǉ:`lj`,Ǌ:`NJ`,ǋ:`Nj`,ǌ:`nj`,č:`c`,Č:`C`,ć:`c`,Ć:`C`,š:`s`,Š:`S`,ა:`a`,ბ:`b`,გ:`g`,დ:`d`,ე:`e`,ვ:`v`,ზ:`z`,თ:`t`,ი:`i`,კ:`k`,ლ:`l`,მ:`m`,ნ:`n`,ო:`o`,პ:`p`,ჟ:`zh`,რ:`r`,ს:`s`,ტ:`t`,უ:`u`,ფ:`f`,ქ:`q`,ღ:`gh`,ყ:`y`,შ:`sh`,ჩ:`ch`,ც:`ts`,ძ:`dz`,წ:`ts`,ჭ:`ch`,ხ:`kh`,ჯ:`j`,ჰ:`h`,Ё:`E`,ё:`e`,Ы:`Y`,ы:`y`,Э:`E`,э:`e`,І:`I`,і:`i`,Ѳ:`F`,ѳ:`f`,Ѣ:`E`,ѣ:`e`,Ѵ:`I`,ѵ:`i`,Є:`Je`,є:`je`,Ѥ:`Je`,ѥ:`je`,Ꙋ:`U`,ꙋ:`u`,Ѡ:`O`,ѡ:`o`,Ѿ:`Ot`,ѿ:`ot`,Ѫ:`U`,ѫ:`u`,Ѧ:`Ja`,ѧ:`ja`,Ѭ:`Ju`,ѭ:`ju`,Ѩ:`Ja`,ѩ:`Ja`,Ѯ:`Ks`,ѯ:`ks`,Ѱ:`Ps`,ѱ:`ps`,Ґ:`G`,ґ:`g`,Ї:`Yi`,ї:`yi`,Ә:`A`,Ғ:`G`,Қ:`Q`,Ң:`N`,Ө:`O`,Ұ:`U`,Ү:`U`,Һ:`H`,ә:`a`,ғ:`g`,қ:`q`,ң:`n`,ө:`o`,ұ:`u`,ү:`u`,һ:`h`,ď:`d`,Ď:`D`,ě:`e`,Ě:`E`,ř:`r`,Ř:`R`,ť:`t`,Ť:`T`,ů:`u`,Ů:`U`,ą:`a`,ę:`e`,ł:`l`,ń:`n`,ś:`s`,ź:`z`,ż:`z`,Ą:`A`,Ę:`E`,Ł:`L`,Ń:`N`,Ś:`S`,Ź:`Z`,Ż:`Z`,ā:`a`,ģ:`g`,ī:`i`,ķ:`k`,ļ:`l`,ņ:`n`,ū:`u`,Ā:`A`,Ģ:`G`,Ī:`I`,Ķ:`k`,Ļ:`L`,Ņ:`N`,Ū:`U`,Ả:`A`,Ạ:`A`,Ắ:`A`,Ằ:`A`,Ẳ:`A`,Ẵ:`A`,Ặ:`A`,Ấ:`A`,Ầ:`A`,Ẩ:`A`,Ẫ:`A`,Ậ:`A`,ả:`a`,ạ:`a`,ắ:`a`,ằ:`a`,ẳ:`a`,ẵ:`a`,ặ:`a`,ấ:`a`,ầ:`a`,ẩ:`a`,ẫ:`a`,ậ:`a`,Ẻ:`E`,Ẽ:`E`,Ẹ:`E`,Ế:`E`,Ề:`E`,Ể:`E`,Ễ:`E`,Ệ:`E`,ẻ:`e`,ẽ:`e`,ẹ:`e`,ế:`e`,ề:`e`,ể:`e`,ễ:`e`,ệ:`e`,Ỉ:`I`,Ị:`I`,ỉ:`i`,ị:`i`,Ỏ:`O`,Ọ:`O`,Ố:`O`,Ồ:`O`,Ổ:`O`,Ỗ:`O`,Ộ:`O`,Ớ:`O`,Ờ:`O`,Ở:`O`,Ỡ:`O`,Ợ:`O`,ỏ:`o`,ọ:`o`,ố:`o`,ồ:`o`,ổ:`o`,ỗ:`o`,ộ:`o`,ớ:`o`,ờ:`o`,ở:`o`,ỡ:`o`,ợ:`o`,Ủ:`U`,Ụ:`U`,Ứ:`U`,Ừ:`U`,Ử:`U`,Ữ:`U`,Ự:`U`,ủ:`u`,ụ:`u`,ứ:`u`,ừ:`u`,ử:`u`,ữ:`u`,ự:`u`,Ỳ:`Y`,Ỷ:`Y`,Ỹ:`Y`,Ỵ:`Y`,ỳ:`y`,ỷ:`y`,ỹ:`y`,ỵ:`y`,ا:`a`,ب:`b`,پ:`p`,ت:`t`,ث:`th`,ج:`g`,چ:`ch`,ح:`h`,خ:`kh`,د:`d`,ذ:`th`,ر:`r`,ز:`z`,س:`s`,ش:`sh`,ص:`s`,ض:`d`,ط:`t`,ظ:`th`,ع:`aa`,غ:`gh`,ف:`f`,ق:`k`,ک:`k`,گ:`g`,ل:`l`,ژ:`zh`,ك:`k`,م:`m`,ن:`n`,ه:`h`,و:`o`,ی:`y`,آ:`a`,"٠":`0`,"١":`1`,"٢":`2`,"٣":`3`,"٤":`4`,"٥":`5`,"٦":`6`,"٧":`7`,"٨":`8`,"٩":`9`,أ:`a`,ي:`y`,إ:`a`,ؤ:`o`,ئ:`y`,ء:`aa`,ђ:`dj`,ћ:`c`,Ђ:`Dj`,Ћ:`C`,ə:`e`,Ə:`E`,ß:`ss`,ẞ:`SS`,ভ্ল:`vl`,পশ:`psh`,ব্ধ:`bdh`,ব্জ:`bj`,ব্দ:`bd`,ব্ব:`bb`,ব্ল:`bl`,ভ:`v`,ব:`b`,চ্ঞ:`cNG`,চ্ছ:`cch`,চ্চ:`cc`,ছ:`ch`,চ:`c`,ধ্ন:`dhn`,ধ্ম:`dhm`,দ্ঘ:`dgh`,দ্ধ:`ddh`,দ্ভ:`dv`,দ্ম:`dm`,ড্ড:`DD`,ঢ:`Dh`,ধ:`dh`,দ্গ:`dg`,দ্দ:`dd`,ড:`D`,দ:`d`,"।":`.`,ঘ্ন:`Ghn`,গ্ধ:`Gdh`,গ্ণ:`GN`,গ্ন:`Gn`,গ্ম:`Gm`,গ্ল:`Gl`,জ্ঞ:`jNG`,ঘ:`Gh`,গ:`g`,হ্ণ:`hN`,হ্ন:`hn`,হ্ম:`hm`,হ্ল:`hl`,হ:`h`,জ্ঝ:`jjh`,ঝ:`jh`,জ্জ:`jj`,জ:`j`,ক্ষ্ণ:`kxN`,ক্ষ্ম:`kxm`,ক্ষ:`ksh`,কশ:`ksh`,ক্ক:`kk`,ক্ট:`kT`,ক্ত:`kt`,ক্ল:`kl`,ক্স:`ks`,খ:`kh`,ক:`k`,ল্ভ:`lv`,ল্ধ:`ldh`,লখ:`lkh`,লঘ:`lgh`,লফ:`lph`,ল্ক:`lk`,ল্গ:`lg`,ল্ট:`lT`,ল্ড:`lD`,ল্প:`lp`,ল্ম:`lm`,ল্ল:`ll`,ল্ব:`lb`,ল:`l`,ম্থ:`mth`,ম্ফ:`mf`,ম্ভ:`mv`,মপ্ল:`mpl`,ম্ন:`mn`,ম্প:`mp`,ম্ম:`mm`,ম্ল:`ml`,ম্ব:`mb`,ম:`m`,"০":`0`,"১":`1`,"২":`2`,"৩":`3`,"৪":`4`,"৫":`5`,"৬":`6`,"৭":`7`,"৮":`8`,"৯":`9`,ঙ্ক্ষ:`Ngkx`,ঞ্ছ:`nch`,ঙ্ঘ:`ngh`,ঙ্খ:`nkh`,ঞ্ঝ:`njh`,ঙ্গৌ:`ngOU`,ঙ্গৈ:`ngOI`,ঞ্চ:`nc`,ঙ্ক:`nk`,ঙ্ষ:`Ngx`,ঙ্গ:`ngo`,ঙ্ম:`Ngm`,ঞ্জ:`nj`,ন্ধ:`ndh`,ন্ঠ:`nTh`,ণ্ঠ:`NTh`,ন্থ:`nth`,ঙ্গা:`nga`,ঙ্গি:`ngi`,ঙ্গী:`ngI`,ঙ্গু:`ngu`,ঙ্গূ:`ngU`,ঙ্গে:`nge`,ঙ্গো:`ngO`,ণ্ঢ:`NDh`,নশ:`nsh`,ঙর:`Ngr`,ঞর:`NGr`,"ংর":`ngr`,ঙ:`Ng`,ঞ:`NG`,"ং":`ng`,ন্ন:`nn`,ণ্ণ:`NN`,ণ্ন:`Nn`,ন্ম:`nm`,ণ্ম:`Nm`,ন্দ:`nd`,ন্ট:`nT`,ণ্ট:`NT`,ন্ড:`nD`,ণ্ড:`ND`,ন্ত:`nt`,ন্স:`ns`,ন:`n`,ণ:`N`,"ৈ":`OI`,"ৌ":`OU`,"ো":`O`,ঐ:`OI`,ঔ:`OU`,অ:`o`,ও:`oo`,ফ্ল:`fl`,প্ট:`pT`,প্ত:`pt`,প্ন:`pn`,প্প:`pp`,প্ল:`pl`,প্স:`ps`,ফ:`f`,প:`p`,"ৃ":`rri`,ঋ:`rri`,রর‍্য:`rry`,"্র্য":`ry`,"্রর":`rr`,ড়্গ:`Rg`,ঢ়:`Rh`,ড়:`R`,র:`r`,"্র":`r`,শ্ছ:`Sch`,ষ্ঠ:`ShTh`,ষ্ফ:`Shf`,স্ক্ল:`skl`,স্খ:`skh`,স্থ:`sth`,স্ফ:`sf`,শ্চ:`Sc`,শ্ত:`St`,শ্ন:`Sn`,শ্ম:`Sm`,শ্ল:`Sl`,ষ্ক:`Shk`,ষ্ট:`ShT`,ষ্ণ:`ShN`,ষ্প:`Shp`,ষ্ম:`Shm`,স্প্ল:`spl`,স্ক:`sk`,স্ট:`sT`,স্ত:`st`,স্ন:`sn`,স্প:`sp`,স্ম:`sm`,স্ল:`sl`,শ:`S`,ষ:`Sh`,স:`s`,"ু":`u`,উ:`u`,অ্য:`oZ`,ত্থ:`tth`,ৎ:`tt`,ট্ট:`TT`,ট্ম:`Tm`,ঠ:`Th`,ত্ন:`tn`,ত্ম:`tm`,থ:`th`,ত্ত:`tt`,ট:`T`,ত:`t`,অ্যা:`AZ`,"া":`a`,আ:`a`,য়া:`ya`,য়:`y`,"ি":`i`,ই:`i`,"ী":`ee`,ঈ:`ee`,"ূ":`uu`,ঊ:`uu`,"ে":`e`,এ:`e`,য:`z`,"্য":`Z`,ইয়:`y`,ওয়:`w`,"্ব":`w`,এক্স:`x`,"ঃ":`:`,"ঁ":`nn`,"্‌":``,"˚":`0`,"¹":`1`,"²":`2`,"³":`3`,"⁴":`4`,"⁵":`5`,"⁶":`6`,"⁷":`7`,"⁸":`8`,"⁹":`9`,"₀":`0`,"₁":`1`,"₂":`2`,"₃":`3`,"₄":`4`,"₅":`5`,"₆":`6`,"₇":`7`,"₈":`8`,"₉":`9`,"௦":`0`,"௧":`1`,"௨":`2`,"௩":`3`,"௪":`4`,"௫":`5`,"௬":`6`,"௭":`7`,"௮":`8`,"௯":`9`,"௰":`10`,"௱":`100`,"௲":`1000`,Ꜳ:`AA`,ꜳ:`aa`,Ꜵ:`AO`,ꜵ:`ao`,Ꜷ:`AU`,ꜷ:`au`,Ꜹ:`AV`,ꜹ:`av`,Ꜻ:`av`,ꜻ:`av`,Ꜽ:`AY`,ꜽ:`ay`,ȸ:`db`,ʣ:`dz`,ʥ:`dz`,ʤ:`dezh`,"🙰":`et`,ﬀ:`ff`,ﬃ:`ffi`,ﬄ:`ffl`,ﬁ:`fi`,ﬂ:`fl`,ʩ:`feng`,ʪ:`ls`,ʫ:`lz`,ɮ:`lezh`,ȹ:`qp`,ʨ:`tc`,ʦ:`ts`,ʧ:`tesh`,Ꝏ:`OO`,ꝏ:`oo`,ﬆ:`st`,ﬅ:`st`,Ꜩ:`TZ`,ꜩ:`tz`,ᵫ:`ue`,Aι:`Ai`,αι:`ai`,ἀ:`a`,ἁ:`a`,ἂ:`a`,ἃ:`a`,ἄ:`a`,ἅ:`a`,ἆ:`a`,ἇ:`a`,Ἀ:`A`,Ἁ:`A`,Ἂ:`A`,Ἃ:`A`,Ἄ:`A`,Ἅ:`A`,Ἆ:`A`,Ἇ:`A`,ᾰ:`a`,ᾱ:`a`,ᾲ:`a`,ᾳ:`a`,ᾴ:`a`,ᾶ:`a`,ᾷ:`a`,Ᾰ:`A`,Ᾱ:`A`,Ὰ:`A`,Ά:`A`,ᾼ:`A`,A̧:`A`,a̧:`a`,Ⱥ:`A`,ⱥ:`a`,Ȧ:`A`,ȧ:`a`,Ɓ:`B`,C̈:`C`,c̈:`c`,C̨:`C`,c̨:`c`,Ȼ:`C`,ȼ:`c`,C̀:`C`,c̀:`c`,C̣:`C`,c̣:`c`,C̄:`C`,c̄:`c`,C̃:`C`,c̃:`c`,Ȩ:`E`,ȩ:`e`,Ɇ:`E`,ɇ:`e`,I̧:`I`,i̧:`i`,Ɨ:`I`,ɨ:`i`,i:`i`,J́́:`J`,j́:`j`,J̀̀:`J`,j̀:`j`,J̈:`J`,j̈:`j`,J̧:`J`,j̧:`j`,J̨:`J`,j̨:`j`,Ɉ:`J`,ɉ:`j`,J̌:`J`,ǰ:`j`,J̇:`J`,j:`j`,J̣:`J`,j̣:`j`,J̄:`J`,j̄:`j`,J̃:`J`,j̃:`j`,ĸ:`k`,L̀:`L`,l̀:`l`,L̂:`L`,l̂:`l`,L̈:`L`,l̈:`l`,L̨:`L`,l̨:`l`,Ƚ:`L`,ƚ:`l`,L̇:`L`,l̇:`l`,Ḷ:`L`,ḷ:`l`,L̄:`L`,l̄:`l`,L̃:`L`,l̃:`l`,Ŋ:`N`,ŋ:`n`,Ǹ:`N`,ǹ:`n`,N̂:`N`,n̂:`n`,N̈:`N`,n̈:`n`,N̨:`N`,n̨:`n`,Ꞥ:`N`,ꞥ:`n`,Ṅ:`N`,ṅ:`n`,Ṇ:`N`,ṇ:`n`,N̄:`N`,n̄:`n`,O̧:`O`,o̧:`o`,Ǫ:`O`,ǫ:`o`,Ɵ:`O`,ɵ:`o`,Ȯ:`O`,ȯ:`o`,S̀:`S`,s̀:`s`,Ŝ̀:`S`,S̈:`S`,s̈:`s`,S̨:`S`,s̨:`s`,Ꞩ:`S`,ꞩ:`s`,Ṡ:`S`,ṡ:`s`,Ṣ:`S`,ṣ:`s`,S̄:`S`,s̄:`s`,S̃:`S`,s̃:`s`,T́:`T`,t́:`t`,T̀:`T`,t̀:`t`,T̂:`T`,t̂:`t`,T̈:`T`,ẗ:`t`,T̨:`T`,t̨:`t`,Ⱦ:`T`,ⱦ:`t`,Ṫ:`T`,ṫ:`t`,Ṭ:`T`,ṭ:`t`,T̄:`T`,t̄:`t`,T̃:`T`,t̃:`t`,U̧:`U`,u̧:`u`,Ʉ:`U`,ʉ:`u`,U̇:`U`,u̇:`u`,Ʊ:`U`,ʊ:`u`,Ẁ:`W`,ẁ:`w`,Ẃ:`W`,ẃ:`w`,Ẅ:`W`,ẅ:`w`,Ꙗ:`Ja`,ꙗ:`ja`,Y̧:`Y`,y̧:`y`,Y̨:`Y`,y̨:`y`,Ɏ:`Y`,ɏ:`y`,Y̌:`Y`,y̌:`y`,Ẏ:`Y`,ẏ:`y`,Ȳ:`Y`,ȳ:`y`,Z̀:`Z`,z̀:`z`,Ẑ:`Z`,ẑ:`z`,Z̈:`Z`,z̈:`z`,Z̧:`Z`,z̧:`z`,Z̨:`Z`,z̨:`z`,Ƶ:`Z`,ƶ:`z`,Ẓ:`Z`,ẓ:`z`,Z̄:`Z`,z̄:`z`,Z̃:`Z`,z̃:`z`,"\xA0":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `,"\u2028":` `,"\u2029":` `,"​":` `," ":` `," ":` `,"　":` `,ﾠ:` `,"«":`<<`,"»":`>>`,"‘":`'`,"’":`'`,"‚":`'`,"‛":`'`,"“":`"`,"”":`"`,"„":`"`,"‟":`"`,"‹":`'`,"›":`'`,"–":`-`,"—":`-`,"…":`...`,"€":`EUR`,$:`$`,"₢":`Cr`,"₣":`Fr.`,"£":`PS`,"₤":`L.`,ℳ:`M`,"₥":`mil`,"₦":`N`,"₧":`Pts`,"₨":`Rs`,රු:`LKR`,ரூ:`LKR`,"௹":`Rs`,रू:`NPR`,"₹":`Rs`,"૱":`Rs`,"₩":`W`,"₪":`NS`,"₸":`KZT`,"₫":`D`,"֏":`AMD`,"₭":`K`,"₺":`TL`,"₼":`AZN`,"₮":`T`,"₯":`Dr`,"₲":`PYG`,"₾":`GEL`,"₳":`ARA`,"₴":`UAH`,"₽":`RUB`,"₵":`GHS`,"₡":`CL`,"¢":`c`,"¥":`YEN`,円:`JPY`,"৳":`BDT`,元:`CNY`,"﷼":`SAR`,"៛":`KR`,"₠":`ECU`,"¤":`$?`,"฿":`THB`,"؋":`AFN`};function ir(e,t=rr){e=e.normalize(`NFC`);let n=``,r;for(let i=0;i<e.length;i++)r=e.charAt(i),n+=typeof t[r]==`string`?t[r]:r;return n}function ar(e,t={}){let n={allowNonAlphaStart:!1,handleCasing:`camel`,...t};var r=e.replace(/<(.*?)>/g,``);r=r.replace(/['"‘’“”ʻ\[\]\(\)\{\}:]/g,``),r=r.toLowerCase(),r=ir(r),n.allowNonAlphaStart||(r=r.replace(/^[^a-z]+/,``));let i=r.split(/[^a-z0-9]+/).filter(Boolean);if(r=``,n.handleCasing===`snake`)return i.join(`_`);for(let e=0;e<i.length;e++)n.handleCasing!==`pascal`&&e===0?r+=i[e]:r+=i[e].charAt(0).toUpperCase()+i[e].substring(1);return r}function or(e,t={}){let n={prefix:``,suffix:``,...t},r=ar(e,{handleCasing:`snake`}).toUpperCase();return r?`${n.prefix}${r}${n.suffix}`:``}function sr(e){let t=e.replace(/<(.*?)>/g,``);return t=t.toLowerCase(),t=ir(t),t=t.replace(/^[^a-z]+/,``),t=t.replace(/[^a-z0-9]+$/,``),t.split(/[^a-z0-9]+/).filter(Boolean).join(`-`)}function cr(e){return e.charAt(0).toUpperCase()+e.slice(1)}function lr(){return Math.floor(Math.random()*1e6)}var ur=new WeakMap,dr=class e{constructor(){this.queue=[],this.workers=[],j(this,ur,null),N(ur,this,new AbortController);for(let e=0;e<3;e++)this.workers.push(new hr(this))}load(t=document,n=`[data-sizes]`){t.querySelectorAll(n).forEach(t=>{if($n(t))this.addToQueue(t);else{let n=`thumb${lr()}`;e.invisibleThumbs[n]=[this,t];let r=()=>{e.invisibleThumbs[n]&&$n(t)&&(delete e.invisibleThumbs[n],this.addToQueue(t))};document.addEventListener(`scroll`,r,{signal:A(ur,this)?.signal}),window.addEventListener(`resize`,r,{signal:A(ur,this)?.signal})}})}addToQueue(e){this.queue.push(e),this.workers.forEach(e=>{e.active||e.loadNext()})}static retryAll(){for(let t in e.invisibleThumbs){let n=e.invisibleThumbs[t];if(!n)continue;let[r,i]=n;delete e.invisibleThumbs[t],r.load(i.parentElement??document)}}destroy(){this.workers.forEach(e=>e.deactivate()),A(ur,this)?.abort()}};dr.invisibleThumbs={};var fr=new WeakMap,pr=new WeakMap,mr=new WeakMap,hr=class{constructor(e){this.active=!1,this.container=void 0,j(this,fr,null),j(this,pr,null),j(this,mr,null),N(fr,this,e)}activate(){this.active||(this.active=!0,this.clearInterval(),N(pr,this,setInterval(()=>{this.loadNextIfRemoved()},500)))}deactivate(){this.active&&(this.active=!1,this.clearInterval(),this.clearTimeout())}clearInterval(){A(pr,this)&&(clearInterval(A(pr,this)),N(pr,this,null))}clearTimeout(){A(mr,this)&&(clearTimeout(A(mr,this)),N(mr,this,null))}loadNext(){if(this.clearTimeout(),this.container=A(fr,this)?.queue.shift(),this.container===void 0){this.deactivate();return}if(this.loadNextIfRemoved())return;if(this.container.querySelectorAll(`img`).length>0){this.loadNext();return}this.activate(),N(mr,this,setTimeout(()=>{this.loadNext()},3e4));let e=document.createElement(`img`);e.sizes=this.container.getAttribute(`data-sizes`)??``,e.srcset=this.container.getAttribute(`data-srcset`)??``,e.alt=this.container.getAttribute(`data-alt`)??``,e.setAttribute(`data-animated`,this.container.getAttribute(`data-animated`)??``),e.src=this.container.getAttribute(`data-src`)??``,e.onload=()=>this.loadNext(),e.onabort=()=>this.loadNext(),e.onerror=()=>this.loadNext(),this.container.appendChild(e)}loadNextIfRemoved(){return this.container&&!document.body.contains(this.container)?(this.loadNext(),!0):!1}},gr=a`
  :host {
    display: contents;
  }
...
`,_r=new WeakMap,vr=new WeakMap,yr=new WeakMap,br=new WeakSet,xr=class extends l{constructor(...e){super(...e),M(this,br),this.size=`small`,this.variant=null,this.appearance=oe.OutlineFill,this.icon=null,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,this.selected=!1,this.selectLabel=null,j(this,_r,!1),j(this,vr,new dr),j(this,yr,new ge(this))}connectedCallback(){super.connectedCallback(),this.getAttribute(`data-color`)||this.setAttribute(`data-color`,`white`)}renderSelect(){return r`<input
      type="checkbox"
      class="cp-chip__select"
      part="select"
      .checked=${this.selected}
      aria-label=${this.selectLabel??_(`Select`)}
      @click=${P(br,this,Sr)}
      @change=${P(br,this,Cr)}
    />`}renderPrefix(){let e=this.showStatus||_e(this,`status`);return r`<div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
        ...
        ${this.icon?r`<slot class="cp-chip__icon" name="icon"
            ...
            ></slot>`:c}
        ${e?r`<slot class="cp-chip__status" name="status"></slot>`:c}
      </slot>
    </div>`}firstUpdated(e){super.firstUpdated(e),A(vr,this).load(this)}render(){let e=_e(this,`prefix`,`icon`,`status`,`thumbnail`)||this.showStatus||this.icon,t=_e(this,`suffix`);return r`
      <div
        part="chip"
        class="${E({"cp-chip":!0,"cp-chip--small":this.size===`small`,"cp-chip--medium":this.size===`medium`,"cp-chip--large":this.size===`large`,"cp-chip--plain":this.appearance===oe.Plain,"cp-chip--selectable":this.selectable,"cp-chip--show-thumb":this.showThumb,"cp-chip--show-status":this.showStatus})}"
      >
    ...
    `}};function Sr(e){N(_r,this,e.shiftKey),e.stopPropagation()}function Cr(e){let{checked:t}=e.target;this.selected=t,this.dispatchEvent(new CustomEvent(`craft-selection-change`,{detail:{selected:t,shiftKey:A(_r,this)},bubbles:!0,composed:!0}))}xr.styles=[pe,gr],D([O()],xr.prototype,`size`,void 0),D([O({reflect:!0})],xr.prototype,`variant`,void 0),D([O({reflect:!0})],xr.prototype,`appearance`,void 0),D([O()],xr.prototype,`icon`,void 0),D([O({attribute:`show-status`,type:Boolean})],xr.prototype,`showStatus`,void 0),D([O({attribute:`show-thumb`,type:Boolean})],xr.prototype,`showThumb`,void 0),D([O({type:Boolean})],xr.prototype,`selectable`,void 0),D([O({type:Boolean,reflect:!0})],xr.prototype,`selected`,void 0),D([O({attribute:`select-label`})],xr.prototype,`selectLabel`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,xr);var wr=e=>{e.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0}))},Tr=e=>{e.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))},Er=class extends En(l){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},Dr=S(e=>class extends un(an(On(Fe(Tn(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],a`
          :host {
            display: block;
          }
...
`,jr=new WeakMap,Mr=new WeakSet,Nr=class extends kr{constructor(...e){super(...e),M(this,Mr),this.hint=null,j(this,jr,void 0)}static get styles(){return[...kr.styles,Ar]}connectedCallback(){super.connectedCallback(),Fr._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),Fr._.unobserve(this)}render(){return r`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?r`<span class="hint">${this.hint}</span>`:c}
        <slot name="suffix"></slot>
      </div>
    `}};function Pr(){return A(jr,this)??N(jr,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),A(jr,this)}var Fr={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=P(Mr,e,Pr).call(e))}})};D([O()],Nr.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,Nr);var Ir=new WeakMap;function Lr(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Ir.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else Lr(n,t)})}function Rr(e){Ir.has(e)&&Ir.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Ir.has(e)&&Ir.get(e)():Rr(e)})}var zr=class extends _n{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof cn}};function Br(e){return Array.isArray(e)?e:[e]}var Vr=S(e=>class extends On(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Br(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Br(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Br(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Br(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Hr=new WeakMap,Ur=class extends Qt(se(Vr(Or))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,a`
        .input-group__input {
          display: flex;
          flex: 1;
        }
      ...
      `]}static get localizeNamespaces(){return[{"lion-combobox":e=>{switch(e){case`bg-BG`:case`bg`:return b(()=>import(`./bg-Bs0XcBVB.js`),[],import.meta.url);case`cs-CZ`:case`cs`:return b(()=>import(`./cs-B8DQIi4_.js`),[],import.meta.url);case`de-AT`:case`de-DE`:case`de`:return b(()=>import(`./de-BGf3YhNb.js`),[],import.meta.url);case`en-AU`:case`en-GB`:case`en-PH`:case`en-US`:case`en`:return b(()=>import(`./en-D-xWIAUL.js`),[],import.meta.url);case`es-ES`:case`es`:return b(()=>import(`./es-BxznwUyK.js`),[],import.meta.url);case`fr-FR`:case`fr-BE`:case`fr`:return b(()=>import(`./fr-Cma_rLCi.js`),[],import.meta.url);case`hu-HU`:case`hu`:return b(()=>import(`./hu-oz_RH6aJ.js`),[],import.meta.url);case`it-IT`:case`it`:return b(()=>import(`./it-BUnCsVOb.js`),[],import.meta.url);case`nl-BE`:case`nl-NL`:case`nl`:return b(()=>import(`./nl-BgK25p-m.js`),[],import.meta.url);case`pl-PL`:case`pl`:return b(()=>import(`./pl-BFxKYQFW.js`),[],import.meta.url);case`ro-RO`:case`ro`:return b(()=>import(`./ro-DXnny9tt.js`),[],import.meta.url);case`ru-RU`:case`ru`:return b(()=>import(`./ru-DxR-HmN-.js`),[],import.meta.url);case`sk-SK`:case`sk`:return b(()=>import(`./sk-Hha-L2N4.js`),[],import.meta.url);case`uk-UA`:case`uk`:return b(()=>import(`./uk-CvmsXQbu.js`),[],import.meta.url);case`zh-CN`:case`zh`:return b(()=>import(`./zh-CgAr6HSc.js`),[],import.meta.url);default:return b(()=>import(`./en-D-xWIAUL.js`),[],import.meta.url)}}},...super.localizeNamespaces]}get modelValue(){let e=super.modelValue;return e===``?this.parser(this.value):e}set modelValue(e){super.modelValue=e}get value(){return this._inputNode?.value||this.__value||``}set value(e){this._inputNode?(this._inputNode.value=e,this.__value=void 0):this.__value=e}reset(){super.reset(),this.multipleChoice||(this.value=this._initialModelValue),this._resetListboxOptions()}_resetListboxOptions(){this.formElements.forEach((e,t)=>{this._unhighlightMatchedOption(e),!this.showAllOnEmpty||!this.opened?e.style.display=`none`:(e.style.display=``,e.setAttribute(`aria-posinset`,`${t+1}`),e.setAttribute(`aria-setsize`,`${this.formElements.length}`),e.removeAttribute(`aria-hidden`))})}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
...
`,qr=new WeakMap,Jr=new WeakMap,Yr=new WeakMap,H=new WeakSet,Xr=new WeakMap,Zr=new WeakMap,Qr=new WeakMap,$r=class extends Ur{static get properties(){return{modelValue:{attribute:`model-value`}}}attributeChangedCallback(e,t,n){if(e===`model-value`){this.modelValue=this.hasAttribute(`multiple-choice`)?JSON.parse(n??`[]`):n??``;return}super.attributeChangedCallback(e,t,n)}static get styles(){return[...super.styles,Kr]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),M(this,H),this.multipleChoice=!1,this.required=!1,this.initialValues=[],this.fieldsetDisabled=!1,this.changingValues=!1,this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,j(this,qr,void 0),j(this,Jr,void 0),j(this,Yr,!1),j(this,Xr,!1),j(this,Zr,e=>{e.stopPropagation(),N(Xr,this,!0);try{N(Yr,this,!0),P(H,this,ai).call(this),!this.multipleChoice&&!this.requireOptionMatch&&P(H,this,ti).call(this)}finally{N(Xr,this,!1)}wr(this)}),j(this,Qr,()=>{if(this.multipleChoice){this.changeValues([]);return}this.modelValue=``,this._inputNode&&(this._inputNode.value=``),P(H,this,ai).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.selectionFollowsFocus=!1,this.addEventListener(`model-value-changed`,e=>{if(this.changingValues){e.stopImmediatePropagation();return}if(e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&JSON.stringify(this.modelValue)!==JSON.stringify(this.pendingModelValue)){e.stopImmediatePropagation();return}e.target===this&&e.detail?.isTriggeredByUser&&(this.pendingModelValue=this.multipleChoice?[...this.selectedValues]:this.modelValue,this.multipleChoice&&(this.syncInputs(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))))}),this.addEventListener(`focusout`,e=>{this.multipleChoice&&!this.requireOptionMatch&&!(e.relatedTarget instanceof Node&&this.contains(e.relatedTarget))&&this.commitQuery()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,A(Zr,this)),this._inputNode?.addEventListener(`change`,e=>e.stopPropagation()),this.addEventListener(`model-value-changed`,()=>{N(qr,this,this.modelValue),A(Xr,this)||(wr(this),P(H,this,ei).call(this))}),this.addEventListener(`blur`,()=>P(H,this,ei).call(this)),N(qr,this,this.modelValue),N(Jr,this,this.modelValue),P(H,this,ai).call(this),this.multipleChoice&&(this.initialValues=[...Array.isArray(this.pendingModelValue)?this.pendingModelValue:[]])}updated(e){if(super.updated(e),this._listboxNode?.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this.multipleChoice){this.syncInputs(),this._inputNode.removeAttribute(`name`),this._comboboxNode.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this._inputNode.disabled=this.disabled||this.fieldsetDisabled;let e=this.required&&!this.inactive&&this.selectedValues.length===0;this.internals??=this.attachInternals(),this.internals.setValidity(e?{valueMissing:!0}:{},e?_(`This field is required.`):``,this._inputNode)}e.has(`opened`)&&!this.opened&&N(Yr,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`)||e.has(`multipleChoice`))&&P(H,this,ai).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,P(H,this,li).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t);let n=e;n.updateComplete.then(()=>{if(this.multipleChoice){n.checked=Array.isArray(this.pendingModelValue)&&this.pendingModelValue.includes(String(n.choiceValue));return}String(n.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(n)))})}_notifyModelValueChanged(){JSON.stringify(this.modelValue)!==JSON.stringify(A(qr,this))&&(N(qr,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:this.multipleChoice?`selection`:`input`}})))}matchCondition(e){return!this.multipleChoice||!e.hidden}_autoSelectCondition(){return!this.multipleChoice}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=P(H,this,li).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ${this.multipleChoice?Gr(this.selectedValues,e=>e,e=>r`
                <span class="token">
                  ${this.valueLabel(e)}
                  ${this.inactive?c:r`<button
                        type="button"
                        aria-label=${_(`Remove {label}`,{label:this.valueLabel(e)})}
        ...
        <div class="combobox__textbox">
          ...
          <slot name="input"></slot>
          ${this.clearable&&P(H,this,si).call(this)&&!this.inactive?r`<craft-button
                class="clear"
                type="button"
                appearance="plain"
                size="small"
    ...
    `}get selectedValues(){return Array.isArray(this.modelValue)?this.modelValue:[]}get inactive(){return this.disabled||this.readOnly||this.fieldsetDisabled}valueLabel(e){return[...P(H,this,ui).call(this)].find(t=>t.value===e)?.label??e}syncInputs(){this.inputs||(this.inputs=document.createElement(`span`),this.inputs.hidden=!0,this.inputs.slot=`native-inputs`,this.inputs.setAttribute(`data-combobox-inputs`,``),this.append(this.inputs)),s(!this.name||this.disabled||this.fieldsetDisabled?c:r`
            ...
            ${this.selectedValues.map(e=>r`<input
                  ...
                  .value=${e}
                />`)}
          `,this.inputs)}formResetCallback(){this.multipleChoice&&(this.modelValue=[...this.initialValues],this.value=``,this.syncInputs())}formDisabledCallback(e){this.fieldsetDisabled=e,this.requestUpdate(),this.multipleChoice&&this.syncInputs()}changeValues(e){if(!this.inactive){this.changingValues=!0;try{this.modelValue=e}finally{this.changingValues=!1}this.value=``,this.opened=!1,P(H,this,ai).call(this),this.syncInputs(),this._notifyModelValueChanged(),this._inputNode.focus()}}commitQuery(){let e=this.value;if(this.inactive||e===``)return;let t=[...P(H,this,ui).call(this)].find(t=>t.value===e);t?.disabled||this.requireOptionMatch&&!t||this.changeValues([...new Set([...this.selectedValues,e])])}_listboxOnKeyDown(e){if(!this.multipleChoice){super._listboxOnKeyDown(e);return}if(this.inactive||e.isComposing)return;if(e.key===`Backspace`&&this.value===``){e.preventDefault(),this.changeValues(this.selectedValues.slice(0,-1));return}let t=this.formElements[this.activeIndex];if(e.key===`Enter`&&(!this.opened||!t||t.hidden||t.hasAttribute(`aria-hidden`))){e.preventDefault(),this.commitQuery();return}super._listboxOnKeyDown(e)}_syncToTextboxMultiple(){}_resetListboxOptions(){super._resetListboxOptions(),this.hideSelectedOptions()}_handleAutocompletion(){super._handleAutocompletion(),this.hideSelectedOptions()}hideSelectedOptions(){if(!this.multipleChoice)return;for(let e of this.formElements)e.hidden&&(e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`aria-posinset`),e.removeAttribute(`aria-setsize`));let e=this.formElements.filter(e=>!e.hasAttribute(`aria-hidden`));e.forEach((t,n)=>{t.setAttribute(`aria-posinset`,String(n+1)),t.setAttribute(`aria-setsize`,String(e.length))})}parser(e){if(typeof e==`string`&&e!==``){let t=P(H,this,ci).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function ei(){this.multipleChoice||this.modelValue!==A(Jr,this)&&(N(Jr,this,this.modelValue),Tr(this))}function ti(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function ni(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(P(H,this,ri).call(this,e))for(let r of e.options)(t===``||P(H,this,ii).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||P(H,this,ii).call(this,t,e))&&n.push({option:e});return n}function ri(e){return e.type===`optgroup`}function ii(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function ai(){let e=this._listboxNode;if(!e)return;let t=A(Yr,this)?this._inputNode?.value??``:``,n=this.multipleChoice?Array.isArray(this.pendingModelValue)?this.pendingModelValue:this.selectedValues:[],i=P(H,this,ni).call(this,t).filter(e=>!n.includes(e.option.value)),a=i.slice(0,this.limit),o=[...P(H,this,ui).call(this)],l=[...n.map(e=>({option:o.find(t=>t.value===e)??{value:e,label:e}})),...a],u,d=l.map(e=>{let t=e.groupLabel&&e.groupLabel!==u?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return u=e.groupLabel,{value:e.option.value,template:r`${t}${P(H,this,oi).call(this,e.option,n.includes(e.option.value))}`}}),f=i.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${_(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:i.length})}
          </div>`:c;s(r`${Gr(d,e=>e.value,e=>e.template)}${f}`,e)}function oi(e,t=!1){let n=e.data??{},i=e.label,a=i.startsWith(`$`)||i.startsWith(`@`);return r`
      <craft-option
        ?hidden=${t}
    ...
    `}function si(){return this.multipleChoice?this.selectedValues.length>0:this.modelValue!==``&&this.modelValue!=null}function ci(e){let t=e.trim();for(let e of P(H,this,ui).call(this))if(P(H,this,di).call(this,e)===t)return e}function li(){if(this.multipleChoice||!P(H,this,si).call(this))return;let e=String(this.modelValue);for(let t of P(H,this,ui).call(this))if(String(t.value)===e)return t}function*ui(){for(let e of this.options)P(H,this,ri).call(this,e)?yield*e.options:yield e}function di(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}$r.formAssociated=!0,D([O({type:Boolean,attribute:`multiple-choice`,reflect:!0})],$r.prototype,`multipleChoice`,void 0),D([O({type:Boolean})],$r.prototype,`required`,void 0),D([O({type:Array})],$r.prototype,`options`,void 0),D([O({type:Number})],$r.prototype,`limit`,void 0),D([O({type:Boolean,reflect:!0})],$r.prototype,`clearable`,void 0),D([O({type:String,reflect:!0})],$r.prototype,`placeholder`,void 0),D([O({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],$r.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,$r);var fi=a`
  :host {
...
`,pi={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},mi=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(pi[`icon.out`].keyframes,pi[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(pi[`icon.in`].keyframes,pi[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(pi[`icon.out`].keyframes,pi[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(pi[`icon.in`].keyframes,pi[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||_(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};mi.styles=[fi],D([k()],mi.prototype,`isCopying`,void 0),D([k()],mi.prototype,`status`,void 0),D([de(`slot[name="copy-icon"]`)],mi.prototype,`copyIconEl`,void 0),D([de(`slot[name="success-icon"]`)],mi.prototype,`successIconEl`,void 0),D([de(`slot[name="error-icon"]`)],mi.prototype,`errorIconEl`,void 0),D([de(`craft-tooltip`)],mi.prototype,`tooltipEl`,void 0),D([O({type:String})],mi.prototype,`value`,void 0),D([O({type:Boolean})],mi.prototype,`disabled`,void 0),D([O({attribute:`feedback-duration`,type:Number})],mi.prototype,`feedbackDuration`,void 0),D([O({attribute:`tooltip-label`})],mi.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,mi);var hi=a`
  :host {
...
`,gi=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return r`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
        class=${E({"copy-attribute":!0})}
      >
        ${this.value}
      </craft-copy-button>
    `}};gi.styles=[f,hi],D([de(`craft-copy-button`)],gi.prototype,`copyButtonEl`,void 0),D([O({type:String})],gi.prototype,`value`,void 0),D([O({type:Boolean,reflect:!0})],gi.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,gi);var _i=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function vi(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function yi(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(_i))).filter(vi)}function bi(e){let t=t=>{if(t.key!==`Tab`)return;let n=yi(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var xi=a`
  :host {
    display: contents;
...
`,Si=0,Ci=0;function wi(){Ci++===0&&document.body.classList.add(`no-scroll`)}function Ti(){Ci>0&&--Ci===0&&document.body.classList.remove(`no-scroll`)}var Ei=new WeakMap,Di=new WeakMap,Oi=new WeakMap,ki=new WeakMap,Ai=new WeakSet,ji=new WeakMap,Mi=new WeakMap,Ni=new WeakMap,Pi=new WeakMap,Fi=new WeakMap,Ii=new WeakMap,Li=class extends l{constructor(...e){super(...e),M(this,Ai),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++Si}`,j(this,Ei,!1),j(this,Di,null),j(this,Oi,!1),j(this,ki,null),j(this,ji,e=>{e.preventDefault(),this.requestClose()}),j(this,Mi,()=>{this.opened=!1}),j(this,Ni,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),j(this,Pi,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),j(this,Fi,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),j(this,Ii,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,A(Pi,this)),this.addEventListener(`keydown`,A(Ni,this)),N(ki,this,new MutationObserver(()=>this.requestUpdate())),A(ki,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,A(Pi,this)),this.removeEventListener(`keydown`,A(Ni,this)),A(ki,this)?.disconnect(),N(ki,this,null),A(Di,this)?.call(this),N(Di,this,null),P(Ai,this,Bi).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
    ...
    `}updated(e){super.updated(e),this.opened!==A(Ei,this)&&(N(Ei,this,this.opened),this.opened?P(Ai,this,Ri).call(this):P(Ai,this,zi).call(this),P(Ai,this,Vi).call(this,this.opened))}requestClose(){this.dispatchEvent(new CustomEvent(`craft-before-hide`,{bubbles:!0,composed:!0,cancelable:!0}))&&(this.opened=!1)}};function Ri(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(A(Di,this)?.call(this),N(Di,this,bi(this))),A(Oi,this)||(N(Oi,this,!0),wi())}function zi(){let e=this.dialogElement;e?.open&&e.close(),A(Di,this)?.call(this),N(Di,this,null),P(Ai,this,Bi).call(this)}function Bi(){A(Oi,this)&&(N(Oi,this,!1),Ti())}function Vi(e){P(Ai,this,Hi).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&P(Ai,this,Hi).call(this,e?`craft-after-show`:`craft-after-hide`)})}function Hi(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}Li.styles=[f,xi],D([O({type:Boolean,attribute:`open`,reflect:!0})],Li.prototype,`opened`,void 0),D([O()],Li.prototype,`label`,void 0),D([O({type:Boolean,attribute:`non-modal`,reflect:!0})],Li.prototype,`nonModal`,void 0),D([O({type:Boolean,reflect:!0})],Li.prototype,`fullscreen`,void 0),D([O({type:Boolean,attribute:`close-on-outside-click`})],Li.prototype,`closeOnOutsideClick`,void 0),D([O({type:Boolean,attribute:`no-close`,reflect:!0})],Li.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,Li);var Ui=new WeakMap,Wi=new WeakSet,Gi=class{constructor(e,t){this.host=e,this.source=t,M(this,Wi),j(this,Ui,null),e.addController(this)}hostConnected(){P(Wi,this,Ki).call(this)}hostDisconnected(){P(Wi,this,qi).call(this)}resubscribe(){P(Wi,this,qi).call(this),P(Wi,this,Ki).call(this)}get state(){return this.source()?.state??null}};function Ki(){N(Ui,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function qi(){A(Ui,this)?.call(this),N(Ui,this,null)}var Ji=a`
  :host {
    /*
...
`,Yi=new WeakMap,Xi=new WeakMap,Zi=new WeakMap,Qi=new WeakMap,$i=new WeakMap,ea=class extends Li{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,j(this,Yi,new Gi(this,()=>this.controller)),j(this,Xi,null),j(this,Zi,()=>{this.submit()}),j(this,Qi,()=>{this.busy||this.requestClose()}),j(this,$i,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&N(Xi,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),A(Xi,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&A(Yi,this).resubscribe();let t=A(Yi,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&A(Xi,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
      ...
      <footer class="footer" part="footer">
        ...
        <div class="footer__group" part="primary-actions">
          ...
          <craft-button
            ...
            @click=${A(Zi,this)}
          >
            ${this.selectLabel||_(`Select`)}
          </craft-button>
        </div>
      </footer>
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};ea.styles=[...Li.styles,Ji],D([O({attribute:!1})],ea.prototype,`controller`,void 0),D([O({type:Boolean,attribute:`show-title`,reflect:!0})],ea.prototype,`showTitle`,void 0),D([O({attribute:`select-label`})],ea.prototype,`selectLabel`,void 0),D([O({attribute:`cancel-label`})],ea.prototype,`cancelLabel`,void 0),D([O({type:Boolean,reflect:!0})],ea.prototype,`busy`,void 0),D([O({type:Boolean,reflect:!0})],ea.prototype,`loading`,void 0),D([O({type:Boolean,attribute:`can-submit`,reflect:!0})],ea.prototype,`canSubmit`,void 0),D([O({type:Boolean,reflect:!0})],ea.prototype,`narrow`,void 0),D([k()],ea.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,ea);var ta=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
...
`,oa=class extends un(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=_(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__hasSlot=new ia(this,`heading-prefix`,`label-extra`,`actions`,`heading-suffix`,`tip`,`warning`),this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[g,dt,aa]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.updateComplete.then(()=>{this.addToAriaLabelledBy(this._labelNode),this.__wireDescribedBy()})}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
    ...
    `}_labelTemplate(){let e=this.__hasLabel,t=this.__hasSlot.test(`label-extra`),n=this.__hasSlot.test(`actions`),i=t||n||this.readOnly||this.__hasSlot.test(`heading-prefix`)||this.__hasSlot.test(`heading-suffix`);if(!e&&!i)return r``;let a=c;return e&&(a=this.labelSrOnly&&i?r`<span class="cp-visually-hidden"
      ...
      <div
        class=${E({"form-field__label":!0,"cp-visually-hidden":this.labelSrOnly&&!i})}
      >
        <slot name="heading-prefix"></slot>
        ${a}
        ${this.readOnly?r`<span class="read-only-badge">${_(`Read Only`)}</span>`:c}
    ...
    `}_helpTextTemplate(){return this.__hasHelpText?super._helpTextTemplate():r``}_inputGroupTemplate(){return r`
      <div class=${E({"input-group":!0,input:!0,[this._resolvedOrientation]:!0,errors:this.hasErrors,disabled:this.disabled})}>
        ${this._inputGroupBeforeTemplate()}
        <div class="input-group__container">
          ${this._inputGroupPrefixTemplate()} ${this._inputGroupInputTemplate()}
          ${this._inputGroupSuffixTemplate()}
    ...
    `}get __hasLabel(){return this.label.trim()!==``}get __hasHelpText(){return this.helpText.trim()!==``}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`craft-visually-hidden`);t.textContent=_(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};D([O({type:Boolean,reflect:!0})],oa.prototype,`required`,void 0),D([O({type:Boolean,reflect:!0})],oa.prototype,`translatable`,void 0),D([O({attribute:`translation-description`})],oa.prototype,`translationDescription`,void 0),D([O({type:Boolean,reflect:!0})],oa.prototype,`fieldset`,void 0),D([O({reflect:!0})],oa.prototype,`status`,void 0),D([O({attribute:`status-label`})],oa.prototype,`statusLabel`,void 0),D([O({reflect:!0})],oa.prototype,`orientation`,void 0),D([O({type:Boolean,reflect:!0,attribute:`has-errors`})],oa.prototype,`hasErrors`,void 0),D([O({attribute:`instructions-position`})],oa.prototype,`instructionsPosition`,void 0),D([O({type:String,reflect:!0})],oa.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,oa);var sa=class extends l{render(){return r`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,sa);var ca=new WeakMap,la=class extends l{constructor(...e){super(...e),this.label=_(`More Info`),this.icon=`circle-info`,this.disabled=!1,j(this,ca,new AbortController)}connectedCallback(){super.connectedCallback(),A(ca,this).signal.aborted&&N(ca,this,new AbortController),this.id||=`info-icon-${Math.random().toString(36).slice(2,8)}`;let{signal:e}=A(ca,this);this.addEventListener(`craft-show`,()=>{ua._&&ua._!==this&&ua._.renderRoot.querySelector(`craft-tooltip`)?.hide(),ua._=this},{signal:e}),this.addEventListener(`craft-after-hide`,()=>{ua._===this&&(ua._=null)},{signal:e})}disconnectedCallback(){ua._===this&&(ua._=null),A(ca,this).abort(),super.disconnectedCallback()}render(){return r`
  ...
  `;var ua={_:null};D([O()],la.prototype,`label`,void 0),D([O()],la.prototype,`icon`,void 0),D([O({type:Boolean,reflect:!0})],la.prototype,`disabled`,void 0),D([O()],la.prototype,`id`,void 0),D([de(`craft-tooltip`)],la.prototype,`tooltip`,void 0),customElements.get(`craft-info-icon`)||customElements.define(`craft-info-icon`,la);var da=a`
  ::slotted(.form-control) {
    ${ct}
  }
...
`,U=class extends Pn{constructor(...e){super(...e),this.size=`medium`,this.inputMode=``,this.ariaInvalid=null,this.autoCorrect=!0,this.autoCapitalize=!0,this.small=!1,this.center=!1,this.monospace=!1,this.hiddenInput=!1}static get styles(){return[...super.styles,ft,da]}connectedCallback(){super.connectedCallback(),this._inputNode&&this.maxlength&&this.maxlength>0&&(this._inputNode.maxLength=this.maxlength,this.width!==`full`&&(this._inputNode.size=this.maxlength)),this.syncNativeAttributes(),this.syncAriaInvalid()}updated(e){super.updated(e),(e.has(`inputSize`)||e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`inputMode`)||e.has(`autoCorrect`)||e.has(`autoCapitalize`))&&this.syncNativeAttributes(),this.syncAriaInvalid()}syncAriaInvalid(){this._inputNode?.setAttribute(`aria-invalid`,this.ariaInvalid??String(this._hasFeedbackVisibleFor(`error`)))}syncNativeAttributes(){let e={size:this.inputSize,min:this.min,max:this.max,step:this.step,inputmode:this.inputMode,autocorrect:this.autoCorrect?void 0:`off`,autocapitalize:this.autoCapitalize?void 0:`none`};for(let[t,n]of Object.entries(e)){if(n===void 0){this._inputNode?.removeAttribute(t);continue}this._inputNode?.setAttribute(t,String(n))}}};D([O({type:Number,reflect:!0})],U.prototype,`maxlength`,void 0),D([O({type:String,reflect:!0})],U.prototype,`size`,void 0),D([O({type:Number,attribute:!1})],U.prototype,`inputSize`,void 0),D([O({attribute:!1})],U.prototype,`min`,void 0),D([O({attribute:!1})],U.prototype,`max`,void 0),D([O({attribute:!1})],U.prototype,`step`,void 0),D([O({attribute:!1})],U.prototype,`inputMode`,void 0),D([O({attribute:`aria-invalid`,reflect:!0})],U.prototype,`ariaInvalid`,void 0),D([O({attribute:!1})],U.prototype,`autoCorrect`,void 0),D([O({attribute:!1})],U.prototype,`autoCapitalize`,void 0),D([O({reflect:!0,type:Boolean})],U.prototype,`small`,void 0),D([O({type:String,reflect:!0})],U.prototype,`width`,void 0),D([O({reflect:!0,type:Boolean})],U.prototype,`center`,void 0),D([O({reflect:!0,type:Boolean})],U.prototype,`monospace`,void 0),D([O({reflect:!0,type:Boolean,attribute:`hidden-input`})],U.prototype,`hiddenInput`,void 0),customElements.get(`craft-input`)||customElements.define(`craft-input`,U);var fa=a`
  ${dt}
...
`,pa=/^[0-9a-f]{6}$/i,ma=/^[0-9a-f]{3}$/i,ha={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function ga(e){return String(e??``).trim().replace(/^#/,``)}function _a(e){let t=ga(e);return ma.test(t)?t.split(``).map(e=>e+e).join(``):pa.test(t)?t:null}var va=class e extends U{static get styles(){return[...super.styles,fa]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,ga(t)),e}}}parser(e){return ga(e)}formatter(e){return ga(e)}serializer(e){return ga(e)}deserializer(e){return ga(e)}preprocessor(e){let t=ga(e);if(t!==e)return t}get _expandedHexValue(){return _a(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>_a(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=ga(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
      <input
        class="input-color__picker"
        type="color"
        aria-label="${_(`Color picker`)}"
    ...
    `}};va._browserSupportsColorInputs=null,D([O({converter:ha})],va.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,va);var ya=a`
  /*
...
`,ba=class extends U{static get styles(){return[...super.styles,ya]}_renderSuffix(){return r`<craft-copy-button
      tooltip-label="${_(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};D([O({type:String,attribute:`copy-value`})],ba.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,ba);var xa=class extends U{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,xa);var Sa={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},Ca=e=>({fromAttribute:t=>t?JSON.parse(t):e(),toAttribute:e=>JSON.stringify(e)}),wa=new WeakSet,Ta=class extends U{constructor(){super(),M(this,wa),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,P(wa,this,Ea))}disconnectedCallback(){this.removeEventListener(`change`,P(wa,this,Ea)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),P(wa,this,Da).call(this)}};function Ea(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=P(wa,this,Oa).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}P(wa,this,Da).call(this)}}function Da(){let e=this._inputNode;if(!e)return;let t=P(wa,this,ka).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=P(wa,this,ka).call(this,e),i=P(wa,this,ka).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function Oa(e){let t=P(wa,this,ka).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function ka(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}D([O({type:Number,attribute:`minute-increment`})],Ta.prototype,`minuteIncrement`,void 0),D([O({attribute:`disabled-time-ranges`,converter:Ca(()=>[])})],Ta.prototype,`disabledTimeRanges`,void 0),D([O({type:Boolean,attribute:`force-round-time`})],Ta.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,Ta);var Aa={date:()=>_(`Date`),time:()=>_(`Time`),timezone:()=>_(`Time zone`)},ja=new WeakSet,Ma=new WeakMap,W=class extends l{constructor(...e){super(...e),M(this,ja),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,j(this,Ma,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof U))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,A(Ma,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,A(Ma,this)),super.disconnectedCallback()}updated(e){super.updated(e),P(ja,this,Na).call(this),P(ja,this,Pa).call(this),P(ja,this,Fa).call(this),P(ja,this,Ba).call(this,`locale`,this.locale,!0),P(ja,this,Ba).call(this,`timezone`,this.timezone,!this.showTimezone)}};function Na(){let e=P(ja,this,Ia).call(this,`craft-input-date`,`date`,this.showDate);e instanceof xa&&(P(ja,this,za).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,P(ja,this,La).call(this,e))}function Pa(){let e=P(ja,this,Ia).call(this,`craft-input-time`,`time`,this.showTime);e instanceof Ta&&(P(ja,this,za).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,P(ja,this,La).call(this,e))}function Fa(){let e=P(ja,this,Ia).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(P(ja,this,za).call(this,e,`timezone`,this.timezone??``,!1),P(ja,this,La).call(this,e))}function Ia(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof U);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function La(e){e.parentElement!==this&&this.insertBefore(e,P(ja,this,Ra).call(this))}function Ra(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function za(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`),e.setAttribute(`aria-label`,Aa[t]?.()??t)}function Ba(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}W.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,D([O()],W.prototype,`name`,void 0),D([O({attribute:`date-value`})],W.prototype,`dateValue`,void 0),D([O({attribute:`time-value`})],W.prototype,`timeValue`,void 0),D([O()],W.prototype,`locale`,void 0),D([O()],W.prototype,`timezone`,void 0),D([O({attribute:`show-date`,converter:Sa})],W.prototype,`showDate`,void 0),D([O({attribute:`show-time`,converter:Sa})],W.prototype,`showTime`,void 0),D([O({type:Boolean,attribute:`show-timezone`})],W.prototype,`showTimezone`,void 0),D([O()],W.prototype,`min`,void 0),D([O()],W.prototype,`max`,void 0),D([O({attribute:`min-time`})],W.prototype,`minTime`,void 0),D([O({attribute:`max-time`})],W.prototype,`maxTime`,void 0),D([O({type:Number,attribute:`minute-increment`})],W.prototype,`minuteIncrement`,void 0),D([O({attribute:`disabled-time-ranges`,converter:Ca(()=>[])})],W.prototype,`disabledTimeRanges`,void 0),D([O({type:Boolean,attribute:`force-round-time`})],W.prototype,`forceRoundTime`,void 0),D([O({type:Boolean})],W.prototype,`disabled`,void 0),D([O({type:Boolean})],W.prototype,`readonly`,void 0),D([O({type:Boolean})],W.prototype,`required`,void 0),D([O({attribute:`described-by`})],W.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,W);var Va=class extends _n{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Ha=class extends _n{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return zt().msg(`lion-input-file:uploadTextDuplicateFileName`)}},Ua=524288e3,Wa={type:`FILE_TYPE`,size:`FILE_SIZE`},Ga={fail:`FAIL`,pass:`SUCCESS`},Ka=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);Va.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Ga.fail,this.failedProp.push(Wa.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;Va.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Ga.fail,this.failedProp.push(Wa.type))}Va.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Ga.fail&&(this.status=Ga.pass):(this.status=Ga.fail,this.failedProp.push(Wa.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},qa=e=>{switch(e){case`bg-BG`:return b(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return b(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return b(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return b(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return b(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return b(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return b(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return b(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return b(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return b(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return b(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return b(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return b(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return b(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return b(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return b(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return b(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return b(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return b(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return b(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return b(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return b(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return b(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return b(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return b(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return b(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return b(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return b(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return b(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return b(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return b(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return b(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return b(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return b(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return b(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return b(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Ja=class extends Qt(an(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":gn}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":qa},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}_removeButtonContentTemplate(){return r`✖️`}_selectedListItemTemplate(e){let t=Ie();return r`
          ...
          <span id="selected-list-item-label-${t}" class="selected__list__item__label__text">
            ...
            ${e.downloadUrl&&e.status!==`LOADING`?r`
                  <a
                    ...
                    rel="${ce(e.downloadUrl.startsWith(`blob`)?`noopener noreferrer`:void 0)}"
                    >${e.systemFile?.name}</a
                  >
                `:e.systemFile?.name}
          </span>
    ...
    `}render(){return this.fileList?.length?r`
      ...
      `]}};function Ya(e,t=2){if(!+e)return`0 Bytes`;let n=1024,r=t<0?0:t,i=[` bytes`,`KB`,`MB`,`GB`,`TB`,`PB`,`EB`,`ZB`,`YB`],a=Math.floor(Math.log(e)/Math.log(n));return`${parseFloat((e/n**a).toFixed(r))}${i[a]}`}var Xa=class extends an(Qt(Cn)){static get scopedElements(){return{...super.scopedElements,"lion-selected-file-list":Ja}}static get properties(){return{accept:{type:String},multiple:{type:Boolean,reflect:!0},buttonLabel:{type:String,attribute:`button-label`},maxFileSize:{type:Number,attribute:`max-file-size`},enableDropZone:{type:Boolean,attribute:`enable-drop-zone`},uploadOnSelect:{type:Boolean,attribute:`upload-on-select`},isDragging:{type:Boolean,attribute:`is-dragging`,reflect:!0},uploadResponse:{type:Array,state:!1},_selectedFilesMetaData:{type:Array,state:!0}}}static localizeNamespaces=[{"lion-input-file":qa},...super.localizeNamespaces];static get validationTypes(){return[`error`,`info`]}get slots(){return{...super.slots,input:()=>r`<input .value="${ce(this.getAttribute(`value`))}" />`,"file-select-button":()=>r`<button
          type="button"
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},Za=class extends Ja{static get styles(){return[...super.styles,a`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
...
`,$a=class extends Xa{static get styles(){return[...super.styles,ft,Qa]}get slots(){return{...super.slots,"file-select-button":()=>r`<craft-button
      ...
      `]}constructor(){super(),M(this,ro),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,this.type=`text`,j(this,io,()=>{this.modelValue=``,this.value=``,P(ro,this,oo).call(this)?.inputmask?.setValue(``),P(ro,this,oo).call(this)?.focus()}),this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&P(ro,this,co).call(this),P(ro,this,oo).call(this)?.classList.toggle(`money-placeholder`,!P(ro,this,lo).call(this))}disconnectedCallback(){P(ro,this,oo).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?r`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${P(ro,this,so).call(this).currency}`}</span
      >
      ...
      <craft-button
        ...
        icon
        aria-label=${_(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!P(ro,this,lo).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${A(io,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function oo(){return this._inputNode}function so(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function co(){let e=P(ro,this,oo).call(this);if(!e)return;let t=String(this.modelValue??``),n=P(ro,this,so).call(this);e.inputmask?.remove(),e.value=t,new no({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function lo(){return this.modelValue!==``&&this.modelValue!=null}D([O()],ao.prototype,`currency`,void 0),D([O()],ao.prototype,`locale`,void 0),D([O({type:Number})],ao.prototype,`decimals`,void 0),D([O({attribute:`decimal-separator`})],ao.prototype,`decimalSeparator`,void 0),D([O({attribute:`group-separator`})],ao.prototype,`groupSeparator`,void 0),D([O({converter:Sa,attribute:`show-currency`})],ao.prototype,`showCurrency`,void 0),D([O({converter:Sa})],ao.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,ao);var uo=new WeakSet,fo=class extends U{static get styles(){return[...super.styles,a`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),M(this,uo),this.passwordRules=``,this._visible=!1,this.type=`password`,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>r`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    >
      <span class="icon"
        >${this._visible?r`<craft-icon
              name="eye-slash"
              label="${_(`Hide`)}"
            ></craft-icon>`:r`<craft-icon name="eye" label="${_(`Show`)}"></craft-icon>`}
      </span>
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),P(uo,this,po).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&P(uo,this,po).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function po(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}D([O({attribute:`passwordrules`})],fo.prototype,`passwordRules`,void 0),D([k()],fo.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,fo);var mo=class extends l{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return r`
  ...
  `,D([O()],mo.prototype,`error`,void 0),D([O({attribute:`plugin-name`})],mo.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,mo);var ho=a`
  :host {
    display: block;
    /*
...
`,go={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(go);var _o={Plain:`plain`,Error:`error`,Code:`code`};Object.values(_o);var vo=new Set([`clip`,`hidden`]),yo=class extends rt(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=go.Raised,this.variant=_o.Plain,this.label=``,this.headingLevel=2,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDom=new ge(this,{attributeFilter:[`aria-label`],characterData:!0,onChange:()=>this._syncLightDom()}),this._observedBoxes=new Set}disconnectedCallback(){super.disconnectedCallback(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_syncSlotPresence(){this._hasSlottedHeader=_e(this,`header`,`title`,`header-actions`),this._hasSlottedFooter=_e(this,`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!vo.has(n)&&e.scrollHeight-e.clientHeight>1||!vo.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||_(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}_renderTitle(){let e=ne(`h${Math.min(6,Math.max(1,Number(this.headingLevel)||2))}`);return ae`<${e} class="cp-pane__title">${this.label}</${e}>`}render(){let e=!!this.label||this._hasSlottedHeader;return r`
      <div
        class="cp-pane"
        part="base"
        style="${C(this.paddingStyles)}"
        ...
        ${e?r`<slot name="header">
              <div class="cp-pane__header" part="header">
                <slot name="title" part="title">
                  ${this.label?this._renderTitle():c}
                </slot>
    ...
    `}};yo.styles=[f,ho],D([O({reflect:!0})],yo.prototype,`appearance`,void 0),D([O({reflect:!0})],yo.prototype,`variant`,void 0),D([O()],yo.prototype,`label`,void 0),D([O({type:Number,attribute:`heading-level`})],yo.prototype,`headingLevel`,void 0),D([k()],yo.prototype,`_hasSlottedHeader`,void 0),D([k()],yo.prototype,`_hasSlottedFooter`,void 0),D([k()],yo.prototype,`_scrollable`,void 0),D([k()],yo.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,yo);var bo=0,xo=new WeakMap,G=new WeakSet,So=class extends l{constructor(...e){super(...e),M(this,G),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,j(this,xo,++bo)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&P(G,this,No).call(this)}render(){let e=P(G,this,To).call(this);return Gr(this.groups,e=>e.handle,(t,n)=>P(G,this,Co).call(this,t,n,e))}};function Co(e,t,n){let i=`permission-tree-heading-${A(xo,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>P(G,this,ko).call(this,e.keys,n)}
                >
                  ${P(G,this,Oo).call(this,e.keys,n)?_(`Deselect all`):_(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${P(G,this,wo).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function wo(e,t,n,i){return Gr(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=P(G,this,Do).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||P(G,this,Eo).call(this,o,i)}
                @model-value-changed=${e=>P(G,this,Ao).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?P(G,this,wo).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function To(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function Eo(e,t){return t.has(e.toLowerCase())}function Do(e,t){return this.modelValue.includes(e)||P(G,this,Eo).call(this,e,t)}function Oo(e,t){let n=e.filter(e=>!P(G,this,Eo).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function ko(e,t){let n=e.filter(e=>!P(G,this,Eo).call(this,e,t));if(P(G,this,Oo).call(this,e,t)){let e=new Set(n);P(G,this,Mo).call(this,this.modelValue.filter(t=>!e.has(t)));return}P(G,this,Mo).call(this,[...new Set([...this.modelValue,...n])])}function Ao(e,t,n,r){if(e.stopPropagation(),this.disabled||P(G,this,Eo).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){P(G,this,Mo).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...P(G,this,jo).call(this,n)]);P(G,this,Mo).call(this,this.modelValue.filter(e=>!o.has(e)))}function jo(e){return Object.values(e).flatMap(e=>[e.key,...P(G,this,jo).call(this,e.nested??{})])}function Mo(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}})),wr(this),Tr(this)}function No(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;P(G,this,Po).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&P(G,this,Po).call(this,`${this.name}[]`,t)}function Po(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}So.styles=a`
    :host {
      display: block;
    }
  ...
  `,D([O({type:Array})],So.prototype,`groups`,void 0),D([O({type:Array,attribute:`model-value`})],So.prototype,`modelValue`,void 0),D([O({type:Array,attribute:`locked-permissions`})],So.prototype,`lockedPermissions`,void 0),D([O()],So.prototype,`name`,void 0),D([O({type:Boolean,reflect:!0})],So.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,So);var Fo=a`
  :host {
...
`,Io=new WeakMap,Lo=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,j(this,Io,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&A(Io,this)<100&&this.dispatchEvent(new CustomEvent(`craft-complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),N(Io,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,N(Io,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
      <div
        class=${E({"progress-bar":!0,"progress-bar--pending":this.pending})}
        part="track"
        role="progressbar"
      ...
      >
        <div
          class=${E({"progress-bar__fill":!0,"progress-bar__fill--smooth":this.smooth&&!this.pending})}
          part="fill"
          style=${C(e)}
        ></div>
      </div>
    ...
    `}};Lo.styles=[Fo],D([O({type:Number})],Lo.prototype,`progress`,void 0),D([O({type:Number})],Lo.prototype,`total`,void 0),D([O({type:Number})],Lo.prototype,`processed`,void 0),D([O({type:Boolean,attribute:`show-status`})],Lo.prototype,`showStatus`,void 0),D([O({type:Boolean,reflect:!0})],Lo.prototype,`pending`,void 0),D([O({type:Boolean})],Lo.prototype,`smooth`,void 0),D([O({type:String})],Lo.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Lo);var Ro=class extends On(Mn(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},zo=class extends An(Pn){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Bo=class extends mt(Ro,`radio`){constructor(...e){super(...e),this.thumbnails=!1}static get styles(){return[...super.styles,ft,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};D([O({type:Boolean,reflect:!0})],Bo.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Bo);var Vo=class extends Rn(zo){static get styles(){return[...super.styles,a`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,Vo);var Ho=a`
  craft-button {
    cursor: move;
  }
...
`,Uo=class extends l{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.moves=[],this.variant=`plain`,this.disabled=!1,this.nested=!1,this.canIndent=!1,this.canOutdent=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_canMove(e){switch(e){case`up`:return this.position!==`first`&&this.position!==`only`;case`down`:return this.position!==`last`&&this.position!==`only`;case`indent`:return this.nested&&this.canIndent;case`outdent`:return this.nested&&this.canOutdent}}_reorder(e){this.disabled||!this._canMove(e)||this.dispatchEvent(new CustomEvent(`craft-reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_move(e){this.disabled||this.dispatchEvent(new CustomEvent(`craft-move`,{detail:{value:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??_(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),i=t?n?`arrow-right`:`arrow-left`:`arrow-up`,a=t?n?`arrow-left`:`arrow-right`:`arrow-down`,o=_(t?`Move forward`:`Move up`),s=_(t?`Move backward`:`Move down`);return r`
        ...
        <div slot="content">
          ...
          ${this.nested?r`
                ...
                <craft-action-item
                  ...
                  data-action="outdent"
                  >${_(`Outdent`)}</craft-action-item
                >
              `:c}
          ${this.moves.length>0?r`
                <hr class="separator" />
                ${this.moves.map(e=>r`
                    <craft-action-item
                      icon="${ce(e.icon??void 0)}"
                      @click="${()=>this._move(e.value)}"
                      >${e.label}</craft-action-item
                    >
                  `)}
              `:c}
        </div>
      </craft-action-menu>
    `}};Uo.styles=[Ho],D([O()],Uo.prototype,`label`,void 0),D([O({reflect:!0})],Uo.prototype,`position`,void 0),D([O({reflect:!0})],Uo.prototype,`orientation`,void 0),D([O({attribute:!1})],Uo.prototype,`moves`,void 0),D([O({reflect:!0})],Uo.prototype,`variant`,void 0),D([O({reflect:!0,type:Boolean})],Uo.prototype,`disabled`,void 0),D([O({reflect:!0,type:Boolean})],Uo.prototype,`nested`,void 0),D([O({attribute:`can-indent`,type:Boolean})],Uo.prototype,`canIndent`,void 0),D([O({attribute:`can-outdent`,type:Boolean})],Uo.prototype,`canOutdent`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,Uo);var Wo=class extends Fe(re){static get styles(){return[...super.styles,a`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Jo=class extends Wo{static get styles(){return[...super.styles,qo]}_afterTemplate(){return r`${this.singleOption?``:r`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},Yo=a`
  ${dt}
...
`,Xo=class extends Ko{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Yo]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Jo}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return r`
    ...
    `}};D([O({reflect:!0,type:Boolean})],Xo.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,Xo);var Zo=a`
  :host {
    display: block;
  }
`;function Qo(e){return e.charAt(0).toUpperCase()+e.slice(1)}var $o=class extends l{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return r`<span
    ...
    ></span>`}_optionTemplate(e,t){return r`<craft-option .choiceValue=${e}>
    ...
    </craft-option>`}_handleModelValueChanged(e){e.stopPropagation();let t=e.target;this.modelValue=t?.modelValue??null,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0})),wr(this),Tr(this)}render(){return r`
      <craft-select-rich
        label=${this.label}
        name=${this.name}
      ...
      >
        ${this.allowTransparent?this._optionTemplate(`__blank__`,_(`Transparent`)):``}
        ${Ge.map(e=>this._optionTemplate(e,_(Qo(e))))}
      </craft-select-rich>
    `}};$o.styles=[Zo],D([O()],$o.prototype,`label`,void 0),D([O()],$o.prototype,`name`,void 0),D([O({attribute:`model-value`})],$o.prototype,`modelValue`,void 0),D([O({type:Boolean,reflect:!0,attribute:`allow-transparent`})],$o.prototype,`allowTransparent`,void 0),customElements.get(`craft-select-color`)||customElements.define(`craft-select-color`,$o);var es=class extends Cn{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>e.slot===`input`)}},ts=class extends es{get operationMode(){return`select`}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener(`change`,this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:`model`})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has(`disabled`)&&(this._inputNode.disabled=this.disabled,this.validate()),e.has(`name`)&&(this._inputNode.name=this.name),e.has(`autocomplete`)&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener(`change`,this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){let t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:``}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=this.modelValue===void 0?``:this.modelValue)}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent(`user-input-changed`,{bubbles:!0,composed:!0}))}},ns=a`
  ${dt}
...
`,rs=class extends ts{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,ns]}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};D([O({reflect:!0,type:Boolean})],rs.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,rs);var is=e=>{var t=new WeakMap,n=new WeakMap,r=new WeakMap;class i extends e{constructor(...e){super(...e),j(this,t,this.attachInternals()),j(this,n,null),j(this,r,!1),this.name=``,this.disabled=!1}_formValue(){return null}_restoreFormValue(e){}get form(){return A(t,this).form}get validity(){return A(t,this).validity}get validationMessage(){return A(t,this).validationMessage}get willValidate(){return A(t,this).willValidate}checkValidity(){return A(t,this).checkValidity()}reportValidity(){return A(t,this).reportValidity()}connectedCallback(){super.connectedCallback(),A(r,this)||(N(r,this,!0),N(n,this,this._formValue())),A(t,this).setFormValue(this._formValue())}updated(e){super.updated(e),A(t,this).setFormValue(this._formValue())}formDisabledCallback(e){this.disabled=e}formResetCallback(){this._restoreFormValue(A(n,this))}formStateRestoreCallback(e){this._restoreFormValue(e)}}return i.formAssociated=!0,D([O({reflect:!0})],i.prototype,`name`,void 0),D([O({type:Boolean,reflect:!0})],i.prototype,`disabled`,void 0),i},as=a`
  :host {
    display: inline-flex;
  }
...
`,os=new WeakSet,ss=class extends is(l){constructor(...e){super(...e),M(this,os),this.min=0,this.max=100,this.step=10,this.value=0,this.label=_(`Number of columns`),this.valueUnit=``,this.readonly=!1}_formValue(){return this.name?String(this.value):null}_restoreFormValue(e){this.value=P(os,this,us).call(this,Number(e??this.min))}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=P(os,this,us).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=P(os,this,ls).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        tabindex=${cs.call(P(os,this))?0:-1}
        aria-label=${this.label}
        aria-valuemin=${this.min}
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${P(os,this,fs).call(this,this.value)}
        aria-readonly=${this.readonly?`true`:`false`}
        aria-disabled=${this.disabled?`true`:`false`}
        aria-describedby=${ce(this.describedBy)}
        @keydown=${P(os,this,hs)}
      >
        ${e.map(e=>r`
            <span
              class=${E({"slide-picker__segment":!0,"is-active":e<=this.value,"is-last-active":e===this.value})}
              role="presentation"
              aria-hidden="true"
              @click=${()=>P(os,this,ms).call(this,e)}
              title=${P(os,this,fs).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function cs(){return!this.readonly&&!this.disabled}function ls(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function us(e){P(os,this,ls).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function ds(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function fs(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function ps(e,t){let n=P(os,this,us).call(this,e);n!==this.value&&(this.value=n,t&&(this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))))}function ms(e){cs.call(P(os,this))&&P(os,this,ps).call(this,e,!0)}function hs(e){if(!cs.call(P(os,this)))return;let t=P(os,this,ds).call(this);switch(e.key){case`ArrowUp`:P(os,this,ps).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:P(os,this,ps).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:P(os,this,ps).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:P(os,this,ps).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:P(os,this,ps).call(this,this.min,!0),e.preventDefault();break;case`End`:P(os,this,ps).call(this,this.max,!0),e.preventDefault();break}}ss.styles=[as],D([O({type:Number})],ss.prototype,`min`,void 0),D([O({type:Number})],ss.prototype,`max`,void 0),D([O({type:Number})],ss.prototype,`step`,void 0),D([O({type:Number})],ss.prototype,`value`,void 0),D([O()],ss.prototype,`label`,void 0),D([O({attribute:`described-by`})],ss.prototype,`describedBy`,void 0),D([O({attribute:`value-unit`})],ss.prototype,`valueUnit`,void 0),D([O({attribute:!1})],ss.prototype,`valueLabel`,void 0),D([O({type:Boolean,reflect:!0})],ss.prototype,`readonly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,ss);var gs=a`
  :host {
    display: block;
  }
...
`,K=new WeakSet,_s=new WeakMap,vs=new WeakMap,ys=new WeakMap,bs=new WeakMap,xs=new WeakMap,Ss=new WeakMap,Cs=new WeakMap,ws=new WeakMap,Ts=class extends is(l){constructor(...e){super(...e),M(this,K),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=_(`Rotate`),j(this,_s,!1),j(this,vs,!1),j(this,ys,0),j(this,bs,0),j(this,xs,0),j(this,Ss,0),j(this,Cs,!1),j(this,ws,null)}_formValue(){return this.name?String(this.value):null}_restoreFormValue(e){this.value=Math.min(Math.max(Number(e??0),this.min),this.max)}connectedCallback(){super.connectedCallback(),N(ws,this,new ResizeObserver(()=>P(K,this,Os).call(this))),A(ws,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),A(ws,this)?.disconnect(),N(ws,this,null)}firstUpdated(){N(Ss,this,(P(K,this,Ds).call(this).length-1)*10),P(K,this,Os).call(this)}updated(e){super.updated(e),(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&P(K,this,Os).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex=${Es.call(P(K,this))?0:-1}
        aria-label=${this.label}
        aria-valuemin=${this.min}
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${P(K,this,Ns).call(this,this.value)}
        aria-disabled=${this.disabled?`true`:`false`}
        @keydown=${P(K,this,Us)}
        @pointerdown=${P(K,this,zs)}
        @pointermove=${P(K,this,Bs)}
        @pointerup=${P(K,this,Vs)}
      >
        ...
        <div class="graduations">
          ...
          ></div>
          <ul aria-hidden="true">
            ${P(K,this,Ds).call(this).map(e=>r`
                <li
                  class=${E({graduation:!0,"main-graduation":e%5==0})}
                  data-graduation=${e}
                >
    ...
    `}};function Es(){return!this.disabled}function Ds(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function Os(){this._graduations?.offsetWidth&&P(K,this,js).call(this),P(K,this,As).call(this),!(!this._list||!this._graduations?.offsetWidth)&&(this._list.style.transform=`translateX(${P(K,this,Fs).call(this,this.value)}px)`,P(K,this,ks).call(this))}function ks(){A(Cs,this)||(N(Cs,this,!0),requestAnimationFrame(()=>this._root?.classList.add(`placed`)))}function As(){if(!this._indicator)return;let e=(this.graduationMin-this.graduationMax)*-1,t=A(Ss,this)/e;this._indicator.style.inlineSize=`${Math.abs(this.value)*t}px`,this._indicator.style.translate=this.value>0?`-100%`:`0`}function js(){let e=P(K,this,Ds).call(this).length,t=this._list.getBoundingClientRect().width/e;t>0&&N(Ss,this,(e-1)*t)}function Ms(){let{transform:e}=getComputedStyle(this._list);return!e||e===`none`?0:new DOMMatrixReadOnly(e).m41}function Ns(e){return _(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function Ps(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/A(Ss,this)*n-t}function Fs(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*A(Ss,this)/n-this._graduations.offsetWidth/2)}function Is(e){let t=Math.min(Math.max(e,this.min),this.max);return t===this.value?!1:(this.value=t,this.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0})),!0)}function Ls(){this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))}function Rs(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function zs(e){N(vs,this,Es.call(P(K,this))&&this._graduations.contains(e.target)&&e.target!==this._graduations),A(vs,this)&&(e.preventDefault(),N(bs,this,e.clientX),N(xs,this,P(K,this,Ms).call(this)),N(ys,this,this.value),this._root.setPointerCapture(e.pointerId),P(K,this,Rs).call(this,`craft-drag-start`))}function Bs(e){A(vs,this)&&Math.abs(e.clientX-A(bs,this))>3&&(N(_s,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),P(K,this,Hs).call(this,e))}function Vs(e){A(vs,this)&&(A(_s,this)?(e.preventDefault(),N(_s,this,!1),this._root.classList.remove(`dragging`)):P(K,this,Hs).call(this,e),this.value!==A(ys,this)&&P(K,this,Ls).call(this),P(K,this,Rs).call(this,`craft-drag-end`),this._root.releasePointerCapture(e.pointerId),N(bs,this,0),N(vs,this,!1))}function Hs(e){let t=A(_s,this)?A(bs,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=A(_s,this)?t-e.clientX:e.clientX-t,r=A(xs,this)-n;P(K,this,Is).call(this,P(K,this,Ps).call(this,r))}function Us(e){if(!Es.call(P(K,this)))return;let t=this.value,n;switch(e.key){case`ArrowUp`:case`ArrowRight`:n=P(K,this,Is).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:n=P(K,this,Is).call(this,t-1);break;case`PageUp`:n=P(K,this,Is).call(this,t+10);break;case`PageDown`:n=P(K,this,Is).call(this,t-10);break;case`Home`:n=P(K,this,Is).call(this,this.min);break;case`End`:n=P(K,this,Is).call(this,this.max);break;default:return}n&&P(K,this,Ls).call(this),e.preventDefault()}Ts.styles=[gs],D([O({type:Number})],Ts.prototype,`min`,void 0),D([O({type:Number})],Ts.prototype,`max`,void 0),D([O({type:Number})],Ts.prototype,`value`,void 0),D([O({type:Number,attribute:`graduation-min`})],Ts.prototype,`graduationMin`,void 0),D([O({type:Number,attribute:`graduation-max`})],Ts.prototype,`graduationMax`,void 0),D([O()],Ts.prototype,`label`,void 0),D([de(`.slide-rule`)],Ts.prototype,`_root`,void 0),D([de(`.graduations`)],Ts.prototype,`_graduations`,void 0),D([de(`.graduations ul`)],Ts.prototype,`_list`,void 0),D([de(`.cursor`)],Ts.prototype,`_cursor`,void 0),D([de(`.indicator`)],Ts.prototype,`_indicator`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,Ts);var Ws=a`
  :host {
    display: inline-flex;
...
`,Gs=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?_(`Status: {status}`,{status:this.status}):this.label}render(){return r`
      <span
        class="${E({status:!0,"status--live":this.status===`live`,"status--enabled":this.status===`enabled`,"status--pending":this.status===`pending`,"status--expired":this.status===`expired`,"status--disabled":this.status===`disabled`})}"
        role="${this.getLabel()?`img`:c}"
        aria-label="${this.getLabel()??c}"
      ></span>
    `}};Gs.styles=[Ws],D([O()],Gs.prototype,`label`,void 0),D([O()],Gs.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Gs);var Ks=class extends ie(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},Js=class extends Ks{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};D([O({type:Boolean,reflect:!0})],Js.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,Js);var Ys=a`
  :host {
    display: grid;
  }
...
`;function Xs(e){return(e??``).split(/\s+/).filter(Boolean)}function Zs(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Qs=Symbol.for(`craft-switch-synthetic-change`),$s=new WeakMap,ec=new WeakSet,tc=class extends qs{constructor(...e){super(...e),M(this,ec),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,j(this,$s,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,dt,Ys]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Js}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?_(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?_(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){P(ec,this,nc).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){P(ec,this,nc).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){P(ec,this,nc).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(A($s,this))return;let e=new Event(`change`,{bubbles:!0});e[Qs]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Qs in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of Xs(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of Xs(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Zs(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
      class="state-label"
      data-state=${e}
      aria-hidden="true"
    ...
    `}};function nc(e,t){if(!this.disabled){if(!t){e();return}N($s,this,!0),e(),this.updateComplete.then(()=>{N($s,this,!1)})}}D([O({type:String,reflect:!0})],tc.prototype,`size`,void 0),D([O({type:String,attribute:`on-label`})],tc.prototype,`onLabel`,void 0),D([O({type:String,attribute:`off-label`})],tc.prototype,`offLabel`,void 0),D([O({attribute:`value`})],tc.prototype,`checkedValue`,void 0),D([O({attribute:`indeterminate-value`})],tc.prototype,`indeterminateValue`,void 0),D([O({type:Boolean,reflect:!0})],tc.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,tc);function rc({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function ic(e){e.setAttribute(`selected`,`true`)}function ac(e){e.removeAttribute(`selected`)}function oc({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function sc({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function cc(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function lc(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function uc(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var dc=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,pc={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(pc);var mc={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(mc);var hc=[pc.InlineStart,pc.InlineEnd],gc=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),q=new WeakSet,_c=new WeakMap,vc=new WeakMap,yc=new WeakMap,bc=new WeakMap,xc=new WeakMap,Sc=new WeakMap,Cc=new WeakMap,wc=new WeakMap,Tc=new WeakMap,Ec=new WeakMap,Dc=new WeakMap,Oc=class extends dc{constructor(...e){super(...e),M(this,q),this.placement=pc.BlockStart,this.collapsible=!1,this.equalWidth=!1,this.size=`medium`,j(this,_c,[]),j(this,vc,!1),j(this,yc,[]),j(this,bc,0),j(this,xc,void 0),j(this,Sc,!1),j(this,Cc,e=>{if(!this.collapsible||Ac.call(P(q,this)))return;let t=P(q,this,Pc).call(this,e.target);!t||t.disabled||jc.call(P(q,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),P(q,this,Fc).call(this,!0))}),j(this,wc,e=>{e.key!==`Escape`||!this.collapsible||Ac.call(P(q,this))||P(q,this,Pc).call(this,e.target)&&(e.stopPropagation(),P(q,this,Fc).call(this,!0))}),j(this,Tc,()=>{Ac.call(P(q,this))&&(jc.call(P(q,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),P(q,this,Ic).call(this)}),j(this,Ec,()=>{if(P(q,this,Rc).call(this),jc.call(P(q,this)).forEach((e,t)=>{let n=()=>P(q,this,Kc).call(this,t,!0),r=e=>{gc.has(e.key)&&e.preventDefault()},i=e=>P(q,this,qc).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),A(_c,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),jc.call(P(q,this))[this.selectedIndex]?.disabled){let e=jc.call(P(q,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}P(q,this,zc).call(this)}),j(this,Dc,()=>{A(Sc,this)||(N(Sc,this,!0),requestAnimationFrame(()=>{N(Sc,this,!1),P(q,this,Vc).call(this)}))})}static get styles(){return[...super.styles,f,fc]}get layout(){return kc.call(P(q,this))?mc.Vertical:mc.Horizontal}set layout(e){this.placement=e===mc.Vertical?pc.InlineStart:pc.BlockStart}refresh(){A(vc,this)&&P(q,this,zc).call(this),P(q,this,Vc).call(this)}close(){!this.collapsible||Ac.call(P(q,this))||P(q,this,Fc).call(this,!0)}open(){Ac.call(P(q,this))&&P(q,this,Kc).call(this,P(q,this,Lc).call(this),!0)}firstUpdated(e){N(vc,this,jc.call(P(q,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(A(vc,this))t?.addEventListener(`slotchange`,A(Ec,this)),A(Ec,this).call(this);else{let n=Ac.call(P(q,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,A(Tc,this))}this.addEventListener(`click`,A(Cc,this),!0),this.addEventListener(`keydown`,A(wc,this)),t?.addEventListener(`slotchange`,A(Dc,this)),N(xc,this,new ResizeObserver(A(Dc,this))),A(xc,this).observe(this),P(q,this,Vc).call(this)}disconnectedCallback(){super.disconnectedCallback(),P(q,this,Rc).call(this),A(xc,this)?.disconnect(),N(xc,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,Ac.call(P(q,this))),e.has(`selectedIndex`)&&(A(vc,this)?P(q,this,zc).call(this):A(Tc,this).call(this),e.get(`selectedIndex`)!==void 0&&this.dispatchEvent(new CustomEvent(`craft-tab-show`))),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`)||e.has(`equalWidth`))&&P(q,this,Vc).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${kc.call(P(q,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${Ac.call(P(q,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function kc(){return hc.includes(this.placement)}function Ac(){return this.selectedIndex<0}function jc(){return this.tabs}function Mc(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function Nc(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function Pc(e){return e instanceof Node?jc.call(P(q,this)).find(t=>t===e||t.contains(e))??null:null}function Fc(e){let t=jc.call(P(q,this))[this.selectedIndex];N(bc,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Ic(){let e=Ac.call(P(q,this))?P(q,this,Lc).call(this):this.selectedIndex;jc.call(P(q,this)).forEach((t,n)=>{t.setAttribute(`tabindex`,n===e?`0`:`-1`)})}function Lc(){let e=jc.call(P(q,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden;return t(A(bc,this))?A(bc,this):e.findIndex((e,n)=>t(n))}function Rc(){for(;A(_c,this).length;)A(_c,this).pop()?.()}function zc(){let e=jc.call(P(q,this)).map(e=>P(q,this,Bc).call(this,e)),t=e.some(Boolean);jc.call(P(q,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Ie()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),P(q,this,Ic).call(this)}function Bc(e){return e.controls?document.getElementById(e.controls):null}function Vc(){let e=Mc.call(P(q,this)),t=Nc.call(P(q,this)),n=jc.call(P(q,this));if(!e||!t)return;if(kc.call(P(q,this))||this.equalWidth||n.length===0){P(q,this,Uc).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=P(q,this,Hc).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){P(q,this,Uc).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);P(q,this,Uc).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Hc(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function Uc(e){let t=Nc.call(P(q,this)),n=new Set(e);jc.call(P(q,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),N(yc,this,e),t&&(t.hidden=e.length===0,t.actions=P(q,this,Wc).call(this))}function Wc(){return A(yc,this).map(e=>{let t=jc.call(P(q,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>P(q,this,Gc).call(this,e)}})}function Gc(e){let t=jc.call(P(q,this))[e];if(!t||t.disabled)return;let n=Nc.call(P(q,this));n&&(n.opened=!1),this.selectedIndex=e,P(q,this,Vc).call(this),t.focus()}function Kc(e,t){let n=jc.call(P(q,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function qc(e){if(!gc.has(e.key))return;let t=P(q,this,Jc).call(this,e.key);t!==-1&&P(q,this,Kc).call(this,t,!0)}function Jc(e){let t=jc.call(P(q,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(Ac.call(P(q,this)))return P(q,this,Jc).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}D([O({reflect:!0})],Oc.prototype,`placement`,void 0),D([O({type:Boolean,reflect:!0})],Oc.prototype,`collapsible`,void 0),D([O({type:Boolean,reflect:!0,attribute:`equal-width`})],Oc.prototype,`equalWidth`,void 0),D([O({reflect:!0})],Oc.prototype,`layout`,null),D([O({reflect:!0})],Oc.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,Oc);var Yc=a`
  :host {
    display: inline-flex;
...
`,al=new WeakMap,ol=new WeakMap,sl=new WeakMap,cl=new WeakSet,ll=class extends rl{constructor(...e){super(...e),M(this,cl),this.monospace=!1,j(this,al,void 0),j(this,ol,void 0),j(this,sl,null)}static get styles(){return[...super.styles,ft,il]}connectedCallback(){super.connectedCallback(),P(cl,this,ul).call(this)}disconnectedCallback(){super.disconnectedCallback(),A(al,this)?.disconnect(),N(al,this,void 0),A(ol,this)?.disconnect(),N(ol,this,void 0)}};function ul(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(N(sl,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{N(sl,this,e.style.height)}),N(ol,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),A(ol,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),N(al,this,new ResizeObserver(()=>{if(e.style.height===A(sl,this))return;let t=e.style.height;tl.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),A(ol,this)?.disconnect(),N(ol,this,void 0),A(al,this)?.disconnect(),N(al,this,void 0)})),A(al,this).observe(e))}D([O({type:Boolean,reflect:!0})],ll.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,ll);var dl=a`
  :host {
    display: block;
    min-width: 0;
  }
...
`,fl=class extends l{constructor(...e){super(...e),this.last=!1,this._hasHeading=!1,this._hasMeta=!1,this._hasBody=!1,this._hasFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,characterData:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasHeading=!!this.querySelector(`:scope > [slot="heading"]`),this._hasMeta=!!this.querySelector(`:scope > [slot="meta"]`),this._hasBody=[...this.childNodes].some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e instanceof HTMLElement&&!e.slot),this._hasFooter=!!this.querySelector(`:scope > [slot="footer"]`)}render(){return r`
    ...
    `}};fl.styles=[dl],D([O({type:Boolean,reflect:!0})],fl.prototype,`last`,void 0),D([k()],fl.prototype,`_hasHeading`,void 0),D([k()],fl.prototype,`_hasMeta`,void 0),D([k()],fl.prototype,`_hasBody`,void 0),D([k()],fl.prototype,`_hasFooter`,void 0),customElements.get(`craft-timeline-item`)||customElements.define(`craft-timeline-item`,fl);var pl=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>ml(e,this),this.compositionEventHandler=e=>bl(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,hl),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,hl)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(yl)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(yl)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(yl),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),vl(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function ml(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:gl(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&gl(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function hl(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&_l(t,{event:e})}function gl(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function _l(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function vl(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function yl(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function bl(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var xl=class extends Event{constructor(){super(`update`)}},Sl=new WeakMap,Cl=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=Sl.get(t);return n||(n=new e(t),Sl.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),Sl.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new xl)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of wl)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},wl=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),Tl=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return Cl.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},El=a`
  :host {
    display: contents;
  }
...
`,Dl=/^[\p{L}\p{N}_.-]*$/u,Ol=_(`Suggestions`),kl=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],Al={handlesAccessibility:!1,visibilityTriggerFunction:void 0},jl=0,J=new WeakMap,Ml=new WeakMap,Nl=new WeakMap,Pl=new WeakMap,Fl=new WeakMap,Il=new WeakMap,Ll=new WeakMap,Rl=new WeakMap,zl=new WeakMap,Bl=new WeakMap,Vl=new WeakMap,Hl=new WeakMap,Ul=new WeakMap,Wl=new WeakMap,Y=new WeakSet,Gl=new WeakMap,Kl=new WeakMap,ql=new WeakMap,Jl=new WeakMap,Yl=new WeakMap,Xl=new WeakMap,Zl=new WeakMap,Ql=new WeakMap,$l=new WeakMap,eu=new WeakMap,tu=new WeakMap,nu=class extends l{constructor(...e){super(...e),M(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,j(this,J,void 0),j(this,Ml,null),j(this,Nl,null),j(this,Pl,new Map),j(this,Fl,null),j(this,Il,[]),j(this,Ll,0),j(this,Rl,null),j(this,zl,null),j(this,Bl,null),j(this,Vl,!1),j(this,Hl,null),j(this,Ul,new DOMRect),j(this,Wl,new MutationObserver(()=>{let e=P(Y,this,iu).call(this);(Eu(e)&&e!==A(Ml,this)||A(Ml,this)&&!A(Ml,this).isConnected)&&P(Y,this,au).call(this)})),j(this,Gl,()=>{A(Vl,this)||P(Y,this,fu).call(this)}),j(this,Kl,()=>{N(Vl,this,!0),P(Y,this,bu).call(this)}),j(this,ql,()=>{N(Vl,this,!1),P(Y,this,fu).call(this)}),j(this,Jl,()=>{queueMicrotask(()=>P(Y,this,bu).call(this))}),j(this,Yl,()=>{let e=A(Ml,this);!e||!A(Fl,this)||!Du(e)||queueMicrotask(()=>{A(Fl,this)&&(e.selectionStart!==A(Fl,this).end||e.selectionEnd!==A(Fl,this).end)&&P(Y,this,fu).call(this)})}),j(this,Xl,()=>{A(Fl,this)&&P(Y,this,yu).call(this)}),j(this,Zl,e=>{let t=e;A(Fl,this)&&A(J,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),j(this,Ql,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),j(this,$l,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),j(this,eu,e=>{P(Y,this,gu).call(this,Number(e.target.dataset.index))}),j(this,tu,e=>{if(e.target!==this.popoverElement)return;let t=A(J,this).getAttribute(`aria-label`)??Ol;P(Y,this,Cu).call(this),N(Fl,this,null),P(Y,this,Su).call(this),P(Y,this,wu).call(this,t===Ol?_(`Suggestions collapsed`):_(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),P(Y,this,ru).call(this),this.hasUpdated&&P(Y,this,au).call(this)}disconnectedCallback(){P(Y,this,su).call(this),A(J,this)?.remove(),A(Bl,this)!==null&&(clearTimeout(A(Bl,this)),N(Bl,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),P(Y,this,au).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&A(Ml,this)!==P(Y,this,iu).call(this)&&P(Y,this,au).call(this),e.has(`triggers`)&&e.get(`triggers`)&&A(Fl,this)){let e=A(J,this).querySelector(`[aria-selected="true"]`),t=e?A(Il,this)[Number(e.dataset.index)]:void 0;P(Y,this,fu).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${Al}
        @craft-hide=${A(tu,this)}
      >
        <div class="text-expander__popup" slot="content">
          ${this.loading?r`<div class="text-expander__loading" part="loading">
                <slot name="loading">${_(`Loading`)}</slot>
              </div>`:c}
          <slot name="listbox"></slot>
        </div>
      </craft-popover>
    ...
    `}};function ru(){N(J,this,document.createElement(`div`)),A(J,this).id=`craft-text-expander-listbox-${++jl}`,A(J,this).slot=`listbox`,A(J,this).setAttribute(`part`,`listbox`),A(J,this).role=`listbox`,A(J,this).setAttribute(`aria-label`,Ol),A(J,this).addEventListener(`pointerdown`,A(Ql,this)),A(J,this).addEventListener(`pointerup`,A($l,this)),A(J,this).addEventListener(`combobox-commit`,A(eu,this)),this.append(A(J,this))}function iu(){return this.getRootNode().getElementById(this.for)}function au(){let e=P(Y,this,iu).call(this);if(P(Y,this,su).call(this),!Eu(e)){P(Y,this,ou).call(this);return}N(Ml,this,e),P(Y,this,cu).call(this,e),N(Nl,this,new pl(e,A(J,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),P(Y,this,lu).call(this,e),e.addEventListener(`input`,A(Gl,this)),e.addEventListener(`keydown`,A(Zl,this)),e.addEventListener(`blur`,A(Jl,this)),e.addEventListener(`compositionstart`,A(Kl,this)),e.addEventListener(`compositionend`,A(ql,this)),e.ownerDocument.addEventListener(`selectionchange`,A(Yl,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>A(Ul,this)},P(Y,this,ou).call(this)}function ou(){A(Wl,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function su(){A(Wl,this).disconnect(),P(Y,this,bu).call(this);let e=A(Ml,this);e&&(e.removeEventListener(`input`,A(Gl,this)),e.removeEventListener(`keydown`,A(Zl,this)),e.removeEventListener(`blur`,A(Jl,this)),e.removeEventListener(`compositionstart`,A(Kl,this)),e.removeEventListener(`compositionend`,A(ql,this)),e.ownerDocument.removeEventListener(`selectionchange`,A(Yl,this)),A(Hl,this)?.getStyleClone().disconnect(),N(Hl,this,null),A(Nl,this)?.destroy(),N(Nl,this,null),P(Y,this,uu).call(this,e),N(Ml,this,null))}function cu(e){A(Pl,this).clear();for(let t of kl)A(Pl,this).set(t,e.getAttribute(t))}function lu(e){let t=[A(Pl,this).get(`aria-controls`),A(J,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):P(Y,this,du).call(this,e,`aria-haspopup`),P(Y,this,du).call(this,e,`aria-expanded`)}function uu(e){for(let t of kl)P(Y,this,du).call(this,e,t);A(Pl,this).clear()}function du(e,t){let n=A(Pl,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function fu(e){P(Y,this,Cu).call(this);let t=P(Y,this,mu).call(this);if(!t){N(Fl,this,null),P(Y,this,xu).call(this);return}N(Fl,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));P(Y,this,hu).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,P(Y,this,hu).call(this,[]),P(Y,this,wu).call(this,_(`Loading`));let r=A(Ll,this);N(zl,this,setTimeout(()=>{P(Y,this,pu).call(this,t,n,r,e)},150))}async function pu(e,t,n,r){N(Rl,this,new AbortController);let i;try{let n=await fe.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:A(Rl,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==A(Ll,this)||Ou(t))return;P(Y,this,bu).call(this),this.dispatchEvent(new CustomEvent(`craft-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===A(Ll,this)&&(this.loading=!1,P(Y,this,hu).call(this,t===void 0?i:i.slice(0,t),r))}function mu(){let e=A(Ml,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!Du(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&Dl.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function hu(e,t){if(P(Y,this,vu).call(this),N(Il,this,e),A(J,this).replaceChildren(),A(J,this).hidden=this.loading,A(J,this).setAttribute(`aria-label`,A(Fl,this)?.trigger.label??Ol),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=Tu(e);n.id=`${A(J,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(A(Fl,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),A(J,this).append(n)}),!this.loading&&!e.length){N(Fl,this,null),P(Y,this,xu).call(this),P(Y,this,wu).call(this,_(`No suggestions`));return}this.updateComplete.then(()=>{A(Fl,this)&&P(Y,this,_u).call(this,t)})}function gu(e){let t=A(Ml,this),n=A(Il,this)[e],r=P(Y,this,mu).call(this),i=A(Fl,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){P(Y,this,bu).call(this);return}ku(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};P(Y,this,bu).call(this),this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0,detail:a}))}async function _u(e){await this.popoverElement.updateComplete;let t=A(Ml,this);if(!t||!P(Y,this,yu).call(this)){P(Y,this,bu).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!A(Fl,this)||t!==A(Ml,this))&&A(Il,this).length&&(A(Nl,this)?.start(),P(Y,this,du).call(this,t,`aria-expanded`),t.removeEventListener(`input`,A(Gl,this)),t.addEventListener(`input`,A(Gl,this)),e)){let t=A(Il,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)A(Nl,this)?.navigate(1)}}function vu(){A(Nl,this)?.stop(),A(Ml,this)&&P(Y,this,du).call(this,A(Ml,this),`aria-expanded`)}function yu(){let e=A(Ml,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!A(Hl,this)){N(Hl,this,new Tl(e));let t=A(Hl,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,A(Xl,this))}return A(Hl,this).setStartOffset(t),A(Hl,this).setEndOffset(t),N(Ul,this,A(Hl,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function bu(){P(Y,this,Cu).call(this),N(Fl,this,null),P(Y,this,xu).call(this)}function xu(){P(Y,this,Su).call(this),this.popoverElement.hide()}function Su(){this.loading=!1,P(Y,this,vu).call(this),N(Il,this,[]),A(J,this)?.replaceChildren(),A(J,this)&&(A(J,this).hidden=!1);let e=A(Ml,this);e&&(P(Y,this,du).call(this,e,`aria-activedescendant`),P(Y,this,du).call(this,e,`aria-busy`))}function Cu(){var e;N(Ll,this,(e=A(Ll,this),e++,e)),A(zl,this)&&(clearTimeout(A(zl,this)),N(zl,this,null)),A(Rl,this)?.abort(),N(Rl,this,null)}function wu(e){A(Bl,this)!==null&&(clearTimeout(A(Bl,this)),N(Bl,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),N(Bl,this,setTimeout(()=>{N(Bl,this,null),this.announcement=``},5e3))}nu.styles=[g,El],D([O({reflect:!0})],nu.prototype,`for`,void 0),D([O({type:Array})],nu.prototype,`triggers`,void 0),D([k()],nu.prototype,`loading`,void 0),D([k()],nu.prototype,`announcement`,void 0),D([de(`craft-popover`)],nu.prototype,`popoverElement`,void 0);function Tu(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function Eu(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function Du(e){return e.getRootNode().activeElement===e}function Ou(e){return e instanceof DOMException&&e.name===`AbortError`}function ku(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,nu);var Au=a`
  :host {
    display: inline-flex;
...
`,ju=new WeakMap,Mu=new WeakSet,Nu=class extends l{constructor(...e){super(...e),M(this,Mu),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,j(this,ju,typeof ResizeObserver<`u`?new ResizeObserver(()=>P(Mu,this,Pu).call(this)):null)}connectedCallback(){super.connectedCallback(),A(ju,this)?.observe(this)}disconnectedCallback(){A(ju,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){A(ju,this)||P(Mu,this,Pu).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${P(Mu,this,Fu)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function Pu(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function Fu(){P(Mu,this,Pu).call(this)}Nu.styles=Au,D([O({reflect:!0})],Nu.prototype,`placement`,void 0),D([O({type:Boolean,reflect:!0})],Nu.prototype,`disabled`,void 0),D([k()],Nu.prototype,`overflowing`,void 0),D([k()],Nu.prototype,`text`,void 0),D([de(`.truncate`)],Nu.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,Nu);var Iu=a`
  :host {
...
`,Lu=class e extends l{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!1,this.rounded=!1,this.animated=!1,this.frozen=!1,this.capturedFrame=null,this.resizeObserver=null}get isAnimated(){return this.animated||e.animatedExtensionPattern.test(this.src??``)||e.animatedExtensionPattern.test(this.srcset??``)}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}willUpdate(e){if((e.has(`src`)||e.has(`srcset`)||e.has(`animated`))&&(this.frozen=!1,this.capturedFrame=null,this.resizeObserver?.disconnect(),this.resizeObserver=null,!e.has(`src`))){let e=this.shadowRoot?.querySelector(`img`);e?.complete&&this.attemptFreeze(e)}}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs(),this.resizeObserver?.disconnect()}render(){return r`
      <div class="${E({thumbnail:!0,"thumbnail--checkered":this.checkered,"thumbnail--rounded":this.rounded,"thumbnail--crop":this.mode===`crop`,"thumbnail--stretch":this.mode===`stretch`})}" part="thumbnail">
        ${this.src?r`<img
              class="${E({thumbnail__image:!0,"cp-visually-hidden":this.frozen})}"
              part="image"
              src="${this.src}"
              srcset="${ce(this.srcset??void 0)}"
              sizes="${ce(this.sizes??void 0)}"
              width="${ce(this.width??void 0)}"
              height="${ce(this.height??void 0)}"
              alt="${this.alt}"
        ...
        ${this.src&&this.isAnimated?r`<canvas
              class="${E({thumbnail__cover:!0,"thumbnail__cover--pending":!this.frozen})}"
              part="cover"
              aria-hidden="true"
              role="presentation"
            ></canvas>`:c}
    ...
    `}freezeFrame(e){this.attemptFreeze(e.target)}attemptFreeze(e){if(!this.isAnimated||!e.currentSrc)return;let t=new Image;t.onload=()=>{this.capturedFrame=t,this.resizeObserver?.disconnect(),this.resizeObserver=new ResizeObserver(()=>{this.capturedFrame&&this.paintCover(this.capturedFrame,e)}),this.resizeObserver.observe(e)},t.src=e.currentSrc}paintCover(e,t){if(!e.naturalWidth||!e.naturalHeight)return;let n=this.shadowRoot?.querySelector(`canvas.thumbnail__cover`),r=n?.getContext(`2d`);if(!r)return;let i=t.clientWidth,a=t.clientHeight;if(!i||!a)return;let o=window.devicePixelRatio||1;if(n.width=i*o,n.height=a*o,n.style.width=`${i}px`,n.style.height=`${a}px`,r.scale(o,o),this.mode===`crop`){let t=Math.max(i/e.naturalWidth,a/e.naturalHeight),n=i/t,o=a/t;r.drawImage(e,(e.naturalWidth-n)/2,(e.naturalHeight-o)/2,n,o,0,0,i,a)}else r.drawImage(e,0,0,i,a);this.frozen=!0}};Lu.styles=[g,Iu],Lu.animatedExtensionPattern=/\.(?:gif|webp)(?=[?#\s,]|$)/i,D([O()],Lu.prototype,`src`,void 0),D([O({reflect:!0})],Lu.prototype,`mode`,void 0),D([O()],Lu.prototype,`srcset`,void 0),D([O()],Lu.prototype,`sizes`,void 0),D([O()],Lu.prototype,`alt`,void 0),D([O({type:Number})],Lu.prototype,`width`,void 0),D([O({type:Number})],Lu.prototype,`height`,void 0),D([O()],Lu.prototype,`loading`,void 0),D([O({type:Boolean,reflect:!0})],Lu.prototype,`checkered`,void 0),D([O({type:Boolean,reflect:!0})],Lu.prototype,`rounded`,void 0),D([O({type:Boolean,reflect:!0})],Lu.prototype,`animated`,void 0),D([k()],Lu.prototype,`frozen`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,Lu);var Ru=new WeakMap,zu=new WeakSet,Bu=class extends HTMLElement{constructor(...e){super(...e),M(this,zu),j(this,Ru,null)}connectedCallback(){P(zu,this,Vu).call(this)}disconnectedCallback(){A(Ru,this)?.destroy(),N(Ru,this,null)}};function Vu(){if(!(A(Ru,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>P(zu,this,Vu).call(this));return}N(Ru,this,new dr),A(Ru,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Bu);function Hu(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function Uu(e={}){let t=Hu({...e,type:`submit`,label:e.label||_(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function Wu(e={}){let t=Hu({...e,icon:`duplicate`,label:e.label||cr(_(`Paste {type}`,{type:_(`elements`)}))});return t.classList.add(`paste-btn`),t}var Gu=async(e,t)=>{let{data:n}=await fe.post(e,t);return n},Ku=new WeakMap,qu=new WeakMap,Ju=new WeakMap,Yu=new WeakMap,Xu=new WeakMap,Zu=new WeakMap,Qu=new WeakMap,$u=new WeakMap,ed=new WeakMap,td=new WeakMap,X=new WeakSet,nd=class e{constructor(t){M(this,X),j(this,Ku,null),j(this,qu,[]),j(this,Ju,[]),j(this,Yu,null),j(this,Xu,!1),j(this,Zu,!1),j(this,Qu,!1),j(this,$u,null),j(this,ed,void 0),j(this,td,new Map),this.options={...e.defaults,modalTitle:_(`Select element`),selectBtnLabel:_(`Select`),...sd(t)},N(Ju,this,[...this.options.disabledElementIds??[]]),N(ed,this,P(X,this,rd).call(this))}get elementType(){return this.options.elementType}get state(){return A(ed,this)}get index(){return A(Ku,this)}get hasSelection(){return A(qu,this).length>0}on(e,t){let n=A(td,this).get(e);return n||(n=new Set,A(td,this).set(e,n)),n.add(t),()=>{A(td,this).get(e)?.delete(t)}}async open(){N(qu,this,[]),A(Ku,this)?.clearSelection(),A(Xu,this)||(N(Xu,this,!0),P(X,this,od).call(this,`open`,void 0)),P(X,this,id).call(this),A(Yu,this)||await this.reload()}close(){A(Xu,this)&&(N(Xu,this,!1),P(X,this,od).call(this,`close`,void 0),this.options.onClose?.(),P(X,this,id).call(this))}destroy(){A(Ku,this)?.destroy?.(),N(Ku,this,null),N(qu,this,[]),N(Yu,this,null),N(Xu,this,!1),N(Qu,this,!1),N(Zu,this,!1),N($u,this,null),P(X,this,id).call(this),A(td,this).clear()}async reload(){let e=this.options.loadIndexBody??Gu;N(Zu,this,!0),N($u,this,null),P(X,this,id).call(this);try{N(Yu,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){P(X,this,ad).call(this,e)}finally{N(Zu,this,!1),P(X,this,id).call(this)}}async submit(){if(!A(ed,this).canSubmit)return;let e=this.buildElementInfo(A(qu,this)),t=this.selectMeta();N(Qu,this,!0),P(X,this,id).call(this);try{P(X,this,od).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){P(X,this,ad).call(this,e);return}finally{N(Qu,this,!1),P(X,this,id).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...A(Ju,this),...e.map(e=>Number(e.id))]),A(Ku,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){A(ed,this).canCancel&&(P(X,this,od).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){N(Ku,this,e),P(X,this,id).call(this)}detachIndex(){N(Ku,this,null),P(X,this,id).call(this)}setSelection(e){N(qu,this,[...e]),P(X,this,id).call(this)}setDisabledElementIds(e){N(Ju,this,[...new Set(e.map(Number))]),P(X,this,id).call(this)}setBusy(e){N(Qu,this,e),P(X,this,id).call(this)}indexParams(){let{options:e}=this,t={context:e.context??`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition,criteria:{...e.criteria}};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),e.criteria&&(t.criteria={...e.criteria}),typeof e.indexSettings.showFolders==`boolean`&&(t.showFolders=e.indexSettings.showFolders),t}indexSettings(){let{options:e}=this;return{context:e.context??`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...A(Ju,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return A(qu,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){P(X,this,id).call(this)}get selection(){return A(qu,this)}get disabledElementIds(){return A(Ju,this)}};function rd(){let e=A(Qu,this),t=A(Zu,this);return Object.freeze({open:A(Xu,this),loading:t,busy:e,selection:Object.freeze([...A(qu,this)]),disabledElementIds:Object.freeze([...A(Ju,this)]),indexBody:A(Yu,this),error:A($u,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function id(){N(ed,this,P(X,this,rd).call(this)),P(X,this,od).call(this,`change`,A(ed,this))}function ad(e){N($u,this,e instanceof Error?e:Error(String(e??`Unknown`))),P(X,this,od).call(this,`error`,A($u,this))}function od(e,t){let n=A(td,this).get(e);n&&[...n].forEach(e=>e(t))}nd.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function sd(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var cd=async(e,t)=>{let{data:n}=await fe.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},ld=new WeakMap,ud=class e extends nd{constructor(e){super(e),j(this,ld,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??cd;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}N(ld,this,t);try{await this.submit()}finally{N(ld,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!A(ld,this))return n;let r=e.transformUrls[A(ld,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:A(ld,this)}}};ud.transformUrls={};var dd=`CraftCms\\Cms\\Asset\\Elements\\Asset`,fd=new WeakSet,pd=class extends nd{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:dd,showSiteMenu:!1}),M(this,fd),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:P(fd,this,md).call(this),status:null,url:null,hasThumb:!1}]}};function md(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var hd=new Map;function gd(e,t){if(hd.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);hd.set(e,t)}function _d(e){return hd.has(e)}function vd(e){return hd.get(e)??nd}function yd(e){return new(vd(e.elementType))(e)}function bd(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))hd.has(t)||hd.set(t,n)}var xd={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},Sd=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,Z=new WeakSet,kd=class{constructor(e={}){M(this,Z),j(this,Sd,new Map),j(this,Cd,null),j(this,wd,0),j(this,Td,[]),j(this,Ed,[]),j(this,Dd,new Set),j(this,Od,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)A(Sd,this).set(e.id,e);r&&(P(Z,this,Nd).call(this),A(Cd,this)!==null&&P(Z,this,Pd).call(this))}getSessions(){return Array.from(A(Sd,this).values())}getCurrentSessionId(){return A(Cd,this)}isProcessing(){return A(wd,this)>0}on(e,t){return A(Od,this).has(e)||A(Od,this).set(e,new Set),A(Od,this).get(e).add(t),()=>{A(Od,this).get(e)?.delete(t)}}async startIndexing(e){let t=await fe.post(xd.START,e),{data:n}=t;return n.session&&(A(Sd,this).set(n.session.id,n.session),N(Cd,this,n.session.id),P(Z,this,jd).call(this),n.stop||P(Z,this,Pd).call(this)),n.stop&&P(Z,this,Md).call(this,n.stop),t}stopSession(e){P(Z,this,Fd).call(this,e),P(Z,this,Id).call(this,{sessionId:e,action:xd.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){P(Z,this,Id).call(this,{sessionId:e,action:xd.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){P(Z,this,Id).call(this,{sessionId:e.sessionId,action:xd.FINISH,params:e,priority:!0})}destroy(){A(Sd,this).clear(),N(Td,this,[]),N(Ed,this,[]),A(Od,this).clear(),N(Cd,this,null),N(wd,this,0)}};function Ad(e,t){A(Od,this).get(e)?.forEach(e=>e(t))}function jd(e){P(Z,this,Ad).call(this,`change`,{sessions:this.getSessions(),currentSessionId:A(Cd,this),reviewSessionId:e})}function Md(e){A(Sd,this).delete(e),A(Cd,this)===e&&N(Cd,this,null),P(Z,this,jd).call(this)}function Nd(){for(let[e,t]of A(Sd,this))if(!t.actionRequired&&!A(Dd,this).has(e)){N(Cd,this,e);return}N(Cd,this,null)}function Pd(){if(A(Cd,this)||P(Z,this,Nd).call(this),!A(Cd,this))return;let e=A(Sd,this).get(A(Cd,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-A(wd,this),r=Math.min(n,t);for(let t=0;t<r;t++)P(Z,this,Id).call(this,{sessionId:e.id,action:xd.PROCESS,params:{sessionId:A(Cd,this)},priority:!1});e.processIfRootEmpty&&P(Z,this,Id).call(this,{sessionId:e.id,action:xd.PROCESS,params:{sessionId:A(Cd,this)},priority:!1})}function Fd(e){A(Dd,this).add(e),N(Td,this,A(Td,this).filter(t=>t.sessionId!==e))}function Id(e){e.priority?A(Ed,this).push(e):A(Td,this).push(e),P(Z,this,Ld).call(this)}function Ld(){if(!(A(Td,this).length+A(Ed,this).length===0||A(wd,this)>=this.maxConcurrentConnections))for(;A(Td,this).length+A(Ed,this).length>0&&A(wd,this)<this.maxConcurrentConnections;){var e;N(wd,this,(e=A(wd,this),e++,e));let t=A(Ed,this).length>0?A(Ed,this).shift():A(Td,this).shift();P(Z,this,Rd).call(this,t)}}async function Rd(e){try{let t=await fe.post(e.action,e.params);P(Z,this,zd).call(this,t.data)}catch(t){P(Z,this,Bd).call(this,t,e)}finally{var t;N(wd,this,(t=A(wd,this),t--,t)),P(Z,this,Ld).call(this)}}function zd(e){let t;e.session&&(A(Sd,this).set(e.session.id,e.session),P(Z,this,Nd).call(this),e.session.actionRequired&&!e.skipDialog?A(Dd,this).has(e.session.id)||(t=e.session.id):A(Dd,this).has(e.session.id)||P(Z,this,Pd).call(this)),P(Z,this,Nd).call(this),e.stop&&(A(Sd,this).delete(e.stop),A(Cd,this)===e.stop&&N(Cd,this,null)),P(Z,this,jd).call(this,t),A(Sd,this).size===0&&P(Z,this,Ad).call(this,`complete`,{})}function Bd(e,t){P(Z,this,Nd).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;P(Z,this,Ad).call(this,`error`,{message:n,sessionId:t.sessionId}),P(Z,this,Ld).call(this)}var Vd=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},Hd=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Ud,Wd=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Gd=typeof Intl<`u`&&Intl.ListFormat||Wd,Kd=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],qd={minimumIntegerDigits:2},Jd=class{constructor(e,t={}){Ud.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Vd(this,Ud,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return Hd(this,Ud,`f`)}formatToParts(e){let t=[],n=Hd(this,Ud,`f`),r=n.style,i=n.locale;for(let[a,o]of Kd){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?qd:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Gd(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Ud=new WeakMap;var Yd=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,Xd=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],Zd=e=>Yd.test(e),Qd=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(Yd)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs($d(r,e.from(t)).getTime()-r),a=Math.abs($d(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Jd(e,t).format(this)}};function $d(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function ef(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new Qd;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=Xd.indexOf(t)||Xd.length;return new Qd(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function tf(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new Qd(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function nf(e,t){let n=tf(e,t);if(n.blank)return[0,`second`];for(let e of Xd){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},rf=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,af,of,sf,cf,lf,uf,df,ff,pf,mf,hf,gf,_f,vf,yf,bf=globalThis.HTMLElement||null,xf=new Qd,Sf=new Qd(0,0,0,0,0,1),Cf=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function wf(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var Tf=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=wf(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,wf(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},Ef=class extends bf{constructor(){super(...arguments),$.add(this),af.set(this,!1),of.set(this,!1),cf.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),yf.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,yf,`f`)}set onRelativeTimeUpdated(e){Q(this,yf,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,yf,`f`)),rf(this,yf,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&Zd(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return Xd.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){Tf.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&rf(this,af,n!==null&&(this.date&&Q(this,$,`m`,lf).call(this,this.date))!==n,`f`),!Q(this,of,`f`)&&!(e===`title`&&Q(this,af,`f`))&&rf(this,of,(async()=>{await Promise.resolve(),this.update(),rf(this,of,!1,`f`)})(),`f`))}update(){let e=Q(this,cf,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,cf,`f`).textContent=e;return}let i=Date.now();Q(this,af,`f`)||(n=Q(this,$,`m`,lf).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=ef(r,this.precision,i),o=Q(this,$,`m`,uf).call(this,a),s=e,c=Q(this,$,`m`,vf).call(this,o);s=c?Q(this,$,`m`,gf).call(this,r):o===`duration`?Q(this,$,`m`,df).call(this,a):o===`relative`?Q(this,$,`m`,ff).call(this,a):Q(this,$,`m`,pf).call(this,r),s?Q(this,$,`m`,_f).call(this,s):this.shadowRoot===Q(this,cf,`f`)&&this.textContent&&Q(this,$,`m`,_f).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new Cf(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,mf).call(this,r)||Q(this,$,`m`,hf).call(this,r))?Tf.observe(this):Tf.unobserve(this)}};af=new WeakMap,of=new WeakMap,cf=new WeakMap,yf=new WeakMap,$=new WeakSet,sf=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},lf=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,sf),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},uf=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||Qd.compare(e,this.threshold)===1)return`relative`}return`datetime`},df=function(e){let t=Q(this,$,`a`,sf),n=this.format,r=this.formatStyle,i=this.tense,a=xf;n===`micro`?(e=tf(e),a=Sf,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=Sf)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},ff=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,sf),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=xf),n===`past`&&e.sign!==-1&&(e=xf);let[r,i]=nf(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},pf=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,sf),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},mf=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,sf),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},hf=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,sf),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},gf=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,mf).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,sf),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,sf))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,sf),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,hf).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,sf),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,sf),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},_f=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,cf,`f`).replaceChildren(t)}else Q(this,cf,`f`).textContent=e},vf=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var Df=typeof globalThis<`u`?globalThis:window;try{Df.RelativeTimeElement=Ef.define()}catch(e){if(!(Df.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{or as C,Qn as D,tr as E,Wn as O,ar as S,Zn as T,va as _,_d as a,cr as b,nd as c,Uu as d,ll as f,eo as g,ao as h,bd as i,_n as k,Wu as l,rs as m,yd as n,pd as o,tc as p,gd as r,ud as s,kd as t,Hu as u,U as v,ir as w,sr as x,dr as y};
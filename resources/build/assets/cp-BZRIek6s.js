...
`;function pe(e){return(t,n)=>{let{slot:r,selector:i}=e??{},a=`slot`+(r?`[name=${r}]`:`:not([name])`);return v(t,n,{get(){let t=(this.renderRoot?.querySelector(a))?.assignedElements(e)??[];return i===void 0?t:t.filter((e=>e.matches(i)))}})}}var me=class extends l{constructor(){super(),this.alt=!1,this.shift=!1,this.os=`Unknown`,this.os=this.detectOS()}connectedCallback(){super.connectedCallback(),this.os===`Unknown`&&(this.os=this.detectOS())}detectOS(){let e=navigator.platform.toLowerCase();return e.includes(`mac`)||/iphone|ipad|ipod/.test(e)?`Mac`:e.includes(`win`)?`Windows`:e.includes(`linux`)?`Linux`:`Unknown`}renderShortcutPrefix(){switch(this.os){case`Mac`:return`${this.alt?`⌥`:``}${this.shift?`⇧`:``}⌘`;case`Linux`:return`Super+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`;default:return`Ctrl+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`}}render(){return r`<span class="shortcut"
  ...
  `,p([g({type:Boolean})],me.prototype,`alt`,void 0),p([g({type:Boolean})],me.prototype,`shift`,void 0),p([g()],me.prototype,`os`,void 0),customElements.get(`craft-shortcut`)||customElements.define(`craft-shortcut`,me);var he=class{constructor(){this.refreshPromise=null,this.tokenName=null,this.tokenValue=null,this.refreshPromise=null}async getToken(){return this.tokenValue||await this.refreshToken(),this.tokenValue}async refreshToken(){return this.refreshPromise||=ve.get(`users/session-info`).then(({data:e})=>{let{csrfTokenName:t,csrfTokenValue:n}=e;return this.tokenName=t??null,this.tokenValue=n??null,this.tokenValue}).finally(()=>{this.refreshPromise=null}),this.refreshPromise}clearToken(){this.tokenValue=null}};function ge(e=``){return b.getInstance().getActionUrl(e)}function _e(){let e=window.Craft,t=e?.registeredAssetBundles??Cp.registeredAssetBundles,n=e?.registeredJsFiles??Cp.registeredJsFiles;return{"X-Registered-Asset-Bundles":[...new Set(t)].join(`,`),"X-Registered-Js-Files":[...new Set(n)].join(`,`)}}var ve=x.create(),ye=new he;ve.interceptors.request.use(async e=>{e.url&&!e.url.startsWith(`/`)&&!/^[a-z][a-z\d+.-]*:/i.test(e.url)?e.url=ge(e.url):e.url?.startsWith(`/`)&&(e.baseURL=new URL(ge()).origin),e.headers.set(`X-Requested-With`,`XMLHttpRequest`);let t=_e();return Object.entries(t).forEach(([t,n])=>{e.headers.set(t,n)}),e}),ve.interceptors.response.use(e=>e,async e=>{let t=e.config;if(e.response?.status===419||e.response?.status===403&&!t._retry){t._retry=!0;try{return ye.clearToken(),t.headers[`X-CSRF-Token`]=await ye.refreshToken(),x(t)}catch(e){return console.error(`Failed to refresh CSRF token:`,e),Promise.reject(e)}}return Promise.reject(e)});function be(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return null}}async function xe(e,t={}){switch(e.type){case`clipboard`:await navigator.clipboard.writeText(e.value);break;case`http`:{if(e.confirm&&!confirm(e.confirm))return;let t=await fetch(e.url,{method:e.method||`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:e.body?JSON.stringify(e.body):void 0}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(n.message??`Request failed`);typeof n.redirect==`string`&&n.redirect&&Se(n.redirect);break}case`event`:if(e.confirm&&!confirm(e.confirm))return;window.dispatchEvent(new CustomEvent(e.name,{detail:{...e.detail??{},...t.trigger?{trigger:t.trigger}:{},...t.sourceEvent?{sourceEvent:t.sourceEvent}:{}}}));break;case`download`:{if(e.confirm&&!confirm(e.confirm))return;if(e.method&&e.method!==`GET`){let t=await ve.request({url:e.url,method:e.method,data:e.body,responseType:`blob`}),n=String(t.headers[`content-disposition`]??``),r=/filename\*?=(?:UTF-8'')?"?([^";]+)"?/i.exec(n),i=e.filename??(r?.[1]?decodeURIComponent(r[1]):`download`),a=URL.createObjectURL(t.data),o=document.createElement(`a`);o.href=a,o.download=i,document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(a);break}let t=document.createElement(`a`);t.href=e.url,t.download=e.filename??``,t.click();break}default:throw Error(`Unknown action type: ${e.type}`)}}function Se(e){window.dispatchEvent(new CustomEvent(`action:redirect`,{cancelable:!0,detail:{url:e}}))&&window.location.assign(e)}var Ce={Neutral:`neutral`,Success:`success`,Warning:`warning`,Danger:`danger`,Info:`info`},we=Object.values(Ce),Te={Idle:`idle`,Loading:`loading`,Success:`success`,Error:`error`},Ee=a`
  :host {
    display: contents;
  }
...
`,A=class extends l{constructor(...e){super(...e),this.icon=null,this.iconColor=null,this.href=null,this.disabled=!1,this.variant=Ce.Neutral,this.checked=!1,this.active=!1,this.type=`button`,this.action=null,this.feedback=null,this.feedbackDuration=1e3,this.confirm=null,this.state=Te.Idle,this.feedbackMessage=null,this.shortcut=null}renderShortcut(){return typeof this.shortcut==`string`?r`<craft-shortcut>${this.shortcut}</craft-shortcut>`:this.shortcut===null?c:r`<craft-shortcut
        ?alt="${this.shortcut.alt??!1}"
        ?shift="${this.shortcut.shift??!1}"
        >${this.shortcut.key}</craft-shortcut
      >`}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this)}setState(e,t={}){this.state=e,this.feedbackMessage=t.message??null,this.dispatchEvent(new CustomEvent(`action:change-state`,{bubbles:!0,composed:!0,detail:{state:e,actionType:be(this.action)?.type,...t}}))}async handleEvent(e){if(this.disabled){e.preventDefault();return}let t=be(this.action);if(e.type===`click`&&t){t.type===`http`&&this.setState(Te.Loading);try{await xe(t,{trigger:this,sourceEvent:e}),this.setState(Te.Success,this.feedback?.success)}catch(e){this.setState(Te.Error,{message:e.message,...this.feedback?.error||{}})}finally{setTimeout(()=>{this.setState(Te.Idle)},this.feedbackDuration)}}}renderCheckbox(){return r`<span class="action-item__check">
      <slot name="checkmark">
        ${this.checked?r`<craft-icon name="check"></craft-icon>`:c}
      </slot>
    </span>`}renderIcon(){switch(this.state){case Te.Loading:return r`<craft-spinner style="--size: 0.8em"></craft-spinner>`;case Te.Success:return r`<craft-icon
          name="check"
          style="color: var(--c-color-success-on-normal)"
        ></craft-icon>`;case Te.Error:return r`<craft-icon
          name="xmark"
    ...
    `],qe._filterableItemsSelector=`craft-action-item, li, button`,p([g({attribute:!1})],qe.prototype,`actions`,void 0),p([g()],qe.prototype,`label`,void 0),p([g()],qe.prototype,`icon`,void 0),p([g({type:Boolean,reflect:!0})],qe.prototype,`disabled`,void 0),p([g({type:Boolean,reflect:!0})],qe.prototype,`searchable`,void 0),p([pe({slot:`invoker`})],qe.prototype,`invokerNodes`,void 0),p([pe({slot:`content`})],qe.prototype,`contentNodes`,void 0),customElements.get(`craft-action-menu`)||customElements.define(`craft-action-menu`,qe);var Je=a`
  :host {
    --color-start: red;
    --color-end: blue;
    --color-text: inherit;
...
`,Ye=class extends l{constructor(...e){super(...e),this.label=null,this._gradientId=null}connectedCallback(){super.connectedCallback(),this._gradientId=`avatar-gradient-${Math.random().toString(36).slice(2,8)}`}text(){return this.label?this.label.split(` `).map(e=>e.charAt(0).toUpperCase()).join(``):`?`}render(){return r`
      <span class="avatar">
        <svg
          viewBox="0 0 100 100"
    ...
    `}};Ye.styles=[Je],p([g()],Ye.prototype,`label`,void 0),p([_()],Ye.prototype,`_gradientId`,void 0),customElements.get(`craft-avatar`)||customElements.define(`craft-avatar`,Ye);var Xe=[`red`,`orange`,`amber`,`yellow`,`lime`,`green`,`emerald`,`teal`,`cyan`,`sky`,`blue`,`indigo`,`violet`,`purple`,`fuchsia`,`pink`,`rose`,`white`,`gray`,`black`,`slate`],Ze={neutral:`slate`,accent:`blue`,info:`sky`,success:`emerald`,warning:`yellow`,danger:`red`},Qe={pending:`orange`,off:`red`,suspended:`red`,expired:`red`,disabled:`gray`,inactive:`gray`,on:`emerald`},$e=e=>e.charAt(0).toUpperCase()+e.slice(1),et={...Object.fromEntries(Xe.map(e=>[$e(e),e])),...Object.fromEntries(Object.entries(Ze).map(([e,t])=>[$e(e),t])),...Object.fromEntries(Object.entries(Qe).map(([e,t])=>[$e(e),t]))},tt=[...Xe],nt=class extends l{constructor(...e){super(...e),this.size=`md`,this.fill=`var(--c-color-fill-loud)`,this.label=null,this.appearance=te.OutlineFill}getFill(){return tt.includes(this.fill)||we.includes(this.fill)?`var(--c-color-${this.fill}-fill-loud)`:this.fill}getSize(){switch(this.size){case`md`:return`0.6em`;case`lg`:return`1em`;default:return this.size}}render(){return r`<span
      style="--fill: ${this.getFill()}; --size: ${this.getSize()}"
      aria-label="${this.label??c}"
      role="${this.label?`img`:c}"
      class="${k({indicator:!0,"indicator--outline":this.appearance===te.Outline})}"
    ></span>`}};nt.styles=[fe,a`
      :host {
        display: contents;
      }
    ...
    `],p([g()],nt.prototype,`size`,void 0),p([g({reflect:!0})],nt.prototype,`fill`,void 0),p([g()],nt.prototype,`label`,void 0),p([g({reflect:!0})],nt.prototype,`appearance`,void 0),customElements.get(`craft-indicator`)||customElements.define(`craft-indicator`,nt);var rt=a`
  :host {
    display: inline-flex;
  }
...
`,it={Small:`small`,Medium:`medium`,Large:`large`};Object.values(it);var at=class extends l{constructor(...e){super(...e),this.fill=et.Gray,this.noPrefix=!1,this.size=it.Medium}getFill(){return this.fill}willUpdate(e){e.has(`fill`)&&(this.dataset.color=this.getFill())}render(){return r`
      <span
        part="badge"
        class="${k({badge:!0,"badge--small":this.size===it.Small,"badge--large":this.size===it.Large})}"
      >
    ...
    `}};at.styles=[rt],p([g({reflect:!0})],at.prototype,`fill`,void 0),p([g({attribute:`no-prefix`,type:Boolean})],at.prototype,`noPrefix`,void 0),p([g()],at.prototype,`size`,void 0),customElements.get(`craft-badge`)||customElements.define(`craft-badge`,at);var ot=class extends l{constructor(...e){super(...e),this.rel=`noreferrer noopener`}render(){return r`
  ...
  `,p([g({reflect:!0})],ot.prototype,`href`,void 0),p([g()],ot.prototype,`target`,void 0),p([g()],ot.prototype,`rel`,void 0),customElements.get(`craft-breadcrumb-item`)||customElements.define(`craft-breadcrumb-item`,ot);var st=class{constructor(){this.__iconResolvers=new Map}addIconResolver(e,t){if(this.__iconResolvers.has(e))throw Error(`An icon resolver has already been registered for namespace: ${e}`);this.__iconResolvers.set(e,t)}removeIconResolver(e){this.__iconResolvers.delete(e)}resolveIcon(e,t,n){let r=this.__iconResolvers.get(e);if(r)return r(t,n);throw Error(`Could not find any icon resolver for namespace ${e}.`)}resolveIconForId(e){let t=e.split(`:`);if(t.length!==3)throw Error(`Incorrect iconId: ${e}. Format: <namespace>:<iconset>:<icon>`);return this.resolveIcon(t[0],t[1],t[2])}};function ct(){if(!ne.has(`@lion/ui::icons::0.x`)){let e=new st;ne.set(`@lion/ui::icons::0.x`,e)}return ne.get(`@lion/ui::icons::0.x`)}var lt=le(ct),ut=class extends de{constructor(e){if(super(e),this.it=c,e.type!==S.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===c||e==null)return this._t=void 0,this.it=e;if(e===o)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};ut.directiveName=`unsafeHTML`,ut.resultType=1;var dt=T(ut),ft=class extends ut{};ft.directiveName=`unsafeSVG`,ft.resultType=2;var pt=T(ft),mt=`craft`,ht=new Map;function gt(e,t){return`${e}/${t}`}function _t(e){let[t=`classic`,n=`regular`]=e.split(`/`);return{family:t,variant:n}}async function vt(e){try{let t=await fetch(e,{mode:`cors`});if(!t.ok)return c;let n=document.createElement(`div`);n.innerHTML=await t.text();let i=n.firstElementChild;return i?.tagName?.toLowerCase()===`svg`?(i.setAttribute(`fill`,`currentColor`),i.setAttribute(`part`,`svg`),r`${pt(i.outerHTML)}`):c}catch{return c}}function yt(e,t=`classic`,n=`regular`,r=`/vendor/craft/icons`){let i=`solid`,a=n,o=e.endsWith(`.svg`)?e.split(`.svg`)[0]:e;if(e.includes(`/`)){let[t,...n]=e.split(`/`);a=t??a,o=n.join(`/`)}return a===`thin`?i=`thin`:a===`light`?i=`light`:a===`regular`?i=`regular`:a===`solid`&&(i=`solid`),(t===`brands`||a===`brands`)&&(i=`brands`),(t===`custom-icons`||a===`custom-icons`)&&(i=`custom-icons`),`${r}/${i}/${o}.svg`}function bt(e){return(t,n,r)=>{let i=e(t,n,r);if(i===null)return c;let a=ht.get(i);return a||(a=vt(i),ht.set(i,a)),a.then(e=>(e===c&&ht.delete(i),e))}}var xt=bt(yt);function St(e){lt.removeIconResolver(mt),lt.addIconResolver(mt,(t,n)=>{let{family:r,variant:i}=_t(t);return e(n,r,i)})}function Ct(e,t=`classic`,n=`regular`){return Promise.resolve(lt.resolveIcon(mt,gt(t,n),e))}St(xt);var wt=new WeakSet,Tt=class extends l{constructor(...e){super(...e),d(this,wt),this.appearance=`plain`,this._svg=c,this._hasSlottedContent=!1}connectedCallback(){super.connectedCallback(),this.appearance===`badge`&&!this.getAttribute(`data-color`)&&this.setAttribute(`data-color`,`warning`),this._hasSlottedContent=this.childElementCount>0}firstUpdated(){u(wt,this,Ot).call(this)}updated(e){super.updated(e),(e.has(`name`)||e.has(`family`)||e.has(`variant`))&&u(wt,this,Dt).call(this),e.has(`label`)&&this.hasUpdated&&u(wt,this,Ot).call(this)}_handleSlotChange(e){let t=e.target;this._hasSlottedContent=t.assignedElements({flatten:!0}).length>0}render(){return r`
...
`,At=class extends l{constructor(...e){super(...e),this.label=O(`Breadcrumbs`),this.items=[],this.visibleItems=0,this.firstRender=!0}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}calculateBreadcrumbItemsWidth(){this.items=this.breadcrumbsElements.map((e,t)=>{let n=e.offsetWidth;return e.hasAttribute(`hidden`)&&(e.removeAttribute(`hidden`),n=e.offsetWidth,e.setAttribute(`hidden`,``)),{label:e.innerText,href:e.href,value:t.toString(),offsetWidth:n,isVisible:!0}})}async handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`craft-breadcrumb-item`);if(e.forEach((t,n)=>{let r=n===e.length-1,i=t.querySelector(`[slot="separator"]`);r?i?.hasAttribute(`data-default`)&&i.remove():i===null?t.append(this.getSeparator()):i.hasAttribute(`data-default`)&&i.replaceWith(this.getSeparator()),r?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)}),this.breadcrumbsElements.length===0){this.items=[],this.visibleItems=0;return}await Promise.all(this.breadcrumbsElements.map(e=>e.updateComplete)),this.calculateBreadcrumbItemsWidth(),this.visibleItems=0,this.adjustOverflow()}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{if(this.firstRender){this.firstRender=!1;return}this.adjustOverflow()}),this.resizeObserver.observe(this)}adjustOverflow(){}disconnectedCallback(){this.resizeObserver?.unobserve(this),super.disconnectedCallback()}render(){return r`
    ...
    `}};At.styles=[kt],p([y(`slot`)],At.prototype,`defaultSlot`,void 0),p([y(`slot[name="separator"]`)],At.prototype,`separatorSlot`,void 0),p([pe({selector:`craft-breadcrumb-item`})],At.prototype,`breadcrumbsElements`,void 0),p([g()],At.prototype,`label`,void 0),p([_()],At.prototype,`items`,void 0),p([_()],At.prototype,`visibleItems`,void 0),customElements.get(`craft-breadcrumbs`)||customElements.define(`craft-breadcrumbs`,At);var jt=a`
  :host {
...
`,Pt=class extends We(ce(l)){static get properties(){return{invokerRelation:{type:String,attribute:`invoker-relation`}}}static get styles(){return[...super.styles,a`
        :host {
      ...
      `]}constructor(){super(),this.hasArrow=!1,this.invokerRelation=`description`}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];_defineOverlayConfig(){let e=super._defineOverlayConfig(),t=Ke({invokerRelation:this.invokerRelation});return{...e,...t,popperConfig:{...e.popperConfig||{},...t.popperConfig||{},modifiers:[...e.popperConfig?.modifiers||[],...t.popperConfig?.modifiers||[]]}}}},Ft=new WeakMap,It=new WeakMap,Lt=new WeakSet,Rt=class extends Pt{constructor(){super(),d(this,Lt),this.placement=`top`,this.trigger=`hover focus`,f(this,Ft,null),f(this,It,()=>{this.opened=!this.opened}),re(this)}static get styles(){return[...super.styles,a`
        :host {
          display: contents;
        }
      ...
      `]}connectedCallback(){u(Lt,this,zt).call(this),super.connectedCallback()}get _overlayInvokerNode(){if(this.for){let e=this.getRootNode();return typeof e.getElementById==`function`?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}_defineOverlayConfig(){let e={...super._defineOverlayConfig()};if(Bt.call(u(Lt,this))||Vt.call(u(Lt,this)))delete e.visibilityTriggerFunction;else{let{visibilityTriggerFunction:t}=Ke({invokerRelation:this.invokerRelation,delayIn:200,delayOut:0});e.visibilityTriggerFunction=t}return{...e,popperConfig:{...e.popperConfig,strategy:`fixed`,placement:this.placement,modifiers:[...e.popperConfig?.modifiers??[],...oe()]}}}_setupOpenCloseListeners(){super._setupOpenCloseListeners(),Bt.call(u(Lt,this))&&this._overlayInvokerNode?.addEventListener(`click`,m(It,this))}_teardownOpenCloseListeners(){super._teardownOpenCloseListeners(),this._overlayInvokerNode?.removeEventListener(`click`,m(It,this))}updated(e){super.updated(e),e.has(`for`)&&e.get(`for`)!==void 0&&this._overlayCtrl&&this._overlayCtrl.updateConfig({invokerNode:this._overlayInvokerNode})}async show(){this.opened=!0,await this.updateComplete}async hide(){this.opened=!1,await this.updateComplete}};function zt(){if(m(Ft,this)?.isConnected)return;let e=document.createElement(`div`);e.slot=`content`,e.append(...Array.from(this.childNodes).filter(e=>!(e instanceof Element)||e.slot===``)),this.append(e),h(Ft,this,e)}function Bt(){return this.trigger.split(` `).includes(`click`)}function Vt(){return this.trigger.split(` `).includes(`manual`)}p([g({reflect:!0})],Rt.prototype,`for`,void 0),p([g({reflect:!0})],Rt.prototype,`placement`,void 0),p([g({reflect:!0})],Rt.prototype,`trigger`,void 0),customElements.get(`craft-tooltip`)||customElements.define(`craft-tooltip`,Rt);var Ht=e=>e.key===` `||e.key===`Enter`,Ut=e=>e.key===` `,Wt=class extends Oe(l){static get properties(){return{active:{type:Boolean,reflect:!0},type:{type:String,reflect:!0}}}render(){return r` <div class="button-content"><slot></slot></div> `}static get styles(){return[a`
        :host {
          position: relative;
          display: inline-flex;
          box-sizing: border-box;
  ...
  `,e}var Jt=class extends Gt{get _nativeButtonNode(){return Kt.get(this._form)?.helper||null}constructor(){super(),this.type=`submit`,this.__implicitSubmitHelperButton=null}_setupSubmitAndResetHelperOnConnected(){if(super._setupSubmitAndResetHelperOnConnected(),!this._form||this.type!==`submit`)return;let e=this._form;if(!Kt.get(this._form)){let t=qt(),n=document.createElement(`div`);n.appendChild(t),Kt.set(this._form,{lionButtons:new Set,helper:t,observer:new MutationObserver(()=>{e.appendChild(n)})}),e.appendChild(n),Kt.get(e)?.observer.observe(n,{childList:!0})}Kt.get(e)?.lionButtons.add(this)}_teardownSubmitAndResetHelperOnDisconnected(){if(super._teardownSubmitAndResetHelperOnDisconnected(),this._form){let e=Kt.get(this._form);e&&(e.lionButtons.delete(this),e.lionButtons.size||(this._form.contains(e.helper)&&e.helper.remove(),Kt.get(this._form)?.observer.disconnect(),Kt.delete(this._form)))}}},Yt=a`
  :host {
...
`,Zt=new WeakMap,Qt=class extends l{constructor(...e){super(...e),this.label=O(`More Info`),this.icon=`circle-info`,this.disabled=!1,this.status=``,f(this,Zt,new AbortController)}connectedCallback(){super.connectedCallback(),m(Zt,this).signal.aborted&&h(Zt,this,new AbortController),this.id||=`info-icon-${Math.random().toString(36).slice(2,8)}`;let{signal:e}=m(Zt,this);this.addEventListener(`craft-show`,()=>{$t._&&$t._!==this&&$t._.renderRoot.querySelector(`craft-tooltip`)?.hide(),$t._=this},{signal:e}),this.addEventListener(`craft-after-show`,()=>{this.status=``,setTimeout(()=>{this.status=`Some new status`},200)},{signal:e}),this.addEventListener(`craft-after-hide`,()=>{$t._===this&&($t._=null),this.status=``},{signal:e})}disconnectedCallback(){$t._===this&&($t._=null),m(Zt,this).abort(),super.disconnectedCallback()}render(){return r`
  ...
  `;var $t={_:null};p([g()],Qt.prototype,`label`,void 0),p([g()],Qt.prototype,`icon`,void 0),p([g({type:Boolean,reflect:!0})],Qt.prototype,`disabled`,void 0),p([g()],Qt.prototype,`id`,void 0),p([_()],Qt.prototype,`status`,void 0),p([y(`craft-tooltip`)],Qt.prototype,`tooltip`,void 0),customElements.get(`craft-info-icon`)||customElements.define(`craft-info-icon`,Qt);var en=class extends l{constructor(...e){super(...e),this.debug=!1}render(){return r`<slot></slot>`}};en.styles=a`
    :host(:not([debug])) {
      position: absolute;
      width: 1px;
      height: 1px;
  ...
  `,p([g({type:Boolean,reflect:!0})],en.prototype,`debug`,void 0),customElements.get(`craft-visually-hidden`)||customElements.define(`craft-visually-hidden`,en);var tn=class extends l{constructor(...e){super(...e),this.visible=!0}show(){this.visible=!0,this.dispatchEvent(new CustomEvent(`show`))}hide(){this.visible=!1,this.dispatchEvent(new CustomEvent(`hide`))}focus(){this.wrapper?.focus()}render(){return r`
      <div
        tabindex="-1"
    ...
    `}};tn.styles=[Nt,Xt],p([g({reflect:!0,type:Boolean})],tn.prototype,`visible`,void 0),p([y(`.wrapper`)],tn.prototype,`wrapper`,void 0),customElements.get(`craft-spinner`)||customElements.define(`craft-spinner`,tn);var nn=Object.prototype.toString;function rn(e){return typeof e==`function`||nn.call(e)===`[object Function]`}function an(e){var t=Number(e);return isNaN(t)?0:t===0||!isFinite(t)?t:(t>0?1:-1)*Math.floor(Math.abs(t))}var on=2**53-1;function sn(e){var t=an(e);return Math.min(Math.max(t,0),on)}function cn(e,t){var n=Array,r=Object(e);if(e==null)throw TypeError(`Array.from requires an array-like object - not null or undefined`);if(t!==void 0&&!rn(t))throw TypeError(`Array.from: when provided, the second argument must be a function`);for(var i=sn(r.length),a=rn(n)?Object(new n(i)):Array(i),o=0,s;o<i;)s=r[o],t?a[o]=t(s,o):a[o]=s,o+=1;return a.length=i,a}function ln(e){"@babel/helpers - typeof";return ln=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},ln(e)}function un(e,t){if(!(e instanceof t))throw TypeError(`Cannot call a class as a function`)}function dn(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,`value`in r&&(r.writable=!0),Object.defineProperty(e,mn(r.key),r)}}function fn(e,t,n){return t&&dn(e.prototype,t),n&&dn(e,n),Object.defineProperty(e,"prototype",{writable:!1}),e}function pn(e,t,n){return t=mn(t),t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function mn(e){var t=hn(e,`string`);return ln(t)==`symbol`?t:t+``}function hn(e,t){if(ln(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(ln(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}var gn=typeof Set>`u`?Set:function(){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[];un(this,e),pn(this,`items`,void 0),this.items=t}return fn(e,[{key:`add`,value:function(e){return this.has(e)===!1&&this.items.push(e),this}},{key:`clear`,value:function(){this.items=[]}},{key:`delete`,value:function(e){var t=this.items.length;return this.items=this.items.filter(function(t){return t!==e}),t!==this.items.length}},{key:`forEach`,value:function(e){var t=this;this.items.forEach(function(n){e(n,n,t)})}},{key:`has`,value:function(e){return this.items.indexOf(e)!==-1}},{key:`size`,get:function(){return this.items.length}}])}();function _n(e){return e.localName??e.tagName.toLowerCase()}var vn={article:`article`,aside:`complementary`,button:`button`,datalist:`listbox`,dd:`definition`,details:`group`,dialog:`dialog`,dt:`term`,fieldset:`group`,figure:`figure`,form:`form`,footer:`contentinfo`,h1:`heading`,h2:`heading`,h3:`heading`,h4:`heading`,h5:`heading`,h6:`heading`,header:`banner`,hr:`separator`,html:`document`,legend:`legend`,li:`listitem`,math:`math`,main:`main`,menu:`list`,nav:`navigation`,ol:`list`,optgroup:`group`,option:`option`,output:`status`,progress:`progressbar`,section:`region`,summary:`button`,table:`table`,tbody:`rowgroup`,textarea:`textbox`,tfoot:`rowgroup`,td:`cell`,th:`columnheader`,thead:`rowgroup`,tr:`row`,ul:`list`},yn={caption:new Set([`aria-label`,`aria-labelledby`]),code:new Set([`aria-label`,`aria-labelledby`]),deletion:new Set([`aria-label`,`aria-labelledby`]),emphasis:new Set([`aria-label`,`aria-labelledby`]),generic:new Set([`aria-label`,`aria-labelledby`,`aria-roledescription`]),insertion:new Set([`aria-label`,`aria-labelledby`]),none:new Set([`aria-label`,`aria-labelledby`]),paragraph:new Set([`aria-label`,`aria-labelledby`]),presentation:new Set([`aria-label`,`aria-labelledby`]),strong:new Set([`aria-label`,`aria-labelledby`]),subscript:new Set([`aria-label`,`aria-labelledby`]),superscript:new Set([`aria-label`,`aria-labelledby`])};function bn(e,t){return[`aria-atomic`,`aria-busy`,`aria-controls`,`aria-current`,`aria-description`,`aria-describedby`,`aria-details`,`aria-dropeffect`,`aria-flowto`,`aria-grabbed`,`aria-hidden`,`aria-keyshortcuts`,`aria-label`,`aria-labelledby`,`aria-live`,`aria-owns`,`aria-relevant`,`aria-roledescription`].some(function(n){var r;return e.hasAttribute(n)&&!((r=yn[t])!=null&&r.has(n))})}function xn(e,t){return bn(e,t)}function Sn(e){var t=wn(e);if(t===null||Tn.indexOf(t)!==-1){var n=Cn(e);if(Tn.indexOf(t||``)===-1||xn(e,n||``))return n}return t}function Cn(e){var t=vn[_n(e)];if(t!==void 0)return t;switch(_n(e)){case`a`:case`area`:case`link`:if(e.hasAttribute(`href`))return`link`;break;case`img`:return e.getAttribute(`alt`)===``&&!xn(e,`img`)?`presentation`:`img`;case`input`:var n=e.type;switch(n){case`button`:case`image`:case`reset`:case`submit`:return`button`;case`checkbox`:case`radio`:return n;case`range`:return`slider`;case`email`:case`tel`:case`text`:case`url`:return e.hasAttribute(`list`)?`combobox`:`textbox`;case`search`:return e.hasAttribute(`list`)?`combobox`:`searchbox`;case`number`:return`spinbutton`;default:return null}case`select`:return e.hasAttribute(`multiple`)||e.size>1?`listbox`:`combobox`}return null}function wn(e){var t=e.getAttribute(`role`);if(t!==null){var n=t.trim().split(` `)[0];if(n.length>0)return n}return null}var Tn=[`presentation`,`none`];function j(e){return e!==null&&e.nodeType===e.ELEMENT_NODE}function En(e){return j(e)&&_n(e)===`caption`}function Dn(e){return j(e)&&_n(e)===`input`}function On(e){return j(e)&&_n(e)===`optgroup`}function kn(e){return j(e)&&_n(e)===`select`}function An(e){return j(e)&&_n(e)===`table`}function jn(e){return j(e)&&_n(e)===`textarea`}function Mn(e){var t=(e.ownerDocument===null?e:e.ownerDocument).defaultView;if(t===null)throw TypeError(`no window available`);return t}function Nn(e){return j(e)&&_n(e)===`fieldset`}function Pn(e){return j(e)&&_n(e)===`legend`}function Fn(e){return j(e)&&_n(e)===`slot`}function In(e){return j(e)&&e.ownerSVGElement!==void 0}function Ln(e){return j(e)&&_n(e)===`svg`}function Rn(e){return In(e)&&_n(e)===`title`}function zn(e,t){if(j(e)&&e.hasAttribute(t)){var n=e.getAttribute(t).split(` `),r=e.getRootNode?e.getRootNode():e.ownerDocument;return n.map(function(e){return r.getElementById(e)}).filter(function(e){return e!==null})}return[]}function Bn(e,t){return j(e)?t.indexOf(Sn(e))!==-1:!1}function Vn(e){return e.trim().replace(/\s\s+/g,` `)}function Hn(e,t){if(!j(e))return!1;if(e.hasAttribute(`hidden`)||e.getAttribute(`aria-hidden`)===`true`)return!0;var n=t(e);return n.getPropertyValue(`display`)===`none`||n.getPropertyValue(`visibility`)===`hidden`}function Un(e){return Bn(e,[`button`,`combobox`,`listbox`,`textbox`])||Wn(e,`range`)}function Wn(e,t){if(!j(e))return!1;switch(t){case`range`:return Bn(e,[`meter`,`progressbar`,`scrollbar`,`slider`,`spinbutton`]);default:throw TypeError(`No knowledge about abstract role '${t}'. This is likely a bug :(`)}}function Gn(e,t){var n=cn(e.querySelectorAll(t));return zn(e,`aria-owns`).forEach(function(e){n.push.apply(n,cn(e.querySelectorAll(t)))}),n}function Kn(e){return kn(e)?e.selectedOptions||Gn(e,`[selected]`):Gn(e,`[aria-selected="true"]`)}function qn(e){return Bn(e,Tn)}function Jn(e){return En(e)}function Yn(e){return Bn(e,[`button`,`cell`,`checkbox`,`columnheader`,`gridcell`,`heading`,`label`,`legend`,`link`,`menuitem`,`menuitemcheckbox`,`menuitemradio`,`option`,`radio`,`row`,`rowheader`,`switch`,`tab`,`tooltip`,`treeitem`])}function Xn(e){return!1}function Zn(e){return Dn(e)||jn(e)?e.value:e.textContent||``}function Qn(e){var t=e.getPropertyValue(`content`);return/^["'].*["']$/.test(t)?t.slice(1,-1):``}function $n(e){var t=_n(e);return t===`button`||t===`input`&&e.getAttribute(`type`)!==`hidden`||t===`meter`||t===`output`||t===`progress`||t===`select`||t===`textarea`}function er(e){if($n(e))return e;var t=null;return e.childNodes.forEach(function(e){if(t===null&&j(e)){var n=er(e);n!==null&&(t=n)}}),t}function tr(e){if(e.control!==void 0)return e.control;var t=e.getAttribute(`for`);return t===null?er(e):e.ownerDocument.getElementById(t)}function nr(e){var t=e.labels;if(t===null)return t;if(t!==void 0)return cn(t);if(!$n(e))return null;var n=e.ownerDocument;return cn(n.querySelectorAll(`label`)).filter(function(t){return tr(t)===e})}function rr(e){var t=e.assignedNodes();return t.length===0?cn(e.childNodes):t}function ir(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=new gn,r=typeof Map>`u`?void 0:new Map,i=Mn(e),a=t.compute,o=a===void 0?`name`:a,s=t.computedStyleSupportsPseudoElements,c=s===void 0?t.getComputedStyle!==void 0:s,l=t.getComputedStyle,u=l===void 0?i.getComputedStyle.bind(i):l,d=t.hidden,f=d!==void 0&&d,p=function(e,t){if(t!==void 0)throw Error(`use uncachedGetComputedStyle directly for pseudo elements`);if(r===void 0)return u(e);var n=r.get(e);if(n)return n;var i=u(e,t);return r.set(e,i),i};function m(e,t){var n=``;if(j(e)&&c&&(n=`${Qn(u(e,`::before`))} ${n}`),(Fn(e)?rr(e):cn(e.childNodes).concat(zn(e,`aria-owns`))).forEach(function(e){var r=v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0}),i=(j(e)?p(e).getPropertyValue(`display`):`inline`)===`inline`?``:` `;n+=`${i}${r}${i}`}),j(e)&&c){var r=Qn(u(e,`::after`));n=`${n} ${r}`}return n.trim()}function h(e,t){var r=e.getAttributeNode(t);return r!==null&&!n.has(r)&&r.value.trim()!==``?(n.add(r),r.value):null}function g(e){return j(e)?h(e,`title`):null}function _(e){if(!j(e))return null;if(Nn(e)){n.add(e);for(var t=cn(e.childNodes),r=0;r<t.length;r+=1){var i=t[r];if(Pn(i))return v(i,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(An(e)){n.add(e);for(var a=cn(e.childNodes),o=0;o<a.length;o+=1){var s=a[o];if(En(s))return v(s,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(Ln(e)){n.add(e);for(var c=cn(e.childNodes),l=0;l<c.length;l+=1){var u=c[l];if(Rn(u))return u.textContent}return null}else if(_n(e)===`img`||_n(e)===`area`){var d=h(e,`alt`);if(d!==null)return d}else if(On(e)){var f=h(e,`label`);if(f!==null)return f}if(Dn(e)&&(e.type===`button`||e.type===`submit`||e.type===`reset`)){var p=h(e,`value`);if(p!==null)return p;if(e.type===`submit`)return`Submit`;if(e.type===`reset`)return`Reset`}var g=nr(e);if(g!==null&&g.length!==0)return n.add(e),cn(g).map(function(e){return v(e,{isEmbeddedInLabel:!0,isReferenced:!1,recursion:!0})}).filter(function(e){return e.length>0}).join(` `);if(Dn(e)&&e.type===`image`){var _=h(e,`alt`);if(_!==null)return _;var y=h(e,`title`);return y===null?`Submit Query`:y}if(Bn(e,[`button`])){var b=m(e,{isEmbeddedInLabel:!1,isReferenced:!1});if(b!==``)return b}return null}function v(e,t){if(n.has(e))return``;if(!f&&Hn(e,p)&&!t.isReferenced)return n.add(e),``;var r=j(e)?e.getAttributeNode(`aria-labelledby`):null,i=r!==null&&!n.has(r)?zn(e,`aria-labelledby`):[];if(o===`name`&&!t.isReferenced&&i.length>0)return n.add(r),i.map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!0,recursion:!1})}).join(` `);var a=t.recursion&&Un(e)&&o===`name`;if(!a){var s=(j(e)&&e.getAttribute(`aria-label`)||``).trim();if(s!==``&&o===`name`)return n.add(e),s;if(!qn(e)){var c=_(e);if(c!==null)return n.add(e),c}}if(Bn(e,[`menu`]))return n.add(e),``;if(a||t.isEmbeddedInLabel||t.isReferenced){if(Bn(e,[`combobox`,`listbox`])){n.add(e);var l=Kn(e);return l.length===0?Dn(e)?e.value:``:cn(l).map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0})}).join(` `)}if(Wn(e,`range`))return n.add(e),e.hasAttribute(`aria-valuetext`)?e.getAttribute(`aria-valuetext`):e.hasAttribute(`aria-valuenow`)?e.getAttribute(`aria-valuenow`):e.getAttribute(`value`)||``;if(Bn(e,[`textbox`]))return n.add(e),Zn(e)}if(Yn(e)||j(e)&&t.isReferenced||Jn(e)||Xn(e)){var u=m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});if(u!==``)return n.add(e),u}if(e.nodeType===e.TEXT_NODE)return n.add(e),e.textContent||``;if(t.recursion)return n.add(e),m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});var d=g(e);return d===null?(n.add(e),``):(n.add(e),d)}return Vn(v(e,{isEmbeddedInLabel:!1,isReferenced:o===`description`,recursion:!1}))}function ar(e){return Bn(e,[`caption`,`code`,`deletion`,`emphasis`,`generic`,`insertion`,`none`,`paragraph`,`presentation`,`strong`,`subscript`,`superscript`])}function or(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return ar(e)?``:ir(e,t)}var sr={Primary:`primary`,Danger:`danger`,DangerPlain:`danger-plain`,Solid:`solid`,Fill:`fill`,Outline:`outline`,Dashed:`dashed`,Plain:`plain`,Link:`link`,None:`none`},cr=new WeakMap,M=class extends Jt{static get styles(){return[...super.styles,Nt,Yt]}constructor(){super(),f(this,cr,async e=>{let t=be(this.action);if(!(!t||this.disabled)){e.preventDefault(),t.type===`http`&&(this.loading=!0);try{await xe(t,{trigger:this,sourceEvent:e})}finally{this.loading=!1}}}),this.variant=sr.Fill,this.inherit=!1,this.size=`medium`,this.active=!1,this.loading=!1,this.align=`center`,this.icon=null,this.action=null,this.href=null,this.target=null,this.rel=null,this.download=null,this.iconPosition=`prefix`,this._hasAccessibilityError=!1,this.linkHostStateApplied=!1,this.originalType=null,this.announcementTimer=null,this.type=`button`}connectedCallback(){this.href&&!this.disabled&&(this.originalType=this.type,this.type=`button`,this.setAttribute(`role`,`presentation`),this.linkHostStateApplied=!0),super.connectedCallback(),this.syncLinkHostState(),this.addEventListener(`click`,m(cr,this))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(cr,this)),this.announcementTimer&&=(clearTimeout(this.announcementTimer),null)}updated(e){super.updated(e),(e.has(`href`)||e.has(`disabled`))&&this.syncLinkHostState(),e.has(`loading`)&&this.loading&&this.announceLoading()}announceLoading(){this.liveRegion.textContent=O(`Loading`),this.announcementTimer&&clearTimeout(this.announcementTimer),this.announcementTimer=setTimeout(()=>{this.liveRegion.textContent=``},5e3)}syncLinkHostState(){this.isLink?(this.linkHostStateApplied||(this.originalType=this.type),this.setAttribute(`role`,`presentation`),this.tabIndex=-1,this.type=`button`,this.linkHostStateApplied=!0):this.linkHostStateApplied&&=(this.setAttribute(`role`,`button`),this.type=this.originalType??`button`,this.disabled||(this.tabIndex=0),!1)}async firstUpdated(e){super.firstUpdated(e),await this.updateComplete;let t=this.querySelectorAll(`craft-icon, craft-spinner`);if(await Promise.all(Array.from(t).map(e=>e.updateComplete)),!this.accessibleName){let e=this.isLink?this.shadowRoot?.querySelector(`a.link`)??this:this;this.accessibleName=or(e)}this._hasAccessibilityError=!this.accessibleName||this.accessibleName.trim()===``}get isLink(){return!!this.href&&!this.disabled}get computedRel(){if(this.target===`_blank`){let e=new Set((this.rel??``).split(/\s+/).filter(Boolean));return e.add(`noopener`),Array.from(e).join(` `)}return this.rel}render(){let e=r`
      <div
    ...
    `;return this.isLink?r`
        <a
          ...
          >${e}</a
        >
      `:e}};p([g({attribute:`accessible-name`})],M.prototype,`accessibleName`,void 0),p([g({reflect:!0})],M.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],M.prototype,`inherit`,void 0),p([g({reflect:!0})],M.prototype,`size`,void 0),p([g({reflect:!0})],M.prototype,`value`,void 0),p([g({reflect:!0,type:Boolean})],M.prototype,`active`,void 0),p([g({reflect:!0,type:Boolean})],M.prototype,`loading`,void 0),p([g()],M.prototype,`align`,void 0),p([g()],M.prototype,`icon`,void 0),p([g({type:Object})],M.prototype,`action`,void 0),p([g({reflect:!0})],M.prototype,`href`,void 0),p([g()],M.prototype,`target`,void 0),p([g()],M.prototype,`rel`,void 0),p([g()],M.prototype,`download`,void 0),p([g({attribute:`icon-position`})],M.prototype,`iconPosition`,void 0),p([y(`[data-live-region]`)],M.prototype,`liveRegion`,void 0),p([_()],M.prototype,`_hasAccessibilityError`,void 0),customElements.get(`craft-button`)||customElements.define(`craft-button`,M);var lr=[`sm`,`md`,`lg`,`xl`];function ur(e){return!isNaN(parseFloat(String(e)))&&isFinite(Number(e))}function dr(e){if(e!=null&&e!==``)return e===0||e===`0`||e===`none`?`0`:ur(e)?`calc(${e}rem / 16)`:lr.includes(e)?`var(--c-spacing-${e})`:String(e)}var fr=(e,{customProperty:t,defaultValue:n})=>{let r=Array.isArray(t)?t:[t];class i extends e{constructor(...e){super(...e),this.padding=n}get resolvedPadding(){return dr(this.padding)}get paddingStyles(){let e=this.resolvedPadding;return e===void 0?{}:Object.fromEntries(r.map(t=>[t,e]))}}return p([g()],i.prototype,`padding`,void 0),i},pr=a`
  :host {
    display: contents;
  }
...
`,mr=class extends fr(l,{customProperty:[`--_callout-padding-block`,`--_callout-padding-inline`]}){constructor(...e){super(...e),this.variant=Ce.Neutral,this.appearance=te.OutlineFill,this.title=``,this.icon=null,this.hideIcon=!1,this.rounded=`all`,this.inline=!1,this.size=`auto`,this.resolvedIcon=null}willUpdate(){this.resolvedIcon=this.icon??this.getDefaultIcon()}getDefaultIcon(){switch(this.variant){case Ce.Info:return`lightbulb`;case Ce.Success:return`circle-check`;case Ce.Warning:return`circle-exclamation`;case Ce.Danger:return`triangle-exclamation`;default:return null}}render(){let e=this.title||!!this.querySelector(`[slot="title"]`),t=!this.hideIcon&&(!!this.resolvedIcon||!!this.querySelector(`[slot="icon"]`));return r`
      <div
        data-variant="${this.variant}"
        style="${se(this.paddingStyles)}"
        class="${k({callout:!0,"callout--hide-icon":!t,"callout--title":e,"callout--small":this.size===`small`})}"
      >
    ...
    `}};mr.styles=[fe,pr],p([g({reflect:!0})],mr.prototype,`variant`,void 0),p([g({reflect:!0})],mr.prototype,`appearance`,void 0),p([g()],mr.prototype,`title`,void 0),p([g()],mr.prototype,`icon`,void 0),p([g({type:Boolean,attribute:`hide-icon`})],mr.prototype,`hideIcon`,void 0),p([g({reflect:!0})],mr.prototype,`rounded`,void 0),p([g({reflect:!0,type:Boolean})],mr.prototype,`inline`,void 0),p([g()],mr.prototype,`size`,void 0),p([_()],mr.prototype,`resolvedIcon`,void 0),customElements.get(`craft-callout`)||customElements.define(`craft-callout`,mr);var hr=a`
  :host {
    display: block;
  }
...
`,gr=class extends l{constructor(...e){super(...e),this.label=``,this.active=!1,this.showThumb=!0,this.thumbAlignment=`start`,this._hasThumbnail=!1,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasSlottedHeader=!!this.querySelector(`:scope > [slot="header"]`)||!!this.querySelector(`:scope > [slot="label"]`)||!!this.querySelector(`:scope > [slot="actions"]`),this._hasSlottedFooter=!!this.querySelector(`:scope > [slot="footer"]`),this._hasThumbnail=!!this.querySelector(`:scope > [slot="thumbnail"]`)}_handleThumbnailSlotChange(e){let t=e.target;this._hasThumbnail=t.assignedElements({flatten:!0}).length>0}render(){let e=!!this.label||this._hasSlottedHeader,t=this._hasSlottedFooter,n=this.showThumb&&this._hasThumbnail;return r`
    ...
    `}};gr.styles=[hr],p([g()],gr.prototype,`label`,void 0),p([g({type:Boolean,reflect:!0})],gr.prototype,`active`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],gr.prototype,`showThumb`,void 0),p([g({attribute:`thumb-alignment`})],gr.prototype,`thumbAlignment`,void 0),p([_()],gr.prototype,`_hasThumbnail`,void 0),p([_()],gr.prototype,`_hasSlottedHeader`,void 0),p([_()],gr.prototype,`_hasSlottedFooter`,void 0),customElements.get(`craft-card`)||customElements.define(`craft-card`,gr);var _r=a`
...
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=ui()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return ui()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(i(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),fi=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function pi(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return fi.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var mi=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},hi=D(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),gi=D(e=>class extends hi(De(He(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=Ue(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...pi(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return r`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof mi&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&(typeof t!=`boolean`||t!==!1)}static get styles(){return[a`
          /**********************
            {block} .form-field
           ********************/
        ...
        `]}_getAriaDescriptionElements(){return[this._helpTextNode,this._feedbackNode]}addToAriaLabelledBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaLabelledNodes.includes(e)||(this._ariaLabelledNodes=[...this._ariaLabelledNodes,e],this.__reorderAriaLabelledNodes=!!n)}removeFromAriaLabelledBy(e){this._ariaLabelledNodes.includes(e)&&(this._ariaLabelledNodes.splice(this._ariaLabelledNodes.indexOf(e),1),this._ariaLabelledNodes=[...this._ariaLabelledNodes],this.__reorderAriaLabelledNodes=!1)}addToAriaDescribedBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaDescribedNodes.includes(e)||(this._ariaDescribedNodes=[...this._ariaDescribedNodes,e],this.__reorderAriaDescribedNodes=!!n)}removeFromAriaDescribedBy(e){this._ariaDescribedNodes.includes(e)&&(this._ariaDescribedNodes.splice(this._ariaDescribedNodes.indexOf(e),1),this._ariaDescribedNodes=[...this._ariaDescribedNodes],this.__reorderAriaLabelledNodes=!1)}__getDirectSlotChild(e){return Array.from(this.children).find(t=>t.slot===e)}_dispatchInitialModelValueChangedEvent(){this._repropagationRole!==`child`&&(this.__repropagateChildrenInitialized=!0,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],initialize:!0,isTriggeredByUser:!1}})))}_onBeforeRepropagateChildrenValues(e){}__repropagateChildrenValues(e){this._onBeforeRepropagateChildrenValues(e);let t=e.detail&&e.detail.element||e.target,n=this._isRepropagationEndpoint||this._repropagationRole===`choice-group`;if(t===this)return;e.stopImmediatePropagation();let r=this._repropagationRole!==`child`&&!this.__repropagateChildrenInitialized,i=e.detail&&e.detail.initialize;if(r||i||!this._repropagationCondition(t))return;let a=[];n||(a=e.detail&&e.detail.formPath||[t]);let o=[...a,this];this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:o,isTriggeredByUser:!!e.detail?.isTriggeredByUser}}))}_repropagationCondition(e){return!!e}_onLabelClick(){}}),_i=class{constructor(){this.__running=!1,this.__queue=[]}add(e){this.__queue.push(e),this.__running||(this.complete=new Promise(e=>{this.__callComplete=e}),this.__run())}async __run(){this.__running=!0,await this.__queue[0](),this.__queue.shift(),this.__queue.length>0?this.__run():(this.__running=!1,this.__callComplete&&this.__callComplete())}};function vi(e){return e.charAt(0).toUpperCase()+e.slice(1)}var yi=D(e=>class extends e{constructor(){super(),this.__SyncUpdatableNamespace={}}firstUpdated(e){super.firstUpdated(e),this.__syncUpdatableInitialize()}connectedCallback(){super.connectedCallback(),this.__SyncUpdatableNamespace.connected=!0}disconnectedCallback(){super.disconnectedCallback(),this.__SyncUpdatableNamespace.connected=!1}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];static __syncUpdatableHasChanged(e,t,n){let r=this.elementProperties;return r.get(e)&&r.get(e).hasChanged?r.get(e).hasChanged(t,n):t!==n}__syncUpdatableInitialize(){let e=this.__SyncUpdatableNamespace,t=this.constructor;e.initialized=!0,e.queue&&Array.from(e.queue).forEach(e=>{t.__syncUpdatableHasChanged(e,this[e],void 0)&&this.updateSync(e,void 0)})}requestUpdate(e,t,n){if(super.requestUpdate(e,t,n),e===void 0)return;this.__SyncUpdatableNamespace=this.__SyncUpdatableNamespace||{};let r=this.__SyncUpdatableNamespace,i=this.constructor;r.initialized?i.__syncUpdatableHasChanged(e,this[e],t)&&this.updateSync(e,t):(r.queue=r.queue||new Set,r.queue.add(e))}updateSync(e,t){}}),bi=e=>{switch(e){case`bg-BG`:return E(()=>import(`./bg-BG-BSOJu8wp.js`),__vite__mapDeps([0,1]),import.meta.url);case`bg`:return E(()=>import(`./bg-tT2-9j0y.js`),__vite__mapDeps([2,1]),import.meta.url);case`cs-CZ`:return E(()=>import(`./cs-CZ-BXYisR25.js`),__vite__mapDeps([3,4]),import.meta.url);case`cs`:return E(()=>import(`./cs-BWWtw9FR.js`),__vite__mapDeps([5,4]),import.meta.url);case`de-DE`:return E(()=>import(`./de-DE-CqA9yOdY.js`),__vite__mapDeps([6,7]),import.meta.url);case`de`:return E(()=>import(`./de-D2KzmuNN.js`),__vite__mapDeps([8,7]),import.meta.url);case`en-AU`:return E(()=>import(`./en-AU-ClGzkm9N.js`),__vite__mapDeps([9,10]),import.meta.url);case`en-GB`:return E(()=>import(`./en-GB-ClGzkm9N.js`),__vite__mapDeps([11,10]),import.meta.url);case`en-US`:return E(()=>import(`./en-US-ClGzkm9N.js`),__vite__mapDeps([12,10]),import.meta.url);case`en-PH`:case`en`:return E(()=>import(`./en-Bn2liEJW.js`),__vite__mapDeps([13,10]),import.meta.url);case`es-ES`:return E(()=>import(`./es-ES-lc8truAL.js`),__vite__mapDeps([14,15]),import.meta.url);case`es`:return E(()=>import(`./es-BHRFfW-v.js`),__vite__mapDeps([16,15]),import.meta.url);case`fr-FR`:return E(()=>import(`./fr-FR-BFPCNFnr.js`),__vite__mapDeps([17,18]),import.meta.url);case`fr-BE`:return E(()=>import(`./fr-BE-BFPCNFnr.js`),__vite__mapDeps([19,18]),import.meta.url);case`fr`:return E(()=>import(`./fr-BatdFrY1.js`),__vite__mapDeps([20,18]),import.meta.url);case`hu-HU`:return E(()=>import(`./hu-HU-CgHBHfiG.js`),__vite__mapDeps([21,22]),import.meta.url);case`hu`:return E(()=>import(`./hu-BGJUkRn0.js`),__vite__mapDeps([23,22]),import.meta.url);case`it-IT`:return E(()=>import(`./it-IT-DXWt8Y3M.js`),__vite__mapDeps([24,25]),import.meta.url);case`it`:return E(()=>import(`./it-BbZB0zCO.js`),__vite__mapDeps([26,25]),import.meta.url);case`nl-BE`:return E(()=>import(`./nl-BE-CN9u7Cp2.js`),__vite__mapDeps([27,28]),import.meta.url);case`nl-NL`:return E(()=>import(`./nl-NL-CN9u7Cp2.js`),__vite__mapDeps([29,28]),import.meta.url);case`nl`:return E(()=>import(`./nl-CubSULoy.js`),__vite__mapDeps([30,28]),import.meta.url);case`pl-PL`:return E(()=>import(`./pl-PL-D0K_dWml.js`),__vite__mapDeps([31,32]),import.meta.url);case`pl`:return E(()=>import(`./pl-BhJlmndU.js`),__vite__mapDeps([33,32]),import.meta.url);case`ro-RO`:return E(()=>import(`./ro-RO-BXVNXH1J.js`),__vite__mapDeps([34,35]),import.meta.url);case`ro`:return E(()=>import(`./ro-75jeTe0N.js`),__vite__mapDeps([36,35]),import.meta.url);case`ru-RU`:return E(()=>import(`./ru-RU-BpGy32BK.js`),__vite__mapDeps([37,38]),import.meta.url);case`ru`:return E(()=>import(`./ru-DU7uFj2i.js`),__vite__mapDeps([39,38]),import.meta.url);case`sk-SK`:return E(()=>import(`./sk-SK-wewEOZGv.js`),__vite__mapDeps([40,41]),import.meta.url);case`sk`:return E(()=>import(`./sk-cN9_UHno.js`),__vite__mapDeps([42,41]),import.meta.url);case`tr-TR`:return E(()=>import(`./tr-TR-D1nJ_iYG.js`),__vite__mapDeps([43,44]),import.meta.url);case`tr`:return E(()=>import(`./tr-DuiqIpvR.js`),__vite__mapDeps([45,44]),import.meta.url);case`uk-UA`:return E(()=>import(`./uk-UA-DHqiIGvL.js`),__vite__mapDeps([46,47]),import.meta.url);case`uk`:return E(()=>import(`./uk-Cm-Wcqws.js`),__vite__mapDeps([48,47]),import.meta.url);case`zh-CN`:case`zh`:return E(()=>import(`./zh-DMe6SF13.js`),[],import.meta.url);default:return E(()=>import(`./en-Bn2liEJW.js`),__vite__mapDeps([13,10]),import.meta.url)}},xi=e=>`${e[0].toUpperCase()}${e.slice(1)}`,Si=class extends ai(l){static get properties(){return{feedbackData:{attribute:!1}}}static localizeNamespaces=[{"lion-form-core":bi},...super.localizeNamespaces];static get styles(){return[a`
    ...
    `}_onRequestToAddFormElement(e){e.target.hasAttribute(`role`)||e.target?.setAttribute(`role`,`listitem`),this.__addToSubCheckboxes(e.detail.element),this._setOwnCheckedState()}_onRequestToRemoveFormElement(e){e.target.getAttribute(`role`)===`listitem`&&e.target?.removeAttribute(`role`),this.__removeFromSubCheckboxes(e.detail.element)}__addToSubCheckboxes(e){e!==this&&this.contains(e)&&this.__subCheckboxes.push(e)}__removeFromSubCheckboxes(e){let t=this.__subCheckboxes.indexOf(e);t!==-1&&this.__subCheckboxes.splice(t,1)}constructor(){super(),this.indeterminate=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this.__onModelValueChanged=this.__onModelValueChanged.bind(this),this.__subCheckboxes=[],this._indeterminateSubStates=[],this.mixedState=!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,this.__onModelValueChanged),this.addEventListener(`form-element-register`,this._onRequestToAddFormElement)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`model-value-changed`,this.__onModelValueChanged),this.removeEventListener(`form-element-register`,this._onRequestToAddFormElement)}firstUpdated(e){super.firstUpdated(e),this._setOldState(),this.indeterminate&&this._storeIndeterminateState()}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&(this._inputNode.indeterminate=this.indeterminate)}},Ui=class extends zi{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="checkbox"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...zi.styles,a`
      ...
      `]}};function qi(){let e=this.allMode===`single-value`&&this.checked;for(let t of this._subCheckboxes??[]){let n=t.querySelector(`:scope > input[slot="input"]`);n&&(e?n.name&&(n.dataset.governedName=n.name,n.removeAttribute(`name`)):n.dataset.governedName&&(n.name=n.dataset.governedName,delete n.dataset.governedName))}}p([g({reflect:!0,attribute:`all-mode`})],Ki.prototype,`allMode`,void 0),customElements.get(`craft-checkbox-indeterminate`)||customElements.define(`craft-checkbox-indeterminate`,Ki);var Ji=class extends Wi(Vi){constructor(...e){super(...e),this.__inputPatched=!1,this.indeterminate=!1}connectedCallback(){super.connectedCallback(),this.__patchSlottedInputProps()}updated(e){super.updated(e),this.__patchSlottedInputProps();let t=this._inputNode;t&&(t.indeterminate=this.indeterminate)}__patchSlottedInputProps(){if(this.__inputPatched)return;let e=this.__slottedInputElement();if(!e)return;this.__inputPatched=!0;let t=this;for(let n of[`checked`,`disabled`]){let r=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,n);if(!r?.get||!r.set)continue;let{get:i,set:a}=r;Object.defineProperty(e,n,{configurable:!0,enumerable:r.enumerable,get(){return i.call(this)},set(e){a.call(this,e),t[n]!==e&&(t[n]=e)}})}}__slottedInputElement(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}static get styles(){return[...Vi.styles,Sr,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Ji.prototype,`indeterminate`,void 0),customElements.get(`craft-checkbox`)||customElements.define(`craft-checkbox`,Ji);var Yi=new Map;async function Xi(e,t,n=!1){let r=[],i=[],a=()=>{for(let e of r)e.remove();i.forEach(e=>e())};if(!e)return a;let o=document.createElement(`template`);o.innerHTML=e.trim();try{for(let e of o.content.childNodes){let a=Qi(e);if(a){let e=Yi.get(a.key);if(e){e.references++,i.push(()=>na(a.key,e)),e.loaded&&await ta(e.loaded,n);continue}if($i(a))continue}let o=Zi(e),s=a&&o instanceof HTMLScriptElement?ea(o,a.value):null;if(t.appendChild(o),a&&(o instanceof HTMLLinkElement||o instanceof HTMLScriptElement)){let e={node:o,loaded:s,references:1};Yi.set(a.key,e),i.push(()=>na(a.key,e))}else r.push(o);s&&await ta(s,n)}return a}catch(e){throw a(),e}}function Zi(e){if(!(e instanceof HTMLScriptElement))return e.cloneNode(!0);let t=document.createElement(`script`);for(let n of e.attributes)t.setAttribute(n.name,n.value);return t.textContent=e.textContent,t.async=!1,t}function Qi(e){return e instanceof HTMLLinkElement&&e.href?{key:`link:${e.href}`,selector:`link[href]`,value:e.href}:e instanceof HTMLScriptElement&&e.src?{key:`script:${e.src}`,selector:`script[src]`,value:e.src}:null}function $i(e){return Array.from(document.querySelectorAll(e.selector)).some(t=>(t instanceof HTMLLinkElement?t.href:t.src)===e.value)}function ea(e,t){return new Promise((n,r)=>{e.addEventListener(`load`,()=>n(),{once:!0}),e.addEventListener(`error`,()=>r(Error(`Failed to load asset [${t}].`)),{once:!0})})}async function ta(e,t){try{await e}catch(e){if(t)throw e}}function na(e,t){t.references--,!(t.references>0)&&(t.node.remove(),Yi.delete(e))}async function ra(e){return Xi(e,document.head)}async function ia(e){return Xi(e,document.body)}function aa(e){return typeof e.checkVisibility==`function`?e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}):e.offsetWidth>0||e.offsetHeight>0}function oa(e){return typeof e==`object`&&!!e&&`checked`in e&&typeof e.checked==`boolean`}function sa(e){return ca(e).toString()}function ca(e){let t=new URLSearchParams,n=e.querySelectorAll(`input[name], select[name], textarea[name]`);for(let e of n)if(!e.disabled&&!(e instanceof HTMLInputElement&&([`file`,`submit`,`button`,`reset`,`image`].includes(e.type)||(e.type===`checkbox`||e.type===`radio`)&&!e.checked))){if(e instanceof HTMLSelectElement&&e.multiple){for(let n of e.selectedOptions)t.append(e.name,n.value);continue}t.append(e.name,e.value)}for(let n of e.querySelectorAll(`*`)){if(!n.tagName.includes(`-`))continue;let e=n.name;if(typeof e!=`string`||e===``||n.disabled===!0||n.querySelector(`input[name], select[name], textarea[name]`))continue;if(oa(n.modelValue)){n.modelValue.checked&&t.append(e,String(n.modelValue.value??``));continue}let r=n.serializedValue??n.value;if(r!=null)if(Array.isArray(r))for(let n of r)t.append(e,String(n));else t.append(e,String(r))}return t}var la={Á:`A`,á:`a`,Ä:`A`,ä:`a`,À:`A`,à:`a`,Â:`A`,â:`a`,É:`E`,é:`e`,Ë:`E`,ë:`e`,È:`E`,è:`e`,Ê:`E`,ê:`e`,Í:`I`,í:`i`,Ï:`I`,ï:`i`,Ì:`I`,ì:`i`,Î:`I`,î:`i`,Ó:`O`,ó:`o`,Ö:`O`,ö:`o`,Ò:`O`,ò:`o`,Ô:`O`,ô:`o`,Ú:`U`,ú:`u`,Ü:`U`,ü:`u`,Ù:`U`,ù:`u`,Û:`U`,û:`u`,Ý:`Y`,ý:`y`,Ÿ:`Y`,А:`A`,Б:`B`,В:`V`,Г:`G`,Д:`D`,Ѓ:`Gj`,Е:`E`,Ж:`Z`,З:`Z`,Ѕ:`Dz`,И:`I`,Ј:`j`,К:`K`,Л:`L`,Љ:`Lj`,М:`M`,Н:`N`,Њ:`Nj`,О:`O`,П:`P`,Р:`R`,С:`S`,Т:`T`,Ќ:`Kj`,У:`U`,Ф:`F`,Х:`X`,Ц:`C`,Ч:`C`,Џ:`Dz`,Ш:`S`,а:`a`,б:`b`,в:`v`,г:`g`,д:`d`,ѓ:`gj`,е:`e`,ж:`z`,з:`z`,ѕ:`dz`,и:`i`,ј:`j`,к:`k`,л:`l`,љ:`lj`,м:`m`,н:`n`,њ:`nj`,о:`o`,п:`p`,р:`r`,с:`s`,т:`t`,ќ:`kj`,у:`u`,ф:`f`,х:`x`,ц:`c`,ч:`c`,џ:`dz`,ш:`s`,æ:`ae`,ǽ:`ae`,Ã:`A`,Å:`A`,Ǻ:`A`,Ă:`A`,Ǎ:`A`,Æ:`AE`,Ǽ:`AE`,ã:`a`,å:`a`,ǻ:`a`,ă:`a`,ǎ:`a`,ª:`a`,Ĉ:`C`,Ċ:`C`,Ç:`C`,ç:`c`,ĉ:`c`,ċ:`c`,Ð:`D`,Đ:`D`,ð:`d`,đ:`d`,Ĕ:`E`,Ė:`E`,ĕ:`e`,ė:`e`,ƒ:`f`,Ĝ:`G`,Ġ:`G`,ĝ:`g`,ġ:`g`,Ĥ:`H`,Ħ:`H`,ĥ:`h`,ħ:`h`,Ĩ:`I`,Ĭ:`I`,Ǐ:`I`,Į:`I`,Ĳ:`IJ`,ĩ:`i`,ĭ:`i`,ǐ:`i`,į:`i`,ĳ:`ij`,Ĵ:`J`,ĵ:`j`,Ĺ:`L`,Ľ:`L`,Ŀ:`L`,ĺ:`l`,ľ:`l`,ŀ:`l`,Ñ:`N`,ñ:`n`,ŉ:`n`,Õ:`O`,Ō:`O`,Ŏ:`O`,Ǒ:`O`,Ő:`O`,Ơ:`O`,Ø:`O`,Ǿ:`O`,Œ:`OE`,õ:`o`,ō:`o`,ŏ:`o`,ǒ:`o`,ő:`o`,ơ:`o`,ø:`o`,ǿ:`o`,º:`o`,œ:`oe`,Ŕ:`R`,Ŗ:`R`,ŕ:`r`,ŗ:`r`,Ŝ:`S`,Ș:`S`,ŝ:`s`,ș:`s`,ſ:`s`,Ţ:`T`,Ț:`T`,Ŧ:`T`,Þ:`TH`,ţ:`t`,ț:`t`,ŧ:`t`,þ:`th`,Ũ:`U`,Ŭ:`U`,Ű:`U`,Ų:`U`,Ư:`U`,Ǔ:`U`,Ǖ:`U`,Ǘ:`U`,Ǚ:`U`,Ǜ:`U`,ũ:`u`,ŭ:`u`,ű:`u`,ų:`u`,ư:`u`,ǔ:`u`,ǖ:`u`,ǘ:`u`,ǚ:`u`,ǜ:`u`,Ŵ:`W`,ŵ:`w`,Ŷ:`Y`,ÿ:`y`,ŷ:`y`,ΑΥ:`AU`,ΑΎ:`AU`,Αυ:`Au`,Αύ:`Au`,ΕΊ:`I`,ΕΙ:`I`,Ει:`Ei`,ΕΥ:`EF`,ΕΎ:`EU`,Εί:`I`,Ευ:`Ef`,Εύ:`Eu`,ΟΙ:`I`,ΟΊ:`I`,ΟΥ:`U`,ΟΎ:`OU`,Οι:`Oi`,Οί:`I`,Ου:`Oy`,Ού:`Ou`,ΥΙ:`I`,ΎΙ:`I`,Υι:`Yi`,Ύι:`I`,ΥΊ:`I`,Υί:`I`,αυ:`au`,αύ:`au`,εί:`i`,ει:`ei`,ευ:`ef`,εύ:`eu`,οι:`oi`,οί:`i`,ου:`oy`,ού:`ou`,υι:`yi`,ύι:`i`,υί:`i`,Α:`A`,Ά:`A`,Β:`B`,Δ:`D`,Ε:`E`,Έ:`E`,Φ:`F`,Γ:`G`,Η:`H`,Ή:`I`,Ι:`I`,Ί:`I`,Ϊ:`I`,Κ:`K`,Ξ:`Ks`,Λ:`L`,Μ:`M`,Ν:`N`,Π:`P`,Ο:`O`,Ό:`O`,Ψ:`Ps`,Ρ:`R`,Σ:`S`,Τ:`T`,Θ:`Th`,Ω:`O`,Ώ:`W`,Χ:`X`,ϒ:`Y`,Υ:`Y`,Ύ:`Y`,Ϋ:`Y`,Ζ:`Z`,α:`a`,ά:`a`,β:`v`,δ:`d`,ε:`e`,έ:`e`,φ:`f`,γ:`gh`,η:`i`,ή:`i`,ι:`i`,ί:`i`,ϊ:`i`,ΐ:`i`,κ:`k`,ξ:`ks`,λ:`l`,μ:`m`,ν:`n`,ο:`o`,ό:`o`,π:`p`,ψ:`ps`,ρ:`r`,σ:`s`,ς:`s`,τ:`t`,ϑ:`th`,θ:`th`,ϐ:`v`,ω:`o`,ώ:`w`,χ:`kh`,υ:`i`,ύ:`y`,ΰ:`y`,ϋ:`y`,ζ:`z`,अ:`a`,आ:`aa`,ए:`e`,ई:`ii`,ऍ:`ei`,ऎ:`ae`,ऐ:`ai`,इ:`i`,ओ:`o`,ऑ:`oi`,ऒ:`oii`,ऊ:`uu`,औ:`ou`,उ:`u`,ब:`B`,भ:`Bha`,च:`Ca`,छ:`Chha`,ड:`Da`,ढ:`Dha`,फ:`Fa`,फ़:`Fi`,ग:`Ga`,घ:`Gha`,ग़:`Ghi`,ह:`Ha`,ज:`Ja`,झ:`Jha`,क:`Ka`,ख:`Kha`,ख़:`Khi`,ल:`L`,ळ:`Li`,ऌ:`Li`,ऴ:`Lii`,ॡ:`Lii`,म:`Ma`,न:`Na`,ङ:`Na`,ञ:`Nia`,ण:`Nae`,ऩ:`Ni`,ॐ:`oms`,प:`Pa`,क़:`Qi`,र:`Ra`,ऋ:`Ri`,ॠ:`Ri`,ऱ:`Ri`,स:`Sa`,श:`Sha`,ष:`Shha`,ट:`Ta`,त:`Ta`,ठ:`Tha`,द:`Tha`,थ:`Tha`,ध:`Thha`,ड़:`ugDha`,ढ़:`ugDhha`,व:`Va`,य:`Ya`,य़:`Yi`,ज़:`Za`,Ա:`A`,Բ:`B`,Գ:`G`,Դ:`D`,Ե:`E`,Զ:`Z`,Է:`E`,Ը:`Y`,Թ:`Th`,Ժ:`Zh`,Ի:`I`,Լ:`L`,Խ:`Kh`,Ծ:`Ts`,Կ:`K`,Հ:`H`,Ձ:`Dz`,Ղ:`Gh`,Ճ:`Tch`,Մ:`M`,Յ:`Y`,Ն:`N`,Շ:`Sh`,Ո:`Vo`,Չ:`Ch`,Պ:`P`,Ջ:`J`,Ռ:`R`,Ս:`S`,Վ:`V`,Տ:`T`,Ր:`R`,Ց:`C`,Ւ:`u`,Փ:`Ph`,Ք:`Q`,և:`ev`,Օ:`O`,Ֆ:`F`,ա:`a`,բ:`b`,գ:`g`,դ:`d`,ե:`e`,զ:`z`,է:`e`,ը:`y`,թ:`th`,ժ:`zh`,ի:`i`,լ:`l`,խ:`kh`,ծ:`ts`,կ:`k`,հ:`h`,ձ:`dz`,ղ:`gh`,ճ:`tch`,մ:`m`,յ:`y`,ն:`n`,շ:`sh`,ո:`vo`,չ:`ch`,պ:`p`,ջ:`j`,ռ:`r`,ս:`s`,վ:`v`,տ:`t`,ր:`r`,ց:`c`,ւ:`u`,փ:`ph`,ք:`q`,օ:`o`,ֆ:`f`,Ž:`Z`,Ň:`N`,Ş:`S`,ž:`z`,ň:`n`,ş:`s`,ı:`i`,İ:`I`,ğ:`g`,Ğ:`G`,ьо:`yo`,Й:`i`,Щ:`Shh`,Ъ:`Ie`,Ь:``,Ю:`Iu`,Я:`Ia`,й:`i`,щ:`shh`,ъ:`ie`,ь:``,ю:`iu`,я:`ia`,Ē:`E`,ē:`e`,န်ုပ်:`nub`,"ောင်":`aung`,"ိုက်":`aik`,"ိုဒ်":`ok`,"ိုင်":`aing`,"ိုလ်":`ol`,"ေါင်":`aung`,သြော:`aw`,"ောက်":`auk`,"ိတ်":`eik`,"ုတ်":`ok`,"ုန်":`on`,"ေတ်":`it`,"ုဒ်":`ait`,"ာန်":`an`,"ိန်":`ein`,"ွတ်":`ut`,"ေါ်":`aw`,"ွန်":`un`,"ိပ်":`eik`,"ုပ်":`ok`,"ွပ်":`ut`,"ိမ်":`ein`,"ုမ်":`on`,"ော်":`aw`,"ွမ်":`un`,က်:`et`,"ေါ":`aw`,"ော":`aw`,"ျွ":`ywa`,"ြွ":`yw`,"ို":`o`,"ုံ":`on`,တ်:`at`,င်:`in`,ည်:`i`,ဒ်:`d`,န်:`an`,ပ်:`at`,မ်:`an`,စျ:`za`,ယ်:`e`,ဉ်:`in`,စ်:`it`,"ိံ":`ein`,"ဲ":`e`,"း":``,"ာ":`a`,"ါ":`a`,"ေ":`e`,"ံ":`an`,"ိ":`i`,"ီ":`i`,"ု":`u`,"ူ":`u`,"်":`at`,"္":``,"့":``,က:`k`,"၉":`9`,တ:`t`,ရ:`ya`,ယ:`y`,မ:`m`,ဘ:`ba`,ဗ:`b`,ဖ:`pa`,ပ:`p`,န:`n`,ဓ:`da`,ဒ:`d`,ထ:`ta`,ဏ:`na`,ဝ:`w`,ဎ:`da`,ဍ:`d`,ဌ:`ta`,ဋ:`t`,ည:`ny`,ဇ:`z`,ဆ:`sa`,စ:`s`,င:`ng`,ဃ:`ga`,ဂ:`g`,လ:`l`,သ:`th`,"၈":`8`,ဩ:`aw`,ခ:`kh`,"၆":`6`,"၅":`5`,"၄":`4`,"၃":`3`,"၂":`2`,"၁":`1`,"၀":`0`,"၌":`hnaik`,"၍":`ywae`,ဪ:`aw`,ဦ:`-u`,ဟ:`h`,ဉ:`u`,ဤ:`-i`,ဣ:`i`,"၏":`-e`,ဧ:`e`,"ှ":`h`,"ွ":`w`,"ျ":`ya`,"ြ":`y`,အ:`a`,ဠ:`la`,"၇":`7`,DŽ:`DZ`,Dž:`Dz`,dž:`dz`,Ǳ:`DZ`,ǲ:`Dz`,ǳ:`dz`,Ǉ:`LJ`,ǈ:`Lj`,ǉ:`lj`,Ǌ:`NJ`,ǋ:`Nj`,ǌ:`nj`,č:`c`,Č:`C`,ć:`c`,Ć:`C`,š:`s`,Š:`S`,ა:`a`,ბ:`b`,გ:`g`,დ:`d`,ე:`e`,ვ:`v`,ზ:`z`,თ:`t`,ი:`i`,კ:`k`,ლ:`l`,მ:`m`,ნ:`n`,ო:`o`,პ:`p`,ჟ:`zh`,რ:`r`,ს:`s`,ტ:`t`,უ:`u`,ფ:`f`,ქ:`q`,ღ:`gh`,ყ:`y`,შ:`sh`,ჩ:`ch`,ც:`ts`,ძ:`dz`,წ:`ts`,ჭ:`ch`,ხ:`kh`,ჯ:`j`,ჰ:`h`,Ё:`E`,ё:`e`,Ы:`Y`,ы:`y`,Э:`E`,э:`e`,І:`I`,і:`i`,Ѳ:`F`,ѳ:`f`,Ѣ:`E`,ѣ:`e`,Ѵ:`I`,ѵ:`i`,Є:`Je`,є:`je`,Ѥ:`Je`,ѥ:`je`,Ꙋ:`U`,ꙋ:`u`,Ѡ:`O`,ѡ:`o`,Ѿ:`Ot`,ѿ:`ot`,Ѫ:`U`,ѫ:`u`,Ѧ:`Ja`,ѧ:`ja`,Ѭ:`Ju`,ѭ:`ju`,Ѩ:`Ja`,ѩ:`Ja`,Ѯ:`Ks`,ѯ:`ks`,Ѱ:`Ps`,ѱ:`ps`,Ґ:`G`,ґ:`g`,Ї:`Yi`,ї:`yi`,Ә:`A`,Ғ:`G`,Қ:`Q`,Ң:`N`,Ө:`O`,Ұ:`U`,Ү:`U`,Һ:`H`,ә:`a`,ғ:`g`,қ:`q`,ң:`n`,ө:`o`,ұ:`u`,ү:`u`,һ:`h`,ď:`d`,Ď:`D`,ě:`e`,Ě:`E`,ř:`r`,Ř:`R`,ť:`t`,Ť:`T`,ů:`u`,Ů:`U`,ą:`a`,ę:`e`,ł:`l`,ń:`n`,ś:`s`,ź:`z`,ż:`z`,Ą:`A`,Ę:`E`,Ł:`L`,Ń:`N`,Ś:`S`,Ź:`Z`,Ż:`Z`,ā:`a`,ģ:`g`,ī:`i`,ķ:`k`,ļ:`l`,ņ:`n`,ū:`u`,Ā:`A`,Ģ:`G`,Ī:`I`,Ķ:`k`,Ļ:`L`,Ņ:`N`,Ū:`U`,Ả:`A`,Ạ:`A`,Ắ:`A`,Ằ:`A`,Ẳ:`A`,Ẵ:`A`,Ặ:`A`,Ấ:`A`,Ầ:`A`,Ẩ:`A`,Ẫ:`A`,Ậ:`A`,ả:`a`,ạ:`a`,ắ:`a`,ằ:`a`,ẳ:`a`,ẵ:`a`,ặ:`a`,ấ:`a`,ầ:`a`,ẩ:`a`,ẫ:`a`,ậ:`a`,Ẻ:`E`,Ẽ:`E`,Ẹ:`E`,Ế:`E`,Ề:`E`,Ể:`E`,Ễ:`E`,Ệ:`E`,ẻ:`e`,ẽ:`e`,ẹ:`e`,ế:`e`,ề:`e`,ể:`e`,ễ:`e`,ệ:`e`,Ỉ:`I`,Ị:`I`,ỉ:`i`,ị:`i`,Ỏ:`O`,Ọ:`O`,Ố:`O`,Ồ:`O`,Ổ:`O`,Ỗ:`O`,Ộ:`O`,Ớ:`O`,Ờ:`O`,Ở:`O`,Ỡ:`O`,Ợ:`O`,ỏ:`o`,ọ:`o`,ố:`o`,ồ:`o`,ổ:`o`,ỗ:`o`,ộ:`o`,ớ:`o`,ờ:`o`,ở:`o`,ỡ:`o`,ợ:`o`,Ủ:`U`,Ụ:`U`,Ứ:`U`,Ừ:`U`,Ử:`U`,Ữ:`U`,Ự:`U`,ủ:`u`,ụ:`u`,ứ:`u`,ừ:`u`,ử:`u`,ữ:`u`,ự:`u`,Ỳ:`Y`,Ỷ:`Y`,Ỹ:`Y`,Ỵ:`Y`,ỳ:`y`,ỷ:`y`,ỹ:`y`,ỵ:`y`,ا:`a`,ب:`b`,پ:`p`,ت:`t`,ث:`th`,ج:`g`,چ:`ch`,ح:`h`,خ:`kh`,د:`d`,ذ:`th`,ر:`r`,ز:`z`,س:`s`,ش:`sh`,ص:`s`,ض:`d`,ط:`t`,ظ:`th`,ع:`aa`,غ:`gh`,ف:`f`,ق:`k`,ک:`k`,گ:`g`,ل:`l`,ژ:`zh`,ك:`k`,م:`m`,ن:`n`,ه:`h`,و:`o`,ی:`y`,آ:`a`,"٠":`0`,"١":`1`,"٢":`2`,"٣":`3`,"٤":`4`,"٥":`5`,"٦":`6`,"٧":`7`,"٨":`8`,"٩":`9`,أ:`a`,ي:`y`,إ:`a`,ؤ:`o`,ئ:`y`,ء:`aa`,ђ:`dj`,ћ:`c`,Ђ:`Dj`,Ћ:`C`,ə:`e`,Ə:`E`,ß:`ss`,ẞ:`SS`,ভ্ল:`vl`,পশ:`psh`,ব্ধ:`bdh`,ব্জ:`bj`,ব্দ:`bd`,ব্ব:`bb`,ব্ল:`bl`,ভ:`v`,ব:`b`,চ্ঞ:`cNG`,চ্ছ:`cch`,চ্চ:`cc`,ছ:`ch`,চ:`c`,ধ্ন:`dhn`,ধ্ম:`dhm`,দ্ঘ:`dgh`,দ্ধ:`ddh`,দ্ভ:`dv`,দ্ম:`dm`,ড্ড:`DD`,ঢ:`Dh`,ধ:`dh`,দ্গ:`dg`,দ্দ:`dd`,ড:`D`,দ:`d`,"।":`.`,ঘ্ন:`Ghn`,গ্ধ:`Gdh`,গ্ণ:`GN`,গ্ন:`Gn`,গ্ম:`Gm`,গ্ল:`Gl`,জ্ঞ:`jNG`,ঘ:`Gh`,গ:`g`,হ্ণ:`hN`,হ্ন:`hn`,হ্ম:`hm`,হ্ল:`hl`,হ:`h`,জ্ঝ:`jjh`,ঝ:`jh`,জ্জ:`jj`,জ:`j`,ক্ষ্ণ:`kxN`,ক্ষ্ম:`kxm`,ক্ষ:`ksh`,কশ:`ksh`,ক্ক:`kk`,ক্ট:`kT`,ক্ত:`kt`,ক্ল:`kl`,ক্স:`ks`,খ:`kh`,ক:`k`,ল্ভ:`lv`,ল্ধ:`ldh`,লখ:`lkh`,লঘ:`lgh`,লফ:`lph`,ল্ক:`lk`,ল্গ:`lg`,ল্ট:`lT`,ল্ড:`lD`,ল্প:`lp`,ল্ম:`lm`,ল্ল:`ll`,ল্ব:`lb`,ল:`l`,ম্থ:`mth`,ম্ফ:`mf`,ম্ভ:`mv`,মপ্ল:`mpl`,ম্ন:`mn`,ম্প:`mp`,ম্ম:`mm`,ম্ল:`ml`,ম্ব:`mb`,ম:`m`,"০":`0`,"১":`1`,"২":`2`,"৩":`3`,"৪":`4`,"৫":`5`,"৬":`6`,"৭":`7`,"৮":`8`,"৯":`9`,ঙ্ক্ষ:`Ngkx`,ঞ্ছ:`nch`,ঙ্ঘ:`ngh`,ঙ্খ:`nkh`,ঞ্ঝ:`njh`,ঙ্গৌ:`ngOU`,ঙ্গৈ:`ngOI`,ঞ্চ:`nc`,ঙ্ক:`nk`,ঙ্ষ:`Ngx`,ঙ্গ:`ngo`,ঙ্ম:`Ngm`,ঞ্জ:`nj`,ন্ধ:`ndh`,ন্ঠ:`nTh`,ণ্ঠ:`NTh`,ন্থ:`nth`,ঙ্গা:`nga`,ঙ্গি:`ngi`,ঙ্গী:`ngI`,ঙ্গু:`ngu`,ঙ্গূ:`ngU`,ঙ্গে:`nge`,ঙ্গো:`ngO`,ণ্ঢ:`NDh`,নশ:`nsh`,ঙর:`Ngr`,ঞর:`NGr`,"ংর":`ngr`,ঙ:`Ng`,ঞ:`NG`,"ং":`ng`,ন্ন:`nn`,ণ্ণ:`NN`,ণ্ন:`Nn`,ন্ম:`nm`,ণ্ম:`Nm`,ন্দ:`nd`,ন্ট:`nT`,ণ্ট:`NT`,ন্ড:`nD`,ণ্ড:`ND`,ন্ত:`nt`,ন্স:`ns`,ন:`n`,ণ:`N`,"ৈ":`OI`,"ৌ":`OU`,"ো":`O`,ঐ:`OI`,ঔ:`OU`,অ:`o`,ও:`oo`,ফ্ল:`fl`,প্ট:`pT`,প্ত:`pt`,প্ন:`pn`,প্প:`pp`,প্ল:`pl`,প্স:`ps`,ফ:`f`,প:`p`,"ৃ":`rri`,ঋ:`rri`,রর‍্য:`rry`,"্র্য":`ry`,"্রর":`rr`,ড়্গ:`Rg`,ঢ়:`Rh`,ড়:`R`,র:`r`,"্র":`r`,শ্ছ:`Sch`,ষ্ঠ:`ShTh`,ষ্ফ:`Shf`,স্ক্ল:`skl`,স্খ:`skh`,স্থ:`sth`,স্ফ:`sf`,শ্চ:`Sc`,শ্ত:`St`,শ্ন:`Sn`,শ্ম:`Sm`,শ্ল:`Sl`,ষ্ক:`Shk`,ষ্ট:`ShT`,ষ্ণ:`ShN`,ষ্প:`Shp`,ষ্ম:`Shm`,স্প্ল:`spl`,স্ক:`sk`,স্ট:`sT`,স্ত:`st`,স্ন:`sn`,স্প:`sp`,স্ম:`sm`,স্ল:`sl`,শ:`S`,ষ:`Sh`,স:`s`,"ু":`u`,উ:`u`,অ্য:`oZ`,ত্থ:`tth`,ৎ:`tt`,ট্ট:`TT`,ট্ম:`Tm`,ঠ:`Th`,ত্ন:`tn`,ত্ম:`tm`,থ:`th`,ত্ত:`tt`,ট:`T`,ত:`t`,অ্যা:`AZ`,"া":`a`,আ:`a`,য়া:`ya`,য়:`y`,"ি":`i`,ই:`i`,"ী":`ee`,ঈ:`ee`,"ূ":`uu`,ঊ:`uu`,"ে":`e`,এ:`e`,য:`z`,"্য":`Z`,ইয়:`y`,ওয়:`w`,"্ব":`w`,এক্স:`x`,"ঃ":`:`,"ঁ":`nn`,"্‌":``,"˚":`0`,"¹":`1`,"²":`2`,"³":`3`,"⁴":`4`,"⁵":`5`,"⁶":`6`,"⁷":`7`,"⁸":`8`,"⁹":`9`,"₀":`0`,"₁":`1`,"₂":`2`,"₃":`3`,"₄":`4`,"₅":`5`,"₆":`6`,"₇":`7`,"₈":`8`,"₉":`9`,"௦":`0`,"௧":`1`,"௨":`2`,"௩":`3`,"௪":`4`,"௫":`5`,"௬":`6`,"௭":`7`,"௮":`8`,"௯":`9`,"௰":`10`,"௱":`100`,"௲":`1000`,Ꜳ:`AA`,ꜳ:`aa`,Ꜵ:`AO`,ꜵ:`ao`,Ꜷ:`AU`,ꜷ:`au`,Ꜹ:`AV`,ꜹ:`av`,Ꜻ:`av`,ꜻ:`av`,Ꜽ:`AY`,ꜽ:`ay`,ȸ:`db`,ʣ:`dz`,ʥ:`dz`,ʤ:`dezh`,"🙰":`et`,ﬀ:`ff`,ﬃ:`ffi`,ﬄ:`ffl`,ﬁ:`fi`,ﬂ:`fl`,ʩ:`feng`,ʪ:`ls`,ʫ:`lz`,ɮ:`lezh`,ȹ:`qp`,ʨ:`tc`,ʦ:`ts`,ʧ:`tesh`,Ꝏ:`OO`,ꝏ:`oo`,ﬆ:`st`,ﬅ:`st`,Ꜩ:`TZ`,ꜩ:`tz`,ᵫ:`ue`,Aι:`Ai`,αι:`ai`,ἀ:`a`,ἁ:`a`,ἂ:`a`,ἃ:`a`,ἄ:`a`,ἅ:`a`,ἆ:`a`,ἇ:`a`,Ἀ:`A`,Ἁ:`A`,Ἂ:`A`,Ἃ:`A`,Ἄ:`A`,Ἅ:`A`,Ἆ:`A`,Ἇ:`A`,ᾰ:`a`,ᾱ:`a`,ᾲ:`a`,ᾳ:`a`,ᾴ:`a`,ᾶ:`a`,ᾷ:`a`,Ᾰ:`A`,Ᾱ:`A`,Ὰ:`A`,Ά:`A`,ᾼ:`A`,A̧:`A`,a̧:`a`,Ⱥ:`A`,ⱥ:`a`,Ȧ:`A`,ȧ:`a`,Ɓ:`B`,C̈:`C`,c̈:`c`,C̨:`C`,c̨:`c`,Ȼ:`C`,ȼ:`c`,C̀:`C`,c̀:`c`,C̣:`C`,c̣:`c`,C̄:`C`,c̄:`c`,C̃:`C`,c̃:`c`,Ȩ:`E`,ȩ:`e`,Ɇ:`E`,ɇ:`e`,I̧:`I`,i̧:`i`,Ɨ:`I`,ɨ:`i`,i:`i`,J́́:`J`,j́:`j`,J̀̀:`J`,j̀:`j`,J̈:`J`,j̈:`j`,J̧:`J`,j̧:`j`,J̨:`J`,j̨:`j`,Ɉ:`J`,ɉ:`j`,J̌:`J`,ǰ:`j`,J̇:`J`,j:`j`,J̣:`J`,j̣:`j`,J̄:`J`,j̄:`j`,J̃:`J`,j̃:`j`,ĸ:`k`,L̀:`L`,l̀:`l`,L̂:`L`,l̂:`l`,L̈:`L`,l̈:`l`,L̨:`L`,l̨:`l`,Ƚ:`L`,ƚ:`l`,L̇:`L`,l̇:`l`,Ḷ:`L`,ḷ:`l`,L̄:`L`,l̄:`l`,L̃:`L`,l̃:`l`,Ŋ:`N`,ŋ:`n`,Ǹ:`N`,ǹ:`n`,N̂:`N`,n̂:`n`,N̈:`N`,n̈:`n`,N̨:`N`,n̨:`n`,Ꞥ:`N`,ꞥ:`n`,Ṅ:`N`,ṅ:`n`,Ṇ:`N`,ṇ:`n`,N̄:`N`,n̄:`n`,O̧:`O`,o̧:`o`,Ǫ:`O`,ǫ:`o`,Ɵ:`O`,ɵ:`o`,Ȯ:`O`,ȯ:`o`,S̀:`S`,s̀:`s`,Ŝ̀:`S`,S̈:`S`,s̈:`s`,S̨:`S`,s̨:`s`,Ꞩ:`S`,ꞩ:`s`,Ṡ:`S`,ṡ:`s`,Ṣ:`S`,ṣ:`s`,S̄:`S`,s̄:`s`,S̃:`S`,s̃:`s`,T́:`T`,t́:`t`,T̀:`T`,t̀:`t`,T̂:`T`,t̂:`t`,T̈:`T`,ẗ:`t`,T̨:`T`,t̨:`t`,Ⱦ:`T`,ⱦ:`t`,Ṫ:`T`,ṫ:`t`,Ṭ:`T`,ṭ:`t`,T̄:`T`,t̄:`t`,T̃:`T`,t̃:`t`,U̧:`U`,u̧:`u`,Ʉ:`U`,ʉ:`u`,U̇:`U`,u̇:`u`,Ʊ:`U`,ʊ:`u`,Ẁ:`W`,ẁ:`w`,Ẃ:`W`,ẃ:`w`,Ẅ:`W`,ẅ:`w`,Ꙗ:`Ja`,ꙗ:`ja`,Y̧:`Y`,y̧:`y`,Y̨:`Y`,y̨:`y`,Ɏ:`Y`,ɏ:`y`,Y̌:`Y`,y̌:`y`,Ẏ:`Y`,ẏ:`y`,Ȳ:`Y`,ȳ:`y`,Z̀:`Z`,z̀:`z`,Ẑ:`Z`,ẑ:`z`,Z̈:`Z`,z̈:`z`,Z̧:`Z`,z̧:`z`,Z̨:`Z`,z̨:`z`,Ƶ:`Z`,ƶ:`z`,Ẓ:`Z`,ẓ:`z`,Z̄:`Z`,z̄:`z`,Z̃:`Z`,z̃:`z`,"\xA0":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `,"\u2028":` `,"\u2029":` `,"​":` `," ":` `," ":` `,"　":` `,ﾠ:` `,"«":`<<`,"»":`>>`,"‘":`'`,"’":`'`,"‚":`'`,"‛":`'`,"“":`"`,"”":`"`,"„":`"`,"‟":`"`,"‹":`'`,"›":`'`,"–":`-`,"—":`-`,"…":`...`,"€":`EUR`,$:`$`,"₢":`Cr`,"₣":`Fr.`,"£":`PS`,"₤":`L.`,ℳ:`M`,"₥":`mil`,"₦":`N`,"₧":`Pts`,"₨":`Rs`,රු:`LKR`,ரூ:`LKR`,"௹":`Rs`,रू:`NPR`,"₹":`Rs`,"૱":`Rs`,"₩":`W`,"₪":`NS`,"₸":`KZT`,"₫":`D`,"֏":`AMD`,"₭":`K`,"₺":`TL`,"₼":`AZN`,"₮":`T`,"₯":`Dr`,"₲":`PYG`,"₾":`GEL`,"₳":`ARA`,"₴":`UAH`,"₽":`RUB`,"₵":`GHS`,"₡":`CL`,"¢":`c`,"¥":`YEN`,円:`JPY`,"৳":`BDT`,元:`CNY`,"﷼":`SAR`,"៛":`KR`,"₠":`ECU`,"¤":`$?`,"฿":`THB`,"؋":`AFN`};function ua(e,t=la){e=e.normalize(`NFC`);let n=``,r;for(let i=0;i<e.length;i++)r=e.charAt(i),n+=typeof t[r]==`string`?t[r]:r;return n}function da(e,t={}){let n={allowNonAlphaStart:!1,handleCasing:`camel`,...t};var r=e.replace(/<(.*?)>/g,``);r=r.replace(/['"‘’“”ʻ\[\]\(\)\{\}:]/g,``),r=r.toLowerCase(),r=ua(r),n.allowNonAlphaStart||(r=r.replace(/^[^a-z]+/,``));let i=r.split(/[^a-z0-9]+/).filter(Boolean);if(r=``,n.handleCasing===`snake`)return i.join(`_`);for(let e=0;e<i.length;e++)n.handleCasing!==`pascal`&&e===0?r+=i[e]:r+=i[e].charAt(0).toUpperCase()+i[e].substring(1);return r}function fa(e,t={}){let n={prefix:``,suffix:``,...t},r=da(e,{handleCasing:`snake`}).toUpperCase();return r?`${n.prefix}${r}${n.suffix}`:``}function pa(e){let t=e.replace(/<(.*?)>/g,``);return t=t.toLowerCase(),t=ua(t),t=t.replace(/^[^a-z]+/,``),t=t.replace(/[^a-z0-9]+$/,``),t.split(/[^a-z0-9]+/).filter(Boolean).join(`-`)}function ma(e){return e.charAt(0).toUpperCase()+e.slice(1)}function ha(){return Math.floor(Math.random()*1e6)}var ga=new WeakMap,_a=class e{constructor(){this.queue=[],this.workers=[],f(this,ga,null),h(ga,this,new AbortController);for(let e=0;e<3;e++)this.workers.push(new xa(this))}load(t=document,n=`[data-sizes]`){t.querySelectorAll(n).forEach(t=>{if(aa(t))this.addToQueue(t);else{let n=`thumb${ha()}`;e.invisibleThumbs[n]=[this,t];let r=()=>{e.invisibleThumbs[n]&&aa(t)&&(delete e.invisibleThumbs[n],this.addToQueue(t))};document.addEventListener(`scroll`,r,{signal:m(ga,this)?.signal}),window.addEventListener(`resize`,r,{signal:m(ga,this)?.signal})}})}addToQueue(e){this.queue.push(e),this.workers.forEach(e=>{e.active||e.loadNext()})}static retryAll(){for(let t in e.invisibleThumbs){let n=e.invisibleThumbs[t];if(!n)continue;let[r,i]=n;delete e.invisibleThumbs[t],r.load(i.parentElement??document)}}destroy(){this.workers.forEach(e=>e.deactivate()),m(ga,this)?.abort()}};_a.invisibleThumbs={};var va=new WeakMap,ya=new WeakMap,ba=new WeakMap,xa=class{constructor(e){this.active=!1,this.container=void 0,f(this,va,null),f(this,ya,null),f(this,ba,null),h(va,this,e)}activate(){this.active||(this.active=!0,this.clearInterval(),h(ya,this,setInterval(()=>{this.loadNextIfRemoved()},500)))}deactivate(){this.active&&(this.active=!1,this.clearInterval(),this.clearTimeout())}clearInterval(){m(ya,this)&&(clearInterval(m(ya,this)),h(ya,this,null))}clearTimeout(){m(ba,this)&&(clearTimeout(m(ba,this)),h(ba,this,null))}loadNext(){if(this.clearTimeout(),this.container=m(va,this)?.queue.shift(),this.container===void 0){this.deactivate();return}if(this.loadNextIfRemoved())return;if(this.container.querySelectorAll(`img`).length>0){this.loadNext();return}this.activate(),h(ba,this,setTimeout(()=>{this.loadNext()},3e4));let e=document.createElement(`img`);e.sizes=this.container.getAttribute(`data-sizes`)??``,e.srcset=this.container.getAttribute(`data-srcset`)??``,e.alt=this.container.getAttribute(`data-alt`)??``,e.setAttribute(`data-animated`,this.container.getAttribute(`data-animated`)??``),e.src=this.container.getAttribute(`data-src`)??``,e.onload=()=>this.loadNext(),e.onabort=()=>this.loadNext(),e.onerror=()=>this.loadNext(),this.container.appendChild(e)}loadNextIfRemoved(){return this.container&&!document.body.contains(this.container)?(this.loadNext(),!0):!1}},Sa=a`
  :host {
    display: contents;
  }
...
`,Ca=new WeakMap,wa=new WeakMap,Ta=new WeakMap,Ea=new WeakSet,Da=class extends l{constructor(...e){super(...e),d(this,Ea),this.size=``,this.variant=Ce.Neutral,this.appearance=te.OutlineFill,this.icon=null,this.showIndicators=!1,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,this.selected=!1,this.selectLabel=null,f(this,Ca,!1),f(this,wa,new _a),this.lightDom=0,f(this,Ta,new MutationObserver(()=>this.lightDom++))}connectedCallback(){super.connectedCallback(),m(Ta,this).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){m(Ta,this).disconnect(),super.disconnectedCallback()}renderSelect(){return r`<input
      type="checkbox"
    ...
    </div>`}firstUpdated(e){super.firstUpdated(e),m(wa,this).load(this)}render(){this.lightDom;let e=!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`)||!!this.querySelector(`[slot="thumbnail"]`)||!!this.querySelector(`[slot="indicator"]`)||!!this.querySelector(`[slot="status"]`)||this.icon,t=!!this.querySelector(`[slot="suffix"]`);return r`
      <div
        part="chip"
        class="${k({"cp-chip":!0,"cp-chip--small":this.size===`small`,"cp-chip--medium":this.size===`medium`,"cp-chip--large":this.size===`large`,"cp-chip--plain":this.appearance===te.Plain,"cp-chip--selectable":this.selectable,"cp-chip--show-thumb":this.showThumb,"cp-chip--show-indicators":this.showIndicators,"cp-chip--show-status":this.showStatus})}"
      >
    ...
    `}};function Oa(e){h(Ca,this,e.shiftKey),e.stopPropagation()}function ka(e){let{checked:t}=e.target;this.selected=t,this.dispatchEvent(new CustomEvent(`selected-change`,{detail:{selected:t,shiftKey:m(Ca,this)},bubbles:!0,composed:!0}))}Da.styles=[Sa],p([g()],Da.prototype,`size`,void 0),p([g({reflect:!0})],Da.prototype,`variant`,void 0),p([g({reflect:!0})],Da.prototype,`appearance`,void 0),p([g()],Da.prototype,`icon`,void 0),p([g({attribute:`show-indicators`,type:Boolean})],Da.prototype,`showIndicators`,void 0),p([g({attribute:`show-status`,type:Boolean})],Da.prototype,`showStatus`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],Da.prototype,`showThumb`,void 0),p([g({type:Boolean})],Da.prototype,`selectable`,void 0),p([g({type:Boolean,reflect:!0})],Da.prototype,`selected`,void 0),p([g({attribute:`select-label`})],Da.prototype,`selectLabel`,void 0),p([_()],Da.prototype,`lightDom`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,Da);var Aa=class extends Mi(l){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},ja=D(e=>class extends gi(di(Pi(He(ji(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],a`
          :host {
            display: block;
          }
...
`,Fa=new WeakMap,Ia=new WeakSet,La=class extends Na{constructor(...e){super(...e),d(this,Ia),this.hint=null,f(this,Fa,void 0)}static get styles(){return[...Na.styles,Pa]}connectedCallback(){super.connectedCallback(),za._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),za._.unobserve(this)}render(){return r`
    ...
    `}};function Ra(){return m(Fa,this)??h(Fa,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),m(Fa,this)}var za={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=u(Ia,e,Ra).call(e))}})};p([g()],La.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,La);var Ba=new WeakMap;function Va(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Ba.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else Va(n,t)})}function Ha(e){Ba.has(e)&&Ba.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Ba.has(e)&&Ba.get(e)():Ha(e)})}var Ua=class extends Ci{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof mi}};function Wa(e){return Array.isArray(e)?e:[e]}var Ga=D(e=>class extends Pi(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Wa(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Wa(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Wa(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Wa(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Ka=new WeakMap,qa=class extends ai(ce(Ga(Ma))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,a`
      ...
      `]}static get localizeNamespaces(){return[{"lion-combobox":e=>{switch(e){case`bg-BG`:case`bg`:return E(()=>import(`./bg-Bs0XcBVB.js`),[],import.meta.url);case`cs-CZ`:case`cs`:return E(()=>import(`./cs-B8DQIi4_.js`),[],import.meta.url);case`de-AT`:case`de-DE`:case`de`:return E(()=>import(`./de-BGf3YhNb.js`),[],import.meta.url);case`en-AU`:case`en-GB`:case`en-PH`:case`en-US`:case`en`:return E(()=>import(`./en-D-xWIAUL.js`),[],import.meta.url);case`es-ES`:case`es`:return E(()=>import(`./es-BxznwUyK.js`),[],import.meta.url);case`fr-FR`:case`fr-BE`:case`fr`:return E(()=>import(`./fr-Cma_rLCi.js`),[],import.meta.url);case`hu-HU`:case`hu`:return E(()=>import(`./hu-oz_RH6aJ.js`),[],import.meta.url);case`it-IT`:case`it`:return E(()=>import(`./it-BUnCsVOb.js`),[],import.meta.url);case`nl-BE`:case`nl-NL`:case`nl`:return E(()=>import(`./nl-BgK25p-m.js`),[],import.meta.url);case`pl-PL`:case`pl`:return E(()=>import(`./pl-BFxKYQFW.js`),[],import.meta.url);case`ro-RO`:case`ro`:return E(()=>import(`./ro-DXnny9tt.js`),[],import.meta.url);case`ru-RU`:case`ru`:return E(()=>import(`./ru-DxR-HmN-.js`),[],import.meta.url);case`sk-SK`:case`sk`:return E(()=>import(`./sk-Hha-L2N4.js`),[],import.meta.url);case`uk-UA`:case`uk`:return E(()=>import(`./uk-CvmsXQbu.js`),[],import.meta.url);case`zh-CN`:case`zh`:return E(()=>import(`./zh-CgAr6HSc.js`),[],import.meta.url);default:return E(()=>import(`./en-D-xWIAUL.js`),[],import.meta.url)}}},...super.localizeNamespaces]}get modelValue(){let e=super.modelValue;return e===``?this.parser(this.value):e}set modelValue(e){super.modelValue=e}get value(){return this._inputNode?.value||this.__value||``}set value(e){this._inputNode?(this._inputNode.value=e,this.__value=void 0):this.__value=e}reset(){super.reset(),this.multipleChoice||(this.value=this._initialModelValue),this._resetListboxOptions()}_resetListboxOptions(){this.formElements.forEach((e,t)=>{this._unhighlightMatchedOption(e),!this.showAllOnEmpty||!this.opened?e.style.display=`none`:(e.style.display=``,e.setAttribute(`aria-posinset`,`${t+1}`),e.setAttribute(`aria-setsize`,`${this.formElements.length}`),e.removeAttribute(`aria-hidden`))})}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
...
`,Za=new WeakMap,Qa=new WeakMap,$a=new WeakMap,B=new WeakSet,eo=new WeakMap,to=class extends qa{static get properties(){return{modelValue:{attribute:`model-value`}}}attributeChangedCallback(e,t,n){if(e===`model-value`){this.modelValue=this.hasAttribute(`multiple-choice`)?JSON.parse(n??`[]`):n??``;return}super.attributeChangedCallback(e,t,n)}static get styles(){return[...super.styles,Xa]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,B),this.multipleChoice=!1,this.required=!1,this.initialValues=[],this.fieldsetDisabled=!1,this.changingValues=!1,this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,Za,void 0),f(this,Qa,!1),f(this,$a,()=>{h(Qa,this,!0),u(B,this,oo).call(this),!this.multipleChoice&&!this.requireOptionMatch&&u(B,this,no).call(this)}),f(this,eo,()=>{if(this.multipleChoice){this.changeValues([]);return}this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(B,this,oo).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.selectionFollowsFocus=!1,this.addEventListener(`model-value-changed`,e=>{if(this.changingValues){e.stopImmediatePropagation();return}if(e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&JSON.stringify(this.modelValue)!==JSON.stringify(this.pendingModelValue)){e.stopImmediatePropagation();return}e.target===this&&e.detail?.isTriggeredByUser&&(this.pendingModelValue=this.multipleChoice?[...this.selectedValues]:this.modelValue,this.multipleChoice&&(this.syncInputs(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))))}),this.addEventListener(`focusout`,e=>{this.multipleChoice&&!this.requireOptionMatch&&!(e.relatedTarget instanceof Node&&this.contains(e.relatedTarget))&&this.commitQuery()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m($a,this)),this.addEventListener(`model-value-changed`,()=>{h(Za,this,this.modelValue)}),h(Za,this,this.modelValue),u(B,this,oo).call(this),this.multipleChoice&&(this.initialValues=[...Array.isArray(this.pendingModelValue)?this.pendingModelValue:[]])}updated(e){if(super.updated(e),this.multipleChoice){this.syncInputs(),this._inputNode.removeAttribute(`name`),this._comboboxNode.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this._inputNode.disabled=this.disabled||this.fieldsetDisabled;let e=this.required&&!this.inactive&&this.selectedValues.length===0;this.internals??=this.attachInternals(),this.internals.setValidity(e?{valueMissing:!0}:{},e?O(`This field is required.`):``,this._inputNode)}e.has(`opened`)&&!this.opened&&h(Qa,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`)||e.has(`multipleChoice`))&&u(B,this,oo).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,u(B,this,uo).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t);let n=e;n.updateComplete.then(()=>{if(this.multipleChoice){n.checked=Array.isArray(this.pendingModelValue)&&this.pendingModelValue.includes(String(n.choiceValue));return}String(n.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(n)))})}_notifyModelValueChanged(){JSON.stringify(this.modelValue)!==JSON.stringify(m(Za,this))&&(h(Za,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:this.multipleChoice?`selection`:`input`}})))}matchCondition(e){return!this.multipleChoice||!e.hidden}_autoSelectCondition(){return!this.multipleChoice}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=u(B,this,uo).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ...
        <div class="combobox__textbox">
          ...
          <slot name="input"></slot>
          ${this.clearable&&u(B,this,co).call(this)&&!this.inactive?r`<craft-button
                class="clear"
                type="button"
                appearance="plain"
                size="small"
    ...
    `}function co(){return this.multipleChoice?this.selectedValues.length>0:this.modelValue!==``&&this.modelValue!=null}function lo(e){let t=e.trim();for(let e of u(B,this,fo).call(this))if(u(B,this,po).call(this,e)===t)return e}function uo(){if(this.multipleChoice||!u(B,this,co).call(this))return;let e=String(this.modelValue);for(let t of u(B,this,fo).call(this))if(String(t.value)===e)return t}function*fo(){for(let e of this.options)u(B,this,io).call(this,e)?yield*e.options:yield e}function po(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}to.formAssociated=!0,p([g({type:Boolean,attribute:`multiple-choice`,reflect:!0})],to.prototype,`multipleChoice`,void 0),p([g({type:Boolean})],to.prototype,`required`,void 0),p([g({type:Array})],to.prototype,`options`,void 0),p([g({type:Number})],to.prototype,`limit`,void 0),p([g({type:Boolean,reflect:!0})],to.prototype,`clearable`,void 0),p([g({type:String,reflect:!0})],to.prototype,`placeholder`,void 0),p([g({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],to.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,to);var mo=a`
  :host {
    display: inline-block;
  }
...
`,ho={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},go=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(ho[`icon.out`].keyframes,ho[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(ho[`icon.in`].keyframes,ho[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(ho[`icon.out`].keyframes,ho[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(ho[`icon.in`].keyframes,ho[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||O(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};go.styles=[mo],p([_()],go.prototype,`isCopying`,void 0),p([_()],go.prototype,`status`,void 0),p([y(`slot[name="copy-icon"]`)],go.prototype,`copyIconEl`,void 0),p([y(`slot[name="success-icon"]`)],go.prototype,`successIconEl`,void 0),p([y(`slot[name="error-icon"]`)],go.prototype,`errorIconEl`,void 0),p([y(`craft-tooltip`)],go.prototype,`tooltipEl`,void 0),p([g({type:String})],go.prototype,`value`,void 0),p([g({type:Boolean})],go.prototype,`disabled`,void 0),p([g({attribute:`feedback-duration`,type:Number})],go.prototype,`feedbackDuration`,void 0),p([g({attribute:`tooltip-label`})],go.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,go);var _o=a`
  :host {
    box-sizing: border-box;
  }
...
`,To=0,Eo=0;function Do(){Eo++===0&&document.body.classList.add(`no-scroll`)}function Oo(){Eo>0&&--Eo===0&&document.body.classList.remove(`no-scroll`)}var ko=new WeakMap,Ao=new WeakMap,jo=new WeakMap,Mo=new WeakMap,No=new WeakSet,Po=new WeakMap,Fo=new WeakMap,Io=new WeakMap,Lo=new WeakMap,Ro=new WeakMap,zo=new WeakMap,Bo=class extends l{constructor(...e){super(...e),d(this,No),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++To}`,f(this,ko,!1),f(this,Ao,null),f(this,jo,!1),f(this,Mo,null),f(this,Po,e=>{e.preventDefault(),this.requestClose()}),f(this,Fo,()=>{this.opened=!1}),f(this,Io,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),f(this,Lo,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),f(this,Ro,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),f(this,zo,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,m(Lo,this)),this.addEventListener(`keydown`,m(Io,this)),h(Mo,this,new MutationObserver(()=>this.requestUpdate())),m(Mo,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(Lo,this)),this.removeEventListener(`keydown`,m(Io,this)),m(Mo,this)?.disconnect(),h(Mo,this,null),m(Ao,this)?.call(this),h(Ao,this,null),u(No,this,Uo).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
    ...
    `}updated(e){super.updated(e),this.opened!==m(ko,this)&&(h(ko,this,this.opened),this.opened?u(No,this,Vo).call(this):u(No,this,Ho).call(this),u(No,this,Wo).call(this,this.opened))}requestClose(){this.opened=!1}};function Vo(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(m(Ao,this)?.call(this),h(Ao,this,Co(this))),m(jo,this)||(h(jo,this,!0),Do())}function Ho(){let e=this.dialogElement;e?.open&&e.close(),m(Ao,this)?.call(this),h(Ao,this,null),u(No,this,Uo).call(this)}function Uo(){m(jo,this)&&(h(jo,this,!1),Oo())}function Wo(e){u(No,this,Go).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&u(No,this,Go).call(this,e?`craft-after-show`:`craft-after-hide`)})}function Go(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}Bo.styles=[_o,wo],p([g({type:Boolean,attribute:`open`,reflect:!0})],Bo.prototype,`opened`,void 0),p([g()],Bo.prototype,`label`,void 0),p([g({type:Boolean,attribute:`non-modal`,reflect:!0})],Bo.prototype,`nonModal`,void 0),p([g({type:Boolean,reflect:!0})],Bo.prototype,`fullscreen`,void 0),p([g({type:Boolean,attribute:`close-on-outside-click`})],Bo.prototype,`closeOnOutsideClick`,void 0),p([g({type:Boolean,attribute:`no-close`,reflect:!0})],Bo.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,Bo);var Ko=new WeakMap,qo=new WeakSet,Jo=class{constructor(e,t){this.host=e,this.source=t,d(this,qo),f(this,Ko,null),e.addController(this)}hostConnected(){u(qo,this,Yo).call(this)}hostDisconnected(){u(qo,this,Xo).call(this)}resubscribe(){u(qo,this,Xo).call(this),u(qo,this,Yo).call(this)}get state(){return this.source()?.state??null}};function Yo(){h(Ko,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function Xo(){m(Ko,this)?.call(this),h(Ko,this,null)}var Zo=a`
  :host {
    /*
...
`,Qo=new WeakMap,$o=new WeakMap,es=new WeakMap,ts=new WeakMap,ns=new WeakMap,rs=class extends Bo{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,f(this,Qo,new Jo(this,()=>this.controller)),f(this,$o,null),f(this,es,()=>{this.submit()}),f(this,ts,()=>{this.busy||this.requestClose()}),f(this,ns,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&h($o,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),m($o,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&m(Qo,this).resubscribe();let t=m(Qo,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&m($o,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
    ...
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};rs.styles=[...Bo.styles,Zo],p([g({attribute:!1})],rs.prototype,`controller`,void 0),p([g({type:Boolean,attribute:`show-title`,reflect:!0})],rs.prototype,`showTitle`,void 0),p([g({attribute:`select-label`})],rs.prototype,`selectLabel`,void 0),p([g({attribute:`cancel-label`})],rs.prototype,`cancelLabel`,void 0),p([g({type:Boolean,reflect:!0})],rs.prototype,`busy`,void 0),p([g({type:Boolean,reflect:!0})],rs.prototype,`loading`,void 0),p([g({type:Boolean,attribute:`can-submit`,reflect:!0})],rs.prototype,`canSubmit`,void 0),p([g({type:Boolean,reflect:!0})],rs.prototype,`narrow`,void 0),p([_()],rs.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,rs);var is=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
...
`,ls=class extends gi(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=O(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__hasSlot=new ss(this,`heading-prefix`,`label-extra`,`actions`,`heading-suffix`,`tip`,`warning`),this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[Nt,br,cs]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.updateComplete.then(()=>{this.addToAriaLabelledBy(this._labelNode),this.__wireDescribedBy()})}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
    ...
    `}_labelTemplate(){let e=this.__hasLabel,t=this.__hasSlot.test(`label-extra`),n=this.__hasSlot.test(`actions`),i=t||n||this.readOnly||this.__hasSlot.test(`heading-prefix`)||this.__hasSlot.test(`heading-suffix`);if(!e&&!i)return r``;let a=c;return e&&(a=this.labelSrOnly&&i?r`<span class="cp-visually-hidden"
      ...
      <div
        class=${k({"form-field__label":!0,"cp-visually-hidden":this.labelSrOnly&&!i})}
      >
...
`,fs=/^[0-9a-f]{6}$/i,ps=/^[0-9a-f]{3}$/i,ms={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function hs(e){return String(e??``).trim().replace(/^#/,``)}function gs(e){let t=hs(e);return ps.test(t)?t.split(``).map(e=>e+e).join(``):fs.test(t)?t:null}var _s=class e extends Bi{static get styles(){return[...super.styles,xr,ds]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,hs(t)),e}}}parser(e){return hs(e)}formatter(e){return hs(e)}serializer(e){return hs(e)}deserializer(e){return hs(e)}preprocessor(e){let t=hs(e);if(t!==e)return t}get _expandedHexValue(){return gs(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>gs(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=hs(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
    ...
    `}};_s._browserSupportsColorInputs=null,p([g({converter:ms})],_s.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,_s);var vs=a`
  ::slotted(.form-control) {
    ${_r}
  }
...
`,bs=class extends V{static get styles(){return[...super.styles,ys]}_renderSuffix(){return r`<craft-copy-button
    ...
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};p([g({type:String,attribute:`copy-value`})],bs.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,bs);var xs=class extends V{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,xs);var Ss=new WeakSet,Cs=class extends V{constructor(){super(),d(this,Ss),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,u(Ss,this,ws))}disconnectedCallback(){this.removeEventListener(`change`,u(Ss,this,ws)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),u(Ss,this,Ts).call(this)}};function ws(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=u(Ss,this,Es).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}u(Ss,this,Ts).call(this)}}function Ts(){let e=this._inputNode;if(!e)return;let t=u(Ss,this,Ds).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=u(Ss,this,Ds).call(this,e),i=u(Ss,this,Ds).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function Es(e){let t=u(Ss,this,Ds).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function Ds(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}p([g({type:Number,attribute:`minute-increment`})],Cs.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],Cs.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],Cs.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,Cs);var Os={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},ks=new WeakSet,As=new WeakMap,H=class extends l{constructor(...e){super(...e),d(this,ks),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,f(this,As,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof V))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,m(As,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,m(As,this)),super.disconnectedCallback()}updated(e){super.updated(e),u(ks,this,js).call(this),u(ks,this,Ms).call(this),u(ks,this,Ns).call(this),u(ks,this,Rs).call(this,`locale`,this.locale,!0),u(ks,this,Rs).call(this,`timezone`,this.timezone,!this.showTimezone)}};function js(){let e=u(ks,this,Ps).call(this,`craft-input-date`,`date`,this.showDate);e instanceof xs&&(u(ks,this,Ls).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,u(ks,this,Fs).call(this,e))}function Ms(){let e=u(ks,this,Ps).call(this,`craft-input-time`,`time`,this.showTime);e instanceof Cs&&(u(ks,this,Ls).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,u(ks,this,Fs).call(this,e))}function Ns(){let e=u(ks,this,Ps).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(u(ks,this,Ls).call(this,e,`timezone`,this.timezone??``,!1),u(ks,this,Fs).call(this,e))}function Ps(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof V);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Fs(e){e.parentElement!==this&&this.insertBefore(e,u(ks,this,Is).call(this))}function Is(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function Ls(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function Rs(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}H.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,p([g()],H.prototype,`name`,void 0),p([g({attribute:`date-value`})],H.prototype,`dateValue`,void 0),p([g({attribute:`time-value`})],H.prototype,`timeValue`,void 0),p([g()],H.prototype,`locale`,void 0),p([g()],H.prototype,`timezone`,void 0),p([g({attribute:`show-date`,converter:Os})],H.prototype,`showDate`,void 0),p([g({attribute:`show-time`,converter:Os})],H.prototype,`showTime`,void 0),p([g({type:Boolean,attribute:`show-timezone`})],H.prototype,`showTimezone`,void 0),p([g()],H.prototype,`min`,void 0),p([g()],H.prototype,`max`,void 0),p([g({attribute:`min-time`})],H.prototype,`minTime`,void 0),p([g({attribute:`max-time`})],H.prototype,`maxTime`,void 0),p([g({type:Number,attribute:`minute-increment`})],H.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],H.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],H.prototype,`forceRoundTime`,void 0),p([g({type:Boolean})],H.prototype,`disabled`,void 0),p([g({type:Boolean})],H.prototype,`readonly`,void 0),p([g({type:Boolean})],H.prototype,`required`,void 0),p([g({attribute:`described-by`})],H.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,H);var zs=class extends Ci{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Bs=class extends Ci{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Kr().msg(`lion-input-file:uploadTextDuplicateFileName`)}},Vs=524288e3,Hs={type:`FILE_TYPE`,size:`FILE_SIZE`},Us={fail:`FAIL`,pass:`SUCCESS`},Ws=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);zs.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Us.fail,this.failedProp.push(Hs.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;zs.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Us.fail,this.failedProp.push(Hs.type))}zs.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Us.fail&&(this.status=Us.pass):(this.status=Us.fail,this.failedProp.push(Hs.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Gs=e=>{switch(e){case`bg-BG`:return E(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return E(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return E(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return E(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return E(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return E(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return E(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return E(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return E(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return E(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return E(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return E(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return E(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return E(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return E(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return E(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return E(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return E(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return E(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return E(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return E(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return E(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return E(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return E(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return E(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return E(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return E(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return E(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return E(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return E(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return E(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return E(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return E(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return E(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Ks=class extends ai(di(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":Si}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Gs},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}_removeButtonContentTemplate(){return r`✖️`}_selectedListItemTemplate(e){let t=Ue();return r`
...
`,Zs=class extends Js{static get styles(){return[...super.styles,xr,Xs]}get slots(){return{...super.slots,"file-select-button":()=>r`<craft-button
          type="button"
          id="select-button-${this._inputId}"
          @click="${this.__openDialogOnBtnClick}"
        >
      ...
      `]}constructor(){super(),d(this,nc),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,f(this,rc,()=>{this.modelValue=``,this.value=``,u(nc,this,ac).call(this)?.inputmask?.setValue(``),u(nc,this,ac).call(this)?.focus()}),this.type=`text`,this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&u(nc,this,sc).call(this),u(nc,this,ac).call(this)?.classList.toggle(`money-placeholder`,!u(nc,this,cc).call(this))}disconnectedCallback(){u(nc,this,ac).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?r`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${u(nc,this,oc).call(this).currency}`}</span
      >
      ...
      <craft-button
        ...
        icon
        aria-label=${O(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!u(nc,this,cc).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${m(rc,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function ac(){return this._inputNode}function oc(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function sc(){let e=u(nc,this,ac).call(this);if(!e)return;let t=String(this.modelValue??``),n=u(nc,this,oc).call(this);e.inputmask?.remove(),e.value=t,new ec({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function cc(){return this.modelValue!==``&&this.modelValue!=null}p([g()],ic.prototype,`currency`,void 0),p([g()],ic.prototype,`locale`,void 0),p([g({type:Number})],ic.prototype,`decimals`,void 0),p([g({attribute:`decimal-separator`})],ic.prototype,`decimalSeparator`,void 0),p([g({attribute:`group-separator`})],ic.prototype,`groupSeparator`,void 0),p([g({converter:tc,attribute:`show-currency`})],ic.prototype,`showCurrency`,void 0),p([g({converter:tc})],ic.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,ic);var lc=new WeakSet,uc=class extends Bi{static get styles(){return[...super.styles,xr,a`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),d(this,lc),this.passwordRules=``,this._visible=!1,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>r`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),u(lc,this,dc).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&u(lc,this,dc).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function dc(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}p([g({attribute:`passwordrules`})],uc.prototype,`passwordRules`,void 0),p([_()],uc.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,uc);var fc=class extends l{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return r`
  ...
  `,p([g()],fc.prototype,`error`,void 0),p([g({attribute:`plugin-name`})],fc.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,fc);var pc=a`
  :host {
    display: block;
    /*
...
`,mc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(mc);var hc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(hc);var gc=new Set([`clip`,`hidden`]),_c=class extends fr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=mc.Raised,this.variant=hc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!gc.has(n)&&e.scrollHeight-e.clientHeight>1||!gc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};_c.styles=[_o,pc],p([g({reflect:!0})],_c.prototype,`appearance`,void 0),p([g({reflect:!0})],_c.prototype,`variant`,void 0),p([g()],_c.prototype,`label`,void 0),p([_()],_c.prototype,`_hasSlottedHeader`,void 0),p([_()],_c.prototype,`_hasSlottedFooter`,void 0),p([_()],_c.prototype,`_scrollable`,void 0),p([_()],_c.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,_c);var vc=0,yc=new WeakMap,U=new WeakSet,bc=class extends l{constructor(...e){super(...e),d(this,U),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,yc,++vc)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(U,this,jc).call(this)}render(){let e=u(U,this,Cc).call(this);return Ya(this.groups,e=>e.handle,(t,n)=>u(U,this,xc).call(this,t,n,e))}};function xc(e,t,n){let i=`permission-tree-heading-${m(yc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>u(U,this,Dc).call(this,e.keys,n)}
                >
                  ${u(U,this,Ec).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${u(U,this,Sc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function Sc(e,t,n,i){return Ya(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(U,this,Tc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||u(U,this,wc).call(this,o,i)}
                @model-value-changed=${e=>u(U,this,Oc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?u(U,this,Sc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function Cc(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function wc(e,t){return t.has(e.toLowerCase())}function Tc(e,t){return this.modelValue.includes(e)||u(U,this,wc).call(this,e,t)}function Ec(e,t){let n=e.filter(e=>!u(U,this,wc).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function Dc(e,t){let n=e.filter(e=>!u(U,this,wc).call(this,e,t));if(u(U,this,Ec).call(this,e,t)){let e=new Set(n);u(U,this,Ac).call(this,this.modelValue.filter(t=>!e.has(t)));return}u(U,this,Ac).call(this,[...new Set([...this.modelValue,...n])])}function Oc(e,t,n,r){if(e.stopPropagation(),this.disabled||u(U,this,wc).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){u(U,this,Ac).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...u(U,this,kc).call(this,n)]);u(U,this,Ac).call(this,this.modelValue.filter(e=>!o.has(e)))}function kc(e){return Object.values(e).flatMap(e=>[e.key,...u(U,this,kc).call(this,e.nested??{})])}function Ac(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function jc(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;u(U,this,Mc).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&u(U,this,Mc).call(this,`${this.name}[]`,t)}function Mc(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}bc.styles=a`
    :host {
      display: block;
    }
  ...
  `,p([g({type:Array})],bc.prototype,`groups`,void 0),p([g({type:Array,attribute:`model-value`})],bc.prototype,`modelValue`,void 0),p([g({type:Array,attribute:`locked-permissions`})],bc.prototype,`lockedPermissions`,void 0),p([g()],bc.prototype,`name`,void 0),p([g({type:Boolean,reflect:!0})],bc.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,bc);var Nc=a`
  :host {
...
`,Pc=new WeakMap,Fc=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,f(this,Pc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&m(Pc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),h(Pc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,h(Pc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
      <div
    ...
    `}};Fc.styles=[Nc],p([g({type:Number})],Fc.prototype,`progress`,void 0),p([g({type:Number})],Fc.prototype,`total`,void 0),p([g({type:Number})],Fc.prototype,`processed`,void 0),p([g({type:Boolean,attribute:`show-status`})],Fc.prototype,`showStatus`,void 0),p([g({type:Boolean,reflect:!0})],Fc.prototype,`pending`,void 0),p([g({type:Boolean})],Fc.prototype,`smooth`,void 0),p([g({type:String})],Fc.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Fc);var Ic=class extends Pi(Ri(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Lc=class extends Ii(Bi){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Rc=class extends Ic{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,xr,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Rc.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Rc);var zc=class extends Wi(Lc){static get styles(){return[...super.styles,a`
...
`,Vc=class extends l{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??O(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),i=t?n?`arrow-right`:`arrow-left`:`arrow-up`,a=t?n?`arrow-left`:`arrow-right`:`arrow-down`,o=O(t?`Move forward`:`Move up`),s=O(t?`Move backward`:`Move down`);return r`
    ...
    `}};Vc.styles=[Bc],p([g()],Vc.prototype,`label`,void 0),p([g({reflect:!0})],Vc.prototype,`position`,void 0),p([g({reflect:!0})],Vc.prototype,`orientation`,void 0),p([g({reflect:!0})],Vc.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],Vc.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,Vc);var Hc=class extends He(Wt){static get styles(){return[...super.styles,a`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Jc=class extends Wc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,qc]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Kc}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return r`
    ...
    `}};p([g({reflect:!0,type:Boolean})],Jc.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,Jc);var Yc=a`
  :host {
    display: block;
  }
...
`,tl=class extends $c{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,el]}_inputGroupInputTemplate(){return r`
    ...
    `}};p([g({reflect:!0,type:Boolean})],tl.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,tl);var nl=a`
  :host {
    display: inline-block;
  }
...
`,W=new WeakSet,rl=class extends l{constructor(...e){super(...e),d(this,W),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(W,this,al).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(W,this,il).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${u(W,this,sl).call(this,this.value)}
      ...
      >
        ${e.map(e=>r`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(W,this,ll).call(this,e)}
              title=${u(W,this,sl).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function il(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function al(e){u(W,this,il).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function ol(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function sl(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function cl(e,t){let n=u(W,this,al).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function ll(e){this.readOnly||u(W,this,cl).call(this,e,!0)}function ul(e){if(this.readOnly)return;let t=u(W,this,ol).call(this);switch(e.key){case`ArrowUp`:u(W,this,cl).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(W,this,cl).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(W,this,cl).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(W,this,cl).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(W,this,cl).call(this,this.min,!0),e.preventDefault();break;case`End`:u(W,this,cl).call(this,this.max,!0),e.preventDefault();break}}rl.styles=[nl],p([g({type:Number})],rl.prototype,`min`,void 0),p([g({type:Number})],rl.prototype,`max`,void 0),p([g({type:Number})],rl.prototype,`step`,void 0),p([g({type:Number})],rl.prototype,`value`,void 0),p([g()],rl.prototype,`label`,void 0),p([g({attribute:`described-by`})],rl.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],rl.prototype,`valueUnit`,void 0),p([g({attribute:!1})],rl.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],rl.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,rl);var dl=a`
  :host {
    display: block;
  }
...
`,fl=new WeakMap,pl=new WeakMap,ml=new WeakMap,hl=new WeakMap,gl=new WeakMap,_l=new WeakMap,G=new WeakSet,vl=class extends l{constructor(...e){super(...e),d(this,G),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,fl,!1),f(this,pl,!1),f(this,ml,0),f(this,hl,0),f(this,gl,0),f(this,_l,null)}connectedCallback(){super.connectedCallback(),h(_l,this,new ResizeObserver(()=>u(G,this,bl).call(this))),m(_l,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(_l,this)?.disconnect(),h(_l,this,null)}firstUpdated(){h(gl,this,(u(G,this,yl).call(this).length-1)*10),u(G,this,bl).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(G,this,bl).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(G,this,xl).call(this,this.value)}
        @keydown=${u(G,this,Al)}
        @pointerdown=${u(G,this,El)}
        @pointermove=${u(G,this,Dl)}
        @pointerup=${u(G,this,Ol)}
      >
        <div class="overlay"></div>
        <div class="cursor"></div>
        <div class="graduations">
          <ul aria-hidden="true">
            ${u(G,this,yl).call(this).map(e=>r`
                <li
                  class=${k({graduation:!0,"main-graduation":e%5==0,selected:u(G,this,jl).call(this,e)})}
                  data-graduation=${e}
                >
    ...
    `}};function yl(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function bl(){this._list&&(this._list.style.left=`${u(G,this,Cl).call(this,this.value)}px`)}function xl(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function Sl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(gl,this)*n-t}function Cl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(gl,this)/n-this._graduations.offsetWidth/2)}function wl(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);this.value=n,t&&u(G,this,Tl).call(this,`change`)}function Tl(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function El(e){h(pl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(pl,this)&&(e.preventDefault(),h(ml,this,e.clientX),h(hl,this,this._list.offsetLeft),this._root.setPointerCapture(e.pointerId),u(G,this,Tl).call(this,`start`))}function Dl(e){m(pl,this)&&Math.abs(e.clientX-m(ml,this))>3&&(h(fl,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(G,this,kl).call(this,e))}function Ol(e){m(pl,this)&&(m(fl,this)?(e.preventDefault(),h(fl,this,!1),this._root.classList.remove(`dragging`)):u(G,this,kl).call(this,e),u(G,this,Tl).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(ml,this,0),h(pl,this,!1))}function kl(e){let t=m(fl,this)?m(ml,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(fl,this)?t-e.clientX:e.clientX-t,r=m(hl,this)-n;u(G,this,wl).call(this,u(G,this,Sl).call(this,r))}function Al(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(G,this,wl).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(G,this,wl).call(this,t-1);break;case`PageUp`:u(G,this,wl).call(this,t+10);break;case`PageDown`:u(G,this,wl).call(this,t-10);break;case`Home`:u(G,this,wl).call(this,this.min);break;case`End`:u(G,this,wl).call(this,this.max);break;default:return}e.preventDefault()}function jl(e){return e>=Math.min(0,this.value)&&e<=Math.max(0,this.value)}vl.styles=[dl],p([g({type:Number})],vl.prototype,`min`,void 0),p([g({type:Number})],vl.prototype,`max`,void 0),p([g({type:Number})],vl.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],vl.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],vl.prototype,`graduationMax`,void 0),p([g()],vl.prototype,`label`,void 0),p([y(`.slide-rule`)],vl.prototype,`_root`,void 0),p([y(`.graduations`)],vl.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],vl.prototype,`_list`,void 0),p([y(`.cursor`)],vl.prototype,`_cursor`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,vl);var Ml=a`
  :host {
    display: inline-flex;
...
`,Nl=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      <span
      ...
      ></span>
    `}};Nl.styles=[Ml],p([g()],Nl.prototype,`label`,void 0),p([g()],Nl.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Nl);var Pl=class extends Oe(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},Il=class extends Pl{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Il.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,Il);var Ll=a`
  :host {
    display: grid;
  }
...
`;function Rl(e){return(e??``).split(/\s+/).filter(Boolean)}function zl(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Bl=Symbol.for(`craft-switch-synthetic-change`),Vl=new WeakMap,Hl=new WeakSet,Ul=class extends Fl{constructor(...e){super(...e),d(this,Hl),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,f(this,Vl,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,br,Ll]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Il}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?O(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?O(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){u(Hl,this,Wl).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){u(Hl,this,Wl).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){u(Hl,this,Wl).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(m(Vl,this))return;let e=new Event(`change`,{bubbles:!0});e[Bl]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Bl in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of Rl(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of Rl(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${zl(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
    ...
    `}};function Wl(e,t){if(!this.disabled){if(!t){e();return}h(Vl,this,!0),e(),this.updateComplete.then(()=>{h(Vl,this,!1)})}}p([g({type:String,reflect:!0})],Ul.prototype,`size`,void 0),p([g({type:String,attribute:`on-label`})],Ul.prototype,`onLabel`,void 0),p([g({type:String,attribute:`off-label`})],Ul.prototype,`offLabel`,void 0),p([g({attribute:`value`})],Ul.prototype,`checkedValue`,void 0),p([g({attribute:`indeterminate-value`})],Ul.prototype,`indeterminateValue`,void 0),p([g({type:Boolean,reflect:!0})],Ul.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,Ul);function Gl({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function Kl(e){e.setAttribute(`selected`,`true`)}function ql(e){e.removeAttribute(`selected`)}function Jl({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function Yl({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function Xl(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function Zl(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function Ql(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var $l=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,tu={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(tu);var nu={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(nu);var ru=[tu.InlineStart,tu.InlineEnd],iu=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),K=new WeakSet,au=new WeakMap,ou=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakMap,du=new WeakMap,fu=new WeakMap,pu=new WeakMap,mu=new WeakMap,hu=new WeakMap,gu=class extends $l{constructor(...e){super(...e),d(this,K),this.placement=tu.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,au,[]),f(this,ou,!1),f(this,su,[]),f(this,cu,0),f(this,lu,void 0),f(this,uu,!1),f(this,du,e=>{if(!this.collapsible||vu.call(u(K,this)))return;let t=u(K,this,Su).call(this,e.target);!t||t.disabled||yu.call(u(K,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(K,this,Cu).call(this,!0))}),f(this,fu,e=>{e.key!==`Escape`||!this.collapsible||vu.call(u(K,this))||u(K,this,Su).call(this,e.target)&&(e.stopPropagation(),u(K,this,Cu).call(this,!0))}),f(this,pu,()=>{vu.call(u(K,this))&&(yu.call(u(K,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(K,this,wu).call(this)}),f(this,mu,()=>{if(u(K,this,Tu).call(this),yu.call(u(K,this)).forEach((e,t)=>{let n=()=>u(K,this,Nu).call(this,t,!0),r=e=>{iu.has(e.key)&&e.preventDefault()},i=e=>u(K,this,Pu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(au,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),yu.call(u(K,this))[this.selectedIndex]?.disabled){let e=yu.call(u(K,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(K,this,Eu).call(this)}),f(this,hu,()=>{m(uu,this)||(h(uu,this,!0),requestAnimationFrame(()=>{h(uu,this,!1),u(K,this,Ou).call(this)}))})}static get styles(){return[...super.styles,_o,eu]}get layout(){return _u.call(u(K,this))?nu.Vertical:nu.Horizontal}set layout(e){this.placement=e===nu.Vertical?tu.InlineStart:tu.BlockStart}refresh(){m(ou,this)&&u(K,this,Eu).call(this),u(K,this,Ou).call(this)}firstUpdated(e){h(ou,this,yu.call(u(K,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(ou,this))t?.addEventListener(`slotchange`,m(mu,this)),m(mu,this).call(this);else{let n=vu.call(u(K,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(pu,this))}this.addEventListener(`click`,m(du,this),!0),this.addEventListener(`keydown`,m(fu,this)),t?.addEventListener(`slotchange`,m(hu,this)),h(lu,this,new ResizeObserver(m(hu,this))),m(lu,this).observe(this),u(K,this,Ou).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(K,this,Tu).call(this),m(lu,this)?.disconnect(),h(lu,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,vu.call(u(K,this))),e.has(`selectedIndex`)&&(m(ou,this)?u(K,this,Eu).call(this):m(pu,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(K,this,Ou).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${_u.call(u(K,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${vu.call(u(K,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function _u(){return ru.includes(this.placement)}function vu(){return this.selectedIndex<0}function yu(){return this.tabs}function bu(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function xu(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function Su(e){return e instanceof Node?yu.call(u(K,this)).find(t=>t===e||t.contains(e))??null:null}function Cu(e){let t=yu.call(u(K,this))[this.selectedIndex];h(cu,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function wu(){let e=yu.call(u(K,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(cu,this))?m(cu,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function Tu(){for(;m(au,this).length;)m(au,this).pop()?.()}function Eu(){let e=yu.call(u(K,this)).map(e=>u(K,this,Du).call(this,e)),t=e.some(Boolean);yu.call(u(K,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Ue()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(K,this,wu).call(this)}function Du(e){return e.controls?document.getElementById(e.controls):null}function Ou(){let e=bu.call(u(K,this)),t=xu.call(u(K,this)),n=yu.call(u(K,this));if(!e||!t)return;if(_u.call(u(K,this))||n.length===0){u(K,this,Au).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(K,this,ku).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(K,this,Au).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(K,this,Au).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function ku(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function Au(e){let t=xu.call(u(K,this)),n=new Set(e);yu.call(u(K,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(su,this,e),t&&(t.hidden=e.length===0,t.actions=u(K,this,ju).call(this))}function ju(){return m(su,this).map(e=>{let t=yu.call(u(K,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(K,this,Mu).call(this,e)}})}function Mu(e){let t=yu.call(u(K,this))[e];if(!t||t.disabled)return;let n=xu.call(u(K,this));n&&(n.opened=!1),this.selectedIndex=e,u(K,this,Ou).call(this),t.focus()}function Nu(e,t){let n=yu.call(u(K,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Pu(e){if(!iu.has(e.key))return;let t=u(K,this,Fu).call(this,e.key);t!==-1&&u(K,this,Nu).call(this,t,!0)}function Fu(e){let t=yu.call(u(K,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(vu.call(u(K,this)))return u(K,this,Fu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],gu.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],gu.prototype,`collapsible`,void 0),p([g({reflect:!0})],gu.prototype,`layout`,null),p([g({reflect:!0})],gu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,gu);var Iu=a`
  :host {
    display: inline-flex;
...
`,Ku=C(ue(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?t.exports=r():typeof define==`function`&&define.amd?define(r):(n||=self,n.autosize=r())})(e,(function(){var e=new Map;function t(t){if(!t||!t.nodeName||t.nodeName!==`TEXTAREA`||e.has(t))return;var n=null;function r(e){for(var t=[];e&&e.parentNode&&e.parentNode instanceof Element;)e.parentNode.scrollTop&&t.push([e.parentNode,e.parentNode.scrollTop]),e=e.parentNode;return function(){return t.forEach(function(e){var t=e[0],n=e[1];t.style.scrollBehavior=`auto`,t.scrollTop=n,t.style.scrollBehavior=null})}}var i=window.getComputedStyle(t);function a(e){var o=e.restoreTextAlign,s=o===void 0?null:o,c=e.testForHeightReduction,l=c===void 0||c,u=i.overflowY;if(t.scrollHeight!==0){i.resize===`vertical`?t.style.resize=`none`:i.resize===`both`&&(t.style.resize=`horizontal`);var d;l&&(d=r(t),t.style.height=``);var f=i.boxSizing===`content-box`?t.scrollHeight-(parseFloat(i.paddingTop)+parseFloat(i.paddingBottom)):t.scrollHeight+parseFloat(i.borderTopWidth)+parseFloat(i.borderBottomWidth);if(i.maxHeight!==`none`&&f>parseFloat(i.maxHeight)?(i.overflowY===`hidden`&&(t.style.overflow=`scroll`),f=parseFloat(i.maxHeight)):i.overflowY!==`hidden`&&(t.style.overflow=`hidden`),t.style.height=f+`px`,s&&(t.style.textAlign=s),d&&d(),n!==f&&(t.dispatchEvent(new Event(`autosize:resized`,{bubbles:!0})),n=f),u!==i.overflow&&!s){var p=i.textAlign;i.overflow===`hidden`&&(t.style.textAlign=p===`start`?`end`:`start`),a({restoreTextAlign:p,testForHeightReduction:!0})}}}function o(){a({testForHeightReduction:!0,restoreTextAlign:null})}var s=function(){var e=t.value;return function(){a({testForHeightReduction:e===``||!t.value.startsWith(e),restoreTextAlign:null}),e=t.value}}(),c=function(n){t.removeEventListener(`autosize:destroy`,c),t.removeEventListener(`autosize:update`,o),t.removeEventListener(`input`,s),window.removeEventListener(`resize`,o),Object.keys(n).forEach(function(e){return t.style[e]=n[e]}),e.delete(t)}.bind(t,{height:t.style.height,resize:t.style.resize,textAlign:t.style.textAlign,overflowY:t.style.overflowY,overflowX:t.style.overflowX,wordWrap:t.style.wordWrap});t.addEventListener(`autosize:destroy`,c),t.addEventListener(`autosize:update`,o),t.addEventListener(`input`,s),window.addEventListener(`resize`,o),t.style.overflowX=`hidden`,t.style.wordWrap=`break-word`,e.set(t,{destroy:c,update:o}),o()}function n(t){var n=e.get(t);n&&n.destroy()}function r(t){var n=e.get(t);n&&n.update()}var i=null;return typeof window>`u`?(i=function(e){return e},i.destroy=function(e){return e},i.update=function(e){return e}):(i=function(e,n){return e&&Array.prototype.forEach.call(e.length?e:[e],function(e){return t(e)}),e},i.destroy=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],n),e},i.update=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],r),e}),i}))}))(),1),qu=new WeakMap,Ju=new WeakMap,Yu=new WeakMap,Xu=new WeakSet,Zu=class extends Wu{constructor(...e){super(...e),d(this,Xu),this.monospace=!1,f(this,qu,void 0),f(this,Ju,void 0),f(this,Yu,null)}static get styles(){return[...super.styles,xr,Gu]}connectedCallback(){super.connectedCallback(),u(Xu,this,Qu).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(qu,this)?.disconnect(),h(qu,this,void 0),m(Ju,this)?.disconnect(),h(Ju,this,void 0)}};function Qu(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(Yu,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(Yu,this,e.style.height)}),h(Ju,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(Ju,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(qu,this,new ResizeObserver(()=>{if(e.style.height===m(Yu,this))return;let t=e.style.height;Ku.default.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(Ju,this)?.disconnect(),h(Ju,this,void 0),m(qu,this)?.disconnect(),h(qu,this,void 0)})),m(qu,this).observe(e))}p([g({type:Boolean,reflect:!0})],Zu.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Zu);var $u=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>ed(e,this),this.compositionEventHandler=e=>od(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,td),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,td)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(ad)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(ad)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(ad),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),id(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function ed(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:nd(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&nd(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function td(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&rd(t,{event:e})}function nd(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function rd(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function id(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function ad(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function od(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var sd=class extends Event{constructor(){super(`update`)}},cd=new WeakMap,ld=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=cd.get(t);return n||(n=new e(t),cd.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),cd.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new sd)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of ud)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},ud=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),dd=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return ld.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},fd=a`
  :host {
    display: contents;
  }
...
`,pd=/^[\p{L}\p{N}_.-]*$/u,md=O(`Suggestions`),hd=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],gd={handlesAccessibility:!1,visibilityTriggerFunction:void 0},_d=0,q=new WeakMap,vd=new WeakMap,yd=new WeakMap,bd=new WeakMap,J=new WeakMap,xd=new WeakMap,Sd=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Y=new WeakSet,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Bd=new WeakMap,Vd=class extends l{constructor(...e){super(...e),d(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,q,void 0),f(this,vd,null),f(this,yd,null),f(this,bd,new Map),f(this,J,null),f(this,xd,[]),f(this,Sd,0),f(this,Cd,null),f(this,wd,null),f(this,Td,null),f(this,Ed,!1),f(this,Dd,null),f(this,Od,new DOMRect),f(this,kd,new MutationObserver(()=>{let e=u(Y,this,Ud).call(this);(ff(e)&&e!==m(vd,this)||m(vd,this)&&!m(vd,this).isConnected)&&u(Y,this,Wd).call(this)})),f(this,Ad,()=>{m(Ed,this)||u(Y,this,Zd).call(this)}),f(this,jd,()=>{h(Ed,this,!0),u(Y,this,of).call(this)}),f(this,Md,()=>{h(Ed,this,!1),u(Y,this,Zd).call(this)}),f(this,Nd,()=>{queueMicrotask(()=>u(Y,this,of).call(this))}),f(this,Pd,()=>{let e=m(vd,this);!e||!m(J,this)||!pf(e)||queueMicrotask(()=>{m(J,this)&&(e.selectionStart!==m(J,this).end||e.selectionEnd!==m(J,this).end)&&u(Y,this,Zd).call(this)})}),f(this,Fd,()=>{m(J,this)&&u(Y,this,af).call(this)}),f(this,Id,e=>{let t=e;m(J,this)&&m(q,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,Ld,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,Rd,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,zd,e=>{u(Y,this,tf).call(this,Number(e.target.dataset.index))}),f(this,Bd,e=>{if(e.target!==this.popoverElement)return;let t=m(q,this).getAttribute(`aria-label`)??md;u(Y,this,lf).call(this),h(J,this,null),u(Y,this,cf).call(this),u(Y,this,uf).call(this,t===md?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(Y,this,Hd).call(this),this.hasUpdated&&u(Y,this,Wd).call(this)}disconnectedCallback(){u(Y,this,Kd).call(this),m(q,this)?.remove(),m(Td,this)!==null&&(clearTimeout(m(Td,this)),h(Td,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(Y,this,Wd).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(vd,this)!==u(Y,this,Ud).call(this)&&u(Y,this,Wd).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(J,this)){let e=m(q,this).querySelector(`[aria-selected="true"]`),t=e?m(xd,this)[Number(e.dataset.index)]:void 0;u(Y,this,Zd).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${gd}
        @craft-hide=${m(Bd,this)}
      >
    ...
    `}};function Hd(){h(q,this,document.createElement(`div`)),m(q,this).id=`craft-text-expander-listbox-${++_d}`,m(q,this).slot=`listbox`,m(q,this).setAttribute(`part`,`listbox`),m(q,this).role=`listbox`,m(q,this).setAttribute(`aria-label`,md),m(q,this).addEventListener(`pointerdown`,m(Ld,this)),m(q,this).addEventListener(`pointerup`,m(Rd,this)),m(q,this).addEventListener(`combobox-commit`,m(zd,this)),this.append(m(q,this))}function Ud(){return this.getRootNode().getElementById(this.for)}function Wd(){let e=u(Y,this,Ud).call(this);if(u(Y,this,Kd).call(this),!ff(e)){u(Y,this,Gd).call(this);return}h(vd,this,e),u(Y,this,qd).call(this,e),h(yd,this,new $u(e,m(q,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(Y,this,Jd).call(this,e),e.addEventListener(`input`,m(Ad,this)),e.addEventListener(`keydown`,m(Id,this)),e.addEventListener(`blur`,m(Nd,this)),e.addEventListener(`compositionstart`,m(jd,this)),e.addEventListener(`compositionend`,m(Md,this)),e.ownerDocument.addEventListener(`selectionchange`,m(Pd,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(Od,this)},u(Y,this,Gd).call(this)}function Gd(){m(kd,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function Kd(){m(kd,this).disconnect(),u(Y,this,of).call(this);let e=m(vd,this);e&&(e.removeEventListener(`input`,m(Ad,this)),e.removeEventListener(`keydown`,m(Id,this)),e.removeEventListener(`blur`,m(Nd,this)),e.removeEventListener(`compositionstart`,m(jd,this)),e.removeEventListener(`compositionend`,m(Md,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(Pd,this)),m(Dd,this)?.getStyleClone().disconnect(),h(Dd,this,null),m(yd,this)?.destroy(),h(yd,this,null),u(Y,this,Yd).call(this,e),h(vd,this,null))}function qd(e){m(bd,this).clear();for(let t of hd)m(bd,this).set(t,e.getAttribute(t))}function Jd(e){let t=[m(bd,this).get(`aria-controls`),m(q,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(Y,this,Xd).call(this,e,`aria-haspopup`),u(Y,this,Xd).call(this,e,`aria-expanded`)}function Yd(e){for(let t of hd)u(Y,this,Xd).call(this,e,t);m(bd,this).clear()}function Xd(e,t){let n=m(bd,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function Zd(e){u(Y,this,lf).call(this);let t=u(Y,this,$d).call(this);if(!t){h(J,this,null),u(Y,this,sf).call(this);return}h(J,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(Y,this,ef).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(Y,this,ef).call(this,[]),u(Y,this,uf).call(this,O(`Loading`));let r=m(Sd,this);h(wd,this,setTimeout(()=>{u(Y,this,Qd).call(this,t,n,r,e)},150))}async function Qd(e,t,n,r){h(Cd,this,new AbortController);let i;try{let n=await ve.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(Cd,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(Sd,this)||mf(t))return;u(Y,this,of).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(Sd,this)&&(this.loading=!1,u(Y,this,ef).call(this,t===void 0?i:i.slice(0,t),r))}function $d(){let e=m(vd,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!pf(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&pd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function ef(e,t){if(u(Y,this,rf).call(this),h(xd,this,e),m(q,this).replaceChildren(),m(q,this).hidden=this.loading,m(q,this).setAttribute(`aria-label`,m(J,this)?.trigger.label??md),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=df(e);n.id=`${m(q,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(J,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(q,this).append(n)}),!this.loading&&!e.length){h(J,this,null),u(Y,this,sf).call(this),u(Y,this,uf).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(J,this)&&u(Y,this,nf).call(this,t)})}function tf(e){let t=m(vd,this),n=m(xd,this)[e],r=u(Y,this,$d).call(this),i=m(J,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(Y,this,of).call(this);return}hf(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(Y,this,of).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function nf(e){await this.popoverElement.updateComplete;let t=m(vd,this);if(!t||!u(Y,this,af).call(this)){u(Y,this,of).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(J,this)||t!==m(vd,this))&&m(xd,this).length&&(m(yd,this)?.start(),u(Y,this,Xd).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(Ad,this)),t.addEventListener(`input`,m(Ad,this)),e)){let t=m(xd,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(yd,this)?.navigate(1)}}function rf(){m(yd,this)?.stop(),m(vd,this)&&u(Y,this,Xd).call(this,m(vd,this),`aria-expanded`)}function af(){let e=m(vd,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(Dd,this)){h(Dd,this,new dd(e));let t=m(Dd,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(Fd,this))}return m(Dd,this).setStartOffset(t),m(Dd,this).setEndOffset(t),h(Od,this,m(Dd,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function of(){u(Y,this,lf).call(this),h(J,this,null),u(Y,this,sf).call(this)}function sf(){u(Y,this,cf).call(this),this.popoverElement.hide()}function cf(){this.loading=!1,u(Y,this,rf).call(this),h(xd,this,[]),m(q,this)?.replaceChildren(),m(q,this)&&(m(q,this).hidden=!1);let e=m(vd,this);e&&(u(Y,this,Xd).call(this,e,`aria-activedescendant`),u(Y,this,Xd).call(this,e,`aria-busy`))}function lf(){var e;h(Sd,this,(e=m(Sd,this),e++,e)),m(wd,this)&&(clearTimeout(m(wd,this)),h(wd,this,null)),m(Cd,this)?.abort(),h(Cd,this,null)}function uf(e){m(Td,this)!==null&&(clearTimeout(m(Td,this)),h(Td,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(Td,this,setTimeout(()=>{h(Td,this,null),this.announcement=``},5e3))}Vd.styles=[Nt,fd],p([g({reflect:!0})],Vd.prototype,`for`,void 0),p([g({type:Array})],Vd.prototype,`triggers`,void 0),p([_()],Vd.prototype,`loading`,void 0),p([_()],Vd.prototype,`announcement`,void 0),p([y(`craft-popover`)],Vd.prototype,`popoverElement`,void 0);function df(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function ff(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function pf(e){return e.getRootNode().activeElement===e}function mf(e){return e instanceof DOMException&&e.name===`AbortError`}function hf(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Vd);var gf=a`
  :host {
    display: inline-flex;
...
`,_f=new WeakMap,vf=new WeakSet,yf=class extends l{constructor(...e){super(...e),d(this,vf),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,f(this,_f,typeof ResizeObserver<`u`?new ResizeObserver(()=>u(vf,this,bf).call(this)):null)}connectedCallback(){super.connectedCallback(),m(_f,this)?.observe(this)}disconnectedCallback(){m(_f,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){u(vf,this,bf).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${u(vf,this,xf)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function bf(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function xf(){u(vf,this,bf).call(this)}yf.styles=gf,p([g({reflect:!0})],yf.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],yf.prototype,`disabled`,void 0),p([_()],yf.prototype,`overflowing`,void 0),p([_()],yf.prototype,`text`,void 0),p([y(`.truncate`)],yf.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,yf);var Sf=a`
  :host {
...
`,Cf={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},wf=class extends l{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs()}render(){return r`
      <div class="${k({thumbnail:!0,"thumbnail--checkered":this.checkered,"thumbnail--rounded":this.rounded,"thumbnail--crop":this.mode===`crop`,"thumbnail--stretch":this.mode===`stretch`})}" part="thumbnail">
        ${this.src?r`<img
    ...
    `}};wf.styles=[Sf],p([g()],wf.prototype,`src`,void 0),p([g({reflect:!0})],wf.prototype,`mode`,void 0),p([g()],wf.prototype,`srcset`,void 0),p([g()],wf.prototype,`sizes`,void 0),p([g()],wf.prototype,`alt`,void 0),p([g({type:Number})],wf.prototype,`width`,void 0),p([g({type:Number})],wf.prototype,`height`,void 0),p([g()],wf.prototype,`loading`,void 0),p([g({reflect:!0,converter:Cf})],wf.prototype,`checkered`,void 0),p([g({type:Boolean,reflect:!0})],wf.prototype,`rounded`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,wf);var Tf=new WeakMap,Ef=new WeakSet,Df=class extends HTMLElement{constructor(...e){super(...e),d(this,Ef),f(this,Tf,null)}connectedCallback(){u(Ef,this,Of).call(this)}disconnectedCallback(){m(Tf,this)?.destroy(),h(Tf,this,null)}};function Of(){if(!(m(Tf,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>u(Ef,this,Of).call(this));return}h(Tf,this,new _a),m(Tf,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Df);var kf=!1,Af=null;async function jf(e){if(!kf){if(Af)return Af;kf=!0;try{return(await ve.post(`app/api-headers`,void 0,{cancelToken:e})).data}catch{}finally{kf=!1}}}var Mf=x.create({baseURL:`https://api.craftcms.com/v1/`});async function Nf(e){return Af?Object.entries(Af).forEach(([t,n])=>{e.headers.set(t,n)}):(e.params=e.params||{},e.params.processCraftHeaders=1),e}async function Pf(e,t){if(Af)return;let{data:n}=await ve.post(`app/process-api-response-headers`,{headers:e},{cancelToken:t});return Af=n,kf=!1,Af}async function Ff(e){return await Pf(e.headers,e.config.cancelToken),e}Mf.interceptors.request.use(async e=>{let{cancelToken:t}=e,n=await jf(t);n&&Object.entries(n).forEach(([t,n])=>{e.headers.set(t,n)});let r={...e,params:{...Cp.apiParams||{},...e.params,v:new Date().getTime()}};return n||(r.params.processCraftHeaders=1),Cp.httpProxy&&(r.proxy=Cp.httpProxy),r}),Mf.interceptors.request.use(Nf),Mf.interceptors.response.use(Ff);function If(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function Lf(e={}){let t=If({...e,type:`submit`,label:e.label||O(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function Rf(e={}){let t=If({...e,icon:`duplicate`,label:e.label||ma(O(`Paste {type}`,{type:O(`elements`)}))});return t.classList.add(`paste-btn`),t}var zf=async(e,t)=>{let{data:n}=await ve.post(e,t);return n},Bf=new WeakMap,Vf=new WeakMap,Hf=new WeakMap,Uf=new WeakMap,Wf=new WeakMap,Gf=new WeakMap,Kf=new WeakMap,qf=new WeakMap,Jf=new WeakMap,Yf=new WeakMap,X=new WeakSet,Xf=class e{constructor(t){d(this,X),f(this,Bf,null),f(this,Vf,[]),f(this,Hf,[]),f(this,Uf,null),f(this,Wf,!1),f(this,Gf,!1),f(this,Kf,!1),f(this,qf,null),f(this,Jf,void 0),f(this,Yf,new Map),this.options={...e.defaults,modalTitle:O(`Select element`),selectBtnLabel:O(`Select`),...tp(t)},h(Hf,this,[...this.options.disabledElementIds??[]]),h(Jf,this,u(X,this,Zf).call(this))}get elementType(){return this.options.elementType}get state(){return m(Jf,this)}get index(){return m(Bf,this)}get hasSelection(){return m(Vf,this).length>0}on(e,t){let n=m(Yf,this).get(e);return n||(n=new Set,m(Yf,this).set(e,n)),n.add(t),()=>{m(Yf,this).get(e)?.delete(t)}}async open(){h(Vf,this,[]),m(Bf,this)?.clearSelection(),m(Wf,this)||(h(Wf,this,!0),u(X,this,ep).call(this,`open`,void 0)),u(X,this,Qf).call(this),m(Uf,this)||await this.reload()}close(){m(Wf,this)&&(h(Wf,this,!1),u(X,this,ep).call(this,`close`,void 0),this.options.onClose?.(),u(X,this,Qf).call(this))}destroy(){m(Bf,this)?.destroy?.(),h(Bf,this,null),h(Vf,this,[]),h(Uf,this,null),h(Wf,this,!1),h(Kf,this,!1),h(Gf,this,!1),h(qf,this,null),u(X,this,Qf).call(this),m(Yf,this).clear()}async reload(){let e=this.options.loadIndexBody??zf;h(Gf,this,!0),h(qf,this,null),u(X,this,Qf).call(this);try{h(Uf,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){u(X,this,$f).call(this,e)}finally{h(Gf,this,!1),u(X,this,Qf).call(this)}}async submit(){if(!m(Jf,this).canSubmit)return;let e=this.buildElementInfo(m(Vf,this)),t=this.selectMeta();h(Kf,this,!0),u(X,this,Qf).call(this);try{u(X,this,ep).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){u(X,this,$f).call(this,e);return}finally{h(Kf,this,!1),u(X,this,Qf).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...m(Hf,this),...e.map(e=>Number(e.id))]),m(Bf,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){m(Jf,this).canCancel&&(u(X,this,ep).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){h(Bf,this,e),u(X,this,Qf).call(this)}detachIndex(){h(Bf,this,null),u(X,this,Qf).call(this)}setSelection(e){h(Vf,this,[...e]),u(X,this,Qf).call(this)}setDisabledElementIds(e){h(Hf,this,[...new Set(e.map(Number))]),u(X,this,Qf).call(this)}setBusy(e){h(Kf,this,e),u(X,this,Qf).call(this)}indexParams(){let{options:e}=this,t={context:`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition,criteria:{...e.criteria}};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),e.criteria&&(t.criteria={...e.criteria}),typeof e.indexSettings.showFolders==`boolean`&&(t.showFolders=e.indexSettings.showFolders),t}indexSettings(){let{options:e}=this;return{context:`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...m(Hf,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return m(Vf,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){u(X,this,Qf).call(this)}get selection(){return m(Vf,this)}get disabledElementIds(){return m(Hf,this)}};function Zf(){let e=m(Kf,this),t=m(Gf,this);return Object.freeze({open:m(Wf,this),loading:t,busy:e,selection:Object.freeze([...m(Vf,this)]),disabledElementIds:Object.freeze([...m(Hf,this)]),indexBody:m(Uf,this),error:m(qf,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function Qf(){h(Jf,this,u(X,this,Zf).call(this)),u(X,this,ep).call(this,`change`,m(Jf,this))}function $f(e){h(qf,this,e instanceof Error?e:Error(String(e??`Unknown`))),u(X,this,ep).call(this,`error`,m(qf,this))}function ep(e,t){let n=m(Yf,this).get(e);n&&[...n].forEach(e=>e(t))}Xf.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function tp(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var np=async(e,t)=>{let{data:n}=await ve.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},rp=new WeakMap,ip=class e extends Xf{constructor(e){super(e),f(this,rp,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??np;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}h(rp,this,t);try{await this.submit()}finally{h(rp,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!m(rp,this))return n;let r=e.transformUrls[m(rp,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:m(rp,this)}}};ip.transformUrls={};var ap=`CraftCms\\Cms\\Asset\\Elements\\Asset`,op=new WeakSet,sp=class extends Xf{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:ap,showSiteMenu:!1}),d(this,op),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:u(op,this,cp).call(this),status:null,url:null,hasThumb:!1}]}};function cp(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var lp=new Map;function up(e,t){if(lp.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);lp.set(e,t)}function dp(e){return lp.has(e)}function fp(e){return lp.get(e)??Xf}function pp(e){return new(fp(e.elementType))(e)}function mp(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))lp.has(t)||lp.set(t,n)}var hp={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},gp=new WeakMap,_p=new WeakMap,vp=new WeakMap,yp=new WeakMap,bp=new WeakMap,xp=new WeakMap,Sp=new WeakMap,Z=new WeakSet,wp=class{constructor(e={}){d(this,Z),f(this,gp,new Map),f(this,_p,null),f(this,vp,0),f(this,yp,[]),f(this,bp,[]),f(this,xp,new Set),f(this,Sp,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)m(gp,this).set(e.id,e);r&&(u(Z,this,Op).call(this),m(_p,this)!==null&&u(Z,this,kp).call(this))}getSessions(){return Array.from(m(gp,this).values())}getCurrentSessionId(){return m(_p,this)}isProcessing(){return m(vp,this)>0}on(e,t){return m(Sp,this).has(e)||m(Sp,this).set(e,new Set),m(Sp,this).get(e).add(t),()=>{m(Sp,this).get(e)?.delete(t)}}async startIndexing(e){let t=await ve.post(hp.START,e),{data:n}=t;return n.session&&(m(gp,this).set(n.session.id,n.session),h(_p,this,n.session.id),u(Z,this,Ep).call(this),n.stop||u(Z,this,kp).call(this)),n.stop&&u(Z,this,Dp).call(this,n.stop),t}stopSession(e){u(Z,this,Ap).call(this,e),u(Z,this,jp).call(this,{sessionId:e,action:hp.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){u(Z,this,jp).call(this,{sessionId:e,action:hp.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){u(Z,this,jp).call(this,{sessionId:e.sessionId,action:hp.FINISH,params:e,priority:!0})}destroy(){m(gp,this).clear(),h(yp,this,[]),h(bp,this,[]),m(Sp,this).clear(),h(_p,this,null),h(vp,this,0)}};function Tp(e,t){m(Sp,this).get(e)?.forEach(e=>e(t))}function Ep(e){u(Z,this,Tp).call(this,`change`,{sessions:this.getSessions(),currentSessionId:m(_p,this),reviewSessionId:e})}function Dp(e){m(gp,this).delete(e),m(_p,this)===e&&h(_p,this,null),u(Z,this,Ep).call(this)}function Op(){for(let[e,t]of m(gp,this))if(!t.actionRequired&&!m(xp,this).has(e)){h(_p,this,e);return}h(_p,this,null)}function kp(){if(m(_p,this)||u(Z,this,Op).call(this),!m(_p,this))return;let e=m(gp,this).get(m(_p,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-m(vp,this),r=Math.min(n,t);for(let t=0;t<r;t++)u(Z,this,jp).call(this,{sessionId:e.id,action:hp.PROCESS,params:{sessionId:m(_p,this)},priority:!1});e.processIfRootEmpty&&u(Z,this,jp).call(this,{sessionId:e.id,action:hp.PROCESS,params:{sessionId:m(_p,this)},priority:!1})}function Ap(e){m(xp,this).add(e),h(yp,this,m(yp,this).filter(t=>t.sessionId!==e))}function jp(e){e.priority?m(bp,this).push(e):m(yp,this).push(e),u(Z,this,Mp).call(this)}function Mp(){if(!(m(yp,this).length+m(bp,this).length===0||m(vp,this)>=this.maxConcurrentConnections))for(;m(yp,this).length+m(bp,this).length>0&&m(vp,this)<this.maxConcurrentConnections;){var e;h(vp,this,(e=m(vp,this),e++,e));let t=m(bp,this).length>0?m(bp,this).shift():m(yp,this).shift();u(Z,this,Np).call(this,t)}}async function Np(e){try{let t=await ve.post(e.action,e.params);u(Z,this,Pp).call(this,t.data)}catch(t){u(Z,this,Fp).call(this,t,e)}finally{var t;h(vp,this,(t=m(vp,this),t--,t)),u(Z,this,Mp).call(this)}}function Pp(e){let t;e.session&&(m(gp,this).set(e.session.id,e.session),u(Z,this,Op).call(this),e.session.actionRequired&&!e.skipDialog?m(xp,this).has(e.session.id)||(t=e.session.id):m(xp,this).has(e.session.id)||u(Z,this,kp).call(this)),u(Z,this,Op).call(this),e.stop&&(m(gp,this).delete(e.stop),m(_p,this)===e.stop&&h(_p,this,null)),u(Z,this,Ep).call(this,t),m(gp,this).size===0&&u(Z,this,Tp).call(this,`complete`,{})}function Fp(e,t){u(Z,this,Op).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;u(Z,this,Tp).call(this,`error`,{message:n,sessionId:t.sessionId}),u(Z,this,Mp).call(this)}var Ip=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},Lp=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Rp,zp=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Bp=typeof Intl<`u`&&Intl.ListFormat||zp,Vp=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],Hp={minimumIntegerDigits:2},Up=class{constructor(e,t={}){Rp.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Ip(this,Rp,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return Lp(this,Rp,`f`)}formatToParts(e){let t=[],n=Lp(this,Rp,`f`),r=n.style,i=n.locale;for(let[a,o]of Vp){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?Hp:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Bp(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Rp=new WeakMap;var Wp=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,Gp=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],Kp=e=>Wp.test(e),qp=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(Wp)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(Jp(r,e.from(t)).getTime()-r),a=Math.abs(Jp(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Up(e,t).format(this)}};function Jp(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function Yp(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new qp;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=Gp.indexOf(t)||Gp.length;return new qp(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function Xp(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new qp(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function Zp(e,t){let n=Xp(e,t);if(n.blank)return[0,`second`];for(let e of Gp){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Qp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,$p,em,tm,nm,rm,im,am,om,sm,cm,lm,um,dm,fm,pm,mm=globalThis.HTMLElement||null,hm=new qp,gm=new qp(0,0,0,0,0,1),_m=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function vm(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var ym=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=vm(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,vm(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},bm=class extends mm{constructor(){super(...arguments),$.add(this),$p.set(this,!1),em.set(this,!1),nm.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),pm.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,pm,`f`)}set onRelativeTimeUpdated(e){Q(this,pm,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,pm,`f`)),Qp(this,pm,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&Kp(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return Gp.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){ym.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&Qp(this,$p,n!==null&&(this.date&&Q(this,$,`m`,rm).call(this,this.date))!==n,`f`),!Q(this,em,`f`)&&!(e===`title`&&Q(this,$p,`f`))&&Qp(this,em,(async()=>{await Promise.resolve(),this.update(),Qp(this,em,!1,`f`)})(),`f`))}update(){let e=Q(this,nm,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,nm,`f`).textContent=e;return}let i=Date.now();Q(this,$p,`f`)||(n=Q(this,$,`m`,rm).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=Yp(r,this.precision,i),o=Q(this,$,`m`,im).call(this,a),s=e,c=Q(this,$,`m`,fm).call(this,o);s=c?Q(this,$,`m`,um).call(this,r):o===`duration`?Q(this,$,`m`,am).call(this,a):o===`relative`?Q(this,$,`m`,om).call(this,a):Q(this,$,`m`,sm).call(this,r),s?Q(this,$,`m`,dm).call(this,s):this.shadowRoot===Q(this,nm,`f`)&&this.textContent&&Q(this,$,`m`,dm).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new _m(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,cm).call(this,r)||Q(this,$,`m`,lm).call(this,r))?ym.observe(this):ym.unobserve(this)}};$p=new WeakMap,em=new WeakMap,nm=new WeakMap,pm=new WeakMap,$=new WeakSet,tm=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},rm=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,tm),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},im=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||qp.compare(e,this.threshold)===1)return`relative`}return`datetime`},am=function(e){let t=Q(this,$,`a`,tm),n=this.format,r=this.formatStyle,i=this.tense,a=hm;n===`micro`?(e=Xp(e),a=gm,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=gm)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},om=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,tm),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=hm),n===`past`&&e.sign!==-1&&(e=hm);let[r,i]=Zp(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},sm=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,tm),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},cm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,tm),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},lm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,tm),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},um=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,cm).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,tm),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,tm))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,tm),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,lm).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,tm),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,tm),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},dm=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,nm,`f`).replaceChildren(t)}else Q(this,nm,`f`).textContent=e},fm=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var xm=typeof globalThis<`u`?globalThis:window;try{xm.RelativeTimeElement=bm.define()}catch(e){if(!(xm.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{Xi as A,pa as C,ra as D,ua as E,yt as F,bt as I,dt as L,sr as M,Nt as N,sa as O,St as P,ve as R,ma as S,fa as T,Qs as _,dp as a,to as b,Xf as c,Lf as d,Mf as f,ic as g,tl as h,mp as i,Ci as j,ia as k,Rf as l,Ul as m,pp as n,sp as o,Zu as p,up as r,ip as s,wp as t,If as u,V as v,da as w,_a as x,_s as y,ge as z};
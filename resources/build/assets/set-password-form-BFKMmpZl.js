import{c as e,r as t,t as n}from"./lit-DNaDb1T7.js";import"./dist-67fTfW2h.js";import{n as r,t as i}from"./decorators-D0-gbKXH.js";import{o as a}from"./nav-item-DEjaz-rb-B-cPuDFl.js";import{t as o}from"./login-form.styles-JHGKlkIR.js";import{t as s}from"./decorate-B3KLIx2E.js";var c=class extends n{constructor(...e){super(...e),this.action=``,this.uid=``,this.code=``,this.initialError=``,this.newUser=!1,this._busy=!1}static{this.styles=[o]}#e(){return this.newUser?a(`Choose a password`):a(`Choose a new password`)}#t(){this._busy=!0}render(){return e`
      <craft-pane>
        <form
          class="auth-form"
          method="post"

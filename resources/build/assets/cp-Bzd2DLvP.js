...
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=Yu()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return Yu()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(u(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),Zu=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function Qu(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return Zu.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var $u=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},ed=P(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),td=P(e=>class extends ed(Ui(ia(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=sa(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...Qu(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return l`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof $u&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&!(typeof t==`boolean`&&t===!1)}static get styles(){return[d`
        ...
        `]}_getAriaDescriptionElements(){return[this._helpTextNode,this._feedbackNode]}addToAriaLabelledBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaLabelledNodes.includes(e)||(this._ariaLabelledNodes=[...this._ariaLabelledNodes,e],this.__reorderAriaLabelledNodes=!!n)}removeFromAriaLabelledBy(e){this._ariaLabelledNodes.includes(e)&&(this._ariaLabelledNodes.splice(this._ariaLabelledNodes.indexOf(e),1),this._ariaLabelledNodes=[...this._ariaLabelledNodes],this.__reorderAriaLabelledNodes=!1)}addToAriaDescribedBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaDescribedNodes.includes(e)||(this._ariaDescribedNodes=[...this._ariaDescribedNodes,e],this.__reorderAriaDescribedNodes=!!n)}removeFromAriaDescribedBy(e){this._ariaDescribedNodes.includes(e)&&(this._ariaDescribedNodes.splice(this._ariaDescribedNodes.indexOf(e),1),this._ariaDescribedNodes=[...this._ariaDescribedNodes],this.__reorderAriaLabelledNodes=!1)}__getDirectSlotChild(e){return Array.from(this.children).find(t=>t.slot===e)}_dispatchInitialModelValueChangedEvent(){this._repropagationRole!==`child`&&(this.__repropagateChildrenInitialized=!0,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],initialize:!0,isTriggeredByUser:!1}})))}_onBeforeRepropagateChildrenValues(e){}__repropagateChildrenValues(e){this._onBeforeRepropagateChildrenValues(e);let t=e.detail&&e.detail.element||e.target,n=this._isRepropagationEndpoint||this._repropagationRole===`choice-group`;if(t===this)return;e.stopImmediatePropagation();let r=this._repropagationRole!==`child`&&!this.__repropagateChildrenInitialized,i=e.detail&&e.detail.initialize;if(r||i||!this._repropagationCondition(t))return;let a=[];n||(a=e.detail&&e.detail.formPath||[t]);let o=[...a,this];this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:o,isTriggeredByUser:!!e.detail?.isTriggeredByUser}}))}_repropagationCondition(e){return!!e}_onLabelClick(){}}),nd=class{constructor(){this.__running=!1,this.__queue=[]}add(e){this.__queue.push(e),this.__running||(this.complete=new Promise(e=>{this.__callComplete=e}),this.__run())}async __run(){this.__running=!0,await this.__queue[0](),this.__queue.shift(),this.__queue.length>0?this.__run():(this.__running=!1,this.__callComplete&&this.__callComplete())}};function rd(e){return e.charAt(0).toUpperCase()+e.slice(1)}var id=P(e=>class extends e{constructor(){super(),this.__SyncUpdatableNamespace={}}firstUpdated(e){super.firstUpdated(e),this.__syncUpdatableInitialize()}connectedCallback(){super.connectedCallback(),this.__SyncUpdatableNamespace.connected=!0}disconnectedCallback(){super.disconnectedCallback(),this.__SyncUpdatableNamespace.connected=!1}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];static __syncUpdatableHasChanged(e,t,n){let r=this.elementProperties;return r.get(e)&&r.get(e).hasChanged?r.get(e).hasChanged(t,n):t!==n}__syncUpdatableInitialize(){let e=this.__SyncUpdatableNamespace,t=this.constructor;e.initialized=!0,e.queue&&Array.from(e.queue).forEach(e=>{t.__syncUpdatableHasChanged(e,this[e],void 0)&&this.updateSync(e,void 0)})}requestUpdate(e,t,n){if(super.requestUpdate(e,t,n),e===void 0)return;this.__SyncUpdatableNamespace=this.__SyncUpdatableNamespace||{};let r=this.__SyncUpdatableNamespace,i=this.constructor;r.initialized?i.__syncUpdatableHasChanged(e,this[e],t)&&this.updateSync(e,t):(r.queue=r.queue||new Set,r.queue.add(e))}updateSync(e,t){}}),ad=e=>{switch(e){case`bg-BG`:return M(()=>import(`./bg-BG-D1PzAYJE.js`),__vite__mapDeps([0,1]),import.meta.url);case`bg`:return M(()=>import(`./bg-CaLj6eGF.js`),__vite__mapDeps([2,1]),import.meta.url);case`cs-CZ`:return M(()=>import(`./cs-CZ-_xpS7g3D.js`),__vite__mapDeps([3,4]),import.meta.url);case`cs`:return M(()=>import(`./cs-jpJvDXVj.js`),__vite__mapDeps([5,4]),import.meta.url);case`de-DE`:return M(()=>import(`./de-DE-jWPdxk-q.js`),__vite__mapDeps([6,7]),import.meta.url);case`de`:return M(()=>import(`./de-o0_2RAJE.js`),__vite__mapDeps([8,7]),import.meta.url);case`en-AU`:return M(()=>import(`./en-AU-BL9BHiRg.js`),__vite__mapDeps([9,10]),import.meta.url);case`en-GB`:return M(()=>import(`./en-GB-DtzQZHQ8.js`),__vite__mapDeps([11,10]),import.meta.url);case`en-US`:return M(()=>import(`./en-US-D2EoT8bz.js`),__vite__mapDeps([12,10]),import.meta.url);case`en-PH`:case`en`:return M(()=>import(`./en-CdiuKlsM.js`),__vite__mapDeps([13,10]),import.meta.url);case`es-ES`:return M(()=>import(`./es-ES-F9vp_qEs.js`),__vite__mapDeps([14,15]),import.meta.url);case`es`:return M(()=>import(`./es-Cy7JR_O2.js`),__vite__mapDeps([16,15]),import.meta.url);case`fr-FR`:return M(()=>import(`./fr-FR-DLfFDnlw.js`),__vite__mapDeps([17,18]),import.meta.url);case`fr-BE`:return M(()=>import(`./fr-BE-D2QZEajY.js`),__vite__mapDeps([19,18]),import.meta.url);case`fr`:return M(()=>import(`./fr-VX2N4AQs.js`),__vite__mapDeps([20,18]),import.meta.url);case`hu-HU`:return M(()=>import(`./hu-HU-ClAcJU0w.js`),__vite__mapDeps([21,22]),import.meta.url);case`hu`:return M(()=>import(`./hu-BIT9X7uB.js`),__vite__mapDeps([23,22]),import.meta.url);case`it-IT`:return M(()=>import(`./it-IT-THCuGZcY.js`),__vite__mapDeps([24,25]),import.meta.url);case`it`:return M(()=>import(`./it-DGDyvETe.js`),__vite__mapDeps([26,25]),import.meta.url);case`nl-BE`:return M(()=>import(`./nl-BE-iwKi4-Od.js`),__vite__mapDeps([27,28]),import.meta.url);case`nl-NL`:return M(()=>import(`./nl-NL-B_8k5NCi.js`),__vite__mapDeps([29,28]),import.meta.url);case`nl`:return M(()=>import(`./nl-D4ruUe4R.js`),__vite__mapDeps([30,28]),import.meta.url);case`pl-PL`:return M(()=>import(`./pl-PL-CQCl4FYm.js`),__vite__mapDeps([31,32]),import.meta.url);case`pl`:return M(()=>import(`./pl-ByKkwQ2L.js`),__vite__mapDeps([33,32]),import.meta.url);case`ro-RO`:return M(()=>import(`./ro-RO-DioaFHHs.js`),__vite__mapDeps([34,35]),import.meta.url);case`ro`:return M(()=>import(`./ro-DYVuDwLl.js`),__vite__mapDeps([36,35]),import.meta.url);case`ru-RU`:return M(()=>import(`./ru-RU-Bvqxxe1H.js`),__vite__mapDeps([37,38]),import.meta.url);case`ru`:return M(()=>import(`./ru-_Gos8_ka.js`),__vite__mapDeps([39,38]),import.meta.url);case`sk-SK`:return M(()=>import(`./sk-SK-lJjhV8vb.js`),__vite__mapDeps([40,41]),import.meta.url);case`sk`:return M(()=>import(`./sk-CF361bov.js`),__vite__mapDeps([42,41]),import.meta.url);case`tr-TR`:return M(()=>import(`./tr-TR-Du5_Q1Ow.js`),__vite__mapDeps([43,44]),import.meta.url);case`tr`:return M(()=>import(`./tr-DslQg4xK.js`),__vite__mapDeps([45,44]),import.meta.url);case`uk-UA`:return M(()=>import(`./uk-UA-CZ2390JH.js`),__vite__mapDeps([46,47]),import.meta.url);case`uk`:return M(()=>import(`./uk-C97tF43p.js`),__vite__mapDeps([48,47]),import.meta.url);case`zh-CN`:case`zh`:return M(()=>import(`./zh-DCINljX9.js`),[],import.meta.url);default:return M(()=>import(`./en-CdiuKlsM.js`),__vite__mapDeps([13,10]),import.meta.url)}},od=e=>`${e[0].toUpperCase()}${e.slice(1)}`,sd=class extends Wu(h){static get properties(){return{feedbackData:{attribute:!1}}}static localizeNamespaces=[{"lion-form-core":ad},...super.localizeNamespaces];static get styles(){return[d`
...
`,Vd=new WeakMap,Hd=class extends zd{static get styles(){return[...zd.styles,Bd]}constructor(){super(),this.hint=null,C(this,Vd,640),T(Vd,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10))}connectedCallback(){super.connectedCallback();let e=this.getBoundingClientRect().width??0;this.toggleAttribute(`wide`,e>=E(Vd,this))}render(){return l`
    ...
    `}};i([g()],Hd.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,Hd);var Ud=new WeakMap;function Wd(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Ud.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else Wd(n,t)})}function Gd(e){Ud.has(e)&&Ud.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Ud.has(e)&&Ud.get(e)():Gd(e)})}var Kd=class extends cd{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof $u}};function qd(e){return Array.isArray(e)?e:[e]}var Jd=P(e=>class extends yd(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(qd(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(qd(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(qd(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...qd(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Yd=new WeakMap,Xd=class extends Wu(Wa(Jd(Rd))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,d`
      ...
      `]}static get localizeNamespaces(){return[{"lion-combobox":e=>{switch(e){case`bg-BG`:case`bg`:return M(()=>import(`./bg-DENNfAPo.js`),[],import.meta.url);case`cs-CZ`:case`cs`:return M(()=>import(`./cs-BRkGZurU.js`),[],import.meta.url);case`de-AT`:case`de-DE`:case`de`:return M(()=>import(`./de-DBQrQjNv.js`),[],import.meta.url);case`en-AU`:case`en-GB`:case`en-PH`:case`en-US`:case`en`:return M(()=>import(`./en-wAmpBV7e.js`),[],import.meta.url);case`es-ES`:case`es`:return M(()=>import(`./es-DxFsnU_E.js`),[],import.meta.url);case`fr-FR`:case`fr-BE`:case`fr`:return M(()=>import(`./fr-Dc1HLDqb.js`),[],import.meta.url);case`hu-HU`:case`hu`:return M(()=>import(`./hu-DxR0zHcn.js`),[],import.meta.url);case`it-IT`:case`it`:return M(()=>import(`./it-L2tcishF.js`),[],import.meta.url);case`nl-BE`:case`nl-NL`:case`nl`:return M(()=>import(`./nl-Deu9hcOZ.js`),[],import.meta.url);case`pl-PL`:case`pl`:return M(()=>import(`./pl-DaHOHISp.js`),[],import.meta.url);case`ro-RO`:case`ro`:return M(()=>import(`./ro-8626Giac.js`),[],import.meta.url);case`ru-RU`:case`ru`:return M(()=>import(`./ru-BmKdtCdG.js`),[],import.meta.url);case`sk-SK`:case`sk`:return M(()=>import(`./sk-DPUOExT0.js`),[],import.meta.url);case`uk-UA`:case`uk`:return M(()=>import(`./uk-CzpPlxQl.js`),[],import.meta.url);case`zh-CN`:case`zh`:return M(()=>import(`./zh-rSqglkiQ.js`),[],import.meta.url);default:return M(()=>import(`./en-wAmpBV7e.js`),[],import.meta.url)}}},...super.localizeNamespaces]}get modelValue(){let e=super.modelValue;return e===``?this.parser(this.value):e}set modelValue(e){super.modelValue=e}get value(){return this._inputNode?.value||this.__value||``}set value(e){this._inputNode?(this._inputNode.value=e,this.__value=void 0):this.__value=e}reset(){super.reset(),this.multipleChoice||(this.value=this._initialModelValue),this._resetListboxOptions()}_resetListboxOptions(){this.formElements.forEach((e,t)=>{this._unhighlightMatchedOption(e),!this.showAllOnEmpty||!this.opened?e.style.display=`none`:(e.style.display=``,e.setAttribute(`aria-posinset`,`${t+1}`),e.setAttribute(`aria-setsize`,`${this.formElements.length}`),e.removeAttribute(`aria-hidden`))})}_inputGroupInputTemplate(){return l`
      <div class="input-group__input">

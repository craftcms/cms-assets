...
`,Qo=new WeakMap,$o=new WeakMap,es=new WeakMap,ts=new WeakMap,ns=new WeakMap,rs=class extends Bo{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,f(this,Qo,new Jo(this,()=>this.controller)),f(this,$o,null),f(this,es,()=>{this.submit()}),f(this,ts,()=>{this.busy||this.requestClose()}),f(this,ns,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&h($o,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),m($o,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&m(Qo,this).resubscribe();let t=m(Qo,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&m($o,this)?.observe(t)}renderHeader(){return r`
    ...
    `],p([g()],os.prototype,`label`,void 0),p([g()],os.prototype,`icon`,void 0),customElements.get(`craft-empty`)||customElements.define(`craft-empty`,os);var ss=a`
  :host {
    position: relative;
    display: block;
  }
...
`,cs=class extends gi(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=O(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[Nt,br,ss]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.updateComplete.then(()=>{this.addToAriaLabelledBy(this._labelNode),this.__wireDescribedBy()})}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
    ...
    `}__hasLightChild(e){return this.__lightChild(e)!==void 0}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`span`);t.className=`visually-hidden`,t.textContent=O(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};p([g({type:Boolean,reflect:!0})],cs.prototype,`required`,void 0),p([g({type:Boolean,reflect:!0})],cs.prototype,`translatable`,void 0),p([g({attribute:`translation-description`})],cs.prototype,`translationDescription`,void 0),p([g({type:Boolean,reflect:!0})],cs.prototype,`fieldset`,void 0),p([g({reflect:!0})],cs.prototype,`status`,void 0),p([g({attribute:`status-label`})],cs.prototype,`statusLabel`,void 0),p([g({reflect:!0})],cs.prototype,`orientation`,void 0),p([g({type:Boolean,reflect:!0,attribute:`has-errors`})],cs.prototype,`hasErrors`,void 0),p([g({attribute:`instructions-position`})],cs.prototype,`instructionsPosition`,void 0),p([g({type:String,reflect:!0})],cs.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,cs);var ls=class extends l{render(){return r`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,ls);var us=a`
  ${br}
...
`,ds=/^[0-9a-f]{6}$/i,fs=/^[0-9a-f]{3}$/i,ps={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function ms(e){return String(e??``).trim().replace(/^#/,``)}function hs(e){let t=ms(e);return fs.test(t)?t.split(``).map(e=>e+e).join(``):ds.test(t)?t:null}var gs=class e extends Bi{static get styles(){return[...super.styles,xr,us]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,ms(t)),e}}}parser(e){return ms(e)}formatter(e){return ms(e)}serializer(e){return ms(e)}deserializer(e){return ms(e)}preprocessor(e){let t=ms(e);if(t!==e)return t}get _expandedHexValue(){return hs(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>hs(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=ms(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
    ...
    `}};gs._browserSupportsColorInputs=null,p([g({converter:ps})],gs.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,gs);var _s=a`
  ::slotted(.form-control) {
    ${_r}
  }
...
`,ys=class extends V{static get styles(){return[...super.styles,vs]}_renderSuffix(){return r`<craft-copy-button
      tooltip-label="${O(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};p([g({type:String,attribute:`copy-value`})],ys.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,ys);var bs=class extends V{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,bs);var xs=new WeakSet,Ss=class extends V{constructor(){super(),d(this,xs),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,u(xs,this,Cs))}disconnectedCallback(){this.removeEventListener(`change`,u(xs,this,Cs)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),u(xs,this,ws).call(this)}};function Cs(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=u(xs,this,Ts).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}u(xs,this,ws).call(this)}}function ws(){let e=this._inputNode;if(!e)return;let t=u(xs,this,Es).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=u(xs,this,Es).call(this,e),i=u(xs,this,Es).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function Ts(e){let t=u(xs,this,Es).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function Es(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}p([g({type:Number,attribute:`minute-increment`})],Ss.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],Ss.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],Ss.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,Ss);var Ds={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},Os=new WeakSet,ks=new WeakMap,H=class extends l{constructor(...e){super(...e),d(this,Os),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,f(this,ks,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof V))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,m(ks,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,m(ks,this)),super.disconnectedCallback()}updated(e){super.updated(e),u(Os,this,As).call(this),u(Os,this,js).call(this),u(Os,this,Ms).call(this),u(Os,this,Ls).call(this,`locale`,this.locale,!0),u(Os,this,Ls).call(this,`timezone`,this.timezone,!this.showTimezone)}};function As(){let e=u(Os,this,Ns).call(this,`craft-input-date`,`date`,this.showDate);e instanceof bs&&(u(Os,this,Is).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,u(Os,this,Ps).call(this,e))}function js(){let e=u(Os,this,Ns).call(this,`craft-input-time`,`time`,this.showTime);e instanceof Ss&&(u(Os,this,Is).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,u(Os,this,Ps).call(this,e))}function Ms(){let e=u(Os,this,Ns).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(u(Os,this,Is).call(this,e,`timezone`,this.timezone??``,!1),u(Os,this,Ps).call(this,e))}function Ns(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof V);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Ps(e){e.parentElement!==this&&this.insertBefore(e,u(Os,this,Fs).call(this))}function Fs(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function Is(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function Ls(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}H.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,p([g()],H.prototype,`name`,void 0),p([g({attribute:`date-value`})],H.prototype,`dateValue`,void 0),p([g({attribute:`time-value`})],H.prototype,`timeValue`,void 0),p([g()],H.prototype,`locale`,void 0),p([g()],H.prototype,`timezone`,void 0),p([g({attribute:`show-date`,converter:Ds})],H.prototype,`showDate`,void 0),p([g({attribute:`show-time`,converter:Ds})],H.prototype,`showTime`,void 0),p([g({type:Boolean,attribute:`show-timezone`})],H.prototype,`showTimezone`,void 0),p([g()],H.prototype,`min`,void 0),p([g()],H.prototype,`max`,void 0),p([g({attribute:`min-time`})],H.prototype,`minTime`,void 0),p([g({attribute:`max-time`})],H.prototype,`maxTime`,void 0),p([g({type:Number,attribute:`minute-increment`})],H.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],H.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],H.prototype,`forceRoundTime`,void 0),p([g({type:Boolean})],H.prototype,`disabled`,void 0),p([g({type:Boolean})],H.prototype,`readonly`,void 0),p([g({type:Boolean})],H.prototype,`required`,void 0),p([g({attribute:`described-by`})],H.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,H);var Rs=class extends Ci{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},zs=class extends Ci{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Kr().msg(`lion-input-file:uploadTextDuplicateFileName`)}},Bs=524288e3,Vs={type:`FILE_TYPE`,size:`FILE_SIZE`},Hs={fail:`FAIL`,pass:`SUCCESS`},Us=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);Rs.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Hs.fail,this.failedProp.push(Vs.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;Rs.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Hs.fail,this.failedProp.push(Vs.type))}Rs.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Hs.fail&&(this.status=Hs.pass):(this.status=Hs.fail,this.failedProp.push(Vs.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Ws=e=>{switch(e){case`bg-BG`:return E(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return E(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return E(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return E(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return E(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return E(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return E(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return E(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return E(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return E(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return E(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return E(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return E(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return E(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return E(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return E(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return E(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return E(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return E(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return E(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return E(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return E(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return E(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return E(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return E(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return E(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return E(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return E(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return E(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return E(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return E(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return E(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return E(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return E(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Gs=class extends ai(di(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":Si}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Ws},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},Js=class extends Gs{static get styles(){return[...super.styles,a`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
...
`,Xs=class extends qs{static get styles(){return[...super.styles,xr,Ys]}get slots(){return{...super.slots,"file-select-button":()=>r`<craft-button
      ...
      `]}constructor(){super(),d(this,tc),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,f(this,nc,()=>{this.modelValue=``,this.value=``,u(tc,this,ic).call(this)?.inputmask?.setValue(``),u(tc,this,ic).call(this)?.focus()}),this.type=`text`,this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&u(tc,this,oc).call(this),u(tc,this,ic).call(this)?.classList.toggle(`money-placeholder`,!u(tc,this,sc).call(this))}disconnectedCallback(){u(tc,this,ic).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?r`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${u(tc,this,ac).call(this).currency}`}</span
      >
      ...
      <craft-button
        ...
        icon
        aria-label=${O(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!u(tc,this,sc).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${m(nc,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function ic(){return this._inputNode}function ac(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function oc(){let e=u(tc,this,ic).call(this);if(!e)return;let t=String(this.modelValue??``),n=u(tc,this,ac).call(this);e.inputmask?.remove(),e.value=t,new $s({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function sc(){return this.modelValue!==``&&this.modelValue!=null}p([g()],rc.prototype,`currency`,void 0),p([g()],rc.prototype,`locale`,void 0),p([g({type:Number})],rc.prototype,`decimals`,void 0),p([g({attribute:`decimal-separator`})],rc.prototype,`decimalSeparator`,void 0),p([g({attribute:`group-separator`})],rc.prototype,`groupSeparator`,void 0),p([g({converter:ec,attribute:`show-currency`})],rc.prototype,`showCurrency`,void 0),p([g({converter:ec})],rc.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,rc);var cc=new WeakSet,lc=class extends Bi{static get styles(){return[...super.styles,xr,a`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),d(this,cc),this.passwordRules=``,this._visible=!1,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>r`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),u(cc,this,uc).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&u(cc,this,uc).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function uc(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}p([g({attribute:`passwordrules`})],lc.prototype,`passwordRules`,void 0),p([_()],lc.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,lc);var dc=class extends l{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return r`
  ...
  `,p([g()],dc.prototype,`error`,void 0),p([g({attribute:`plugin-name`})],dc.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,dc);var fc=a`
  :host {
    display: block;
    /*
...
`,pc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(pc);var mc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(mc);var hc=new Set([`clip`,`hidden`]),gc=class extends fr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=pc.Raised,this.variant=mc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!hc.has(n)&&e.scrollHeight-e.clientHeight>1||!hc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};gc.styles=[_o,fc],p([g({reflect:!0})],gc.prototype,`appearance`,void 0),p([g({reflect:!0})],gc.prototype,`variant`,void 0),p([g()],gc.prototype,`label`,void 0),p([_()],gc.prototype,`_hasSlottedHeader`,void 0),p([_()],gc.prototype,`_hasSlottedFooter`,void 0),p([_()],gc.prototype,`_scrollable`,void 0),p([_()],gc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,gc);var _c=0,vc=new WeakMap,U=new WeakSet,yc=class extends l{constructor(...e){super(...e),d(this,U),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,vc,++_c)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(U,this,Ac).call(this)}render(){let e=u(U,this,Sc).call(this);return Ya(this.groups,e=>e.handle,(t,n)=>u(U,this,bc).call(this,t,n,e))}};function bc(e,t,n){let i=`permission-tree-heading-${m(vc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>u(U,this,Ec).call(this,e.keys,n)}
                >
                  ${u(U,this,Tc).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${u(U,this,xc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function xc(e,t,n,i){return Ya(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(U,this,wc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||u(U,this,Cc).call(this,o,i)}
                @model-value-changed=${e=>u(U,this,Dc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?u(U,this,xc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function Sc(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function Cc(e,t){return t.has(e.toLowerCase())}function wc(e,t){return this.modelValue.includes(e)||u(U,this,Cc).call(this,e,t)}function Tc(e,t){let n=e.filter(e=>!u(U,this,Cc).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function Ec(e,t){let n=e.filter(e=>!u(U,this,Cc).call(this,e,t));if(u(U,this,Tc).call(this,e,t)){let e=new Set(n);u(U,this,kc).call(this,this.modelValue.filter(t=>!e.has(t)));return}u(U,this,kc).call(this,[...new Set([...this.modelValue,...n])])}function Dc(e,t,n,r){if(e.stopPropagation(),this.disabled||u(U,this,Cc).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){u(U,this,kc).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...u(U,this,Oc).call(this,n)]);u(U,this,kc).call(this,this.modelValue.filter(e=>!o.has(e)))}function Oc(e){return Object.values(e).flatMap(e=>[e.key,...u(U,this,Oc).call(this,e.nested??{})])}function kc(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function Ac(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;u(U,this,jc).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&u(U,this,jc).call(this,`${this.name}[]`,t)}function jc(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}yc.styles=a`
    :host {
      display: block;
    }
  ...
  `,p([g({type:Array})],yc.prototype,`groups`,void 0),p([g({type:Array,attribute:`model-value`})],yc.prototype,`modelValue`,void 0),p([g({type:Array,attribute:`locked-permissions`})],yc.prototype,`lockedPermissions`,void 0),p([g()],yc.prototype,`name`,void 0),p([g({type:Boolean,reflect:!0})],yc.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,yc);var Mc=a`
  :host {
...
`,Nc=new WeakMap,Pc=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,f(this,Nc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&m(Nc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),h(Nc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,h(Nc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
      <div
    ...
    `}};Pc.styles=[Mc],p([g({type:Number})],Pc.prototype,`progress`,void 0),p([g({type:Number})],Pc.prototype,`total`,void 0),p([g({type:Number})],Pc.prototype,`processed`,void 0),p([g({type:Boolean,attribute:`show-status`})],Pc.prototype,`showStatus`,void 0),p([g({type:Boolean,reflect:!0})],Pc.prototype,`pending`,void 0),p([g({type:Boolean})],Pc.prototype,`smooth`,void 0),p([g({type:String})],Pc.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Pc);var Fc=class extends Pi(Ri(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Ic=class extends Ii(Bi){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Lc=class extends Fc{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,xr,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Lc.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Lc);var Rc=class extends Wi(Ic){static get styles(){return[...super.styles,a`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,Rc);var zc=a`
  craft-button {
    cursor: move;
  }
...
`,Bc=class extends l{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??O(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),i=t?n?`arrow-right`:`arrow-left`:`arrow-up`,a=t?n?`arrow-left`:`arrow-right`:`arrow-down`,o=O(t?`Move forward`:`Move up`),s=O(t?`Move backward`:`Move down`);return r`
    ...
    `}};Bc.styles=[zc],p([g()],Bc.prototype,`label`,void 0),p([g({reflect:!0})],Bc.prototype,`position`,void 0),p([g({reflect:!0})],Bc.prototype,`orientation`,void 0),p([g({reflect:!0})],Bc.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],Bc.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,Bc);var Vc=class extends He(Wt){static get styles(){return[...super.styles,a`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Gc=class extends Vc{static get styles(){return[...super.styles,Wc]}_afterTemplate(){return r`${this.singleOption?``:r`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},Kc=a`
  ${br}
...
`,qc=class extends Uc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Kc]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Gc}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return r`
    ...
    `}};p([g({reflect:!0,type:Boolean})],qc.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,qc);var Jc=a`
  :host {
    display: block;
  }
`;function Yc(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Xc=class extends l{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return r`<span
    ...
    ></span>`}_optionTemplate(e,t){return r`<craft-option .choiceValue=${e}>
      ...
      >
        ...
        ${tt.map(e=>this._optionTemplate(e,O(Yc(e))))}
      </craft-select-rich>
    `}};Xc.styles=[Jc],p([g()],Xc.prototype,`label`,void 0),p([g()],Xc.prototype,`name`,void 0),p([g({attribute:`model-value`})],Xc.prototype,`modelValue`,void 0),p([g({type:Boolean,reflect:!0,attribute:`allow-transparent`})],Xc.prototype,`allowTransparent`,void 0),customElements.get(`craft-select-color`)||customElements.define(`craft-select-color`,Xc);var Zc=class extends ki{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>e.slot===`input`)}},Qc=class extends Zc{get operationMode(){return`select`}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener(`change`,this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:`model`})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has(`disabled`)&&(this._inputNode.disabled=this.disabled,this.validate()),e.has(`name`)&&(this._inputNode.name=this.name),e.has(`autocomplete`)&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener(`change`,this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){let t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:``}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=this.modelValue===void 0?``:this.modelValue)}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent(`user-input-changed`,{bubbles:!0,composed:!0}))}},$c=a`
  ${br}
...
`,el=class extends Qc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,$c]}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};p([g({reflect:!0,type:Boolean})],el.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,el);var tl=a`
  :host {
    display: inline-block;
  }
...
`,W=new WeakSet,nl=class extends l{constructor(...e){super(...e),d(this,W),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(W,this,il).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(W,this,rl).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${u(W,this,ol).call(this,this.value)}
      ...
      >
        ${e.map(e=>r`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(W,this,cl).call(this,e)}
              title=${u(W,this,ol).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function rl(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function il(e){u(W,this,rl).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function al(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function ol(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function sl(e,t){let n=u(W,this,il).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function cl(e){this.readOnly||u(W,this,sl).call(this,e,!0)}function ll(e){if(this.readOnly)return;let t=u(W,this,al).call(this);switch(e.key){case`ArrowUp`:u(W,this,sl).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(W,this,sl).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(W,this,sl).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(W,this,sl).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(W,this,sl).call(this,this.min,!0),e.preventDefault();break;case`End`:u(W,this,sl).call(this,this.max,!0),e.preventDefault();break}}nl.styles=[tl],p([g({type:Number})],nl.prototype,`min`,void 0),p([g({type:Number})],nl.prototype,`max`,void 0),p([g({type:Number})],nl.prototype,`step`,void 0),p([g({type:Number})],nl.prototype,`value`,void 0),p([g()],nl.prototype,`label`,void 0),p([g({attribute:`described-by`})],nl.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],nl.prototype,`valueUnit`,void 0),p([g({attribute:!1})],nl.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],nl.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,nl);var ul=a`
  :host {
    display: block;
  }
...
`,dl=new WeakMap,fl=new WeakMap,pl=new WeakMap,ml=new WeakMap,hl=new WeakMap,gl=new WeakMap,G=new WeakSet,_l=class extends l{constructor(...e){super(...e),d(this,G),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,dl,!1),f(this,fl,!1),f(this,pl,0),f(this,ml,0),f(this,hl,0),f(this,gl,null)}connectedCallback(){super.connectedCallback(),h(gl,this,new ResizeObserver(()=>u(G,this,yl).call(this))),m(gl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(gl,this)?.disconnect(),h(gl,this,null)}firstUpdated(){h(hl,this,(u(G,this,vl).call(this).length-1)*10),u(G,this,yl).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(G,this,yl).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(G,this,bl).call(this,this.value)}
        @keydown=${u(G,this,kl)}
        @pointerdown=${u(G,this,Tl)}
        @pointermove=${u(G,this,El)}
        @pointerup=${u(G,this,Dl)}
      >
        <div class="overlay"></div>
        <div class="cursor"></div>
        <div class="graduations">
          <ul aria-hidden="true">
            ${u(G,this,vl).call(this).map(e=>r`
                <li
                  class=${k({graduation:!0,"main-graduation":e%5==0,selected:u(G,this,Al).call(this,e)})}
                  data-graduation=${e}
                >
    ...
    `}};function vl(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function yl(){this._list&&(this._list.style.left=`${u(G,this,Sl).call(this,this.value)}px`)}function bl(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function xl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(hl,this)*n-t}function Sl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(hl,this)/n-this._graduations.offsetWidth/2)}function Cl(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);this.value=n,t&&u(G,this,wl).call(this,`change`)}function wl(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function Tl(e){h(fl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(fl,this)&&(e.preventDefault(),h(pl,this,e.clientX),h(ml,this,this._list.offsetLeft),this._root.setPointerCapture(e.pointerId),u(G,this,wl).call(this,`start`))}function El(e){m(fl,this)&&Math.abs(e.clientX-m(pl,this))>3&&(h(dl,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(G,this,Ol).call(this,e))}function Dl(e){m(fl,this)&&(m(dl,this)?(e.preventDefault(),h(dl,this,!1),this._root.classList.remove(`dragging`)):u(G,this,Ol).call(this,e),u(G,this,wl).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(pl,this,0),h(fl,this,!1))}function Ol(e){let t=m(dl,this)?m(pl,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(dl,this)?t-e.clientX:e.clientX-t,r=m(ml,this)-n;u(G,this,Cl).call(this,u(G,this,xl).call(this,r))}function kl(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(G,this,Cl).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(G,this,Cl).call(this,t-1);break;case`PageUp`:u(G,this,Cl).call(this,t+10);break;case`PageDown`:u(G,this,Cl).call(this,t-10);break;case`Home`:u(G,this,Cl).call(this,this.min);break;case`End`:u(G,this,Cl).call(this,this.max);break;default:return}e.preventDefault()}function Al(e){return e>=Math.min(0,this.value)&&e<=Math.max(0,this.value)}_l.styles=[ul],p([g({type:Number})],_l.prototype,`min`,void 0),p([g({type:Number})],_l.prototype,`max`,void 0),p([g({type:Number})],_l.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],_l.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],_l.prototype,`graduationMax`,void 0),p([g()],_l.prototype,`label`,void 0),p([y(`.slide-rule`)],_l.prototype,`_root`,void 0),p([y(`.graduations`)],_l.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],_l.prototype,`_list`,void 0),p([y(`.cursor`)],_l.prototype,`_cursor`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,_l);var jl=a`
  :host {
    display: inline-flex;
...
`,Ml=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      <span
      ...
      ></span>
    `}};Ml.styles=[jl],p([g()],Ml.prototype,`label`,void 0),p([g()],Ml.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Ml);var Nl=class extends Oe(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},Fl=class extends Nl{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Fl.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,Fl);var Il=a`
  :host {
    display: grid;
  }
...
`;function Ll(e){return(e??``).split(/\s+/).filter(Boolean)}function Rl(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var zl=Symbol.for(`craft-switch-synthetic-change`),Bl=new WeakMap,Vl=new WeakSet,Hl=class extends Pl{constructor(...e){super(...e),d(this,Vl),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,f(this,Bl,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,br,Il]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Fl}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?O(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?O(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){u(Vl,this,Ul).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){u(Vl,this,Ul).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){u(Vl,this,Ul).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(m(Bl,this))return;let e=new Event(`change`,{bubbles:!0});e[zl]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&zl in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of Ll(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of Ll(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Rl(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
    ...
    `}};function Ul(e,t){if(!this.disabled){if(!t){e();return}h(Bl,this,!0),e(),this.updateComplete.then(()=>{h(Bl,this,!1)})}}p([g({type:String,reflect:!0})],Hl.prototype,`size`,void 0),p([g({type:String,attribute:`on-label`})],Hl.prototype,`onLabel`,void 0),p([g({type:String,attribute:`off-label`})],Hl.prototype,`offLabel`,void 0),p([g({attribute:`value`})],Hl.prototype,`checkedValue`,void 0),p([g({attribute:`indeterminate-value`})],Hl.prototype,`indeterminateValue`,void 0),p([g({type:Boolean,reflect:!0})],Hl.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,Hl);function Wl({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function Gl(e){e.setAttribute(`selected`,`true`)}function Kl(e){e.removeAttribute(`selected`)}function ql({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function Jl({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function Yl(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function Xl(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function Zl(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var Ql=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,eu={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(eu);var tu={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(tu);var nu=[eu.InlineStart,eu.InlineEnd],ru=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),K=new WeakSet,iu=new WeakMap,au=new WeakMap,ou=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakMap,du=new WeakMap,fu=new WeakMap,pu=new WeakMap,mu=new WeakMap,hu=class extends Ql{constructor(...e){super(...e),d(this,K),this.placement=eu.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,iu,[]),f(this,au,!1),f(this,ou,[]),f(this,su,0),f(this,cu,void 0),f(this,lu,!1),f(this,uu,e=>{if(!this.collapsible||_u.call(u(K,this)))return;let t=u(K,this,xu).call(this,e.target);!t||t.disabled||vu.call(u(K,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(K,this,Su).call(this,!0))}),f(this,du,e=>{e.key!==`Escape`||!this.collapsible||_u.call(u(K,this))||u(K,this,xu).call(this,e.target)&&(e.stopPropagation(),u(K,this,Su).call(this,!0))}),f(this,fu,()=>{_u.call(u(K,this))&&(vu.call(u(K,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(K,this,Cu).call(this)}),f(this,pu,()=>{if(u(K,this,wu).call(this),vu.call(u(K,this)).forEach((e,t)=>{let n=()=>u(K,this,Mu).call(this,t,!0),r=e=>{ru.has(e.key)&&e.preventDefault()},i=e=>u(K,this,Nu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(iu,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),vu.call(u(K,this))[this.selectedIndex]?.disabled){let e=vu.call(u(K,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(K,this,Tu).call(this)}),f(this,mu,()=>{m(lu,this)||(h(lu,this,!0),requestAnimationFrame(()=>{h(lu,this,!1),u(K,this,Du).call(this)}))})}static get styles(){return[...super.styles,_o,$l]}get layout(){return gu.call(u(K,this))?tu.Vertical:tu.Horizontal}set layout(e){this.placement=e===tu.Vertical?eu.InlineStart:eu.BlockStart}refresh(){m(au,this)&&u(K,this,Tu).call(this),u(K,this,Du).call(this)}firstUpdated(e){h(au,this,vu.call(u(K,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(au,this))t?.addEventListener(`slotchange`,m(pu,this)),m(pu,this).call(this);else{let n=_u.call(u(K,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(fu,this))}this.addEventListener(`click`,m(uu,this),!0),this.addEventListener(`keydown`,m(du,this)),t?.addEventListener(`slotchange`,m(mu,this)),h(cu,this,new ResizeObserver(m(mu,this))),m(cu,this).observe(this),u(K,this,Du).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(K,this,wu).call(this),m(cu,this)?.disconnect(),h(cu,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,_u.call(u(K,this))),e.has(`selectedIndex`)&&(m(au,this)?u(K,this,Tu).call(this):m(fu,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(K,this,Du).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${gu.call(u(K,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${_u.call(u(K,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function gu(){return nu.includes(this.placement)}function _u(){return this.selectedIndex<0}function vu(){return this.tabs}function yu(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function bu(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function xu(e){return e instanceof Node?vu.call(u(K,this)).find(t=>t===e||t.contains(e))??null:null}function Su(e){let t=vu.call(u(K,this))[this.selectedIndex];h(su,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Cu(){let e=vu.call(u(K,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(su,this))?m(su,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function wu(){for(;m(iu,this).length;)m(iu,this).pop()?.()}function Tu(){let e=vu.call(u(K,this)).map(e=>u(K,this,Eu).call(this,e)),t=e.some(Boolean);vu.call(u(K,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Ue()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(K,this,Cu).call(this)}function Eu(e){return e.controls?document.getElementById(e.controls):null}function Du(){let e=yu.call(u(K,this)),t=bu.call(u(K,this)),n=vu.call(u(K,this));if(!e||!t)return;if(gu.call(u(K,this))||n.length===0){u(K,this,ku).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(K,this,Ou).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(K,this,ku).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(K,this,ku).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Ou(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function ku(e){let t=bu.call(u(K,this)),n=new Set(e);vu.call(u(K,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(ou,this,e),t&&(t.hidden=e.length===0,t.actions=u(K,this,Au).call(this))}function Au(){return m(ou,this).map(e=>{let t=vu.call(u(K,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(K,this,ju).call(this,e)}})}function ju(e){let t=vu.call(u(K,this))[e];if(!t||t.disabled)return;let n=bu.call(u(K,this));n&&(n.opened=!1),this.selectedIndex=e,u(K,this,Du).call(this),t.focus()}function Mu(e,t){let n=vu.call(u(K,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Nu(e){if(!ru.has(e.key))return;let t=u(K,this,Pu).call(this,e.key);t!==-1&&u(K,this,Mu).call(this,t,!0)}function Pu(e){let t=vu.call(u(K,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(_u.call(u(K,this)))return u(K,this,Pu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],hu.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],hu.prototype,`collapsible`,void 0),p([g({reflect:!0})],hu.prototype,`layout`,null),p([g({reflect:!0})],hu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,hu);var Fu=a`
  :host {
    display: inline-flex;
...
`,Gu=C(ue(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?t.exports=r():typeof define==`function`&&define.amd?define(r):(n||=self,n.autosize=r())})(e,(function(){var e=new Map;function t(t){if(!t||!t.nodeName||t.nodeName!==`TEXTAREA`||e.has(t))return;var n=null;function r(e){for(var t=[];e&&e.parentNode&&e.parentNode instanceof Element;)e.parentNode.scrollTop&&t.push([e.parentNode,e.parentNode.scrollTop]),e=e.parentNode;return function(){return t.forEach(function(e){var t=e[0],n=e[1];t.style.scrollBehavior=`auto`,t.scrollTop=n,t.style.scrollBehavior=null})}}var i=window.getComputedStyle(t);function a(e){var o=e.restoreTextAlign,s=o===void 0?null:o,c=e.testForHeightReduction,l=c===void 0||c,u=i.overflowY;if(t.scrollHeight!==0){i.resize===`vertical`?t.style.resize=`none`:i.resize===`both`&&(t.style.resize=`horizontal`);var d;l&&(d=r(t),t.style.height=``);var f=i.boxSizing===`content-box`?t.scrollHeight-(parseFloat(i.paddingTop)+parseFloat(i.paddingBottom)):t.scrollHeight+parseFloat(i.borderTopWidth)+parseFloat(i.borderBottomWidth);if(i.maxHeight!==`none`&&f>parseFloat(i.maxHeight)?(i.overflowY===`hidden`&&(t.style.overflow=`scroll`),f=parseFloat(i.maxHeight)):i.overflowY!==`hidden`&&(t.style.overflow=`hidden`),t.style.height=f+`px`,s&&(t.style.textAlign=s),d&&d(),n!==f&&(t.dispatchEvent(new Event(`autosize:resized`,{bubbles:!0})),n=f),u!==i.overflow&&!s){var p=i.textAlign;i.overflow===`hidden`&&(t.style.textAlign=p===`start`?`end`:`start`),a({restoreTextAlign:p,testForHeightReduction:!0})}}}function o(){a({testForHeightReduction:!0,restoreTextAlign:null})}var s=function(){var e=t.value;return function(){a({testForHeightReduction:e===``||!t.value.startsWith(e),restoreTextAlign:null}),e=t.value}}(),c=function(n){t.removeEventListener(`autosize:destroy`,c),t.removeEventListener(`autosize:update`,o),t.removeEventListener(`input`,s),window.removeEventListener(`resize`,o),Object.keys(n).forEach(function(e){return t.style[e]=n[e]}),e.delete(t)}.bind(t,{height:t.style.height,resize:t.style.resize,textAlign:t.style.textAlign,overflowY:t.style.overflowY,overflowX:t.style.overflowX,wordWrap:t.style.wordWrap});t.addEventListener(`autosize:destroy`,c),t.addEventListener(`autosize:update`,o),t.addEventListener(`input`,s),window.addEventListener(`resize`,o),t.style.overflowX=`hidden`,t.style.wordWrap=`break-word`,e.set(t,{destroy:c,update:o}),o()}function n(t){var n=e.get(t);n&&n.destroy()}function r(t){var n=e.get(t);n&&n.update()}var i=null;return typeof window>`u`?(i=function(e){return e},i.destroy=function(e){return e},i.update=function(e){return e}):(i=function(e,n){return e&&Array.prototype.forEach.call(e.length?e:[e],function(e){return t(e)}),e},i.destroy=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],n),e},i.update=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],r),e}),i}))}))(),1),Ku=new WeakMap,qu=new WeakMap,Ju=new WeakMap,Yu=new WeakSet,Xu=class extends Uu{constructor(...e){super(...e),d(this,Yu),this.monospace=!1,f(this,Ku,void 0),f(this,qu,void 0),f(this,Ju,null)}static get styles(){return[...super.styles,xr,Wu]}connectedCallback(){super.connectedCallback(),u(Yu,this,Zu).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(Ku,this)?.disconnect(),h(Ku,this,void 0),m(qu,this)?.disconnect(),h(qu,this,void 0)}};function Zu(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(Ju,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(Ju,this,e.style.height)}),h(qu,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(qu,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(Ku,this,new ResizeObserver(()=>{if(e.style.height===m(Ju,this))return;let t=e.style.height;Gu.default.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(qu,this)?.disconnect(),h(qu,this,void 0),m(Ku,this)?.disconnect(),h(Ku,this,void 0)})),m(Ku,this).observe(e))}p([g({type:Boolean,reflect:!0})],Xu.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Xu);var Qu=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>$u(e,this),this.compositionEventHandler=e=>ad(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,ed),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,ed)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(id)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(id)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(id),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),rd(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function $u(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:td(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&td(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function ed(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&nd(t,{event:e})}function td(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function nd(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function rd(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function id(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function ad(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var od=class extends Event{constructor(){super(`update`)}},sd=new WeakMap,cd=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=sd.get(t);return n||(n=new e(t),sd.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),sd.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new od)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of ld)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},ld=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),ud=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return cd.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},dd=a`
  :host {
    display: contents;
  }
...
`,fd=/^[\p{L}\p{N}_.-]*$/u,pd=O(`Suggestions`),md=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],hd={handlesAccessibility:!1,visibilityTriggerFunction:void 0},gd=0,q=new WeakMap,_d=new WeakMap,vd=new WeakMap,yd=new WeakMap,J=new WeakMap,bd=new WeakMap,xd=new WeakMap,Sd=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,Y=new WeakSet,kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Bd=class extends l{constructor(...e){super(...e),d(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,q,void 0),f(this,_d,null),f(this,vd,null),f(this,yd,new Map),f(this,J,null),f(this,bd,[]),f(this,xd,0),f(this,Sd,null),f(this,Cd,null),f(this,wd,null),f(this,Td,!1),f(this,Ed,null),f(this,Dd,new DOMRect),f(this,Od,new MutationObserver(()=>{let e=u(Y,this,Hd).call(this);(df(e)&&e!==m(_d,this)||m(_d,this)&&!m(_d,this).isConnected)&&u(Y,this,Ud).call(this)})),f(this,kd,()=>{m(Td,this)||u(Y,this,Xd).call(this)}),f(this,Ad,()=>{h(Td,this,!0),u(Y,this,af).call(this)}),f(this,jd,()=>{h(Td,this,!1),u(Y,this,Xd).call(this)}),f(this,Md,()=>{queueMicrotask(()=>u(Y,this,af).call(this))}),f(this,Nd,()=>{let e=m(_d,this);!e||!m(J,this)||!ff(e)||queueMicrotask(()=>{m(J,this)&&(e.selectionStart!==m(J,this).end||e.selectionEnd!==m(J,this).end)&&u(Y,this,Xd).call(this)})}),f(this,Pd,()=>{m(J,this)&&u(Y,this,rf).call(this)}),f(this,Fd,e=>{let t=e;m(J,this)&&m(q,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,Id,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,Ld,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,Rd,e=>{u(Y,this,ef).call(this,Number(e.target.dataset.index))}),f(this,zd,e=>{if(e.target!==this.popoverElement)return;let t=m(q,this).getAttribute(`aria-label`)??pd;u(Y,this,cf).call(this),h(J,this,null),u(Y,this,sf).call(this),u(Y,this,lf).call(this,t===pd?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(Y,this,Vd).call(this),this.hasUpdated&&u(Y,this,Ud).call(this)}disconnectedCallback(){u(Y,this,Gd).call(this),m(q,this)?.remove(),m(wd,this)!==null&&(clearTimeout(m(wd,this)),h(wd,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(Y,this,Ud).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(_d,this)!==u(Y,this,Hd).call(this)&&u(Y,this,Ud).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(J,this)){let e=m(q,this).querySelector(`[aria-selected="true"]`),t=e?m(bd,this)[Number(e.dataset.index)]:void 0;u(Y,this,Xd).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${hd}
    ...
    `}};function Vd(){h(q,this,document.createElement(`div`)),m(q,this).id=`craft-text-expander-listbox-${++gd}`,m(q,this).slot=`listbox`,m(q,this).setAttribute(`part`,`listbox`),m(q,this).role=`listbox`,m(q,this).setAttribute(`aria-label`,pd),m(q,this).addEventListener(`pointerdown`,m(Id,this)),m(q,this).addEventListener(`pointerup`,m(Ld,this)),m(q,this).addEventListener(`combobox-commit`,m(Rd,this)),this.append(m(q,this))}function Hd(){return this.getRootNode().getElementById(this.for)}function Ud(){let e=u(Y,this,Hd).call(this);if(u(Y,this,Gd).call(this),!df(e)){u(Y,this,Wd).call(this);return}h(_d,this,e),u(Y,this,Kd).call(this,e),h(vd,this,new Qu(e,m(q,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(Y,this,qd).call(this,e),e.addEventListener(`input`,m(kd,this)),e.addEventListener(`keydown`,m(Fd,this)),e.addEventListener(`blur`,m(Md,this)),e.addEventListener(`compositionstart`,m(Ad,this)),e.addEventListener(`compositionend`,m(jd,this)),e.ownerDocument.addEventListener(`selectionchange`,m(Nd,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(Dd,this)},u(Y,this,Wd).call(this)}function Wd(){m(Od,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function Gd(){m(Od,this).disconnect(),u(Y,this,af).call(this);let e=m(_d,this);e&&(e.removeEventListener(`input`,m(kd,this)),e.removeEventListener(`keydown`,m(Fd,this)),e.removeEventListener(`blur`,m(Md,this)),e.removeEventListener(`compositionstart`,m(Ad,this)),e.removeEventListener(`compositionend`,m(jd,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(Nd,this)),m(Ed,this)?.getStyleClone().disconnect(),h(Ed,this,null),m(vd,this)?.destroy(),h(vd,this,null),u(Y,this,Jd).call(this,e),h(_d,this,null))}function Kd(e){m(yd,this).clear();for(let t of md)m(yd,this).set(t,e.getAttribute(t))}function qd(e){let t=[m(yd,this).get(`aria-controls`),m(q,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(Y,this,Yd).call(this,e,`aria-haspopup`),u(Y,this,Yd).call(this,e,`aria-expanded`)}function Jd(e){for(let t of md)u(Y,this,Yd).call(this,e,t);m(yd,this).clear()}function Yd(e,t){let n=m(yd,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function Xd(e){u(Y,this,cf).call(this);let t=u(Y,this,Qd).call(this);if(!t){h(J,this,null),u(Y,this,of).call(this);return}h(J,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(Y,this,$d).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(Y,this,$d).call(this,[]),u(Y,this,lf).call(this,O(`Loading`));let r=m(xd,this);h(Cd,this,setTimeout(()=>{u(Y,this,Zd).call(this,t,n,r,e)},150))}async function Zd(e,t,n,r){h(Sd,this,new AbortController);let i;try{let n=await ve.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(Sd,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(xd,this)||pf(t))return;u(Y,this,af).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(xd,this)&&(this.loading=!1,u(Y,this,$d).call(this,t===void 0?i:i.slice(0,t),r))}function Qd(){let e=m(_d,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!ff(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&fd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function $d(e,t){if(u(Y,this,nf).call(this),h(bd,this,e),m(q,this).replaceChildren(),m(q,this).hidden=this.loading,m(q,this).setAttribute(`aria-label`,m(J,this)?.trigger.label??pd),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=uf(e);n.id=`${m(q,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(J,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(q,this).append(n)}),!this.loading&&!e.length){h(J,this,null),u(Y,this,of).call(this),u(Y,this,lf).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(J,this)&&u(Y,this,tf).call(this,t)})}function ef(e){let t=m(_d,this),n=m(bd,this)[e],r=u(Y,this,Qd).call(this),i=m(J,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(Y,this,af).call(this);return}mf(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(Y,this,af).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function tf(e){await this.popoverElement.updateComplete;let t=m(_d,this);if(!t||!u(Y,this,rf).call(this)){u(Y,this,af).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(J,this)||t!==m(_d,this))&&m(bd,this).length&&(m(vd,this)?.start(),u(Y,this,Yd).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(kd,this)),t.addEventListener(`input`,m(kd,this)),e)){let t=m(bd,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(vd,this)?.navigate(1)}}function nf(){m(vd,this)?.stop(),m(_d,this)&&u(Y,this,Yd).call(this,m(_d,this),`aria-expanded`)}function rf(){let e=m(_d,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(Ed,this)){h(Ed,this,new ud(e));let t=m(Ed,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(Pd,this))}return m(Ed,this).setStartOffset(t),m(Ed,this).setEndOffset(t),h(Dd,this,m(Ed,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function af(){u(Y,this,cf).call(this),h(J,this,null),u(Y,this,of).call(this)}function of(){u(Y,this,sf).call(this),this.popoverElement.hide()}function sf(){this.loading=!1,u(Y,this,nf).call(this),h(bd,this,[]),m(q,this)?.replaceChildren(),m(q,this)&&(m(q,this).hidden=!1);let e=m(_d,this);e&&(u(Y,this,Yd).call(this,e,`aria-activedescendant`),u(Y,this,Yd).call(this,e,`aria-busy`))}function cf(){var e;h(xd,this,(e=m(xd,this),e++,e)),m(Cd,this)&&(clearTimeout(m(Cd,this)),h(Cd,this,null)),m(Sd,this)?.abort(),h(Sd,this,null)}function lf(e){m(wd,this)!==null&&(clearTimeout(m(wd,this)),h(wd,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(wd,this,setTimeout(()=>{h(wd,this,null),this.announcement=``},5e3))}Bd.styles=[Nt,dd],p([g({reflect:!0})],Bd.prototype,`for`,void 0),p([g({type:Array})],Bd.prototype,`triggers`,void 0),p([_()],Bd.prototype,`loading`,void 0),p([_()],Bd.prototype,`announcement`,void 0),p([y(`craft-popover`)],Bd.prototype,`popoverElement`,void 0);function uf(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function df(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function ff(e){return e.getRootNode().activeElement===e}function pf(e){return e instanceof DOMException&&e.name===`AbortError`}function mf(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Bd);var hf=a`
  :host {
    display: inline-flex;
...
`,gf=new WeakMap,_f=new WeakSet,vf=class extends l{constructor(...e){super(...e),d(this,_f),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,f(this,gf,typeof ResizeObserver<`u`?new ResizeObserver(()=>u(_f,this,yf).call(this)):null)}connectedCallback(){super.connectedCallback(),m(gf,this)?.observe(this)}disconnectedCallback(){m(gf,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){u(_f,this,yf).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${u(_f,this,bf)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function yf(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function bf(){u(_f,this,yf).call(this)}vf.styles=hf,p([g({reflect:!0})],vf.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],vf.prototype,`disabled`,void 0),p([_()],vf.prototype,`overflowing`,void 0),p([_()],vf.prototype,`text`,void 0),p([y(`.truncate`)],vf.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,vf);var xf=a`
  :host {
...
`,Sf={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},Cf=class extends l{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs()}render(){return r`
    ...
    `}};Cf.styles=[xf],p([g()],Cf.prototype,`src`,void 0),p([g({reflect:!0})],Cf.prototype,`mode`,void 0),p([g()],Cf.prototype,`srcset`,void 0),p([g()],Cf.prototype,`sizes`,void 0),p([g()],Cf.prototype,`alt`,void 0),p([g({type:Number})],Cf.prototype,`width`,void 0),p([g({type:Number})],Cf.prototype,`height`,void 0),p([g()],Cf.prototype,`loading`,void 0),p([g({reflect:!0,converter:Sf})],Cf.prototype,`checkered`,void 0),p([g({type:Boolean,reflect:!0})],Cf.prototype,`rounded`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,Cf);var wf=new WeakMap,Tf=new WeakSet,Ef=class extends HTMLElement{constructor(...e){super(...e),d(this,Tf),f(this,wf,null)}connectedCallback(){u(Tf,this,Df).call(this)}disconnectedCallback(){m(wf,this)?.destroy(),h(wf,this,null)}};function Df(){if(!(m(wf,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>u(Tf,this,Df).call(this));return}h(wf,this,new _a),m(wf,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Ef);var Of=!1,kf=null;async function Af(e){if(!Of){if(kf)return kf;Of=!0;try{return(await ve.post(`app/api-headers`,void 0,{cancelToken:e})).data}catch{}finally{Of=!1}}}var jf=x.create({baseURL:`https://api.craftcms.com/v1/`});async function Mf(e){return kf?Object.entries(kf).forEach(([t,n])=>{e.headers.set(t,n)}):(e.params=e.params||{},e.params.processCraftHeaders=1),e}async function Nf(e,t){if(kf)return;let{data:n}=await ve.post(`app/process-api-response-headers`,{headers:e},{cancelToken:t});return kf=n,Of=!1,kf}async function Pf(e){return await Nf(e.headers,e.config.cancelToken),e}jf.interceptors.request.use(async e=>{let{cancelToken:t}=e,n=await Af(t);n&&Object.entries(n).forEach(([t,n])=>{e.headers.set(t,n)});let r={...e,params:{...Cp.apiParams||{},...e.params,v:new Date().getTime()}};return n||(r.params.processCraftHeaders=1),Cp.httpProxy&&(r.proxy=Cp.httpProxy),r}),jf.interceptors.request.use(Mf),jf.interceptors.response.use(Pf);function Ff(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function If(e={}){let t=Ff({...e,type:`submit`,label:e.label||O(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function Lf(e={}){let t=Ff({...e,icon:`duplicate`,label:e.label||ma(O(`Paste {type}`,{type:O(`elements`)}))});return t.classList.add(`paste-btn`),t}var Rf=async(e,t)=>{let{data:n}=await ve.post(e,t);return n},zf=new WeakMap,Bf=new WeakMap,Vf=new WeakMap,Hf=new WeakMap,Uf=new WeakMap,Wf=new WeakMap,Gf=new WeakMap,Kf=new WeakMap,qf=new WeakMap,Jf=new WeakMap,X=new WeakSet,Yf=class e{constructor(t){d(this,X),f(this,zf,null),f(this,Bf,[]),f(this,Vf,[]),f(this,Hf,null),f(this,Uf,!1),f(this,Wf,!1),f(this,Gf,!1),f(this,Kf,null),f(this,qf,void 0),f(this,Jf,new Map),this.options={...e.defaults,modalTitle:O(`Select element`),selectBtnLabel:O(`Select`),...ep(t)},h(Vf,this,[...this.options.disabledElementIds??[]]),h(qf,this,u(X,this,Xf).call(this))}get elementType(){return this.options.elementType}get state(){return m(qf,this)}get index(){return m(zf,this)}get hasSelection(){return m(Bf,this).length>0}on(e,t){let n=m(Jf,this).get(e);return n||(n=new Set,m(Jf,this).set(e,n)),n.add(t),()=>{m(Jf,this).get(e)?.delete(t)}}async open(){h(Bf,this,[]),m(zf,this)?.clearSelection(),m(Uf,this)||(h(Uf,this,!0),u(X,this,$f).call(this,`open`,void 0)),u(X,this,Zf).call(this),m(Hf,this)||await this.reload()}close(){m(Uf,this)&&(h(Uf,this,!1),u(X,this,$f).call(this,`close`,void 0),this.options.onClose?.(),u(X,this,Zf).call(this))}destroy(){m(zf,this)?.destroy?.(),h(zf,this,null),h(Bf,this,[]),h(Hf,this,null),h(Uf,this,!1),h(Gf,this,!1),h(Wf,this,!1),h(Kf,this,null),u(X,this,Zf).call(this),m(Jf,this).clear()}async reload(){let e=this.options.loadIndexBody??Rf;h(Wf,this,!0),h(Kf,this,null),u(X,this,Zf).call(this);try{h(Hf,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){u(X,this,Qf).call(this,e)}finally{h(Wf,this,!1),u(X,this,Zf).call(this)}}async submit(){if(!m(qf,this).canSubmit)return;let e=this.buildElementInfo(m(Bf,this)),t=this.selectMeta();h(Gf,this,!0),u(X,this,Zf).call(this);try{u(X,this,$f).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){u(X,this,Qf).call(this,e);return}finally{h(Gf,this,!1),u(X,this,Zf).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...m(Vf,this),...e.map(e=>Number(e.id))]),m(zf,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){m(qf,this).canCancel&&(u(X,this,$f).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){h(zf,this,e),u(X,this,Zf).call(this)}detachIndex(){h(zf,this,null),u(X,this,Zf).call(this)}setSelection(e){h(Bf,this,[...e]),u(X,this,Zf).call(this)}setDisabledElementIds(e){h(Vf,this,[...new Set(e.map(Number))]),u(X,this,Zf).call(this)}setBusy(e){h(Gf,this,e),u(X,this,Zf).call(this)}indexParams(){let{options:e}=this,t={context:`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition,criteria:{...e.criteria}};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),e.criteria&&(t.criteria={...e.criteria}),typeof e.indexSettings.showFolders==`boolean`&&(t.showFolders=e.indexSettings.showFolders),t}indexSettings(){let{options:e}=this;return{context:`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...m(Vf,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return m(Bf,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){u(X,this,Zf).call(this)}get selection(){return m(Bf,this)}get disabledElementIds(){return m(Vf,this)}};function Xf(){let e=m(Gf,this),t=m(Wf,this);return Object.freeze({open:m(Uf,this),loading:t,busy:e,selection:Object.freeze([...m(Bf,this)]),disabledElementIds:Object.freeze([...m(Vf,this)]),indexBody:m(Hf,this),error:m(Kf,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function Zf(){h(qf,this,u(X,this,Xf).call(this)),u(X,this,$f).call(this,`change`,m(qf,this))}function Qf(e){h(Kf,this,e instanceof Error?e:Error(String(e??`Unknown`))),u(X,this,$f).call(this,`error`,m(Kf,this))}function $f(e,t){let n=m(Jf,this).get(e);n&&[...n].forEach(e=>e(t))}Yf.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function ep(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var tp=async(e,t)=>{let{data:n}=await ve.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},np=new WeakMap,rp=class e extends Yf{constructor(e){super(e),f(this,np,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??tp;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}h(np,this,t);try{await this.submit()}finally{h(np,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!m(np,this))return n;let r=e.transformUrls[m(np,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:m(np,this)}}};rp.transformUrls={};var ip=`CraftCms\\Cms\\Asset\\Elements\\Asset`,ap=new WeakSet,op=class extends Yf{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:ip,showSiteMenu:!1}),d(this,ap),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:u(ap,this,sp).call(this),status:null,url:null,hasThumb:!1}]}};function sp(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var cp=new Map;function lp(e,t){if(cp.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);cp.set(e,t)}function up(e){return cp.has(e)}function dp(e){return cp.get(e)??Yf}function fp(e){return new(dp(e.elementType))(e)}function pp(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))cp.has(t)||cp.set(t,n)}var mp={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},hp=new WeakMap,gp=new WeakMap,_p=new WeakMap,vp=new WeakMap,yp=new WeakMap,bp=new WeakMap,xp=new WeakMap,Z=new WeakSet,Sp=class{constructor(e={}){d(this,Z),f(this,hp,new Map),f(this,gp,null),f(this,_p,0),f(this,vp,[]),f(this,yp,[]),f(this,bp,new Set),f(this,xp,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)m(hp,this).set(e.id,e);r&&(u(Z,this,Dp).call(this),m(gp,this)!==null&&u(Z,this,Op).call(this))}getSessions(){return Array.from(m(hp,this).values())}getCurrentSessionId(){return m(gp,this)}isProcessing(){return m(_p,this)>0}on(e,t){return m(xp,this).has(e)||m(xp,this).set(e,new Set),m(xp,this).get(e).add(t),()=>{m(xp,this).get(e)?.delete(t)}}async startIndexing(e){let t=await ve.post(mp.START,e),{data:n}=t;return n.session&&(m(hp,this).set(n.session.id,n.session),h(gp,this,n.session.id),u(Z,this,Tp).call(this),n.stop||u(Z,this,Op).call(this)),n.stop&&u(Z,this,Ep).call(this,n.stop),t}stopSession(e){u(Z,this,kp).call(this,e),u(Z,this,Ap).call(this,{sessionId:e,action:mp.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){u(Z,this,Ap).call(this,{sessionId:e,action:mp.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){u(Z,this,Ap).call(this,{sessionId:e.sessionId,action:mp.FINISH,params:e,priority:!0})}destroy(){m(hp,this).clear(),h(vp,this,[]),h(yp,this,[]),m(xp,this).clear(),h(gp,this,null),h(_p,this,0)}};function wp(e,t){m(xp,this).get(e)?.forEach(e=>e(t))}function Tp(e){u(Z,this,wp).call(this,`change`,{sessions:this.getSessions(),currentSessionId:m(gp,this),reviewSessionId:e})}function Ep(e){m(hp,this).delete(e),m(gp,this)===e&&h(gp,this,null),u(Z,this,Tp).call(this)}function Dp(){for(let[e,t]of m(hp,this))if(!t.actionRequired&&!m(bp,this).has(e)){h(gp,this,e);return}h(gp,this,null)}function Op(){if(m(gp,this)||u(Z,this,Dp).call(this),!m(gp,this))return;let e=m(hp,this).get(m(gp,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-m(_p,this),r=Math.min(n,t);for(let t=0;t<r;t++)u(Z,this,Ap).call(this,{sessionId:e.id,action:mp.PROCESS,params:{sessionId:m(gp,this)},priority:!1});e.processIfRootEmpty&&u(Z,this,Ap).call(this,{sessionId:e.id,action:mp.PROCESS,params:{sessionId:m(gp,this)},priority:!1})}function kp(e){m(bp,this).add(e),h(vp,this,m(vp,this).filter(t=>t.sessionId!==e))}function Ap(e){e.priority?m(yp,this).push(e):m(vp,this).push(e),u(Z,this,jp).call(this)}function jp(){if(!(m(vp,this).length+m(yp,this).length===0||m(_p,this)>=this.maxConcurrentConnections))for(;m(vp,this).length+m(yp,this).length>0&&m(_p,this)<this.maxConcurrentConnections;){var e;h(_p,this,(e=m(_p,this),e++,e));let t=m(yp,this).length>0?m(yp,this).shift():m(vp,this).shift();u(Z,this,Mp).call(this,t)}}async function Mp(e){try{let t=await ve.post(e.action,e.params);u(Z,this,Np).call(this,t.data)}catch(t){u(Z,this,Pp).call(this,t,e)}finally{var t;h(_p,this,(t=m(_p,this),t--,t)),u(Z,this,jp).call(this)}}function Np(e){let t;e.session&&(m(hp,this).set(e.session.id,e.session),u(Z,this,Dp).call(this),e.session.actionRequired&&!e.skipDialog?m(bp,this).has(e.session.id)||(t=e.session.id):m(bp,this).has(e.session.id)||u(Z,this,Op).call(this)),u(Z,this,Dp).call(this),e.stop&&(m(hp,this).delete(e.stop),m(gp,this)===e.stop&&h(gp,this,null)),u(Z,this,Tp).call(this,t),m(hp,this).size===0&&u(Z,this,wp).call(this,`complete`,{})}function Pp(e,t){u(Z,this,Dp).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;u(Z,this,wp).call(this,`error`,{message:n,sessionId:t.sessionId}),u(Z,this,jp).call(this)}var Fp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},Ip=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Lp,Rp=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},zp=typeof Intl<`u`&&Intl.ListFormat||Rp,Bp=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],Vp={minimumIntegerDigits:2},Hp=class{constructor(e,t={}){Lp.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Fp(this,Lp,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return Ip(this,Lp,`f`)}formatToParts(e){let t=[],n=Ip(this,Lp,`f`),r=n.style,i=n.locale;for(let[a,o]of Bp){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?Vp:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new zp(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Lp=new WeakMap;var Up=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,Wp=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],Gp=e=>Up.test(e),Kp=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(Up)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(qp(r,e.from(t)).getTime()-r),a=Math.abs(qp(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Hp(e,t).format(this)}};function qp(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function Jp(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new Kp;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=Wp.indexOf(t)||Wp.length;return new Kp(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function Yp(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new Kp(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function Xp(e,t){let n=Yp(e,t);if(n.blank)return[0,`second`];for(let e of Wp){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Zp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,Qp,$p,em,tm,nm,rm,im,am,om,sm,cm,lm,um,dm,fm,pm=globalThis.HTMLElement||null,mm=new Kp,hm=new Kp(0,0,0,0,0,1),gm=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function _m(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var vm=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=_m(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,_m(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},ym=class extends pm{constructor(){super(...arguments),$.add(this),Qp.set(this,!1),$p.set(this,!1),tm.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),fm.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,fm,`f`)}set onRelativeTimeUpdated(e){Q(this,fm,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,fm,`f`)),Zp(this,fm,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&Gp(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return Wp.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){vm.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&Zp(this,Qp,n!==null&&(this.date&&Q(this,$,`m`,nm).call(this,this.date))!==n,`f`),!Q(this,$p,`f`)&&!(e===`title`&&Q(this,Qp,`f`))&&Zp(this,$p,(async()=>{await Promise.resolve(),this.update(),Zp(this,$p,!1,`f`)})(),`f`))}update(){let e=Q(this,tm,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,tm,`f`).textContent=e;return}let i=Date.now();Q(this,Qp,`f`)||(n=Q(this,$,`m`,nm).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=Jp(r,this.precision,i),o=Q(this,$,`m`,rm).call(this,a),s=e,c=Q(this,$,`m`,dm).call(this,o);s=c?Q(this,$,`m`,lm).call(this,r):o===`duration`?Q(this,$,`m`,im).call(this,a):o===`relative`?Q(this,$,`m`,am).call(this,a):Q(this,$,`m`,om).call(this,r),s?Q(this,$,`m`,um).call(this,s):this.shadowRoot===Q(this,tm,`f`)&&this.textContent&&Q(this,$,`m`,um).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new gm(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,sm).call(this,r)||Q(this,$,`m`,cm).call(this,r))?vm.observe(this):vm.unobserve(this)}};Qp=new WeakMap,$p=new WeakMap,tm=new WeakMap,fm=new WeakMap,$=new WeakSet,em=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},nm=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,em),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},rm=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||Kp.compare(e,this.threshold)===1)return`relative`}return`datetime`},im=function(e){let t=Q(this,$,`a`,em),n=this.format,r=this.formatStyle,i=this.tense,a=mm;n===`micro`?(e=Yp(e),a=hm,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=hm)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},am=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,em),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=mm),n===`past`&&e.sign!==-1&&(e=mm);let[r,i]=Xp(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},om=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,em),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},sm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,em),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},cm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,em),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},lm=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,sm).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,em),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,em))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,em),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,cm).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,em),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,em),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},um=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,tm,`f`).replaceChildren(t)}else Q(this,tm,`f`).textContent=e},dm=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var bm=typeof globalThis<`u`?globalThis:window;try{bm.RelativeTimeElement=ym.define()}catch(e){if(!(bm.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{Xi as A,pa as C,ra as D,ua as E,yt as F,bt as I,dt as L,sr as M,Nt as N,sa as O,St as P,ve as R,ma as S,fa as T,Zs as _,up as a,to as b,Yf as c,If as d,jf as f,rc as g,el as h,pp as i,Ci as j,ia as k,Lf as l,Hl as m,fp as n,op as o,Xu as p,lp as r,rp as s,Sp as t,Ff as u,V as v,da as w,_a as x,gs as y,ge as z};
...
import{a as e,t}from"./rolldown-runtime-CNC7AqOf.js";import{A as n,C as r,D as i,E as a,O as o,S as s,T as c,_ as l,a as u,b as d,d as f,f as p,g as m,h,i as g,j as _,k as v,m as y,n as b,p as x,u as S,v as C,w,y as ee}from"./nav-item-DXC64eky-BeAHJ0vd.js";import{a as T,c as E,d as te,f as D,i as ne,n as re,r as O,t as k}from"./lit-DNaDb1T7.js";import{t as A}from"./decorate-B3KLIx2E-B3KLIx2E.js";import{n as j,t as M}from"./decorators-D0-gbKXH.js";import{n as ie,t as ae}from"./query-Df4-SAIv.js";import{a as N,i as P,o as F,r as I,s as L}from"./axios-Mm3N8iqg.js";import{t as oe}from"./actionClient-NFMyfrDL-DsDU7tG9.js";import"./nav-list.ts-DPwcLr0r.js";import"./progress.ts-Nx9tZC2s.js";import"./apiClient.ts-Ch6pjDG0.js";D`
  :host([data-color='red']),
  [data-color='red'] {
...
`;function ce(e){return(t,n)=>{let{slot:r,selector:i}=e??{},a=`slot`+(r?`[name=${r}]`:`:not([name])`);return ie(t,n,{get(){let t=(this.renderRoot?.querySelector(a))?.assignedElements(e)??[];return i===void 0?t:t.filter((e=>e.matches(i)))}})}}var le=class extends k{constructor(){super(),this.alt=!1,this.shift=!1,this.os=`Unknown`,this.os=this.detectOS()}connectedCallback(){super.connectedCallback(),this.os===`Unknown`&&(this.os=this.detectOS())}detectOS(){let e=navigator.platform.toLowerCase();return e.includes(`mac`)||/iphone|ipad|ipod/.test(e)?`Mac`:e.includes(`win`)?`Windows`:e.includes(`linux`)?`Linux`:`Unknown`}renderShortcutPrefix(){switch(this.os){case`Mac`:return`${this.alt?`⌥`:``}${this.shift?`⇧`:``}⌘`;case`Linux`:return`Super+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`;default:return`Ctrl+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`}}render(){return E`<span class="shortcut"
  ...
  `,A([j({type:Boolean})],le.prototype,`alt`,void 0),A([j({type:Boolean})],le.prototype,`shift`,void 0),A([j()],le.prototype,`os`,void 0),customElements.get(`craft-shortcut`)||customElements.define(`craft-shortcut`,le);var ue={Neutral:`neutral`,Success:`success`,Warning:`warning`,Danger:`danger`,Info:`info`},de=Object.values(ue),fe=D`
  :host {
    display: contents;
  }
...
`,pe=class extends k{constructor(...e){super(...e),this.icon=null,this.iconColor=null,this.href=null,this.target=null,this.rel=null,this.disabled=!1,this.variant=ue.Neutral,this.checked=!1,this.active=!1,this.type=`button`,this.action=null,this.feedback=null,this.feedbackDuration=1e3,this.confirm=null,this.state=_.Idle,this.feedbackMessage=null,this.shortcut=null}renderShortcut(){return typeof this.shortcut==`string`?E`<craft-shortcut>${this.shortcut}</craft-shortcut>`:this.shortcut===null?O:E`<craft-shortcut
        ?alt="${this.shortcut.alt??!1}"
        ?shift="${this.shortcut.shift??!1}"
        >${this.shortcut.key}</craft-shortcut
      >`}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this)}setState(e,t={}){this.state=e,this.feedbackMessage=t.message??null,this.dispatchEvent(new CustomEvent(`action:change-state`,{bubbles:!0,composed:!0,detail:{state:e,actionType:v(this.action)?.type,...t}}))}async handleEvent(e){if(this.disabled){e.preventDefault();return}let t=v(this.action);if(e.type===`click`&&t){t.type===`http`&&this.setState(_.Loading);try{await o(t,{trigger:this,sourceEvent:e}),this.setState(_.Success,this.feedback?.success)}catch(e){this.setState(_.Error,{message:e.message,...this.feedback?.error||{}})}finally{setTimeout(()=>{this.setState(_.Idle)},this.feedbackDuration)}}}renderCheckbox(){return E`<span class="action-item__check">
      <slot name="checkmark">
        ${this.checked?E`<craft-icon name="check"></craft-icon>`:O}
      </slot>
    </span>`}renderIcon(){switch(this.state){case _.Loading:return E`<craft-spinner style="--size: 0.8em"></craft-spinner>`;case _.Success:return E`<craft-icon
          name="check"
          style="color: var(--c-color-success-on-normal)"
        ></craft-icon>`;case _.Error:return E`<craft-icon
          name="xmark"
          style="color: var(--c-color-danger-on-normal)"
        ></craft-icon>`;default:return E`
          <slot name="icon">
        ...
        `}}renderPrefix(){let e=!!this.querySelector(`[slot="icon"]`)||!!this.icon,t=!!this.querySelector(`[slot="prefix"]`);return E`
      ${this.type===`checkbox`?this.renderCheckbox():O}
      ${t?E`<slot name="prefix" part="prefix"></slot>`:O}
      ${e?E`<div class="action-item__icon">${this.renderIcon()}</div>`:O}
    `}renderBody(){return E`
      ${this.renderPrefix()}

      <span class="action-item__label">
        ${this.feedbackMessage?this.feedbackMessage:E`<slot></slot>`}
      </span>
    ...
    `}render(){return this.href?E`
          <a
            class="${w({"action-item":!0,"action-item--checkbox":this.type===`checkbox`})}"
            href="${this.href}"
            target="${r(this.target??void 0)}"
            rel="${r(this.rel??(this.target===`_blank`?`noopener`:null)??void 0)}"
          >
            ${this.renderBody()}
          </a>
        `:E`
    ...
    `],ke._filterableItemsSelector=`craft-action-item, li, button`,A([j({attribute:!1})],ke.prototype,`actions`,void 0),A([j()],ke.prototype,`label`,void 0),A([j()],ke.prototype,`icon`,void 0),A([j({type:Boolean,reflect:!0})],ke.prototype,`disabled`,void 0),A([j({type:Boolean,reflect:!0})],ke.prototype,`searchable`,void 0),A([ce({slot:`invoker`})],ke.prototype,`invokerNodes`,void 0),A([ce({slot:`content`})],ke.prototype,`contentNodes`,void 0),customElements.get(`craft-action-menu`)||customElements.define(`craft-action-menu`,ke);var Ae=D`
  :host {
    --color-start: red;
    --color-end: blue;
    --color-text: inherit;
...
`,je=class extends k{constructor(...e){super(...e),this.label=null,this._gradientId=null}connectedCallback(){super.connectedCallback(),this._gradientId=`avatar-gradient-${Math.random().toString(36).slice(2,8)}`}text(){return this.label?this.label.split(` `).map(e=>e.charAt(0).toUpperCase()).join(``):`?`}render(){return E`
      <span class="avatar">
        <svg
          viewBox="0 0 100 100"
    ...
    `}};je.styles=[Ae],A([j()],je.prototype,`label`,void 0),A([M()],je.prototype,`_gradientId`,void 0),customElements.get(`craft-avatar`)||customElements.define(`craft-avatar`,je);var Me=[`red`,`orange`,`amber`,`yellow`,`lime`,`green`,`emerald`,`teal`,`cyan`,`sky`,`blue`,`indigo`,`violet`,`purple`,`fuchsia`,`pink`,`rose`,`white`,`gray`,`black`,`slate`],Ne={neutral:`slate`,accent:`blue`,info:`sky`,success:`emerald`,warning:`yellow`,danger:`red`},Pe={pending:`orange`,off:`red`,suspended:`red`,expired:`red`,disabled:`gray`,inactive:`gray`,on:`emerald`},Fe=e=>e.charAt(0).toUpperCase()+e.slice(1),Ie={...Object.fromEntries(Me.map(e=>[Fe(e),e])),...Object.fromEntries(Object.entries(Ne).map(([e,t])=>[Fe(e),t])),...Object.fromEntries(Object.entries(Pe).map(([e,t])=>[Fe(e),t]))},Le=[...Me],Re=class extends k{constructor(...e){super(...e),this.size=`md`,this.fill=`var(--c-color-fill-loud)`,this.label=null,this.appearance=S.OutlineFill}getFill(){return Le.includes(this.fill)||de.includes(this.fill)?`var(--c-color-${this.fill}-fill-loud)`:this.fill}getSize(){switch(this.size){case`md`:return`0.6em`;case`lg`:return`1em`;default:return this.size}}render(){return E`<span
      style="--fill: ${this.getFill()}; --size: ${this.getSize()}"
      aria-label="${this.label??O}"
      role="${this.label?`img`:O}"
      class="${w({indicator:!0,"indicator--outline":this.appearance===S.Outline})}"
    ></span>`}};Re.styles=[se,D`
      :host {
        display: contents;
      }
    ...
    `],A([j()],Re.prototype,`size`,void 0),A([j({reflect:!0})],Re.prototype,`fill`,void 0),A([j()],Re.prototype,`label`,void 0),A([j({reflect:!0})],Re.prototype,`appearance`,void 0),customElements.get(`craft-indicator`)||customElements.define(`craft-indicator`,Re);var ze=D`
  :host {
    display: inline-flex;
  }
...
`,Be={Small:`small`,Medium:`medium`,Large:`large`};Object.values(Be);var Ve=class extends k{constructor(...e){super(...e),this.fill=Ie.Gray,this.noPrefix=!1,this.size=Be.Medium}getFill(){return this.fill}willUpdate(e){e.has(`fill`)&&(this.dataset.color=this.getFill())}render(){return E`
      <span
        part="badge"
        class="${w({badge:!0,"badge--small":this.size===Be.Small,"badge--large":this.size===Be.Large})}"
      >
        <span class="badge__prefix">
          ${this.noPrefix?O:E` <slot name="prefix" part="prefix">
                <craft-indicator
                  part="indicator"
                  fill="${this.getFill()}"
                ></craft-indicator>
    ...
    `}};Ve.styles=[ze],A([j({reflect:!0})],Ve.prototype,`fill`,void 0),A([j({attribute:`no-prefix`,type:Boolean})],Ve.prototype,`noPrefix`,void 0),A([j()],Ve.prototype,`size`,void 0),customElements.get(`craft-badge`)||customElements.define(`craft-badge`,Ve);var He=class extends k{constructor(...e){super(...e),this.rel=`noreferrer noopener`}render(){return E`
      ...
      ${this.href?E`<a
          ...
          ><slot></slot
        ></a>`:E`<span part="label" class="label"><slot></slot></span>`}
      <slot name="suffix" part="suffix"></slot>
...
`,We=class extends k{constructor(...e){super(...e),this.label=s(`Breadcrumbs`),this.items=[],this.visibleItems=0,this.firstRender=!0}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}calculateBreadcrumbItemsWidth(){this.items=this.breadcrumbsElements.map((e,t)=>{let n=e.offsetWidth;return e.hasAttribute(`hidden`)&&(e.removeAttribute(`hidden`),n=e.offsetWidth,e.setAttribute(`hidden`,``)),{label:e.innerText,href:e.href,value:t.toString(),offsetWidth:n,isVisible:!0}})}async handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`craft-breadcrumb-item`);if(e.forEach((t,n)=>{let r=n===e.length-1,i=t.querySelector(`[slot="separator"]`);r?i?.hasAttribute(`data-default`)&&i.remove():i===null?t.append(this.getSeparator()):i.hasAttribute(`data-default`)&&i.replaceWith(this.getSeparator()),r?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)}),this.breadcrumbsElements.length===0){this.items=[],this.visibleItems=0;return}await Promise.all(this.breadcrumbsElements.map(e=>e.updateComplete)),this.calculateBreadcrumbItemsWidth(),this.visibleItems=0,this.adjustOverflow()}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{if(this.firstRender){this.firstRender=!1;return}this.adjustOverflow()}),this.resizeObserver.observe(this)}adjustOverflow(){}disconnectedCallback(){this.resizeObserver?.unobserve(this),super.disconnectedCallback()}render(){return E`
    ...
    `}};We.styles=[Ue],A([ae(`slot`)],We.prototype,`defaultSlot`,void 0),A([ae(`slot[name="separator"]`)],We.prototype,`separatorSlot`,void 0),A([ce({selector:`craft-breadcrumb-item`})],We.prototype,`breadcrumbsElements`,void 0),A([j()],We.prototype,`label`,void 0),A([M()],We.prototype,`items`,void 0),A([M()],We.prototype,`visibleItems`,void 0),customElements.get(`craft-breadcrumbs`)||customElements.define(`craft-breadcrumbs`,We);var Ge=D`
  :host {
...
`,Qe=class extends Xe(k,{customProperty:[`--_callout-padding-block`,`--_callout-padding-inline`]}){constructor(...e){super(...e),this.variant=ue.Neutral,this.appearance=S.OutlineFill,this.title=``,this.icon=null,this.hideIcon=!1,this.rounded=`all`,this.inline=!1,this.size=`auto`,this.resolvedIcon=null}willUpdate(){this.resolvedIcon=this.icon??this.getDefaultIcon()}getDefaultIcon(){switch(this.variant){case ue.Info:return`lightbulb`;case ue.Success:return`circle-check`;case ue.Warning:return`circle-exclamation`;case ue.Danger:return`triangle-exclamation`;default:return null}}render(){let e=this.title||!!this.querySelector(`[slot="title"]`),t=!this.hideIcon&&(!!this.resolvedIcon||!!this.querySelector(`[slot="icon"]`));return E`
      <div
        data-variant="${this.variant}"
        style="${b(this.paddingStyles)}"
        class="${w({callout:!0,"callout--hide-icon":!t,"callout--title":e,"callout--small":this.size===`small`})}"
      >
        ${t?E`<slot name="icon" class="callout__icon">
              ${this.resolvedIcon?E`<craft-icon
                    name="${this.resolvedIcon}"
                    style="font-size: 0.9em"
                  ></craft-icon>`:O}
            </slot>`:O}
        ${e?E`<div class="callout__title">
    ...
    `}};Qe.styles=[se,Ze],A([j({reflect:!0})],Qe.prototype,`variant`,void 0),A([j({reflect:!0})],Qe.prototype,`appearance`,void 0),A([j()],Qe.prototype,`title`,void 0),A([j()],Qe.prototype,`icon`,void 0),A([j({type:Boolean,attribute:`hide-icon`})],Qe.prototype,`hideIcon`,void 0),A([j({reflect:!0})],Qe.prototype,`rounded`,void 0),A([j({reflect:!0,type:Boolean})],Qe.prototype,`inline`,void 0),A([j()],Qe.prototype,`size`,void 0),A([M()],Qe.prototype,`resolvedIcon`,void 0),customElements.get(`craft-callout`)||customElements.define(`craft-callout`,Qe);var $e=D`
  :host {
    display: block;
  }
...
`,et=class extends k{constructor(...e){super(...e),this.label=``,this.active=!1,this.collapsed=!1,this.showThumb=!0,this.thumbAlignment=`start`,this._hasThumbnail=!1,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasSlottedHeader=!!this.querySelector(`:scope > [slot="header"]`)||!!this.querySelector(`:scope > [slot="label"]`)||!!this.querySelector(`:scope > [slot="actions"]`),this._hasSlottedFooter=!!this.querySelector(`:scope > [slot="footer"]`),this._hasThumbnail=!!this.querySelector(`:scope > [slot="thumbnail"]`)}_handleThumbnailSlotChange(e){let t=e.target;this._hasThumbnail=t.assignedElements({flatten:!0}).length>0}render(){let e=!!this.label||this._hasSlottedHeader,t=this._hasSlottedFooter,n=this.showThumb&&this._hasThumbnail;return E`
      ...
      >
        ...
        <div
          class="${w({"card-body":!0,"card-body--thumb-start":n&&this.thumbAlignment===`start`,"card-body--thumb-end":n&&this.thumbAlignment===`end`})}"
        >
        ...
        ${t?E`<div class="card__footer"><slot name="footer"></slot></div>`:O}
      </div>
    `}};et.styles=[$e],A([j()],et.prototype,`label`,void 0),A([j({type:Boolean,reflect:!0})],et.prototype,`active`,void 0),A([j({type:Boolean,reflect:!0})],et.prototype,`collapsed`,void 0),A([j({attribute:`show-thumb`,type:Boolean})],et.prototype,`showThumb`,void 0),A([j({attribute:`thumb-alignment`})],et.prototype,`thumbAlignment`,void 0),A([M()],et.prototype,`_hasThumbnail`,void 0),A([M()],et.prototype,`_hasSlottedHeader`,void 0),A([M()],et.prototype,`_hasSlottedFooter`,void 0),customElements.get(`craft-card`)||customElements.define(`craft-card`,et);var tt=D`
...
`,st=window,ct=new WeakMap;function lt(e){st.applyFocusVisiblePolyfill&&!ct.has(e)&&(st.applyFocusVisiblePolyfill(e),ct.set(e,void 0))}var ut=d(e=>class extends e{static get properties(){return{focused:{type:Boolean,reflect:!0},focusedVisible:{type:Boolean,reflect:!0,attribute:`focused-visible`},autofocus:{type:Boolean,reflect:!0}}}constructor(){super(),this.focused=!1,this.focusedVisible=!1,this.autofocus=!1}firstUpdated(e){super.firstUpdated(e),this.__registerEventsForFocusMixin(),this.__syncAutofocusToFocusableElement()}disconnectedCallback(){super.disconnectedCallback(),this.__teardownEventsForFocusMixin()}updated(e){super.updated(e),e.has(`autofocus`)&&this.__syncAutofocusToFocusableElement()}__syncAutofocusToFocusableElement(){this._focusableNode&&(this.hasAttribute(`autofocus`)?this._focusableNode.setAttribute(`autofocus`,``):this._focusableNode.removeAttribute(`autofocus`))}focus(){this._focusableNode?.focus()}blur(){this._focusableNode?.blur()}get _focusableNode(){return this._inputNode||document.createElement(`input`)}__onFocus(){if(this.focused=!0,typeof st.applyFocusVisiblePolyfill==`function`)this.focusedVisible=this._focusableNode.hasAttribute(`data-focus-visible-added`);else try{this.focusedVisible=this._focusableNode.matches(`:focus-visible`)}catch{this.focusedVisible=!1}}__onBlur(){this.focused=!1,this.focusedVisible=!1}__registerEventsForFocusMixin(){lt(this.getRootNode()),this.__redispatchFocus=e=>{e.stopPropagation(),this.dispatchEvent(new Event(`focus`))},this._focusableNode.addEventListener(`focus`,this.__redispatchFocus),this.__redispatchBlur=e=>{e.stopPropagation(),this.dispatchEvent(new Event(`blur`))},this._focusableNode.addEventListener(`blur`,this.__redispatchBlur),this.__redispatchFocusin=e=>{e.stopPropagation(),this.__onFocus(),this.dispatchEvent(new Event(`focusin`,{bubbles:!0,composed:!0}))},this._focusableNode.addEventListener(`focusin`,this.__redispatchFocusin),this.__redispatchFocusout=e=>{e.stopPropagation(),this.__onBlur(),this.dispatchEvent(new Event(`focusout`,{bubbles:!0,composed:!0}))},this._focusableNode.addEventListener(`focusout`,this.__redispatchFocusout)}__teardownEventsForFocusMixin(){this._focusableNode&&(this._focusableNode?.removeEventListener(`focus`,this.__redispatchFocus),this._focusableNode?.removeEventListener(`blur`,this.__redispatchBlur),this._focusableNode?.removeEventListener(`focusin`,this.__redispatchFocusin),this._focusableNode?.removeEventListener(`focusout`,this.__redispatchFocusout))}});function dt(e,t){return t={exports:{}},e(t,t.exports),t.exports}var ft=`long`,pt=`short`,mt=`narrow`,R=`numeric`,ht=`2-digit`,gt={number:{decimal:{style:`decimal`},integer:{style:`decimal`,maximumFractionDigits:0},currency:{style:`currency`,currency:`USD`},percent:{style:`percent`},default:{style:`decimal`}},date:{short:{month:R,day:R,year:ht},medium:{month:pt,day:R,year:R},long:{month:ft,day:R,year:R},full:{month:ft,day:R,year:R,weekday:ft},default:{month:pt,day:R,year:R}},time:{short:{hour:R,minute:R},medium:{hour:R,minute:R,second:R},long:{hour:R,minute:R,second:R,timeZoneName:pt},full:{hour:R,minute:R,second:R,timeZoneName:pt},default:{hour:R,minute:R,second:R}},duration:{default:{hours:{minimumIntegerDigits:1,maximumFractionDigits:0},minutes:{minimumIntegerDigits:2,maximumFractionDigits:0},seconds:{minimumIntegerDigits:2,maximumFractionDigits:3}}},parseNumberPattern:function(e){if(e){var t={},n=e.match(/\b[A-Z]{3}\b/i),r=e.replace(/[^¤]/g,``).length;if(!r&&n&&(r=1),r?(t.style=`currency`,t.currencyDisplay=r===1?`symbol`:r===2?`code`:`name`,t.currency=n?n[0].toUpperCase():`USD`):e.indexOf(`%`)>=0&&(t.style=`percent`),!/[@#0]/.test(e))return t.style?t:void 0;if(t.useGrouping=e.indexOf(`,`)>=0,/E\+?[@#0]+/i.test(e)||e.indexOf(`@`)>=0){var i=e.replace(/E\+?[@#0]+|[^@#0]/gi,``);t.minimumSignificantDigits=Math.min(Math.max(i.replace(/[^@0]/g,``).length,1),21),t.maximumSignificantDigits=Math.min(Math.max(i.length,1),21)}else{for(var a=e.replace(/[^#0.]/g,``).split(`.`),o=a[0],s=o.length-1;o[s]===`0`;)--s;t.minimumIntegerDigits=Math.min(Math.max(o.length-1-s,1),21);var c=a[1]||``;for(s=0;c[s]===`0`;)++s;for(t.minimumFractionDigits=Math.min(Math.max(s,0),20);c[s]===`#`;)++s;t.maximumFractionDigits=Math.min(Math.max(s,0),20)}return t}},parseDatePattern:function(e){if(e){for(var t={},n=0;n<e.length;){for(var r=e[n],i=1;e[++n]===r;)++i;switch(r){case`G`:t.era=i===5?mt:i===4?ft:pt;break;case`y`:case`Y`:t.year=i===2?ht:R;break;case`M`:case`L`:i=Math.min(Math.max(i-1,0),4),t.month=[R,ht,pt,ft,mt][i];break;case`E`:case`e`:case`c`:t.weekday=i===5?mt:i===4?ft:pt;break;case`d`:case`D`:t.day=i===2?ht:R;break;case`h`:case`K`:t.hour12=!0,t.hour=i===2?ht:R;break;case`H`:case`k`:t.hour12=!1,t.hour=i===2?ht:R;break;case`m`:t.minute=i===2?ht:R;break;case`s`:case`S`:t.second=i===2?ht:R;break;case`z`:case`Z`:case`v`:case`V`:t.timeZoneName=i===1?pt:ft;break}}return Object.keys(t).length?t:void 0}}},_t=function(e,t){if(typeof e==`string`&&t[e])return e;for(var n=[].concat(e||[]),r=0,i=n.length;r<i;++r)for(var a=n[r].split(`-`);a.length;){var o=a.join(`-`);if(t[o])return o;a.pop()}},vt=`zero`,z=`one`,yt=`two`,B=`few`,bt=`many`,V=`other`,H=[function(e){return+e==1?z:V},function(e){var t=+e;return 0<=t&&t<=1?z:V},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return t===0||n===1?z:V},function(e){var t=+e;return t===0?vt:t===1?z:t===2?yt:3<=t%100&&t%100<=10?B:11<=t%100&&t%100<=99?bt:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?z:V},function(e){var t=+e;return t%10==1&&t%100!=11?z:2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?B:t%10==0||5<=t%10&&t%10<=9||11<=t%100&&t%100<=14?bt:V},function(e){var t=+e;return t%10==1&&t%100!=11&&t%100!=71&&t%100!=91?z:t%10==2&&t%100!=12&&t%100!=72&&t%100!=92?yt:(3<=t%10&&t%10<=4||t%10==9)&&(t%100<10||19<t%100)&&(t%100<70||79<t%100)&&(t%100<90||99<t%100)?B:t!==0&&t%1e6==0?bt:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%10==1&&t%100!=11||r%10==1&&r%100!=11?z:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)||2<=r%10&&r%10<=4&&(r%100<12||14<r%100)?B:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?z:2<=t&&t<=4&&n===0?B:n===0?V:bt},function(e){var t=+e;return t===0?vt:t===1?z:t===2?yt:t===3?B:t===6?bt:V},function(e){var t=Math.floor(Math.abs(+e)),n=+(``+e).replace(/^[^.]*.?|0+$/g,``);return+e==1||n!==0&&(t===0||t===1)?z:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%100==1||r%100==1?z:n===0&&t%100==2||r%100==2?yt:n===0&&3<=t%100&&t%100<=4||3<=r%100&&r%100<=4?B:V},function(e){var t=Math.floor(Math.abs(+e));return t===0||t===1?z:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&(t===1||t===2||t===3)||n===0&&t%10!=4&&t%10!=6&&t%10!=9||n!==0&&r%10!=4&&r%10!=6&&r%10!=9?z:V},function(e){var t=+e;return t===1?z:t===2?yt:3<=t&&t<=6?B:7<=t&&t<=10?bt:V},function(e){var t=+e;return t===1||t===11?z:t===2||t===12?yt:3<=t&&t<=10||13<=t&&t<=19?B:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%10==1?z:n===0&&t%10==2?yt:n===0&&(t%100==0||t%100==20||t%100==40||t%100==60||t%100==80)?B:n===0?V:bt},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+e;return t===1&&n===0?z:t===2&&n===0?yt:n===0&&(r<0||10<r)&&r%10==0?bt:V},function(e){var t=Math.floor(Math.abs(+e)),n=+(``+e).replace(/^[^.]*.?|0+$/g,``);return n===0&&t%10==1&&t%100!=11||n!==0?z:V},function(e){var t=+e;return t===1?z:t===2?yt:V},function(e){var t=+e;return t===0?vt:t===1?z:V},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return n===0?vt:(t===0||t===1)&&n!==0?z:V},function(e){var t=+(e+`.`).split(`.`)[1],n=+e;return n%10==1&&(n%100<11||19<n%100)?z:2<=n%10&&n%10<=9&&(n%100<11||19<n%100)?B:t===0?V:bt},function(e){var t=(e+`.`).split(`.`)[1].length,n=+(e+`.`).split(`.`)[1],r=+e;return r%10==0||11<=r%100&&r%100<=19||t===2&&11<=n%100&&n%100<=19?vt:r%10==1&&r%100!=11||t===2&&n%10==1&&n%100!=11||t!==2&&n%10==1?z:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%10==1&&t%100!=11||r%10==1&&r%100!=11?z:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+e;return t===1&&n===0?z:n!==0||r===0||r!==1&&1<=r%100&&r%100<=19?B:V},function(e){var t=+e;return t===1?z:t===0||2<=t%100&&t%100<=10?B:11<=t%100&&t%100<=19?bt:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?z:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?B:n===0&&t!==1&&0<=t%10&&t%10<=1||n===0&&5<=t%10&&t%10<=9||n===0&&12<=t%100&&t%100<=14?bt:V},function(e){var t=Math.floor(Math.abs(+e));return 0<=t&&t<=1?z:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%10==1&&t%100!=11?z:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?B:n===0&&t%10==0||n===0&&5<=t%10&&t%10<=9||n===0&&11<=t%100&&t%100<=14?bt:V},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return t===0||n===1?z:2<=n&&n<=10?B:V},function(e){var t=Math.floor(Math.abs(+e)),n=+(e+`.`).split(`.`)[1],r=+e;return r===0||r===1||t===0&&n===1?z:V},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%100==1?z:n===0&&t%100==2?yt:n===0&&3<=t%100&&t%100<=4||n!==0?B:V},function(e){var t=+e;return 0<=t&&t<=1||11<=t&&t<=99?z:V},function(e){var t=+e;return t===1||t===5||t===7||t===8||t===9||t===10?z:t===2||t===3?yt:t===4?B:t===6?bt:V},function(e){var t=Math.floor(Math.abs(+e));return t%10==1||t%10==2||t%10==5||t%10==7||t%10==8||t%100==20||t%100==50||t%100==70||t%100==80?z:t%10==3||t%10==4||t%1e3==100||t%1e3==200||t%1e3==300||t%1e3==400||t%1e3==500||t%1e3==600||t%1e3==700||t%1e3==800||t%1e3==900?B:t===0||t%10==6||t%100==40||t%100==60||t%100==90?bt:V},function(e){var t=+e;return(t%10==2||t%10==3)&&t%100!=12&&t%100!=13?B:V},function(e){var t=+e;return t===1||t===3?z:t===2?yt:t===4?B:V},function(e){var t=+e;return t===0||t===7||t===8||t===9?vt:t===1?z:t===2?yt:t===3||t===4?B:t===5||t===6?bt:V},function(e){var t=+e;return t%10==1&&t%100!=11?z:t%10==2&&t%100!=12?yt:t%10==3&&t%100!=13?B:V},function(e){var t=+e;return t===1||t===11?z:t===2||t===12?yt:t===3||t===13?B:V},function(e){var t=+e;return t===1?z:t===2||t===3?yt:t===4?B:t===6?bt:V},function(e){var t=+e;return t===1||t===5?z:V},function(e){var t=+e;return t===11||t===8||t===80||t===800?bt:V},function(e){var t=Math.floor(Math.abs(+e));return t===1?z:t===0||2<=t%100&&t%100<=20||t%100==40||t%100==60||t%100==80?bt:V},function(e){var t=+e;return t%10==6||t%10==9||t%10==0&&t!==0?bt:V},function(e){var t=Math.floor(Math.abs(+e));return t%10==1&&t%100!=11?z:t%10==2&&t%100!=12?yt:(t%10==7||t%10==8)&&t%100!=17&&t%100!=18?bt:V},function(e){var t=+e;return t===1?z:t===2||t===3?yt:t===4?B:V},function(e){var t=+e;return 1<=t&&t<=4?z:V},function(e){var t=+e;return t===1||t===5||7<=t&&t<=9?z:t===2||t===3?yt:t===4?B:t===6?bt:V},function(e){var t=+e;return t===1?z:t%10==4&&t%100!=14?bt:V},function(e){var t=+e;return(t%10==1||t%10==2)&&t%100!=11&&t%100!=12?z:V},function(e){var t=+e;return t%10==6||t%10==9||t===10?B:V},function(e){var t=+e;return t%10==3&&t%100!=13?B:V}],xt={af:{cardinal:H[0]},ak:{cardinal:H[1]},am:{cardinal:H[2]},ar:{cardinal:H[3]},ars:{cardinal:H[3]},as:{cardinal:H[2],ordinal:H[34]},asa:{cardinal:H[0]},ast:{cardinal:H[4]},az:{cardinal:H[0],ordinal:H[35]},be:{cardinal:H[5],ordinal:H[36]},bem:{cardinal:H[0]},bez:{cardinal:H[0]},bg:{cardinal:H[0]},bh:{cardinal:H[1]},bn:{cardinal:H[2],ordinal:H[34]},br:{cardinal:H[6]},brx:{cardinal:H[0]},bs:{cardinal:H[7]},ca:{cardinal:H[4],ordinal:H[37]},ce:{cardinal:H[0]},cgg:{cardinal:H[0]},chr:{cardinal:H[0]},ckb:{cardinal:H[0]},cs:{cardinal:H[8]},cy:{cardinal:H[9],ordinal:H[38]},da:{cardinal:H[10]},de:{cardinal:H[4]},dsb:{cardinal:H[11]},dv:{cardinal:H[0]},ee:{cardinal:H[0]},el:{cardinal:H[0]},en:{cardinal:H[4],ordinal:H[39]},eo:{cardinal:H[0]},es:{cardinal:H[0]},et:{cardinal:H[4]},eu:{cardinal:H[0]},fa:{cardinal:H[2]},ff:{cardinal:H[12]},fi:{cardinal:H[4]},fil:{cardinal:H[13],ordinal:H[0]},fo:{cardinal:H[0]},fr:{cardinal:H[12],ordinal:H[0]},fur:{cardinal:H[0]},fy:{cardinal:H[4]},ga:{cardinal:H[14],ordinal:H[0]},gd:{cardinal:H[15],ordinal:H[40]},gl:{cardinal:H[4]},gsw:{cardinal:H[0]},gu:{cardinal:H[2],ordinal:H[41]},guw:{cardinal:H[1]},gv:{cardinal:H[16]},ha:{cardinal:H[0]},haw:{cardinal:H[0]},he:{cardinal:H[17]},hi:{cardinal:H[2],ordinal:H[41]},hr:{cardinal:H[7]},hsb:{cardinal:H[11]},hu:{cardinal:H[0],ordinal:H[42]},hy:{cardinal:H[12],ordinal:H[0]},ia:{cardinal:H[4]},io:{cardinal:H[4]},is:{cardinal:H[18]},it:{cardinal:H[4],ordinal:H[43]},iu:{cardinal:H[19]},iw:{cardinal:H[17]},jgo:{cardinal:H[0]},ji:{cardinal:H[4]},jmc:{cardinal:H[0]},ka:{cardinal:H[0],ordinal:H[44]},kab:{cardinal:H[12]},kaj:{cardinal:H[0]},kcg:{cardinal:H[0]},kk:{cardinal:H[0],ordinal:H[45]},kkj:{cardinal:H[0]},kl:{cardinal:H[0]},kn:{cardinal:H[2]},ks:{cardinal:H[0]},ksb:{cardinal:H[0]},ksh:{cardinal:H[20]},ku:{cardinal:H[0]},kw:{cardinal:H[19]},ky:{cardinal:H[0]},lag:{cardinal:H[21]},lb:{cardinal:H[0]},lg:{cardinal:H[0]},ln:{cardinal:H[1]},lt:{cardinal:H[22]},lv:{cardinal:H[23]},mas:{cardinal:H[0]},mg:{cardinal:H[1]},mgo:{cardinal:H[0]},mk:{cardinal:H[24],ordinal:H[46]},ml:{cardinal:H[0]},mn:{cardinal:H[0]},mo:{cardinal:H[25],ordinal:H[0]},mr:{cardinal:H[2],ordinal:H[47]},mt:{cardinal:H[26]},nah:{cardinal:H[0]},naq:{cardinal:H[19]},nb:{cardinal:H[0]},nd:{cardinal:H[0]},ne:{cardinal:H[0],ordinal:H[48]},nl:{cardinal:H[4]},nn:{cardinal:H[0]},nnh:{cardinal:H[0]},no:{cardinal:H[0]},nr:{cardinal:H[0]},nso:{cardinal:H[1]},ny:{cardinal:H[0]},nyn:{cardinal:H[0]},om:{cardinal:H[0]},or:{cardinal:H[0],ordinal:H[49]},os:{cardinal:H[0]},pa:{cardinal:H[1]},pap:{cardinal:H[0]},pl:{cardinal:H[27]},prg:{cardinal:H[23]},ps:{cardinal:H[0]},pt:{cardinal:H[28]},"pt-PT":{cardinal:H[4]},rm:{cardinal:H[0]},ro:{cardinal:H[25],ordinal:H[0]},rof:{cardinal:H[0]},ru:{cardinal:H[29]},rwk:{cardinal:H[0]},saq:{cardinal:H[0]},sc:{cardinal:H[4],ordinal:H[43]},scn:{cardinal:H[4],ordinal:H[43]},sd:{cardinal:H[0]},sdh:{cardinal:H[0]},se:{cardinal:H[19]},seh:{cardinal:H[0]},sh:{cardinal:H[7]},shi:{cardinal:H[30]},si:{cardinal:H[31]},sk:{cardinal:H[8]},sl:{cardinal:H[32]},sma:{cardinal:H[19]},smi:{cardinal:H[19]},smj:{cardinal:H[19]},smn:{cardinal:H[19]},sms:{cardinal:H[19]},sn:{cardinal:H[0]},so:{cardinal:H[0]},sq:{cardinal:H[0],ordinal:H[50]},sr:{cardinal:H[7]},ss:{cardinal:H[0]},ssy:{cardinal:H[0]},st:{cardinal:H[0]},sv:{cardinal:H[4],ordinal:H[51]},sw:{cardinal:H[4]},syr:{cardinal:H[0]},ta:{cardinal:H[0]},te:{cardinal:H[0]},teo:{cardinal:H[0]},ti:{cardinal:H[1]},tig:{cardinal:H[0]},tk:{cardinal:H[0],ordinal:H[52]},tl:{cardinal:H[13],ordinal:H[0]},tn:{cardinal:H[0]},tr:{cardinal:H[0]},ts:{cardinal:H[0]},tzm:{cardinal:H[33]},ug:{cardinal:H[0]},uk:{cardinal:H[29],ordinal:H[53]},ur:{cardinal:H[4]},uz:{cardinal:H[0]},ve:{cardinal:H[0]},vo:{cardinal:H[0]},vun:{cardinal:H[0]},wa:{cardinal:H[1]},wae:{cardinal:H[0]},xh:{cardinal:H[0]},xog:{cardinal:H[0]},yi:{cardinal:H[4]},zu:{cardinal:H[2]},lo:{ordinal:H[0]},ms:{ordinal:H[0]},vi:{ordinal:H[0]}},St=dt(function(e,t){t=e.exports=function(e,t,r){return n(e,null,t||`en`,r||{},!0)},t.toParts=function(e,t,r){return n(e,null,t||`en`,r||{},!1)};function n(e,t,n,i,a){var o=e.map(function(e){return r(e,t,n,i,a)});return a?o.length===1?o[0]:function(e){for(var t=``,n=0;n<o.length;++n)t+=o[n](e);return t}:function(e){return o.reduce(function(t,n){return t.concat(n(e))},[])}}function r(e,t,r,a,o){if(typeof e==`string`){var s=e;return function(){return s}}var c=e[0],l=e[1];if(t&&e[0]===`#`){c=t[0];var u=t[2],f=(a.number||d.number)([c,`number`],r);return function(e){return f(i(c,e)-u,e)}}var p;l===`plural`||l===`selectordinal`?(p={},Object.keys(e[3]).forEach(function(t){p[t]=n(e[3][t],e,r,a,o)}),e=[e[0],e[1],e[2],p]):e[2]&&typeof e[2]==`object`&&(p={},Object.keys(e[2]).forEach(function(t){p[t]=n(e[2][t],e,r,a,o)}),e=[e[0],e[1],p]);var m=l&&(a[l]||d[l]);if(m){var h=m(e,r);return function(e){return h(i(c,e),e)}}return o?function(e){return String(i(c,e))}:function(e){return i(c,e)}}function i(e,t){if(t&&e in t)return t[e];for(var n=e.split(`.`),r=t,i=0,a=n.length;r&&i<a;++i)r=r[n[i]];return r}function a(e,t){var n=e[2],r=gt.number[n]||gt.parseNumberPattern(n)||gt.number.default;return new Intl.NumberFormat(t,r).format}function o(e,t){var n=e[2],r=gt.duration[n]||gt.duration.default,i=new Intl.NumberFormat(t,r.seconds).format,a=new Intl.NumberFormat(t,r.minutes).format,o=new Intl.NumberFormat(t,r.hours).format,s=/^fi$|^fi-|^da/.test(String(t))?`.`:`:`;return function(e,t){if(e=+e,!isFinite(e))return i(e);var n=~~(e/60/60),r=~~(e/60%60),c=(n?o(Math.abs(n))+s:``)+a(Math.abs(r))+s+i(Math.abs(e%60));return e<0?o(-1).replace(o(1),c):c}}function s(e,t){var n=e[1],r=e[2],i=gt[n][r]||gt.parseDatePattern(r)||gt[n].default;return new Intl.DateTimeFormat(t,i).format}function c(e,t){var n=e[1]===`selectordinal`?`ordinal`:`cardinal`,r=e[2],i=e[3],a;if(Intl.PluralRules&&Intl.PluralRules.supportedLocalesOf(t).length>0)a=new Intl.PluralRules(t,{type:n});else{var o=_t(t,xt);a={select:o&&xt[o][n]||l}}return function(e,t){return(i[`=`+ +e]||i[a.select(e-r)]||i.other)(t)}}function l(){return`other`}function u(e,t){var n=e[2];return function(e,t){return(n[e]||n.other)(t)}}var d={number:a,ordinal:a,spellout:a,duration:o,date:s,time:s,plural:c,selectordinal:c,select:u};t.types=d});St.toParts,St.types;var Ct=dt(function(e,t){var n=[`number`,`date`,`time`,`ordinal`,`duration`,`spellout`],r=[`plural`,`select`,`selectordinal`];t=e.exports=function(e,t){return i({pattern:String(e),index:0,tagsType:t&&t.tagsType||null,tokens:t&&t.tokens||null},``)};function i(e,t){var n=e.pattern,r=n.length,i=[],o=e.index,s=a(e,t);for(s&&i.push(s),s&&e.tokens&&e.tokens.push([`text`,n.slice(o,e.index)]);e.index<r;){if(n[e.index]===`}`){if(!t)throw g(e);break}if(t&&e.tagsType&&n.slice(e.index,e.index+2)===`</`)break;i.push(c(e)),o=e.index,s=a(e,t),s&&i.push(s),s&&e.tokens&&e.tokens.push([`text`,n.slice(o,e.index)])}return i}function a(e,t){for(var n=e.pattern,r=n.length,i=t===`plural`||t===`selectordinal`,a=!!e.tagsType,s=t===`{style}`,c=``;e.index<r;){var l=n[e.index];if(l===`{`||l===`}`||i&&l===`#`||a&&l===`<`||s&&o(l.charCodeAt(0)))break;if(l===`'`)if(l=n[++e.index],l===`'`)c+=l,++e.index;else if(l===`{`||l===`}`||i&&l===`#`||a&&l===`<`||s)for(c+=l;++e.index<r;)if(l=n[e.index],l===`'`&&n[e.index+1]===`'`)c+=`'`,++e.index;else if(l===`'`){++e.index;break}else c+=l;else c+=`'`;else c+=l,++e.index}return c}function o(e){return e>=9&&e<=13||e===32||e===133||e===160||e===6158||e>=8192&&e<=8205||e===8232||e===8233||e===8239||e===8287||e===8288||e===12288||e===65279}function s(e){for(var t=e.pattern,n=t.length,r=e.index;e.index<n&&o(t.charCodeAt(e.index));)++e.index;r<e.index&&e.tokens&&e.tokens.push([`space`,e.pattern.slice(r,e.index)])}function c(e){var t=e.pattern;if(t[e.index]===`#`)return e.tokens&&e.tokens.push([`syntax`,`#`]),++e.index,[`#`];var r=l(e);if(r)return r;if(t[e.index]!==`{`)throw g(e,`{`);e.tokens&&e.tokens.push([`syntax`,`{`]),++e.index,s(e);var i=u(e);if(!i)throw g(e,`placeholder id`);e.tokens&&e.tokens.push([`id`,i]),s(e);var a=t[e.index];if(a===`}`)return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,[i];if(a!==`,`)throw g(e,`, or }`);e.tokens&&e.tokens.push([`syntax`,`,`]),++e.index,s(e);var o=u(e);if(!o)throw g(e,`placeholder type`);if(e.tokens&&e.tokens.push([`type`,o]),s(e),a=t[e.index],a===`}`){if(e.tokens&&e.tokens.push([`syntax`,`}`]),o===`plural`||o===`selectordinal`||o===`select`)throw g(e,o+` sub-messages`);return++e.index,[i,o]}if(a!==`,`)throw g(e,`, or }`);e.tokens&&e.tokens.push([`syntax`,`,`]),++e.index,s(e);var c;if(o===`plural`||o===`selectordinal`){var p=f(e);s(e),c=[i,o,p,m(e,o)]}else if(o===`select`)c=[i,o,m(e,o)];else if(n.indexOf(o)>=0)c=[i,o,d(e)];else{var h=e.index,_=d(e);s(e),t[e.index]===`{`&&(e.index=h,_=m(e,o)),c=[i,o,_]}if(s(e),t[e.index]!==`}`)throw g(e,`}`);return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,c}function l(e){var t=e.tagsType;if(!(!t||e.pattern[e.index]!==`<`)){if(e.pattern.slice(e.index,e.index+2)===`</`)throw g(e,null,`closing tag without matching opening tag`);e.tokens&&e.tokens.push([`syntax`,`<`]),++e.index;var n=u(e,!0);if(!n)throw g(e,`placeholder id`);if(e.tokens&&e.tokens.push([`id`,n]),s(e),e.pattern.slice(e.index,e.index+2)===`/>`)return e.tokens&&e.tokens.push([`syntax`,`/>`]),e.index+=2,[n,t];if(e.pattern[e.index]!==`>`)throw g(e,`>`);e.tokens&&e.tokens.push([`syntax`,`>`]),++e.index;var r=i(e,t),a=e.index;if(e.pattern.slice(e.index,e.index+2)!==`</`)throw g(e,`</`+n+`>`);e.tokens&&e.tokens.push([`syntax`,`</`]),e.index+=2;var o=u(e,!0);if(o&&e.tokens&&e.tokens.push([`id`,o]),n!==o)throw e.index=a,g(e,`</`+n+`>`,`</`+o+`>`);if(s(e),e.pattern[e.index]!==`>`)throw g(e,`>`);return e.tokens&&e.tokens.push([`syntax`,`>`]),++e.index,[n,t,{children:r}]}}function u(e,t){for(var n=e.pattern,r=n.length,i=``;e.index<r;){var a=n[e.index];if(a===`{`||a===`}`||a===`,`||a===`#`||a===`'`||o(a.charCodeAt(0))||t&&(a===`<`||a===`>`||a===`/`))break;i+=a,++e.index}return i}function d(e){var t=e.index,n=a(e,`{style}`);if(!n)throw g(e,`placeholder style name`);return e.tokens&&e.tokens.push([`style`,e.pattern.slice(t,e.index)]),n}function f(e){var t=e.pattern,n=t.length,r=0;if(t.slice(e.index,e.index+7)===`offset:`){e.tokens&&e.tokens.push([`offset`,`offset`],[`syntax`,`:`]),e.index+=7,s(e);for(var i=e.index;e.index<n&&p(t.charCodeAt(e.index));)++e.index;if(i===e.index)throw g(e,`offset number`);e.tokens&&e.tokens.push([`number`,t.slice(i,e.index)]),r=+t.slice(i,e.index)}return r}function p(e){return e>=48&&e<=57}function m(e,t){for(var n=e.pattern,i=n.length,a={};e.index<i&&n[e.index]!==`}`;){var o=u(e);if(!o)throw g(e,`sub-message selector`);e.tokens&&e.tokens.push([`selector`,o]),s(e),a[o]=h(e,t),s(e)}if(!a.other&&r.indexOf(t)>=0)throw g(e,null,null,`"other" sub-message must be specified in `+t);return a}function h(e,t){if(e.pattern[e.index]!==`{`)throw g(e,`{ to start sub-message`);e.tokens&&e.tokens.push([`syntax`,`{`]),++e.index;var n=i(e,t);if(e.pattern[e.index]!==`}`)throw g(e,`} to end sub-message`);return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,n}function g(e,t,n,r){var i=e.pattern,a=i.slice(0,e.index).split(/\r?\n/),o=e.index,s=a.length,c=a.slice(-1)[0].length;return n||=e.index>=i.length?`end of message pattern`:u(e)||i[e.index],r||=_(t,n),r+=` in `+i.replace(/\r?\n/g,`
`),new v(r,t,n,o,s,c)}function _(e,t){return e?`Expected `+e+` but found `+t:`Unexpected `+t+` found`}function v(e,t,n,r,i,a){Error.call(this,e),this.name=`SyntaxError`,this.message=e,this.expected=t,this.found=n,this.offset=r,this.line=i,this.column=a}v.prototype=Object.create(Error.prototype),t.SyntaxError=v});Ct.SyntaxError;var wt=RegExp(`^(`+Object.keys(xt).join(`|`)+`)\\b`),Tt=new WeakMap;function Et(e,t,n){if(!(this instanceof Et)||Tt.has(this))throw TypeError(`calling MessageFormat constructor without new is invalid`);var r=Ct(e);Tt.set(this,{ast:r,format:St(r,t,n&&n.types),locale:Et.supportedLocalesOf(t)[0]||`en`,locales:t,options:n})}var Dt=Et;Object.defineProperties(Et.prototype,{format:{configurable:!0,get:function(){var e=Tt.get(this);if(!e)throw TypeError(`MessageFormat.prototype.format called on value that's not an object initialized as a MessageFormat`);return e.format}},formatToParts:{configurable:!0,writable:!0,value:function(e){var t=Tt.get(this);if(!t)throw TypeError(`MessageFormat.prototype.formatToParts called on value that's not an object initialized as a MessageFormat`);return(t.toParts||=St.toParts(t.ast,t.locales,t.options&&t.options.types))(e)}},resolvedOptions:{configurable:!0,writable:!0,value:function(){var e=Tt.get(this);if(!e)throw TypeError(`MessageFormat.prototype.resolvedOptions called on value that's not an object initialized as a MessageFormat`);return{locale:e.locale}}}}),typeof Symbol<`u`&&Object.defineProperty(Et.prototype,Symbol.toStringTag,{value:`Object`}),Object.defineProperties(Et,{supportedLocalesOf:{configurable:!0,writable:!0,value:function(e){return[].concat(Intl.NumberFormat.supportedLocalesOf(e),Intl.DateTimeFormat.supportedLocalesOf(e),Intl.PluralRules?Intl.PluralRules.supportedLocalesOf(e):[],[].concat(e||[]).filter(function(e){return wt.test(e)})).filter(function(e,t,n){return n.indexOf(e)===t})}}});function Ot(e){return!!(e&&e.default&&typeof e.default==`object`&&Object.keys(e).length===1)}var kt=globalThis.document?.documentElement,At=class extends EventTarget{formatNumberOptions={returnIfNaN:``,postProcessors:new Map};formatDateOptions={postProcessors:new Map};#e=!1;#t=``;#n=null;__storage={};__namespacePatternsMap=new Map;__namespaceLoadersCache={};__namespaceLoaderPromisesCache={};get locale(){return this.#e?this.#t||``:kt.lang||``}set locale(e){if(this.#r(e),!this.#e){let t=kt.lang;this._setHtmlLangAttribute(e),this._onLocaleChanged(e,t);return}let t=this.#t;this.#t=e,this.#n===null&&this._setHtmlLangAttribute(e),this._onLocaleChanged(e,t)}get loadingComplete(){return typeof this.__namespaceLoaderPromisesCache[this.locale]==`object`?Promise.all(Object.values(this.__namespaceLoaderPromisesCache[this.locale])):Promise.resolve()}constructor({allowOverridesForExistingNamespaces:e=!1,autoLoadOnLocaleChange:t=!1,showKeyAsFallback:n=!1,fallbackLocale:r=``}={}){super(),this.__allowOverridesForExistingNamespaces=e,this._autoLoadOnLocaleChange=!!t,this._showKeyAsFallback=n,this._fallbackLocale=r;let i=kt.getAttribute(`data-localize-lang`);this.#e=!!i,this.#e&&(this.locale=i,this._setupTranslationToolSupport()),kt.lang||=this.locale||`en-GB`,this._setupHtmlLangAttributeObserver()}addData(e,t,n){if(!this.__allowOverridesForExistingNamespaces&&this._isNamespaceInCache(e,t))throw Error(`Namespace "${t}" has been already added for the locale "${e}".`);this.__storage[e]=this.__storage[e]||{},this.__allowOverridesForExistingNamespaces?this.__storage[e][t]={...this.__storage[e][t],...n}:this.__storage[e][t]=n}setupNamespaceLoader(e,t){this.__namespacePatternsMap.set(e,t)}loadNamespaces(e,{locale:t}={}){return Promise.all(e.map(e=>this.loadNamespace(e,{locale:t})))}loadNamespace(e,{locale:t=this.locale}={locale:this.locale}){let n=typeof e==`object`,r=n?Object.keys(e)[0]:e;return this._isNamespaceInCache(t,r)?Promise.resolve():this._getCachedNamespaceLoaderPromise(t,r)||this._loadNamespaceData(t,e,n,r)}msg(e,t,n={}){let r=n.locale?n.locale:this.locale,i=this._getMessageForKeys(e,r);return i?new Dt(i,r).format(t):``}teardown(){this._teardownHtmlLangAttributeObserver()}reset(){this.__storage={},this.__namespacePatternsMap=new Map,this.__namespaceLoadersCache={},this.__namespaceLoaderPromisesCache={}}setDatePostProcessorForLocale({locale:e,postProcessor:t}){this.formatDateOptions?.postProcessors.set(e,t)}setNumberPostProcessorForLocale({locale:e,postProcessor:t}){this.formatNumberOptions?.postProcessors.set(e,t)}_setupTranslationToolSupport(){this.#n=kt.lang||null}_setHtmlLangAttribute(e){this._teardownHtmlLangAttributeObserver(),kt.lang=e,this._setupHtmlLangAttributeObserver()}_setupHtmlLangAttributeObserver(){this._htmlLangAttributeObserver||=new MutationObserver(e=>{e.forEach(e=>{this.#e?kt.lang===`auto`?(this.#n=null,this._setHtmlLangAttribute(this.locale)):this.#n=document.documentElement.lang:this._onLocaleChanged(document.documentElement.lang,e.oldValue||``)})}),this._htmlLangAttributeObserver.observe(document.documentElement,{attributes:!0,attributeFilter:[`lang`],attributeOldValue:!0})}_teardownHtmlLangAttributeObserver(){this._htmlLangAttributeObserver&&this._htmlLangAttributeObserver.disconnect()}_isNamespaceInCache(e,t){return!!(this.__storage[e]&&this.__storage[e][t])}_getCachedNamespaceLoaderPromise(e,t){return this.__namespaceLoaderPromisesCache[e]?this.__namespaceLoaderPromisesCache[e][t]:null}_loadNamespaceData(e,t,n,r){let i=this._getNamespaceLoader(t,n,r),a=this._getNamespaceLoaderPromise(i,e,r);return this._cacheNamespaceLoaderPromise(e,r,a),a.then(t=>{if(this.__namespaceLoaderPromisesCache[e]&&this.__namespaceLoaderPromisesCache[e][r]===a){let n=Ot(t)?t.default:t;this.addData(e,r,n)}})}_getNamespaceLoader(e,t,n){let r=this.__namespaceLoadersCache[n];if(r||(t?(r=e[n],this.__namespaceLoadersCache[n]=r):(r=this._lookupNamespaceLoader(n),this.__namespaceLoadersCache[n]=r)),!r)throw Error(`Namespace "${n}" was not properly setup.`);return this.__namespaceLoadersCache[n]=r,r}_getNamespaceLoaderPromise(e,t,n,r=this._fallbackLocale){return e(t,n).catch(()=>{let i=this._getLangFromLocale(t);return e(i,n).catch(()=>{if(r)return this._getNamespaceLoaderPromise(e,r,n,``).catch(()=>{let e=this._getLangFromLocale(r);throw Error(`Data for namespace "${n}" and current locale "${t}" or fallback locale "${r}" could not be loaded. Make sure you have data either for locale "${t}" (and/or generic language "${i}") or for fallback "${r}" (and/or "${e}").`)});throw Error(`Data for namespace "${n}" and locale "${t}" could not be loaded. Make sure you have data for locale "${t}" (and/or generic language "${i}").`)})})}_cacheNamespaceLoaderPromise(e,t,n){this.__namespaceLoaderPromisesCache[e]||(this.__namespaceLoaderPromisesCache[e]={}),this.__namespaceLoaderPromisesCache[e][t]=n}_lookupNamespaceLoader(e){for(let[t,n]of this.__namespacePatternsMap){let r=typeof t==`string`&&t===e,i=typeof t==`object`&&t.constructor.name===`RegExp`&&t.test(e);if(r||i)return n}return null}_getLangFromLocale(e){return e.substring(0,2)}_onLocaleChanged(e,t){this.dispatchEvent(new CustomEvent(`__localeChanging`)),e!==t&&(this._autoLoadOnLocaleChange?(this._loadAllMissing(e,t),this.loadingComplete.then(()=>{this.dispatchEvent(new CustomEvent(`localeChanged`,{detail:{newLocale:e,oldLocale:t}}))})):this.dispatchEvent(new CustomEvent(`localeChanged`,{detail:{newLocale:e,oldLocale:t}})))}_loadAllMissing(e,t){let n=this.__storage[t]||{},r=this.__storage[e]||{};Object.keys(n).forEach(t=>{r[t]||this.loadNamespace(t,{locale:e})})}_getMessageForKeys(e,t){if(typeof e==`string`)return this._getMessageForKey(e,t);let n=Array.from(e).reverse(),r,i;for(;n.length;)if(r=n.pop(),i=this._getMessageForKey(r,t),i)return i}_getMessageForKey(e,t){if(!e||e.indexOf(`:`)===-1)throw Error(`Namespace is missing in the key "${e}". The format for keys is "namespace:name".`);let[n,r]=e.split(`:`),i=this.__storage[t],a=i?i[n]:{},o=r.split(`.`).reduce((e,t)=>typeof e==`object`?e[t]:e,a);return String(o||(this._showKeyAsFallback?e:``))}#r(e){if(!e.includes(`-`))throw Error(`
      Locale was set to ${e}.
      Language only locales are not allowed, please use the full language locale e.g. 'en-GB' instead of 'en'.
      See https://github.com/ing-bank/lion/issues/187 for more information.
    `)}get _supportExternalTranslationTools(){return this.#e}set _supportExternalTranslationTools(e){this.#e=e}get _langAttrSetByTranslationTool(){return this.#t}set _langAttrSetByTranslationTool(e){this.#t=e}};function jt(){if(!h.has(`@lion/ui::localize::0.x`)){let e=new At({autoLoadOnLocaleChange:!0,fallbackLocale:`en-GB`});h.set(`@lion/ui::localize::0.x`,e)}return h.get(`@lion/ui::localize::0.x`)}function Mt(){return m(jt)}var Nt=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),Nt(e,t);return!0},Pt=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},Ft=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),Rt(t)}};function It(e){this._$AN===void 0?this._$AM=e:(Pt(this),this._$AM=e,Ft(this))}function Lt(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(r))for(let e=n;e<r.length;e++)Nt(r[e],!1),Pt(r[e]);else r!=null&&(Nt(r,!1),Pt(r));else Nt(this,e)}var Rt=e=>{e.type==i.CHILD&&(e._$AP??=Lt,e._$AQ??=It)},zt=class extends a{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),Ft(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Nt(this,e),Pt(this))}setValue(e){if(_e(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},Bt=class{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}},Vt=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((e=>this.Z=e))}resume(){this.Z?.(),this.Y=this.Z=void 0}},Ht=e=>!he(e)&&typeof e.then==`function`,Ut=1073741823,Wt=c(class extends zt{constructor(){super(...arguments),this._$Cwt=Ut,this._$Cbt=[],this._$CK=new Bt(this),this._$CX=new Vt}render(...e){return e.find((e=>!Ht(e)))??ne}update(e,t){let n=this._$Cbt,r=n.length;this._$Cbt=t;let i=this._$CK,a=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){let o=t[e];if(!Ht(o))return this._$Cwt=e,o;e<r&&o===n[e]||(this._$Cwt=Ut,r=0,Promise.resolve(o).then((async e=>{for(;a.get();)await a.get();let t=i.deref();if(t!==void 0){let n=t._$Cbt.indexOf(o);n>-1&&n<t._$Cwt&&(t._$Cwt=n,t.setValue(e))}})))}return ne}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),Gt=d(e=>class extends e{static get localizeNamespaces(){return[]}static get waitForLocalizeNamespaces(){return!0}constructor(){super(),this._localizeManager=Mt(),this.__boundLocalizeOnLocaleChanged=(...e)=>{let t=Array.from(e)[0];this.__localizeOnLocaleChanged(t)},this.__boundLocalizeOnLocaleChanging=()=>{this.__localizeOnLocaleChanging()},this.__localizeStartLoadingNamespaces(),this.localizeNamespacesLoaded&&this.localizeNamespacesLoaded.then(()=>{this.__localizeMessageSync=!0})}async scheduleUpdate(){Object.getPrototypeOf(this).constructor.waitForLocalizeNamespaces&&await this.localizeNamespacesLoaded,super.scheduleUpdate()}connectedCallback(){super.connectedCallback(),this.localizeNamespacesLoaded&&this.localizeNamespacesLoaded.then(()=>this.onLocaleReady()),this._localizeManager.addEventListener(`__localeChanging`,this.__boundLocalizeOnLocaleChanging),this._localizeManager.addEventListener(`localeChanged`,this.__boundLocalizeOnLocaleChanged)}disconnectedCallback(){super.disconnectedCallback(),this._localizeManager.removeEventListener(`__localeChanging`,this.__boundLocalizeOnLocaleChanging),this._localizeManager.removeEventListener(`localeChanged`,this.__boundLocalizeOnLocaleChanged)}msgLit(e,t,n){return this.__localizeMessageSync?this._localizeManager.msg(e,t,n):this.localizeNamespacesLoaded?Wt(this.localizeNamespacesLoaded.then(()=>this._localizeManager.msg(e,t,n)),O):``}__getUniqueNamespaces(){let e=[],t=new Set;return Object.getPrototypeOf(this).constructor.localizeNamespaces.forEach(t.add.bind(t)),t.forEach(t=>{e.push(t)}),e}__localizeStartLoadingNamespaces(){this.localizeNamespacesLoaded=this._localizeManager.loadNamespaces(this.__getUniqueNamespaces())}__localizeOnLocaleChanging(){this.__localizeStartLoadingNamespaces()}__localizeOnLocaleChanged(e){this.onLocaleChanged(e.detail.newLocale,e.detail.oldLocale)}onLocaleReady(){this.onLocaleUpdated()}onLocaleChanged(e,t){this.onLocaleUpdated(),this.requestUpdate()}onLocaleUpdated(){}}),Kt=`3.0.0`,qt=window.scopedElementsVersions||(window.scopedElementsVersions=[]);qt.includes(Kt)||qt.push(Kt);var Jt=d(e=>class extends e{static scopedElements;static get scopedElementsVersion(){return Kt}static __registry;get registry(){return this.constructor.__registry}set registry(e){this.constructor.__registry=e}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=new CustomElementRegistry;for(let[e,n]of Object.entries(t??{}))this.registry.define(e,n)}return super.attachShadow({...e,customElements:this.registry,registry:this.registry})}}),Yt=d(e=>class extends Jt(e){createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return this.renderOptions.creationScope=n,te(n,t),this.renderOptions.renderBefore??=n.firstChild,n}});function Xt(){return!!(globalThis.ShadowRoot?.prototype.createElement&&globalThis.ShadowRoot?.prototype.importNode)}var Zt=d(e=>class extends Yt(e){constructor(){super()}createScopedElement(e){return(Xt()?this.shadowRoot:document).createElement(e)}defineScopedElement(e,t){let n=this.registry.get(e),r=n&&n!==t;return!Xt()&&r&&console.error([`You are trying to re-register the "${e}" custom element with a different class via ScopedElementsMixin.`,`This is only possible with a CustomElementRegistry.`,`Your browser does not support this feature so you will need to load a polyfill for it.`,`Load "@webcomponents/scoped-custom-element-registry" before you register ANY web component to the global customElements registry.`,`e.g. add "<script src="/node_modules/@webcomponents/scoped-custom-element-registry/scoped-custom-element-registry.min.js"><\/script>" as your first script tag.`,`For more details you can visit https://open-wc.org/docs/development/scoped-elements/`].join(`
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=Xt()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return Xt()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(te(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),Qt=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function $t(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return Qt.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var en=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},tn=d(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),nn=d(e=>class extends tn(ee(De(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=Oe(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...$t(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return E`
      ...
      `}_inputGroupPrefixTemplate(){return Array.from(this.children).find(e=>e.slot===`prefix`)?E`
          ...
          `:O}_inputGroupInputTemplate(){return E`
      ...
      `}_inputGroupSuffixTemplate(){return Array.from(this.children).find(e=>e.slot===`suffix`)?E`
          ...
          `:O}_inputGroupAfterTemplate(){return E`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof en&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&(typeof t!=`boolean`||t!==!1)}static get styles(){return[D`
          /**********************
            {block} .form-field
           ********************/
        ...
        `]}_getAriaDescriptionElements(){return[this._helpTextNode,this._feedbackNode]}addToAriaLabelledBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaLabelledNodes.includes(e)||(this._ariaLabelledNodes=[...this._ariaLabelledNodes,e],this.__reorderAriaLabelledNodes=!!n)}removeFromAriaLabelledBy(e){this._ariaLabelledNodes.includes(e)&&(this._ariaLabelledNodes.splice(this._ariaLabelledNodes.indexOf(e),1),this._ariaLabelledNodes=[...this._ariaLabelledNodes],this.__reorderAriaLabelledNodes=!1)}addToAriaDescribedBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaDescribedNodes.includes(e)||(this._ariaDescribedNodes=[...this._ariaDescribedNodes,e],this.__reorderAriaDescribedNodes=!!n)}removeFromAriaDescribedBy(e){this._ariaDescribedNodes.includes(e)&&(this._ariaDescribedNodes.splice(this._ariaDescribedNodes.indexOf(e),1),this._ariaDescribedNodes=[...this._ariaDescribedNodes],this.__reorderAriaLabelledNodes=!1)}__getDirectSlotChild(e){return Array.from(this.children).find(t=>t.slot===e)}_dispatchInitialModelValueChangedEvent(){this._repropagationRole!==`child`&&(this.__repropagateChildrenInitialized=!0,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],initialize:!0,isTriggeredByUser:!1}})))}_onBeforeRepropagateChildrenValues(e){}__repropagateChildrenValues(e){this._onBeforeRepropagateChildrenValues(e);let t=e.detail&&e.detail.element||e.target,n=this._isRepropagationEndpoint||this._repropagationRole===`choice-group`;if(t===this)return;e.stopImmediatePropagation();let r=this._repropagationRole!==`child`&&!this.__repropagateChildrenInitialized,i=e.detail&&e.detail.initialize;if(r||i||!this._repropagationCondition(t))return;let a=[];n||(a=e.detail&&e.detail.formPath||[t]);let o=[...a,this];this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:o,isTriggeredByUser:!!e.detail?.isTriggeredByUser}}))}_repropagationCondition(e){return!!e}_onLabelClick(){}}),rn=class{constructor(){this.__running=!1,this.__queue=[]}add(e){this.__queue.push(e),this.__running||(this.complete=new Promise(e=>{this.__callComplete=e}),this.__run())}async __run(){this.__running=!0,await this.__queue[0](),this.__queue.shift(),this.__queue.length>0?this.__run():(this.__running=!1,this.__callComplete&&this.__callComplete())}};function an(e){return e.charAt(0).toUpperCase()+e.slice(1)}var on=d(e=>class extends e{constructor(){super(),this.__SyncUpdatableNamespace={}}firstUpdated(e){super.firstUpdated(e),this.__syncUpdatableInitialize()}connectedCallback(){super.connectedCallback(),this.__SyncUpdatableNamespace.connected=!0}disconnectedCallback(){super.disconnectedCallback(),this.__SyncUpdatableNamespace.connected=!1}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];static __syncUpdatableHasChanged(e,t,n){let r=this.elementProperties;return r.get(e)&&r.get(e).hasChanged?r.get(e).hasChanged(t,n):t!==n}__syncUpdatableInitialize(){let e=this.__SyncUpdatableNamespace,t=this.constructor;e.initialized=!0,e.queue&&Array.from(e.queue).forEach(e=>{t.__syncUpdatableHasChanged(e,this[e],void 0)&&this.updateSync(e,void 0)})}requestUpdate(e,t,n){if(super.requestUpdate(e,t,n),e===void 0)return;this.__SyncUpdatableNamespace=this.__SyncUpdatableNamespace||{};let r=this.__SyncUpdatableNamespace,i=this.constructor;r.initialized?i.__syncUpdatableHasChanged(e,this[e],t)&&this.updateSync(e,t):(r.queue=r.queue||new Set,r.queue.add(e))}updateSync(e,t){}}),sn=e=>{switch(e){case`bg-BG`:return y(()=>import(`./bg-BG-BSOJu8wp.js`),__vite__mapDeps([0,1]),import.meta.url);case`bg`:return y(()=>import(`./bg-tT2-9j0y.js`),__vite__mapDeps([2,1]),import.meta.url);case`cs-CZ`:return y(()=>import(`./cs-CZ-BXYisR25.js`),__vite__mapDeps([3,4]),import.meta.url);case`cs`:return y(()=>import(`./cs-BWWtw9FR.js`),__vite__mapDeps([5,4]),import.meta.url);case`de-DE`:return y(()=>import(`./de-DE-CqA9yOdY.js`),__vite__mapDeps([6,7]),import.meta.url);case`de`:return y(()=>import(`./de-D2KzmuNN.js`),__vite__mapDeps([8,7]),import.meta.url);case`en-AU`:return y(()=>import(`./en-AU-ClGzkm9N.js`),__vite__mapDeps([9,10]),import.meta.url);case`en-GB`:return y(()=>import(`./en-GB-ClGzkm9N.js`),__vite__mapDeps([11,10]),import.meta.url);case`en-US`:return y(()=>import(`./en-US-ClGzkm9N.js`),__vite__mapDeps([12,10]),import.meta.url);case`en-PH`:case`en`:return y(()=>import(`./en-Bn2liEJW.js`),__vite__mapDeps([13,10]),import.meta.url);case`es-ES`:return y(()=>import(`./es-ES-lc8truAL.js`),__vite__mapDeps([14,15]),import.meta.url);case`es`:return y(()=>import(`./es-BHRFfW-v.js`),__vite__mapDeps([16,15]),import.meta.url);case`fr-FR`:return y(()=>import(`./fr-FR-BFPCNFnr.js`),__vite__mapDeps([17,18]),import.meta.url);case`fr-BE`:return y(()=>import(`./fr-BE-BFPCNFnr.js`),__vite__mapDeps([19,18]),import.meta.url);case`fr`:return y(()=>import(`./fr-BatdFrY1.js`),__vite__mapDeps([20,18]),import.meta.url);case`hu-HU`:return y(()=>import(`./hu-HU-CgHBHfiG.js`),__vite__mapDeps([21,22]),import.meta.url);case`hu`:return y(()=>import(`./hu-BGJUkRn0.js`),__vite__mapDeps([23,22]),import.meta.url);case`it-IT`:return y(()=>import(`./it-IT-DXWt8Y3M.js`),__vite__mapDeps([24,25]),import.meta.url);case`it`:return y(()=>import(`./it-BbZB0zCO.js`),__vite__mapDeps([26,25]),import.meta.url);case`nl-BE`:return y(()=>import(`./nl-BE-CN9u7Cp2.js`),__vite__mapDeps([27,28]),import.meta.url);case`nl-NL`:return y(()=>import(`./nl-NL-CN9u7Cp2.js`),__vite__mapDeps([29,28]),import.meta.url);case`nl`:return y(()=>import(`./nl-CubSULoy.js`),__vite__mapDeps([30,28]),import.meta.url);case`pl-PL`:return y(()=>import(`./pl-PL-D0K_dWml.js`),__vite__mapDeps([31,32]),import.meta.url);case`pl`:return y(()=>import(`./pl-BhJlmndU.js`),__vite__mapDeps([33,32]),import.meta.url);case`ro-RO`:return y(()=>import(`./ro-RO-BXVNXH1J.js`),__vite__mapDeps([34,35]),import.meta.url);case`ro`:return y(()=>import(`./ro-75jeTe0N.js`),__vite__mapDeps([36,35]),import.meta.url);case`ru-RU`:return y(()=>import(`./ru-RU-BpGy32BK.js`),__vite__mapDeps([37,38]),import.meta.url);case`ru`:return y(()=>import(`./ru-DU7uFj2i.js`),__vite__mapDeps([39,38]),import.meta.url);case`sk-SK`:return y(()=>import(`./sk-SK-wewEOZGv.js`),__vite__mapDeps([40,41]),import.meta.url);case`sk`:return y(()=>import(`./sk-cN9_UHno.js`),__vite__mapDeps([42,41]),import.meta.url);case`tr-TR`:return y(()=>import(`./tr-TR-D1nJ_iYG.js`),__vite__mapDeps([43,44]),import.meta.url);case`tr`:return y(()=>import(`./tr-DuiqIpvR.js`),__vite__mapDeps([45,44]),import.meta.url);case`uk-UA`:return y(()=>import(`./uk-UA-DHqiIGvL.js`),__vite__mapDeps([46,47]),import.meta.url);case`uk`:return y(()=>import(`./uk-Cm-Wcqws.js`),__vite__mapDeps([48,47]),import.meta.url);case`zh-CN`:case`zh`:return y(()=>import(`./zh-DMe6SF13.js`),[],import.meta.url);default:return y(()=>import(`./en-Bn2liEJW.js`),__vite__mapDeps([13,10]),import.meta.url)}},cn=e=>`${e[0].toUpperCase()}${e.slice(1)}`,ln=class extends Gt(k){static get properties(){return{feedbackData:{attribute:!1}}}static localizeNamespaces=[{"lion-form-core":sn},...super.localizeNamespaces];static get styles(){return[D`
    ...
    `}_onRequestToAddFormElement(e){e.target.hasAttribute(`role`)||e.target?.setAttribute(`role`,`listitem`),this.__addToSubCheckboxes(e.detail.element),this._setOwnCheckedState()}_onRequestToRemoveFormElement(e){e.target.getAttribute(`role`)===`listitem`&&e.target?.removeAttribute(`role`),this.__removeFromSubCheckboxes(e.detail.element)}__addToSubCheckboxes(e){e!==this&&this.contains(e)&&this.__subCheckboxes.push(e)}__removeFromSubCheckboxes(e){let t=this.__subCheckboxes.indexOf(e);t!==-1&&this.__subCheckboxes.splice(t,1)}constructor(){super(),this.indeterminate=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this.__onModelValueChanged=this.__onModelValueChanged.bind(this),this.__subCheckboxes=[],this._indeterminateSubStates=[],this.mixedState=!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,this.__onModelValueChanged),this.addEventListener(`form-element-register`,this._onRequestToAddFormElement)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`model-value-changed`,this.__onModelValueChanged),this.removeEventListener(`form-element-register`,this._onRequestToAddFormElement)}firstUpdated(e){super.firstUpdated(e),this._setOldState(),this.indeterminate&&this._storeIndeterminateState()}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&(this._inputNode.indeterminate=this.indeterminate)}},An=class extends En{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="checkbox"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...En.styles,D`
      ...
      `]}};function Pn(){let e=this.allMode===`single-value`&&this.checked;for(let t of this._subCheckboxes??[]){let n=t.querySelector(`:scope > input[slot="input"]`);n&&(e?n.name&&(n.dataset.governedName=n.name,n.removeAttribute(`name`)):n.dataset.governedName&&(n.name=n.dataset.governedName,delete n.dataset.governedName))}}A([j({reflect:!0,attribute:`all-mode`})],Nn.prototype,`allMode`,void 0),customElements.get(`craft-checkbox-indeterminate`)||customElements.define(`craft-checkbox-indeterminate`,Nn);var Fn=class extends jn(On){constructor(...e){super(...e),this.__inputPatched=!1,this.indeterminate=!1}connectedCallback(){super.connectedCallback(),this.__patchSlottedInputProps()}updated(e){super.updated(e),this.__patchSlottedInputProps();let t=this._inputNode;t&&(t.indeterminate=this.indeterminate)}__patchSlottedInputProps(){if(this.__inputPatched)return;let e=this.__slottedInputElement();if(!e)return;this.__inputPatched=!0;let t=this;for(let n of[`checked`,`disabled`]){let r=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,n);if(!r?.get||!r.set)continue;let{get:i,set:a}=r;Object.defineProperty(e,n,{configurable:!0,enumerable:r.enumerable,get(){return i.call(this)},set(e){a.call(this,e),t[n]!==e&&(t[n]=e)}})}}__slottedInputElement(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}static get styles(){return[...On.styles,ot,D`
      ...
      `]}};A([j({type:Boolean,reflect:!0})],Fn.prototype,`indeterminate`,void 0),customElements.get(`craft-checkbox`)||customElements.define(`craft-checkbox`,Fn);var In=new Map;async function Ln(e,t,n=!1){let r=[],i=[],a=()=>{for(let e of r)e.remove();i.forEach(e=>e())};if(!e)return a;let o=document.createElement(`template`);o.innerHTML=e.trim();try{for(let e of o.content.childNodes){let a=zn(e);if(a){let e=In.get(a.key);if(e){e.references++,i.push(()=>Un(a.key,e)),e.loaded&&await Hn(e.loaded,n);continue}if(Bn(a))continue}let o=Rn(e),s=a&&o instanceof HTMLScriptElement?Vn(o,a.value):null;if(t.appendChild(o),a&&(o instanceof HTMLLinkElement||o instanceof HTMLScriptElement)){let e={node:o,loaded:s,references:1};In.set(a.key,e),i.push(()=>Un(a.key,e))}else r.push(o);s&&await Hn(s,n)}return a}catch(e){throw a(),e}}function Rn(e){if(!(e instanceof HTMLScriptElement))return e.cloneNode(!0);let t=document.createElement(`script`);for(let n of e.attributes)t.setAttribute(n.name,n.value);return t.textContent=e.textContent,t.async=!1,t}function zn(e){return e instanceof HTMLLinkElement&&e.href?{key:`link:${e.href}`,selector:`link[href]`,value:e.href}:e instanceof HTMLScriptElement&&e.src?{key:`script:${e.src}`,selector:`script[src]`,value:e.src}:null}function Bn(e){return Array.from(document.querySelectorAll(e.selector)).some(t=>(t instanceof HTMLLinkElement?t.href:t.src)===e.value)}function Vn(e,t){return new Promise((n,r)=>{e.addEventListener(`load`,()=>n(),{once:!0}),e.addEventListener(`error`,()=>r(Error(`Failed to load asset [${t}].`)),{once:!0})})}async function Hn(e,t){try{await e}catch(e){if(t)throw e}}function Un(e,t){t.references--,!(t.references>0)&&(t.node.remove(),In.delete(e))}async function Wn(e){return Ln(e,document.head)}async function Gn(e){return Ln(e,document.body)}function Kn(e){return typeof e.checkVisibility==`function`?e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}):e.offsetWidth>0||e.offsetHeight>0}function qn(e){return typeof e==`object`&&!!e&&`checked`in e&&typeof e.checked==`boolean`}function Jn(e){return Yn(e).toString()}function Yn(e){let t=new URLSearchParams,n=e.querySelectorAll(`input[name], select[name], textarea[name]`);for(let e of n)if(!e.disabled&&!(e instanceof HTMLInputElement&&([`file`,`submit`,`button`,`reset`,`image`].includes(e.type)||(e.type===`checkbox`||e.type===`radio`)&&!e.checked))){if(e instanceof HTMLSelectElement&&e.multiple){for(let n of e.selectedOptions)t.append(e.name,n.value);continue}t.append(e.name,e.value)}for(let n of e.querySelectorAll(`*`)){if(!n.tagName.includes(`-`))continue;let e=n.name;if(typeof e!=`string`||e===``||n.disabled===!0||n.querySelector(`input[name], select[name], textarea[name]`))continue;if(qn(n.modelValue)){n.modelValue.checked&&t.append(e,String(n.modelValue.value??``));continue}let r=n.serializedValue??n.value;if(r!=null)if(Array.isArray(r))for(let n of r)t.append(e,String(n));else t.append(e,String(r))}return t}var Xn={Á:`A`,á:`a`,Ä:`A`,ä:`a`,À:`A`,à:`a`,Â:`A`,â:`a`,É:`E`,é:`e`,Ë:`E`,ë:`e`,È:`E`,è:`e`,Ê:`E`,ê:`e`,Í:`I`,í:`i`,Ï:`I`,ï:`i`,Ì:`I`,ì:`i`,Î:`I`,î:`i`,Ó:`O`,ó:`o`,Ö:`O`,ö:`o`,Ò:`O`,ò:`o`,Ô:`O`,ô:`o`,Ú:`U`,ú:`u`,Ü:`U`,ü:`u`,Ù:`U`,ù:`u`,Û:`U`,û:`u`,Ý:`Y`,ý:`y`,Ÿ:`Y`,А:`A`,Б:`B`,В:`V`,Г:`G`,Д:`D`,Ѓ:`Gj`,Е:`E`,Ж:`Z`,З:`Z`,Ѕ:`Dz`,И:`I`,Ј:`j`,К:`K`,Л:`L`,Љ:`Lj`,М:`M`,Н:`N`,Њ:`Nj`,О:`O`,П:`P`,Р:`R`,С:`S`,Т:`T`,Ќ:`Kj`,У:`U`,Ф:`F`,Х:`X`,Ц:`C`,Ч:`C`,Џ:`Dz`,Ш:`S`,а:`a`,б:`b`,в:`v`,г:`g`,д:`d`,ѓ:`gj`,е:`e`,ж:`z`,з:`z`,ѕ:`dz`,и:`i`,ј:`j`,к:`k`,л:`l`,љ:`lj`,м:`m`,н:`n`,њ:`nj`,о:`o`,п:`p`,р:`r`,с:`s`,т:`t`,ќ:`kj`,у:`u`,ф:`f`,х:`x`,ц:`c`,ч:`c`,џ:`dz`,ш:`s`,æ:`ae`,ǽ:`ae`,Ã:`A`,Å:`A`,Ǻ:`A`,Ă:`A`,Ǎ:`A`,Æ:`AE`,Ǽ:`AE`,ã:`a`,å:`a`,ǻ:`a`,ă:`a`,ǎ:`a`,ª:`a`,Ĉ:`C`,Ċ:`C`,Ç:`C`,ç:`c`,ĉ:`c`,ċ:`c`,Ð:`D`,Đ:`D`,ð:`d`,đ:`d`,Ĕ:`E`,Ė:`E`,ĕ:`e`,ė:`e`,ƒ:`f`,Ĝ:`G`,Ġ:`G`,ĝ:`g`,ġ:`g`,Ĥ:`H`,Ħ:`H`,ĥ:`h`,ħ:`h`,Ĩ:`I`,Ĭ:`I`,Ǐ:`I`,Į:`I`,Ĳ:`IJ`,ĩ:`i`,ĭ:`i`,ǐ:`i`,į:`i`,ĳ:`ij`,Ĵ:`J`,ĵ:`j`,Ĺ:`L`,Ľ:`L`,Ŀ:`L`,ĺ:`l`,ľ:`l`,ŀ:`l`,Ñ:`N`,ñ:`n`,ŉ:`n`,Õ:`O`,Ō:`O`,Ŏ:`O`,Ǒ:`O`,Ő:`O`,Ơ:`O`,Ø:`O`,Ǿ:`O`,Œ:`OE`,õ:`o`,ō:`o`,ŏ:`o`,ǒ:`o`,ő:`o`,ơ:`o`,ø:`o`,ǿ:`o`,º:`o`,œ:`oe`,Ŕ:`R`,Ŗ:`R`,ŕ:`r`,ŗ:`r`,Ŝ:`S`,Ș:`S`,ŝ:`s`,ș:`s`,ſ:`s`,Ţ:`T`,Ț:`T`,Ŧ:`T`,Þ:`TH`,ţ:`t`,ț:`t`,ŧ:`t`,þ:`th`,Ũ:`U`,Ŭ:`U`,Ű:`U`,Ų:`U`,Ư:`U`,Ǔ:`U`,Ǖ:`U`,Ǘ:`U`,Ǚ:`U`,Ǜ:`U`,ũ:`u`,ŭ:`u`,ű:`u`,ų:`u`,ư:`u`,ǔ:`u`,ǖ:`u`,ǘ:`u`,ǚ:`u`,ǜ:`u`,Ŵ:`W`,ŵ:`w`,Ŷ:`Y`,ÿ:`y`,ŷ:`y`,ΑΥ:`AU`,ΑΎ:`AU`,Αυ:`Au`,Αύ:`Au`,ΕΊ:`I`,ΕΙ:`I`,Ει:`Ei`,ΕΥ:`EF`,ΕΎ:`EU`,Εί:`I`,Ευ:`Ef`,Εύ:`Eu`,ΟΙ:`I`,ΟΊ:`I`,ΟΥ:`U`,ΟΎ:`OU`,Οι:`Oi`,Οί:`I`,Ου:`Oy`,Ού:`Ou`,ΥΙ:`I`,ΎΙ:`I`,Υι:`Yi`,Ύι:`I`,ΥΊ:`I`,Υί:`I`,αυ:`au`,αύ:`au`,εί:`i`,ει:`ei`,ευ:`ef`,εύ:`eu`,οι:`oi`,οί:`i`,ου:`oy`,ού:`ou`,υι:`yi`,ύι:`i`,υί:`i`,Α:`A`,Ά:`A`,Β:`B`,Δ:`D`,Ε:`E`,Έ:`E`,Φ:`F`,Γ:`G`,Η:`H`,Ή:`I`,Ι:`I`,Ί:`I`,Ϊ:`I`,Κ:`K`,Ξ:`Ks`,Λ:`L`,Μ:`M`,Ν:`N`,Π:`P`,Ο:`O`,Ό:`O`,Ψ:`Ps`,Ρ:`R`,Σ:`S`,Τ:`T`,Θ:`Th`,Ω:`O`,Ώ:`W`,Χ:`X`,ϒ:`Y`,Υ:`Y`,Ύ:`Y`,Ϋ:`Y`,Ζ:`Z`,α:`a`,ά:`a`,β:`v`,δ:`d`,ε:`e`,έ:`e`,φ:`f`,γ:`gh`,η:`i`,ή:`i`,ι:`i`,ί:`i`,ϊ:`i`,ΐ:`i`,κ:`k`,ξ:`ks`,λ:`l`,μ:`m`,ν:`n`,ο:`o`,ό:`o`,π:`p`,ψ:`ps`,ρ:`r`,σ:`s`,ς:`s`,τ:`t`,ϑ:`th`,θ:`th`,ϐ:`v`,ω:`o`,ώ:`w`,χ:`kh`,υ:`i`,ύ:`y`,ΰ:`y`,ϋ:`y`,ζ:`z`,अ:`a`,आ:`aa`,ए:`e`,ई:`ii`,ऍ:`ei`,ऎ:`ae`,ऐ:`ai`,इ:`i`,ओ:`o`,ऑ:`oi`,ऒ:`oii`,ऊ:`uu`,औ:`ou`,उ:`u`,ब:`B`,भ:`Bha`,च:`Ca`,छ:`Chha`,ड:`Da`,ढ:`Dha`,फ:`Fa`,फ़:`Fi`,ग:`Ga`,घ:`Gha`,ग़:`Ghi`,ह:`Ha`,ज:`Ja`,झ:`Jha`,क:`Ka`,ख:`Kha`,ख़:`Khi`,ल:`L`,ळ:`Li`,ऌ:`Li`,ऴ:`Lii`,ॡ:`Lii`,म:`Ma`,न:`Na`,ङ:`Na`,ञ:`Nia`,ण:`Nae`,ऩ:`Ni`,ॐ:`oms`,प:`Pa`,क़:`Qi`,र:`Ra`,ऋ:`Ri`,ॠ:`Ri`,ऱ:`Ri`,स:`Sa`,श:`Sha`,ष:`Shha`,ट:`Ta`,त:`Ta`,ठ:`Tha`,द:`Tha`,थ:`Tha`,ध:`Thha`,ड़:`ugDha`,ढ़:`ugDhha`,व:`Va`,य:`Ya`,य़:`Yi`,ज़:`Za`,Ա:`A`,Բ:`B`,Գ:`G`,Դ:`D`,Ե:`E`,Զ:`Z`,Է:`E`,Ը:`Y`,Թ:`Th`,Ժ:`Zh`,Ի:`I`,Լ:`L`,Խ:`Kh`,Ծ:`Ts`,Կ:`K`,Հ:`H`,Ձ:`Dz`,Ղ:`Gh`,Ճ:`Tch`,Մ:`M`,Յ:`Y`,Ն:`N`,Շ:`Sh`,Ո:`Vo`,Չ:`Ch`,Պ:`P`,Ջ:`J`,Ռ:`R`,Ս:`S`,Վ:`V`,Տ:`T`,Ր:`R`,Ց:`C`,Ւ:`u`,Փ:`Ph`,Ք:`Q`,և:`ev`,Օ:`O`,Ֆ:`F`,ա:`a`,բ:`b`,գ:`g`,դ:`d`,ե:`e`,զ:`z`,է:`e`,ը:`y`,թ:`th`,ժ:`zh`,ի:`i`,լ:`l`,խ:`kh`,ծ:`ts`,կ:`k`,հ:`h`,ձ:`dz`,ղ:`gh`,ճ:`tch`,մ:`m`,յ:`y`,ն:`n`,շ:`sh`,ո:`vo`,չ:`ch`,պ:`p`,ջ:`j`,ռ:`r`,ս:`s`,վ:`v`,տ:`t`,ր:`r`,ց:`c`,ւ:`u`,փ:`ph`,ք:`q`,օ:`o`,ֆ:`f`,Ž:`Z`,Ň:`N`,Ş:`S`,ž:`z`,ň:`n`,ş:`s`,ı:`i`,İ:`I`,ğ:`g`,Ğ:`G`,ьо:`yo`,Й:`i`,Щ:`Shh`,Ъ:`Ie`,Ь:``,Ю:`Iu`,Я:`Ia`,й:`i`,щ:`shh`,ъ:`ie`,ь:``,ю:`iu`,я:`ia`,Ē:`E`,ē:`e`,န်ုပ်:`nub`,"ောင်":`aung`,"ိုက်":`aik`,"ိုဒ်":`ok`,"ိုင်":`aing`,"ိုလ်":`ol`,"ေါင်":`aung`,သြော:`aw`,"ောက်":`auk`,"ိတ်":`eik`,"ုတ်":`ok`,"ုန်":`on`,"ေတ်":`it`,"ုဒ်":`ait`,"ာန်":`an`,"ိန်":`ein`,"ွတ်":`ut`,"ေါ်":`aw`,"ွန်":`un`,"ိပ်":`eik`,"ုပ်":`ok`,"ွပ်":`ut`,"ိမ်":`ein`,"ုမ်":`on`,"ော်":`aw`,"ွမ်":`un`,က်:`et`,"ေါ":`aw`,"ော":`aw`,"ျွ":`ywa`,"ြွ":`yw`,"ို":`o`,"ုံ":`on`,တ်:`at`,င်:`in`,ည်:`i`,ဒ်:`d`,န်:`an`,ပ်:`at`,မ်:`an`,စျ:`za`,ယ်:`e`,ဉ်:`in`,စ်:`it`,"ိံ":`ein`,"ဲ":`e`,"း":``,"ာ":`a`,"ါ":`a`,"ေ":`e`,"ံ":`an`,"ိ":`i`,"ီ":`i`,"ု":`u`,"ူ":`u`,"်":`at`,"္":``,"့":``,က:`k`,"၉":`9`,တ:`t`,ရ:`ya`,ယ:`y`,မ:`m`,ဘ:`ba`,ဗ:`b`,ဖ:`pa`,ပ:`p`,န:`n`,ဓ:`da`,ဒ:`d`,ထ:`ta`,ဏ:`na`,ဝ:`w`,ဎ:`da`,ဍ:`d`,ဌ:`ta`,ဋ:`t`,ည:`ny`,ဇ:`z`,ဆ:`sa`,စ:`s`,င:`ng`,ဃ:`ga`,ဂ:`g`,လ:`l`,သ:`th`,"၈":`8`,ဩ:`aw`,ခ:`kh`,"၆":`6`,"၅":`5`,"၄":`4`,"၃":`3`,"၂":`2`,"၁":`1`,"၀":`0`,"၌":`hnaik`,"၍":`ywae`,ဪ:`aw`,ဦ:`-u`,ဟ:`h`,ဉ:`u`,ဤ:`-i`,ဣ:`i`,"၏":`-e`,ဧ:`e`,"ှ":`h`,"ွ":`w`,"ျ":`ya`,"ြ":`y`,အ:`a`,ဠ:`la`,"၇":`7`,DŽ:`DZ`,Dž:`Dz`,dž:`dz`,Ǳ:`DZ`,ǲ:`Dz`,ǳ:`dz`,Ǉ:`LJ`,ǈ:`Lj`,ǉ:`lj`,Ǌ:`NJ`,ǋ:`Nj`,ǌ:`nj`,č:`c`,Č:`C`,ć:`c`,Ć:`C`,š:`s`,Š:`S`,ა:`a`,ბ:`b`,გ:`g`,დ:`d`,ე:`e`,ვ:`v`,ზ:`z`,თ:`t`,ი:`i`,კ:`k`,ლ:`l`,მ:`m`,ნ:`n`,ო:`o`,პ:`p`,ჟ:`zh`,რ:`r`,ს:`s`,ტ:`t`,უ:`u`,ფ:`f`,ქ:`q`,ღ:`gh`,ყ:`y`,შ:`sh`,ჩ:`ch`,ც:`ts`,ძ:`dz`,წ:`ts`,ჭ:`ch`,ხ:`kh`,ჯ:`j`,ჰ:`h`,Ё:`E`,ё:`e`,Ы:`Y`,ы:`y`,Э:`E`,э:`e`,І:`I`,і:`i`,Ѳ:`F`,ѳ:`f`,Ѣ:`E`,ѣ:`e`,Ѵ:`I`,ѵ:`i`,Є:`Je`,є:`je`,Ѥ:`Je`,ѥ:`je`,Ꙋ:`U`,ꙋ:`u`,Ѡ:`O`,ѡ:`o`,Ѿ:`Ot`,ѿ:`ot`,Ѫ:`U`,ѫ:`u`,Ѧ:`Ja`,ѧ:`ja`,Ѭ:`Ju`,ѭ:`ju`,Ѩ:`Ja`,ѩ:`Ja`,Ѯ:`Ks`,ѯ:`ks`,Ѱ:`Ps`,ѱ:`ps`,Ґ:`G`,ґ:`g`,Ї:`Yi`,ї:`yi`,Ә:`A`,Ғ:`G`,Қ:`Q`,Ң:`N`,Ө:`O`,Ұ:`U`,Ү:`U`,Һ:`H`,ә:`a`,ғ:`g`,қ:`q`,ң:`n`,ө:`o`,ұ:`u`,ү:`u`,һ:`h`,ď:`d`,Ď:`D`,ě:`e`,Ě:`E`,ř:`r`,Ř:`R`,ť:`t`,Ť:`T`,ů:`u`,Ů:`U`,ą:`a`,ę:`e`,ł:`l`,ń:`n`,ś:`s`,ź:`z`,ż:`z`,Ą:`A`,Ę:`E`,Ł:`L`,Ń:`N`,Ś:`S`,Ź:`Z`,Ż:`Z`,ā:`a`,ģ:`g`,ī:`i`,ķ:`k`,ļ:`l`,ņ:`n`,ū:`u`,Ā:`A`,Ģ:`G`,Ī:`I`,Ķ:`k`,Ļ:`L`,Ņ:`N`,Ū:`U`,Ả:`A`,Ạ:`A`,Ắ:`A`,Ằ:`A`,Ẳ:`A`,Ẵ:`A`,Ặ:`A`,Ấ:`A`,Ầ:`A`,Ẩ:`A`,Ẫ:`A`,Ậ:`A`,ả:`a`,ạ:`a`,ắ:`a`,ằ:`a`,ẳ:`a`,ẵ:`a`,ặ:`a`,ấ:`a`,ầ:`a`,ẩ:`a`,ẫ:`a`,ậ:`a`,Ẻ:`E`,Ẽ:`E`,Ẹ:`E`,Ế:`E`,Ề:`E`,Ể:`E`,Ễ:`E`,Ệ:`E`,ẻ:`e`,ẽ:`e`,ẹ:`e`,ế:`e`,ề:`e`,ể:`e`,ễ:`e`,ệ:`e`,Ỉ:`I`,Ị:`I`,ỉ:`i`,ị:`i`,Ỏ:`O`,Ọ:`O`,Ố:`O`,Ồ:`O`,Ổ:`O`,Ỗ:`O`,Ộ:`O`,Ớ:`O`,Ờ:`O`,Ở:`O`,Ỡ:`O`,Ợ:`O`,ỏ:`o`,ọ:`o`,ố:`o`,ồ:`o`,ổ:`o`,ỗ:`o`,ộ:`o`,ớ:`o`,ờ:`o`,ở:`o`,ỡ:`o`,ợ:`o`,Ủ:`U`,Ụ:`U`,Ứ:`U`,Ừ:`U`,Ử:`U`,Ữ:`U`,Ự:`U`,ủ:`u`,ụ:`u`,ứ:`u`,ừ:`u`,ử:`u`,ữ:`u`,ự:`u`,Ỳ:`Y`,Ỷ:`Y`,Ỹ:`Y`,Ỵ:`Y`,ỳ:`y`,ỷ:`y`,ỹ:`y`,ỵ:`y`,ا:`a`,ب:`b`,پ:`p`,ت:`t`,ث:`th`,ج:`g`,چ:`ch`,ح:`h`,خ:`kh`,د:`d`,ذ:`th`,ر:`r`,ز:`z`,س:`s`,ش:`sh`,ص:`s`,ض:`d`,ط:`t`,ظ:`th`,ع:`aa`,غ:`gh`,ف:`f`,ق:`k`,ک:`k`,گ:`g`,ل:`l`,ژ:`zh`,ك:`k`,م:`m`,ن:`n`,ه:`h`,و:`o`,ی:`y`,آ:`a`,"٠":`0`,"١":`1`,"٢":`2`,"٣":`3`,"٤":`4`,"٥":`5`,"٦":`6`,"٧":`7`,"٨":`8`,"٩":`9`,أ:`a`,ي:`y`,إ:`a`,ؤ:`o`,ئ:`y`,ء:`aa`,ђ:`dj`,ћ:`c`,Ђ:`Dj`,Ћ:`C`,ə:`e`,Ə:`E`,ß:`ss`,ẞ:`SS`,ভ্ল:`vl`,পশ:`psh`,ব্ধ:`bdh`,ব্জ:`bj`,ব্দ:`bd`,ব্ব:`bb`,ব্ল:`bl`,ভ:`v`,ব:`b`,চ্ঞ:`cNG`,চ্ছ:`cch`,চ্চ:`cc`,ছ:`ch`,চ:`c`,ধ্ন:`dhn`,ধ্ম:`dhm`,দ্ঘ:`dgh`,দ্ধ:`ddh`,দ্ভ:`dv`,দ্ম:`dm`,ড্ড:`DD`,ঢ:`Dh`,ধ:`dh`,দ্গ:`dg`,দ্দ:`dd`,ড:`D`,দ:`d`,"।":`.`,ঘ্ন:`Ghn`,গ্ধ:`Gdh`,গ্ণ:`GN`,গ্ন:`Gn`,গ্ম:`Gm`,গ্ল:`Gl`,জ্ঞ:`jNG`,ঘ:`Gh`,গ:`g`,হ্ণ:`hN`,হ্ন:`hn`,হ্ম:`hm`,হ্ল:`hl`,হ:`h`,জ্ঝ:`jjh`,ঝ:`jh`,জ্জ:`jj`,জ:`j`,ক্ষ্ণ:`kxN`,ক্ষ্ম:`kxm`,ক্ষ:`ksh`,কশ:`ksh`,ক্ক:`kk`,ক্ট:`kT`,ক্ত:`kt`,ক্ল:`kl`,ক্স:`ks`,খ:`kh`,ক:`k`,ল্ভ:`lv`,ল্ধ:`ldh`,লখ:`lkh`,লঘ:`lgh`,লফ:`lph`,ল্ক:`lk`,ল্গ:`lg`,ল্ট:`lT`,ল্ড:`lD`,ল্প:`lp`,ল্ম:`lm`,ল্ল:`ll`,ল্ব:`lb`,ল:`l`,ম্থ:`mth`,ম্ফ:`mf`,ম্ভ:`mv`,মপ্ল:`mpl`,ম্ন:`mn`,ম্প:`mp`,ম্ম:`mm`,ম্ল:`ml`,ম্ব:`mb`,ম:`m`,"০":`0`,"১":`1`,"২":`2`,"৩":`3`,"৪":`4`,"৫":`5`,"৬":`6`,"৭":`7`,"৮":`8`,"৯":`9`,ঙ্ক্ষ:`Ngkx`,ঞ্ছ:`nch`,ঙ্ঘ:`ngh`,ঙ্খ:`nkh`,ঞ্ঝ:`njh`,ঙ্গৌ:`ngOU`,ঙ্গৈ:`ngOI`,ঞ্চ:`nc`,ঙ্ক:`nk`,ঙ্ষ:`Ngx`,ঙ্গ:`ngo`,ঙ্ম:`Ngm`,ঞ্জ:`nj`,ন্ধ:`ndh`,ন্ঠ:`nTh`,ণ্ঠ:`NTh`,ন্থ:`nth`,ঙ্গা:`nga`,ঙ্গি:`ngi`,ঙ্গী:`ngI`,ঙ্গু:`ngu`,ঙ্গূ:`ngU`,ঙ্গে:`nge`,ঙ্গো:`ngO`,ণ্ঢ:`NDh`,নশ:`nsh`,ঙর:`Ngr`,ঞর:`NGr`,"ংর":`ngr`,ঙ:`Ng`,ঞ:`NG`,"ং":`ng`,ন্ন:`nn`,ণ্ণ:`NN`,ণ্ন:`Nn`,ন্ম:`nm`,ণ্ম:`Nm`,ন্দ:`nd`,ন্ট:`nT`,ণ্ট:`NT`,ন্ড:`nD`,ণ্ড:`ND`,ন্ত:`nt`,ন্স:`ns`,ন:`n`,ণ:`N`,"ৈ":`OI`,"ৌ":`OU`,"ো":`O`,ঐ:`OI`,ঔ:`OU`,অ:`o`,ও:`oo`,ফ্ল:`fl`,প্ট:`pT`,প্ত:`pt`,প্ন:`pn`,প্প:`pp`,প্ল:`pl`,প্স:`ps`,ফ:`f`,প:`p`,"ৃ":`rri`,ঋ:`rri`,রর‍্য:`rry`,"্র্য":`ry`,"্রর":`rr`,ড়্গ:`Rg`,ঢ়:`Rh`,ড়:`R`,র:`r`,"্র":`r`,শ্ছ:`Sch`,ষ্ঠ:`ShTh`,ষ্ফ:`Shf`,স্ক্ল:`skl`,স্খ:`skh`,স্থ:`sth`,স্ফ:`sf`,শ্চ:`Sc`,শ্ত:`St`,শ্ন:`Sn`,শ্ম:`Sm`,শ্ল:`Sl`,ষ্ক:`Shk`,ষ্ট:`ShT`,ষ্ণ:`ShN`,ষ্প:`Shp`,ষ্ম:`Shm`,স্প্ল:`spl`,স্ক:`sk`,স্ট:`sT`,স্ত:`st`,স্ন:`sn`,স্প:`sp`,স্ম:`sm`,স্ল:`sl`,শ:`S`,ষ:`Sh`,স:`s`,"ু":`u`,উ:`u`,অ্য:`oZ`,ত্থ:`tth`,ৎ:`tt`,ট্ট:`TT`,ট্ম:`Tm`,ঠ:`Th`,ত্ন:`tn`,ত্ম:`tm`,থ:`th`,ত্ত:`tt`,ট:`T`,ত:`t`,অ্যা:`AZ`,"া":`a`,আ:`a`,য়া:`ya`,য়:`y`,"ি":`i`,ই:`i`,"ী":`ee`,ঈ:`ee`,"ূ":`uu`,ঊ:`uu`,"ে":`e`,এ:`e`,য:`z`,"্য":`Z`,ইয়:`y`,ওয়:`w`,"্ব":`w`,এক্স:`x`,"ঃ":`:`,"ঁ":`nn`,"্‌":``,"˚":`0`,"¹":`1`,"²":`2`,"³":`3`,"⁴":`4`,"⁵":`5`,"⁶":`6`,"⁷":`7`,"⁸":`8`,"⁹":`9`,"₀":`0`,"₁":`1`,"₂":`2`,"₃":`3`,"₄":`4`,"₅":`5`,"₆":`6`,"₇":`7`,"₈":`8`,"₉":`9`,"௦":`0`,"௧":`1`,"௨":`2`,"௩":`3`,"௪":`4`,"௫":`5`,"௬":`6`,"௭":`7`,"௮":`8`,"௯":`9`,"௰":`10`,"௱":`100`,"௲":`1000`,Ꜳ:`AA`,ꜳ:`aa`,Ꜵ:`AO`,ꜵ:`ao`,Ꜷ:`AU`,ꜷ:`au`,Ꜹ:`AV`,ꜹ:`av`,Ꜻ:`av`,ꜻ:`av`,Ꜽ:`AY`,ꜽ:`ay`,ȸ:`db`,ʣ:`dz`,ʥ:`dz`,ʤ:`dezh`,"🙰":`et`,ﬀ:`ff`,ﬃ:`ffi`,ﬄ:`ffl`,ﬁ:`fi`,ﬂ:`fl`,ʩ:`feng`,ʪ:`ls`,ʫ:`lz`,ɮ:`lezh`,ȹ:`qp`,ʨ:`tc`,ʦ:`ts`,ʧ:`tesh`,Ꝏ:`OO`,ꝏ:`oo`,ﬆ:`st`,ﬅ:`st`,Ꜩ:`TZ`,ꜩ:`tz`,ᵫ:`ue`,Aι:`Ai`,αι:`ai`,ἀ:`a`,ἁ:`a`,ἂ:`a`,ἃ:`a`,ἄ:`a`,ἅ:`a`,ἆ:`a`,ἇ:`a`,Ἀ:`A`,Ἁ:`A`,Ἂ:`A`,Ἃ:`A`,Ἄ:`A`,Ἅ:`A`,Ἆ:`A`,Ἇ:`A`,ᾰ:`a`,ᾱ:`a`,ᾲ:`a`,ᾳ:`a`,ᾴ:`a`,ᾶ:`a`,ᾷ:`a`,Ᾰ:`A`,Ᾱ:`A`,Ὰ:`A`,Ά:`A`,ᾼ:`A`,A̧:`A`,a̧:`a`,Ⱥ:`A`,ⱥ:`a`,Ȧ:`A`,ȧ:`a`,Ɓ:`B`,C̈:`C`,c̈:`c`,C̨:`C`,c̨:`c`,Ȼ:`C`,ȼ:`c`,C̀:`C`,c̀:`c`,C̣:`C`,c̣:`c`,C̄:`C`,c̄:`c`,C̃:`C`,c̃:`c`,Ȩ:`E`,ȩ:`e`,Ɇ:`E`,ɇ:`e`,I̧:`I`,i̧:`i`,Ɨ:`I`,ɨ:`i`,i:`i`,J́́:`J`,j́:`j`,J̀̀:`J`,j̀:`j`,J̈:`J`,j̈:`j`,J̧:`J`,j̧:`j`,J̨:`J`,j̨:`j`,Ɉ:`J`,ɉ:`j`,J̌:`J`,ǰ:`j`,J̇:`J`,j:`j`,J̣:`J`,j̣:`j`,J̄:`J`,j̄:`j`,J̃:`J`,j̃:`j`,ĸ:`k`,L̀:`L`,l̀:`l`,L̂:`L`,l̂:`l`,L̈:`L`,l̈:`l`,L̨:`L`,l̨:`l`,Ƚ:`L`,ƚ:`l`,L̇:`L`,l̇:`l`,Ḷ:`L`,ḷ:`l`,L̄:`L`,l̄:`l`,L̃:`L`,l̃:`l`,Ŋ:`N`,ŋ:`n`,Ǹ:`N`,ǹ:`n`,N̂:`N`,n̂:`n`,N̈:`N`,n̈:`n`,N̨:`N`,n̨:`n`,Ꞥ:`N`,ꞥ:`n`,Ṅ:`N`,ṅ:`n`,Ṇ:`N`,ṇ:`n`,N̄:`N`,n̄:`n`,O̧:`O`,o̧:`o`,Ǫ:`O`,ǫ:`o`,Ɵ:`O`,ɵ:`o`,Ȯ:`O`,ȯ:`o`,S̀:`S`,s̀:`s`,Ŝ̀:`S`,S̈:`S`,s̈:`s`,S̨:`S`,s̨:`s`,Ꞩ:`S`,ꞩ:`s`,Ṡ:`S`,ṡ:`s`,Ṣ:`S`,ṣ:`s`,S̄:`S`,s̄:`s`,S̃:`S`,s̃:`s`,T́:`T`,t́:`t`,T̀:`T`,t̀:`t`,T̂:`T`,t̂:`t`,T̈:`T`,ẗ:`t`,T̨:`T`,t̨:`t`,Ⱦ:`T`,ⱦ:`t`,Ṫ:`T`,ṫ:`t`,Ṭ:`T`,ṭ:`t`,T̄:`T`,t̄:`t`,T̃:`T`,t̃:`t`,U̧:`U`,u̧:`u`,Ʉ:`U`,ʉ:`u`,U̇:`U`,u̇:`u`,Ʊ:`U`,ʊ:`u`,Ẁ:`W`,ẁ:`w`,Ẃ:`W`,ẃ:`w`,Ẅ:`W`,ẅ:`w`,Ꙗ:`Ja`,ꙗ:`ja`,Y̧:`Y`,y̧:`y`,Y̨:`Y`,y̨:`y`,Ɏ:`Y`,ɏ:`y`,Y̌:`Y`,y̌:`y`,Ẏ:`Y`,ẏ:`y`,Ȳ:`Y`,ȳ:`y`,Z̀:`Z`,z̀:`z`,Ẑ:`Z`,ẑ:`z`,Z̈:`Z`,z̈:`z`,Z̧:`Z`,z̧:`z`,Z̨:`Z`,z̨:`z`,Ƶ:`Z`,ƶ:`z`,Ẓ:`Z`,ẓ:`z`,Z̄:`Z`,z̄:`z`,Z̃:`Z`,z̃:`z`,"\xA0":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `,"\u2028":` `,"\u2029":` `,"​":` `," ":` `," ":` `,"　":` `,ﾠ:` `,"«":`<<`,"»":`>>`,"‘":`'`,"’":`'`,"‚":`'`,"‛":`'`,"“":`"`,"”":`"`,"„":`"`,"‟":`"`,"‹":`'`,"›":`'`,"–":`-`,"—":`-`,"…":`...`,"€":`EUR`,$:`$`,"₢":`Cr`,"₣":`Fr.`,"£":`PS`,"₤":`L.`,ℳ:`M`,"₥":`mil`,"₦":`N`,"₧":`Pts`,"₨":`Rs`,රු:`LKR`,ரூ:`LKR`,"௹":`Rs`,रू:`NPR`,"₹":`Rs`,"૱":`Rs`,"₩":`W`,"₪":`NS`,"₸":`KZT`,"₫":`D`,"֏":`AMD`,"₭":`K`,"₺":`TL`,"₼":`AZN`,"₮":`T`,"₯":`Dr`,"₲":`PYG`,"₾":`GEL`,"₳":`ARA`,"₴":`UAH`,"₽":`RUB`,"₵":`GHS`,"₡":`CL`,"¢":`c`,"¥":`YEN`,円:`JPY`,"৳":`BDT`,元:`CNY`,"﷼":`SAR`,"៛":`KR`,"₠":`ECU`,"¤":`$?`,"฿":`THB`,"؋":`AFN`};function Zn(e,t=Xn){e=e.normalize(`NFC`);let n=``,r;for(let i=0;i<e.length;i++)r=e.charAt(i),n+=typeof t[r]==`string`?t[r]:r;return n}function Qn(e,t={}){let n={allowNonAlphaStart:!1,handleCasing:`camel`,...t};var r=e.replace(/<(.*?)>/g,``);r=r.replace(/['"‘’“”ʻ\[\]\(\)\{\}:]/g,``),r=r.toLowerCase(),r=Zn(r),n.allowNonAlphaStart||(r=r.replace(/^[^a-z]+/,``));let i=r.split(/[^a-z0-9]+/).filter(Boolean);if(r=``,n.handleCasing===`snake`)return i.join(`_`);for(let e=0;e<i.length;e++)n.handleCasing!==`pascal`&&e===0?r+=i[e]:r+=i[e].charAt(0).toUpperCase()+i[e].substring(1);return r}function $n(e,t={}){let n={prefix:``,suffix:``,...t},r=Qn(e,{handleCasing:`snake`}).toUpperCase();return r?`${n.prefix}${r}${n.suffix}`:``}function er(e){let t=e.replace(/<(.*?)>/g,``);return t=t.toLowerCase(),t=Zn(t),t=t.replace(/^[^a-z]+/,``),t=t.replace(/[^a-z0-9]+$/,``),t.split(/[^a-z0-9]+/).filter(Boolean).join(`-`)}function tr(e){return e.charAt(0).toUpperCase()+e.slice(1)}function nr(){return Math.floor(Math.random()*1e6)}var rr=new WeakMap,ir=class e{constructor(){this.queue=[],this.workers=[],P(this,rr,null),I(rr,this,new AbortController);for(let e=0;e<3;e++)this.workers.push(new cr(this))}load(t=document,n=`[data-sizes]`){t.querySelectorAll(n).forEach(t=>{if(Kn(t))this.addToQueue(t);else{let n=`thumb${nr()}`;e.invisibleThumbs[n]=[this,t];let r=()=>{e.invisibleThumbs[n]&&Kn(t)&&(delete e.invisibleThumbs[n],this.addToQueue(t))};document.addEventListener(`scroll`,r,{signal:N(rr,this)?.signal}),window.addEventListener(`resize`,r,{signal:N(rr,this)?.signal})}})}addToQueue(e){this.queue.push(e),this.workers.forEach(e=>{e.active||e.loadNext()})}static retryAll(){for(let t in e.invisibleThumbs){let n=e.invisibleThumbs[t];if(!n)continue;let[r,i]=n;delete e.invisibleThumbs[t],r.load(i.parentElement??document)}}destroy(){this.workers.forEach(e=>e.deactivate()),N(rr,this)?.abort()}};ir.invisibleThumbs={};var ar=new WeakMap,or=new WeakMap,sr=new WeakMap,cr=class{constructor(e){this.active=!1,this.container=void 0,P(this,ar,null),P(this,or,null),P(this,sr,null),I(ar,this,e)}activate(){this.active||(this.active=!0,this.clearInterval(),I(or,this,setInterval(()=>{this.loadNextIfRemoved()},500)))}deactivate(){this.active&&(this.active=!1,this.clearInterval(),this.clearTimeout())}clearInterval(){N(or,this)&&(clearInterval(N(or,this)),I(or,this,null))}clearTimeout(){N(sr,this)&&(clearTimeout(N(sr,this)),I(sr,this,null))}loadNext(){if(this.clearTimeout(),this.container=N(ar,this)?.queue.shift(),this.container===void 0){this.deactivate();return}if(this.loadNextIfRemoved())return;if(this.container.querySelectorAll(`img`).length>0){this.loadNext();return}this.activate(),I(sr,this,setTimeout(()=>{this.loadNext()},3e4));let e=document.createElement(`img`);e.sizes=this.container.getAttribute(`data-sizes`)??``,e.srcset=this.container.getAttribute(`data-srcset`)??``,e.alt=this.container.getAttribute(`data-alt`)??``,e.setAttribute(`data-animated`,this.container.getAttribute(`data-animated`)??``),e.src=this.container.getAttribute(`data-src`)??``,e.onload=()=>this.loadNext(),e.onabort=()=>this.loadNext(),e.onerror=()=>this.loadNext(),this.container.appendChild(e)}loadNextIfRemoved(){return this.container&&!document.body.contains(this.container)?(this.loadNext(),!0):!1}},lr=D`
  :host {
    display: contents;
  }
...
`,ur=new WeakMap,dr=new WeakMap,fr=new WeakMap,pr=new WeakSet,mr=class extends k{constructor(...e){super(...e),F(this,pr),this.size=``,this.variant=ue.Neutral,this.appearance=S.OutlineFill,this.icon=null,this.showIndicators=!1,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,this.selected=!1,this.selectLabel=null,P(this,ur,!1),P(this,dr,new ir),this.lightDom=0,P(this,fr,new MutationObserver(()=>this.lightDom++))}connectedCallback(){super.connectedCallback(),N(fr,this).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){N(fr,this).disconnect(),super.disconnectedCallback()}renderSelect(){return E`<input
      type="checkbox"
      class="cp-chip__select"
      part="select"
      .checked=${this.selected}
      aria-label=${this.selectLabel??O}
      @click=${L(pr,this,hr)}
      @change=${L(pr,this,gr)}
    />`}renderPrefix(){return E`<div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
        ${this.showThumb?E`<slot class="cp-chip__thumbnail" name="thumbnail"></slot>`:O}
        ${this.icon?E`<slot class="cp-chip__icon" name="icon"
              ><craft-icon name="${this.icon}"></craft-icon
            ></slot>`:O}
        ${this.showStatus?E`<slot class="cp-chip__status" name="status"></slot>`:O}
      </slot>
    </div>`}firstUpdated(e){super.firstUpdated(e),N(dr,this).load(this)}render(){this.lightDom;let e=L(pr,this,_r).call(this,`prefix`)||L(pr,this,_r).call(this,`icon`)||L(pr,this,_r).call(this,`thumbnail`)||L(pr,this,_r).call(this,`indicator`)||L(pr,this,_r).call(this,`status`)||this.icon,t=L(pr,this,_r).call(this,`suffix`);return E`
      <div
        part="chip"
        class="${w({"cp-chip":!0,"cp-chip--small":this.size===`small`,"cp-chip--medium":this.size===`medium`,"cp-chip--large":this.size===`large`,"cp-chip--plain":this.appearance===S.Plain,"cp-chip--selectable":this.selectable,"cp-chip--show-thumb":this.showThumb,"cp-chip--show-indicators":this.showIndicators,"cp-chip--show-status":this.showStatus})}"
      >
        ${this.selectable?this.renderSelect():O}
    ...
    `}};function hr(e){I(ur,this,e.shiftKey),e.stopPropagation()}function gr(e){let{checked:t}=e.target;this.selected=t,this.dispatchEvent(new CustomEvent(`selected-change`,{detail:{selected:t,shiftKey:N(ur,this)},bubbles:!0,composed:!0}))}function _r(e){return!!this.querySelector(`:scope > [slot="${e}"]`)}mr.styles=[lr],A([j()],mr.prototype,`size`,void 0),A([j({reflect:!0})],mr.prototype,`variant`,void 0),A([j({reflect:!0})],mr.prototype,`appearance`,void 0),A([j()],mr.prototype,`icon`,void 0),A([j({attribute:`show-indicators`,type:Boolean})],mr.prototype,`showIndicators`,void 0),A([j({attribute:`show-status`,type:Boolean})],mr.prototype,`showStatus`,void 0),A([j({attribute:`show-thumb`,type:Boolean})],mr.prototype,`showThumb`,void 0),A([j({type:Boolean})],mr.prototype,`selectable`,void 0),A([j({type:Boolean,reflect:!0})],mr.prototype,`selected`,void 0),A([j({attribute:`select-label`})],mr.prototype,`selectLabel`,void 0),A([M()],mr.prototype,`lightDom`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,mr);var vr=class extends yn(k){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},yr=d(e=>class extends nn(Zt(xn(De(vn(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],D`
          :host {
            display: block;
          }
...
`,Cr=new WeakMap,wr=new WeakSet,Tr=class extends xr{constructor(...e){super(...e),F(this,wr),this.hint=null,P(this,Cr,void 0)}static get styles(){return[...xr.styles,Sr]}connectedCallback(){super.connectedCallback(),Dr._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),Dr._.unobserve(this)}render(){return E`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?E`<span class="hint">${this.hint}</span>`:O}
        <slot name="suffix"></slot>
      </div>
    `}};function Er(){return N(Cr,this)??I(Cr,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),N(Cr,this)}var Dr={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=L(wr,e,Er).call(e))}})};A([j()],Tr.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,Tr);var Or=new WeakMap;function kr(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Or.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else kr(n,t)})}function Ar(e){Or.has(e)&&Or.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Or.has(e)&&Or.get(e)():Ar(e)})}var jr=class extends un{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof en}};function Mr(e){return Array.isArray(e)?e:[e]}var Nr=d(e=>class extends xn(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Mr(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Mr(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Mr(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Mr(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Pr=new WeakMap,Fr=class extends Gt(x(Nr(br))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,D`
        .input-group__input {
          display: flex;
          flex: 1;
        }
      ...
      `]}static get localizeNamespaces(){return[{"lion-combobox":e=>{switch(e){case`bg-BG`:case`bg`:return y(()=>import(`./bg-Bs0XcBVB.js`),[],import.meta.url);case`cs-CZ`:case`cs`:return y(()=>import(`./cs-B8DQIi4_.js`),[],import.meta.url);case`de-AT`:case`de-DE`:case`de`:return y(()=>import(`./de-BGf3YhNb.js`),[],import.meta.url);case`en-AU`:case`en-GB`:case`en-PH`:case`en-US`:case`en`:return y(()=>import(`./en-D-xWIAUL.js`),[],import.meta.url);case`es-ES`:case`es`:return y(()=>import(`./es-BxznwUyK.js`),[],import.meta.url);case`fr-FR`:case`fr-BE`:case`fr`:return y(()=>import(`./fr-Cma_rLCi.js`),[],import.meta.url);case`hu-HU`:case`hu`:return y(()=>import(`./hu-oz_RH6aJ.js`),[],import.meta.url);case`it-IT`:case`it`:return y(()=>import(`./it-BUnCsVOb.js`),[],import.meta.url);case`nl-BE`:case`nl-NL`:case`nl`:return y(()=>import(`./nl-BgK25p-m.js`),[],import.meta.url);case`pl-PL`:case`pl`:return y(()=>import(`./pl-BFxKYQFW.js`),[],import.meta.url);case`ro-RO`:case`ro`:return y(()=>import(`./ro-DXnny9tt.js`),[],import.meta.url);case`ru-RU`:case`ru`:return y(()=>import(`./ru-DxR-HmN-.js`),[],import.meta.url);case`sk-SK`:case`sk`:return y(()=>import(`./sk-Hha-L2N4.js`),[],import.meta.url);case`uk-UA`:case`uk`:return y(()=>import(`./uk-CvmsXQbu.js`),[],import.meta.url);case`zh-CN`:case`zh`:return y(()=>import(`./zh-CgAr6HSc.js`),[],import.meta.url);default:return y(()=>import(`./en-D-xWIAUL.js`),[],import.meta.url)}}},...super.localizeNamespaces]}get modelValue(){let e=super.modelValue;return e===``?this.parser(this.value):e}set modelValue(e){super.modelValue=e}get value(){return this._inputNode?.value||this.__value||``}set value(e){this._inputNode?(this._inputNode.value=e,this.__value=void 0):this.__value=e}reset(){super.reset(),this.multipleChoice||(this.value=this._initialModelValue),this._resetListboxOptions()}_resetListboxOptions(){this.formElements.forEach((e,t)=>{this._unhighlightMatchedOption(e),!this.showAllOnEmpty||!this.opened?e.style.display=`none`:(e.style.display=``,e.setAttribute(`aria-posinset`,`${t+1}`),e.setAttribute(`aria-setsize`,`${this.formElements.length}`),e.removeAttribute(`aria-hidden`))})}_inputGroupInputTemplate(){return E`
      <div class="input-group__input">
    ...
    `}_overlayListboxTemplate(){return E`
      ...
      <slot id="options-outlet"></slot>
    `}_groupTwoTemplate(){return E` ${super._groupTwoTemplate()} ${this._overlayListboxTemplate()}`}get slots(){return{...super.slots,input:()=>{if(this._ariaVersion===`1.1`){let e=document.createElement(`div`),t=document.createElement(`input`);return t.style.cssText=`
          border: none;
          outline: none;
          width: 100%;
          height: 100%;
...
`,zr=new WeakMap,Br=new WeakMap,Vr=new WeakMap,U=new WeakSet,Hr=new WeakMap,Ur=class extends Fr{static get properties(){return{modelValue:{attribute:`model-value`}}}attributeChangedCallback(e,t,n){if(e===`model-value`){this.modelValue=this.hasAttribute(`multiple-choice`)?JSON.parse(n??`[]`):n??``;return}super.attributeChangedCallback(e,t,n)}static get styles(){return[...super.styles,Rr]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),F(this,U),this.multipleChoice=!1,this.required=!1,this.initialValues=[],this.fieldsetDisabled=!1,this.changingValues=!1,this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,P(this,zr,void 0),P(this,Br,!1),P(this,Vr,()=>{I(Br,this,!0),L(U,this,Jr).call(this),!this.multipleChoice&&!this.requireOptionMatch&&L(U,this,Wr).call(this)}),P(this,Hr,()=>{if(this.multipleChoice){this.changeValues([]);return}this.modelValue=``,this._inputNode&&(this._inputNode.value=``),L(U,this,Jr).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.selectionFollowsFocus=!1,this.addEventListener(`model-value-changed`,e=>{if(this.changingValues){e.stopImmediatePropagation();return}if(e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&JSON.stringify(this.modelValue)!==JSON.stringify(this.pendingModelValue)){e.stopImmediatePropagation();return}e.target===this&&e.detail?.isTriggeredByUser&&(this.pendingModelValue=this.multipleChoice?[...this.selectedValues]:this.modelValue,this.multipleChoice&&(this.syncInputs(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))))}),this.addEventListener(`focusout`,e=>{this.multipleChoice&&!this.requireOptionMatch&&!(e.relatedTarget instanceof Node&&this.contains(e.relatedTarget))&&this.commitQuery()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,N(Vr,this)),this.addEventListener(`model-value-changed`,()=>{I(zr,this,this.modelValue)}),I(zr,this,this.modelValue),L(U,this,Jr).call(this),this.multipleChoice&&(this.initialValues=[...Array.isArray(this.pendingModelValue)?this.pendingModelValue:[]])}updated(e){if(super.updated(e),this._listboxNode?.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this.multipleChoice){this.syncInputs(),this._inputNode.removeAttribute(`name`),this._comboboxNode.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this._inputNode.disabled=this.disabled||this.fieldsetDisabled;let e=this.required&&!this.inactive&&this.selectedValues.length===0;this.internals??=this.attachInternals(),this.internals.setValidity(e?{valueMissing:!0}:{},e?s(`This field is required.`):``,this._inputNode)}e.has(`opened`)&&!this.opened&&I(Br,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`)||e.has(`multipleChoice`))&&L(U,this,Jr).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,L(U,this,Qr).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t);let n=e;n.updateComplete.then(()=>{if(this.multipleChoice){n.checked=Array.isArray(this.pendingModelValue)&&this.pendingModelValue.includes(String(n.choiceValue));return}String(n.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(n)))})}_notifyModelValueChanged(){JSON.stringify(this.modelValue)!==JSON.stringify(N(zr,this))&&(I(zr,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:this.multipleChoice?`selection`:`input`}})))}matchCondition(e){return!this.multipleChoice||!e.hidden}_autoSelectCondition(){return!this.multipleChoice}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=L(U,this,Qr).call(this)?.data?.icon;return E`
      <div class="input-group__input">
        ${this.multipleChoice?Lr(this.selectedValues,e=>e,e=>E`
                <span class="token">
                  ${this.valueLabel(e)}
                  ${this.inactive?O:E`<button
                        type="button"
                        aria-label=${s(`Remove {label}`,{label:this.valueLabel(e)})}
        ...
        <div class="combobox__textbox">
          ${e?E`<craft-icon class="prefix" name=${e}></craft-icon>`:O}
          <slot name="input"></slot>
          ${this.clearable&&L(U,this,Xr).call(this)&&!this.inactive?E`<craft-button
                class="clear"
                type="button"
                appearance="plain"
                size="small"
    ...
    `}get selectedValues(){return Array.isArray(this.modelValue)?this.modelValue:[]}get inactive(){return this.disabled||this.readOnly||this.fieldsetDisabled}valueLabel(e){return[...L(U,this,$r).call(this)].find(t=>t.value===e)?.label??e}syncInputs(){this.inputs||(this.inputs=document.createElement(`span`),this.inputs.hidden=!0,this.inputs.slot=`native-inputs`,this.inputs.setAttribute(`data-combobox-inputs`,``),this.append(this.inputs)),re(!this.name||this.disabled||this.fieldsetDisabled?O:E`
            <input type="hidden" name=${this.name} value="" />
            ${this.selectedValues.map(e=>E`<input
                  type="hidden"
                  name=${`${this.name}[]`}
                  .value=${e}
                />`)}
          `,this.inputs)}formResetCallback(){this.multipleChoice&&(this.modelValue=[...this.initialValues],this.value=``,this.syncInputs())}formDisabledCallback(e){this.fieldsetDisabled=e,this.requestUpdate(),this.multipleChoice&&this.syncInputs()}changeValues(e){if(!this.inactive){this.changingValues=!0;try{this.modelValue=e}finally{this.changingValues=!1}this.value=``,this.opened=!1,L(U,this,Jr).call(this),this.syncInputs(),this._notifyModelValueChanged(),this._inputNode.focus()}}commitQuery(){let e=this.value;if(this.inactive||e===``)return;let t=[...L(U,this,$r).call(this)].find(t=>t.value===e);t?.disabled||this.requireOptionMatch&&!t||this.changeValues([...new Set([...this.selectedValues,e])])}_listboxOnKeyDown(e){if(!this.multipleChoice){super._listboxOnKeyDown(e);return}if(this.inactive||e.isComposing)return;if(e.key===`Backspace`&&this.value===``){e.preventDefault(),this.changeValues(this.selectedValues.slice(0,-1));return}let t=this.formElements[this.activeIndex];if(e.key===`Enter`&&(!this.opened||!t||t.hidden||t.hasAttribute(`aria-hidden`))){e.preventDefault(),this.commitQuery();return}super._listboxOnKeyDown(e)}_syncToTextboxMultiple(){}_resetListboxOptions(){super._resetListboxOptions(),this.hideSelectedOptions()}_handleAutocompletion(){super._handleAutocompletion(),this.hideSelectedOptions()}hideSelectedOptions(){if(!this.multipleChoice)return;for(let e of this.formElements)e.hidden&&(e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`aria-posinset`),e.removeAttribute(`aria-setsize`));let e=this.formElements.filter(e=>!e.hasAttribute(`aria-hidden`));e.forEach((t,n)=>{t.setAttribute(`aria-posinset`,String(n+1)),t.setAttribute(`aria-setsize`,String(e.length))})}parser(e){if(typeof e==`string`&&e!==``){let t=L(U,this,Zr).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function Wr(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function Gr(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(L(U,this,Kr).call(this,e))for(let r of e.options)(t===``||L(U,this,qr).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||L(U,this,qr).call(this,t,e))&&n.push({option:e});return n}function Kr(e){return e.type===`optgroup`}function qr(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function Jr(){let e=this._listboxNode;if(!e)return;let t=N(Br,this)?this._inputNode?.value??``:``,n=this.multipleChoice?Array.isArray(this.pendingModelValue)?this.pendingModelValue:this.selectedValues:[],r=L(U,this,Gr).call(this,t).filter(e=>!n.includes(e.option.value)),i=r.slice(0,this.limit),a=[...L(U,this,$r).call(this)],o=[...n.map(e=>({option:a.find(t=>t.value===e)??{value:e,label:e}})),...i],c,l=o.map(e=>{let t=e.groupLabel&&e.groupLabel!==c?E`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:O;return c=e.groupLabel,{value:e.option.value,template:E`${t}${L(U,this,Yr).call(this,e.option,n.includes(e.option.value))}`}}),u=r.length>this.limit?E`<div class="combobox__footer" aria-hidden="true">
            ${s(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:r.length})}
          </div>`:O;re(E`${Lr(l,e=>e.value,e=>e.template)}${u}`,e)}function Yr(e,t=!1){let n=e.data??{},r=e.label,i=r.startsWith(`$`)||r.startsWith(`@`);return E`
      <craft-option
        ?hidden=${t}
        aria-hidden=${t?`true`:O}
        .choiceValue=${String(e.value)}
        .hint=${n.hint??null}
        ?disabled=${e.disabled??!1}
      >
        <span class="combobox__option">
          ${n.indicator?E`<craft-indicator
                variant=${n.indicator.variant??`neutral`}
              ></craft-indicator>`:O}
          ${n.icon?E`<craft-icon name="${n.icon}"></craft-icon>`:O}
          ${i?E`<code>${r}</code>`:r}
        </span>
      </craft-option>
    `}function Xr(){return this.multipleChoice?this.selectedValues.length>0:this.modelValue!==``&&this.modelValue!=null}function Zr(e){let t=e.trim();for(let e of L(U,this,$r).call(this))if(L(U,this,ei).call(this,e)===t)return e}function Qr(){if(this.multipleChoice||!L(U,this,Xr).call(this))return;let e=String(this.modelValue);for(let t of L(U,this,$r).call(this))if(String(t.value)===e)return t}function*$r(){for(let e of this.options)L(U,this,Kr).call(this,e)?yield*e.options:yield e}function ei(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}Ur.formAssociated=!0,A([j({type:Boolean,attribute:`multiple-choice`,reflect:!0})],Ur.prototype,`multipleChoice`,void 0),A([j({type:Boolean})],Ur.prototype,`required`,void 0),A([j({type:Array})],Ur.prototype,`options`,void 0),A([j({type:Number})],Ur.prototype,`limit`,void 0),A([j({type:Boolean,reflect:!0})],Ur.prototype,`clearable`,void 0),A([j({type:String,reflect:!0})],Ur.prototype,`placeholder`,void 0),A([j({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],Ur.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,Ur);var ti=D`
  :host {
...
`,ni={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},ri=class extends k{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(ni[`icon.out`].keyframes,ni[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(ni[`icon.in`].keyframes,ni[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(ni[`icon.out`].keyframes,ni[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(ni[`icon.in`].keyframes,ni[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||s(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return E`
    ...
    `}};ri.styles=[ti],A([M()],ri.prototype,`isCopying`,void 0),A([M()],ri.prototype,`status`,void 0),A([ae(`slot[name="copy-icon"]`)],ri.prototype,`copyIconEl`,void 0),A([ae(`slot[name="success-icon"]`)],ri.prototype,`successIconEl`,void 0),A([ae(`slot[name="error-icon"]`)],ri.prototype,`errorIconEl`,void 0),A([ae(`craft-tooltip`)],ri.prototype,`tooltipEl`,void 0),A([j({type:String})],ri.prototype,`value`,void 0),A([j({type:Boolean})],ri.prototype,`disabled`,void 0),A([j({attribute:`feedback-duration`,type:Number})],ri.prototype,`feedbackDuration`,void 0),A([j({attribute:`tooltip-label`})],ri.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,ri);var ii=D`
  :host {
...
`,ai=class extends k{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return E`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
        class=${w({"copy-attribute":!0})}
      >
        ${this.value}
      </craft-copy-button>
    `}};ai.styles=[n,ii],A([ae(`craft-copy-button`)],ai.prototype,`copyButtonEl`,void 0),A([j({type:String})],ai.prototype,`value`,void 0),A([j({type:Boolean,reflect:!0})],ai.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,ai);var oi=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function si(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function ci(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(oi))).filter(si)}function li(e){let t=t=>{if(t.key!==`Tab`)return;let n=ci(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var ui=D`
  :host {
    display: contents;
...
`,di=0,fi=0;function pi(){fi++===0&&document.body.classList.add(`no-scroll`)}function mi(){fi>0&&--fi===0&&document.body.classList.remove(`no-scroll`)}var hi=new WeakMap,gi=new WeakMap,_i=new WeakMap,vi=new WeakMap,yi=new WeakSet,bi=new WeakMap,xi=new WeakMap,Si=new WeakMap,Ci=new WeakMap,wi=new WeakMap,Ti=new WeakMap,Ei=class extends k{constructor(...e){super(...e),F(this,yi),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++di}`,P(this,hi,!1),P(this,gi,null),P(this,_i,!1),P(this,vi,null),P(this,bi,e=>{e.preventDefault(),this.requestClose()}),P(this,xi,()=>{this.opened=!1}),P(this,Si,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),P(this,Ci,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),P(this,wi,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),P(this,Ti,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,N(Ci,this)),this.addEventListener(`keydown`,N(Si,this)),I(vi,this,new MutationObserver(()=>this.requestUpdate())),N(vi,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,N(Ci,this)),this.removeEventListener(`keydown`,N(Si,this)),N(vi,this)?.disconnect(),I(vi,this,null),N(gi,this)?.call(this),I(gi,this,null),L(yi,this,ki).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return E`
      ${this.nonModal&&this.opened?E`<div
            class="backdrop"
            part="backdrop"
            @click=${N(Ti,this)}
          ></div>`:O}
      <dialog
        part="dialog"
        aria-labelledby=${this.hasHeader&&this.label!==``?this.titleId:O}
        @cancel=${N(bi,this)}
        @close=${N(xi,this)}
        @click=${N(wi,this)}
      >
        <div class="surface" part="surface">
          ${this.hasHeader?this.renderHeader():O} ${this.renderBody()}
          ${this.renderFooter()}
        </div>
      </dialog>
    `}get hasHeader(){return this.label!==``||!this.noClose}renderHeader(){return E`
      <header class="header" part="header">
        ${this.label===``?E`<div></div>`:E`<h2 class="title" part="title" id=${this.titleId}>
              ${this.label}
            </h2>`}
        ${this.noClose?O:E`<button
              type="button"
              class="close"
              part="close"
              aria-label=${s(`Close`)}
    ...
    `}renderBody(){return E`<div class="body" part="body"><slot></slot></div>`}renderFooter(){return E`
      <footer class="footer" part="footer" ?hidden=${!this.hasFooter}>
        <slot name="footer"> </slot>
      </footer>
    `}updated(e){super.updated(e),this.opened!==N(hi,this)&&(I(hi,this,this.opened),this.opened?L(yi,this,Di).call(this):L(yi,this,Oi).call(this),L(yi,this,Ai).call(this,this.opened))}requestClose(){this.dispatchEvent(new CustomEvent(`craft-before-hide`,{bubbles:!0,composed:!0,cancelable:!0}))&&(this.opened=!1)}};function Di(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(N(gi,this)?.call(this),I(gi,this,li(this))),N(_i,this)||(I(_i,this,!0),pi())}function Oi(){let e=this.dialogElement;e?.open&&e.close(),N(gi,this)?.call(this),I(gi,this,null),L(yi,this,ki).call(this)}function ki(){N(_i,this)&&(I(_i,this,!1),mi())}function Ai(e){L(yi,this,ji).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&L(yi,this,ji).call(this,e?`craft-after-show`:`craft-after-hide`)})}function ji(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}Ei.styles=[n,ui],A([j({type:Boolean,attribute:`open`,reflect:!0})],Ei.prototype,`opened`,void 0),A([j()],Ei.prototype,`label`,void 0),A([j({type:Boolean,attribute:`non-modal`,reflect:!0})],Ei.prototype,`nonModal`,void 0),A([j({type:Boolean,reflect:!0})],Ei.prototype,`fullscreen`,void 0),A([j({type:Boolean,attribute:`close-on-outside-click`})],Ei.prototype,`closeOnOutsideClick`,void 0),A([j({type:Boolean,attribute:`no-close`,reflect:!0})],Ei.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,Ei);var Mi=new WeakMap,Ni=new WeakSet,Pi=class{constructor(e,t){this.host=e,this.source=t,F(this,Ni),P(this,Mi,null),e.addController(this)}hostConnected(){L(Ni,this,Fi).call(this)}hostDisconnected(){L(Ni,this,Ii).call(this)}resubscribe(){L(Ni,this,Ii).call(this),L(Ni,this,Fi).call(this)}get state(){return this.source()?.state??null}};function Fi(){I(Mi,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function Ii(){N(Mi,this)?.call(this),I(Mi,this,null)}var Li=D`
  :host {
    /*
...
`,Ri=new WeakMap,zi=new WeakMap,Bi=new WeakMap,Vi=new WeakMap,Hi=new WeakMap,Ui=class extends Ei{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,P(this,Ri,new Pi(this,()=>this.controller)),P(this,zi,null),P(this,Bi,()=>{this.submit()}),P(this,Vi,()=>{this.busy||this.requestClose()}),P(this,Hi,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&I(zi,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),N(zi,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&N(Ri,this).resubscribe();let t=N(Ri,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&N(zi,this)?.observe(t)}renderHeader(){return E`
      <header class="header" part="header">
        ${this.label===``?O:E`<h1
    ...
    `}renderBody(){return E`
      <div class="body" part="body" ?inert=${this.busy}>
        ${this.loading&&!this.hasIndex?E`<div class="loading"><craft-spinner></craft-spinner></div>`:O}
        <slot></slot>
      </div>
      ...
      <footer class="footer" part="footer">
        ...
        <div class="footer__group" part="primary-actions">
          ...
          <craft-button
            ...
            @click=${N(Bi,this)}
          >
            ${this.selectLabel||s(`Select`)}
          </craft-button>
        </div>
      </footer>
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};Ui.styles=[...Ei.styles,Li],A([j({attribute:!1})],Ui.prototype,`controller`,void 0),A([j({type:Boolean,attribute:`show-title`,reflect:!0})],Ui.prototype,`showTitle`,void 0),A([j({attribute:`select-label`})],Ui.prototype,`selectLabel`,void 0),A([j({attribute:`cancel-label`})],Ui.prototype,`cancelLabel`,void 0),A([j({type:Boolean,reflect:!0})],Ui.prototype,`busy`,void 0),A([j({type:Boolean,reflect:!0})],Ui.prototype,`loading`,void 0),A([j({type:Boolean,attribute:`can-submit`,reflect:!0})],Ui.prototype,`canSubmit`,void 0),A([j({type:Boolean,reflect:!0})],Ui.prototype,`narrow`,void 0),A([M()],Ui.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,Ui);var Wi=class extends k{static get styles(){return[D`
        :host {
          display: block;
        }
...
`,Yi=class extends nn(k){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=s(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__hasSlot=new qi(this,`heading-prefix`,`label-extra`,`actions`,`heading-suffix`,`tip`,`warning`),this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[u,it,Ji]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.updateComplete.then(()=>{this.addToAriaLabelledBy(this._labelNode),this.__wireDescribedBy()})}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return E`
    ...
    `}_labelTemplate(){let e=this.__hasLabel,t=this.__hasSlot.test(`label-extra`),n=this.__hasSlot.test(`actions`),r=t||n||this.readOnly||this.__hasSlot.test(`heading-prefix`)||this.__hasSlot.test(`heading-suffix`);if(!e&&!r)return E``;let i=O;return e&&(i=this.labelSrOnly&&r?E`<span class="cp-visually-hidden"
              ><slot name="label"></slot
            ></span>`:E`<slot name="label"></slot>`),E`
      <div
        class=${w({"form-field__label":!0,"cp-visually-hidden":this.labelSrOnly&&!r})}
      >
        <slot name="heading-prefix"></slot>
        ${i}
        ${this.readOnly?E`<span class="read-only-badge">${s(`Read Only`)}</span>`:O}
        ${t||n?E`<div class="flex-grow"></div>`:O}
        ...
        ${n?E`
              <div
                ...
                part="actions"
                role="group"
                aria-label=${s(`Field actions`)}
              >
                <slot name="actions"></slot>
              </div>
            `:E`<slot name="actions"></slot>`}
        <slot name="heading-suffix"></slot>
      </div>
    `}_helpTextTemplate(){return this.__hasHelpText?super._helpTextTemplate():E``}_inputGroupTemplate(){return E`
      <div class=${w({"input-group":!0,input:!0,[this._resolvedOrientation]:!0,errors:this.hasErrors,disabled:this.disabled})}>
        ${this._inputGroupBeforeTemplate()}
        <div class="input-group__container">
          ${this._inputGroupPrefixTemplate()} ${this._inputGroupInputTemplate()}
          ${this._inputGroupSuffixTemplate()}
    ...
    `}_statusBadgeTemplate(){return this.status?E`
      <div
        class="form-field__status-indicator"
        title=${r(this.statusLabel)}
        aria-hidden="true"
      >
        <craft-visually-hidden>${this.statusLabel}</craft-visually-hidden>
      </div>
    `:O}_noticeTemplate(e){if(!this.__hasSlot.test(e))return O;let t=e===`tip`;return E`
      <craft-callout
        class="field-notice"
    ...
    `}get __hasLabel(){return this.label.trim()!==``}get __hasHelpText(){return this.helpText.trim()!==``}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`craft-visually-hidden`);t.textContent=s(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};A([j({type:Boolean,reflect:!0})],Yi.prototype,`required`,void 0),A([j({type:Boolean,reflect:!0})],Yi.prototype,`translatable`,void 0),A([j({attribute:`translation-description`})],Yi.prototype,`translationDescription`,void 0),A([j({type:Boolean,reflect:!0})],Yi.prototype,`fieldset`,void 0),A([j({reflect:!0})],Yi.prototype,`status`,void 0),A([j({attribute:`status-label`})],Yi.prototype,`statusLabel`,void 0),A([j({reflect:!0})],Yi.prototype,`orientation`,void 0),A([j({type:Boolean,reflect:!0,attribute:`has-errors`})],Yi.prototype,`hasErrors`,void 0),A([j({attribute:`instructions-position`})],Yi.prototype,`instructionsPosition`,void 0),A([j({type:String,reflect:!0})],Yi.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,Yi);var Xi=class extends k{render(){return E`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,Xi);var Zi=D`
  ${it}
...
`,Qi=/^[0-9a-f]{6}$/i,$i=/^[0-9a-f]{3}$/i,ea={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function ta(e){return String(e??``).trim().replace(/^#/,``)}function na(e){let t=ta(e);return $i.test(t)?t.split(``).map(e=>e+e).join(``):Qi.test(t)?t:null}var ra=class e extends Dn{static get styles(){return[...super.styles,at,Zi]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,ta(t)),e}}}parser(e){return ta(e)}formatter(e){return ta(e)}serializer(e){return ta(e)}deserializer(e){return ta(e)}preprocessor(e){let t=ta(e);if(t!==e)return t}get _expandedHexValue(){return na(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>na(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=ta(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return O;let t=this._validPresets;return E`
      <input
        class="input-color__picker"
        type="color"
        aria-label="${s(`Color picker`)}"
      ...
      ${t.length?E`
            <datalist id="${this._pickerListId}">
              ${t.map(e=>E`<option value="${e}"></option>`)}
            </datalist>
          `:O}
    `}_swatchTemplate(){return E`
    ...
    `}};ra._browserSupportsColorInputs=null,A([j({converter:ea})],ra.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,ra);var ia=D`
  ::slotted(.form-control) {
    ${tt}
  }
...
`,W=class extends Dn{constructor(...e){super(...e),this.size=`medium`,this.inputMode=``,this.ariaInvalid=null,this.autoCorrect=!0,this.autoCapitalize=!0,this.small=!1,this.center=!1,this.monospace=!1,this.hiddenInput=!1}static get styles(){return[...super.styles,at,ia]}connectedCallback(){super.connectedCallback(),this._inputNode&&this.maxlength&&this.maxlength>0&&(this._inputNode.maxLength=this.maxlength,this.width!==`full`&&(this._inputNode.size=this.maxlength)),this.syncNativeAttributes(),this.syncAriaInvalid()}updated(e){super.updated(e),(e.has(`inputSize`)||e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`inputMode`)||e.has(`autoCorrect`)||e.has(`autoCapitalize`))&&this.syncNativeAttributes(),this.syncAriaInvalid()}syncAriaInvalid(){this._inputNode?.setAttribute(`aria-invalid`,this.ariaInvalid??String(this._hasFeedbackVisibleFor(`error`)))}syncNativeAttributes(){let e={size:this.inputSize,min:this.min,max:this.max,step:this.step,inputmode:this.inputMode,autocorrect:this.autoCorrect?void 0:`off`,autocapitalize:this.autoCapitalize?void 0:`none`};for(let[t,n]of Object.entries(e)){if(n===void 0){this._inputNode?.removeAttribute(t);continue}this._inputNode?.setAttribute(t,String(n))}}};A([j({type:Number,reflect:!0})],W.prototype,`maxlength`,void 0),A([j({type:String,reflect:!0})],W.prototype,`size`,void 0),A([j({type:Number,attribute:!1})],W.prototype,`inputSize`,void 0),A([j({attribute:!1})],W.prototype,`min`,void 0),A([j({attribute:!1})],W.prototype,`max`,void 0),A([j({attribute:!1})],W.prototype,`step`,void 0),A([j({attribute:!1})],W.prototype,`inputMode`,void 0),A([j({attribute:`aria-invalid`,reflect:!0})],W.prototype,`ariaInvalid`,void 0),A([j({attribute:!1})],W.prototype,`autoCorrect`,void 0),A([j({attribute:!1})],W.prototype,`autoCapitalize`,void 0),A([j({reflect:!0,type:Boolean})],W.prototype,`small`,void 0),A([j({type:String,reflect:!0})],W.prototype,`width`,void 0),A([j({reflect:!0,type:Boolean})],W.prototype,`center`,void 0),A([j({reflect:!0,type:Boolean})],W.prototype,`monospace`,void 0),A([j({reflect:!0,type:Boolean,attribute:`hidden-input`})],W.prototype,`hiddenInput`,void 0),customElements.get(`craft-input`)||customElements.define(`craft-input`,W);var aa=D`
  /*
...
`,oa=class extends W{static get styles(){return[...super.styles,aa]}_renderSuffix(){return E`<craft-copy-button
      tooltip-label="${s(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};A([j({type:String,attribute:`copy-value`})],oa.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,oa);var sa=class extends W{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,sa);var ca=new WeakSet,la=class extends W{constructor(){super(),F(this,ca),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,L(ca,this,ua))}disconnectedCallback(){this.removeEventListener(`change`,L(ca,this,ua)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),L(ca,this,da).call(this)}};function ua(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=L(ca,this,fa).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}L(ca,this,da).call(this)}}function da(){let e=this._inputNode;if(!e)return;let t=L(ca,this,pa).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=L(ca,this,pa).call(this,e),i=L(ca,this,pa).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function fa(e){let t=L(ca,this,pa).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function pa(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}A([j({type:Number,attribute:`minute-increment`})],la.prototype,`minuteIncrement`,void 0),A([j({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],la.prototype,`disabledTimeRanges`,void 0),A([j({type:Boolean,attribute:`force-round-time`})],la.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,la);var ma={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},ha=new WeakSet,ga=new WeakMap,_a=class extends k{constructor(...e){super(...e),F(this,ha),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,P(this,ga,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof W))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return E`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,N(ga,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,N(ga,this)),super.disconnectedCallback()}updated(e){super.updated(e),L(ha,this,va).call(this),L(ha,this,ya).call(this),L(ha,this,ba).call(this),L(ha,this,Ta).call(this,`locale`,this.locale,!0),L(ha,this,Ta).call(this,`timezone`,this.timezone,!this.showTimezone)}};function va(){let e=L(ha,this,xa).call(this,`craft-input-date`,`date`,this.showDate);e instanceof sa&&(L(ha,this,wa).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,L(ha,this,Sa).call(this,e))}function ya(){let e=L(ha,this,xa).call(this,`craft-input-time`,`time`,this.showTime);e instanceof la&&(L(ha,this,wa).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,L(ha,this,Sa).call(this,e))}function ba(){let e=L(ha,this,xa).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(L(ha,this,wa).call(this,e,`timezone`,this.timezone??``,!1),L(ha,this,Sa).call(this,e))}function xa(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof W);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Sa(e){e.parentElement!==this&&this.insertBefore(e,L(ha,this,Ca).call(this))}function Ca(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function wa(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function Ta(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}_a.styles=D`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,A([j()],_a.prototype,`name`,void 0),A([j({attribute:`date-value`})],_a.prototype,`dateValue`,void 0),A([j({attribute:`time-value`})],_a.prototype,`timeValue`,void 0),A([j()],_a.prototype,`locale`,void 0),A([j()],_a.prototype,`timezone`,void 0),A([j({attribute:`show-date`,converter:ma})],_a.prototype,`showDate`,void 0),A([j({attribute:`show-time`,converter:ma})],_a.prototype,`showTime`,void 0),A([j({type:Boolean,attribute:`show-timezone`})],_a.prototype,`showTimezone`,void 0),A([j()],_a.prototype,`min`,void 0),A([j()],_a.prototype,`max`,void 0),A([j({attribute:`min-time`})],_a.prototype,`minTime`,void 0),A([j({attribute:`max-time`})],_a.prototype,`maxTime`,void 0),A([j({type:Number,attribute:`minute-increment`})],_a.prototype,`minuteIncrement`,void 0),A([j({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],_a.prototype,`disabledTimeRanges`,void 0),A([j({type:Boolean,attribute:`force-round-time`})],_a.prototype,`forceRoundTime`,void 0),A([j({type:Boolean})],_a.prototype,`disabled`,void 0),A([j({type:Boolean})],_a.prototype,`readonly`,void 0),A([j({type:Boolean})],_a.prototype,`required`,void 0),A([j({attribute:`described-by`})],_a.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,_a);var Ea=class extends un{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Da=class extends un{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Mt().msg(`lion-input-file:uploadTextDuplicateFileName`)}},Oa=524288e3,ka={type:`FILE_TYPE`,size:`FILE_SIZE`},Aa={fail:`FAIL`,pass:`SUCCESS`},ja=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);Ea.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Aa.fail,this.failedProp.push(ka.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;Ea.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Aa.fail,this.failedProp.push(ka.type))}Ea.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Aa.fail&&(this.status=Aa.pass):(this.status=Aa.fail,this.failedProp.push(ka.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Ma=e=>{switch(e){case`bg-BG`:return y(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return y(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return y(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return y(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return y(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return y(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return y(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return y(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return y(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return y(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return y(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return y(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return y(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return y(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return y(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return y(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return y(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return y(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return y(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return y(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return y(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return y(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return y(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return y(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return y(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return y(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return y(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return y(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return y(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return y(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return y(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return y(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return y(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return y(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return y(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return y(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Na=class extends Gt(Zt(k)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":ln}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Ma},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return E`
      <lion-validation-feedback
        id="file-feedback-${t}"
        .feedbackData="${e}"
        aria-live="assertive"
      ></lion-validation-feedback>
    `}_listItemBeforeTemplate(e){return O}_listItemAfterTemplate(e,t){return E`
      <button
    ...
    `}_removeButtonContentTemplate(){return E`✖️`}_selectedListItemTemplate(e){let t=Oe();return E`
      <div class="selected__list__item" status="${e.status?e.status.toLowerCase():``}">
        <div class="selected__list__item__label">
          ...
          <span id="selected-list-item-label-${t}" class="selected__list__item__label__text">
            ...
            ${e.downloadUrl&&e.status!==`LOADING`?E`
                  <a
                    class="selected__list__item__label__link"
                    href="${e.downloadUrl}"
                    target="${e.downloadUrl.startsWith(`blob`)?`_blank`:``}"
                    rel="${r(e.downloadUrl.startsWith(`blob`)?`noopener noreferrer`:void 0)}"
                    >${e.systemFile?.name}</a
                  >
                `:e.systemFile?.name}
          </span>
        ...
        ${e.status===`FAIL`&&e.validationFeedback?E`
              ${Lr(e.validationFeedback,e=>E`
                  ${this._validationFeedbackTemplate([e],t)}
                `)}
            `:O}
      </div>
    `}render(){return this.fileList?.length?E`
          ${this.multiple?E`
                <ul class="selected__list">
                  ${this.fileList.map(e=>E` <li>${this._selectedListItemTemplate(e)}</li> `)}
                </ul>
              `:E` ${this._selectedListItemTemplate(this.fileList[0])} `}
        `:O}static get styles(){return[D`
        .selected__list {
    ...
    `}_inputGroupAfterTemplate(){return E` <slot name="selected-file-list"></slot> `}_inputGroupInputTemplate(){return E`
      <slot name="input"> </slot>
      <slot name="after"> </slot>
      ${this.enableDropZone&&this._isDragAndDropSupported?this._dropZoneTemplate():E`
    ...
    `}static get styles(){return[super.styles,D`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},Ia=class extends Na{static get styles(){return[...super.styles,D`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
      ...
      `]}_listItemAfterTemplate(e,t){return E`
      <craft-button
        icon
        size="small"
        variant="plain"
...
`,Ra=class extends Fa{static get styles(){return[...super.styles,at,La]}get slots(){return{...super.slots,"file-select-button":()=>E`<craft-button
      ...
      `]}constructor(){super(),F(this,Ua),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,P(this,Wa,()=>{this.modelValue=``,this.value=``,L(Ua,this,Ka).call(this)?.inputmask?.setValue(``),L(Ua,this,Ka).call(this)?.focus()}),this.type=`text`,this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&L(Ua,this,Ja).call(this),L(Ua,this,Ka).call(this)?.classList.toggle(`money-placeholder`,!L(Ua,this,Ya).call(this))}disconnectedCallback(){L(Ua,this,Ka).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?E`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${L(Ua,this,qa).call(this).currency}`}</span
      >
    </div>`:O}_inputGroupInputTemplate(){return E`<div class="input-group__input">
      <slot name="input"></slot>
      <craft-button
        class="clear"
        type="button"
        ...
        icon
        aria-label=${s(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!L(Ua,this,Ya).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${N(Wa,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function Ka(){return this._inputNode}function qa(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function Ja(){let e=L(Ua,this,Ka).call(this);if(!e)return;let t=String(this.modelValue??``),n=L(Ua,this,qa).call(this);e.inputmask?.remove(),e.value=t,new Va({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function Ya(){return this.modelValue!==``&&this.modelValue!=null}A([j()],Ga.prototype,`currency`,void 0),A([j()],Ga.prototype,`locale`,void 0),A([j({type:Number})],Ga.prototype,`decimals`,void 0),A([j({attribute:`decimal-separator`})],Ga.prototype,`decimalSeparator`,void 0),A([j({attribute:`group-separator`})],Ga.prototype,`groupSeparator`,void 0),A([j({converter:Ha,attribute:`show-currency`})],Ga.prototype,`showCurrency`,void 0),A([j({converter:Ha})],Ga.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,Ga);var Xa=new WeakSet,Za=class extends Dn{static get styles(){return[...super.styles,at,D`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),F(this,Xa),this.passwordRules=``,this._visible=!1,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>E`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    >
      <span class="icon"
        >${this._visible?E`<craft-icon
              name="eye-slash"
              label="${s(`Hide`)}"
            ></craft-icon>`:E`<craft-icon name="eye" label="${s(`Show`)}"></craft-icon>`}
      </span>
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),L(Xa,this,Qa).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&L(Xa,this,Qa).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function Qa(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}A([j({attribute:`passwordrules`})],Za.prototype,`passwordRules`,void 0),A([M()],Za.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,Za);var $a=class extends k{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return E`
      <p class="error" role="alert">${this.error}</p>
      ${this.pluginName?E`<div class="install-plugin">
  ...
  `,A([j()],$a.prototype,`error`,void 0),A([j({attribute:`plugin-name`})],$a.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,$a);var eo=D`
  :host {
    display: block;
    /*
...
`,to={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(to);var no={Plain:`plain`,Error:`error`,Code:`code`};Object.values(no);var ro=new Set([`clip`,`hidden`]),io=class extends Xe(k,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=to.Raised,this.variant=no.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!ro.has(n)&&e.scrollHeight-e.clientHeight>1||!ro.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||s(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return E`
      ...
      >
        ...
        ${this._hasSlottedFooter?E`<slot name="footer">
    ...
    `}};io.styles=[n,eo],A([j({reflect:!0})],io.prototype,`appearance`,void 0),A([j({reflect:!0})],io.prototype,`variant`,void 0),A([j()],io.prototype,`label`,void 0),A([M()],io.prototype,`_hasSlottedHeader`,void 0),A([M()],io.prototype,`_hasSlottedFooter`,void 0),A([M()],io.prototype,`_scrollable`,void 0),A([M()],io.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,io);var ao=0,oo=new WeakMap,G=new WeakSet,so=class extends k{constructor(...e){super(...e),F(this,G),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,P(this,oo,++ao)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&L(G,this,yo).call(this)}render(){let e=L(G,this,uo).call(this);return Lr(this.groups,e=>e.handle,(t,n)=>L(G,this,co).call(this,t,n,e))}};function co(e,t,n){let r=`permission-tree-heading-${N(oo,this)}-${t}`;return E`
      <section class="group">
        ${e.heading?E`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${r}
                  ?disabled=${this.disabled}
                  @click=${()=>L(G,this,ho).call(this,e.keys,n)}
                >
                  ${L(G,this,mo).call(this,e.keys,n)?s(`Deselect all`):s(`Select all`)}
                </craft-button>
              </div>
            `:O}
        ${L(G,this,lo).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function lo(e,t,n,r){return Lr(Object.entries(e),([e])=>e,([e,i])=>{let a=i.key||e,o=L(G,this,po).call(this,a,r),s=i.nested??{};return E`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${a}
                .checked=${o}
                .disabled=${n||L(G,this,fo).call(this,a,r)}
                @model-value-changed=${e=>L(G,this,go).call(this,e,a,s,r)}
              >
                ${i.info||i.warning?E`
                      <div slot="help-text">
                        ${i.info??O}
              ...
              ${Object.keys(s).length?L(G,this,lo).call(this,s,t+1,n||!o,r):O}
            </li>
          </ul>
        `})}function uo(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function fo(e,t){return t.has(e.toLowerCase())}function po(e,t){return this.modelValue.includes(e)||L(G,this,fo).call(this,e,t)}function mo(e,t){let n=e.filter(e=>!L(G,this,fo).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function ho(e,t){let n=e.filter(e=>!L(G,this,fo).call(this,e,t));if(L(G,this,mo).call(this,e,t)){let e=new Set(n);L(G,this,vo).call(this,this.modelValue.filter(t=>!e.has(t)));return}L(G,this,vo).call(this,[...new Set([...this.modelValue,...n])])}function go(e,t,n,r){if(e.stopPropagation(),this.disabled||L(G,this,fo).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){L(G,this,vo).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...L(G,this,_o).call(this,n)]);L(G,this,vo).call(this,this.modelValue.filter(e=>!o.has(e)))}function _o(e){return Object.values(e).flatMap(e=>[e.key,...L(G,this,_o).call(this,e.nested??{})])}function vo(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function yo(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;L(G,this,bo).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&L(G,this,bo).call(this,`${this.name}[]`,t)}function bo(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}so.styles=D`
    :host {
      display: block;
    }
  ...
  `,A([j({type:Array})],so.prototype,`groups`,void 0),A([j({type:Array,attribute:`model-value`})],so.prototype,`modelValue`,void 0),A([j({type:Array,attribute:`locked-permissions`})],so.prototype,`lockedPermissions`,void 0),A([j()],so.prototype,`name`,void 0),A([j({type:Boolean,reflect:!0})],so.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,so);var xo=D`
  :host {
...
`,So=new WeakMap,Co=class extends k{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,P(this,So,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&N(So,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),I(So,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,I(So,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return E`
      <div
        class=${w({"progress-bar":!0,"progress-bar--pending":this.pending})}
        part="track"
        role="progressbar"
      ...
      >
        <div
          class=${w({"progress-bar__fill":!0,"progress-bar__fill--smooth":this.smooth&&!this.pending})}
          part="fill"
          style=${b(e)}
        ></div>
      </div>
      ${this.showStatus?E`<div class="progress-bar__status" part="status">
            ${this.statusText}
          </div>`:O}
      <span class="visually-hidden">
        ${this.pending?`Loading`:`${this.progressPercent}%`}
      </span>
    `}};Co.styles=[xo],A([j({type:Number})],Co.prototype,`progress`,void 0),A([j({type:Number})],Co.prototype,`total`,void 0),A([j({type:Number})],Co.prototype,`processed`,void 0),A([j({type:Boolean,attribute:`show-status`})],Co.prototype,`showStatus`,void 0),A([j({type:Boolean,reflect:!0})],Co.prototype,`pending`,void 0),A([j({type:Boolean})],Co.prototype,`smooth`,void 0),A([j({type:String})],Co.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Co);var wo=class extends xn(Tn(k)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},To=class extends Cn(Dn){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Eo=class extends wo{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,at,D`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};A([j({type:Boolean,reflect:!0})],Eo.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Eo);var Do=class extends jn(To){static get styles(){return[...super.styles,D`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,Do);var Oo=D`
  craft-button {
    cursor: move;
  }
...
`,ko=class extends k{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1,this.nested=!1,this.canIndent=!1,this.canOutdent=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_canMove(e){switch(e){case`up`:return this.position!==`first`&&this.position!==`only`;case`down`:return this.position!==`last`&&this.position!==`only`;case`indent`:return this.nested&&this.canIndent;case`outdent`:return this.nested&&this.canOutdent}}_reorder(e){this.disabled||!this._canMove(e)||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??s(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),r=t?n?`arrow-right`:`arrow-left`:`arrow-up`,i=t?n?`arrow-left`:`arrow-right`:`arrow-down`,a=s(t?`Move forward`:`Move up`),o=s(t?`Move backward`:`Move down`);return E`
        ...
        <div slot="content">
          ...
          ${this.nested?E`
                ...
                <craft-action-item
                  ...
                  data-action="outdent"
                  >${s(`Outdent`)}</craft-action-item
                >
              `:O}
        </div>
      </craft-action-menu>
    `}};ko.styles=[Oo],A([j()],ko.prototype,`label`,void 0),A([j({reflect:!0})],ko.prototype,`position`,void 0),A([j({reflect:!0})],ko.prototype,`orientation`,void 0),A([j({reflect:!0})],ko.prototype,`variant`,void 0),A([j({reflect:!0,type:Boolean})],ko.prototype,`disabled`,void 0),A([j({reflect:!0,type:Boolean})],ko.prototype,`nested`,void 0),A([j({attribute:`can-indent`,type:Boolean})],ko.prototype,`canIndent`,void 0),A([j({attribute:`can-outdent`,type:Boolean})],ko.prototype,`canOutdent`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,ko);var Ao=class extends De(g){static get styles(){return[...super.styles,D`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Po=class extends Ao{static get styles(){return[...super.styles,No]}_afterTemplate(){return E`${this.singleOption?``:E`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},Fo=D`
  ${it}
...
`,Io=class extends Mo{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Fo]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Po}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return E`
    ...
    `}};A([j({reflect:!0,type:Boolean})],Io.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,Io);var Lo=D`
  :host {
    display: block;
  }
`;function Ro(e){return e.charAt(0).toUpperCase()+e.slice(1)}var zo=class extends k{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return E`<span
      ...
      aria-hidden="true"
    ></span>`}_optionTemplate(e,t){return E`<craft-option .choiceValue=${e}>
      <span
    ...
    </craft-option>`}_handleModelValueChanged(e){e.stopPropagation();let t=e.target;this.modelValue=t?.modelValue??null,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0}))}render(){return E`
      <craft-select-rich
        label=${this.label}
        name=${this.name}
      ...
      >
        ${this.allowTransparent?this._optionTemplate(`__blank__`,s(`Transparent`)):``}
        ${Le.map(e=>this._optionTemplate(e,s(Ro(e))))}
      </craft-select-rich>
    `}};zo.styles=[Lo],A([j()],zo.prototype,`label`,void 0),A([j()],zo.prototype,`name`,void 0),A([j({attribute:`model-value`})],zo.prototype,`modelValue`,void 0),A([j({type:Boolean,reflect:!0,attribute:`allow-transparent`})],zo.prototype,`allowTransparent`,void 0),customElements.get(`craft-select-color`)||customElements.define(`craft-select-color`,zo);var Bo=class extends gn{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>e.slot===`input`)}},Vo=class extends Bo{get operationMode(){return`select`}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener(`change`,this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:`model`})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has(`disabled`)&&(this._inputNode.disabled=this.disabled,this.validate()),e.has(`name`)&&(this._inputNode.name=this.name),e.has(`autocomplete`)&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener(`change`,this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){let t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:``}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=this.modelValue===void 0?``:this.modelValue)}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent(`user-input-changed`,{bubbles:!0,composed:!0}))}},Ho=D`
  ${it}
...
`,Uo=class extends Vo{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Ho]}_inputGroupInputTemplate(){return E`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};A([j({reflect:!0,type:Boolean})],Uo.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,Uo);var Wo=D`
  :host {
    display: inline-flex;
  }
...
`,Go=new WeakSet,Ko=class extends k{constructor(...e){super(...e),F(this,Go),this.min=0,this.max=100,this.step=10,this.value=0,this.label=s(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=L(Go,this,Jo).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=L(Go,this,qo).call(this);return E`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${L(Go,this,Xo).call(this,this.value)}
      ...
      >
        ${e.map(e=>E`
            <span
              class=${w({"slide-picker__segment":!0,"is-active":e<=this.value,"is-last-active":e===this.value})}
              role="presentation"
              aria-hidden="true"
              @click=${()=>L(Go,this,Qo).call(this,e)}
              title=${L(Go,this,Xo).call(this,e)}
              >${O}</span
            >
          `)}
      </div>
    `}};function qo(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function Jo(e){L(Go,this,qo).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function Yo(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function Xo(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function Zo(e,t){let n=L(Go,this,Jo).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function Qo(e){this.readOnly||L(Go,this,Zo).call(this,e,!0)}function $o(e){if(this.readOnly)return;let t=L(Go,this,Yo).call(this);switch(e.key){case`ArrowUp`:L(Go,this,Zo).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:L(Go,this,Zo).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:L(Go,this,Zo).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:L(Go,this,Zo).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:L(Go,this,Zo).call(this,this.min,!0),e.preventDefault();break;case`End`:L(Go,this,Zo).call(this,this.max,!0),e.preventDefault();break}}Ko.styles=[Wo],A([j({type:Number})],Ko.prototype,`min`,void 0),A([j({type:Number})],Ko.prototype,`max`,void 0),A([j({type:Number})],Ko.prototype,`step`,void 0),A([j({type:Number})],Ko.prototype,`value`,void 0),A([j()],Ko.prototype,`label`,void 0),A([j({attribute:`described-by`})],Ko.prototype,`describedBy`,void 0),A([j({attribute:`value-unit`})],Ko.prototype,`valueUnit`,void 0),A([j({attribute:!1})],Ko.prototype,`valueLabel`,void 0),A([j({type:Boolean,reflect:!0,attribute:`read-only`})],Ko.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,Ko);var es=D`
  :host {
    display: block;
  }
...
`,ts=new WeakMap,ns=new WeakMap,rs=new WeakMap,is=new WeakMap,as=new WeakMap,os=new WeakMap,ss=new WeakMap,K=new WeakSet,cs=class extends k{constructor(...e){super(...e),F(this,K),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=s(`Rotate`),P(this,ts,!1),P(this,ns,!1),P(this,rs,0),P(this,is,0),P(this,as,0),P(this,os,!1),P(this,ss,null)}connectedCallback(){super.connectedCallback(),I(ss,this,new ResizeObserver(()=>L(K,this,us).call(this))),N(ss,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),N(ss,this)?.disconnect(),I(ss,this,null)}firstUpdated(){I(as,this,(L(K,this,ls).call(this).length-1)*10),L(K,this,us).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&L(K,this,us).call(this)}render(){return E`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${L(K,this,hs).call(this,this.value)}
        @keydown=${L(K,this,ws)}
        @pointerdown=${L(K,this,bs)}
        @pointermove=${L(K,this,xs)}
        @pointerup=${L(K,this,Ss)}
      >
        ...
        <div class="graduations">
          ...
          ></div>
          <ul aria-hidden="true">
            ${L(K,this,ls).call(this).map(e=>E`
                <li
                  class=${w({graduation:!0,"main-graduation":e%5==0})}
                  data-graduation=${e}
                >
    ...
    `}};function ls(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function us(){this._graduations?.offsetWidth&&L(K,this,ps).call(this),L(K,this,fs).call(this),!(!this._list||!this._graduations?.offsetWidth)&&(this._list.style.transform=`translateX(${L(K,this,_s).call(this,this.value)}px)`,L(K,this,ds).call(this))}function ds(){N(os,this)||(I(os,this,!0),requestAnimationFrame(()=>this._root?.classList.add(`placed`)))}function fs(){if(!this._indicator)return;let e=(this.graduationMin-this.graduationMax)*-1,t=N(as,this)/e;this._indicator.style.inlineSize=`${Math.abs(this.value)*t}px`,this._indicator.style.translate=this.value>0?`-100%`:`0`}function ps(){let e=L(K,this,ls).call(this).length,t=this._list.getBoundingClientRect().width/e;t>0&&I(as,this,(e-1)*t)}function ms(){let{transform:e}=getComputedStyle(this._list);return!e||e===`none`?0:new DOMMatrixReadOnly(e).m41}function hs(e){return s(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function gs(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/N(as,this)*n-t}function _s(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*N(as,this)/n-this._graduations.offsetWidth/2)}function vs(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);n!==this.value&&(this.value=n,t&&L(K,this,ys).call(this,`change`))}function ys(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function bs(e){I(ns,this,this._graduations.contains(e.target)&&e.target!==this._graduations),N(ns,this)&&(e.preventDefault(),I(rs,this,e.clientX),I(is,this,L(K,this,ms).call(this)),this._root.setPointerCapture(e.pointerId),L(K,this,ys).call(this,`start`))}function xs(e){N(ns,this)&&Math.abs(e.clientX-N(rs,this))>3&&(I(ts,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),L(K,this,Cs).call(this,e))}function Ss(e){N(ns,this)&&(N(ts,this)?(e.preventDefault(),I(ts,this,!1),this._root.classList.remove(`dragging`)):L(K,this,Cs).call(this,e),L(K,this,ys).call(this,`end`),this._root.releasePointerCapture(e.pointerId),I(rs,this,0),I(ns,this,!1))}function Cs(e){let t=N(ts,this)?N(rs,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=N(ts,this)?t-e.clientX:e.clientX-t,r=N(is,this)-n;L(K,this,vs).call(this,L(K,this,gs).call(this,r))}function ws(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:L(K,this,vs).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:L(K,this,vs).call(this,t-1);break;case`PageUp`:L(K,this,vs).call(this,t+10);break;case`PageDown`:L(K,this,vs).call(this,t-10);break;case`Home`:L(K,this,vs).call(this,this.min);break;case`End`:L(K,this,vs).call(this,this.max);break;default:return}e.preventDefault()}cs.styles=[es],A([j({type:Number})],cs.prototype,`min`,void 0),A([j({type:Number})],cs.prototype,`max`,void 0),A([j({type:Number})],cs.prototype,`value`,void 0),A([j({type:Number,attribute:`graduation-min`})],cs.prototype,`graduationMin`,void 0),A([j({type:Number,attribute:`graduation-max`})],cs.prototype,`graduationMax`,void 0),A([j()],cs.prototype,`label`,void 0),A([ae(`.slide-rule`)],cs.prototype,`_root`,void 0),A([ae(`.graduations`)],cs.prototype,`_graduations`,void 0),A([ae(`.graduations ul`)],cs.prototype,`_list`,void 0),A([ae(`.cursor`)],cs.prototype,`_cursor`,void 0),A([ae(`.indicator`)],cs.prototype,`_indicator`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,cs);var Ts=D`
  :host {
    display: inline-flex;
...
`,Es=class extends k{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return E`
      <span
        class="${w({status:!0,"status--live":this.status===`live`,"status--enabled":this.status===`enabled`,"status--pending":this.status===`pending`,"status--expired":this.status===`expired`,"status--disabled":this.status===`disabled`})}"
        role="img"
        aria-label="${this.getLabel()}"
      ></span>
    `}};Es.styles=[Ts],A([j()],Es.prototype,`label`,void 0),A([j()],Es.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Es);var Ds=class extends C(k){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[D`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return E`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return E`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},ks=class extends Ds{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,D`
      ...
      `]}};A([j({type:Boolean,reflect:!0})],ks.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,ks);var As=D`
  :host {
    display: grid;
  }
...
`;function js(e){return(e??``).split(/\s+/).filter(Boolean)}function Ms(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Ns=Symbol.for(`craft-switch-synthetic-change`),Ps=new WeakMap,Fs=new WeakSet,Is=class extends Os{constructor(...e){super(...e),F(this,Fs),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,P(this,Ps,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,it,As]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":ks}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?s(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?s(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){L(Fs,this,Ls).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){L(Fs,this,Ls).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){L(Fs,this,Ls).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(N(Ps,this))return;let e=new Event(`change`,{bubbles:!0});e[Ns]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Ns in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of js(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of js(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Ms(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return E`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return E`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?E`<span
      class="state-label"
      data-state=${e}
      aria-hidden="true"
      @click=${()=>this._setCheckedState(e===`on`)}
      >${t}</span
    >`:O}_inputGroupBeforeTemplate(){return E`
      <div class="input-group__before">
        <slot name="before"></slot>
        ${this._stateLabelTemplate(`off`)}
      </div>
    `}_inputGroupAfterTemplate(){return E`
      <div class="input-group__after">
        ${this._stateLabelTemplate(`on`)}
        <slot name="after"></slot>
      </div>
    `}};function Ls(e,t){if(!this.disabled){if(!t){e();return}I(Ps,this,!0),e(),this.updateComplete.then(()=>{I(Ps,this,!1)})}}A([j({type:String,reflect:!0})],Is.prototype,`size`,void 0),A([j({type:String,attribute:`on-label`})],Is.prototype,`onLabel`,void 0),A([j({type:String,attribute:`off-label`})],Is.prototype,`offLabel`,void 0),A([j({attribute:`value`})],Is.prototype,`checkedValue`,void 0),A([j({attribute:`indeterminate-value`})],Is.prototype,`indeterminateValue`,void 0),A([j({type:Boolean,reflect:!0})],Is.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,Is);function Rs({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function zs(e){e.setAttribute(`selected`,`true`)}function Bs(e){e.removeAttribute(`selected`)}function Vs({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function Hs({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function Us(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function Ws(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function Gs(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var Ks=class extends k{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[D`
        .tabs__tab-group {
          display: flex;
        }
...
`,Js={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(Js);var Ys={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(Ys);var Xs=[Js.InlineStart,Js.InlineEnd],Zs=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),q=new WeakSet,Qs=new WeakMap,$s=new WeakMap,ec=new WeakMap,tc=new WeakMap,nc=new WeakMap,rc=new WeakMap,ic=new WeakMap,ac=new WeakMap,oc=new WeakMap,sc=new WeakMap,cc=new WeakMap,lc=class extends Ks{constructor(...e){super(...e),F(this,q),this.placement=Js.BlockStart,this.collapsible=!1,this.size=`medium`,P(this,Qs,[]),P(this,$s,!1),P(this,ec,[]),P(this,tc,0),P(this,nc,void 0),P(this,rc,!1),P(this,ic,e=>{if(!this.collapsible||dc.call(L(q,this)))return;let t=L(q,this,hc).call(this,e.target);!t||t.disabled||fc.call(L(q,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),L(q,this,gc).call(this,!0))}),P(this,ac,e=>{e.key!==`Escape`||!this.collapsible||dc.call(L(q,this))||L(q,this,hc).call(this,e.target)&&(e.stopPropagation(),L(q,this,gc).call(this,!0))}),P(this,oc,()=>{dc.call(L(q,this))&&(fc.call(L(q,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),L(q,this,_c).call(this)}),P(this,sc,()=>{if(L(q,this,yc).call(this),fc.call(L(q,this)).forEach((e,t)=>{let n=()=>L(q,this,Dc).call(this,t,!0),r=e=>{Zs.has(e.key)&&e.preventDefault()},i=e=>L(q,this,Oc).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),N(Qs,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),fc.call(L(q,this))[this.selectedIndex]?.disabled){let e=fc.call(L(q,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}L(q,this,bc).call(this)}),P(this,cc,()=>{N(rc,this)||(I(rc,this,!0),requestAnimationFrame(()=>{I(rc,this,!1),L(q,this,Sc).call(this)}))})}static get styles(){return[...super.styles,n,qs]}get layout(){return uc.call(L(q,this))?Ys.Vertical:Ys.Horizontal}set layout(e){this.placement=e===Ys.Vertical?Js.InlineStart:Js.BlockStart}refresh(){N($s,this)&&L(q,this,bc).call(this),L(q,this,Sc).call(this)}close(){!this.collapsible||dc.call(L(q,this))||L(q,this,gc).call(this,!0)}open(){dc.call(L(q,this))&&L(q,this,Dc).call(this,L(q,this,vc).call(this),!0)}firstUpdated(e){I($s,this,fc.call(L(q,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(N($s,this))t?.addEventListener(`slotchange`,N(sc,this)),N(sc,this).call(this);else{let n=dc.call(L(q,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,N(oc,this))}this.addEventListener(`click`,N(ic,this),!0),this.addEventListener(`keydown`,N(ac,this)),t?.addEventListener(`slotchange`,N(cc,this)),I(nc,this,new ResizeObserver(N(cc,this))),N(nc,this).observe(this),L(q,this,Sc).call(this)}disconnectedCallback(){super.disconnectedCallback(),L(q,this,yc).call(this),N(nc,this)?.disconnect(),I(nc,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,dc.call(L(q,this))),e.has(`selectedIndex`)&&(N($s,this)?L(q,this,bc).call(this):N(oc,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&L(q,this,Sc).call(this)}render(){return E`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${uc.call(L(q,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${dc.call(L(q,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function uc(){return Xs.includes(this.placement)}function dc(){return this.selectedIndex<0}function fc(){return this.tabs}function pc(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function mc(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function hc(e){return e instanceof Node?fc.call(L(q,this)).find(t=>t===e||t.contains(e))??null:null}function gc(e){let t=fc.call(L(q,this))[this.selectedIndex];I(tc,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function _c(){let e=dc.call(L(q,this))?L(q,this,vc).call(this):this.selectedIndex;fc.call(L(q,this)).forEach((t,n)=>{t.setAttribute(`tabindex`,n===e?`0`:`-1`)})}function vc(){let e=fc.call(L(q,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden;return t(N(tc,this))?N(tc,this):e.findIndex((e,n)=>t(n))}function yc(){for(;N(Qs,this).length;)N(Qs,this).pop()?.()}function bc(){let e=fc.call(L(q,this)).map(e=>L(q,this,xc).call(this,e)),t=e.some(Boolean);fc.call(L(q,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Oe()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),L(q,this,_c).call(this)}function xc(e){return e.controls?document.getElementById(e.controls):null}function Sc(){let e=pc.call(L(q,this)),t=mc.call(L(q,this)),n=fc.call(L(q,this));if(!e||!t)return;if(uc.call(L(q,this))||n.length===0){L(q,this,wc).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=L(q,this,Cc).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){L(q,this,wc).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);L(q,this,wc).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Cc(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function wc(e){let t=mc.call(L(q,this)),n=new Set(e);fc.call(L(q,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),I(ec,this,e),t&&(t.hidden=e.length===0,t.actions=L(q,this,Tc).call(this))}function Tc(){return N(ec,this).map(e=>{let t=fc.call(L(q,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>L(q,this,Ec).call(this,e)}})}function Ec(e){let t=fc.call(L(q,this))[e];if(!t||t.disabled)return;let n=mc.call(L(q,this));n&&(n.opened=!1),this.selectedIndex=e,L(q,this,Sc).call(this),t.focus()}function Dc(e,t){let n=fc.call(L(q,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Oc(e){if(!Zs.has(e.key))return;let t=L(q,this,kc).call(this,e.key);t!==-1&&L(q,this,Dc).call(this,t,!0)}function kc(e){let t=fc.call(L(q,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(dc.call(L(q,this)))return L(q,this,kc).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}A([j({reflect:!0})],lc.prototype,`placement`,void 0),A([j({type:Boolean,reflect:!0})],lc.prototype,`collapsible`,void 0),A([j({reflect:!0})],lc.prototype,`layout`,null),A([j({reflect:!0})],lc.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,lc);var Ac=D`
  :host {
    display: inline-flex;
...
`,Bc=new WeakMap,Vc=new WeakMap,Hc=new WeakMap,Uc=new WeakSet,Wc=class extends Rc{constructor(...e){super(...e),F(this,Uc),this.monospace=!1,P(this,Bc,void 0),P(this,Vc,void 0),P(this,Hc,null)}static get styles(){return[...super.styles,at,zc]}connectedCallback(){super.connectedCallback(),L(Uc,this,Gc).call(this)}disconnectedCallback(){super.disconnectedCallback(),N(Bc,this)?.disconnect(),I(Bc,this,void 0),N(Vc,this)?.disconnect(),I(Vc,this,void 0)}};function Gc(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(I(Hc,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{I(Hc,this,e.style.height)}),I(Vc,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),N(Vc,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),I(Bc,this,new ResizeObserver(()=>{if(e.style.height===N(Hc,this))return;let t=e.style.height;Ic.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),N(Vc,this)?.disconnect(),I(Vc,this,void 0),N(Bc,this)?.disconnect(),I(Bc,this,void 0)})),N(Bc,this).observe(e))}A([j({type:Boolean,reflect:!0})],Wc.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Wc);var Kc=D`
  :host {
    display: block;
    min-width: 0;
  }
...
`,qc=class extends k{constructor(...e){super(...e),this.last=!1,this._hasHeading=!1,this._hasMeta=!1,this._hasBody=!1,this._hasFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,characterData:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasHeading=!!this.querySelector(`:scope > [slot="heading"]`),this._hasMeta=!!this.querySelector(`:scope > [slot="meta"]`),this._hasBody=[...this.childNodes].some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e instanceof HTMLElement&&!e.slot),this._hasFooter=!!this.querySelector(`:scope > [slot="footer"]`)}render(){return E`
      <div class="timeline-item" part="base">
        ...
        <div class="timeline-item__content" part="content">
          ${this._hasHeading||this._hasMeta?E`<div class="timeline-item__header" part="header">
                ${this._hasHeading?E`<div class="timeline-item__heading" part="heading">
                      <slot name="heading"></slot>
                    </div>`:O}
                ${this._hasMeta?E`<div class="timeline-item__meta" part="meta">
                      ${this._hasHeading?E`<span
          ...
          ${this._hasBody?E`<div class="timeline-item__body" part="body">
                <slot></slot>
              </div>`:O}
          ${this._hasFooter?E`<div class="timeline-item__footer" part="footer">
                <slot name="footer"></slot>
              </div>`:O}
        </div>
      </div>
    `}};qc.styles=[Kc],A([j({type:Boolean,reflect:!0})],qc.prototype,`last`,void 0),A([M()],qc.prototype,`_hasHeading`,void 0),A([M()],qc.prototype,`_hasMeta`,void 0),A([M()],qc.prototype,`_hasBody`,void 0),A([M()],qc.prototype,`_hasFooter`,void 0),customElements.get(`craft-timeline-item`)||customElements.define(`craft-timeline-item`,qc);var Jc=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>Yc(e,this),this.compositionEventHandler=e=>tl(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,Xc),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,Xc)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(el)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(el)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(el),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),$c(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function Yc(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:Zc(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&Zc(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function Xc(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&Qc(t,{event:e})}function Zc(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function Qc(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function $c(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function el(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function tl(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var nl=class extends Event{constructor(){super(`update`)}},rl=new WeakMap,il=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=rl.get(t);return n||(n=new e(t),rl.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),rl.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new nl)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of al)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},al=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),ol=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return il.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},sl=D`
  :host {
    display: contents;
  }
...
`,cl=/^[\p{L}\p{N}_.-]*$/u,ll=s(`Suggestions`),ul=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],dl={handlesAccessibility:!1,visibilityTriggerFunction:void 0},fl=0,J=new WeakMap,pl=new WeakMap,ml=new WeakMap,hl=new WeakMap,gl=new WeakMap,_l=new WeakMap,vl=new WeakMap,yl=new WeakMap,bl=new WeakMap,xl=new WeakMap,Sl=new WeakMap,Cl=new WeakMap,wl=new WeakMap,Tl=new WeakMap,Y=new WeakSet,El=new WeakMap,Dl=new WeakMap,Ol=new WeakMap,kl=new WeakMap,Al=new WeakMap,jl=new WeakMap,Ml=new WeakMap,Nl=new WeakMap,Pl=new WeakMap,Fl=new WeakMap,Il=new WeakMap,Ll=class extends k{constructor(...e){super(...e),F(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,P(this,J,void 0),P(this,pl,null),P(this,ml,null),P(this,hl,new Map),P(this,gl,null),P(this,_l,[]),P(this,vl,0),P(this,yl,null),P(this,bl,null),P(this,xl,null),P(this,Sl,!1),P(this,Cl,null),P(this,wl,new DOMRect),P(this,Tl,new MutationObserver(()=>{let e=L(Y,this,zl).call(this);(su(e)&&e!==N(pl,this)||N(pl,this)&&!N(pl,this).isConnected)&&L(Y,this,Bl).call(this)})),P(this,El,()=>{N(Sl,this)||L(Y,this,ql).call(this)}),P(this,Dl,()=>{I(Sl,this,!0),L(Y,this,tu).call(this)}),P(this,Ol,()=>{I(Sl,this,!1),L(Y,this,ql).call(this)}),P(this,kl,()=>{queueMicrotask(()=>L(Y,this,tu).call(this))}),P(this,Al,()=>{let e=N(pl,this);!e||!N(gl,this)||!cu(e)||queueMicrotask(()=>{N(gl,this)&&(e.selectionStart!==N(gl,this).end||e.selectionEnd!==N(gl,this).end)&&L(Y,this,ql).call(this)})}),P(this,jl,()=>{N(gl,this)&&L(Y,this,eu).call(this)}),P(this,Ml,e=>{let t=e;N(gl,this)&&N(J,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),P(this,Nl,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),P(this,Pl,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),P(this,Fl,e=>{L(Y,this,Zl).call(this,Number(e.target.dataset.index))}),P(this,Il,e=>{if(e.target!==this.popoverElement)return;let t=N(J,this).getAttribute(`aria-label`)??ll;L(Y,this,iu).call(this),I(gl,this,null),L(Y,this,ru).call(this),L(Y,this,au).call(this,t===ll?s(`Suggestions collapsed`):s(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),L(Y,this,Rl).call(this),this.hasUpdated&&L(Y,this,Bl).call(this)}disconnectedCallback(){L(Y,this,Hl).call(this),N(J,this)?.remove(),N(xl,this)!==null&&(clearTimeout(N(xl,this)),I(xl,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),L(Y,this,Bl).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&N(pl,this)!==L(Y,this,zl).call(this)&&L(Y,this,Bl).call(this),e.has(`triggers`)&&e.get(`triggers`)&&N(gl,this)){let e=N(J,this).querySelector(`[aria-selected="true"]`),t=e?N(_l,this)[Number(e.dataset.index)]:void 0;L(Y,this,ql).call(this,t)}}render(){return E`
      <craft-popover
        exportparts="popup"
        .config=${dl}
        @craft-hide=${N(Il,this)}
      >
        <div class="text-expander__popup" slot="content">
          ${this.loading?E`<div class="text-expander__loading" part="loading">
                <slot name="loading">${s(`Loading`)}</slot>
              </div>`:O}
          <slot name="listbox"></slot>
        </div>
      </craft-popover>
    ...
    `}};function Rl(){I(J,this,document.createElement(`div`)),N(J,this).id=`craft-text-expander-listbox-${++fl}`,N(J,this).slot=`listbox`,N(J,this).setAttribute(`part`,`listbox`),N(J,this).role=`listbox`,N(J,this).setAttribute(`aria-label`,ll),N(J,this).addEventListener(`pointerdown`,N(Nl,this)),N(J,this).addEventListener(`pointerup`,N(Pl,this)),N(J,this).addEventListener(`combobox-commit`,N(Fl,this)),this.append(N(J,this))}function zl(){return this.getRootNode().getElementById(this.for)}function Bl(){let e=L(Y,this,zl).call(this);if(L(Y,this,Hl).call(this),!su(e)){L(Y,this,Vl).call(this);return}I(pl,this,e),L(Y,this,Ul).call(this,e),I(ml,this,new Jc(e,N(J,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),L(Y,this,Wl).call(this,e),e.addEventListener(`input`,N(El,this)),e.addEventListener(`keydown`,N(Ml,this)),e.addEventListener(`blur`,N(kl,this)),e.addEventListener(`compositionstart`,N(Dl,this)),e.addEventListener(`compositionend`,N(Ol,this)),e.ownerDocument.addEventListener(`selectionchange`,N(Al,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>N(wl,this)},L(Y,this,Vl).call(this)}function Vl(){N(Tl,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function Hl(){N(Tl,this).disconnect(),L(Y,this,tu).call(this);let e=N(pl,this);e&&(e.removeEventListener(`input`,N(El,this)),e.removeEventListener(`keydown`,N(Ml,this)),e.removeEventListener(`blur`,N(kl,this)),e.removeEventListener(`compositionstart`,N(Dl,this)),e.removeEventListener(`compositionend`,N(Ol,this)),e.ownerDocument.removeEventListener(`selectionchange`,N(Al,this)),N(Cl,this)?.getStyleClone().disconnect(),I(Cl,this,null),N(ml,this)?.destroy(),I(ml,this,null),L(Y,this,Gl).call(this,e),I(pl,this,null))}function Ul(e){N(hl,this).clear();for(let t of ul)N(hl,this).set(t,e.getAttribute(t))}function Wl(e){let t=[N(hl,this).get(`aria-controls`),N(J,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):L(Y,this,Kl).call(this,e,`aria-haspopup`),L(Y,this,Kl).call(this,e,`aria-expanded`)}function Gl(e){for(let t of ul)L(Y,this,Kl).call(this,e,t);N(hl,this).clear()}function Kl(e,t){let n=N(hl,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function ql(e){L(Y,this,iu).call(this);let t=L(Y,this,Yl).call(this);if(!t){I(gl,this,null),L(Y,this,nu).call(this);return}I(gl,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));L(Y,this,Xl).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,L(Y,this,Xl).call(this,[]),L(Y,this,au).call(this,s(`Loading`));let r=N(vl,this);I(bl,this,setTimeout(()=>{L(Y,this,Jl).call(this,t,n,r,e)},150))}async function Jl(e,t,n,r){I(yl,this,new AbortController);let i;try{let n=await oe.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:N(yl,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==N(vl,this)||lu(t))return;L(Y,this,tu).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===N(vl,this)&&(this.loading=!1,L(Y,this,Xl).call(this,t===void 0?i:i.slice(0,t),r))}function Yl(){let e=N(pl,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!cu(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&cl.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function Xl(e,t){if(L(Y,this,$l).call(this),I(_l,this,e),N(J,this).replaceChildren(),N(J,this).hidden=this.loading,N(J,this).setAttribute(`aria-label`,N(gl,this)?.trigger.label??ll),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=ou(e);n.id=`${N(J,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(N(gl,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),N(J,this).append(n)}),!this.loading&&!e.length){I(gl,this,null),L(Y,this,nu).call(this),L(Y,this,au).call(this,s(`No suggestions`));return}this.updateComplete.then(()=>{N(gl,this)&&L(Y,this,Ql).call(this,t)})}function Zl(e){let t=N(pl,this),n=N(_l,this)[e],r=L(Y,this,Yl).call(this),i=N(gl,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){L(Y,this,tu).call(this);return}uu(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};L(Y,this,tu).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function Ql(e){await this.popoverElement.updateComplete;let t=N(pl,this);if(!t||!L(Y,this,eu).call(this)){L(Y,this,tu).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!N(gl,this)||t!==N(pl,this))&&N(_l,this).length&&(N(ml,this)?.start(),L(Y,this,Kl).call(this,t,`aria-expanded`),t.removeEventListener(`input`,N(El,this)),t.addEventListener(`input`,N(El,this)),e)){let t=N(_l,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)N(ml,this)?.navigate(1)}}function $l(){N(ml,this)?.stop(),N(pl,this)&&L(Y,this,Kl).call(this,N(pl,this),`aria-expanded`)}function eu(){let e=N(pl,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!N(Cl,this)){I(Cl,this,new ol(e));let t=N(Cl,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,N(jl,this))}return N(Cl,this).setStartOffset(t),N(Cl,this).setEndOffset(t),I(wl,this,N(Cl,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function tu(){L(Y,this,iu).call(this),I(gl,this,null),L(Y,this,nu).call(this)}function nu(){L(Y,this,ru).call(this),this.popoverElement.hide()}function ru(){this.loading=!1,L(Y,this,$l).call(this),I(_l,this,[]),N(J,this)?.replaceChildren(),N(J,this)&&(N(J,this).hidden=!1);let e=N(pl,this);e&&(L(Y,this,Kl).call(this,e,`aria-activedescendant`),L(Y,this,Kl).call(this,e,`aria-busy`))}function iu(){var e;I(vl,this,(e=N(vl,this),e++,e)),N(bl,this)&&(clearTimeout(N(bl,this)),I(bl,this,null)),N(yl,this)?.abort(),I(yl,this,null)}function au(e){N(xl,this)!==null&&(clearTimeout(N(xl,this)),I(xl,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),I(xl,this,setTimeout(()=>{I(xl,this,null),this.announcement=``},5e3))}Ll.styles=[u,sl],A([j({reflect:!0})],Ll.prototype,`for`,void 0),A([j({type:Array})],Ll.prototype,`triggers`,void 0),A([M()],Ll.prototype,`loading`,void 0),A([M()],Ll.prototype,`announcement`,void 0),A([ae(`craft-popover`)],Ll.prototype,`popoverElement`,void 0);function ou(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function su(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function cu(e){return e.getRootNode().activeElement===e}function lu(e){return e instanceof DOMException&&e.name===`AbortError`}function uu(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Ll);var du=D`
  :host {
    display: inline-flex;
...
`,fu=new WeakMap,pu=new WeakSet,mu=class extends k{constructor(...e){super(...e),F(this,pu),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,P(this,fu,typeof ResizeObserver<`u`?new ResizeObserver(()=>L(pu,this,hu).call(this)):null)}connectedCallback(){super.connectedCallback(),N(fu,this)?.observe(this)}disconnectedCallback(){N(fu,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){L(pu,this,hu).call(this)}render(){let e=this.overflowing&&!this.disabled;return E`
      <span class="truncate" id="content">
        <slot @slotchange=${L(pu,this,gu)}></slot>
      </span>
      ${e?E`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function hu(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function gu(){L(pu,this,hu).call(this)}mu.styles=du,A([j({reflect:!0})],mu.prototype,`placement`,void 0),A([j({type:Boolean,reflect:!0})],mu.prototype,`disabled`,void 0),A([M()],mu.prototype,`overflowing`,void 0),A([M()],mu.prototype,`text`,void 0),A([ae(`.truncate`)],mu.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,mu);var _u=D`
  :host {
...
`,vu={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},yu=class e extends k{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1,this.animated=!1,this.frozen=!1,this.capturedFrame=null,this.resizeObserver=null}get isAnimated(){return this.animated||e.animatedExtensionPattern.test(this.src??``)||e.animatedExtensionPattern.test(this.srcset??``)}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}willUpdate(e){if((e.has(`src`)||e.has(`srcset`)||e.has(`animated`))&&(this.frozen=!1,this.capturedFrame=null,this.resizeObserver?.disconnect(),this.resizeObserver=null,!e.has(`src`))){let e=this.shadowRoot?.querySelector(`img`);e?.complete&&this.attemptFreeze(e)}}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs(),this.resizeObserver?.disconnect()}render(){return E`
      <div class="${w({thumbnail:!0,"thumbnail--checkered":this.checkered,"thumbnail--rounded":this.rounded,"thumbnail--crop":this.mode===`crop`,"thumbnail--stretch":this.mode===`stretch`})}" part="thumbnail">
        ${this.src?E`<img
              class="${w({thumbnail__image:!0,"cp-visually-hidden":this.frozen})}"
              part="image"
              src="${this.src}"
              srcset="${r(this.srcset??void 0)}"
              sizes="${r(this.sizes??void 0)}"
              width="${r(this.width??void 0)}"
              height="${r(this.height??void 0)}"
              alt="${this.alt}"
              loading="${this.loading}"
              decoding="async"
              @load=${this.freezeFrame}
            />`:O}
        ${this.src&&this.isAnimated?E`<canvas
              class="${w({thumbnail__cover:!0,"thumbnail__cover--pending":!this.frozen})}"
              part="cover"
              aria-hidden="true"
              role="presentation"
            ></canvas>`:O}
    ...
    `}freezeFrame(e){this.attemptFreeze(e.target)}attemptFreeze(e){if(!this.isAnimated||!e.currentSrc)return;let t=new Image;t.onload=()=>{this.capturedFrame=t,this.resizeObserver?.disconnect(),this.resizeObserver=new ResizeObserver(()=>{this.capturedFrame&&this.paintCover(this.capturedFrame,e)}),this.resizeObserver.observe(e)},t.src=e.currentSrc}paintCover(e,t){if(!e.naturalWidth||!e.naturalHeight)return;let n=this.shadowRoot?.querySelector(`canvas.thumbnail__cover`),r=n?.getContext(`2d`);if(!r)return;let i=t.clientWidth,a=t.clientHeight;if(!i||!a)return;let o=window.devicePixelRatio||1;if(n.width=i*o,n.height=a*o,n.style.width=`${i}px`,n.style.height=`${a}px`,r.scale(o,o),this.mode===`crop`){let t=Math.max(i/e.naturalWidth,a/e.naturalHeight),n=i/t,o=a/t;r.drawImage(e,(e.naturalWidth-n)/2,(e.naturalHeight-o)/2,n,o,0,0,i,a)}else r.drawImage(e,0,0,i,a);this.frozen=!0}};yu.styles=[u,_u],yu.animatedExtensionPattern=/\.(?:gif|webp)(?=[?#\s,]|$)/i,A([j()],yu.prototype,`src`,void 0),A([j({reflect:!0})],yu.prototype,`mode`,void 0),A([j()],yu.prototype,`srcset`,void 0),A([j()],yu.prototype,`sizes`,void 0),A([j()],yu.prototype,`alt`,void 0),A([j({type:Number})],yu.prototype,`width`,void 0),A([j({type:Number})],yu.prototype,`height`,void 0),A([j()],yu.prototype,`loading`,void 0),A([j({reflect:!0,converter:vu})],yu.prototype,`checkered`,void 0),A([j({type:Boolean,reflect:!0})],yu.prototype,`rounded`,void 0),A([j({type:Boolean,reflect:!0})],yu.prototype,`animated`,void 0),A([M()],yu.prototype,`frozen`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,yu);var bu=new WeakMap,xu=new WeakSet,Su=class extends HTMLElement{constructor(...e){super(...e),F(this,xu),P(this,bu,null)}connectedCallback(){L(xu,this,Cu).call(this)}disconnectedCallback(){N(bu,this)?.destroy(),I(bu,this,null)}};function Cu(){if(!(N(bu,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>L(xu,this,Cu).call(this));return}I(bu,this,new ir),N(bu,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Su);function wu(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function Tu(e={}){let t=wu({...e,type:`submit`,label:e.label||s(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function Eu(e={}){let t=wu({...e,icon:`duplicate`,label:e.label||tr(s(`Paste {type}`,{type:s(`elements`)}))});return t.classList.add(`paste-btn`),t}var Du=async(e,t)=>{let{data:n}=await oe.post(e,t);return n},Ou=new WeakMap,ku=new WeakMap,Au=new WeakMap,ju=new WeakMap,Mu=new WeakMap,Nu=new WeakMap,Pu=new WeakMap,Fu=new WeakMap,Iu=new WeakMap,Lu=new WeakMap,X=new WeakSet,Ru=class e{constructor(t){F(this,X),P(this,Ou,null),P(this,ku,[]),P(this,Au,[]),P(this,ju,null),P(this,Mu,!1),P(this,Nu,!1),P(this,Pu,!1),P(this,Fu,null),P(this,Iu,void 0),P(this,Lu,new Map),this.options={...e.defaults,modalTitle:s(`Select element`),selectBtnLabel:s(`Select`),...Uu(t)},I(Au,this,[...this.options.disabledElementIds??[]]),I(Iu,this,L(X,this,zu).call(this))}get elementType(){return this.options.elementType}get state(){return N(Iu,this)}get index(){return N(Ou,this)}get hasSelection(){return N(ku,this).length>0}on(e,t){let n=N(Lu,this).get(e);return n||(n=new Set,N(Lu,this).set(e,n)),n.add(t),()=>{N(Lu,this).get(e)?.delete(t)}}async open(){I(ku,this,[]),N(Ou,this)?.clearSelection(),N(Mu,this)||(I(Mu,this,!0),L(X,this,Hu).call(this,`open`,void 0)),L(X,this,Bu).call(this),N(ju,this)||await this.reload()}close(){N(Mu,this)&&(I(Mu,this,!1),L(X,this,Hu).call(this,`close`,void 0),this.options.onClose?.(),L(X,this,Bu).call(this))}destroy(){N(Ou,this)?.destroy?.(),I(Ou,this,null),I(ku,this,[]),I(ju,this,null),I(Mu,this,!1),I(Pu,this,!1),I(Nu,this,!1),I(Fu,this,null),L(X,this,Bu).call(this),N(Lu,this).clear()}async reload(){let e=this.options.loadIndexBody??Du;I(Nu,this,!0),I(Fu,this,null),L(X,this,Bu).call(this);try{I(ju,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){L(X,this,Vu).call(this,e)}finally{I(Nu,this,!1),L(X,this,Bu).call(this)}}async submit(){if(!N(Iu,this).canSubmit)return;let e=this.buildElementInfo(N(ku,this)),t=this.selectMeta();I(Pu,this,!0),L(X,this,Bu).call(this);try{L(X,this,Hu).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){L(X,this,Vu).call(this,e);return}finally{I(Pu,this,!1),L(X,this,Bu).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...N(Au,this),...e.map(e=>Number(e.id))]),N(Ou,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){N(Iu,this).canCancel&&(L(X,this,Hu).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){I(Ou,this,e),L(X,this,Bu).call(this)}detachIndex(){I(Ou,this,null),L(X,this,Bu).call(this)}setSelection(e){I(ku,this,[...e]),L(X,this,Bu).call(this)}setDisabledElementIds(e){I(Au,this,[...new Set(e.map(Number))]),L(X,this,Bu).call(this)}setBusy(e){I(Pu,this,e),L(X,this,Bu).call(this)}indexParams(){let{options:e}=this,t={context:e.context??`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition,criteria:{...e.criteria}};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),e.criteria&&(t.criteria={...e.criteria}),typeof e.indexSettings.showFolders==`boolean`&&(t.showFolders=e.indexSettings.showFolders),t}indexSettings(){let{options:e}=this;return{context:e.context??`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...N(Au,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return N(ku,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){L(X,this,Bu).call(this)}get selection(){return N(ku,this)}get disabledElementIds(){return N(Au,this)}};function zu(){let e=N(Pu,this),t=N(Nu,this);return Object.freeze({open:N(Mu,this),loading:t,busy:e,selection:Object.freeze([...N(ku,this)]),disabledElementIds:Object.freeze([...N(Au,this)]),indexBody:N(ju,this),error:N(Fu,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function Bu(){I(Iu,this,L(X,this,zu).call(this)),L(X,this,Hu).call(this,`change`,N(Iu,this))}function Vu(e){I(Fu,this,e instanceof Error?e:Error(String(e??`Unknown`))),L(X,this,Hu).call(this,`error`,N(Fu,this))}function Hu(e,t){let n=N(Lu,this).get(e);n&&[...n].forEach(e=>e(t))}Ru.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function Uu(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var Wu=async(e,t)=>{let{data:n}=await oe.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},Gu=new WeakMap,Ku=class e extends Ru{constructor(e){super(e),P(this,Gu,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??Wu;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}I(Gu,this,t);try{await this.submit()}finally{I(Gu,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!N(Gu,this))return n;let r=e.transformUrls[N(Gu,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:N(Gu,this)}}};Ku.transformUrls={};var qu=`CraftCms\\Cms\\Asset\\Elements\\Asset`,Ju=new WeakSet,Yu=class extends Ru{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:qu,showSiteMenu:!1}),F(this,Ju),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:L(Ju,this,Xu).call(this),status:null,url:null,hasThumb:!1}]}};function Xu(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var Zu=new Map;function Qu(e,t){if(Zu.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);Zu.set(e,t)}function $u(e){return Zu.has(e)}function ed(e){return Zu.get(e)??Ru}function td(e){return new(ed(e.elementType))(e)}function nd(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))Zu.has(t)||Zu.set(t,n)}var rd={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},id=new WeakMap,ad=new WeakMap,od=new WeakMap,sd=new WeakMap,cd=new WeakMap,ld=new WeakMap,ud=new WeakMap,Z=new WeakSet,dd=class{constructor(e={}){F(this,Z),P(this,id,new Map),P(this,ad,null),P(this,od,0),P(this,sd,[]),P(this,cd,[]),P(this,ld,new Set),P(this,ud,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)N(id,this).set(e.id,e);r&&(L(Z,this,hd).call(this),N(ad,this)!==null&&L(Z,this,gd).call(this))}getSessions(){return Array.from(N(id,this).values())}getCurrentSessionId(){return N(ad,this)}isProcessing(){return N(od,this)>0}on(e,t){return N(ud,this).has(e)||N(ud,this).set(e,new Set),N(ud,this).get(e).add(t),()=>{N(ud,this).get(e)?.delete(t)}}async startIndexing(e){let t=await oe.post(rd.START,e),{data:n}=t;return n.session&&(N(id,this).set(n.session.id,n.session),I(ad,this,n.session.id),L(Z,this,pd).call(this),n.stop||L(Z,this,gd).call(this)),n.stop&&L(Z,this,md).call(this,n.stop),t}stopSession(e){L(Z,this,_d).call(this,e),L(Z,this,vd).call(this,{sessionId:e,action:rd.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){L(Z,this,vd).call(this,{sessionId:e,action:rd.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){L(Z,this,vd).call(this,{sessionId:e.sessionId,action:rd.FINISH,params:e,priority:!0})}destroy(){N(id,this).clear(),I(sd,this,[]),I(cd,this,[]),N(ud,this).clear(),I(ad,this,null),I(od,this,0)}};function fd(e,t){N(ud,this).get(e)?.forEach(e=>e(t))}function pd(e){L(Z,this,fd).call(this,`change`,{sessions:this.getSessions(),currentSessionId:N(ad,this),reviewSessionId:e})}function md(e){N(id,this).delete(e),N(ad,this)===e&&I(ad,this,null),L(Z,this,pd).call(this)}function hd(){for(let[e,t]of N(id,this))if(!t.actionRequired&&!N(ld,this).has(e)){I(ad,this,e);return}I(ad,this,null)}function gd(){if(N(ad,this)||L(Z,this,hd).call(this),!N(ad,this))return;let e=N(id,this).get(N(ad,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-N(od,this),r=Math.min(n,t);for(let t=0;t<r;t++)L(Z,this,vd).call(this,{sessionId:e.id,action:rd.PROCESS,params:{sessionId:N(ad,this)},priority:!1});e.processIfRootEmpty&&L(Z,this,vd).call(this,{sessionId:e.id,action:rd.PROCESS,params:{sessionId:N(ad,this)},priority:!1})}function _d(e){N(ld,this).add(e),I(sd,this,N(sd,this).filter(t=>t.sessionId!==e))}function vd(e){e.priority?N(cd,this).push(e):N(sd,this).push(e),L(Z,this,yd).call(this)}function yd(){if(!(N(sd,this).length+N(cd,this).length===0||N(od,this)>=this.maxConcurrentConnections))for(;N(sd,this).length+N(cd,this).length>0&&N(od,this)<this.maxConcurrentConnections;){var e;I(od,this,(e=N(od,this),e++,e));let t=N(cd,this).length>0?N(cd,this).shift():N(sd,this).shift();L(Z,this,bd).call(this,t)}}async function bd(e){try{let t=await oe.post(e.action,e.params);L(Z,this,xd).call(this,t.data)}catch(t){L(Z,this,Sd).call(this,t,e)}finally{var t;I(od,this,(t=N(od,this),t--,t)),L(Z,this,yd).call(this)}}function xd(e){let t;e.session&&(N(id,this).set(e.session.id,e.session),L(Z,this,hd).call(this),e.session.actionRequired&&!e.skipDialog?N(ld,this).has(e.session.id)||(t=e.session.id):N(ld,this).has(e.session.id)||L(Z,this,gd).call(this)),L(Z,this,hd).call(this),e.stop&&(N(id,this).delete(e.stop),N(ad,this)===e.stop&&I(ad,this,null)),L(Z,this,pd).call(this,t),N(id,this).size===0&&L(Z,this,fd).call(this,`complete`,{})}function Sd(e,t){L(Z,this,hd).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;L(Z,this,fd).call(this,`error`,{message:n,sessionId:t.sessionId}),L(Z,this,yd).call(this)}var Cd=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},wd=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Td,Ed=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Dd=typeof Intl<`u`&&Intl.ListFormat||Ed,Od=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],kd={minimumIntegerDigits:2},Ad=class{constructor(e,t={}){Td.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Cd(this,Td,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return wd(this,Td,`f`)}formatToParts(e){let t=[],n=wd(this,Td,`f`),r=n.style,i=n.locale;for(let[a,o]of Od){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?kd:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Dd(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Td=new WeakMap;var jd=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,Md=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],Nd=e=>jd.test(e),Pd=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(jd)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(Fd(r,e.from(t)).getTime()-r),a=Math.abs(Fd(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Ad(e,t).format(this)}};function Fd(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function Id(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new Pd;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=Md.indexOf(t)||Md.length;return new Pd(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function Ld(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new Pd(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function Rd(e,t){let n=Ld(e,t);if(n.blank)return[0,`second`];for(let e of Md){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},zd=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,Bd,Vd,Hd,Ud,Wd,Gd,Kd,qd,Jd,Yd,Xd,Zd,Qd,$d,ef,tf=globalThis.HTMLElement||null,nf=new Pd,rf=new Pd(0,0,0,0,0,1),af=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function of(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var sf=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=of(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,of(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},cf=class extends tf{constructor(){super(...arguments),$.add(this),Bd.set(this,!1),Vd.set(this,!1),Ud.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),ef.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,ef,`f`)}set onRelativeTimeUpdated(e){Q(this,ef,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,ef,`f`)),zd(this,ef,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&Nd(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return Md.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){sf.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&zd(this,Bd,n!==null&&(this.date&&Q(this,$,`m`,Wd).call(this,this.date))!==n,`f`),!Q(this,Vd,`f`)&&!(e===`title`&&Q(this,Bd,`f`))&&zd(this,Vd,(async()=>{await Promise.resolve(),this.update(),zd(this,Vd,!1,`f`)})(),`f`))}update(){let e=Q(this,Ud,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,Ud,`f`).textContent=e;return}let i=Date.now();Q(this,Bd,`f`)||(n=Q(this,$,`m`,Wd).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=Id(r,this.precision,i),o=Q(this,$,`m`,Gd).call(this,a),s=e,c=Q(this,$,`m`,$d).call(this,o);s=c?Q(this,$,`m`,Zd).call(this,r):o===`duration`?Q(this,$,`m`,Kd).call(this,a):o===`relative`?Q(this,$,`m`,qd).call(this,a):Q(this,$,`m`,Jd).call(this,r),s?Q(this,$,`m`,Qd).call(this,s):this.shadowRoot===Q(this,Ud,`f`)&&this.textContent&&Q(this,$,`m`,Qd).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new af(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,Yd).call(this,r)||Q(this,$,`m`,Xd).call(this,r))?sf.observe(this):sf.unobserve(this)}};Bd=new WeakMap,Vd=new WeakMap,Ud=new WeakMap,ef=new WeakMap,$=new WeakSet,Hd=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},Wd=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,Hd),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},Gd=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||Pd.compare(e,this.threshold)===1)return`relative`}return`datetime`},Kd=function(e){let t=Q(this,$,`a`,Hd),n=this.format,r=this.formatStyle,i=this.tense,a=nf;n===`micro`?(e=Ld(e),a=rf,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=rf)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},qd=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,Hd),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=nf),n===`past`&&e.sign!==-1&&(e=nf);let[r,i]=Rd(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},Jd=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,Hd),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},Yd=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Hd),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},Xd=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Hd),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},Zd=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,Yd).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,Hd),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,Hd))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,Hd),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,Xd).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,Hd),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,Hd),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},Qd=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,Ud,`f`).replaceChildren(t)}else Q(this,Ud,`f`).textContent=e},$d=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var lf=typeof globalThis<`u`?globalThis:window;try{lf.RelativeTimeElement=cf.define()}catch(e){if(!(lf.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{$n as C,Gn as D,Jn as E,Ln as O,Qn as S,Wn as T,W as _,$u as a,tr as b,Ru as c,Tu as d,Wc as f,za as g,Ga as h,nd as i,un as k,Eu as l,Uo as m,td as n,Yu as o,Is as p,Qu as r,Ku as s,dd as t,wu as u,ra as v,Zn as w,er as x,ir as y};
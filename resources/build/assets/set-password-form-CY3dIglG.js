import{o as e,r as t,t as n}from"./lit-Lit6OlC5.js";import"./dist-kkm-n_N6.js";import{n as r,t as i}from"./decorators-w0eQ18Zy.js";import{o as a}from"./nav-item-Wzo36dty-4c3mTCBD.js";import{t as o}from"./login-form.styles-CHGo5LIL.js";import{t as s}from"./decorate-B3KLIx2E.js";var c=class extends n{constructor(...e){super(...e),this.action=``,this.uid=``,this.code=``,this.initialError=``,this.newUser=!1,this._busy=!1}static{this.styles=[o]}#e(){return this.newUser?a(`Choose a password`):a(`Choose a new password`)}#t(){this._busy=!0}render(){return e`
      <craft-pane>
        <form
          class="auth-form"
          method="post"

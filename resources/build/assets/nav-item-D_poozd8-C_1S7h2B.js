...
`,z=new WeakMap,Ke=new WeakSet,B=class extends He(i){constructor(){super(),o(this,Ke),this.placement=`bottom-start`,this.distance=4,this.matchInvokerWidth=!1,this.withoutArrow=!1,s(this,z,null),E(this)}_defineOverlayConfig(){return{...We(),inheritsReferenceWidth:this.matchInvokerWidth?`min`:`none`,popperConfig:{strategy:`fixed`,placement:this.placement,modifiers:[{name:`offset`,options:{offset:[0,this.distance]}},...ce()]}}}get _overlayContentNode(){return this.shadowRoot?.querySelector(`.popover-pane`)}get _overlayInvokerNode(){if(this.anchor instanceof HTMLElement)return this.anchor;if(this.anchor?.contextElement instanceof HTMLElement)return this.anchor.contextElement;if(this.for){let e=this.getRootNode();return typeof e.getElementById==`function`?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}get _overlayReferenceNode(){return this.anchor}render(){return e`
    ...
    `}connectedCallback(){a(Ke,this,qe).call(this),super.connectedCallback()}updated(e){super.updated(e),(e.has(`for`)||e.has(`anchor`))&&this._overlayCtrl&&this._overlayCtrl.updateConfig({invokerNode:this._overlayInvokerNode,referenceNode:this._overlayReferenceNode})}async show(){this.opened=!0,await this.updateComplete,await this.open()}async hide(){this.opened=!1,await this.updateComplete,await this.close()}};function qe(){if(l(z,this)?.isConnected)return;let e=Array.from(this.childNodes).filter(e=>e instanceof Element?e.slot===``:(e.textContent??``).trim()!==``);if(!e.length)return;let t=document.createElement(`div`);t.slot=`content`,t.append(...e),this.append(t),u(z,this,t)}B.styles=[Ge],c([d({reflect:!0})],B.prototype,`for`,void 0),c([d({attribute:!1})],B.prototype,`anchor`,void 0),c([d({reflect:!0})],B.prototype,`placement`,void 0),c([d({type:Number})],B.prototype,`distance`,void 0),c([d({attribute:`match-invoker-width`,type:Boolean})],B.prototype,`matchInvokerWidth`,void 0),c([d({type:Boolean,attribute:`without-arrow`})],B.prototype,`withoutArrow`,void 0),customElements.get(`craft-popover`)||customElements.define(`craft-popover`,B);var V={Solid:`solid`,OutlineFill:`outline-fill`,Fill:`fill`,Outline:`outline`,Plain:`plain`};Object.values(V);var Je=`important`,Ye=` !important`,Xe=m(class extends h{constructor(e){if(super(e),e.type!==p.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:r}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?r.removeProperty(e):r[e]=null);for(let e in t){let n=t[e];if(n!=null){this.ft.add(e);let t=typeof n==`string`&&n.endsWith(Ye);e.includes(`-`)||t?r.setProperty(e,t?n.slice(0,-11):n,t?Je:``):r[e]=n}}return n}}),Ze=t`
...
`,$e=Object.defineProperty,et=Object.getOwnPropertyDescriptor,tt=Object.getOwnPropertySymbols,nt=Object.prototype.hasOwnProperty,rt=Object.prototype.propertyIsEnumerable,it=e=>{throw TypeError(e)},at=(e,t,n)=>t in e?$e(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,ot=(e,t)=>{for(var n in t||={})nt.call(t,n)&&at(e,n,t[n]);if(tt)for(var n of tt(t))rt.call(t,n)&&at(e,n,t[n]);return e},st=(e,t,n,r)=>{for(var i=r>1?void 0:r?et(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&$e(t,n,i),i},ct=(e,t,n)=>t.has(e)||it(`Cannot `+n),lt=(e,t,n)=>(ct(e,t,`read from private field`),n?n.call(e):t.get(e)),ut=(e,t,n)=>t.has(e)?it(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),dt=(e,t,n,r)=>(ct(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),H,U=class extends i{constructor(){super(),ut(this,H,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,ot({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){lt(this,H)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),dt(this,H,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}};H=new WeakMap,U.version=`2.20.1`,U.dependencies={},st([d()],U.prototype,`dir`,2),st([d()],U.prototype,`lang`,2);var ft=class extends U{render(){return e` <slot></slot> `}};ft.styles=[Qe,Ze],ft.define(`sl-visually-hidden`);var W=e=>e??r,pt=t`
  .badge-indicator {
...
`,G=class extends i{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant=`primary`,this.id=this.id||`badge-${Math.floor(Math.random()*1e9).toString()}`}showCount(){return this.badgeCount!==null&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?`99+`:this.badgeCount.toString()}getBadgeRole(){return this.altText?`img`:r}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return e`
    ...
    `}};G.styles=[pt],c([d({attribute:`alt-text`})],G.prototype,`altText`,void 0),c([d({attribute:`badge-count`})],G.prototype,`badgeCount`,void 0),c([d({attribute:`badge-count-suffix`})],G.prototype,`badgeCountSuffix`,void 0),c([d()],G.prototype,`variant`,void 0),c([d()],G.prototype,`id`,void 0),customElements.get(`craft-badge-indicator`)||customElements.define(`craft-badge-indicator`,G);function mt(e,t,n){if(!(n.button===0&&!n.metaKey&&!n.ctrlKey&&!n.shiftKey&&!n.altKey))return;let r=new CustomEvent(`craft-navigate`,{bubbles:!0,composed:!0,cancelable:!0,detail:{href:t}});e.dispatchEvent(r)||n.preventDefault()}var ht=Symbol.for(``),gt=e=>{if(e?.r===ht)return e?._$litStatic$},K=(e,...t)=>({_$litStatic$:t.reduce(((t,n,r)=>t+(e=>{if(e._$litStatic$!==void 0)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(n)+e[r+1]),e[0]),r:ht}),_t=new Map,q=(e=>(t,...n)=>{let r=n.length,i,a,o=[],s=[],c,l=0,u=!1;for(;l<r;){for(c=t[l];l<r&&(a=n[l],(i=gt(a))!==void 0);)c+=i+t[++l],u=!0;l!==r&&s.push(a),o.push(c),l++}if(l===r&&o.push(t[r]),u){let e=o.join(`$$lit$$`);(t=_t.get(e))===void 0&&(o.raw=o,_t.set(e,t=o)),n=s}return e(t,...n)})(e),vt=t`
  :host {
...
`,J=new WeakMap,Y=new WeakMap,X=new WeakMap,Z=new WeakMap,yt=new WeakMap,Q=new WeakMap,$=class t extends i{get hasLabel(){return Array.from(this.childNodes).some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE&&!e.hasAttribute(`slot`))}constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.initialState=`closed`,this.group=!1,this.togglePosition=`suffix`,this.subnavState=`closed`,this.flyoutOpen=!1,s(this,J,void 0),s(this,Y,void 0),s(this,X,()=>{clearTimeout(l(J,this)),this.flyoutOpen=!0}),s(this,Z,()=>{clearTimeout(l(J,this)),u(J,this,setTimeout(()=>{this.flyoutOpen=!1},t.flyoutCloseDelay))}),s(this,yt,e=>{this.flyoutOpen=e.target.opened===!0}),s(this,Q,e=>{this.href&&mt(this,this.href,e)}),this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active||this.initialState===`open`?`open`:`closed`;let{signal:e}=u(Y,this,new AbortController);this.addEventListener(`mouseenter`,l(X,this),{signal:e}),this.addEventListener(`mouseleave`,l(Z,this),{signal:e}),this.addEventListener(`focusin`,l(X,this),{signal:e}),this.addEventListener(`focusout`,l(Z,this),{signal:e})}disconnectedCallback(){l(Y,this)?.abort(),clearTimeout(l(J,this)),super.disconnectedCallback()}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(t){let n=`item-${this.id}`,i=this.href?K`a`:K`span`;return q`
      <${i}
    ...
    `}renderInteractiveItem(){let e=this.href?K`a`:K`span`;return q`
      <${e}

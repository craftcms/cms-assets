...
`,Ya=new WeakMap,Xa=new WeakMap,Za=new WeakMap,B=new WeakSet,Qa=new WeakMap,$a=class extends qa{static get styles(){return[...super.styles,Ja]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,B),this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,Ya,void 0),f(this,Xa,!1),f(this,Za,()=>{h(Xa,this,!0),u(B,this,io).call(this),u(B,this,eo).call(this)}),f(this,Qa,()=>{this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(B,this,io).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m(Za,this)),this.addEventListener(`model-value-changed`,()=>{h(Ya,this,this.modelValue)}),h(Ya,this,this.modelValue),u(B,this,io).call(this)}updated(e){super.updated(e),e.has(`opened`)&&!this.opened&&h(Xa,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`))&&u(B,this,io).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,u(B,this,co).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t),e.updateComplete.then(()=>{String(e.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(e)))})}_notifyModelValueChanged(){this.modelValue!==m(Ya,this)&&(h(Ya,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:`input`}})))}matchCondition(){return!0}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=u(B,this,co).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ${e?r`<craft-icon class="prefix" name=${e}></craft-icon>`:c}
        <slot name="input"></slot>
        ${this.clearable&&u(B,this,oo).call(this)?r`<craft-button
              class="clear"
              type="button"
              appearance="plain"
              size="small"
    ...
    `}parser(e){if(typeof e==`string`&&e!==``){let t=u(B,this,so).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function eo(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function to(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(u(B,this,no).call(this,e))for(let r of e.options)(t===``||u(B,this,ro).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||u(B,this,ro).call(this,t,e))&&n.push({option:e});return n}function no(e){return e.type===`optgroup`}function ro(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function io(){let e=this._listboxNode;if(!e)return;let t=m(Xa,this)?this._inputNode?.value??``:``,n=u(B,this,to).call(this,t),i=n.slice(0,this.limit),a;s(r`${i.map(e=>{let t=e.groupLabel&&e.groupLabel!==a?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return a=e.groupLabel,r`${t}${u(B,this,ao).call(this,e.option)}`})}${n.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${O(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:n.length})}
          </div>`:c}`,e)}function ao(e){let t=e.data??{},n=e.label,i=n.startsWith(`$`)||n.startsWith(`@`);return r`
      <craft-option
    ...
    `}function oo(){return this.modelValue!==``&&this.modelValue!=null}function so(e){let t=e.trim();for(let e of u(B,this,lo).call(this))if(u(B,this,uo).call(this,e)===t)return e}function co(){if(!u(B,this,oo).call(this))return;let e=String(this.modelValue);for(let t of u(B,this,lo).call(this))if(String(t.value)===e)return t}function*lo(){for(let e of this.options)u(B,this,no).call(this,e)?yield*e.options:yield e}function uo(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}p([g({type:Array})],$a.prototype,`options`,void 0),p([g({type:Number})],$a.prototype,`limit`,void 0),p([g({type:Boolean,reflect:!0})],$a.prototype,`clearable`,void 0),p([g({type:String,reflect:!0})],$a.prototype,`placeholder`,void 0),p([g({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],$a.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,$a);var fo=a`
  :host {
    display: inline-block;
  }
...
`,po={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},mo=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(po[`icon.out`].keyframes,po[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(po[`icon.in`].keyframes,po[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(po[`icon.out`].keyframes,po[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(po[`icon.in`].keyframes,po[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||O(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};mo.styles=[fo],p([_()],mo.prototype,`isCopying`,void 0),p([_()],mo.prototype,`status`,void 0),p([y(`slot[name="copy-icon"]`)],mo.prototype,`copyIconEl`,void 0),p([y(`slot[name="success-icon"]`)],mo.prototype,`successIconEl`,void 0),p([y(`slot[name="error-icon"]`)],mo.prototype,`errorIconEl`,void 0),p([y(`craft-tooltip`)],mo.prototype,`tooltipEl`,void 0),p([g({type:String})],mo.prototype,`value`,void 0),p([g({type:Boolean})],mo.prototype,`disabled`,void 0),p([g({attribute:`feedback-duration`,type:Number})],mo.prototype,`feedbackDuration`,void 0),p([g({attribute:`tooltip-label`})],mo.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,mo);var ho=a`
  :host {
    box-sizing: border-box;
  }
...
`,_o=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return r`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};_o.styles=[ho,go],p([y(`craft-copy-button`)],_o.prototype,`copyButtonEl`,void 0),p([g({type:String})],_o.prototype,`value`,void 0),p([g({type:Boolean,reflect:!0})],_o.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,_o);var vo=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function yo(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function bo(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(vo))).filter(yo)}function xo(e){let t=t=>{if(t.key!==`Tab`)return;let n=bo(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var So=a`
  :host {
    display: contents;
...
`,Co=0,wo=0;function To(){wo++===0&&document.body.classList.add(`no-scroll`)}function Eo(){wo>0&&--wo===0&&document.body.classList.remove(`no-scroll`)}var Do=new WeakMap,Oo=new WeakMap,ko=new WeakMap,Ao=new WeakMap,jo=new WeakSet,Mo=new WeakMap,No=new WeakMap,Po=new WeakMap,Fo=new WeakMap,Io=new WeakMap,Lo=new WeakMap,Ro=class extends l{constructor(...e){super(...e),d(this,jo),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++Co}`,f(this,Do,!1),f(this,Oo,null),f(this,ko,!1),f(this,Ao,null),f(this,Mo,e=>{e.preventDefault(),this.requestClose()}),f(this,No,()=>{this.opened=!1}),f(this,Po,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),f(this,Fo,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),f(this,Io,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),f(this,Lo,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,m(Fo,this)),this.addEventListener(`keydown`,m(Po,this)),h(Ao,this,new MutationObserver(()=>this.requestUpdate())),m(Ao,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(Fo,this)),this.removeEventListener(`keydown`,m(Po,this)),m(Ao,this)?.disconnect(),h(Ao,this,null),m(Oo,this)?.call(this),h(Oo,this,null),u(jo,this,Vo).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
    ...
    `}updated(e){super.updated(e),this.opened!==m(Do,this)&&(h(Do,this,this.opened),this.opened?u(jo,this,zo).call(this):u(jo,this,Bo).call(this),u(jo,this,Ho).call(this,this.opened))}requestClose(){this.opened=!1}};function zo(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(m(Oo,this)?.call(this),h(Oo,this,xo(this))),m(ko,this)||(h(ko,this,!0),To())}function Bo(){let e=this.dialogElement;e?.open&&e.close(),m(Oo,this)?.call(this),h(Oo,this,null),u(jo,this,Vo).call(this)}function Vo(){m(ko,this)&&(h(ko,this,!1),Eo())}function Ho(e){u(jo,this,Uo).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&u(jo,this,Uo).call(this,e?`craft-after-show`:`craft-after-hide`)})}function Uo(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}Ro.styles=[ho,So],p([g({type:Boolean,attribute:`open`,reflect:!0})],Ro.prototype,`opened`,void 0),p([g()],Ro.prototype,`label`,void 0),p([g({type:Boolean,attribute:`non-modal`,reflect:!0})],Ro.prototype,`nonModal`,void 0),p([g({type:Boolean,reflect:!0})],Ro.prototype,`fullscreen`,void 0),p([g({type:Boolean,attribute:`close-on-outside-click`})],Ro.prototype,`closeOnOutsideClick`,void 0),p([g({type:Boolean,attribute:`no-close`,reflect:!0})],Ro.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,Ro);var Wo=new WeakMap,Go=new WeakSet,Ko=class{constructor(e,t){this.host=e,this.source=t,d(this,Go),f(this,Wo,null),e.addController(this)}hostConnected(){u(Go,this,qo).call(this)}hostDisconnected(){u(Go,this,Jo).call(this)}resubscribe(){u(Go,this,Jo).call(this),u(Go,this,qo).call(this)}get state(){return this.source()?.state??null}};function qo(){h(Wo,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function Jo(){m(Wo,this)?.call(this),h(Wo,this,null)}var Yo=a`
  :host {
    /*
...
`,Xo=new WeakMap,Zo=new WeakMap,Qo=new WeakMap,$o=new WeakMap,es=new WeakMap,ts=class extends Ro{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,f(this,Xo,new Ko(this,()=>this.controller)),f(this,Zo,null),f(this,Qo,()=>{this.submit()}),f(this,$o,()=>{this.busy||this.requestClose()}),f(this,es,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&h(Zo,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),m(Zo,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&m(Xo,this).resubscribe();let t=m(Xo,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&m(Zo,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
    ...
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};ts.styles=[...Ro.styles,Yo],p([g({attribute:!1})],ts.prototype,`controller`,void 0),p([g({type:Boolean,attribute:`show-title`,reflect:!0})],ts.prototype,`showTitle`,void 0),p([g({attribute:`select-label`})],ts.prototype,`selectLabel`,void 0),p([g({attribute:`cancel-label`})],ts.prototype,`cancelLabel`,void 0),p([g({type:Boolean,reflect:!0})],ts.prototype,`busy`,void 0),p([g({type:Boolean,reflect:!0})],ts.prototype,`loading`,void 0),p([g({type:Boolean,attribute:`can-submit`,reflect:!0})],ts.prototype,`canSubmit`,void 0),p([g({type:Boolean,reflect:!0})],ts.prototype,`narrow`,void 0),p([_()],ts.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,ts);var ns=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
    ...
    `],p([g()],is.prototype,`label`,void 0),p([g()],is.prototype,`icon`,void 0),customElements.get(`craft-empty`)||customElements.define(`craft-empty`,is);var as=a`
  :host {
    position: relative;
    display: block;
  }
...
`,os=class extends gi(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=O(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[Nt,br,as]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth()}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
    ...
    `}__hasLightChild(e){return this.__lightChild(e)!==void 0}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`span`);t.className=`visually-hidden`,t.textContent=O(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};p([g({type:Boolean,reflect:!0})],os.prototype,`required`,void 0),p([g({type:Boolean,reflect:!0})],os.prototype,`translatable`,void 0),p([g({attribute:`translation-description`})],os.prototype,`translationDescription`,void 0),p([g({type:Boolean,reflect:!0})],os.prototype,`fieldset`,void 0),p([g({reflect:!0})],os.prototype,`status`,void 0),p([g({attribute:`status-label`})],os.prototype,`statusLabel`,void 0),p([g({reflect:!0})],os.prototype,`orientation`,void 0),p([g({type:Boolean,reflect:!0,attribute:`has-errors`})],os.prototype,`hasErrors`,void 0),p([g({attribute:`instructions-position`})],os.prototype,`instructionsPosition`,void 0),p([g({type:String,reflect:!0})],os.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,os);var ss=class extends l{render(){return r`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,ss);var cs=a`
  ${br}
...
`,ls=/^[0-9a-f]{6}$/i,us=/^[0-9a-f]{3}$/i,ds={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function fs(e){return String(e??``).trim().replace(/^#/,``)}function ps(e){let t=fs(e);return us.test(t)?t.split(``).map(e=>e+e).join(``):ls.test(t)?t:null}var ms=class e extends Bi{static get styles(){return[...super.styles,xr,cs]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,fs(t)),e}}}parser(e){return fs(e)}formatter(e){return fs(e)}serializer(e){return fs(e)}deserializer(e){return fs(e)}preprocessor(e){let t=fs(e);if(t!==e)return t}get _expandedHexValue(){return ps(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>ps(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=fs(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
      <input
    ...
    `}};ms._browserSupportsColorInputs=null,p([g({converter:ds})],ms.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,ms);var hs=a`
  ::slotted(.form-control) {
    ${_r}
  }
...
`,_s=class extends V{static get styles(){return[...super.styles,gs]}_renderSuffix(){return r`<craft-copy-button
      tooltip-label="${O(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};p([g({type:String,attribute:`copy-value`})],_s.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,_s);var vs=class extends V{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,vs);var ys=new WeakSet,bs=class extends V{constructor(){super(),d(this,ys),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,u(ys,this,xs))}disconnectedCallback(){this.removeEventListener(`change`,u(ys,this,xs)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),u(ys,this,Ss).call(this)}};function xs(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=u(ys,this,Cs).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}u(ys,this,Ss).call(this)}}function Ss(){let e=this._inputNode;if(!e)return;let t=u(ys,this,ws).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=u(ys,this,ws).call(this,e),i=u(ys,this,ws).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function Cs(e){let t=u(ys,this,ws).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function ws(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}p([g({type:Number,attribute:`minute-increment`})],bs.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],bs.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],bs.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,bs);var Ts={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},Es=new WeakSet,Ds=new WeakMap,H=class extends l{constructor(...e){super(...e),d(this,Es),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,f(this,Ds,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof V))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,m(Ds,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,m(Ds,this)),super.disconnectedCallback()}updated(e){super.updated(e),u(Es,this,Os).call(this),u(Es,this,ks).call(this),u(Es,this,As).call(this),u(Es,this,Fs).call(this,`locale`,this.locale,!0),u(Es,this,Fs).call(this,`timezone`,this.timezone,!this.showTimezone)}};function Os(){let e=u(Es,this,js).call(this,`craft-input-date`,`date`,this.showDate);e instanceof vs&&(u(Es,this,Ps).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,u(Es,this,Ms).call(this,e))}function ks(){let e=u(Es,this,js).call(this,`craft-input-time`,`time`,this.showTime);e instanceof bs&&(u(Es,this,Ps).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,u(Es,this,Ms).call(this,e))}function As(){let e=u(Es,this,js).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(u(Es,this,Ps).call(this,e,`timezone`,this.timezone??``,!1),u(Es,this,Ms).call(this,e))}function js(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof V);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Ms(e){e.parentElement!==this&&this.insertBefore(e,u(Es,this,Ns).call(this))}function Ns(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function Ps(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function Fs(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}H.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
...
`,pc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(pc);var mc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(mc);var hc=new Set([`clip`,`hidden`]),gc=class extends fr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=pc.Raised,this.variant=mc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!hc.has(n)&&e.scrollHeight-e.clientHeight>1||!hc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};gc.styles=[ho,fc],p([g({reflect:!0})],gc.prototype,`appearance`,void 0),p([g({reflect:!0})],gc.prototype,`variant`,void 0),p([g()],gc.prototype,`label`,void 0),p([_()],gc.prototype,`_hasSlottedHeader`,void 0),p([_()],gc.prototype,`_hasSlottedFooter`,void 0),p([_()],gc.prototype,`_scrollable`,void 0),p([_()],gc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,gc);var _c=0,vc=new WeakMap,U=new WeakSet,yc=class extends l{constructor(...e){super(...e),d(this,U),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,vc,++_c)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(U,this,Ac).call(this)}render(){let e=u(U,this,Sc).call(this);return Us(this.groups,e=>e.handle,(t,n)=>u(U,this,bc).call(this,t,n,e))}};function bc(e,t,n){let i=`permission-tree-heading-${m(vc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
    ...
    `}function xc(e,t,n,i){return Us(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(U,this,wc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
...
`,Sf={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},Cf=class extends l{constructor(...e){super(...e),this.src=null,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}render(){return r`

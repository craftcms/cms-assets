...
`,B=new WeakMap,We=new WeakSet,V=class extends Be(i){constructor(){super(),o(this,We),this.placement=`bottom-start`,this.distance=4,this.matchInvokerWidth=!1,this.withoutArrow=!1,s(this,B,null),T(this)}_defineOverlayConfig(){return{...He(),inheritsReferenceWidth:this.matchInvokerWidth?`min`:`none`,popperConfig:{strategy:`fixed`,placement:this.placement,modifiers:[{name:`offset`,options:{offset:[0,this.distance]}},...E()]}}}get _overlayContentNode(){return this.shadowRoot?.querySelector(`.popover-pane`)}get _overlayInvokerNode(){if(this.anchor instanceof HTMLElement)return this.anchor;if(this.anchor?.contextElement instanceof HTMLElement)return this.anchor.contextElement;if(this.for){let e=this.getRootNode();return typeof e.getElementById==`function`?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}get _overlayReferenceNode(){return this.anchor}render(){return e`
    ...
    `}connectedCallback(){a(We,this,Ge).call(this),super.connectedCallback()}updated(e){super.updated(e),(e.has(`for`)||e.has(`anchor`))&&this._overlayCtrl&&this._overlayCtrl.updateConfig({invokerNode:this._overlayInvokerNode,referenceNode:this._overlayReferenceNode})}async show(){this.opened=!0,await this.updateComplete,await this.open()}async hide(){this.opened=!1,await this.updateComplete,await this.close()}};function Ge(){if(l(B,this)?.isConnected)return;let e=Array.from(this.childNodes).filter(e=>e instanceof Element?e.slot===``:(e.textContent??``).trim()!==``);if(!e.length)return;let t=document.createElement(`div`);t.slot=`content`,t.append(...e),this.append(t),u(B,this,t)}V.styles=[Ue],c([d({reflect:!0})],V.prototype,`for`,void 0),c([d({attribute:!1})],V.prototype,`anchor`,void 0),c([d({reflect:!0})],V.prototype,`placement`,void 0),c([d({type:Number})],V.prototype,`distance`,void 0),c([d({attribute:`match-invoker-width`,type:Boolean})],V.prototype,`matchInvokerWidth`,void 0),c([d({type:Boolean,attribute:`without-arrow`})],V.prototype,`withoutArrow`,void 0),customElements.get(`craft-popover`)||customElements.define(`craft-popover`,V);var H={Solid:`solid`,OutlineFill:`outline-fill`,Fill:`fill`,Outline:`outline`,Plain:`plain`};Object.values(H);var Ke=`important`,qe=` !important`,Je=m(class extends h{constructor(e){if(super(e),e.type!==p.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:r}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?r.removeProperty(e):r[e]=null);for(let e in t){let n=t[e];if(n!=null){this.ft.add(e);let t=typeof n==`string`&&n.endsWith(qe);e.includes(`-`)||t?r.setProperty(e,t?n.slice(0,-11):n,t?Ke:``):r[e]=n}}return n}}),Ye=t`
...
`,Y=new WeakMap,X=new WeakMap,Z=new WeakMap,Q=new WeakMap,gt=new WeakMap,$=class t extends i{get hasLabel(){return Array.from(this.childNodes).some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE&&!e.hasAttribute(`slot`))}constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.initialState=`closed`,this.group=!1,this.togglePosition=`suffix`,this.subnavState=`closed`,this.flyoutOpen=!1,s(this,Y,void 0),s(this,X,void 0),s(this,Z,()=>{clearTimeout(l(Y,this)),this.flyoutOpen=!0}),s(this,Q,()=>{clearTimeout(l(Y,this)),u(Y,this,setTimeout(()=>{this.flyoutOpen=!1},t.flyoutCloseDelay))}),s(this,gt,e=>{this.flyoutOpen=e.target.opened===!0}),this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active||this.initialState===`open`?`open`:`closed`;let{signal:e}=u(X,this,new AbortController);this.addEventListener(`mouseenter`,l(Z,this),{signal:e}),this.addEventListener(`mouseleave`,l(Q,this),{signal:e}),this.addEventListener(`focusin`,l(Z,this),{signal:e}),this.addEventListener(`focusout`,l(Q,this),{signal:e})}disconnectedCallback(){l(X,this)?.abort(),clearTimeout(l(Y,this)),super.disconnectedCallback()}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(t){let n=`item-${this.id}`,i=this.href?J`a`:J`span`;return mt`
    ...
    `}renderItem(e,t=!1){let n=this.href?J`a`:J`span`;return mt`
      <${n}

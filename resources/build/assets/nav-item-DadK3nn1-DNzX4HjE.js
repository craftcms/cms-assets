...
`,A=Object.defineProperty,te=Object.getOwnPropertyDescriptor,j=Object.getOwnPropertySymbols,M=Object.prototype.hasOwnProperty,N=Object.prototype.propertyIsEnumerable,P=e=>{throw TypeError(e)},F=(e,t,n)=>t in e?A(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,I=(e,t)=>{for(var n in t||={})M.call(t,n)&&F(e,n,t[n]);if(j)for(var n of j(t))N.call(t,n)&&F(e,n,t[n]);return e},L=(e,t,n,r)=>{for(var i=r>1?void 0:r?te(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&A(t,n,i),i},R=(e,t,n)=>t.has(e)||P(`Cannot `+n),z=(e,t,n)=>(R(e,t,`read from private field`),n?n.call(e):t.get(e)),B=(e,t,n)=>t.has(e)?P(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),V=(e,t,n,r)=>(R(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),H,U=class extends i{constructor(){super(),B(this,H,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,I({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){z(this,H)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),V(this,H,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}};H=new WeakMap,U.version=`2.20.1`,U.dependencies={},L([o()],U.prototype,`dir`,2),L([o()],U.prototype,`lang`,2);var W=class extends U{render(){return e` <slot></slot> `}};W.styles=[ee,k],W.define(`sl-visually-hidden`);var G=e=>e??r,K=t`
  .badge-indicator {
...
`,q=class extends i{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant=`primary`,this.id=this.id||`badge-${Math.floor(Math.random()*1e9).toString()}`}showCount(){return this.badgeCount!==null&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?`99+`:this.badgeCount.toString()}getBadgeRole(){return this.altText?`img`:r}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return e`
    ...
    `}};q.styles=[K],a([o({attribute:`alt-text`})],q.prototype,`altText`,void 0),a([o({attribute:`badge-count`})],q.prototype,`badgeCount`,void 0),a([o({attribute:`badge-count-suffix`})],q.prototype,`badgeCountSuffix`,void 0),a([o()],q.prototype,`variant`,void 0),a([o()],q.prototype,`id`,void 0),customElements.get(`craft-badge-indicator`)||customElements.define(`craft-badge-indicator`,q);var J=Symbol.for(``),ne=e=>{if(e?.r===J)return e?._$litStatic$},Y=(e,...t)=>({_$litStatic$:t.reduce(((t,n,r)=>t+(e=>{if(e._$litStatic$!==void 0)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(n)+e[r+1]),e[0]),r:J}),X=new Map,Z=(e=>(t,...n)=>{let r=n.length,i,a,o=[],s=[],c,l=0,u=!1;for(;l<r;){for(c=t[l];l<r&&(a=n[l],(i=ne(a))!==void 0);)c+=i+t[++l],u=!0;l!==r&&s.push(a),o.push(c),l++}if(l===r&&o.push(t[r]),u){let e=o.join(`$$lit$$`);(t=X.get(e))===void 0&&(o.raw=o,X.set(e,t=o)),n=s}return e(t,...n)})(e),re=`important`,ie=` !important`,Q=l(class extends u{constructor(e){if(super(e),e.type!==c.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:r}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?r.removeProperty(e):r[e]=null);for(let e in t){let n=t[e];if(n!=null){this.ft.add(e);let t=typeof n==`string`&&n.endsWith(ie);e.includes(`-`)||t?r.setProperty(e,t?n.slice(0,-11):n,t?re:``):r[e]=n}}return n}}),ae=t`
  :host {
...
`,$=class extends i{get hasLabel(){return Array.from(this.childNodes).some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE&&!e.hasAttribute(`slot`))}constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.initialState=`closed`,this.group=!1,this.togglePosition=`suffix`,this.subnavState=`closed`,this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active||this.initialState===`open`?`open`:`closed`}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(e){let t=`item-${this.id}`,n=this.href?Y`a`:Y`span`;return Z`
      <${n}
        class="${d({"nav-item":!0,"nav-item--icon":!0,"nav-item--static":!this.href})}"
        id="${t}"
    ...
    `}renderItem(e,t=!1){let n=this.href?Y`a`:Y`span`;return Z`
      <${n}
        class="${d({"nav-item":!0,"nav-item--prefixed":t,"nav-item--flush":this.flush,"nav-item--static":!this.href})}"
        href="${G(this.href||void 0)}"
        aria-current="${this.href?this.active?`page`:`false`:r}"
      >
    ...
    `}render(){let t=!!this.querySelector(`[slot="subnav"]`),n=t&&this.hasLabel&&!this.group,i=n&&this.togglePosition===`prefix`||!!this.icon||!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`),a=!n||this.subnavState===`open`;return e`
      <li>
        ${this.iconOnly?this.renderIconItem(n):this.renderItem(n,i)}
        ${t?e`
              <div
                class="subnav"
                id="${this.id}-subnav"
                style="${Q({display:a?`block`:`none`})}"
              >
                <slot name="subnav"></slot>
              </div>
            `:r}
      </li>
    `}};$.styles=ae,a([o()],$.prototype,`icon`,void 0),a([o()],$.prototype,`href`,void 0),a([o({type:Boolean,reflect:!0})],$.prototype,`active`,void 0),a([o({type:Boolean})],$.prototype,`external`,void 0),a([o({type:Boolean})],$.prototype,`indicator`,void 0),a([o()],$.prototype,`id`,void 0),a([o({reflect:!0,type:Boolean,attribute:`icon-only`})],$.prototype,`iconOnly`,void 0),a([o()],$.prototype,`flush`,void 0),a([o({reflect:!0,attribute:`initial-state`})],$.prototype,`initialState`,void 0),a([o({type:Boolean,reflect:!0})],$.prototype,`group`,void 0),a([o({attribute:`toggle-position`})],$.prototype,`togglePosition`,void 0),a([s()],$.prototype,`subnavState`,void 0),customElements.get(`craft-nav-item`)||customElements.define(`craft-nav-item`,$);export{E as a,l as c,O as i,u as l,Q as n,D as o,G as r,d as s,$ as t,c as u};
import{S as e}from"./nav-item-PE_0Q8tE-A6oeOABY.js";import{c as t,r as n,t as r}from"./lit-DNaDb1T7.js";import"./cp-j7KRBPPu.js";import{n as i,t as a}from"./decorators-D0-gbKXH.js";import{t as o}from"./login-form.styles-CWUEj_6V.js";import{t as s}from"./decorate-B3KLIx2E.js";var c=class extends r{constructor(...e){super(...e),this.action=``,this.uid=``,this.code=``,this.passwordRules=``,this.initialError=``,this.newUser=!1,this._busy=!1}static{this.styles=[o]}#e(){return this.newUser?e(`Choose a password`):e(`Choose a new password`)}#t(){this._busy=!0}render(){return t`
      <craft-pane>
        <form
          class="auth-form"
          method="post"

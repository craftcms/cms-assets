...
`,q=class extends r{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant=`primary`,this.id=this.id||`badge-${Math.floor(Math.random()*1e9).toString()}`}showCount(){return this.badgeCount!==null&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?`99+`:this.badgeCount.toString()}getBadgeRole(){return this.altText?`img`:n}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return t`
    ...
    `}};q.styles=[K],_([a()],q.prototype,`altText`,void 0),_([a()],q.prototype,`badgeCount`,void 0),_([a()],q.prototype,`badgeCountSuffix`,void 0),_([a()],q.prototype,`variant`,void 0),_([a()],q.prototype,`id`,void 0),customElements.get(`craft-badge-indicator`)||customElements.define(`craft-badge-indicator`,q);var J=`important`,Y=` !`+J,X=y(class extends b{constructor(e){if(super(e),e.type!==v.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(t,[n]){let{style:r}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(n)),this.render(n);for(let e of this.ft)n[e]??(this.ft.delete(e),e.includes(`-`)?r.removeProperty(e):r[e]=null);for(let e in n){let t=n[e];if(t!=null){this.ft.add(e);let n=typeof t==`string`&&t.endsWith(Y);e.includes(`-`)||n?r.setProperty(e,n?t.slice(0,-11):t,n?J:``):r[e]=t}}return e}}),Z=i`
  :host {
...
`,Q=class extends r{constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.subnavState=`closed`,this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active?`open`:`closed`}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(e){let n=`item-${this.id}`;return t`
      <a
    ...
    `}renderItem(e,r=!1){return t`
      <a
        class="${x({"nav-item":!0,"nav-item--prefixed":r,"nav-item--flush":this.flush})}"
        href="${this.href}"
        aria-current="${this.active?`page`:!1}"
      >
        ${r?this.renderPrefix():n}
        <slot id="${this.id}-label"></slot>
        ${this.renderSuffix(e)}
      </a>
    `}render(){let e=!!this.querySelector(`[slot="subnav"]`),r=!!this.icon||!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`);return t`
      <li>
        ${this.iconOnly?this.renderIconItem(e):this.renderItem(e,r)}
        ${e?t`
              <div
                class="subnav"
                id="${this.id}-subnav"
    ...
    `}};Q.styles=Z,_([a()],Q.prototype,`icon`,void 0),_([a()],Q.prototype,`href`,void 0),_([a({type:Boolean,reflect:!0})],Q.prototype,`active`,void 0),_([a({type:Boolean})],Q.prototype,`external`,void 0),_([a({type:Boolean})],Q.prototype,`indicator`,void 0),_([a()],Q.prototype,`id`,void 0),_([a({reflect:!0,type:Boolean,attribute:`icon-only`})],Q.prototype,`iconOnly`,void 0),_([a()],Q.prototype,`flush`,void 0),_([o()],Q.prototype,`subnavState`,void 0),customElements.get(`craft-nav-item`)||customElements.define(`craft-nav-item`,Q);export{x as a,v as c,D as i,_ as l,X as n,y as o,E as r,b as s,Q as t};
...
`;function fe(e){return(t,n)=>{let{slot:r,selector:i}=e??{},a=`slot`+(r?`[name=${r}]`:`:not([name])`);return v(t,n,{get(){let t=(this.renderRoot?.querySelector(a))?.assignedElements(e)??[];return i===void 0?t:t.filter((e=>e.matches(i)))}})}}var pe=class extends l{constructor(){super(),this.alt=!1,this.shift=!1,this.os=`Unknown`,this.os=this.detectOS()}connectedCallback(){super.connectedCallback(),this.os===`Unknown`&&(this.os=this.detectOS())}detectOS(){let e=navigator.platform.toLowerCase();return e.includes(`mac`)||/iphone|ipad|ipod/.test(e)?`Mac`:e.includes(`win`)?`Windows`:e.includes(`linux`)?`Linux`:`Unknown`}renderShortcutPrefix(){switch(this.os){case`Mac`:return`${this.alt?`⌥`:``}${this.shift?`⇧`:``}⌘`;case`Linux`:return`Super+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`;default:return`Ctrl+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`}}render(){return r`<span class="shortcut"
  ...
  `,p([g({type:Boolean})],pe.prototype,`alt`,void 0),p([g({type:Boolean})],pe.prototype,`shift`,void 0),p([g()],pe.prototype,`os`,void 0),customElements.get(`craft-shortcut`)||customElements.define(`craft-shortcut`,pe);var me=class{constructor(){this.refreshPromise=null,this.tokenName=null,this.tokenValue=null,this.refreshPromise=null}async getToken(){return this.tokenValue||await this.refreshToken(),this.tokenValue}async refreshToken(){return this.refreshPromise||=_e.get(`users/session-info`).then(({data:e})=>{let{csrfTokenName:t,csrfTokenValue:n}=e;if(this.tokenName=t??null,this.tokenValue=n??null,t&&n){let e=b.getInstance();e.set(`csrfTokenName`,t),e.set(`csrfTokenValue`,n),x.defaults.headers.common[`X-CSRF-TOKEN`]=n;let r=window.Craft;r&&(r.csrfTokenValue=n),document.querySelectorAll(`input[type="hidden"]`).forEach(e=>{e.name===t&&(e.value=e.defaultValue=n)})}return this.tokenValue}).finally(()=>{this.refreshPromise=null}),this.refreshPromise}clearToken(){this.tokenValue=null}};function he(e=``){return b.getInstance().getActionUrl(e)}function ge(){let e=window.Craft,t=e?.registeredAssetBundles??Cp.registeredAssetBundles,n=e?.registeredJsFiles??Cp.registeredJsFiles;return{"X-Registered-Asset-Bundles":[...new Set(t)].join(`,`),"X-Registered-Js-Files":[...new Set(n)].join(`,`)}}var _e=x.create(),ve=new me;_e.interceptors.request.use(async e=>{e.url&&!e.url.startsWith(`/`)&&!/^[a-z][a-z\d+.-]*:/i.test(e.url)?e.url=he(e.url):e.url?.startsWith(`/`)&&(e.baseURL=new URL(he()).origin),e.headers.set(`X-Requested-With`,`XMLHttpRequest`);let t=ge();return Object.entries(t).forEach(([t,n])=>{e.headers.set(t,n)}),e}),_e.interceptors.response.use(e=>e,async e=>{let t=e.config;if(e.response?.status===419||e.response?.status===403&&!t._retry){t._retry=!0;try{return ve.clearToken(),t.headers[`X-CSRF-Token`]=await ve.refreshToken(),x(t)}catch(e){return console.error(`Failed to refresh CSRF token:`,e),Promise.reject(e)}}return Promise.reject(e)});function ye(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return null}}async function be(e,t={}){switch(e.type){case`clipboard`:await navigator.clipboard.writeText(e.value);break;case`http`:{if(e.confirm&&!confirm(e.confirm))return;let t=await fetch(e.url,{method:e.method||`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:e.body?JSON.stringify(e.body):void 0}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(n.message??`Request failed`);typeof n.redirect==`string`&&n.redirect&&xe(n.redirect);break}case`event`:if(e.confirm&&!confirm(e.confirm))return;window.dispatchEvent(new CustomEvent(e.name,{detail:{...e.detail??{},...t.trigger?{trigger:t.trigger}:{},...t.sourceEvent?{sourceEvent:t.sourceEvent}:{}}}));break;case`download`:{if(e.confirm&&!confirm(e.confirm))return;if(e.method&&e.method!==`GET`){let t=await _e.request({url:e.url,method:e.method,data:e.body,responseType:`blob`}),n=String(t.headers[`content-disposition`]??``),r=/filename\*?=(?:UTF-8'')?"?([^";]+)"?/i.exec(n),i=e.filename??(r?.[1]?decodeURIComponent(r[1]):`download`),a=URL.createObjectURL(t.data),o=document.createElement(`a`);o.href=a,o.download=i,document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(a);break}let t=document.createElement(`a`);t.href=e.url,t.download=e.filename??``,t.click();break}default:throw Error(`Unknown action type: ${e.type}`)}}function xe(e){window.dispatchEvent(new CustomEvent(`action:redirect`,{cancelable:!0,detail:{url:e}}))&&window.location.assign(e)}var Se={Neutral:`neutral`,Success:`success`,Warning:`warning`,Danger:`danger`,Info:`info`},Ce=Object.values(Se),we={Idle:`idle`,Loading:`loading`,Success:`success`,Error:`error`},Te=a`
  :host {
    display: contents;
  }
...
`,k=class extends l{constructor(...e){super(...e),this.icon=null,this.iconColor=null,this.href=null,this.disabled=!1,this.variant=Se.Neutral,this.checked=!1,this.active=!1,this.type=`button`,this.action=null,this.feedback=null,this.feedbackDuration=1e3,this.confirm=null,this.state=we.Idle,this.feedbackMessage=null,this.shortcut=null}renderShortcut(){return typeof this.shortcut==`string`?r`<craft-shortcut>${this.shortcut}</craft-shortcut>`:this.shortcut===null?c:r`<craft-shortcut
        ?alt="${this.shortcut.alt??!1}"
        ?shift="${this.shortcut.shift??!1}"
        >${this.shortcut.key}</craft-shortcut
      >`}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this)}setState(e,t={}){this.state=e,this.feedbackMessage=t.message??null,this.dispatchEvent(new CustomEvent(`action:change-state`,{bubbles:!0,composed:!0,detail:{state:e,actionType:ye(this.action)?.type,...t}}))}async handleEvent(e){if(this.disabled){e.preventDefault();return}let t=ye(this.action);if(e.type===`click`&&t){t.type===`http`&&this.setState(we.Loading);try{await be(t,{trigger:this,sourceEvent:e}),this.setState(we.Success,this.feedback?.success)}catch(e){this.setState(we.Error,{message:e.message,...this.feedback?.error||{}})}finally{setTimeout(()=>{this.setState(we.Idle)},this.feedbackDuration)}}}renderCheckbox(){return r`<span class="action-item__check">
      <slot name="checkmark">
        ${this.checked?r`<craft-icon name="check"></craft-icon>`:c}
      </slot>
    </span>`}renderIcon(){switch(this.state){case we.Loading:return r`<craft-spinner style="--size: 0.8em"></craft-spinner>`;case we.Success:return r`<craft-icon
          name="check"
          style="color: var(--c-color-success-on-normal)"
        ></craft-icon>`;case we.Error:return r`<craft-icon
          name="xmark"
    ...
    `],Ke._filterableItemsSelector=`craft-action-item, li, button`,p([g({attribute:!1})],Ke.prototype,`actions`,void 0),p([g()],Ke.prototype,`label`,void 0),p([g()],Ke.prototype,`icon`,void 0),p([g({type:Boolean,reflect:!0})],Ke.prototype,`disabled`,void 0),p([g({type:Boolean,reflect:!0})],Ke.prototype,`searchable`,void 0),p([fe({slot:`invoker`})],Ke.prototype,`invokerNodes`,void 0),p([fe({slot:`content`})],Ke.prototype,`contentNodes`,void 0),customElements.get(`craft-action-menu`)||customElements.define(`craft-action-menu`,Ke);var qe=a`
  :host {
    --color-start: red;
    --color-end: blue;
    --color-text: inherit;
...
`,Je=class extends l{constructor(...e){super(...e),this.label=null,this._gradientId=null}connectedCallback(){super.connectedCallback(),this._gradientId=`avatar-gradient-${Math.random().toString(36).slice(2,8)}`}text(){return this.label?this.label.split(` `).map(e=>e.charAt(0).toUpperCase()).join(``):`?`}render(){return r`
      <span class="avatar">
        <svg
          viewBox="0 0 100 100"
    ...
    `}};Je.styles=[qe],p([g()],Je.prototype,`label`,void 0),p([_()],Je.prototype,`_gradientId`,void 0),customElements.get(`craft-avatar`)||customElements.define(`craft-avatar`,Je);var Ye=[`red`,`orange`,`amber`,`yellow`,`lime`,`green`,`emerald`,`teal`,`cyan`,`sky`,`blue`,`indigo`,`violet`,`purple`,`fuchsia`,`pink`,`rose`,`white`,`gray`,`black`,`slate`],Xe={neutral:`slate`,accent:`blue`,info:`sky`,success:`emerald`,warning:`yellow`,danger:`red`},Ze={pending:`orange`,off:`red`,suspended:`red`,expired:`red`,disabled:`gray`,inactive:`gray`,on:`emerald`},Qe=e=>e.charAt(0).toUpperCase()+e.slice(1),$e={...Object.fromEntries(Ye.map(e=>[Qe(e),e])),...Object.fromEntries(Object.entries(Xe).map(([e,t])=>[Qe(e),t])),...Object.fromEntries(Object.entries(Ze).map(([e,t])=>[Qe(e),t]))},et=[...Ye],tt=class extends l{constructor(...e){super(...e),this.size=`md`,this.fill=`var(--c-color-fill-loud)`,this.label=null,this.appearance=ee.OutlineFill}getFill(){return et.includes(this.fill)||Ce.includes(this.fill)?`var(--c-color-${this.fill}-fill-loud)`:this.fill}getSize(){switch(this.size){case`md`:return`0.6em`;case`lg`:return`1em`;default:return this.size}}render(){return r`<span
      style="--fill: ${this.getFill()}; --size: ${this.getSize()}"
      aria-label="${this.label??c}"
      role="${this.label?`img`:c}"
      class="${S({indicator:!0,"indicator--outline":this.appearance===ee.Outline})}"
    ></span>`}};tt.styles=[de,a`
      :host {
        display: contents;
      }
    ...
    `],p([g()],tt.prototype,`size`,void 0),p([g({reflect:!0})],tt.prototype,`fill`,void 0),p([g()],tt.prototype,`label`,void 0),p([g({reflect:!0})],tt.prototype,`appearance`,void 0),customElements.get(`craft-indicator`)||customElements.define(`craft-indicator`,tt);var nt=a`
  :host {
    display: inline-flex;
  }
...
`,rt={Small:`small`,Medium:`medium`,Large:`large`};Object.values(rt);var it=class extends l{constructor(...e){super(...e),this.fill=$e.Gray,this.noPrefix=!1,this.size=rt.Medium}getFill(){return this.fill}willUpdate(e){e.has(`fill`)&&(this.dataset.color=this.getFill())}render(){return r`
      <span
        part="badge"
        class="${S({badge:!0,"badge--small":this.size===rt.Small,"badge--large":this.size===rt.Large})}"
      >
    ...
    `}};it.styles=[nt],p([g({reflect:!0})],it.prototype,`fill`,void 0),p([g({attribute:`no-prefix`,type:Boolean})],it.prototype,`noPrefix`,void 0),p([g()],it.prototype,`size`,void 0),customElements.get(`craft-badge`)||customElements.define(`craft-badge`,it);var at=class extends l{constructor(...e){super(...e),this.rel=`noreferrer noopener`}render(){return r`
  ...
  `,p([g({reflect:!0})],at.prototype,`href`,void 0),p([g()],at.prototype,`target`,void 0),p([g()],at.prototype,`rel`,void 0),customElements.get(`craft-breadcrumb-item`)||customElements.define(`craft-breadcrumb-item`,at);var ot=class{constructor(){this.__iconResolvers=new Map}addIconResolver(e,t){if(this.__iconResolvers.has(e))throw Error(`An icon resolver has already been registered for namespace: ${e}`);this.__iconResolvers.set(e,t)}removeIconResolver(e){this.__iconResolvers.delete(e)}resolveIcon(e,t,n){let r=this.__iconResolvers.get(e);if(r)return r(t,n);throw Error(`Could not find any icon resolver for namespace ${e}.`)}resolveIconForId(e){let t=e.split(`:`);if(t.length!==3)throw Error(`Incorrect iconId: ${e}. Format: <namespace>:<iconset>:<icon>`);return this.resolveIcon(t[0],t[1],t[2])}};function st(){if(!te.has(`@lion/ui::icons::0.x`)){let e=new ot;te.set(`@lion/ui::icons::0.x`,e)}return te.get(`@lion/ui::icons::0.x`)}var ct=ce(st),lt=class extends ue{constructor(e){if(super(e),this.it=c,e.type!==w.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===c||e==null)return this._t=void 0,this.it=e;if(e===o)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};lt.directiveName=`unsafeHTML`,lt.resultType=1;var ut=le(lt),dt=class extends lt{};dt.directiveName=`unsafeSVG`,dt.resultType=2;var ft=le(dt),pt=`craft`,mt=new Map;function ht(e,t){return`${e}/${t}`}function gt(e){let[t=`classic`,n=`regular`]=e.split(`/`);return{family:t,variant:n}}async function _t(e){try{let t=await fetch(e,{mode:`cors`});if(!t.ok)return c;let n=document.createElement(`div`);n.innerHTML=await t.text();let i=n.firstElementChild;return i?.tagName?.toLowerCase()===`svg`?(i.setAttribute(`fill`,`currentColor`),i.setAttribute(`part`,`svg`),r`${ft(i.outerHTML)}`):c}catch{return c}}function vt(e,t=`classic`,n=`regular`,r=`/vendor/craft/icons`){let i=`solid`,a=n,o=e.endsWith(`.svg`)?e.split(`.svg`)[0]:e;if(e.includes(`/`)){let[t,...n]=e.split(`/`);a=t??a,o=n.join(`/`)}return a===`thin`?i=`thin`:a===`light`?i=`light`:a===`regular`?i=`regular`:a===`solid`&&(i=`solid`),(t===`brands`||a===`brands`)&&(i=`brands`),(t===`custom-icons`||a===`custom-icons`)&&(i=`custom-icons`),`${r}/${i}/${o}.svg`}function yt(e){return(t,n,r)=>{let i=e(t,n,r);if(i===null)return c;let a=mt.get(i);return a||(a=_t(i),mt.set(i,a)),a.then(e=>(e===c&&mt.delete(i),e))}}var bt=yt(vt);function xt(e){ct.removeIconResolver(pt),ct.addIconResolver(pt,(t,n)=>{let{family:r,variant:i}=gt(t);return e(n,r,i)})}function St(e,t=`classic`,n=`regular`){return Promise.resolve(ct.resolveIcon(pt,ht(t,n),e))}xt(bt);var Ct=new WeakSet,wt=class extends l{constructor(...e){super(...e),d(this,Ct),this.appearance=`plain`,this._svg=c,this._hasSlottedContent=!1}connectedCallback(){super.connectedCallback(),this.appearance===`badge`&&!this.getAttribute(`data-color`)&&this.setAttribute(`data-color`,`warning`),this._hasSlottedContent=this.childElementCount>0}firstUpdated(){u(Ct,this,Dt).call(this)}updated(e){super.updated(e),(e.has(`name`)||e.has(`family`)||e.has(`variant`))&&u(Ct,this,Et).call(this),e.has(`label`)&&this.hasUpdated&&u(Ct,this,Dt).call(this)}_handleSlotChange(e){let t=e.target;this._hasSlottedContent=t.assignedElements({flatten:!0}).length>0}render(){return r`
...
`,kt=class extends l{constructor(...e){super(...e),this.label=O(`Breadcrumbs`),this.items=[],this.visibleItems=0,this.firstRender=!0}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}calculateBreadcrumbItemsWidth(){this.items=this.breadcrumbsElements.map((e,t)=>{let n=e.offsetWidth;return e.hasAttribute(`hidden`)&&(e.removeAttribute(`hidden`),n=e.offsetWidth,e.setAttribute(`hidden`,``)),{label:e.innerText,href:e.href,value:t.toString(),offsetWidth:n,isVisible:!0}})}async handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`craft-breadcrumb-item`);if(e.forEach((t,n)=>{let r=n===e.length-1,i=t.querySelector(`[slot="separator"]`);r?i?.hasAttribute(`data-default`)&&i.remove():i===null?t.append(this.getSeparator()):i.hasAttribute(`data-default`)&&i.replaceWith(this.getSeparator()),r?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)}),this.breadcrumbsElements.length===0){this.items=[],this.visibleItems=0;return}await Promise.all(this.breadcrumbsElements.map(e=>e.updateComplete)),this.calculateBreadcrumbItemsWidth(),this.visibleItems=0,this.adjustOverflow()}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{if(this.firstRender){this.firstRender=!1;return}this.adjustOverflow()}),this.resizeObserver.observe(this)}adjustOverflow(){}disconnectedCallback(){this.resizeObserver?.unobserve(this),super.disconnectedCallback()}render(){return r`
    ...
    `}};kt.styles=[Ot],p([y(`slot`)],kt.prototype,`defaultSlot`,void 0),p([y(`slot[name="separator"]`)],kt.prototype,`separatorSlot`,void 0),p([fe({selector:`craft-breadcrumb-item`})],kt.prototype,`breadcrumbsElements`,void 0),p([g()],kt.prototype,`label`,void 0),p([_()],kt.prototype,`items`,void 0),p([_()],kt.prototype,`visibleItems`,void 0),customElements.get(`craft-breadcrumbs`)||customElements.define(`craft-breadcrumbs`,kt);var At=a`
  :host {
...
`,Nt=class extends Ue(se(l)){static get properties(){return{invokerRelation:{type:String,attribute:`invoker-relation`}}}static get styles(){return[...super.styles,a`
        :host {
      ...
      `]}constructor(){super(),this.hasArrow=!1,this.invokerRelation=`description`}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];_defineOverlayConfig(){let e=super._defineOverlayConfig(),t=Ge({invokerRelation:this.invokerRelation});return{...e,...t,popperConfig:{...e.popperConfig||{},...t.popperConfig||{},modifiers:[...e.popperConfig?.modifiers||[],...t.popperConfig?.modifiers||[]]}}}},Pt=new WeakMap,Ft=new WeakMap,It=new WeakSet,Lt=class extends Nt{constructor(){super(),d(this,It),this.placement=`top`,this.trigger=`hover focus`,f(this,Pt,null),f(this,Ft,()=>{this.opened=!this.opened}),ne(this)}static get styles(){return[...super.styles,a`
        :host {
          display: contents;
        }
      ...
      `]}connectedCallback(){u(It,this,Rt).call(this),super.connectedCallback()}get _overlayInvokerNode(){if(this.for){let e=this.getRootNode();return typeof e.getElementById==`function`?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}_defineOverlayConfig(){let e={...super._defineOverlayConfig()};if(zt.call(u(It,this))||Bt.call(u(It,this)))delete e.visibilityTriggerFunction;else{let{visibilityTriggerFunction:t}=Ge({invokerRelation:this.invokerRelation,delayIn:200,delayOut:0});e.visibilityTriggerFunction=t}return{...e,popperConfig:{...e.popperConfig,strategy:`fixed`,placement:this.placement,modifiers:[...e.popperConfig?.modifiers??[],...ae()]}}}_setupOpenCloseListeners(){super._setupOpenCloseListeners(),zt.call(u(It,this))&&this._overlayInvokerNode?.addEventListener(`click`,m(Ft,this))}_teardownOpenCloseListeners(){super._teardownOpenCloseListeners(),this._overlayInvokerNode?.removeEventListener(`click`,m(Ft,this))}updated(e){super.updated(e),e.has(`for`)&&e.get(`for`)!==void 0&&this._overlayCtrl&&this._overlayCtrl.updateConfig({invokerNode:this._overlayInvokerNode})}async show(){this.opened=!0,await this.updateComplete}async hide(){this.opened=!1,await this.updateComplete}};function Rt(){if(m(Pt,this)?.isConnected)return;let e=document.createElement(`div`);e.slot=`content`,e.append(...Array.from(this.childNodes).filter(e=>!(e instanceof Element)||e.slot===``)),this.append(e),h(Pt,this,e)}function zt(){return this.trigger.split(` `).includes(`click`)}function Bt(){return this.trigger.split(` `).includes(`manual`)}p([g({reflect:!0})],Lt.prototype,`for`,void 0),p([g({reflect:!0})],Lt.prototype,`placement`,void 0),p([g({reflect:!0})],Lt.prototype,`trigger`,void 0),customElements.get(`craft-tooltip`)||customElements.define(`craft-tooltip`,Lt);var Vt=e=>e.key===` `||e.key===`Enter`,Ht=e=>e.key===` `,Ut=class extends De(l){static get properties(){return{active:{type:Boolean,reflect:!0},type:{type:String,reflect:!0}}}render(){return r` <div class="button-content"><slot></slot></div> `}static get styles(){return[a`
        :host {
          position: relative;
          display: inline-flex;
          box-sizing: border-box;
  ...
  `,e}var qt=class extends Wt{get _nativeButtonNode(){return Gt.get(this._form)?.helper||null}constructor(){super(),this.type=`submit`,this.__implicitSubmitHelperButton=null}_setupSubmitAndResetHelperOnConnected(){if(super._setupSubmitAndResetHelperOnConnected(),!this._form||this.type!==`submit`)return;let e=this._form;if(!Gt.get(this._form)){let t=Kt(),n=document.createElement(`div`);n.appendChild(t),Gt.set(this._form,{lionButtons:new Set,helper:t,observer:new MutationObserver(()=>{e.appendChild(n)})}),e.appendChild(n),Gt.get(e)?.observer.observe(n,{childList:!0})}Gt.get(e)?.lionButtons.add(this)}_teardownSubmitAndResetHelperOnDisconnected(){if(super._teardownSubmitAndResetHelperOnDisconnected(),this._form){let e=Gt.get(this._form);e&&(e.lionButtons.delete(this),e.lionButtons.size||(this._form.contains(e.helper)&&e.helper.remove(),Gt.get(this._form)?.observer.disconnect(),Gt.delete(this._form)))}}},Jt=a`
  :host {
...
`,Xt=new WeakMap,Zt=class extends l{constructor(...e){super(...e),this.label=O(`More Info`),this.icon=`circle-info`,this.disabled=!1,this.status=``,f(this,Xt,new AbortController)}connectedCallback(){super.connectedCallback(),m(Xt,this).signal.aborted&&h(Xt,this,new AbortController),this.id||=`info-icon-${Math.random().toString(36).slice(2,8)}`;let{signal:e}=m(Xt,this);this.addEventListener(`craft-show`,()=>{Qt._&&Qt._!==this&&Qt._.renderRoot.querySelector(`craft-tooltip`)?.hide(),Qt._=this},{signal:e}),this.addEventListener(`craft-after-show`,()=>{this.status=``,setTimeout(()=>{this.status=`Some new status`},200)},{signal:e}),this.addEventListener(`craft-after-hide`,()=>{Qt._===this&&(Qt._=null),this.status=``},{signal:e})}disconnectedCallback(){Qt._===this&&(Qt._=null),m(Xt,this).abort(),super.disconnectedCallback()}render(){return r`
  ...
  `;var Qt={_:null};p([g()],Zt.prototype,`label`,void 0),p([g()],Zt.prototype,`icon`,void 0),p([g({type:Boolean,reflect:!0})],Zt.prototype,`disabled`,void 0),p([g()],Zt.prototype,`id`,void 0),p([_()],Zt.prototype,`status`,void 0),p([y(`craft-tooltip`)],Zt.prototype,`tooltip`,void 0),customElements.get(`craft-info-icon`)||customElements.define(`craft-info-icon`,Zt);var $t=class extends l{constructor(...e){super(...e),this.debug=!1}render(){return r`<slot></slot>`}};$t.styles=a`
    :host(:not([debug])) {
      position: absolute;
      width: 1px;
      height: 1px;
  ...
  `,p([g({type:Boolean,reflect:!0})],$t.prototype,`debug`,void 0),customElements.get(`craft-visually-hidden`)||customElements.define(`craft-visually-hidden`,$t);var en=class extends l{constructor(...e){super(...e),this.visible=!0}show(){this.visible=!0,this.dispatchEvent(new CustomEvent(`show`))}hide(){this.visible=!1,this.dispatchEvent(new CustomEvent(`hide`))}focus(){this.wrapper?.focus()}render(){return r`
      <div
        tabindex="-1"
    ...
    `}};en.styles=[Mt,Yt],p([g({reflect:!0,type:Boolean})],en.prototype,`visible`,void 0),p([y(`.wrapper`)],en.prototype,`wrapper`,void 0),customElements.get(`craft-spinner`)||customElements.define(`craft-spinner`,en);var tn=Object.prototype.toString;function nn(e){return typeof e==`function`||tn.call(e)===`[object Function]`}function rn(e){var t=Number(e);return isNaN(t)?0:t===0||!isFinite(t)?t:(t>0?1:-1)*Math.floor(Math.abs(t))}var an=2**53-1;function on(e){var t=rn(e);return Math.min(Math.max(t,0),an)}function sn(e,t){var n=Array,r=Object(e);if(e==null)throw TypeError(`Array.from requires an array-like object - not null or undefined`);if(t!==void 0&&!nn(t))throw TypeError(`Array.from: when provided, the second argument must be a function`);for(var i=on(r.length),a=nn(n)?Object(new n(i)):Array(i),o=0,s;o<i;)s=r[o],t?a[o]=t(s,o):a[o]=s,o+=1;return a.length=i,a}function cn(e){"@babel/helpers - typeof";return cn=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},cn(e)}function ln(e,t){if(!(e instanceof t))throw TypeError(`Cannot call a class as a function`)}function un(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,`value`in r&&(r.writable=!0),Object.defineProperty(e,pn(r.key),r)}}function dn(e,t,n){return t&&un(e.prototype,t),n&&un(e,n),Object.defineProperty(e,"prototype",{writable:!1}),e}function fn(e,t,n){return t=pn(t),t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function pn(e){var t=mn(e,`string`);return cn(t)==`symbol`?t:t+``}function mn(e,t){if(cn(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(cn(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}var hn=typeof Set>`u`?Set:function(){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[];ln(this,e),fn(this,`items`,void 0),this.items=t}return dn(e,[{key:`add`,value:function(e){return this.has(e)===!1&&this.items.push(e),this}},{key:`clear`,value:function(){this.items=[]}},{key:`delete`,value:function(e){var t=this.items.length;return this.items=this.items.filter(function(t){return t!==e}),t!==this.items.length}},{key:`forEach`,value:function(e){var t=this;this.items.forEach(function(n){e(n,n,t)})}},{key:`has`,value:function(e){return this.items.indexOf(e)!==-1}},{key:`size`,get:function(){return this.items.length}}])}();function gn(e){return e.localName??e.tagName.toLowerCase()}var _n={article:`article`,aside:`complementary`,button:`button`,datalist:`listbox`,dd:`definition`,details:`group`,dialog:`dialog`,dt:`term`,fieldset:`group`,figure:`figure`,form:`form`,footer:`contentinfo`,h1:`heading`,h2:`heading`,h3:`heading`,h4:`heading`,h5:`heading`,h6:`heading`,header:`banner`,hr:`separator`,html:`document`,legend:`legend`,li:`listitem`,math:`math`,main:`main`,menu:`list`,nav:`navigation`,ol:`list`,optgroup:`group`,option:`option`,output:`status`,progress:`progressbar`,section:`region`,summary:`button`,table:`table`,tbody:`rowgroup`,textarea:`textbox`,tfoot:`rowgroup`,td:`cell`,th:`columnheader`,thead:`rowgroup`,tr:`row`,ul:`list`},vn={caption:new Set([`aria-label`,`aria-labelledby`]),code:new Set([`aria-label`,`aria-labelledby`]),deletion:new Set([`aria-label`,`aria-labelledby`]),emphasis:new Set([`aria-label`,`aria-labelledby`]),generic:new Set([`aria-label`,`aria-labelledby`,`aria-roledescription`]),insertion:new Set([`aria-label`,`aria-labelledby`]),none:new Set([`aria-label`,`aria-labelledby`]),paragraph:new Set([`aria-label`,`aria-labelledby`]),presentation:new Set([`aria-label`,`aria-labelledby`]),strong:new Set([`aria-label`,`aria-labelledby`]),subscript:new Set([`aria-label`,`aria-labelledby`]),superscript:new Set([`aria-label`,`aria-labelledby`])};function yn(e,t){return[`aria-atomic`,`aria-busy`,`aria-controls`,`aria-current`,`aria-description`,`aria-describedby`,`aria-details`,`aria-dropeffect`,`aria-flowto`,`aria-grabbed`,`aria-hidden`,`aria-keyshortcuts`,`aria-label`,`aria-labelledby`,`aria-live`,`aria-owns`,`aria-relevant`,`aria-roledescription`].some(function(n){var r;return e.hasAttribute(n)&&!((r=vn[t])!=null&&r.has(n))})}function bn(e,t){return yn(e,t)}function xn(e){var t=Cn(e);if(t===null||wn.indexOf(t)!==-1){var n=Sn(e);if(wn.indexOf(t||``)===-1||bn(e,n||``))return n}return t}function Sn(e){var t=_n[gn(e)];if(t!==void 0)return t;switch(gn(e)){case`a`:case`area`:case`link`:if(e.hasAttribute(`href`))return`link`;break;case`img`:return e.getAttribute(`alt`)===``&&!bn(e,`img`)?`presentation`:`img`;case`input`:var n=e.type;switch(n){case`button`:case`image`:case`reset`:case`submit`:return`button`;case`checkbox`:case`radio`:return n;case`range`:return`slider`;case`email`:case`tel`:case`text`:case`url`:return e.hasAttribute(`list`)?`combobox`:`textbox`;case`search`:return e.hasAttribute(`list`)?`combobox`:`searchbox`;case`number`:return`spinbutton`;default:return null}case`select`:return e.hasAttribute(`multiple`)||e.size>1?`listbox`:`combobox`}return null}function Cn(e){var t=e.getAttribute(`role`);if(t!==null){var n=t.trim().split(` `)[0];if(n.length>0)return n}return null}var wn=[`presentation`,`none`];function A(e){return e!==null&&e.nodeType===e.ELEMENT_NODE}function Tn(e){return A(e)&&gn(e)===`caption`}function En(e){return A(e)&&gn(e)===`input`}function Dn(e){return A(e)&&gn(e)===`optgroup`}function On(e){return A(e)&&gn(e)===`select`}function kn(e){return A(e)&&gn(e)===`table`}function An(e){return A(e)&&gn(e)===`textarea`}function jn(e){var t=(e.ownerDocument===null?e:e.ownerDocument).defaultView;if(t===null)throw TypeError(`no window available`);return t}function Mn(e){return A(e)&&gn(e)===`fieldset`}function Nn(e){return A(e)&&gn(e)===`legend`}function Pn(e){return A(e)&&gn(e)===`slot`}function Fn(e){return A(e)&&e.ownerSVGElement!==void 0}function In(e){return A(e)&&gn(e)===`svg`}function Ln(e){return Fn(e)&&gn(e)===`title`}function Rn(e,t){if(A(e)&&e.hasAttribute(t)){var n=e.getAttribute(t).split(` `),r=e.getRootNode?e.getRootNode():e.ownerDocument;return n.map(function(e){return r.getElementById(e)}).filter(function(e){return e!==null})}return[]}function zn(e,t){return A(e)?t.indexOf(xn(e))!==-1:!1}function Bn(e){return e.trim().replace(/\s\s+/g,` `)}function Vn(e,t){if(!A(e))return!1;if(e.hasAttribute(`hidden`)||e.getAttribute(`aria-hidden`)===`true`)return!0;var n=t(e);return n.getPropertyValue(`display`)===`none`||n.getPropertyValue(`visibility`)===`hidden`}function Hn(e){return zn(e,[`button`,`combobox`,`listbox`,`textbox`])||Un(e,`range`)}function Un(e,t){if(!A(e))return!1;switch(t){case`range`:return zn(e,[`meter`,`progressbar`,`scrollbar`,`slider`,`spinbutton`]);default:throw TypeError(`No knowledge about abstract role '${t}'. This is likely a bug :(`)}}function Wn(e,t){var n=sn(e.querySelectorAll(t));return Rn(e,`aria-owns`).forEach(function(e){n.push.apply(n,sn(e.querySelectorAll(t)))}),n}function Gn(e){return On(e)?e.selectedOptions||Wn(e,`[selected]`):Wn(e,`[aria-selected="true"]`)}function Kn(e){return zn(e,wn)}function qn(e){return Tn(e)}function Jn(e){return zn(e,[`button`,`cell`,`checkbox`,`columnheader`,`gridcell`,`heading`,`label`,`legend`,`link`,`menuitem`,`menuitemcheckbox`,`menuitemradio`,`option`,`radio`,`row`,`rowheader`,`switch`,`tab`,`tooltip`,`treeitem`])}function Yn(e){return!1}function Xn(e){return En(e)||An(e)?e.value:e.textContent||``}function Zn(e){var t=e.getPropertyValue(`content`);return/^["'].*["']$/.test(t)?t.slice(1,-1):``}function Qn(e){var t=gn(e);return t===`button`||t===`input`&&e.getAttribute(`type`)!==`hidden`||t===`meter`||t===`output`||t===`progress`||t===`select`||t===`textarea`}function $n(e){if(Qn(e))return e;var t=null;return e.childNodes.forEach(function(e){if(t===null&&A(e)){var n=$n(e);n!==null&&(t=n)}}),t}function er(e){if(e.control!==void 0)return e.control;var t=e.getAttribute(`for`);return t===null?$n(e):e.ownerDocument.getElementById(t)}function tr(e){var t=e.labels;if(t===null)return t;if(t!==void 0)return sn(t);if(!Qn(e))return null;var n=e.ownerDocument;return sn(n.querySelectorAll(`label`)).filter(function(t){return er(t)===e})}function nr(e){var t=e.assignedNodes();return t.length===0?sn(e.childNodes):t}function rr(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=new hn,r=typeof Map>`u`?void 0:new Map,i=jn(e),a=t.compute,o=a===void 0?`name`:a,s=t.computedStyleSupportsPseudoElements,c=s===void 0?t.getComputedStyle!==void 0:s,l=t.getComputedStyle,u=l===void 0?i.getComputedStyle.bind(i):l,d=t.hidden,f=d!==void 0&&d,p=function(e,t){if(t!==void 0)throw Error(`use uncachedGetComputedStyle directly for pseudo elements`);if(r===void 0)return u(e);var n=r.get(e);if(n)return n;var i=u(e,t);return r.set(e,i),i};function m(e,t){var n=``;if(A(e)&&c&&(n=`${Zn(u(e,`::before`))} ${n}`),(Pn(e)?nr(e):sn(e.childNodes).concat(Rn(e,`aria-owns`))).forEach(function(e){var r=v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0}),i=(A(e)?p(e).getPropertyValue(`display`):`inline`)===`inline`?``:` `;n+=`${i}${r}${i}`}),A(e)&&c){var r=Zn(u(e,`::after`));n=`${n} ${r}`}return n.trim()}function h(e,t){var r=e.getAttributeNode(t);return r!==null&&!n.has(r)&&r.value.trim()!==``?(n.add(r),r.value):null}function g(e){return A(e)?h(e,`title`):null}function _(e){if(!A(e))return null;if(Mn(e)){n.add(e);for(var t=sn(e.childNodes),r=0;r<t.length;r+=1){var i=t[r];if(Nn(i))return v(i,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(kn(e)){n.add(e);for(var a=sn(e.childNodes),o=0;o<a.length;o+=1){var s=a[o];if(Tn(s))return v(s,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(In(e)){n.add(e);for(var c=sn(e.childNodes),l=0;l<c.length;l+=1){var u=c[l];if(Ln(u))return u.textContent}return null}else if(gn(e)===`img`||gn(e)===`area`){var d=h(e,`alt`);if(d!==null)return d}else if(Dn(e)){var f=h(e,`label`);if(f!==null)return f}if(En(e)&&(e.type===`button`||e.type===`submit`||e.type===`reset`)){var p=h(e,`value`);if(p!==null)return p;if(e.type===`submit`)return`Submit`;if(e.type===`reset`)return`Reset`}var g=tr(e);if(g!==null&&g.length!==0)return n.add(e),sn(g).map(function(e){return v(e,{isEmbeddedInLabel:!0,isReferenced:!1,recursion:!0})}).filter(function(e){return e.length>0}).join(` `);if(En(e)&&e.type===`image`){var _=h(e,`alt`);if(_!==null)return _;var y=h(e,`title`);return y===null?`Submit Query`:y}if(zn(e,[`button`])){var b=m(e,{isEmbeddedInLabel:!1,isReferenced:!1});if(b!==``)return b}return null}function v(e,t){if(n.has(e))return``;if(!f&&Vn(e,p)&&!t.isReferenced)return n.add(e),``;var r=A(e)?e.getAttributeNode(`aria-labelledby`):null,i=r!==null&&!n.has(r)?Rn(e,`aria-labelledby`):[];if(o===`name`&&!t.isReferenced&&i.length>0)return n.add(r),i.map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!0,recursion:!1})}).join(` `);var a=t.recursion&&Hn(e)&&o===`name`;if(!a){var s=(A(e)&&e.getAttribute(`aria-label`)||``).trim();if(s!==``&&o===`name`)return n.add(e),s;if(!Kn(e)){var c=_(e);if(c!==null)return n.add(e),c}}if(zn(e,[`menu`]))return n.add(e),``;if(a||t.isEmbeddedInLabel||t.isReferenced){if(zn(e,[`combobox`,`listbox`])){n.add(e);var l=Gn(e);return l.length===0?En(e)?e.value:``:sn(l).map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0})}).join(` `)}if(Un(e,`range`))return n.add(e),e.hasAttribute(`aria-valuetext`)?e.getAttribute(`aria-valuetext`):e.hasAttribute(`aria-valuenow`)?e.getAttribute(`aria-valuenow`):e.getAttribute(`value`)||``;if(zn(e,[`textbox`]))return n.add(e),Xn(e)}if(Jn(e)||A(e)&&t.isReferenced||qn(e)||Yn(e)){var u=m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});if(u!==``)return n.add(e),u}if(e.nodeType===e.TEXT_NODE)return n.add(e),e.textContent||``;if(t.recursion)return n.add(e),m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});var d=g(e);return d===null?(n.add(e),``):(n.add(e),d)}return Bn(v(e,{isEmbeddedInLabel:!1,isReferenced:o===`description`,recursion:!1}))}function ir(e){return zn(e,[`caption`,`code`,`deletion`,`emphasis`,`generic`,`insertion`,`none`,`paragraph`,`presentation`,`strong`,`subscript`,`superscript`])}function ar(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return ir(e)?``:rr(e,t)}var or={Primary:`primary`,Danger:`danger`,DangerPlain:`danger-plain`,Solid:`solid`,Fill:`fill`,Outline:`outline`,Dashed:`dashed`,Plain:`plain`,Link:`link`,None:`none`},sr=new WeakMap,cr=new WeakMap,lr=new WeakSet,ur=new WeakMap,j=class extends qt{static get styles(){return[...super.styles,Mt,Jt]}constructor(){super(),d(this,lr),f(this,sr,async e=>{let t=ye(this.action);if(!(!t||this.disabled)){e.preventDefault(),t.type===`http`&&(this.loading=!0);try{await be(t,{trigger:this,sourceEvent:e})}finally{this.loading=!1}}}),f(this,cr,e=>{!this.toggle||this.disabled||this.loading||this.dispatchEvent(new CustomEvent(`craft-toggle`,{bubbles:!0,composed:!0,cancelable:!0,detail:{active:!this.active,sourceEvent:e}}))}),this.variant=or.Fill,this.inherit=!1,this.size=`medium`,this.active=!1,this.toggle=!1,this.loading=!1,this.align=`center`,this.icon=null,this.action=null,this.href=null,this.target=null,this.rel=null,this.download=null,this.iconPosition=`prefix`,this._hasAccessibilityError=!1,f(this,ur,null),this.linkHostStateApplied=!1,this.originalType=null,this.announcementTimer=null,this.type=`button`}connectedCallback(){this.href&&!this.disabled&&(this.originalType=this.type,this.type=`button`,this.setAttribute(`role`,`presentation`),this.linkHostStateApplied=!0),super.connectedCallback(),this.syncLinkHostState(),this.addEventListener(`click`,m(sr,this)),this.addEventListener(`click`,m(cr,this)),this.hasUpdated&&!this.accessibleName&&u(lr,this,dr).call(this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(sr,this)),this.removeEventListener(`click`,m(cr,this)),u(lr,this,mr).call(this),this.announcementTimer&&=(clearTimeout(this.announcementTimer),null)}updated(e){super.updated(e),(e.has(`href`)||e.has(`disabled`))&&this.syncLinkHostState(),this.toggle&&(e.has(`active`)||e.has(`toggle`))&&this.setAttribute(`aria-pressed`,String(this.active)),e.has(`loading`)&&this.loading&&this.announceLoading()}announceLoading(){this.liveRegion.textContent=O(`Loading`),this.announcementTimer&&clearTimeout(this.announcementTimer),this.announcementTimer=setTimeout(()=>{this.liveRegion.textContent=``},5e3)}syncLinkHostState(){this.isLink?(this.linkHostStateApplied||(this.originalType=this.type),this.setAttribute(`role`,`presentation`),this.tabIndex=-1,this.type=`button`,this.linkHostStateApplied=!0):this.linkHostStateApplied&&=(this.setAttribute(`role`,`button`),this.type=this.originalType??`button`,this.disabled||(this.tabIndex=0),!1)}async firstUpdated(e){super.firstUpdated(e),await this.updateComplete;let t=this.querySelectorAll(`craft-icon, craft-spinner`);await Promise.all(Array.from(t).map(e=>e.updateComplete)),u(lr,this,dr).call(this)}get isLink(){return!!this.href&&!this.disabled}get computedRel(){if(this.target===`_blank`){let e=new Set((this.rel??``).split(/\s+/).filter(Boolean));return e.add(`noopener`),Array.from(e).join(` `)}return this.rel}render(){let e=r`
      <div
    ...
    `;return this.isLink?r`
        <a
          ...
          >${e}</a
        >
      `:e}};function dr(){if(!this.accessibleName){let e=this.isLink?this.shadowRoot?.querySelector(`a.link`)??this:this;this.accessibleName=ar(e)}let e=!this.accessibleName||this.accessibleName.trim()===``;if(e&&!u(lr,this,fr).call(this)){u(lr,this,pr).call(this);return}this._hasAccessibilityError=e}function fr(){return typeof this.checkVisibility==`function`?this.checkVisibility({visibilityProperty:!0}):this.getClientRects().length>0}function pr(){m(ur,this)||typeof ResizeObserver>`u`||(h(ur,this,new ResizeObserver(()=>{u(lr,this,fr).call(this)&&(u(lr,this,mr).call(this),u(lr,this,dr).call(this))})),m(ur,this).observe(this))}function mr(){m(ur,this)?.disconnect(),h(ur,this,null)}p([g({attribute:`accessible-name`})],j.prototype,`accessibleName`,void 0),p([g({reflect:!0})],j.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],j.prototype,`inherit`,void 0),p([g({reflect:!0})],j.prototype,`size`,void 0),p([g({reflect:!0})],j.prototype,`value`,void 0),p([g({reflect:!0,type:Boolean})],j.prototype,`active`,void 0),p([g({type:Boolean,reflect:!0})],j.prototype,`toggle`,void 0),p([g({reflect:!0,type:Boolean})],j.prototype,`loading`,void 0),p([g()],j.prototype,`align`,void 0),p([g()],j.prototype,`icon`,void 0),p([g({type:Object})],j.prototype,`action`,void 0),p([g({reflect:!0})],j.prototype,`href`,void 0),p([g()],j.prototype,`target`,void 0),p([g()],j.prototype,`rel`,void 0),p([g()],j.prototype,`download`,void 0),p([g({attribute:`icon-position`})],j.prototype,`iconPosition`,void 0),p([y(`[data-live-region]`)],j.prototype,`liveRegion`,void 0),p([_()],j.prototype,`_hasAccessibilityError`,void 0),customElements.get(`craft-button`)||customElements.define(`craft-button`,j);var hr=[`sm`,`md`,`lg`,`xl`];function gr(e){return!isNaN(parseFloat(String(e)))&&isFinite(Number(e))}function _r(e){if(e!=null&&e!==``)return e===0||e===`0`||e===`none`?`0`:gr(e)?`calc(${e}rem / 16)`:hr.includes(e)?`var(--c-spacing-${e})`:String(e)}var vr=(e,{customProperty:t,defaultValue:n})=>{let r=Array.isArray(t)?t:[t];class i extends e{constructor(...e){super(...e),this.padding=n}get resolvedPadding(){return _r(this.padding)}get paddingStyles(){let e=this.resolvedPadding;return e===void 0?{}:Object.fromEntries(r.map(t=>[t,e]))}}return p([g()],i.prototype,`padding`,void 0),i},yr=a`
  :host {
    display: contents;
  }
...
`,br=class extends vr(l,{customProperty:[`--_callout-padding-block`,`--_callout-padding-inline`]}){constructor(...e){super(...e),this.variant=Se.Neutral,this.appearance=ee.OutlineFill,this.title=``,this.icon=null,this.hideIcon=!1,this.rounded=`all`,this.inline=!1,this.size=`auto`,this.resolvedIcon=null}willUpdate(){this.resolvedIcon=this.icon??this.getDefaultIcon()}getDefaultIcon(){switch(this.variant){case Se.Info:return`lightbulb`;case Se.Success:return`circle-check`;case Se.Warning:return`circle-exclamation`;case Se.Danger:return`triangle-exclamation`;default:return null}}render(){let e=this.title||!!this.querySelector(`[slot="title"]`),t=!this.hideIcon&&(!!this.resolvedIcon||!!this.querySelector(`[slot="icon"]`));return r`
      <div
        data-variant="${this.variant}"
        style="${oe(this.paddingStyles)}"
    ...
    `}};br.styles=[de,yr],p([g({reflect:!0})],br.prototype,`variant`,void 0),p([g({reflect:!0})],br.prototype,`appearance`,void 0),p([g()],br.prototype,`title`,void 0),p([g()],br.prototype,`icon`,void 0),p([g({type:Boolean,attribute:`hide-icon`})],br.prototype,`hideIcon`,void 0),p([g({reflect:!0})],br.prototype,`rounded`,void 0),p([g({reflect:!0,type:Boolean})],br.prototype,`inline`,void 0),p([g()],br.prototype,`size`,void 0),p([_()],br.prototype,`resolvedIcon`,void 0),customElements.get(`craft-callout`)||customElements.define(`craft-callout`,br);var xr=a`
  :host {
    display: block;
  }
...
`,Sr=class extends l{constructor(...e){super(...e),this.label=``,this.active=!1,this.showThumb=!0,this.thumbAlignment=`start`,this._hasThumbnail=!1,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasSlottedHeader=!!this.querySelector(`:scope > [slot="header"]`)||!!this.querySelector(`:scope > [slot="label"]`)||!!this.querySelector(`:scope > [slot="actions"]`),this._hasSlottedFooter=!!this.querySelector(`:scope > [slot="footer"]`),this._hasThumbnail=!!this.querySelector(`:scope > [slot="thumbnail"]`)}_handleThumbnailSlotChange(e){let t=e.target;this._hasThumbnail=t.assignedElements({flatten:!0}).length>0}render(){let e=!!this.label||this._hasSlottedHeader,t=this._hasSlottedFooter,n=this.showThumb&&this._hasThumbnail;return r`
    ...
    `}};Sr.styles=[xr],p([g()],Sr.prototype,`label`,void 0),p([g({type:Boolean,reflect:!0})],Sr.prototype,`active`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],Sr.prototype,`showThumb`,void 0),p([g({attribute:`thumb-alignment`})],Sr.prototype,`thumbAlignment`,void 0),p([_()],Sr.prototype,`_hasThumbnail`,void 0),p([_()],Sr.prototype,`_hasSlottedHeader`,void 0),p([_()],Sr.prototype,`_hasSlottedFooter`,void 0),customElements.get(`craft-card`)||customElements.define(`craft-card`,Sr);var Cr=a`
...
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=gi()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return gi()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(i(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),vi=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function yi(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return vi.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var bi=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},xi=D(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),Si=D(e=>class extends xi(Ee(Ve(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=He(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...yi(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return r`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof bi&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&(typeof t!=`boolean`||t!==!1)}static get styles(){return[a`
          /**********************
            {block} .form-field
           ********************/
        ...
        `]}_getAriaDescriptionElements(){return[this._helpTextNode,this._feedbackNode]}addToAriaLabelledBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaLabelledNodes.includes(e)||(this._ariaLabelledNodes=[...this._ariaLabelledNodes,e],this.__reorderAriaLabelledNodes=!!n)}removeFromAriaLabelledBy(e){this._ariaLabelledNodes.includes(e)&&(this._ariaLabelledNodes.splice(this._ariaLabelledNodes.indexOf(e),1),this._ariaLabelledNodes=[...this._ariaLabelledNodes],this.__reorderAriaLabelledNodes=!1)}addToAriaDescribedBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaDescribedNodes.includes(e)||(this._ariaDescribedNodes=[...this._ariaDescribedNodes,e],this.__reorderAriaDescribedNodes=!!n)}removeFromAriaDescribedBy(e){this._ariaDescribedNodes.includes(e)&&(this._ariaDescribedNodes.splice(this._ariaDescribedNodes.indexOf(e),1),this._ariaDescribedNodes=[...this._ariaDescribedNodes],this.__reorderAriaLabelledNodes=!1)}__getDirectSlotChild(e){return Array.from(this.children).find(t=>t.slot===e)}_dispatchInitialModelValueChangedEvent(){this._repropagationRole!==`child`&&(this.__repropagateChildrenInitialized=!0,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],initialize:!0,isTriggeredByUser:!1}})))}_onBeforeRepropagateChildrenValues(e){}__repropagateChildrenValues(e){this._onBeforeRepropagateChildrenValues(e);let t=e.detail&&e.detail.element||e.target,n=this._isRepropagationEndpoint||this._repropagationRole===`choice-group`;if(t===this)return;e.stopImmediatePropagation();let r=this._repropagationRole!==`child`&&!this.__repropagateChildrenInitialized,i=e.detail&&e.detail.initialize;if(r||i||!this._repropagationCondition(t))return;let a=[];n||(a=e.detail&&e.detail.formPath||[t]);let o=[...a,this];this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:o,isTriggeredByUser:!!e.detail?.isTriggeredByUser}}))}_repropagationCondition(e){return!!e}_onLabelClick(){}}),Ci=class{constructor(){this.__running=!1,this.__queue=[]}add(e){this.__queue.push(e),this.__running||(this.complete=new Promise(e=>{this.__callComplete=e}),this.__run())}async __run(){this.__running=!0,await this.__queue[0](),this.__queue.shift(),this.__queue.length>0?this.__run():(this.__running=!1,this.__callComplete&&this.__callComplete())}};function wi(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Ti=D(e=>class extends e{constructor(){super(),this.__SyncUpdatableNamespace={}}firstUpdated(e){super.firstUpdated(e),this.__syncUpdatableInitialize()}connectedCallback(){super.connectedCallback(),this.__SyncUpdatableNamespace.connected=!0}disconnectedCallback(){super.disconnectedCallback(),this.__SyncUpdatableNamespace.connected=!1}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];static __syncUpdatableHasChanged(e,t,n){let r=this.elementProperties;return r.get(e)&&r.get(e).hasChanged?r.get(e).hasChanged(t,n):t!==n}__syncUpdatableInitialize(){let e=this.__SyncUpdatableNamespace,t=this.constructor;e.initialized=!0,e.queue&&Array.from(e.queue).forEach(e=>{t.__syncUpdatableHasChanged(e,this[e],void 0)&&this.updateSync(e,void 0)})}requestUpdate(e,t,n){if(super.requestUpdate(e,t,n),e===void 0)return;this.__SyncUpdatableNamespace=this.__SyncUpdatableNamespace||{};let r=this.__SyncUpdatableNamespace,i=this.constructor;r.initialized?i.__syncUpdatableHasChanged(e,this[e],t)&&this.updateSync(e,t):(r.queue=r.queue||new Set,r.queue.add(e))}updateSync(e,t){}}),Ei=e=>{switch(e){case`bg-BG`:return T(()=>import(`./bg-BG-BSOJu8wp.js`),__vite__mapDeps([0,1]),import.meta.url);case`bg`:return T(()=>import(`./bg-tT2-9j0y.js`),__vite__mapDeps([2,1]),import.meta.url);case`cs-CZ`:return T(()=>import(`./cs-CZ-BXYisR25.js`),__vite__mapDeps([3,4]),import.meta.url);case`cs`:return T(()=>import(`./cs-BWWtw9FR.js`),__vite__mapDeps([5,4]),import.meta.url);case`de-DE`:return T(()=>import(`./de-DE-CqA9yOdY.js`),__vite__mapDeps([6,7]),import.meta.url);case`de`:return T(()=>import(`./de-D2KzmuNN.js`),__vite__mapDeps([8,7]),import.meta.url);case`en-AU`:return T(()=>import(`./en-AU-ClGzkm9N.js`),__vite__mapDeps([9,10]),import.meta.url);case`en-GB`:return T(()=>import(`./en-GB-ClGzkm9N.js`),__vite__mapDeps([11,10]),import.meta.url);case`en-US`:return T(()=>import(`./en-US-ClGzkm9N.js`),__vite__mapDeps([12,10]),import.meta.url);case`en-PH`:case`en`:return T(()=>import(`./en-Bn2liEJW.js`),__vite__mapDeps([13,10]),import.meta.url);case`es-ES`:return T(()=>import(`./es-ES-lc8truAL.js`),__vite__mapDeps([14,15]),import.meta.url);case`es`:return T(()=>import(`./es-BHRFfW-v.js`),__vite__mapDeps([16,15]),import.meta.url);case`fr-FR`:return T(()=>import(`./fr-FR-BFPCNFnr.js`),__vite__mapDeps([17,18]),import.meta.url);case`fr-BE`:return T(()=>import(`./fr-BE-BFPCNFnr.js`),__vite__mapDeps([19,18]),import.meta.url);case`fr`:return T(()=>import(`./fr-BatdFrY1.js`),__vite__mapDeps([20,18]),import.meta.url);case`hu-HU`:return T(()=>import(`./hu-HU-CgHBHfiG.js`),__vite__mapDeps([21,22]),import.meta.url);case`hu`:return T(()=>import(`./hu-BGJUkRn0.js`),__vite__mapDeps([23,22]),import.meta.url);case`it-IT`:return T(()=>import(`./it-IT-DXWt8Y3M.js`),__vite__mapDeps([24,25]),import.meta.url);case`it`:return T(()=>import(`./it-BbZB0zCO.js`),__vite__mapDeps([26,25]),import.meta.url);case`nl-BE`:return T(()=>import(`./nl-BE-CN9u7Cp2.js`),__vite__mapDeps([27,28]),import.meta.url);case`nl-NL`:return T(()=>import(`./nl-NL-CN9u7Cp2.js`),__vite__mapDeps([29,28]),import.meta.url);case`nl`:return T(()=>import(`./nl-CubSULoy.js`),__vite__mapDeps([30,28]),import.meta.url);case`pl-PL`:return T(()=>import(`./pl-PL-D0K_dWml.js`),__vite__mapDeps([31,32]),import.meta.url);case`pl`:return T(()=>import(`./pl-BhJlmndU.js`),__vite__mapDeps([33,32]),import.meta.url);case`ro-RO`:return T(()=>import(`./ro-RO-BXVNXH1J.js`),__vite__mapDeps([34,35]),import.meta.url);case`ro`:return T(()=>import(`./ro-75jeTe0N.js`),__vite__mapDeps([36,35]),import.meta.url);case`ru-RU`:return T(()=>import(`./ru-RU-BpGy32BK.js`),__vite__mapDeps([37,38]),import.meta.url);case`ru`:return T(()=>import(`./ru-DU7uFj2i.js`),__vite__mapDeps([39,38]),import.meta.url);case`sk-SK`:return T(()=>import(`./sk-SK-wewEOZGv.js`),__vite__mapDeps([40,41]),import.meta.url);case`sk`:return T(()=>import(`./sk-cN9_UHno.js`),__vite__mapDeps([42,41]),import.meta.url);case`tr-TR`:return T(()=>import(`./tr-TR-D1nJ_iYG.js`),__vite__mapDeps([43,44]),import.meta.url);case`tr`:return T(()=>import(`./tr-DuiqIpvR.js`),__vite__mapDeps([45,44]),import.meta.url);case`uk-UA`:return T(()=>import(`./uk-UA-DHqiIGvL.js`),__vite__mapDeps([46,47]),import.meta.url);case`uk`:return T(()=>import(`./uk-Cm-Wcqws.js`),__vite__mapDeps([48,47]),import.meta.url);case`zh-CN`:case`zh`:return T(()=>import(`./zh-DMe6SF13.js`),[],import.meta.url);default:return T(()=>import(`./en-Bn2liEJW.js`),__vite__mapDeps([13,10]),import.meta.url)}},Di=e=>`${e[0].toUpperCase()}${e.slice(1)}`,Oi=class extends di(l){static get properties(){return{feedbackData:{attribute:!1}}}static localizeNamespaces=[{"lion-form-core":Ei},...super.localizeNamespaces];static get styles(){return[a`
    ...
    `}_onRequestToAddFormElement(e){e.target.hasAttribute(`role`)||e.target?.setAttribute(`role`,`listitem`),this.__addToSubCheckboxes(e.detail.element),this._setOwnCheckedState()}_onRequestToRemoveFormElement(e){e.target.getAttribute(`role`)===`listitem`&&e.target?.removeAttribute(`role`),this.__removeFromSubCheckboxes(e.detail.element)}__addToSubCheckboxes(e){e!==this&&this.contains(e)&&this.__subCheckboxes.push(e)}__removeFromSubCheckboxes(e){let t=this.__subCheckboxes.indexOf(e);t!==-1&&this.__subCheckboxes.splice(t,1)}constructor(){super(),this.indeterminate=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this.__onModelValueChanged=this.__onModelValueChanged.bind(this),this.__subCheckboxes=[],this._indeterminateSubStates=[],this.mixedState=!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,this.__onModelValueChanged),this.addEventListener(`form-element-register`,this._onRequestToAddFormElement)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`model-value-changed`,this.__onModelValueChanged),this.removeEventListener(`form-element-register`,this._onRequestToAddFormElement)}firstUpdated(e){super.firstUpdated(e),this._setOldState(),this.indeterminate&&this._storeIndeterminateState()}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&(this._inputNode.indeterminate=this.indeterminate)}},Yi=class extends Gi{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="checkbox"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...Gi.styles,a`
      ...
      `]}};function $i(){let e=this.allMode===`single-value`&&this.checked;for(let t of this._subCheckboxes??[]){let n=t.querySelector(`:scope > input[slot="input"]`);n&&(e?n.name&&(n.dataset.governedName=n.name,n.removeAttribute(`name`)):n.dataset.governedName&&(n.name=n.dataset.governedName,delete n.dataset.governedName))}}p([g({reflect:!0,attribute:`all-mode`})],Qi.prototype,`allMode`,void 0),customElements.get(`craft-checkbox-indeterminate`)||customElements.define(`craft-checkbox-indeterminate`,Qi);var ea=class extends Xi(qi){constructor(...e){super(...e),this.__inputPatched=!1,this.indeterminate=!1}connectedCallback(){super.connectedCallback(),this.__patchSlottedInputProps()}updated(e){super.updated(e),this.__patchSlottedInputProps();let t=this._inputNode;t&&(t.indeterminate=this.indeterminate)}__patchSlottedInputProps(){if(this.__inputPatched)return;let e=this.__slottedInputElement();if(!e)return;this.__inputPatched=!0;let t=this;for(let n of[`checked`,`disabled`]){let r=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,n);if(!r?.get||!r.set)continue;let{get:i,set:a}=r;Object.defineProperty(e,n,{configurable:!0,enumerable:r.enumerable,get(){return i.call(this)},set(e){a.call(this,e),t[n]!==e&&(t[n]=e)}})}}__slottedInputElement(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}static get styles(){return[...qi.styles,Or,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],ea.prototype,`indeterminate`,void 0),customElements.get(`craft-checkbox`)||customElements.define(`craft-checkbox`,ea);var ta=new Map;async function na(e,t,n=!1){let r=[],i=[],a=()=>{for(let e of r)e.remove();i.forEach(e=>e())};if(!e)return a;let o=document.createElement(`template`);o.innerHTML=e.trim();try{for(let e of o.content.childNodes){let a=ia(e);if(a){let e=ta.get(a.key);if(e){e.references++,i.push(()=>ca(a.key,e)),e.loaded&&await sa(e.loaded,n);continue}if(aa(a))continue}let o=ra(e),s=a&&o instanceof HTMLScriptElement?oa(o,a.value):null;if(t.appendChild(o),a&&(o instanceof HTMLLinkElement||o instanceof HTMLScriptElement)){let e={node:o,loaded:s,references:1};ta.set(a.key,e),i.push(()=>ca(a.key,e))}else r.push(o);s&&await sa(s,n)}return a}catch(e){throw a(),e}}function ra(e){if(!(e instanceof HTMLScriptElement))return e.cloneNode(!0);let t=document.createElement(`script`);for(let n of e.attributes)t.setAttribute(n.name,n.value);return t.textContent=e.textContent,t.async=!1,t}function ia(e){return e instanceof HTMLLinkElement&&e.href?{key:`link:${e.href}`,selector:`link[href]`,value:e.href}:e instanceof HTMLScriptElement&&e.src?{key:`script:${e.src}`,selector:`script[src]`,value:e.src}:null}function aa(e){return Array.from(document.querySelectorAll(e.selector)).some(t=>(t instanceof HTMLLinkElement?t.href:t.src)===e.value)}function oa(e,t){return new Promise((n,r)=>{e.addEventListener(`load`,()=>n(),{once:!0}),e.addEventListener(`error`,()=>r(Error(`Failed to load asset [${t}].`)),{once:!0})})}async function sa(e,t){try{await e}catch(e){if(t)throw e}}function ca(e,t){t.references--,!(t.references>0)&&(t.node.remove(),ta.delete(e))}async function la(e){return na(e,document.head)}async function ua(e){return na(e,document.body)}function da(e){return typeof e.checkVisibility==`function`?e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}):e.offsetWidth>0||e.offsetHeight>0}function fa(e){return typeof e==`object`&&!!e&&`checked`in e&&typeof e.checked==`boolean`}function pa(e){return ma(e).toString()}function ma(e){let t=new URLSearchParams,n=e.querySelectorAll(`input[name], select[name], textarea[name]`);for(let e of n)if(!e.disabled&&!(e instanceof HTMLInputElement&&([`file`,`submit`,`button`,`reset`,`image`].includes(e.type)||(e.type===`checkbox`||e.type===`radio`)&&!e.checked))){if(e instanceof HTMLSelectElement&&e.multiple){for(let n of e.selectedOptions)t.append(e.name,n.value);continue}t.append(e.name,e.value)}for(let n of e.querySelectorAll(`*`)){if(!n.tagName.includes(`-`))continue;let e=n.name;if(typeof e!=`string`||e===``||n.disabled===!0||n.querySelector(`input[name], select[name], textarea[name]`))continue;if(fa(n.modelValue)){n.modelValue.checked&&t.append(e,String(n.modelValue.value??``));continue}let r=n.serializedValue??n.value;if(r!=null)if(Array.isArray(r))for(let n of r)t.append(e,String(n));else t.append(e,String(r))}return t}var ha={Á:`A`,á:`a`,Ä:`A`,ä:`a`,À:`A`,à:`a`,Â:`A`,â:`a`,É:`E`,é:`e`,Ë:`E`,ë:`e`,È:`E`,è:`e`,Ê:`E`,ê:`e`,Í:`I`,í:`i`,Ï:`I`,ï:`i`,Ì:`I`,ì:`i`,Î:`I`,î:`i`,Ó:`O`,ó:`o`,Ö:`O`,ö:`o`,Ò:`O`,ò:`o`,Ô:`O`,ô:`o`,Ú:`U`,ú:`u`,Ü:`U`,ü:`u`,Ù:`U`,ù:`u`,Û:`U`,û:`u`,Ý:`Y`,ý:`y`,Ÿ:`Y`,А:`A`,Б:`B`,В:`V`,Г:`G`,Д:`D`,Ѓ:`Gj`,Е:`E`,Ж:`Z`,З:`Z`,Ѕ:`Dz`,И:`I`,Ј:`j`,К:`K`,Л:`L`,Љ:`Lj`,М:`M`,Н:`N`,Њ:`Nj`,О:`O`,П:`P`,Р:`R`,С:`S`,Т:`T`,Ќ:`Kj`,У:`U`,Ф:`F`,Х:`X`,Ц:`C`,Ч:`C`,Џ:`Dz`,Ш:`S`,а:`a`,б:`b`,в:`v`,г:`g`,д:`d`,ѓ:`gj`,е:`e`,ж:`z`,з:`z`,ѕ:`dz`,и:`i`,ј:`j`,к:`k`,л:`l`,љ:`lj`,м:`m`,н:`n`,њ:`nj`,о:`o`,п:`p`,р:`r`,с:`s`,т:`t`,ќ:`kj`,у:`u`,ф:`f`,х:`x`,ц:`c`,ч:`c`,џ:`dz`,ш:`s`,æ:`ae`,ǽ:`ae`,Ã:`A`,Å:`A`,Ǻ:`A`,Ă:`A`,Ǎ:`A`,Æ:`AE`,Ǽ:`AE`,ã:`a`,å:`a`,ǻ:`a`,ă:`a`,ǎ:`a`,ª:`a`,Ĉ:`C`,Ċ:`C`,Ç:`C`,ç:`c`,ĉ:`c`,ċ:`c`,Ð:`D`,Đ:`D`,ð:`d`,đ:`d`,Ĕ:`E`,Ė:`E`,ĕ:`e`,ė:`e`,ƒ:`f`,Ĝ:`G`,Ġ:`G`,ĝ:`g`,ġ:`g`,Ĥ:`H`,Ħ:`H`,ĥ:`h`,ħ:`h`,Ĩ:`I`,Ĭ:`I`,Ǐ:`I`,Į:`I`,Ĳ:`IJ`,ĩ:`i`,ĭ:`i`,ǐ:`i`,į:`i`,ĳ:`ij`,Ĵ:`J`,ĵ:`j`,Ĺ:`L`,Ľ:`L`,Ŀ:`L`,ĺ:`l`,ľ:`l`,ŀ:`l`,Ñ:`N`,ñ:`n`,ŉ:`n`,Õ:`O`,Ō:`O`,Ŏ:`O`,Ǒ:`O`,Ő:`O`,Ơ:`O`,Ø:`O`,Ǿ:`O`,Œ:`OE`,õ:`o`,ō:`o`,ŏ:`o`,ǒ:`o`,ő:`o`,ơ:`o`,ø:`o`,ǿ:`o`,º:`o`,œ:`oe`,Ŕ:`R`,Ŗ:`R`,ŕ:`r`,ŗ:`r`,Ŝ:`S`,Ș:`S`,ŝ:`s`,ș:`s`,ſ:`s`,Ţ:`T`,Ț:`T`,Ŧ:`T`,Þ:`TH`,ţ:`t`,ț:`t`,ŧ:`t`,þ:`th`,Ũ:`U`,Ŭ:`U`,Ű:`U`,Ų:`U`,Ư:`U`,Ǔ:`U`,Ǖ:`U`,Ǘ:`U`,Ǚ:`U`,Ǜ:`U`,ũ:`u`,ŭ:`u`,ű:`u`,ų:`u`,ư:`u`,ǔ:`u`,ǖ:`u`,ǘ:`u`,ǚ:`u`,ǜ:`u`,Ŵ:`W`,ŵ:`w`,Ŷ:`Y`,ÿ:`y`,ŷ:`y`,ΑΥ:`AU`,ΑΎ:`AU`,Αυ:`Au`,Αύ:`Au`,ΕΊ:`I`,ΕΙ:`I`,Ει:`Ei`,ΕΥ:`EF`,ΕΎ:`EU`,Εί:`I`,Ευ:`Ef`,Εύ:`Eu`,ΟΙ:`I`,ΟΊ:`I`,ΟΥ:`U`,ΟΎ:`OU`,Οι:`Oi`,Οί:`I`,Ου:`Oy`,Ού:`Ou`,ΥΙ:`I`,ΎΙ:`I`,Υι:`Yi`,Ύι:`I`,ΥΊ:`I`,Υί:`I`,αυ:`au`,αύ:`au`,εί:`i`,ει:`ei`,ευ:`ef`,εύ:`eu`,οι:`oi`,οί:`i`,ου:`oy`,ού:`ou`,υι:`yi`,ύι:`i`,υί:`i`,Α:`A`,Ά:`A`,Β:`B`,Δ:`D`,Ε:`E`,Έ:`E`,Φ:`F`,Γ:`G`,Η:`H`,Ή:`I`,Ι:`I`,Ί:`I`,Ϊ:`I`,Κ:`K`,Ξ:`Ks`,Λ:`L`,Μ:`M`,Ν:`N`,Π:`P`,Ο:`O`,Ό:`O`,Ψ:`Ps`,Ρ:`R`,Σ:`S`,Τ:`T`,Θ:`Th`,Ω:`O`,Ώ:`W`,Χ:`X`,ϒ:`Y`,Υ:`Y`,Ύ:`Y`,Ϋ:`Y`,Ζ:`Z`,α:`a`,ά:`a`,β:`v`,δ:`d`,ε:`e`,έ:`e`,φ:`f`,γ:`gh`,η:`i`,ή:`i`,ι:`i`,ί:`i`,ϊ:`i`,ΐ:`i`,κ:`k`,ξ:`ks`,λ:`l`,μ:`m`,ν:`n`,ο:`o`,ό:`o`,π:`p`,ψ:`ps`,ρ:`r`,σ:`s`,ς:`s`,τ:`t`,ϑ:`th`,θ:`th`,ϐ:`v`,ω:`o`,ώ:`w`,χ:`kh`,υ:`i`,ύ:`y`,ΰ:`y`,ϋ:`y`,ζ:`z`,अ:`a`,आ:`aa`,ए:`e`,ई:`ii`,ऍ:`ei`,ऎ:`ae`,ऐ:`ai`,इ:`i`,ओ:`o`,ऑ:`oi`,ऒ:`oii`,ऊ:`uu`,औ:`ou`,उ:`u`,ब:`B`,भ:`Bha`,च:`Ca`,छ:`Chha`,ड:`Da`,ढ:`Dha`,फ:`Fa`,फ़:`Fi`,ग:`Ga`,घ:`Gha`,ग़:`Ghi`,ह:`Ha`,ज:`Ja`,झ:`Jha`,क:`Ka`,ख:`Kha`,ख़:`Khi`,ल:`L`,ळ:`Li`,ऌ:`Li`,ऴ:`Lii`,ॡ:`Lii`,म:`Ma`,न:`Na`,ङ:`Na`,ञ:`Nia`,ण:`Nae`,ऩ:`Ni`,ॐ:`oms`,प:`Pa`,क़:`Qi`,र:`Ra`,ऋ:`Ri`,ॠ:`Ri`,ऱ:`Ri`,स:`Sa`,श:`Sha`,ष:`Shha`,ट:`Ta`,त:`Ta`,ठ:`Tha`,द:`Tha`,थ:`Tha`,ध:`Thha`,ड़:`ugDha`,ढ़:`ugDhha`,व:`Va`,य:`Ya`,य़:`Yi`,ज़:`Za`,Ա:`A`,Բ:`B`,Գ:`G`,Դ:`D`,Ե:`E`,Զ:`Z`,Է:`E`,Ը:`Y`,Թ:`Th`,Ժ:`Zh`,Ի:`I`,Լ:`L`,Խ:`Kh`,Ծ:`Ts`,Կ:`K`,Հ:`H`,Ձ:`Dz`,Ղ:`Gh`,Ճ:`Tch`,Մ:`M`,Յ:`Y`,Ն:`N`,Շ:`Sh`,Ո:`Vo`,Չ:`Ch`,Պ:`P`,Ջ:`J`,Ռ:`R`,Ս:`S`,Վ:`V`,Տ:`T`,Ր:`R`,Ց:`C`,Ւ:`u`,Փ:`Ph`,Ք:`Q`,և:`ev`,Օ:`O`,Ֆ:`F`,ա:`a`,բ:`b`,գ:`g`,դ:`d`,ե:`e`,զ:`z`,է:`e`,ը:`y`,թ:`th`,ժ:`zh`,ի:`i`,լ:`l`,խ:`kh`,ծ:`ts`,կ:`k`,հ:`h`,ձ:`dz`,ղ:`gh`,ճ:`tch`,մ:`m`,յ:`y`,ն:`n`,շ:`sh`,ո:`vo`,չ:`ch`,պ:`p`,ջ:`j`,ռ:`r`,ս:`s`,վ:`v`,տ:`t`,ր:`r`,ց:`c`,ւ:`u`,փ:`ph`,ք:`q`,օ:`o`,ֆ:`f`,Ž:`Z`,Ň:`N`,Ş:`S`,ž:`z`,ň:`n`,ş:`s`,ı:`i`,İ:`I`,ğ:`g`,Ğ:`G`,ьо:`yo`,Й:`i`,Щ:`Shh`,Ъ:`Ie`,Ь:``,Ю:`Iu`,Я:`Ia`,й:`i`,щ:`shh`,ъ:`ie`,ь:``,ю:`iu`,я:`ia`,Ē:`E`,ē:`e`,န်ုပ်:`nub`,"ောင်":`aung`,"ိုက်":`aik`,"ိုဒ်":`ok`,"ိုင်":`aing`,"ိုလ်":`ol`,"ေါင်":`aung`,သြော:`aw`,"ောက်":`auk`,"ိတ်":`eik`,"ုတ်":`ok`,"ုန်":`on`,"ေတ်":`it`,"ုဒ်":`ait`,"ာန်":`an`,"ိန်":`ein`,"ွတ်":`ut`,"ေါ်":`aw`,"ွန်":`un`,"ိပ်":`eik`,"ုပ်":`ok`,"ွပ်":`ut`,"ိမ်":`ein`,"ုမ်":`on`,"ော်":`aw`,"ွမ်":`un`,က်:`et`,"ေါ":`aw`,"ော":`aw`,"ျွ":`ywa`,"ြွ":`yw`,"ို":`o`,"ုံ":`on`,တ်:`at`,င်:`in`,ည်:`i`,ဒ်:`d`,န်:`an`,ပ်:`at`,မ်:`an`,စျ:`za`,ယ်:`e`,ဉ်:`in`,စ်:`it`,"ိံ":`ein`,"ဲ":`e`,"း":``,"ာ":`a`,"ါ":`a`,"ေ":`e`,"ံ":`an`,"ိ":`i`,"ီ":`i`,"ု":`u`,"ူ":`u`,"်":`at`,"္":``,"့":``,က:`k`,"၉":`9`,တ:`t`,ရ:`ya`,ယ:`y`,မ:`m`,ဘ:`ba`,ဗ:`b`,ဖ:`pa`,ပ:`p`,န:`n`,ဓ:`da`,ဒ:`d`,ထ:`ta`,ဏ:`na`,ဝ:`w`,ဎ:`da`,ဍ:`d`,ဌ:`ta`,ဋ:`t`,ည:`ny`,ဇ:`z`,ဆ:`sa`,စ:`s`,င:`ng`,ဃ:`ga`,ဂ:`g`,လ:`l`,သ:`th`,"၈":`8`,ဩ:`aw`,ခ:`kh`,"၆":`6`,"၅":`5`,"၄":`4`,"၃":`3`,"၂":`2`,"၁":`1`,"၀":`0`,"၌":`hnaik`,"၍":`ywae`,ဪ:`aw`,ဦ:`-u`,ဟ:`h`,ဉ:`u`,ဤ:`-i`,ဣ:`i`,"၏":`-e`,ဧ:`e`,"ှ":`h`,"ွ":`w`,"ျ":`ya`,"ြ":`y`,အ:`a`,ဠ:`la`,"၇":`7`,DŽ:`DZ`,Dž:`Dz`,dž:`dz`,Ǳ:`DZ`,ǲ:`Dz`,ǳ:`dz`,Ǉ:`LJ`,ǈ:`Lj`,ǉ:`lj`,Ǌ:`NJ`,ǋ:`Nj`,ǌ:`nj`,č:`c`,Č:`C`,ć:`c`,Ć:`C`,š:`s`,Š:`S`,ა:`a`,ბ:`b`,გ:`g`,დ:`d`,ე:`e`,ვ:`v`,ზ:`z`,თ:`t`,ი:`i`,კ:`k`,ლ:`l`,მ:`m`,ნ:`n`,ო:`o`,პ:`p`,ჟ:`zh`,რ:`r`,ს:`s`,ტ:`t`,უ:`u`,ფ:`f`,ქ:`q`,ღ:`gh`,ყ:`y`,შ:`sh`,ჩ:`ch`,ც:`ts`,ძ:`dz`,წ:`ts`,ჭ:`ch`,ხ:`kh`,ჯ:`j`,ჰ:`h`,Ё:`E`,ё:`e`,Ы:`Y`,ы:`y`,Э:`E`,э:`e`,І:`I`,і:`i`,Ѳ:`F`,ѳ:`f`,Ѣ:`E`,ѣ:`e`,Ѵ:`I`,ѵ:`i`,Є:`Je`,є:`je`,Ѥ:`Je`,ѥ:`je`,Ꙋ:`U`,ꙋ:`u`,Ѡ:`O`,ѡ:`o`,Ѿ:`Ot`,ѿ:`ot`,Ѫ:`U`,ѫ:`u`,Ѧ:`Ja`,ѧ:`ja`,Ѭ:`Ju`,ѭ:`ju`,Ѩ:`Ja`,ѩ:`Ja`,Ѯ:`Ks`,ѯ:`ks`,Ѱ:`Ps`,ѱ:`ps`,Ґ:`G`,ґ:`g`,Ї:`Yi`,ї:`yi`,Ә:`A`,Ғ:`G`,Қ:`Q`,Ң:`N`,Ө:`O`,Ұ:`U`,Ү:`U`,Һ:`H`,ә:`a`,ғ:`g`,қ:`q`,ң:`n`,ө:`o`,ұ:`u`,ү:`u`,һ:`h`,ď:`d`,Ď:`D`,ě:`e`,Ě:`E`,ř:`r`,Ř:`R`,ť:`t`,Ť:`T`,ů:`u`,Ů:`U`,ą:`a`,ę:`e`,ł:`l`,ń:`n`,ś:`s`,ź:`z`,ż:`z`,Ą:`A`,Ę:`E`,Ł:`L`,Ń:`N`,Ś:`S`,Ź:`Z`,Ż:`Z`,ā:`a`,ģ:`g`,ī:`i`,ķ:`k`,ļ:`l`,ņ:`n`,ū:`u`,Ā:`A`,Ģ:`G`,Ī:`I`,Ķ:`k`,Ļ:`L`,Ņ:`N`,Ū:`U`,Ả:`A`,Ạ:`A`,Ắ:`A`,Ằ:`A`,Ẳ:`A`,Ẵ:`A`,Ặ:`A`,Ấ:`A`,Ầ:`A`,Ẩ:`A`,Ẫ:`A`,Ậ:`A`,ả:`a`,ạ:`a`,ắ:`a`,ằ:`a`,ẳ:`a`,ẵ:`a`,ặ:`a`,ấ:`a`,ầ:`a`,ẩ:`a`,ẫ:`a`,ậ:`a`,Ẻ:`E`,Ẽ:`E`,Ẹ:`E`,Ế:`E`,Ề:`E`,Ể:`E`,Ễ:`E`,Ệ:`E`,ẻ:`e`,ẽ:`e`,ẹ:`e`,ế:`e`,ề:`e`,ể:`e`,ễ:`e`,ệ:`e`,Ỉ:`I`,Ị:`I`,ỉ:`i`,ị:`i`,Ỏ:`O`,Ọ:`O`,Ố:`O`,Ồ:`O`,Ổ:`O`,Ỗ:`O`,Ộ:`O`,Ớ:`O`,Ờ:`O`,Ở:`O`,Ỡ:`O`,Ợ:`O`,ỏ:`o`,ọ:`o`,ố:`o`,ồ:`o`,ổ:`o`,ỗ:`o`,ộ:`o`,ớ:`o`,ờ:`o`,ở:`o`,ỡ:`o`,ợ:`o`,Ủ:`U`,Ụ:`U`,Ứ:`U`,Ừ:`U`,Ử:`U`,Ữ:`U`,Ự:`U`,ủ:`u`,ụ:`u`,ứ:`u`,ừ:`u`,ử:`u`,ữ:`u`,ự:`u`,Ỳ:`Y`,Ỷ:`Y`,Ỹ:`Y`,Ỵ:`Y`,ỳ:`y`,ỷ:`y`,ỹ:`y`,ỵ:`y`,ا:`a`,ب:`b`,پ:`p`,ت:`t`,ث:`th`,ج:`g`,چ:`ch`,ح:`h`,خ:`kh`,د:`d`,ذ:`th`,ر:`r`,ز:`z`,س:`s`,ش:`sh`,ص:`s`,ض:`d`,ط:`t`,ظ:`th`,ع:`aa`,غ:`gh`,ف:`f`,ق:`k`,ک:`k`,گ:`g`,ل:`l`,ژ:`zh`,ك:`k`,م:`m`,ن:`n`,ه:`h`,و:`o`,ی:`y`,آ:`a`,"٠":`0`,"١":`1`,"٢":`2`,"٣":`3`,"٤":`4`,"٥":`5`,"٦":`6`,"٧":`7`,"٨":`8`,"٩":`9`,أ:`a`,ي:`y`,إ:`a`,ؤ:`o`,ئ:`y`,ء:`aa`,ђ:`dj`,ћ:`c`,Ђ:`Dj`,Ћ:`C`,ə:`e`,Ə:`E`,ß:`ss`,ẞ:`SS`,ভ্ল:`vl`,পশ:`psh`,ব্ধ:`bdh`,ব্জ:`bj`,ব্দ:`bd`,ব্ব:`bb`,ব্ল:`bl`,ভ:`v`,ব:`b`,চ্ঞ:`cNG`,চ্ছ:`cch`,চ্চ:`cc`,ছ:`ch`,চ:`c`,ধ্ন:`dhn`,ধ্ম:`dhm`,দ্ঘ:`dgh`,দ্ধ:`ddh`,দ্ভ:`dv`,দ্ম:`dm`,ড্ড:`DD`,ঢ:`Dh`,ধ:`dh`,দ্গ:`dg`,দ্দ:`dd`,ড:`D`,দ:`d`,"।":`.`,ঘ্ন:`Ghn`,গ্ধ:`Gdh`,গ্ণ:`GN`,গ্ন:`Gn`,গ্ম:`Gm`,গ্ল:`Gl`,জ্ঞ:`jNG`,ঘ:`Gh`,গ:`g`,হ্ণ:`hN`,হ্ন:`hn`,হ্ম:`hm`,হ্ল:`hl`,হ:`h`,জ্ঝ:`jjh`,ঝ:`jh`,জ্জ:`jj`,জ:`j`,ক্ষ্ণ:`kxN`,ক্ষ্ম:`kxm`,ক্ষ:`ksh`,কশ:`ksh`,ক্ক:`kk`,ক্ট:`kT`,ক্ত:`kt`,ক্ল:`kl`,ক্স:`ks`,খ:`kh`,ক:`k`,ল্ভ:`lv`,ল্ধ:`ldh`,লখ:`lkh`,লঘ:`lgh`,লফ:`lph`,ল্ক:`lk`,ল্গ:`lg`,ল্ট:`lT`,ল্ড:`lD`,ল্প:`lp`,ল্ম:`lm`,ল্ল:`ll`,ল্ব:`lb`,ল:`l`,ম্থ:`mth`,ম্ফ:`mf`,ম্ভ:`mv`,মপ্ল:`mpl`,ম্ন:`mn`,ম্প:`mp`,ম্ম:`mm`,ম্ল:`ml`,ম্ব:`mb`,ম:`m`,"০":`0`,"১":`1`,"২":`2`,"৩":`3`,"৪":`4`,"৫":`5`,"৬":`6`,"৭":`7`,"৮":`8`,"৯":`9`,ঙ্ক্ষ:`Ngkx`,ঞ্ছ:`nch`,ঙ্ঘ:`ngh`,ঙ্খ:`nkh`,ঞ্ঝ:`njh`,ঙ্গৌ:`ngOU`,ঙ্গৈ:`ngOI`,ঞ্চ:`nc`,ঙ্ক:`nk`,ঙ্ষ:`Ngx`,ঙ্গ:`ngo`,ঙ্ম:`Ngm`,ঞ্জ:`nj`,ন্ধ:`ndh`,ন্ঠ:`nTh`,ণ্ঠ:`NTh`,ন্থ:`nth`,ঙ্গা:`nga`,ঙ্গি:`ngi`,ঙ্গী:`ngI`,ঙ্গু:`ngu`,ঙ্গূ:`ngU`,ঙ্গে:`nge`,ঙ্গো:`ngO`,ণ্ঢ:`NDh`,নশ:`nsh`,ঙর:`Ngr`,ঞর:`NGr`,"ংর":`ngr`,ঙ:`Ng`,ঞ:`NG`,"ং":`ng`,ন্ন:`nn`,ণ্ণ:`NN`,ণ্ন:`Nn`,ন্ম:`nm`,ণ্ম:`Nm`,ন্দ:`nd`,ন্ট:`nT`,ণ্ট:`NT`,ন্ড:`nD`,ণ্ড:`ND`,ন্ত:`nt`,ন্স:`ns`,ন:`n`,ণ:`N`,"ৈ":`OI`,"ৌ":`OU`,"ো":`O`,ঐ:`OI`,ঔ:`OU`,অ:`o`,ও:`oo`,ফ্ল:`fl`,প্ট:`pT`,প্ত:`pt`,প্ন:`pn`,প্প:`pp`,প্ল:`pl`,প্স:`ps`,ফ:`f`,প:`p`,"ৃ":`rri`,ঋ:`rri`,রর‍্য:`rry`,"্র্য":`ry`,"্রর":`rr`,ড়্গ:`Rg`,ঢ়:`Rh`,ড়:`R`,র:`r`,"্র":`r`,শ্ছ:`Sch`,ষ্ঠ:`ShTh`,ষ্ফ:`Shf`,স্ক্ল:`skl`,স্খ:`skh`,স্থ:`sth`,স্ফ:`sf`,শ্চ:`Sc`,শ্ত:`St`,শ্ন:`Sn`,শ্ম:`Sm`,শ্ল:`Sl`,ষ্ক:`Shk`,ষ্ট:`ShT`,ষ্ণ:`ShN`,ষ্প:`Shp`,ষ্ম:`Shm`,স্প্ল:`spl`,স্ক:`sk`,স্ট:`sT`,স্ত:`st`,স্ন:`sn`,স্প:`sp`,স্ম:`sm`,স্ল:`sl`,শ:`S`,ষ:`Sh`,স:`s`,"ু":`u`,উ:`u`,অ্য:`oZ`,ত্থ:`tth`,ৎ:`tt`,ট্ট:`TT`,ট্ম:`Tm`,ঠ:`Th`,ত্ন:`tn`,ত্ম:`tm`,থ:`th`,ত্ত:`tt`,ট:`T`,ত:`t`,অ্যা:`AZ`,"া":`a`,আ:`a`,য়া:`ya`,য়:`y`,"ি":`i`,ই:`i`,"ী":`ee`,ঈ:`ee`,"ূ":`uu`,ঊ:`uu`,"ে":`e`,এ:`e`,য:`z`,"্য":`Z`,ইয়:`y`,ওয়:`w`,"্ব":`w`,এক্স:`x`,"ঃ":`:`,"ঁ":`nn`,"্‌":``,"˚":`0`,"¹":`1`,"²":`2`,"³":`3`,"⁴":`4`,"⁵":`5`,"⁶":`6`,"⁷":`7`,"⁸":`8`,"⁹":`9`,"₀":`0`,"₁":`1`,"₂":`2`,"₃":`3`,"₄":`4`,"₅":`5`,"₆":`6`,"₇":`7`,"₈":`8`,"₉":`9`,"௦":`0`,"௧":`1`,"௨":`2`,"௩":`3`,"௪":`4`,"௫":`5`,"௬":`6`,"௭":`7`,"௮":`8`,"௯":`9`,"௰":`10`,"௱":`100`,"௲":`1000`,Ꜳ:`AA`,ꜳ:`aa`,Ꜵ:`AO`,ꜵ:`ao`,Ꜷ:`AU`,ꜷ:`au`,Ꜹ:`AV`,ꜹ:`av`,Ꜻ:`av`,ꜻ:`av`,Ꜽ:`AY`,ꜽ:`ay`,ȸ:`db`,ʣ:`dz`,ʥ:`dz`,ʤ:`dezh`,"🙰":`et`,ﬀ:`ff`,ﬃ:`ffi`,ﬄ:`ffl`,ﬁ:`fi`,ﬂ:`fl`,ʩ:`feng`,ʪ:`ls`,ʫ:`lz`,ɮ:`lezh`,ȹ:`qp`,ʨ:`tc`,ʦ:`ts`,ʧ:`tesh`,Ꝏ:`OO`,ꝏ:`oo`,ﬆ:`st`,ﬅ:`st`,Ꜩ:`TZ`,ꜩ:`tz`,ᵫ:`ue`,Aι:`Ai`,αι:`ai`,ἀ:`a`,ἁ:`a`,ἂ:`a`,ἃ:`a`,ἄ:`a`,ἅ:`a`,ἆ:`a`,ἇ:`a`,Ἀ:`A`,Ἁ:`A`,Ἂ:`A`,Ἃ:`A`,Ἄ:`A`,Ἅ:`A`,Ἆ:`A`,Ἇ:`A`,ᾰ:`a`,ᾱ:`a`,ᾲ:`a`,ᾳ:`a`,ᾴ:`a`,ᾶ:`a`,ᾷ:`a`,Ᾰ:`A`,Ᾱ:`A`,Ὰ:`A`,Ά:`A`,ᾼ:`A`,A̧:`A`,a̧:`a`,Ⱥ:`A`,ⱥ:`a`,Ȧ:`A`,ȧ:`a`,Ɓ:`B`,C̈:`C`,c̈:`c`,C̨:`C`,c̨:`c`,Ȼ:`C`,ȼ:`c`,C̀:`C`,c̀:`c`,C̣:`C`,c̣:`c`,C̄:`C`,c̄:`c`,C̃:`C`,c̃:`c`,Ȩ:`E`,ȩ:`e`,Ɇ:`E`,ɇ:`e`,I̧:`I`,i̧:`i`,Ɨ:`I`,ɨ:`i`,i:`i`,J́́:`J`,j́:`j`,J̀̀:`J`,j̀:`j`,J̈:`J`,j̈:`j`,J̧:`J`,j̧:`j`,J̨:`J`,j̨:`j`,Ɉ:`J`,ɉ:`j`,J̌:`J`,ǰ:`j`,J̇:`J`,j:`j`,J̣:`J`,j̣:`j`,J̄:`J`,j̄:`j`,J̃:`J`,j̃:`j`,ĸ:`k`,L̀:`L`,l̀:`l`,L̂:`L`,l̂:`l`,L̈:`L`,l̈:`l`,L̨:`L`,l̨:`l`,Ƚ:`L`,ƚ:`l`,L̇:`L`,l̇:`l`,Ḷ:`L`,ḷ:`l`,L̄:`L`,l̄:`l`,L̃:`L`,l̃:`l`,Ŋ:`N`,ŋ:`n`,Ǹ:`N`,ǹ:`n`,N̂:`N`,n̂:`n`,N̈:`N`,n̈:`n`,N̨:`N`,n̨:`n`,Ꞥ:`N`,ꞥ:`n`,Ṅ:`N`,ṅ:`n`,Ṇ:`N`,ṇ:`n`,N̄:`N`,n̄:`n`,O̧:`O`,o̧:`o`,Ǫ:`O`,ǫ:`o`,Ɵ:`O`,ɵ:`o`,Ȯ:`O`,ȯ:`o`,S̀:`S`,s̀:`s`,Ŝ̀:`S`,S̈:`S`,s̈:`s`,S̨:`S`,s̨:`s`,Ꞩ:`S`,ꞩ:`s`,Ṡ:`S`,ṡ:`s`,Ṣ:`S`,ṣ:`s`,S̄:`S`,s̄:`s`,S̃:`S`,s̃:`s`,T́:`T`,t́:`t`,T̀:`T`,t̀:`t`,T̂:`T`,t̂:`t`,T̈:`T`,ẗ:`t`,T̨:`T`,t̨:`t`,Ⱦ:`T`,ⱦ:`t`,Ṫ:`T`,ṫ:`t`,Ṭ:`T`,ṭ:`t`,T̄:`T`,t̄:`t`,T̃:`T`,t̃:`t`,U̧:`U`,u̧:`u`,Ʉ:`U`,ʉ:`u`,U̇:`U`,u̇:`u`,Ʊ:`U`,ʊ:`u`,Ẁ:`W`,ẁ:`w`,Ẃ:`W`,ẃ:`w`,Ẅ:`W`,ẅ:`w`,Ꙗ:`Ja`,ꙗ:`ja`,Y̧:`Y`,y̧:`y`,Y̨:`Y`,y̨:`y`,Ɏ:`Y`,ɏ:`y`,Y̌:`Y`,y̌:`y`,Ẏ:`Y`,ẏ:`y`,Ȳ:`Y`,ȳ:`y`,Z̀:`Z`,z̀:`z`,Ẑ:`Z`,ẑ:`z`,Z̈:`Z`,z̈:`z`,Z̧:`Z`,z̧:`z`,Z̨:`Z`,z̨:`z`,Ƶ:`Z`,ƶ:`z`,Ẓ:`Z`,ẓ:`z`,Z̄:`Z`,z̄:`z`,Z̃:`Z`,z̃:`z`,"\xA0":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `,"\u2028":` `,"\u2029":` `,"​":` `," ":` `," ":` `,"　":` `,ﾠ:` `,"«":`<<`,"»":`>>`,"‘":`'`,"’":`'`,"‚":`'`,"‛":`'`,"“":`"`,"”":`"`,"„":`"`,"‟":`"`,"‹":`'`,"›":`'`,"–":`-`,"—":`-`,"…":`...`,"€":`EUR`,$:`$`,"₢":`Cr`,"₣":`Fr.`,"£":`PS`,"₤":`L.`,ℳ:`M`,"₥":`mil`,"₦":`N`,"₧":`Pts`,"₨":`Rs`,රු:`LKR`,ரூ:`LKR`,"௹":`Rs`,रू:`NPR`,"₹":`Rs`,"૱":`Rs`,"₩":`W`,"₪":`NS`,"₸":`KZT`,"₫":`D`,"֏":`AMD`,"₭":`K`,"₺":`TL`,"₼":`AZN`,"₮":`T`,"₯":`Dr`,"₲":`PYG`,"₾":`GEL`,"₳":`ARA`,"₴":`UAH`,"₽":`RUB`,"₵":`GHS`,"₡":`CL`,"¢":`c`,"¥":`YEN`,円:`JPY`,"৳":`BDT`,元:`CNY`,"﷼":`SAR`,"៛":`KR`,"₠":`ECU`,"¤":`$?`,"฿":`THB`,"؋":`AFN`};function ga(e,t=ha){e=e.normalize(`NFC`);let n=``,r;for(let i=0;i<e.length;i++)r=e.charAt(i),n+=typeof t[r]==`string`?t[r]:r;return n}function _a(e,t={}){let n={allowNonAlphaStart:!1,handleCasing:`camel`,...t};var r=e.replace(/<(.*?)>/g,``);r=r.replace(/['"‘’“”ʻ\[\]\(\)\{\}:]/g,``),r=r.toLowerCase(),r=ga(r),n.allowNonAlphaStart||(r=r.replace(/^[^a-z]+/,``));let i=r.split(/[^a-z0-9]+/).filter(Boolean);if(r=``,n.handleCasing===`snake`)return i.join(`_`);for(let e=0;e<i.length;e++)n.handleCasing!==`pascal`&&e===0?r+=i[e]:r+=i[e].charAt(0).toUpperCase()+i[e].substring(1);return r}function va(e,t={}){let n={prefix:``,suffix:``,...t},r=_a(e,{handleCasing:`snake`}).toUpperCase();return r?`${n.prefix}${r}${n.suffix}`:``}function ya(e){let t=e.replace(/<(.*?)>/g,``);return t=t.toLowerCase(),t=ga(t),t=t.replace(/^[^a-z]+/,``),t=t.replace(/[^a-z0-9]+$/,``),t.split(/[^a-z0-9]+/).filter(Boolean).join(`-`)}function ba(e){return e.charAt(0).toUpperCase()+e.slice(1)}function xa(){return Math.floor(Math.random()*1e6)}var Sa=new WeakMap,Ca=class e{constructor(){this.queue=[],this.workers=[],f(this,Sa,null),h(Sa,this,new AbortController);for(let e=0;e<3;e++)this.workers.push(new Da(this))}load(t=document,n=`[data-sizes]`){t.querySelectorAll(n).forEach(t=>{if(da(t))this.addToQueue(t);else{let n=`thumb${xa()}`;e.invisibleThumbs[n]=[this,t];let r=()=>{e.invisibleThumbs[n]&&da(t)&&(delete e.invisibleThumbs[n],this.addToQueue(t))};document.addEventListener(`scroll`,r,{signal:m(Sa,this)?.signal}),window.addEventListener(`resize`,r,{signal:m(Sa,this)?.signal})}})}addToQueue(e){this.queue.push(e),this.workers.forEach(e=>{e.active||e.loadNext()})}static retryAll(){for(let t in e.invisibleThumbs){let n=e.invisibleThumbs[t];if(!n)continue;let[r,i]=n;delete e.invisibleThumbs[t],r.load(i.parentElement??document)}}destroy(){this.workers.forEach(e=>e.deactivate()),m(Sa,this)?.abort()}};Ca.invisibleThumbs={};var wa=new WeakMap,Ta=new WeakMap,Ea=new WeakMap,Da=class{constructor(e){this.active=!1,this.container=void 0,f(this,wa,null),f(this,Ta,null),f(this,Ea,null),h(wa,this,e)}activate(){this.active||(this.active=!0,this.clearInterval(),h(Ta,this,setInterval(()=>{this.loadNextIfRemoved()},500)))}deactivate(){this.active&&(this.active=!1,this.clearInterval(),this.clearTimeout())}clearInterval(){m(Ta,this)&&(clearInterval(m(Ta,this)),h(Ta,this,null))}clearTimeout(){m(Ea,this)&&(clearTimeout(m(Ea,this)),h(Ea,this,null))}loadNext(){if(this.clearTimeout(),this.container=m(wa,this)?.queue.shift(),this.container===void 0){this.deactivate();return}if(this.loadNextIfRemoved())return;if(this.container.querySelectorAll(`img`).length>0){this.loadNext();return}this.activate(),h(Ea,this,setTimeout(()=>{this.loadNext()},3e4));let e=document.createElement(`img`);e.sizes=this.container.getAttribute(`data-sizes`)??``,e.srcset=this.container.getAttribute(`data-srcset`)??``,e.alt=this.container.getAttribute(`data-alt`)??``,e.setAttribute(`data-animated`,this.container.getAttribute(`data-animated`)??``),e.src=this.container.getAttribute(`data-src`)??``,e.onload=()=>this.loadNext(),e.onabort=()=>this.loadNext(),e.onerror=()=>this.loadNext(),this.container.appendChild(e)}loadNextIfRemoved(){return this.container&&!document.body.contains(this.container)?(this.loadNext(),!0):!1}},Oa=a`
  :host {
    display: contents;
  }
...
`,ka=new WeakMap,Aa=new WeakMap,ja=new WeakMap,Ma=new WeakSet,Na=class extends l{constructor(...e){super(...e),d(this,Ma),this.size=``,this.variant=Se.Neutral,this.appearance=ee.OutlineFill,this.icon=null,this.showIndicators=!1,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,this.selected=!1,this.selectLabel=null,f(this,ka,!1),f(this,Aa,new Ca),this.lightDom=0,f(this,ja,new MutationObserver(()=>this.lightDom++))}connectedCallback(){super.connectedCallback(),m(ja,this).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){m(ja,this).disconnect(),super.disconnectedCallback()}renderSelect(){return r`<input
      type="checkbox"
    ...
    </div>`}firstUpdated(e){super.firstUpdated(e),m(Aa,this).load(this)}render(){this.lightDom;let e=!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`)||!!this.querySelector(`[slot="thumbnail"]`)||!!this.querySelector(`[slot="indicator"]`)||!!this.querySelector(`[slot="status"]`)||this.icon,t=!!this.querySelector(`[slot="suffix"]`);return r`
      <div
        part="chip"
        class="${S({"cp-chip":!0,"cp-chip--small":this.size===`small`,"cp-chip--medium":this.size===`medium`,"cp-chip--large":this.size===`large`,"cp-chip--plain":this.appearance===ee.Plain,"cp-chip--selectable":this.selectable,"cp-chip--show-thumb":this.showThumb,"cp-chip--show-indicators":this.showIndicators,"cp-chip--show-status":this.showStatus})}"
      >
    ...
    `}};function Pa(e){h(ka,this,e.shiftKey),e.stopPropagation()}function Fa(e){let{checked:t}=e.target;this.selected=t,this.dispatchEvent(new CustomEvent(`selected-change`,{detail:{selected:t,shiftKey:m(ka,this)},bubbles:!0,composed:!0}))}Na.styles=[Oa],p([g()],Na.prototype,`size`,void 0),p([g({reflect:!0})],Na.prototype,`variant`,void 0),p([g({reflect:!0})],Na.prototype,`appearance`,void 0),p([g()],Na.prototype,`icon`,void 0),p([g({attribute:`show-indicators`,type:Boolean})],Na.prototype,`showIndicators`,void 0),p([g({attribute:`show-status`,type:Boolean})],Na.prototype,`showStatus`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],Na.prototype,`showThumb`,void 0),p([g({type:Boolean})],Na.prototype,`selectable`,void 0),p([g({type:Boolean,reflect:!0})],Na.prototype,`selected`,void 0),p([g({attribute:`select-label`})],Na.prototype,`selectLabel`,void 0),p([_()],Na.prototype,`lightDom`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,Na);var Ia=class extends Ri(l){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},La=D(e=>class extends Si(_i(Bi(Ve(Li(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],a`
          :host {
            display: block;
          }
...
`,Va=new WeakMap,Ha=new WeakSet,Ua=class extends za{constructor(...e){super(...e),d(this,Ha),this.hint=null,f(this,Va,void 0)}static get styles(){return[...za.styles,Ba]}connectedCallback(){super.connectedCallback(),Ga._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),Ga._.unobserve(this)}render(){return r`
    ...
    `}};function Wa(){return m(Va,this)??h(Va,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),m(Va,this)}var Ga={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=u(Ha,e,Wa).call(e))}})};p([g()],Ua.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,Ua);var Ka=new WeakMap;function qa(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Ka.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else qa(n,t)})}function Ja(e){Ka.has(e)&&Ka.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Ka.has(e)&&Ka.get(e)():Ja(e)})}var Ya=class extends ki{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof bi}};function Xa(e){return Array.isArray(e)?e:[e]}var Za=D(e=>class extends Bi(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Xa(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Xa(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Xa(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Xa(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Qa=new WeakMap,$a=class extends di(se(Za(Ra))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,a`
      ...
      `]}static get localizeNamespaces(){return[{"lion-combobox":e=>{switch(e){case`bg-BG`:case`bg`:return T(()=>import(`./bg-Bs0XcBVB.js`),[],import.meta.url);case`cs-CZ`:case`cs`:return T(()=>import(`./cs-B8DQIi4_.js`),[],import.meta.url);case`de-AT`:case`de-DE`:case`de`:return T(()=>import(`./de-BGf3YhNb.js`),[],import.meta.url);case`en-AU`:case`en-GB`:case`en-PH`:case`en-US`:case`en`:return T(()=>import(`./en-D-xWIAUL.js`),[],import.meta.url);case`es-ES`:case`es`:return T(()=>import(`./es-BxznwUyK.js`),[],import.meta.url);case`fr-FR`:case`fr-BE`:case`fr`:return T(()=>import(`./fr-Cma_rLCi.js`),[],import.meta.url);case`hu-HU`:case`hu`:return T(()=>import(`./hu-oz_RH6aJ.js`),[],import.meta.url);case`it-IT`:case`it`:return T(()=>import(`./it-BUnCsVOb.js`),[],import.meta.url);case`nl-BE`:case`nl-NL`:case`nl`:return T(()=>import(`./nl-BgK25p-m.js`),[],import.meta.url);case`pl-PL`:case`pl`:return T(()=>import(`./pl-BFxKYQFW.js`),[],import.meta.url);case`ro-RO`:case`ro`:return T(()=>import(`./ro-DXnny9tt.js`),[],import.meta.url);case`ru-RU`:case`ru`:return T(()=>import(`./ru-DxR-HmN-.js`),[],import.meta.url);case`sk-SK`:case`sk`:return T(()=>import(`./sk-Hha-L2N4.js`),[],import.meta.url);case`uk-UA`:case`uk`:return T(()=>import(`./uk-CvmsXQbu.js`),[],import.meta.url);case`zh-CN`:case`zh`:return T(()=>import(`./zh-CgAr6HSc.js`),[],import.meta.url);default:return T(()=>import(`./en-D-xWIAUL.js`),[],import.meta.url)}}},...super.localizeNamespaces]}get modelValue(){let e=super.modelValue;return e===``?this.parser(this.value):e}set modelValue(e){super.modelValue=e}get value(){return this._inputNode?.value||this.__value||``}set value(e){this._inputNode?(this._inputNode.value=e,this.__value=void 0):this.__value=e}reset(){super.reset(),this.multipleChoice||(this.value=this._initialModelValue),this._resetListboxOptions()}_resetListboxOptions(){this.formElements.forEach((e,t)=>{this._unhighlightMatchedOption(e),!this.showAllOnEmpty||!this.opened?e.style.display=`none`:(e.style.display=``,e.setAttribute(`aria-posinset`,`${t+1}`),e.setAttribute(`aria-setsize`,`${this.formElements.length}`),e.removeAttribute(`aria-hidden`))})}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
...
`,ro=new WeakMap,io=new WeakMap,ao=new WeakMap,z=new WeakSet,oo=new WeakMap,so=class extends $a{static get properties(){return{modelValue:{attribute:`model-value`}}}attributeChangedCallback(e,t,n){if(e===`model-value`){this.modelValue=this.hasAttribute(`multiple-choice`)?JSON.parse(n??`[]`):n??``;return}super.attributeChangedCallback(e,t,n)}static get styles(){return[...super.styles,no]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,z),this.multipleChoice=!1,this.required=!1,this.initialValues=[],this.fieldsetDisabled=!1,this.changingValues=!1,this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,ro,void 0),f(this,io,!1),f(this,ao,()=>{h(io,this,!0),u(z,this,po).call(this),!this.multipleChoice&&!this.requireOptionMatch&&u(z,this,co).call(this)}),f(this,oo,()=>{if(this.multipleChoice){this.changeValues([]);return}this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(z,this,po).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.selectionFollowsFocus=!1,this.addEventListener(`model-value-changed`,e=>{if(this.changingValues){e.stopImmediatePropagation();return}if(e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&JSON.stringify(this.modelValue)!==JSON.stringify(this.pendingModelValue)){e.stopImmediatePropagation();return}e.target===this&&e.detail?.isTriggeredByUser&&(this.pendingModelValue=this.multipleChoice?[...this.selectedValues]:this.modelValue,this.multipleChoice&&(this.syncInputs(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))))}),this.addEventListener(`focusout`,e=>{this.multipleChoice&&!this.requireOptionMatch&&!(e.relatedTarget instanceof Node&&this.contains(e.relatedTarget))&&this.commitQuery()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m(ao,this)),this.addEventListener(`model-value-changed`,()=>{h(ro,this,this.modelValue)}),h(ro,this,this.modelValue),u(z,this,po).call(this),this.multipleChoice&&(this.initialValues=[...Array.isArray(this.pendingModelValue)?this.pendingModelValue:[]])}updated(e){if(super.updated(e),this.multipleChoice){this.syncInputs(),this._inputNode.removeAttribute(`name`),this._comboboxNode.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this._inputNode.disabled=this.disabled||this.fieldsetDisabled;let e=this.required&&!this.inactive&&this.selectedValues.length===0;this.internals??=this.attachInternals(),this.internals.setValidity(e?{valueMissing:!0}:{},e?O(`This field is required.`):``,this._inputNode)}e.has(`opened`)&&!this.opened&&h(io,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`)||e.has(`multipleChoice`))&&u(z,this,po).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,u(z,this,_o).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t);let n=e;n.updateComplete.then(()=>{if(this.multipleChoice){n.checked=Array.isArray(this.pendingModelValue)&&this.pendingModelValue.includes(String(n.choiceValue));return}String(n.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(n)))})}_notifyModelValueChanged(){JSON.stringify(this.modelValue)!==JSON.stringify(m(ro,this))&&(h(ro,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:this.multipleChoice?`selection`:`input`}})))}matchCondition(e){return!this.multipleChoice||!e.hidden}_autoSelectCondition(){return!this.multipleChoice}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=u(z,this,_o).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ...
        <div class="combobox__textbox">
          ...
          <slot name="input"></slot>
          ${this.clearable&&u(z,this,ho).call(this)&&!this.inactive?r`<craft-button
                class="clear"
                type="button"
                appearance="plain"
                size="small"
    ...
    `}get selectedValues(){return Array.isArray(this.modelValue)?this.modelValue:[]}get inactive(){return this.disabled||this.readOnly||this.fieldsetDisabled}valueLabel(e){return[...u(z,this,vo).call(this)].find(t=>t.value===e)?.label??e}syncInputs(){this.inputs||(this.inputs=document.createElement(`span`),this.inputs.hidden=!0,this.inputs.slot=`native-inputs`,this.inputs.setAttribute(`data-combobox-inputs`,``),this.append(this.inputs)),s(!this.name||this.disabled||this.fieldsetDisabled?c:r`
            ...
            ${this.selectedValues.map(e=>r`<input
                  ...
                  .value=${e}
                />`)}
          `,this.inputs)}formResetCallback(){this.multipleChoice&&(this.modelValue=[...this.initialValues],this.value=``,this.syncInputs())}formDisabledCallback(e){this.fieldsetDisabled=e,this.requestUpdate(),this.multipleChoice&&this.syncInputs()}changeValues(e){if(!this.inactive){this.changingValues=!0;try{this.modelValue=e}finally{this.changingValues=!1}this.value=``,this.opened=!1,u(z,this,po).call(this),this.syncInputs(),this._notifyModelValueChanged(),this._inputNode.focus()}}commitQuery(){let e=this.value;if(this.inactive||e===``)return;let t=[...u(z,this,vo).call(this)].find(t=>t.value===e);t?.disabled||this.requireOptionMatch&&!t||this.changeValues([...new Set([...this.selectedValues,e])])}_listboxOnKeyDown(e){if(!this.multipleChoice){super._listboxOnKeyDown(e);return}if(this.inactive||e.isComposing)return;if(e.key===`Backspace`&&this.value===``){e.preventDefault(),this.changeValues(this.selectedValues.slice(0,-1));return}let t=this.formElements[this.activeIndex];if(e.key===`Enter`&&(!this.opened||!t||t.hidden||t.hasAttribute(`aria-hidden`))){e.preventDefault(),this.commitQuery();return}super._listboxOnKeyDown(e)}_syncToTextboxMultiple(){}_resetListboxOptions(){super._resetListboxOptions(),this.hideSelectedOptions()}_handleAutocompletion(){super._handleAutocompletion(),this.hideSelectedOptions()}hideSelectedOptions(){if(!this.multipleChoice)return;for(let e of this.formElements)e.hidden&&(e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`aria-posinset`),e.removeAttribute(`aria-setsize`));let e=this.formElements.filter(e=>!e.hasAttribute(`aria-hidden`));e.forEach((t,n)=>{t.setAttribute(`aria-posinset`,String(n+1)),t.setAttribute(`aria-setsize`,String(e.length))})}parser(e){if(typeof e==`string`&&e!==``){let t=u(z,this,go).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function co(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function lo(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(u(z,this,uo).call(this,e))for(let r of e.options)(t===``||u(z,this,fo).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||u(z,this,fo).call(this,t,e))&&n.push({option:e});return n}function uo(e){return e.type===`optgroup`}function fo(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function po(){let e=this._listboxNode;if(!e)return;let t=m(io,this)?this._inputNode?.value??``:``,n=this.multipleChoice?Array.isArray(this.pendingModelValue)?this.pendingModelValue:this.selectedValues:[],i=u(z,this,lo).call(this,t).filter(e=>!n.includes(e.option.value)),a=i.slice(0,this.limit),o=[...u(z,this,vo).call(this)],l=[...n.map(e=>({option:o.find(t=>t.value===e)??{value:e,label:e}})),...a],d,f=l.map(e=>{let t=e.groupLabel&&e.groupLabel!==d?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return d=e.groupLabel,{value:e.option.value,template:r`${t}${u(z,this,mo).call(this,e.option,n.includes(e.option.value))}`}}),p=i.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
...
`,vs=/^[0-9a-f]{6}$/i,ys=/^[0-9a-f]{3}$/i,bs={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function xs(e){return String(e??``).trim().replace(/^#/,``)}function Ss(e){let t=xs(e);return ys.test(t)?t.split(``).map(e=>e+e).join(``):vs.test(t)?t:null}var Cs=class e extends Ki{static get styles(){return[...super.styles,Dr,_s]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,xs(t)),e}}}parser(e){return xs(e)}formatter(e){return xs(e)}serializer(e){return xs(e)}deserializer(e){return xs(e)}preprocessor(e){let t=xs(e);if(t!==e)return t}get _expandedHexValue(){return Ss(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>Ss(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=xs(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
      <input
...
`,B=class extends Ki{constructor(...e){super(...e),this.size=`medium`,this.inputMode=``,this.autoCorrect=!0,this.autoCapitalize=!0,this.small=!1,this.center=!1,this.monospace=!1,this.hiddenInput=!1}static get styles(){return[...super.styles,Dr,ws]}connectedCallback(){super.connectedCallback(),this._inputNode&&this.maxlength&&this.maxlength>0&&(this._inputNode.maxLength=this.maxlength,this.width!==`full`&&(this._inputNode.size=this.maxlength)),this.syncNativeAttributes(),this.syncAriaInvalid()}updated(e){super.updated(e),(e.has(`inputSize`)||e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`inputMode`)||e.has(`autoCorrect`)||e.has(`autoCapitalize`))&&this.syncNativeAttributes(),this.syncAriaInvalid()}syncAriaInvalid(){let e=this.getAttribute(`aria-invalid`);e!==null&&this._inputNode?.setAttribute(`aria-invalid`,e)}syncNativeAttributes(){let e={size:this.inputSize,min:this.min,max:this.max,step:this.step,inputmode:this.inputMode,autocorrect:this.autoCorrect?void 0:`off`,autocapitalize:this.autoCapitalize?void 0:`none`};for(let[t,n]of Object.entries(e)){if(n===void 0){this._inputNode?.removeAttribute(t);continue}this._inputNode?.setAttribute(t,String(n))}}};p([g({type:Number,reflect:!0})],B.prototype,`maxlength`,void 0),p([g({type:String,reflect:!0})],B.prototype,`size`,void 0),p([g({type:Number,attribute:!1})],B.prototype,`inputSize`,void 0),p([g({attribute:!1})],B.prototype,`min`,void 0),p([g({attribute:!1})],B.prototype,`max`,void 0),p([g({attribute:!1})],B.prototype,`step`,void 0),p([g({attribute:!1})],B.prototype,`inputMode`,void 0),p([g({attribute:!1})],B.prototype,`autoCorrect`,void 0),p([g({attribute:!1})],B.prototype,`autoCapitalize`,void 0),p([g({reflect:!0,type:Boolean})],B.prototype,`small`,void 0),p([g({type:String,reflect:!0})],B.prototype,`width`,void 0),p([g({reflect:!0,type:Boolean})],B.prototype,`center`,void 0),p([g({reflect:!0,type:Boolean})],B.prototype,`monospace`,void 0),p([g({reflect:!0,type:Boolean,attribute:`hidden-input`})],B.prototype,`hiddenInput`,void 0),customElements.get(`craft-input`)||customElements.define(`craft-input`,B);var Ts=a`
  /*
...
`,Es=class extends B{static get styles(){return[...super.styles,Ts]}_renderSuffix(){return r`<craft-copy-button
  ...
  `,p([g()],V.prototype,`name`,void 0),p([g({attribute:`date-value`})],V.prototype,`dateValue`,void 0),p([g({attribute:`time-value`})],V.prototype,`timeValue`,void 0),p([g()],V.prototype,`locale`,void 0),p([g()],V.prototype,`timezone`,void 0),p([g({attribute:`show-date`,converter:Ps})],V.prototype,`showDate`,void 0),p([g({attribute:`show-time`,converter:Ps})],V.prototype,`showTime`,void 0),p([g({type:Boolean,attribute:`show-timezone`})],V.prototype,`showTimezone`,void 0),p([g()],V.prototype,`min`,void 0),p([g()],V.prototype,`max`,void 0),p([g({attribute:`min-time`})],V.prototype,`minTime`,void 0),p([g({attribute:`max-time`})],V.prototype,`maxTime`,void 0),p([g({type:Number,attribute:`minute-increment`})],V.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],V.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],V.prototype,`forceRoundTime`,void 0),p([g({type:Boolean})],V.prototype,`disabled`,void 0),p([g({type:Boolean})],V.prototype,`readonly`,void 0),p([g({type:Boolean})],V.prototype,`required`,void 0),p([g({attribute:`described-by`})],V.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,V);var Gs=class extends ki{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Ks=class extends ki{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Qr().msg(`lion-input-file:uploadTextDuplicateFileName`)}},qs=524288e3,Js={type:`FILE_TYPE`,size:`FILE_SIZE`},Ys={fail:`FAIL`,pass:`SUCCESS`},Xs=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);Gs.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Ys.fail,this.failedProp.push(Js.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;Gs.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Ys.fail,this.failedProp.push(Js.type))}Gs.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Ys.fail&&(this.status=Ys.pass):(this.status=Ys.fail,this.failedProp.push(Js.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Zs=e=>{switch(e){case`bg-BG`:return T(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return T(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return T(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return T(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return T(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return T(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return T(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return T(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return T(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return T(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return T(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return T(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return T(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return T(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return T(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return T(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return T(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return T(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return T(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return T(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return T(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return T(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return T(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return T(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return T(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return T(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return T(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return T(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return T(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return T(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return T(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return T(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return T(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return T(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return T(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return T(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Qs=class extends di(_i(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":Oi}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Zs},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}_removeButtonContentTemplate(){return r`✖️`}_selectedListItemTemplate(e){let t=He();return r`
          ...
          <span id="selected-list-item-label-${t}" class="selected__list__item__label__text">
            ...
            ${e.downloadUrl&&e.status!==`LOADING`?r`
                  <a
                    ...
                    rel="${re(e.downloadUrl.startsWith(`blob`)?`noopener noreferrer`:void 0)}"
                    >${e.systemFile?.name}</a
                  >
                `:e.systemFile?.name}
          </span>
...
`,bc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(bc);var xc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(xc);var Sc=new Set([`clip`,`hidden`]),Cc=class extends vr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=bc.Raised,this.variant=xc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!Sc.has(n)&&e.scrollHeight-e.clientHeight>1||!Sc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};Cc.styles=[Co,yc],p([g({reflect:!0})],Cc.prototype,`appearance`,void 0),p([g({reflect:!0})],Cc.prototype,`variant`,void 0),p([g()],Cc.prototype,`label`,void 0),p([_()],Cc.prototype,`_hasSlottedHeader`,void 0),p([_()],Cc.prototype,`_hasSlottedFooter`,void 0),p([_()],Cc.prototype,`_scrollable`,void 0),p([_()],Cc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,Cc);var wc=0,Tc=new WeakMap,H=new WeakSet,Ec=class extends l{constructor(...e){super(...e),d(this,H),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,Tc,++wc)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(H,this,Lc).call(this)}render(){let e=u(H,this,kc).call(this);return to(this.groups,e=>e.handle,(t,n)=>u(H,this,Dc).call(this,t,n,e))}};function Dc(e,t,n){let i=`permission-tree-heading-${m(Tc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>u(H,this,Nc).call(this,e.keys,n)}
                >
                  ${u(H,this,Mc).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${u(H,this,Oc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function Oc(e,t,n,i){return to(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(H,this,jc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||u(H,this,Ac).call(this,o,i)}
                @model-value-changed=${e=>u(H,this,Pc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?u(H,this,Oc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function kc(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function Ac(e,t){return t.has(e.toLowerCase())}function jc(e,t){return this.modelValue.includes(e)||u(H,this,Ac).call(this,e,t)}function Mc(e,t){let n=e.filter(e=>!u(H,this,Ac).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function Nc(e,t){let n=e.filter(e=>!u(H,this,Ac).call(this,e,t));if(u(H,this,Mc).call(this,e,t)){let e=new Set(n);u(H,this,Ic).call(this,this.modelValue.filter(t=>!e.has(t)));return}u(H,this,Ic).call(this,[...new Set([...this.modelValue,...n])])}function Pc(e,t,n,r){if(e.stopPropagation(),this.disabled||u(H,this,Ac).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){u(H,this,Ic).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...u(H,this,Fc).call(this,n)]);u(H,this,Ic).call(this,this.modelValue.filter(e=>!o.has(e)))}function Fc(e){return Object.values(e).flatMap(e=>[e.key,...u(H,this,Fc).call(this,e.nested??{})])}function Ic(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function Lc(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;u(H,this,Rc).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&u(H,this,Rc).call(this,`${this.name}[]`,t)}function Rc(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}Ec.styles=a`
    :host {
      display: block;
    }
...
`,Bc=new WeakMap,Vc=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,f(this,Bc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&m(Bc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),h(Bc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,h(Bc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
    ...
    `}};Vc.styles=[zc],p([g({type:Number})],Vc.prototype,`progress`,void 0),p([g({type:Number})],Vc.prototype,`total`,void 0),p([g({type:Number})],Vc.prototype,`processed`,void 0),p([g({type:Boolean,attribute:`show-status`})],Vc.prototype,`showStatus`,void 0),p([g({type:Boolean,reflect:!0})],Vc.prototype,`pending`,void 0),p([g({type:Boolean})],Vc.prototype,`smooth`,void 0),p([g({type:String})],Vc.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Vc);var Hc=class extends Bi(Wi(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Uc=class extends Hi(Ki){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Wc=class extends Hc{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,Dr,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Wc.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Wc);var Gc=class extends Xi(Uc){static get styles(){return[...super.styles,a`
...
`,U=new WeakSet,ll=class extends l{constructor(...e){super(...e),d(this,U),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(U,this,dl).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(U,this,ul).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${u(U,this,pl).call(this,this.value)}
        aria-readonly=${this.readOnly?`true`:`false`}
        aria-describedby=${re(this.describedBy)}
        @keydown=${u(U,this,gl)}
      >
        ${e.map(e=>r`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(U,this,hl).call(this,e)}
              title=${u(U,this,pl).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function ul(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function dl(e){u(U,this,ul).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function fl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function pl(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function ml(e,t){let n=u(U,this,dl).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function hl(e){this.readOnly||u(U,this,ml).call(this,e,!0)}function gl(e){if(this.readOnly)return;let t=u(U,this,fl).call(this);switch(e.key){case`ArrowUp`:u(U,this,ml).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(U,this,ml).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(U,this,ml).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(U,this,ml).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(U,this,ml).call(this,this.min,!0),e.preventDefault();break;case`End`:u(U,this,ml).call(this,this.max,!0),e.preventDefault();break}}ll.styles=[cl],p([g({type:Number})],ll.prototype,`min`,void 0),p([g({type:Number})],ll.prototype,`max`,void 0),p([g({type:Number})],ll.prototype,`step`,void 0),p([g({type:Number})],ll.prototype,`value`,void 0),p([g()],ll.prototype,`label`,void 0),p([g({attribute:`described-by`})],ll.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],ll.prototype,`valueUnit`,void 0),p([g({attribute:!1})],ll.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],ll.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,ll);var _l=a`
  :host {
    display: block;
  }
...
`,vl=new WeakMap,yl=new WeakMap,bl=new WeakMap,xl=new WeakMap,Sl=new WeakMap,Cl=new WeakMap,wl=new WeakMap,W=new WeakSet,Tl=class extends l{constructor(...e){super(...e),d(this,W),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,vl,!1),f(this,yl,!1),f(this,bl,0),f(this,xl,0),f(this,Sl,0),f(this,Cl,!1),f(this,wl,null)}connectedCallback(){super.connectedCallback(),h(wl,this,new ResizeObserver(()=>u(W,this,Dl).call(this))),m(wl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(wl,this)?.disconnect(),h(wl,this,null)}firstUpdated(){h(Sl,this,(u(W,this,El).call(this).length-1)*10),u(W,this,Dl).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(W,this,Dl).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(W,this,Ml).call(this,this.value)}
        @keydown=${u(W,this,Vl)}
        @pointerdown=${u(W,this,Ll)}
        @pointermove=${u(W,this,Rl)}
        @pointerup=${u(W,this,zl)}
      >
    ...
    `}};function El(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function Dl(){this._graduations?.offsetWidth&&u(W,this,Al).call(this),u(W,this,kl).call(this),!(!this._list||!this._graduations?.offsetWidth)&&(this._list.style.transform=`translateX(${u(W,this,Pl).call(this,this.value)}px)`,u(W,this,Ol).call(this))}function Ol(){m(Cl,this)||(h(Cl,this,!0),requestAnimationFrame(()=>this._root?.classList.add(`placed`)))}function kl(){if(!this._indicator)return;let e=(this.graduationMin-this.graduationMax)*-1,t=m(Sl,this)/e;this._indicator.style.inlineSize=`${Math.abs(this.value)*t}px`,this._indicator.style.translate=this.value>0?`-100%`:`0`}function Al(){let e=u(W,this,El).call(this).length,t=this._list.getBoundingClientRect().width/e;t>0&&h(Sl,this,(e-1)*t)}function jl(){let{transform:e}=getComputedStyle(this._list);return!e||e===`none`?0:new DOMMatrixReadOnly(e).m41}function Ml(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function Nl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(Sl,this)*n-t}function Pl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(Sl,this)/n-this._graduations.offsetWidth/2)}function Fl(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);n!==this.value&&(this.value=n,t&&u(W,this,Il).call(this,`change`))}function Il(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function Ll(e){h(yl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(yl,this)&&(e.preventDefault(),h(bl,this,e.clientX),h(xl,this,u(W,this,jl).call(this)),this._root.setPointerCapture(e.pointerId),u(W,this,Il).call(this,`start`))}function Rl(e){m(yl,this)&&Math.abs(e.clientX-m(bl,this))>3&&(h(vl,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(W,this,Bl).call(this,e))}function zl(e){m(yl,this)&&(m(vl,this)?(e.preventDefault(),h(vl,this,!1),this._root.classList.remove(`dragging`)):u(W,this,Bl).call(this,e),u(W,this,Il).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(bl,this,0),h(yl,this,!1))}function Bl(e){let t=m(vl,this)?m(bl,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(vl,this)?t-e.clientX:e.clientX-t,r=m(xl,this)-n;u(W,this,Fl).call(this,u(W,this,Nl).call(this,r))}function Vl(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(W,this,Fl).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(W,this,Fl).call(this,t-1);break;case`PageUp`:u(W,this,Fl).call(this,t+10);break;case`PageDown`:u(W,this,Fl).call(this,t-10);break;case`Home`:u(W,this,Fl).call(this,this.min);break;case`End`:u(W,this,Fl).call(this,this.max);break;default:return}e.preventDefault()}Tl.styles=[_l],p([g({type:Number})],Tl.prototype,`min`,void 0),p([g({type:Number})],Tl.prototype,`max`,void 0),p([g({type:Number})],Tl.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],Tl.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],Tl.prototype,`graduationMax`,void 0),p([g()],Tl.prototype,`label`,void 0),p([y(`.slide-rule`)],Tl.prototype,`_root`,void 0),p([y(`.graduations`)],Tl.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],Tl.prototype,`_list`,void 0),p([y(`.cursor`)],Tl.prototype,`_cursor`,void 0),p([y(`.indicator`)],Tl.prototype,`_indicator`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,Tl);var Hl=a`
  :host {
    display: inline-flex;
...
`,Ul=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      ...
      ></span>
    `}};Ul.styles=[Hl],p([g()],Ul.prototype,`label`,void 0),p([g()],Ul.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Ul);var Wl=class extends De(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
...
`,du={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(du);var fu={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(fu);var pu=[du.InlineStart,du.InlineEnd],mu=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),G=new WeakSet,hu=new WeakMap,gu=new WeakMap,_u=new WeakMap,vu=new WeakMap,yu=new WeakMap,bu=new WeakMap,xu=new WeakMap,Su=new WeakMap,Cu=new WeakMap,wu=new WeakMap,Tu=new WeakMap,Eu=class extends lu{constructor(...e){super(...e),d(this,G),this.placement=du.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,hu,[]),f(this,gu,!1),f(this,_u,[]),f(this,vu,0),f(this,yu,void 0),f(this,bu,!1),f(this,xu,e=>{if(!this.collapsible||Ou.call(u(G,this)))return;let t=u(G,this,ju).call(this,e.target);!t||t.disabled||K.call(u(G,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(G,this,Mu).call(this,!0))}),f(this,Su,e=>{e.key!==`Escape`||!this.collapsible||Ou.call(u(G,this))||u(G,this,ju).call(this,e.target)&&(e.stopPropagation(),u(G,this,Mu).call(this,!0))}),f(this,Cu,()=>{Ou.call(u(G,this))&&(K.call(u(G,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(G,this,Nu).call(this)}),f(this,wu,()=>{if(u(G,this,Pu).call(this),K.call(u(G,this)).forEach((e,t)=>{let n=()=>u(G,this,Hu).call(this,t,!0),r=e=>{mu.has(e.key)&&e.preventDefault()},i=e=>u(G,this,Uu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(hu,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),K.call(u(G,this))[this.selectedIndex]?.disabled){let e=K.call(u(G,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(G,this,Fu).call(this)}),f(this,Tu,()=>{m(bu,this)||(h(bu,this,!0),requestAnimationFrame(()=>{h(bu,this,!1),u(G,this,Lu).call(this)}))})}static get styles(){return[...super.styles,Co,uu]}get layout(){return Du.call(u(G,this))?fu.Vertical:fu.Horizontal}set layout(e){this.placement=e===fu.Vertical?du.InlineStart:du.BlockStart}refresh(){m(gu,this)&&u(G,this,Fu).call(this),u(G,this,Lu).call(this)}firstUpdated(e){h(gu,this,K.call(u(G,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(gu,this))t?.addEventListener(`slotchange`,m(wu,this)),m(wu,this).call(this);else{let n=Ou.call(u(G,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(Cu,this))}this.addEventListener(`click`,m(xu,this),!0),this.addEventListener(`keydown`,m(Su,this)),t?.addEventListener(`slotchange`,m(Tu,this)),h(yu,this,new ResizeObserver(m(Tu,this))),m(yu,this).observe(this),u(G,this,Lu).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(G,this,Pu).call(this),m(yu,this)?.disconnect(),h(yu,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,Ou.call(u(G,this))),e.has(`selectedIndex`)&&(m(gu,this)?u(G,this,Fu).call(this):m(Cu,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(G,this,Lu).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${Du.call(u(G,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${Ou.call(u(G,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function Du(){return pu.includes(this.placement)}function Ou(){return this.selectedIndex<0}function K(){return this.tabs}function ku(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function Au(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function ju(e){return e instanceof Node?K.call(u(G,this)).find(t=>t===e||t.contains(e))??null:null}function Mu(e){let t=K.call(u(G,this))[this.selectedIndex];h(vu,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Nu(){let e=K.call(u(G,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(vu,this))?m(vu,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function Pu(){for(;m(hu,this).length;)m(hu,this).pop()?.()}function Fu(){let e=K.call(u(G,this)).map(e=>u(G,this,Iu).call(this,e)),t=e.some(Boolean);K.call(u(G,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${He()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(G,this,Nu).call(this)}function Iu(e){return e.controls?document.getElementById(e.controls):null}function Lu(){let e=ku.call(u(G,this)),t=Au.call(u(G,this)),n=K.call(u(G,this));if(!e||!t)return;if(Du.call(u(G,this))||n.length===0){u(G,this,zu).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(G,this,Ru).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(G,this,zu).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(G,this,zu).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Ru(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function zu(e){let t=Au.call(u(G,this)),n=new Set(e);K.call(u(G,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(_u,this,e),t&&(t.hidden=e.length===0,t.actions=u(G,this,Bu).call(this))}function Bu(){return m(_u,this).map(e=>{let t=K.call(u(G,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(G,this,Vu).call(this,e)}})}function Vu(e){let t=K.call(u(G,this))[e];if(!t||t.disabled)return;let n=Au.call(u(G,this));n&&(n.opened=!1),this.selectedIndex=e,u(G,this,Lu).call(this),t.focus()}function Hu(e,t){let n=K.call(u(G,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Uu(e){if(!mu.has(e.key))return;let t=u(G,this,Wu).call(this,e.key);t!==-1&&u(G,this,Hu).call(this,t,!0)}function Wu(e){let t=K.call(u(G,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(Ou.call(u(G,this)))return u(G,this,Wu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],Eu.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],Eu.prototype,`collapsible`,void 0),p([g({reflect:!0})],Eu.prototype,`layout`,null),p([g({reflect:!0})],Eu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,Eu);var Gu=a`
  :host {
    display: inline-flex;
...
`,td=new WeakMap,nd=new WeakMap,rd=new WeakMap,id=new WeakSet,ad=class extends $u{constructor(...e){super(...e),d(this,id),this.monospace=!1,f(this,td,void 0),f(this,nd,void 0),f(this,rd,null)}static get styles(){return[...super.styles,Dr,ed]}connectedCallback(){super.connectedCallback(),u(id,this,od).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(td,this)?.disconnect(),h(td,this,void 0),m(nd,this)?.disconnect(),h(nd,this,void 0)}};function od(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(rd,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(rd,this,e.style.height)}),h(nd,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(nd,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(td,this,new ResizeObserver(()=>{if(e.style.height===m(rd,this))return;let t=e.style.height;Zu.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(nd,this)?.disconnect(),h(nd,this,void 0),m(td,this)?.disconnect(),h(td,this,void 0)})),m(td,this).observe(e))}p([g({type:Boolean,reflect:!0})],ad.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,ad);var sd=a`
  :host {
    display: block;
    min-width: 0;
  }
...
`,cd=class extends l{constructor(...e){super(...e),this.last=!1,this._hasHeading=!1,this._hasMeta=!1,this._hasBody=!1,this._hasFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,characterData:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasHeading=!!this.querySelector(`:scope > [slot="heading"]`),this._hasMeta=!!this.querySelector(`:scope > [slot="meta"]`),this._hasBody=[...this.childNodes].some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e instanceof HTMLElement&&!e.slot),this._hasFooter=!!this.querySelector(`:scope > [slot="footer"]`)}render(){return r`
    ...
    `}};cd.styles=[sd],p([g({type:Boolean,reflect:!0})],cd.prototype,`last`,void 0),p([_()],cd.prototype,`_hasHeading`,void 0),p([_()],cd.prototype,`_hasMeta`,void 0),p([_()],cd.prototype,`_hasBody`,void 0),p([_()],cd.prototype,`_hasFooter`,void 0),customElements.get(`craft-timeline-item`)||customElements.define(`craft-timeline-item`,cd);var ld=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>ud(e,this),this.compositionEventHandler=e=>gd(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,dd),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,dd)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(hd)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(hd)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(hd),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),md(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function ud(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:fd(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&fd(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function dd(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&pd(t,{event:e})}function fd(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function pd(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function md(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function hd(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function gd(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var _d=class extends Event{constructor(){super(`update`)}},vd=new WeakMap,yd=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=vd.get(t);return n||(n=new e(t),vd.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),vd.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new _d)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of bd)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},bd=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),xd=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return yd.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},Sd=a`
  :host {
    display: contents;
  }
...
`,Cd=/^[\p{L}\p{N}_.-]*$/u,wd=O(`Suggestions`),Td=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],Ed={handlesAccessibility:!1,visibilityTriggerFunction:void 0},Dd=0,q=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,J=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Y=new WeakSet,Bd=new WeakMap,Vd=new WeakMap,Hd=new WeakMap,Ud=new WeakMap,Wd=new WeakMap,Gd=new WeakMap,Kd=new WeakMap,qd=new WeakMap,Jd=new WeakMap,Yd=new WeakMap,Xd=new WeakMap,Zd=class extends l{constructor(...e){super(...e),d(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,q,void 0),f(this,Od,null),f(this,kd,null),f(this,Ad,new Map),f(this,J,null),f(this,jd,[]),f(this,Md,0),f(this,Nd,null),f(this,Pd,null),f(this,Fd,null),f(this,Id,!1),f(this,Ld,null),f(this,Rd,new DOMRect),f(this,zd,new MutationObserver(()=>{let e=u(Y,this,$d).call(this);(Sf(e)&&e!==m(Od,this)||m(Od,this)&&!m(Od,this).isConnected)&&u(Y,this,ef).call(this)})),f(this,Bd,()=>{m(Id,this)||u(Y,this,cf).call(this)}),f(this,Vd,()=>{h(Id,this,!0),u(Y,this,gf).call(this)}),f(this,Hd,()=>{h(Id,this,!1),u(Y,this,cf).call(this)}),f(this,Ud,()=>{queueMicrotask(()=>u(Y,this,gf).call(this))}),f(this,Wd,()=>{let e=m(Od,this);!e||!m(J,this)||!Cf(e)||queueMicrotask(()=>{m(J,this)&&(e.selectionStart!==m(J,this).end||e.selectionEnd!==m(J,this).end)&&u(Y,this,cf).call(this)})}),f(this,Gd,()=>{m(J,this)&&u(Y,this,hf).call(this)}),f(this,Kd,e=>{let t=e;m(J,this)&&m(q,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,qd,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,Jd,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,Yd,e=>{u(Y,this,ff).call(this,Number(e.target.dataset.index))}),f(this,Xd,e=>{if(e.target!==this.popoverElement)return;let t=m(q,this).getAttribute(`aria-label`)??wd;u(Y,this,yf).call(this),h(J,this,null),u(Y,this,vf).call(this),u(Y,this,bf).call(this,t===wd?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(Y,this,Qd).call(this),this.hasUpdated&&u(Y,this,ef).call(this)}disconnectedCallback(){u(Y,this,nf).call(this),m(q,this)?.remove(),m(Fd,this)!==null&&(clearTimeout(m(Fd,this)),h(Fd,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(Y,this,ef).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(Od,this)!==u(Y,this,$d).call(this)&&u(Y,this,ef).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(J,this)){let e=m(q,this).querySelector(`[aria-selected="true"]`),t=e?m(jd,this)[Number(e.dataset.index)]:void 0;u(Y,this,cf).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${Ed}
        @craft-hide=${m(Xd,this)}
      >
    ...
    `}};function Qd(){h(q,this,document.createElement(`div`)),m(q,this).id=`craft-text-expander-listbox-${++Dd}`,m(q,this).slot=`listbox`,m(q,this).setAttribute(`part`,`listbox`),m(q,this).role=`listbox`,m(q,this).setAttribute(`aria-label`,wd),m(q,this).addEventListener(`pointerdown`,m(qd,this)),m(q,this).addEventListener(`pointerup`,m(Jd,this)),m(q,this).addEventListener(`combobox-commit`,m(Yd,this)),this.append(m(q,this))}function $d(){return this.getRootNode().getElementById(this.for)}function ef(){let e=u(Y,this,$d).call(this);if(u(Y,this,nf).call(this),!Sf(e)){u(Y,this,tf).call(this);return}h(Od,this,e),u(Y,this,rf).call(this,e),h(kd,this,new ld(e,m(q,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(Y,this,af).call(this,e),e.addEventListener(`input`,m(Bd,this)),e.addEventListener(`keydown`,m(Kd,this)),e.addEventListener(`blur`,m(Ud,this)),e.addEventListener(`compositionstart`,m(Vd,this)),e.addEventListener(`compositionend`,m(Hd,this)),e.ownerDocument.addEventListener(`selectionchange`,m(Wd,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(Rd,this)},u(Y,this,tf).call(this)}function tf(){m(zd,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function nf(){m(zd,this).disconnect(),u(Y,this,gf).call(this);let e=m(Od,this);e&&(e.removeEventListener(`input`,m(Bd,this)),e.removeEventListener(`keydown`,m(Kd,this)),e.removeEventListener(`blur`,m(Ud,this)),e.removeEventListener(`compositionstart`,m(Vd,this)),e.removeEventListener(`compositionend`,m(Hd,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(Wd,this)),m(Ld,this)?.getStyleClone().disconnect(),h(Ld,this,null),m(kd,this)?.destroy(),h(kd,this,null),u(Y,this,of).call(this,e),h(Od,this,null))}function rf(e){m(Ad,this).clear();for(let t of Td)m(Ad,this).set(t,e.getAttribute(t))}function af(e){let t=[m(Ad,this).get(`aria-controls`),m(q,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(Y,this,sf).call(this,e,`aria-haspopup`),u(Y,this,sf).call(this,e,`aria-expanded`)}function of(e){for(let t of Td)u(Y,this,sf).call(this,e,t);m(Ad,this).clear()}function sf(e,t){let n=m(Ad,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function cf(e){u(Y,this,yf).call(this);let t=u(Y,this,uf).call(this);if(!t){h(J,this,null),u(Y,this,_f).call(this);return}h(J,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(Y,this,df).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(Y,this,df).call(this,[]),u(Y,this,bf).call(this,O(`Loading`));let r=m(Md,this);h(Pd,this,setTimeout(()=>{u(Y,this,lf).call(this,t,n,r,e)},150))}async function lf(e,t,n,r){h(Nd,this,new AbortController);let i;try{let n=await _e.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(Nd,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(Md,this)||wf(t))return;u(Y,this,gf).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(Md,this)&&(this.loading=!1,u(Y,this,df).call(this,t===void 0?i:i.slice(0,t),r))}function uf(){let e=m(Od,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!Cf(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&Cd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function df(e,t){if(u(Y,this,mf).call(this),h(jd,this,e),m(q,this).replaceChildren(),m(q,this).hidden=this.loading,m(q,this).setAttribute(`aria-label`,m(J,this)?.trigger.label??wd),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=xf(e);n.id=`${m(q,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(J,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(q,this).append(n)}),!this.loading&&!e.length){h(J,this,null),u(Y,this,_f).call(this),u(Y,this,bf).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(J,this)&&u(Y,this,pf).call(this,t)})}function ff(e){let t=m(Od,this),n=m(jd,this)[e],r=u(Y,this,uf).call(this),i=m(J,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(Y,this,gf).call(this);return}Tf(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(Y,this,gf).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function pf(e){await this.popoverElement.updateComplete;let t=m(Od,this);if(!t||!u(Y,this,hf).call(this)){u(Y,this,gf).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(J,this)||t!==m(Od,this))&&m(jd,this).length&&(m(kd,this)?.start(),u(Y,this,sf).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(Bd,this)),t.addEventListener(`input`,m(Bd,this)),e)){let t=m(jd,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(kd,this)?.navigate(1)}}function mf(){m(kd,this)?.stop(),m(Od,this)&&u(Y,this,sf).call(this,m(Od,this),`aria-expanded`)}function hf(){let e=m(Od,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(Ld,this)){h(Ld,this,new xd(e));let t=m(Ld,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(Gd,this))}return m(Ld,this).setStartOffset(t),m(Ld,this).setEndOffset(t),h(Rd,this,m(Ld,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function gf(){u(Y,this,yf).call(this),h(J,this,null),u(Y,this,_f).call(this)}function _f(){u(Y,this,vf).call(this),this.popoverElement.hide()}function vf(){this.loading=!1,u(Y,this,mf).call(this),h(jd,this,[]),m(q,this)?.replaceChildren(),m(q,this)&&(m(q,this).hidden=!1);let e=m(Od,this);e&&(u(Y,this,sf).call(this,e,`aria-activedescendant`),u(Y,this,sf).call(this,e,`aria-busy`))}function yf(){var e;h(Md,this,(e=m(Md,this),e++,e)),m(Pd,this)&&(clearTimeout(m(Pd,this)),h(Pd,this,null)),m(Nd,this)?.abort(),h(Nd,this,null)}function bf(e){m(Fd,this)!==null&&(clearTimeout(m(Fd,this)),h(Fd,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(Fd,this,setTimeout(()=>{h(Fd,this,null),this.announcement=``},5e3))}Zd.styles=[Mt,Sd],p([g({reflect:!0})],Zd.prototype,`for`,void 0),p([g({type:Array})],Zd.prototype,`triggers`,void 0),p([_()],Zd.prototype,`loading`,void 0),p([_()],Zd.prototype,`announcement`,void 0),p([y(`craft-popover`)],Zd.prototype,`popoverElement`,void 0);function xf(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function Sf(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function Cf(e){return e.getRootNode().activeElement===e}function wf(e){return e instanceof DOMException&&e.name===`AbortError`}function Tf(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Zd);var Ef=a`
  :host {
    display: inline-flex;
...
`,Df=new WeakMap,Of=new WeakSet,kf=class extends l{constructor(...e){super(...e),d(this,Of),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,f(this,Df,typeof ResizeObserver<`u`?new ResizeObserver(()=>u(Of,this,Af).call(this)):null)}connectedCallback(){super.connectedCallback(),m(Df,this)?.observe(this)}disconnectedCallback(){m(Df,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){u(Of,this,Af).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${u(Of,this,jf)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function Af(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function jf(){u(Of,this,Af).call(this)}kf.styles=Ef,p([g({reflect:!0})],kf.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],kf.prototype,`disabled`,void 0),p([_()],kf.prototype,`overflowing`,void 0),p([_()],kf.prototype,`text`,void 0),p([y(`.truncate`)],kf.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,kf);var Mf=a`
  :host {
...
`,Nf={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},Pf=class extends l{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs()}render(){return r`
      <div class="${S({thumbnail:!0,"thumbnail--checkered":this.checkered,"thumbnail--rounded":this.rounded,"thumbnail--crop":this.mode===`crop`,"thumbnail--stretch":this.mode===`stretch`})}" part="thumbnail">
        ${this.src?r`<img
              ...
              part="image"
              src="${this.src}"
              srcset="${re(this.srcset??void 0)}"
              sizes="${re(this.sizes??void 0)}"
              width="${re(this.width??void 0)}"
              height="${re(this.height??void 0)}"
              alt="${this.alt}"
    ...
    `}};Pf.styles=[Mf],p([g()],Pf.prototype,`src`,void 0),p([g({reflect:!0})],Pf.prototype,`mode`,void 0),p([g()],Pf.prototype,`srcset`,void 0),p([g()],Pf.prototype,`sizes`,void 0),p([g()],Pf.prototype,`alt`,void 0),p([g({type:Number})],Pf.prototype,`width`,void 0),p([g({type:Number})],Pf.prototype,`height`,void 0),p([g()],Pf.prototype,`loading`,void 0),p([g({reflect:!0,converter:Nf})],Pf.prototype,`checkered`,void 0),p([g({type:Boolean,reflect:!0})],Pf.prototype,`rounded`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,Pf);var Ff=new WeakMap,If=new WeakSet,Lf=class extends HTMLElement{constructor(...e){super(...e),d(this,If),f(this,Ff,null)}connectedCallback(){u(If,this,Rf).call(this)}disconnectedCallback(){m(Ff,this)?.destroy(),h(Ff,this,null)}};function Rf(){if(!(m(Ff,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>u(If,this,Rf).call(this));return}h(Ff,this,new Ca),m(Ff,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Lf);var zf=!1,Bf=null;async function Vf(e){if(!zf){if(Bf)return Bf;zf=!0;try{return(await _e.post(`app/api-headers`,void 0,{cancelToken:e})).data}catch{}finally{zf=!1}}}var Hf=x.create({baseURL:`https://api.craftcms.com/v1/`});async function Uf(e){return Bf?Object.entries(Bf).forEach(([t,n])=>{e.headers.set(t,n)}):(e.params=e.params||{},e.params.processCraftHeaders=1),e}async function Wf(e,t){if(Bf)return;let{data:n}=await _e.post(`app/process-api-response-headers`,{headers:e},{cancelToken:t});return Bf=n,zf=!1,Bf}async function Gf(e){return await Wf(e.headers,e.config.cancelToken),e}Hf.interceptors.request.use(async e=>{let{cancelToken:t}=e,n=await Vf(t);n&&Object.entries(n).forEach(([t,n])=>{e.headers.set(t,n)});let r={...e,params:{...Cp.apiParams||{},...e.params,v:new Date().getTime()}};return n||(r.params.processCraftHeaders=1),Cp.httpProxy&&(r.proxy=Cp.httpProxy),r}),Hf.interceptors.request.use(Uf),Hf.interceptors.response.use(Gf);function Kf(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function qf(e={}){let t=Kf({...e,type:`submit`,label:e.label||O(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function Jf(e={}){let t=Kf({...e,icon:`duplicate`,label:e.label||ba(O(`Paste {type}`,{type:O(`elements`)}))});return t.classList.add(`paste-btn`),t}var Yf=async(e,t)=>{let{data:n}=await _e.post(e,t);return n},Xf=new WeakMap,Zf=new WeakMap,Qf=new WeakMap,$f=new WeakMap,ep=new WeakMap,tp=new WeakMap,np=new WeakMap,rp=new WeakMap,ip=new WeakMap,ap=new WeakMap,X=new WeakSet,op=class e{constructor(t){d(this,X),f(this,Xf,null),f(this,Zf,[]),f(this,Qf,[]),f(this,$f,null),f(this,ep,!1),f(this,tp,!1),f(this,np,!1),f(this,rp,null),f(this,ip,void 0),f(this,ap,new Map),this.options={...e.defaults,modalTitle:O(`Select element`),selectBtnLabel:O(`Select`),...dp(t)},h(Qf,this,[...this.options.disabledElementIds??[]]),h(ip,this,u(X,this,sp).call(this))}get elementType(){return this.options.elementType}get state(){return m(ip,this)}get index(){return m(Xf,this)}get hasSelection(){return m(Zf,this).length>0}on(e,t){let n=m(ap,this).get(e);return n||(n=new Set,m(ap,this).set(e,n)),n.add(t),()=>{m(ap,this).get(e)?.delete(t)}}async open(){h(Zf,this,[]),m(Xf,this)?.clearSelection(),m(ep,this)||(h(ep,this,!0),u(X,this,up).call(this,`open`,void 0)),u(X,this,cp).call(this),m($f,this)||await this.reload()}close(){m(ep,this)&&(h(ep,this,!1),u(X,this,up).call(this,`close`,void 0),this.options.onClose?.(),u(X,this,cp).call(this))}destroy(){m(Xf,this)?.destroy?.(),h(Xf,this,null),h(Zf,this,[]),h($f,this,null),h(ep,this,!1),h(np,this,!1),h(tp,this,!1),h(rp,this,null),u(X,this,cp).call(this),m(ap,this).clear()}async reload(){let e=this.options.loadIndexBody??Yf;h(tp,this,!0),h(rp,this,null),u(X,this,cp).call(this);try{h($f,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){u(X,this,lp).call(this,e)}finally{h(tp,this,!1),u(X,this,cp).call(this)}}async submit(){if(!m(ip,this).canSubmit)return;let e=this.buildElementInfo(m(Zf,this)),t=this.selectMeta();h(np,this,!0),u(X,this,cp).call(this);try{u(X,this,up).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){u(X,this,lp).call(this,e);return}finally{h(np,this,!1),u(X,this,cp).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...m(Qf,this),...e.map(e=>Number(e.id))]),m(Xf,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){m(ip,this).canCancel&&(u(X,this,up).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){h(Xf,this,e),u(X,this,cp).call(this)}detachIndex(){h(Xf,this,null),u(X,this,cp).call(this)}setSelection(e){h(Zf,this,[...e]),u(X,this,cp).call(this)}setDisabledElementIds(e){h(Qf,this,[...new Set(e.map(Number))]),u(X,this,cp).call(this)}setBusy(e){h(np,this,e),u(X,this,cp).call(this)}indexParams(){let{options:e}=this,t={context:`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition,criteria:{...e.criteria}};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),e.criteria&&(t.criteria={...e.criteria}),typeof e.indexSettings.showFolders==`boolean`&&(t.showFolders=e.indexSettings.showFolders),t}indexSettings(){let{options:e}=this;return{context:`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...m(Qf,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return m(Zf,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){u(X,this,cp).call(this)}get selection(){return m(Zf,this)}get disabledElementIds(){return m(Qf,this)}};function sp(){let e=m(np,this),t=m(tp,this);return Object.freeze({open:m(ep,this),loading:t,busy:e,selection:Object.freeze([...m(Zf,this)]),disabledElementIds:Object.freeze([...m(Qf,this)]),indexBody:m($f,this),error:m(rp,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function cp(){h(ip,this,u(X,this,sp).call(this)),u(X,this,up).call(this,`change`,m(ip,this))}function lp(e){h(rp,this,e instanceof Error?e:Error(String(e??`Unknown`))),u(X,this,up).call(this,`error`,m(rp,this))}function up(e,t){let n=m(ap,this).get(e);n&&[...n].forEach(e=>e(t))}op.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function dp(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var fp=async(e,t)=>{let{data:n}=await _e.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},pp=new WeakMap,mp=class e extends op{constructor(e){super(e),f(this,pp,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??fp;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}h(pp,this,t);try{await this.submit()}finally{h(pp,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!m(pp,this))return n;let r=e.transformUrls[m(pp,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:m(pp,this)}}};mp.transformUrls={};var hp=`CraftCms\\Cms\\Asset\\Elements\\Asset`,gp=new WeakSet,_p=class extends op{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:hp,showSiteMenu:!1}),d(this,gp),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:u(gp,this,vp).call(this),status:null,url:null,hasThumb:!1}]}};function vp(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var yp=new Map;function bp(e,t){if(yp.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);yp.set(e,t)}function xp(e){return yp.has(e)}function Sp(e){return yp.get(e)??op}function wp(e){return new(Sp(e.elementType))(e)}function Tp(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))yp.has(t)||yp.set(t,n)}var Ep={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},Dp=new WeakMap,Op=new WeakMap,kp=new WeakMap,Ap=new WeakMap,jp=new WeakMap,Mp=new WeakMap,Np=new WeakMap,Z=new WeakSet,Pp=class{constructor(e={}){d(this,Z),f(this,Dp,new Map),f(this,Op,null),f(this,kp,0),f(this,Ap,[]),f(this,jp,[]),f(this,Mp,new Set),f(this,Np,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)m(Dp,this).set(e.id,e);r&&(u(Z,this,Rp).call(this),m(Op,this)!==null&&u(Z,this,zp).call(this))}getSessions(){return Array.from(m(Dp,this).values())}getCurrentSessionId(){return m(Op,this)}isProcessing(){return m(kp,this)>0}on(e,t){return m(Np,this).has(e)||m(Np,this).set(e,new Set),m(Np,this).get(e).add(t),()=>{m(Np,this).get(e)?.delete(t)}}async startIndexing(e){let t=await _e.post(Ep.START,e),{data:n}=t;return n.session&&(m(Dp,this).set(n.session.id,n.session),h(Op,this,n.session.id),u(Z,this,Ip).call(this),n.stop||u(Z,this,zp).call(this)),n.stop&&u(Z,this,Lp).call(this,n.stop),t}stopSession(e){u(Z,this,Bp).call(this,e),u(Z,this,Vp).call(this,{sessionId:e,action:Ep.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){u(Z,this,Vp).call(this,{sessionId:e,action:Ep.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){u(Z,this,Vp).call(this,{sessionId:e.sessionId,action:Ep.FINISH,params:e,priority:!0})}destroy(){m(Dp,this).clear(),h(Ap,this,[]),h(jp,this,[]),m(Np,this).clear(),h(Op,this,null),h(kp,this,0)}};function Fp(e,t){m(Np,this).get(e)?.forEach(e=>e(t))}function Ip(e){u(Z,this,Fp).call(this,`change`,{sessions:this.getSessions(),currentSessionId:m(Op,this),reviewSessionId:e})}function Lp(e){m(Dp,this).delete(e),m(Op,this)===e&&h(Op,this,null),u(Z,this,Ip).call(this)}function Rp(){for(let[e,t]of m(Dp,this))if(!t.actionRequired&&!m(Mp,this).has(e)){h(Op,this,e);return}h(Op,this,null)}function zp(){if(m(Op,this)||u(Z,this,Rp).call(this),!m(Op,this))return;let e=m(Dp,this).get(m(Op,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-m(kp,this),r=Math.min(n,t);for(let t=0;t<r;t++)u(Z,this,Vp).call(this,{sessionId:e.id,action:Ep.PROCESS,params:{sessionId:m(Op,this)},priority:!1});e.processIfRootEmpty&&u(Z,this,Vp).call(this,{sessionId:e.id,action:Ep.PROCESS,params:{sessionId:m(Op,this)},priority:!1})}function Bp(e){m(Mp,this).add(e),h(Ap,this,m(Ap,this).filter(t=>t.sessionId!==e))}function Vp(e){e.priority?m(jp,this).push(e):m(Ap,this).push(e),u(Z,this,Hp).call(this)}function Hp(){if(!(m(Ap,this).length+m(jp,this).length===0||m(kp,this)>=this.maxConcurrentConnections))for(;m(Ap,this).length+m(jp,this).length>0&&m(kp,this)<this.maxConcurrentConnections;){var e;h(kp,this,(e=m(kp,this),e++,e));let t=m(jp,this).length>0?m(jp,this).shift():m(Ap,this).shift();u(Z,this,Up).call(this,t)}}async function Up(e){try{let t=await _e.post(e.action,e.params);u(Z,this,Wp).call(this,t.data)}catch(t){u(Z,this,Gp).call(this,t,e)}finally{var t;h(kp,this,(t=m(kp,this),t--,t)),u(Z,this,Hp).call(this)}}function Wp(e){let t;e.session&&(m(Dp,this).set(e.session.id,e.session),u(Z,this,Rp).call(this),e.session.actionRequired&&!e.skipDialog?m(Mp,this).has(e.session.id)||(t=e.session.id):m(Mp,this).has(e.session.id)||u(Z,this,zp).call(this)),u(Z,this,Rp).call(this),e.stop&&(m(Dp,this).delete(e.stop),m(Op,this)===e.stop&&h(Op,this,null)),u(Z,this,Ip).call(this,t),m(Dp,this).size===0&&u(Z,this,Fp).call(this,`complete`,{})}function Gp(e,t){u(Z,this,Rp).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;u(Z,this,Fp).call(this,`error`,{message:n,sessionId:t.sessionId}),u(Z,this,Hp).call(this)}var Kp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},qp=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Jp,Yp=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Xp=typeof Intl<`u`&&Intl.ListFormat||Yp,Zp=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],Qp={minimumIntegerDigits:2},$p=class{constructor(e,t={}){Jp.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Kp(this,Jp,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return qp(this,Jp,`f`)}formatToParts(e){let t=[],n=qp(this,Jp,`f`),r=n.style,i=n.locale;for(let[a,o]of Zp){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?Qp:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Xp(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Jp=new WeakMap;var em=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,tm=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],nm=e=>em.test(e),rm=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(em)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(im(r,e.from(t)).getTime()-r),a=Math.abs(im(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new $p(e,t).format(this)}};function im(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function am(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new rm;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=tm.indexOf(t)||tm.length;return new rm(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function om(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new rm(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function sm(e,t){let n=om(e,t);if(n.blank)return[0,`second`];for(let e of tm){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},cm=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,lm,um,dm,fm,pm,mm,hm,gm,_m,vm,ym,bm,xm,Sm,Cm,wm=globalThis.HTMLElement||null,Tm=new rm,Em=new rm(0,0,0,0,0,1),Dm=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function Om(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var km=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=Om(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,Om(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},Am=class extends wm{constructor(){super(...arguments),$.add(this),lm.set(this,!1),um.set(this,!1),fm.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),Cm.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,Cm,`f`)}set onRelativeTimeUpdated(e){Q(this,Cm,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,Cm,`f`)),cm(this,Cm,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&nm(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return tm.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){km.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&cm(this,lm,n!==null&&(this.date&&Q(this,$,`m`,pm).call(this,this.date))!==n,`f`),!Q(this,um,`f`)&&!(e===`title`&&Q(this,lm,`f`))&&cm(this,um,(async()=>{await Promise.resolve(),this.update(),cm(this,um,!1,`f`)})(),`f`))}update(){let e=Q(this,fm,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,fm,`f`).textContent=e;return}let i=Date.now();Q(this,lm,`f`)||(n=Q(this,$,`m`,pm).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=am(r,this.precision,i),o=Q(this,$,`m`,mm).call(this,a),s=e,c=Q(this,$,`m`,Sm).call(this,o);s=c?Q(this,$,`m`,bm).call(this,r):o===`duration`?Q(this,$,`m`,hm).call(this,a):o===`relative`?Q(this,$,`m`,gm).call(this,a):Q(this,$,`m`,_m).call(this,r),s?Q(this,$,`m`,xm).call(this,s):this.shadowRoot===Q(this,fm,`f`)&&this.textContent&&Q(this,$,`m`,xm).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new Dm(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,vm).call(this,r)||Q(this,$,`m`,ym).call(this,r))?km.observe(this):km.unobserve(this)}};lm=new WeakMap,um=new WeakMap,fm=new WeakMap,Cm=new WeakMap,$=new WeakSet,dm=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},pm=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,dm),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},mm=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||rm.compare(e,this.threshold)===1)return`relative`}return`datetime`},hm=function(e){let t=Q(this,$,`a`,dm),n=this.format,r=this.formatStyle,i=this.tense,a=Tm;n===`micro`?(e=om(e),a=Em,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=Em)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},gm=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,dm),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=Tm),n===`past`&&e.sign!==-1&&(e=Tm);let[r,i]=sm(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},_m=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,dm),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},vm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,dm),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},ym=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,dm),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},bm=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,vm).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,dm),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,dm))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,dm),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,ym).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,dm),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,dm),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},xm=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,fm,`f`).replaceChildren(t)}else Q(this,fm,`f`).textContent=e},Sm=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var jm=typeof globalThis<`u`?globalThis:window;try{jm.RelativeTimeElement=Am.define()}catch(e){if(!(jm.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{na as A,he as B,ya as C,la as D,ga as E,vt as F,yt as I,ut as L,or as M,Mt as N,pa as O,xt as P,_e as R,ba as S,va as T,ic as _,xp as a,so as b,op as c,qf as d,Hf as f,uc as g,sl as h,Tp as i,ki as j,ua as k,Jf as l,$l as m,wp as n,_p as o,ad as p,bp as r,mp as s,Pp as t,Kf as u,B as v,_a as w,Ca as x,Cs as y,ve as z};
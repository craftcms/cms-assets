...
`,ko=class extends k{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??s(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),r=t?n?`arrow-right`:`arrow-left`:`arrow-up`,i=t?n?`arrow-left`:`arrow-right`:`arrow-down`,a=s(t?`Move forward`:`Move up`),o=s(t?`Move backward`:`Move down`);return E`
    ...
    `}};ko.styles=[Oo],A([j()],ko.prototype,`label`,void 0),A([j({reflect:!0})],ko.prototype,`position`,void 0),A([j({reflect:!0})],ko.prototype,`orientation`,void 0),A([j({reflect:!0})],ko.prototype,`variant`,void 0),A([j({reflect:!0,type:Boolean})],ko.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,ko);var Ao=class extends De(g){static get styles(){return[...super.styles,D`
        :host {
          justify-content: space-between;
          align-items: center;
        }

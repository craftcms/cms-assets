...
`;function de(e){return(t,n)=>{let{slot:r,selector:i}=e??{},a=`slot`+(r?`[name=${r}]`:`:not([name])`);return v(t,n,{get(){let t=(this.renderRoot?.querySelector(a))?.assignedElements(e)??[];return i===void 0?t:t.filter((e=>e.matches(i)))}})}}var fe=class extends l{constructor(){super(),this.alt=!1,this.shift=!1,this.os=`Unknown`,this.os=this.detectOS()}connectedCallback(){super.connectedCallback(),this.os===`Unknown`&&(this.os=this.detectOS())}detectOS(){let e=navigator.platform.toLowerCase();return e.includes(`mac`)||/iphone|ipad|ipod/.test(e)?`Mac`:e.includes(`win`)?`Windows`:e.includes(`linux`)?`Linux`:`Unknown`}renderShortcutPrefix(){switch(this.os){case`Mac`:return`${this.alt?`⌥`:``}${this.shift?`⇧`:``}⌘`;case`Linux`:return`Super+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`;default:return`Ctrl+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`}}render(){return r`<span class="shortcut"
  ...
  `,p([g({type:Boolean})],fe.prototype,`alt`,void 0),p([g({type:Boolean})],fe.prototype,`shift`,void 0),p([g()],fe.prototype,`os`,void 0),customElements.get(`craft-shortcut`)||customElements.define(`craft-shortcut`,fe);var pe=class{constructor(){this.refreshPromise=null,this.tokenName=null,this.tokenValue=null,this.refreshPromise=null}async getToken(){return this.tokenValue||await this.refreshToken(),this.tokenValue}async refreshToken(){return this.refreshPromise||=ge.get(`users/session-info`).then(({data:e})=>{let{csrfTokenName:t,csrfTokenValue:n}=e;if(this.tokenName=t??null,this.tokenValue=n??null,t&&n){let e=b.getInstance();e.set(`csrfTokenName`,t),e.set(`csrfTokenValue`,n),x.defaults.headers.common[`X-CSRF-TOKEN`]=n;let r=window.Craft;r&&(r.csrfTokenValue=n),document.querySelectorAll(`input[type="hidden"]`).forEach(e=>{e.name===t&&(e.value=e.defaultValue=n)})}return this.tokenValue}).finally(()=>{this.refreshPromise=null}),this.refreshPromise}clearToken(){this.tokenValue=null}};function me(e=``){return b.getInstance().getActionUrl(e)}function he(){let e=window.Craft,t=e?.registeredAssetBundles??Cp.registeredAssetBundles,n=e?.registeredJsFiles??Cp.registeredJsFiles;return{"X-Registered-Asset-Bundles":[...new Set(t)].join(`,`),"X-Registered-Js-Files":[...new Set(n)].join(`,`)}}var ge=x.create(),_e=new pe;ge.interceptors.request.use(async e=>{e.url&&!e.url.startsWith(`/`)&&!/^[a-z][a-z\d+.-]*:/i.test(e.url)?e.url=me(e.url):e.url?.startsWith(`/`)&&(e.baseURL=new URL(me()).origin),e.headers.set(`X-Requested-With`,`XMLHttpRequest`);let t=he();return Object.entries(t).forEach(([t,n])=>{e.headers.set(t,n)}),e}),ge.interceptors.response.use(e=>e,async e=>{let t=e.config;if(e.response?.status===419||e.response?.status===403&&!t._retry){t._retry=!0;try{return _e.clearToken(),t.headers[`X-CSRF-Token`]=await _e.refreshToken(),x(t)}catch(e){return console.error(`Failed to refresh CSRF token:`,e),Promise.reject(e)}}return Promise.reject(e)});function ve(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return null}}async function ye(e,t={}){switch(e.type){case`clipboard`:await navigator.clipboard.writeText(e.value);break;case`http`:{if(e.confirm&&!confirm(e.confirm))return;let t=await fetch(e.url,{method:e.method||`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:e.body?JSON.stringify(e.body):void 0}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(n.message??`Request failed`);typeof n.redirect==`string`&&n.redirect&&be(n.redirect);break}case`event`:if(e.confirm&&!confirm(e.confirm))return;window.dispatchEvent(new CustomEvent(e.name,{detail:{...e.detail??{},...t.trigger?{trigger:t.trigger}:{},...t.sourceEvent?{sourceEvent:t.sourceEvent}:{}}}));break;case`download`:{if(e.confirm&&!confirm(e.confirm))return;if(e.method&&e.method!==`GET`){let t=await ge.request({url:e.url,method:e.method,data:e.body,responseType:`blob`}),n=String(t.headers[`content-disposition`]??``),r=/filename\*?=(?:UTF-8'')?"?([^";]+)"?/i.exec(n),i=e.filename??(r?.[1]?decodeURIComponent(r[1]):`download`),a=URL.createObjectURL(t.data),o=document.createElement(`a`);o.href=a,o.download=i,document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(a);break}let t=document.createElement(`a`);t.href=e.url,t.download=e.filename??``,t.click();break}default:throw Error(`Unknown action type: ${e.type}`)}}function be(e){window.dispatchEvent(new CustomEvent(`action:redirect`,{cancelable:!0,detail:{url:e}}))&&window.location.assign(e)}var xe={Neutral:`neutral`,Success:`success`,Warning:`warning`,Danger:`danger`,Info:`info`},Se=Object.values(xe),Ce={Idle:`idle`,Loading:`loading`,Success:`success`,Error:`error`},we=a`
  :host {
    display: contents;
  }
...
`,A=class extends l{constructor(...e){super(...e),this.icon=null,this.iconColor=null,this.href=null,this.target=null,this.rel=null,this.disabled=!1,this.variant=xe.Neutral,this.checked=!1,this.active=!1,this.type=`button`,this.action=null,this.feedback=null,this.feedbackDuration=1e3,this.confirm=null,this.state=Ce.Idle,this.feedbackMessage=null,this.shortcut=null}renderShortcut(){return typeof this.shortcut==`string`?r`<craft-shortcut>${this.shortcut}</craft-shortcut>`:this.shortcut===null?c:r`<craft-shortcut
        ?alt="${this.shortcut.alt??!1}"
        ?shift="${this.shortcut.shift??!1}"
        >${this.shortcut.key}</craft-shortcut
      >`}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this)}setState(e,t={}){this.state=e,this.feedbackMessage=t.message??null,this.dispatchEvent(new CustomEvent(`action:change-state`,{bubbles:!0,composed:!0,detail:{state:e,actionType:ve(this.action)?.type,...t}}))}async handleEvent(e){if(this.disabled){e.preventDefault();return}let t=ve(this.action);if(e.type===`click`&&t){t.type===`http`&&this.setState(Ce.Loading);try{await ye(t,{trigger:this,sourceEvent:e}),this.setState(Ce.Success,this.feedback?.success)}catch(e){this.setState(Ce.Error,{message:e.message,...this.feedback?.error||{}})}finally{setTimeout(()=>{this.setState(Ce.Idle)},this.feedbackDuration)}}}renderCheckbox(){return r`<span class="action-item__check">
      <slot name="checkmark">
        ${this.checked?r`<craft-icon name="check"></craft-icon>`:c}
      </slot>
    </span>`}renderIcon(){switch(this.state){case Ce.Loading:return r`<craft-spinner style="--size: 0.8em"></craft-spinner>`;case Ce.Success:return r`<craft-icon
          name="check"
          style="color: var(--c-color-success-on-normal)"
        ></craft-icon>`;case Ce.Error:return r`<craft-icon
          name="xmark"
          style="color: var(--c-color-danger-on-normal)"
        ></craft-icon>`;default:return r`
          <slot name="icon">
            ${this.icon?r`<craft-icon
                  name="${this.icon}"
                  style="${this.iconColor?`color: var(--c-color-${this.iconColor}-on-normal, currentColor)`:c}"
                ></craft-icon>`:c}
          </slot>
        `}}renderPrefix(){let e=!!this.querySelector(`[slot="icon"]`)||!!this.icon,t=!!this.querySelector(`[slot="prefix"]`);return r`
      ${this.type===`checkbox`?this.renderCheckbox():c}
      ${t?r`<slot name="prefix" part="prefix"></slot>`:c}
      ${e?r`<div class="action-item__icon">${this.renderIcon()}</div>`:c}
    `}renderBody(){return r`
      ${this.renderPrefix()}

      <span class="action-item__label">
        ${this.feedbackMessage?this.feedbackMessage:r`<slot></slot>`}
      </span>
    ...
    `}render(){return this.href?r`
          <a
            ...
            rel="${D(this.rel??(this.target===`_blank`?`noopener`:null)??void 0)}"
          >
            ${this.renderBody()}
          </a>
        `:r`
    ...
    `],Ge._filterableItemsSelector=`craft-action-item, li, button`,p([g({attribute:!1})],Ge.prototype,`actions`,void 0),p([g()],Ge.prototype,`label`,void 0),p([g()],Ge.prototype,`icon`,void 0),p([g({type:Boolean,reflect:!0})],Ge.prototype,`disabled`,void 0),p([g({type:Boolean,reflect:!0})],Ge.prototype,`searchable`,void 0),p([de({slot:`invoker`})],Ge.prototype,`invokerNodes`,void 0),p([de({slot:`content`})],Ge.prototype,`contentNodes`,void 0),customElements.get(`craft-action-menu`)||customElements.define(`craft-action-menu`,Ge);var Ke=a`
  :host {
    --color-start: red;
    --color-end: blue;
    --color-text: inherit;
...
`,qe=class extends l{constructor(...e){super(...e),this.label=null,this._gradientId=null}connectedCallback(){super.connectedCallback(),this._gradientId=`avatar-gradient-${Math.random().toString(36).slice(2,8)}`}text(){return this.label?this.label.split(` `).map(e=>e.charAt(0).toUpperCase()).join(``):`?`}render(){return r`
      <span class="avatar">
        <svg
          viewBox="0 0 100 100"
    ...
    `}};qe.styles=[Ke],p([g()],qe.prototype,`label`,void 0),p([_()],qe.prototype,`_gradientId`,void 0),customElements.get(`craft-avatar`)||customElements.define(`craft-avatar`,qe);var Je=[`red`,`orange`,`amber`,`yellow`,`lime`,`green`,`emerald`,`teal`,`cyan`,`sky`,`blue`,`indigo`,`violet`,`purple`,`fuchsia`,`pink`,`rose`,`white`,`gray`,`black`,`slate`],Ye={neutral:`slate`,accent:`blue`,info:`sky`,success:`emerald`,warning:`yellow`,danger:`red`},Xe={pending:`orange`,off:`red`,suspended:`red`,expired:`red`,disabled:`gray`,inactive:`gray`,on:`emerald`},Ze=e=>e.charAt(0).toUpperCase()+e.slice(1),Qe={...Object.fromEntries(Je.map(e=>[Ze(e),e])),...Object.fromEntries(Object.entries(Ye).map(([e,t])=>[Ze(e),t])),...Object.fromEntries(Object.entries(Xe).map(([e,t])=>[Ze(e),t]))},$e=[...Je],et=class extends l{constructor(...e){super(...e),this.size=`md`,this.fill=`var(--c-color-fill-loud)`,this.label=null,this.appearance=oe.OutlineFill}getFill(){return $e.includes(this.fill)||Se.includes(this.fill)?`var(--c-color-${this.fill}-fill-loud)`:this.fill}getSize(){switch(this.size){case`md`:return`0.6em`;case`lg`:return`1em`;default:return this.size}}render(){return r`<span
      style="--fill: ${this.getFill()}; --size: ${this.getSize()}"
      aria-label="${this.label??c}"
      role="${this.label?`img`:c}"
      class="${S({indicator:!0,"indicator--outline":this.appearance===oe.Outline})}"
    ></span>`}};et.styles=[ue,a`
      :host {
        display: contents;
      }
    ...
    `],p([g()],et.prototype,`size`,void 0),p([g({reflect:!0})],et.prototype,`fill`,void 0),p([g()],et.prototype,`label`,void 0),p([g({reflect:!0})],et.prototype,`appearance`,void 0),customElements.get(`craft-indicator`)||customElements.define(`craft-indicator`,et);var tt=a`
  :host {
    display: inline-flex;
  }
...
`,nt={Small:`small`,Medium:`medium`,Large:`large`};Object.values(nt);var rt=class extends l{constructor(...e){super(...e),this.fill=Qe.Gray,this.noPrefix=!1,this.size=nt.Medium}getFill(){return this.fill}willUpdate(e){e.has(`fill`)&&(this.dataset.color=this.getFill())}render(){return r`
      <span
        part="badge"
        class="${S({badge:!0,"badge--small":this.size===nt.Small,"badge--large":this.size===nt.Large})}"
      >
        <span class="badge__prefix">
          ${this.noPrefix?c:r` <slot name="prefix" part="prefix">
                <craft-indicator
                  part="indicator"
                  fill="${this.getFill()}"
                ></craft-indicator>
    ...
    `}};rt.styles=[tt],p([g({reflect:!0})],rt.prototype,`fill`,void 0),p([g({attribute:`no-prefix`,type:Boolean})],rt.prototype,`noPrefix`,void 0),p([g()],rt.prototype,`size`,void 0),customElements.get(`craft-badge`)||customElements.define(`craft-badge`,rt);var it=class extends l{constructor(...e){super(...e),this.rel=`noreferrer noopener`}render(){return r`
      ...
      ${this.href?r`<a
          ...
          rel=${this.target?this.rel:c}
          ><slot></slot
        ></a>`:r`<span part="label" class="label"><slot></slot></span>`}
      <slot name="suffix" part="suffix"></slot>
  ...
  `,p([g({reflect:!0})],it.prototype,`href`,void 0),p([g()],it.prototype,`target`,void 0),p([g()],it.prototype,`rel`,void 0),customElements.get(`craft-breadcrumb-item`)||customElements.define(`craft-breadcrumb-item`,it);var at=class{constructor(){this.__iconResolvers=new Map}addIconResolver(e,t){if(this.__iconResolvers.has(e))throw Error(`An icon resolver has already been registered for namespace: ${e}`);this.__iconResolvers.set(e,t)}removeIconResolver(e){this.__iconResolvers.delete(e)}resolveIcon(e,t,n){let r=this.__iconResolvers.get(e);if(r)return r(t,n);throw Error(`Could not find any icon resolver for namespace ${e}.`)}resolveIconForId(e){let t=e.split(`:`);if(t.length!==3)throw Error(`Incorrect iconId: ${e}. Format: <namespace>:<iconset>:<icon>`);return this.resolveIcon(t[0],t[1],t[2])}};function ot(){if(!T.has(`@lion/ui::icons::0.x`)){let e=new at;T.set(`@lion/ui::icons::0.x`,e)}return T.get(`@lion/ui::icons::0.x`)}var st=ne(ot),ct=class extends le{constructor(e){if(super(e),this.it=c,e.type!==w.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===c||e==null)return this._t=void 0,this.it=e;if(e===o)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};ct.directiveName=`unsafeHTML`,ct.resultType=1;var lt=ce(ct),ut=class extends ct{};ut.directiveName=`unsafeSVG`,ut.resultType=2;var dt=ce(ut),ft=`craft`,pt=new Map;function mt(e,t){return`${e}/${t}`}function ht(e){let[t=`classic`,n=`regular`]=e.split(`/`);return{family:t,variant:n}}async function gt(e){try{let t=await fetch(e,{mode:`cors`});if(!t.ok)return c;let n=document.createElement(`div`);n.innerHTML=await t.text();let i=n.firstElementChild;return i?.tagName?.toLowerCase()===`svg`?(i.setAttribute(`fill`,`currentColor`),i.setAttribute(`part`,`svg`),r`${dt(i.outerHTML)}`):c}catch{return c}}function _t(e,t=`classic`,n=`regular`,r=`/vendor/craft/icons`){let i=`solid`,a=n,o=e.endsWith(`.svg`)?e.split(`.svg`)[0]:e;if(e.includes(`/`)){let[t,...n]=e.split(`/`);a=t??a,o=n.join(`/`)}return a===`thin`?i=`thin`:a===`light`?i=`light`:a===`regular`?i=`regular`:a===`solid`&&(i=`solid`),(t===`brands`||a===`brands`)&&(i=`brands`),(t===`custom-icons`||a===`custom-icons`)&&(i=`custom-icons`),`${r}/${i}/${o}.svg`}function vt(e){return(t,n,r)=>{let i=e(t,n,r);if(i===null)return c;let a=pt.get(i);return a||(a=gt(i),pt.set(i,a)),a.then(e=>(e===c&&pt.delete(i),e))}}var yt=vt(_t);function bt(e){st.removeIconResolver(ft),st.addIconResolver(ft,(t,n)=>{let{family:r,variant:i}=ht(t);return e(n,r,i)})}function xt(e,t=`classic`,n=`regular`){return Promise.resolve(st.resolveIcon(ft,mt(t,n),e))}bt(yt);var St=new WeakSet,Ct=class extends l{constructor(...e){super(...e),d(this,St),this.appearance=`plain`,this._svg=c,this._hasSlottedContent=!1}connectedCallback(){super.connectedCallback(),this.appearance===`badge`&&!this.getAttribute(`data-color`)&&this.setAttribute(`data-color`,`warning`),this._hasSlottedContent=this.childElementCount>0}firstUpdated(){u(St,this,Et).call(this)}updated(e){super.updated(e),(e.has(`name`)||e.has(`family`)||e.has(`variant`))&&u(St,this,Tt).call(this),e.has(`label`)&&this.hasUpdated&&u(St,this,Et).call(this)}_handleSlotChange(e){let t=e.target;this._hasSlottedContent=t.assignedElements({flatten:!0}).length>0}render(){return r`
      <slot @slotchange=${this._handleSlotChange}></slot>
      ${this._hasSlottedContent?c:this._svg}
...
`,Ot=class extends l{constructor(...e){super(...e),this.label=O(`Breadcrumbs`),this.items=[],this.visibleItems=0,this.firstRender=!0}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}calculateBreadcrumbItemsWidth(){this.items=this.breadcrumbsElements.map((e,t)=>{let n=e.offsetWidth;return e.hasAttribute(`hidden`)&&(e.removeAttribute(`hidden`),n=e.offsetWidth,e.setAttribute(`hidden`,``)),{label:e.innerText,href:e.href,value:t.toString(),offsetWidth:n,isVisible:!0}})}async handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`craft-breadcrumb-item`);if(e.forEach((t,n)=>{let r=n===e.length-1,i=t.querySelector(`[slot="separator"]`);r?i?.hasAttribute(`data-default`)&&i.remove():i===null?t.append(this.getSeparator()):i.hasAttribute(`data-default`)&&i.replaceWith(this.getSeparator()),r?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)}),this.breadcrumbsElements.length===0){this.items=[],this.visibleItems=0;return}await Promise.all(this.breadcrumbsElements.map(e=>e.updateComplete)),this.calculateBreadcrumbItemsWidth(),this.visibleItems=0,this.adjustOverflow()}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{if(this.firstRender){this.firstRender=!1;return}this.adjustOverflow()}),this.resizeObserver.observe(this)}adjustOverflow(){}disconnectedCallback(){this.resizeObserver?.unobserve(this),super.disconnectedCallback()}render(){return r`
    ...
    `}};Ot.styles=[Dt],p([y(`slot`)],Ot.prototype,`defaultSlot`,void 0),p([y(`slot[name="separator"]`)],Ot.prototype,`separatorSlot`,void 0),p([de({selector:`craft-breadcrumb-item`})],Ot.prototype,`breadcrumbsElements`,void 0),p([g()],Ot.prototype,`label`,void 0),p([_()],Ot.prototype,`items`,void 0),p([_()],Ot.prototype,`visibleItems`,void 0),customElements.get(`craft-breadcrumbs`)||customElements.define(`craft-breadcrumbs`,Ot);var kt=a`
  :host {
...
`,Mt=class extends He(ie(l)){static get properties(){return{invokerRelation:{type:String,attribute:`invoker-relation`}}}static get styles(){return[...super.styles,a`
        :host {
      ...
      `]}constructor(){super(),this.hasArrow=!1,this.invokerRelation=`description`}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];_defineOverlayConfig(){let e=super._defineOverlayConfig(),t=We({invokerRelation:this.invokerRelation});return{...e,...t,popperConfig:{...e.popperConfig||{},...t.popperConfig||{},modifiers:[...e.popperConfig?.modifiers||[],...t.popperConfig?.modifiers||[]]}}}},Nt=new WeakMap,Pt=new WeakMap,Ft=new WeakSet,It=class extends Mt{constructor(){super(),d(this,Ft),this.placement=`top`,this.trigger=`hover focus`,f(this,Nt,null),f(this,Pt,()=>{this.opened=!this.opened}),ae(this)}static get styles(){return[...super.styles,a`
        :host {
          display: contents;
        }
      ...
      `]}connectedCallback(){u(Ft,this,Lt).call(this),super.connectedCallback()}get _overlayInvokerNode(){if(this.for){let e=this.getRootNode();return typeof e.getElementById==`function`?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}_defineOverlayConfig(){let e={...super._defineOverlayConfig()};if(Rt.call(u(Ft,this))||zt.call(u(Ft,this)))delete e.visibilityTriggerFunction;else{let{visibilityTriggerFunction:t}=We({invokerRelation:this.invokerRelation,delayIn:200,delayOut:0});e.visibilityTriggerFunction=t}return{...e,popperConfig:{...e.popperConfig,strategy:`fixed`,placement:this.placement,modifiers:[...e.popperConfig?.modifiers??[],...ee()]}}}_setupOpenCloseListeners(){super._setupOpenCloseListeners(),Rt.call(u(Ft,this))&&this._overlayInvokerNode?.addEventListener(`click`,m(Pt,this))}_teardownOpenCloseListeners(){super._teardownOpenCloseListeners(),this._overlayInvokerNode?.removeEventListener(`click`,m(Pt,this))}updated(e){super.updated(e),e.has(`for`)&&e.get(`for`)!==void 0&&this._overlayCtrl&&this._overlayCtrl.updateConfig({invokerNode:this._overlayInvokerNode})}async show(){this.opened=!0,await this.updateComplete}async hide(){this.opened=!1,await this.updateComplete}};function Lt(){if(m(Nt,this)?.isConnected)return;let e=document.createElement(`div`);e.slot=`content`,e.append(...Array.from(this.childNodes).filter(e=>!(e instanceof Element)||e.slot===``)),this.append(e),h(Nt,this,e)}function Rt(){return this.trigger.split(` `).includes(`click`)}function zt(){return this.trigger.split(` `).includes(`manual`)}p([g({reflect:!0})],It.prototype,`for`,void 0),p([g({reflect:!0})],It.prototype,`placement`,void 0),p([g({reflect:!0})],It.prototype,`trigger`,void 0),customElements.get(`craft-tooltip`)||customElements.define(`craft-tooltip`,It);var Bt=e=>e.key===` `||e.key===`Enter`,Vt=e=>e.key===` `,Ht=class extends Ee(l){static get properties(){return{active:{type:Boolean,reflect:!0},type:{type:String,reflect:!0}}}render(){return r` <div class="button-content"><slot></slot></div> `}static get styles(){return[a`
        :host {
          position: relative;
          display: inline-flex;
          box-sizing: border-box;
  ...
  `,e}var Kt=class extends Ut{get _nativeButtonNode(){return Wt.get(this._form)?.helper||null}constructor(){super(),this.type=`submit`,this.__implicitSubmitHelperButton=null}_setupSubmitAndResetHelperOnConnected(){if(super._setupSubmitAndResetHelperOnConnected(),!this._form||this.type!==`submit`)return;let e=this._form;if(!Wt.get(this._form)){let t=Gt(),n=document.createElement(`div`);n.appendChild(t),Wt.set(this._form,{lionButtons:new Set,helper:t,observer:new MutationObserver(()=>{e.appendChild(n)})}),e.appendChild(n),Wt.get(e)?.observer.observe(n,{childList:!0})}Wt.get(e)?.lionButtons.add(this)}_teardownSubmitAndResetHelperOnDisconnected(){if(super._teardownSubmitAndResetHelperOnDisconnected(),this._form){let e=Wt.get(this._form);e&&(e.lionButtons.delete(this),e.lionButtons.size||(this._form.contains(e.helper)&&e.helper.remove(),Wt.get(this._form)?.observer.disconnect(),Wt.delete(this._form)))}}},qt=a`
  :host {
...
`,Yt=new WeakMap,Xt=class extends l{constructor(...e){super(...e),this.label=O(`More Info`),this.icon=`circle-info`,this.disabled=!1,this.status=``,f(this,Yt,new AbortController)}connectedCallback(){super.connectedCallback(),m(Yt,this).signal.aborted&&h(Yt,this,new AbortController),this.id||=`info-icon-${Math.random().toString(36).slice(2,8)}`;let{signal:e}=m(Yt,this);this.addEventListener(`craft-show`,()=>{Zt._&&Zt._!==this&&Zt._.renderRoot.querySelector(`craft-tooltip`)?.hide(),Zt._=this},{signal:e}),this.addEventListener(`craft-after-show`,()=>{this.status=``,setTimeout(()=>{this.status=`Some new status`},200)},{signal:e}),this.addEventListener(`craft-after-hide`,()=>{Zt._===this&&(Zt._=null),this.status=``},{signal:e})}disconnectedCallback(){Zt._===this&&(Zt._=null),m(Yt,this).abort(),super.disconnectedCallback()}render(){return r`
  ...
  `;var Zt={_:null};p([g()],Xt.prototype,`label`,void 0),p([g()],Xt.prototype,`icon`,void 0),p([g({type:Boolean,reflect:!0})],Xt.prototype,`disabled`,void 0),p([g()],Xt.prototype,`id`,void 0),p([_()],Xt.prototype,`status`,void 0),p([y(`craft-tooltip`)],Xt.prototype,`tooltip`,void 0),customElements.get(`craft-info-icon`)||customElements.define(`craft-info-icon`,Xt);var Qt=class extends l{constructor(...e){super(...e),this.debug=!1}render(){return r`<slot></slot>`}};Qt.styles=a`
    :host(:not([debug])) {
      position: absolute;
      width: 1px;
      height: 1px;
  ...
  `,p([g({type:Boolean,reflect:!0})],Qt.prototype,`debug`,void 0),customElements.get(`craft-visually-hidden`)||customElements.define(`craft-visually-hidden`,Qt);var $t=class extends l{constructor(...e){super(...e),this.visible=!0}show(){this.visible=!0,this.dispatchEvent(new CustomEvent(`show`))}hide(){this.visible=!1,this.dispatchEvent(new CustomEvent(`hide`))}focus(){this.wrapper?.focus()}render(){return r`
      <div
        tabindex="-1"
    ...
    `}};$t.styles=[jt,Jt],p([g({reflect:!0,type:Boolean})],$t.prototype,`visible`,void 0),p([y(`.wrapper`)],$t.prototype,`wrapper`,void 0),customElements.get(`craft-spinner`)||customElements.define(`craft-spinner`,$t);var en=Object.prototype.toString;function tn(e){return typeof e==`function`||en.call(e)===`[object Function]`}function nn(e){var t=Number(e);return isNaN(t)?0:t===0||!isFinite(t)?t:(t>0?1:-1)*Math.floor(Math.abs(t))}var rn=2**53-1;function an(e){var t=nn(e);return Math.min(Math.max(t,0),rn)}function on(e,t){var n=Array,r=Object(e);if(e==null)throw TypeError(`Array.from requires an array-like object - not null or undefined`);if(t!==void 0&&!tn(t))throw TypeError(`Array.from: when provided, the second argument must be a function`);for(var i=an(r.length),a=tn(n)?Object(new n(i)):Array(i),o=0,s;o<i;)s=r[o],t?a[o]=t(s,o):a[o]=s,o+=1;return a.length=i,a}function sn(e){"@babel/helpers - typeof";return sn=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},sn(e)}function cn(e,t){if(!(e instanceof t))throw TypeError(`Cannot call a class as a function`)}function ln(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,`value`in r&&(r.writable=!0),Object.defineProperty(e,fn(r.key),r)}}function un(e,t,n){return t&&ln(e.prototype,t),n&&ln(e,n),Object.defineProperty(e,"prototype",{writable:!1}),e}function dn(e,t,n){return t=fn(t),t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function fn(e){var t=pn(e,`string`);return sn(t)==`symbol`?t:t+``}function pn(e,t){if(sn(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(sn(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}var mn=typeof Set>`u`?Set:function(){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[];cn(this,e),dn(this,`items`,void 0),this.items=t}return un(e,[{key:`add`,value:function(e){return this.has(e)===!1&&this.items.push(e),this}},{key:`clear`,value:function(){this.items=[]}},{key:`delete`,value:function(e){var t=this.items.length;return this.items=this.items.filter(function(t){return t!==e}),t!==this.items.length}},{key:`forEach`,value:function(e){var t=this;this.items.forEach(function(n){e(n,n,t)})}},{key:`has`,value:function(e){return this.items.indexOf(e)!==-1}},{key:`size`,get:function(){return this.items.length}}])}();function hn(e){return e.localName??e.tagName.toLowerCase()}var gn={article:`article`,aside:`complementary`,button:`button`,datalist:`listbox`,dd:`definition`,details:`group`,dialog:`dialog`,dt:`term`,fieldset:`group`,figure:`figure`,form:`form`,footer:`contentinfo`,h1:`heading`,h2:`heading`,h3:`heading`,h4:`heading`,h5:`heading`,h6:`heading`,header:`banner`,hr:`separator`,html:`document`,legend:`legend`,li:`listitem`,math:`math`,main:`main`,menu:`list`,nav:`navigation`,ol:`list`,optgroup:`group`,option:`option`,output:`status`,progress:`progressbar`,section:`region`,summary:`button`,table:`table`,tbody:`rowgroup`,textarea:`textbox`,tfoot:`rowgroup`,td:`cell`,th:`columnheader`,thead:`rowgroup`,tr:`row`,ul:`list`},_n={caption:new Set([`aria-label`,`aria-labelledby`]),code:new Set([`aria-label`,`aria-labelledby`]),deletion:new Set([`aria-label`,`aria-labelledby`]),emphasis:new Set([`aria-label`,`aria-labelledby`]),generic:new Set([`aria-label`,`aria-labelledby`,`aria-roledescription`]),insertion:new Set([`aria-label`,`aria-labelledby`]),none:new Set([`aria-label`,`aria-labelledby`]),paragraph:new Set([`aria-label`,`aria-labelledby`]),presentation:new Set([`aria-label`,`aria-labelledby`]),strong:new Set([`aria-label`,`aria-labelledby`]),subscript:new Set([`aria-label`,`aria-labelledby`]),superscript:new Set([`aria-label`,`aria-labelledby`])};function vn(e,t){return[`aria-atomic`,`aria-busy`,`aria-controls`,`aria-current`,`aria-description`,`aria-describedby`,`aria-details`,`aria-dropeffect`,`aria-flowto`,`aria-grabbed`,`aria-hidden`,`aria-keyshortcuts`,`aria-label`,`aria-labelledby`,`aria-live`,`aria-owns`,`aria-relevant`,`aria-roledescription`].some(function(n){var r;return e.hasAttribute(n)&&!((r=_n[t])!=null&&r.has(n))})}function yn(e,t){return vn(e,t)}function bn(e){var t=Sn(e);if(t===null||Cn.indexOf(t)!==-1){var n=xn(e);if(Cn.indexOf(t||``)===-1||yn(e,n||``))return n}return t}function xn(e){var t=gn[hn(e)];if(t!==void 0)return t;switch(hn(e)){case`a`:case`area`:case`link`:if(e.hasAttribute(`href`))return`link`;break;case`img`:return e.getAttribute(`alt`)===``&&!yn(e,`img`)?`presentation`:`img`;case`input`:var n=e.type;switch(n){case`button`:case`image`:case`reset`:case`submit`:return`button`;case`checkbox`:case`radio`:return n;case`range`:return`slider`;case`email`:case`tel`:case`text`:case`url`:return e.hasAttribute(`list`)?`combobox`:`textbox`;case`search`:return e.hasAttribute(`list`)?`combobox`:`searchbox`;case`number`:return`spinbutton`;default:return null}case`select`:return e.hasAttribute(`multiple`)||e.size>1?`listbox`:`combobox`}return null}function Sn(e){var t=e.getAttribute(`role`);if(t!==null){var n=t.trim().split(` `)[0];if(n.length>0)return n}return null}var Cn=[`presentation`,`none`];function j(e){return e!==null&&e.nodeType===e.ELEMENT_NODE}function wn(e){return j(e)&&hn(e)===`caption`}function Tn(e){return j(e)&&hn(e)===`input`}function En(e){return j(e)&&hn(e)===`optgroup`}function Dn(e){return j(e)&&hn(e)===`select`}function On(e){return j(e)&&hn(e)===`table`}function kn(e){return j(e)&&hn(e)===`textarea`}function An(e){var t=(e.ownerDocument===null?e:e.ownerDocument).defaultView;if(t===null)throw TypeError(`no window available`);return t}function jn(e){return j(e)&&hn(e)===`fieldset`}function Mn(e){return j(e)&&hn(e)===`legend`}function Nn(e){return j(e)&&hn(e)===`slot`}function Pn(e){return j(e)&&e.ownerSVGElement!==void 0}function Fn(e){return j(e)&&hn(e)===`svg`}function In(e){return Pn(e)&&hn(e)===`title`}function Ln(e,t){if(j(e)&&e.hasAttribute(t)){var n=e.getAttribute(t).split(` `),r=e.getRootNode?e.getRootNode():e.ownerDocument;return n.map(function(e){return r.getElementById(e)}).filter(function(e){return e!==null})}return[]}function Rn(e,t){return j(e)?t.indexOf(bn(e))!==-1:!1}function zn(e){return e.trim().replace(/\s\s+/g,` `)}function Bn(e,t){if(!j(e))return!1;if(e.hasAttribute(`hidden`)||e.getAttribute(`aria-hidden`)===`true`)return!0;var n=t(e);return n.getPropertyValue(`display`)===`none`||n.getPropertyValue(`visibility`)===`hidden`}function Vn(e){return Rn(e,[`button`,`combobox`,`listbox`,`textbox`])||Hn(e,`range`)}function Hn(e,t){if(!j(e))return!1;switch(t){case`range`:return Rn(e,[`meter`,`progressbar`,`scrollbar`,`slider`,`spinbutton`]);default:throw TypeError(`No knowledge about abstract role '${t}'. This is likely a bug :(`)}}function Un(e,t){var n=on(e.querySelectorAll(t));return Ln(e,`aria-owns`).forEach(function(e){n.push.apply(n,on(e.querySelectorAll(t)))}),n}function Wn(e){return Dn(e)?e.selectedOptions||Un(e,`[selected]`):Un(e,`[aria-selected="true"]`)}function Gn(e){return Rn(e,Cn)}function Kn(e){return wn(e)}function qn(e){return Rn(e,[`button`,`cell`,`checkbox`,`columnheader`,`gridcell`,`heading`,`label`,`legend`,`link`,`menuitem`,`menuitemcheckbox`,`menuitemradio`,`option`,`radio`,`row`,`rowheader`,`switch`,`tab`,`tooltip`,`treeitem`])}function Jn(e){return!1}function Yn(e){return Tn(e)||kn(e)?e.value:e.textContent||``}function Xn(e){var t=e.getPropertyValue(`content`);return/^["'].*["']$/.test(t)?t.slice(1,-1):``}function Zn(e){var t=hn(e);return t===`button`||t===`input`&&e.getAttribute(`type`)!==`hidden`||t===`meter`||t===`output`||t===`progress`||t===`select`||t===`textarea`}function Qn(e){if(Zn(e))return e;var t=null;return e.childNodes.forEach(function(e){if(t===null&&j(e)){var n=Qn(e);n!==null&&(t=n)}}),t}function $n(e){if(e.control!==void 0)return e.control;var t=e.getAttribute(`for`);return t===null?Qn(e):e.ownerDocument.getElementById(t)}function er(e){var t=e.labels;if(t===null)return t;if(t!==void 0)return on(t);if(!Zn(e))return null;var n=e.ownerDocument;return on(n.querySelectorAll(`label`)).filter(function(t){return $n(t)===e})}function tr(e){var t=e.assignedNodes();return t.length===0?on(e.childNodes):t}function nr(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=new mn,r=typeof Map>`u`?void 0:new Map,i=An(e),a=t.compute,o=a===void 0?`name`:a,s=t.computedStyleSupportsPseudoElements,c=s===void 0?t.getComputedStyle!==void 0:s,l=t.getComputedStyle,u=l===void 0?i.getComputedStyle.bind(i):l,d=t.hidden,f=d!==void 0&&d,p=function(e,t){if(t!==void 0)throw Error(`use uncachedGetComputedStyle directly for pseudo elements`);if(r===void 0)return u(e);var n=r.get(e);if(n)return n;var i=u(e,t);return r.set(e,i),i};function m(e,t){var n=``;if(j(e)&&c&&(n=`${Xn(u(e,`::before`))} ${n}`),(Nn(e)?tr(e):on(e.childNodes).concat(Ln(e,`aria-owns`))).forEach(function(e){var r=v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0}),i=(j(e)?p(e).getPropertyValue(`display`):`inline`)===`inline`?``:` `;n+=`${i}${r}${i}`}),j(e)&&c){var r=Xn(u(e,`::after`));n=`${n} ${r}`}return n.trim()}function h(e,t){var r=e.getAttributeNode(t);return r!==null&&!n.has(r)&&r.value.trim()!==``?(n.add(r),r.value):null}function g(e){return j(e)?h(e,`title`):null}function _(e){if(!j(e))return null;if(jn(e)){n.add(e);for(var t=on(e.childNodes),r=0;r<t.length;r+=1){var i=t[r];if(Mn(i))return v(i,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(On(e)){n.add(e);for(var a=on(e.childNodes),o=0;o<a.length;o+=1){var s=a[o];if(wn(s))return v(s,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(Fn(e)){n.add(e);for(var c=on(e.childNodes),l=0;l<c.length;l+=1){var u=c[l];if(In(u))return u.textContent}return null}else if(hn(e)===`img`||hn(e)===`area`){var d=h(e,`alt`);if(d!==null)return d}else if(En(e)){var f=h(e,`label`);if(f!==null)return f}if(Tn(e)&&(e.type===`button`||e.type===`submit`||e.type===`reset`)){var p=h(e,`value`);if(p!==null)return p;if(e.type===`submit`)return`Submit`;if(e.type===`reset`)return`Reset`}var g=er(e);if(g!==null&&g.length!==0)return n.add(e),on(g).map(function(e){return v(e,{isEmbeddedInLabel:!0,isReferenced:!1,recursion:!0})}).filter(function(e){return e.length>0}).join(` `);if(Tn(e)&&e.type===`image`){var _=h(e,`alt`);if(_!==null)return _;var y=h(e,`title`);return y===null?`Submit Query`:y}if(Rn(e,[`button`])){var b=m(e,{isEmbeddedInLabel:!1,isReferenced:!1});if(b!==``)return b}return null}function v(e,t){if(n.has(e))return``;if(!f&&Bn(e,p)&&!t.isReferenced)return n.add(e),``;var r=j(e)?e.getAttributeNode(`aria-labelledby`):null,i=r!==null&&!n.has(r)?Ln(e,`aria-labelledby`):[];if(o===`name`&&!t.isReferenced&&i.length>0)return n.add(r),i.map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!0,recursion:!1})}).join(` `);var a=t.recursion&&Vn(e)&&o===`name`;if(!a){var s=(j(e)&&e.getAttribute(`aria-label`)||``).trim();if(s!==``&&o===`name`)return n.add(e),s;if(!Gn(e)){var c=_(e);if(c!==null)return n.add(e),c}}if(Rn(e,[`menu`]))return n.add(e),``;if(a||t.isEmbeddedInLabel||t.isReferenced){if(Rn(e,[`combobox`,`listbox`])){n.add(e);var l=Wn(e);return l.length===0?Tn(e)?e.value:``:on(l).map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0})}).join(` `)}if(Hn(e,`range`))return n.add(e),e.hasAttribute(`aria-valuetext`)?e.getAttribute(`aria-valuetext`):e.hasAttribute(`aria-valuenow`)?e.getAttribute(`aria-valuenow`):e.getAttribute(`value`)||``;if(Rn(e,[`textbox`]))return n.add(e),Yn(e)}if(qn(e)||j(e)&&t.isReferenced||Kn(e)||Jn(e)){var u=m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});if(u!==``)return n.add(e),u}if(e.nodeType===e.TEXT_NODE)return n.add(e),e.textContent||``;if(t.recursion)return n.add(e),m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});var d=g(e);return d===null?(n.add(e),``):(n.add(e),d)}return zn(v(e,{isEmbeddedInLabel:!1,isReferenced:o===`description`,recursion:!1}))}function rr(e){return Rn(e,[`caption`,`code`,`deletion`,`emphasis`,`generic`,`insertion`,`none`,`paragraph`,`presentation`,`strong`,`subscript`,`superscript`])}function ir(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return rr(e)?``:nr(e,t)}var ar={Primary:`primary`,Danger:`danger`,DangerPlain:`danger-plain`,Solid:`solid`,Fill:`fill`,Outline:`outline`,Dashed:`dashed`,Plain:`plain`,Link:`link`,None:`none`},or=new WeakMap,sr=new WeakMap,cr=new WeakSet,lr=new WeakMap,M=class extends Kt{static get styles(){return[...super.styles,jt,qt]}constructor(){super(),d(this,cr),f(this,or,async e=>{let t=ve(this.action);if(!(!t||this.disabled)){e.preventDefault(),t.type===`http`&&(this.loading=!0);try{await ye(t,{trigger:this,sourceEvent:e})}finally{this.loading=!1}}}),f(this,sr,e=>{!this.toggle||this.disabled||this.loading||this.dispatchEvent(new CustomEvent(`craft-toggle`,{bubbles:!0,composed:!0,cancelable:!0,detail:{active:!this.active,sourceEvent:e}}))}),this.variant=ar.Fill,this.inherit=!1,this.size=`medium`,this.active=!1,this.toggle=!1,this.loading=!1,this.align=`center`,this.icon=null,this.action=null,this.href=null,this.target=null,this.rel=null,this.download=null,this.iconPosition=`prefix`,this._hasAccessibilityError=!1,f(this,lr,null),this.linkHostStateApplied=!1,this.originalType=null,this.announcementTimer=null,this.type=`button`}connectedCallback(){this.href&&!this.disabled&&(this.originalType=this.type,this.type=`button`,this.setAttribute(`role`,`presentation`),this.linkHostStateApplied=!0),super.connectedCallback(),this.syncLinkHostState(),this.addEventListener(`click`,m(or,this)),this.addEventListener(`click`,m(sr,this)),this.hasUpdated&&!this.accessibleName&&u(cr,this,ur).call(this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(or,this)),this.removeEventListener(`click`,m(sr,this)),u(cr,this,pr).call(this),this.announcementTimer&&=(clearTimeout(this.announcementTimer),null)}updated(e){super.updated(e),(e.has(`href`)||e.has(`disabled`))&&this.syncLinkHostState(),this.toggle&&(e.has(`active`)||e.has(`toggle`))&&this.setAttribute(`aria-pressed`,String(this.active)),e.has(`loading`)&&this.loading&&this.announceLoading()}announceLoading(){this.liveRegion.textContent=O(`Loading`),this.announcementTimer&&clearTimeout(this.announcementTimer),this.announcementTimer=setTimeout(()=>{this.liveRegion.textContent=``},5e3)}syncLinkHostState(){this.isLink?(this.linkHostStateApplied||(this.originalType=this.type),this.setAttribute(`role`,`presentation`),this.tabIndex=-1,this.type=`button`,this.linkHostStateApplied=!0):this.linkHostStateApplied&&=(this.setAttribute(`role`,`button`),this.type=this.originalType??`button`,this.disabled||(this.tabIndex=0),!1)}async firstUpdated(e){super.firstUpdated(e),await this.updateComplete;let t=this.querySelectorAll(`craft-icon, craft-spinner`);await Promise.all(Array.from(t).map(e=>e.updateComplete)),u(cr,this,ur).call(this)}get isLink(){return!!this.href&&!this.disabled}get computedRel(){if(this.target===`_blank`){let e=new Set((this.rel??``).split(/\s+/).filter(Boolean));return e.add(`noopener`),Array.from(e).join(` `)}return this.rel}render(){let e=r`
      <div
      ...
      >
        <slot name="prefix" class="prefix" part="prefix">
          ${this.icon&&this.iconPosition===`prefix`?r`<craft-icon name="${this.icon}"></craft-icon>`:c}
        </slot>
        <slot class="label" part="label"></slot>
        <slot name="suffix" class="suffix" part="suffix">
          ${this.icon&&this.iconPosition===`suffix`?r`<craft-icon name="${this.icon}"></craft-icon>`:c}
        </slot>
      </div>
      ${this.loading?r`<craft-spinner part="spinner"></craft-spinner>`:c}
      <span class="cp-visually-hidden" role="status" data-live-region></span>
    `;return this.isLink?r`
        <a
          class="link"
          part="link"
          href="${this.href}"
          target="${this.target??c}"
          rel="${this.computedRel??c}"
          download="${this.download??c}"
          >${e}</a
        >
      `:e}};function ur(){if(!this.accessibleName){let e=this.isLink?this.shadowRoot?.querySelector(`a.link`)??this:this;this.accessibleName=ir(e)}let e=!this.accessibleName||this.accessibleName.trim()===``;if(e&&!u(cr,this,dr).call(this)){u(cr,this,fr).call(this);return}this._hasAccessibilityError=e}function dr(){return typeof this.checkVisibility==`function`?this.checkVisibility({visibilityProperty:!0}):this.getClientRects().length>0}function fr(){m(lr,this)||typeof ResizeObserver>`u`||(h(lr,this,new ResizeObserver(()=>{u(cr,this,dr).call(this)&&(u(cr,this,pr).call(this),u(cr,this,ur).call(this))})),m(lr,this).observe(this))}function pr(){m(lr,this)?.disconnect(),h(lr,this,null)}p([g({attribute:`accessible-name`})],M.prototype,`accessibleName`,void 0),p([g({reflect:!0})],M.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],M.prototype,`inherit`,void 0),p([g({reflect:!0})],M.prototype,`size`,void 0),p([g({reflect:!0})],M.prototype,`value`,void 0),p([g({reflect:!0,type:Boolean})],M.prototype,`active`,void 0),p([g({type:Boolean,reflect:!0})],M.prototype,`toggle`,void 0),p([g({reflect:!0,type:Boolean})],M.prototype,`loading`,void 0),p([g()],M.prototype,`align`,void 0),p([g()],M.prototype,`icon`,void 0),p([g({type:Object})],M.prototype,`action`,void 0),p([g({reflect:!0})],M.prototype,`href`,void 0),p([g()],M.prototype,`target`,void 0),p([g()],M.prototype,`rel`,void 0),p([g()],M.prototype,`download`,void 0),p([g({attribute:`icon-position`})],M.prototype,`iconPosition`,void 0),p([y(`[data-live-region]`)],M.prototype,`liveRegion`,void 0),p([_()],M.prototype,`_hasAccessibilityError`,void 0),customElements.get(`craft-button`)||customElements.define(`craft-button`,M);var mr=[`sm`,`md`,`lg`,`xl`];function hr(e){return!isNaN(parseFloat(String(e)))&&isFinite(Number(e))}function gr(e){if(e!=null&&e!==``)return e===0||e===`0`||e===`none`?`0`:hr(e)?`calc(${e}rem / 16)`:mr.includes(e)?`var(--c-spacing-${e})`:String(e)}var _r=(e,{customProperty:t,defaultValue:n})=>{let r=Array.isArray(t)?t:[t];class i extends e{constructor(...e){super(...e),this.padding=n}get resolvedPadding(){return gr(this.padding)}get paddingStyles(){let e=this.resolvedPadding;return e===void 0?{}:Object.fromEntries(r.map(t=>[t,e]))}}return p([g()],i.prototype,`padding`,void 0),i},vr=a`
  :host {
    display: contents;
  }
...
`,yr=class extends _r(l,{customProperty:[`--_callout-padding-block`,`--_callout-padding-inline`]}){constructor(...e){super(...e),this.variant=xe.Neutral,this.appearance=oe.OutlineFill,this.title=``,this.icon=null,this.hideIcon=!1,this.rounded=`all`,this.inline=!1,this.size=`auto`,this.resolvedIcon=null}willUpdate(){this.resolvedIcon=this.icon??this.getDefaultIcon()}getDefaultIcon(){switch(this.variant){case xe.Info:return`lightbulb`;case xe.Success:return`circle-check`;case xe.Warning:return`circle-exclamation`;case xe.Danger:return`triangle-exclamation`;default:return null}}render(){let e=this.title||!!this.querySelector(`[slot="title"]`),t=!this.hideIcon&&(!!this.resolvedIcon||!!this.querySelector(`[slot="icon"]`));return r`
      <div
        data-variant="${this.variant}"
        style="${re(this.paddingStyles)}"
        class="${S({callout:!0,"callout--hide-icon":!t,"callout--title":e,"callout--small":this.size===`small`})}"
      >
        ${t?r`<slot name="icon" class="callout__icon">
              ${this.resolvedIcon?r`<craft-icon
                    name="${this.resolvedIcon}"
                    style="font-size: 0.9em"
                  ></craft-icon>`:c}
            </slot>`:c}
        ${e?r`<div class="callout__title">
    ...
    `}};yr.styles=[ue,vr],p([g({reflect:!0})],yr.prototype,`variant`,void 0),p([g({reflect:!0})],yr.prototype,`appearance`,void 0),p([g()],yr.prototype,`title`,void 0),p([g()],yr.prototype,`icon`,void 0),p([g({type:Boolean,attribute:`hide-icon`})],yr.prototype,`hideIcon`,void 0),p([g({reflect:!0})],yr.prototype,`rounded`,void 0),p([g({reflect:!0,type:Boolean})],yr.prototype,`inline`,void 0),p([g()],yr.prototype,`size`,void 0),p([_()],yr.prototype,`resolvedIcon`,void 0),customElements.get(`craft-callout`)||customElements.define(`craft-callout`,yr);var br=a`
  :host {
    display: block;
  }
...
`,xr=class extends l{constructor(...e){super(...e),this.label=``,this.active=!1,this.collapsed=!1,this.showThumb=!0,this.thumbAlignment=`start`,this._hasThumbnail=!1,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasSlottedHeader=!!this.querySelector(`:scope > [slot="header"]`)||!!this.querySelector(`:scope > [slot="label"]`)||!!this.querySelector(`:scope > [slot="actions"]`),this._hasSlottedFooter=!!this.querySelector(`:scope > [slot="footer"]`),this._hasThumbnail=!!this.querySelector(`:scope > [slot="thumbnail"]`)}_handleThumbnailSlotChange(e){let t=e.target;this._hasThumbnail=t.assignedElements({flatten:!0}).length>0}render(){let e=!!this.label||this._hasSlottedHeader,t=this._hasSlottedFooter,n=this.showThumb&&this._hasThumbnail;return r`
      <div
        class="${S({card:!0,"card--has-thumbnail":n})}"
      >
        ...
        <div
          class="${S({"card-body":!0,"card-body--thumb-start":n&&this.thumbAlignment===`start`,"card-body--thumb-end":n&&this.thumbAlignment===`end`})}"
        >
    ...
    `}};xr.styles=[br],p([g()],xr.prototype,`label`,void 0),p([g({type:Boolean,reflect:!0})],xr.prototype,`active`,void 0),p([g({type:Boolean,reflect:!0})],xr.prototype,`collapsed`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],xr.prototype,`showThumb`,void 0),p([g({attribute:`thumb-alignment`})],xr.prototype,`thumbAlignment`,void 0),p([_()],xr.prototype,`_hasThumbnail`,void 0),p([_()],xr.prototype,`_hasSlottedHeader`,void 0),p([_()],xr.prototype,`_hasSlottedFooter`,void 0),customElements.get(`craft-card`)||customElements.define(`craft-card`,xr);var Sr=a`
...
`,Or=window,kr=new WeakMap;function Ar(e){Or.applyFocusVisiblePolyfill&&!kr.has(e)&&(Or.applyFocusVisiblePolyfill(e),kr.set(e,void 0))}var jr=E(e=>class extends e{static get properties(){return{focused:{type:Boolean,reflect:!0},focusedVisible:{type:Boolean,reflect:!0,attribute:`focused-visible`},autofocus:{type:Boolean,reflect:!0}}}constructor(){super(),this.focused=!1,this.focusedVisible=!1,this.autofocus=!1}firstUpdated(e){super.firstUpdated(e),this.__registerEventsForFocusMixin(),this.__syncAutofocusToFocusableElement()}disconnectedCallback(){super.disconnectedCallback(),this.__teardownEventsForFocusMixin()}updated(e){super.updated(e),e.has(`autofocus`)&&this.__syncAutofocusToFocusableElement()}__syncAutofocusToFocusableElement(){this._focusableNode&&(this.hasAttribute(`autofocus`)?this._focusableNode.setAttribute(`autofocus`,``):this._focusableNode.removeAttribute(`autofocus`))}focus(){this._focusableNode?.focus()}blur(){this._focusableNode?.blur()}get _focusableNode(){return this._inputNode||document.createElement(`input`)}__onFocus(){if(this.focused=!0,typeof Or.applyFocusVisiblePolyfill==`function`)this.focusedVisible=this._focusableNode.hasAttribute(`data-focus-visible-added`);else try{this.focusedVisible=this._focusableNode.matches(`:focus-visible`)}catch{this.focusedVisible=!1}}__onBlur(){this.focused=!1,this.focusedVisible=!1}__registerEventsForFocusMixin(){Ar(this.getRootNode()),this.__redispatchFocus=e=>{e.stopPropagation(),this.dispatchEvent(new Event(`focus`))},this._focusableNode.addEventListener(`focus`,this.__redispatchFocus),this.__redispatchBlur=e=>{e.stopPropagation(),this.dispatchEvent(new Event(`blur`))},this._focusableNode.addEventListener(`blur`,this.__redispatchBlur),this.__redispatchFocusin=e=>{e.stopPropagation(),this.__onFocus(),this.dispatchEvent(new Event(`focusin`,{bubbles:!0,composed:!0}))},this._focusableNode.addEventListener(`focusin`,this.__redispatchFocusin),this.__redispatchFocusout=e=>{e.stopPropagation(),this.__onBlur(),this.dispatchEvent(new Event(`focusout`,{bubbles:!0,composed:!0}))},this._focusableNode.addEventListener(`focusout`,this.__redispatchFocusout)}__teardownEventsForFocusMixin(){this._focusableNode&&(this._focusableNode?.removeEventListener(`focus`,this.__redispatchFocus),this._focusableNode?.removeEventListener(`blur`,this.__redispatchBlur),this._focusableNode?.removeEventListener(`focusin`,this.__redispatchFocusin),this._focusableNode?.removeEventListener(`focusout`,this.__redispatchFocusout))}});function Mr(e,t){return t={exports:{}},e(t,t.exports),t.exports}var Nr=`long`,Pr=`short`,Fr=`narrow`,N=`numeric`,Ir=`2-digit`,Lr={number:{decimal:{style:`decimal`},integer:{style:`decimal`,maximumFractionDigits:0},currency:{style:`currency`,currency:`USD`},percent:{style:`percent`},default:{style:`decimal`}},date:{short:{month:N,day:N,year:Ir},medium:{month:Pr,day:N,year:N},long:{month:Nr,day:N,year:N},full:{month:Nr,day:N,year:N,weekday:Nr},default:{month:Pr,day:N,year:N}},time:{short:{hour:N,minute:N},medium:{hour:N,minute:N,second:N},long:{hour:N,minute:N,second:N,timeZoneName:Pr},full:{hour:N,minute:N,second:N,timeZoneName:Pr},default:{hour:N,minute:N,second:N}},duration:{default:{hours:{minimumIntegerDigits:1,maximumFractionDigits:0},minutes:{minimumIntegerDigits:2,maximumFractionDigits:0},seconds:{minimumIntegerDigits:2,maximumFractionDigits:3}}},parseNumberPattern:function(e){if(e){var t={},n=e.match(/\b[A-Z]{3}\b/i),r=e.replace(/[^¤]/g,``).length;if(!r&&n&&(r=1),r?(t.style=`currency`,t.currencyDisplay=r===1?`symbol`:r===2?`code`:`name`,t.currency=n?n[0].toUpperCase():`USD`):e.indexOf(`%`)>=0&&(t.style=`percent`),!/[@#0]/.test(e))return t.style?t:void 0;if(t.useGrouping=e.indexOf(`,`)>=0,/E\+?[@#0]+/i.test(e)||e.indexOf(`@`)>=0){var i=e.replace(/E\+?[@#0]+|[^@#0]/gi,``);t.minimumSignificantDigits=Math.min(Math.max(i.replace(/[^@0]/g,``).length,1),21),t.maximumSignificantDigits=Math.min(Math.max(i.length,1),21)}else{for(var a=e.replace(/[^#0.]/g,``).split(`.`),o=a[0],s=o.length-1;o[s]===`0`;)--s;t.minimumIntegerDigits=Math.min(Math.max(o.length-1-s,1),21);var c=a[1]||``;for(s=0;c[s]===`0`;)++s;for(t.minimumFractionDigits=Math.min(Math.max(s,0),20);c[s]===`#`;)++s;t.maximumFractionDigits=Math.min(Math.max(s,0),20)}return t}},parseDatePattern:function(e){if(e){for(var t={},n=0;n<e.length;){for(var r=e[n],i=1;e[++n]===r;)++i;switch(r){case`G`:t.era=i===5?Fr:i===4?Nr:Pr;break;case`y`:case`Y`:t.year=i===2?Ir:N;break;case`M`:case`L`:i=Math.min(Math.max(i-1,0),4),t.month=[N,Ir,Pr,Nr,Fr][i];break;case`E`:case`e`:case`c`:t.weekday=i===5?Fr:i===4?Nr:Pr;break;case`d`:case`D`:t.day=i===2?Ir:N;break;case`h`:case`K`:t.hour12=!0,t.hour=i===2?Ir:N;break;case`H`:case`k`:t.hour12=!1,t.hour=i===2?Ir:N;break;case`m`:t.minute=i===2?Ir:N;break;case`s`:case`S`:t.second=i===2?Ir:N;break;case`z`:case`Z`:case`v`:case`V`:t.timeZoneName=i===1?Pr:Nr;break}}return Object.keys(t).length?t:void 0}}},Rr=function(e,t){if(typeof e==`string`&&t[e])return e;for(var n=[].concat(e||[]),r=0,i=n.length;r<i;++r)for(var a=n[r].split(`-`);a.length;){var o=a.join(`-`);if(t[o])return o;a.pop()}},zr=`zero`,P=`one`,F=`two`,I=`few`,L=`many`,R=`other`,z=[function(e){return+e==1?P:R},function(e){var t=+e;return 0<=t&&t<=1?P:R},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return t===0||n===1?P:R},function(e){var t=+e;return t===0?zr:t===1?P:t===2?F:3<=t%100&&t%100<=10?I:11<=t%100&&t%100<=99?L:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?P:R},function(e){var t=+e;return t%10==1&&t%100!=11?P:2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?I:t%10==0||5<=t%10&&t%10<=9||11<=t%100&&t%100<=14?L:R},function(e){var t=+e;return t%10==1&&t%100!=11&&t%100!=71&&t%100!=91?P:t%10==2&&t%100!=12&&t%100!=72&&t%100!=92?F:(3<=t%10&&t%10<=4||t%10==9)&&(t%100<10||19<t%100)&&(t%100<70||79<t%100)&&(t%100<90||99<t%100)?I:t!==0&&t%1e6==0?L:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%10==1&&t%100!=11||r%10==1&&r%100!=11?P:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)||2<=r%10&&r%10<=4&&(r%100<12||14<r%100)?I:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?P:2<=t&&t<=4&&n===0?I:n===0?R:L},function(e){var t=+e;return t===0?zr:t===1?P:t===2?F:t===3?I:t===6?L:R},function(e){var t=Math.floor(Math.abs(+e)),n=+(``+e).replace(/^[^.]*.?|0+$/g,``);return+e==1||n!==0&&(t===0||t===1)?P:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%100==1||r%100==1?P:n===0&&t%100==2||r%100==2?F:n===0&&3<=t%100&&t%100<=4||3<=r%100&&r%100<=4?I:R},function(e){var t=Math.floor(Math.abs(+e));return t===0||t===1?P:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&(t===1||t===2||t===3)||n===0&&t%10!=4&&t%10!=6&&t%10!=9||n!==0&&r%10!=4&&r%10!=6&&r%10!=9?P:R},function(e){var t=+e;return t===1?P:t===2?F:3<=t&&t<=6?I:7<=t&&t<=10?L:R},function(e){var t=+e;return t===1||t===11?P:t===2||t===12?F:3<=t&&t<=10||13<=t&&t<=19?I:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%10==1?P:n===0&&t%10==2?F:n===0&&(t%100==0||t%100==20||t%100==40||t%100==60||t%100==80)?I:n===0?R:L},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+e;return t===1&&n===0?P:t===2&&n===0?F:n===0&&(r<0||10<r)&&r%10==0?L:R},function(e){var t=Math.floor(Math.abs(+e)),n=+(``+e).replace(/^[^.]*.?|0+$/g,``);return n===0&&t%10==1&&t%100!=11||n!==0?P:R},function(e){var t=+e;return t===1?P:t===2?F:R},function(e){var t=+e;return t===0?zr:t===1?P:R},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return n===0?zr:(t===0||t===1)&&n!==0?P:R},function(e){var t=+(e+`.`).split(`.`)[1],n=+e;return n%10==1&&(n%100<11||19<n%100)?P:2<=n%10&&n%10<=9&&(n%100<11||19<n%100)?I:t===0?R:L},function(e){var t=(e+`.`).split(`.`)[1].length,n=+(e+`.`).split(`.`)[1],r=+e;return r%10==0||11<=r%100&&r%100<=19||t===2&&11<=n%100&&n%100<=19?zr:r%10==1&&r%100!=11||t===2&&n%10==1&&n%100!=11||t!==2&&n%10==1?P:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+(e+`.`).split(`.`)[1];return n===0&&t%10==1&&t%100!=11||r%10==1&&r%100!=11?P:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length,r=+e;return t===1&&n===0?P:n!==0||r===0||r!==1&&1<=r%100&&r%100<=19?I:R},function(e){var t=+e;return t===1?P:t===0||2<=t%100&&t%100<=10?I:11<=t%100&&t%100<=19?L:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return t===1&&n===0?P:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?I:n===0&&t!==1&&0<=t%10&&t%10<=1||n===0&&5<=t%10&&t%10<=9||n===0&&12<=t%100&&t%100<=14?L:R},function(e){var t=Math.floor(Math.abs(+e));return 0<=t&&t<=1?P:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%10==1&&t%100!=11?P:n===0&&2<=t%10&&t%10<=4&&(t%100<12||14<t%100)?I:n===0&&t%10==0||n===0&&5<=t%10&&t%10<=9||n===0&&11<=t%100&&t%100<=14?L:R},function(e){var t=Math.floor(Math.abs(+e)),n=+e;return t===0||n===1?P:2<=n&&n<=10?I:R},function(e){var t=Math.floor(Math.abs(+e)),n=+(e+`.`).split(`.`)[1],r=+e;return r===0||r===1||t===0&&n===1?P:R},function(e){var t=Math.floor(Math.abs(+e)),n=(e+`.`).split(`.`)[1].length;return n===0&&t%100==1?P:n===0&&t%100==2?F:n===0&&3<=t%100&&t%100<=4||n!==0?I:R},function(e){var t=+e;return 0<=t&&t<=1||11<=t&&t<=99?P:R},function(e){var t=+e;return t===1||t===5||t===7||t===8||t===9||t===10?P:t===2||t===3?F:t===4?I:t===6?L:R},function(e){var t=Math.floor(Math.abs(+e));return t%10==1||t%10==2||t%10==5||t%10==7||t%10==8||t%100==20||t%100==50||t%100==70||t%100==80?P:t%10==3||t%10==4||t%1e3==100||t%1e3==200||t%1e3==300||t%1e3==400||t%1e3==500||t%1e3==600||t%1e3==700||t%1e3==800||t%1e3==900?I:t===0||t%10==6||t%100==40||t%100==60||t%100==90?L:R},function(e){var t=+e;return(t%10==2||t%10==3)&&t%100!=12&&t%100!=13?I:R},function(e){var t=+e;return t===1||t===3?P:t===2?F:t===4?I:R},function(e){var t=+e;return t===0||t===7||t===8||t===9?zr:t===1?P:t===2?F:t===3||t===4?I:t===5||t===6?L:R},function(e){var t=+e;return t%10==1&&t%100!=11?P:t%10==2&&t%100!=12?F:t%10==3&&t%100!=13?I:R},function(e){var t=+e;return t===1||t===11?P:t===2||t===12?F:t===3||t===13?I:R},function(e){var t=+e;return t===1?P:t===2||t===3?F:t===4?I:t===6?L:R},function(e){var t=+e;return t===1||t===5?P:R},function(e){var t=+e;return t===11||t===8||t===80||t===800?L:R},function(e){var t=Math.floor(Math.abs(+e));return t===1?P:t===0||2<=t%100&&t%100<=20||t%100==40||t%100==60||t%100==80?L:R},function(e){var t=+e;return t%10==6||t%10==9||t%10==0&&t!==0?L:R},function(e){var t=Math.floor(Math.abs(+e));return t%10==1&&t%100!=11?P:t%10==2&&t%100!=12?F:(t%10==7||t%10==8)&&t%100!=17&&t%100!=18?L:R},function(e){var t=+e;return t===1?P:t===2||t===3?F:t===4?I:R},function(e){var t=+e;return 1<=t&&t<=4?P:R},function(e){var t=+e;return t===1||t===5||7<=t&&t<=9?P:t===2||t===3?F:t===4?I:t===6?L:R},function(e){var t=+e;return t===1?P:t%10==4&&t%100!=14?L:R},function(e){var t=+e;return(t%10==1||t%10==2)&&t%100!=11&&t%100!=12?P:R},function(e){var t=+e;return t%10==6||t%10==9||t===10?I:R},function(e){var t=+e;return t%10==3&&t%100!=13?I:R}],Br={af:{cardinal:z[0]},ak:{cardinal:z[1]},am:{cardinal:z[2]},ar:{cardinal:z[3]},ars:{cardinal:z[3]},as:{cardinal:z[2],ordinal:z[34]},asa:{cardinal:z[0]},ast:{cardinal:z[4]},az:{cardinal:z[0],ordinal:z[35]},be:{cardinal:z[5],ordinal:z[36]},bem:{cardinal:z[0]},bez:{cardinal:z[0]},bg:{cardinal:z[0]},bh:{cardinal:z[1]},bn:{cardinal:z[2],ordinal:z[34]},br:{cardinal:z[6]},brx:{cardinal:z[0]},bs:{cardinal:z[7]},ca:{cardinal:z[4],ordinal:z[37]},ce:{cardinal:z[0]},cgg:{cardinal:z[0]},chr:{cardinal:z[0]},ckb:{cardinal:z[0]},cs:{cardinal:z[8]},cy:{cardinal:z[9],ordinal:z[38]},da:{cardinal:z[10]},de:{cardinal:z[4]},dsb:{cardinal:z[11]},dv:{cardinal:z[0]},ee:{cardinal:z[0]},el:{cardinal:z[0]},en:{cardinal:z[4],ordinal:z[39]},eo:{cardinal:z[0]},es:{cardinal:z[0]},et:{cardinal:z[4]},eu:{cardinal:z[0]},fa:{cardinal:z[2]},ff:{cardinal:z[12]},fi:{cardinal:z[4]},fil:{cardinal:z[13],ordinal:z[0]},fo:{cardinal:z[0]},fr:{cardinal:z[12],ordinal:z[0]},fur:{cardinal:z[0]},fy:{cardinal:z[4]},ga:{cardinal:z[14],ordinal:z[0]},gd:{cardinal:z[15],ordinal:z[40]},gl:{cardinal:z[4]},gsw:{cardinal:z[0]},gu:{cardinal:z[2],ordinal:z[41]},guw:{cardinal:z[1]},gv:{cardinal:z[16]},ha:{cardinal:z[0]},haw:{cardinal:z[0]},he:{cardinal:z[17]},hi:{cardinal:z[2],ordinal:z[41]},hr:{cardinal:z[7]},hsb:{cardinal:z[11]},hu:{cardinal:z[0],ordinal:z[42]},hy:{cardinal:z[12],ordinal:z[0]},ia:{cardinal:z[4]},io:{cardinal:z[4]},is:{cardinal:z[18]},it:{cardinal:z[4],ordinal:z[43]},iu:{cardinal:z[19]},iw:{cardinal:z[17]},jgo:{cardinal:z[0]},ji:{cardinal:z[4]},jmc:{cardinal:z[0]},ka:{cardinal:z[0],ordinal:z[44]},kab:{cardinal:z[12]},kaj:{cardinal:z[0]},kcg:{cardinal:z[0]},kk:{cardinal:z[0],ordinal:z[45]},kkj:{cardinal:z[0]},kl:{cardinal:z[0]},kn:{cardinal:z[2]},ks:{cardinal:z[0]},ksb:{cardinal:z[0]},ksh:{cardinal:z[20]},ku:{cardinal:z[0]},kw:{cardinal:z[19]},ky:{cardinal:z[0]},lag:{cardinal:z[21]},lb:{cardinal:z[0]},lg:{cardinal:z[0]},ln:{cardinal:z[1]},lt:{cardinal:z[22]},lv:{cardinal:z[23]},mas:{cardinal:z[0]},mg:{cardinal:z[1]},mgo:{cardinal:z[0]},mk:{cardinal:z[24],ordinal:z[46]},ml:{cardinal:z[0]},mn:{cardinal:z[0]},mo:{cardinal:z[25],ordinal:z[0]},mr:{cardinal:z[2],ordinal:z[47]},mt:{cardinal:z[26]},nah:{cardinal:z[0]},naq:{cardinal:z[19]},nb:{cardinal:z[0]},nd:{cardinal:z[0]},ne:{cardinal:z[0],ordinal:z[48]},nl:{cardinal:z[4]},nn:{cardinal:z[0]},nnh:{cardinal:z[0]},no:{cardinal:z[0]},nr:{cardinal:z[0]},nso:{cardinal:z[1]},ny:{cardinal:z[0]},nyn:{cardinal:z[0]},om:{cardinal:z[0]},or:{cardinal:z[0],ordinal:z[49]},os:{cardinal:z[0]},pa:{cardinal:z[1]},pap:{cardinal:z[0]},pl:{cardinal:z[27]},prg:{cardinal:z[23]},ps:{cardinal:z[0]},pt:{cardinal:z[28]},"pt-PT":{cardinal:z[4]},rm:{cardinal:z[0]},ro:{cardinal:z[25],ordinal:z[0]},rof:{cardinal:z[0]},ru:{cardinal:z[29]},rwk:{cardinal:z[0]},saq:{cardinal:z[0]},sc:{cardinal:z[4],ordinal:z[43]},scn:{cardinal:z[4],ordinal:z[43]},sd:{cardinal:z[0]},sdh:{cardinal:z[0]},se:{cardinal:z[19]},seh:{cardinal:z[0]},sh:{cardinal:z[7]},shi:{cardinal:z[30]},si:{cardinal:z[31]},sk:{cardinal:z[8]},sl:{cardinal:z[32]},sma:{cardinal:z[19]},smi:{cardinal:z[19]},smj:{cardinal:z[19]},smn:{cardinal:z[19]},sms:{cardinal:z[19]},sn:{cardinal:z[0]},so:{cardinal:z[0]},sq:{cardinal:z[0],ordinal:z[50]},sr:{cardinal:z[7]},ss:{cardinal:z[0]},ssy:{cardinal:z[0]},st:{cardinal:z[0]},sv:{cardinal:z[4],ordinal:z[51]},sw:{cardinal:z[4]},syr:{cardinal:z[0]},ta:{cardinal:z[0]},te:{cardinal:z[0]},teo:{cardinal:z[0]},ti:{cardinal:z[1]},tig:{cardinal:z[0]},tk:{cardinal:z[0],ordinal:z[52]},tl:{cardinal:z[13],ordinal:z[0]},tn:{cardinal:z[0]},tr:{cardinal:z[0]},ts:{cardinal:z[0]},tzm:{cardinal:z[33]},ug:{cardinal:z[0]},uk:{cardinal:z[29],ordinal:z[53]},ur:{cardinal:z[4]},uz:{cardinal:z[0]},ve:{cardinal:z[0]},vo:{cardinal:z[0]},vun:{cardinal:z[0]},wa:{cardinal:z[1]},wae:{cardinal:z[0]},xh:{cardinal:z[0]},xog:{cardinal:z[0]},yi:{cardinal:z[4]},zu:{cardinal:z[2]},lo:{ordinal:z[0]},ms:{ordinal:z[0]},vi:{ordinal:z[0]}},Vr=Mr(function(e,t){t=e.exports=function(e,t,r){return n(e,null,t||`en`,r||{},!0)},t.toParts=function(e,t,r){return n(e,null,t||`en`,r||{},!1)};function n(e,t,n,i,a){var o=e.map(function(e){return r(e,t,n,i,a)});return a?o.length===1?o[0]:function(e){for(var t=``,n=0;n<o.length;++n)t+=o[n](e);return t}:function(e){return o.reduce(function(t,n){return t.concat(n(e))},[])}}function r(e,t,r,a,o){if(typeof e==`string`){var s=e;return function(){return s}}var c=e[0],l=e[1];if(t&&e[0]===`#`){c=t[0];var u=t[2],f=(a.number||d.number)([c,`number`],r);return function(e){return f(i(c,e)-u,e)}}var p;l===`plural`||l===`selectordinal`?(p={},Object.keys(e[3]).forEach(function(t){p[t]=n(e[3][t],e,r,a,o)}),e=[e[0],e[1],e[2],p]):e[2]&&typeof e[2]==`object`&&(p={},Object.keys(e[2]).forEach(function(t){p[t]=n(e[2][t],e,r,a,o)}),e=[e[0],e[1],p]);var m=l&&(a[l]||d[l]);if(m){var h=m(e,r);return function(e){return h(i(c,e),e)}}return o?function(e){return String(i(c,e))}:function(e){return i(c,e)}}function i(e,t){if(t&&e in t)return t[e];for(var n=e.split(`.`),r=t,i=0,a=n.length;r&&i<a;++i)r=r[n[i]];return r}function a(e,t){var n=e[2],r=Lr.number[n]||Lr.parseNumberPattern(n)||Lr.number.default;return new Intl.NumberFormat(t,r).format}function o(e,t){var n=e[2],r=Lr.duration[n]||Lr.duration.default,i=new Intl.NumberFormat(t,r.seconds).format,a=new Intl.NumberFormat(t,r.minutes).format,o=new Intl.NumberFormat(t,r.hours).format,s=/^fi$|^fi-|^da/.test(String(t))?`.`:`:`;return function(e,t){if(e=+e,!isFinite(e))return i(e);var n=~~(e/60/60),r=~~(e/60%60),c=(n?o(Math.abs(n))+s:``)+a(Math.abs(r))+s+i(Math.abs(e%60));return e<0?o(-1).replace(o(1),c):c}}function s(e,t){var n=e[1],r=e[2],i=Lr[n][r]||Lr.parseDatePattern(r)||Lr[n].default;return new Intl.DateTimeFormat(t,i).format}function c(e,t){var n=e[1]===`selectordinal`?`ordinal`:`cardinal`,r=e[2],i=e[3],a;if(Intl.PluralRules&&Intl.PluralRules.supportedLocalesOf(t).length>0)a=new Intl.PluralRules(t,{type:n});else{var o=Rr(t,Br);a={select:o&&Br[o][n]||l}}return function(e,t){return(i[`=`+ +e]||i[a.select(e-r)]||i.other)(t)}}function l(){return`other`}function u(e,t){var n=e[2];return function(e,t){return(n[e]||n.other)(t)}}var d={number:a,ordinal:a,spellout:a,duration:o,date:s,time:s,plural:c,selectordinal:c,select:u};t.types=d});Vr.toParts,Vr.types;var Hr=Mr(function(e,t){var n=[`number`,`date`,`time`,`ordinal`,`duration`,`spellout`],r=[`plural`,`select`,`selectordinal`];t=e.exports=function(e,t){return i({pattern:String(e),index:0,tagsType:t&&t.tagsType||null,tokens:t&&t.tokens||null},``)};function i(e,t){var n=e.pattern,r=n.length,i=[],o=e.index,s=a(e,t);for(s&&i.push(s),s&&e.tokens&&e.tokens.push([`text`,n.slice(o,e.index)]);e.index<r;){if(n[e.index]===`}`){if(!t)throw g(e);break}if(t&&e.tagsType&&n.slice(e.index,e.index+2)===`</`)break;i.push(c(e)),o=e.index,s=a(e,t),s&&i.push(s),s&&e.tokens&&e.tokens.push([`text`,n.slice(o,e.index)])}return i}function a(e,t){for(var n=e.pattern,r=n.length,i=t===`plural`||t===`selectordinal`,a=!!e.tagsType,s=t===`{style}`,c=``;e.index<r;){var l=n[e.index];if(l===`{`||l===`}`||i&&l===`#`||a&&l===`<`||s&&o(l.charCodeAt(0)))break;if(l===`'`)if(l=n[++e.index],l===`'`)c+=l,++e.index;else if(l===`{`||l===`}`||i&&l===`#`||a&&l===`<`||s)for(c+=l;++e.index<r;)if(l=n[e.index],l===`'`&&n[e.index+1]===`'`)c+=`'`,++e.index;else if(l===`'`){++e.index;break}else c+=l;else c+=`'`;else c+=l,++e.index}return c}function o(e){return e>=9&&e<=13||e===32||e===133||e===160||e===6158||e>=8192&&e<=8205||e===8232||e===8233||e===8239||e===8287||e===8288||e===12288||e===65279}function s(e){for(var t=e.pattern,n=t.length,r=e.index;e.index<n&&o(t.charCodeAt(e.index));)++e.index;r<e.index&&e.tokens&&e.tokens.push([`space`,e.pattern.slice(r,e.index)])}function c(e){var t=e.pattern;if(t[e.index]===`#`)return e.tokens&&e.tokens.push([`syntax`,`#`]),++e.index,[`#`];var r=l(e);if(r)return r;if(t[e.index]!==`{`)throw g(e,`{`);e.tokens&&e.tokens.push([`syntax`,`{`]),++e.index,s(e);var i=u(e);if(!i)throw g(e,`placeholder id`);e.tokens&&e.tokens.push([`id`,i]),s(e);var a=t[e.index];if(a===`}`)return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,[i];if(a!==`,`)throw g(e,`, or }`);e.tokens&&e.tokens.push([`syntax`,`,`]),++e.index,s(e);var o=u(e);if(!o)throw g(e,`placeholder type`);if(e.tokens&&e.tokens.push([`type`,o]),s(e),a=t[e.index],a===`}`){if(e.tokens&&e.tokens.push([`syntax`,`}`]),o===`plural`||o===`selectordinal`||o===`select`)throw g(e,o+` sub-messages`);return++e.index,[i,o]}if(a!==`,`)throw g(e,`, or }`);e.tokens&&e.tokens.push([`syntax`,`,`]),++e.index,s(e);var c;if(o===`plural`||o===`selectordinal`){var p=f(e);s(e),c=[i,o,p,m(e,o)]}else if(o===`select`)c=[i,o,m(e,o)];else if(n.indexOf(o)>=0)c=[i,o,d(e)];else{var h=e.index,_=d(e);s(e),t[e.index]===`{`&&(e.index=h,_=m(e,o)),c=[i,o,_]}if(s(e),t[e.index]!==`}`)throw g(e,`}`);return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,c}function l(e){var t=e.tagsType;if(!(!t||e.pattern[e.index]!==`<`)){if(e.pattern.slice(e.index,e.index+2)===`</`)throw g(e,null,`closing tag without matching opening tag`);e.tokens&&e.tokens.push([`syntax`,`<`]),++e.index;var n=u(e,!0);if(!n)throw g(e,`placeholder id`);if(e.tokens&&e.tokens.push([`id`,n]),s(e),e.pattern.slice(e.index,e.index+2)===`/>`)return e.tokens&&e.tokens.push([`syntax`,`/>`]),e.index+=2,[n,t];if(e.pattern[e.index]!==`>`)throw g(e,`>`);e.tokens&&e.tokens.push([`syntax`,`>`]),++e.index;var r=i(e,t),a=e.index;if(e.pattern.slice(e.index,e.index+2)!==`</`)throw g(e,`</`+n+`>`);e.tokens&&e.tokens.push([`syntax`,`</`]),e.index+=2;var o=u(e,!0);if(o&&e.tokens&&e.tokens.push([`id`,o]),n!==o)throw e.index=a,g(e,`</`+n+`>`,`</`+o+`>`);if(s(e),e.pattern[e.index]!==`>`)throw g(e,`>`);return e.tokens&&e.tokens.push([`syntax`,`>`]),++e.index,[n,t,{children:r}]}}function u(e,t){for(var n=e.pattern,r=n.length,i=``;e.index<r;){var a=n[e.index];if(a===`{`||a===`}`||a===`,`||a===`#`||a===`'`||o(a.charCodeAt(0))||t&&(a===`<`||a===`>`||a===`/`))break;i+=a,++e.index}return i}function d(e){var t=e.index,n=a(e,`{style}`);if(!n)throw g(e,`placeholder style name`);return e.tokens&&e.tokens.push([`style`,e.pattern.slice(t,e.index)]),n}function f(e){var t=e.pattern,n=t.length,r=0;if(t.slice(e.index,e.index+7)===`offset:`){e.tokens&&e.tokens.push([`offset`,`offset`],[`syntax`,`:`]),e.index+=7,s(e);for(var i=e.index;e.index<n&&p(t.charCodeAt(e.index));)++e.index;if(i===e.index)throw g(e,`offset number`);e.tokens&&e.tokens.push([`number`,t.slice(i,e.index)]),r=+t.slice(i,e.index)}return r}function p(e){return e>=48&&e<=57}function m(e,t){for(var n=e.pattern,i=n.length,a={};e.index<i&&n[e.index]!==`}`;){var o=u(e);if(!o)throw g(e,`sub-message selector`);e.tokens&&e.tokens.push([`selector`,o]),s(e),a[o]=h(e,t),s(e)}if(!a.other&&r.indexOf(t)>=0)throw g(e,null,null,`"other" sub-message must be specified in `+t);return a}function h(e,t){if(e.pattern[e.index]!==`{`)throw g(e,`{ to start sub-message`);e.tokens&&e.tokens.push([`syntax`,`{`]),++e.index;var n=i(e,t);if(e.pattern[e.index]!==`}`)throw g(e,`} to end sub-message`);return e.tokens&&e.tokens.push([`syntax`,`}`]),++e.index,n}function g(e,t,n,r){var i=e.pattern,a=i.slice(0,e.index).split(/\r?\n/),o=e.index,s=a.length,c=a.slice(-1)[0].length;return n||=e.index>=i.length?`end of message pattern`:u(e)||i[e.index],r||=_(t,n),r+=` in `+i.replace(/\r?\n/g,`
`),new v(r,t,n,o,s,c)}function _(e,t){return e?`Expected `+e+` but found `+t:`Unexpected `+t+` found`}function v(e,t,n,r,i,a){Error.call(this,e),this.name=`SyntaxError`,this.message=e,this.expected=t,this.found=n,this.offset=r,this.line=i,this.column=a}v.prototype=Object.create(Error.prototype),t.SyntaxError=v});Hr.SyntaxError;var Ur=RegExp(`^(`+Object.keys(Br).join(`|`)+`)\\b`),Wr=new WeakMap;function Gr(e,t,n){if(!(this instanceof Gr)||Wr.has(this))throw TypeError(`calling MessageFormat constructor without new is invalid`);var r=Hr(e);Wr.set(this,{ast:r,format:Vr(r,t,n&&n.types),locale:Gr.supportedLocalesOf(t)[0]||`en`,locales:t,options:n})}var Kr=Gr;Object.defineProperties(Gr.prototype,{format:{configurable:!0,get:function(){var e=Wr.get(this);if(!e)throw TypeError(`MessageFormat.prototype.format called on value that's not an object initialized as a MessageFormat`);return e.format}},formatToParts:{configurable:!0,writable:!0,value:function(e){var t=Wr.get(this);if(!t)throw TypeError(`MessageFormat.prototype.formatToParts called on value that's not an object initialized as a MessageFormat`);return(t.toParts||=Vr.toParts(t.ast,t.locales,t.options&&t.options.types))(e)}},resolvedOptions:{configurable:!0,writable:!0,value:function(){var e=Wr.get(this);if(!e)throw TypeError(`MessageFormat.prototype.resolvedOptions called on value that's not an object initialized as a MessageFormat`);return{locale:e.locale}}}}),typeof Symbol<`u`&&Object.defineProperty(Gr.prototype,Symbol.toStringTag,{value:`Object`}),Object.defineProperties(Gr,{supportedLocalesOf:{configurable:!0,writable:!0,value:function(e){return[].concat(Intl.NumberFormat.supportedLocalesOf(e),Intl.DateTimeFormat.supportedLocalesOf(e),Intl.PluralRules?Intl.PluralRules.supportedLocalesOf(e):[],[].concat(e||[]).filter(function(e){return Ur.test(e)})).filter(function(e,t,n){return n.indexOf(e)===t})}}});function qr(e){return!!(e&&e.default&&typeof e.default==`object`&&Object.keys(e).length===1)}var Jr=globalThis.document?.documentElement,Yr=class extends EventTarget{formatNumberOptions={returnIfNaN:``,postProcessors:new Map};formatDateOptions={postProcessors:new Map};#e=!1;#t=``;#n=null;__storage={};__namespacePatternsMap=new Map;__namespaceLoadersCache={};__namespaceLoaderPromisesCache={};get locale(){return this.#e?this.#t||``:Jr.lang||``}set locale(e){if(this.#r(e),!this.#e){let t=Jr.lang;this._setHtmlLangAttribute(e),this._onLocaleChanged(e,t);return}let t=this.#t;this.#t=e,this.#n===null&&this._setHtmlLangAttribute(e),this._onLocaleChanged(e,t)}get loadingComplete(){return typeof this.__namespaceLoaderPromisesCache[this.locale]==`object`?Promise.all(Object.values(this.__namespaceLoaderPromisesCache[this.locale])):Promise.resolve()}constructor({allowOverridesForExistingNamespaces:e=!1,autoLoadOnLocaleChange:t=!1,showKeyAsFallback:n=!1,fallbackLocale:r=``}={}){super(),this.__allowOverridesForExistingNamespaces=e,this._autoLoadOnLocaleChange=!!t,this._showKeyAsFallback=n,this._fallbackLocale=r;let i=Jr.getAttribute(`data-localize-lang`);this.#e=!!i,this.#e&&(this.locale=i,this._setupTranslationToolSupport()),Jr.lang||=this.locale||`en-GB`,this._setupHtmlLangAttributeObserver()}addData(e,t,n){if(!this.__allowOverridesForExistingNamespaces&&this._isNamespaceInCache(e,t))throw Error(`Namespace "${t}" has been already added for the locale "${e}".`);this.__storage[e]=this.__storage[e]||{},this.__allowOverridesForExistingNamespaces?this.__storage[e][t]={...this.__storage[e][t],...n}:this.__storage[e][t]=n}setupNamespaceLoader(e,t){this.__namespacePatternsMap.set(e,t)}loadNamespaces(e,{locale:t}={}){return Promise.all(e.map(e=>this.loadNamespace(e,{locale:t})))}loadNamespace(e,{locale:t=this.locale}={locale:this.locale}){let n=typeof e==`object`,r=n?Object.keys(e)[0]:e;return this._isNamespaceInCache(t,r)?Promise.resolve():this._getCachedNamespaceLoaderPromise(t,r)||this._loadNamespaceData(t,e,n,r)}msg(e,t,n={}){let r=n.locale?n.locale:this.locale,i=this._getMessageForKeys(e,r);return i?new Kr(i,r).format(t):``}teardown(){this._teardownHtmlLangAttributeObserver()}reset(){this.__storage={},this.__namespacePatternsMap=new Map,this.__namespaceLoadersCache={},this.__namespaceLoaderPromisesCache={}}setDatePostProcessorForLocale({locale:e,postProcessor:t}){this.formatDateOptions?.postProcessors.set(e,t)}setNumberPostProcessorForLocale({locale:e,postProcessor:t}){this.formatNumberOptions?.postProcessors.set(e,t)}_setupTranslationToolSupport(){this.#n=Jr.lang||null}_setHtmlLangAttribute(e){this._teardownHtmlLangAttributeObserver(),Jr.lang=e,this._setupHtmlLangAttributeObserver()}_setupHtmlLangAttributeObserver(){this._htmlLangAttributeObserver||=new MutationObserver(e=>{e.forEach(e=>{this.#e?Jr.lang===`auto`?(this.#n=null,this._setHtmlLangAttribute(this.locale)):this.#n=document.documentElement.lang:this._onLocaleChanged(document.documentElement.lang,e.oldValue||``)})}),this._htmlLangAttributeObserver.observe(document.documentElement,{attributes:!0,attributeFilter:[`lang`],attributeOldValue:!0})}_teardownHtmlLangAttributeObserver(){this._htmlLangAttributeObserver&&this._htmlLangAttributeObserver.disconnect()}_isNamespaceInCache(e,t){return!!(this.__storage[e]&&this.__storage[e][t])}_getCachedNamespaceLoaderPromise(e,t){return this.__namespaceLoaderPromisesCache[e]?this.__namespaceLoaderPromisesCache[e][t]:null}_loadNamespaceData(e,t,n,r){let i=this._getNamespaceLoader(t,n,r),a=this._getNamespaceLoaderPromise(i,e,r);return this._cacheNamespaceLoaderPromise(e,r,a),a.then(t=>{if(this.__namespaceLoaderPromisesCache[e]&&this.__namespaceLoaderPromisesCache[e][r]===a){let n=qr(t)?t.default:t;this.addData(e,r,n)}})}_getNamespaceLoader(e,t,n){let r=this.__namespaceLoadersCache[n];if(r||(t?(r=e[n],this.__namespaceLoadersCache[n]=r):(r=this._lookupNamespaceLoader(n),this.__namespaceLoadersCache[n]=r)),!r)throw Error(`Namespace "${n}" was not properly setup.`);return this.__namespaceLoadersCache[n]=r,r}_getNamespaceLoaderPromise(e,t,n,r=this._fallbackLocale){return e(t,n).catch(()=>{let i=this._getLangFromLocale(t);return e(i,n).catch(()=>{if(r)return this._getNamespaceLoaderPromise(e,r,n,``).catch(()=>{let e=this._getLangFromLocale(r);throw Error(`Data for namespace "${n}" and current locale "${t}" or fallback locale "${r}" could not be loaded. Make sure you have data either for locale "${t}" (and/or generic language "${i}") or for fallback "${r}" (and/or "${e}").`)});throw Error(`Data for namespace "${n}" and locale "${t}" could not be loaded. Make sure you have data for locale "${t}" (and/or generic language "${i}").`)})})}_cacheNamespaceLoaderPromise(e,t,n){this.__namespaceLoaderPromisesCache[e]||(this.__namespaceLoaderPromisesCache[e]={}),this.__namespaceLoaderPromisesCache[e][t]=n}_lookupNamespaceLoader(e){for(let[t,n]of this.__namespacePatternsMap){let r=typeof t==`string`&&t===e,i=typeof t==`object`&&t.constructor.name===`RegExp`&&t.test(e);if(r||i)return n}return null}_getLangFromLocale(e){return e.substring(0,2)}_onLocaleChanged(e,t){this.dispatchEvent(new CustomEvent(`__localeChanging`)),e!==t&&(this._autoLoadOnLocaleChange?(this._loadAllMissing(e,t),this.loadingComplete.then(()=>{this.dispatchEvent(new CustomEvent(`localeChanged`,{detail:{newLocale:e,oldLocale:t}}))})):this.dispatchEvent(new CustomEvent(`localeChanged`,{detail:{newLocale:e,oldLocale:t}})))}_loadAllMissing(e,t){let n=this.__storage[t]||{},r=this.__storage[e]||{};Object.keys(n).forEach(t=>{r[t]||this.loadNamespace(t,{locale:e})})}_getMessageForKeys(e,t){if(typeof e==`string`)return this._getMessageForKey(e,t);let n=Array.from(e).reverse(),r,i;for(;n.length;)if(r=n.pop(),i=this._getMessageForKey(r,t),i)return i}_getMessageForKey(e,t){if(!e||e.indexOf(`:`)===-1)throw Error(`Namespace is missing in the key "${e}". The format for keys is "namespace:name".`);let[n,r]=e.split(`:`),i=this.__storage[t],a=i?i[n]:{},o=r.split(`.`).reduce((e,t)=>typeof e==`object`?e[t]:e,a);return String(o||(this._showKeyAsFallback?e:``))}#r(e){if(!e.includes(`-`))throw Error(`
      Locale was set to ${e}.
      Language only locales are not allowed, please use the full language locale e.g. 'en-GB' instead of 'en'.
      See https://github.com/ing-bank/lion/issues/187 for more information.
    `)}get _supportExternalTranslationTools(){return this.#e}set _supportExternalTranslationTools(e){this.#e=e}get _langAttrSetByTranslationTool(){return this.#t}set _langAttrSetByTranslationTool(e){this.#t=e}};function Xr(){if(!T.has(`@lion/ui::localize::0.x`)){let e=new Yr({autoLoadOnLocaleChange:!0,fallbackLocale:`en-GB`});T.set(`@lion/ui::localize::0.x`,e)}return T.get(`@lion/ui::localize::0.x`)}function Zr(){return ne(Xr)}var Qr=(e,t)=>{let n=e._$AN;if(n===void 0)return!1;for(let e of n)e._$AO?.(t,!1),Qr(e,t);return!0},$r=e=>{let t,n;do{if((t=e._$AM)===void 0)break;n=t._$AN,n.delete(e),e=t}while(n?.size===0)},ei=e=>{for(let t;t=e._$AM;e=t){let n=t._$AN;if(n===void 0)t._$AN=n=new Set;else if(n.has(e))break;n.add(e),ri(t)}};function ti(e){this._$AN===void 0?this._$AM=e:($r(this),this._$AM=e,ei(this))}function ni(e,t=!1,n=0){let r=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(r))for(let e=n;e<r.length;e++)Qr(r[e],!1),$r(r[e]);else r!=null&&(Qr(r,!1),$r(r));else Qr(this,e)}var ri=e=>{e.type==w.CHILD&&(e._$AP??=ni,e._$AQ??=ti)},ii=class extends le{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,n){super._$AT(e,t,n),ei(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(Qr(this,e),$r(this))}setValue(e){if(Ae(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}},ai=class{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}},oi=class{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise((e=>this.Z=e))}resume(){this.Z?.(),this.Y=this.Z=void 0}},si=e=>!Oe(e)&&typeof e.then==`function`,ci=1073741823,li=ce(class extends ii{constructor(){super(...arguments),this._$Cwt=ci,this._$Cbt=[],this._$CK=new ai(this),this._$CX=new oi}render(...e){return e.find((e=>!si(e)))??o}update(e,t){let n=this._$Cbt,r=n.length;this._$Cbt=t;let i=this._$CK,a=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){let o=t[e];if(!si(o))return this._$Cwt=e,o;e<r&&o===n[e]||(this._$Cwt=ci,r=0,Promise.resolve(o).then((async e=>{for(;a.get();)await a.get();let t=i.deref();if(t!==void 0){let n=t._$Cbt.indexOf(o);n>-1&&n<t._$Cwt&&(t._$Cwt=n,t.setValue(e))}})))}return o}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}}),ui=E(e=>class extends e{static get localizeNamespaces(){return[]}static get waitForLocalizeNamespaces(){return!0}constructor(){super(),this._localizeManager=Zr(),this.__boundLocalizeOnLocaleChanged=(...e)=>{let t=Array.from(e)[0];this.__localizeOnLocaleChanged(t)},this.__boundLocalizeOnLocaleChanging=()=>{this.__localizeOnLocaleChanging()},this.__localizeStartLoadingNamespaces(),this.localizeNamespacesLoaded&&this.localizeNamespacesLoaded.then(()=>{this.__localizeMessageSync=!0})}async scheduleUpdate(){Object.getPrototypeOf(this).constructor.waitForLocalizeNamespaces&&await this.localizeNamespacesLoaded,super.scheduleUpdate()}connectedCallback(){super.connectedCallback(),this.localizeNamespacesLoaded&&this.localizeNamespacesLoaded.then(()=>this.onLocaleReady()),this._localizeManager.addEventListener(`__localeChanging`,this.__boundLocalizeOnLocaleChanging),this._localizeManager.addEventListener(`localeChanged`,this.__boundLocalizeOnLocaleChanged)}disconnectedCallback(){super.disconnectedCallback(),this._localizeManager.removeEventListener(`__localeChanging`,this.__boundLocalizeOnLocaleChanging),this._localizeManager.removeEventListener(`localeChanged`,this.__boundLocalizeOnLocaleChanged)}msgLit(e,t,n){return this.__localizeMessageSync?this._localizeManager.msg(e,t,n):this.localizeNamespacesLoaded?li(this.localizeNamespacesLoaded.then(()=>this._localizeManager.msg(e,t,n)),c):``}__getUniqueNamespaces(){let e=[],t=new Set;return Object.getPrototypeOf(this).constructor.localizeNamespaces.forEach(t.add.bind(t)),t.forEach(t=>{e.push(t)}),e}__localizeStartLoadingNamespaces(){this.localizeNamespacesLoaded=this._localizeManager.loadNamespaces(this.__getUniqueNamespaces())}__localizeOnLocaleChanging(){this.__localizeStartLoadingNamespaces()}__localizeOnLocaleChanged(e){this.onLocaleChanged(e.detail.newLocale,e.detail.oldLocale)}onLocaleReady(){this.onLocaleUpdated()}onLocaleChanged(e,t){this.onLocaleUpdated(),this.requestUpdate()}onLocaleUpdated(){}}),di=`3.0.0`,fi=window.scopedElementsVersions||(window.scopedElementsVersions=[]);fi.includes(di)||fi.push(di);var pi=E(e=>class extends e{static scopedElements;static get scopedElementsVersion(){return di}static __registry;get registry(){return this.constructor.__registry}set registry(e){this.constructor.__registry=e}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=new CustomElementRegistry;for(let[e,n]of Object.entries(t??{}))this.registry.define(e,n)}return super.attachShadow({...e,customElements:this.registry,registry:this.registry})}}),mi=E(e=>class extends pi(e){createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return this.renderOptions.creationScope=n,i(n,t),this.renderOptions.renderBefore??=n.firstChild,n}});function hi(){return!!(globalThis.ShadowRoot?.prototype.createElement&&globalThis.ShadowRoot?.prototype.importNode)}var gi=E(e=>class extends mi(e){constructor(){super()}createScopedElement(e){return(hi()?this.shadowRoot:document).createElement(e)}defineScopedElement(e,t){let n=this.registry.get(e),r=n&&n!==t;return!hi()&&r&&console.error([`You are trying to re-register the "${e}" custom element with a different class via ScopedElementsMixin.`,`This is only possible with a CustomElementRegistry.`,`Your browser does not support this feature so you will need to load a polyfill for it.`,`Load "@webcomponents/scoped-custom-element-registry" before you register ANY web component to the global customElements registry.`,`e.g. add "<script src="/node_modules/@webcomponents/scoped-custom-element-registry/scoped-custom-element-registry.min.js"><\/script>" as your first script tag.`,`For more details you can visit https://open-wc.org/docs/development/scoped-elements/`].join(`
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=hi()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return hi()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(i(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),_i=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function vi(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return _i.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var yi=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},bi=E(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),xi=E(e=>class extends bi(Te(Be(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=Ve(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...vi(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return r`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof yi&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&(typeof t!=`boolean`||t!==!1)}static get styles(){return[a`
          /**********************
            {block} .form-field
           ********************/
    ...
    `}_onRequestToAddFormElement(e){e.target.hasAttribute(`role`)||e.target?.setAttribute(`role`,`listitem`),this.__addToSubCheckboxes(e.detail.element),this._setOwnCheckedState()}_onRequestToRemoveFormElement(e){e.target.getAttribute(`role`)===`listitem`&&e.target?.removeAttribute(`role`),this.__removeFromSubCheckboxes(e.detail.element)}__addToSubCheckboxes(e){e!==this&&this.contains(e)&&this.__subCheckboxes.push(e)}__removeFromSubCheckboxes(e){let t=this.__subCheckboxes.indexOf(e);t!==-1&&this.__subCheckboxes.splice(t,1)}constructor(){super(),this.indeterminate=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this.__onModelValueChanged=this.__onModelValueChanged.bind(this),this.__subCheckboxes=[],this._indeterminateSubStates=[],this.mixedState=!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,this.__onModelValueChanged),this.addEventListener(`form-element-register`,this._onRequestToAddFormElement)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`model-value-changed`,this.__onModelValueChanged),this.removeEventListener(`form-element-register`,this._onRequestToAddFormElement)}firstUpdated(e){super.firstUpdated(e),this._setOldState(),this.indeterminate&&this._storeIndeterminateState()}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&(this._inputNode.indeterminate=this.indeterminate)}},Ji=class extends Wi{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="checkbox"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...Wi.styles,a`
      ...
      `]}};customElements.get(`craft-checkbox-group`)||customElements.define(`craft-checkbox-group`,Ji);var Yi=e=>{class t extends e{constructor(...e){super(...e),this.__ssrStateAdopted=!1}set value(e){e===``&&!this.__ssrStateAdopted&&this.__slottedInput()?.hasAttribute(`value`)||(super.value=e)}get value(){return super.value}connectedCallback(){this.__adoptSlottedInputState(),super.connectedCallback()}_toggleChecked(e){let n=this,r=n._inputNode;if(!this.disabled){if(!(r instanceof HTMLInputElement)){Object.getPrototypeOf(t.prototype)._toggleChecked?.call(this,e);return}n._isHandlingUserInput=!0,this.checked=r.checked,n._isHandlingUserInput=!1}}willUpdate(e){this.__adoptSlottedInputState(),super.willUpdate(e)}updated(e){super.updated(e);let{_inputNode:t}=this,n=this.choiceValue;typeof n==`string`&&n!==``&&t instanceof HTMLInputElement&&t.value!==n&&(t.value=n)}__slottedInput(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}__adoptSlottedInputState(){if(this.__ssrStateAdopted)return;let e=this.__slottedInput();if(!e)return;this.__ssrStateAdopted=!0,e.id&&(this._inputId=e.id),!this.name&&e.name&&(this.name=e.name);let t=e.getAttribute(`value`)??e.value;t&&(this.choiceValue=t,e.value=t),e.checked&&(this.checked=!0),e.disabled&&(this.disabled=!0)}}return t},Xi=new WeakSet,Zi=class extends Yi(qi){constructor(...e){super(...e),d(this,Xi),this.allMode=`single-value`}updated(e){super.updated(e),(e.has(`checked`)||e.has(`allMode`))&&u(Xi,this,Qi).call(this)}static get styles(){return[...qi.styles,Dr,a`
        :host {
          display: flex;
          align-items: center;
      ...
      `]}};function Qi(){let e=this.allMode===`single-value`&&this.checked;for(let t of this._subCheckboxes??[]){let n=t.querySelector(`:scope > input[slot="input"]`);n&&(e?n.name&&(n.dataset.governedName=n.name,n.removeAttribute(`name`)):n.dataset.governedName&&(n.name=n.dataset.governedName,delete n.dataset.governedName))}}p([g({reflect:!0,attribute:`all-mode`})],Zi.prototype,`allMode`,void 0),customElements.get(`craft-checkbox-indeterminate`)||customElements.define(`craft-checkbox-indeterminate`,Zi);var $i=class extends Yi(Ki){constructor(...e){super(...e),this.__inputPatched=!1,this.indeterminate=!1}connectedCallback(){super.connectedCallback(),this.__patchSlottedInputProps()}updated(e){super.updated(e),this.__patchSlottedInputProps();let t=this._inputNode;t&&(t.indeterminate=this.indeterminate)}__patchSlottedInputProps(){if(this.__inputPatched)return;let e=this.__slottedInputElement();if(!e)return;this.__inputPatched=!0;let t=this;for(let n of[`checked`,`disabled`]){let r=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,n);if(!r?.get||!r.set)continue;let{get:i,set:a}=r;Object.defineProperty(e,n,{configurable:!0,enumerable:r.enumerable,get(){return i.call(this)},set(e){a.call(this,e),t[n]!==e&&(t[n]=e)}})}}__slottedInputElement(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}static get styles(){return[...Ki.styles,Dr,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],$i.prototype,`indeterminate`,void 0),customElements.get(`craft-checkbox`)||customElements.define(`craft-checkbox`,$i);var ea=new Map;async function ta(e,t,n=!1){let r=[],i=[],a=()=>{for(let e of r)e.remove();i.forEach(e=>e())};if(!e)return a;let o=document.createElement(`template`);o.innerHTML=e.trim();try{for(let e of o.content.childNodes){let a=ra(e);if(a){let e=ea.get(a.key);if(e){e.references++,i.push(()=>sa(a.key,e)),e.loaded&&await oa(e.loaded,n);continue}if(ia(a))continue}let o=na(e),s=a&&o instanceof HTMLScriptElement?aa(o,a.value):null;if(t.appendChild(o),a&&(o instanceof HTMLLinkElement||o instanceof HTMLScriptElement)){let e={node:o,loaded:s,references:1};ea.set(a.key,e),i.push(()=>sa(a.key,e))}else r.push(o);s&&await oa(s,n)}return a}catch(e){throw a(),e}}function na(e){if(!(e instanceof HTMLScriptElement))return e.cloneNode(!0);let t=document.createElement(`script`);for(let n of e.attributes)t.setAttribute(n.name,n.value);return t.textContent=e.textContent,t.async=!1,t}function ra(e){return e instanceof HTMLLinkElement&&e.href?{key:`link:${e.href}`,selector:`link[href]`,value:e.href}:e instanceof HTMLScriptElement&&e.src?{key:`script:${e.src}`,selector:`script[src]`,value:e.src}:null}function ia(e){return Array.from(document.querySelectorAll(e.selector)).some(t=>(t instanceof HTMLLinkElement?t.href:t.src)===e.value)}function aa(e,t){return new Promise((n,r)=>{e.addEventListener(`load`,()=>n(),{once:!0}),e.addEventListener(`error`,()=>r(Error(`Failed to load asset [${t}].`)),{once:!0})})}async function oa(e,t){try{await e}catch(e){if(t)throw e}}function sa(e,t){t.references--,!(t.references>0)&&(t.node.remove(),ea.delete(e))}async function ca(e){return ta(e,document.head)}async function la(e){return ta(e,document.body)}function ua(e){return typeof e.checkVisibility==`function`?e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}):e.offsetWidth>0||e.offsetHeight>0}function da(e){return typeof e==`object`&&!!e&&`checked`in e&&typeof e.checked==`boolean`}function fa(e){return pa(e).toString()}function pa(e){let t=new URLSearchParams,n=e.querySelectorAll(`input[name], select[name], textarea[name]`);for(let e of n)if(!e.disabled&&!(e instanceof HTMLInputElement&&([`file`,`submit`,`button`,`reset`,`image`].includes(e.type)||(e.type===`checkbox`||e.type===`radio`)&&!e.checked))){if(e instanceof HTMLSelectElement&&e.multiple){for(let n of e.selectedOptions)t.append(e.name,n.value);continue}t.append(e.name,e.value)}for(let n of e.querySelectorAll(`*`)){if(!n.tagName.includes(`-`))continue;let e=n.name;if(typeof e!=`string`||e===``||n.disabled===!0||n.querySelector(`input[name], select[name], textarea[name]`))continue;if(da(n.modelValue)){n.modelValue.checked&&t.append(e,String(n.modelValue.value??``));continue}let r=n.serializedValue??n.value;if(r!=null)if(Array.isArray(r))for(let n of r)t.append(e,String(n));else t.append(e,String(r))}return t}var ma={Á:`A`,á:`a`,Ä:`A`,ä:`a`,À:`A`,à:`a`,Â:`A`,â:`a`,É:`E`,é:`e`,Ë:`E`,ë:`e`,È:`E`,è:`e`,Ê:`E`,ê:`e`,Í:`I`,í:`i`,Ï:`I`,ï:`i`,Ì:`I`,ì:`i`,Î:`I`,î:`i`,Ó:`O`,ó:`o`,Ö:`O`,ö:`o`,Ò:`O`,ò:`o`,Ô:`O`,ô:`o`,Ú:`U`,ú:`u`,Ü:`U`,ü:`u`,Ù:`U`,ù:`u`,Û:`U`,û:`u`,Ý:`Y`,ý:`y`,Ÿ:`Y`,А:`A`,Б:`B`,В:`V`,Г:`G`,Д:`D`,Ѓ:`Gj`,Е:`E`,Ж:`Z`,З:`Z`,Ѕ:`Dz`,И:`I`,Ј:`j`,К:`K`,Л:`L`,Љ:`Lj`,М:`M`,Н:`N`,Њ:`Nj`,О:`O`,П:`P`,Р:`R`,С:`S`,Т:`T`,Ќ:`Kj`,У:`U`,Ф:`F`,Х:`X`,Ц:`C`,Ч:`C`,Џ:`Dz`,Ш:`S`,а:`a`,б:`b`,в:`v`,г:`g`,д:`d`,ѓ:`gj`,е:`e`,ж:`z`,з:`z`,ѕ:`dz`,и:`i`,ј:`j`,к:`k`,л:`l`,љ:`lj`,м:`m`,н:`n`,њ:`nj`,о:`o`,п:`p`,р:`r`,с:`s`,т:`t`,ќ:`kj`,у:`u`,ф:`f`,х:`x`,ц:`c`,ч:`c`,џ:`dz`,ш:`s`,æ:`ae`,ǽ:`ae`,Ã:`A`,Å:`A`,Ǻ:`A`,Ă:`A`,Ǎ:`A`,Æ:`AE`,Ǽ:`AE`,ã:`a`,å:`a`,ǻ:`a`,ă:`a`,ǎ:`a`,ª:`a`,Ĉ:`C`,Ċ:`C`,Ç:`C`,ç:`c`,ĉ:`c`,ċ:`c`,Ð:`D`,Đ:`D`,ð:`d`,đ:`d`,Ĕ:`E`,Ė:`E`,ĕ:`e`,ė:`e`,ƒ:`f`,Ĝ:`G`,Ġ:`G`,ĝ:`g`,ġ:`g`,Ĥ:`H`,Ħ:`H`,ĥ:`h`,ħ:`h`,Ĩ:`I`,Ĭ:`I`,Ǐ:`I`,Į:`I`,Ĳ:`IJ`,ĩ:`i`,ĭ:`i`,ǐ:`i`,į:`i`,ĳ:`ij`,Ĵ:`J`,ĵ:`j`,Ĺ:`L`,Ľ:`L`,Ŀ:`L`,ĺ:`l`,ľ:`l`,ŀ:`l`,Ñ:`N`,ñ:`n`,ŉ:`n`,Õ:`O`,Ō:`O`,Ŏ:`O`,Ǒ:`O`,Ő:`O`,Ơ:`O`,Ø:`O`,Ǿ:`O`,Œ:`OE`,õ:`o`,ō:`o`,ŏ:`o`,ǒ:`o`,ő:`o`,ơ:`o`,ø:`o`,ǿ:`o`,º:`o`,œ:`oe`,Ŕ:`R`,Ŗ:`R`,ŕ:`r`,ŗ:`r`,Ŝ:`S`,Ș:`S`,ŝ:`s`,ș:`s`,ſ:`s`,Ţ:`T`,Ț:`T`,Ŧ:`T`,Þ:`TH`,ţ:`t`,ț:`t`,ŧ:`t`,þ:`th`,Ũ:`U`,Ŭ:`U`,Ű:`U`,Ų:`U`,Ư:`U`,Ǔ:`U`,Ǖ:`U`,Ǘ:`U`,Ǚ:`U`,Ǜ:`U`,ũ:`u`,ŭ:`u`,ű:`u`,ų:`u`,ư:`u`,ǔ:`u`,ǖ:`u`,ǘ:`u`,ǚ:`u`,ǜ:`u`,Ŵ:`W`,ŵ:`w`,Ŷ:`Y`,ÿ:`y`,ŷ:`y`,ΑΥ:`AU`,ΑΎ:`AU`,Αυ:`Au`,Αύ:`Au`,ΕΊ:`I`,ΕΙ:`I`,Ει:`Ei`,ΕΥ:`EF`,ΕΎ:`EU`,Εί:`I`,Ευ:`Ef`,Εύ:`Eu`,ΟΙ:`I`,ΟΊ:`I`,ΟΥ:`U`,ΟΎ:`OU`,Οι:`Oi`,Οί:`I`,Ου:`Oy`,Ού:`Ou`,ΥΙ:`I`,ΎΙ:`I`,Υι:`Yi`,Ύι:`I`,ΥΊ:`I`,Υί:`I`,αυ:`au`,αύ:`au`,εί:`i`,ει:`ei`,ευ:`ef`,εύ:`eu`,οι:`oi`,οί:`i`,ου:`oy`,ού:`ou`,υι:`yi`,ύι:`i`,υί:`i`,Α:`A`,Ά:`A`,Β:`B`,Δ:`D`,Ε:`E`,Έ:`E`,Φ:`F`,Γ:`G`,Η:`H`,Ή:`I`,Ι:`I`,Ί:`I`,Ϊ:`I`,Κ:`K`,Ξ:`Ks`,Λ:`L`,Μ:`M`,Ν:`N`,Π:`P`,Ο:`O`,Ό:`O`,Ψ:`Ps`,Ρ:`R`,Σ:`S`,Τ:`T`,Θ:`Th`,Ω:`O`,Ώ:`W`,Χ:`X`,ϒ:`Y`,Υ:`Y`,Ύ:`Y`,Ϋ:`Y`,Ζ:`Z`,α:`a`,ά:`a`,β:`v`,δ:`d`,ε:`e`,έ:`e`,φ:`f`,γ:`gh`,η:`i`,ή:`i`,ι:`i`,ί:`i`,ϊ:`i`,ΐ:`i`,κ:`k`,ξ:`ks`,λ:`l`,μ:`m`,ν:`n`,ο:`o`,ό:`o`,π:`p`,ψ:`ps`,ρ:`r`,σ:`s`,ς:`s`,τ:`t`,ϑ:`th`,θ:`th`,ϐ:`v`,ω:`o`,ώ:`w`,χ:`kh`,υ:`i`,ύ:`y`,ΰ:`y`,ϋ:`y`,ζ:`z`,अ:`a`,आ:`aa`,ए:`e`,ई:`ii`,ऍ:`ei`,ऎ:`ae`,ऐ:`ai`,इ:`i`,ओ:`o`,ऑ:`oi`,ऒ:`oii`,ऊ:`uu`,औ:`ou`,उ:`u`,ब:`B`,भ:`Bha`,च:`Ca`,छ:`Chha`,ड:`Da`,ढ:`Dha`,फ:`Fa`,फ़:`Fi`,ग:`Ga`,घ:`Gha`,ग़:`Ghi`,ह:`Ha`,ज:`Ja`,झ:`Jha`,क:`Ka`,ख:`Kha`,ख़:`Khi`,ल:`L`,ळ:`Li`,ऌ:`Li`,ऴ:`Lii`,ॡ:`Lii`,म:`Ma`,न:`Na`,ङ:`Na`,ञ:`Nia`,ण:`Nae`,ऩ:`Ni`,ॐ:`oms`,प:`Pa`,क़:`Qi`,र:`Ra`,ऋ:`Ri`,ॠ:`Ri`,ऱ:`Ri`,स:`Sa`,श:`Sha`,ष:`Shha`,ट:`Ta`,त:`Ta`,ठ:`Tha`,द:`Tha`,थ:`Tha`,ध:`Thha`,ड़:`ugDha`,ढ़:`ugDhha`,व:`Va`,य:`Ya`,य़:`Yi`,ज़:`Za`,Ա:`A`,Բ:`B`,Գ:`G`,Դ:`D`,Ե:`E`,Զ:`Z`,Է:`E`,Ը:`Y`,Թ:`Th`,Ժ:`Zh`,Ի:`I`,Լ:`L`,Խ:`Kh`,Ծ:`Ts`,Կ:`K`,Հ:`H`,Ձ:`Dz`,Ղ:`Gh`,Ճ:`Tch`,Մ:`M`,Յ:`Y`,Ն:`N`,Շ:`Sh`,Ո:`Vo`,Չ:`Ch`,Պ:`P`,Ջ:`J`,Ռ:`R`,Ս:`S`,Վ:`V`,Տ:`T`,Ր:`R`,Ց:`C`,Ւ:`u`,Փ:`Ph`,Ք:`Q`,և:`ev`,Օ:`O`,Ֆ:`F`,ա:`a`,բ:`b`,գ:`g`,դ:`d`,ե:`e`,զ:`z`,է:`e`,ը:`y`,թ:`th`,ժ:`zh`,ի:`i`,լ:`l`,խ:`kh`,ծ:`ts`,կ:`k`,հ:`h`,ձ:`dz`,ղ:`gh`,ճ:`tch`,մ:`m`,յ:`y`,ն:`n`,շ:`sh`,ո:`vo`,չ:`ch`,պ:`p`,ջ:`j`,ռ:`r`,ս:`s`,վ:`v`,տ:`t`,ր:`r`,ց:`c`,ւ:`u`,փ:`ph`,ք:`q`,օ:`o`,ֆ:`f`,Ž:`Z`,Ň:`N`,Ş:`S`,ž:`z`,ň:`n`,ş:`s`,ı:`i`,İ:`I`,ğ:`g`,Ğ:`G`,ьо:`yo`,Й:`i`,Щ:`Shh`,Ъ:`Ie`,Ь:``,Ю:`Iu`,Я:`Ia`,й:`i`,щ:`shh`,ъ:`ie`,ь:``,ю:`iu`,я:`ia`,Ē:`E`,ē:`e`,န်ုပ်:`nub`,"ောင်":`aung`,"ိုက်":`aik`,"ိုဒ်":`ok`,"ိုင်":`aing`,"ိုလ်":`ol`,"ေါင်":`aung`,သြော:`aw`,"ောက်":`auk`,"ိတ်":`eik`,"ုတ်":`ok`,"ုန်":`on`,"ေတ်":`it`,"ုဒ်":`ait`,"ာန်":`an`,"ိန်":`ein`,"ွတ်":`ut`,"ေါ်":`aw`,"ွန်":`un`,"ိပ်":`eik`,"ုပ်":`ok`,"ွပ်":`ut`,"ိမ်":`ein`,"ုမ်":`on`,"ော်":`aw`,"ွမ်":`un`,က်:`et`,"ေါ":`aw`,"ော":`aw`,"ျွ":`ywa`,"ြွ":`yw`,"ို":`o`,"ုံ":`on`,တ်:`at`,င်:`in`,ည်:`i`,ဒ်:`d`,န်:`an`,ပ်:`at`,မ်:`an`,စျ:`za`,ယ်:`e`,ဉ်:`in`,စ်:`it`,"ိံ":`ein`,"ဲ":`e`,"း":``,"ာ":`a`,"ါ":`a`,"ေ":`e`,"ံ":`an`,"ိ":`i`,"ီ":`i`,"ု":`u`,"ူ":`u`,"်":`at`,"္":``,"့":``,က:`k`,"၉":`9`,တ:`t`,ရ:`ya`,ယ:`y`,မ:`m`,ဘ:`ba`,ဗ:`b`,ဖ:`pa`,ပ:`p`,န:`n`,ဓ:`da`,ဒ:`d`,ထ:`ta`,ဏ:`na`,ဝ:`w`,ဎ:`da`,ဍ:`d`,ဌ:`ta`,ဋ:`t`,ည:`ny`,ဇ:`z`,ဆ:`sa`,စ:`s`,င:`ng`,ဃ:`ga`,ဂ:`g`,လ:`l`,သ:`th`,"၈":`8`,ဩ:`aw`,ခ:`kh`,"၆":`6`,"၅":`5`,"၄":`4`,"၃":`3`,"၂":`2`,"၁":`1`,"၀":`0`,"၌":`hnaik`,"၍":`ywae`,ဪ:`aw`,ဦ:`-u`,ဟ:`h`,ဉ:`u`,ဤ:`-i`,ဣ:`i`,"၏":`-e`,ဧ:`e`,"ှ":`h`,"ွ":`w`,"ျ":`ya`,"ြ":`y`,အ:`a`,ဠ:`la`,"၇":`7`,DŽ:`DZ`,Dž:`Dz`,dž:`dz`,Ǳ:`DZ`,ǲ:`Dz`,ǳ:`dz`,Ǉ:`LJ`,ǈ:`Lj`,ǉ:`lj`,Ǌ:`NJ`,ǋ:`Nj`,ǌ:`nj`,č:`c`,Č:`C`,ć:`c`,Ć:`C`,š:`s`,Š:`S`,ა:`a`,ბ:`b`,გ:`g`,დ:`d`,ე:`e`,ვ:`v`,ზ:`z`,თ:`t`,ი:`i`,კ:`k`,ლ:`l`,მ:`m`,ნ:`n`,ო:`o`,პ:`p`,ჟ:`zh`,რ:`r`,ს:`s`,ტ:`t`,უ:`u`,ფ:`f`,ქ:`q`,ღ:`gh`,ყ:`y`,შ:`sh`,ჩ:`ch`,ც:`ts`,ძ:`dz`,წ:`ts`,ჭ:`ch`,ხ:`kh`,ჯ:`j`,ჰ:`h`,Ё:`E`,ё:`e`,Ы:`Y`,ы:`y`,Э:`E`,э:`e`,І:`I`,і:`i`,Ѳ:`F`,ѳ:`f`,Ѣ:`E`,ѣ:`e`,Ѵ:`I`,ѵ:`i`,Є:`Je`,є:`je`,Ѥ:`Je`,ѥ:`je`,Ꙋ:`U`,ꙋ:`u`,Ѡ:`O`,ѡ:`o`,Ѿ:`Ot`,ѿ:`ot`,Ѫ:`U`,ѫ:`u`,Ѧ:`Ja`,ѧ:`ja`,Ѭ:`Ju`,ѭ:`ju`,Ѩ:`Ja`,ѩ:`Ja`,Ѯ:`Ks`,ѯ:`ks`,Ѱ:`Ps`,ѱ:`ps`,Ґ:`G`,ґ:`g`,Ї:`Yi`,ї:`yi`,Ә:`A`,Ғ:`G`,Қ:`Q`,Ң:`N`,Ө:`O`,Ұ:`U`,Ү:`U`,Һ:`H`,ә:`a`,ғ:`g`,қ:`q`,ң:`n`,ө:`o`,ұ:`u`,ү:`u`,һ:`h`,ď:`d`,Ď:`D`,ě:`e`,Ě:`E`,ř:`r`,Ř:`R`,ť:`t`,Ť:`T`,ů:`u`,Ů:`U`,ą:`a`,ę:`e`,ł:`l`,ń:`n`,ś:`s`,ź:`z`,ż:`z`,Ą:`A`,Ę:`E`,Ł:`L`,Ń:`N`,Ś:`S`,Ź:`Z`,Ż:`Z`,ā:`a`,ģ:`g`,ī:`i`,ķ:`k`,ļ:`l`,ņ:`n`,ū:`u`,Ā:`A`,Ģ:`G`,Ī:`I`,Ķ:`k`,Ļ:`L`,Ņ:`N`,Ū:`U`,Ả:`A`,Ạ:`A`,Ắ:`A`,Ằ:`A`,Ẳ:`A`,Ẵ:`A`,Ặ:`A`,Ấ:`A`,Ầ:`A`,Ẩ:`A`,Ẫ:`A`,Ậ:`A`,ả:`a`,ạ:`a`,ắ:`a`,ằ:`a`,ẳ:`a`,ẵ:`a`,ặ:`a`,ấ:`a`,ầ:`a`,ẩ:`a`,ẫ:`a`,ậ:`a`,Ẻ:`E`,Ẽ:`E`,Ẹ:`E`,Ế:`E`,Ề:`E`,Ể:`E`,Ễ:`E`,Ệ:`E`,ẻ:`e`,ẽ:`e`,ẹ:`e`,ế:`e`,ề:`e`,ể:`e`,ễ:`e`,ệ:`e`,Ỉ:`I`,Ị:`I`,ỉ:`i`,ị:`i`,Ỏ:`O`,Ọ:`O`,Ố:`O`,Ồ:`O`,Ổ:`O`,Ỗ:`O`,Ộ:`O`,Ớ:`O`,Ờ:`O`,Ở:`O`,Ỡ:`O`,Ợ:`O`,ỏ:`o`,ọ:`o`,ố:`o`,ồ:`o`,ổ:`o`,ỗ:`o`,ộ:`o`,ớ:`o`,ờ:`o`,ở:`o`,ỡ:`o`,ợ:`o`,Ủ:`U`,Ụ:`U`,Ứ:`U`,Ừ:`U`,Ử:`U`,Ữ:`U`,Ự:`U`,ủ:`u`,ụ:`u`,ứ:`u`,ừ:`u`,ử:`u`,ữ:`u`,ự:`u`,Ỳ:`Y`,Ỷ:`Y`,Ỹ:`Y`,Ỵ:`Y`,ỳ:`y`,ỷ:`y`,ỹ:`y`,ỵ:`y`,ا:`a`,ب:`b`,پ:`p`,ت:`t`,ث:`th`,ج:`g`,چ:`ch`,ح:`h`,خ:`kh`,د:`d`,ذ:`th`,ر:`r`,ز:`z`,س:`s`,ش:`sh`,ص:`s`,ض:`d`,ط:`t`,ظ:`th`,ع:`aa`,غ:`gh`,ف:`f`,ق:`k`,ک:`k`,گ:`g`,ل:`l`,ژ:`zh`,ك:`k`,م:`m`,ن:`n`,ه:`h`,و:`o`,ی:`y`,آ:`a`,"٠":`0`,"١":`1`,"٢":`2`,"٣":`3`,"٤":`4`,"٥":`5`,"٦":`6`,"٧":`7`,"٨":`8`,"٩":`9`,أ:`a`,ي:`y`,إ:`a`,ؤ:`o`,ئ:`y`,ء:`aa`,ђ:`dj`,ћ:`c`,Ђ:`Dj`,Ћ:`C`,ə:`e`,Ə:`E`,ß:`ss`,ẞ:`SS`,ভ্ল:`vl`,পশ:`psh`,ব্ধ:`bdh`,ব্জ:`bj`,ব্দ:`bd`,ব্ব:`bb`,ব্ল:`bl`,ভ:`v`,ব:`b`,চ্ঞ:`cNG`,চ্ছ:`cch`,চ্চ:`cc`,ছ:`ch`,চ:`c`,ধ্ন:`dhn`,ধ্ম:`dhm`,দ্ঘ:`dgh`,দ্ধ:`ddh`,দ্ভ:`dv`,দ্ম:`dm`,ড্ড:`DD`,ঢ:`Dh`,ধ:`dh`,দ্গ:`dg`,দ্দ:`dd`,ড:`D`,দ:`d`,"।":`.`,ঘ্ন:`Ghn`,গ্ধ:`Gdh`,গ্ণ:`GN`,গ্ন:`Gn`,গ্ম:`Gm`,গ্ল:`Gl`,জ্ঞ:`jNG`,ঘ:`Gh`,গ:`g`,হ্ণ:`hN`,হ্ন:`hn`,হ্ম:`hm`,হ্ল:`hl`,হ:`h`,জ্ঝ:`jjh`,ঝ:`jh`,জ্জ:`jj`,জ:`j`,ক্ষ্ণ:`kxN`,ক্ষ্ম:`kxm`,ক্ষ:`ksh`,কশ:`ksh`,ক্ক:`kk`,ক্ট:`kT`,ক্ত:`kt`,ক্ল:`kl`,ক্স:`ks`,খ:`kh`,ক:`k`,ল্ভ:`lv`,ল্ধ:`ldh`,লখ:`lkh`,লঘ:`lgh`,লফ:`lph`,ল্ক:`lk`,ল্গ:`lg`,ল্ট:`lT`,ল্ড:`lD`,ল্প:`lp`,ল্ম:`lm`,ল্ল:`ll`,ল্ব:`lb`,ল:`l`,ম্থ:`mth`,ম্ফ:`mf`,ম্ভ:`mv`,মপ্ল:`mpl`,ম্ন:`mn`,ম্প:`mp`,ম্ম:`mm`,ম্ল:`ml`,ম্ব:`mb`,ম:`m`,"০":`0`,"১":`1`,"২":`2`,"৩":`3`,"৪":`4`,"৫":`5`,"৬":`6`,"৭":`7`,"৮":`8`,"৯":`9`,ঙ্ক্ষ:`Ngkx`,ঞ্ছ:`nch`,ঙ্ঘ:`ngh`,ঙ্খ:`nkh`,ঞ্ঝ:`njh`,ঙ্গৌ:`ngOU`,ঙ্গৈ:`ngOI`,ঞ্চ:`nc`,ঙ্ক:`nk`,ঙ্ষ:`Ngx`,ঙ্গ:`ngo`,ঙ্ম:`Ngm`,ঞ্জ:`nj`,ন্ধ:`ndh`,ন্ঠ:`nTh`,ণ্ঠ:`NTh`,ন্থ:`nth`,ঙ্গা:`nga`,ঙ্গি:`ngi`,ঙ্গী:`ngI`,ঙ্গু:`ngu`,ঙ্গূ:`ngU`,ঙ্গে:`nge`,ঙ্গো:`ngO`,ণ্ঢ:`NDh`,নশ:`nsh`,ঙর:`Ngr`,ঞর:`NGr`,"ংর":`ngr`,ঙ:`Ng`,ঞ:`NG`,"ং":`ng`,ন্ন:`nn`,ণ্ণ:`NN`,ণ্ন:`Nn`,ন্ম:`nm`,ণ্ম:`Nm`,ন্দ:`nd`,ন্ট:`nT`,ণ্ট:`NT`,ন্ড:`nD`,ণ্ড:`ND`,ন্ত:`nt`,ন্স:`ns`,ন:`n`,ণ:`N`,"ৈ":`OI`,"ৌ":`OU`,"ো":`O`,ঐ:`OI`,ঔ:`OU`,অ:`o`,ও:`oo`,ফ্ল:`fl`,প্ট:`pT`,প্ত:`pt`,প্ন:`pn`,প্প:`pp`,প্ল:`pl`,প্স:`ps`,ফ:`f`,প:`p`,"ৃ":`rri`,ঋ:`rri`,রর‍্য:`rry`,"্র্য":`ry`,"্রর":`rr`,ড়্গ:`Rg`,ঢ়:`Rh`,ড়:`R`,র:`r`,"্র":`r`,শ্ছ:`Sch`,ষ্ঠ:`ShTh`,ষ্ফ:`Shf`,স্ক্ল:`skl`,স্খ:`skh`,স্থ:`sth`,স্ফ:`sf`,শ্চ:`Sc`,শ্ত:`St`,শ্ন:`Sn`,শ্ম:`Sm`,শ্ল:`Sl`,ষ্ক:`Shk`,ষ্ট:`ShT`,ষ্ণ:`ShN`,ষ্প:`Shp`,ষ্ম:`Shm`,স্প্ল:`spl`,স্ক:`sk`,স্ট:`sT`,স্ত:`st`,স্ন:`sn`,স্প:`sp`,স্ম:`sm`,স্ল:`sl`,শ:`S`,ষ:`Sh`,স:`s`,"ু":`u`,উ:`u`,অ্য:`oZ`,ত্থ:`tth`,ৎ:`tt`,ট্ট:`TT`,ট্ম:`Tm`,ঠ:`Th`,ত্ন:`tn`,ত্ম:`tm`,থ:`th`,ত্ত:`tt`,ট:`T`,ত:`t`,অ্যা:`AZ`,"া":`a`,আ:`a`,য়া:`ya`,য়:`y`,"ি":`i`,ই:`i`,"ী":`ee`,ঈ:`ee`,"ূ":`uu`,ঊ:`uu`,"ে":`e`,এ:`e`,য:`z`,"্য":`Z`,ইয়:`y`,ওয়:`w`,"্ব":`w`,এক্স:`x`,"ঃ":`:`,"ঁ":`nn`,"্‌":``,"˚":`0`,"¹":`1`,"²":`2`,"³":`3`,"⁴":`4`,"⁵":`5`,"⁶":`6`,"⁷":`7`,"⁸":`8`,"⁹":`9`,"₀":`0`,"₁":`1`,"₂":`2`,"₃":`3`,"₄":`4`,"₅":`5`,"₆":`6`,"₇":`7`,"₈":`8`,"₉":`9`,"௦":`0`,"௧":`1`,"௨":`2`,"௩":`3`,"௪":`4`,"௫":`5`,"௬":`6`,"௭":`7`,"௮":`8`,"௯":`9`,"௰":`10`,"௱":`100`,"௲":`1000`,Ꜳ:`AA`,ꜳ:`aa`,Ꜵ:`AO`,ꜵ:`ao`,Ꜷ:`AU`,ꜷ:`au`,Ꜹ:`AV`,ꜹ:`av`,Ꜻ:`av`,ꜻ:`av`,Ꜽ:`AY`,ꜽ:`ay`,ȸ:`db`,ʣ:`dz`,ʥ:`dz`,ʤ:`dezh`,"🙰":`et`,ﬀ:`ff`,ﬃ:`ffi`,ﬄ:`ffl`,ﬁ:`fi`,ﬂ:`fl`,ʩ:`feng`,ʪ:`ls`,ʫ:`lz`,ɮ:`lezh`,ȹ:`qp`,ʨ:`tc`,ʦ:`ts`,ʧ:`tesh`,Ꝏ:`OO`,ꝏ:`oo`,ﬆ:`st`,ﬅ:`st`,Ꜩ:`TZ`,ꜩ:`tz`,ᵫ:`ue`,Aι:`Ai`,αι:`ai`,ἀ:`a`,ἁ:`a`,ἂ:`a`,ἃ:`a`,ἄ:`a`,ἅ:`a`,ἆ:`a`,ἇ:`a`,Ἀ:`A`,Ἁ:`A`,Ἂ:`A`,Ἃ:`A`,Ἄ:`A`,Ἅ:`A`,Ἆ:`A`,Ἇ:`A`,ᾰ:`a`,ᾱ:`a`,ᾲ:`a`,ᾳ:`a`,ᾴ:`a`,ᾶ:`a`,ᾷ:`a`,Ᾰ:`A`,Ᾱ:`A`,Ὰ:`A`,Ά:`A`,ᾼ:`A`,A̧:`A`,a̧:`a`,Ⱥ:`A`,ⱥ:`a`,Ȧ:`A`,ȧ:`a`,Ɓ:`B`,C̈:`C`,c̈:`c`,C̨:`C`,c̨:`c`,Ȼ:`C`,ȼ:`c`,C̀:`C`,c̀:`c`,C̣:`C`,c̣:`c`,C̄:`C`,c̄:`c`,C̃:`C`,c̃:`c`,Ȩ:`E`,ȩ:`e`,Ɇ:`E`,ɇ:`e`,I̧:`I`,i̧:`i`,Ɨ:`I`,ɨ:`i`,i:`i`,J́́:`J`,j́:`j`,J̀̀:`J`,j̀:`j`,J̈:`J`,j̈:`j`,J̧:`J`,j̧:`j`,J̨:`J`,j̨:`j`,Ɉ:`J`,ɉ:`j`,J̌:`J`,ǰ:`j`,J̇:`J`,j:`j`,J̣:`J`,j̣:`j`,J̄:`J`,j̄:`j`,J̃:`J`,j̃:`j`,ĸ:`k`,L̀:`L`,l̀:`l`,L̂:`L`,l̂:`l`,L̈:`L`,l̈:`l`,L̨:`L`,l̨:`l`,Ƚ:`L`,ƚ:`l`,L̇:`L`,l̇:`l`,Ḷ:`L`,ḷ:`l`,L̄:`L`,l̄:`l`,L̃:`L`,l̃:`l`,Ŋ:`N`,ŋ:`n`,Ǹ:`N`,ǹ:`n`,N̂:`N`,n̂:`n`,N̈:`N`,n̈:`n`,N̨:`N`,n̨:`n`,Ꞥ:`N`,ꞥ:`n`,Ṅ:`N`,ṅ:`n`,Ṇ:`N`,ṇ:`n`,N̄:`N`,n̄:`n`,O̧:`O`,o̧:`o`,Ǫ:`O`,ǫ:`o`,Ɵ:`O`,ɵ:`o`,Ȯ:`O`,ȯ:`o`,S̀:`S`,s̀:`s`,Ŝ̀:`S`,S̈:`S`,s̈:`s`,S̨:`S`,s̨:`s`,Ꞩ:`S`,ꞩ:`s`,Ṡ:`S`,ṡ:`s`,Ṣ:`S`,ṣ:`s`,S̄:`S`,s̄:`s`,S̃:`S`,s̃:`s`,T́:`T`,t́:`t`,T̀:`T`,t̀:`t`,T̂:`T`,t̂:`t`,T̈:`T`,ẗ:`t`,T̨:`T`,t̨:`t`,Ⱦ:`T`,ⱦ:`t`,Ṫ:`T`,ṫ:`t`,Ṭ:`T`,ṭ:`t`,T̄:`T`,t̄:`t`,T̃:`T`,t̃:`t`,U̧:`U`,u̧:`u`,Ʉ:`U`,ʉ:`u`,U̇:`U`,u̇:`u`,Ʊ:`U`,ʊ:`u`,Ẁ:`W`,ẁ:`w`,Ẃ:`W`,ẃ:`w`,Ẅ:`W`,ẅ:`w`,Ꙗ:`Ja`,ꙗ:`ja`,Y̧:`Y`,y̧:`y`,Y̨:`Y`,y̨:`y`,Ɏ:`Y`,ɏ:`y`,Y̌:`Y`,y̌:`y`,Ẏ:`Y`,ẏ:`y`,Ȳ:`Y`,ȳ:`y`,Z̀:`Z`,z̀:`z`,Ẑ:`Z`,ẑ:`z`,Z̈:`Z`,z̈:`z`,Z̧:`Z`,z̧:`z`,Z̨:`Z`,z̨:`z`,Ƶ:`Z`,ƶ:`z`,Ẓ:`Z`,ẓ:`z`,Z̄:`Z`,z̄:`z`,Z̃:`Z`,z̃:`z`,"\xA0":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `,"\u2028":` `,"\u2029":` `,"​":` `," ":` `," ":` `,"　":` `,ﾠ:` `,"«":`<<`,"»":`>>`,"‘":`'`,"’":`'`,"‚":`'`,"‛":`'`,"“":`"`,"”":`"`,"„":`"`,"‟":`"`,"‹":`'`,"›":`'`,"–":`-`,"—":`-`,"…":`...`,"€":`EUR`,$:`$`,"₢":`Cr`,"₣":`Fr.`,"£":`PS`,"₤":`L.`,ℳ:`M`,"₥":`mil`,"₦":`N`,"₧":`Pts`,"₨":`Rs`,රු:`LKR`,ரூ:`LKR`,"௹":`Rs`,रू:`NPR`,"₹":`Rs`,"૱":`Rs`,"₩":`W`,"₪":`NS`,"₸":`KZT`,"₫":`D`,"֏":`AMD`,"₭":`K`,"₺":`TL`,"₼":`AZN`,"₮":`T`,"₯":`Dr`,"₲":`PYG`,"₾":`GEL`,"₳":`ARA`,"₴":`UAH`,"₽":`RUB`,"₵":`GHS`,"₡":`CL`,"¢":`c`,"¥":`YEN`,円:`JPY`,"৳":`BDT`,元:`CNY`,"﷼":`SAR`,"៛":`KR`,"₠":`ECU`,"¤":`$?`,"฿":`THB`,"؋":`AFN`};function ha(e,t=ma){e=e.normalize(`NFC`);let n=``,r;for(let i=0;i<e.length;i++)r=e.charAt(i),n+=typeof t[r]==`string`?t[r]:r;return n}function ga(e,t={}){let n={allowNonAlphaStart:!1,handleCasing:`camel`,...t};var r=e.replace(/<(.*?)>/g,``);r=r.replace(/['"‘’“”ʻ\[\]\(\)\{\}:]/g,``),r=r.toLowerCase(),r=ha(r),n.allowNonAlphaStart||(r=r.replace(/^[^a-z]+/,``));let i=r.split(/[^a-z0-9]+/).filter(Boolean);if(r=``,n.handleCasing===`snake`)return i.join(`_`);for(let e=0;e<i.length;e++)n.handleCasing!==`pascal`&&e===0?r+=i[e]:r+=i[e].charAt(0).toUpperCase()+i[e].substring(1);return r}function _a(e,t={}){let n={prefix:``,suffix:``,...t},r=ga(e,{handleCasing:`snake`}).toUpperCase();return r?`${n.prefix}${r}${n.suffix}`:``}function va(e){let t=e.replace(/<(.*?)>/g,``);return t=t.toLowerCase(),t=ha(t),t=t.replace(/^[^a-z]+/,``),t=t.replace(/[^a-z0-9]+$/,``),t.split(/[^a-z0-9]+/).filter(Boolean).join(`-`)}function ya(e){return e.charAt(0).toUpperCase()+e.slice(1)}function ba(){return Math.floor(Math.random()*1e6)}var xa=new WeakMap,Sa=class e{constructor(){this.queue=[],this.workers=[],f(this,xa,null),h(xa,this,new AbortController);for(let e=0;e<3;e++)this.workers.push(new Ea(this))}load(t=document,n=`[data-sizes]`){t.querySelectorAll(n).forEach(t=>{if(ua(t))this.addToQueue(t);else{let n=`thumb${ba()}`;e.invisibleThumbs[n]=[this,t];let r=()=>{e.invisibleThumbs[n]&&ua(t)&&(delete e.invisibleThumbs[n],this.addToQueue(t))};document.addEventListener(`scroll`,r,{signal:m(xa,this)?.signal}),window.addEventListener(`resize`,r,{signal:m(xa,this)?.signal})}})}addToQueue(e){this.queue.push(e),this.workers.forEach(e=>{e.active||e.loadNext()})}static retryAll(){for(let t in e.invisibleThumbs){let n=e.invisibleThumbs[t];if(!n)continue;let[r,i]=n;delete e.invisibleThumbs[t],r.load(i.parentElement??document)}}destroy(){this.workers.forEach(e=>e.deactivate()),m(xa,this)?.abort()}};Sa.invisibleThumbs={};var Ca=new WeakMap,wa=new WeakMap,Ta=new WeakMap,Ea=class{constructor(e){this.active=!1,this.container=void 0,f(this,Ca,null),f(this,wa,null),f(this,Ta,null),h(Ca,this,e)}activate(){this.active||(this.active=!0,this.clearInterval(),h(wa,this,setInterval(()=>{this.loadNextIfRemoved()},500)))}deactivate(){this.active&&(this.active=!1,this.clearInterval(),this.clearTimeout())}clearInterval(){m(wa,this)&&(clearInterval(m(wa,this)),h(wa,this,null))}clearTimeout(){m(Ta,this)&&(clearTimeout(m(Ta,this)),h(Ta,this,null))}loadNext(){if(this.clearTimeout(),this.container=m(Ca,this)?.queue.shift(),this.container===void 0){this.deactivate();return}if(this.loadNextIfRemoved())return;if(this.container.querySelectorAll(`img`).length>0){this.loadNext();return}this.activate(),h(Ta,this,setTimeout(()=>{this.loadNext()},3e4));let e=document.createElement(`img`);e.sizes=this.container.getAttribute(`data-sizes`)??``,e.srcset=this.container.getAttribute(`data-srcset`)??``,e.alt=this.container.getAttribute(`data-alt`)??``,e.setAttribute(`data-animated`,this.container.getAttribute(`data-animated`)??``),e.src=this.container.getAttribute(`data-src`)??``,e.onload=()=>this.loadNext(),e.onabort=()=>this.loadNext(),e.onerror=()=>this.loadNext(),this.container.appendChild(e)}loadNextIfRemoved(){return this.container&&!document.body.contains(this.container)?(this.loadNext(),!0):!1}},Da=a`
  :host {
    display: contents;
  }
...
`,Oa=new WeakMap,ka=new WeakMap,Aa=new WeakMap,ja=new WeakSet,Ma=class extends l{constructor(...e){super(...e),d(this,ja),this.size=``,this.variant=xe.Neutral,this.appearance=oe.OutlineFill,this.icon=null,this.showIndicators=!1,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,this.selected=!1,this.selectLabel=null,f(this,Oa,!1),f(this,ka,new Sa),this.lightDom=0,f(this,Aa,new MutationObserver(()=>this.lightDom++))}connectedCallback(){super.connectedCallback(),m(Aa,this).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){m(Aa,this).disconnect(),super.disconnectedCallback()}renderSelect(){return r`<input
      type="checkbox"
      class="cp-chip__select"
      part="select"
      .checked=${this.selected}
      aria-label=${this.selectLabel??c}
      @click=${u(ja,this,Na)}
      @change=${u(ja,this,Pa)}
    />`}renderPrefix(){return r`<div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
        ${this.showThumb?r`<slot class="cp-chip__thumbnail" name="thumbnail"></slot>`:c}
        ${this.icon?r`<slot class="cp-chip__icon" name="icon"
              ><craft-icon name="${this.icon}"></craft-icon
            ></slot>`:c}
        ${this.showStatus?r`<slot class="cp-chip__status" name="status"></slot>`:c}
      </slot>
    </div>`}firstUpdated(e){super.firstUpdated(e),m(ka,this).load(this)}render(){this.lightDom;let e=u(ja,this,Fa).call(this,`prefix`)||u(ja,this,Fa).call(this,`icon`)||u(ja,this,Fa).call(this,`thumbnail`)||u(ja,this,Fa).call(this,`indicator`)||u(ja,this,Fa).call(this,`status`)||this.icon,t=u(ja,this,Fa).call(this,`suffix`);return r`
      <div
        part="chip"
        class="${S({"cp-chip":!0,"cp-chip--small":this.size===`small`,"cp-chip--medium":this.size===`medium`,"cp-chip--large":this.size===`large`,"cp-chip--plain":this.appearance===oe.Plain,"cp-chip--selectable":this.selectable,"cp-chip--show-thumb":this.showThumb,"cp-chip--show-indicators":this.showIndicators,"cp-chip--show-status":this.showStatus})}"
      >
        ${this.selectable?this.renderSelect():c}
    ...
    `}};function Na(e){h(Oa,this,e.shiftKey),e.stopPropagation()}function Pa(e){let{checked:t}=e.target;this.selected=t,this.dispatchEvent(new CustomEvent(`selected-change`,{detail:{selected:t,shiftKey:m(Oa,this)},bubbles:!0,composed:!0}))}function Fa(e){return!!this.querySelector(`:scope > [slot="${e}"]`)}Ma.styles=[Da],p([g()],Ma.prototype,`size`,void 0),p([g({reflect:!0})],Ma.prototype,`variant`,void 0),p([g({reflect:!0})],Ma.prototype,`appearance`,void 0),p([g()],Ma.prototype,`icon`,void 0),p([g({attribute:`show-indicators`,type:Boolean})],Ma.prototype,`showIndicators`,void 0),p([g({attribute:`show-status`,type:Boolean})],Ma.prototype,`showStatus`,void 0),p([g({attribute:`show-thumb`,type:Boolean})],Ma.prototype,`showThumb`,void 0),p([g({type:Boolean})],Ma.prototype,`selectable`,void 0),p([g({type:Boolean,reflect:!0})],Ma.prototype,`selected`,void 0),p([g({attribute:`select-label`})],Ma.prototype,`selectLabel`,void 0),p([_()],Ma.prototype,`lightDom`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,Ma);var Ia=class extends Li(l){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},La=E(e=>class extends xi(gi(zi(Be(Ii(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],a`
          :host {
            display: block;
          }
...
`,Va=new WeakMap,Ha=new WeakSet,Ua=class extends za{constructor(...e){super(...e),d(this,Ha),this.hint=null,f(this,Va,void 0)}static get styles(){return[...za.styles,Ba]}connectedCallback(){super.connectedCallback(),Ga._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),Ga._.unobserve(this)}render(){return r`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?r`<span class="hint">${this.hint}</span>`:c}
        <slot name="suffix"></slot>
      </div>
    `}};function Wa(){return m(Va,this)??h(Va,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),m(Va,this)}var Ga={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=u(Ha,e,Wa).call(e))}})};p([g()],Ua.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,Ua);var Ka=new WeakMap;function qa(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Ka.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else qa(n,t)})}function Ja(e){Ka.has(e)&&Ka.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Ka.has(e)&&Ka.get(e)():Ja(e)})}var Ya=class extends Oi{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof yi}};function Xa(e){return Array.isArray(e)?e:[e]}var Za=E(e=>class extends zi(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Xa(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Xa(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Xa(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Xa(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Qa=new WeakMap,$a=class extends ui(ie(Za(Ra))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,a`
        .input-group__input {
          display: flex;
          flex: 1;
        }
...
`,ro=new WeakMap,io=new WeakMap,ao=new WeakMap,B=new WeakSet,oo=new WeakMap,so=class extends $a{static get properties(){return{modelValue:{attribute:`model-value`}}}attributeChangedCallback(e,t,n){if(e===`model-value`){this.modelValue=this.hasAttribute(`multiple-choice`)?JSON.parse(n??`[]`):n??``;return}super.attributeChangedCallback(e,t,n)}static get styles(){return[...super.styles,no]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,B),this.multipleChoice=!1,this.required=!1,this.initialValues=[],this.fieldsetDisabled=!1,this.changingValues=!1,this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,ro,void 0),f(this,io,!1),f(this,ao,()=>{h(io,this,!0),u(B,this,po).call(this),!this.multipleChoice&&!this.requireOptionMatch&&u(B,this,co).call(this)}),f(this,oo,()=>{if(this.multipleChoice){this.changeValues([]);return}this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(B,this,po).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.selectionFollowsFocus=!1,this.addEventListener(`model-value-changed`,e=>{if(this.changingValues){e.stopImmediatePropagation();return}if(e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&JSON.stringify(this.modelValue)!==JSON.stringify(this.pendingModelValue)){e.stopImmediatePropagation();return}e.target===this&&e.detail?.isTriggeredByUser&&(this.pendingModelValue=this.multipleChoice?[...this.selectedValues]:this.modelValue,this.multipleChoice&&(this.syncInputs(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))))}),this.addEventListener(`focusout`,e=>{this.multipleChoice&&!this.requireOptionMatch&&!(e.relatedTarget instanceof Node&&this.contains(e.relatedTarget))&&this.commitQuery()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m(ao,this)),this.addEventListener(`model-value-changed`,()=>{h(ro,this,this.modelValue)}),h(ro,this,this.modelValue),u(B,this,po).call(this),this.multipleChoice&&(this.initialValues=[...Array.isArray(this.pendingModelValue)?this.pendingModelValue:[]])}updated(e){if(super.updated(e),this.multipleChoice){this.syncInputs(),this._inputNode.removeAttribute(`name`),this._comboboxNode.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this._inputNode.disabled=this.disabled||this.fieldsetDisabled;let e=this.required&&!this.inactive&&this.selectedValues.length===0;this.internals??=this.attachInternals(),this.internals.setValidity(e?{valueMissing:!0}:{},e?O(`This field is required.`):``,this._inputNode)}e.has(`opened`)&&!this.opened&&h(io,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`)||e.has(`multipleChoice`))&&u(B,this,po).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,u(B,this,_o).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t);let n=e;n.updateComplete.then(()=>{if(this.multipleChoice){n.checked=Array.isArray(this.pendingModelValue)&&this.pendingModelValue.includes(String(n.choiceValue));return}String(n.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(n)))})}_notifyModelValueChanged(){JSON.stringify(this.modelValue)!==JSON.stringify(m(ro,this))&&(h(ro,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:this.multipleChoice?`selection`:`input`}})))}matchCondition(e){return!this.multipleChoice||!e.hidden}_autoSelectCondition(){return!this.multipleChoice}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=u(B,this,_o).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ${this.multipleChoice?to(this.selectedValues,e=>e,e=>r`
                <span class="token">
                  ${this.valueLabel(e)}
                  ${this.inactive?c:r`<button
                        type="button"
                        aria-label=${O(`Remove {label}`,{label:this.valueLabel(e)})}
                        @click=${()=>this.changeValues(this.selectedValues.filter(t=>t!==e))}
                      >
                        ×
                      </button>`}
                </span>
        ...
        <div class="combobox__textbox">
          ${e?r`<craft-icon class="prefix" name=${e}></craft-icon>`:c}
          <slot name="input"></slot>
          ${this.clearable&&u(B,this,ho).call(this)&&!this.inactive?r`<craft-button
                class="clear"
                type="button"
                appearance="plain"
                size="small"
    ...
    `}get selectedValues(){return Array.isArray(this.modelValue)?this.modelValue:[]}get inactive(){return this.disabled||this.readOnly||this.fieldsetDisabled}valueLabel(e){return[...u(B,this,vo).call(this)].find(t=>t.value===e)?.label??e}syncInputs(){this.inputs||(this.inputs=document.createElement(`span`),this.inputs.hidden=!0,this.inputs.slot=`native-inputs`,this.inputs.setAttribute(`data-combobox-inputs`,``),this.append(this.inputs)),s(!this.name||this.disabled||this.fieldsetDisabled?c:r`
            <input type="hidden" name=${this.name} value="" />
            ${this.selectedValues.map(e=>r`<input
                  type="hidden"
                  name=${`${this.name}[]`}
                  .value=${e}
                />`)}
          `,this.inputs)}formResetCallback(){this.multipleChoice&&(this.modelValue=[...this.initialValues],this.value=``,this.syncInputs())}formDisabledCallback(e){this.fieldsetDisabled=e,this.requestUpdate(),this.multipleChoice&&this.syncInputs()}changeValues(e){if(!this.inactive){this.changingValues=!0;try{this.modelValue=e}finally{this.changingValues=!1}this.value=``,this.opened=!1,u(B,this,po).call(this),this.syncInputs(),this._notifyModelValueChanged(),this._inputNode.focus()}}commitQuery(){let e=this.value;if(this.inactive||e===``)return;let t=[...u(B,this,vo).call(this)].find(t=>t.value===e);t?.disabled||this.requireOptionMatch&&!t||this.changeValues([...new Set([...this.selectedValues,e])])}_listboxOnKeyDown(e){if(!this.multipleChoice){super._listboxOnKeyDown(e);return}if(this.inactive||e.isComposing)return;if(e.key===`Backspace`&&this.value===``){e.preventDefault(),this.changeValues(this.selectedValues.slice(0,-1));return}let t=this.formElements[this.activeIndex];if(e.key===`Enter`&&(!this.opened||!t||t.hidden||t.hasAttribute(`aria-hidden`))){e.preventDefault(),this.commitQuery();return}super._listboxOnKeyDown(e)}_syncToTextboxMultiple(){}_resetListboxOptions(){super._resetListboxOptions(),this.hideSelectedOptions()}_handleAutocompletion(){super._handleAutocompletion(),this.hideSelectedOptions()}hideSelectedOptions(){if(!this.multipleChoice)return;for(let e of this.formElements)e.hidden&&(e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`aria-posinset`),e.removeAttribute(`aria-setsize`));let e=this.formElements.filter(e=>!e.hasAttribute(`aria-hidden`));e.forEach((t,n)=>{t.setAttribute(`aria-posinset`,String(n+1)),t.setAttribute(`aria-setsize`,String(e.length))})}parser(e){if(typeof e==`string`&&e!==``){let t=u(B,this,go).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function co(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function lo(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(u(B,this,uo).call(this,e))for(let r of e.options)(t===``||u(B,this,fo).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||u(B,this,fo).call(this,t,e))&&n.push({option:e});return n}function uo(e){return e.type===`optgroup`}function fo(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function po(){let e=this._listboxNode;if(!e)return;let t=m(io,this)?this._inputNode?.value??``:``,n=this.multipleChoice?Array.isArray(this.pendingModelValue)?this.pendingModelValue:this.selectedValues:[],i=u(B,this,lo).call(this,t).filter(e=>!n.includes(e.option.value)),a=i.slice(0,this.limit),o=[...u(B,this,vo).call(this)],l=[...n.map(e=>({option:o.find(t=>t.value===e)??{value:e,label:e}})),...a],d,f=l.map(e=>{let t=e.groupLabel&&e.groupLabel!==d?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return d=e.groupLabel,{value:e.option.value,template:r`${t}${u(B,this,mo).call(this,e.option,n.includes(e.option.value))}`}}),p=i.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${O(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:i.length})}
          </div>`:c;s(r`${to(f,e=>e.value,e=>e.template)}${p}`,e)}function mo(e,t=!1){let n=e.data??{},i=e.label,a=i.startsWith(`$`)||i.startsWith(`@`);return r`
      <craft-option
        ?hidden=${t}
        aria-hidden=${t?`true`:c}
        .choiceValue=${String(e.value)}
        .hint=${n.hint??null}
        ?disabled=${e.disabled??!1}
      >
        <span class="combobox__option">
          ${n.indicator?r`<craft-indicator
                variant=${n.indicator.variant??`neutral`}
              ></craft-indicator>`:c}
          ${n.icon?r`<craft-icon name="${n.icon}"></craft-icon>`:c}
          ${a?r`<code>${i}</code>`:i}
        </span>
      </craft-option>
    `}function ho(){return this.multipleChoice?this.selectedValues.length>0:this.modelValue!==``&&this.modelValue!=null}function go(e){let t=e.trim();for(let e of u(B,this,vo).call(this))if(u(B,this,yo).call(this,e)===t)return e}function _o(){if(this.multipleChoice||!u(B,this,ho).call(this))return;let e=String(this.modelValue);for(let t of u(B,this,vo).call(this))if(String(t.value)===e)return t}function*vo(){for(let e of this.options)u(B,this,uo).call(this,e)?yield*e.options:yield e}function yo(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}so.formAssociated=!0,p([g({type:Boolean,attribute:`multiple-choice`,reflect:!0})],so.prototype,`multipleChoice`,void 0),p([g({type:Boolean})],so.prototype,`required`,void 0),p([g({type:Array})],so.prototype,`options`,void 0),p([g({type:Number})],so.prototype,`limit`,void 0),p([g({type:Boolean,reflect:!0})],so.prototype,`clearable`,void 0),p([g({type:String,reflect:!0})],so.prototype,`placeholder`,void 0),p([g({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],so.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,so);var bo=a`
  :host {
    display: inline-block;
  }
...
`,xo={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},So=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(xo[`icon.out`].keyframes,xo[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(xo[`icon.in`].keyframes,xo[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(xo[`icon.out`].keyframes,xo[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(xo[`icon.in`].keyframes,xo[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||O(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};So.styles=[bo],p([_()],So.prototype,`isCopying`,void 0),p([_()],So.prototype,`status`,void 0),p([y(`slot[name="copy-icon"]`)],So.prototype,`copyIconEl`,void 0),p([y(`slot[name="success-icon"]`)],So.prototype,`successIconEl`,void 0),p([y(`slot[name="error-icon"]`)],So.prototype,`errorIconEl`,void 0),p([y(`craft-tooltip`)],So.prototype,`tooltipEl`,void 0),p([g({type:String})],So.prototype,`value`,void 0),p([g({type:Boolean})],So.prototype,`disabled`,void 0),p([g({attribute:`feedback-duration`,type:Number})],So.prototype,`feedbackDuration`,void 0),p([g({attribute:`tooltip-label`})],So.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,So);var Co=a`
  :host {
    box-sizing: border-box;
  }
...
`,To=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return r`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};To.styles=[Co,wo],p([y(`craft-copy-button`)],To.prototype,`copyButtonEl`,void 0),p([g({type:String})],To.prototype,`value`,void 0),p([g({type:Boolean,reflect:!0})],To.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,To);var Eo=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function Do(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function Oo(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(Eo))).filter(Do)}function ko(e){let t=t=>{if(t.key!==`Tab`)return;let n=Oo(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var Ao=a`
  :host {
    display: contents;
...
`,jo=0,Mo=0;function No(){Mo++===0&&document.body.classList.add(`no-scroll`)}function Po(){Mo>0&&--Mo===0&&document.body.classList.remove(`no-scroll`)}var Fo=new WeakMap,Io=new WeakMap,Lo=new WeakMap,Ro=new WeakMap,zo=new WeakSet,Bo=new WeakMap,Vo=new WeakMap,Ho=new WeakMap,Uo=new WeakMap,Wo=new WeakMap,Go=new WeakMap,Ko=class extends l{constructor(...e){super(...e),d(this,zo),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++jo}`,f(this,Fo,!1),f(this,Io,null),f(this,Lo,!1),f(this,Ro,null),f(this,Bo,e=>{e.preventDefault(),this.requestClose()}),f(this,Vo,()=>{this.opened=!1}),f(this,Ho,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),f(this,Uo,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),f(this,Wo,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),f(this,Go,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,m(Uo,this)),this.addEventListener(`keydown`,m(Ho,this)),h(Ro,this,new MutationObserver(()=>this.requestUpdate())),m(Ro,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(Uo,this)),this.removeEventListener(`keydown`,m(Ho,this)),m(Ro,this)?.disconnect(),h(Ro,this,null),m(Io,this)?.call(this),h(Io,this,null),u(zo,this,Yo).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
      ${this.nonModal&&this.opened?r`<div
            class="backdrop"
            part="backdrop"
            @click=${m(Go,this)}
          ></div>`:c}
      <dialog
        part="dialog"
        aria-labelledby=${this.hasHeader&&this.label!==``?this.titleId:c}
        @cancel=${m(Bo,this)}
        @close=${m(Vo,this)}
        @click=${m(Wo,this)}
      >
        <div class="surface" part="surface">
          ${this.hasHeader?this.renderHeader():c} ${this.renderBody()}
          ${this.renderFooter()}
        </div>
      </dialog>
    `}get hasHeader(){return this.label!==``||!this.noClose}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?r`<div></div>`:r`<h2 class="title" part="title" id=${this.titleId}>
              ${this.label}
            </h2>`}
        ${this.noClose?c:r`<button
              type="button"
              class="close"
              part="close"
              aria-label=${O(`Close`)}
    ...
    `}renderBody(){return r`<div class="body" part="body"><slot></slot></div>`}renderFooter(){return r`
      <footer class="footer" part="footer" ?hidden=${!this.hasFooter}>
        <slot name="footer"> </slot>
      </footer>
    `}updated(e){super.updated(e),this.opened!==m(Fo,this)&&(h(Fo,this,this.opened),this.opened?u(zo,this,qo).call(this):u(zo,this,Jo).call(this),u(zo,this,Xo).call(this,this.opened))}requestClose(){this.dispatchEvent(new CustomEvent(`craft-before-hide`,{bubbles:!0,composed:!0,cancelable:!0}))&&(this.opened=!1)}};function qo(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(m(Io,this)?.call(this),h(Io,this,ko(this))),m(Lo,this)||(h(Lo,this,!0),No())}function Jo(){let e=this.dialogElement;e?.open&&e.close(),m(Io,this)?.call(this),h(Io,this,null),u(zo,this,Yo).call(this)}function Yo(){m(Lo,this)&&(h(Lo,this,!1),Po())}function Xo(e){u(zo,this,Zo).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&u(zo,this,Zo).call(this,e?`craft-after-show`:`craft-after-hide`)})}function Zo(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}Ko.styles=[Co,Ao],p([g({type:Boolean,attribute:`open`,reflect:!0})],Ko.prototype,`opened`,void 0),p([g()],Ko.prototype,`label`,void 0),p([g({type:Boolean,attribute:`non-modal`,reflect:!0})],Ko.prototype,`nonModal`,void 0),p([g({type:Boolean,reflect:!0})],Ko.prototype,`fullscreen`,void 0),p([g({type:Boolean,attribute:`close-on-outside-click`})],Ko.prototype,`closeOnOutsideClick`,void 0),p([g({type:Boolean,attribute:`no-close`,reflect:!0})],Ko.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,Ko);var Qo=new WeakMap,$o=new WeakSet,es=class{constructor(e,t){this.host=e,this.source=t,d(this,$o),f(this,Qo,null),e.addController(this)}hostConnected(){u($o,this,ts).call(this)}hostDisconnected(){u($o,this,ns).call(this)}resubscribe(){u($o,this,ns).call(this),u($o,this,ts).call(this)}get state(){return this.source()?.state??null}};function ts(){h(Qo,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function ns(){m(Qo,this)?.call(this),h(Qo,this,null)}var rs=a`
  :host {
    /*
...
`,is=new WeakMap,as=new WeakMap,os=new WeakMap,ss=new WeakMap,cs=new WeakMap,ls=class extends Ko{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,f(this,is,new es(this,()=>this.controller)),f(this,as,null),f(this,os,()=>{this.submit()}),f(this,ss,()=>{this.busy||this.requestClose()}),f(this,cs,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&h(as,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),m(as,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&m(is,this).resubscribe();let t=m(is,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&m(as,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
    ...
    `}renderBody(){return r`
      <div class="body" part="body" ?inert=${this.busy}>
        ${this.loading&&!this.hasIndex?r`<div class="loading"><craft-spinner></craft-spinner></div>`:c}
        <slot></slot>
      </div>
      ...
      <footer class="footer" part="footer">
        ...
        <div class="footer__group" part="primary-actions">
          ...
          <craft-button
            ...
            @click=${m(os,this)}
          >
            ${this.selectLabel||O(`Select`)}
          </craft-button>
        </div>
      </footer>
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};ls.styles=[...Ko.styles,rs],p([g({attribute:!1})],ls.prototype,`controller`,void 0),p([g({type:Boolean,attribute:`show-title`,reflect:!0})],ls.prototype,`showTitle`,void 0),p([g({attribute:`select-label`})],ls.prototype,`selectLabel`,void 0),p([g({attribute:`cancel-label`})],ls.prototype,`cancelLabel`,void 0),p([g({type:Boolean,reflect:!0})],ls.prototype,`busy`,void 0),p([g({type:Boolean,reflect:!0})],ls.prototype,`loading`,void 0),p([g({type:Boolean,attribute:`can-submit`,reflect:!0})],ls.prototype,`canSubmit`,void 0),p([g({type:Boolean,reflect:!0})],ls.prototype,`narrow`,void 0),p([_()],ls.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,ls);var us=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
    ...
    `],p([g()],fs.prototype,`label`,void 0),p([g()],fs.prototype,`icon`,void 0),customElements.get(`craft-empty`)||customElements.define(`craft-empty`,fs);var ps=class e{constructor(e,...t){this.host=e,this.presence=[],this.handleMutations=()=>{let e=this.snapshot();e.some((e,t)=>e!==this.presence[t])&&(this.presence=e,this.host.requestUpdate())},this.slotNames=t,e.addController(this)}test(t){return t===e.DEFAULT_SLOT?this.hasDefaultSlot():this.hasNamedSlot(t)}hostConnected(){this.presence=this.snapshot(),this.observer??=new MutationObserver(this.handleMutations),this.observer.observe(this.host,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`],characterData:this.slotNames.includes(e.DEFAULT_SLOT)})}hostDisconnected(){this.observer?.disconnect()}hasDefaultSlot(){return Array.from(this.host.childNodes).some(e=>e.nodeType===Node.TEXT_NODE?e.textContent.trim()!==``:e.nodeType===Node.ELEMENT_NODE&&!e.slot)}hasNamedSlot(e){return Array.from(this.host.children).some(t=>t.slot===e)}snapshot(){return this.slotNames.map(e=>this.test(e))}};ps.DEFAULT_SLOT=`[default]`;var ms=a`
  :host {
    position: relative;
    display: block;
  }
...
`,hs=class extends xi(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=O(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__hasSlot=new ps(this,`heading-prefix`,`label-extra`,`actions`,`heading-suffix`,`tip`,`warning`),this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[jt,Tr,ms]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.updateComplete.then(()=>{this.addToAriaLabelledBy(this._labelNode),this.__wireDescribedBy()})}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
      ...
      >
        ...
        ${n?r`
              <div
                ...
                part="actions"
                role="group"
                aria-label=${O(`Field actions`)}
              >
                <slot name="actions"></slot>
              </div>
            `:r`<slot name="actions"></slot>`}
        <slot name="heading-suffix"></slot>
      </div>
    `}_helpTextTemplate(){return this.__hasHelpText?super._helpTextTemplate():r``}_inputGroupTemplate(){return r`
    ...
    `}_statusBadgeTemplate(){return this.status?r`
      <div
        class="form-field__status-indicator"
        title=${D(this.statusLabel)}
        aria-hidden="true"
      >
        <craft-visually-hidden>${this.statusLabel}</craft-visually-hidden>
      </div>
    `:c}_noticeTemplate(e){if(!this.__hasSlot.test(e))return c;let t=e===`tip`;return r`
      <craft-callout
        class="field-notice"
    ...
    `}get __hasLabel(){return this.label.trim()!==``}get __hasHelpText(){return this.helpText.trim()!==``}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`craft-visually-hidden`);t.textContent=O(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};p([g({type:Boolean,reflect:!0})],hs.prototype,`required`,void 0),p([g({type:Boolean,reflect:!0})],hs.prototype,`translatable`,void 0),p([g({attribute:`translation-description`})],hs.prototype,`translationDescription`,void 0),p([g({type:Boolean,reflect:!0})],hs.prototype,`fieldset`,void 0),p([g({reflect:!0})],hs.prototype,`status`,void 0),p([g({attribute:`status-label`})],hs.prototype,`statusLabel`,void 0),p([g({reflect:!0})],hs.prototype,`orientation`,void 0),p([g({type:Boolean,reflect:!0,attribute:`has-errors`})],hs.prototype,`hasErrors`,void 0),p([g({attribute:`instructions-position`})],hs.prototype,`instructionsPosition`,void 0),p([g({type:String,reflect:!0})],hs.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,hs);var gs=class extends l{render(){return r`
      <style>
        craft-field-group {
          display: grid;
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,gs);var _s=a`
  ${Tr}
...
`,vs=/^[0-9a-f]{6}$/i,ys=/^[0-9a-f]{3}$/i,bs={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function xs(e){return String(e??``).trim().replace(/^#/,``)}function Ss(e){let t=xs(e);return ys.test(t)?t.split(``).map(e=>e+e).join(``):vs.test(t)?t:null}var Cs=class e extends Gi{static get styles(){return[...super.styles,Er,_s]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,xs(t)),e}}}parser(e){return xs(e)}formatter(e){return xs(e)}serializer(e){return xs(e)}deserializer(e){return xs(e)}preprocessor(e){let t=xs(e);if(t!==e)return t}get _expandedHexValue(){return Ss(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>Ss(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=xs(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
      <input
      ...
      ${t.length?r`
            <datalist id="${this._pickerListId}">
              ${t.map(e=>r`<option value="${e}"></option>`)}
            </datalist>
          `:c}
    `}_swatchTemplate(){return r`
    ...
    `}};Cs._browserSupportsColorInputs=null,p([g({converter:bs})],Cs.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,Cs);var ws=a`
  ::slotted(.form-control) {
    ${Sr}
  }
...
`,V=class extends Gi{constructor(...e){super(...e),this.size=`medium`,this.inputMode=``,this.autoCorrect=!0,this.autoCapitalize=!0,this.small=!1,this.center=!1,this.monospace=!1,this.hiddenInput=!1}static get styles(){return[...super.styles,Er,ws]}connectedCallback(){super.connectedCallback(),this._inputNode&&this.maxlength&&this.maxlength>0&&(this._inputNode.maxLength=this.maxlength,this.width!==`full`&&(this._inputNode.size=this.maxlength)),this.syncNativeAttributes(),this.syncAriaInvalid()}updated(e){super.updated(e),(e.has(`inputSize`)||e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`inputMode`)||e.has(`autoCorrect`)||e.has(`autoCapitalize`))&&this.syncNativeAttributes(),this.syncAriaInvalid()}syncAriaInvalid(){let e=this.getAttribute(`aria-invalid`);e!==null&&this._inputNode?.setAttribute(`aria-invalid`,e)}syncNativeAttributes(){let e={size:this.inputSize,min:this.min,max:this.max,step:this.step,inputmode:this.inputMode,autocorrect:this.autoCorrect?void 0:`off`,autocapitalize:this.autoCapitalize?void 0:`none`};for(let[t,n]of Object.entries(e)){if(n===void 0){this._inputNode?.removeAttribute(t);continue}this._inputNode?.setAttribute(t,String(n))}}};p([g({type:Number,reflect:!0})],V.prototype,`maxlength`,void 0),p([g({type:String,reflect:!0})],V.prototype,`size`,void 0),p([g({type:Number,attribute:!1})],V.prototype,`inputSize`,void 0),p([g({attribute:!1})],V.prototype,`min`,void 0),p([g({attribute:!1})],V.prototype,`max`,void 0),p([g({attribute:!1})],V.prototype,`step`,void 0),p([g({attribute:!1})],V.prototype,`inputMode`,void 0),p([g({attribute:!1})],V.prototype,`autoCorrect`,void 0),p([g({attribute:!1})],V.prototype,`autoCapitalize`,void 0),p([g({reflect:!0,type:Boolean})],V.prototype,`small`,void 0),p([g({type:String,reflect:!0})],V.prototype,`width`,void 0),p([g({reflect:!0,type:Boolean})],V.prototype,`center`,void 0),p([g({reflect:!0,type:Boolean})],V.prototype,`monospace`,void 0),p([g({reflect:!0,type:Boolean,attribute:`hidden-input`})],V.prototype,`hiddenInput`,void 0),customElements.get(`craft-input`)||customElements.define(`craft-input`,V);var Ts=a`
  /*
...
`,Es=class extends V{static get styles(){return[...super.styles,Ts]}_renderSuffix(){return r`<craft-copy-button
      tooltip-label="${O(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};p([g({type:String,attribute:`copy-value`})],Es.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,Es);var Ds=class extends V{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,Ds);var Os=new WeakSet,ks=class extends V{constructor(){super(),d(this,Os),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,u(Os,this,As))}disconnectedCallback(){this.removeEventListener(`change`,u(Os,this,As)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),u(Os,this,js).call(this)}};function As(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=u(Os,this,Ms).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}u(Os,this,js).call(this)}}function js(){let e=this._inputNode;if(!e)return;let t=u(Os,this,Ns).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=u(Os,this,Ns).call(this,e),i=u(Os,this,Ns).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function Ms(e){let t=u(Os,this,Ns).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function Ns(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}p([g({type:Number,attribute:`minute-increment`})],ks.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],ks.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],ks.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,ks);var Ps={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},Fs=new WeakSet,Is=new WeakMap,H=class extends l{constructor(...e){super(...e),d(this,Fs),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,f(this,Is,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof V))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,m(Is,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,m(Is,this)),super.disconnectedCallback()}updated(e){super.updated(e),u(Fs,this,Ls).call(this),u(Fs,this,Rs).call(this),u(Fs,this,zs).call(this),u(Fs,this,Ws).call(this,`locale`,this.locale,!0),u(Fs,this,Ws).call(this,`timezone`,this.timezone,!this.showTimezone)}};function Ls(){let e=u(Fs,this,Bs).call(this,`craft-input-date`,`date`,this.showDate);e instanceof Ds&&(u(Fs,this,Us).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,u(Fs,this,Vs).call(this,e))}function Rs(){let e=u(Fs,this,Bs).call(this,`craft-input-time`,`time`,this.showTime);e instanceof ks&&(u(Fs,this,Us).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,u(Fs,this,Vs).call(this,e))}function zs(){let e=u(Fs,this,Bs).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(u(Fs,this,Us).call(this,e,`timezone`,this.timezone??``,!1),u(Fs,this,Vs).call(this,e))}function Bs(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof V);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Vs(e){e.parentElement!==this&&this.insertBefore(e,u(Fs,this,Hs).call(this))}function Hs(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function Us(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function Ws(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}H.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,p([g()],H.prototype,`name`,void 0),p([g({attribute:`date-value`})],H.prototype,`dateValue`,void 0),p([g({attribute:`time-value`})],H.prototype,`timeValue`,void 0),p([g()],H.prototype,`locale`,void 0),p([g()],H.prototype,`timezone`,void 0),p([g({attribute:`show-date`,converter:Ps})],H.prototype,`showDate`,void 0),p([g({attribute:`show-time`,converter:Ps})],H.prototype,`showTime`,void 0),p([g({type:Boolean,attribute:`show-timezone`})],H.prototype,`showTimezone`,void 0),p([g()],H.prototype,`min`,void 0),p([g()],H.prototype,`max`,void 0),p([g({attribute:`min-time`})],H.prototype,`minTime`,void 0),p([g({attribute:`max-time`})],H.prototype,`maxTime`,void 0),p([g({type:Number,attribute:`minute-increment`})],H.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],H.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],H.prototype,`forceRoundTime`,void 0),p([g({type:Boolean})],H.prototype,`disabled`,void 0),p([g({type:Boolean})],H.prototype,`readonly`,void 0),p([g({type:Boolean})],H.prototype,`required`,void 0),p([g({attribute:`described-by`})],H.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,H);var Gs=class extends Oi{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Ks=class extends Oi{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Zr().msg(`lion-input-file:uploadTextDuplicateFileName`)}},qs=524288e3,Js={type:`FILE_TYPE`,size:`FILE_SIZE`},Ys={fail:`FAIL`,pass:`SUCCESS`},Xs=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);Gs.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Ys.fail,this.failedProp.push(Js.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;Gs.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Ys.fail,this.failedProp.push(Js.type))}Gs.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Ys.fail&&(this.status=Ys.pass):(this.status=Ys.fail,this.failedProp.push(Js.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Zs=e=>{switch(e){case`bg-BG`:return k(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return k(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return k(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return k(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return k(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return k(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return k(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return k(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return k(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return k(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return k(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return k(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return k(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return k(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return k(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return k(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return k(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return k(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return k(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return k(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return k(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return k(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return k(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return k(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return k(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return k(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return k(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return k(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return k(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return k(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return k(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return k(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return k(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return k(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return k(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return k(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Qs=class extends ui(gi(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":Di}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Zs},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}_removeButtonContentTemplate(){return r`✖️`}_selectedListItemTemplate(e){let t=Ve();return r`
          ...
          <span id="selected-list-item-label-${t}" class="selected__list__item__label__text">
            ...
            ${e.downloadUrl&&e.status!==`LOADING`?r`
                  <a
                    ...
                    rel="${D(e.downloadUrl.startsWith(`blob`)?`noopener noreferrer`:void 0)}"
                    >${e.systemFile?.name}</a
                  >
                `:e.systemFile?.name}
          </span>
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},tc=class extends Qs{static get styles(){return[...super.styles,a`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
...
`,rc=class extends ec{static get styles(){return[...super.styles,Er,nc]}get slots(){return{...super.slots,"file-select-button":()=>r`<craft-button
      ...
      `]}constructor(){super(),d(this,cc),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,f(this,lc,()=>{this.modelValue=``,this.value=``,u(cc,this,dc).call(this)?.inputmask?.setValue(``),u(cc,this,dc).call(this)?.focus()}),this.type=`text`,this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&u(cc,this,pc).call(this),u(cc,this,dc).call(this)?.classList.toggle(`money-placeholder`,!u(cc,this,mc).call(this))}disconnectedCallback(){u(cc,this,dc).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?r`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${u(cc,this,fc).call(this).currency}`}</span
      >
    </div>`:c}_inputGroupInputTemplate(){return r`<div class="input-group__input">
      <slot name="input"></slot>
      <craft-button
        class="clear"
        type="button"
        ...
        icon
        aria-label=${O(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!u(cc,this,mc).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${m(lc,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function dc(){return this._inputNode}function fc(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function pc(){let e=u(cc,this,dc).call(this);if(!e)return;let t=String(this.modelValue??``),n=u(cc,this,fc).call(this);e.inputmask?.remove(),e.value=t,new oc({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function mc(){return this.modelValue!==``&&this.modelValue!=null}p([g()],uc.prototype,`currency`,void 0),p([g()],uc.prototype,`locale`,void 0),p([g({type:Number})],uc.prototype,`decimals`,void 0),p([g({attribute:`decimal-separator`})],uc.prototype,`decimalSeparator`,void 0),p([g({attribute:`group-separator`})],uc.prototype,`groupSeparator`,void 0),p([g({converter:sc,attribute:`show-currency`})],uc.prototype,`showCurrency`,void 0),p([g({converter:sc})],uc.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,uc);var hc=new WeakSet,gc=class extends Gi{static get styles(){return[...super.styles,Er,a`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),d(this,hc),this.passwordRules=``,this._visible=!1,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>r`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    >
      <span class="icon"
        >${this._visible?r`<craft-icon
              name="eye-slash"
              label="${O(`Hide`)}"
            ></craft-icon>`:r`<craft-icon name="eye" label="${O(`Show`)}"></craft-icon>`}
      </span>
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),u(hc,this,_c).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&u(hc,this,_c).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function _c(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}p([g({attribute:`passwordrules`})],gc.prototype,`passwordRules`,void 0),p([_()],gc.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,gc);var vc=class extends l{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return r`
      <p class="error" role="alert">${this.error}</p>
      ${this.pluginName?r`<div class="install-plugin">
  ...
  `,p([g()],vc.prototype,`error`,void 0),p([g({attribute:`plugin-name`})],vc.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,vc);var yc=a`
  :host {
    display: block;
    /*
...
`,bc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(bc);var xc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(xc);var Sc=new Set([`clip`,`hidden`]),Cc=class extends _r(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=bc.Raised,this.variant=xc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!Sc.has(n)&&e.scrollHeight-e.clientHeight>1||!Sc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
      ...
      >
        ...
        ${this._hasSlottedFooter?r`<slot name="footer">
    ...
    `}};Cc.styles=[Co,yc],p([g({reflect:!0})],Cc.prototype,`appearance`,void 0),p([g({reflect:!0})],Cc.prototype,`variant`,void 0),p([g()],Cc.prototype,`label`,void 0),p([_()],Cc.prototype,`_hasSlottedHeader`,void 0),p([_()],Cc.prototype,`_hasSlottedFooter`,void 0),p([_()],Cc.prototype,`_scrollable`,void 0),p([_()],Cc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,Cc);var wc=0,Tc=new WeakMap,U=new WeakSet,Ec=class extends l{constructor(...e){super(...e),d(this,U),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,Tc,++wc)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(U,this,Lc).call(this)}render(){let e=u(U,this,kc).call(this);return to(this.groups,e=>e.handle,(t,n)=>u(U,this,Dc).call(this,t,n,e))}};function Dc(e,t,n){let i=`permission-tree-heading-${m(Tc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                <h3 id=${i}>${e.heading}</h3>
                <craft-button
                  type="button"
                  size="small"
                  variant="plain"
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>u(U,this,Nc).call(this,e.keys,n)}
                >
                  ${u(U,this,Mc).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${u(U,this,Oc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function Oc(e,t,n,i){return to(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(U,this,jc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||u(U,this,Ac).call(this,o,i)}
                @model-value-changed=${e=>u(U,this,Pc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?u(U,this,Oc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function kc(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function Ac(e,t){return t.has(e.toLowerCase())}function jc(e,t){return this.modelValue.includes(e)||u(U,this,Ac).call(this,e,t)}function Mc(e,t){let n=e.filter(e=>!u(U,this,Ac).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function Nc(e,t){let n=e.filter(e=>!u(U,this,Ac).call(this,e,t));if(u(U,this,Mc).call(this,e,t)){let e=new Set(n);u(U,this,Ic).call(this,this.modelValue.filter(t=>!e.has(t)));return}u(U,this,Ic).call(this,[...new Set([...this.modelValue,...n])])}function Pc(e,t,n,r){if(e.stopPropagation(),this.disabled||u(U,this,Ac).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){u(U,this,Ic).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...u(U,this,Fc).call(this,n)]);u(U,this,Ic).call(this,this.modelValue.filter(e=>!o.has(e)))}function Fc(e){return Object.values(e).flatMap(e=>[e.key,...u(U,this,Fc).call(this,e.nested??{})])}function Ic(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function Lc(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;u(U,this,Rc).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&u(U,this,Rc).call(this,`${this.name}[]`,t)}function Rc(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}Ec.styles=a`
    :host {
      display: block;
    }
  ...
  `,p([g({type:Array})],Ec.prototype,`groups`,void 0),p([g({type:Array,attribute:`model-value`})],Ec.prototype,`modelValue`,void 0),p([g({type:Array,attribute:`locked-permissions`})],Ec.prototype,`lockedPermissions`,void 0),p([g()],Ec.prototype,`name`,void 0),p([g({type:Boolean,reflect:!0})],Ec.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,Ec);var zc=a`
  :host {
...
`,Bc=new WeakMap,Vc=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,f(this,Bc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&m(Bc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),h(Bc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,h(Bc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
      <div
    ...
    `}};Vc.styles=[zc],p([g({type:Number})],Vc.prototype,`progress`,void 0),p([g({type:Number})],Vc.prototype,`total`,void 0),p([g({type:Number})],Vc.prototype,`processed`,void 0),p([g({type:Boolean,attribute:`show-status`})],Vc.prototype,`showStatus`,void 0),p([g({type:Boolean,reflect:!0})],Vc.prototype,`pending`,void 0),p([g({type:Boolean})],Vc.prototype,`smooth`,void 0),p([g({type:String})],Vc.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Vc);var Hc=class extends zi(Ui(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Uc=class extends Vi(Gi){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Wc=class extends Hc{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,Er,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Wc.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Wc);var Gc=class extends Yi(Uc){static get styles(){return[...super.styles,a`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,Gc);var Kc=a`
  craft-button {
    cursor: move;
  }
...
`,qc=class extends l{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??O(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),i=t?n?`arrow-right`:`arrow-left`:`arrow-up`,a=t?n?`arrow-left`:`arrow-right`:`arrow-down`,o=O(t?`Move forward`:`Move up`),s=O(t?`Move backward`:`Move down`);return r`
    ...
    `}};qc.styles=[Kc],p([g()],qc.prototype,`label`,void 0),p([g({reflect:!0})],qc.prototype,`position`,void 0),p([g({reflect:!0})],qc.prototype,`orientation`,void 0),p([g({reflect:!0})],qc.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],qc.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,qc);var Jc=class extends Be(Ht){static get styles(){return[...super.styles,a`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Qc=class extends Jc{static get styles(){return[...super.styles,Zc]}_afterTemplate(){return r`${this.singleOption?``:r`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},$c=a`
  ${Tr}
...
`,el=class extends Xc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,$c]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Qc}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return r`
    ...
    `}};p([g({reflect:!0,type:Boolean})],el.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,el);var tl=a`
  :host {
    display: block;
  }
`;function nl(e){return e.charAt(0).toUpperCase()+e.slice(1)}var rl=class extends l{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return r`<span
      ...
      aria-hidden="true"
    ></span>`}_optionTemplate(e,t){return r`<craft-option .choiceValue=${e}>
      <span
    ...
    </craft-option>`}_handleModelValueChanged(e){e.stopPropagation();let t=e.target;this.modelValue=t?.modelValue??null,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0}))}render(){return r`
      <craft-select-rich
        label=${this.label}
        name=${this.name}
      ...
      >
        ...
        ${$e.map(e=>this._optionTemplate(e,O(nl(e))))}
      </craft-select-rich>
    `}};rl.styles=[tl],p([g()],rl.prototype,`label`,void 0),p([g()],rl.prototype,`name`,void 0),p([g({attribute:`model-value`})],rl.prototype,`modelValue`,void 0),p([g({type:Boolean,reflect:!0,attribute:`allow-transparent`})],rl.prototype,`allowTransparent`,void 0),customElements.get(`craft-select-color`)||customElements.define(`craft-select-color`,rl);var il=class extends Pi{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>e.slot===`input`)}},al=class extends il{get operationMode(){return`select`}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener(`change`,this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:`model`})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has(`disabled`)&&(this._inputNode.disabled=this.disabled,this.validate()),e.has(`name`)&&(this._inputNode.name=this.name),e.has(`autocomplete`)&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener(`change`,this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){let t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:``}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=this.modelValue===void 0?``:this.modelValue)}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent(`user-input-changed`,{bubbles:!0,composed:!0}))}},ol=a`
  ${Tr}
...
`,sl=class extends al{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,ol]}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};p([g({reflect:!0,type:Boolean})],sl.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,sl);var cl=a`
  :host {
    display: inline-block;
  }
...
`,W=new WeakSet,ll=class extends l{constructor(...e){super(...e),d(this,W),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(W,this,dl).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(W,this,ul).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${u(W,this,pl).call(this,this.value)}
        aria-readonly=${this.readOnly?`true`:`false`}
        aria-describedby=${D(this.describedBy)}
        @keydown=${u(W,this,gl)}
      >
        ${e.map(e=>r`
            <span
              class=${S({"slide-picker__segment":!0,"is-active":e<=this.value,"is-last-active":e===this.value})}
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(W,this,hl).call(this,e)}
              title=${u(W,this,pl).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function ul(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function dl(e){u(W,this,ul).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function fl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function pl(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function ml(e,t){let n=u(W,this,dl).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function hl(e){this.readOnly||u(W,this,ml).call(this,e,!0)}function gl(e){if(this.readOnly)return;let t=u(W,this,fl).call(this);switch(e.key){case`ArrowUp`:u(W,this,ml).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(W,this,ml).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(W,this,ml).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(W,this,ml).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(W,this,ml).call(this,this.min,!0),e.preventDefault();break;case`End`:u(W,this,ml).call(this,this.max,!0),e.preventDefault();break}}ll.styles=[cl],p([g({type:Number})],ll.prototype,`min`,void 0),p([g({type:Number})],ll.prototype,`max`,void 0),p([g({type:Number})],ll.prototype,`step`,void 0),p([g({type:Number})],ll.prototype,`value`,void 0),p([g()],ll.prototype,`label`,void 0),p([g({attribute:`described-by`})],ll.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],ll.prototype,`valueUnit`,void 0),p([g({attribute:!1})],ll.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],ll.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,ll);var _l=a`
  :host {
    display: block;
  }
...
`,vl=new WeakMap,yl=new WeakMap,bl=new WeakMap,xl=new WeakMap,Sl=new WeakMap,Cl=new WeakMap,wl=new WeakMap,G=new WeakSet,Tl=class extends l{constructor(...e){super(...e),d(this,G),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,vl,!1),f(this,yl,!1),f(this,bl,0),f(this,xl,0),f(this,Sl,0),f(this,Cl,!1),f(this,wl,null)}connectedCallback(){super.connectedCallback(),h(wl,this,new ResizeObserver(()=>u(G,this,Dl).call(this))),m(wl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(wl,this)?.disconnect(),h(wl,this,null)}firstUpdated(){h(Sl,this,(u(G,this,El).call(this).length-1)*10),u(G,this,Dl).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(G,this,Dl).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(G,this,Ml).call(this,this.value)}
        @keydown=${u(G,this,Vl)}
        @pointerdown=${u(G,this,Ll)}
        @pointermove=${u(G,this,Rl)}
        @pointerup=${u(G,this,zl)}
      >
        ...
        <div class="graduations">
          ...
          ></div>
          <ul aria-hidden="true">
            ${u(G,this,El).call(this).map(e=>r`
                <li
                  class=${S({graduation:!0,"main-graduation":e%5==0})}
                  data-graduation=${e}
                >
    ...
    `}};function El(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function Dl(){this._graduations?.offsetWidth&&u(G,this,Al).call(this),u(G,this,kl).call(this),!(!this._list||!this._graduations?.offsetWidth)&&(this._list.style.transform=`translateX(${u(G,this,Pl).call(this,this.value)}px)`,u(G,this,Ol).call(this))}function Ol(){m(Cl,this)||(h(Cl,this,!0),requestAnimationFrame(()=>this._root?.classList.add(`placed`)))}function kl(){if(!this._indicator)return;let e=(this.graduationMin-this.graduationMax)*-1,t=m(Sl,this)/e;this._indicator.style.inlineSize=`${Math.abs(this.value)*t}px`,this._indicator.style.translate=this.value>0?`-100%`:`0`}function Al(){let e=u(G,this,El).call(this).length,t=this._list.getBoundingClientRect().width/e;t>0&&h(Sl,this,(e-1)*t)}function jl(){let{transform:e}=getComputedStyle(this._list);return!e||e===`none`?0:new DOMMatrixReadOnly(e).m41}function Ml(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function Nl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(Sl,this)*n-t}function Pl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(Sl,this)/n-this._graduations.offsetWidth/2)}function Fl(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);n!==this.value&&(this.value=n,t&&u(G,this,Il).call(this,`change`))}function Il(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function Ll(e){h(yl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(yl,this)&&(e.preventDefault(),h(bl,this,e.clientX),h(xl,this,u(G,this,jl).call(this)),this._root.setPointerCapture(e.pointerId),u(G,this,Il).call(this,`start`))}function Rl(e){m(yl,this)&&Math.abs(e.clientX-m(bl,this))>3&&(h(vl,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(G,this,Bl).call(this,e))}function zl(e){m(yl,this)&&(m(vl,this)?(e.preventDefault(),h(vl,this,!1),this._root.classList.remove(`dragging`)):u(G,this,Bl).call(this,e),u(G,this,Il).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(bl,this,0),h(yl,this,!1))}function Bl(e){let t=m(vl,this)?m(bl,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(vl,this)?t-e.clientX:e.clientX-t,r=m(xl,this)-n;u(G,this,Fl).call(this,u(G,this,Nl).call(this,r))}function Vl(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(G,this,Fl).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(G,this,Fl).call(this,t-1);break;case`PageUp`:u(G,this,Fl).call(this,t+10);break;case`PageDown`:u(G,this,Fl).call(this,t-10);break;case`Home`:u(G,this,Fl).call(this,this.min);break;case`End`:u(G,this,Fl).call(this,this.max);break;default:return}e.preventDefault()}Tl.styles=[_l],p([g({type:Number})],Tl.prototype,`min`,void 0),p([g({type:Number})],Tl.prototype,`max`,void 0),p([g({type:Number})],Tl.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],Tl.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],Tl.prototype,`graduationMax`,void 0),p([g()],Tl.prototype,`label`,void 0),p([y(`.slide-rule`)],Tl.prototype,`_root`,void 0),p([y(`.graduations`)],Tl.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],Tl.prototype,`_list`,void 0),p([y(`.cursor`)],Tl.prototype,`_cursor`,void 0),p([y(`.indicator`)],Tl.prototype,`_indicator`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,Tl);var Hl=a`
  :host {
    display: inline-flex;
...
`,Ul=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      <span
      ...
      ></span>
    `}};Ul.styles=[Hl],p([g()],Ul.prototype,`label`,void 0),p([g()],Ul.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Ul);var Wl=class extends Ee(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},Kl=class extends Wl{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Kl.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,Kl);var ql=a`
  :host {
    display: grid;
  }
...
`;function Jl(e){return(e??``).split(/\s+/).filter(Boolean)}function Yl(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Xl=Symbol.for(`craft-switch-synthetic-change`),Zl=new WeakMap,Ql=new WeakSet,$l=class extends Gl{constructor(...e){super(...e),d(this,Ql),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,f(this,Zl,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,Tr,ql]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Kl}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?O(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?O(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){u(Ql,this,eu).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){u(Ql,this,eu).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){u(Ql,this,eu).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(m(Zl,this))return;let e=new Event(`change`,{bubbles:!0});e[Xl]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Xl in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of Jl(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of Jl(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Yl(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
      class="state-label"
      data-state=${e}
      aria-hidden="true"
      @click=${()=>this._setCheckedState(e===`on`)}
      >${t}</span
    >`:c}_inputGroupBeforeTemplate(){return r`
      <div class="input-group__before">
        <slot name="before"></slot>
        ${this._stateLabelTemplate(`off`)}
      </div>
    `}_inputGroupAfterTemplate(){return r`
      <div class="input-group__after">
        ${this._stateLabelTemplate(`on`)}
        <slot name="after"></slot>
      </div>
    `}};function eu(e,t){if(!this.disabled){if(!t){e();return}h(Zl,this,!0),e(),this.updateComplete.then(()=>{h(Zl,this,!1)})}}p([g({type:String,reflect:!0})],$l.prototype,`size`,void 0),p([g({type:String,attribute:`on-label`})],$l.prototype,`onLabel`,void 0),p([g({type:String,attribute:`off-label`})],$l.prototype,`offLabel`,void 0),p([g({attribute:`value`})],$l.prototype,`checkedValue`,void 0),p([g({attribute:`indeterminate-value`})],$l.prototype,`indeterminateValue`,void 0),p([g({type:Boolean,reflect:!0})],$l.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,$l);function tu({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function nu(e){e.setAttribute(`selected`,`true`)}function ru(e){e.removeAttribute(`selected`)}function iu({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function au({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function ou(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function su(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function cu(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var lu=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,du={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(du);var fu={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(fu);var pu=[du.InlineStart,du.InlineEnd],mu=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),K=new WeakSet,hu=new WeakMap,gu=new WeakMap,_u=new WeakMap,vu=new WeakMap,yu=new WeakMap,bu=new WeakMap,xu=new WeakMap,Su=new WeakMap,Cu=new WeakMap,wu=new WeakMap,Tu=new WeakMap,Eu=class extends lu{constructor(...e){super(...e),d(this,K),this.placement=du.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,hu,[]),f(this,gu,!1),f(this,_u,[]),f(this,vu,0),f(this,yu,void 0),f(this,bu,!1),f(this,xu,e=>{if(!this.collapsible||Ou.call(u(K,this)))return;let t=u(K,this,Mu).call(this,e.target);!t||t.disabled||ku.call(u(K,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(K,this,Nu).call(this,!0))}),f(this,Su,e=>{e.key!==`Escape`||!this.collapsible||Ou.call(u(K,this))||u(K,this,Mu).call(this,e.target)&&(e.stopPropagation(),u(K,this,Nu).call(this,!0))}),f(this,Cu,()=>{Ou.call(u(K,this))&&(ku.call(u(K,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(K,this,Pu).call(this)}),f(this,wu,()=>{if(u(K,this,Fu).call(this),ku.call(u(K,this)).forEach((e,t)=>{let n=()=>u(K,this,Uu).call(this,t,!0),r=e=>{mu.has(e.key)&&e.preventDefault()},i=e=>u(K,this,Wu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(hu,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),ku.call(u(K,this))[this.selectedIndex]?.disabled){let e=ku.call(u(K,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(K,this,Iu).call(this)}),f(this,Tu,()=>{m(bu,this)||(h(bu,this,!0),requestAnimationFrame(()=>{h(bu,this,!1),u(K,this,Ru).call(this)}))})}static get styles(){return[...super.styles,Co,uu]}get layout(){return Du.call(u(K,this))?fu.Vertical:fu.Horizontal}set layout(e){this.placement=e===fu.Vertical?du.InlineStart:du.BlockStart}refresh(){m(gu,this)&&u(K,this,Iu).call(this),u(K,this,Ru).call(this)}firstUpdated(e){h(gu,this,ku.call(u(K,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(gu,this))t?.addEventListener(`slotchange`,m(wu,this)),m(wu,this).call(this);else{let n=Ou.call(u(K,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(Cu,this))}this.addEventListener(`click`,m(xu,this),!0),this.addEventListener(`keydown`,m(Su,this)),t?.addEventListener(`slotchange`,m(Tu,this)),h(yu,this,new ResizeObserver(m(Tu,this))),m(yu,this).observe(this),u(K,this,Ru).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(K,this,Fu).call(this),m(yu,this)?.disconnect(),h(yu,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,Ou.call(u(K,this))),e.has(`selectedIndex`)&&(m(gu,this)?u(K,this,Iu).call(this):m(Cu,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(K,this,Ru).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${Du.call(u(K,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${Ou.call(u(K,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function Du(){return pu.includes(this.placement)}function Ou(){return this.selectedIndex<0}function ku(){return this.tabs}function Au(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function ju(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function Mu(e){return e instanceof Node?ku.call(u(K,this)).find(t=>t===e||t.contains(e))??null:null}function Nu(e){let t=ku.call(u(K,this))[this.selectedIndex];h(vu,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Pu(){let e=ku.call(u(K,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(vu,this))?m(vu,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function Fu(){for(;m(hu,this).length;)m(hu,this).pop()?.()}function Iu(){let e=ku.call(u(K,this)).map(e=>u(K,this,Lu).call(this,e)),t=e.some(Boolean);ku.call(u(K,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Ve()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(K,this,Pu).call(this)}function Lu(e){return e.controls?document.getElementById(e.controls):null}function Ru(){let e=Au.call(u(K,this)),t=ju.call(u(K,this)),n=ku.call(u(K,this));if(!e||!t)return;if(Du.call(u(K,this))||n.length===0){u(K,this,Bu).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(K,this,zu).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(K,this,Bu).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(K,this,Bu).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function zu(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function Bu(e){let t=ju.call(u(K,this)),n=new Set(e);ku.call(u(K,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(_u,this,e),t&&(t.hidden=e.length===0,t.actions=u(K,this,Vu).call(this))}function Vu(){return m(_u,this).map(e=>{let t=ku.call(u(K,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(K,this,Hu).call(this,e)}})}function Hu(e){let t=ku.call(u(K,this))[e];if(!t||t.disabled)return;let n=ju.call(u(K,this));n&&(n.opened=!1),this.selectedIndex=e,u(K,this,Ru).call(this),t.focus()}function Uu(e,t){let n=ku.call(u(K,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Wu(e){if(!mu.has(e.key))return;let t=u(K,this,Gu).call(this,e.key);t!==-1&&u(K,this,Uu).call(this,t,!0)}function Gu(e){let t=ku.call(u(K,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(Ou.call(u(K,this)))return u(K,this,Gu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],Eu.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],Eu.prototype,`collapsible`,void 0),p([g({reflect:!0})],Eu.prototype,`layout`,null),p([g({reflect:!0})],Eu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,Eu);var Ku=a`
  :host {
    display: inline-flex;
...
`,nd=new WeakMap,rd=new WeakMap,id=new WeakMap,ad=new WeakSet,od=class extends ed{constructor(...e){super(...e),d(this,ad),this.monospace=!1,f(this,nd,void 0),f(this,rd,void 0),f(this,id,null)}static get styles(){return[...super.styles,Er,td]}connectedCallback(){super.connectedCallback(),u(ad,this,sd).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(nd,this)?.disconnect(),h(nd,this,void 0),m(rd,this)?.disconnect(),h(rd,this,void 0)}};function sd(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(id,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(id,this,e.style.height)}),h(rd,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(rd,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(nd,this,new ResizeObserver(()=>{if(e.style.height===m(id,this))return;let t=e.style.height;Qu.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(rd,this)?.disconnect(),h(rd,this,void 0),m(nd,this)?.disconnect(),h(nd,this,void 0)})),m(nd,this).observe(e))}p([g({type:Boolean,reflect:!0})],od.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,od);var cd=a`
  :host {
    display: block;
    min-width: 0;
  }
...
`,ld=class extends l{constructor(...e){super(...e),this.last=!1,this._hasHeading=!1,this._hasMeta=!1,this._hasBody=!1,this._hasFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,characterData:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasHeading=!!this.querySelector(`:scope > [slot="heading"]`),this._hasMeta=!!this.querySelector(`:scope > [slot="meta"]`),this._hasBody=[...this.childNodes].some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e instanceof HTMLElement&&!e.slot),this._hasFooter=!!this.querySelector(`:scope > [slot="footer"]`)}render(){return r`
      <div class="timeline-item" part="base">
        ...
        <div class="timeline-item__content" part="content">
          ${this._hasHeading||this._hasMeta?r`<div class="timeline-item__header" part="header">
                ${this._hasHeading?r`<div class="timeline-item__heading" part="heading">
                      <slot name="heading"></slot>
                    </div>`:c}
                ${this._hasMeta?r`<div class="timeline-item__meta" part="meta">
                      ${this._hasHeading?r`<span
          ...
          ${this._hasBody?r`<div class="timeline-item__body" part="body">
                <slot></slot>
              </div>`:c}
          ${this._hasFooter?r`<div class="timeline-item__footer" part="footer">
                <slot name="footer"></slot>
              </div>`:c}
        </div>
      </div>
    `}};ld.styles=[cd],p([g({type:Boolean,reflect:!0})],ld.prototype,`last`,void 0),p([_()],ld.prototype,`_hasHeading`,void 0),p([_()],ld.prototype,`_hasMeta`,void 0),p([_()],ld.prototype,`_hasBody`,void 0),p([_()],ld.prototype,`_hasFooter`,void 0),customElements.get(`craft-timeline-item`)||customElements.define(`craft-timeline-item`,ld);var ud=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>dd(e,this),this.compositionEventHandler=e=>_d(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,fd),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,fd)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(gd)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(gd)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(gd),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),hd(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function dd(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:pd(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&pd(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function fd(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&md(t,{event:e})}function pd(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function md(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function hd(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function gd(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function _d(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var vd=class extends Event{constructor(){super(`update`)}},yd=new WeakMap,bd=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=yd.get(t);return n||(n=new e(t),yd.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),yd.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new vd)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of xd)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},xd=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),Sd=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return bd.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},Cd=a`
  :host {
    display: contents;
  }
...
`,wd=/^[\p{L}\p{N}_.-]*$/u,Td=O(`Suggestions`),Ed=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],Dd={handlesAccessibility:!1,visibilityTriggerFunction:void 0},Od=0,q=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,J=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Bd=new WeakMap,Y=new WeakSet,Vd=new WeakMap,Hd=new WeakMap,Ud=new WeakMap,Wd=new WeakMap,Gd=new WeakMap,Kd=new WeakMap,qd=new WeakMap,Jd=new WeakMap,Yd=new WeakMap,Xd=new WeakMap,Zd=new WeakMap,Qd=class extends l{constructor(...e){super(...e),d(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,q,void 0),f(this,kd,null),f(this,Ad,null),f(this,jd,new Map),f(this,J,null),f(this,Md,[]),f(this,Nd,0),f(this,Pd,null),f(this,Fd,null),f(this,Id,null),f(this,Ld,!1),f(this,Rd,null),f(this,zd,new DOMRect),f(this,Bd,new MutationObserver(()=>{let e=u(Y,this,ef).call(this);(Cf(e)&&e!==m(kd,this)||m(kd,this)&&!m(kd,this).isConnected)&&u(Y,this,tf).call(this)})),f(this,Vd,()=>{m(Ld,this)||u(Y,this,lf).call(this)}),f(this,Hd,()=>{h(Ld,this,!0),u(Y,this,_f).call(this)}),f(this,Ud,()=>{h(Ld,this,!1),u(Y,this,lf).call(this)}),f(this,Wd,()=>{queueMicrotask(()=>u(Y,this,_f).call(this))}),f(this,Gd,()=>{let e=m(kd,this);!e||!m(J,this)||!wf(e)||queueMicrotask(()=>{m(J,this)&&(e.selectionStart!==m(J,this).end||e.selectionEnd!==m(J,this).end)&&u(Y,this,lf).call(this)})}),f(this,Kd,()=>{m(J,this)&&u(Y,this,gf).call(this)}),f(this,qd,e=>{let t=e;m(J,this)&&m(q,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,Jd,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,Yd,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,Xd,e=>{u(Y,this,pf).call(this,Number(e.target.dataset.index))}),f(this,Zd,e=>{if(e.target!==this.popoverElement)return;let t=m(q,this).getAttribute(`aria-label`)??Td;u(Y,this,bf).call(this),h(J,this,null),u(Y,this,yf).call(this),u(Y,this,xf).call(this,t===Td?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(Y,this,$d).call(this),this.hasUpdated&&u(Y,this,tf).call(this)}disconnectedCallback(){u(Y,this,rf).call(this),m(q,this)?.remove(),m(Id,this)!==null&&(clearTimeout(m(Id,this)),h(Id,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(Y,this,tf).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(kd,this)!==u(Y,this,ef).call(this)&&u(Y,this,tf).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(J,this)){let e=m(q,this).querySelector(`[aria-selected="true"]`),t=e?m(Md,this)[Number(e.dataset.index)]:void 0;u(Y,this,lf).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${Dd}
        @craft-hide=${m(Zd,this)}
      >
        <div class="text-expander__popup" slot="content">
          ${this.loading?r`<div class="text-expander__loading" part="loading">
                <slot name="loading">${O(`Loading`)}</slot>
              </div>`:c}
          <slot name="listbox"></slot>
        </div>
      </craft-popover>
    ...
    `}};function $d(){h(q,this,document.createElement(`div`)),m(q,this).id=`craft-text-expander-listbox-${++Od}`,m(q,this).slot=`listbox`,m(q,this).setAttribute(`part`,`listbox`),m(q,this).role=`listbox`,m(q,this).setAttribute(`aria-label`,Td),m(q,this).addEventListener(`pointerdown`,m(Jd,this)),m(q,this).addEventListener(`pointerup`,m(Yd,this)),m(q,this).addEventListener(`combobox-commit`,m(Xd,this)),this.append(m(q,this))}function ef(){return this.getRootNode().getElementById(this.for)}function tf(){let e=u(Y,this,ef).call(this);if(u(Y,this,rf).call(this),!Cf(e)){u(Y,this,nf).call(this);return}h(kd,this,e),u(Y,this,af).call(this,e),h(Ad,this,new ud(e,m(q,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(Y,this,of).call(this,e),e.addEventListener(`input`,m(Vd,this)),e.addEventListener(`keydown`,m(qd,this)),e.addEventListener(`blur`,m(Wd,this)),e.addEventListener(`compositionstart`,m(Hd,this)),e.addEventListener(`compositionend`,m(Ud,this)),e.ownerDocument.addEventListener(`selectionchange`,m(Gd,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(zd,this)},u(Y,this,nf).call(this)}function nf(){m(Bd,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function rf(){m(Bd,this).disconnect(),u(Y,this,_f).call(this);let e=m(kd,this);e&&(e.removeEventListener(`input`,m(Vd,this)),e.removeEventListener(`keydown`,m(qd,this)),e.removeEventListener(`blur`,m(Wd,this)),e.removeEventListener(`compositionstart`,m(Hd,this)),e.removeEventListener(`compositionend`,m(Ud,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(Gd,this)),m(Rd,this)?.getStyleClone().disconnect(),h(Rd,this,null),m(Ad,this)?.destroy(),h(Ad,this,null),u(Y,this,sf).call(this,e),h(kd,this,null))}function af(e){m(jd,this).clear();for(let t of Ed)m(jd,this).set(t,e.getAttribute(t))}function of(e){let t=[m(jd,this).get(`aria-controls`),m(q,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(Y,this,cf).call(this,e,`aria-haspopup`),u(Y,this,cf).call(this,e,`aria-expanded`)}function sf(e){for(let t of Ed)u(Y,this,cf).call(this,e,t);m(jd,this).clear()}function cf(e,t){let n=m(jd,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function lf(e){u(Y,this,bf).call(this);let t=u(Y,this,df).call(this);if(!t){h(J,this,null),u(Y,this,vf).call(this);return}h(J,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(Y,this,ff).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(Y,this,ff).call(this,[]),u(Y,this,xf).call(this,O(`Loading`));let r=m(Nd,this);h(Fd,this,setTimeout(()=>{u(Y,this,uf).call(this,t,n,r,e)},150))}async function uf(e,t,n,r){h(Pd,this,new AbortController);let i;try{let n=await ge.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(Pd,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(Nd,this)||Tf(t))return;u(Y,this,_f).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(Nd,this)&&(this.loading=!1,u(Y,this,ff).call(this,t===void 0?i:i.slice(0,t),r))}function df(){let e=m(kd,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!wf(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&wd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function ff(e,t){if(u(Y,this,hf).call(this),h(Md,this,e),m(q,this).replaceChildren(),m(q,this).hidden=this.loading,m(q,this).setAttribute(`aria-label`,m(J,this)?.trigger.label??Td),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=Sf(e);n.id=`${m(q,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(J,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(q,this).append(n)}),!this.loading&&!e.length){h(J,this,null),u(Y,this,vf).call(this),u(Y,this,xf).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(J,this)&&u(Y,this,mf).call(this,t)})}function pf(e){let t=m(kd,this),n=m(Md,this)[e],r=u(Y,this,df).call(this),i=m(J,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(Y,this,_f).call(this);return}Ef(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(Y,this,_f).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function mf(e){await this.popoverElement.updateComplete;let t=m(kd,this);if(!t||!u(Y,this,gf).call(this)){u(Y,this,_f).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(J,this)||t!==m(kd,this))&&m(Md,this).length&&(m(Ad,this)?.start(),u(Y,this,cf).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(Vd,this)),t.addEventListener(`input`,m(Vd,this)),e)){let t=m(Md,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(Ad,this)?.navigate(1)}}function hf(){m(Ad,this)?.stop(),m(kd,this)&&u(Y,this,cf).call(this,m(kd,this),`aria-expanded`)}function gf(){let e=m(kd,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(Rd,this)){h(Rd,this,new Sd(e));let t=m(Rd,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(Kd,this))}return m(Rd,this).setStartOffset(t),m(Rd,this).setEndOffset(t),h(zd,this,m(Rd,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function _f(){u(Y,this,bf).call(this),h(J,this,null),u(Y,this,vf).call(this)}function vf(){u(Y,this,yf).call(this),this.popoverElement.hide()}function yf(){this.loading=!1,u(Y,this,hf).call(this),h(Md,this,[]),m(q,this)?.replaceChildren(),m(q,this)&&(m(q,this).hidden=!1);let e=m(kd,this);e&&(u(Y,this,cf).call(this,e,`aria-activedescendant`),u(Y,this,cf).call(this,e,`aria-busy`))}function bf(){var e;h(Nd,this,(e=m(Nd,this),e++,e)),m(Fd,this)&&(clearTimeout(m(Fd,this)),h(Fd,this,null)),m(Pd,this)?.abort(),h(Pd,this,null)}function xf(e){m(Id,this)!==null&&(clearTimeout(m(Id,this)),h(Id,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(Id,this,setTimeout(()=>{h(Id,this,null),this.announcement=``},5e3))}Qd.styles=[jt,Cd],p([g({reflect:!0})],Qd.prototype,`for`,void 0),p([g({type:Array})],Qd.prototype,`triggers`,void 0),p([_()],Qd.prototype,`loading`,void 0),p([_()],Qd.prototype,`announcement`,void 0),p([y(`craft-popover`)],Qd.prototype,`popoverElement`,void 0);function Sf(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function Cf(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function wf(e){return e.getRootNode().activeElement===e}function Tf(e){return e instanceof DOMException&&e.name===`AbortError`}function Ef(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Qd);var Df=a`
  :host {
    display: inline-flex;
...
`,Of=new WeakMap,kf=new WeakSet,Af=class extends l{constructor(...e){super(...e),d(this,kf),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,f(this,Of,typeof ResizeObserver<`u`?new ResizeObserver(()=>u(kf,this,jf).call(this)):null)}connectedCallback(){super.connectedCallback(),m(Of,this)?.observe(this)}disconnectedCallback(){m(Of,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){u(kf,this,jf).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${u(kf,this,Mf)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function jf(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function Mf(){u(kf,this,jf).call(this)}Af.styles=Df,p([g({reflect:!0})],Af.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],Af.prototype,`disabled`,void 0),p([_()],Af.prototype,`overflowing`,void 0),p([_()],Af.prototype,`text`,void 0),p([y(`.truncate`)],Af.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,Af);var Nf=a`
  :host {
...
`,Pf={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},Ff=class extends l{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs()}render(){return r`
      <div class="${S({thumbnail:!0,"thumbnail--checkered":this.checkered,"thumbnail--rounded":this.rounded,"thumbnail--crop":this.mode===`crop`,"thumbnail--stretch":this.mode===`stretch`})}" part="thumbnail">
        ${this.src?r`<img
              class="thumbnail__image"
              part="image"
              src="${this.src}"
              srcset="${D(this.srcset??void 0)}"
              sizes="${D(this.sizes??void 0)}"
              width="${D(this.width??void 0)}"
              height="${D(this.height??void 0)}"
              alt="${this.alt}"
    ...
    `}};Ff.styles=[Nf],p([g()],Ff.prototype,`src`,void 0),p([g({reflect:!0})],Ff.prototype,`mode`,void 0),p([g()],Ff.prototype,`srcset`,void 0),p([g()],Ff.prototype,`sizes`,void 0),p([g()],Ff.prototype,`alt`,void 0),p([g({type:Number})],Ff.prototype,`width`,void 0),p([g({type:Number})],Ff.prototype,`height`,void 0),p([g()],Ff.prototype,`loading`,void 0),p([g({reflect:!0,converter:Pf})],Ff.prototype,`checkered`,void 0),p([g({type:Boolean,reflect:!0})],Ff.prototype,`rounded`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,Ff);var If=new WeakMap,Lf=new WeakSet,Rf=class extends HTMLElement{constructor(...e){super(...e),d(this,Lf),f(this,If,null)}connectedCallback(){u(Lf,this,zf).call(this)}disconnectedCallback(){m(If,this)?.destroy(),h(If,this,null)}};function zf(){if(!(m(If,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>u(Lf,this,zf).call(this));return}h(If,this,new Sa),m(If,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Rf);var Bf=!1,Vf=null;async function Hf(e){if(!Bf){if(Vf)return Vf;Bf=!0;try{return(await ge.post(`app/api-headers`,void 0,{cancelToken:e})).data}catch{}finally{Bf=!1}}}var Uf=x.create({baseURL:`https://api.craftcms.com/v1/`});async function Wf(e){return Vf?Object.entries(Vf).forEach(([t,n])=>{e.headers.set(t,n)}):(e.params=e.params||{},e.params.processCraftHeaders=1),e}async function Gf(e,t){if(Vf)return;let{data:n}=await ge.post(`app/process-api-response-headers`,{headers:e},{cancelToken:t});return Vf=n,Bf=!1,Vf}async function Kf(e){return await Gf(e.headers,e.config.cancelToken),e}Uf.interceptors.request.use(async e=>{let{cancelToken:t}=e,n=await Hf(t);n&&Object.entries(n).forEach(([t,n])=>{e.headers.set(t,n)});let r={...e,params:{...Cp.apiParams||{},...e.params,v:new Date().getTime()}};return n||(r.params.processCraftHeaders=1),Cp.httpProxy&&(r.proxy=Cp.httpProxy),r}),Uf.interceptors.request.use(Wf),Uf.interceptors.response.use(Kf);function qf(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function Jf(e={}){let t=qf({...e,type:`submit`,label:e.label||O(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function Yf(e={}){let t=qf({...e,icon:`duplicate`,label:e.label||ya(O(`Paste {type}`,{type:O(`elements`)}))});return t.classList.add(`paste-btn`),t}var Xf=async(e,t)=>{let{data:n}=await ge.post(e,t);return n},Zf=new WeakMap,Qf=new WeakMap,$f=new WeakMap,ep=new WeakMap,tp=new WeakMap,np=new WeakMap,rp=new WeakMap,ip=new WeakMap,ap=new WeakMap,op=new WeakMap,X=new WeakSet,sp=class e{constructor(t){d(this,X),f(this,Zf,null),f(this,Qf,[]),f(this,$f,[]),f(this,ep,null),f(this,tp,!1),f(this,np,!1),f(this,rp,!1),f(this,ip,null),f(this,ap,void 0),f(this,op,new Map),this.options={...e.defaults,modalTitle:O(`Select element`),selectBtnLabel:O(`Select`),...fp(t)},h($f,this,[...this.options.disabledElementIds??[]]),h(ap,this,u(X,this,cp).call(this))}get elementType(){return this.options.elementType}get state(){return m(ap,this)}get index(){return m(Zf,this)}get hasSelection(){return m(Qf,this).length>0}on(e,t){let n=m(op,this).get(e);return n||(n=new Set,m(op,this).set(e,n)),n.add(t),()=>{m(op,this).get(e)?.delete(t)}}async open(){h(Qf,this,[]),m(Zf,this)?.clearSelection(),m(tp,this)||(h(tp,this,!0),u(X,this,dp).call(this,`open`,void 0)),u(X,this,lp).call(this),m(ep,this)||await this.reload()}close(){m(tp,this)&&(h(tp,this,!1),u(X,this,dp).call(this,`close`,void 0),this.options.onClose?.(),u(X,this,lp).call(this))}destroy(){m(Zf,this)?.destroy?.(),h(Zf,this,null),h(Qf,this,[]),h(ep,this,null),h(tp,this,!1),h(rp,this,!1),h(np,this,!1),h(ip,this,null),u(X,this,lp).call(this),m(op,this).clear()}async reload(){let e=this.options.loadIndexBody??Xf;h(np,this,!0),h(ip,this,null),u(X,this,lp).call(this);try{h(ep,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){u(X,this,up).call(this,e)}finally{h(np,this,!1),u(X,this,lp).call(this)}}async submit(){if(!m(ap,this).canSubmit)return;let e=this.buildElementInfo(m(Qf,this)),t=this.selectMeta();h(rp,this,!0),u(X,this,lp).call(this);try{u(X,this,dp).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){u(X,this,up).call(this,e);return}finally{h(rp,this,!1),u(X,this,lp).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...m($f,this),...e.map(e=>Number(e.id))]),m(Zf,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){m(ap,this).canCancel&&(u(X,this,dp).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){h(Zf,this,e),u(X,this,lp).call(this)}detachIndex(){h(Zf,this,null),u(X,this,lp).call(this)}setSelection(e){h(Qf,this,[...e]),u(X,this,lp).call(this)}setDisabledElementIds(e){h($f,this,[...new Set(e.map(Number))]),u(X,this,lp).call(this)}setBusy(e){h(rp,this,e),u(X,this,lp).call(this)}indexParams(){let{options:e}=this,t={context:`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition,criteria:{...e.criteria}};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),e.criteria&&(t.criteria={...e.criteria}),typeof e.indexSettings.showFolders==`boolean`&&(t.showFolders=e.indexSettings.showFolders),t}indexSettings(){let{options:e}=this;return{context:`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...m($f,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return m(Qf,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){u(X,this,lp).call(this)}get selection(){return m(Qf,this)}get disabledElementIds(){return m($f,this)}};function cp(){let e=m(rp,this),t=m(np,this);return Object.freeze({open:m(tp,this),loading:t,busy:e,selection:Object.freeze([...m(Qf,this)]),disabledElementIds:Object.freeze([...m($f,this)]),indexBody:m(ep,this),error:m(ip,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function lp(){h(ap,this,u(X,this,cp).call(this)),u(X,this,dp).call(this,`change`,m(ap,this))}function up(e){h(ip,this,e instanceof Error?e:Error(String(e??`Unknown`))),u(X,this,dp).call(this,`error`,m(ip,this))}function dp(e,t){let n=m(op,this).get(e);n&&[...n].forEach(e=>e(t))}sp.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function fp(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var pp=async(e,t)=>{let{data:n}=await ge.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},mp=new WeakMap,hp=class e extends sp{constructor(e){super(e),f(this,mp,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??pp;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}h(mp,this,t);try{await this.submit()}finally{h(mp,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!m(mp,this))return n;let r=e.transformUrls[m(mp,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:m(mp,this)}}};hp.transformUrls={};var gp=`CraftCms\\Cms\\Asset\\Elements\\Asset`,_p=new WeakSet,vp=class extends sp{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:gp,showSiteMenu:!1}),d(this,_p),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:u(_p,this,yp).call(this),status:null,url:null,hasThumb:!1}]}};function yp(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var bp=new Map;function xp(e,t){if(bp.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);bp.set(e,t)}function Sp(e){return bp.has(e)}function wp(e){return bp.get(e)??sp}function Tp(e){return new(wp(e.elementType))(e)}function Ep(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))bp.has(t)||bp.set(t,n)}var Dp={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},Op=new WeakMap,kp=new WeakMap,Ap=new WeakMap,jp=new WeakMap,Mp=new WeakMap,Np=new WeakMap,Pp=new WeakMap,Z=new WeakSet,Fp=class{constructor(e={}){d(this,Z),f(this,Op,new Map),f(this,kp,null),f(this,Ap,0),f(this,jp,[]),f(this,Mp,[]),f(this,Np,new Set),f(this,Pp,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)m(Op,this).set(e.id,e);r&&(u(Z,this,zp).call(this),m(kp,this)!==null&&u(Z,this,Bp).call(this))}getSessions(){return Array.from(m(Op,this).values())}getCurrentSessionId(){return m(kp,this)}isProcessing(){return m(Ap,this)>0}on(e,t){return m(Pp,this).has(e)||m(Pp,this).set(e,new Set),m(Pp,this).get(e).add(t),()=>{m(Pp,this).get(e)?.delete(t)}}async startIndexing(e){let t=await ge.post(Dp.START,e),{data:n}=t;return n.session&&(m(Op,this).set(n.session.id,n.session),h(kp,this,n.session.id),u(Z,this,Lp).call(this),n.stop||u(Z,this,Bp).call(this)),n.stop&&u(Z,this,Rp).call(this,n.stop),t}stopSession(e){u(Z,this,Vp).call(this,e),u(Z,this,Hp).call(this,{sessionId:e,action:Dp.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){u(Z,this,Hp).call(this,{sessionId:e,action:Dp.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){u(Z,this,Hp).call(this,{sessionId:e.sessionId,action:Dp.FINISH,params:e,priority:!0})}destroy(){m(Op,this).clear(),h(jp,this,[]),h(Mp,this,[]),m(Pp,this).clear(),h(kp,this,null),h(Ap,this,0)}};function Ip(e,t){m(Pp,this).get(e)?.forEach(e=>e(t))}function Lp(e){u(Z,this,Ip).call(this,`change`,{sessions:this.getSessions(),currentSessionId:m(kp,this),reviewSessionId:e})}function Rp(e){m(Op,this).delete(e),m(kp,this)===e&&h(kp,this,null),u(Z,this,Lp).call(this)}function zp(){for(let[e,t]of m(Op,this))if(!t.actionRequired&&!m(Np,this).has(e)){h(kp,this,e);return}h(kp,this,null)}function Bp(){if(m(kp,this)||u(Z,this,zp).call(this),!m(kp,this))return;let e=m(Op,this).get(m(kp,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-m(Ap,this),r=Math.min(n,t);for(let t=0;t<r;t++)u(Z,this,Hp).call(this,{sessionId:e.id,action:Dp.PROCESS,params:{sessionId:m(kp,this)},priority:!1});e.processIfRootEmpty&&u(Z,this,Hp).call(this,{sessionId:e.id,action:Dp.PROCESS,params:{sessionId:m(kp,this)},priority:!1})}function Vp(e){m(Np,this).add(e),h(jp,this,m(jp,this).filter(t=>t.sessionId!==e))}function Hp(e){e.priority?m(Mp,this).push(e):m(jp,this).push(e),u(Z,this,Up).call(this)}function Up(){if(!(m(jp,this).length+m(Mp,this).length===0||m(Ap,this)>=this.maxConcurrentConnections))for(;m(jp,this).length+m(Mp,this).length>0&&m(Ap,this)<this.maxConcurrentConnections;){var e;h(Ap,this,(e=m(Ap,this),e++,e));let t=m(Mp,this).length>0?m(Mp,this).shift():m(jp,this).shift();u(Z,this,Wp).call(this,t)}}async function Wp(e){try{let t=await ge.post(e.action,e.params);u(Z,this,Gp).call(this,t.data)}catch(t){u(Z,this,Kp).call(this,t,e)}finally{var t;h(Ap,this,(t=m(Ap,this),t--,t)),u(Z,this,Up).call(this)}}function Gp(e){let t;e.session&&(m(Op,this).set(e.session.id,e.session),u(Z,this,zp).call(this),e.session.actionRequired&&!e.skipDialog?m(Np,this).has(e.session.id)||(t=e.session.id):m(Np,this).has(e.session.id)||u(Z,this,Bp).call(this)),u(Z,this,zp).call(this),e.stop&&(m(Op,this).delete(e.stop),m(kp,this)===e.stop&&h(kp,this,null)),u(Z,this,Lp).call(this,t),m(Op,this).size===0&&u(Z,this,Ip).call(this,`complete`,{})}function Kp(e,t){u(Z,this,zp).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;u(Z,this,Ip).call(this,`error`,{message:n,sessionId:t.sessionId}),u(Z,this,Up).call(this)}var qp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},Jp=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Yp,Xp=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Zp=typeof Intl<`u`&&Intl.ListFormat||Xp,Qp=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],$p={minimumIntegerDigits:2},em=class{constructor(e,t={}){Yp.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;qp(this,Yp,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return Jp(this,Yp,`f`)}formatToParts(e){let t=[],n=Jp(this,Yp,`f`),r=n.style,i=n.locale;for(let[a,o]of Qp){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?$p:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Zp(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Yp=new WeakMap;var tm=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,nm=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],rm=e=>tm.test(e),im=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(tm)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(am(r,e.from(t)).getTime()-r),a=Math.abs(am(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new em(e,t).format(this)}};function am(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function om(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new im;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=nm.indexOf(t)||nm.length;return new im(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function sm(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new im(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function cm(e,t){let n=sm(e,t);if(n.blank)return[0,`second`];for(let e of nm){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},lm=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,um,dm,fm,pm,mm,hm,gm,_m,vm,ym,bm,xm,Sm,Cm,wm,Tm=globalThis.HTMLElement||null,Em=new im,Dm=new im(0,0,0,0,0,1),Om=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function km(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var Am=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=km(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,km(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},jm=class extends Tm{constructor(){super(...arguments),$.add(this),um.set(this,!1),dm.set(this,!1),pm.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),wm.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,wm,`f`)}set onRelativeTimeUpdated(e){Q(this,wm,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,wm,`f`)),lm(this,wm,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&rm(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return nm.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){Am.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&lm(this,um,n!==null&&(this.date&&Q(this,$,`m`,mm).call(this,this.date))!==n,`f`),!Q(this,dm,`f`)&&!(e===`title`&&Q(this,um,`f`))&&lm(this,dm,(async()=>{await Promise.resolve(),this.update(),lm(this,dm,!1,`f`)})(),`f`))}update(){let e=Q(this,pm,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,pm,`f`).textContent=e;return}let i=Date.now();Q(this,um,`f`)||(n=Q(this,$,`m`,mm).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=om(r,this.precision,i),o=Q(this,$,`m`,hm).call(this,a),s=e,c=Q(this,$,`m`,Cm).call(this,o);s=c?Q(this,$,`m`,xm).call(this,r):o===`duration`?Q(this,$,`m`,gm).call(this,a):o===`relative`?Q(this,$,`m`,_m).call(this,a):Q(this,$,`m`,vm).call(this,r),s?Q(this,$,`m`,Sm).call(this,s):this.shadowRoot===Q(this,pm,`f`)&&this.textContent&&Q(this,$,`m`,Sm).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new Om(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,ym).call(this,r)||Q(this,$,`m`,bm).call(this,r))?Am.observe(this):Am.unobserve(this)}};um=new WeakMap,dm=new WeakMap,pm=new WeakMap,wm=new WeakMap,$=new WeakSet,fm=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},mm=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,fm),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},hm=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||im.compare(e,this.threshold)===1)return`relative`}return`datetime`},gm=function(e){let t=Q(this,$,`a`,fm),n=this.format,r=this.formatStyle,i=this.tense,a=Em;n===`micro`?(e=sm(e),a=Dm,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=Dm)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},_m=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,fm),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=Em),n===`past`&&e.sign!==-1&&(e=Em);let[r,i]=cm(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},vm=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,fm),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},ym=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,fm),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},bm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,fm),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},xm=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,ym).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,fm),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,fm))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,fm),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,bm).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,fm),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,fm),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},Sm=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,pm,`f`).replaceChildren(t)}else Q(this,pm,`f`).textContent=e},Cm=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var Mm=typeof globalThis<`u`?globalThis:window;try{Mm.RelativeTimeElement=jm.define()}catch(e){if(!(Mm.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{ta as A,me as B,va as C,ca as D,ha as E,_t as F,vt as I,lt as L,ar as M,jt as N,fa as O,bt as P,ge as R,ya as S,_a as T,ic as _,Sp as a,so as b,sp as c,Jf as d,Uf as f,uc as g,sl as h,Ep as i,Oi as j,la as k,Yf as l,$l as m,Tp as n,vp as o,od as p,xp as r,hp as s,Fp as t,qf as u,V as v,ga as w,Sa as x,Cs as y,_e as z};
...
`,fl=new WeakMap,pl=class extends g{constructor(...e){super(...e),this.size=``,this.variant=Lr.Neutral,this.appearance=r.OutlineFill,this.icon=null,w(this,fl,new ol)}renderPrefix(){let e=!!this.querySelector(`[slot="thumbnail"]`),t=!!this.querySelector(`[slot="indicator"]`);return m` <div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
    ...
    </div>`}firstUpdated(e){super.firstUpdated(e),E(fl,this).load(this)}render(){let e=!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`)||!!this.querySelector(`[slot="thumbnail"]`)||!!this.querySelector(`[slot="indicator"]`)||this.icon,t=!!this.querySelector(`[slot="suffix"]`);return m`
      <div
        part="chip"
    ...
    `}};pl.styles=[dl],n([v()],pl.prototype,`size`,void 0),n([v({reflect:!0})],pl.prototype,`variant`,void 0),n([v({reflect:!0})],pl.prototype,`appearance`,void 0),n([v()],pl.prototype,`icon`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,pl);var ml=_`
  --_border-width: var(
    --c-input-border-width,
    var(--c-form-control-border-width)
  );
...
`,_l=class extends Oc(g){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},vl=L(e=>class extends fc(sc(Ac(ii(Dc(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],_`
          :host {
            display: block;
          }
...
`,Sl=new WeakMap,Cl=new WeakSet,wl=class extends bl{constructor(...e){super(...e),C(this,Cl),this.hint=null,w(this,Sl,void 0)}static get styles(){return[...bl.styles,xl]}connectedCallback(){super.connectedCallback(),El._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),El._.unobserve(this)}render(){return m`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?m`<span class="hint">${this.hint}</span>`:h}
        <slot name="suffix"></slot>
      </div>
    `}};function Tl(){return E(Sl,this)??T(Sl,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),E(Sl,this)}var El={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=S(Cl,e,Tl).call(e))}})};n([v()],wl.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,wl);var Dl=new WeakMap;function Ol(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Dl.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else Ol(n,t)})}function kl(e){Dl.has(e)&&Dl.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Dl.has(e)&&Dl.get(e)():kl(e)})}var Al=class extends yc{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof uc}};function jl(e){return Array.isArray(e)?e:[e]}var Ml=L(e=>class extends Ac(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(jl(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(jl(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(jl(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...jl(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Nl=new WeakMap,Pl=class extends tc(qi(Ml(yl))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,_`
        .input-group__input {
          display: flex;
          flex: 1;
        }
...
`,Il=class extends Pl{static get styles(){return[...super.styles,Fl]}constructor(){super(),this.defaultValidators=[]}_inputGroupInputTemplate(){return m`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}parser(e){return e===``?super.parser(e):e}_getTextboxValueFromOption(e){return e?e.textContent?.trim()||``:super._getTextboxValueFromOption(e)}};customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,Il);var Ll=_`
  :host {
    display: inline-block;
  }
...
`,Rl={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},zl=class extends g{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await t.animate(Rl[`icon.out`].keyframes,Rl[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(Rl[`icon.in`].keyframes,Rl[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(Rl[`icon.out`].keyframes,Rl[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(Rl[`icon.in`].keyframes,Rl[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||o(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return m`
    ...
    `}};zl.styles=[Ll],n([y()],zl.prototype,`isCopying`,void 0),n([y()],zl.prototype,`status`,void 0),n([b(`slot[name="copy-icon"]`)],zl.prototype,`copyIconEl`,void 0),n([b(`slot[name="success-icon"]`)],zl.prototype,`successIconEl`,void 0),n([b(`slot[name="error-icon"]`)],zl.prototype,`errorIconEl`,void 0),n([v({type:String})],zl.prototype,`value`,void 0),n([v({type:Boolean})],zl.prototype,`disabled`,void 0),n([v({attribute:`feedback-duration`,type:Number})],zl.prototype,`feedbackDuration`,void 0),n([v()],zl.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,zl);var Bl=_`
  :host {
    box-sizing: border-box;
  }
...
`,Hl=class extends g{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return m`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};Hl.styles=[Bl,Vl],n([b(`craft-copy-button`)],Hl.prototype,`copyButtonEl`,void 0),n([v({type:String})],Hl.prototype,`value`,void 0),n([v({type:Boolean,reflect:!0})],Hl.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,Hl);var Ul=class extends qi(g){static get properties(){return{isAlertDialog:{type:Boolean,attribute:`is-alert-dialog`}}}constructor(){super(),this.isAlertDialog=!1}_defineOverlayConfig(){return{...Xi(),isAlertDialog:this.isAlertDialog}}render(){return m`
      <slot name="invoker"></slot>
      <div id="overlay-content-node-wrapper">
        <slot name="content"></slot>
      </div>
    `}},Wl=typeof CSSStyleSheet<`u`?new CSSStyleSheet:null;Wl?.replaceSync(`
  .craft-dialog {
...
`);var Gl=new WeakMap,Kl=new WeakMap,ql=new WeakSet,Jl=class extends Ul{constructor(){super(),C(this,ql),this.openAttribute=!1,this.label=``,w(this,Gl,null),w(this,Kl,null),Br(this),this.addEventListener(`opened-changed`,()=>{let e=!!this.opened;this.openAttribute!==e&&(this.openAttribute=e)})}static get styles(){return[_`
        :host {
          display: contents;
        }
      ...
      `]}connectedCallback(){S(ql,this,Yl).call(this),S(ql,this,Xl).call(this),super.connectedCallback()}updated(e){super.updated(e),e.has(`openAttribute`)&&this.openAttribute!==this.opened&&(this.opened=this.openAttribute),e.has(`label`)&&E(Kl,this)&&(E(Kl,this).textContent=this.label)}};function Yl(){let e=this.getRootNode();Wl&&(e instanceof Document||e instanceof ShadowRoot)&&!e.adoptedStyleSheets.includes(Wl)&&(e.adoptedStyleSheets=[...e.adoptedStyleSheets,Wl])}function Xl(){if(E(Gl,this)?.isConnected)return;let e=document.createElement(`div`);e.slot=`content`,e.classList.add(`craft-dialog`);let t=document.createElement(`div`);t.classList.add(`craft-dialog__body`),t.append(...Array.from(this.childNodes).filter(e=>!(e instanceof Element)||e.slot===``));let n=Array.from(this.children).filter(e=>e.slot===`footer`);if(e.append(S(ql,this,Zl).call(this),t),n.length>0){let t=document.createElement(`footer`);t.classList.add(`craft-dialog__footer`),t.append(...n),e.append(t)}e.addEventListener(`click`,e=>{e.target.closest?.(`[data-dialog="close"]`)&&(this.opened=!1)}),this.append(e),T(Gl,this,e)}function Zl(){let e=document.createElement(`header`);e.classList.add(`craft-dialog__header`);let t=document.createElement(`h2`);t.classList.add(`craft-dialog__title`),t.textContent=this.label,T(Kl,this,t);let n=document.createElement(`button`);n.type=`button`,n.classList.add(`craft-dialog__close`),n.setAttribute(`aria-label`,o(`Close`)),n.setAttribute(`data-dialog`,`close`);let r=document.createElement(`craft-icon`);return r.setAttribute(`name`,`xmark`),n.append(r),e.append(t,n),e}n([v({type:Boolean,attribute:`open`,reflect:!0})],Jl.prototype,`openAttribute`,void 0),n([v()],Jl.prototype,`label`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,Jl);var Ql=class extends HTMLElement{constructor(...e){super(...e),this.cookieName=null,this.state=`collapsed`,this.expanded=!1,this.handleOpen=()=>{this.trigger?.setAttribute(`aria-expanded`,`true`),this.expanded=!0,this.dispatchEvent(new CustomEvent(`open`)),this.target&&(this.target.dataset.state=`expanded`),this.cookieName&&window.Craft?.setCookie(this.cookieName,`expanded`)},this.handleClose=()=>{this.trigger?.setAttribute(`aria-expanded`,`false`),this.expanded=!1,this.dispatchEvent(new CustomEvent(`close`)),this.target&&(this.target.dataset.state=`collapsed`),this.cookieName&&window.Craft?.setCookie(this.cookieName,`collapsed`)}}get trigger(){return this.querySelector(`button[type="button"]`)}get target(){if(!this.trigger)return console.warn(`No trigger found for disclosure.`),null;let e=this.trigger.getAttribute(`aria-controls`);return e?document.getElementById(e):(console.warn(`No target selector found for disclosure.`),null)}connectedCallback(){if(!this.trigger){console.error(`craft-disclosure elements must include a button`,this);return}if(!this.target){console.error(`No target with id ${this.trigger.getAttribute(`aria-controls`)} found for disclosure. `,this.trigger);return}this.cookieName=this.getAttribute(`cookie-name`),this.state=this.getAttribute(`state`)??`expanded`,this.trigger.setAttribute(`aria-expanded`,this.state===`expanded`?`true`:`false`),this.trigger.addEventListener(`click`,this.toggle.bind(this)),this.state===`expanded`?this.open():this.close()}disconnectedCallback(){this.open(),this.trigger?.removeEventListener(`click`,this.toggle.bind(this))}attributeChangedCallback(e,t,n){e===`state`&&(n===`expanded`?this.handleOpen():this.handleClose())}toggle(){this.expanded?this.close():this.open()}open(){this.setAttribute(`state`,`expanded`)}close(){this.setAttribute(`state`,`collapsed`)}};Ql.observedAttributes=[`state`],customElements.get(`craft-disclosure`)||customElements.define(`craft-disclosure`,Ql);var $l=class extends g{render(){return m`
      <style>
        craft-field-group {
          display: grid;
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,$l);var eu=_`
  ${hl}
...
`,tu=/^[0-9a-f]{6}$/i,nu=/^[0-9a-f]{3}$/i,ru={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function iu(e){return String(e??``).trim().replace(/^#/,``)}function au(e){let t=iu(e);return nu.test(t)?t.split(``).map(e=>e+e).join(``):tu.test(t)?t:null}var ou=class e extends Ic{static get styles(){return[...super.styles,gl,eu]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,iu(t)),e}}}parser(e){return iu(e)}formatter(e){return iu(e)}serializer(e){return iu(e)}deserializer(e){return iu(e)}preprocessor(e){let t=iu(e);if(t!==e)return t}get _expandedHexValue(){return au(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>au(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=iu(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return h;let t=this._validPresets;return m`
      <input
    ...
    `}static get styles(){return[super.styles,_`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},yu=class extends gu{static get styles(){return[...super.styles,_`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
    ...
    `}_removeButtonContentTemplate(){return m`<craft-icon name="x"></craft-icon>`}_listItemBeforeTemplate(e){return m`<img src="${e.downloadUrl}" alt="" class="preview-thumb" />`}},bu=_`
  /* Add any craft-specific styles for input-file here */
  ::slotted([slot='selected-file-list']) {
    margin-block-start: var(--c-spacing-lg);
  }
`,xu=class extends vu{static get styles(){return[...super.styles,gl,bu]}get slots(){return{...super.slots,"file-select-button":()=>m`<craft-button
          type="button"
          id="select-button-${this._inputId}"
          @click="${this.__openDialogOnBtnClick}"
        >
          ${this.buttonLabel}
        </craft-button>`}}static get scopedElements(){return{...super.scopedElements,"lion-selected-file-list":yu}}};customElements.get(`craft-input-file`)||customElements.define(`craft-input-file`,xu);var Su=_`
...
`,Cu=class extends Ic{constructor(...e){super(...e),this.size=`medium`,this.small=!1,this.center=!1,this.monospace=!1,this.hiddenInput=!1}static get styles(){return[...super.styles,gl,Su]}connectedCallback(){super.connectedCallback(),this._inputNode&&this.maxlength&&this.maxlength>0&&(this._inputNode.maxLength=this.maxlength)}};n([v({type:Number,reflect:!0})],Cu.prototype,`maxlength`,void 0),n([v({type:String,reflect:!0})],Cu.prototype,`size`,void 0),n([v({reflect:!0,type:Boolean})],Cu.prototype,`small`,void 0),n([v({reflect:!0,type:Boolean})],Cu.prototype,`center`,void 0),n([v({reflect:!0,type:Boolean})],Cu.prototype,`monospace`,void 0),n([v({reflect:!0,type:Boolean,attribute:`hidden-input`})],Cu.prototype,`hiddenInput`,void 0),customElements.get(`craft-input`)||customElements.define(`craft-input`,Cu);var wu=class extends Cu{constructor(...e){super(...e),this.autocorrect=!1,this.autocapitalize=`off`}static get styles(){return[...super.styles,_`
        .input-group__input {
          font-family: var(--c-font-mono);
          font-size: 0.9em;
        }
      `]}firstUpdated(e){super.firstUpdated(e),this._inputNode?.setAttribute(`autocorrect`,this.autocorrect?`on`:`off`),this._inputNode?.setAttribute(`autocapitalize`,this.autocapitalize)}};n([v({reflect:!0})],wu.prototype,`autocorrect`,void 0),n([v({reflect:!0,type:String})],wu.prototype,`autocapitalize`,void 0),customElements.get(`craft-input-handle`)||customElements.define(`craft-input-handle`,wu);var Tu=class extends Ic{static get styles(){return[...super.styles,gl,_`
        .input-group__container {
          position: relative;
        }
    ...
    `,this.type=`password`}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix()})}}};n([y()],Tu.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,Tu);var Eu=class extends g{constructor(...e){super(...e),this.appearance=`raised`,this.size=`lg`}render(){return m`<div
    ...
    `],n([v()],Eu.prototype,`appearance`,void 0),n([v()],Eu.prototype,`size`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,Eu);var Du=_`
  :host {
...
`,Ou=new WeakMap,ku=class extends g{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,w(this,Ou,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&E(Ou,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),T(Ou,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,T(Ou,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return m`
      <div
    ...
    `}};ku.styles=[Du],n([v({type:Number})],ku.prototype,`progress`,void 0),n([v({type:Number})],ku.prototype,`total`,void 0),n([v({type:Number})],ku.prototype,`processed`,void 0),n([v({type:Boolean,attribute:`show-status`})],ku.prototype,`showStatus`,void 0),n([v({type:Boolean,reflect:!0})],ku.prototype,`pending`,void 0),n([v({type:Boolean})],ku.prototype,`smooth`,void 0),n([v({type:String})],ku.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,ku);var Au=new WeakMap,ju=new WeakMap,Mu=new WeakMap,Nu=new WeakMap,Pu=new WeakMap,Fu=new WeakMap,Iu=new WeakMap,Lu=new WeakMap,Ru=new WeakMap,zu=new WeakMap,Bu=new WeakMap,Y=new WeakSet,Vu=class extends g{constructor(...e){super(...e),C(this,Y),this.progress=0,this.failed=!1,this.color=`currentColor`,this.bgColor=`#a3afbb`,this.failColor=`#da5a47`,this.label=`Progress`,this.autoComplete=!1,w(this,Au,null),w(this,ju,0),w(this,Mu,0),w(this,Nu,0),w(this,Pu,0),w(this,Fu,0),w(this,Iu,null),w(this,Lu,0),w(this,Ru,null),w(this,zu,0),w(this,Bu,!1)}connectedCallback(){super.connectedCallback(),T(Bu,this,window.matchMedia(`(prefers-reduced-motion: reduce)`).matches)}disconnectedCallback(){super.disconnectedCallback(),S(Y,this,Ju).call(this)}firstUpdated(){T(Au,this,this.renderRoot.querySelector(`canvas`)),S(Y,this,Hu).call(this),S(Y,this,Uu).call(this)}updated(e){e.has(`progress`)?S(Y,this,Uu).call(this):(e.has(`color`)||e.has(`bgColor`)||e.has(`failColor`)||e.has(`failed`))&&S(Y,this,Gu).call(this)}get canvas(){return E(Au,this)}get prefersReducedMotion(){return E(Bu,this)}runCompleteAnimation(){return new Promise(e=>{if(E(Bu,this)){T(Fu,this,1),E(Au,this)&&(E(Au,this).style.opacity=`0`),S(Y,this,Gu).call(this),e();return}S(Y,this,qu).call(this,1,()=>{E(Au,this)&&(E(Au,this).style.transition=`opacity 0.4s`,E(Au,this).style.opacity=`0`),setTimeout(e,400)})})}async complete(){await this.runCompleteAnimation(),this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0}))}render(){return m`
      <canvas
        part="canvas"
        role="progressbar"
    ...
    `}};function Hu(){let e=getComputedStyle(this),t=parseFloat(e.getPropertyValue(`--_size`)),n=parseFloat(e.getPropertyValue(`--_stroke-width`)),r=window.devicePixelRatio>1?2:1;T(ju,this,t*r),T(Mu,this,E(ju,this)/2),T(Pu,this,n*r),T(Nu,this,(t/2-n/2)*r),E(Au,this)&&(E(Au,this).width=E(ju,this),E(Au,this).height=E(ju,this))}function Uu(){if(this.progress>=0&&E(Ru,this)!==null&&(cancelAnimationFrame(E(Ru,this)),T(Ru,this,null),T(Lu,this,0)),this.progress<0){E(Ru,this)===null&&S(Y,this,Wu).call(this);return}let e=this.progress/100;if(this.autoComplete&&this.progress>=100&&E(zu,this)<100){T(zu,this,this.progress),this.complete();return}E(zu,this)>0&&this.progress>E(zu,this)&&!E(Bu,this)?S(Y,this,qu).call(this,e):(T(Fu,this,e),S(Y,this,Gu).call(this)),T(zu,this,this.progress)}function Wu(){if(E(Bu,this)){T(Fu,this,.25),S(Y,this,Gu).call(this);return}let e=()=>{T(Lu,this,E(Lu,this)+.05),T(Fu,this,.15+.1*Math.sin(E(Lu,this)*3)),S(Y,this,Gu).call(this),T(Ru,this,requestAnimationFrame(e))};T(Ru,this,requestAnimationFrame(e))}function Gu(){let e=E(Au,this)?.getContext(`2d`);if(e){if(e.clearRect(0,0,E(ju,this),E(ju,this)),this.failed){S(Y,this,Ku).call(this,e,this.failColor,1,0);return}if(S(Y,this,Ku).call(this,e,this.bgColor,1,0),E(Fu,this)>0){let t=this.progress<0?E(Lu,this):-Math.PI/2;S(Y,this,Ku).call(this,e,this.color,E(Fu,this),t)}}}function Ku(e,t,n,r){e.strokeStyle=t,e.lineWidth=E(Pu,this),e.lineCap=`round`,e.beginPath(),e.arc(E(Mu,this),E(Mu,this),E(Nu,this),r,r+n*2*Math.PI),e.stroke()}function qu(e,t){S(Y,this,Ju).call(this);let n=performance.now(),r=E(Fu,this),i=a=>{let o=a-n,s=Math.min(o/500,1),c=1-(1-s)**3;T(Fu,this,r+(e-r)*c),S(Y,this,Gu).call(this),s<1?T(Iu,this,requestAnimationFrame(i)):(T(Iu,this,null),t?.())};T(Iu,this,requestAnimationFrame(i))}function Ju(){E(Iu,this)!==null&&(cancelAnimationFrame(E(Iu,this)),T(Iu,this,null)),E(Ru,this)!==null&&(cancelAnimationFrame(E(Ru,this)),T(Ru,this,null))}Vu.styles=_`
    :host {
  ...
  `,n([v({type:Number})],Vu.prototype,`progress`,void 0),n([v({type:Boolean})],Vu.prototype,`failed`,void 0),n([v({type:String})],Vu.prototype,`color`,void 0),n([v({type:String,attribute:`bg-color`})],Vu.prototype,`bgColor`,void 0),n([v({type:String,attribute:`fail-color`})],Vu.prototype,`failColor`,void 0),n([v({type:String})],Vu.prototype,`label`,void 0),n([v({type:Boolean,attribute:`auto-complete`})],Vu.prototype,`autoComplete`,void 0),customElements.get(`craft-progress`)||customElements.define(`craft-progress`,Vu);var Yu=class extends Ac(Pc(g)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Xu=class extends Mc(Ic){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Zu=class extends Yu{static get styles(){return[...super.styles,gl,_`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      `]}};customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Zu);var Qu=class extends Xu{static get styles(){return[...super.styles,_`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,Qu);var $u=_`
  craft-button {
    cursor: move;
  }
...
`,ed=class extends g{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.variant=`neutral`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e}}))}render(){let e=this.label??o(`Reorder`);return m`
    ...
    `}};ed.styles=[$u],n([v()],ed.prototype,`label`,void 0),n([v({reflect:!0})],ed.prototype,`position`,void 0),n([v({reflect:!0})],ed.prototype,`variant`,void 0),n([v({reflect:!0,type:Boolean})],ed.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,ed);var td=class extends ii(Xa){static get styles(){return[...super.styles,_`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,ad=class extends td{static get styles(){return[...super.styles,id]}_afterTemplate(){return m`${this.singleOption?``:m`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},od=_`
  ${hl}
...
`,sd=class extends rd{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,od]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":ad}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return m`
    ...
    `}};n([v({reflect:!0,type:Boolean})],sd.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,sd);var cd=_`
  :host {
    display: block;
  }
`;function ld(e){return e.charAt(0).toUpperCase()+e.slice(1)}var ud=class extends g{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return m`<span
...
`,md=class extends fd{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,pd]}_inputGroupInputTemplate(){return m`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};n([v({reflect:!0,type:Boolean})],md.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,md);var hd=_`
  :host {
    display: inline-flex;
...
`,gd=class extends g{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return m`
      <span
      ...
      ></span>
    `}};gd.styles=[hd],n([v()],gd.prototype,`label`,void 0),n([v()],gd.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,gd);var _d=class extends Wr(g){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[_`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return m`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return m`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},yd=class extends _d{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,_`
      ...
      `]}};n([v({type:Boolean,reflect:!0})],yd.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,yd);var bd=_`
  :host {
    display: grid;
  }
...
`;function xd(e){return(e??``).split(/\s+/).filter(Boolean)}function Sd(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Cd=Symbol.for(`craft-switch-synthetic-change`),wd=class extends vd{constructor(...e){super(...e),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,hl,bd]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":yd}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?o(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?o(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}__dispatchNativeChange(){let e=new Event(`change`,{bubbles:!0});e[Cd]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Cd in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of xd(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of xd(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Sd(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return m`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return m`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?m`<span
    ...
    `}};n([v({type:String,reflect:!0})],wd.prototype,`size`,void 0),n([v({type:String,attribute:`on-label`})],wd.prototype,`onLabel`,void 0),n([v({type:String,attribute:`off-label`})],wd.prototype,`offLabel`,void 0),n([v({attribute:`value`})],wd.prototype,`checkedValue`,void 0),n([v({attribute:`indeterminate-value`})],wd.prototype,`indeterminateValue`,void 0),n([v({type:Boolean,reflect:!0})],wd.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,wd);function Td({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function Ed(e){e.setAttribute(`selected`,`true`)}function Dd(e){e.removeAttribute(`selected`)}function Od({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function kd({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function Ad(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function jd(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function Md(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var Nd=class extends g{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[_`
        .tabs__tab-group {
          display: flex;
        }
...
`,Fd=class extends Nd{static get styles(){return[...super.styles,Pd]}};customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,Fd);var Id=_`
  :host {
    display: inline-flex;
...
`,Kd=class extends Wd{constructor(...e){super(...e),this.monospace=!1}static get styles(){return[...super.styles,gl,Gd]}};n([v({type:Boolean,reflect:!0})],Kd.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Kd);var qd=_`
  :host {
...
`,Jd={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},Yd=class extends g{constructor(...e){super(...e),this.src=null,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}render(){return m`
    ...
    `}};Yd.styles=[qd],n([v()],Yd.prototype,`src`,void 0),n([v()],Yd.prototype,`srcset`,void 0),n([v()],Yd.prototype,`sizes`,void 0),n([v()],Yd.prototype,`alt`,void 0),n([v({type:Number})],Yd.prototype,`width`,void 0),n([v({type:Number})],Yd.prototype,`height`,void 0),n([v()],Yd.prototype,`loading`,void 0),n([v({reflect:!0,converter:Jd})],Yd.prototype,`checkered`,void 0),n([v({type:Boolean,reflect:!0})],Yd.prototype,`rounded`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,Yd);var Xd=new WeakMap,Zd=new WeakSet,Qd=class extends HTMLElement{constructor(...e){super(...e),C(this,Zd),w(this,Xd,null)}connectedCallback(){S(Zd,this,$d).call(this)}disconnectedCallback(){E(Xd,this)?.destroy(),T(Xd,this,null)}};function $d(){if(!(E(Xd,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>S(Zd,this,$d).call(this));return}T(Xd,this,new ol),E(Xd,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Qd);var ef=class e{constructor(t={}){this.config={...e.defaultCookieOptions,...t}}set(e,t,n={}){let{path:r,domain:i,maxAge:a,expires:o,secure:s,sameSite:c,prefix:l}=Object.assign({},this.config,n),u=`${this.config.prefix}:${e}=${encodeURIComponent(t)}`;r&&(u+=`;path=${r}`),i&&(u+=`;domain=${i}`),a?u+=`;max-age-in-seconds=${a}`:o&&(u+=`;expires=${o.toUTCString()}`),s&&(u+=`;secure`),document.cookie=u}get(e){return document.cookie.replace(RegExp(`(?:(?:^|.*;\\s*)${this.config.prefix}:${e}\\s*\\=\\s*([^;]*).*$)|^.*$`),`$1`)}remove(e){this.set(e,``,{expires:new Date(`1970-01-01T00:00:00`)})}};ef.defaultCookieOptions={path:`/`,domain:null,secure:!1,sameSite:`strict`,prefix:`Craft`};var tf=class{constructor(){this.refreshPromise=null,this.tokenName=null,this.tokenValue=null,this.refreshPromise=null}async getToken(){return this.tokenValue||await this.refreshToken(),this.tokenValue}async refreshToken(){return this.refreshPromise||=af.get(`users/session-info`).then(({data:e})=>{let{csrfTokenName:t,csrfTokenValue:n}=e;return this.tokenName=t??null,this.tokenValue=n??null,this.tokenValue}).finally(()=>{this.refreshPromise=null}),this.refreshPromise}clearToken(){this.tokenValue=null}};function nf(e=``){return ie.getInstance().getActionUrl(e)}function rf(){return{"X-Registered-Asset-Bundles":[...new Set(Cp.registeredAssetBundles)].join(`,`),"X-Registered-Js-Files":[...new Set(Cp.registeredJsFiles)].join(`,`)}}var af=P.create(),of=new tf;af.interceptors.request.use(async e=>{e.baseURL=nf(),e.headers.set(`X-Requested-With`,`XMLHttpRequest`);let t=rf();return Object.entries(t).forEach(([t,n])=>{e.headers.set(t,n)}),e}),af.interceptors.response.use(e=>e,async e=>{let t=e.config;if(e.response?.status===419||e.response?.status===403&&!t._retry){t._retry=!0;try{return of.clearToken(),t.headers[`X-CSRF-Token`]=await of.refreshToken(),P(t)}catch(e){return console.error(`Failed to refresh CSRF token:`,e),Promise.reject(e)}}return Promise.reject(e)});var sf=!1,cf=null;async function lf(e){if(!sf){if(cf)return cf;sf=!0;try{return(await af.post(`app/api-headers`,void 0,{cancelToken:e})).data}catch{}finally{sf=!1}}}var uf=P.create({baseURL:`https://api.craftcms.com/v1/`});async function df(e){return cf?Object.entries(cf).forEach(([t,n])=>{e.headers.set(t,n)}):(e.params=e.params||{},e.params.processCraftHeaders=1),e}async function ff(e,t){if(cf)return;let{data:n}=await af.post(`app/process-api-response-headers`,{headers:e},{cancelToken:t});return cf=n,sf=!1,cf}async function pf(e){return await ff(e.headers,e.config.cancelToken),e}uf.interceptors.request.use(async e=>{let{cancelToken:t}=e,n=await lf(t);n&&Object.entries(n).forEach(([t,n])=>{e.headers.set(t,n)});let r={...e,params:{...Cp.apiParams||{},...e.params,v:new Date().getTime()}};return n||(r.params.processCraftHeaders=1),Cp.httpProxy&&(r.proxy=Cp.httpProxy),r}),uf.interceptors.request.use(df),uf.interceptors.response.use(pf);var mf={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},hf=new WeakMap,X=new WeakMap,gf=new WeakMap,_f=new WeakMap,vf=new WeakMap,yf=new WeakMap,bf=new WeakMap,Z=new WeakSet,xf=class{constructor(e={}){C(this,Z),w(this,hf,new Map),w(this,X,null),w(this,gf,0),w(this,_f,[]),w(this,vf,[]),w(this,yf,new Set),w(this,bf,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)E(hf,this).set(e.id,e);r&&(S(Z,this,Tf).call(this),E(X,this)!==null&&S(Z,this,Ef).call(this))}getSessions(){return Array.from(E(hf,this).values())}getCurrentSessionId(){return E(X,this)}isProcessing(){return E(gf,this)>0}on(e,t){return E(bf,this).has(e)||E(bf,this).set(e,new Set),E(bf,this).get(e).add(t),()=>{E(bf,this).get(e)?.delete(t)}}async startIndexing(e){let t=await af.post(mf.START,e),{data:n}=t;return n.session&&(E(hf,this).set(n.session.id,n.session),T(X,this,n.session.id),S(Z,this,Cf).call(this),n.stop||S(Z,this,Ef).call(this)),n.stop&&S(Z,this,wf).call(this,n.stop),t}stopSession(e){S(Z,this,Df).call(this,e),S(Z,this,Of).call(this,{sessionId:e,action:mf.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){S(Z,this,Of).call(this,{sessionId:e,action:mf.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){S(Z,this,Of).call(this,{sessionId:e.sessionId,action:mf.FINISH,params:e,priority:!0})}destroy(){E(hf,this).clear(),T(_f,this,[]),T(vf,this,[]),E(bf,this).clear(),T(X,this,null),T(gf,this,0)}};function Sf(e,t){E(bf,this).get(e)?.forEach(e=>e(t))}function Cf(e){S(Z,this,Sf).call(this,`change`,{sessions:this.getSessions(),currentSessionId:E(X,this),reviewSessionId:e})}function wf(e){E(hf,this).delete(e),E(X,this)===e&&T(X,this,null),S(Z,this,Cf).call(this)}function Tf(){for(let[e,t]of E(hf,this))if(!t.actionRequired&&!E(yf,this).has(e)){T(X,this,e);return}T(X,this,null)}function Ef(){if(E(X,this)||S(Z,this,Tf).call(this),!E(X,this))return;let e=E(hf,this).get(E(X,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-E(gf,this),r=Math.min(n,t);for(let t=0;t<r;t++)S(Z,this,Of).call(this,{sessionId:e.id,action:mf.PROCESS,params:{sessionId:E(X,this)},priority:!1});e.processIfRootEmpty&&S(Z,this,Of).call(this,{sessionId:e.id,action:mf.PROCESS,params:{sessionId:E(X,this)},priority:!1})}function Df(e){E(yf,this).add(e),T(_f,this,E(_f,this).filter(t=>t.sessionId!==e))}function Of(e){e.priority?E(vf,this).push(e):E(_f,this).push(e),S(Z,this,kf).call(this)}function kf(){if(!(E(_f,this).length+E(vf,this).length===0||E(gf,this)>=this.maxConcurrentConnections))for(;E(_f,this).length+E(vf,this).length>0&&E(gf,this)<this.maxConcurrentConnections;){var e;T(gf,this,(e=E(gf,this),e++,e));let t=E(vf,this).length>0?E(vf,this).shift():E(_f,this).shift();S(Z,this,Af).call(this,t)}}async function Af(e){try{let t=await af.post(e.action,e.params);S(Z,this,jf).call(this,t.data)}catch(t){S(Z,this,Mf).call(this,t,e)}finally{var t;T(gf,this,(t=E(gf,this),t--,t)),S(Z,this,kf).call(this)}}function jf(e){let t;e.session&&(E(hf,this).set(e.session.id,e.session),S(Z,this,Tf).call(this),e.session.actionRequired&&!e.skipDialog?E(yf,this).has(e.session.id)||(t=e.session.id):E(yf,this).has(e.session.id)||S(Z,this,Ef).call(this)),S(Z,this,Tf).call(this),e.stop&&(E(hf,this).delete(e.stop),E(X,this)===e.stop&&T(X,this,null)),S(Z,this,Cf).call(this,t),E(hf,this).size===0&&S(Z,this,Sf).call(this,`complete`,{})}function Mf(e,t){S(Z,this,Tf).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;S(Z,this,Sf).call(this,`error`,{message:n,sessionId:t.sessionId}),S(Z,this,kf).call(this)}var Nf=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},Pf=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Ff,If=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Lf=typeof Intl<`u`&&Intl.ListFormat||If,Rf=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],zf={minimumIntegerDigits:2},Bf=class{constructor(e,t={}){Ff.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Nf(this,Ff,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return Pf(this,Ff,`f`)}formatToParts(e){let t=[],n=Pf(this,Ff,`f`),r=n.style,i=n.locale;for(let[a,o]of Rf){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?zf:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Lf(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Ff=new WeakMap;var Vf=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,Hf=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],Uf=e=>Vf.test(e),Wf=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(Vf)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(Gf(r,e.from(t)).getTime()-r),a=Math.abs(Gf(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Bf(e,t).format(this)}};function Gf(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function Kf(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new Wf;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=Hf.indexOf(t)||Hf.length;return new Wf(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function qf(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new Wf(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function Jf(e,t){let n=qf(e,t);if(n.blank)return[0,`second`];for(let e of Hf){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Yf=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,Xf,Zf,Qf,$f,ep,tp,np,rp,ip,ap,op,sp,cp,lp,up,dp=globalThis.HTMLElement||null,fp=new Wf,pp=new Wf(0,0,0,0,0,1),mp=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function hp(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var gp=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=hp(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,hp(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},_p=class extends dp{constructor(){super(...arguments),$.add(this),Xf.set(this,!1),Zf.set(this,!1),$f.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),up.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,up,`f`)}set onRelativeTimeUpdated(e){Q(this,up,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,up,`f`)),Yf(this,up,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&Uf(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return Hf.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){gp.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&Yf(this,Xf,n!==null&&(this.date&&Q(this,$,`m`,ep).call(this,this.date))!==n,`f`),!Q(this,Zf,`f`)&&!(e===`title`&&Q(this,Xf,`f`))&&Yf(this,Zf,(async()=>{await Promise.resolve(),this.update(),Yf(this,Zf,!1,`f`)})(),`f`))}update(){let e=Q(this,$f,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,$f,`f`).textContent=e;return}let i=Date.now();Q(this,Xf,`f`)||(n=Q(this,$,`m`,ep).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=Kf(r,this.precision,i),o=Q(this,$,`m`,tp).call(this,a),s=e,c=Q(this,$,`m`,lp).call(this,o);s=c?Q(this,$,`m`,sp).call(this,r):o===`duration`?Q(this,$,`m`,np).call(this,a):o===`relative`?Q(this,$,`m`,rp).call(this,a):Q(this,$,`m`,ip).call(this,r),s?Q(this,$,`m`,cp).call(this,s):this.shadowRoot===Q(this,$f,`f`)&&this.textContent&&Q(this,$,`m`,cp).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new mp(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,ap).call(this,r)||Q(this,$,`m`,op).call(this,r))?gp.observe(this):gp.unobserve(this)}};Xf=new WeakMap,Zf=new WeakMap,$f=new WeakMap,up=new WeakMap,$=new WeakSet,Qf=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},ep=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,Qf),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},tp=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||Wf.compare(e,this.threshold)===1)return`relative`}return`datetime`},np=function(e){let t=Q(this,$,`a`,Qf),n=this.format,r=this.formatStyle,i=this.tense,a=fp;n===`micro`?(e=qf(e),a=pp,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=pp)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},rp=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,Qf),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=fp),n===`past`&&e.sign!==-1&&(e=fp);let[r,i]=Jf(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},ip=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,Qf),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},ap=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Qf),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},op=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Qf),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},sp=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,ap).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,Qf),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,Qf))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,Qf),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,op).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,Qf),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,Qf),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},cp=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,$f,`f`).replaceChildren(t)}else Q(this,$f,`f`).textContent=e},lp=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var vp=typeof globalThis<`u`?globalThis:window;try{vp.RelativeTimeElement=_p.define()}catch(e){if(!(vp.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}var yp=new Map,bp=class extends g{constructor(...e){super(...e),this.returnUrl=``,this._state=`idle`}firstUpdated(){this._input?.focus()}async _onSubmit(e){e.preventDefault(),await this._submit(this._input?.value??``)}async _submit(e){if(this._state!==`loading`){this._state=`loading`;try{await af.post(this.endpoint,{code:e}),this.dispatchEvent(new CustomEvent(`login-verified`,{bubbles:!0,composed:!0,detail:{returnUrl:this.returnUrl}})),this._state=`success`,setTimeout(()=>{this._state=`idle`},2e3)}catch(e){this._state=`error`,this.dispatchEvent(new CustomEvent(`login-failed`,{bubbles:!0,composed:!0,detail:{message:e?.response?.data?.message??o(`A server error occurred.`)}}))}}}renderInput(){return m`<slot name="input">
      <div>
    ...
    `}static register(e,t){customElements.get(e)||customElements.define(e,t),yp.set(t.METHOD,t)}static isNative(e){return yp.has(e)}};bp.styles=[_`
      :host {
        display: block;
        width: 100%;
      }
    ...
    `],n([v({attribute:`return-url`})],bp.prototype,`returnUrl`,void 0),n([y()],bp.prototype,`_state`,void 0),n([b(`craft-input`)],bp.prototype,`_input`,void 0);function xp(e,t={}){let n={};if(!e)return n;let r=new Set(t.exclude??[]);for(let[t,i]of Object.entries(e))if(!r.has(t)&&!(i===null||i===!1))if(t===`class`)n.class=Array.isArray(i)||typeof i!=`object`?i:Object.values(i);else if(t===`style`)n.style=i;else if(typeof i==`object`&&!Array.isArray(i))for(let[e,r]of Object.entries(i))r===null||r===!1||(n[`${t}-${e}`]=typeof r==`object`&&r?JSON.stringify(r):r);else n[t]=i;return n}export{br as C,x as E,R as S,ie as T,ps as _,af as a,Da as b,el as c,Xc as d,Kc as f,ro as g,ms as h,uf as i,tl as l,Yc as m,bp as n,rl as o,Gc as p,xf as r,nl as s,xp as t,qc as u,ka as v,P as w,va as x,Ea as y};
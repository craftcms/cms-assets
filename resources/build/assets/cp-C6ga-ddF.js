...
`,Xa=new WeakMap,Za=new WeakMap,Qa=new WeakMap,B=new WeakSet,$a=new WeakMap,eo=class extends qa{static get styles(){return[...super.styles,Ya]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,B),this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,Xa,void 0),f(this,Za,!1),f(this,Qa,()=>{h(Za,this,!0),u(B,this,ao).call(this),u(B,this,to).call(this)}),f(this,$a,()=>{this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(B,this,ao).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.addEventListener(`model-value-changed`,e=>{e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&this.modelValue!==this.pendingModelValue&&e.stopImmediatePropagation()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m(Qa,this)),this.addEventListener(`model-value-changed`,()=>{h(Xa,this,this.modelValue)}),h(Xa,this,this.modelValue),u(B,this,ao).call(this)}updated(e){super.updated(e),e.has(`opened`)&&!this.opened&&h(Za,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`))&&u(B,this,ao).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,u(B,this,uo).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t),e.updateComplete.then(()=>{String(e.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(e)))})}_notifyModelValueChanged(){this.modelValue!==m(Xa,this)&&(h(Xa,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:`input`}})))}matchCondition(){return!0}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=u(B,this,uo).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ${e?r`<craft-icon class="prefix" name=${e}></craft-icon>`:c}
        <slot name="input"></slot>
        ${this.clearable&&u(B,this,co).call(this)?r`<craft-button
              class="clear"
              type="button"
              appearance="plain"
              size="small"
    ...
    `}parser(e){if(typeof e==`string`&&e!==``){let t=u(B,this,lo).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function to(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function no(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(u(B,this,ro).call(this,e))for(let r of e.options)(t===``||u(B,this,io).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||u(B,this,io).call(this,t,e))&&n.push({option:e});return n}function ro(e){return e.type===`optgroup`}function io(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function ao(){let e=this._listboxNode;if(!e)return;let t=m(Za,this)?this._inputNode?.value??``:``,n=u(B,this,no).call(this,t),i=n.slice(0,this.limit),a,o=i.map(e=>{let t=e.groupLabel&&e.groupLabel!==a?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return a=e.groupLabel,r`${t}${u(B,this,so).call(this,e.option)}`}),l=n.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${O(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:n.length})}
          </div>`:c;s(Ja(u(B,this,oo).call(this),r`${o}${l}`),e)}function oo(){let e=[];for(let t of this.options)if(u(B,this,ro).call(this,t))for(let n of t.options)e.push(String(n.value));else e.push(String(t.value));return e.join(`\0`)}function so(e){let t=e.data??{},n=e.label,i=n.startsWith(`$`)||n.startsWith(`@`);return r`
      <craft-option
      ...
      >
        <span class="combobox__option">
          ${t.indicator?r`<craft-indicator
                variant=${t.indicator.variant??`neutral`}
              ></craft-indicator>`:c}
          ${t.icon?r`<craft-icon name="${t.icon}"></craft-icon>`:c}
          ${i?r`<code>${n}</code>`:n}
        </span>
      </craft-option>
    `}function co(){return this.modelValue!==``&&this.modelValue!=null}function lo(e){let t=e.trim();for(let e of u(B,this,fo).call(this))if(u(B,this,po).call(this,e)===t)return e}function uo(){if(!u(B,this,co).call(this))return;let e=String(this.modelValue);for(let t of u(B,this,fo).call(this))if(String(t.value)===e)return t}function*fo(){for(let e of this.options)u(B,this,ro).call(this,e)?yield*e.options:yield e}function po(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}p([g({type:Array})],eo.prototype,`options`,void 0),p([g({type:Number})],eo.prototype,`limit`,void 0),p([g({type:Boolean,reflect:!0})],eo.prototype,`clearable`,void 0),p([g({type:String,reflect:!0})],eo.prototype,`placeholder`,void 0),p([g({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],eo.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,eo);var mo=a`
  :host {
    display: inline-block;
  }
...
`,hc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(hc);var gc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(gc);var _c=new Set([`clip`,`hidden`]),vc=class extends fr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=hc.Raised,this.variant=gc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!_c.has(n)&&e.scrollHeight-e.clientHeight>1||!_c.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};vc.styles=[_o,mc],p([g({reflect:!0})],vc.prototype,`appearance`,void 0),p([g({reflect:!0})],vc.prototype,`variant`,void 0),p([g()],vc.prototype,`label`,void 0),p([_()],vc.prototype,`_hasSlottedHeader`,void 0),p([_()],vc.prototype,`_hasSlottedFooter`,void 0),p([_()],vc.prototype,`_scrollable`,void 0),p([_()],vc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,vc);var yc=0,bc=new WeakMap,U=new WeakSet,xc=class extends l{constructor(...e){super(...e),d(this,U),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,bc,++yc)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(U,this,Mc).call(this)}render(){let e=u(U,this,wc).call(this);return Gs(this.groups,e=>e.handle,(t,n)=>u(U,this,Sc).call(this,t,n,e))}};function Sc(e,t,n){let i=`permission-tree-heading-${m(bc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
    ...
    `}function Cc(e,t,n,i){return Gs(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(U,this,Ec).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
...
`,W=new WeakSet,il=class extends l{constructor(...e){super(...e),d(this,W),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(W,this,ol).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(W,this,al).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
      ...
      >
        ${e.map(e=>r`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(W,this,ul).call(this,e)}
              title=${u(W,this,cl).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function al(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function ol(e){u(W,this,al).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function sl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function cl(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function ll(e,t){let n=u(W,this,ol).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function ul(e){this.readOnly||u(W,this,ll).call(this,e,!0)}function dl(e){if(this.readOnly)return;let t=u(W,this,sl).call(this);switch(e.key){case`ArrowUp`:u(W,this,ll).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(W,this,ll).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(W,this,ll).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(W,this,ll).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(W,this,ll).call(this,this.min,!0),e.preventDefault();break;case`End`:u(W,this,ll).call(this,this.max,!0),e.preventDefault();break}}il.styles=[rl],p([g({type:Number})],il.prototype,`min`,void 0),p([g({type:Number})],il.prototype,`max`,void 0),p([g({type:Number})],il.prototype,`step`,void 0),p([g({type:Number})],il.prototype,`value`,void 0),p([g()],il.prototype,`label`,void 0),p([g({attribute:`described-by`})],il.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],il.prototype,`valueUnit`,void 0),p([g({attribute:!1})],il.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],il.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,il);var fl=a`
  :host {
    display: block;
  }
...
`,pl=new WeakMap,ml=new WeakMap,hl=new WeakMap,gl=new WeakMap,_l=new WeakMap,vl=new WeakMap,G=new WeakSet,yl=class extends l{constructor(...e){super(...e),d(this,G),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,pl,!1),f(this,ml,!1),f(this,hl,0),f(this,gl,0),f(this,_l,0),f(this,vl,null)}connectedCallback(){super.connectedCallback(),h(vl,this,new ResizeObserver(()=>u(G,this,xl).call(this))),m(vl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(vl,this)?.disconnect(),h(vl,this,null)}firstUpdated(){h(_l,this,(u(G,this,bl).call(this).length-1)*10),u(G,this,xl).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(G,this,xl).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(G,this,Sl).call(this,this.value)}
        @keydown=${u(G,this,jl)}
        @pointerdown=${u(G,this,Dl)}
        @pointermove=${u(G,this,Ol)}
        @pointerup=${u(G,this,kl)}
      >
        <div class="overlay"></div>
        <div class="cursor"></div>
        <div class="graduations">
          <ul aria-hidden="true">
            ${u(G,this,bl).call(this).map(e=>r`
                <li
                  class=${k({graduation:!0,"main-graduation":e%5==0,selected:u(G,this,Ml).call(this,e)})}
                  data-graduation=${e}
                >
    ...
    `}};function bl(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function xl(){this._list&&(this._list.style.left=`${u(G,this,wl).call(this,this.value)}px`)}function Sl(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function Cl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(_l,this)*n-t}function wl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(_l,this)/n-this._graduations.offsetWidth/2)}function Tl(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);this.value=n,t&&u(G,this,El).call(this,`change`)}function El(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function Dl(e){h(ml,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(ml,this)&&(e.preventDefault(),h(hl,this,e.clientX),h(gl,this,this._list.offsetLeft),this._root.setPointerCapture(e.pointerId),u(G,this,El).call(this,`start`))}function Ol(e){m(ml,this)&&Math.abs(e.clientX-m(hl,this))>3&&(h(pl,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(G,this,Al).call(this,e))}function kl(e){m(ml,this)&&(m(pl,this)?(e.preventDefault(),h(pl,this,!1),this._root.classList.remove(`dragging`)):u(G,this,Al).call(this,e),u(G,this,El).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(hl,this,0),h(ml,this,!1))}function Al(e){let t=m(pl,this)?m(hl,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(pl,this)?t-e.clientX:e.clientX-t,r=m(gl,this)-n;u(G,this,Tl).call(this,u(G,this,Cl).call(this,r))}function jl(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(G,this,Tl).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(G,this,Tl).call(this,t-1);break;case`PageUp`:u(G,this,Tl).call(this,t+10);break;case`PageDown`:u(G,this,Tl).call(this,t-10);break;case`Home`:u(G,this,Tl).call(this,this.min);break;case`End`:u(G,this,Tl).call(this,this.max);break;default:return}e.preventDefault()}function Ml(e){return e>=Math.min(0,this.value)&&e<=Math.max(0,this.value)}yl.styles=[fl],p([g({type:Number})],yl.prototype,`min`,void 0),p([g({type:Number})],yl.prototype,`max`,void 0),p([g({type:Number})],yl.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],yl.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],yl.prototype,`graduationMax`,void 0),p([g()],yl.prototype,`label`,void 0),p([y(`.slide-rule`)],yl.prototype,`_root`,void 0),p([y(`.graduations`)],yl.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],yl.prototype,`_list`,void 0),p([y(`.cursor`)],yl.prototype,`_cursor`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,yl);var Nl=a`
  :host {
    display: inline-flex;
...
`,Pl=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      <span
      ...
      ></span>
    `}};Pl.styles=[Nl],p([g()],Pl.prototype,`label`,void 0),p([g()],Pl.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Pl);var Fl=class extends Oe(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},Ll=class extends Fl{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Ll.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,Ll);var Rl=a`
  :host {
    display: grid;
  }
...
`;function zl(e){return(e??``).split(/\s+/).filter(Boolean)}function Bl(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Vl=Symbol.for(`craft-switch-synthetic-change`),Hl=new WeakMap,Ul=new WeakSet,Wl=class extends Il{constructor(...e){super(...e),d(this,Ul),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,f(this,Hl,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,br,Rl]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Ll}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?O(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?O(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){u(Ul,this,Gl).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){u(Ul,this,Gl).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){u(Ul,this,Gl).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(m(Hl,this))return;let e=new Event(`change`,{bubbles:!0});e[Vl]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Vl in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of zl(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of zl(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Bl(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
    ...
    `}};function Gl(e,t){if(!this.disabled){if(!t){e();return}h(Hl,this,!0),e(),this.updateComplete.then(()=>{h(Hl,this,!1)})}}p([g({type:String,reflect:!0})],Wl.prototype,`size`,void 0),p([g({type:String,attribute:`on-label`})],Wl.prototype,`onLabel`,void 0),p([g({type:String,attribute:`off-label`})],Wl.prototype,`offLabel`,void 0),p([g({attribute:`value`})],Wl.prototype,`checkedValue`,void 0),p([g({attribute:`indeterminate-value`})],Wl.prototype,`indeterminateValue`,void 0),p([g({type:Boolean,reflect:!0})],Wl.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,Wl);function Kl({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function ql(e){e.setAttribute(`selected`,`true`)}function Jl(e){e.removeAttribute(`selected`)}function Yl({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function Xl({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function Zl(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function Ql(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function $l(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var eu=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,nu={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(nu);var ru={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(ru);var iu=[nu.InlineStart,nu.InlineEnd],au=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),K=new WeakSet,ou=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakMap,du=new WeakMap,fu=new WeakMap,pu=new WeakMap,mu=new WeakMap,hu=new WeakMap,gu=new WeakMap,_u=class extends eu{constructor(...e){super(...e),d(this,K),this.placement=nu.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,ou,[]),f(this,su,!1),f(this,cu,[]),f(this,lu,0),f(this,uu,void 0),f(this,du,!1),f(this,fu,e=>{if(!this.collapsible||yu.call(u(K,this)))return;let t=u(K,this,Cu).call(this,e.target);!t||t.disabled||bu.call(u(K,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(K,this,wu).call(this,!0))}),f(this,pu,e=>{e.key!==`Escape`||!this.collapsible||yu.call(u(K,this))||u(K,this,Cu).call(this,e.target)&&(e.stopPropagation(),u(K,this,wu).call(this,!0))}),f(this,mu,()=>{yu.call(u(K,this))&&(bu.call(u(K,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(K,this,Tu).call(this)}),f(this,hu,()=>{if(u(K,this,Eu).call(this),bu.call(u(K,this)).forEach((e,t)=>{let n=()=>u(K,this,Pu).call(this,t,!0),r=e=>{au.has(e.key)&&e.preventDefault()},i=e=>u(K,this,Fu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(ou,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),bu.call(u(K,this))[this.selectedIndex]?.disabled){let e=bu.call(u(K,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(K,this,Du).call(this)}),f(this,gu,()=>{m(du,this)||(h(du,this,!0),requestAnimationFrame(()=>{h(du,this,!1),u(K,this,ku).call(this)}))})}static get styles(){return[...super.styles,_o,tu]}get layout(){return vu.call(u(K,this))?ru.Vertical:ru.Horizontal}set layout(e){this.placement=e===ru.Vertical?nu.InlineStart:nu.BlockStart}refresh(){m(su,this)&&u(K,this,Du).call(this),u(K,this,ku).call(this)}firstUpdated(e){h(su,this,bu.call(u(K,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(su,this))t?.addEventListener(`slotchange`,m(hu,this)),m(hu,this).call(this);else{let n=yu.call(u(K,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(mu,this))}this.addEventListener(`click`,m(fu,this),!0),this.addEventListener(`keydown`,m(pu,this)),t?.addEventListener(`slotchange`,m(gu,this)),h(uu,this,new ResizeObserver(m(gu,this))),m(uu,this).observe(this),u(K,this,ku).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(K,this,Eu).call(this),m(uu,this)?.disconnect(),h(uu,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,yu.call(u(K,this))),e.has(`selectedIndex`)&&(m(su,this)?u(K,this,Du).call(this):m(mu,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(K,this,ku).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${vu.call(u(K,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${yu.call(u(K,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function vu(){return iu.includes(this.placement)}function yu(){return this.selectedIndex<0}function bu(){return this.tabs}function xu(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function Su(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function Cu(e){return e instanceof Node?bu.call(u(K,this)).find(t=>t===e||t.contains(e))??null:null}function wu(e){let t=bu.call(u(K,this))[this.selectedIndex];h(lu,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Tu(){let e=bu.call(u(K,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(lu,this))?m(lu,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function Eu(){for(;m(ou,this).length;)m(ou,this).pop()?.()}function Du(){let e=bu.call(u(K,this)).map(e=>u(K,this,Ou).call(this,e)),t=e.some(Boolean);bu.call(u(K,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Ue()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(K,this,Tu).call(this)}function Ou(e){return e.controls?document.getElementById(e.controls):null}function ku(){let e=xu.call(u(K,this)),t=Su.call(u(K,this)),n=bu.call(u(K,this));if(!e||!t)return;if(vu.call(u(K,this))||n.length===0){u(K,this,ju).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(K,this,Au).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(K,this,ju).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(K,this,ju).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Au(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function ju(e){let t=Su.call(u(K,this)),n=new Set(e);bu.call(u(K,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(cu,this,e),t&&(t.hidden=e.length===0,t.actions=u(K,this,Mu).call(this))}function Mu(){return m(cu,this).map(e=>{let t=bu.call(u(K,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(K,this,Nu).call(this,e)}})}function Nu(e){let t=bu.call(u(K,this))[e];if(!t||t.disabled)return;let n=Su.call(u(K,this));n&&(n.opened=!1),this.selectedIndex=e,u(K,this,ku).call(this),t.focus()}function Pu(e,t){let n=bu.call(u(K,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Fu(e){if(!au.has(e.key))return;let t=u(K,this,Iu).call(this,e.key);t!==-1&&u(K,this,Pu).call(this,t,!0)}function Iu(e){let t=bu.call(u(K,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(yu.call(u(K,this)))return u(K,this,Iu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],_u.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],_u.prototype,`collapsible`,void 0),p([g({reflect:!0})],_u.prototype,`layout`,null),p([g({reflect:!0})],_u.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,_u);var Lu=a`
  :host {
    display: inline-flex;
...
`,qu=C(ue(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?t.exports=r():typeof define==`function`&&define.amd?define(r):(n||=self,n.autosize=r())})(e,(function(){var e=new Map;function t(t){if(!t||!t.nodeName||t.nodeName!==`TEXTAREA`||e.has(t))return;var n=null;function r(e){for(var t=[];e&&e.parentNode&&e.parentNode instanceof Element;)e.parentNode.scrollTop&&t.push([e.parentNode,e.parentNode.scrollTop]),e=e.parentNode;return function(){return t.forEach(function(e){var t=e[0],n=e[1];t.style.scrollBehavior=`auto`,t.scrollTop=n,t.style.scrollBehavior=null})}}var i=window.getComputedStyle(t);function a(e){var o=e.restoreTextAlign,s=o===void 0?null:o,c=e.testForHeightReduction,l=c===void 0||c,u=i.overflowY;if(t.scrollHeight!==0){i.resize===`vertical`?t.style.resize=`none`:i.resize===`both`&&(t.style.resize=`horizontal`);var d;l&&(d=r(t),t.style.height=``);var f=i.boxSizing===`content-box`?t.scrollHeight-(parseFloat(i.paddingTop)+parseFloat(i.paddingBottom)):t.scrollHeight+parseFloat(i.borderTopWidth)+parseFloat(i.borderBottomWidth);if(i.maxHeight!==`none`&&f>parseFloat(i.maxHeight)?(i.overflowY===`hidden`&&(t.style.overflow=`scroll`),f=parseFloat(i.maxHeight)):i.overflowY!==`hidden`&&(t.style.overflow=`hidden`),t.style.height=f+`px`,s&&(t.style.textAlign=s),d&&d(),n!==f&&(t.dispatchEvent(new Event(`autosize:resized`,{bubbles:!0})),n=f),u!==i.overflow&&!s){var p=i.textAlign;i.overflow===`hidden`&&(t.style.textAlign=p===`start`?`end`:`start`),a({restoreTextAlign:p,testForHeightReduction:!0})}}}function o(){a({testForHeightReduction:!0,restoreTextAlign:null})}var s=function(){var e=t.value;return function(){a({testForHeightReduction:e===``||!t.value.startsWith(e),restoreTextAlign:null}),e=t.value}}(),c=function(n){t.removeEventListener(`autosize:destroy`,c),t.removeEventListener(`autosize:update`,o),t.removeEventListener(`input`,s),window.removeEventListener(`resize`,o),Object.keys(n).forEach(function(e){return t.style[e]=n[e]}),e.delete(t)}.bind(t,{height:t.style.height,resize:t.style.resize,textAlign:t.style.textAlign,overflowY:t.style.overflowY,overflowX:t.style.overflowX,wordWrap:t.style.wordWrap});t.addEventListener(`autosize:destroy`,c),t.addEventListener(`autosize:update`,o),t.addEventListener(`input`,s),window.addEventListener(`resize`,o),t.style.overflowX=`hidden`,t.style.wordWrap=`break-word`,e.set(t,{destroy:c,update:o}),o()}function n(t){var n=e.get(t);n&&n.destroy()}function r(t){var n=e.get(t);n&&n.update()}var i=null;return typeof window>`u`?(i=function(e){return e},i.destroy=function(e){return e},i.update=function(e){return e}):(i=function(e,n){return e&&Array.prototype.forEach.call(e.length?e:[e],function(e){return t(e)}),e},i.destroy=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],n),e},i.update=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],r),e}),i}))}))(),1),Ju=new WeakMap,Yu=new WeakMap,Xu=new WeakMap,Zu=new WeakSet,Qu=class extends Gu{constructor(...e){super(...e),d(this,Zu),this.monospace=!1,f(this,Ju,void 0),f(this,Yu,void 0),f(this,Xu,null)}static get styles(){return[...super.styles,xr,Ku]}connectedCallback(){super.connectedCallback(),u(Zu,this,$u).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(Ju,this)?.disconnect(),h(Ju,this,void 0),m(Yu,this)?.disconnect(),h(Yu,this,void 0)}};function $u(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(Xu,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(Xu,this,e.style.height)}),h(Yu,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(Yu,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(Ju,this,new ResizeObserver(()=>{if(e.style.height===m(Xu,this))return;let t=e.style.height;qu.default.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(Yu,this)?.disconnect(),h(Yu,this,void 0),m(Ju,this)?.disconnect(),h(Ju,this,void 0)})),m(Ju,this).observe(e))}p([g({type:Boolean,reflect:!0})],Qu.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Qu);var ed=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>td(e,this),this.compositionEventHandler=e=>sd(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,nd),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,nd)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(od)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(od)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(od),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),ad(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function td(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:rd(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&rd(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function nd(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&id(t,{event:e})}function rd(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function id(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function ad(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function od(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function sd(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var cd=class extends Event{constructor(){super(`update`)}},ld=new WeakMap,ud=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=ld.get(t);return n||(n=new e(t),ld.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),ld.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new cd)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of dd)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},dd=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),fd=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return ud.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},pd=a`
  :host {
    display: contents;
  }
...
`,md=/^[\p{L}\p{N}_.-]*$/u,hd=O(`Suggestions`),gd=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],_d={handlesAccessibility:!1,visibilityTriggerFunction:void 0},vd=0,q=new WeakMap,yd=new WeakMap,bd=new WeakMap,xd=new WeakMap,J=new WeakMap,Sd=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,Y=new WeakSet,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Bd=new WeakMap,Vd=new WeakMap,Hd=class extends l{constructor(...e){super(...e),d(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,q,void 0),f(this,yd,null),f(this,bd,null),f(this,xd,new Map),f(this,J,null),f(this,Sd,[]),f(this,Cd,0),f(this,wd,null),f(this,Td,null),f(this,Ed,null),f(this,Dd,!1),f(this,Od,null),f(this,kd,new DOMRect),f(this,Ad,new MutationObserver(()=>{let e=u(Y,this,Wd).call(this);(pf(e)&&e!==m(yd,this)||m(yd,this)&&!m(yd,this).isConnected)&&u(Y,this,Gd).call(this)})),f(this,jd,()=>{m(Dd,this)||u(Y,this,Qd).call(this)}),f(this,Md,()=>{h(Dd,this,!0),u(Y,this,sf).call(this)}),f(this,Nd,()=>{h(Dd,this,!1),u(Y,this,Qd).call(this)}),f(this,Pd,()=>{queueMicrotask(()=>u(Y,this,sf).call(this))}),f(this,Fd,()=>{let e=m(yd,this);!e||!m(J,this)||!mf(e)||queueMicrotask(()=>{m(J,this)&&(e.selectionStart!==m(J,this).end||e.selectionEnd!==m(J,this).end)&&u(Y,this,Qd).call(this)})}),f(this,Id,()=>{m(J,this)&&u(Y,this,of).call(this)}),f(this,Ld,e=>{let t=e;m(J,this)&&m(q,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,Rd,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,zd,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,Bd,e=>{u(Y,this,nf).call(this,Number(e.target.dataset.index))}),f(this,Vd,e=>{if(e.target!==this.popoverElement)return;let t=m(q,this).getAttribute(`aria-label`)??hd;u(Y,this,uf).call(this),h(J,this,null),u(Y,this,lf).call(this),u(Y,this,df).call(this,t===hd?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(Y,this,Ud).call(this),this.hasUpdated&&u(Y,this,Gd).call(this)}disconnectedCallback(){u(Y,this,qd).call(this),m(q,this)?.remove(),m(Ed,this)!==null&&(clearTimeout(m(Ed,this)),h(Ed,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(Y,this,Gd).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(yd,this)!==u(Y,this,Wd).call(this)&&u(Y,this,Gd).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(J,this)){let e=m(q,this).querySelector(`[aria-selected="true"]`),t=e?m(Sd,this)[Number(e.dataset.index)]:void 0;u(Y,this,Qd).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${_d}
    ...
    `}};function Ud(){h(q,this,document.createElement(`div`)),m(q,this).id=`craft-text-expander-listbox-${++vd}`,m(q,this).slot=`listbox`,m(q,this).setAttribute(`part`,`listbox`),m(q,this).role=`listbox`,m(q,this).setAttribute(`aria-label`,hd),m(q,this).addEventListener(`pointerdown`,m(Rd,this)),m(q,this).addEventListener(`pointerup`,m(zd,this)),m(q,this).addEventListener(`combobox-commit`,m(Bd,this)),this.append(m(q,this))}function Wd(){return this.getRootNode().getElementById(this.for)}function Gd(){let e=u(Y,this,Wd).call(this);if(u(Y,this,qd).call(this),!pf(e)){u(Y,this,Kd).call(this);return}h(yd,this,e),u(Y,this,Jd).call(this,e),h(bd,this,new ed(e,m(q,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(Y,this,Yd).call(this,e),e.addEventListener(`input`,m(jd,this)),e.addEventListener(`keydown`,m(Ld,this)),e.addEventListener(`blur`,m(Pd,this)),e.addEventListener(`compositionstart`,m(Md,this)),e.addEventListener(`compositionend`,m(Nd,this)),e.ownerDocument.addEventListener(`selectionchange`,m(Fd,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(kd,this)},u(Y,this,Kd).call(this)}function Kd(){m(Ad,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function qd(){m(Ad,this).disconnect(),u(Y,this,sf).call(this);let e=m(yd,this);e&&(e.removeEventListener(`input`,m(jd,this)),e.removeEventListener(`keydown`,m(Ld,this)),e.removeEventListener(`blur`,m(Pd,this)),e.removeEventListener(`compositionstart`,m(Md,this)),e.removeEventListener(`compositionend`,m(Nd,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(Fd,this)),m(Od,this)?.getStyleClone().disconnect(),h(Od,this,null),m(bd,this)?.destroy(),h(bd,this,null),u(Y,this,Xd).call(this,e),h(yd,this,null))}function Jd(e){m(xd,this).clear();for(let t of gd)m(xd,this).set(t,e.getAttribute(t))}function Yd(e){let t=[m(xd,this).get(`aria-controls`),m(q,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(Y,this,Zd).call(this,e,`aria-haspopup`),u(Y,this,Zd).call(this,e,`aria-expanded`)}function Xd(e){for(let t of gd)u(Y,this,Zd).call(this,e,t);m(xd,this).clear()}function Zd(e,t){let n=m(xd,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function Qd(e){u(Y,this,uf).call(this);let t=u(Y,this,ef).call(this);if(!t){h(J,this,null),u(Y,this,cf).call(this);return}h(J,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(Y,this,tf).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(Y,this,tf).call(this,[]),u(Y,this,df).call(this,O(`Loading`));let r=m(Cd,this);h(Td,this,setTimeout(()=>{u(Y,this,$d).call(this,t,n,r,e)},150))}async function $d(e,t,n,r){h(wd,this,new AbortController);let i;try{let n=await ve.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(wd,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(Cd,this)||hf(t))return;u(Y,this,sf).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(Cd,this)&&(this.loading=!1,u(Y,this,tf).call(this,t===void 0?i:i.slice(0,t),r))}function ef(){let e=m(yd,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!mf(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&md.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function tf(e,t){if(u(Y,this,af).call(this),h(Sd,this,e),m(q,this).replaceChildren(),m(q,this).hidden=this.loading,m(q,this).setAttribute(`aria-label`,m(J,this)?.trigger.label??hd),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=ff(e);n.id=`${m(q,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(J,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(q,this).append(n)}),!this.loading&&!e.length){h(J,this,null),u(Y,this,cf).call(this),u(Y,this,df).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(J,this)&&u(Y,this,rf).call(this,t)})}function nf(e){let t=m(yd,this),n=m(Sd,this)[e],r=u(Y,this,ef).call(this),i=m(J,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(Y,this,sf).call(this);return}gf(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(Y,this,sf).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function rf(e){await this.popoverElement.updateComplete;let t=m(yd,this);if(!t||!u(Y,this,of).call(this)){u(Y,this,sf).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(J,this)||t!==m(yd,this))&&m(Sd,this).length&&(m(bd,this)?.start(),u(Y,this,Zd).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(jd,this)),t.addEventListener(`input`,m(jd,this)),e)){let t=m(Sd,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(bd,this)?.navigate(1)}}function af(){m(bd,this)?.stop(),m(yd,this)&&u(Y,this,Zd).call(this,m(yd,this),`aria-expanded`)}function of(){let e=m(yd,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(Od,this)){h(Od,this,new fd(e));let t=m(Od,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(Id,this))}return m(Od,this).setStartOffset(t),m(Od,this).setEndOffset(t),h(kd,this,m(Od,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function sf(){u(Y,this,uf).call(this),h(J,this,null),u(Y,this,cf).call(this)}function cf(){u(Y,this,lf).call(this),this.popoverElement.hide()}function lf(){this.loading=!1,u(Y,this,af).call(this),h(Sd,this,[]),m(q,this)?.replaceChildren(),m(q,this)&&(m(q,this).hidden=!1);let e=m(yd,this);e&&(u(Y,this,Zd).call(this,e,`aria-activedescendant`),u(Y,this,Zd).call(this,e,`aria-busy`))}function uf(){var e;h(Cd,this,(e=m(Cd,this),e++,e)),m(Td,this)&&(clearTimeout(m(Td,this)),h(Td,this,null)),m(wd,this)?.abort(),h(wd,this,null)}function df(e){m(Ed,this)!==null&&(clearTimeout(m(Ed,this)),h(Ed,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(Ed,this,setTimeout(()=>{h(Ed,this,null),this.announcement=``},5e3))}Hd.styles=[Nt,pd],p([g({reflect:!0})],Hd.prototype,`for`,void 0),p([g({type:Array})],Hd.prototype,`triggers`,void 0),p([_()],Hd.prototype,`loading`,void 0),p([_()],Hd.prototype,`announcement`,void 0),p([y(`craft-popover`)],Hd.prototype,`popoverElement`,void 0);function ff(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function pf(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function mf(e){return e.getRootNode().activeElement===e}function hf(e){return e instanceof DOMException&&e.name===`AbortError`}function gf(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Hd);var _f=a`
  :host {
    display: inline-flex;

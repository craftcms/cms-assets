...
import{a as e,t}from"./rolldown-runtime-CNC7AqOf.js";import{a as n,c as r,d as i,f as a,i as o,n as s,r as c,t as l}from"./lit-DNaDb1T7.js";import{t as u}from"./decorate-B3KLIx2E-B3KLIx2E.js";import{n as d,t as f}from"./decorators-D0-gbKXH.js";import{n as p,t as m}from"./query-Df4-SAIv.js";import{a as h,i as g,n as _,r as v,t as y}from"./classPrivateFieldSet2-BrH7O_C6-CUGCWNrd.js";import{n as b}from"./apiClient.ts-BCGkFfOS.js";import{_ as x,a as S,b as C,c as w,d as T,f as E,g as D,h as O,i as ee,l as te,n as ne,o as re,p as ie,r as ae,s as k,u as oe,v as se,y as ce}from"./nav-item-iu1kiJ6N-WJ01PjAN.js";import"./nav-list.ts-DPwcLr0r.js";import"./progress.ts-Ds7fWnuo.js";a`
  :host([data-color='red']),
  [data-color='red'] {
...
`;function ue(e){return(t,n)=>{let{slot:r,selector:i}=e??{},a=`slot`+(r?`[name=${r}]`:`:not([name])`);return p(t,n,{get(){let t=(this.renderRoot?.querySelector(a))?.assignedElements(e)??[];return i===void 0?t:t.filter((e=>e.matches(i)))}})}}var de=class extends l{constructor(){super(),this.alt=!1,this.shift=!1,this.os=`Unknown`,this.os=this.detectOS()}connectedCallback(){super.connectedCallback(),this.os===`Unknown`&&(this.os=this.detectOS())}detectOS(){let e=navigator.platform.toLowerCase();return e.includes(`mac`)||/iphone|ipad|ipod/.test(e)?`Mac`:e.includes(`win`)?`Windows`:e.includes(`linux`)?`Linux`:`Unknown`}renderShortcutPrefix(){switch(this.os){case`Mac`:return`${this.alt?`⌥`:``}${this.shift?`⇧`:``}⌘`;case`Linux`:return`Super+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`;default:return`Ctrl+${this.alt?`Alt+`:``}${this.shift?`Shift+`:``}`}}render(){return r`<span class="shortcut"
  ...
  `,u([d({type:Boolean})],de.prototype,`alt`,void 0),u([d({type:Boolean})],de.prototype,`shift`,void 0),u([d()],de.prototype,`os`,void 0),customElements.get(`craft-shortcut`)||customElements.define(`craft-shortcut`,de);function fe(e){if(typeof e!=`string`)return e;try{return JSON.parse(e)}catch{return null}}async function pe(e,t={}){switch(e.type){case`clipboard`:await navigator.clipboard.writeText(e.value);break;case`http`:{if(e.confirm&&!confirm(e.confirm))return;let t=await fetch(e.url,{method:e.method||`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:e.body?JSON.stringify(e.body):void 0}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(n.message??`Request failed`);typeof n.redirect==`string`&&n.redirect&&me(n.redirect);break}case`event`:if(e.confirm&&!confirm(e.confirm))return;window.dispatchEvent(new CustomEvent(e.name,{detail:{...e.detail??{},...t.trigger?{trigger:t.trigger}:{},...t.sourceEvent?{sourceEvent:t.sourceEvent}:{}}}));break;case`download`:{if(e.confirm&&!confirm(e.confirm))return;if(e.method&&e.method!==`GET`){let t=await b.request({url:e.url,method:e.method,data:e.body,responseType:`blob`}),n=String(t.headers[`content-disposition`]??``),r=/filename\*?=(?:UTF-8'')?"?([^";]+)"?/i.exec(n),i=e.filename??(r?.[1]?decodeURIComponent(r[1]):`download`),a=URL.createObjectURL(t.data),o=document.createElement(`a`);o.href=a,o.download=i,document.body.appendChild(o),o.click(),o.remove(),URL.revokeObjectURL(a);break}let t=document.createElement(`a`);t.href=e.url,t.download=e.filename??``,t.click();break}default:throw Error(`Unknown action type: ${e.type}`)}}function me(e){window.dispatchEvent(new CustomEvent(`action:redirect`,{cancelable:!0,detail:{url:e}}))&&window.location.assign(e)}var he={Neutral:`neutral`,Success:`success`,Warning:`warning`,Danger:`danger`,Info:`info`},ge=Object.values(he),_e={Idle:`idle`,Loading:`loading`,Success:`success`,Error:`error`},ve=a`
  :host {
    display: contents;
  }
...
`,A=class extends l{constructor(...e){super(...e),this.icon=null,this.iconColor=null,this.href=null,this.target=null,this.rel=null,this.disabled=!1,this.variant=he.Neutral,this.checked=!1,this.active=!1,this.type=`button`,this.action=null,this.feedback=null,this.feedbackDuration=1e3,this.confirm=null,this.state=_e.Idle,this.feedbackMessage=null,this.shortcut=null}renderShortcut(){return typeof this.shortcut==`string`?r`<craft-shortcut>${this.shortcut}</craft-shortcut>`:this.shortcut===null?c:r`<craft-shortcut
        ?alt="${this.shortcut.alt??!1}"
        ?shift="${this.shortcut.shift??!1}"
        >${this.shortcut.key}</craft-shortcut
      >`}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,this)}setState(e,t={}){this.state=e,this.feedbackMessage=t.message??null,this.dispatchEvent(new CustomEvent(`action:change-state`,{bubbles:!0,composed:!0,detail:{state:e,actionType:fe(this.action)?.type,...t}}))}async handleEvent(e){if(this.disabled){e.preventDefault();return}let t=fe(this.action);if(e.type===`click`&&t){t.type===`http`&&this.setState(_e.Loading);try{await pe(t,{trigger:this,sourceEvent:e}),this.setState(_e.Success,this.feedback?.success)}catch(e){this.setState(_e.Error,{message:e.message,...this.feedback?.error||{}})}finally{setTimeout(()=>{this.setState(_e.Idle)},this.feedbackDuration)}}}renderCheckbox(){return r`<span class="action-item__check">
      <slot name="checkmark">
        ${this.checked?r`<craft-icon name="check"></craft-icon>`:c}
      </slot>
    </span>`}renderIcon(){switch(this.state){case _e.Loading:return r`<craft-spinner style="--size: 0.8em"></craft-spinner>`;case _e.Success:return r`<craft-icon
          name="check"
          style="color: var(--c-color-success-on-normal)"
        ></craft-icon>`;case _e.Error:return r`<craft-icon
          name="xmark"
    ...
    `}render(){return this.href?r`
          <a
            class="${x({"action-item":!0,"action-item--checkbox":this.type===`checkbox`})}"
            href="${this.href}"
    ...
    `],ze._filterableItemsSelector=`craft-action-item, li, button`,u([d({attribute:!1})],ze.prototype,`actions`,void 0),u([d()],ze.prototype,`label`,void 0),u([d()],ze.prototype,`icon`,void 0),u([d({type:Boolean,reflect:!0})],ze.prototype,`disabled`,void 0),u([d({type:Boolean,reflect:!0})],ze.prototype,`searchable`,void 0),u([ue({slot:`invoker`})],ze.prototype,`invokerNodes`,void 0),u([ue({slot:`content`})],ze.prototype,`contentNodes`,void 0),customElements.get(`craft-action-menu`)||customElements.define(`craft-action-menu`,ze);var Be=a`
  :host {
    --color-start: red;
    --color-end: blue;
    --color-text: inherit;
...
`,Ve=class extends l{constructor(...e){super(...e),this.label=null,this._gradientId=null}connectedCallback(){super.connectedCallback(),this._gradientId=`avatar-gradient-${Math.random().toString(36).slice(2,8)}`}text(){return this.label?this.label.split(` `).map(e=>e.charAt(0).toUpperCase()).join(``):`?`}render(){return r`
      <span class="avatar">
        <svg
          viewBox="0 0 100 100"
    ...
    `}};Ve.styles=[Be],u([d()],Ve.prototype,`label`,void 0),u([f()],Ve.prototype,`_gradientId`,void 0),customElements.get(`craft-avatar`)||customElements.define(`craft-avatar`,Ve);var He=[`red`,`orange`,`amber`,`yellow`,`lime`,`green`,`emerald`,`teal`,`cyan`,`sky`,`blue`,`indigo`,`violet`,`purple`,`fuchsia`,`pink`,`rose`,`white`,`gray`,`black`,`slate`],Ue={neutral:`slate`,accent:`blue`,info:`sky`,success:`emerald`,warning:`yellow`,danger:`red`},We={pending:`orange`,off:`red`,suspended:`red`,expired:`red`,disabled:`gray`,inactive:`gray`,on:`emerald`},Ge=e=>e.charAt(0).toUpperCase()+e.slice(1),Ke={...Object.fromEntries(He.map(e=>[Ge(e),e])),...Object.fromEntries(Object.entries(Ue).map(([e,t])=>[Ge(e),t])),...Object.fromEntries(Object.entries(We).map(([e,t])=>[Ge(e),t]))},qe=[...He],Je=class extends l{constructor(...e){super(...e),this.size=`md`,this.fill=`var(--c-color-fill-loud)`,this.label=null,this.appearance=ae.OutlineFill}getFill(){return qe.includes(this.fill)||ge.includes(this.fill)?`var(--c-color-${this.fill}-fill-loud)`:this.fill}getSize(){switch(this.size){case`md`:return`0.6em`;case`lg`:return`1em`;default:return this.size}}render(){return r`<span
      style="--fill: ${this.getFill()}; --size: ${this.getSize()}"
      aria-label="${this.label??c}"
      role="${this.label?`img`:c}"
      class="${x({indicator:!0,"indicator--outline":this.appearance===ae.Outline})}"
    ></span>`}};Je.styles=[le,a`
      :host {
        display: contents;
      }
    ...
    `],u([d()],Je.prototype,`size`,void 0),u([d({reflect:!0})],Je.prototype,`fill`,void 0),u([d()],Je.prototype,`label`,void 0),u([d({reflect:!0})],Je.prototype,`appearance`,void 0),customElements.get(`craft-indicator`)||customElements.define(`craft-indicator`,Je);var Ye=a`
  :host {
    display: inline-flex;
  }
...
`,Xe={Small:`small`,Medium:`medium`,Large:`large`};Object.values(Xe);var Ze=class extends l{constructor(...e){super(...e),this.fill=Ke.Gray,this.noPrefix=!1,this.size=Xe.Medium}getFill(){return this.fill}willUpdate(e){e.has(`fill`)&&(this.dataset.color=this.getFill())}render(){return r`
      <span
        part="badge"
        class="${x({badge:!0,"badge--small":this.size===Xe.Small,"badge--large":this.size===Xe.Large})}"
      >
    ...
    `}};Ze.styles=[Ye],u([d({reflect:!0})],Ze.prototype,`fill`,void 0),u([d({attribute:`no-prefix`,type:Boolean})],Ze.prototype,`noPrefix`,void 0),u([d()],Ze.prototype,`size`,void 0),customElements.get(`craft-badge`)||customElements.define(`craft-badge`,Ze);var Qe=class extends l{constructor(...e){super(...e),this.rel=`noreferrer noopener`}render(){return r`
  ...
  `,u([d({reflect:!0})],Qe.prototype,`href`,void 0),u([d()],Qe.prototype,`target`,void 0),u([d()],Qe.prototype,`rel`,void 0),customElements.get(`craft-breadcrumb-item`)||customElements.define(`craft-breadcrumb-item`,Qe);var $e=class{constructor(){this.__iconResolvers=new Map}addIconResolver(e,t){if(this.__iconResolvers.has(e))throw Error(`An icon resolver has already been registered for namespace: ${e}`);this.__iconResolvers.set(e,t)}removeIconResolver(e){this.__iconResolvers.delete(e)}resolveIcon(e,t,n){let r=this.__iconResolvers.get(e);if(r)return r(t,n);throw Error(`Could not find any icon resolver for namespace ${e}.`)}resolveIconForId(e){let t=e.split(`:`);if(t.length!==3)throw Error(`Incorrect iconId: ${e}. Format: <namespace>:<iconset>:<icon>`);return this.resolveIcon(t[0],t[1],t[2])}};function et(){if(!w.has(`@lion/ui::icons::0.x`)){let e=new $e;w.set(`@lion/ui::icons::0.x`,e)}return w.get(`@lion/ui::icons::0.x`)}var tt=te(et),nt=class extends ce{constructor(e){if(super(e),this.it=c,e.type!==C.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===c||e==null)return this._t=void 0,this.it=e;if(e===o)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};nt.directiveName=`unsafeHTML`,nt.resultType=1;var rt=se(nt),it=class extends nt{};it.directiveName=`unsafeSVG`,it.resultType=2;var at=se(it),ot=`craft`,st=new Map;function ct(e,t){return`${e}/${t}`}function lt(e){let[t=`classic`,n=`regular`]=e.split(`/`);return{family:t,variant:n}}async function ut(e){try{let t=await fetch(e,{mode:`cors`});if(!t.ok)return c;let n=document.createElement(`div`);n.innerHTML=await t.text();let i=n.firstElementChild;return i?.tagName?.toLowerCase()===`svg`?(i.setAttribute(`fill`,`currentColor`),i.setAttribute(`part`,`svg`),r`${at(i.outerHTML)}`):c}catch{return c}}function dt(e,t=`classic`,n=`regular`,r=`/vendor/craft/icons`){let i=`solid`,a=n,o=e.endsWith(`.svg`)?e.split(`.svg`)[0]:e;if(e.includes(`/`)){let[t,...n]=e.split(`/`);a=t??a,o=n.join(`/`)}return a===`thin`?i=`thin`:a===`light`?i=`light`:a===`regular`?i=`regular`:a===`solid`&&(i=`solid`),(t===`brands`||a===`brands`)&&(i=`brands`),(t===`custom-icons`||a===`custom-icons`)&&(i=`custom-icons`),`${r}/${i}/${o}.svg`}function ft(e){return(t,n,r)=>{let i=e(t,n,r);if(i===null)return c;let a=st.get(i);return a||(a=ut(i),st.set(i,a)),a.then(e=>(e===c&&st.delete(i),e))}}var pt=ft(dt);function mt(e){tt.removeIconResolver(ot),tt.addIconResolver(ot,(t,n)=>{let{family:r,variant:i}=lt(t);return e(n,r,i)})}function ht(e,t=`classic`,n=`regular`){return Promise.resolve(tt.resolveIcon(ot,ct(t,n),e))}mt(pt);var gt=new WeakSet,_t=class extends l{constructor(...e){super(...e),g(this,gt),this.appearance=`plain`,this._svg=c,this._hasSlottedContent=!1}connectedCallback(){super.connectedCallback(),this.appearance===`badge`&&!this.getAttribute(`data-color`)&&this.setAttribute(`data-color`,`warning`),this._hasSlottedContent=this.childElementCount>0}firstUpdated(){h(gt,this,bt).call(this)}updated(e){super.updated(e),(e.has(`name`)||e.has(`family`)||e.has(`variant`))&&h(gt,this,yt).call(this),e.has(`label`)&&this.hasUpdated&&h(gt,this,bt).call(this)}_handleSlotChange(e){let t=e.target;this._hasSlottedContent=t.assignedElements({flatten:!0}).length>0}render(){return r`
...
`,St=class extends l{constructor(...e){super(...e),this.label=O(`Breadcrumbs`),this.items=[],this.visibleItems=0,this.firstRender=!0}getSeparator(){let e=this.separatorSlot.assignedElements({flatten:!0})[0].cloneNode(!0);return[e,...e.querySelectorAll(`[id]`)].forEach(e=>e.removeAttribute(`id`)),e.setAttribute(`data-default`,``),e.slot=`separator`,e}calculateBreadcrumbItemsWidth(){this.items=this.breadcrumbsElements.map((e,t)=>{let n=e.offsetWidth;return e.hasAttribute(`hidden`)&&(e.removeAttribute(`hidden`),n=e.offsetWidth,e.setAttribute(`hidden`,``)),{label:e.innerText,href:e.href,value:t.toString(),offsetWidth:n,isVisible:!0}})}async handleSlotChange(){let e=[...this.defaultSlot.assignedElements({flatten:!0})].filter(e=>e.tagName.toLowerCase()===`craft-breadcrumb-item`);if(e.forEach((t,n)=>{let r=n===e.length-1,i=t.querySelector(`[slot="separator"]`);r?i?.hasAttribute(`data-default`)&&i.remove():i===null?t.append(this.getSeparator()):i.hasAttribute(`data-default`)&&i.replaceWith(this.getSeparator()),r?t.setAttribute(`aria-current`,`page`):t.removeAttribute(`aria-current`)}),this.breadcrumbsElements.length===0){this.items=[],this.visibleItems=0;return}await Promise.all(this.breadcrumbsElements.map(e=>e.updateComplete)),this.calculateBreadcrumbItemsWidth(),this.visibleItems=0,this.adjustOverflow()}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{if(this.firstRender){this.firstRender=!1;return}this.adjustOverflow()}),this.resizeObserver.observe(this)}adjustOverflow(){}disconnectedCallback(){this.resizeObserver?.unobserve(this),super.disconnectedCallback()}render(){return r`
    ...
    `}};St.styles=[xt],u([m(`slot`)],St.prototype,`defaultSlot`,void 0),u([m(`slot[name="separator"]`)],St.prototype,`separatorSlot`,void 0),u([ue({selector:`craft-breadcrumb-item`})],St.prototype,`breadcrumbsElements`,void 0),u([d()],St.prototype,`label`,void 0),u([f()],St.prototype,`items`,void 0),u([f()],St.prototype,`visibleItems`,void 0),customElements.get(`craft-breadcrumbs`)||customElements.define(`craft-breadcrumbs`,St);var Ct=a`
  :host {
...
`,Et=class extends Ie(re(l)){static get properties(){return{invokerRelation:{type:String,attribute:`invoker-relation`}}}static get styles(){return[...super.styles,a`
        :host {
      ...
      `]}constructor(){super(),this.hasArrow=!1,this.invokerRelation=`description`}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];_defineOverlayConfig(){let e=super._defineOverlayConfig(),t=Re({invokerRelation:this.invokerRelation});return{...e,...t,popperConfig:{...e.popperConfig||{},...t.popperConfig||{},modifiers:[...e.popperConfig?.modifiers||[],...t.popperConfig?.modifiers||[]]}}}},Dt=new WeakMap,Ot=new WeakMap,kt=new WeakSet,At=class extends Et{constructor(){super(),g(this,kt),this.placement=`top`,this.trigger=`hover focus`,_(this,Dt,null),_(this,Ot,()=>{this.opened=!this.opened}),ie(this)}static get styles(){return[...super.styles,a`
        :host {
          display: contents;
        }
      ...
      `]}connectedCallback(){h(kt,this,jt).call(this),super.connectedCallback()}get _overlayInvokerNode(){if(this.for){let e=this.getRootNode();return typeof e.getElementById==`function`?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}_defineOverlayConfig(){let e={...super._defineOverlayConfig()};if(Mt.call(h(kt,this))||Nt.call(h(kt,this)))delete e.visibilityTriggerFunction;else{let{visibilityTriggerFunction:t}=Re({invokerRelation:this.invokerRelation,delayIn:200,delayOut:0});e.visibilityTriggerFunction=t}return{...e,popperConfig:{...e.popperConfig,strategy:`fixed`,placement:this.placement,modifiers:[...e.popperConfig?.modifiers??[],...E()]}}}_setupOpenCloseListeners(){super._setupOpenCloseListeners(),Mt.call(h(kt,this))&&this._overlayInvokerNode?.addEventListener(`click`,v(Ot,this))}_teardownOpenCloseListeners(){super._teardownOpenCloseListeners(),this._overlayInvokerNode?.removeEventListener(`click`,v(Ot,this))}updated(e){super.updated(e),e.has(`for`)&&e.get(`for`)!==void 0&&this._overlayCtrl&&this._overlayCtrl.updateConfig({invokerNode:this._overlayInvokerNode})}async show(){this.opened=!0,await this.updateComplete}async hide(){this.opened=!1,await this.updateComplete}};function jt(){if(v(Dt,this)?.isConnected)return;let e=document.createElement(`div`);e.slot=`content`,e.append(...Array.from(this.childNodes).filter(e=>!(e instanceof Element)||e.slot===``)),this.append(e),y(Dt,this,e)}function Mt(){return this.trigger.split(` `).includes(`click`)}function Nt(){return this.trigger.split(` `).includes(`manual`)}u([d({reflect:!0})],At.prototype,`for`,void 0),u([d({reflect:!0})],At.prototype,`placement`,void 0),u([d({reflect:!0})],At.prototype,`trigger`,void 0),customElements.get(`craft-tooltip`)||customElements.define(`craft-tooltip`,At);var Pt=e=>e.key===` `||e.key===`Enter`,Ft=e=>e.key===` `,It=class extends be(l){static get properties(){return{active:{type:Boolean,reflect:!0},type:{type:String,reflect:!0}}}render(){return r` <div class="button-content"><slot></slot></div> `}static get styles(){return[a`
        :host {
          position: relative;
          display: inline-flex;
          box-sizing: border-box;
  ...
  `,e}var Bt=class extends Lt{get _nativeButtonNode(){return Rt.get(this._form)?.helper||null}constructor(){super(),this.type=`submit`,this.__implicitSubmitHelperButton=null}_setupSubmitAndResetHelperOnConnected(){if(super._setupSubmitAndResetHelperOnConnected(),!this._form||this.type!==`submit`)return;let e=this._form;if(!Rt.get(this._form)){let t=zt(),n=document.createElement(`div`);n.appendChild(t),Rt.set(this._form,{lionButtons:new Set,helper:t,observer:new MutationObserver(()=>{e.appendChild(n)})}),e.appendChild(n),Rt.get(e)?.observer.observe(n,{childList:!0})}Rt.get(e)?.lionButtons.add(this)}_teardownSubmitAndResetHelperOnDisconnected(){if(super._teardownSubmitAndResetHelperOnDisconnected(),this._form){let e=Rt.get(this._form);e&&(e.lionButtons.delete(this),e.lionButtons.size||(this._form.contains(e.helper)&&e.helper.remove(),Rt.get(this._form)?.observer.disconnect(),Rt.delete(this._form)))}}},Vt=a`
  :host {
...
`,Ut=new WeakMap,Wt=class extends l{constructor(...e){super(...e),this.label=O(`More Info`),this.icon=`circle-info`,this.disabled=!1,this.status=``,_(this,Ut,new AbortController)}connectedCallback(){super.connectedCallback(),v(Ut,this).signal.aborted&&y(Ut,this,new AbortController),this.id||=`info-icon-${Math.random().toString(36).slice(2,8)}`;let{signal:e}=v(Ut,this);this.addEventListener(`craft-show`,()=>{Gt._&&Gt._!==this&&Gt._.renderRoot.querySelector(`craft-tooltip`)?.hide(),Gt._=this},{signal:e}),this.addEventListener(`craft-after-show`,()=>{this.status=``,setTimeout(()=>{this.status=`Some new status`},200)},{signal:e}),this.addEventListener(`craft-after-hide`,()=>{Gt._===this&&(Gt._=null),this.status=``},{signal:e})}disconnectedCallback(){Gt._===this&&(Gt._=null),v(Ut,this).abort(),super.disconnectedCallback()}render(){return r`
  ...
  `;var Gt={_:null};u([d()],Wt.prototype,`label`,void 0),u([d()],Wt.prototype,`icon`,void 0),u([d({type:Boolean,reflect:!0})],Wt.prototype,`disabled`,void 0),u([d()],Wt.prototype,`id`,void 0),u([f()],Wt.prototype,`status`,void 0),u([m(`craft-tooltip`)],Wt.prototype,`tooltip`,void 0),customElements.get(`craft-info-icon`)||customElements.define(`craft-info-icon`,Wt);var Kt=class extends l{constructor(...e){super(...e),this.debug=!1}render(){return r`<slot></slot>`}};Kt.styles=a`
    :host(:not([debug])) {
      position: absolute;
      width: 1px;
      height: 1px;
  ...
  `,u([d({type:Boolean,reflect:!0})],Kt.prototype,`debug`,void 0),customElements.get(`craft-visually-hidden`)||customElements.define(`craft-visually-hidden`,Kt);var qt=class extends l{constructor(...e){super(...e),this.visible=!0}show(){this.visible=!0,this.dispatchEvent(new CustomEvent(`show`))}hide(){this.visible=!1,this.dispatchEvent(new CustomEvent(`hide`))}focus(){this.wrapper?.focus()}render(){return r`
      <div
        tabindex="-1"
        class="${x({wrapper:!0,hidden:!this.visible})}"
      >
        <div class="spinner"></div>
        <span class="cp-visually-hidden"><slot /></span>
      </div>
    `}};qt.styles=[Tt,Ht],u([d({reflect:!0,type:Boolean})],qt.prototype,`visible`,void 0),u([m(`.wrapper`)],qt.prototype,`wrapper`,void 0),customElements.get(`craft-spinner`)||customElements.define(`craft-spinner`,qt);var Jt=Object.prototype.toString;function Yt(e){return typeof e==`function`||Jt.call(e)===`[object Function]`}function Xt(e){var t=Number(e);return isNaN(t)?0:t===0||!isFinite(t)?t:(t>0?1:-1)*Math.floor(Math.abs(t))}var Zt=2**53-1;function Qt(e){var t=Xt(e);return Math.min(Math.max(t,0),Zt)}function $t(e,t){var n=Array,r=Object(e);if(e==null)throw TypeError(`Array.from requires an array-like object - not null or undefined`);if(t!==void 0&&!Yt(t))throw TypeError(`Array.from: when provided, the second argument must be a function`);for(var i=Qt(r.length),a=Yt(n)?Object(new n(i)):Array(i),o=0,s;o<i;)s=r[o],t?a[o]=t(s,o):a[o]=s,o+=1;return a.length=i,a}function en(e){"@babel/helpers - typeof";return en=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},en(e)}function tn(e,t){if(!(e instanceof t))throw TypeError(`Cannot call a class as a function`)}function nn(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,`value`in r&&(r.writable=!0),Object.defineProperty(e,on(r.key),r)}}function rn(e,t,n){return t&&nn(e.prototype,t),n&&nn(e,n),Object.defineProperty(e,"prototype",{writable:!1}),e}function an(e,t,n){return t=on(t),t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function on(e){var t=sn(e,`string`);return en(t)==`symbol`?t:t+``}function sn(e,t){if(en(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(en(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}var cn=typeof Set>`u`?Set:function(){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[];tn(this,e),an(this,`items`,void 0),this.items=t}return rn(e,[{key:`add`,value:function(e){return this.has(e)===!1&&this.items.push(e),this}},{key:`clear`,value:function(){this.items=[]}},{key:`delete`,value:function(e){var t=this.items.length;return this.items=this.items.filter(function(t){return t!==e}),t!==this.items.length}},{key:`forEach`,value:function(e){var t=this;this.items.forEach(function(n){e(n,n,t)})}},{key:`has`,value:function(e){return this.items.indexOf(e)!==-1}},{key:`size`,get:function(){return this.items.length}}])}();function ln(e){return e.localName??e.tagName.toLowerCase()}var un={article:`article`,aside:`complementary`,button:`button`,datalist:`listbox`,dd:`definition`,details:`group`,dialog:`dialog`,dt:`term`,fieldset:`group`,figure:`figure`,form:`form`,footer:`contentinfo`,h1:`heading`,h2:`heading`,h3:`heading`,h4:`heading`,h5:`heading`,h6:`heading`,header:`banner`,hr:`separator`,html:`document`,legend:`legend`,li:`listitem`,math:`math`,main:`main`,menu:`list`,nav:`navigation`,ol:`list`,optgroup:`group`,option:`option`,output:`status`,progress:`progressbar`,section:`region`,summary:`button`,table:`table`,tbody:`rowgroup`,textarea:`textbox`,tfoot:`rowgroup`,td:`cell`,th:`columnheader`,thead:`rowgroup`,tr:`row`,ul:`list`},dn={caption:new Set([`aria-label`,`aria-labelledby`]),code:new Set([`aria-label`,`aria-labelledby`]),deletion:new Set([`aria-label`,`aria-labelledby`]),emphasis:new Set([`aria-label`,`aria-labelledby`]),generic:new Set([`aria-label`,`aria-labelledby`,`aria-roledescription`]),insertion:new Set([`aria-label`,`aria-labelledby`]),none:new Set([`aria-label`,`aria-labelledby`]),paragraph:new Set([`aria-label`,`aria-labelledby`]),presentation:new Set([`aria-label`,`aria-labelledby`]),strong:new Set([`aria-label`,`aria-labelledby`]),subscript:new Set([`aria-label`,`aria-labelledby`]),superscript:new Set([`aria-label`,`aria-labelledby`])};function fn(e,t){return[`aria-atomic`,`aria-busy`,`aria-controls`,`aria-current`,`aria-description`,`aria-describedby`,`aria-details`,`aria-dropeffect`,`aria-flowto`,`aria-grabbed`,`aria-hidden`,`aria-keyshortcuts`,`aria-label`,`aria-labelledby`,`aria-live`,`aria-owns`,`aria-relevant`,`aria-roledescription`].some(function(n){var r;return e.hasAttribute(n)&&!((r=dn[t])!=null&&r.has(n))})}function pn(e,t){return fn(e,t)}function mn(e){var t=gn(e);if(t===null||_n.indexOf(t)!==-1){var n=hn(e);if(_n.indexOf(t||``)===-1||pn(e,n||``))return n}return t}function hn(e){var t=un[ln(e)];if(t!==void 0)return t;switch(ln(e)){case`a`:case`area`:case`link`:if(e.hasAttribute(`href`))return`link`;break;case`img`:return e.getAttribute(`alt`)===``&&!pn(e,`img`)?`presentation`:`img`;case`input`:var n=e.type;switch(n){case`button`:case`image`:case`reset`:case`submit`:return`button`;case`checkbox`:case`radio`:return n;case`range`:return`slider`;case`email`:case`tel`:case`text`:case`url`:return e.hasAttribute(`list`)?`combobox`:`textbox`;case`search`:return e.hasAttribute(`list`)?`combobox`:`searchbox`;case`number`:return`spinbutton`;default:return null}case`select`:return e.hasAttribute(`multiple`)||e.size>1?`listbox`:`combobox`}return null}function gn(e){var t=e.getAttribute(`role`);if(t!==null){var n=t.trim().split(` `)[0];if(n.length>0)return n}return null}var _n=[`presentation`,`none`];function j(e){return e!==null&&e.nodeType===e.ELEMENT_NODE}function vn(e){return j(e)&&ln(e)===`caption`}function yn(e){return j(e)&&ln(e)===`input`}function bn(e){return j(e)&&ln(e)===`optgroup`}function xn(e){return j(e)&&ln(e)===`select`}function Sn(e){return j(e)&&ln(e)===`table`}function Cn(e){return j(e)&&ln(e)===`textarea`}function wn(e){var t=(e.ownerDocument===null?e:e.ownerDocument).defaultView;if(t===null)throw TypeError(`no window available`);return t}function Tn(e){return j(e)&&ln(e)===`fieldset`}function En(e){return j(e)&&ln(e)===`legend`}function Dn(e){return j(e)&&ln(e)===`slot`}function On(e){return j(e)&&e.ownerSVGElement!==void 0}function kn(e){return j(e)&&ln(e)===`svg`}function An(e){return On(e)&&ln(e)===`title`}function jn(e,t){if(j(e)&&e.hasAttribute(t)){var n=e.getAttribute(t).split(` `),r=e.getRootNode?e.getRootNode():e.ownerDocument;return n.map(function(e){return r.getElementById(e)}).filter(function(e){return e!==null})}return[]}function Mn(e,t){return j(e)?t.indexOf(mn(e))!==-1:!1}function Nn(e){return e.trim().replace(/\s\s+/g,` `)}function Pn(e,t){if(!j(e))return!1;if(e.hasAttribute(`hidden`)||e.getAttribute(`aria-hidden`)===`true`)return!0;var n=t(e);return n.getPropertyValue(`display`)===`none`||n.getPropertyValue(`visibility`)===`hidden`}function Fn(e){return Mn(e,[`button`,`combobox`,`listbox`,`textbox`])||In(e,`range`)}function In(e,t){if(!j(e))return!1;switch(t){case`range`:return Mn(e,[`meter`,`progressbar`,`scrollbar`,`slider`,`spinbutton`]);default:throw TypeError(`No knowledge about abstract role '${t}'. This is likely a bug :(`)}}function Ln(e,t){var n=$t(e.querySelectorAll(t));return jn(e,`aria-owns`).forEach(function(e){n.push.apply(n,$t(e.querySelectorAll(t)))}),n}function Rn(e){return xn(e)?e.selectedOptions||Ln(e,`[selected]`):Ln(e,`[aria-selected="true"]`)}function zn(e){return Mn(e,_n)}function Bn(e){return vn(e)}function Vn(e){return Mn(e,[`button`,`cell`,`checkbox`,`columnheader`,`gridcell`,`heading`,`label`,`legend`,`link`,`menuitem`,`menuitemcheckbox`,`menuitemradio`,`option`,`radio`,`row`,`rowheader`,`switch`,`tab`,`tooltip`,`treeitem`])}function Hn(e){return!1}function Un(e){return yn(e)||Cn(e)?e.value:e.textContent||``}function Wn(e){var t=e.getPropertyValue(`content`);return/^["'].*["']$/.test(t)?t.slice(1,-1):``}function Gn(e){var t=ln(e);return t===`button`||t===`input`&&e.getAttribute(`type`)!==`hidden`||t===`meter`||t===`output`||t===`progress`||t===`select`||t===`textarea`}function Kn(e){if(Gn(e))return e;var t=null;return e.childNodes.forEach(function(e){if(t===null&&j(e)){var n=Kn(e);n!==null&&(t=n)}}),t}function qn(e){if(e.control!==void 0)return e.control;var t=e.getAttribute(`for`);return t===null?Kn(e):e.ownerDocument.getElementById(t)}function Jn(e){var t=e.labels;if(t===null)return t;if(t!==void 0)return $t(t);if(!Gn(e))return null;var n=e.ownerDocument;return $t(n.querySelectorAll(`label`)).filter(function(t){return qn(t)===e})}function Yn(e){var t=e.assignedNodes();return t.length===0?$t(e.childNodes):t}function Xn(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=new cn,r=typeof Map>`u`?void 0:new Map,i=wn(e),a=t.compute,o=a===void 0?`name`:a,s=t.computedStyleSupportsPseudoElements,c=s===void 0?t.getComputedStyle!==void 0:s,l=t.getComputedStyle,u=l===void 0?i.getComputedStyle.bind(i):l,d=t.hidden,f=d!==void 0&&d,p=function(e,t){if(t!==void 0)throw Error(`use uncachedGetComputedStyle directly for pseudo elements`);if(r===void 0)return u(e);var n=r.get(e);if(n)return n;var i=u(e,t);return r.set(e,i),i};function m(e,t){var n=``;if(j(e)&&c&&(n=`${Wn(u(e,`::before`))} ${n}`),(Dn(e)?Yn(e):$t(e.childNodes).concat(jn(e,`aria-owns`))).forEach(function(e){var r=v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0}),i=(j(e)?p(e).getPropertyValue(`display`):`inline`)===`inline`?``:` `;n+=`${i}${r}${i}`}),j(e)&&c){var r=Wn(u(e,`::after`));n=`${n} ${r}`}return n.trim()}function h(e,t){var r=e.getAttributeNode(t);return r!==null&&!n.has(r)&&r.value.trim()!==``?(n.add(r),r.value):null}function g(e){return j(e)?h(e,`title`):null}function _(e){if(!j(e))return null;if(Tn(e)){n.add(e);for(var t=$t(e.childNodes),r=0;r<t.length;r+=1){var i=t[r];if(En(i))return v(i,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(Sn(e)){n.add(e);for(var a=$t(e.childNodes),o=0;o<a.length;o+=1){var s=a[o];if(vn(s))return v(s,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(kn(e)){n.add(e);for(var c=$t(e.childNodes),l=0;l<c.length;l+=1){var u=c[l];if(An(u))return u.textContent}return null}else if(ln(e)===`img`||ln(e)===`area`){var d=h(e,`alt`);if(d!==null)return d}else if(bn(e)){var f=h(e,`label`);if(f!==null)return f}if(yn(e)&&(e.type===`button`||e.type===`submit`||e.type===`reset`)){var p=h(e,`value`);if(p!==null)return p;if(e.type===`submit`)return`Submit`;if(e.type===`reset`)return`Reset`}var g=Jn(e);if(g!==null&&g.length!==0)return n.add(e),$t(g).map(function(e){return v(e,{isEmbeddedInLabel:!0,isReferenced:!1,recursion:!0})}).filter(function(e){return e.length>0}).join(` `);if(yn(e)&&e.type===`image`){var _=h(e,`alt`);if(_!==null)return _;var y=h(e,`title`);return y===null?`Submit Query`:y}if(Mn(e,[`button`])){var b=m(e,{isEmbeddedInLabel:!1,isReferenced:!1});if(b!==``)return b}return null}function v(e,t){if(n.has(e))return``;if(!f&&Pn(e,p)&&!t.isReferenced)return n.add(e),``;var r=j(e)?e.getAttributeNode(`aria-labelledby`):null,i=r!==null&&!n.has(r)?jn(e,`aria-labelledby`):[];if(o===`name`&&!t.isReferenced&&i.length>0)return n.add(r),i.map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!0,recursion:!1})}).join(` `);var a=t.recursion&&Fn(e)&&o===`name`;if(!a){var s=(j(e)&&e.getAttribute(`aria-label`)||``).trim();if(s!==``&&o===`name`)return n.add(e),s;if(!zn(e)){var c=_(e);if(c!==null)return n.add(e),c}}if(Mn(e,[`menu`]))return n.add(e),``;if(a||t.isEmbeddedInLabel||t.isReferenced){if(Mn(e,[`combobox`,`listbox`])){n.add(e);var l=Rn(e);return l.length===0?yn(e)?e.value:``:$t(l).map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0})}).join(` `)}if(In(e,`range`))return n.add(e),e.hasAttribute(`aria-valuetext`)?e.getAttribute(`aria-valuetext`):e.hasAttribute(`aria-valuenow`)?e.getAttribute(`aria-valuenow`):e.getAttribute(`value`)||``;if(Mn(e,[`textbox`]))return n.add(e),Un(e)}if(Vn(e)||j(e)&&t.isReferenced||Bn(e)||Hn(e)){var u=m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});if(u!==``)return n.add(e),u}if(e.nodeType===e.TEXT_NODE)return n.add(e),e.textContent||``;if(t.recursion)return n.add(e),m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});var d=g(e);return d===null?(n.add(e),``):(n.add(e),d)}return Nn(v(e,{isEmbeddedInLabel:!1,isReferenced:o===`description`,recursion:!1}))}function Zn(e){return Mn(e,[`caption`,`code`,`deletion`,`emphasis`,`generic`,`insertion`,`none`,`paragraph`,`presentation`,`strong`,`subscript`,`superscript`])}function Qn(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return Zn(e)?``:Xn(e,t)}var $n={Primary:`primary`,Danger:`danger`,DangerPlain:`danger-plain`,Solid:`solid`,Fill:`fill`,Outline:`outline`,Dashed:`dashed`,Plain:`plain`,Link:`link`,None:`none`},er=new WeakMap,tr=new WeakMap,nr=new WeakSet,rr=new WeakMap,M=class extends Bt{static get styles(){return[...super.styles,Tt,Vt]}constructor(){super(),g(this,nr),_(this,er,async e=>{let t=fe(this.action);if(!(!t||this.disabled)){e.preventDefault(),t.type===`http`&&(this.loading=!0);try{await pe(t,{trigger:this,sourceEvent:e})}finally{this.loading=!1}}}),_(this,tr,e=>{!this.toggle||this.disabled||this.loading||this.dispatchEvent(new CustomEvent(`craft-toggle`,{bubbles:!0,composed:!0,cancelable:!0,detail:{active:!this.active,sourceEvent:e}}))}),this.variant=$n.Fill,this.inherit=!1,this.size=`medium`,this.active=!1,this.toggle=!1,this.loading=!1,this.align=`center`,this.icon=null,this.action=null,this.href=null,this.target=null,this.rel=null,this.download=null,this.iconPosition=`prefix`,this._hasAccessibilityError=!1,_(this,rr,null),this.linkHostStateApplied=!1,this.originalType=null,this.announcementTimer=null,this.type=`button`}connectedCallback(){this.href&&!this.disabled&&(this.originalType=this.type,this.type=`button`,this.setAttribute(`role`,`presentation`),this.linkHostStateApplied=!0),super.connectedCallback(),this.syncLinkHostState(),this.addEventListener(`click`,v(er,this)),this.addEventListener(`click`,v(tr,this)),this.hasUpdated&&!this.accessibleName&&h(nr,this,ir).call(this)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,v(er,this)),this.removeEventListener(`click`,v(tr,this)),h(nr,this,sr).call(this),this.announcementTimer&&=(clearTimeout(this.announcementTimer),null)}updated(e){super.updated(e),(e.has(`href`)||e.has(`disabled`))&&this.syncLinkHostState(),this.toggle&&(e.has(`active`)||e.has(`toggle`))&&this.setAttribute(`aria-pressed`,String(this.active)),e.has(`loading`)&&this.loading&&this.announceLoading()}announceLoading(){this.liveRegion.textContent=O(`Loading`),this.announcementTimer&&clearTimeout(this.announcementTimer),this.announcementTimer=setTimeout(()=>{this.liveRegion.textContent=``},5e3)}syncLinkHostState(){this.isLink?(this.linkHostStateApplied||(this.originalType=this.type),this.setAttribute(`role`,`presentation`),this.tabIndex=-1,this.type=`button`,this.linkHostStateApplied=!0):this.linkHostStateApplied&&=(this.setAttribute(`role`,`button`),this.type=this.originalType??`button`,this.disabled||(this.tabIndex=0),!1)}async firstUpdated(e){super.firstUpdated(e),await this.updateComplete;let t=this.querySelectorAll(`craft-icon, craft-spinner`);await Promise.all(Array.from(t).map(e=>e.updateComplete)),h(nr,this,ir).call(this)}get isLink(){return!!this.href&&!this.disabled}get computedRel(){if(this.target===`_blank`){let e=new Set((this.rel??``).split(/\s+/).filter(Boolean));return e.add(`noopener`),Array.from(e).join(` `)}return this.rel}render(){let e=r`
      <div
        class="${x({"button-content":!0,"button-content--start":this.align===`start`,"button-content--end":this.align===`end`,"a11y-error":this._hasAccessibilityError})}"
        part="content"
      >
    ...
    `;return this.isLink?r`
        <a
          ...
          >${e}</a
        >
      `:e}};function ir(){if(!this.accessibleName){let e=this.isLink?this.shadowRoot?.querySelector(`a.link`)??this:this;this.accessibleName=Qn(e)}let e=!this.accessibleName||this.accessibleName.trim()===``;if(e&&!h(nr,this,ar).call(this)){h(nr,this,or).call(this);return}this._hasAccessibilityError=e}function ar(){return typeof this.checkVisibility==`function`?this.checkVisibility({visibilityProperty:!0}):this.getClientRects().length>0}function or(){v(rr,this)||typeof ResizeObserver>`u`||(y(rr,this,new ResizeObserver(()=>{h(nr,this,ar).call(this)&&(h(nr,this,sr).call(this),h(nr,this,ir).call(this))})),v(rr,this).observe(this))}function sr(){v(rr,this)?.disconnect(),y(rr,this,null)}u([d({attribute:`accessible-name`})],M.prototype,`accessibleName`,void 0),u([d({reflect:!0})],M.prototype,`variant`,void 0),u([d({reflect:!0,type:Boolean})],M.prototype,`inherit`,void 0),u([d({reflect:!0})],M.prototype,`size`,void 0),u([d({reflect:!0})],M.prototype,`value`,void 0),u([d({reflect:!0,type:Boolean})],M.prototype,`active`,void 0),u([d({type:Boolean,reflect:!0})],M.prototype,`toggle`,void 0),u([d({reflect:!0,type:Boolean})],M.prototype,`loading`,void 0),u([d()],M.prototype,`align`,void 0),u([d()],M.prototype,`icon`,void 0),u([d({type:Object})],M.prototype,`action`,void 0),u([d({reflect:!0})],M.prototype,`href`,void 0),u([d()],M.prototype,`target`,void 0),u([d()],M.prototype,`rel`,void 0),u([d()],M.prototype,`download`,void 0),u([d({attribute:`icon-position`})],M.prototype,`iconPosition`,void 0),u([m(`[data-live-region]`)],M.prototype,`liveRegion`,void 0),u([f()],M.prototype,`_hasAccessibilityError`,void 0),customElements.get(`craft-button`)||customElements.define(`craft-button`,M);var cr=[`sm`,`md`,`lg`,`xl`];function lr(e){return!isNaN(parseFloat(String(e)))&&isFinite(Number(e))}function ur(e){if(e!=null&&e!==``)return e===0||e===`0`||e===`none`?`0`:lr(e)?`calc(${e}rem / 16)`:cr.includes(e)?`var(--c-spacing-${e})`:String(e)}var dr=(e,{customProperty:t,defaultValue:n})=>{let r=Array.isArray(t)?t:[t];class i extends e{constructor(...e){super(...e),this.padding=n}get resolvedPadding(){return ur(this.padding)}get paddingStyles(){let e=this.resolvedPadding;return e===void 0?{}:Object.fromEntries(r.map(t=>[t,e]))}}return u([d()],i.prototype,`padding`,void 0),i},fr=a`
  :host {
    display: contents;
  }
...
`,pr=class extends dr(l,{customProperty:[`--_callout-padding-block`,`--_callout-padding-inline`]}){constructor(...e){super(...e),this.variant=he.Neutral,this.appearance=ae.OutlineFill,this.title=``,this.icon=null,this.hideIcon=!1,this.rounded=`all`,this.inline=!1,this.size=`auto`,this.resolvedIcon=null}willUpdate(){this.resolvedIcon=this.icon??this.getDefaultIcon()}getDefaultIcon(){switch(this.variant){case he.Info:return`lightbulb`;case he.Success:return`circle-check`;case he.Warning:return`circle-exclamation`;case he.Danger:return`triangle-exclamation`;default:return null}}render(){let e=this.title||!!this.querySelector(`[slot="title"]`),t=!this.hideIcon&&(!!this.resolvedIcon||!!this.querySelector(`[slot="icon"]`));return r`
      <div
        data-variant="${this.variant}"
        style="${ne(this.paddingStyles)}"
        class="${x({callout:!0,"callout--hide-icon":!t,"callout--title":e,"callout--small":this.size===`small`})}"
      >
    ...
    `}};pr.styles=[le,fr],u([d({reflect:!0})],pr.prototype,`variant`,void 0),u([d({reflect:!0})],pr.prototype,`appearance`,void 0),u([d()],pr.prototype,`title`,void 0),u([d()],pr.prototype,`icon`,void 0),u([d({type:Boolean,attribute:`hide-icon`})],pr.prototype,`hideIcon`,void 0),u([d({reflect:!0})],pr.prototype,`rounded`,void 0),u([d({reflect:!0,type:Boolean})],pr.prototype,`inline`,void 0),u([d()],pr.prototype,`size`,void 0),u([f()],pr.prototype,`resolvedIcon`,void 0),customElements.get(`craft-callout`)||customElements.define(`craft-callout`,pr);var mr=a`
  :host {
    display: block;
  }
...
`,hr=class extends l{constructor(...e){super(...e),this.label=``,this.active=!1,this.collapsed=!1,this.showThumb=!0,this.thumbAlignment=`start`,this._hasThumbnail=!1,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasSlottedHeader=!!this.querySelector(`:scope > [slot="header"]`)||!!this.querySelector(`:scope > [slot="label"]`)||!!this.querySelector(`:scope > [slot="actions"]`),this._hasSlottedFooter=!!this.querySelector(`:scope > [slot="footer"]`),this._hasThumbnail=!!this.querySelector(`:scope > [slot="thumbnail"]`)}_handleThumbnailSlotChange(e){let t=e.target;this._hasThumbnail=t.assignedElements({flatten:!0}).length>0}render(){let e=!!this.label||this._hasSlottedHeader,t=this._hasSlottedFooter,n=this.showThumb&&this._hasThumbnail;return r`
      ...
      >
        ...
        <div
          class="${x({"card-body":!0,"card-body--thumb-start":n&&this.thumbAlignment===`start`,"card-body--thumb-end":n&&this.thumbAlignment===`end`})}"
        >
    ...
    `}};hr.styles=[mr],u([d()],hr.prototype,`label`,void 0),u([d({type:Boolean,reflect:!0})],hr.prototype,`active`,void 0),u([d({type:Boolean,reflect:!0})],hr.prototype,`collapsed`,void 0),u([d({attribute:`show-thumb`,type:Boolean})],hr.prototype,`showThumb`,void 0),u([d({attribute:`thumb-alignment`})],hr.prototype,`thumbAlignment`,void 0),u([f()],hr.prototype,`_hasThumbnail`,void 0),u([f()],hr.prototype,`_hasSlottedHeader`,void 0),u([f()],hr.prototype,`_hasSlottedFooter`,void 0),customElements.get(`craft-card`)||customElements.define(`craft-card`,hr);var gr=a`
...
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=li()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return li()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(i(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),di=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function fi(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return di.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var pi=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},mi=T(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),hi=T(e=>class extends mi(ye(Pe(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=Fe(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...fi(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return r`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof pi&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&(typeof t!=`boolean`||t!==!1)}static get styles(){return[a`
          /**********************
            {block} .form-field
           ********************/
    ...
    `}_onRequestToAddFormElement(e){e.target.hasAttribute(`role`)||e.target?.setAttribute(`role`,`listitem`),this.__addToSubCheckboxes(e.detail.element),this._setOwnCheckedState()}_onRequestToRemoveFormElement(e){e.target.getAttribute(`role`)===`listitem`&&e.target?.removeAttribute(`role`),this.__removeFromSubCheckboxes(e.detail.element)}__addToSubCheckboxes(e){e!==this&&this.contains(e)&&this.__subCheckboxes.push(e)}__removeFromSubCheckboxes(e){let t=this.__subCheckboxes.indexOf(e);t!==-1&&this.__subCheckboxes.splice(t,1)}constructor(){super(),this.indeterminate=!1,this._onRequestToAddFormElement=this._onRequestToAddFormElement.bind(this),this.__onModelValueChanged=this.__onModelValueChanged.bind(this),this.__subCheckboxes=[],this._indeterminateSubStates=[],this.mixedState=!1}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,this.__onModelValueChanged),this.addEventListener(`form-element-register`,this._onRequestToAddFormElement)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`model-value-changed`,this.__onModelValueChanged),this.removeEventListener(`form-element-register`,this._onRequestToAddFormElement)}firstUpdated(e){super.firstUpdated(e),this._setOldState(),this.indeterminate&&this._storeIndeterminateState()}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&(this._inputNode.indeterminate=this.indeterminate)}},Hi=class extends Ri{constructor(...e){super(...e),this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="checkbox"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...Ri.styles,a`
      ...
      `]}};function Ki(){let e=this.allMode===`single-value`&&this.checked;for(let t of this._subCheckboxes??[]){let n=t.querySelector(`:scope > input[slot="input"]`);n&&(e?n.name&&(n.dataset.governedName=n.name,n.removeAttribute(`name`)):n.dataset.governedName&&(n.name=n.dataset.governedName,delete n.dataset.governedName))}}u([d({reflect:!0,attribute:`all-mode`})],Gi.prototype,`allMode`,void 0),customElements.get(`craft-checkbox-indeterminate`)||customElements.define(`craft-checkbox-indeterminate`,Gi);var qi=class extends Ui(Bi){constructor(...e){super(...e),this.__inputPatched=!1,this.indeterminate=!1}connectedCallback(){super.connectedCallback(),this.__patchSlottedInputProps()}updated(e){super.updated(e),this.__patchSlottedInputProps();let t=this._inputNode;t&&(t.indeterminate=this.indeterminate)}__patchSlottedInputProps(){if(this.__inputPatched)return;let e=this.__slottedInputElement();if(!e)return;this.__inputPatched=!0;let t=this;for(let n of[`checked`,`disabled`]){let r=Object.getOwnPropertyDescriptor(HTMLInputElement.prototype,n);if(!r?.get||!r.set)continue;let{get:i,set:a}=r;Object.defineProperty(e,n,{configurable:!0,enumerable:r.enumerable,get(){return i.call(this)},set(e){a.call(this,e),t[n]!==e&&(t[n]=e)}})}}__slottedInputElement(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`input`)}static get styles(){return[...Bi.styles,xr,a`
      ...
      `]}};u([d({type:Boolean,reflect:!0})],qi.prototype,`indeterminate`,void 0),customElements.get(`craft-checkbox`)||customElements.define(`craft-checkbox`,qi);var Ji=new Map;async function Yi(e,t,n=!1){let r=[],i=[],a=()=>{for(let e of r)e.remove();i.forEach(e=>e())};if(!e)return a;let o=document.createElement(`template`);o.innerHTML=e.trim();try{for(let e of o.content.childNodes){let a=Zi(e);if(a){let e=Ji.get(a.key);if(e){e.references++,i.push(()=>ta(a.key,e)),e.loaded&&await ea(e.loaded,n);continue}if(Qi(a))continue}let o=Xi(e),s=a&&o instanceof HTMLScriptElement?$i(o,a.value):null;if(t.appendChild(o),a&&(o instanceof HTMLLinkElement||o instanceof HTMLScriptElement)){let e={node:o,loaded:s,references:1};Ji.set(a.key,e),i.push(()=>ta(a.key,e))}else r.push(o);s&&await ea(s,n)}return a}catch(e){throw a(),e}}function Xi(e){if(!(e instanceof HTMLScriptElement))return e.cloneNode(!0);let t=document.createElement(`script`);for(let n of e.attributes)t.setAttribute(n.name,n.value);return t.textContent=e.textContent,t.async=!1,t}function Zi(e){return e instanceof HTMLLinkElement&&e.href?{key:`link:${e.href}`,selector:`link[href]`,value:e.href}:e instanceof HTMLScriptElement&&e.src?{key:`script:${e.src}`,selector:`script[src]`,value:e.src}:null}function Qi(e){return Array.from(document.querySelectorAll(e.selector)).some(t=>(t instanceof HTMLLinkElement?t.href:t.src)===e.value)}function $i(e,t){return new Promise((n,r)=>{e.addEventListener(`load`,()=>n(),{once:!0}),e.addEventListener(`error`,()=>r(Error(`Failed to load asset [${t}].`)),{once:!0})})}async function ea(e,t){try{await e}catch(e){if(t)throw e}}function ta(e,t){t.references--,!(t.references>0)&&(t.node.remove(),Ji.delete(e))}async function na(e){return Yi(e,document.head)}async function ra(e){return Yi(e,document.body)}function ia(e){return typeof e.checkVisibility==`function`?e.checkVisibility({checkOpacity:!0,checkVisibilityCSS:!0}):e.offsetWidth>0||e.offsetHeight>0}function aa(e){return typeof e==`object`&&!!e&&`checked`in e&&typeof e.checked==`boolean`}function oa(e){return sa(e).toString()}function sa(e){let t=new URLSearchParams,n=e.querySelectorAll(`input[name], select[name], textarea[name]`);for(let e of n)if(!e.disabled&&!(e instanceof HTMLInputElement&&([`file`,`submit`,`button`,`reset`,`image`].includes(e.type)||(e.type===`checkbox`||e.type===`radio`)&&!e.checked))){if(e instanceof HTMLSelectElement&&e.multiple){for(let n of e.selectedOptions)t.append(e.name,n.value);continue}t.append(e.name,e.value)}for(let n of e.querySelectorAll(`*`)){if(!n.tagName.includes(`-`))continue;let e=n.name;if(typeof e!=`string`||e===``||n.disabled===!0||n.querySelector(`input[name], select[name], textarea[name]`))continue;if(aa(n.modelValue)){n.modelValue.checked&&t.append(e,String(n.modelValue.value??``));continue}let r=n.serializedValue??n.value;if(r!=null)if(Array.isArray(r))for(let n of r)t.append(e,String(n));else t.append(e,String(r))}return t}var ca={Á:`A`,á:`a`,Ä:`A`,ä:`a`,À:`A`,à:`a`,Â:`A`,â:`a`,É:`E`,é:`e`,Ë:`E`,ë:`e`,È:`E`,è:`e`,Ê:`E`,ê:`e`,Í:`I`,í:`i`,Ï:`I`,ï:`i`,Ì:`I`,ì:`i`,Î:`I`,î:`i`,Ó:`O`,ó:`o`,Ö:`O`,ö:`o`,Ò:`O`,ò:`o`,Ô:`O`,ô:`o`,Ú:`U`,ú:`u`,Ü:`U`,ü:`u`,Ù:`U`,ù:`u`,Û:`U`,û:`u`,Ý:`Y`,ý:`y`,Ÿ:`Y`,А:`A`,Б:`B`,В:`V`,Г:`G`,Д:`D`,Ѓ:`Gj`,Е:`E`,Ж:`Z`,З:`Z`,Ѕ:`Dz`,И:`I`,Ј:`j`,К:`K`,Л:`L`,Љ:`Lj`,М:`M`,Н:`N`,Њ:`Nj`,О:`O`,П:`P`,Р:`R`,С:`S`,Т:`T`,Ќ:`Kj`,У:`U`,Ф:`F`,Х:`X`,Ц:`C`,Ч:`C`,Џ:`Dz`,Ш:`S`,а:`a`,б:`b`,в:`v`,г:`g`,д:`d`,ѓ:`gj`,е:`e`,ж:`z`,з:`z`,ѕ:`dz`,и:`i`,ј:`j`,к:`k`,л:`l`,љ:`lj`,м:`m`,н:`n`,њ:`nj`,о:`o`,п:`p`,р:`r`,с:`s`,т:`t`,ќ:`kj`,у:`u`,ф:`f`,х:`x`,ц:`c`,ч:`c`,џ:`dz`,ш:`s`,æ:`ae`,ǽ:`ae`,Ã:`A`,Å:`A`,Ǻ:`A`,Ă:`A`,Ǎ:`A`,Æ:`AE`,Ǽ:`AE`,ã:`a`,å:`a`,ǻ:`a`,ă:`a`,ǎ:`a`,ª:`a`,Ĉ:`C`,Ċ:`C`,Ç:`C`,ç:`c`,ĉ:`c`,ċ:`c`,Ð:`D`,Đ:`D`,ð:`d`,đ:`d`,Ĕ:`E`,Ė:`E`,ĕ:`e`,ė:`e`,ƒ:`f`,Ĝ:`G`,Ġ:`G`,ĝ:`g`,ġ:`g`,Ĥ:`H`,Ħ:`H`,ĥ:`h`,ħ:`h`,Ĩ:`I`,Ĭ:`I`,Ǐ:`I`,Į:`I`,Ĳ:`IJ`,ĩ:`i`,ĭ:`i`,ǐ:`i`,į:`i`,ĳ:`ij`,Ĵ:`J`,ĵ:`j`,Ĺ:`L`,Ľ:`L`,Ŀ:`L`,ĺ:`l`,ľ:`l`,ŀ:`l`,Ñ:`N`,ñ:`n`,ŉ:`n`,Õ:`O`,Ō:`O`,Ŏ:`O`,Ǒ:`O`,Ő:`O`,Ơ:`O`,Ø:`O`,Ǿ:`O`,Œ:`OE`,õ:`o`,ō:`o`,ŏ:`o`,ǒ:`o`,ő:`o`,ơ:`o`,ø:`o`,ǿ:`o`,º:`o`,œ:`oe`,Ŕ:`R`,Ŗ:`R`,ŕ:`r`,ŗ:`r`,Ŝ:`S`,Ș:`S`,ŝ:`s`,ș:`s`,ſ:`s`,Ţ:`T`,Ț:`T`,Ŧ:`T`,Þ:`TH`,ţ:`t`,ț:`t`,ŧ:`t`,þ:`th`,Ũ:`U`,Ŭ:`U`,Ű:`U`,Ų:`U`,Ư:`U`,Ǔ:`U`,Ǖ:`U`,Ǘ:`U`,Ǚ:`U`,Ǜ:`U`,ũ:`u`,ŭ:`u`,ű:`u`,ų:`u`,ư:`u`,ǔ:`u`,ǖ:`u`,ǘ:`u`,ǚ:`u`,ǜ:`u`,Ŵ:`W`,ŵ:`w`,Ŷ:`Y`,ÿ:`y`,ŷ:`y`,ΑΥ:`AU`,ΑΎ:`AU`,Αυ:`Au`,Αύ:`Au`,ΕΊ:`I`,ΕΙ:`I`,Ει:`Ei`,ΕΥ:`EF`,ΕΎ:`EU`,Εί:`I`,Ευ:`Ef`,Εύ:`Eu`,ΟΙ:`I`,ΟΊ:`I`,ΟΥ:`U`,ΟΎ:`OU`,Οι:`Oi`,Οί:`I`,Ου:`Oy`,Ού:`Ou`,ΥΙ:`I`,ΎΙ:`I`,Υι:`Yi`,Ύι:`I`,ΥΊ:`I`,Υί:`I`,αυ:`au`,αύ:`au`,εί:`i`,ει:`ei`,ευ:`ef`,εύ:`eu`,οι:`oi`,οί:`i`,ου:`oy`,ού:`ou`,υι:`yi`,ύι:`i`,υί:`i`,Α:`A`,Ά:`A`,Β:`B`,Δ:`D`,Ε:`E`,Έ:`E`,Φ:`F`,Γ:`G`,Η:`H`,Ή:`I`,Ι:`I`,Ί:`I`,Ϊ:`I`,Κ:`K`,Ξ:`Ks`,Λ:`L`,Μ:`M`,Ν:`N`,Π:`P`,Ο:`O`,Ό:`O`,Ψ:`Ps`,Ρ:`R`,Σ:`S`,Τ:`T`,Θ:`Th`,Ω:`O`,Ώ:`W`,Χ:`X`,ϒ:`Y`,Υ:`Y`,Ύ:`Y`,Ϋ:`Y`,Ζ:`Z`,α:`a`,ά:`a`,β:`v`,δ:`d`,ε:`e`,έ:`e`,φ:`f`,γ:`gh`,η:`i`,ή:`i`,ι:`i`,ί:`i`,ϊ:`i`,ΐ:`i`,κ:`k`,ξ:`ks`,λ:`l`,μ:`m`,ν:`n`,ο:`o`,ό:`o`,π:`p`,ψ:`ps`,ρ:`r`,σ:`s`,ς:`s`,τ:`t`,ϑ:`th`,θ:`th`,ϐ:`v`,ω:`o`,ώ:`w`,χ:`kh`,υ:`i`,ύ:`y`,ΰ:`y`,ϋ:`y`,ζ:`z`,अ:`a`,आ:`aa`,ए:`e`,ई:`ii`,ऍ:`ei`,ऎ:`ae`,ऐ:`ai`,इ:`i`,ओ:`o`,ऑ:`oi`,ऒ:`oii`,ऊ:`uu`,औ:`ou`,उ:`u`,ब:`B`,भ:`Bha`,च:`Ca`,छ:`Chha`,ड:`Da`,ढ:`Dha`,फ:`Fa`,फ़:`Fi`,ग:`Ga`,घ:`Gha`,ग़:`Ghi`,ह:`Ha`,ज:`Ja`,झ:`Jha`,क:`Ka`,ख:`Kha`,ख़:`Khi`,ल:`L`,ळ:`Li`,ऌ:`Li`,ऴ:`Lii`,ॡ:`Lii`,म:`Ma`,न:`Na`,ङ:`Na`,ञ:`Nia`,ण:`Nae`,ऩ:`Ni`,ॐ:`oms`,प:`Pa`,क़:`Qi`,र:`Ra`,ऋ:`Ri`,ॠ:`Ri`,ऱ:`Ri`,स:`Sa`,श:`Sha`,ष:`Shha`,ट:`Ta`,त:`Ta`,ठ:`Tha`,द:`Tha`,थ:`Tha`,ध:`Thha`,ड़:`ugDha`,ढ़:`ugDhha`,व:`Va`,य:`Ya`,य़:`Yi`,ज़:`Za`,Ա:`A`,Բ:`B`,Գ:`G`,Դ:`D`,Ե:`E`,Զ:`Z`,Է:`E`,Ը:`Y`,Թ:`Th`,Ժ:`Zh`,Ի:`I`,Լ:`L`,Խ:`Kh`,Ծ:`Ts`,Կ:`K`,Հ:`H`,Ձ:`Dz`,Ղ:`Gh`,Ճ:`Tch`,Մ:`M`,Յ:`Y`,Ն:`N`,Շ:`Sh`,Ո:`Vo`,Չ:`Ch`,Պ:`P`,Ջ:`J`,Ռ:`R`,Ս:`S`,Վ:`V`,Տ:`T`,Ր:`R`,Ց:`C`,Ւ:`u`,Փ:`Ph`,Ք:`Q`,և:`ev`,Օ:`O`,Ֆ:`F`,ա:`a`,բ:`b`,գ:`g`,դ:`d`,ե:`e`,զ:`z`,է:`e`,ը:`y`,թ:`th`,ժ:`zh`,ի:`i`,լ:`l`,խ:`kh`,ծ:`ts`,կ:`k`,հ:`h`,ձ:`dz`,ղ:`gh`,ճ:`tch`,մ:`m`,յ:`y`,ն:`n`,շ:`sh`,ո:`vo`,չ:`ch`,պ:`p`,ջ:`j`,ռ:`r`,ս:`s`,վ:`v`,տ:`t`,ր:`r`,ց:`c`,ւ:`u`,փ:`ph`,ք:`q`,օ:`o`,ֆ:`f`,Ž:`Z`,Ň:`N`,Ş:`S`,ž:`z`,ň:`n`,ş:`s`,ı:`i`,İ:`I`,ğ:`g`,Ğ:`G`,ьо:`yo`,Й:`i`,Щ:`Shh`,Ъ:`Ie`,Ь:``,Ю:`Iu`,Я:`Ia`,й:`i`,щ:`shh`,ъ:`ie`,ь:``,ю:`iu`,я:`ia`,Ē:`E`,ē:`e`,န်ုပ်:`nub`,"ောင်":`aung`,"ိုက်":`aik`,"ိုဒ်":`ok`,"ိုင်":`aing`,"ိုလ်":`ol`,"ေါင်":`aung`,သြော:`aw`,"ောက်":`auk`,"ိတ်":`eik`,"ုတ်":`ok`,"ုန်":`on`,"ေတ်":`it`,"ုဒ်":`ait`,"ာန်":`an`,"ိန်":`ein`,"ွတ်":`ut`,"ေါ်":`aw`,"ွန်":`un`,"ိပ်":`eik`,"ုပ်":`ok`,"ွပ်":`ut`,"ိမ်":`ein`,"ုမ်":`on`,"ော်":`aw`,"ွမ်":`un`,က်:`et`,"ေါ":`aw`,"ော":`aw`,"ျွ":`ywa`,"ြွ":`yw`,"ို":`o`,"ုံ":`on`,တ်:`at`,င်:`in`,ည်:`i`,ဒ်:`d`,န်:`an`,ပ်:`at`,မ်:`an`,စျ:`za`,ယ်:`e`,ဉ်:`in`,စ်:`it`,"ိံ":`ein`,"ဲ":`e`,"း":``,"ာ":`a`,"ါ":`a`,"ေ":`e`,"ံ":`an`,"ိ":`i`,"ီ":`i`,"ု":`u`,"ူ":`u`,"်":`at`,"္":``,"့":``,က:`k`,"၉":`9`,တ:`t`,ရ:`ya`,ယ:`y`,မ:`m`,ဘ:`ba`,ဗ:`b`,ဖ:`pa`,ပ:`p`,န:`n`,ဓ:`da`,ဒ:`d`,ထ:`ta`,ဏ:`na`,ဝ:`w`,ဎ:`da`,ဍ:`d`,ဌ:`ta`,ဋ:`t`,ည:`ny`,ဇ:`z`,ဆ:`sa`,စ:`s`,င:`ng`,ဃ:`ga`,ဂ:`g`,လ:`l`,သ:`th`,"၈":`8`,ဩ:`aw`,ခ:`kh`,"၆":`6`,"၅":`5`,"၄":`4`,"၃":`3`,"၂":`2`,"၁":`1`,"၀":`0`,"၌":`hnaik`,"၍":`ywae`,ဪ:`aw`,ဦ:`-u`,ဟ:`h`,ဉ:`u`,ဤ:`-i`,ဣ:`i`,"၏":`-e`,ဧ:`e`,"ှ":`h`,"ွ":`w`,"ျ":`ya`,"ြ":`y`,အ:`a`,ဠ:`la`,"၇":`7`,DŽ:`DZ`,Dž:`Dz`,dž:`dz`,Ǳ:`DZ`,ǲ:`Dz`,ǳ:`dz`,Ǉ:`LJ`,ǈ:`Lj`,ǉ:`lj`,Ǌ:`NJ`,ǋ:`Nj`,ǌ:`nj`,č:`c`,Č:`C`,ć:`c`,Ć:`C`,š:`s`,Š:`S`,ა:`a`,ბ:`b`,გ:`g`,დ:`d`,ე:`e`,ვ:`v`,ზ:`z`,თ:`t`,ი:`i`,კ:`k`,ლ:`l`,მ:`m`,ნ:`n`,ო:`o`,პ:`p`,ჟ:`zh`,რ:`r`,ს:`s`,ტ:`t`,უ:`u`,ფ:`f`,ქ:`q`,ღ:`gh`,ყ:`y`,შ:`sh`,ჩ:`ch`,ც:`ts`,ძ:`dz`,წ:`ts`,ჭ:`ch`,ხ:`kh`,ჯ:`j`,ჰ:`h`,Ё:`E`,ё:`e`,Ы:`Y`,ы:`y`,Э:`E`,э:`e`,І:`I`,і:`i`,Ѳ:`F`,ѳ:`f`,Ѣ:`E`,ѣ:`e`,Ѵ:`I`,ѵ:`i`,Є:`Je`,є:`je`,Ѥ:`Je`,ѥ:`je`,Ꙋ:`U`,ꙋ:`u`,Ѡ:`O`,ѡ:`o`,Ѿ:`Ot`,ѿ:`ot`,Ѫ:`U`,ѫ:`u`,Ѧ:`Ja`,ѧ:`ja`,Ѭ:`Ju`,ѭ:`ju`,Ѩ:`Ja`,ѩ:`Ja`,Ѯ:`Ks`,ѯ:`ks`,Ѱ:`Ps`,ѱ:`ps`,Ґ:`G`,ґ:`g`,Ї:`Yi`,ї:`yi`,Ә:`A`,Ғ:`G`,Қ:`Q`,Ң:`N`,Ө:`O`,Ұ:`U`,Ү:`U`,Һ:`H`,ә:`a`,ғ:`g`,қ:`q`,ң:`n`,ө:`o`,ұ:`u`,ү:`u`,һ:`h`,ď:`d`,Ď:`D`,ě:`e`,Ě:`E`,ř:`r`,Ř:`R`,ť:`t`,Ť:`T`,ů:`u`,Ů:`U`,ą:`a`,ę:`e`,ł:`l`,ń:`n`,ś:`s`,ź:`z`,ż:`z`,Ą:`A`,Ę:`E`,Ł:`L`,Ń:`N`,Ś:`S`,Ź:`Z`,Ż:`Z`,ā:`a`,ģ:`g`,ī:`i`,ķ:`k`,ļ:`l`,ņ:`n`,ū:`u`,Ā:`A`,Ģ:`G`,Ī:`I`,Ķ:`k`,Ļ:`L`,Ņ:`N`,Ū:`U`,Ả:`A`,Ạ:`A`,Ắ:`A`,Ằ:`A`,Ẳ:`A`,Ẵ:`A`,Ặ:`A`,Ấ:`A`,Ầ:`A`,Ẩ:`A`,Ẫ:`A`,Ậ:`A`,ả:`a`,ạ:`a`,ắ:`a`,ằ:`a`,ẳ:`a`,ẵ:`a`,ặ:`a`,ấ:`a`,ầ:`a`,ẩ:`a`,ẫ:`a`,ậ:`a`,Ẻ:`E`,Ẽ:`E`,Ẹ:`E`,Ế:`E`,Ề:`E`,Ể:`E`,Ễ:`E`,Ệ:`E`,ẻ:`e`,ẽ:`e`,ẹ:`e`,ế:`e`,ề:`e`,ể:`e`,ễ:`e`,ệ:`e`,Ỉ:`I`,Ị:`I`,ỉ:`i`,ị:`i`,Ỏ:`O`,Ọ:`O`,Ố:`O`,Ồ:`O`,Ổ:`O`,Ỗ:`O`,Ộ:`O`,Ớ:`O`,Ờ:`O`,Ở:`O`,Ỡ:`O`,Ợ:`O`,ỏ:`o`,ọ:`o`,ố:`o`,ồ:`o`,ổ:`o`,ỗ:`o`,ộ:`o`,ớ:`o`,ờ:`o`,ở:`o`,ỡ:`o`,ợ:`o`,Ủ:`U`,Ụ:`U`,Ứ:`U`,Ừ:`U`,Ử:`U`,Ữ:`U`,Ự:`U`,ủ:`u`,ụ:`u`,ứ:`u`,ừ:`u`,ử:`u`,ữ:`u`,ự:`u`,Ỳ:`Y`,Ỷ:`Y`,Ỹ:`Y`,Ỵ:`Y`,ỳ:`y`,ỷ:`y`,ỹ:`y`,ỵ:`y`,ا:`a`,ب:`b`,پ:`p`,ت:`t`,ث:`th`,ج:`g`,چ:`ch`,ح:`h`,خ:`kh`,د:`d`,ذ:`th`,ر:`r`,ز:`z`,س:`s`,ش:`sh`,ص:`s`,ض:`d`,ط:`t`,ظ:`th`,ع:`aa`,غ:`gh`,ف:`f`,ق:`k`,ک:`k`,گ:`g`,ل:`l`,ژ:`zh`,ك:`k`,م:`m`,ن:`n`,ه:`h`,و:`o`,ی:`y`,آ:`a`,"٠":`0`,"١":`1`,"٢":`2`,"٣":`3`,"٤":`4`,"٥":`5`,"٦":`6`,"٧":`7`,"٨":`8`,"٩":`9`,أ:`a`,ي:`y`,إ:`a`,ؤ:`o`,ئ:`y`,ء:`aa`,ђ:`dj`,ћ:`c`,Ђ:`Dj`,Ћ:`C`,ə:`e`,Ə:`E`,ß:`ss`,ẞ:`SS`,ভ্ল:`vl`,পশ:`psh`,ব্ধ:`bdh`,ব্জ:`bj`,ব্দ:`bd`,ব্ব:`bb`,ব্ল:`bl`,ভ:`v`,ব:`b`,চ্ঞ:`cNG`,চ্ছ:`cch`,চ্চ:`cc`,ছ:`ch`,চ:`c`,ধ্ন:`dhn`,ধ্ম:`dhm`,দ্ঘ:`dgh`,দ্ধ:`ddh`,দ্ভ:`dv`,দ্ম:`dm`,ড্ড:`DD`,ঢ:`Dh`,ধ:`dh`,দ্গ:`dg`,দ্দ:`dd`,ড:`D`,দ:`d`,"।":`.`,ঘ্ন:`Ghn`,গ্ধ:`Gdh`,গ্ণ:`GN`,গ্ন:`Gn`,গ্ম:`Gm`,গ্ল:`Gl`,জ্ঞ:`jNG`,ঘ:`Gh`,গ:`g`,হ্ণ:`hN`,হ্ন:`hn`,হ্ম:`hm`,হ্ল:`hl`,হ:`h`,জ্ঝ:`jjh`,ঝ:`jh`,জ্জ:`jj`,জ:`j`,ক্ষ্ণ:`kxN`,ক্ষ্ম:`kxm`,ক্ষ:`ksh`,কশ:`ksh`,ক্ক:`kk`,ক্ট:`kT`,ক্ত:`kt`,ক্ল:`kl`,ক্স:`ks`,খ:`kh`,ক:`k`,ল্ভ:`lv`,ল্ধ:`ldh`,লখ:`lkh`,লঘ:`lgh`,লফ:`lph`,ল্ক:`lk`,ল্গ:`lg`,ল্ট:`lT`,ল্ড:`lD`,ল্প:`lp`,ল্ম:`lm`,ল্ল:`ll`,ল্ব:`lb`,ল:`l`,ম্থ:`mth`,ম্ফ:`mf`,ম্ভ:`mv`,মপ্ল:`mpl`,ম্ন:`mn`,ম্প:`mp`,ম্ম:`mm`,ম্ল:`ml`,ম্ব:`mb`,ম:`m`,"০":`0`,"১":`1`,"২":`2`,"৩":`3`,"৪":`4`,"৫":`5`,"৬":`6`,"৭":`7`,"৮":`8`,"৯":`9`,ঙ্ক্ষ:`Ngkx`,ঞ্ছ:`nch`,ঙ্ঘ:`ngh`,ঙ্খ:`nkh`,ঞ্ঝ:`njh`,ঙ্গৌ:`ngOU`,ঙ্গৈ:`ngOI`,ঞ্চ:`nc`,ঙ্ক:`nk`,ঙ্ষ:`Ngx`,ঙ্গ:`ngo`,ঙ্ম:`Ngm`,ঞ্জ:`nj`,ন্ধ:`ndh`,ন্ঠ:`nTh`,ণ্ঠ:`NTh`,ন্থ:`nth`,ঙ্গা:`nga`,ঙ্গি:`ngi`,ঙ্গী:`ngI`,ঙ্গু:`ngu`,ঙ্গূ:`ngU`,ঙ্গে:`nge`,ঙ্গো:`ngO`,ণ্ঢ:`NDh`,নশ:`nsh`,ঙর:`Ngr`,ঞর:`NGr`,"ংর":`ngr`,ঙ:`Ng`,ঞ:`NG`,"ং":`ng`,ন্ন:`nn`,ণ্ণ:`NN`,ণ্ন:`Nn`,ন্ম:`nm`,ণ্ম:`Nm`,ন্দ:`nd`,ন্ট:`nT`,ণ্ট:`NT`,ন্ড:`nD`,ণ্ড:`ND`,ন্ত:`nt`,ন্স:`ns`,ন:`n`,ণ:`N`,"ৈ":`OI`,"ৌ":`OU`,"ো":`O`,ঐ:`OI`,ঔ:`OU`,অ:`o`,ও:`oo`,ফ্ল:`fl`,প্ট:`pT`,প্ত:`pt`,প্ন:`pn`,প্প:`pp`,প্ল:`pl`,প্স:`ps`,ফ:`f`,প:`p`,"ৃ":`rri`,ঋ:`rri`,রর‍্য:`rry`,"্র্য":`ry`,"্রর":`rr`,ড়্গ:`Rg`,ঢ়:`Rh`,ড়:`R`,র:`r`,"্র":`r`,শ্ছ:`Sch`,ষ্ঠ:`ShTh`,ষ্ফ:`Shf`,স্ক্ল:`skl`,স্খ:`skh`,স্থ:`sth`,স্ফ:`sf`,শ্চ:`Sc`,শ্ত:`St`,শ্ন:`Sn`,শ্ম:`Sm`,শ্ল:`Sl`,ষ্ক:`Shk`,ষ্ট:`ShT`,ষ্ণ:`ShN`,ষ্প:`Shp`,ষ্ম:`Shm`,স্প্ল:`spl`,স্ক:`sk`,স্ট:`sT`,স্ত:`st`,স্ন:`sn`,স্প:`sp`,স্ম:`sm`,স্ল:`sl`,শ:`S`,ষ:`Sh`,স:`s`,"ু":`u`,উ:`u`,অ্য:`oZ`,ত্থ:`tth`,ৎ:`tt`,ট্ট:`TT`,ট্ম:`Tm`,ঠ:`Th`,ত্ন:`tn`,ত্ম:`tm`,থ:`th`,ত্ত:`tt`,ট:`T`,ত:`t`,অ্যা:`AZ`,"া":`a`,আ:`a`,য়া:`ya`,য়:`y`,"ি":`i`,ই:`i`,"ী":`ee`,ঈ:`ee`,"ূ":`uu`,ঊ:`uu`,"ে":`e`,এ:`e`,য:`z`,"্য":`Z`,ইয়:`y`,ওয়:`w`,"্ব":`w`,এক্স:`x`,"ঃ":`:`,"ঁ":`nn`,"্‌":``,"˚":`0`,"¹":`1`,"²":`2`,"³":`3`,"⁴":`4`,"⁵":`5`,"⁶":`6`,"⁷":`7`,"⁸":`8`,"⁹":`9`,"₀":`0`,"₁":`1`,"₂":`2`,"₃":`3`,"₄":`4`,"₅":`5`,"₆":`6`,"₇":`7`,"₈":`8`,"₉":`9`,"௦":`0`,"௧":`1`,"௨":`2`,"௩":`3`,"௪":`4`,"௫":`5`,"௬":`6`,"௭":`7`,"௮":`8`,"௯":`9`,"௰":`10`,"௱":`100`,"௲":`1000`,Ꜳ:`AA`,ꜳ:`aa`,Ꜵ:`AO`,ꜵ:`ao`,Ꜷ:`AU`,ꜷ:`au`,Ꜹ:`AV`,ꜹ:`av`,Ꜻ:`av`,ꜻ:`av`,Ꜽ:`AY`,ꜽ:`ay`,ȸ:`db`,ʣ:`dz`,ʥ:`dz`,ʤ:`dezh`,"🙰":`et`,ﬀ:`ff`,ﬃ:`ffi`,ﬄ:`ffl`,ﬁ:`fi`,ﬂ:`fl`,ʩ:`feng`,ʪ:`ls`,ʫ:`lz`,ɮ:`lezh`,ȹ:`qp`,ʨ:`tc`,ʦ:`ts`,ʧ:`tesh`,Ꝏ:`OO`,ꝏ:`oo`,ﬆ:`st`,ﬅ:`st`,Ꜩ:`TZ`,ꜩ:`tz`,ᵫ:`ue`,Aι:`Ai`,αι:`ai`,ἀ:`a`,ἁ:`a`,ἂ:`a`,ἃ:`a`,ἄ:`a`,ἅ:`a`,ἆ:`a`,ἇ:`a`,Ἀ:`A`,Ἁ:`A`,Ἂ:`A`,Ἃ:`A`,Ἄ:`A`,Ἅ:`A`,Ἆ:`A`,Ἇ:`A`,ᾰ:`a`,ᾱ:`a`,ᾲ:`a`,ᾳ:`a`,ᾴ:`a`,ᾶ:`a`,ᾷ:`a`,Ᾰ:`A`,Ᾱ:`A`,Ὰ:`A`,Ά:`A`,ᾼ:`A`,A̧:`A`,a̧:`a`,Ⱥ:`A`,ⱥ:`a`,Ȧ:`A`,ȧ:`a`,Ɓ:`B`,C̈:`C`,c̈:`c`,C̨:`C`,c̨:`c`,Ȼ:`C`,ȼ:`c`,C̀:`C`,c̀:`c`,C̣:`C`,c̣:`c`,C̄:`C`,c̄:`c`,C̃:`C`,c̃:`c`,Ȩ:`E`,ȩ:`e`,Ɇ:`E`,ɇ:`e`,I̧:`I`,i̧:`i`,Ɨ:`I`,ɨ:`i`,i:`i`,J́́:`J`,j́:`j`,J̀̀:`J`,j̀:`j`,J̈:`J`,j̈:`j`,J̧:`J`,j̧:`j`,J̨:`J`,j̨:`j`,Ɉ:`J`,ɉ:`j`,J̌:`J`,ǰ:`j`,J̇:`J`,j:`j`,J̣:`J`,j̣:`j`,J̄:`J`,j̄:`j`,J̃:`J`,j̃:`j`,ĸ:`k`,L̀:`L`,l̀:`l`,L̂:`L`,l̂:`l`,L̈:`L`,l̈:`l`,L̨:`L`,l̨:`l`,Ƚ:`L`,ƚ:`l`,L̇:`L`,l̇:`l`,Ḷ:`L`,ḷ:`l`,L̄:`L`,l̄:`l`,L̃:`L`,l̃:`l`,Ŋ:`N`,ŋ:`n`,Ǹ:`N`,ǹ:`n`,N̂:`N`,n̂:`n`,N̈:`N`,n̈:`n`,N̨:`N`,n̨:`n`,Ꞥ:`N`,ꞥ:`n`,Ṅ:`N`,ṅ:`n`,Ṇ:`N`,ṇ:`n`,N̄:`N`,n̄:`n`,O̧:`O`,o̧:`o`,Ǫ:`O`,ǫ:`o`,Ɵ:`O`,ɵ:`o`,Ȯ:`O`,ȯ:`o`,S̀:`S`,s̀:`s`,Ŝ̀:`S`,S̈:`S`,s̈:`s`,S̨:`S`,s̨:`s`,Ꞩ:`S`,ꞩ:`s`,Ṡ:`S`,ṡ:`s`,Ṣ:`S`,ṣ:`s`,S̄:`S`,s̄:`s`,S̃:`S`,s̃:`s`,T́:`T`,t́:`t`,T̀:`T`,t̀:`t`,T̂:`T`,t̂:`t`,T̈:`T`,ẗ:`t`,T̨:`T`,t̨:`t`,Ⱦ:`T`,ⱦ:`t`,Ṫ:`T`,ṫ:`t`,Ṭ:`T`,ṭ:`t`,T̄:`T`,t̄:`t`,T̃:`T`,t̃:`t`,U̧:`U`,u̧:`u`,Ʉ:`U`,ʉ:`u`,U̇:`U`,u̇:`u`,Ʊ:`U`,ʊ:`u`,Ẁ:`W`,ẁ:`w`,Ẃ:`W`,ẃ:`w`,Ẅ:`W`,ẅ:`w`,Ꙗ:`Ja`,ꙗ:`ja`,Y̧:`Y`,y̧:`y`,Y̨:`Y`,y̨:`y`,Ɏ:`Y`,ɏ:`y`,Y̌:`Y`,y̌:`y`,Ẏ:`Y`,ẏ:`y`,Ȳ:`Y`,ȳ:`y`,Z̀:`Z`,z̀:`z`,Ẑ:`Z`,ẑ:`z`,Z̈:`Z`,z̈:`z`,Z̧:`Z`,z̧:`z`,Z̨:`Z`,z̨:`z`,Ƶ:`Z`,ƶ:`z`,Ẓ:`Z`,ẓ:`z`,Z̄:`Z`,z̄:`z`,Z̃:`Z`,z̃:`z`,"\xA0":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `," ":` `,"\u2028":` `,"\u2029":` `,"​":` `," ":` `," ":` `,"　":` `,ﾠ:` `,"«":`<<`,"»":`>>`,"‘":`'`,"’":`'`,"‚":`'`,"‛":`'`,"“":`"`,"”":`"`,"„":`"`,"‟":`"`,"‹":`'`,"›":`'`,"–":`-`,"—":`-`,"…":`...`,"€":`EUR`,$:`$`,"₢":`Cr`,"₣":`Fr.`,"£":`PS`,"₤":`L.`,ℳ:`M`,"₥":`mil`,"₦":`N`,"₧":`Pts`,"₨":`Rs`,රු:`LKR`,ரூ:`LKR`,"௹":`Rs`,रू:`NPR`,"₹":`Rs`,"૱":`Rs`,"₩":`W`,"₪":`NS`,"₸":`KZT`,"₫":`D`,"֏":`AMD`,"₭":`K`,"₺":`TL`,"₼":`AZN`,"₮":`T`,"₯":`Dr`,"₲":`PYG`,"₾":`GEL`,"₳":`ARA`,"₴":`UAH`,"₽":`RUB`,"₵":`GHS`,"₡":`CL`,"¢":`c`,"¥":`YEN`,円:`JPY`,"৳":`BDT`,元:`CNY`,"﷼":`SAR`,"៛":`KR`,"₠":`ECU`,"¤":`$?`,"฿":`THB`,"؋":`AFN`};function la(e,t=ca){e=e.normalize(`NFC`);let n=``,r;for(let i=0;i<e.length;i++)r=e.charAt(i),n+=typeof t[r]==`string`?t[r]:r;return n}function ua(e,t={}){let n={allowNonAlphaStart:!1,handleCasing:`camel`,...t};var r=e.replace(/<(.*?)>/g,``);r=r.replace(/['"‘’“”ʻ\[\]\(\)\{\}:]/g,``),r=r.toLowerCase(),r=la(r),n.allowNonAlphaStart||(r=r.replace(/^[^a-z]+/,``));let i=r.split(/[^a-z0-9]+/).filter(Boolean);if(r=``,n.handleCasing===`snake`)return i.join(`_`);for(let e=0;e<i.length;e++)n.handleCasing!==`pascal`&&e===0?r+=i[e]:r+=i[e].charAt(0).toUpperCase()+i[e].substring(1);return r}function da(e,t={}){let n={prefix:``,suffix:``,...t},r=ua(e,{handleCasing:`snake`}).toUpperCase();return r?`${n.prefix}${r}${n.suffix}`:``}function fa(e){let t=e.replace(/<(.*?)>/g,``);return t=t.toLowerCase(),t=la(t),t=t.replace(/^[^a-z]+/,``),t=t.replace(/[^a-z0-9]+$/,``),t.split(/[^a-z0-9]+/).filter(Boolean).join(`-`)}function pa(e){return e.charAt(0).toUpperCase()+e.slice(1)}function ma(){return Math.floor(Math.random()*1e6)}var ha=new WeakMap,ga=class e{constructor(){this.queue=[],this.workers=[],_(this,ha,null),y(ha,this,new AbortController);for(let e=0;e<3;e++)this.workers.push(new ba(this))}load(t=document,n=`[data-sizes]`){t.querySelectorAll(n).forEach(t=>{if(ia(t))this.addToQueue(t);else{let n=`thumb${ma()}`;e.invisibleThumbs[n]=[this,t];let r=()=>{e.invisibleThumbs[n]&&ia(t)&&(delete e.invisibleThumbs[n],this.addToQueue(t))};document.addEventListener(`scroll`,r,{signal:v(ha,this)?.signal}),window.addEventListener(`resize`,r,{signal:v(ha,this)?.signal})}})}addToQueue(e){this.queue.push(e),this.workers.forEach(e=>{e.active||e.loadNext()})}static retryAll(){for(let t in e.invisibleThumbs){let n=e.invisibleThumbs[t];if(!n)continue;let[r,i]=n;delete e.invisibleThumbs[t],r.load(i.parentElement??document)}}destroy(){this.workers.forEach(e=>e.deactivate()),v(ha,this)?.abort()}};ga.invisibleThumbs={};var _a=new WeakMap,va=new WeakMap,ya=new WeakMap,ba=class{constructor(e){this.active=!1,this.container=void 0,_(this,_a,null),_(this,va,null),_(this,ya,null),y(_a,this,e)}activate(){this.active||(this.active=!0,this.clearInterval(),y(va,this,setInterval(()=>{this.loadNextIfRemoved()},500)))}deactivate(){this.active&&(this.active=!1,this.clearInterval(),this.clearTimeout())}clearInterval(){v(va,this)&&(clearInterval(v(va,this)),y(va,this,null))}clearTimeout(){v(ya,this)&&(clearTimeout(v(ya,this)),y(ya,this,null))}loadNext(){if(this.clearTimeout(),this.container=v(_a,this)?.queue.shift(),this.container===void 0){this.deactivate();return}if(this.loadNextIfRemoved())return;if(this.container.querySelectorAll(`img`).length>0){this.loadNext();return}this.activate(),y(ya,this,setTimeout(()=>{this.loadNext()},3e4));let e=document.createElement(`img`);e.sizes=this.container.getAttribute(`data-sizes`)??``,e.srcset=this.container.getAttribute(`data-srcset`)??``,e.alt=this.container.getAttribute(`data-alt`)??``,e.setAttribute(`data-animated`,this.container.getAttribute(`data-animated`)??``),e.src=this.container.getAttribute(`data-src`)??``,e.onload=()=>this.loadNext(),e.onabort=()=>this.loadNext(),e.onerror=()=>this.loadNext(),this.container.appendChild(e)}loadNextIfRemoved(){return this.container&&!document.body.contains(this.container)?(this.loadNext(),!0):!1}},xa=a`
  :host {
    display: contents;
  }
...
`,Sa=new WeakMap,Ca=new WeakMap,wa=new WeakMap,Ta=new WeakSet,Ea=class extends l{constructor(...e){super(...e),g(this,Ta),this.size=``,this.variant=he.Neutral,this.appearance=ae.OutlineFill,this.icon=null,this.showIndicators=!1,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,this.selected=!1,this.selectLabel=null,_(this,Sa,!1),_(this,Ca,new ga),this.lightDom=0,_(this,wa,new MutationObserver(()=>this.lightDom++))}connectedCallback(){super.connectedCallback(),v(wa,this).observe(this,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`slot`]})}disconnectedCallback(){v(wa,this).disconnect(),super.disconnectedCallback()}renderSelect(){return r`<input
      type="checkbox"
    ...
    </div>`}firstUpdated(e){super.firstUpdated(e),v(Ca,this).load(this)}render(){this.lightDom;let e=h(Ta,this,ka).call(this,`prefix`)||h(Ta,this,ka).call(this,`icon`)||h(Ta,this,ka).call(this,`thumbnail`)||h(Ta,this,ka).call(this,`indicator`)||h(Ta,this,ka).call(this,`status`)||this.icon,t=h(Ta,this,ka).call(this,`suffix`);return r`
      <div
        part="chip"
        class="${x({"cp-chip":!0,"cp-chip--small":this.size===`small`,"cp-chip--medium":this.size===`medium`,"cp-chip--large":this.size===`large`,"cp-chip--plain":this.appearance===ae.Plain,"cp-chip--selectable":this.selectable,"cp-chip--show-thumb":this.showThumb,"cp-chip--show-indicators":this.showIndicators,"cp-chip--show-status":this.showStatus})}"
      >
    ...
    `}};function Da(e){y(Sa,this,e.shiftKey),e.stopPropagation()}function Oa(e){let{checked:t}=e.target;this.selected=t,this.dispatchEvent(new CustomEvent(`selected-change`,{detail:{selected:t,shiftKey:v(Sa,this)},bubbles:!0,composed:!0}))}function ka(e){return!!this.querySelector(`:scope > [slot="${e}"]`)}Ea.styles=[xa],u([d()],Ea.prototype,`size`,void 0),u([d({reflect:!0})],Ea.prototype,`variant`,void 0),u([d({reflect:!0})],Ea.prototype,`appearance`,void 0),u([d()],Ea.prototype,`icon`,void 0),u([d({attribute:`show-indicators`,type:Boolean})],Ea.prototype,`showIndicators`,void 0),u([d({attribute:`show-status`,type:Boolean})],Ea.prototype,`showStatus`,void 0),u([d({attribute:`show-thumb`,type:Boolean})],Ea.prototype,`showThumb`,void 0),u([d({type:Boolean})],Ea.prototype,`selectable`,void 0),u([d({type:Boolean,reflect:!0})],Ea.prototype,`selected`,void 0),u([d({attribute:`select-label`})],Ea.prototype,`selectLabel`,void 0),u([f()],Ea.prototype,`lightDom`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,Ea);var Aa=class extends ji(l){static get properties(){return{tabIndex:{type:Number,reflect:!0,attribute:`tabindex`}}}constructor(){super(),this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`listbox`)}createRenderRoot(){return this}},ja=T(e=>class extends hi(ui(Ni(Pe(Ai(e))))){static get properties(){return{orientation:String,selectionFollowsFocus:{type:Boolean,attribute:`selection-follows-focus`},rotateKeyboardNavigation:{type:Boolean,attribute:`rotate-keyboard-navigation`},hasNoDefaultSelected:{type:Boolean,reflect:!0,attribute:`has-no-default-selected`},_noTypeAhead:{type:Boolean}}}static get styles(){return[...super.styles||[],a`
          :host {
            display: block;
          }
...
`,Fa=new WeakMap,Ia=new WeakSet,La=class extends Na{constructor(...e){super(...e),g(this,Ia),this.hint=null,_(this,Fa,void 0)}static get styles(){return[...Na.styles,Pa]}connectedCallback(){super.connectedCallback(),za._.observe(this)}disconnectedCallback(){super.disconnectedCallback(),za._.unobserve(this)}render(){return r`
      <div class="choice-field__label">
        <slot></slot>
        ${this.hint?r`<span class="hint">${this.hint}</span>`:c}
        <slot name="suffix"></slot>
      </div>
    `}};function Ra(){return v(Fa,this)??y(Fa,this,parseInt(getComputedStyle(this).getPropertyValue(`--c-option-wide-threshold`)||`640`,10)),v(Fa,this)}var za={_:new ResizeObserver(e=>{for(let t of e){let e=t.target,n=t.borderBoxSize?.[0]?.inlineSize??t.contentRect.width;e.toggleAttribute(`wide`,n>=h(Ia,e,Ra).call(e))}})};u([d()],La.prototype,`hint`,void 0),customElements.get(`craft-option`)||customElements.define(`craft-option`,La);var Ba=new WeakMap;function Va(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),Ba.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else Va(n,t)})}function Ha(e){Ba.has(e)&&Ba.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?Ba.has(e)&&Ba.get(e)():Ha(e)})}var Ua=class extends Si{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof pi}};function Wa(e){return Array.isArray(e)?e:[e]}var Ga=T(e=>class extends Ni(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Wa(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Wa(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Wa(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Wa(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Ka=new WeakMap,qa=class extends ii(re(Ga(Ma))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,a`
        .input-group__input {
          display: flex;
          flex: 1;
        }
...
`,Za=new WeakMap,Qa=new WeakMap,$a=new WeakMap,B=new WeakSet,eo=new WeakMap,to=class extends qa{static get properties(){return{modelValue:{attribute:`model-value`}}}attributeChangedCallback(e,t,n){if(e===`model-value`){this.modelValue=this.hasAttribute(`multiple-choice`)?JSON.parse(n??`[]`):n??``;return}super.attributeChangedCallback(e,t,n)}static get styles(){return[...super.styles,Xa]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),g(this,B),this.multipleChoice=!1,this.required=!1,this.initialValues=[],this.fieldsetDisabled=!1,this.changingValues=!1,this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,_(this,Za,void 0),_(this,Qa,!1),_(this,$a,()=>{y(Qa,this,!0),h(B,this,oo).call(this),!this.multipleChoice&&!this.requireOptionMatch&&h(B,this,no).call(this)}),_(this,eo,()=>{if(this.multipleChoice){this.changeValues([]);return}this.modelValue=``,this._inputNode&&(this._inputNode.value=``),h(B,this,oo).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.selectionFollowsFocus=!1,this.addEventListener(`model-value-changed`,e=>{if(this.changingValues){e.stopImmediatePropagation();return}if(e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&JSON.stringify(this.modelValue)!==JSON.stringify(this.pendingModelValue)){e.stopImmediatePropagation();return}e.target===this&&e.detail?.isTriggeredByUser&&(this.pendingModelValue=this.multipleChoice?[...this.selectedValues]:this.modelValue,this.multipleChoice&&(this.syncInputs(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))))}),this.addEventListener(`focusout`,e=>{this.multipleChoice&&!this.requireOptionMatch&&!(e.relatedTarget instanceof Node&&this.contains(e.relatedTarget))&&this.commitQuery()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,v($a,this)),this.addEventListener(`model-value-changed`,()=>{y(Za,this,this.modelValue)}),y(Za,this,this.modelValue),h(B,this,oo).call(this),this.multipleChoice&&(this.initialValues=[...Array.isArray(this.pendingModelValue)?this.pendingModelValue:[]])}updated(e){if(super.updated(e),this.multipleChoice){this.syncInputs(),this._inputNode.removeAttribute(`name`),this._comboboxNode.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this._inputNode.disabled=this.disabled||this.fieldsetDisabled;let e=this.required&&!this.inactive&&this.selectedValues.length===0;this.internals??=this.attachInternals(),this.internals.setValidity(e?{valueMissing:!0}:{},e?O(`This field is required.`):``,this._inputNode)}e.has(`opened`)&&!this.opened&&y(Qa,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`)||e.has(`multipleChoice`))&&h(B,this,oo).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,h(B,this,uo).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t);let n=e;n.updateComplete.then(()=>{if(this.multipleChoice){n.checked=Array.isArray(this.pendingModelValue)&&this.pendingModelValue.includes(String(n.choiceValue));return}String(n.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(n)))})}_notifyModelValueChanged(){JSON.stringify(this.modelValue)!==JSON.stringify(v(Za,this))&&(y(Za,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:this.multipleChoice?`selection`:`input`}})))}matchCondition(e){return!this.multipleChoice||!e.hidden}_autoSelectCondition(){return!this.multipleChoice}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=h(B,this,uo).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ${this.multipleChoice?Ya(this.selectedValues,e=>e,e=>r`
                <span class="token">
                  ${this.valueLabel(e)}
        ...
        <div class="combobox__textbox">
          ...
          <slot name="input"></slot>
          ${this.clearable&&h(B,this,co).call(this)&&!this.inactive?r`<craft-button
                class="clear"
                type="button"
                appearance="plain"
                size="small"
    ...
    `}get selectedValues(){return Array.isArray(this.modelValue)?this.modelValue:[]}get inactive(){return this.disabled||this.readOnly||this.fieldsetDisabled}valueLabel(e){return[...h(B,this,fo).call(this)].find(t=>t.value===e)?.label??e}syncInputs(){this.inputs||(this.inputs=document.createElement(`span`),this.inputs.hidden=!0,this.inputs.slot=`native-inputs`,this.inputs.setAttribute(`data-combobox-inputs`,``),this.append(this.inputs)),s(!this.name||this.disabled||this.fieldsetDisabled?c:r`
            ...
            ${this.selectedValues.map(e=>r`<input
                  ...
                  .value=${e}
                />`)}
          `,this.inputs)}formResetCallback(){this.multipleChoice&&(this.modelValue=[...this.initialValues],this.value=``,this.syncInputs())}formDisabledCallback(e){this.fieldsetDisabled=e,this.requestUpdate(),this.multipleChoice&&this.syncInputs()}changeValues(e){if(!this.inactive){this.changingValues=!0;try{this.modelValue=e}finally{this.changingValues=!1}this.value=``,this.opened=!1,h(B,this,oo).call(this),this.syncInputs(),this._notifyModelValueChanged(),this._inputNode.focus()}}commitQuery(){let e=this.value;if(this.inactive||e===``)return;let t=[...h(B,this,fo).call(this)].find(t=>t.value===e);t?.disabled||this.requireOptionMatch&&!t||this.changeValues([...new Set([...this.selectedValues,e])])}_listboxOnKeyDown(e){if(!this.multipleChoice){super._listboxOnKeyDown(e);return}if(this.inactive||e.isComposing)return;if(e.key===`Backspace`&&this.value===``){e.preventDefault(),this.changeValues(this.selectedValues.slice(0,-1));return}let t=this.formElements[this.activeIndex];if(e.key===`Enter`&&(!this.opened||!t||t.hidden||t.hasAttribute(`aria-hidden`))){e.preventDefault(),this.commitQuery();return}super._listboxOnKeyDown(e)}_syncToTextboxMultiple(){}_resetListboxOptions(){super._resetListboxOptions(),this.hideSelectedOptions()}_handleAutocompletion(){super._handleAutocompletion(),this.hideSelectedOptions()}hideSelectedOptions(){if(!this.multipleChoice)return;for(let e of this.formElements)e.hidden&&(e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`aria-posinset`),e.removeAttribute(`aria-setsize`));let e=this.formElements.filter(e=>!e.hasAttribute(`aria-hidden`));e.forEach((t,n)=>{t.setAttribute(`aria-posinset`,String(n+1)),t.setAttribute(`aria-setsize`,String(e.length))})}parser(e){if(typeof e==`string`&&e!==``){let t=h(B,this,lo).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function no(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function ro(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(h(B,this,io).call(this,e))for(let r of e.options)(t===``||h(B,this,ao).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||h(B,this,ao).call(this,t,e))&&n.push({option:e});return n}function io(e){return e.type===`optgroup`}function ao(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function oo(){let e=this._listboxNode;if(!e)return;let t=v(Qa,this)?this._inputNode?.value??``:``,n=this.multipleChoice?Array.isArray(this.pendingModelValue)?this.pendingModelValue:this.selectedValues:[],i=h(B,this,ro).call(this,t).filter(e=>!n.includes(e.option.value)),a=i.slice(0,this.limit),o=[...h(B,this,fo).call(this)],l=[...n.map(e=>({option:o.find(t=>t.value===e)??{value:e,label:e}})),...a],u,d=l.map(e=>{let t=e.groupLabel&&e.groupLabel!==u?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return u=e.groupLabel,{value:e.option.value,template:r`${t}${h(B,this,so).call(this,e.option,n.includes(e.option.value))}`}}),f=i.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${O(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:i.length})}
          </div>`:c;s(r`${Ya(d,e=>e.value,e=>e.template)}${f}`,e)}function so(e,t=!1){let n=e.data??{},i=e.label,a=i.startsWith(`$`)||i.startsWith(`@`);return r`
      <craft-option
        ?hidden=${t}
    ...
    `}function co(){return this.multipleChoice?this.selectedValues.length>0:this.modelValue!==``&&this.modelValue!=null}function lo(e){let t=e.trim();for(let e of h(B,this,fo).call(this))if(h(B,this,po).call(this,e)===t)return e}function uo(){if(this.multipleChoice||!h(B,this,co).call(this))return;let e=String(this.modelValue);for(let t of h(B,this,fo).call(this))if(String(t.value)===e)return t}function*fo(){for(let e of this.options)h(B,this,io).call(this,e)?yield*e.options:yield e}function po(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}to.formAssociated=!0,u([d({type:Boolean,attribute:`multiple-choice`,reflect:!0})],to.prototype,`multipleChoice`,void 0),u([d({type:Boolean})],to.prototype,`required`,void 0),u([d({type:Array})],to.prototype,`options`,void 0),u([d({type:Number})],to.prototype,`limit`,void 0),u([d({type:Boolean,reflect:!0})],to.prototype,`clearable`,void 0),u([d({type:String,reflect:!0})],to.prototype,`placeholder`,void 0),u([d({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],to.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,to);var mo=a`
  :host {
    display: inline-block;
  }
...
`,ho={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},go=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(ho[`icon.out`].keyframes,ho[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(ho[`icon.in`].keyframes,ho[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(ho[`icon.out`].keyframes,ho[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(ho[`icon.in`].keyframes,ho[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||O(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};go.styles=[mo],u([f()],go.prototype,`isCopying`,void 0),u([f()],go.prototype,`status`,void 0),u([m(`slot[name="copy-icon"]`)],go.prototype,`copyIconEl`,void 0),u([m(`slot[name="success-icon"]`)],go.prototype,`successIconEl`,void 0),u([m(`slot[name="error-icon"]`)],go.prototype,`errorIconEl`,void 0),u([m(`craft-tooltip`)],go.prototype,`tooltipEl`,void 0),u([d({type:String})],go.prototype,`value`,void 0),u([d({type:Boolean})],go.prototype,`disabled`,void 0),u([d({attribute:`feedback-duration`,type:Number})],go.prototype,`feedbackDuration`,void 0),u([d({attribute:`tooltip-label`})],go.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,go);var _o=a`
  :host {
    box-sizing: border-box;
  }
...
`,yo=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return r`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
        class=${x({"copy-attribute":!0})}
      >
        ${this.value}
      </craft-copy-button>
    `}};yo.styles=[_o,vo],u([m(`craft-copy-button`)],yo.prototype,`copyButtonEl`,void 0),u([d({type:String})],yo.prototype,`value`,void 0),u([d({type:Boolean,reflect:!0})],yo.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,yo);var bo=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function xo(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function So(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(bo))).filter(xo)}function Co(e){let t=t=>{if(t.key!==`Tab`)return;let n=So(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var wo=a`
  :host {
    display: contents;
...
`,To=0,Eo=0;function Do(){Eo++===0&&document.body.classList.add(`no-scroll`)}function Oo(){Eo>0&&--Eo===0&&document.body.classList.remove(`no-scroll`)}var ko=new WeakMap,Ao=new WeakMap,jo=new WeakMap,Mo=new WeakMap,No=new WeakSet,Po=new WeakMap,Fo=new WeakMap,Io=new WeakMap,Lo=new WeakMap,Ro=new WeakMap,zo=new WeakMap,Bo=class extends l{constructor(...e){super(...e),g(this,No),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++To}`,_(this,ko,!1),_(this,Ao,null),_(this,jo,!1),_(this,Mo,null),_(this,Po,e=>{e.preventDefault(),this.requestClose()}),_(this,Fo,()=>{this.opened=!1}),_(this,Io,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),_(this,Lo,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),_(this,Ro,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),_(this,zo,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,v(Lo,this)),this.addEventListener(`keydown`,v(Io,this)),y(Mo,this,new MutationObserver(()=>this.requestUpdate())),v(Mo,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,v(Lo,this)),this.removeEventListener(`keydown`,v(Io,this)),v(Mo,this)?.disconnect(),y(Mo,this,null),v(Ao,this)?.call(this),y(Ao,this,null),h(No,this,Uo).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
    ...
    `}updated(e){super.updated(e),this.opened!==v(ko,this)&&(y(ko,this,this.opened),this.opened?h(No,this,Vo).call(this):h(No,this,Ho).call(this),h(No,this,Wo).call(this,this.opened))}requestClose(){this.dispatchEvent(new CustomEvent(`craft-before-hide`,{bubbles:!0,composed:!0,cancelable:!0}))&&(this.opened=!1)}};function Vo(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(v(Ao,this)?.call(this),y(Ao,this,Co(this))),v(jo,this)||(y(jo,this,!0),Do())}function Ho(){let e=this.dialogElement;e?.open&&e.close(),v(Ao,this)?.call(this),y(Ao,this,null),h(No,this,Uo).call(this)}function Uo(){v(jo,this)&&(y(jo,this,!1),Oo())}function Wo(e){h(No,this,Go).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&h(No,this,Go).call(this,e?`craft-after-show`:`craft-after-hide`)})}function Go(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}Bo.styles=[_o,wo],u([d({type:Boolean,attribute:`open`,reflect:!0})],Bo.prototype,`opened`,void 0),u([d()],Bo.prototype,`label`,void 0),u([d({type:Boolean,attribute:`non-modal`,reflect:!0})],Bo.prototype,`nonModal`,void 0),u([d({type:Boolean,reflect:!0})],Bo.prototype,`fullscreen`,void 0),u([d({type:Boolean,attribute:`close-on-outside-click`})],Bo.prototype,`closeOnOutsideClick`,void 0),u([d({type:Boolean,attribute:`no-close`,reflect:!0})],Bo.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,Bo);var Ko=new WeakMap,qo=new WeakSet,Jo=class{constructor(e,t){this.host=e,this.source=t,g(this,qo),_(this,Ko,null),e.addController(this)}hostConnected(){h(qo,this,Yo).call(this)}hostDisconnected(){h(qo,this,Xo).call(this)}resubscribe(){h(qo,this,Xo).call(this),h(qo,this,Yo).call(this)}get state(){return this.source()?.state??null}};function Yo(){y(Ko,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function Xo(){v(Ko,this)?.call(this),y(Ko,this,null)}var Zo=a`
  :host {
    /*
...
`,Qo=new WeakMap,$o=new WeakMap,es=new WeakMap,ts=new WeakMap,ns=new WeakMap,rs=class extends Bo{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,_(this,Qo,new Jo(this,()=>this.controller)),_(this,$o,null),_(this,es,()=>{this.submit()}),_(this,ts,()=>{this.busy||this.requestClose()}),_(this,ns,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&y($o,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),v($o,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&v(Qo,this).resubscribe();let t=v(Qo,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&v($o,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
    ...
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};rs.styles=[...Bo.styles,Zo],u([d({attribute:!1})],rs.prototype,`controller`,void 0),u([d({type:Boolean,attribute:`show-title`,reflect:!0})],rs.prototype,`showTitle`,void 0),u([d({attribute:`select-label`})],rs.prototype,`selectLabel`,void 0),u([d({attribute:`cancel-label`})],rs.prototype,`cancelLabel`,void 0),u([d({type:Boolean,reflect:!0})],rs.prototype,`busy`,void 0),u([d({type:Boolean,reflect:!0})],rs.prototype,`loading`,void 0),u([d({type:Boolean,attribute:`can-submit`,reflect:!0})],rs.prototype,`canSubmit`,void 0),u([d({type:Boolean,reflect:!0})],rs.prototype,`narrow`,void 0),u([f()],rs.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,rs);var is=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
...
`,ls=class extends hi(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=O(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__hasSlot=new ss(this,`heading-prefix`,`label-extra`,`actions`,`heading-suffix`,`tip`,`warning`),this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[Tt,yr,cs]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.updateComplete.then(()=>{this.addToAriaLabelledBy(this._labelNode),this.__wireDescribedBy()})}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
    ...
    `}_labelTemplate(){let e=this.__hasLabel,t=this.__hasSlot.test(`label-extra`),n=this.__hasSlot.test(`actions`),i=t||n||this.readOnly||this.__hasSlot.test(`heading-prefix`)||this.__hasSlot.test(`heading-suffix`);if(!e&&!i)return r``;let a=c;return e&&(a=this.labelSrOnly&&i?r`<span class="cp-visually-hidden"
      ...
      <div
        class=${x({"form-field__label":!0,"cp-visually-hidden":this.labelSrOnly&&!i})}
      >
    ...
    `}_helpTextTemplate(){return this.__hasHelpText?super._helpTextTemplate():r``}_inputGroupTemplate(){return r`
      <div class=${x({"input-group":!0,input:!0,[this._resolvedOrientation]:!0,errors:this.hasErrors,disabled:this.disabled})}>
        ${this._inputGroupBeforeTemplate()}
        <div class="input-group__container">
          ${this._inputGroupPrefixTemplate()} ${this._inputGroupInputTemplate()}
          ${this._inputGroupSuffixTemplate()}
    ...
    `}get __hasLabel(){return this.label.trim()!==``}get __hasHelpText(){return this.helpText.trim()!==``}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`craft-visually-hidden`);t.textContent=O(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};u([d({type:Boolean,reflect:!0})],ls.prototype,`required`,void 0),u([d({type:Boolean,reflect:!0})],ls.prototype,`translatable`,void 0),u([d({attribute:`translation-description`})],ls.prototype,`translationDescription`,void 0),u([d({type:Boolean,reflect:!0})],ls.prototype,`fieldset`,void 0),u([d({reflect:!0})],ls.prototype,`status`,void 0),u([d({attribute:`status-label`})],ls.prototype,`statusLabel`,void 0),u([d({reflect:!0})],ls.prototype,`orientation`,void 0),u([d({type:Boolean,reflect:!0,attribute:`has-errors`})],ls.prototype,`hasErrors`,void 0),u([d({attribute:`instructions-position`})],ls.prototype,`instructionsPosition`,void 0),u([d({type:String,reflect:!0})],ls.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,ls);var us=class extends l{render(){return r`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,us);var ds=a`
  ${yr}
...
`,fs=/^[0-9a-f]{6}$/i,ps=/^[0-9a-f]{3}$/i,ms={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function hs(e){return String(e??``).trim().replace(/^#/,``)}function gs(e){let t=hs(e);return ps.test(t)?t.split(``).map(e=>e+e).join(``):fs.test(t)?t:null}var _s=class e extends zi{static get styles(){return[...super.styles,br,ds]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,hs(t)),e}}}parser(e){return hs(e)}formatter(e){return hs(e)}serializer(e){return hs(e)}deserializer(e){return hs(e)}preprocessor(e){let t=hs(e);if(t!==e)return t}get _expandedHexValue(){return gs(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>gs(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=hs(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
      <input
    ...
    `}};_s._browserSupportsColorInputs=null,u([d({converter:ms})],_s.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,_s);var vs=a`
  ::slotted(.form-control) {
    ${gr}
  }
...
`,V=class extends zi{constructor(...e){super(...e),this.size=`medium`,this.inputMode=``,this.autoCorrect=!0,this.autoCapitalize=!0,this.small=!1,this.center=!1,this.monospace=!1,this.hiddenInput=!1}static get styles(){return[...super.styles,br,vs]}connectedCallback(){super.connectedCallback(),this._inputNode&&this.maxlength&&this.maxlength>0&&(this._inputNode.maxLength=this.maxlength,this.width!==`full`&&(this._inputNode.size=this.maxlength)),this.syncNativeAttributes(),this.syncAriaInvalid()}updated(e){super.updated(e),(e.has(`inputSize`)||e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`inputMode`)||e.has(`autoCorrect`)||e.has(`autoCapitalize`))&&this.syncNativeAttributes(),this.syncAriaInvalid()}syncAriaInvalid(){let e=this.getAttribute(`aria-invalid`);e!==null&&this._inputNode?.setAttribute(`aria-invalid`,e)}syncNativeAttributes(){let e={size:this.inputSize,min:this.min,max:this.max,step:this.step,inputmode:this.inputMode,autocorrect:this.autoCorrect?void 0:`off`,autocapitalize:this.autoCapitalize?void 0:`none`};for(let[t,n]of Object.entries(e)){if(n===void 0){this._inputNode?.removeAttribute(t);continue}this._inputNode?.setAttribute(t,String(n))}}};u([d({type:Number,reflect:!0})],V.prototype,`maxlength`,void 0),u([d({type:String,reflect:!0})],V.prototype,`size`,void 0),u([d({type:Number,attribute:!1})],V.prototype,`inputSize`,void 0),u([d({attribute:!1})],V.prototype,`min`,void 0),u([d({attribute:!1})],V.prototype,`max`,void 0),u([d({attribute:!1})],V.prototype,`step`,void 0),u([d({attribute:!1})],V.prototype,`inputMode`,void 0),u([d({attribute:!1})],V.prototype,`autoCorrect`,void 0),u([d({attribute:!1})],V.prototype,`autoCapitalize`,void 0),u([d({reflect:!0,type:Boolean})],V.prototype,`small`,void 0),u([d({type:String,reflect:!0})],V.prototype,`width`,void 0),u([d({reflect:!0,type:Boolean})],V.prototype,`center`,void 0),u([d({reflect:!0,type:Boolean})],V.prototype,`monospace`,void 0),u([d({reflect:!0,type:Boolean,attribute:`hidden-input`})],V.prototype,`hiddenInput`,void 0),customElements.get(`craft-input`)||customElements.define(`craft-input`,V);var ys=a`
  /*
...
`,bs=class extends V{static get styles(){return[...super.styles,ys]}_renderSuffix(){return r`<craft-copy-button
      tooltip-label="${O(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};u([d({type:String,attribute:`copy-value`})],bs.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,bs);var xs=class extends V{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,xs);var Ss=new WeakSet,Cs=class extends V{constructor(){super(),g(this,Ss),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,h(Ss,this,ws))}disconnectedCallback(){this.removeEventListener(`change`,h(Ss,this,ws)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),h(Ss,this,Ts).call(this)}};function ws(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=h(Ss,this,Es).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}h(Ss,this,Ts).call(this)}}function Ts(){let e=this._inputNode;if(!e)return;let t=h(Ss,this,Ds).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=h(Ss,this,Ds).call(this,e),i=h(Ss,this,Ds).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function Es(e){let t=h(Ss,this,Ds).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function Ds(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}u([d({type:Number,attribute:`minute-increment`})],Cs.prototype,`minuteIncrement`,void 0),u([d({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],Cs.prototype,`disabledTimeRanges`,void 0),u([d({type:Boolean,attribute:`force-round-time`})],Cs.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,Cs);var Os={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},ks=new WeakSet,As=new WeakMap,H=class extends l{constructor(...e){super(...e),g(this,ks),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,_(this,As,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof V))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,v(As,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,v(As,this)),super.disconnectedCallback()}updated(e){super.updated(e),h(ks,this,js).call(this),h(ks,this,Ms).call(this),h(ks,this,Ns).call(this),h(ks,this,Rs).call(this,`locale`,this.locale,!0),h(ks,this,Rs).call(this,`timezone`,this.timezone,!this.showTimezone)}};function js(){let e=h(ks,this,Ps).call(this,`craft-input-date`,`date`,this.showDate);e instanceof xs&&(h(ks,this,Ls).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,h(ks,this,Fs).call(this,e))}function Ms(){let e=h(ks,this,Ps).call(this,`craft-input-time`,`time`,this.showTime);e instanceof Cs&&(h(ks,this,Ls).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,h(ks,this,Fs).call(this,e))}function Ns(){let e=h(ks,this,Ps).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(h(ks,this,Ls).call(this,e,`timezone`,this.timezone??``,!1),h(ks,this,Fs).call(this,e))}function Ps(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof V);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Fs(e){e.parentElement!==this&&this.insertBefore(e,h(ks,this,Is).call(this))}function Is(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function Ls(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function Rs(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}H.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,u([d()],H.prototype,`name`,void 0),u([d({attribute:`date-value`})],H.prototype,`dateValue`,void 0),u([d({attribute:`time-value`})],H.prototype,`timeValue`,void 0),u([d()],H.prototype,`locale`,void 0),u([d()],H.prototype,`timezone`,void 0),u([d({attribute:`show-date`,converter:Os})],H.prototype,`showDate`,void 0),u([d({attribute:`show-time`,converter:Os})],H.prototype,`showTime`,void 0),u([d({type:Boolean,attribute:`show-timezone`})],H.prototype,`showTimezone`,void 0),u([d()],H.prototype,`min`,void 0),u([d()],H.prototype,`max`,void 0),u([d({attribute:`min-time`})],H.prototype,`minTime`,void 0),u([d({attribute:`max-time`})],H.prototype,`maxTime`,void 0),u([d({type:Number,attribute:`minute-increment`})],H.prototype,`minuteIncrement`,void 0),u([d({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],H.prototype,`disabledTimeRanges`,void 0),u([d({type:Boolean,attribute:`force-round-time`})],H.prototype,`forceRoundTime`,void 0),u([d({type:Boolean})],H.prototype,`disabled`,void 0),u([d({type:Boolean})],H.prototype,`readonly`,void 0),u([d({type:Boolean})],H.prototype,`required`,void 0),u([d({attribute:`described-by`})],H.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,H);var zs=class extends Si{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Bs=class extends Si{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Gr().msg(`lion-input-file:uploadTextDuplicateFileName`)}},Vs=524288e3,Hs={type:`FILE_TYPE`,size:`FILE_SIZE`},Us={fail:`FAIL`,pass:`SUCCESS`},Ws=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);zs.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Us.fail,this.failedProp.push(Hs.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;zs.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Us.fail,this.failedProp.push(Hs.type))}zs.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Us.fail&&(this.status=Us.pass):(this.status=Us.fail,this.failedProp.push(Hs.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Gs=e=>{switch(e){case`bg-BG`:return k(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return k(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return k(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return k(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return k(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return k(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return k(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return k(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return k(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return k(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return k(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return k(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return k(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return k(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return k(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return k(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return k(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return k(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return k(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return k(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return k(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return k(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return k(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return k(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return k(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return k(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return k(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return k(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return k(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return k(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return k(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return k(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return k(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return k(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return k(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return k(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},Ks=class extends ii(ui(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":xi}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Gs},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}_removeButtonContentTemplate(){return r`✖️`}_selectedListItemTemplate(e){let t=Fe();return r`
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},Ys=class extends Ks{static get styles(){return[...super.styles,a`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
...
`,Zs=class extends Js{static get styles(){return[...super.styles,br,Xs]}get slots(){return{...super.slots,"file-select-button":()=>r`<craft-button
      ...
      `]}constructor(){super(),g(this,nc),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,_(this,rc,()=>{this.modelValue=``,this.value=``,h(nc,this,ac).call(this)?.inputmask?.setValue(``),h(nc,this,ac).call(this)?.focus()}),this.type=`text`,this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&h(nc,this,sc).call(this),h(nc,this,ac).call(this)?.classList.toggle(`money-placeholder`,!h(nc,this,cc).call(this))}disconnectedCallback(){h(nc,this,ac).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?r`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${h(nc,this,oc).call(this).currency}`}</span
      >
      ...
      <craft-button
        ...
        icon
        aria-label=${O(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!h(nc,this,cc).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${v(rc,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function ac(){return this._inputNode}function oc(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function sc(){let e=h(nc,this,ac).call(this);if(!e)return;let t=String(this.modelValue??``),n=h(nc,this,oc).call(this);e.inputmask?.remove(),e.value=t,new ec({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function cc(){return this.modelValue!==``&&this.modelValue!=null}u([d()],ic.prototype,`currency`,void 0),u([d()],ic.prototype,`locale`,void 0),u([d({type:Number})],ic.prototype,`decimals`,void 0),u([d({attribute:`decimal-separator`})],ic.prototype,`decimalSeparator`,void 0),u([d({attribute:`group-separator`})],ic.prototype,`groupSeparator`,void 0),u([d({converter:tc,attribute:`show-currency`})],ic.prototype,`showCurrency`,void 0),u([d({converter:tc})],ic.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,ic);var lc=new WeakSet,uc=class extends zi{static get styles(){return[...super.styles,br,a`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),g(this,lc),this.passwordRules=``,this._visible=!1,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>r`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),h(lc,this,dc).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&h(lc,this,dc).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function dc(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}u([d({attribute:`passwordrules`})],uc.prototype,`passwordRules`,void 0),u([f()],uc.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,uc);var fc=class extends l{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return r`
  ...
  `,u([d()],fc.prototype,`error`,void 0),u([d({attribute:`plugin-name`})],fc.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,fc);var pc=a`
  :host {
    display: block;
    /*
...
`,mc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(mc);var hc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(hc);var gc=new Set([`clip`,`hidden`]),_c=class extends dr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=mc.Raised,this.variant=hc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!gc.has(n)&&e.scrollHeight-e.clientHeight>1||!gc.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};_c.styles=[_o,pc],u([d({reflect:!0})],_c.prototype,`appearance`,void 0),u([d({reflect:!0})],_c.prototype,`variant`,void 0),u([d()],_c.prototype,`label`,void 0),u([f()],_c.prototype,`_hasSlottedHeader`,void 0),u([f()],_c.prototype,`_hasSlottedFooter`,void 0),u([f()],_c.prototype,`_scrollable`,void 0),u([f()],_c.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,_c);var vc=0,yc=new WeakMap,U=new WeakSet,bc=class extends l{constructor(...e){super(...e),g(this,U),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,_(this,yc,++vc)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&h(U,this,jc).call(this)}render(){let e=h(U,this,Cc).call(this);return Ya(this.groups,e=>e.handle,(t,n)=>h(U,this,xc).call(this,t,n,e))}};function xc(e,t,n){let i=`permission-tree-heading-${v(yc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>h(U,this,Dc).call(this,e.keys,n)}
                >
                  ${h(U,this,Ec).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${h(U,this,Sc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function Sc(e,t,n,i){return Ya(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=h(U,this,Tc).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||h(U,this,wc).call(this,o,i)}
                @model-value-changed=${e=>h(U,this,Oc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?h(U,this,Sc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function Cc(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function wc(e,t){return t.has(e.toLowerCase())}function Tc(e,t){return this.modelValue.includes(e)||h(U,this,wc).call(this,e,t)}function Ec(e,t){let n=e.filter(e=>!h(U,this,wc).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function Dc(e,t){let n=e.filter(e=>!h(U,this,wc).call(this,e,t));if(h(U,this,Ec).call(this,e,t)){let e=new Set(n);h(U,this,Ac).call(this,this.modelValue.filter(t=>!e.has(t)));return}h(U,this,Ac).call(this,[...new Set([...this.modelValue,...n])])}function Oc(e,t,n,r){if(e.stopPropagation(),this.disabled||h(U,this,wc).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){h(U,this,Ac).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...h(U,this,kc).call(this,n)]);h(U,this,Ac).call(this,this.modelValue.filter(e=>!o.has(e)))}function kc(e){return Object.values(e).flatMap(e=>[e.key,...h(U,this,kc).call(this,e.nested??{})])}function Ac(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function jc(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;h(U,this,Mc).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&h(U,this,Mc).call(this,`${this.name}[]`,t)}function Mc(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}bc.styles=a`
    :host {
      display: block;
    }
  ...
  `,u([d({type:Array})],bc.prototype,`groups`,void 0),u([d({type:Array,attribute:`model-value`})],bc.prototype,`modelValue`,void 0),u([d({type:Array,attribute:`locked-permissions`})],bc.prototype,`lockedPermissions`,void 0),u([d()],bc.prototype,`name`,void 0),u([d({type:Boolean,reflect:!0})],bc.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,bc);var Nc=a`
  :host {
...
`,Pc=new WeakMap,Fc=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,_(this,Pc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&v(Pc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),y(Pc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,y(Pc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
      <div
        class=${x({"progress-bar":!0,"progress-bar--pending":this.pending})}
        part="track"
        role="progressbar"
      ...
      >
        <div
          class=${x({"progress-bar__fill":!0,"progress-bar__fill--smooth":this.smooth&&!this.pending})}
          part="fill"
          style=${ne(e)}
        ></div>
      </div>
    ...
    `}};Fc.styles=[Nc],u([d({type:Number})],Fc.prototype,`progress`,void 0),u([d({type:Number})],Fc.prototype,`total`,void 0),u([d({type:Number})],Fc.prototype,`processed`,void 0),u([d({type:Boolean,attribute:`show-status`})],Fc.prototype,`showStatus`,void 0),u([d({type:Boolean,reflect:!0})],Fc.prototype,`pending`,void 0),u([d({type:Boolean})],Fc.prototype,`smooth`,void 0),u([d({type:String})],Fc.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Fc);var Ic=class extends Ni(Li(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Lc=class extends Fi(zi){connectedCallback(){super.connectedCallback(),this.type=`radio`}},Rc=class extends Ic{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,br,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};u([d({type:Boolean,reflect:!0})],Rc.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,Rc);var zc=class extends Ui(Lc){static get styles(){return[...super.styles,a`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,zc);var Bc=a`
  craft-button {
    cursor: move;
  }
...
`,Vc=class extends l{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??O(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),i=t?n?`arrow-right`:`arrow-left`:`arrow-up`,a=t?n?`arrow-left`:`arrow-right`:`arrow-down`,o=O(t?`Move forward`:`Move up`),s=O(t?`Move backward`:`Move down`);return r`
    ...
    `}};Vc.styles=[Bc],u([d()],Vc.prototype,`label`,void 0),u([d({reflect:!0})],Vc.prototype,`position`,void 0),u([d({reflect:!0})],Vc.prototype,`orientation`,void 0),u([d({reflect:!0})],Vc.prototype,`variant`,void 0),u([d({reflect:!0,type:Boolean})],Vc.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,Vc);var Hc=class extends Pe(It){static get styles(){return[...super.styles,a`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,Kc=class extends Hc{static get styles(){return[...super.styles,Gc]}_afterTemplate(){return r`${this.singleOption?``:r`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},qc=a`
  ${yr}
...
`,Jc=class extends Wc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,qc]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":Kc}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return r`
    ...
    `}};u([d({reflect:!0,type:Boolean})],Jc.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,Jc);var Yc=a`
  :host {
    display: block;
  }
`;function Xc(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Zc=class extends l{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return r`<span
    ...
    ></span>`}_optionTemplate(e,t){return r`<craft-option .choiceValue=${e}>
      ...
      >
        ...
        ${qe.map(e=>this._optionTemplate(e,O(Xc(e))))}
      </craft-select-rich>
    `}};Zc.styles=[Yc],u([d()],Zc.prototype,`label`,void 0),u([d()],Zc.prototype,`name`,void 0),u([d({attribute:`model-value`})],Zc.prototype,`modelValue`,void 0),u([d({type:Boolean,reflect:!0,attribute:`allow-transparent`})],Zc.prototype,`allowTransparent`,void 0),customElements.get(`craft-select-color`)||customElements.define(`craft-select-color`,Zc);var Qc=class extends Oi{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>e.slot===`input`)}},$c=class extends Qc{get operationMode(){return`select`}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener(`change`,this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:`model`})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has(`disabled`)&&(this._inputNode.disabled=this.disabled,this.validate()),e.has(`name`)&&(this._inputNode.name=this.name),e.has(`autocomplete`)&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener(`change`,this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){let t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:``}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=this.modelValue===void 0?``:this.modelValue)}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent(`user-input-changed`,{bubbles:!0,composed:!0}))}},el=a`
  ${yr}
...
`,tl=class extends $c{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,el]}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};u([d({reflect:!0,type:Boolean})],tl.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,tl);var nl=a`
  :host {
    display: inline-block;
  }
...
`,W=new WeakSet,rl=class extends l{constructor(...e){super(...e),g(this,W),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=h(W,this,al).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=h(W,this,il).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${h(W,this,sl).call(this,this.value)}
      ...
      >
        ${e.map(e=>r`
            <span
              class=${x({"slide-picker__segment":!0,"is-active":e<=this.value,"is-last-active":e===this.value})}
              role="presentation"
              aria-hidden="true"
              @click=${()=>h(W,this,ll).call(this,e)}
              title=${h(W,this,sl).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function il(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function al(e){h(W,this,il).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function ol(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function sl(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function cl(e,t){let n=h(W,this,al).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function ll(e){this.readOnly||h(W,this,cl).call(this,e,!0)}function ul(e){if(this.readOnly)return;let t=h(W,this,ol).call(this);switch(e.key){case`ArrowUp`:h(W,this,cl).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:h(W,this,cl).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:h(W,this,cl).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:h(W,this,cl).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:h(W,this,cl).call(this,this.min,!0),e.preventDefault();break;case`End`:h(W,this,cl).call(this,this.max,!0),e.preventDefault();break}}rl.styles=[nl],u([d({type:Number})],rl.prototype,`min`,void 0),u([d({type:Number})],rl.prototype,`max`,void 0),u([d({type:Number})],rl.prototype,`step`,void 0),u([d({type:Number})],rl.prototype,`value`,void 0),u([d()],rl.prototype,`label`,void 0),u([d({attribute:`described-by`})],rl.prototype,`describedBy`,void 0),u([d({attribute:`value-unit`})],rl.prototype,`valueUnit`,void 0),u([d({attribute:!1})],rl.prototype,`valueLabel`,void 0),u([d({type:Boolean,reflect:!0,attribute:`read-only`})],rl.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,rl);var dl=a`
  :host {
    display: block;
  }
...
`,fl=new WeakMap,pl=new WeakMap,ml=new WeakMap,hl=new WeakMap,gl=new WeakMap,_l=new WeakMap,vl=new WeakMap,G=new WeakSet,yl=class extends l{constructor(...e){super(...e),g(this,G),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),_(this,fl,!1),_(this,pl,!1),_(this,ml,0),_(this,hl,0),_(this,gl,0),_(this,_l,!1),_(this,vl,null)}connectedCallback(){super.connectedCallback(),y(vl,this,new ResizeObserver(()=>h(G,this,xl).call(this))),v(vl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),v(vl,this)?.disconnect(),y(vl,this,null)}firstUpdated(){y(gl,this,(h(G,this,bl).call(this).length-1)*10),h(G,this,xl).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&h(G,this,xl).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${h(G,this,El).call(this,this.value)}
        @keydown=${h(G,this,Fl)}
        @pointerdown=${h(G,this,jl)}
        @pointermove=${h(G,this,Ml)}
        @pointerup=${h(G,this,Nl)}
      >
        ...
        <div class="graduations">
          ...
          ></div>
          <ul aria-hidden="true">
            ${h(G,this,bl).call(this).map(e=>r`
                <li
                  class=${x({graduation:!0,"main-graduation":e%5==0})}
                  data-graduation=${e}
                >
    ...
    `}};function bl(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function xl(){this._graduations?.offsetWidth&&h(G,this,wl).call(this),h(G,this,Cl).call(this),!(!this._list||!this._graduations?.offsetWidth)&&(this._list.style.transform=`translateX(${h(G,this,Ol).call(this,this.value)}px)`,h(G,this,Sl).call(this))}function Sl(){v(_l,this)||(y(_l,this,!0),requestAnimationFrame(()=>this._root?.classList.add(`placed`)))}function Cl(){if(!this._indicator)return;let e=(this.graduationMin-this.graduationMax)*-1,t=v(gl,this)/e;this._indicator.style.inlineSize=`${Math.abs(this.value)*t}px`,this._indicator.style.translate=this.value>0?`-100%`:`0`}function wl(){let e=h(G,this,bl).call(this).length,t=this._list.getBoundingClientRect().width/e;t>0&&y(gl,this,(e-1)*t)}function Tl(){let{transform:e}=getComputedStyle(this._list);return!e||e===`none`?0:new DOMMatrixReadOnly(e).m41}function El(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function Dl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/v(gl,this)*n-t}function Ol(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*v(gl,this)/n-this._graduations.offsetWidth/2)}function kl(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);n!==this.value&&(this.value=n,t&&h(G,this,Al).call(this,`change`))}function Al(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function jl(e){y(pl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),v(pl,this)&&(e.preventDefault(),y(ml,this,e.clientX),y(hl,this,h(G,this,Tl).call(this)),this._root.setPointerCapture(e.pointerId),h(G,this,Al).call(this,`start`))}function Ml(e){v(pl,this)&&Math.abs(e.clientX-v(ml,this))>3&&(y(fl,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),h(G,this,Pl).call(this,e))}function Nl(e){v(pl,this)&&(v(fl,this)?(e.preventDefault(),y(fl,this,!1),this._root.classList.remove(`dragging`)):h(G,this,Pl).call(this,e),h(G,this,Al).call(this,`end`),this._root.releasePointerCapture(e.pointerId),y(ml,this,0),y(pl,this,!1))}function Pl(e){let t=v(fl,this)?v(ml,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=v(fl,this)?t-e.clientX:e.clientX-t,r=v(hl,this)-n;h(G,this,kl).call(this,h(G,this,Dl).call(this,r))}function Fl(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:h(G,this,kl).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:h(G,this,kl).call(this,t-1);break;case`PageUp`:h(G,this,kl).call(this,t+10);break;case`PageDown`:h(G,this,kl).call(this,t-10);break;case`Home`:h(G,this,kl).call(this,this.min);break;case`End`:h(G,this,kl).call(this,this.max);break;default:return}e.preventDefault()}yl.styles=[dl],u([d({type:Number})],yl.prototype,`min`,void 0),u([d({type:Number})],yl.prototype,`max`,void 0),u([d({type:Number})],yl.prototype,`value`,void 0),u([d({type:Number,attribute:`graduation-min`})],yl.prototype,`graduationMin`,void 0),u([d({type:Number,attribute:`graduation-max`})],yl.prototype,`graduationMax`,void 0),u([d()],yl.prototype,`label`,void 0),u([m(`.slide-rule`)],yl.prototype,`_root`,void 0),u([m(`.graduations`)],yl.prototype,`_graduations`,void 0),u([m(`.graduations ul`)],yl.prototype,`_list`,void 0),u([m(`.cursor`)],yl.prototype,`_cursor`,void 0),u([m(`.indicator`)],yl.prototype,`_indicator`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,yl);var Il=a`
  :host {
    display: inline-flex;
...
`,Ll=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      <span
        class="${x({status:!0,"status--live":this.status===`live`,"status--enabled":this.status===`enabled`,"status--pending":this.status===`pending`,"status--expired":this.status===`expired`,"status--disabled":this.status===`disabled`})}"
        role="img"
        aria-label="${this.getLabel()}"
      ></span>
    `}};Ll.styles=[Il],u([d()],Ll.prototype,`label`,void 0),u([d()],Ll.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Ll);var Rl=class extends be(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},Bl=class extends Rl{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};u([d({type:Boolean,reflect:!0})],Bl.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,Bl);var Vl=a`
  :host {
    display: grid;
  }
...
`;function Hl(e){return(e??``).split(/\s+/).filter(Boolean)}function Ul(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Wl=Symbol.for(`craft-switch-synthetic-change`),Gl=new WeakMap,Kl=new WeakSet,ql=class extends zl{constructor(...e){super(...e),g(this,Kl),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,_(this,Gl,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,yr,Vl]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Bl}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?O(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?O(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){h(Kl,this,Jl).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){h(Kl,this,Jl).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){h(Kl,this,Jl).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(v(Gl,this))return;let e=new Event(`change`,{bubbles:!0});e[Wl]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Wl in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of Hl(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of Hl(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Ul(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
    ...
    `}};function Jl(e,t){if(!this.disabled){if(!t){e();return}y(Gl,this,!0),e(),this.updateComplete.then(()=>{y(Gl,this,!1)})}}u([d({type:String,reflect:!0})],ql.prototype,`size`,void 0),u([d({type:String,attribute:`on-label`})],ql.prototype,`onLabel`,void 0),u([d({type:String,attribute:`off-label`})],ql.prototype,`offLabel`,void 0),u([d({attribute:`value`})],ql.prototype,`checkedValue`,void 0),u([d({attribute:`indeterminate-value`})],ql.prototype,`indeterminateValue`,void 0),u([d({type:Boolean,reflect:!0})],ql.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,ql);function Yl({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function Xl(e){e.setAttribute(`selected`,`true`)}function Zl(e){e.removeAttribute(`selected`)}function Ql({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function $l({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function eu(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function tu(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function nu(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var ru=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,au={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(au);var ou={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(ou);var su=[au.InlineStart,au.InlineEnd],cu=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),K=new WeakSet,lu=new WeakMap,uu=new WeakMap,du=new WeakMap,fu=new WeakMap,pu=new WeakMap,mu=new WeakMap,hu=new WeakMap,gu=new WeakMap,_u=new WeakMap,vu=new WeakMap,yu=new WeakMap,bu=class extends ru{constructor(...e){super(...e),g(this,K),this.placement=au.BlockStart,this.collapsible=!1,this.size=`medium`,_(this,lu,[]),_(this,uu,!1),_(this,du,[]),_(this,fu,0),_(this,pu,void 0),_(this,mu,!1),_(this,hu,e=>{if(!this.collapsible||Su.call(h(K,this)))return;let t=h(K,this,Eu).call(this,e.target);!t||t.disabled||Cu.call(h(K,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),h(K,this,Du).call(this,!0))}),_(this,gu,e=>{e.key!==`Escape`||!this.collapsible||Su.call(h(K,this))||h(K,this,Eu).call(this,e.target)&&(e.stopPropagation(),h(K,this,Du).call(this,!0))}),_(this,_u,()=>{Su.call(h(K,this))&&(Cu.call(h(K,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),h(K,this,Ou).call(this)}),_(this,vu,()=>{if(h(K,this,ku).call(this),Cu.call(h(K,this)).forEach((e,t)=>{let n=()=>h(K,this,Lu).call(this,t,!0),r=e=>{cu.has(e.key)&&e.preventDefault()},i=e=>h(K,this,Ru).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),v(lu,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),Cu.call(h(K,this))[this.selectedIndex]?.disabled){let e=Cu.call(h(K,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}h(K,this,Au).call(this)}),_(this,yu,()=>{v(mu,this)||(y(mu,this,!0),requestAnimationFrame(()=>{y(mu,this,!1),h(K,this,Mu).call(this)}))})}static get styles(){return[...super.styles,_o,iu]}get layout(){return xu.call(h(K,this))?ou.Vertical:ou.Horizontal}set layout(e){this.placement=e===ou.Vertical?au.InlineStart:au.BlockStart}refresh(){v(uu,this)&&h(K,this,Au).call(this),h(K,this,Mu).call(this)}firstUpdated(e){y(uu,this,Cu.call(h(K,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(v(uu,this))t?.addEventListener(`slotchange`,v(vu,this)),v(vu,this).call(this);else{let n=Su.call(h(K,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,v(_u,this))}this.addEventListener(`click`,v(hu,this),!0),this.addEventListener(`keydown`,v(gu,this)),t?.addEventListener(`slotchange`,v(yu,this)),y(pu,this,new ResizeObserver(v(yu,this))),v(pu,this).observe(this),h(K,this,Mu).call(this)}disconnectedCallback(){super.disconnectedCallback(),h(K,this,ku).call(this),v(pu,this)?.disconnect(),y(pu,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,Su.call(h(K,this))),e.has(`selectedIndex`)&&(v(uu,this)?h(K,this,Au).call(this):v(_u,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&h(K,this,Mu).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${xu.call(h(K,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${Su.call(h(K,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function xu(){return su.includes(this.placement)}function Su(){return this.selectedIndex<0}function Cu(){return this.tabs}function wu(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function Tu(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function Eu(e){return e instanceof Node?Cu.call(h(K,this)).find(t=>t===e||t.contains(e))??null:null}function Du(e){let t=Cu.call(h(K,this))[this.selectedIndex];y(fu,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Ou(){let e=Cu.call(h(K,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(v(fu,this))?v(fu,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function ku(){for(;v(lu,this).length;)v(lu,this).pop()?.()}function Au(){let e=Cu.call(h(K,this)).map(e=>h(K,this,ju).call(this,e)),t=e.some(Boolean);Cu.call(h(K,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Fe()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),h(K,this,Ou).call(this)}function ju(e){return e.controls?document.getElementById(e.controls):null}function Mu(){let e=wu.call(h(K,this)),t=Tu.call(h(K,this)),n=Cu.call(h(K,this));if(!e||!t)return;if(xu.call(h(K,this))||n.length===0){h(K,this,Pu).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=h(K,this,Nu).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){h(K,this,Pu).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);h(K,this,Pu).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Nu(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function Pu(e){let t=Tu.call(h(K,this)),n=new Set(e);Cu.call(h(K,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),y(du,this,e),t&&(t.hidden=e.length===0,t.actions=h(K,this,Fu).call(this))}function Fu(){return v(du,this).map(e=>{let t=Cu.call(h(K,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>h(K,this,Iu).call(this,e)}})}function Iu(e){let t=Cu.call(h(K,this))[e];if(!t||t.disabled)return;let n=Tu.call(h(K,this));n&&(n.opened=!1),this.selectedIndex=e,h(K,this,Mu).call(this),t.focus()}function Lu(e,t){let n=Cu.call(h(K,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Ru(e){if(!cu.has(e.key))return;let t=h(K,this,zu).call(this,e.key);t!==-1&&h(K,this,Lu).call(this,t,!0)}function zu(e){let t=Cu.call(h(K,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(Su.call(h(K,this)))return h(K,this,zu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}u([d({reflect:!0})],bu.prototype,`placement`,void 0),u([d({type:Boolean,reflect:!0})],bu.prototype,`collapsible`,void 0),u([d({reflect:!0})],bu.prototype,`layout`,null),u([d({reflect:!0})],bu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,bu);var Bu=a`
  :host {
    display: inline-flex;
...
`,Xu=new WeakMap,Zu=new WeakMap,Qu=new WeakMap,$u=new WeakSet,ed=class extends Ju{constructor(...e){super(...e),g(this,$u),this.monospace=!1,_(this,Xu,void 0),_(this,Zu,void 0),_(this,Qu,null)}static get styles(){return[...super.styles,br,Yu]}connectedCallback(){super.connectedCallback(),h($u,this,td).call(this)}disconnectedCallback(){super.disconnectedCallback(),v(Xu,this)?.disconnect(),y(Xu,this,void 0),v(Zu,this)?.disconnect(),y(Zu,this,void 0)}};function td(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(y(Qu,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{y(Qu,this,e.style.height)}),y(Zu,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),v(Zu,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),y(Xu,this,new ResizeObserver(()=>{if(e.style.height===v(Qu,this))return;let t=e.style.height;Ku.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),v(Zu,this)?.disconnect(),y(Zu,this,void 0),v(Xu,this)?.disconnect(),y(Xu,this,void 0)})),v(Xu,this).observe(e))}u([d({type:Boolean,reflect:!0})],ed.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,ed);var nd=a`
  :host {
    display: block;
    min-width: 0;
  }
...
`,rd=class extends l{constructor(...e){super(...e),this.last=!1,this._hasHeading=!1,this._hasMeta=!1,this._hasBody=!1,this._hasFooter=!1,this._lightDomObserver=new MutationObserver(()=>this._syncSlotPresence())}connectedCallback(){super.connectedCallback(),this._syncSlotPresence(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,attributes:!0,characterData:!0,attributeFilter:[`slot`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect()}_syncSlotPresence(){this._hasHeading=!!this.querySelector(`:scope > [slot="heading"]`),this._hasMeta=!!this.querySelector(`:scope > [slot="meta"]`),this._hasBody=[...this.childNodes].some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e instanceof HTMLElement&&!e.slot),this._hasFooter=!!this.querySelector(`:scope > [slot="footer"]`)}render(){return r`
    ...
    `}};rd.styles=[nd],u([d({type:Boolean,reflect:!0})],rd.prototype,`last`,void 0),u([f()],rd.prototype,`_hasHeading`,void 0),u([f()],rd.prototype,`_hasMeta`,void 0),u([f()],rd.prototype,`_hasBody`,void 0),u([f()],rd.prototype,`_hasFooter`,void 0),customElements.get(`craft-timeline-item`)||customElements.define(`craft-timeline-item`,rd);var id=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>ad(e,this),this.compositionEventHandler=e=>dd(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,od),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,od)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(ud)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(ud)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(ud),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),ld(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function ad(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:sd(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&sd(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function od(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&cd(t,{event:e})}function sd(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function cd(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function ld(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function ud(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function dd(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var fd=class extends Event{constructor(){super(`update`)}},pd=new WeakMap,md=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=pd.get(t);return n||(n=new e(t),pd.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),pd.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new fd)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of hd)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},hd=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),gd=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return md.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},_d=a`
  :host {
    display: contents;
  }
...
`,vd=/^[\p{L}\p{N}_.-]*$/u,yd=O(`Suggestions`),bd=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],xd={handlesAccessibility:!1,visibilityTriggerFunction:void 0},Sd=0,q=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,J=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Y=new WeakSet,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Bd=new WeakMap,Vd=new WeakMap,Hd=new WeakMap,Ud=new WeakMap,Wd=new WeakMap,Gd=new WeakMap,Kd=class extends l{constructor(...e){super(...e),g(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,_(this,q,void 0),_(this,Cd,null),_(this,wd,null),_(this,Td,new Map),_(this,J,null),_(this,Ed,[]),_(this,Dd,0),_(this,Od,null),_(this,kd,null),_(this,Ad,null),_(this,jd,!1),_(this,Md,null),_(this,Nd,new DOMRect),_(this,Pd,new MutationObserver(()=>{let e=h(Y,this,Jd).call(this);(_f(e)&&e!==v(Cd,this)||v(Cd,this)&&!v(Cd,this).isConnected)&&h(Y,this,Yd).call(this)})),_(this,Fd,()=>{v(jd,this)||h(Y,this,nf).call(this)}),_(this,Id,()=>{y(jd,this,!0),h(Y,this,df).call(this)}),_(this,Ld,()=>{y(jd,this,!1),h(Y,this,nf).call(this)}),_(this,Rd,()=>{queueMicrotask(()=>h(Y,this,df).call(this))}),_(this,zd,()=>{let e=v(Cd,this);!e||!v(J,this)||!vf(e)||queueMicrotask(()=>{v(J,this)&&(e.selectionStart!==v(J,this).end||e.selectionEnd!==v(J,this).end)&&h(Y,this,nf).call(this)})}),_(this,Bd,()=>{v(J,this)&&h(Y,this,uf).call(this)}),_(this,Vd,e=>{let t=e;v(J,this)&&v(q,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),_(this,Hd,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),_(this,Ud,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),_(this,Wd,e=>{h(Y,this,sf).call(this,Number(e.target.dataset.index))}),_(this,Gd,e=>{if(e.target!==this.popoverElement)return;let t=v(q,this).getAttribute(`aria-label`)??yd;h(Y,this,mf).call(this),y(J,this,null),h(Y,this,pf).call(this),h(Y,this,hf).call(this,t===yd?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),h(Y,this,qd).call(this),this.hasUpdated&&h(Y,this,Yd).call(this)}disconnectedCallback(){h(Y,this,Zd).call(this),v(q,this)?.remove(),v(Ad,this)!==null&&(clearTimeout(v(Ad,this)),y(Ad,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),h(Y,this,Yd).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&v(Cd,this)!==h(Y,this,Jd).call(this)&&h(Y,this,Yd).call(this),e.has(`triggers`)&&e.get(`triggers`)&&v(J,this)){let e=v(q,this).querySelector(`[aria-selected="true"]`),t=e?v(Ed,this)[Number(e.dataset.index)]:void 0;h(Y,this,nf).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${xd}
        @craft-hide=${v(Gd,this)}
      >
    ...
    `}};function qd(){y(q,this,document.createElement(`div`)),v(q,this).id=`craft-text-expander-listbox-${++Sd}`,v(q,this).slot=`listbox`,v(q,this).setAttribute(`part`,`listbox`),v(q,this).role=`listbox`,v(q,this).setAttribute(`aria-label`,yd),v(q,this).addEventListener(`pointerdown`,v(Hd,this)),v(q,this).addEventListener(`pointerup`,v(Ud,this)),v(q,this).addEventListener(`combobox-commit`,v(Wd,this)),this.append(v(q,this))}function Jd(){return this.getRootNode().getElementById(this.for)}function Yd(){let e=h(Y,this,Jd).call(this);if(h(Y,this,Zd).call(this),!_f(e)){h(Y,this,Xd).call(this);return}y(Cd,this,e),h(Y,this,Qd).call(this,e),y(wd,this,new id(e,v(q,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),h(Y,this,$d).call(this,e),e.addEventListener(`input`,v(Fd,this)),e.addEventListener(`keydown`,v(Vd,this)),e.addEventListener(`blur`,v(Rd,this)),e.addEventListener(`compositionstart`,v(Id,this)),e.addEventListener(`compositionend`,v(Ld,this)),e.ownerDocument.addEventListener(`selectionchange`,v(zd,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>v(Nd,this)},h(Y,this,Xd).call(this)}function Xd(){v(Pd,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function Zd(){v(Pd,this).disconnect(),h(Y,this,df).call(this);let e=v(Cd,this);e&&(e.removeEventListener(`input`,v(Fd,this)),e.removeEventListener(`keydown`,v(Vd,this)),e.removeEventListener(`blur`,v(Rd,this)),e.removeEventListener(`compositionstart`,v(Id,this)),e.removeEventListener(`compositionend`,v(Ld,this)),e.ownerDocument.removeEventListener(`selectionchange`,v(zd,this)),v(Md,this)?.getStyleClone().disconnect(),y(Md,this,null),v(wd,this)?.destroy(),y(wd,this,null),h(Y,this,ef).call(this,e),y(Cd,this,null))}function Qd(e){v(Td,this).clear();for(let t of bd)v(Td,this).set(t,e.getAttribute(t))}function $d(e){let t=[v(Td,this).get(`aria-controls`),v(q,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):h(Y,this,tf).call(this,e,`aria-haspopup`),h(Y,this,tf).call(this,e,`aria-expanded`)}function ef(e){for(let t of bd)h(Y,this,tf).call(this,e,t);v(Td,this).clear()}function tf(e,t){let n=v(Td,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function nf(e){h(Y,this,mf).call(this);let t=h(Y,this,af).call(this);if(!t){y(J,this,null),h(Y,this,ff).call(this);return}y(J,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));h(Y,this,of).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,h(Y,this,of).call(this,[]),h(Y,this,hf).call(this,O(`Loading`));let r=v(Dd,this);y(kd,this,setTimeout(()=>{h(Y,this,rf).call(this,t,n,r,e)},150))}async function rf(e,t,n,r){y(Od,this,new AbortController);let i;try{let n=await b.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:v(Od,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==v(Dd,this)||yf(t))return;h(Y,this,df).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===v(Dd,this)&&(this.loading=!1,h(Y,this,of).call(this,t===void 0?i:i.slice(0,t),r))}function af(){let e=v(Cd,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!vf(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&vd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function of(e,t){if(h(Y,this,lf).call(this),y(Ed,this,e),v(q,this).replaceChildren(),v(q,this).hidden=this.loading,v(q,this).setAttribute(`aria-label`,v(J,this)?.trigger.label??yd),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=gf(e);n.id=`${v(q,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(v(J,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),v(q,this).append(n)}),!this.loading&&!e.length){y(J,this,null),h(Y,this,ff).call(this),h(Y,this,hf).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{v(J,this)&&h(Y,this,cf).call(this,t)})}function sf(e){let t=v(Cd,this),n=v(Ed,this)[e],r=h(Y,this,af).call(this),i=v(J,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){h(Y,this,df).call(this);return}bf(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};h(Y,this,df).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function cf(e){await this.popoverElement.updateComplete;let t=v(Cd,this);if(!t||!h(Y,this,uf).call(this)){h(Y,this,df).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!v(J,this)||t!==v(Cd,this))&&v(Ed,this).length&&(v(wd,this)?.start(),h(Y,this,tf).call(this,t,`aria-expanded`),t.removeEventListener(`input`,v(Fd,this)),t.addEventListener(`input`,v(Fd,this)),e)){let t=v(Ed,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)v(wd,this)?.navigate(1)}}function lf(){v(wd,this)?.stop(),v(Cd,this)&&h(Y,this,tf).call(this,v(Cd,this),`aria-expanded`)}function uf(){let e=v(Cd,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!v(Md,this)){y(Md,this,new gd(e));let t=v(Md,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,v(Bd,this))}return v(Md,this).setStartOffset(t),v(Md,this).setEndOffset(t),y(Nd,this,v(Md,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function df(){h(Y,this,mf).call(this),y(J,this,null),h(Y,this,ff).call(this)}function ff(){h(Y,this,pf).call(this),this.popoverElement.hide()}function pf(){this.loading=!1,h(Y,this,lf).call(this),y(Ed,this,[]),v(q,this)?.replaceChildren(),v(q,this)&&(v(q,this).hidden=!1);let e=v(Cd,this);e&&(h(Y,this,tf).call(this,e,`aria-activedescendant`),h(Y,this,tf).call(this,e,`aria-busy`))}function mf(){var e;y(Dd,this,(e=v(Dd,this),e++,e)),v(kd,this)&&(clearTimeout(v(kd,this)),y(kd,this,null)),v(Od,this)?.abort(),y(Od,this,null)}function hf(e){v(Ad,this)!==null&&(clearTimeout(v(Ad,this)),y(Ad,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),y(Ad,this,setTimeout(()=>{y(Ad,this,null),this.announcement=``},5e3))}Kd.styles=[Tt,_d],u([d({reflect:!0})],Kd.prototype,`for`,void 0),u([d({type:Array})],Kd.prototype,`triggers`,void 0),u([f()],Kd.prototype,`loading`,void 0),u([f()],Kd.prototype,`announcement`,void 0),u([m(`craft-popover`)],Kd.prototype,`popoverElement`,void 0);function gf(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function _f(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function vf(e){return e.getRootNode().activeElement===e}function yf(e){return e instanceof DOMException&&e.name===`AbortError`}function bf(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Kd);var xf=a`
  :host {
    display: inline-flex;
...
`,Sf=new WeakMap,Cf=new WeakSet,wf=class extends l{constructor(...e){super(...e),g(this,Cf),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,_(this,Sf,typeof ResizeObserver<`u`?new ResizeObserver(()=>h(Cf,this,Tf).call(this)):null)}connectedCallback(){super.connectedCallback(),v(Sf,this)?.observe(this)}disconnectedCallback(){v(Sf,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){h(Cf,this,Tf).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${h(Cf,this,Ef)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function Tf(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function Ef(){h(Cf,this,Tf).call(this)}wf.styles=xf,u([d({reflect:!0})],wf.prototype,`placement`,void 0),u([d({type:Boolean,reflect:!0})],wf.prototype,`disabled`,void 0),u([f()],wf.prototype,`overflowing`,void 0),u([f()],wf.prototype,`text`,void 0),u([m(`.truncate`)],wf.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,wf);var Df=a`
  :host {
...
`,Of={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},kf=class e extends l{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1,this.animated=!1,this.frozen=!1,this.capturedFrame=null,this.resizeObserver=null}get isAnimated(){return this.animated||e.animatedExtensionPattern.test(this.src??``)||e.animatedExtensionPattern.test(this.srcset??``)}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}willUpdate(e){if((e.has(`src`)||e.has(`srcset`)||e.has(`animated`))&&(this.frozen=!1,this.capturedFrame=null,this.resizeObserver?.disconnect(),this.resizeObserver=null,!e.has(`src`))){let e=this.shadowRoot?.querySelector(`img`);e?.complete&&this.attemptFreeze(e)}}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs(),this.resizeObserver?.disconnect()}render(){return r`
      <div class="${x({thumbnail:!0,"thumbnail--checkered":this.checkered,"thumbnail--rounded":this.rounded,"thumbnail--crop":this.mode===`crop`,"thumbnail--stretch":this.mode===`stretch`})}" part="thumbnail">
        ${this.src?r`<img
              class="${x({thumbnail__image:!0,"cp-visually-hidden":this.frozen})}"
              part="image"
              src="${this.src}"
            ...
            />`:c}
        ${this.src&&this.isAnimated?r`<canvas
              class="${x({thumbnail__cover:!0,"thumbnail__cover--pending":!this.frozen})}"
              part="cover"
              aria-hidden="true"
              role="presentation"
            ></canvas>`:c}
    ...
    `}freezeFrame(e){this.attemptFreeze(e.target)}attemptFreeze(e){if(!this.isAnimated||!e.currentSrc)return;let t=new Image;t.onload=()=>{this.capturedFrame=t,this.resizeObserver?.disconnect(),this.resizeObserver=new ResizeObserver(()=>{this.capturedFrame&&this.paintCover(this.capturedFrame,e)}),this.resizeObserver.observe(e)},t.src=e.currentSrc}paintCover(e,t){if(!e.naturalWidth||!e.naturalHeight)return;let n=this.shadowRoot?.querySelector(`canvas.thumbnail__cover`),r=n?.getContext(`2d`);if(!r)return;let i=t.clientWidth,a=t.clientHeight;if(!i||!a)return;let o=window.devicePixelRatio||1;if(n.width=i*o,n.height=a*o,n.style.width=`${i}px`,n.style.height=`${a}px`,r.scale(o,o),this.mode===`crop`){let t=Math.max(i/e.naturalWidth,a/e.naturalHeight),n=i/t,o=a/t;r.drawImage(e,(e.naturalWidth-n)/2,(e.naturalHeight-o)/2,n,o,0,0,i,a)}else r.drawImage(e,0,0,i,a);this.frozen=!0}};kf.styles=[Tt,Df],kf.animatedExtensionPattern=/\.(?:gif|webp)(?=[?#\s,]|$)/i,u([d()],kf.prototype,`src`,void 0),u([d({reflect:!0})],kf.prototype,`mode`,void 0),u([d()],kf.prototype,`srcset`,void 0),u([d()],kf.prototype,`sizes`,void 0),u([d()],kf.prototype,`alt`,void 0),u([d({type:Number})],kf.prototype,`width`,void 0),u([d({type:Number})],kf.prototype,`height`,void 0),u([d()],kf.prototype,`loading`,void 0),u([d({reflect:!0,converter:Of})],kf.prototype,`checkered`,void 0),u([d({type:Boolean,reflect:!0})],kf.prototype,`rounded`,void 0),u([d({type:Boolean,reflect:!0})],kf.prototype,`animated`,void 0),u([f()],kf.prototype,`frozen`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,kf);var Af=new WeakMap,jf=new WeakSet,Mf=class extends HTMLElement{constructor(...e){super(...e),g(this,jf),_(this,Af,null)}connectedCallback(){h(jf,this,Nf).call(this)}disconnectedCallback(){v(Af,this)?.destroy(),y(Af,this,null)}};function Nf(){if(!(v(Af,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>h(jf,this,Nf).call(this));return}y(Af,this,new ga),v(Af,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Mf);function Pf(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function Ff(e={}){let t=Pf({...e,type:`submit`,label:e.label||O(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function If(e={}){let t=Pf({...e,icon:`duplicate`,label:e.label||pa(O(`Paste {type}`,{type:O(`elements`)}))});return t.classList.add(`paste-btn`),t}var Lf=async(e,t)=>{let{data:n}=await b.post(e,t);return n},Rf=new WeakMap,zf=new WeakMap,Bf=new WeakMap,Vf=new WeakMap,Hf=new WeakMap,Uf=new WeakMap,Wf=new WeakMap,Gf=new WeakMap,Kf=new WeakMap,qf=new WeakMap,X=new WeakSet,Jf=class e{constructor(t){g(this,X),_(this,Rf,null),_(this,zf,[]),_(this,Bf,[]),_(this,Vf,null),_(this,Hf,!1),_(this,Uf,!1),_(this,Wf,!1),_(this,Gf,null),_(this,Kf,void 0),_(this,qf,new Map),this.options={...e.defaults,modalTitle:O(`Select element`),selectBtnLabel:O(`Select`),...$f(t)},y(Bf,this,[...this.options.disabledElementIds??[]]),y(Kf,this,h(X,this,Yf).call(this))}get elementType(){return this.options.elementType}get state(){return v(Kf,this)}get index(){return v(Rf,this)}get hasSelection(){return v(zf,this).length>0}on(e,t){let n=v(qf,this).get(e);return n||(n=new Set,v(qf,this).set(e,n)),n.add(t),()=>{v(qf,this).get(e)?.delete(t)}}async open(){y(zf,this,[]),v(Rf,this)?.clearSelection(),v(Hf,this)||(y(Hf,this,!0),h(X,this,Qf).call(this,`open`,void 0)),h(X,this,Xf).call(this),v(Vf,this)||await this.reload()}close(){v(Hf,this)&&(y(Hf,this,!1),h(X,this,Qf).call(this,`close`,void 0),this.options.onClose?.(),h(X,this,Xf).call(this))}destroy(){v(Rf,this)?.destroy?.(),y(Rf,this,null),y(zf,this,[]),y(Vf,this,null),y(Hf,this,!1),y(Wf,this,!1),y(Uf,this,!1),y(Gf,this,null),h(X,this,Xf).call(this),v(qf,this).clear()}async reload(){let e=this.options.loadIndexBody??Lf;y(Uf,this,!0),y(Gf,this,null),h(X,this,Xf).call(this);try{y(Vf,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){h(X,this,Zf).call(this,e)}finally{y(Uf,this,!1),h(X,this,Xf).call(this)}}async submit(){if(!v(Kf,this).canSubmit)return;let e=this.buildElementInfo(v(zf,this)),t=this.selectMeta();y(Wf,this,!0),h(X,this,Xf).call(this);try{h(X,this,Qf).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){h(X,this,Zf).call(this,e);return}finally{y(Wf,this,!1),h(X,this,Xf).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...v(Bf,this),...e.map(e=>Number(e.id))]),v(Rf,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){v(Kf,this).canCancel&&(h(X,this,Qf).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){y(Rf,this,e),h(X,this,Xf).call(this)}detachIndex(){y(Rf,this,null),h(X,this,Xf).call(this)}setSelection(e){y(zf,this,[...e]),h(X,this,Xf).call(this)}setDisabledElementIds(e){y(Bf,this,[...new Set(e.map(Number))]),h(X,this,Xf).call(this)}setBusy(e){y(Wf,this,e),h(X,this,Xf).call(this)}indexParams(){let{options:e}=this,t={context:e.context??`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition,criteria:{...e.criteria}};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),e.criteria&&(t.criteria={...e.criteria}),typeof e.indexSettings.showFolders==`boolean`&&(t.showFolders=e.indexSettings.showFolders),t}indexSettings(){let{options:e}=this;return{context:e.context??`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...v(Bf,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return v(zf,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){h(X,this,Xf).call(this)}get selection(){return v(zf,this)}get disabledElementIds(){return v(Bf,this)}};function Yf(){let e=v(Wf,this),t=v(Uf,this);return Object.freeze({open:v(Hf,this),loading:t,busy:e,selection:Object.freeze([...v(zf,this)]),disabledElementIds:Object.freeze([...v(Bf,this)]),indexBody:v(Vf,this),error:v(Gf,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function Xf(){y(Kf,this,h(X,this,Yf).call(this)),h(X,this,Qf).call(this,`change`,v(Kf,this))}function Zf(e){y(Gf,this,e instanceof Error?e:Error(String(e??`Unknown`))),h(X,this,Qf).call(this,`error`,v(Gf,this))}function Qf(e,t){let n=v(qf,this).get(e);n&&[...n].forEach(e=>e(t))}Jf.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function $f(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var ep=async(e,t)=>{let{data:n}=await b.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},tp=new WeakMap,np=class e extends Jf{constructor(e){super(e),_(this,tp,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??ep;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}y(tp,this,t);try{await this.submit()}finally{y(tp,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!v(tp,this))return n;let r=e.transformUrls[v(tp,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:v(tp,this)}}};np.transformUrls={};var rp=`CraftCms\\Cms\\Asset\\Elements\\Asset`,ip=new WeakSet,ap=class extends Jf{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:rp,showSiteMenu:!1}),g(this,ip),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:h(ip,this,op).call(this),status:null,url:null,hasThumb:!1}]}};function op(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var sp=new Map;function cp(e,t){if(sp.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);sp.set(e,t)}function lp(e){return sp.has(e)}function up(e){return sp.get(e)??Jf}function dp(e){return new(up(e.elementType))(e)}function fp(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))sp.has(t)||sp.set(t,n)}var pp={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},mp=new WeakMap,hp=new WeakMap,gp=new WeakMap,_p=new WeakMap,vp=new WeakMap,yp=new WeakMap,bp=new WeakMap,Z=new WeakSet,xp=class{constructor(e={}){g(this,Z),_(this,mp,new Map),_(this,hp,null),_(this,gp,0),_(this,_p,[]),_(this,vp,[]),_(this,yp,new Set),_(this,bp,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)v(mp,this).set(e.id,e);r&&(h(Z,this,Tp).call(this),v(hp,this)!==null&&h(Z,this,Ep).call(this))}getSessions(){return Array.from(v(mp,this).values())}getCurrentSessionId(){return v(hp,this)}isProcessing(){return v(gp,this)>0}on(e,t){return v(bp,this).has(e)||v(bp,this).set(e,new Set),v(bp,this).get(e).add(t),()=>{v(bp,this).get(e)?.delete(t)}}async startIndexing(e){let t=await b.post(pp.START,e),{data:n}=t;return n.session&&(v(mp,this).set(n.session.id,n.session),y(hp,this,n.session.id),h(Z,this,Cp).call(this),n.stop||h(Z,this,Ep).call(this)),n.stop&&h(Z,this,wp).call(this,n.stop),t}stopSession(e){h(Z,this,Dp).call(this,e),h(Z,this,Op).call(this,{sessionId:e,action:pp.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){h(Z,this,Op).call(this,{sessionId:e,action:pp.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){h(Z,this,Op).call(this,{sessionId:e.sessionId,action:pp.FINISH,params:e,priority:!0})}destroy(){v(mp,this).clear(),y(_p,this,[]),y(vp,this,[]),v(bp,this).clear(),y(hp,this,null),y(gp,this,0)}};function Sp(e,t){v(bp,this).get(e)?.forEach(e=>e(t))}function Cp(e){h(Z,this,Sp).call(this,`change`,{sessions:this.getSessions(),currentSessionId:v(hp,this),reviewSessionId:e})}function wp(e){v(mp,this).delete(e),v(hp,this)===e&&y(hp,this,null),h(Z,this,Cp).call(this)}function Tp(){for(let[e,t]of v(mp,this))if(!t.actionRequired&&!v(yp,this).has(e)){y(hp,this,e);return}y(hp,this,null)}function Ep(){if(v(hp,this)||h(Z,this,Tp).call(this),!v(hp,this))return;let e=v(mp,this).get(v(hp,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-v(gp,this),r=Math.min(n,t);for(let t=0;t<r;t++)h(Z,this,Op).call(this,{sessionId:e.id,action:pp.PROCESS,params:{sessionId:v(hp,this)},priority:!1});e.processIfRootEmpty&&h(Z,this,Op).call(this,{sessionId:e.id,action:pp.PROCESS,params:{sessionId:v(hp,this)},priority:!1})}function Dp(e){v(yp,this).add(e),y(_p,this,v(_p,this).filter(t=>t.sessionId!==e))}function Op(e){e.priority?v(vp,this).push(e):v(_p,this).push(e),h(Z,this,kp).call(this)}function kp(){if(!(v(_p,this).length+v(vp,this).length===0||v(gp,this)>=this.maxConcurrentConnections))for(;v(_p,this).length+v(vp,this).length>0&&v(gp,this)<this.maxConcurrentConnections;){var e;y(gp,this,(e=v(gp,this),e++,e));let t=v(vp,this).length>0?v(vp,this).shift():v(_p,this).shift();h(Z,this,Ap).call(this,t)}}async function Ap(e){try{let t=await b.post(e.action,e.params);h(Z,this,jp).call(this,t.data)}catch(t){h(Z,this,Mp).call(this,t,e)}finally{var t;y(gp,this,(t=v(gp,this),t--,t)),h(Z,this,kp).call(this)}}function jp(e){let t;e.session&&(v(mp,this).set(e.session.id,e.session),h(Z,this,Tp).call(this),e.session.actionRequired&&!e.skipDialog?v(yp,this).has(e.session.id)||(t=e.session.id):v(yp,this).has(e.session.id)||h(Z,this,Ep).call(this)),h(Z,this,Tp).call(this),e.stop&&(v(mp,this).delete(e.stop),v(hp,this)===e.stop&&y(hp,this,null)),h(Z,this,Cp).call(this,t),v(mp,this).size===0&&h(Z,this,Sp).call(this,`complete`,{})}function Mp(e,t){h(Z,this,Tp).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;h(Z,this,Sp).call(this,`error`,{message:n,sessionId:t.sessionId}),h(Z,this,kp).call(this)}var Np=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},Pp=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Fp,Ip=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Lp=typeof Intl<`u`&&Intl.ListFormat||Ip,Rp=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],zp={minimumIntegerDigits:2},Bp=class{constructor(e,t={}){Fp.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Np(this,Fp,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return Pp(this,Fp,`f`)}formatToParts(e){let t=[],n=Pp(this,Fp,`f`),r=n.style,i=n.locale;for(let[a,o]of Rp){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?zp:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Lp(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};Fp=new WeakMap;var Vp=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,Hp=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],Up=e=>Vp.test(e),Wp=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(Vp)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(Gp(r,e.from(t)).getTime()-r),a=Math.abs(Gp(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Bp(e,t).format(this)}};function Gp(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function Kp(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new Wp;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=Hp.indexOf(t)||Hp.length;return new Wp(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function qp(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new Wp(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function Jp(e,t){let n=qp(e,t);if(n.blank)return[0,`second`];for(let e of Hp){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},Yp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,Xp,Zp,Qp,$p,em,tm,nm,rm,im,am,om,sm,cm,lm,um,dm=globalThis.HTMLElement||null,fm=new Wp,pm=new Wp(0,0,0,0,0,1),mm=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function hm(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var gm=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=hm(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,hm(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},_m=class extends dm{constructor(){super(...arguments),$.add(this),Xp.set(this,!1),Zp.set(this,!1),$p.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),um.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,um,`f`)}set onRelativeTimeUpdated(e){Q(this,um,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,um,`f`)),Yp(this,um,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&Up(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return Hp.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){gm.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&Yp(this,Xp,n!==null&&(this.date&&Q(this,$,`m`,em).call(this,this.date))!==n,`f`),!Q(this,Zp,`f`)&&!(e===`title`&&Q(this,Xp,`f`))&&Yp(this,Zp,(async()=>{await Promise.resolve(),this.update(),Yp(this,Zp,!1,`f`)})(),`f`))}update(){let e=Q(this,$p,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,$p,`f`).textContent=e;return}let i=Date.now();Q(this,Xp,`f`)||(n=Q(this,$,`m`,em).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=Kp(r,this.precision,i),o=Q(this,$,`m`,tm).call(this,a),s=e,c=Q(this,$,`m`,lm).call(this,o);s=c?Q(this,$,`m`,sm).call(this,r):o===`duration`?Q(this,$,`m`,nm).call(this,a):o===`relative`?Q(this,$,`m`,rm).call(this,a):Q(this,$,`m`,im).call(this,r),s?Q(this,$,`m`,cm).call(this,s):this.shadowRoot===Q(this,$p,`f`)&&this.textContent&&Q(this,$,`m`,cm).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new mm(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,am).call(this,r)||Q(this,$,`m`,om).call(this,r))?gm.observe(this):gm.unobserve(this)}};Xp=new WeakMap,Zp=new WeakMap,$p=new WeakMap,um=new WeakMap,$=new WeakSet,Qp=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},em=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,Qp),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},tm=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||Wp.compare(e,this.threshold)===1)return`relative`}return`datetime`},nm=function(e){let t=Q(this,$,`a`,Qp),n=this.format,r=this.formatStyle,i=this.tense,a=fm;n===`micro`?(e=qp(e),a=pm,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=pm)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},rm=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,Qp),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=fm),n===`past`&&e.sign!==-1&&(e=fm);let[r,i]=Jp(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},im=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,Qp),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},am=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Qp),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},om=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,Qp),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},sm=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,am).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,Qp),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,Qp))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,Qp),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,om).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,Qp),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,Qp),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},cm=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,$p,`f`).replaceChildren(t)}else Q(this,$p,`f`).textContent=e},lm=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var vm=typeof globalThis<`u`?globalThis:window;try{vm.RelativeTimeElement=_m.define()}catch(e){if(!(vm.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{$n as A,da as C,ra as D,oa as E,rt as F,mt as M,dt as N,Yi as O,ft as P,ua as S,na as T,V as _,lp as a,pa as b,Jf as c,Ff as d,ed as f,Qs as g,ic as h,fp as i,Tt as j,Si as k,If as l,tl as m,dp as n,ap as o,ql as p,cp as r,np as s,xp as t,Pf as u,_s as v,la as w,fa as x,ga as y};
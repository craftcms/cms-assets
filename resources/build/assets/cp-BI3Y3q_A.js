...
`,yr=new WeakMap,br=new WeakMap,xr=new WeakMap,Sr=new WeakSet,Cr=class extends l{constructor(...e){super(...e),j(this,Sr),this.size=`small`,this.variant=null,this.appearance=oe.OutlineFill,this.icon=null,this.showStatus=!1,this.showThumb=!1,this.selectable=!1,this.selected=!1,this.selectLabel=null,A(this,yr,!1),A(this,br,new pr),A(this,xr,new _e(this))}connectedCallback(){super.connectedCallback(),this.getAttribute(`data-color`)||this.setAttribute(`data-color`,`white`)}renderSelect(){return r`<input
    ...
    </div>`}firstUpdated(e){super.firstUpdated(e),k(br,this).load(this)}render(){let e=ve(this,`prefix`,`icon`,`status`,`thumbnail`)||this.showStatus||this.icon,t=ve(this,`suffix`);return r`
      <div
        part="chip"

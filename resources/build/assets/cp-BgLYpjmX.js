...
`,Qa=new WeakMap,$a=new WeakMap,eo=new WeakMap,B=new WeakSet,to=new WeakMap,no=class extends qa{static get properties(){return{modelValue:{attribute:`model-value`}}}attributeChangedCallback(e,t,n){if(e===`model-value`){this.modelValue=this.hasAttribute(`multiple-choice`)?JSON.parse(n??`[]`):n??``;return}super.attributeChangedCallback(e,t,n)}static get styles(){return[...super.styles,Za]}get modelValue(){return super.modelValue}set modelValue(e){this.pendingModelValue=e,super.modelValue=e}constructor(){super(),d(this,B),this.multipleChoice=!1,this.required=!1,this.initialValues=[],this.fieldsetDisabled=!1,this.changingValues=!1,this.options=[],this.limit=150,this.clearable=!1,this.placeholder=``,this.showSelectedHint=!1,f(this,Qa,void 0),f(this,$a,!1),f(this,eo,()=>{h($a,this,!0),u(B,this,so).call(this),this.multipleChoice||u(B,this,ro).call(this)}),f(this,to,()=>{if(this.multipleChoice){this.changeValues([]);return}this.modelValue=``,this._inputNode&&(this._inputNode.value=``),u(B,this,so).call(this),this._inputNode?.focus()}),this.defaultValidators=[],this.autocomplete=`list`,this.addEventListener(`model-value-changed`,e=>{if(this.changingValues){e.stopImmediatePropagation();return}if(e.target===this&&!e.detail?.isTriggeredByUser&&this.pendingModelValue!==void 0&&JSON.stringify(this.modelValue)!==JSON.stringify(this.pendingModelValue)){e.stopImmediatePropagation();return}this.multipleChoice&&e.target===this&&e.detail?.isTriggeredByUser&&(this.pendingModelValue=[...this.selectedValues],this.syncInputs(),this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0})))}),this.addEventListener(`focusout`,e=>{this.multipleChoice&&!this.requireOptionMatch&&!(e.relatedTarget instanceof Node&&this.contains(e.relatedTarget))&&this.commitQuery()})}firstUpdated(e){super.firstUpdated(e),this._inputNode?.addEventListener(`input`,m(eo,this)),this.addEventListener(`model-value-changed`,()=>{h(Qa,this,this.modelValue)}),h(Qa,this,this.modelValue),u(B,this,so).call(this),this.multipleChoice&&(this.initialValues=[...Array.isArray(this.pendingModelValue)?this.pendingModelValue:[]])}updated(e){if(super.updated(e),this.multipleChoice){this.syncInputs(),this._inputNode.removeAttribute(`name`),this._comboboxNode.setAttribute(`aria-labelledby`,this._inputNode.getAttribute(`aria-labelledby`)??``),this._inputNode.disabled=this.disabled||this.fieldsetDisabled;let e=this.required&&!this.inactive&&this.selectedValues.length===0;this.internals??=this.attachInternals(),this.internals.setValidity(e?{valueMissing:!0}:{},e?O(`This field is required.`):``,this._inputNode)}e.has(`opened`)&&!this.opened&&h($a,this,!1),e.has(`placeholder`)&&(this._inputNode.placeholder=this.placeholder),(e.has(`options`)||e.has(`limit`)||e.has(`opened`)||e.has(`modelValue`)||e.has(`showSelectedHint`)||e.has(`multipleChoice`))&&u(B,this,so).call(this),(e.has(`options`)||e.has(`modelValue`))&&this.toggleAttribute(`has-prefix-icon`,u(B,this,po).call(this)?.data?.icon!=null)}addFormElement(e,t){super.addFormElement(e,t);let n=e;n.updateComplete.then(()=>{if(this.multipleChoice){n.checked=Array.isArray(this.pendingModelValue)&&this.pendingModelValue.includes(String(n.choiceValue));return}String(n.choiceValue)===String(this.pendingModelValue)&&(super.modelValue=this.pendingModelValue,this._setTextboxValue(this._getTextboxValueFromOption(n)))})}_notifyModelValueChanged(){JSON.stringify(this.modelValue)!==JSON.stringify(m(Qa,this))&&(h(Qa,this,this.modelValue),this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{formPath:[this],isTriggeredByUser:!0,changeSource:this.multipleChoice?`selection`:`input`}})))}matchCondition(e){return!this.multipleChoice||!e.hidden}_highlightMatchedOption(){}_unhighlightMatchedOption(){}_showOverlayCondition(e){return!this.disabled&&!this.readOnly&&(e.lastKey===`ArrowDown`||e.lastKey===`ArrowUp`)||super._showOverlayCondition(e)}_inputGroupInputTemplate(){let e=u(B,this,po).call(this)?.data?.icon;return r`
      <div class="input-group__input">
        ${this.multipleChoice?Xa(this.selectedValues,e=>e,e=>r`
                <span class="token">
                  ${this.valueLabel(e)}
        ...
        <div class="combobox__textbox">
          ...
          <slot name="input"></slot>
          ${this.clearable&&u(B,this,uo).call(this)&&!this.inactive?r`<craft-button
                class="clear"
                type="button"
                appearance="plain"
                size="small"
    ...
    `}get selectedValues(){return Array.isArray(this.modelValue)?this.modelValue:[]}get inactive(){return this.disabled||this.readOnly||this.fieldsetDisabled}valueLabel(e){return[...u(B,this,mo).call(this)].find(t=>t.value===e)?.label??e}syncInputs(){this.inputs||(this.inputs=document.createElement(`span`),this.inputs.hidden=!0,this.inputs.slot=`native-inputs`,this.inputs.setAttribute(`data-combobox-inputs`,``),this.append(this.inputs)),s(!this.name||this.disabled||this.fieldsetDisabled?c:r`
            ...
            ${this.selectedValues.map(e=>r`<input
                  ...
                  .value=${e}
                />`)}
          `,this.inputs)}formResetCallback(){this.multipleChoice&&(this.modelValue=[...this.initialValues],this.value=``,this.syncInputs())}formDisabledCallback(e){this.fieldsetDisabled=e,this.requestUpdate(),this.multipleChoice&&this.syncInputs()}changeValues(e){if(!this.inactive){this.changingValues=!0;try{this.modelValue=e}finally{this.changingValues=!1}this.value=``,this.opened=!1,u(B,this,so).call(this),this.syncInputs(),this._notifyModelValueChanged(),this._inputNode.focus()}}commitQuery(){let e=this.value;if(this.inactive||e===``)return;let t=[...u(B,this,mo).call(this)].find(t=>t.value===e);t?.disabled||this.requireOptionMatch&&!t||this.changeValues([...new Set([...this.selectedValues,e])])}_listboxOnKeyDown(e){if(!this.multipleChoice){super._listboxOnKeyDown(e);return}if(this.inactive||e.isComposing)return;if(e.key===`Backspace`&&this.value===``){e.preventDefault(),this.changeValues(this.selectedValues.slice(0,-1));return}let t=this.formElements[this.activeIndex];if(e.key===`Enter`&&(!this.opened||!t||t.hidden||t.hasAttribute(`aria-hidden`))){e.preventDefault(),this.commitQuery();return}super._listboxOnKeyDown(e)}_syncToTextboxMultiple(){}_resetListboxOptions(){super._resetListboxOptions(),this.hideSelectedOptions()}_handleAutocompletion(){super._handleAutocompletion(),this.hideSelectedOptions()}hideSelectedOptions(){if(!this.multipleChoice)return;for(let e of this.formElements)e.hidden&&(e.setAttribute(`aria-hidden`,`true`),e.removeAttribute(`aria-posinset`),e.removeAttribute(`aria-setsize`));let e=this.formElements.filter(e=>!e.hasAttribute(`aria-hidden`));e.forEach((t,n)=>{t.setAttribute(`aria-posinset`,String(n+1)),t.setAttribute(`aria-setsize`,String(e.length))})}parser(e){if(typeof e==`string`&&e!==``){let t=u(B,this,fo).call(this,e);return t?t.value:e}return super.parser(e)}_syncToTextboxCondition(e,t,n={}){return n.phase===`overlay-close`||super._syncToTextboxCondition(e,t,n)}_getTextboxValueFromOption(e){if(e){let t=e.textContent?.trim()||``;return this.showSelectedHint&&e.hint?`${t} – ${e.hint}`:t}return super._getTextboxValueFromOption(e)}};function ro(){let e=this.parser(this._inputNode?.value??``);e!==this.modelValue&&(this.modelValue=e),this._notifyModelValueChanged()}function io(e){let t=e.trim().toLowerCase(),n=[];for(let e of this.options)if(u(B,this,ao).call(this,e))for(let r of e.options)(t===``||u(B,this,oo).call(this,t,r))&&n.push({groupLabel:e.label,option:r});else(t===``||u(B,this,oo).call(this,t,e))&&n.push({option:e});return n}function ao(e){return e.type===`optgroup`}function oo(e,t){return t.label.toLowerCase().includes(e)||String(t.value).toLowerCase().includes(e)||(t.data?.keywords?.toLowerCase().includes(e)??!1)}function so(){let e=this._listboxNode;if(!e)return;let t=m($a,this)?this._inputNode?.value??``:``,n=this.multipleChoice?Array.isArray(this.pendingModelValue)?this.pendingModelValue:this.selectedValues:[],i=u(B,this,io).call(this,t).filter(e=>!n.includes(e.option.value)),a=i.slice(0,this.limit),o=[...u(B,this,mo).call(this)],l=[...n.map(e=>({option:o.find(t=>t.value===e)??{value:e,label:e}})),...a],d,f=l.map(e=>{let t=e.groupLabel&&e.groupLabel!==d?r`<div class="combobox__optgroup" aria-hidden="true">
              ${e.groupLabel}
            </div>`:c;return d=e.groupLabel,{value:e.option.value,template:r`${t}${u(B,this,lo).call(this,e.option,n.includes(e.option.value))}`}}),p=i.length>this.limit?r`<div class="combobox__footer" aria-hidden="true">
            ${O(`Showing {shown} of {total} — keep typing to narrow results.`,{shown:this.limit,total:i.length})}
          </div>`:c,h=r`${this.multipleChoice?Xa(f,e=>e.value,e=>e.template):f.map(e=>e.template)}${p}`;s(this.multipleChoice?h:Ja(u(B,this,co).call(this),h),e)}function co(){let e=[];for(let t of this.options)if(u(B,this,ao).call(this,t))for(let n of t.options)e.push(String(n.value));else e.push(String(t.value));return e.join(`\0`)}function lo(e,t=!1){let n=e.data??{},i=e.label,a=i.startsWith(`$`)||i.startsWith(`@`);return r`
      <craft-option
        ?hidden=${t}
    ...
    `}function uo(){return this.multipleChoice?this.selectedValues.length>0:this.modelValue!==``&&this.modelValue!=null}function fo(e){let t=e.trim();for(let e of u(B,this,mo).call(this))if(u(B,this,ho).call(this,e)===t)return e}function po(){if(this.multipleChoice||!u(B,this,uo).call(this))return;let e=String(this.modelValue);for(let t of u(B,this,mo).call(this))if(String(t.value)===e)return t}function*mo(){for(let e of this.options)u(B,this,ao).call(this,e)?yield*e.options:yield e}function ho(e){return this.showSelectedHint&&e.data?.hint?`${e.label} – ${e.data.hint}`:e.label}no.formAssociated=!0,p([g({type:Boolean,attribute:`multiple-choice`,reflect:!0})],no.prototype,`multipleChoice`,void 0),p([g({type:Boolean})],no.prototype,`required`,void 0),p([g({type:Array})],no.prototype,`options`,void 0),p([g({type:Number})],no.prototype,`limit`,void 0),p([g({type:Boolean,reflect:!0})],no.prototype,`clearable`,void 0),p([g({type:String,reflect:!0})],no.prototype,`placeholder`,void 0),p([g({type:Boolean,reflect:!0,attribute:`show-selected-hint`})],no.prototype,`showSelectedHint`,void 0),customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,no);var go=a`
  :host {
    display: inline-block;
  }
...
`,_o={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},vo=class extends l{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await this.updateComplete,this.tooltipEl?.repositionOverlay(),await t.animate(_o[`icon.out`].keyframes,_o[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(_o[`icon.in`].keyframes,_o[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(_o[`icon.out`].keyframes,_o[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(_o[`icon.in`].keyframes,_o[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`,this.tooltipEl?.hide()},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||O(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return r`
    ...
    `}};vo.styles=[go],p([_()],vo.prototype,`isCopying`,void 0),p([_()],vo.prototype,`status`,void 0),p([y(`slot[name="copy-icon"]`)],vo.prototype,`copyIconEl`,void 0),p([y(`slot[name="success-icon"]`)],vo.prototype,`successIconEl`,void 0),p([y(`slot[name="error-icon"]`)],vo.prototype,`errorIconEl`,void 0),p([y(`craft-tooltip`)],vo.prototype,`tooltipEl`,void 0),p([g({type:String})],vo.prototype,`value`,void 0),p([g({type:Boolean})],vo.prototype,`disabled`,void 0),p([g({attribute:`feedback-duration`,type:Number})],vo.prototype,`feedbackDuration`,void 0),p([g({attribute:`tooltip-label`})],vo.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,vo);var yo=a`
  :host {
    box-sizing: border-box;
  }
...
`,xo=class extends l{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return r`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};xo.styles=[yo,bo],p([y(`craft-copy-button`)],xo.prototype,`copyButtonEl`,void 0),p([g({type:String})],xo.prototype,`value`,void 0),p([g({type:Boolean,reflect:!0})],xo.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,xo);var So=[`a[href]`,`area[href]`,`button`,`input`,`select`,`textarea`,`details > summary`,`iframe`,`object`,`embed`,`audio[controls]`,`video[controls]`,`[contenteditable]`,`[tabindex]`].join(`,`);function Co(e){return e.hasAttribute(`disabled`)||e.hasAttribute(`inert`)||e.getAttribute(`aria-hidden`)===`true`||e.hidden?!1:e.tabIndex>=0}function wo(e){return(e.shadowRoot?[e.shadowRoot,e]:[e]).flatMap(e=>Array.from(e.querySelectorAll(So))).filter(Co)}function To(e){let t=t=>{if(t.key!==`Tab`)return;let n=wo(e);if(n.length===0)return;let r=n[0],i=n[n.length-1],a=t.composedPath()[0];t.shiftKey&&a===r?(t.preventDefault(),i.focus()):!t.shiftKey&&a===i&&(t.preventDefault(),r.focus())};return e.addEventListener(`keydown`,t),()=>e.removeEventListener(`keydown`,t)}var Eo=a`
  :host {
    display: contents;
...
`,Do=0,Oo=0;function ko(){Oo++===0&&document.body.classList.add(`no-scroll`)}function Ao(){Oo>0&&--Oo===0&&document.body.classList.remove(`no-scroll`)}var jo=new WeakMap,Mo=new WeakMap,No=new WeakMap,Po=new WeakMap,Fo=new WeakSet,Io=new WeakMap,Lo=new WeakMap,Ro=new WeakMap,zo=new WeakMap,Bo=new WeakMap,Vo=new WeakMap,Ho=class extends l{constructor(...e){super(...e),d(this,Fo),this.opened=!1,this.label=``,this.nonModal=!1,this.fullscreen=!1,this.closeOnOutsideClick=!1,this.noClose=!1,this.titleId=`craft-dialog-title-${++Do}`,f(this,jo,!1),f(this,Mo,null),f(this,No,!1),f(this,Po,null),f(this,Io,e=>{e.preventDefault(),this.requestClose()}),f(this,Lo,()=>{this.opened=!1}),f(this,Ro,e=>{this.nonModal&&this.opened&&e.key===`Escape`&&(e.preventDefault(),this.requestClose())}),f(this,zo,e=>{e.target?.closest?.(`[data-dialog="close"]`)&&this.requestClose()}),f(this,Bo,e=>{this.closeOnOutsideClick&&e.target===this.dialogElement&&this.requestClose()}),f(this,Vo,()=>{this.closeOnOutsideClick&&this.requestClose()})}connectedCallback(){super.connectedCallback(),this.addEventListener(`click`,m(zo,this)),this.addEventListener(`keydown`,m(Ro,this)),h(Po,this,new MutationObserver(()=>this.requestUpdate())),m(Po,this).observe(this,{childList:!0})}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`click`,m(zo,this)),this.removeEventListener(`keydown`,m(Ro,this)),m(Po,this)?.disconnect(),h(Po,this,null),m(Mo,this)?.call(this),h(Mo,this,null),u(Fo,this,Go).call(this)}get dialogElement(){return this.shadowRoot?.querySelector(`dialog`)??null}get hasFooter(){return this.querySelector(`:scope > [slot="footer"]`)!==null}render(){return r`
    ...
    `}updated(e){super.updated(e),this.opened!==m(jo,this)&&(h(jo,this,this.opened),this.opened?u(Fo,this,Uo).call(this):u(Fo,this,Wo).call(this),u(Fo,this,Ko).call(this,this.opened))}requestClose(){this.opened=!1}};function Uo(){let e=this.dialogElement;e&&!e.open&&(this.nonModal?e.show():e.showModal()),this.nonModal&&(m(Mo,this)?.call(this),h(Mo,this,To(this))),m(No,this)||(h(No,this,!0),ko())}function Wo(){let e=this.dialogElement;e?.open&&e.close(),m(Mo,this)?.call(this),h(Mo,this,null),u(Fo,this,Go).call(this)}function Go(){m(No,this)&&(h(No,this,!1),Ao())}function Ko(e){u(Fo,this,qo).call(this,e?`craft-show`:`craft-hide`),this.updateComplete.then(()=>{this.opened===e&&u(Fo,this,qo).call(this,e?`craft-after-show`:`craft-after-hide`)})}function qo(e){this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0}))}Ho.styles=[yo,Eo],p([g({type:Boolean,attribute:`open`,reflect:!0})],Ho.prototype,`opened`,void 0),p([g()],Ho.prototype,`label`,void 0),p([g({type:Boolean,attribute:`non-modal`,reflect:!0})],Ho.prototype,`nonModal`,void 0),p([g({type:Boolean,reflect:!0})],Ho.prototype,`fullscreen`,void 0),p([g({type:Boolean,attribute:`close-on-outside-click`})],Ho.prototype,`closeOnOutsideClick`,void 0),p([g({type:Boolean,attribute:`no-close`,reflect:!0})],Ho.prototype,`noClose`,void 0),customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,Ho);var Jo=new WeakMap,Yo=new WeakSet,Xo=class{constructor(e,t){this.host=e,this.source=t,d(this,Yo),f(this,Jo,null),e.addController(this)}hostConnected(){u(Yo,this,Zo).call(this)}hostDisconnected(){u(Yo,this,Qo).call(this)}resubscribe(){u(Yo,this,Qo).call(this),u(Yo,this,Zo).call(this)}get state(){return this.source()?.state??null}};function Zo(){h(Jo,this,this.source()?.on(`change`,()=>this.host.requestUpdate())??null)}function Qo(){m(Jo,this)?.call(this),h(Jo,this,null)}var $o=a`
  :host {
    /*
...
`,es=new WeakMap,ts=new WeakMap,ns=new WeakMap,rs=new WeakMap,is=new WeakMap,as=class extends Ho{constructor(...e){super(...e),this.controller=null,this.showTitle=!1,this.selectLabel=``,this.cancelLabel=``,this.busy=!1,this.loading=!1,this.canSubmit=!1,this.narrow=!1,this.hasIndex=!1,f(this,es,new Xo(this,()=>this.controller)),f(this,ts,null),f(this,ns,()=>{this.submit()}),f(this,rs,()=>{this.busy||this.requestClose()}),f(this,is,()=>{this.busy||this.requestClose()})}connectedCallback(){super.connectedCallback(),typeof ResizeObserver<`u`&&h(ts,this,new ResizeObserver(([e])=>{e&&(this.narrow=e.contentRect.width<550)}))}disconnectedCallback(){super.disconnectedCallback(),m(ts,this)?.disconnect()}willUpdate(e){e.has(`controller`)&&m(es,this).resubscribe();let t=m(es,this).state;t&&(this.opened=t.open,this.busy=t.busy,this.loading=t.loading,this.canSubmit=t.canSubmit,this.label=t.title,this.showTitle=t.showTitle,this.selectLabel=t.selectLabel,this.hasIndex=t.indexBody!==null),super.willUpdate(e)}firstUpdated(e){super.firstUpdated(e);let t=this.shadowRoot?.querySelector(`.surface`);t&&m(ts,this)?.observe(t)}renderHeader(){return r`
      <header class="header" part="header">
        ${this.label===``?c:r`<h1
    ...
    `}submit(){this.canSubmit&&(this.dispatchEvent(new CustomEvent(`craft-select`,{bubbles:!0,composed:!0})),this.controller?.submit())}requestClose(){if(this.dispatchEvent(new CustomEvent(`craft-cancel`,{bubbles:!0,composed:!0})),this.controller){this.controller.cancel();return}super.requestClose()}};as.styles=[...Ho.styles,$o],p([g({attribute:!1})],as.prototype,`controller`,void 0),p([g({type:Boolean,attribute:`show-title`,reflect:!0})],as.prototype,`showTitle`,void 0),p([g({attribute:`select-label`})],as.prototype,`selectLabel`,void 0),p([g({attribute:`cancel-label`})],as.prototype,`cancelLabel`,void 0),p([g({type:Boolean,reflect:!0})],as.prototype,`busy`,void 0),p([g({type:Boolean,reflect:!0})],as.prototype,`loading`,void 0),p([g({type:Boolean,attribute:`can-submit`,reflect:!0})],as.prototype,`canSubmit`,void 0),p([g({type:Boolean,reflect:!0})],as.prototype,`narrow`,void 0),p([_()],as.prototype,`hasIndex`,void 0),customElements.get(`craft-element-selector-modal`)||customElements.define(`craft-element-selector-modal`,as);var os=class extends l{static get styles(){return[a`
        :host {
          display: block;
        }
    ...
    `],p([g()],cs.prototype,`label`,void 0),p([g()],cs.prototype,`icon`,void 0),customElements.get(`craft-empty`)||customElements.define(`craft-empty`,cs);var ls=a`
  :host {
    position: relative;
    display: block;
  }
...
`,us=class extends gi(l){constructor(...e){super(...e),this.required=!1,this.translatable=!1,this.translationDescription=O(`This field is translatable.`),this.fieldset=!1,this.hasErrors=!1,this.instructionsPosition=`before`,this.__lightDomObserver=new MutationObserver(()=>this.__onLightDomChanged())}static get styles(){return[Nt,br,ls]}connectedCallback(){super.connectedCallback(),this.__lightDomObserver.observe(this,{childList:!0}),this.__syncHasErrors(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.updateComplete.then(()=>{this.addToAriaLabelledBy(this._labelNode),this.__wireDescribedBy()})}__syncHasMaxlength(){this.toggleAttribute(`has-maxlength`,this.querySelector(`:scope > [slot="input"]`)?.hasAttribute(`maxlength`)??!1)}__syncControlWidth(){if(this.width!==void 0)return;let e=this.querySelector(`:scope > [slot="input"]`)?.getAttribute(`width`);(e===`full`||e===`auto`)&&(this.width=e)}disconnectedCallback(){super.disconnectedCallback(),this.__lightDomObserver.disconnect()}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.removeAttribute(`aria-disabled`),e.has(`fieldset`)&&this.__syncFieldsetSemantics(),(e.has(`label`)||e.has(`required`)||e.has(`translatable`)||e.has(`translationDescription`))&&this.__syncLabelDecorations()}get control(){return this._inputNode??void 0}get _resolvedOrientation(){return this.orientation?this.orientation:(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`?`rtl`:`ltr`}_enhanceLightDomA11y(){super._enhanceLightDomA11y(),this.__wireDescribedBy(),this.__syncFieldsetSemantics()}_onLabelClick(){this.__formControlTarget()?.focus()}addToAriaLabelledBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaLabelledBy(e,{...t,idPrefix:`field-${t.idPrefix??`label`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-labelledby`,e,`label`);return}super.addToAriaLabelledBy(e,{...t,reorder:!1})}addToAriaDescribedBy(e,t={}){let n=this.__formControlTarget();if(n){n.addToAriaDescribedBy(e,{...t,idPrefix:`field-${t.idPrefix??`description`}`});return}if(this.fieldset||!this.__hasNativeLabelTarget()){this.__addGroupAriaReference(`aria-describedby`,e,t.idPrefix??`description`);return}super.addToAriaDescribedBy(e,{...t,reorder:!1})}render(){return r`
    ...
    `}_labelTemplate(){let e=this.__hasLightChild(`actions`);return r`
      <div class="form-field__label">
        <slot name="heading-prefix"></slot>
        <slot name="label"></slot>
        ${this.readOnly?r`<span class="read-only-badge">${O(`Read Only`)}</span>`:c}
        ${this.__hasLightChild(`label-extra`)||e?r`<div class="flex-grow"></div>`:c}
    ...
    `:c}_noticeTemplate(e){if(!this.__hasLightChild(e))return c;let t=e===`tip`;return r`
      <craft-callout
        class="field-notice"
    ...
    `}__hasLightChild(e){return this.__lightChild(e)!==void 0}__lightChild(e){return Array.from(this.children).find(t=>t.slot===e)}__onLightDomChanged(){this.__wireDescribedBy(),this.__syncFieldsetSemantics(),this.__syncHasErrors(),this.__syncLabelDecorations(),this.__syncHasMaxlength(),this.__syncControlWidth(),this.requestUpdate()}__wireDescribedBy(){for(let e of[`help-text`,`feedback`,`tip`,`warning`]){let t=this.__lightChild(e);t&&this.addToAriaDescribedBy(t,{idPrefix:e})}}__formControlTarget(){let e=this._inputNode;return e&&`addToAriaLabelledBy`in e&&`addToAriaDescribedBy`in e?e:void 0}__hasNativeLabelTarget(){return!!this._inputNode?.matches(`button, input, meter, output, progress, select, textarea`)}__addGroupAriaReference(e,t,n){t.id||=`${n}-${this._inputId}`;let r=new Set((this.getAttribute(e)??``).split(/\s+/).filter(Boolean));r.add(t.id),this.setAttribute(e,[...r].join(` `))}__syncHasErrors(){let e=this.__lightChild(`feedback`);e&&(this.hasErrors=!!(e.childElementCount||e.textContent?.trim()))}__syncFieldsetSemantics(){let e=this._labelNode,t=this.__formControlTarget();this.fieldset||!t&&!this.__hasNativeLabelTarget()?(this.setAttribute(`role`,`group`),e&&(e.id||=`label-${this._inputId}`,this.setAttribute(`aria-labelledby`,e.id),e.removeAttribute(`for`))):(this.getAttribute(`role`)===`group`&&this.removeAttribute(`role`),this.removeAttribute(`aria-labelledby`),e&&t?e.removeAttribute(`for`):e&&this._inputNode&&e.setAttribute(`for`,this._inputNode.id||this._inputId))}__syncLabelDecorations(){let e=this._labelNode;if(e){for(let t of e.querySelectorAll(`[data-craft-field-decoration]`))t.remove();if(this.label){if(this.required){let t=document.createElement(`span`);t.className=`visually-hidden`,t.textContent=O(`Required`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`craft-icon`);n.setAttribute(`name`,`asterisk`),n.setAttribute(`data-craft-field-decoration`,``),n.setAttribute(`data-color`,`danger`),n.setAttribute(`aria-hidden`,`true`),e.append(t,n)}if(this.translatable){let t=document.createElement(`craft-tooltip`);t.setAttribute(`placement`,`bottom`),t.setAttribute(`max-width`,`200px`),t.setAttribute(`text`,this.translationDescription),t.setAttribute(`delay`,`1000`),t.setAttribute(`data-craft-field-decoration`,``);let n=document.createElement(`button`);n.type=`button`,n.className=`t9n-indicator prevent-autofocus`,n.setAttribute(`data-icon`,`language`),n.setAttribute(`aria-label`,this.translationDescription),t.append(n),e.append(t)}}}}};p([g({type:Boolean,reflect:!0})],us.prototype,`required`,void 0),p([g({type:Boolean,reflect:!0})],us.prototype,`translatable`,void 0),p([g({attribute:`translation-description`})],us.prototype,`translationDescription`,void 0),p([g({type:Boolean,reflect:!0})],us.prototype,`fieldset`,void 0),p([g({reflect:!0})],us.prototype,`status`,void 0),p([g({attribute:`status-label`})],us.prototype,`statusLabel`,void 0),p([g({reflect:!0})],us.prototype,`orientation`,void 0),p([g({type:Boolean,reflect:!0,attribute:`has-errors`})],us.prototype,`hasErrors`,void 0),p([g({attribute:`instructions-position`})],us.prototype,`instructionsPosition`,void 0),p([g({type:String,reflect:!0})],us.prototype,`width`,void 0),customElements.get(`craft-field`)||customElements.define(`craft-field`,us);var ds=class extends l{render(){return r`
      ...
      <slot></slot>
    `}createRenderRoot(){return this}};customElements.get(`craft-field-group`)||customElements.define(`craft-field-group`,ds);var fs=a`
  ${br}
...
`,ps=/^[0-9a-f]{6}$/i,ms=/^[0-9a-f]{3}$/i,hs={fromAttribute(e){if(!e)return[];try{let t=JSON.parse(e);return Array.isArray(t)?t.map(e=>String(e)):[]}catch{return[]}}};function gs(e){return String(e??``).trim().replace(/^#/,``)}function _s(e){let t=gs(e);return ms.test(t)?t.split(``).map(e=>e+e).join(``):ps.test(t)?t:null}var vs=class e extends Bi{static get styles(){return[...super.styles,xr,fs]}constructor(){super(),this.presets=[],this._pickerListId=`${this._inputId}-presets`,this.type=`text`}static doesBrowserSupportColorInputs(){if(e._browserSupportsColorInputs===null){let t=document.createElement(`input`);t.setAttribute(`type`,`color`),e._browserSupportsColorInputs=t.type===`color`}return e._browserSupportsColorInputs}get slots(){return{...super.slots,input:()=>{let e=document.createElement(`input`),t=this.getAttribute(`value`);return e.type=`text`,e.inputMode=`text`,e.spellcheck=!1,e.setAttribute(`autocorrect`,`off`),e.setAttribute(`autocapitalize`,`off`),t&&e.setAttribute(`value`,gs(t)),e}}}parser(e){return gs(e)}formatter(e){return gs(e)}serializer(e){return gs(e)}deserializer(e){return gs(e)}preprocessor(e){let t=gs(e);if(t!==e)return t}get _expandedHexValue(){return _s(this.modelValue)}get _pickerValue(){return this._expandedHexValue?`#${this._expandedHexValue}`:`#ffffff`}get _validPresets(){return this.presets.map(e=>_s(e)).filter(e=>e!==null).map(e=>`#${e}`)}_handlePickerInput(e){let t=e.target,n=gs(t.value),r=this._isHandlingUserInput;this._isHandlingUserInput=!0,this.modelValue=n,this.value=n,this._isHandlingUserInput=r}_pickerTemplate(){if(!e.doesBrowserSupportColorInputs())return c;let t=this._validPresets;return r`
      <input
    ...
    `}};vs._browserSupportsColorInputs=null,p([g({converter:hs})],vs.prototype,`presets`,void 0),customElements.get(`craft-input-color`)||customElements.define(`craft-input-color`,vs);var ys=a`
  ::slotted(.form-control) {
    ${_r}
  }
...
`,xs=class extends V{static get styles(){return[...super.styles,bs]}_renderSuffix(){return r`<craft-copy-button
      tooltip-label="${O(`Copy`)}"
    ></craft-copy-button>`}get slots(){return{...super.slots,suffix:()=>({template:this._renderSuffix(),renderAsDirectHostChild:!0})}}connectedCallback(){super.connectedCallback(),this.readOnly=!0}_copyButton(){return this.querySelector(`craft-copy-button`)}_syncCopyButton(){let e=this._copyButton();e&&(e.value=this.copyValue??String(this.modelValue??``))}updated(e){super.updated(e),this.readOnly=!0,this._syncCopyButton()}};p([g({type:String,attribute:`copy-value`})],xs.prototype,`copyValue`,void 0),customElements.get(`craft-input-copy`)||customElements.define(`craft-input-copy`,xs);var Ss=class extends V{constructor(){super(),this.type=`date`}};customElements.get(`craft-input-date`)||customElements.define(`craft-input-date`,Ss);var Cs=new WeakSet,ws=class extends V{constructor(){super(),d(this,Cs),this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.type=`time`}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,u(Cs,this,Ts))}disconnectedCallback(){this.removeEventListener(`change`,u(Cs,this,Ts)),super.disconnectedCallback()}updated(e){e.has(`minuteIncrement`)&&(this.step=this.minuteIncrement*60),super.updated(e),u(Cs,this,Es).call(this)}};function Ts(e){if(!(e.target===this||!(e.target instanceof HTMLInputElement))){if(this.forceRoundTime){let t=u(Cs,this,Ds).call(this,e.target.value);e.target.value=t,this.modelValue=t,this.value=t}u(Cs,this,Es).call(this)}}function Es(){let e=this._inputNode;if(!e)return;let t=u(Cs,this,Os).call(this,e.value),n=t!==null&&this.disabledTimeRanges.some(([e,n])=>{let r=u(Cs,this,Os).call(this,e),i=u(Cs,this,Os).call(this,n);return r!==null&&i!==null&&t>=r&&t<i});e.setCustomValidity(n?`This time is unavailable.`:``)}function Ds(e){let t=u(Cs,this,Os).call(this,e);if(t===null)return e;let n=Math.max(1,this.minuteIncrement)*60,r=Math.min(86399,Math.round(t/n)*n),i=Math.floor(r/3600),a=Math.floor(r%3600/60);return`${String(i).padStart(2,`0`)}:${String(a).padStart(2,`0`)}`}function Os(e){let t=/^(\d{1,2}):(\d{2})(?::(\d{2}))?$/.exec(e);return t?Number(t[1])*3600+Number(t[2])*60+Number(t[3]??0):null}p([g({type:Number,attribute:`minute-increment`})],ws.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],ws.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],ws.prototype,`forceRoundTime`,void 0),customElements.get(`craft-input-time`)||customElements.define(`craft-input-time`,ws);var ks={fromAttribute:e=>e!==`false`,toAttribute:e=>String(e)},As=new WeakSet,js=new WeakMap,H=class extends l{constructor(...e){super(...e),d(this,As),this.dateValue=``,this.timeValue=``,this.showDate=!0,this.showTime=!0,this.showTimezone=!1,this.minuteIncrement=30,this.disabledTimeRanges=[],this.forceRoundTime=!1,this.disabled=!1,this.readonly=!1,this.required=!1,f(this,js,e=>{let t=e.target;if(e.detail?.initialize||!(t instanceof V))return;let n=String(t.modelValue??``);switch(t.dataset.dateTimePart){case`date`:this.dateValue=n;break;case`time`:this.timeValue=n;break;case`timezone`:this.timezone=n}})}render(){return r`<slot></slot>`}connectedCallback(){super.connectedCallback(),this.addEventListener(`model-value-changed`,m(js,this))}disconnectedCallback(){this.removeEventListener(`model-value-changed`,m(js,this)),super.disconnectedCallback()}updated(e){super.updated(e),u(As,this,Ms).call(this),u(As,this,Ns).call(this),u(As,this,Ps).call(this),u(As,this,zs).call(this,`locale`,this.locale,!0),u(As,this,zs).call(this,`timezone`,this.timezone,!this.showTimezone)}};function Ms(){let e=u(As,this,Fs).call(this,`craft-input-date`,`date`,this.showDate);e instanceof Ss&&(u(As,this,Rs).call(this,e,`date`,this.dateValue,this.required),e.min=this.min,e.max=this.max,u(As,this,Is).call(this,e))}function Ns(){let e=u(As,this,Fs).call(this,`craft-input-time`,`time`,this.showTime);e instanceof ws&&(u(As,this,Rs).call(this,e,`time`,this.timeValue,this.required),e.min=this.minTime,e.max=this.maxTime,e.minuteIncrement=this.minuteIncrement,e.disabledTimeRanges=this.disabledTimeRanges,e.forceRoundTime=this.forceRoundTime,u(As,this,Is).call(this,e))}function Ps(){let e=u(As,this,Fs).call(this,`craft-input`,`timezone`,this.showTimezone);e&&(u(As,this,Rs).call(this,e,`timezone`,this.timezone??``,!1),u(As,this,Is).call(this,e))}function Fs(e,t,n){let r=[...this.children].find(t=>t.tagName.toLowerCase()===e&&t instanceof V);if(!n)return r?.remove(),null;let i=r??document.createElement(e);return i.dataset.dateTimePart=t,i}function Is(e){e.parentElement!==this&&this.insertBefore(e,u(As,this,Ls).call(this))}function Ls(){return[...this.children].find(e=>!(e instanceof HTMLElement)||e.dataset.dateTimePart===void 0&&e.dataset.dateTimeMetadata===void 0)??null}function Rs(e,t,n,r){e.name=this.name?`${this.name}[${t}]`:``,e.disabled=this.disabled,e.readOnly=this.readonly,e.required=r,e.modelValue!==n&&(e.modelValue=n),this.describedBy?e.setAttribute(`aria-describedby`,this.describedBy):e.removeAttribute(`aria-describedby`)}function zs(e,t,n){let r=this.name?`${this.name}[${e}]`:void 0,i=[...this.children].find(t=>t instanceof HTMLInputElement&&t.type===`hidden`&&t.dataset.dateTimeMetadata===e);if(!r||!n){i?.remove();return}let a=i??document.createElement(`input`);a.type=`hidden`,a.dataset.dateTimeMetadata=e,a.name=r,a.value=t??``,i||this.append(a)}H.styles=a`
    :host {
      display: flex;
      flex-flow: row wrap;
      align-items: center;
  ...
  `,p([g()],H.prototype,`name`,void 0),p([g({attribute:`date-value`})],H.prototype,`dateValue`,void 0),p([g({attribute:`time-value`})],H.prototype,`timeValue`,void 0),p([g()],H.prototype,`locale`,void 0),p([g()],H.prototype,`timezone`,void 0),p([g({attribute:`show-date`,converter:ks})],H.prototype,`showDate`,void 0),p([g({attribute:`show-time`,converter:ks})],H.prototype,`showTime`,void 0),p([g({type:Boolean,attribute:`show-timezone`})],H.prototype,`showTimezone`,void 0),p([g()],H.prototype,`min`,void 0),p([g()],H.prototype,`max`,void 0),p([g({attribute:`min-time`})],H.prototype,`minTime`,void 0),p([g({attribute:`max-time`})],H.prototype,`maxTime`,void 0),p([g({type:Number,attribute:`minute-increment`})],H.prototype,`minuteIncrement`,void 0),p([g({attribute:`disabled-time-ranges`,converter:{fromAttribute:e=>JSON.parse(e??`[]`),toAttribute:e=>JSON.stringify(e)}})],H.prototype,`disabledTimeRanges`,void 0),p([g({type:Boolean,attribute:`force-round-time`})],H.prototype,`forceRoundTime`,void 0),p([g({type:Boolean})],H.prototype,`disabled`,void 0),p([g({type:Boolean})],H.prototype,`readonly`,void 0),p([g({type:Boolean})],H.prototype,`required`,void 0),p([g({attribute:`described-by`})],H.prototype,`describedBy`,void 0),customElements.get(`craft-input-date-time`)||customElements.define(`craft-input-date-time`,H);var Bs=class extends Ci{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},Vs=class extends Ci{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Kr().msg(`lion-input-file:uploadTextDuplicateFileName`)}},Hs=524288e3,Us={type:`FILE_TYPE`,size:`FILE_SIZE`},Ws={fail:`FAIL`,pass:`SUCCESS`},Gs=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);Bs.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Ws.fail,this.failedProp.push(Us.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;Bs.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Ws.fail,this.failedProp.push(Us.type))}Bs.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Ws.fail&&(this.status=Ws.pass):(this.status=Ws.fail,this.failedProp.push(Us.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Ks=e=>{switch(e){case`bg-BG`:return E(()=>import(`./bg-BG-BztIKams.js`),__vite__mapDeps([49,50]),import.meta.url);case`bg`:return E(()=>import(`./bg-CLv3tqUg.js`),__vite__mapDeps([51,50]),import.meta.url);case`cs-CZ`:return E(()=>import(`./cs-CZ-VPjqqYsZ.js`),__vite__mapDeps([52,53]),import.meta.url);case`cs`:return E(()=>import(`./cs-B7yAvqdQ.js`),__vite__mapDeps([54,53]),import.meta.url);case`de-DE`:return E(()=>import(`./de-DE-CsSmh1gZ.js`),__vite__mapDeps([55,56]),import.meta.url);case`de`:return E(()=>import(`./de-kP5ksqlV.js`),__vite__mapDeps([57,56]),import.meta.url);case`en-AU`:return E(()=>import(`./en-AU-3urcHPzk.js`),__vite__mapDeps([58,59]),import.meta.url);case`en-GB`:return E(()=>import(`./en-GB-3urcHPzk.js`),__vite__mapDeps([60,59]),import.meta.url);case`en-US`:return E(()=>import(`./en-US-3urcHPzk.js`),__vite__mapDeps([61,59]),import.meta.url);case`en-PH`:case`en`:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url);case`es-ES`:return E(()=>import(`./es-ES-BbUihx_Q.js`),__vite__mapDeps([63,64]),import.meta.url);case`es`:return E(()=>import(`./es-CqwOJyIS.js`),__vite__mapDeps([65,64]),import.meta.url);case`fr-FR`:return E(()=>import(`./fr-FR-CuiHGLXU.js`),__vite__mapDeps([66,67]),import.meta.url);case`fr-BE`:return E(()=>import(`./fr-BE-CuiHGLXU.js`),__vite__mapDeps([68,67]),import.meta.url);case`fr`:return E(()=>import(`./fr-DDoohrFe.js`),__vite__mapDeps([69,67]),import.meta.url);case`hu-HU`:return E(()=>import(`./hu-HU-CsgTXklM.js`),__vite__mapDeps([70,71]),import.meta.url);case`hu`:return E(()=>import(`./hu-mlQa-ass.js`),__vite__mapDeps([72,71]),import.meta.url);case`id-ID`:return E(()=>import(`./id-ID-DmQHtDR1.js`),__vite__mapDeps([73,74]),import.meta.url);case`id`:return E(()=>import(`./id-wVaUF8IY.js`),__vite__mapDeps([75,74]),import.meta.url);case`it-IT`:return E(()=>import(`./it-IT-UwtN86gq.js`),__vite__mapDeps([76,77]),import.meta.url);case`it`:return E(()=>import(`./it-Cau1XULR.js`),__vite__mapDeps([78,77]),import.meta.url);case`nl-BE`:return E(()=>import(`./nl-BE-BWsuTFhd.js`),__vite__mapDeps([79,80]),import.meta.url);case`nl-NL`:return E(()=>import(`./nl-NL-BWsuTFhd.js`),__vite__mapDeps([81,80]),import.meta.url);case`nl`:return E(()=>import(`./nl-AKV00b4f.js`),__vite__mapDeps([82,80]),import.meta.url);case`pl-PL`:return E(()=>import(`./pl-PL-DNBiW1Dr.js`),__vite__mapDeps([83,84]),import.meta.url);case`pl`:return E(()=>import(`./pl-BYkVljz3.js`),__vite__mapDeps([85,84]),import.meta.url);case`ro-RO`:return E(()=>import(`./ro-RO-f1xYkV2I.js`),__vite__mapDeps([86,87]),import.meta.url);case`ro`:return E(()=>import(`./ro-ocFYhLc_.js`),__vite__mapDeps([88,87]),import.meta.url);case`ru-RU`:return E(()=>import(`./ru-RU-CR2XPZpu.js`),__vite__mapDeps([89,90]),import.meta.url);case`ru`:return E(()=>import(`./ru-DZLJ_F1W.js`),__vite__mapDeps([91,90]),import.meta.url);case`sk-SK`:return E(()=>import(`./sk-SK-zTlM1iZC.js`),__vite__mapDeps([92,93]),import.meta.url);case`sk`:return E(()=>import(`./sk-DV9gBcF9.js`),__vite__mapDeps([94,93]),import.meta.url);case`uk-UA`:return E(()=>import(`./uk-UA-Db28XQdn.js`),__vite__mapDeps([95,96]),import.meta.url);case`uk`:return E(()=>import(`./uk-b3alyY__.js`),__vite__mapDeps([97,96]),import.meta.url);case`zh-CN`:case`zh`:return E(()=>import(`./zh-HUllbHAl.js`),[],import.meta.url);default:return E(()=>import(`./en-CqZ6PnT7.js`),__vite__mapDeps([62,59]),import.meta.url)}},qs=class extends ai(di(l)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":Si}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Ks},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return r`
    ...
    `}static get styles(){return[super.styles,a`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},Xs=class extends qs{static get styles(){return[...super.styles,a`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
...
`,Qs=class extends Ys{static get styles(){return[...super.styles,xr,Zs]}get slots(){return{...super.slots,"file-select-button":()=>r`<craft-button
      ...
      `]}constructor(){super(),d(this,rc),this.currency=`USD`,this.locale=`en-US`,this.showCurrency=!0,this.clearable=!0,f(this,ic,()=>{this.modelValue=``,this.value=``,u(rc,this,oc).call(this)?.inputmask?.setValue(``),u(rc,this,oc).call(this)?.focus()}),this.type=`text`,this.inputMode=`decimal`}updated(e){super.updated(e),(e.has(`currency`)||e.has(`locale`)||e.has(`decimals`)||e.has(`decimalSeparator`)||e.has(`groupSeparator`)||e.has(`placeholder`))&&u(rc,this,cc).call(this),u(rc,this,oc).call(this)?.classList.toggle(`money-placeholder`,!u(rc,this,lc).call(this))}disconnectedCallback(){u(rc,this,oc).call(this)?.inputmask?.remove(),super.disconnectedCallback()}_inputGroupPrefixTemplate(){return this.showCurrency?r`<div class="input-group__prefix">
      <span class="currency"
        >${`(${this.currency}) ${u(rc,this,sc).call(this).currency}`}</span
      >
      ...
      <craft-button
        ...
        icon
        aria-label=${O(`Clear`)}
        ?hidden=${!this.clearable||this.disabled||!u(rc,this,lc).call(this)}
        @mousedown=${e=>e.preventDefault()}
        @click=${m(ic,this)}
      >
        <craft-icon name="xmark" style="font-size: 0.8em"></craft-icon>
      </craft-button>
    </div>`}};function oc(){return this._inputNode}function sc(){let e=new Intl.NumberFormat(this.locale.replaceAll(`_`,`-`),{style:`currency`,currency:this.currency}),t=e.formatToParts(12345.6);return{currency:t.find(({type:e})=>e===`currency`)?.value??``,decimal:t.find(({type:e})=>e===`decimal`)?.value??`.`,group:t.find(({type:e})=>e===`group`)?.value??`,`,decimals:e.resolvedOptions().maximumFractionDigits}}function cc(){let e=u(rc,this,oc).call(this);if(!e)return;let t=String(this.modelValue??``),n=u(rc,this,sc).call(this);e.inputmask?.remove(),e.value=t,new tc({alias:`currency`,autoGroup:!1,clearMaskOnLostFocus:!0,digits:this.decimals??n.decimals,digitsOptional:!1,groupSeparator:this.groupSeparator??n.group,placeholder:this.placeholder||`0`,prefix:``,radixPoint:this.decimalSeparator??n.decimal}).mask(e)}function lc(){return this.modelValue!==``&&this.modelValue!=null}p([g()],ac.prototype,`currency`,void 0),p([g()],ac.prototype,`locale`,void 0),p([g({type:Number})],ac.prototype,`decimals`,void 0),p([g({attribute:`decimal-separator`})],ac.prototype,`decimalSeparator`,void 0),p([g({attribute:`group-separator`})],ac.prototype,`groupSeparator`,void 0),p([g({converter:nc,attribute:`show-currency`})],ac.prototype,`showCurrency`,void 0),p([g({converter:nc})],ac.prototype,`clearable`,void 0),customElements.get(`craft-input-money`)||customElements.define(`craft-input-money`,ac);var uc=new WeakSet,dc=class extends Bi{static get styles(){return[...super.styles,xr,a`
        .input-group__container {
          position: relative;
        }
      ...
      `]}constructor(){super(),d(this,uc),this.passwordRules=``,this._visible=!1,this.reveal=()=>{this._visible=!this._visible,this.type=this._visible?`text`:`password`},this.renderSuffix=()=>r`<craft-button
      type="button"
      icon
      size="small"
      variant="plain"
    ...
    </craft-button>`,this.type=`password`}connectedCallback(){super.connectedCallback(),u(uc,this,fc).call(this)}updated(e){super.updated(e),e.has(`passwordRules`)&&u(uc,this,fc).call(this)}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix(),renderAsDirectHostChild:!0})}}};function fc(){if(this.passwordRules){this._inputNode?.setAttribute(`passwordrules`,this.passwordRules);return}this._inputNode?.removeAttribute(`passwordrules`)}p([g({attribute:`passwordrules`})],dc.prototype,`passwordRules`,void 0),p([_()],dc.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,dc);var pc=class extends l{constructor(...e){super(...e),this.error=``,this.pluginName=``}render(){return r`
  ...
  `,p([g()],pc.prototype,`error`,void 0),p([g({attribute:`plugin-name`})],pc.prototype,`pluginName`,void 0),customElements.get(`craft-missing-component`)||customElements.define(`craft-missing-component`,pc);var mc=a`
  :host {
    display: block;
    /*
...
`,hc={Raised:`raised`,Outline:`outline`,Plain:`plain`,Sunken:`sunken`};Object.values(hc);var gc={Plain:`plain`,Error:`error`,Code:`code`};Object.values(gc);var _c=new Set([`clip`,`hidden`]),vc=class extends fr(l,{customProperty:`--_pane-spacing`,defaultValue:`lg`}){constructor(...e){super(...e),this.appearance=hc.Raised,this.variant=gc.Plain,this.label=``,this._hasSlottedHeader=!1,this._hasSlottedFooter=!1,this._scrollable=!1,this._hostLabel=``,this._lightDomObserver=new MutationObserver(()=>this._syncLightDom()),this._observedBoxes=new Set}connectedCallback(){super.connectedCallback(),this._syncLightDom(),this._lightDomObserver.observe(this,{childList:!0,subtree:!0,characterData:!0,attributes:!0,attributeFilter:[`slot`,`aria-label`]})}disconnectedCallback(){super.disconnectedCallback(),this._lightDomObserver.disconnect(),this._resizeObserver?.disconnect(),this._observedBoxes.clear()}get _scroller(){return this.renderRoot?.querySelector(`.cp-pane`)??null}_hasSlot(...e){return Array.from(this.children).some(t=>e.includes(t.slot))}_syncSlotPresence(){this._hasSlottedHeader=this._hasSlot(`header`,`title`,`header-actions`),this._hasSlottedFooter=this._hasSlot(`footer`,`footer-content`,`feedback`,`actions`,`primary-action`,`secondary-action`)}_syncLightDom(){this._syncSlotPresence(),this._hostLabel=this.getAttribute(`aria-label`)??``,this._syncScrollable(),this._observeScrollable()}_syncScrollable(){let e=this._scroller;if(!e?.isConnected){this._scrollable=!1;return}let{overflowX:t,overflowY:n}=getComputedStyle(e);this._scrollable=!_c.has(n)&&e.scrollHeight-e.clientHeight>1||!_c.has(t)&&e.scrollWidth-e.clientWidth>1}_observeScrollable(){if(typeof ResizeObserver>`u`)return;let e=this._resizeObserver??=new ResizeObserver(()=>this._syncScrollable()),t=this._scroller,n=new Set(t?[t,...t.querySelectorAll(`.cp-pane__header, .cp-pane__body, .cp-pane__footer`),...this.children]:[]);for(let t of this._observedBoxes)n.has(t)||(e.unobserve(t),this._observedBoxes.delete(t));for(let t of n)this._observedBoxes.has(t)||(e.observe(t),this._observedBoxes.add(t))}get _scrollRegionLabel(){return this.label||this._hostLabel||O(`Scrollable region`)}focus(e){if(this._scrollable&&this._scroller){this._scroller.focus(e);return}super.focus(e)}updated(e){super.updated(e),this._observeScrollable()}render(){let e=!!this.label||this._hasSlottedHeader;return r`
    ...
    `}};vc.styles=[yo,mc],p([g({reflect:!0})],vc.prototype,`appearance`,void 0),p([g({reflect:!0})],vc.prototype,`variant`,void 0),p([g()],vc.prototype,`label`,void 0),p([_()],vc.prototype,`_hasSlottedHeader`,void 0),p([_()],vc.prototype,`_hasSlottedFooter`,void 0),p([_()],vc.prototype,`_scrollable`,void 0),p([_()],vc.prototype,`_hostLabel`,void 0),customElements.get(`craft-pane`)||customElements.define(`craft-pane`,vc);var yc=0,bc=new WeakMap,U=new WeakSet,xc=class extends l{constructor(...e){super(...e),d(this,U),this.groups=[],this.modelValue=[],this.lockedPermissions=[],this.name=``,this.disabled=!1,f(this,bc,++yc)}updated(e){super.updated(e),(e.has(`modelValue`)||e.has(`groups`)||e.has(`name`)||e.has(`disabled`))&&u(U,this,Mc).call(this)}render(){let e=u(U,this,wc).call(this);return Xa(this.groups,e=>e.handle,(t,n)=>u(U,this,Sc).call(this,t,n,e))}};function Sc(e,t,n){let i=`permission-tree-heading-${m(bc,this)}-${t}`;return r`
      <section class="group">
        ${e.heading?r`
              <div class="heading">
                ...
                <craft-button
                  ...
                  aria-describedby=${i}
                  ?disabled=${this.disabled}
                  @click=${()=>u(U,this,Oc).call(this,e.keys,n)}
                >
                  ${u(U,this,Dc).call(this,e.keys,n)?O(`Deselect all`):O(`Select all`)}
                </craft-button>
              </div>
            `:c}
        ${u(U,this,Cc).call(this,e.permissions,0,this.disabled,n)}
      </section>
    `}function Cc(e,t,n,i){return Xa(Object.entries(e),([e])=>e,([e,a])=>{let o=a.key||e,s=u(U,this,Ec).call(this,o,i),l=a.nested??{};return r`
          <ul>
            <li>
              <craft-checkbox
                class=${t>0?`indented`:``}
                ...
                .choiceValue=${o}
                .checked=${s}
                .disabled=${n||u(U,this,Tc).call(this,o,i)}
                @model-value-changed=${e=>u(U,this,kc).call(this,e,o,l,i)}
              >
                ${a.info||a.warning?r`
                      <div slot="help-text">
                        ${a.info??c}
              ...
              ${Object.keys(l).length?u(U,this,Cc).call(this,l,t+1,n||!s,i):c}
            </li>
          </ul>
        `})}function wc(){return new Set(this.lockedPermissions.map(e=>e.toLowerCase()))}function Tc(e,t){return t.has(e.toLowerCase())}function Ec(e,t){return this.modelValue.includes(e)||u(U,this,Tc).call(this,e,t)}function Dc(e,t){let n=e.filter(e=>!u(U,this,Tc).call(this,e,t));return n.length>0&&n.every(e=>this.modelValue.includes(e))}function Oc(e,t){let n=e.filter(e=>!u(U,this,Tc).call(this,e,t));if(u(U,this,Dc).call(this,e,t)){let e=new Set(n);u(U,this,jc).call(this,this.modelValue.filter(t=>!e.has(t)));return}u(U,this,jc).call(this,[...new Set([...this.modelValue,...n])])}function kc(e,t,n,r){if(e.stopPropagation(),this.disabled||u(U,this,Tc).call(this,t,r))return;let i=e.currentTarget.checked,a=this.modelValue.indexOf(t);if(i&&a===-1){u(U,this,jc).call(this,[...this.modelValue,t]);return}if(i||a===-1)return;let o=new Set([t,...u(U,this,Ac).call(this,n)]);u(U,this,jc).call(this,this.modelValue.filter(e=>!o.has(e)))}function Ac(e){return Object.values(e).flatMap(e=>[e.key,...u(U,this,Ac).call(this,e.nested??{})])}function jc(e){this.modelValue=e,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,composed:!0,detail:{isTriggeredByUser:!0}}))}function Mc(){if(this.querySelectorAll(`[data-permission-tree-input]`).forEach(e=>e.remove()),!this.name||this.disabled)return;u(U,this,Nc).call(this,this.name,``);let e=new Set(this.groups.flatMap(e=>e.keys));for(let t of this.modelValue)e.has(t)&&u(U,this,Nc).call(this,`${this.name}[]`,t)}function Nc(e,t){let n=document.createElement(`input`);n.type=`hidden`,n.name=e,n.value=t,n.dataset.permissionTreeInput=``,this.append(n)}xc.styles=a`
    :host {
      display: block;
    }
  ...
  `,p([g({type:Array})],xc.prototype,`groups`,void 0),p([g({type:Array,attribute:`model-value`})],xc.prototype,`modelValue`,void 0),p([g({type:Array,attribute:`locked-permissions`})],xc.prototype,`lockedPermissions`,void 0),p([g()],xc.prototype,`name`,void 0),p([g({type:Boolean,reflect:!0})],xc.prototype,`disabled`,void 0),customElements.get(`craft-permission-tree`)||customElements.define(`craft-permission-tree`,xc);var Pc=a`
  :host {
...
`,Fc=new WeakMap,Ic=class extends l{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,f(this,Fc,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&m(Fc,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),h(Fc,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,h(Fc,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return r`
      <div
    ...
    `}};Ic.styles=[Pc],p([g({type:Number})],Ic.prototype,`progress`,void 0),p([g({type:Number})],Ic.prototype,`total`,void 0),p([g({type:Number})],Ic.prototype,`processed`,void 0),p([g({type:Boolean,attribute:`show-status`})],Ic.prototype,`showStatus`,void 0),p([g({type:Boolean,reflect:!0})],Ic.prototype,`pending`,void 0),p([g({type:Boolean})],Ic.prototype,`smooth`,void 0),p([g({type:String})],Ic.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,Ic);var Lc=class extends Pi(Ri(l)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},Rc=class extends Ii(Bi){connectedCallback(){super.connectedCallback(),this.type=`radio`}},zc=class extends Lc{constructor(...e){super(...e),this.thumbnails=!1,this.__ssrNameAdopted=!1}connectedCallback(){this.__adoptSlottedName(),super.connectedCallback()}willUpdate(e){this.__adoptSlottedName(),super.willUpdate(e)}__adoptSlottedName(){if(this.__ssrNameAdopted||this.name)return;let e=this.querySelector(`input[type="radio"][name]`);e&&(this.__ssrNameAdopted=!0,this.name=e.name)}static get styles(){return[...super.styles,xr,a`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }
      ...
      `]}};p([g({type:Boolean,reflect:!0})],zc.prototype,`thumbnails`,void 0),customElements.get(`craft-radio-group`)||customElements.define(`craft-radio-group`,zc);var Bc=class extends Wi(Rc){static get styles(){return[...super.styles,a`
        /* same as checkbox, potentially consolidate */
        :host {
          gap: var(--c-spacing-sm);
        }
      `]}};customElements.get(`craft-radio`)||customElements.define(`craft-radio`,Bc);var Vc=a`
  craft-button {
    cursor: move;
  }
...
`,Hc=class extends l{constructor(...e){super(...e),this.label=null,this.position=`middle`,this.orientation=`vertical`,this.variant=`plain`,this.disabled=!1}updated(e){super.updated(e),e.has(`disabled`)&&(this.disabled?this.setAttribute(`aria-disabled`,`true`):this.removeAttribute(`aria-disabled`))}_reorder(e){this.disabled||e===`up`&&this.position===`first`||e===`down`&&this.position===`last`||this.dispatchEvent(new CustomEvent(`reorder`,{detail:{direction:e},bubbles:!0,composed:!0}))}_isRtl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}render(){let e=this.label??O(`Reorder`),t=this.orientation===`horizontal`,n=t&&this._isRtl(),i=t?n?`arrow-right`:`arrow-left`:`arrow-up`,a=t?n?`arrow-left`:`arrow-right`:`arrow-down`,o=O(t?`Move forward`:`Move up`),s=O(t?`Move backward`:`Move down`);return r`
    ...
    `}};Hc.styles=[Vc],p([g()],Hc.prototype,`label`,void 0),p([g({reflect:!0})],Hc.prototype,`position`,void 0),p([g({reflect:!0})],Hc.prototype,`orientation`,void 0),p([g({reflect:!0})],Hc.prototype,`variant`,void 0),p([g({reflect:!0,type:Boolean})],Hc.prototype,`disabled`,void 0),customElements.get(`craft-reorder-button`)||customElements.define(`craft-reorder-button`,Hc);var Uc=class extends He(Wt){static get styles(){return[...super.styles,a`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,qc=class extends Uc{static get styles(){return[...super.styles,Kc]}_afterTemplate(){return r`${this.singleOption?``:r`<craft-icon class="indicator" name="chevron-down"></craft-icon>`}`}},Jc=a`
  ${br}
...
`,Yc=class extends Gc{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,Jc]}static get scopedElements(){return{...super.scopedElements,"lion-select-invoker":qc}}async _alignInvokerWidth(){if(await this.updateComplete,!this._overlayCtrl?.content)return;let e=this._overlayCtrl.content.style.display,t=this._overlayCtrl.contentWrapperNode.style.minWidth,n=this._overlayCtrl.contentWrapperNode.style.width;this._overlayCtrl.content.style.display=``,this._overlayCtrl.contentWrapperNode.style.minWidth=`auto`,this._overlayCtrl.contentWrapperNode.style.width=`auto`;let r=this._overlayCtrl.contentWrapperNode.getBoundingClientRect().width;r>0&&(this._invokerNode.style.minWidth=`${r}px`,this._invokerNode.style.width=``),this._overlayCtrl.content.style.display=e,this._overlayCtrl.contentWrapperNode.style.minWidth=t,this._overlayCtrl.contentWrapperNode.style.width=n}_inputGroupInputTemplate(){return r`
    ...
    `}};p([g({reflect:!0,type:Boolean})],Yc.prototype,`small`,void 0),customElements.get(`craft-select-rich`)||customElements.define(`craft-select-rich`,Yc);var Xc=a`
  :host {
    display: block;
  }
`;function Zc(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Qc=class extends l{constructor(...e){super(...e),this.label=``,this.name=``,this.modelValue=null,this.allowTransparent=!1}_swatchTemplate(e){return r`<span
    ...
    ></span>`}_optionTemplate(e,t){return r`<craft-option .choiceValue=${e}>
      ...
      >
        ...
        ${tt.map(e=>this._optionTemplate(e,O(Zc(e))))}
      </craft-select-rich>
    `}};Qc.styles=[Xc],p([g()],Qc.prototype,`label`,void 0),p([g()],Qc.prototype,`name`,void 0),p([g({attribute:`model-value`})],Qc.prototype,`modelValue`,void 0),p([g({type:Boolean,reflect:!0,attribute:`allow-transparent`})],Qc.prototype,`allowTransparent`,void 0),customElements.get(`craft-select-color`)||customElements.define(`craft-select-color`,Qc);var $c=class extends ki{static get properties(){return{autocomplete:{type:String}}}constructor(){super(),this.autocomplete=void 0}get _inputNode(){return Array.from(this.children).find(e=>e.slot===`input`)}},el=class extends $c{get operationMode(){return`select`}connectedCallback(){super.connectedCallback(),this._inputNode.addEventListener(`change`,this._proxyChangeEvent),this.__selectObserver=new MutationObserver(()=>{this._syncValueUpwards(),this._calculateValues({source:`model`})}),this.__selectObserver.observe(this._inputNode,{attributes:!0,childList:!0,subtree:!0})}updated(e){super.updated(e),e.has(`disabled`)&&(this._inputNode.disabled=this.disabled,this.validate()),e.has(`name`)&&(this._inputNode.name=this.name),e.has(`autocomplete`)&&(this._inputNode.autocomplete=this.autocomplete)}disconnectedCallback(){super.disconnectedCallback(),this._inputNode.removeEventListener(`change`,this._proxyChangeEvent),this.__selectObserver?.disconnect()}formatter(e){let t=Array.from(this._inputNode.options).find(t=>t.value===e);return t?t.text:``}_reflectBackFormattedValueToUser(){this._reflectBackOn()&&(this.value=this.modelValue===void 0?``:this.modelValue)}_proxyChangeEvent(){this.dispatchEvent(new CustomEvent(`user-input-changed`,{bubbles:!0,composed:!0}))}},tl=a`
  ${br}
...
`,nl=class extends el{constructor(...e){super(...e),this.small=!1}static get styles(){return[...super.styles,tl]}_inputGroupInputTemplate(){return r`
      <div class="input-group__input">
        <slot name="input"></slot>
        <craft-icon
          class="indicator"
    ...
    `}};p([g({reflect:!0,type:Boolean})],nl.prototype,`small`,void 0),customElements.get(`craft-select`)||customElements.define(`craft-select`,nl);var rl=a`
  :host {
    display: inline-block;
  }
...
`,il=new WeakSet,al=class extends l{constructor(...e){super(...e),d(this,il),this.min=0,this.max=100,this.step=10,this.value=0,this.label=O(`Number of columns`),this.valueUnit=``,this.readOnly=!1}willUpdate(e){if(super.willUpdate(e),e.has(`min`)||e.has(`max`)||e.has(`step`)||e.has(`value`)){let e=u(il,this,sl).call(this,this.value);e!==this.value&&(this.value=e)}}render(){let e=u(il,this,ol).call(this);return r`
      <div
        class="slide-picker"
        role="slider"
        ...
        aria-valuetext=${u(il,this,ll).call(this,this.value)}
        aria-readonly=${this.readOnly?`true`:`false`}
        aria-describedby=${ie(this.describedBy)}
        @keydown=${u(il,this,fl)}
      >
        ${e.map(e=>r`
            <span
              ...
              role="presentation"
              aria-hidden="true"
              @click=${()=>u(il,this,dl).call(this,e)}
              title=${u(il,this,ll).call(this,e)}
              >${c}</span
            >
          `)}
      </div>
    `}};function ol(){let{min:e,max:t,step:n}=this;if(n<=0||t<e)throw Error(`Invalid craft-slide-picker range configuration.`);let r=(t-e)/n;if(!Number.isInteger(r))throw Error(`Invalid craft-slide-picker step configuration for the provided range.`);return Array.from({length:r+1},(t,r)=>e+r*n)}function sl(e){u(il,this,ol).call(this);let{min:t,max:n,step:r}=this,i=t+Math.round((Math.min(Math.max(e,t),n)-t)/r)*r;return Math.min(Math.max(i,t),n)}function cl(){return(this.closest(`[dir]`)?.getAttribute(`dir`)??document.documentElement.getAttribute(`dir`))?.toLowerCase()===`rtl`}function ll(e){return this.valueLabel?this.valueLabel(e):this.valueUnit?`${e}${this.valueUnit}`:`${e}`}function ul(e,t){let n=u(il,this,sl).call(this,e);n!==this.value&&(this.value=n,t&&this.dispatchEvent(new CustomEvent(`value-change`,{detail:{value:n},bubbles:!0,composed:!0})))}function dl(e){this.readOnly||u(il,this,ul).call(this,e,!0)}function fl(e){if(this.readOnly)return;let t=u(il,this,cl).call(this);switch(e.key){case`ArrowUp`:u(il,this,ul).call(this,this.value+this.step,!0),e.preventDefault();break;case`ArrowDown`:u(il,this,ul).call(this,this.value-this.step,!0),e.preventDefault();break;case`ArrowRight`:u(il,this,ul).call(this,this.value+(t?-this.step:this.step),!0),e.preventDefault();break;case`ArrowLeft`:u(il,this,ul).call(this,this.value+(t?this.step:-this.step),!0),e.preventDefault();break;case`Home`:u(il,this,ul).call(this,this.min,!0),e.preventDefault();break;case`End`:u(il,this,ul).call(this,this.max,!0),e.preventDefault();break}}al.styles=[rl],p([g({type:Number})],al.prototype,`min`,void 0),p([g({type:Number})],al.prototype,`max`,void 0),p([g({type:Number})],al.prototype,`step`,void 0),p([g({type:Number})],al.prototype,`value`,void 0),p([g()],al.prototype,`label`,void 0),p([g({attribute:`described-by`})],al.prototype,`describedBy`,void 0),p([g({attribute:`value-unit`})],al.prototype,`valueUnit`,void 0),p([g({attribute:!1})],al.prototype,`valueLabel`,void 0),p([g({type:Boolean,reflect:!0,attribute:`read-only`})],al.prototype,`readOnly`,void 0),customElements.get(`craft-slide-picker`)||customElements.define(`craft-slide-picker`,al);var pl=a`
  :host {
    display: block;
  }
...
`,ml=new WeakMap,hl=new WeakMap,gl=new WeakMap,_l=new WeakMap,vl=new WeakMap,yl=new WeakMap,W=new WeakSet,bl=class extends l{constructor(...e){super(...e),d(this,W),this.min=-45,this.max=45,this.value=0,this.graduationMin=-70,this.graduationMax=70,this.label=O(`Rotate`),f(this,ml,!1),f(this,hl,!1),f(this,gl,0),f(this,_l,0),f(this,vl,0),f(this,yl,null)}connectedCallback(){super.connectedCallback(),h(yl,this,new ResizeObserver(()=>u(W,this,Sl).call(this))),m(yl,this).observe(this)}disconnectedCallback(){super.disconnectedCallback(),m(yl,this)?.disconnect(),h(yl,this,null)}firstUpdated(){h(vl,this,(u(W,this,xl).call(this).length-1)*10),u(W,this,Sl).call(this)}updated(e){(e.has(`value`)||e.has(`min`)||e.has(`max`)||e.has(`graduationMin`)||e.has(`graduationMax`))&&u(W,this,Sl).call(this)}render(){return r`
      <div
        class="slide-rule"
        role="slider"
        tabindex="0"
        ...
        aria-valuemax=${this.max}
        aria-valuenow=${this.value}
        aria-valuetext=${u(W,this,Cl).call(this,this.value)}
        @keydown=${u(W,this,Ml)}
        @pointerdown=${u(W,this,Ol)}
        @pointermove=${u(W,this,kl)}
        @pointerup=${u(W,this,Al)}
      >
        <div class="overlay"></div>
        <div class="cursor"></div>
        <div class="graduations">
          <ul aria-hidden="true">
            ${u(W,this,xl).call(this).map(e=>r`
                <li
                  class=${k({graduation:!0,"main-graduation":e%5==0,selected:u(W,this,Nl).call(this,e)})}
                  data-graduation=${e}
                >
    ...
    `}};function xl(){let e=[];for(let t=this.graduationMin;t<=this.graduationMax;t++)e.push(t);return e}function Sl(){this._list&&(this._list.style.left=`${u(W,this,Tl).call(this,this.value)}px`)}function Cl(e){return O(`{num, number} {num, plural, =1{degree} other{degrees}}`,{num:Math.round(e)})}function wl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return(this._graduations.offsetWidth/2+e*-1)/m(vl,this)*n-t}function Tl(e){let t=this.graduationMin*-1,n=(this.graduationMin-this.graduationMax)*-1;return-((e+t)*m(vl,this)/n-this._graduations.offsetWidth/2)}function El(e,t=!0){let n=Math.min(Math.max(e,this.min),this.max);this.value=n,t&&u(W,this,Dl).call(this,`change`)}function Dl(e){this.dispatchEvent(new CustomEvent(e,{detail:{value:this.value},bubbles:!0,composed:!0}))}function Ol(e){h(hl,this,this._graduations.contains(e.target)&&e.target!==this._graduations),m(hl,this)&&(e.preventDefault(),h(gl,this,e.clientX),h(_l,this,this._list.offsetLeft),this._root.setPointerCapture(e.pointerId),u(W,this,Dl).call(this,`start`))}function kl(e){m(hl,this)&&Math.abs(e.clientX-m(gl,this))>3&&(h(ml,this,!0),this._root.classList.add(`dragging`),e.preventDefault(),u(W,this,jl).call(this,e))}function Al(e){m(hl,this)&&(m(ml,this)?(e.preventDefault(),h(ml,this,!1),this._root.classList.remove(`dragging`)):u(W,this,jl).call(this,e),u(W,this,Dl).call(this,`end`),this._root.releasePointerCapture(e.pointerId),h(gl,this,0),h(hl,this,!1))}function jl(e){let t=m(ml,this)?m(gl,this):this._cursor.getBoundingClientRect().left+this._cursor.offsetWidth/2,n=m(ml,this)?t-e.clientX:e.clientX-t,r=m(_l,this)-n;u(W,this,El).call(this,u(W,this,wl).call(this,r))}function Ml(e){let t=this.value;switch(e.key){case`ArrowUp`:case`ArrowRight`:u(W,this,El).call(this,t+1);break;case`ArrowDown`:case`ArrowLeft`:u(W,this,El).call(this,t-1);break;case`PageUp`:u(W,this,El).call(this,t+10);break;case`PageDown`:u(W,this,El).call(this,t-10);break;case`Home`:u(W,this,El).call(this,this.min);break;case`End`:u(W,this,El).call(this,this.max);break;default:return}e.preventDefault()}function Nl(e){return e>=Math.min(0,this.value)&&e<=Math.max(0,this.value)}bl.styles=[pl],p([g({type:Number})],bl.prototype,`min`,void 0),p([g({type:Number})],bl.prototype,`max`,void 0),p([g({type:Number})],bl.prototype,`value`,void 0),p([g({type:Number,attribute:`graduation-min`})],bl.prototype,`graduationMin`,void 0),p([g({type:Number,attribute:`graduation-max`})],bl.prototype,`graduationMax`,void 0),p([g()],bl.prototype,`label`,void 0),p([y(`.slide-rule`)],bl.prototype,`_root`,void 0),p([y(`.graduations`)],bl.prototype,`_graduations`,void 0),p([y(`.graduations ul`)],bl.prototype,`_list`,void 0),p([y(`.cursor`)],bl.prototype,`_cursor`,void 0),customElements.get(`craft-slide-rule`)||customElements.define(`craft-slide-rule`,bl);var Pl=a`
  :host {
    display: inline-flex;
...
`,Fl=class extends l{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return r`
      <span
      ...
      ></span>
    `}};Fl.styles=[Pl],p([g()],Fl.prototype,`label`,void 0),p([g()],Fl.prototype,`status`,void 0),customElements.get(`craft-status`)||customElements.define(`craft-status`,Fl);var Il=class extends Oe(l){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[a`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
    ...
    `}_groupOneTemplate(){return r`${this._labelTemplate()} ${this._helpTextTemplate()} ${this._feedbackTemplate()}`}_groupTwoTemplate(){return r`${this._inputGroupTemplate()}`}constructor(){super(),this.checked=!1,this.__handleButtonSwitchCheckedChanged=this.__handleButtonSwitchCheckedChanged.bind(this)}connectedCallback(){super.connectedCallback(),this.addEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.addEventListener(`click`,this._toggleChecked),this._syncButtonSwitch()}disconnectedCallback(){super.disconnectedCallback(),this._inputNode&&this.removeEventListener(`checked-changed`,this.__handleButtonSwitchCheckedChanged),this._labelNode&&this._labelNode.removeEventListener(`click`,this._toggleChecked)}updated(e){super.updated(e),e.has(`disabled`)&&this._syncButtonSwitch()}_toggleChecked(e){e.preventDefault(),super._toggleChecked(e)}_isEmpty(){return!1}__handleButtonSwitchCheckedChanged(e){e.stopPropagation(),this._isHandlingUserInput=!0,this.checked=this._inputNode.checked,this._isHandlingUserInput=!1}_syncButtonSwitch(){this._inputNode.disabled=this.disabled}_onLabelClick(){this.disabled||this._inputNode.focus()}},Rl=class extends Il{constructor(...e){super(...e),this.indeterminate=!1}updated(e){super.updated(e),(e.has(`indeterminate`)||e.has(`checked`))&&this.setAttribute(`aria-checked`,this.checked?`true`:this.indeterminate?`mixed`:`false`)}static get styles(){return[...super.styles,a`
      ...
      `]}};p([g({type:Boolean,reflect:!0})],Rl.prototype,`indeterminate`,void 0),customElements.get(`craft-switch-button`)||customElements.define(`craft-switch-button`,Rl);var zl=a`
  :host {
    display: grid;
  }
...
`;function Bl(e){return(e??``).split(/\s+/).filter(Boolean)}function Vl(e){return typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(e):e}var Hl=Symbol.for(`craft-switch-synthetic-change`),Ul=new WeakMap,Wl=new WeakSet,Gl=class extends Ll{constructor(...e){super(...e),d(this,Wl),this.size=`medium`,this.onLabel=``,this.offLabel=``,this.checkedValue=`1`,this.indeterminateValue=`-`,this.indeterminate=!1,this.__externalLabelledByNodes=[],this.__externalDescribedByNodes=[],this.__clickableExternalLabels=new Set,f(this,Ul,!1),this.__onKeydown=e=>{if(e.key!==`ArrowLeft`&&e.key!==`ArrowRight`||this.disabled||e.target!==this._inputNode)return;e.preventDefault();let t=getComputedStyle(this).direction===`rtl`;this._setCheckedState(e.key===(t?`ArrowLeft`:`ArrowRight`))},this.__forwardNativeChange=e=>{e.target===this._inputNode&&this.__dispatchNativeChange()},this.__onExternalLabelClick=e=>{this.disabled||e.composedPath().includes(this)||this._inputNode?.click()}}static get styles(){return[...super.styles,br,zl]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e},"state-description":()=>{let e=document.createElement(`div`);return e.textContent=this._stateDescriptionText,e},"hidden-input":()=>{if(!this.name)return;let e=document.createElement(`input`);return e.type=`hidden`,e.name=this.name,e.value=this._postedValue,e.disabled=this.disabled,e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Rl}}connectedCallback(){super.connectedCallback(),this.__adoptExternalAria(),this.addEventListener(`checked-changed`,this.__forwardNativeChange),this.addEventListener(`keydown`,this.__onKeydown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`checked-changed`,this.__forwardNativeChange),this.removeEventListener(`keydown`,this.__onKeydown),this.__teardownExternalLabelClicks()}get _hiddenInputNode(){return Array.from(this.children).find(e=>e instanceof HTMLInputElement&&e.slot===`hidden-input`)}get _postedValue(){return this.checked?this.checkedValue:this.indeterminate?this.indeterminateValue:``}get _stateDescriptionNode(){return Array.from(this.children).find(e=>e.slot===`state-description`)}get _stateDescriptionText(){return[this.onLabel?O(`Check for {onLabel}.`,{onLabel:this.onLabel}):``,this.offLabel?O(`Uncheck for {offLabel}.`,{offLabel:this.offLabel}):``].filter(Boolean).join(` `)}updated(e){super.updated(e),e.has(`checked`)&&this.checked&&this.indeterminate&&(this.indeterminate=!1),(e.has(`onLabel`)||e.has(`offLabel`))&&this.__syncStateDescription(),[`checked`,`indeterminate`,`checkedValue`,`indeterminateValue`,`disabled`,`size`].some(t=>e.has(t))&&(this.__syncSwitchButton(),this.__syncHiddenInput()),(e.has(`checked`)||e.has(`indeterminate`))&&this.__syncToggleTargets()}__syncToggleTargets(){let e=this._inputNode;if(!e)return;let t=e.getAttribute(`data-target`),n=e.getAttribute(`data-reverse-target`);if(!t&&!n)return;let r=window.jQuery;r&&r(e).data?.(`fieldtoggle`)||(this.__toggleTargets(t,this.checked),this.__toggleTargets(n,!this.checked))}__toggleTargets(e,t){if(!e)return;let n=/^[#.]/.test(e)?e:`#${e}`,r=this.getRootNode(),i=!1;for(let e of r.querySelectorAll(n))e.classList.contains(`hidden`)===t&&(e.classList.toggle(`hidden`,!t),i=!0);i&&t&&window.dispatchEvent(new Event(`resize`))}_setCheckedState(e){if(this.disabled)return;let t=this.indeterminate;this.checked===e&&!t||(this.indeterminate=!1,this.checked===e?t&&this.__dispatchNativeChange():this.checked=e)}get on(){return this.checked}get postedValue(){return this._postedValue}turnOn(e=!1){u(Wl,this,Kl).call(this,()=>this._setCheckedState(!0),e)}turnOff(e=!1){u(Wl,this,Kl).call(this,()=>this._setCheckedState(!1),e)}turnIndeterminate(e=!1){u(Wl,this,Kl).call(this,()=>{if(this.indeterminate&&!this.checked)return;let e=this.checked;this.checked=!1,this.indeterminate=!0,e||this.__dispatchNativeChange()},e)}__dispatchNativeChange(){if(m(Ul,this))return;let e=new Event(`change`,{bubbles:!0});e[Hl]=!0,this._inputNode?.dispatchEvent(e)}_onChange(e){e&&Hl in e||super._onChange(e)}__adoptExternalAria(){let e=this._inputNode;if(!e)return;let t=this.getRootNode();for(let n of Bl(e.getAttribute(`aria-labelledby`))){let e=t.getElementById(n);e&&!this.__externalLabelledByNodes.includes(e)&&(this.addToAriaLabelledBy(e,{reorder:!1}),this.__externalLabelledByNodes.push(e))}for(let n of Bl(e.getAttribute(`aria-describedby`))){let e=t.getElementById(n);e&&!this.__externalDescribedByNodes.includes(e)&&(this.addToAriaDescribedBy(e,{reorder:!1}),this.__externalDescribedByNodes.push(e))}this.__setupExternalLabelClicks()}__setupExternalLabelClicks(){let e=this._inputNode;if(!e)return;let t=this.getRootNode(),n=new Set(this.__externalLabelledByNodes.filter(e=>e instanceof HTMLLabelElement));if(e.id)for(let r of t.querySelectorAll(`label[for="${Vl(e.id)}"]`))n.add(r);for(let e of n)this.__clickableExternalLabels.has(e)||(e.addEventListener(`click`,this.__onExternalLabelClick),this.__clickableExternalLabels.add(e))}__teardownExternalLabelClicks(){for(let e of this.__clickableExternalLabels)e.removeEventListener(`click`,this.__onExternalLabelClick);this.__clickableExternalLabels.clear()}__syncSwitchButton(){let e=this._inputNode;if(!e)return;e.getAttribute(`size`)!==this.size&&e.setAttribute(`size`,this.size);let t=this.indeterminate&&!this.checked;e.indeterminate!==t&&(e.indeterminate=t)}__syncHiddenInput(){let e=this._hiddenInputNode;e&&(e.value=this._postedValue,e.disabled=this.disabled,this.name&&e.name!==this.name&&(e.name=this.name))}__syncStateDescription(){let e=this._stateDescriptionNode;if(!e)return;let t=this._stateDescriptionText;e.textContent=t,t?this.addToAriaDescribedBy(e,{idPrefix:`state-description`,reorder:!1}):this.removeFromAriaDescribedBy(e)}_groupOneTemplate(){return r`${super._groupOneTemplate()} ${this._stateDescriptionTemplate()}`}_stateDescriptionTemplate(){return r`<slot name="state-description"></slot>`}_stateLabelTemplate(e){let t=e===`on`?this.onLabel:this.offLabel;return t?r`<span
    ...
    `}};function Kl(e,t){if(!this.disabled){if(!t){e();return}h(Ul,this,!0),e(),this.updateComplete.then(()=>{h(Ul,this,!1)})}}p([g({type:String,reflect:!0})],Gl.prototype,`size`,void 0),p([g({type:String,attribute:`on-label`})],Gl.prototype,`onLabel`,void 0),p([g({type:String,attribute:`off-label`})],Gl.prototype,`offLabel`,void 0),p([g({attribute:`value`})],Gl.prototype,`checkedValue`,void 0),p([g({attribute:`indeterminate-value`})],Gl.prototype,`indeterminateValue`,void 0),p([g({type:Boolean,reflect:!0})],Gl.prototype,`indeterminate`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,Gl);function ql({el:e,uid:t}){e.setAttribute(`id`,`panel-${t}`),e.setAttribute(`role`,`tabpanel`),e.setAttribute(`aria-labelledby`,`button-${t}`),e.hasAttribute(`tabindex`)||e.setAttribute(`tabindex`,`0`)}function Jl(e){e.setAttribute(`selected`,`true`)}function Yl(e){e.removeAttribute(`selected`)}function Xl({el:e,uid:t,clickHandler:n,keydownHandler:r,keyupHandler:i}){e.setAttribute(`id`,`button-${t}`),e.setAttribute(`role`,`tab`),e.setAttribute(`aria-controls`,`panel-${t}`),e.addEventListener(`click`,n),e.addEventListener(`keyup`,i),e.addEventListener(`keydown`,r)}function Zl({el:e,clickHandler:t,keydownHandler:n,keyupHandler:r}){e.removeAttribute(`id`),e.removeAttribute(`role`),e.removeAttribute(`aria-controls`),e.removeEventListener(`click`,t),e.removeEventListener(`keyup`,r),e.removeEventListener(`keydown`,n)}function Ql(e,t=!1){t&&e.focus(),e.setAttribute(`selected`,`true`),e.setAttribute(`aria-selected`,`true`),e.setAttribute(`tabindex`,`0`)}function $l(e){e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`),e.setAttribute(`tabindex`,`-1`)}function eu(e){let t=e;switch(t.key){case`ArrowDown`:case`ArrowRight`:case`ArrowUp`:case`ArrowLeft`:case`Home`:case`End`:t.preventDefault()}}var tu=class extends l{static get properties(){return{selectedIndex:{type:Number,attribute:`selected-index`,reflect:!0}}}static get styles(){return[a`
        .tabs__tab-group {
          display: flex;
        }
...
`,ru={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(ru);var iu={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(iu);var au=[ru.InlineStart,ru.InlineEnd],ou=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),G=new WeakSet,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakMap,du=new WeakMap,fu=new WeakMap,pu=new WeakMap,mu=new WeakMap,hu=new WeakMap,gu=new WeakMap,_u=new WeakMap,vu=class extends tu{constructor(...e){super(...e),d(this,G),this.placement=ru.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,su,[]),f(this,cu,!1),f(this,lu,[]),f(this,uu,0),f(this,du,void 0),f(this,fu,!1),f(this,pu,e=>{if(!this.collapsible||bu.call(u(G,this)))return;let t=u(G,this,wu).call(this,e.target);!t||t.disabled||xu.call(u(G,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(G,this,Tu).call(this,!0))}),f(this,mu,e=>{e.key!==`Escape`||!this.collapsible||bu.call(u(G,this))||u(G,this,wu).call(this,e.target)&&(e.stopPropagation(),u(G,this,Tu).call(this,!0))}),f(this,hu,()=>{bu.call(u(G,this))&&(xu.call(u(G,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(G,this,Eu).call(this)}),f(this,gu,()=>{if(u(G,this,Du).call(this),xu.call(u(G,this)).forEach((e,t)=>{let n=()=>u(G,this,Fu).call(this,t,!0),r=e=>{ou.has(e.key)&&e.preventDefault()},i=e=>u(G,this,Iu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(su,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),xu.call(u(G,this))[this.selectedIndex]?.disabled){let e=xu.call(u(G,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(G,this,Ou).call(this)}),f(this,_u,()=>{m(fu,this)||(h(fu,this,!0),requestAnimationFrame(()=>{h(fu,this,!1),u(G,this,Au).call(this)}))})}static get styles(){return[...super.styles,yo,nu]}get layout(){return yu.call(u(G,this))?iu.Vertical:iu.Horizontal}set layout(e){this.placement=e===iu.Vertical?ru.InlineStart:ru.BlockStart}refresh(){m(cu,this)&&u(G,this,Ou).call(this),u(G,this,Au).call(this)}firstUpdated(e){h(cu,this,xu.call(u(G,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(cu,this))t?.addEventListener(`slotchange`,m(gu,this)),m(gu,this).call(this);else{let n=bu.call(u(G,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(hu,this))}this.addEventListener(`click`,m(pu,this),!0),this.addEventListener(`keydown`,m(mu,this)),t?.addEventListener(`slotchange`,m(_u,this)),h(du,this,new ResizeObserver(m(_u,this))),m(du,this).observe(this),u(G,this,Au).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(G,this,Du).call(this),m(du,this)?.disconnect(),h(du,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,bu.call(u(G,this))),e.has(`selectedIndex`)&&(m(cu,this)?u(G,this,Ou).call(this):m(hu,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(G,this,Au).call(this)}render(){return r`
      <div class="tabs" part="base">
        <div class="tabs__strip" part="strip">
          <div
            ...
            part="tab-group"
            role="tablist"
            aria-orientation="${yu.call(u(G,this))?`vertical`:`horizontal`}"
          >
            <slot name="tab"></slot>
          </div>
          <!--
        ...
        -->
        <div class="tabs__panels" part="panels" ?hidden="${bu.call(u(G,this))}">
          <slot name="panel"></slot>
        </div>
      </div>
    `}};function yu(){return au.includes(this.placement)}function bu(){return this.selectedIndex<0}function xu(){return this.tabs}function Su(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function Cu(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function wu(e){return e instanceof Node?xu.call(u(G,this)).find(t=>t===e||t.contains(e))??null:null}function Tu(e){let t=xu.call(u(G,this))[this.selectedIndex];h(uu,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Eu(){let e=xu.call(u(G,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(uu,this))?m(uu,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function Du(){for(;m(su,this).length;)m(su,this).pop()?.()}function Ou(){let e=xu.call(u(G,this)).map(e=>u(G,this,ku).call(this,e)),t=e.some(Boolean);xu.call(u(G,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${Ue()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(G,this,Eu).call(this)}function ku(e){return e.controls?document.getElementById(e.controls):null}function Au(){let e=Su.call(u(G,this)),t=Cu.call(u(G,this)),n=xu.call(u(G,this));if(!e||!t)return;if(yu.call(u(G,this))||n.length===0){u(G,this,Mu).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(G,this,ju).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(G,this,Mu).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(G,this,Mu).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function ju(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function Mu(e){let t=Cu.call(u(G,this)),n=new Set(e);xu.call(u(G,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(lu,this,e),t&&(t.hidden=e.length===0,t.actions=u(G,this,Nu).call(this))}function Nu(){return m(lu,this).map(e=>{let t=xu.call(u(G,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(G,this,Pu).call(this,e)}})}function Pu(e){let t=xu.call(u(G,this))[e];if(!t||t.disabled)return;let n=Cu.call(u(G,this));n&&(n.opened=!1),this.selectedIndex=e,u(G,this,Au).call(this),t.focus()}function Fu(e,t){let n=xu.call(u(G,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Iu(e){if(!ou.has(e.key))return;let t=u(G,this,Lu).call(this,e.key);t!==-1&&u(G,this,Fu).call(this,t,!0)}function Lu(e){let t=xu.call(u(G,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(bu.call(u(G,this)))return u(G,this,Lu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],vu.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],vu.prototype,`collapsible`,void 0),p([g({reflect:!0})],vu.prototype,`layout`,null),p([g({reflect:!0})],vu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,vu);var Ru=a`
  :host {
    display: inline-flex;
...
`,Ju=C(ue(((e,t)=>{(function(n,r){typeof e==`object`&&t!==void 0?t.exports=r():typeof define==`function`&&define.amd?define(r):(n||=self,n.autosize=r())})(e,(function(){var e=new Map;function t(t){if(!t||!t.nodeName||t.nodeName!==`TEXTAREA`||e.has(t))return;var n=null;function r(e){for(var t=[];e&&e.parentNode&&e.parentNode instanceof Element;)e.parentNode.scrollTop&&t.push([e.parentNode,e.parentNode.scrollTop]),e=e.parentNode;return function(){return t.forEach(function(e){var t=e[0],n=e[1];t.style.scrollBehavior=`auto`,t.scrollTop=n,t.style.scrollBehavior=null})}}var i=window.getComputedStyle(t);function a(e){var o=e.restoreTextAlign,s=o===void 0?null:o,c=e.testForHeightReduction,l=c===void 0||c,u=i.overflowY;if(t.scrollHeight!==0){i.resize===`vertical`?t.style.resize=`none`:i.resize===`both`&&(t.style.resize=`horizontal`);var d;l&&(d=r(t),t.style.height=``);var f=i.boxSizing===`content-box`?t.scrollHeight-(parseFloat(i.paddingTop)+parseFloat(i.paddingBottom)):t.scrollHeight+parseFloat(i.borderTopWidth)+parseFloat(i.borderBottomWidth);if(i.maxHeight!==`none`&&f>parseFloat(i.maxHeight)?(i.overflowY===`hidden`&&(t.style.overflow=`scroll`),f=parseFloat(i.maxHeight)):i.overflowY!==`hidden`&&(t.style.overflow=`hidden`),t.style.height=f+`px`,s&&(t.style.textAlign=s),d&&d(),n!==f&&(t.dispatchEvent(new Event(`autosize:resized`,{bubbles:!0})),n=f),u!==i.overflow&&!s){var p=i.textAlign;i.overflow===`hidden`&&(t.style.textAlign=p===`start`?`end`:`start`),a({restoreTextAlign:p,testForHeightReduction:!0})}}}function o(){a({testForHeightReduction:!0,restoreTextAlign:null})}var s=function(){var e=t.value;return function(){a({testForHeightReduction:e===``||!t.value.startsWith(e),restoreTextAlign:null}),e=t.value}}(),c=function(n){t.removeEventListener(`autosize:destroy`,c),t.removeEventListener(`autosize:update`,o),t.removeEventListener(`input`,s),window.removeEventListener(`resize`,o),Object.keys(n).forEach(function(e){return t.style[e]=n[e]}),e.delete(t)}.bind(t,{height:t.style.height,resize:t.style.resize,textAlign:t.style.textAlign,overflowY:t.style.overflowY,overflowX:t.style.overflowX,wordWrap:t.style.wordWrap});t.addEventListener(`autosize:destroy`,c),t.addEventListener(`autosize:update`,o),t.addEventListener(`input`,s),window.addEventListener(`resize`,o),t.style.overflowX=`hidden`,t.style.wordWrap=`break-word`,e.set(t,{destroy:c,update:o}),o()}function n(t){var n=e.get(t);n&&n.destroy()}function r(t){var n=e.get(t);n&&n.update()}var i=null;return typeof window>`u`?(i=function(e){return e},i.destroy=function(e){return e},i.update=function(e){return e}):(i=function(e,n){return e&&Array.prototype.forEach.call(e.length?e:[e],function(e){return t(e)}),e},i.destroy=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],n),e},i.update=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],r),e}),i}))}))(),1),Yu=new WeakMap,Xu=new WeakMap,Zu=new WeakMap,Qu=new WeakSet,$u=class extends Ku{constructor(...e){super(...e),d(this,Qu),this.monospace=!1,f(this,Yu,void 0),f(this,Xu,void 0),f(this,Zu,null)}static get styles(){return[...super.styles,xr,qu]}connectedCallback(){super.connectedCallback(),u(Qu,this,ed).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(Yu,this)?.disconnect(),h(Yu,this,void 0),m(Xu,this)?.disconnect(),h(Xu,this,void 0)}};function ed(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(Zu,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(Zu,this,e.style.height)}),h(Xu,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(Xu,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(Yu,this,new ResizeObserver(()=>{if(e.style.height===m(Zu,this))return;let t=e.style.height;Ju.default.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(Xu,this)?.disconnect(),h(Xu,this,void 0),m(Yu,this)?.disconnect(),h(Yu,this,void 0)})),m(Yu,this).observe(e))}p([g({type:Boolean,reflect:!0})],$u.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,$u);var td=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>nd(e,this),this.compositionEventHandler=e=>cd(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,rd),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,rd)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(sd)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(sd)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(sd),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),od(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function nd(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:id(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&id(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function rd(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&ad(t,{event:e})}function id(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function ad(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function od(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function sd(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function cd(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var ld=class extends Event{constructor(){super(`update`)}},ud=new WeakMap,dd=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=ud.get(t);return n||(n=new e(t),ud.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),ud.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new ld)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of fd)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},fd=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),pd=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return dd.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},md=a`
  :host {
    display: contents;
  }
...
`,hd=/^[\p{L}\p{N}_.-]*$/u,gd=O(`Suggestions`),_d=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],vd={handlesAccessibility:!1,visibilityTriggerFunction:void 0},yd=0,K=new WeakMap,q=new WeakMap,bd=new WeakMap,xd=new WeakMap,J=new WeakMap,Sd=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,Y=new WeakSet,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=new WeakMap,Bd=new WeakMap,Vd=new WeakMap,Hd=class extends l{constructor(...e){super(...e),d(this,Y),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,K,void 0),f(this,q,null),f(this,bd,null),f(this,xd,new Map),f(this,J,null),f(this,Sd,[]),f(this,Cd,0),f(this,wd,null),f(this,Td,null),f(this,Ed,null),f(this,Dd,!1),f(this,Od,null),f(this,kd,new DOMRect),f(this,Ad,new MutationObserver(()=>{let e=u(Y,this,Wd).call(this);(pf(e)&&e!==m(q,this)||m(q,this)&&!m(q,this).isConnected)&&u(Y,this,Gd).call(this)})),f(this,jd,()=>{m(Dd,this)||u(Y,this,Qd).call(this)}),f(this,Md,()=>{h(Dd,this,!0),u(Y,this,sf).call(this)}),f(this,Nd,()=>{h(Dd,this,!1),u(Y,this,Qd).call(this)}),f(this,Pd,()=>{queueMicrotask(()=>u(Y,this,sf).call(this))}),f(this,Fd,()=>{let e=m(q,this);!e||!m(J,this)||!mf(e)||queueMicrotask(()=>{m(J,this)&&(e.selectionStart!==m(J,this).end||e.selectionEnd!==m(J,this).end)&&u(Y,this,Qd).call(this)})}),f(this,Id,()=>{m(J,this)&&u(Y,this,of).call(this)}),f(this,Ld,e=>{let t=e;m(J,this)&&m(K,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,Rd,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,zd,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,Bd,e=>{u(Y,this,nf).call(this,Number(e.target.dataset.index))}),f(this,Vd,e=>{if(e.target!==this.popoverElement)return;let t=m(K,this).getAttribute(`aria-label`)??gd;u(Y,this,uf).call(this),h(J,this,null),u(Y,this,lf).call(this),u(Y,this,df).call(this,t===gd?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(Y,this,Ud).call(this),this.hasUpdated&&u(Y,this,Gd).call(this)}disconnectedCallback(){u(Y,this,qd).call(this),m(K,this)?.remove(),m(Ed,this)!==null&&(clearTimeout(m(Ed,this)),h(Ed,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(Y,this,Gd).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(q,this)!==u(Y,this,Wd).call(this)&&u(Y,this,Gd).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(J,this)){let e=m(K,this).querySelector(`[aria-selected="true"]`),t=e?m(Sd,this)[Number(e.dataset.index)]:void 0;u(Y,this,Qd).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${vd}
        @craft-hide=${m(Vd,this)}
      >
    ...
    `}};function Ud(){h(K,this,document.createElement(`div`)),m(K,this).id=`craft-text-expander-listbox-${++yd}`,m(K,this).slot=`listbox`,m(K,this).setAttribute(`part`,`listbox`),m(K,this).role=`listbox`,m(K,this).setAttribute(`aria-label`,gd),m(K,this).addEventListener(`pointerdown`,m(Rd,this)),m(K,this).addEventListener(`pointerup`,m(zd,this)),m(K,this).addEventListener(`combobox-commit`,m(Bd,this)),this.append(m(K,this))}function Wd(){return this.getRootNode().getElementById(this.for)}function Gd(){let e=u(Y,this,Wd).call(this);if(u(Y,this,qd).call(this),!pf(e)){u(Y,this,Kd).call(this);return}h(q,this,e),u(Y,this,Jd).call(this,e),h(bd,this,new td(e,m(K,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(Y,this,Yd).call(this,e),e.addEventListener(`input`,m(jd,this)),e.addEventListener(`keydown`,m(Ld,this)),e.addEventListener(`blur`,m(Pd,this)),e.addEventListener(`compositionstart`,m(Md,this)),e.addEventListener(`compositionend`,m(Nd,this)),e.ownerDocument.addEventListener(`selectionchange`,m(Fd,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(kd,this)},u(Y,this,Kd).call(this)}function Kd(){m(Ad,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function qd(){m(Ad,this).disconnect(),u(Y,this,sf).call(this);let e=m(q,this);e&&(e.removeEventListener(`input`,m(jd,this)),e.removeEventListener(`keydown`,m(Ld,this)),e.removeEventListener(`blur`,m(Pd,this)),e.removeEventListener(`compositionstart`,m(Md,this)),e.removeEventListener(`compositionend`,m(Nd,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(Fd,this)),m(Od,this)?.getStyleClone().disconnect(),h(Od,this,null),m(bd,this)?.destroy(),h(bd,this,null),u(Y,this,Xd).call(this,e),h(q,this,null))}function Jd(e){m(xd,this).clear();for(let t of _d)m(xd,this).set(t,e.getAttribute(t))}function Yd(e){let t=[m(xd,this).get(`aria-controls`),m(K,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(Y,this,Zd).call(this,e,`aria-haspopup`),u(Y,this,Zd).call(this,e,`aria-expanded`)}function Xd(e){for(let t of _d)u(Y,this,Zd).call(this,e,t);m(xd,this).clear()}function Zd(e,t){let n=m(xd,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function Qd(e){u(Y,this,uf).call(this);let t=u(Y,this,ef).call(this);if(!t){h(J,this,null),u(Y,this,cf).call(this);return}h(J,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(Y,this,tf).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(Y,this,tf).call(this,[]),u(Y,this,df).call(this,O(`Loading`));let r=m(Cd,this);h(Td,this,setTimeout(()=>{u(Y,this,$d).call(this,t,n,r,e)},150))}async function $d(e,t,n,r){h(wd,this,new AbortController);let i;try{let n=await ve.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(wd,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(Cd,this)||hf(t))return;u(Y,this,sf).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(Cd,this)&&(this.loading=!1,u(Y,this,tf).call(this,t===void 0?i:i.slice(0,t),r))}function ef(){let e=m(q,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!mf(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&hd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function tf(e,t){if(u(Y,this,af).call(this),h(Sd,this,e),m(K,this).replaceChildren(),m(K,this).hidden=this.loading,m(K,this).setAttribute(`aria-label`,m(J,this)?.trigger.label??gd),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=ff(e);n.id=`${m(K,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(J,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(K,this).append(n)}),!this.loading&&!e.length){h(J,this,null),u(Y,this,cf).call(this),u(Y,this,df).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(J,this)&&u(Y,this,rf).call(this,t)})}function nf(e){let t=m(q,this),n=m(Sd,this)[e],r=u(Y,this,ef).call(this),i=m(J,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(Y,this,sf).call(this);return}gf(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(Y,this,sf).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function rf(e){await this.popoverElement.updateComplete;let t=m(q,this);if(!t||!u(Y,this,of).call(this)){u(Y,this,sf).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(J,this)||t!==m(q,this))&&m(Sd,this).length&&(m(bd,this)?.start(),u(Y,this,Zd).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(jd,this)),t.addEventListener(`input`,m(jd,this)),e)){let t=m(Sd,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(bd,this)?.navigate(1)}}function af(){m(bd,this)?.stop(),m(q,this)&&u(Y,this,Zd).call(this,m(q,this),`aria-expanded`)}function of(){let e=m(q,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(Od,this)){h(Od,this,new pd(e));let t=m(Od,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(Id,this))}return m(Od,this).setStartOffset(t),m(Od,this).setEndOffset(t),h(kd,this,m(Od,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function sf(){u(Y,this,uf).call(this),h(J,this,null),u(Y,this,cf).call(this)}function cf(){u(Y,this,lf).call(this),this.popoverElement.hide()}function lf(){this.loading=!1,u(Y,this,af).call(this),h(Sd,this,[]),m(K,this)?.replaceChildren(),m(K,this)&&(m(K,this).hidden=!1);let e=m(q,this);e&&(u(Y,this,Zd).call(this,e,`aria-activedescendant`),u(Y,this,Zd).call(this,e,`aria-busy`))}function uf(){var e;h(Cd,this,(e=m(Cd,this),e++,e)),m(Td,this)&&(clearTimeout(m(Td,this)),h(Td,this,null)),m(wd,this)?.abort(),h(wd,this,null)}function df(e){m(Ed,this)!==null&&(clearTimeout(m(Ed,this)),h(Ed,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(Ed,this,setTimeout(()=>{h(Ed,this,null),this.announcement=``},5e3))}Hd.styles=[Nt,md],p([g({reflect:!0})],Hd.prototype,`for`,void 0),p([g({type:Array})],Hd.prototype,`triggers`,void 0),p([_()],Hd.prototype,`loading`,void 0),p([_()],Hd.prototype,`announcement`,void 0),p([y(`craft-popover`)],Hd.prototype,`popoverElement`,void 0);function ff(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function pf(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function mf(e){return e.getRootNode().activeElement===e}function hf(e){return e instanceof DOMException&&e.name===`AbortError`}function gf(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,Hd);var _f=a`
  :host {
    display: inline-flex;
...
`,vf=new WeakMap,yf=new WeakSet,bf=class extends l{constructor(...e){super(...e),d(this,yf),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,f(this,vf,typeof ResizeObserver<`u`?new ResizeObserver(()=>u(yf,this,xf).call(this)):null)}connectedCallback(){super.connectedCallback(),m(vf,this)?.observe(this)}disconnectedCallback(){m(vf,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){u(yf,this,xf).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${u(yf,this,Sf)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function xf(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function Sf(){u(yf,this,xf).call(this)}bf.styles=_f,p([g({reflect:!0})],bf.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],bf.prototype,`disabled`,void 0),p([_()],bf.prototype,`overflowing`,void 0),p([_()],bf.prototype,`text`,void 0),p([y(`.truncate`)],bf.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,bf);var Cf=a`
  :host {
...
`,wf={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},Tf=class extends l{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs()}render(){return r`
    ...
    `}};Tf.styles=[Cf],p([g()],Tf.prototype,`src`,void 0),p([g({reflect:!0})],Tf.prototype,`mode`,void 0),p([g()],Tf.prototype,`srcset`,void 0),p([g()],Tf.prototype,`sizes`,void 0),p([g()],Tf.prototype,`alt`,void 0),p([g({type:Number})],Tf.prototype,`width`,void 0),p([g({type:Number})],Tf.prototype,`height`,void 0),p([g()],Tf.prototype,`loading`,void 0),p([g({reflect:!0,converter:wf})],Tf.prototype,`checkered`,void 0),p([g({type:Boolean,reflect:!0})],Tf.prototype,`rounded`,void 0),customElements.get(`craft-thumbnail`)||customElements.define(`craft-thumbnail`,Tf);var Ef=new WeakMap,Df=new WeakSet,Of=class extends HTMLElement{constructor(...e){super(...e),d(this,Df),f(this,Ef,null)}connectedCallback(){u(Df,this,kf).call(this)}disconnectedCallback(){m(Ef,this)?.destroy(),h(Ef,this,null)}};function kf(){if(!(m(Ef,this)||!this.isConnected)){if(!this.querySelector(`[data-sizes]`)){requestAnimationFrame(()=>u(Df,this,kf).call(this));return}h(Ef,this,new _a),m(Ef,this).load(this)}}customElements.get(`craft-thumbnail-loader`)||customElements.define(`craft-thumbnail-loader`,Of);var Af=!1,jf=null;async function Mf(e){if(!Af){if(jf)return jf;Af=!0;try{return(await ve.post(`app/api-headers`,void 0,{cancelToken:e})).data}catch{}finally{Af=!1}}}var Nf=x.create({baseURL:`https://api.craftcms.com/v1/`});async function Pf(e){return jf?Object.entries(jf).forEach(([t,n])=>{e.headers.set(t,n)}):(e.params=e.params||{},e.params.processCraftHeaders=1),e}async function Ff(e,t){if(jf)return;let{data:n}=await ve.post(`app/process-api-response-headers`,{headers:e},{cancelToken:t});return jf=n,Af=!1,jf}async function If(e){return await Ff(e.headers,e.config.cancelToken),e}Nf.interceptors.request.use(async e=>{let{cancelToken:t}=e,n=await Mf(t);n&&Object.entries(n).forEach(([t,n])=>{e.headers.set(t,n)});let r={...e,params:{...Cp.apiParams||{},...e.params,v:new Date().getTime()}};return n||(r.params.processCraftHeaders=1),Cp.httpProxy&&(r.proxy=Cp.httpProxy),r}),Nf.interceptors.request.use(Pf),Nf.interceptors.response.use(If);function Lf(e={}){let t=document.createElement(`craft-button`);if(t.type=e.type??`button`,e.id&&(t.id=e.id),e.class)for(let n of e.class.split(/\s+/).filter(Boolean))t.classList.add(n);if(e.ariaLabel&&t.setAttribute(`aria-label`,e.ariaLabel),e.ariaDescribedBy&&t.setAttribute(`aria-describedby`,e.ariaDescribedBy),e.role&&t.setAttribute(`role`,e.role),e.toggle&&t.setAttribute(`aria-expanded`,`false`),e.controls&&t.setAttribute(`aria-controls`,e.controls),e.data)for(let[n,r]of Object.entries(e.data))t.setAttribute(`data-${n}`,String(r));if(e.icon&&(t.icon=e.icon),e.label||e.html){let n=document.createElement(`span`);n.className=`label`,e.label?n.textContent=e.label:n.innerHTML=e.html,t.append(n)}return e.disabled&&(t.disabled=!0),e.loading&&(t.loading=!0),e.variant&&(t.variant=e.variant),e.size&&(t.size=e.size),t}function Rf(e={}){let t=Lf({...e,type:`submit`,label:e.label||O(`Submit`),variant:e.variant??`accent`});return t.classList.add(`submit`),t}function zf(e={}){let t=Lf({...e,icon:`duplicate`,label:e.label||ma(O(`Paste {type}`,{type:O(`elements`)}))});return t.classList.add(`paste-btn`),t}var Bf=async(e,t)=>{let{data:n}=await ve.post(e,t);return n},Vf=new WeakMap,Hf=new WeakMap,Uf=new WeakMap,Wf=new WeakMap,Gf=new WeakMap,Kf=new WeakMap,qf=new WeakMap,Jf=new WeakMap,Yf=new WeakMap,Xf=new WeakMap,X=new WeakSet,Zf=class e{constructor(t){d(this,X),f(this,Vf,null),f(this,Hf,[]),f(this,Uf,[]),f(this,Wf,null),f(this,Gf,!1),f(this,Kf,!1),f(this,qf,!1),f(this,Jf,null),f(this,Yf,void 0),f(this,Xf,new Map),this.options={...e.defaults,modalTitle:O(`Select element`),selectBtnLabel:O(`Select`),...np(t)},h(Uf,this,[...this.options.disabledElementIds??[]]),h(Yf,this,u(X,this,Qf).call(this))}get elementType(){return this.options.elementType}get state(){return m(Yf,this)}get index(){return m(Vf,this)}get hasSelection(){return m(Hf,this).length>0}on(e,t){let n=m(Xf,this).get(e);return n||(n=new Set,m(Xf,this).set(e,n)),n.add(t),()=>{m(Xf,this).get(e)?.delete(t)}}async open(){h(Hf,this,[]),m(Vf,this)?.clearSelection(),m(Gf,this)||(h(Gf,this,!0),u(X,this,tp).call(this,`open`,void 0)),u(X,this,$f).call(this),m(Wf,this)||await this.reload()}close(){m(Gf,this)&&(h(Gf,this,!1),u(X,this,tp).call(this,`close`,void 0),this.options.onClose?.(),u(X,this,$f).call(this))}destroy(){m(Vf,this)?.destroy?.(),h(Vf,this,null),h(Hf,this,[]),h(Wf,this,null),h(Gf,this,!1),h(qf,this,!1),h(Kf,this,!1),h(Jf,this,null),u(X,this,$f).call(this),m(Xf,this).clear()}async reload(){let e=this.options.loadIndexBody??Bf;h(Kf,this,!0),h(Jf,this,null),u(X,this,$f).call(this);try{h(Wf,this,await e(this.options.bodyAction,this.indexParams()))}catch(e){u(X,this,ep).call(this,e)}finally{h(Kf,this,!1),u(X,this,$f).call(this)}}async submit(){if(!m(Yf,this).canSubmit)return;let e=this.buildElementInfo(m(Hf,this)),t=this.selectMeta();h(qf,this,!0),u(X,this,$f).call(this);try{u(X,this,tp).call(this,`select`,{elements:e,meta:t}),await this.options.onSelect?.(e,t)}catch(e){u(X,this,ep).call(this,e);return}finally{h(qf,this,!1),u(X,this,$f).call(this)}this.options.disableElementsOnSelect&&(this.setDisabledElementIds([...m(Uf,this),...e.map(e=>Number(e.id))]),m(Vf,this)?.clearSelection()),this.options.hideOnSelect&&this.close()}cancel(){m(Yf,this).canCancel&&(u(X,this,tp).call(this,`cancel`,void 0),this.options.onCancel?.(),this.close())}attachIndex(e){h(Vf,this,e),u(X,this,$f).call(this)}detachIndex(){h(Vf,this,null),u(X,this,$f).call(this)}setSelection(e){h(Hf,this,[...e]),u(X,this,$f).call(this)}setDisabledElementIds(e){h(Uf,this,[...new Set(e.map(Number))]),u(X,this,$f).call(this)}setBusy(e){h(qf,this,e),u(X,this,$f).call(this)}indexParams(){let{options:e}=this,t={context:`modal`,elementType:this.elementType,sources:e.sources,condition:e.condition,criteria:{...e.criteria}};return e.showSiteMenu!=null&&e.showSiteMenu!==`auto`&&(t.showSiteMenu=e.showSiteMenu?`1`:`0`),e.siteIds&&(t.siteIds=e.siteIds),e.criteria&&(t.criteria={...e.criteria}),typeof e.indexSettings.showFolders==`boolean`&&(t.showFolders=e.indexSettings.showFolders),t}indexSettings(){let{options:e}=this;return{context:`modal`,storageKey:e.storageKey,condition:e.condition,referenceElementId:e.referenceElementId,referenceElementOwnerId:e.referenceElementOwnerId,referenceElementSiteId:e.referenceElementSiteId,criteria:{...e.criteria},disabledElementIds:[...m(Uf,this)],selectable:!0,multiSelect:e.multiSelect,waitForDoubleClicks:!0,hideSidebar:e.hideSidebar,defaultSiteId:e.defaultSiteId,defaultSource:e.defaultSource,defaultSourcePath:e.defaultSourcePath,preferStoredSource:e.preferStoredSource,showSourcePath:e.showSourcePath,...e.indexSettings}}canSubmitSelection(){return m(Hf,this).length>0}buildElementInfo(e){return e.map(e=>({...e}))}selectMeta(){return{}}notifyChange(){u(X,this,$f).call(this)}get selection(){return m(Hf,this)}get disabledElementIds(){return m(Uf,this)}};function Qf(){let e=m(qf,this),t=m(Kf,this);return Object.freeze({open:m(Gf,this),loading:t,busy:e,selection:Object.freeze([...m(Hf,this)]),disabledElementIds:Object.freeze([...m(Uf,this)]),indexBody:m(Wf,this),error:m(Jf,this),title:this.options.modalTitle,showTitle:this.options.showTitle,selectLabel:this.options.selectBtnLabel,canSubmit:!e&&!t&&this.canSubmitSelection(),canCancel:!e})}function $f(){h(Yf,this,u(X,this,Qf).call(this)),u(X,this,tp).call(this,`change`,m(Yf,this))}function ep(e){h(Jf,this,e instanceof Error?e:Error(String(e??`Unknown`))),u(X,this,tp).call(this,`error`,m(Jf,this))}function tp(e,t){let n=m(Xf,this).get(e);n&&[...n].forEach(e=>e(t))}Zf.defaults={multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,showTitle:!1,fullscreen:!1,bodyAction:`element-selector-modals/body`,indexSettings:{},preferStoredSource:!1,showSourcePath:!0,hideSidebar:!1};function np(e){return Object.fromEntries(Object.entries(e).filter(([,e])=>e!==void 0))}var rp=async(e,t)=>{let{data:n}=await ve.post(`assets/generate-transform`,{assetId:e,handle:t});return n?.url||!1},ip=new WeakMap,ap=class e extends Zf{constructor(e){super(e),f(this,ip,null)}get transforms(){return this.options.transforms??[]}get canApplyTransform(){return this.selection.length>0&&this.transforms.length>0}async selectWithTransform(t){var n;let r=(n=e.transformUrls)[t]??(n[t]={}),i=this.selection.map(e=>Number(e.id)).filter(e=>r[e]===void 0);if(i.length>0){let e=this.options.fetchTransformUrl??rp;this.setBusy(!0);try{for(let n of i)try{r[n]=await e(n,t)}catch{r[n]=!1}}finally{this.setBusy(!1)}}h(ip,this,t);try{await this.submit()}finally{h(ip,this,null)}}buildElementInfo(t){let n=super.buildElementInfo(t);if(!m(ip,this))return n;let r=e.transformUrls[m(ip,this)]??{};for(let e of n){let t=r[Number(e.id)];t!==void 0&&t!==!1&&(e.url=t)}return n}selectMeta(){return{transform:m(ip,this)}}};ap.transformUrls={};var op=`CraftCms\\Cms\\Asset\\Elements\\Asset`,sp=new WeakSet,cp=class extends Zf{constructor(e={}){let{disabledFolderIds:t=[],...n}=e;super({...n,elementType:op,showSiteMenu:!1}),d(this,sp),this.disabledFolderIds=[...t]}indexParams(){return{...super.indexParams(),foldersOnly:!0}}indexSettings(){return{...super.indexSettings(),foldersOnly:!0,disabledFolderIds:[...this.disabledFolderIds]}}currentFolderId(){let e=this.index?.sourcePath;if(!e?.length)return null;let t=e[e.length-1],n=Number(t.folderId);return Number.isFinite(n)?this.disabledFolderIds.includes(n)?null:n:null}canSubmitSelection(){return super.canSubmitSelection()||this.currentFolderId()!==null}buildElementInfo(e){if(e.length>0)return e.map(e=>({...e,folderId:Number(e.folderId??e.id)}));let t=this.currentFolderId();return t===null?[]:[{id:t,folderId:t,siteId:null,label:u(sp,this,lp).call(this),status:null,url:null,hasThumb:!1}]}};function lp(){let e=this.index?.sourcePath;return e?.[e.length-1]?.label??``}var up=new Map;function dp(e,t){if(up.has(e))throw Error(`An element selector controller has already been registered for the element type “${e}”.`);up.set(e,t)}function fp(e){return up.has(e)}function pp(e){return up.get(e)??Zf}function mp(e){return new(pp(e.elementType))(e)}function hp(){if(typeof window>`u`)return;let e=window.Craft?._elementSelectorModalClasses;if(e)for(let[t,n]of Object.entries(e))up.has(t)||up.set(t,n)}var gp={START:`asset-indexes/start-indexing`,STOP:`asset-indexes/stop-indexing-session`,PROCESS:`asset-indexes/process-indexing-session`,OVERVIEW:`asset-indexes/indexing-session-overview`,FINISH:`asset-indexes/finish-indexing-session`},_p=new WeakMap,vp=new WeakMap,yp=new WeakMap,bp=new WeakMap,xp=new WeakMap,Sp=new WeakMap,wp=new WeakMap,Z=new WeakSet,Tp=class{constructor(e={}){d(this,Z),f(this,_p,new Map),f(this,vp,null),f(this,yp,0),f(this,bp,[]),f(this,xp,[]),f(this,Sp,new Set),f(this,wp,new Map);let{existingSessions:t=[],maxConcurrentConnections:n=3,autoResume:r=!0}=e;this.maxConcurrentConnections=n;for(let e of t)m(_p,this).set(e.id,e);r&&(u(Z,this,kp).call(this),m(vp,this)!==null&&u(Z,this,Ap).call(this))}getSessions(){return Array.from(m(_p,this).values())}getCurrentSessionId(){return m(vp,this)}isProcessing(){return m(yp,this)>0}on(e,t){return m(wp,this).has(e)||m(wp,this).set(e,new Set),m(wp,this).get(e).add(t),()=>{m(wp,this).get(e)?.delete(t)}}async startIndexing(e){let t=await ve.post(gp.START,e),{data:n}=t;return n.session&&(m(_p,this).set(n.session.id,n.session),h(vp,this,n.session.id),u(Z,this,Dp).call(this),n.stop||u(Z,this,Ap).call(this)),n.stop&&u(Z,this,Op).call(this,n.stop),t}stopSession(e){u(Z,this,jp).call(this,e),u(Z,this,Mp).call(this,{sessionId:e,action:gp.STOP,params:{sessionId:e},priority:!0})}getSessionOverview(e){u(Z,this,Mp).call(this,{sessionId:e,action:gp.OVERVIEW,params:{sessionId:e},priority:!0})}finishSession(e){u(Z,this,Mp).call(this,{sessionId:e.sessionId,action:gp.FINISH,params:e,priority:!0})}destroy(){m(_p,this).clear(),h(bp,this,[]),h(xp,this,[]),m(wp,this).clear(),h(vp,this,null),h(yp,this,0)}};function Ep(e,t){m(wp,this).get(e)?.forEach(e=>e(t))}function Dp(e){u(Z,this,Ep).call(this,`change`,{sessions:this.getSessions(),currentSessionId:m(vp,this),reviewSessionId:e})}function Op(e){m(_p,this).delete(e),m(vp,this)===e&&h(vp,this,null),u(Z,this,Dp).call(this)}function kp(){for(let[e,t]of m(_p,this))if(!t.actionRequired&&!m(Sp,this).has(e)){h(vp,this,e);return}h(vp,this,null)}function Ap(){if(m(vp,this)||u(Z,this,kp).call(this),!m(vp,this))return;let e=m(_p,this).get(m(vp,this));if(!e)return;let t=e.totalEntries-e.processedEntries,n=this.maxConcurrentConnections-m(yp,this),r=Math.min(n,t);for(let t=0;t<r;t++)u(Z,this,Mp).call(this,{sessionId:e.id,action:gp.PROCESS,params:{sessionId:m(vp,this)},priority:!1});e.processIfRootEmpty&&u(Z,this,Mp).call(this,{sessionId:e.id,action:gp.PROCESS,params:{sessionId:m(vp,this)},priority:!1})}function jp(e){m(Sp,this).add(e),h(bp,this,m(bp,this).filter(t=>t.sessionId!==e))}function Mp(e){e.priority?m(xp,this).push(e):m(bp,this).push(e),u(Z,this,Np).call(this)}function Np(){if(!(m(bp,this).length+m(xp,this).length===0||m(yp,this)>=this.maxConcurrentConnections))for(;m(bp,this).length+m(xp,this).length>0&&m(yp,this)<this.maxConcurrentConnections;){var e;h(yp,this,(e=m(yp,this),e++,e));let t=m(xp,this).length>0?m(xp,this).shift():m(bp,this).shift();u(Z,this,Pp).call(this,t)}}async function Pp(e){try{let t=await ve.post(e.action,e.params);u(Z,this,Fp).call(this,t.data)}catch(t){u(Z,this,Ip).call(this,t,e)}finally{var t;h(yp,this,(t=m(yp,this),t--,t)),u(Z,this,Np).call(this)}}function Fp(e){let t;e.session&&(m(_p,this).set(e.session.id,e.session),u(Z,this,kp).call(this),e.session.actionRequired&&!e.skipDialog?m(Sp,this).has(e.session.id)||(t=e.session.id):m(Sp,this).has(e.session.id)||u(Z,this,Ap).call(this)),u(Z,this,kp).call(this),e.stop&&(m(_p,this).delete(e.stop),m(vp,this)===e.stop&&h(vp,this,null)),u(Z,this,Dp).call(this,t),m(_p,this).size===0&&u(Z,this,Ep).call(this,`complete`,{})}function Ip(e,t){u(Z,this,kp).call(this);let n=e?.response?.data?.message||e.message||`An error occurred during indexing.`;u(Z,this,Ep).call(this,`error`,{message:n,sessionId:t.sessionId}),u(Z,this,Np).call(this)}var Lp=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},Rp=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},zp,Bp=class{formatToParts(e){let t=[];for(let n of e)t.push({type:`element`,value:n}),t.push({type:`literal`,value:`, `});return t.slice(0,-1)}},Vp=typeof Intl<`u`&&Intl.ListFormat||Bp,Hp=[[`years`,`year`],[`months`,`month`],[`weeks`,`week`],[`days`,`day`],[`hours`,`hour`],[`minutes`,`minute`],[`seconds`,`second`],[`milliseconds`,`millisecond`]],Up={minimumIntegerDigits:2},Wp=class{constructor(e,t={}){zp.set(this,void 0);let n=String(t.style||`short`);n!==`long`&&n!==`short`&&n!==`narrow`&&n!==`digital`&&(n=`short`);let r=n===`digital`?`numeric`:n,i=t.hours||r;r=i===`2-digit`?`numeric`:i;let a=t.minutes||r;r=a===`2-digit`?`numeric`:a;let o=t.seconds||r;r=o===`2-digit`?`numeric`:o;let s=t.milliseconds||r;Lp(this,zp,{locale:e,style:n,years:t.years||n===`digital`?`short`:n,yearsDisplay:t.yearsDisplay===`always`?`always`:`auto`,months:t.months||n===`digital`?`short`:n,monthsDisplay:t.monthsDisplay===`always`?`always`:`auto`,weeks:t.weeks||n===`digital`?`short`:n,weeksDisplay:t.weeksDisplay===`always`?`always`:`auto`,days:t.days||n===`digital`?`short`:n,daysDisplay:t.daysDisplay===`always`?`always`:`auto`,hours:i,hoursDisplay:t.hoursDisplay===`always`||n===`digital`?`always`:`auto`,minutes:a,minutesDisplay:t.minutesDisplay===`always`||n===`digital`?`always`:`auto`,seconds:o,secondsDisplay:t.secondsDisplay===`always`||n===`digital`?`always`:`auto`,milliseconds:s,millisecondsDisplay:t.millisecondsDisplay===`always`?`always`:`auto`},`f`)}resolvedOptions(){return Rp(this,zp,`f`)}formatToParts(e){let t=[],n=Rp(this,zp,`f`),r=n.style,i=n.locale;for(let[a,o]of Hp){let s=e[a];if(n[`${a}Display`]===`auto`&&!s)continue;let c=n[a],l=c===`2-digit`?Up:c===`numeric`?{}:{style:`unit`,unit:o,unitDisplay:c},u=new Intl.NumberFormat(i,l).format(s);a===`months`&&(c===`narrow`||r===`narrow`&&u.endsWith(`m`))&&(u=u.replace(/(\d+)m$/,`$1mo`)),t.push(u)}return new Vp(i,{type:`unit`,style:r===`digital`?`short`:r}).formatToParts(t)}format(e){return this.formatToParts(e).map(e=>e.value).join(``)}};zp=new WeakMap;var Gp=/^[-+]?P(?:(\d+)Y)?(?:(\d+)M)?(?:(\d+)W)?(?:(\d+)D)?(?:T(?:(\d+)H)?(?:(\d+)M)?(?:(\d+)S)?)?$/,Kp=[`year`,`month`,`week`,`day`,`hour`,`minute`,`second`,`millisecond`],qp=e=>Gp.test(e),Jp=class e{constructor(e=0,t=0,n=0,r=0,i=0,a=0,o=0,s=0){this.years=e,this.months=t,this.weeks=n,this.days=r,this.hours=i,this.minutes=a,this.seconds=o,this.milliseconds=s,this.years||=0,this.sign||=Math.sign(this.years),this.months||=0,this.sign||=Math.sign(this.months),this.weeks||=0,this.sign||=Math.sign(this.weeks),this.days||=0,this.sign||=Math.sign(this.days),this.hours||=0,this.sign||=Math.sign(this.hours),this.minutes||=0,this.sign||=Math.sign(this.minutes),this.seconds||=0,this.sign||=Math.sign(this.seconds),this.milliseconds||=0,this.sign||=Math.sign(this.milliseconds),this.blank=this.sign===0}abs(){return new e(Math.abs(this.years),Math.abs(this.months),Math.abs(this.weeks),Math.abs(this.days),Math.abs(this.hours),Math.abs(this.minutes),Math.abs(this.seconds),Math.abs(this.milliseconds))}static from(t){if(typeof t==`string`){let n=String(t).trim(),r=n.startsWith(`-`)?-1:1,i=n.match(Gp)?.slice(1).map(e=>(Number(e)||0)*r);return i?new e(...i):new e}else if(typeof t==`object`){let{years:n,months:r,weeks:i,days:a,hours:o,minutes:s,seconds:c,milliseconds:l}=t;return new e(n,r,i,a,o,s,c,l)}throw RangeError(`invalid duration`)}static compare(t,n){let r=Date.now(),i=Math.abs(Yp(r,e.from(t)).getTime()-r),a=Math.abs(Yp(r,e.from(n)).getTime()-r);return i>a?-1:+(i<a)}toLocaleString(e,t){return new Wp(e,t).format(this)}};function Yp(e,t){let n=new Date(e);return t.sign<0?(n.setUTCSeconds(n.getUTCSeconds()+t.seconds),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCFullYear(n.getUTCFullYear()+t.years)):(n.setUTCFullYear(n.getUTCFullYear()+t.years),n.setUTCMonth(n.getUTCMonth()+t.months),n.setUTCDate(n.getUTCDate()+t.weeks*7+t.days),n.setUTCHours(n.getUTCHours()+t.hours),n.setUTCMinutes(n.getUTCMinutes()+t.minutes),n.setUTCSeconds(n.getUTCSeconds()+t.seconds)),n}function Xp(e,t=`second`,n=Date.now()){let r=e.getTime()-n;if(r===0)return new Jp;let i=Math.sign(r),a=Math.abs(r),o=Math.floor(a/1e3),s=Math.floor(o/60),c=Math.floor(s/60),l=Math.floor(c/24),u=Math.floor(l/30),d=Math.floor(u/12),f=Kp.indexOf(t)||Kp.length;return new Jp(f>=0?d*i:0,f>=1?(u-d*12)*i:0,0,f>=3?(l-u*30)*i:0,f>=4?(c-l*24)*i:0,f>=5?(s-c*60)*i:0,f>=6?(o-s*60)*i:0,f>=7?(a-o*1e3)*i:0)}function Zp(e,{relativeTo:t=Date.now()}={}){if(t=new Date(t),e.blank)return e;let n=e.sign,r=Math.abs(e.years),i=Math.abs(e.months),a=Math.abs(e.weeks),o=Math.abs(e.days),s=Math.abs(e.hours),c=Math.abs(e.minutes),l=Math.abs(e.seconds),u=Math.abs(e.milliseconds);u>=900&&(l+=Math.round(u/1e3)),(l||c||s||o||a||i||r)&&(u=0),l>=55&&(c+=Math.round(l/60)),(c||s||o||a||i||r)&&(l=0),c>=55&&(s+=Math.round(c/60)),(s||o||a||i||r)&&(c=0),o&&s>=12&&(o+=Math.round(s/24)),!o&&s>=21&&(o+=Math.round(s/24)),(o||a||i||r)&&(s=0);let d=t.getFullYear(),f=t.getMonth(),p=t.getDate();if(o>=27||r+i+o){let e=new Date(t);e.setDate(1),e.setMonth(f+i*n+1),e.setDate(0);let s=Math.max(0,p-e.getDate()),c=new Date(t);c.setFullYear(d+r*n),c.setDate(p-s),c.setMonth(f+i*n),c.setDate(p-s+o*n);let l=c.getFullYear()-t.getFullYear(),u=c.getMonth()-t.getMonth(),m=Math.abs(Math.round((Number(c)-Number(t))/864e5))+s,h=Math.abs(l*12+u);m<27?(o>=6?(a+=Math.round(o/7),o=0):o=m,i=r=0):h<=11?(i=h,r=0):(i=0,r=l*n),(i||r)&&(o=0)}return r&&(i=0),a>=4&&(i+=Math.round(a/4)),(i||r)&&(a=0),o&&a&&!i&&!r&&(a+=Math.round(o/7),o=0),new Jp(r*n,i*n,a*n,o*n,s*n,c*n,l*n,u*n)}function Qp(e,t){let n=Zp(e,t);if(n.blank)return[0,`second`];for(let e of Kp){if(e===`millisecond`)continue;let t=n[`${e}s`];if(t)return[t,e]}return[0,`second`]}var Q=function(e,t,n,r){if(n===`a`&&!r)throw TypeError(`Private accessor was defined without a getter`);if(typeof t==`function`?e!==t||!r:!t.has(e))throw TypeError(`Cannot read private member from an object whose class did not declare it`);return n===`m`?r:n===`a`?r.call(e):r?r.value:t.get(e)},$p=function(e,t,n,r,i){if(r===`m`)throw TypeError(`Private method is not writable`);if(r===`a`&&!i)throw TypeError(`Private accessor was defined without a setter`);if(typeof t==`function`?e!==t||!i:!t.has(e))throw TypeError(`Cannot write private member to an object whose class did not declare it`);return r===`a`?i.call(e,n):i?i.value=n:t.set(e,n),n},$,em,tm,nm,rm,im,am,om,sm,cm,lm,um,dm,fm,pm,mm,hm=globalThis.HTMLElement||null,gm=new Jp,_m=new Jp(0,0,0,0,0,1),vm=class extends Event{constructor(e,t,n,r){super(`relative-time-updated`,{bubbles:!0,composed:!0}),this.oldText=e,this.newText=t,this.oldTitle=n,this.newTitle=r}};function ym(e){if(!e.date)return 1/0;if(e.format===`duration`||e.format===`elapsed`){let t=e.precision;if(t===`second`)return 1e3;if(t===`minute`)return 60*1e3}let t=Math.abs(Date.now()-e.date.getTime());return t<60*1e3?1e3:t<3600*1e3?60*1e3:3600*1e3}var bm=new class{constructor(){this.elements=new Set,this.time=1/0,this.timer=-1}observe(e){if(this.elements.has(e))return;this.elements.add(e);let t=e.date;if(t&&t.getTime()){let t=ym(e),n=Date.now()+t;n<this.time&&(clearTimeout(this.timer),this.timer=setTimeout(()=>this.update(),t),this.time=n)}}unobserve(e){this.elements.has(e)&&this.elements.delete(e)}update(){if(clearTimeout(this.timer),!this.elements.size)return;let e=1/0;for(let t of this.elements)e=Math.min(e,ym(t)),t.update();this.time=Math.min(3600*1e3,e),this.timer=setTimeout(()=>this.update(),this.time),this.time+=Date.now()}},xm=class extends hm{constructor(){super(...arguments),$.add(this),em.set(this,!1),tm.set(this,!1),rm.set(this,this.shadowRoot?this.shadowRoot:this.attachShadow?this.attachShadow({mode:`open`}):this),mm.set(this,null)}static define(e=`relative-time`,t=customElements){return t.define(e,this),this}get timeZone(){return this.closest(`[time-zone]`)?.getAttribute(`time-zone`)||this.ownerDocument.documentElement.getAttribute(`time-zone`)||void 0}static get observedAttributes(){return[`second`,`minute`,`hour`,`weekday`,`day`,`month`,`year`,`time-zone-name`,`prefix`,`threshold`,`tense`,`precision`,`format`,`format-style`,`no-title`,`datetime`,`lang`,`title`,`aria-hidden`,`time-zone`]}get onRelativeTimeUpdated(){return Q(this,mm,`f`)}set onRelativeTimeUpdated(e){Q(this,mm,`f`)&&this.removeEventListener(`relative-time-updated`,Q(this,mm,`f`)),$p(this,mm,typeof e==`object`||typeof e==`function`?e:null,`f`),typeof e==`function`&&this.addEventListener(`relative-time-updated`,e)}get second(){let e=this.getAttribute(`second`);if(e===`numeric`||e===`2-digit`)return e}set second(e){this.setAttribute(`second`,e||``)}get minute(){let e=this.getAttribute(`minute`);if(e===`numeric`||e===`2-digit`)return e}set minute(e){this.setAttribute(`minute`,e||``)}get hour(){let e=this.getAttribute(`hour`);if(e===`numeric`||e===`2-digit`)return e}set hour(e){this.setAttribute(`hour`,e||``)}get weekday(){let e=this.getAttribute(`weekday`);if(e===`long`||e===`short`||e===`narrow`)return e;if(this.format===`datetime`&&e!==``)return this.formatStyle}set weekday(e){this.setAttribute(`weekday`,e||``)}get day(){let e=this.getAttribute(`day`)??`numeric`;if(e===`numeric`||e===`2-digit`)return e}set day(e){this.setAttribute(`day`,e||``)}get month(){let e=this.format,t=this.getAttribute(`month`);if(t!==``&&(t??=e===`datetime`?this.formatStyle:`short`,t===`numeric`||t===`2-digit`||t===`short`||t===`long`||t===`narrow`))return t}set month(e){this.setAttribute(`month`,e||``)}get year(){let e=this.getAttribute(`year`);if(e===`numeric`||e===`2-digit`)return e;if(!this.hasAttribute(`year`)&&new Date().getUTCFullYear()!==this.date?.getUTCFullYear())return`numeric`}set year(e){this.setAttribute(`year`,e||``)}get timeZoneName(){let e=this.getAttribute(`time-zone-name`);if(e===`long`||e===`short`||e===`shortOffset`||e===`longOffset`||e===`shortGeneric`||e===`longGeneric`)return e}set timeZoneName(e){this.setAttribute(`time-zone-name`,e||``)}get prefix(){return this.getAttribute(`prefix`)??(this.format===`datetime`?``:`on`)}set prefix(e){this.setAttribute(`prefix`,e)}get threshold(){let e=this.getAttribute(`threshold`);return e&&qp(e)?e:`P30D`}set threshold(e){this.setAttribute(`threshold`,e)}get tense(){let e=this.getAttribute(`tense`);return e===`past`?`past`:e===`future`?`future`:`auto`}set tense(e){this.setAttribute(`tense`,e)}get precision(){let e=this.getAttribute(`precision`);return Kp.includes(e)?e:this.format===`micro`?`minute`:`second`}set precision(e){this.setAttribute(`precision`,e)}get format(){let e=this.getAttribute(`format`);return e===`datetime`?`datetime`:e===`relative`?`relative`:e===`duration`?`duration`:e===`micro`?`micro`:e===`elapsed`?`elapsed`:`auto`}set format(e){this.setAttribute(`format`,e)}get formatStyle(){let e=this.getAttribute(`format-style`);if(e===`long`)return`long`;if(e===`short`)return`short`;if(e===`narrow`)return`narrow`;let t=this.format;return t===`elapsed`||t===`micro`?`narrow`:t===`datetime`?`short`:`long`}set formatStyle(e){this.setAttribute(`format-style`,e)}get noTitle(){return this.hasAttribute(`no-title`)}set noTitle(e){this.toggleAttribute(`no-title`,e)}get datetime(){return this.getAttribute(`datetime`)||``}set datetime(e){this.setAttribute(`datetime`,e)}get date(){let e=Date.parse(this.datetime);return Number.isNaN(e)?null:new Date(e)}set date(e){this.datetime=e?.toISOString()||``}connectedCallback(){this.update()}disconnectedCallback(){bm.unobserve(this)}attributeChangedCallback(e,t,n){t!==n&&(e===`title`&&$p(this,em,n!==null&&(this.date&&Q(this,$,`m`,im).call(this,this.date))!==n,`f`),!Q(this,tm,`f`)&&!(e===`title`&&Q(this,em,`f`))&&$p(this,tm,(async()=>{await Promise.resolve(),this.update(),$p(this,tm,!1,`f`)})(),`f`))}update(){let e=Q(this,rm,`f`).textContent||this.textContent||``,t=this.getAttribute(`title`)||``,n=t,r=this.date;if(typeof Intl>`u`||!Intl.DateTimeFormat||!r){Q(this,rm,`f`).textContent=e;return}let i=Date.now();Q(this,em,`f`)||(n=Q(this,$,`m`,im).call(this,r)||``,n&&!this.noTitle&&this.setAttribute(`title`,n));let a=Xp(r,this.precision,i),o=Q(this,$,`m`,am).call(this,a),s=e,c=Q(this,$,`m`,pm).call(this,o);s=c?Q(this,$,`m`,dm).call(this,r):o===`duration`?Q(this,$,`m`,om).call(this,a):o===`relative`?Q(this,$,`m`,sm).call(this,a):Q(this,$,`m`,cm).call(this,r),s?Q(this,$,`m`,fm).call(this,s):this.shadowRoot===Q(this,rm,`f`)&&this.textContent&&Q(this,$,`m`,fm).call(this,this.textContent),(s!==e||n!==t)&&this.dispatchEvent(new vm(e,s,t,n)),o===`relative`||o===`duration`||c&&(Q(this,$,`m`,lm).call(this,r)||Q(this,$,`m`,um).call(this,r))?bm.observe(this):bm.unobserve(this)}};em=new WeakMap,tm=new WeakMap,rm=new WeakMap,mm=new WeakMap,$=new WeakSet,nm=function(){let e=this.closest(`[lang]`)?.getAttribute(`lang`)||this.ownerDocument.documentElement.getAttribute(`lang`);try{return new Intl.Locale(e??``).toString()}catch{return`default`}},im=function(e){return new Intl.DateTimeFormat(Q(this,$,`a`,nm),{day:`numeric`,month:`short`,year:`numeric`,hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone}).format(e)},am=function(e){let t=this.format;if(t===`datetime`)return`datetime`;if(t===`duration`||t===`elapsed`||t===`micro`)return`duration`;if((t===`auto`||t===`relative`)&&typeof Intl<`u`&&Intl.RelativeTimeFormat){let t=this.tense;if(t===`past`||t===`future`||Jp.compare(e,this.threshold)===1)return`relative`}return`datetime`},om=function(e){let t=Q(this,$,`a`,nm),n=this.format,r=this.formatStyle,i=this.tense,a=gm;n===`micro`?(e=Zp(e),a=_m,e.months===0&&(this.tense===`past`&&e.sign!==-1||this.tense===`future`&&e.sign!==1)&&(e=_m)):(i===`past`&&e.sign!==-1||i===`future`&&e.sign!==1)&&(e=a);let o=`${this.precision}sDisplay`;return e.blank?a.toLocaleString(t,{style:r,[o]:`always`}):e.abs().toLocaleString(t,{style:r})},sm=function(e){let t=new Intl.RelativeTimeFormat(Q(this,$,`a`,nm),{numeric:`auto`,style:this.formatStyle}),n=this.tense;n===`future`&&e.sign!==1&&(e=gm),n===`past`&&e.sign!==-1&&(e=gm);let[r,i]=Qp(e);return i===`second`&&r<10?t.format(0,this.precision===`millisecond`?`second`:this.precision):t.format(r,i)},cm=function(e){let t=new Intl.DateTimeFormat(Q(this,$,`a`,nm),{second:this.second,minute:this.minute,hour:this.hour,weekday:this.weekday,day:this.day,month:this.month,year:this.year,timeZoneName:this.timeZoneName,timeZone:this.timeZone});return`${this.prefix} ${t.format(e)}`.trim()},lm=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,nm),{timeZone:this.timeZone,year:`numeric`,month:`2-digit`,day:`2-digit`});return n.format(t)===n.format(e)},um=function(e){let t=new Date,n=new Intl.DateTimeFormat(Q(this,$,`a`,nm),{timeZone:this.timeZone,year:`numeric`});return n.format(t)===n.format(e)},dm=function(e){let t={hour:`numeric`,minute:`2-digit`,timeZoneName:`short`,timeZone:this.timeZone};if(Q(this,$,`m`,lm).call(this,e)){let n=new Intl.RelativeTimeFormat(Q(this,$,`a`,nm),{numeric:`auto`}).format(0,`day`);n=n.charAt(0).toLocaleUpperCase(Q(this,$,`a`,nm))+n.slice(1);let r=new Intl.DateTimeFormat(Q(this,$,`a`,nm),t).format(e);return`${n} ${r}`}let n=Object.assign(Object.assign({},t),{day:`numeric`,month:`short`});return Q(this,$,`m`,um).call(this,e)?new Intl.DateTimeFormat(Q(this,$,`a`,nm),n).format(e):new Intl.DateTimeFormat(Q(this,$,`a`,nm),Object.assign(Object.assign({},n),{year:`numeric`})).format(e)},fm=function(e){if(this.hasAttribute(`aria-hidden`)&&this.getAttribute(`aria-hidden`)===`true`){let t=document.createElement(`span`);t.setAttribute(`aria-hidden`,`true`),t.textContent=e,Q(this,rm,`f`).replaceChildren(t)}else Q(this,rm,`f`).textContent=e},pm=function(e){return e===`duration`?!1:this.ownerDocument.documentElement.getAttribute(`data-prefers-absolute-time`)===`true`||this.ownerDocument.body?.getAttribute(`data-prefers-absolute-time`)===`true`};var Sm=typeof globalThis<`u`?globalThis:window;try{Sm.RelativeTimeElement=xm.define()}catch(e){if(!(Sm.DOMException&&e instanceof DOMException&&e.name===`NotSupportedError`)&&!(e instanceof ReferenceError))throw e}export{Xi as A,pa as C,ra as D,ua as E,yt as F,bt as I,dt as L,sr as M,Nt as N,sa as O,St as P,ve as R,ma as S,fa as T,$s as _,fp as a,no as b,Zf as c,Rf as d,Nf as f,ac as g,nl as h,hp as i,Ci as j,ia as k,zf as l,Gl as m,mp as n,cp as o,$u as p,dp as r,ap as s,Tp as t,Lf as u,V as v,da as w,_a as x,vs as y,ge as z};
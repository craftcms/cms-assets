...
`,eu={BlockStart:`block-start`,BlockEnd:`block-end`,InlineStart:`inline-start`,InlineEnd:`inline-end`};Object.values(eu);var tu={Horizontal:`horizontal`,Vertical:`vertical`};Object.values(tu);var nu=[eu.InlineStart,eu.InlineEnd],ru=new Set([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Home`,`End`]),G=new WeakSet,iu=new WeakMap,au=new WeakMap,ou=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakMap,du=new WeakMap,fu=new WeakMap,pu=new WeakMap,mu=new WeakMap,hu=class extends Ql{constructor(...e){super(...e),d(this,G),this.placement=eu.BlockStart,this.collapsible=!1,this.size=`medium`,f(this,iu,[]),f(this,au,!1),f(this,ou,[]),f(this,su,0),f(this,cu,void 0),f(this,lu,!1),f(this,uu,e=>{if(!this.collapsible||_u.call(u(G,this)))return;let t=u(G,this,xu).call(this,e.target);!t||t.disabled||vu.call(u(G,this)).indexOf(t)!==this.selectedIndex||(e.stopPropagation(),u(G,this,Su).call(this,!0))}),f(this,du,e=>{e.key!==`Escape`||!this.collapsible||_u.call(u(G,this))||u(G,this,xu).call(this,e.target)&&(e.stopPropagation(),u(G,this,Su).call(this,!0))}),f(this,fu,()=>{_u.call(u(G,this))&&(vu.call(u(G,this)).forEach(e=>{e.removeAttribute(`selected`),e.setAttribute(`aria-selected`,`false`)}),this.panels.forEach(e=>e.removeAttribute(`selected`))),u(G,this,Cu).call(this)}),f(this,pu,()=>{if(u(G,this,wu).call(this),vu.call(u(G,this)).forEach((e,t)=>{let n=()=>u(G,this,Mu).call(this,t,!0),r=e=>{ru.has(e.key)&&e.preventDefault()},i=e=>u(G,this,Nu).call(this,e);e.addEventListener(`click`,n),e.addEventListener(`keydown`,r),e.addEventListener(`keyup`,i),m(iu,this).push(()=>{e.removeEventListener(`click`,n),e.removeEventListener(`keydown`,r),e.removeEventListener(`keyup`,i)})}),vu.call(u(G,this))[this.selectedIndex]?.disabled){let e=vu.call(u(G,this)).findIndex(e=>!e.disabled);e!==-1&&(this.selectedIndex=e)}u(G,this,Tu).call(this)}),f(this,mu,()=>{m(lu,this)||(h(lu,this,!0),requestAnimationFrame(()=>{h(lu,this,!1),u(G,this,Du).call(this)}))})}static get styles(){return[...super.styles,go,$l]}get layout(){return gu.call(u(G,this))?tu.Vertical:tu.Horizontal}set layout(e){this.placement=e===tu.Vertical?eu.InlineStart:eu.BlockStart}refresh(){m(au,this)&&u(G,this,Tu).call(this),u(G,this,Du).call(this)}firstUpdated(e){h(au,this,vu.call(u(G,this)).some(e=>e.controls));let t=this.shadowRoot?.querySelector(`slot[name="tab"]`);if(m(au,this))t?.addEventListener(`slotchange`,m(pu,this)),m(pu,this).call(this);else{let n=_u.call(u(G,this));super.firstUpdated(e),n&&(this.selectedIndex=-1),t?.addEventListener(`slotchange`,m(fu,this))}this.addEventListener(`click`,m(uu,this),!0),this.addEventListener(`keydown`,m(du,this)),t?.addEventListener(`slotchange`,m(mu,this)),h(cu,this,new ResizeObserver(m(mu,this))),m(cu,this).observe(this),u(G,this,Du).call(this)}disconnectedCallback(){super.disconnectedCallback(),u(G,this,wu).call(this),m(cu,this)?.disconnect(),h(cu,this,void 0)}updated(e){super.updated(e),this.toggleAttribute(`collapsed`,_u.call(u(G,this))),e.has(`selectedIndex`)&&(m(au,this)?u(G,this,Tu).call(this):m(fu,this).call(this)),(e.has(`selectedIndex`)||e.has(`placement`)||e.has(`size`))&&u(G,this,Du).call(this)}render(){return r`
    ...
    `}};function gu(){return nu.includes(this.placement)}function _u(){return this.selectedIndex<0}function vu(){return this.tabs}function yu(){return this.shadowRoot?.querySelector(`.tabs__tab-group`)??null}function bu(){return this.shadowRoot?.querySelector(`.tabs__overflow`)??null}function xu(e){return e instanceof Node?vu.call(u(G,this)).find(t=>t===e||t.contains(e))??null:null}function Su(e){let t=vu.call(u(G,this))[this.selectedIndex];h(su,this,this.selectedIndex),this.selectedIndex=-1,e&&t?.focus()}function Cu(){let e=vu.call(u(G,this)),t=t=>!!e[t]&&!e[t].disabled&&!e[t].hidden,n=this.selectedIndex;n<0&&(n=t(m(su,this))?m(su,this):e.findIndex((e,n)=>t(n))),e.forEach((e,t)=>{e.setAttribute(`tabindex`,t===n?`0`:`-1`)})}function wu(){for(;m(iu,this).length;)m(iu,this).pop()?.()}function Tu(){let e=vu.call(u(G,this)).map(e=>u(G,this,Eu).call(this,e)),t=e.some(Boolean);vu.call(u(G,this)).forEach((n,r)=>{let i=r===this.selectedIndex,a=e[r];if(n.id||=`tab-${He()}`,n.setAttribute(`role`,`tab`),n.toggleAttribute(`selected`,i),n.setAttribute(`aria-selected`,String(i)),!a){t&&console.error(`<craft-tabs> found no panel with id "${n.controls}".`,n);return}n.setAttribute(`aria-controls`,a.id),a.setAttribute(`role`,`tabpanel`),a.setAttribute(`aria-labelledby`,n.id),a.hasAttribute(`tabindex`)||a.setAttribute(`tabindex`,`0`),a.classList.toggle(`hidden`,!i),a.toggleAttribute(`selected`,i)}),u(G,this,Cu).call(this)}function Eu(e){return e.controls?document.getElementById(e.controls):null}function Du(){let e=yu.call(u(G,this)),t=bu.call(u(G,this)),n=vu.call(u(G,this));if(!e||!t)return;if(gu.call(u(G,this))||n.length===0){u(G,this,ku).call(this,[]);return}n.forEach(e=>e.removeAttribute(`hidden`)),t.hidden=!0;let r=u(G,this,Ou).call(this,e),i=n.map(e=>e.offsetWidth);if(i.reduce((e,t,n)=>e+t+(n?r:0),0)<=e.clientWidth+1){u(G,this,ku).call(this,[]);return}t.hidden=!1;let a=e.clientWidth,o=[],s=0;for(let e=0;e<n.length;e++){let t=i[e]+(o.length?r:0);if(s+t>a+1)break;s+=t,o.push(e)}let c=this.selectedIndex;if(c>=0&&c<n.length&&!o.includes(c)){let e=i[c];for(;o.length&&s+e+r>a;){let e=o.pop();s-=i[e]+(o.length?r:0)}o.push(c)}let l=new Set(o);u(G,this,ku).call(this,n.map((e,t)=>t).filter(e=>!l.has(e)))}function Ou(e){let t=parseFloat(getComputedStyle(e).columnGap);return Number.isFinite(t)?t:0}function ku(e){let t=bu.call(u(G,this)),n=new Set(e);vu.call(u(G,this)).forEach((e,t)=>{e.toggleAttribute(`hidden`,n.has(t))}),h(ou,this,e),t&&(t.hidden=e.length===0,t.actions=u(G,this,Au).call(this))}function Au(){return m(ou,this).map(e=>{let t=vu.call(u(G,this))[e];return{label:t.textContent?.trim()??``,disabled:t.disabled,onClick:()=>u(G,this,ju).call(this,e)}})}function ju(e){let t=vu.call(u(G,this))[e];if(!t||t.disabled)return;let n=bu.call(u(G,this));n&&(n.opened=!1),this.selectedIndex=e,u(G,this,Du).call(this),t.focus()}function Mu(e,t){let n=vu.call(u(G,this))[e];!n||n.disabled||(this.selectedIndex=e,t&&n.focus())}function Nu(e){if(!ru.has(e.key))return;let t=u(G,this,Pu).call(this,e.key);t!==-1&&u(G,this,Mu).call(this,t,!0)}function Pu(e){let t=vu.call(u(G,this)),n=e=>t[e]&&!t[e].disabled&&!t[e].hidden;if(e===`Home`)return t.findIndex((e,t)=>n(t));if(e===`End`){for(let e=t.length-1;e>=0;e--)if(n(e))return e;return-1}let r=e===`ArrowRight`||e===`ArrowDown`?1:-1;if(_u.call(u(G,this)))return u(G,this,Pu).call(this,r===1?`Home`:`End`);for(let e=1;e<=t.length;e++){let i=((this.selectedIndex+r*e)%t.length+t.length)%t.length;if(n(i))return i}return-1}p([g({reflect:!0})],hu.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],hu.prototype,`collapsible`,void 0),p([g({reflect:!0})],hu.prototype,`layout`,null),p([g({reflect:!0})],hu.prototype,`size`,void 0),customElements.get(`craft-tabs`)||customElements.define(`craft-tabs`,hu);var Fu=a`
  :host {
    display: inline-flex;
...
`,Gu=new WeakMap,Ku=new WeakMap,qu=new WeakMap,Ju=new WeakSet,Yu=class extends Uu{constructor(...e){super(...e),d(this,Ju),this.monospace=!1,f(this,Gu,void 0),f(this,Ku,void 0),f(this,qu,null)}static get styles(){return[...super.styles,br,Wu]}connectedCallback(){super.connectedCallback(),u(Ju,this,Xu).call(this)}disconnectedCallback(){super.disconnectedCallback(),m(Gu,this)?.disconnect(),h(Gu,this,void 0),m(Ku,this)?.disconnect(),h(Ku,this,void 0)}};function Xu(){let e=this._inputNode;!e||typeof ResizeObserver>`u`||typeof MutationObserver>`u`||(h(qu,this,e.style.height),e.style.removeProperty(`resize`),e.addEventListener(`autosize:resized`,()=>{h(qu,this,e.style.height)}),h(Ku,this,new MutationObserver(()=>{e.style.resize!==``&&e.style.removeProperty(`resize`)})),m(Ku,this).observe(e,{attributes:!0,attributeFilter:[`style`]}),h(Gu,this,new ResizeObserver(()=>{if(e.style.height===m(qu,this))return;let t=e.style.height;Vu.destroy(e),e.style.height=t,e.style.removeProperty(`overflow`),m(Ku,this)?.disconnect(),h(Ku,this,void 0),m(Gu,this)?.disconnect(),h(Gu,this,void 0)})),m(Gu,this).observe(e))}p([g({type:Boolean,reflect:!0})],Yu.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,Yu);var Zu=class{constructor(e,t,{tabInsertsSuggestions:n,firstOptionSelectionMode:r,scrollIntoViewOptions:i}={}){this.input=e,this.list=t,this.tabInsertsSuggestions=n??!0,this.firstOptionSelectionMode=r??`none`,this.scrollIntoViewOptions=i??{block:`nearest`,inline:`nearest`},this.isComposing=!1,this.didAutoAssignLastSelectedId=!1,t.id||=`combobox-${Math.random().toString().slice(2,6)}`,this.ctrlBindings=!!navigator.userAgent.match(/Macintosh/),this.keyboardEventHandler=e=>Qu(e,this),this.compositionEventHandler=e=>id(e,this),this.inputHandler=this.clearSelection.bind(this),e.setAttribute(`role`,`combobox`),e.setAttribute(`aria-controls`,t.id),e.setAttribute(`aria-expanded`,`false`),e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-haspopup`,`listbox`)}destroy(){this.clearSelection(),this.stop(),this.input.removeAttribute(`role`),this.input.removeAttribute(`aria-controls`),this.input.removeAttribute(`aria-expanded`),this.input.removeAttribute(`aria-autocomplete`),this.input.removeAttribute(`aria-haspopup`)}start(){this.input.setAttribute(`aria-expanded`,`true`),this.input.addEventListener(`compositionstart`,this.compositionEventHandler),this.input.addEventListener(`compositionend`,this.compositionEventHandler),this.input.addEventListener(`input`,this.inputHandler),this.input.addEventListener(`keydown`,this.keyboardEventHandler),this.list.addEventListener(`click`,$u),this.resetSelection()}stop(){this.clearSelection(),this.input.setAttribute(`aria-expanded`,`false`),this.input.removeEventListener(`compositionstart`,this.compositionEventHandler),this.input.removeEventListener(`compositionend`,this.compositionEventHandler),this.input.removeEventListener(`input`,this.inputHandler),this.input.removeEventListener(`keydown`,this.keyboardEventHandler),this.list.removeEventListener(`click`,$u)}indicateDefaultOption(){var e;this.firstOptionSelectionMode===`active`?(e=Array.from(this.list.querySelectorAll(`[role="option"]:not([aria-disabled="true"])`)).filter(rd)[0])==null||e.setAttribute(`data-combobox-option-default`,`true`):this.firstOptionSelectionMode===`selected`&&this.navigate(1)}navigate(e=1){let t=Array.from(this.list.querySelectorAll(`[aria-selected="true"]`)).filter(rd)[0],n=Array.from(this.list.querySelectorAll(`[role="option"]`)).filter(rd),r=n.indexOf(t);if(r===n.length-1&&e===1||r===0&&e===-1){this.clearSelection(),this.input.focus();return}let i=e===1?0:n.length-1;if(t&&r>=0){let t=r+e;t>=0&&t<n.length&&(i=t)}let a=n[i];if(a)for(let e of n)e.removeAttribute(`data-combobox-option-default`),a===e?(!a.id&&!document.getElementById(`${this.list.id}-selected`)&&(a.id=`${this.list.id}-selected`,this.didAutoAssignLastSelectedId=!0),a.id&&this.input.setAttribute(`aria-activedescendant`,a.id),a.setAttribute(`aria-selected`,`true`),nd(a),a.scrollIntoView(this.scrollIntoViewOptions)):(e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1),e.removeAttribute(`aria-selected`))}clearSelection(){this.input.removeAttribute(`aria-activedescendant`);for(let e of this.list.querySelectorAll(`[aria-selected="true"], [data-combobox-option-default="true"]`))e.removeAttribute(`aria-selected`),e.removeAttribute(`data-combobox-option-default`),e.id===`${this.list.id}-selected`&&this.didAutoAssignLastSelectedId&&(e.removeAttribute(`id`),this.didAutoAssignLastSelectedId=!1)}resetSelection(){this.clearSelection(),this.indicateDefaultOption()}};function Qu(e,t){if(!(e.shiftKey||e.metaKey||e.altKey)&&!(!t.ctrlBindings&&e.ctrlKey)&&!t.isComposing)switch(e.key){case`Enter`:ed(t.input,t.list)&&e.preventDefault();break;case`Tab`:t.tabInsertsSuggestions&&ed(t.input,t.list)&&e.preventDefault();break;case`Escape`:t.clearSelection();break;case`ArrowDown`:t.navigate(1),e.preventDefault();break;case`ArrowUp`:t.navigate(-1),e.preventDefault();break;case`n`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(1),e.preventDefault());break;case`p`:t.ctrlBindings&&e.ctrlKey&&(t.navigate(-1),e.preventDefault());break;default:if(e.ctrlKey)break;t.resetSelection()}}function $u(e){if(!(e.target instanceof Element))return;let t=e.target.closest(`[role="option"]`);t&&t.getAttribute(`aria-disabled`)!==`true`&&td(t,{event:e})}function ed(e,t){let n=t.querySelector(`[aria-selected="true"], [data-combobox-option-default="true"]`);return n?(n.getAttribute(`aria-disabled`)===`true`||n.click(),!0):!1}function td(e,t){e.dispatchEvent(new CustomEvent(`combobox-commit`,{bubbles:!0,detail:t}))}function nd(e){e.dispatchEvent(new Event(`combobox-select`,{bubbles:!0}))}function rd(e){return!e.hidden&&!(e instanceof HTMLInputElement&&e.type===`hidden`)&&(e.offsetWidth>0||e.offsetHeight>0)}function id(e,t){t.isComposing=e.type===`compositionstart`,document.getElementById(t.input.getAttribute(`aria-controls`)||``)&&t.clearSelection()}var ad=class extends Event{constructor(){super(`update`)}},od=new WeakMap,sd=class e extends EventTarget{#e=new MutationObserver(()=>this.#f());#t=new ResizeObserver(()=>this.#d());#n;#r=document.createElement(`div`);#i=document.createElement(`div`);static for(t){let n=od.get(t);return n||(n=new e(t),od.set(t,n)),n}constructor(e){super(),this.#n=new WeakRef(e),this.#r.style.position=`absolute`,this.#r.style.pointerEvents=`none`,this.#r.setAttribute(`aria-hidden`,`true`),this.#r.appendChild(this.#i),this.#i.style.pointerEvents=`none`,this.#i.style.userSelect=`none`,this.#i.style.overflow=`hidden`,this.#i.style.display=`block`,this.#i.style.visibility=`hidden`,e instanceof HTMLTextAreaElement?(this.#i.style.whiteSpace=`pre-wrap`,this.#i.style.wordWrap=`break-word`):(this.#i.style.whiteSpace=`nowrap`,this.#i.style.display=`table-cell`,this.#i.style.verticalAlign=`middle`),e.after(this.#r),this.#f(),this.#p(),this.#e.observe(e,{attributeFilter:[`style`,`dir`]}),this.#t.observe(e),document.addEventListener(`scroll`,this.#h,{capture:!0}),window.addEventListener(`resize`,this.#h,{capture:!0}),e.addEventListener(`input`,this.#m,{capture:!0})}get element(){return this.#i}forceUpdate(){this.#f(),this.#p()}disconnect(){this.#r?.remove(),this.#e.disconnect(),this.#t.disconnect(),document.removeEventListener(`scroll`,this.#h,{capture:!0}),window.removeEventListener(`resize`,this.#h,{capture:!0});let e=this.#a;e&&(e.removeEventListener(`input`,this.#m,{capture:!0}),od.delete(e))}get#a(){return this.#n?.deref()}#o(e){let t=this.#a;return t?e(t):this.disconnect()}#s=0;#c=0;#l(){this.#o(e=>{let t=window.getComputedStyle(e);this.#i.style.height=t.height,this.#i.style.width=t.width,e.clientHeight!==this.#i.clientHeight&&(this.#i.style.height=`calc(${t.height} + ${e.clientHeight-this.#i.clientHeight}px)`),e.clientWidth!==this.#i.clientWidth&&(this.#i.style.width=`calc(${t.width} + ${e.clientWidth-this.#i.clientWidth}px)`);let n=e.getBoundingClientRect(),r=this.#i.getBoundingClientRect();this.#s=this.#s+n.left-r.left,this.#c=this.#c+n.top-r.top,this.#i.style.transform=`translate(${this.#s}px, ${this.#c}px)`,this.#i.scrollTop=e.scrollTop,this.#i.scrollLeft=e.scrollLeft,this.dispatchEvent(new ad)})}#u=!1;#d(){this.#u||(this.#u=!0,requestAnimationFrame(()=>{this.#l(),this.#u=!1}))}#f(){this.#o(e=>{let t=window.getComputedStyle(e);for(let e of cd)this.#i.style[e]=t[e];this.#d()})}#p(){this.#o(e=>{this.#i.textContent=e.value,this.#l()})}#m=()=>this.#p();#h=e=>{this.#o(t=>{(e.target===document||e.target===window||e.target instanceof Node&&e.target.contains(t))&&this.#d()})}},cd=`direction.writingMode.unicodeBidi.textOrientation.boxSizing.borderTopWidth.borderRightWidth.borderBottomWidth.borderLeftWidth.borderStyle.paddingTop.paddingRight.paddingBottom.paddingLeft.fontStyle.fontVariant.fontWeight.fontStretch.fontSize.fontSizeAdjust.lineHeight.fontFamily.textAlign.textTransform.textIndent.textDecoration.letterSpacing.wordSpacing.tabSize.MozTabSize`.split(`.`),ld=class e{#e;#t;#n;constructor(e,t=0,n=t){this.#e=e,this.#t=t,this.#n=n}static fromSelection(t){let{selectionStart:n,selectionEnd:r}=t;return new e(t,n??void 0,r??void 0)}get collapsed(){return this.startOffset===this.endOffset}get commonAncestorContainer(){return this.#e}get endContainer(){return this.#e}get startContainer(){return this.#e}get startOffset(){return this.#t}get endOffset(){return this.#n}setStartOffset(e){this.#t=this.#a(e)}setEndOffset(e){this.#n=this.#a(e)}collapse(e=!1){e?this.setEndOffset(this.startOffset):this.setStartOffset(this.endOffset)}cloneContents(){return this.#o().cloneContents()}cloneRange(){return new e(this.#e,this.startOffset,this.endOffset)}getBoundingClientRect(){return this.#o().getBoundingClientRect()}getClientRects(){return this.#o().getClientRects()}toString(){return this.#o().toString()}getStyleClone(){return this.#r}get#r(){return sd.for(this.#e)}get#i(){return this.#r}#a(e){return Math.max(0,Math.min(e,this.#e.value.length))}#o(){let e=document.createRange(),t=this.#i.element.childNodes[0];return t&&(e.setStart(t,this.startOffset),e.setEnd(t,this.endOffset)),e}},ud=a`
  :host {
    display: contents;
  }
...
`,dd=/^[\p{L}\p{N}_.-]*$/u,fd=O(`Suggestions`),pd=[`role`,`aria-autocomplete`,`aria-haspopup`,`aria-expanded`,`aria-controls`,`aria-activedescendant`,`aria-busy`],md={handlesAccessibility:!1,visibilityTriggerFunction:void 0},hd=0,K=new WeakMap,gd=new WeakMap,_d=new WeakMap,vd=new WeakMap,q=new WeakMap,yd=new WeakMap,bd=new WeakMap,xd=new WeakMap,Sd=new WeakMap,Cd=new WeakMap,wd=new WeakMap,Td=new WeakMap,Ed=new WeakMap,Dd=new WeakMap,J=new WeakSet,Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=new WeakMap,Md=new WeakMap,Nd=new WeakMap,Pd=new WeakMap,Fd=new WeakMap,Id=new WeakMap,Ld=new WeakMap,Rd=new WeakMap,zd=class extends l{constructor(...e){super(...e),d(this,J),this.for=``,this.triggers=[],this.loading=!1,this.announcement=``,f(this,K,void 0),f(this,gd,null),f(this,_d,null),f(this,vd,new Map),f(this,q,null),f(this,yd,[]),f(this,bd,0),f(this,xd,null),f(this,Sd,null),f(this,Cd,null),f(this,wd,!1),f(this,Td,null),f(this,Ed,new DOMRect),f(this,Dd,new MutationObserver(()=>{let e=u(J,this,Vd).call(this);(uf(e)&&e!==m(gd,this)||m(gd,this)&&!m(gd,this).isConnected)&&u(J,this,Hd).call(this)})),f(this,Od,()=>{m(wd,this)||u(J,this,Yd).call(this)}),f(this,kd,()=>{h(wd,this,!0),u(J,this,rf).call(this)}),f(this,Ad,()=>{h(wd,this,!1),u(J,this,Yd).call(this)}),f(this,jd,()=>{queueMicrotask(()=>u(J,this,rf).call(this))}),f(this,Md,()=>{let e=m(gd,this);!e||!m(q,this)||!df(e)||queueMicrotask(()=>{m(q,this)&&(e.selectionStart!==m(q,this).end||e.selectionEnd!==m(q,this).end)&&u(J,this,Yd).call(this)})}),f(this,Nd,()=>{m(q,this)&&u(J,this,nf).call(this)}),f(this,Pd,e=>{let t=e;m(q,this)&&m(K,this).querySelector(`[aria-selected="true"]`)&&[`ArrowDown`,`ArrowUp`,`Enter`].includes(t.key)&&t.stopPropagation()}),f(this,Fd,e=>{e.target instanceof Element&&e.target.closest(`[role="option"]`)&&e.preventDefault()}),f(this,Id,e=>{e.pointerType===`touch`&&e.target instanceof Element&&e.target.closest(`[role="option"]`)?.click()}),f(this,Ld,e=>{u(J,this,$d).call(this,Number(e.target.dataset.index))}),f(this,Rd,e=>{if(e.target!==this.popoverElement)return;let t=m(K,this).getAttribute(`aria-label`)??fd;u(J,this,sf).call(this),h(q,this,null),u(J,this,of).call(this),u(J,this,cf).call(this,t===fd?O(`Suggestions collapsed`):O(`{name} suggestions collapsed`,{name:t}))})}connectedCallback(){super.connectedCallback(),u(J,this,Bd).call(this),this.hasUpdated&&u(J,this,Hd).call(this)}disconnectedCallback(){u(J,this,Wd).call(this),m(K,this)?.remove(),m(Cd,this)!==null&&(clearTimeout(m(Cd,this)),h(Cd,this,null)),super.disconnectedCallback()}firstUpdated(e){super.firstUpdated(e),u(J,this,Hd).call(this)}updated(e){if(super.updated(e),e.has(`for`)&&m(gd,this)!==u(J,this,Vd).call(this)&&u(J,this,Hd).call(this),e.has(`triggers`)&&e.get(`triggers`)&&m(q,this)){let e=m(K,this).querySelector(`[aria-selected="true"]`),t=e?m(yd,this)[Number(e.dataset.index)]:void 0;u(J,this,Yd).call(this,t)}}render(){return r`
      <craft-popover
        exportparts="popup"
        .config=${md}
        @craft-hide=${m(Rd,this)}
      >
    ...
    `}};function Bd(){h(K,this,document.createElement(`div`)),m(K,this).id=`craft-text-expander-listbox-${++hd}`,m(K,this).slot=`listbox`,m(K,this).setAttribute(`part`,`listbox`),m(K,this).role=`listbox`,m(K,this).setAttribute(`aria-label`,fd),m(K,this).addEventListener(`pointerdown`,m(Fd,this)),m(K,this).addEventListener(`pointerup`,m(Id,this)),m(K,this).addEventListener(`combobox-commit`,m(Ld,this)),this.append(m(K,this))}function Vd(){return this.getRootNode().getElementById(this.for)}function Hd(){let e=u(J,this,Vd).call(this);if(u(J,this,Wd).call(this),!uf(e)){u(J,this,Ud).call(this);return}h(gd,this,e),u(J,this,Gd).call(this,e),h(_d,this,new Zu(e,m(K,this),{tabInsertsSuggestions:!1,firstOptionSelectionMode:`selected`,scrollIntoViewOptions:{block:`nearest`}})),u(J,this,Kd).call(this,e),e.addEventListener(`input`,m(Od,this)),e.addEventListener(`keydown`,m(Pd,this)),e.addEventListener(`blur`,m(jd,this)),e.addEventListener(`compositionstart`,m(kd,this)),e.addEventListener(`compositionend`,m(Ad,this)),e.ownerDocument.addEventListener(`selectionchange`,m(Md,this)),this.popoverElement.anchor={contextElement:e,getBoundingClientRect:()=>m(Ed,this)},u(J,this,Ud).call(this)}function Ud(){m(Dd,this).observe(this.getRootNode(),{attributes:!0,attributeFilter:[`id`],childList:!0,subtree:!0})}function Wd(){m(Dd,this).disconnect(),u(J,this,rf).call(this);let e=m(gd,this);e&&(e.removeEventListener(`input`,m(Od,this)),e.removeEventListener(`keydown`,m(Pd,this)),e.removeEventListener(`blur`,m(jd,this)),e.removeEventListener(`compositionstart`,m(kd,this)),e.removeEventListener(`compositionend`,m(Ad,this)),e.ownerDocument.removeEventListener(`selectionchange`,m(Md,this)),m(Td,this)?.getStyleClone().disconnect(),h(Td,this,null),m(_d,this)?.destroy(),h(_d,this,null),u(J,this,qd).call(this,e),h(gd,this,null))}function Gd(e){m(vd,this).clear();for(let t of pd)m(vd,this).set(t,e.getAttribute(t))}function Kd(e){let t=[m(vd,this).get(`aria-controls`),m(K,this).id].filter(Boolean).join(` `);e.setAttribute(`aria-autocomplete`,`list`),e.setAttribute(`aria-controls`,t),e.setAttribute(`data-text-expander-input`,``),e.getAttribute(`role`)===`combobox`&&e.removeAttribute(`role`),e instanceof HTMLInputElement?e.setAttribute(`aria-haspopup`,`listbox`):u(J,this,Jd).call(this,e,`aria-haspopup`),u(J,this,Jd).call(this,e,`aria-expanded`)}function qd(e){for(let t of pd)u(J,this,Jd).call(this,e,t);m(vd,this).clear()}function Jd(e,t){let n=m(vd,this).get(t);n==null?e.removeAttribute(t):e.setAttribute(t,n)}function Yd(e){u(J,this,sf).call(this);let t=u(J,this,Zd).call(this);if(!t){h(q,this,null),u(J,this,af).call(this);return}h(q,this,t);let n=t.trigger.limit;if(t.trigger.options){this.loading=!1;let r=t.query.toLowerCase(),i=t.trigger.options.filter(e=>[e.label,...e.keywords??[]].some(e=>e.toLowerCase().includes(r)));u(J,this,Qd).call(this,n===void 0?i:i.slice(0,n),e);return}this.loading=!0,u(J,this,Qd).call(this,[]),u(J,this,cf).call(this,O(`Loading`));let r=m(bd,this);h(Sd,this,setTimeout(()=>{u(J,this,Xd).call(this,t,n,r,e)},150))}async function Xd(e,t,n,r){h(xd,this,new AbortController);let i;try{let n=await _e.get(e.trigger.source,{params:{query:`${e.character}${e.query}`,...t===void 0?{}:{limit:t}},signal:m(xd,this).signal});if(!Array.isArray(n.data))throw TypeError(`Text expander sources must return an array.`);i=n.data}catch(t){if(n!==m(bd,this)||ff(t))return;u(J,this,rf).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-error`,{bubbles:!0,composed:!0,detail:{character:e.character,query:e.query,error:t}}));return}n===m(bd,this)&&(this.loading=!1,u(J,this,Qd).call(this,t===void 0?i:i.slice(0,t),r))}function Zd(){let e=m(gd,this);if(!e||!e.isConnected||e.disabled||e.readOnly||!df(e)||e.selectionStart===null||e.selectionEnd===null||e.selectionStart!==e.selectionEnd)return null;let t=e.selectionStart,n=e.value.slice(0,t),r=null;for(let e of this.triggers){let i=e.trigger,a=n.lastIndexOf(i);if(a===-1||r&&a<=r.start)continue;let o=Array.from(n.slice(0,a)).at(-1),s=n.slice(a+i.length);(e.boundary===`anywhere`||(e.boundary===`start`?a===0:!o||/\s/u.test(o)))&&dd.test(s)&&(r={character:i,query:s,start:a,end:t,trigger:e})}return r}function Qd(e,t){if(u(J,this,tf).call(this),h(yd,this,e),m(K,this).replaceChildren(),m(K,this).hidden=this.loading,m(K,this).setAttribute(`aria-label`,m(q,this)?.trigger.label??fd),e.forEach((e,t)=>{let n=document.createElement(`craft-option`),r=lf(e);n.id=`${m(K,this).id}-option-${t}`,n.setAttribute(`part`,`option`),n.dataset.index=String(t),n.setAttribute(`aria-label`,r?`${e.label}, ${r}`:e.label),n.hint=r,n.append(m(q,this)?.trigger.renderOption?.(e)??document.createTextNode(e.label)),m(K,this).append(n)}),!this.loading&&!e.length){h(q,this,null),u(J,this,af).call(this),u(J,this,cf).call(this,O(`No suggestions`));return}this.updateComplete.then(()=>{m(q,this)&&u(J,this,ef).call(this,t)})}function $d(e){let t=m(gd,this),n=m(yd,this)[e],r=u(J,this,Zd).call(this),i=m(q,this);if(!t||!n||!i||!r||r.start!==i.start||r.end!==i.end||r.character!==i.character||r.query!==i.query){u(J,this,rf).call(this);return}pf(t,i.start,i.end,n.value);let a={character:i.character,query:i.query,option:n};u(J,this,rf).call(this),this.dispatchEvent(new CustomEvent(`craft-text-expander-select`,{bubbles:!0,composed:!0,detail:a}))}async function ef(e){await this.popoverElement.updateComplete;let t=m(gd,this);if(!t||!u(J,this,nf).call(this)){u(J,this,rf).call(this);return}if(t.setAttribute(`aria-busy`,String(this.loading)),await this.popoverElement.show(),!(!m(q,this)||t!==m(gd,this))&&m(yd,this).length&&(m(_d,this)?.start(),u(J,this,Jd).call(this,t,`aria-expanded`),t.removeEventListener(`input`,m(Od,this)),t.addEventListener(`input`,m(Od,this)),e)){let t=m(yd,this).findIndex(t=>t.label===e.label&&t.value===e.value);for(let e=0;e<t;e++)m(_d,this)?.navigate(1)}}function tf(){m(_d,this)?.stop(),m(gd,this)&&u(J,this,Jd).call(this,m(gd,this),`aria-expanded`)}function nf(){let e=m(gd,this),t=e?.selectionStart;if(!e?.isConnected||t==null)return!1;if(!m(Td,this)){h(Td,this,new ld(e));let t=m(Td,this).getStyleClone();t.element.parentElement.slot=e.slot,t.forceUpdate(),t.addEventListener(`update`,m(Nd,this))}return m(Td,this).setStartOffset(t),m(Td,this).setEndOffset(t),h(Ed,this,m(Td,this).getBoundingClientRect()),this.popoverElement.repositionOverlay(),!0}function rf(){u(J,this,sf).call(this),h(q,this,null),u(J,this,af).call(this)}function af(){u(J,this,of).call(this),this.popoverElement.hide()}function of(){this.loading=!1,u(J,this,tf).call(this),h(yd,this,[]),m(K,this)?.replaceChildren(),m(K,this)&&(m(K,this).hidden=!1);let e=m(gd,this);e&&(u(J,this,Jd).call(this,e,`aria-activedescendant`),u(J,this,Jd).call(this,e,`aria-busy`))}function sf(){var e;h(bd,this,(e=m(bd,this),e++,e)),m(Sd,this)&&(clearTimeout(m(Sd,this)),h(Sd,this,null)),m(xd,this)?.abort(),h(xd,this,null)}function cf(e){m(Cd,this)!==null&&(clearTimeout(m(Cd,this)),h(Cd,this,null)),this.announcement=``,queueMicrotask(()=>{this.isConnected&&(this.announcement=e)}),h(Cd,this,setTimeout(()=>{h(Cd,this,null),this.announcement=``},5e3))}zd.styles=[Mt,ud],p([g({reflect:!0})],zd.prototype,`for`,void 0),p([g({type:Array})],zd.prototype,`triggers`,void 0),p([_()],zd.prototype,`loading`,void 0),p([_()],zd.prototype,`announcement`,void 0),p([y(`craft-popover`)],zd.prototype,`popoverElement`,void 0);function lf(e){return typeof e.data!=`object`||e.data===null||!(`hint`in e.data)||typeof e.data.hint!=`string`?null:e.data.hint}function uf(e){return e instanceof HTMLTextAreaElement||e instanceof HTMLInputElement&&e.type===`text`}function df(e){return e.getRootNode().activeElement===e}function ff(e){return e instanceof DOMException&&e.name===`AbortError`}function pf(e,t,n,r){e.maxLength>=0&&(r=r.slice(0,Math.max(0,e.maxLength-(e.value.length-(n-t)))));let i=`${e.value.slice(0,t)}${r}${e.value.slice(n)}`,a=!1,o=()=>{a=!0};e.focus({preventScroll:!0}),e.setSelectionRange(t,n),e.addEventListener(`input`,o,{once:!0});try{e.ownerDocument.execCommand?.(`insertText`,!1,r)}catch{}e.removeEventListener(`input`,o),e.value!==i&&(e.setRangeText(r,t,n,`end`),a=!1),a||e.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0,data:r,inputType:`insertReplacementText`}))}customElements.get(`craft-text-expander`)||customElements.define(`craft-text-expander`,zd);var mf=a`
  :host {
    display: inline-flex;
...
`,hf=new WeakMap,gf=new WeakSet,_f=class extends l{constructor(...e){super(...e),d(this,gf),this.placement=`top`,this.disabled=!1,this.overflowing=!1,this.text=``,f(this,hf,typeof ResizeObserver<`u`?new ResizeObserver(()=>u(gf,this,vf).call(this)):null)}connectedCallback(){super.connectedCallback(),m(hf,this)?.observe(this)}disconnectedCallback(){m(hf,this)?.disconnect(),super.disconnectedCallback()}firstUpdated(){u(gf,this,vf).call(this)}render(){let e=this.overflowing&&!this.disabled;return r`
      <span class="truncate" id="content">
        <slot @slotchange=${u(gf,this,yf)}></slot>
      </span>
      ${e?r`<craft-tooltip for="content" placement=${this.placement}
            >${this.text}</craft-tooltip
          >`:``}
    `}};function vf(){this.text=(this.textContent??``).replace(/\s+/g,` `).trim();let e=this.content;this.overflowing=!!e&&e.scrollWidth>e.clientWidth}function yf(){u(gf,this,vf).call(this)}_f.styles=mf,p([g({reflect:!0})],_f.prototype,`placement`,void 0),p([g({type:Boolean,reflect:!0})],_f.prototype,`disabled`,void 0),p([_()],_f.prototype,`overflowing`,void 0),p([_()],_f.prototype,`text`,void 0),p([y(`.truncate`)],_f.prototype,`content`,void 0),customElements.get(`craft-truncate`)||customElements.define(`craft-truncate`,_f);var bf=a`
  :host {
...
`,xf={fromAttribute:e=>e!==null&&e!==`false`,toAttribute:e=>e?``:null},Sf=class extends l{constructor(...e){super(...e),this.src=null,this.mode=`fit`,this.svgAspectRatios=new Map,this.srcset=null,this.sizes=null,this.alt=``,this.width=null,this.height=null,this.loading=`lazy`,this.checkered=!0,this.rounded=!1}restoreSlottedSvgs(){for(let[e,t]of this.svgAspectRatios)t===null?e.removeAttribute(`preserveAspectRatio`):e.setAttribute(`preserveAspectRatio`,t);this.svgAspectRatios.clear()}updateSlottedSvgs(){if(this.restoreSlottedSvgs(),this.mode!==`crop`&&this.mode!==`stretch`)return;let e=this.shadowRoot?.querySelector(`slot`);for(let t of e?.assignedElements()??[])t instanceof SVGSVGElement&&(this.svgAspectRatios.set(t,t.getAttribute(`preserveAspectRatio`)),t.setAttribute(`preserveAspectRatio`,this.mode===`crop`?`xMidYMid slice`:`none`))}updated(){this.updateSlottedSvgs()}connectedCallback(){super.connectedCallback(),this.updateSlottedSvgs()}disconnectedCallback(){super.disconnectedCallback(),this.restoreSlottedSvgs()}render(){return r`

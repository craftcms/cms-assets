import{c as e,f as t,r as n,t as r}from"./lit-DNaDb1T7.js";import{E as i,_ as a}from"./nav-item-BaculwHk-XKDDKY1Y.js";import"./cp-CNzXDxH5.js";import{t as o}from"./custom-element-Bov83m9_.js";import{n as s}from"./decorators-D0-gbKXH.js";import{t as c}from"./query-Df4-SAIv.js";import{t as l}from"./actionClient-NFMyfrDL-DsDU7tG9.js";import{i as u,n as d,t as f}from"./wayfinder-Byp9MxZi.js";import"./actionClient.ts-zYZ3wcB4.js";import"./unsafe-html-DK1p6zyd.js";import{t as p}from"./decorate-B3KLIx2E.js";import"./button.ts-DK1p6zyd.js";import"./popover.ts-DK1p6zyd.js";var m=(e,t)=>({url:m.url(e,t),method:`post`});m.definition={methods:[`post`],url:`/{cpTrigger?}/notifications/mark-read`},m.url=(e,t)=>{(typeof e==`string`||typeof e==`number`)&&(e={cpTrigger:e}),Array.isArray(e)&&(e={cpTrigger:e[0]}),e=f(e),u(e,[`cpTrigger`]);let n={cpTrigger:e?.cpTrigger??`admin`};return m.definition.url.replace(`{cpTrigger?}`,n.cpTrigger?.toString()??``).replace(/\/+$/,``)+d(t)},m.post=(e,t)=>({url:m.url(e,t),method:`post`});var h=class extends r{constructor(...e){super(...e),this.notifications=window.Craft.notifications??[]}static{this.styles=t`
  ...
  `}get#e(){return this.notifications.filter(e=>e.unread)}get#t(){return this.#e.length?a(`Notifications, {count} unread`,{count:this.#e.length}):a(`Notifications`)}async#n(e){let t=this.notifications.filter(t=>t.unread&&e.includes(t.id)).map(e=>e.id);if(t.length){this.#r(t,!1);try{await l.post(m().url,{ids:t})}catch{this.#r(t,!0),Craft.cp?.displayError?.(a(`Couldn’t mark notifications as read.`))}}}#r(e,t){this.notifications=this.notifications.map(n=>e.includes(n.id)?{...n,unread:t}:n)}#i(e,t){return e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||t.target!==``&&t.target!==`_self`}async#a(e,t){let n=t.composedPath().find(e=>e instanceof HTMLAnchorElement);if(n){if(this.#i(t,n)){e.unread&&this.#n([e.id]);return}t.preventDefault();try{await this.#n([e.id])}finally{this.#o(n.href)}}}#o(e){if(this.popoverElement?.hide(),new URL(e).origin!==window.location.origin){window.location.assign(e);return}window.dispatchEvent(new CustomEvent(`action:redirect`,{cancelable:!0,detail:{url:e}}))&&window.location.assign(e)}#s(t){return e`
      <div
      ...
      >
        ${t.url?e`
              <a
                ...
                href=${t.url}
                aria-label=${t.title??a(`Open notification`)}
              ></a>
            `:n}
        ${this.#s(t)}
      ...
      <craft-popover placement="bottom-end" .distance=${8}>
        ...
        <div slot="content">
          <header class="notification-header">
            <h2 class="notification-heading">${a(`Notifications`)}</h2>
            ${this.#e.length?e`
                  <craft-button
                    type="button"
                    size="small"

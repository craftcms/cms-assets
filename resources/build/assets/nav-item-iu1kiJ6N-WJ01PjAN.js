...
`,pe=class e{static __createGlobalStyleNode(){let e=document.createElement(`style`);return e.setAttribute(`data-overlays`,``),e.textContent=fe.cssText,document.head.appendChild(e),e}get list(){return this.__list}get shownList(){return this.__shownList}constructor(){this.__list=[],this.__shownList=[],this._siblingsInert=!1,this.__blockingMap=new WeakMap,e.__globalStyleNode||=e.__createGlobalStyleNode()}add(e){if(this.list.find(t=>e===t))throw Error(`controller instance is already added`);return this.list.push(e),e}remove(e){if(!this.list.find(t=>e===t))throw Error(`could not find controller to remove`);this.__list=this.list.filter(t=>t!==e),this.__shownList=this.shownList.filter(t=>t!==e)}show(e){this.list.find(t=>e===t)&&this.hide(e),this.__shownList.unshift(e),Array.from(this.__shownList).reverse().forEach((e,t)=>{e.elevation=t+1})}hide(e){if(!this.list.find(t=>e===t))throw Error(`could not find controller to hide`);this.__shownList=this.shownList.filter(t=>t!==e)}teardown(){this.list.forEach(e=>{e.teardown()}),this.__list=[],this.__shownList=[],this._siblingsInert=!1,e.__globalStyleNode&&=(document.head.removeChild(e.__globalStyleNode),void 0)}get siblingsInert(){return this._siblingsInert}requestToPreventScroll(){let{isIOS:e,isMacSafari:t}=O;document.body.classList.add(`overlays-scroll-lock`),(e||t)&&document.body.classList.add(`overlays-scroll-lock-ios-fix`),e&&document.documentElement.classList.add(`overlays-scroll-lock-ios-fix`)}requestToEnableScroll(e){if((e?this.shownList.filter(t=>t!==e):this.shownList).some(e=>e.preventsScroll===!0))return;let{isIOS:t,isMacSafari:n}=O;document.body.classList.remove(`overlays-scroll-lock`),(t||n)&&document.body.classList.remove(`overlays-scroll-lock-ios-fix`),t&&document.documentElement.classList.remove(`overlays-scroll-lock-ios-fix`)}requestToShowOnly(e){let t=this.shownList.filter(t=>t!==e);t.forEach(e=>e.hide()),this.__blockingMap.set(e,t)}retractRequestToShowOnly(e){this.__blockingMap.has(e)&&this.__blockingMap.get(e).forEach(e=>e.show())}};pe.__globalStyleNode=void 0;var k=Symbol.for(`lion::SingletonManagerClassStorage`),A=globalThis||window,me=class{constructor(){this._map=A[k]?A[k]:A[k]=new Map}set(e,t){this.has(e)||this._map.set(e,t)}get(e){return this._map.get(e)}has(e){return this._map.has(e)}},he=e=>{let t=null,n=()=>(t===null&&(t=e()),t);return new Proxy({},{get(e,t){let r=n();return t===`addEventListener`||t===`removeEventListener`?Reflect.get(r,t).bind(r):t===`__instance_for_testing`?r:Reflect.get(r,t,r)},set(e,t,r){return Reflect.set(n(),t,r)},getOwnPropertyDescriptor(e,t){return Reflect.getOwnPropertyDescriptor(n(),t)},getPrototypeOf(){return Reflect.getPrototypeOf(n())}})},j=new me;function ge(){if(!j.has(`@lion/ui::overlays::0.x`)){let e=new pe;j.set(`@lion/ui::overlays::0.x`,e)}return j.get(`@lion/ui::overlays::0.x`)}var _e=he(ge);function M(e,t,n={}){function r(e){return`getAttribute`in e}function i(e){if(!r(e))return null;let t=e.getAttribute(`slot`),i=null;if(t){let r=n[t];r&&(i=r.filter(t=>t?.element===e)[0]||null)}return i}let a=i(e);if(a)return a.deepContains;function o(t){if(!r(e))return;let i=e.getAttribute(`slot`);i&&(n[i]=n[i]||[],n[i].push({element:e,deepContains:t}))}let s=e.contains(t);if(s)return o(!0),!0;function c(e){return e.tagName===`SLOT`}function l(e){return c(e)?e.assignedElements():[]}function u(e){return e.nodeType===Node.DOCUMENT_FRAGMENT_NODE}function d(e){let i=!1;for(let a=0;a<e.length;a+=1){let o=e[a];if(o&&(r(o)||u(o))&&M(o,t,n)){i=!0;break}}return i}function f(e){for(let t=0;t<e.children.length;t+=1){let n=e.children[t],r=i(n);if(r){s=r.deepContains||s;break}let a=l(n);if(d([n.shadowRoot,...a])){s=!0;break}n.children.length>0&&f(n)}}return e instanceof HTMLElement&&e.shadowRoot&&(s=M(e.shadowRoot,t,n),s)?(o(!0),!0):(f(e),o(s),s)}var ve=t`
  .overlays {
    position: fixed;
    z-index: 200;
  }
...
`,H=new WeakMap,Ue=new WeakSet,U=class extends B(i){constructor(){super(),l(this,Ue),this.placement=`bottom-start`,this.distance=4,this.matchInvokerWidth=!1,this.withoutArrow=!1,u(this,H,null),E(this)}_defineOverlayConfig(){return{...V(),inheritsReferenceWidth:this.matchInvokerWidth?`min`:`none`,popperConfig:{strategy:`fixed`,placement:this.placement,modifiers:[{name:`offset`,options:{offset:[0,this.distance]}},...ce()]}}}get _overlayContentNode(){return this.shadowRoot?.querySelector(`.popover-pane`)}get _overlayInvokerNode(){if(this.anchor instanceof HTMLElement)return this.anchor;if(this.anchor?.contextElement instanceof HTMLElement)return this.anchor.contextElement;if(this.for){let e=this.getRootNode();return typeof e.getElementById==`function`?e.getElementById(this.for)??void 0:void 0}return super._overlayInvokerNode}get _overlayReferenceNode(){return this.anchor}render(){return e`
    ...
    `}connectedCallback(){c(Ue,this,We).call(this),super.connectedCallback()}updated(e){super.updated(e),(e.has(`for`)||e.has(`anchor`))&&this._overlayCtrl&&this._overlayCtrl.updateConfig({invokerNode:this._overlayInvokerNode,referenceNode:this._overlayReferenceNode})}async show(){this.opened=!0,await this.updateComplete,await this.open()}async hide(){this.opened=!1,await this.updateComplete,await this.close()}};function We(){if(d(H,this)?.isConnected)return;let e=Array.from(this.childNodes).filter(e=>e instanceof Element?e.slot===``:(e.textContent??``).trim()!==``);if(!e.length)return;let t=document.createElement(`div`);t.slot=`content`,t.append(...e),this.append(t),f(H,this,t)}U.styles=[He],a([o({reflect:!0})],U.prototype,`for`,void 0),a([o({attribute:!1})],U.prototype,`anchor`,void 0),a([o({reflect:!0})],U.prototype,`placement`,void 0),a([o({type:Number})],U.prototype,`distance`,void 0),a([o({attribute:`match-invoker-width`,type:Boolean})],U.prototype,`matchInvokerWidth`,void 0),a([o({type:Boolean,attribute:`without-arrow`})],U.prototype,`withoutArrow`,void 0),customElements.get(`craft-popover`)||customElements.define(`craft-popover`,U);var W={Solid:`solid`,OutlineFill:`outline-fill`,Fill:`fill`,Outline:`outline`,Plain:`plain`};Object.values(W);var Ge=`important`,Ke=` !important`,qe=m(class extends h{constructor(e){if(super(e),e.type!==p.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:r}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?r.removeProperty(e):r[e]=null);for(let e in t){let n=t[e];if(n!=null){this.ft.add(e);let t=typeof n==`string`&&n.endsWith(Ke);e.includes(`-`)||t?r.setProperty(e,t?n.slice(0,-11):n,t?Ge:``):r[e]=n}}return n}}),Je=t`
...
`,Xe=Object.defineProperty,Ze=Object.getOwnPropertyDescriptor,Qe=Object.getOwnPropertySymbols,$e=Object.prototype.hasOwnProperty,et=Object.prototype.propertyIsEnumerable,tt=e=>{throw TypeError(e)},nt=(e,t,n)=>t in e?Xe(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,rt=(e,t)=>{for(var n in t||={})$e.call(t,n)&&nt(e,n,t[n]);if(Qe)for(var n of Qe(t))et.call(t,n)&&nt(e,n,t[n]);return e},it=(e,t,n,r)=>{for(var i=r>1?void 0:r?Ze(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&Xe(t,n,i),i},at=(e,t,n)=>t.has(e)||tt(`Cannot `+n),ot=(e,t,n)=>(at(e,t,`read from private field`),n?n.call(e):t.get(e)),st=(e,t,n)=>t.has(e)?tt(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),ct=(e,t,n,r)=>(at(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),G,K=class extends i{constructor(){super(),st(this,G,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,rt({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){ot(this,G)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),ct(this,G,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}};G=new WeakMap,K.version=`2.20.1`,K.dependencies={},it([o()],K.prototype,`dir`,2),it([o()],K.prototype,`lang`,2);var lt=class extends K{render(){return e` <slot></slot> `}};lt.styles=[Ye,Je],lt.define(`sl-visually-hidden`);var ut=t`
  .badge-indicator {
...
`,q=class extends i{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant=`primary`,this.id=this.id||`badge-${Math.floor(Math.random()*1e9).toString()}`}showCount(){return this.badgeCount!==null&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?`99+`:this.badgeCount.toString()}getBadgeRole(){return this.altText?`img`:r}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return e`
    ...
    `}};q.styles=[ut],a([o({attribute:`alt-text`})],q.prototype,`altText`,void 0),a([o({attribute:`badge-count`})],q.prototype,`badgeCount`,void 0),a([o({attribute:`badge-count-suffix`})],q.prototype,`badgeCountSuffix`,void 0),a([o()],q.prototype,`variant`,void 0),a([o()],q.prototype,`id`,void 0),customElements.get(`craft-badge-indicator`)||customElements.define(`craft-badge-indicator`,q);var dt=Symbol.for(``),ft=e=>{if(e?.r===dt)return e?._$litStatic$},J=(e,...t)=>({_$litStatic$:t.reduce(((t,n,r)=>t+(e=>{if(e._$litStatic$!==void 0)return e._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${e}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(n)+e[r+1]),e[0]),r:dt}),pt=new Map,mt=(e=>(t,...n)=>{let r=n.length,i,a,o=[],s=[],c,l=0,u=!1;for(;l<r;){for(c=t[l];l<r&&(a=n[l],(i=ft(a))!==void 0);)c+=i+t[++l],u=!0;l!==r&&s.push(a),o.push(c),l++}if(l===r&&o.push(t[r]),u){let e=o.join(`$$lit$$`);(t=pt.get(e))===void 0&&(o.raw=o,pt.set(e,t=o)),n=s}return e(t,...n)})(e),ht=t`
  :host {
...
`,Y=new WeakMap,X=new WeakMap,Z=new WeakMap,Q=new WeakMap,gt=new WeakMap,$=class t extends i{get hasLabel(){return Array.from(this.childNodes).some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE&&!e.hasAttribute(`slot`))}constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.initialState=`closed`,this.group=!1,this.togglePosition=`suffix`,this.subnavState=`closed`,this.flyoutOpen=!1,u(this,Y,void 0),u(this,X,void 0),u(this,Z,()=>{clearTimeout(d(Y,this)),this.flyoutOpen=!0}),u(this,Q,()=>{clearTimeout(d(Y,this)),f(Y,this,setTimeout(()=>{this.flyoutOpen=!1},t.flyoutCloseDelay))}),u(this,gt,e=>{this.flyoutOpen=e.target.opened===!0}),this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active||this.initialState===`open`?`open`:`closed`;let{signal:e}=f(X,this,new AbortController);this.addEventListener(`mouseenter`,d(Z,this),{signal:e}),this.addEventListener(`mouseleave`,d(Q,this),{signal:e}),this.addEventListener(`focusin`,d(Z,this),{signal:e}),this.addEventListener(`focusout`,d(Q,this),{signal:e})}disconnectedCallback(){d(X,this)?.abort(),clearTimeout(d(Y,this)),super.disconnectedCallback()}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(t){let n=`item-${this.id}`,i=this.href?J`a`:J`span`;return mt`
      <${i}
        class="${g({"nav-item":!0,"nav-item--icon":!0,"nav-item--static":!this.href})}"
        id="${n}"
        href="${_(this.href||void 0)}"
    ...
    `}renderItem(e,t=!1){return mt`
      <${this.href?J`a`:J`span`}
      ...
      <li>
        ...
        ${o?e`
              <div
                class="subnav"
                id="${this.id}-subnav"
                style="${qe({display:a?`block`:`none`})}"
              >
                <slot name="subnav"></slot>
              </div>
            `:r}
      </li>
    `}};$.styles=ht,$.flyoutCloseDelay=150,a([o()],$.prototype,`icon`,void 0),a([o()],$.prototype,`href`,void 0),a([o({type:Boolean,reflect:!0})],$.prototype,`active`,void 0),a([o({type:Boolean})],$.prototype,`external`,void 0),a([o({type:Boolean})],$.prototype,`indicator`,void 0),a([o()],$.prototype,`id`,void 0),a([o({reflect:!0,type:Boolean,attribute:`icon-only`})],$.prototype,`iconOnly`,void 0),a([o()],$.prototype,`flush`,void 0),a([o({reflect:!0,attribute:`initial-state`})],$.prototype,`initialState`,void 0),a([o({type:Boolean,reflect:!0})],$.prototype,`group`,void 0),a([o({attribute:`toggle-position`})],$.prototype,`togglePosition`,void 0),a([s()],$.prototype,`subnavState`,void 0),a([s()],$.prototype,`flyoutOpen`,void 0),customElements.get(`craft-nav-item`)||customElements.define(`craft-nav-item`,$);export{g as _,V as a,p as b,j as c,de as d,ce as f,_ as g,T as h,U as i,he as l,se as m,qe as n,B as o,E as p,W as r,Re as s,$ as t,O as u,m as v,h as y};
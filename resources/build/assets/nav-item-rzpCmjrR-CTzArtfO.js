...
`,j=Object.defineProperty,M=Object.getOwnPropertyDescriptor,N=Object.getOwnPropertySymbols,P=Object.prototype.hasOwnProperty,F=Object.prototype.propertyIsEnumerable,I=e=>{throw TypeError(e)},L=(e,t,n)=>t in e?j(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,R=(e,t)=>{for(var n in t||={})P.call(t,n)&&L(e,n,t[n]);if(N)for(var n of N(t))F.call(t,n)&&L(e,n,t[n]);return e},z=(e,t,n,r)=>{for(var i=r>1?void 0:r?M(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&j(t,n,i),i},B=(e,t,n)=>t.has(e)||I(`Cannot `+n),ee=(e,t,n)=>(B(e,t,`read from private field`),n?n.call(e):t.get(e)),V=(e,t,n)=>t.has(e)?I(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),H=(e,t,n,r)=>(B(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),U,W=class extends r{constructor(){super(),V(this,U,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,R({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){ee(this,U)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),H(this,U,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}};U=new WeakMap,W.version=`2.20.1`,W.dependencies={},z([o()],W.prototype,`dir`,2),z([o()],W.prototype,`lang`,2);var G=class extends W{render(){return t` <slot></slot> `}};G.styles=[A,k],G.define(`sl-visually-hidden`);var K=e=>e??n,q=i`
  .badge-indicator {
...
`,J=class extends r{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant=`primary`,this.id=this.id||`badge-${Math.floor(Math.random()*1e9).toString()}`}showCount(){return this.badgeCount!==null&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?`99+`:this.badgeCount.toString()}getBadgeRole(){return this.altText?`img`:n}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return t`
      ${this.showCount()?t`
    ...
    `}render(){return t`
      <div
        part="badge"
        id=${this.id}
        class="${x({"badge-indicator":!0,"badge-indicator--with-number":this.showCount(),"badge-indicator--secondary":this.variant===`secondary`,"badge-indicator--inverse":this.variant===`inverse`})}"
        role="${this.getBadgeRole()}"
        aria-labelledby="${this.altText?this.getLabelId():n}"
      >
        ${this.renderBadgeContents()}
      </div>
    `}};J.styles=[q],a([o({attribute:`alt-text`})],J.prototype,`altText`,void 0),a([o({attribute:`badge-count`})],J.prototype,`badgeCount`,void 0),a([o({attribute:`badge-count-suffix`})],J.prototype,`badgeCountSuffix`,void 0),a([o()],J.prototype,`variant`,void 0),a([o()],J.prototype,`id`,void 0),customElements.get(`craft-badge-indicator`)||customElements.define(`craft-badge-indicator`,J);var Y=`important`,X=` !`+Y,Z=y(class extends b{constructor(e){if(super(e),e.type!==v.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(t,[n]){let{style:r}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(n)),this.render(n);for(let e of this.ft)n[e]??(this.ft.delete(e),e.includes(`-`)?r.removeProperty(e):r[e]=null);for(let e in n){let t=n[e];if(t!=null){this.ft.add(e);let n=typeof t==`string`&&t.endsWith(X);e.includes(`-`)||n?r.setProperty(e,n?t.slice(0,-11):t,n?Y:``):r[e]=t}}return e}}),Q=i`
  :host {
...
`,$=class extends r{get hasLabel(){return Array.from(this.childNodes).some(e=>e.nodeType===Node.TEXT_NODE?!!e.textContent?.trim():e.nodeType===Node.ELEMENT_NODE&&!e.hasAttribute(`slot`))}constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.initialState=`closed`,this.togglePosition=`suffix`,this.subnavState=`closed`,this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active||this.initialState===`open`?`open`:`closed`}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(e){let n=`item-${this.id}`;return t`
      <a
        class="${x({"nav-item":!0,"nav-item--icon":!0,"nav-item--static":!this.href})}"
        id="${n}"
      ...
      <craft-tooltip for="${n}" placement="right-start"
        ><slot></slot
      ></craft-tooltip>
    `}renderSubnavToggle(){return t`
      <craft-button
      ...
      >
        <craft-icon
          ...
          label="${D(`Toggle subnavigation`)}"
        ></craft-icon>
      </craft-button>
    `}renderPrefix(e=!1){return e&&this.togglePosition===`prefix`?t`
    ...
    `}renderSuffix(e=!1){return t`
      <div class="nav-item__suffix">
        <slot name="suffix">
          ${e&&this.togglePosition===`suffix`?this.renderSubnavToggle():n}
        </slot>
      </div>
    `}renderItem(e,r=!1){return t`
      <a
        class="${x({"nav-item":!0,"nav-item--prefixed":r,"nav-item--flush":this.flush,"nav-item--static":!this.href})}"
        href="${K(this.href||void 0)}"
        aria-current="${this.active?`page`:!1}"
      >
        ${r?this.renderPrefix(e):n}
        <slot
          id="${this.id}-label"
    ...
    `}render(){let e=!!this.querySelector(`[slot="subnav"]`),r=e&&this.hasLabel,i=r&&this.togglePosition===`prefix`||!!this.icon||!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`),a=r?this.subnavState===`open`:!0;return t`
      <li>
        ${this.iconOnly?this.renderIconItem(r):this.renderItem(r,i)}
        ${e?t`
              <div
                class="subnav"
                id="${this.id}-subnav"
                style="${Z({display:a?`block`:`none`})}"
              >
                <slot name="subnav"></slot>
              </div>
            `:n}
      </li>
    `}};$.styles=Q,a([o()],$.prototype,`icon`,void 0),a([o()],$.prototype,`href`,void 0),a([o({type:Boolean,reflect:!0})],$.prototype,`active`,void 0),a([o({type:Boolean})],$.prototype,`external`,void 0),a([o({type:Boolean})],$.prototype,`indicator`,void 0),a([o()],$.prototype,`id`,void 0),a([o({reflect:!0,type:Boolean,attribute:`icon-only`})],$.prototype,`iconOnly`,void 0),a([o()],$.prototype,`flush`,void 0),a([o({reflect:!0,attribute:`initial-state`})],$.prototype,`initialState`,void 0),a([o({attribute:`toggle-position`})],$.prototype,`togglePosition`,void 0),a([s()],$.prototype,`subnavState`,void 0),customElements.get(`craft-nav-item`)||customElements.define(`craft-nav-item`,$);export{E as a,y as c,O as i,b as l,Z as n,D as o,K as r,x as s,$ as t,v as u};